...
function interfacesMarshalVOIDOBJECTBOOLEAN(closure: GObject.TClosure, returnValue: any, nParamValues: number, paramValues: any, invocationHint: any, marshalData: any): void
function interfacesMarshalVOIDOBJECTINT(closure: GObject.TClosure, returnValue: any, nParamValues: number, paramValues: any, invocationHint: any, marshalData: any): void
function interfacesMarshalVOIDOBJECTPOINTER(closure: GObject.TClosure, returnValue: any, nParamValues: number, paramValues: any, invocationHint: any, marshalData: any): void
function interfacesMarshalVOIDOBJECTSTRING(closure: GObject.TClosure, returnValue: any, nParamValues: number, paramValues: any, invocationHint: any, marshalData: any): void
function interfacesMarshalVOIDOBJECTULONG(closure: GObject.TClosure, returnValue: any, nParamValues: number, paramValues: any, invocationHint: any, marshalData: any): void
/**
 ...
 */
function mixerMessageParseOptionChanged(message: Gst.Message, options: MixerOptions, value: string | null): void
/**
...
function navigationEventParseKeyEvent(event: Gst.Event, key: string | null): boolean
/**

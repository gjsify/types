...
export namespace Uhm {
    ...
    namespace Server {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
            /**
             * Emitted whenever the mock server must compare two {@link Uhm.Message}<!-- -->s for equality; e.g. when in the testing or comparison modes.
    ...
    class Server extends GObject.Object {
        ...
        /**
         * Class handler for the {@link Uhm.Server.SignalSignatures.compare_messages | Uhm.Server::compare-messages} signal. Subclasses may implement this to override
        ...
        /**
         * Class handler for the {@link Uhm.Server.SignalSignatures.handle_message | Uhm.Server::handle-message} signal. Subclasses may implement this to override the
         * default handler for the signal. The default handler should always return `true` to indicate that it has handled
         * the `message` from `client` by setting an appropriate response on the {@link Soup.ServerMessage}.
         * @param message
         * @virtual
         */

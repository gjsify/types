...
export namespace SecretUnstable {
    ...
    class Collection extends Gio.DBusProxy {
        // Own properties of SecretUnstable-0.Collection
        ...
        // Constructors of SecretUnstable-0.Collection
        ...
        // Owm methods of SecretUnstable-0.Collection
    ...
    class Item extends Gio.DBusProxy {
        // Own properties of SecretUnstable-0.Item
        ...
        // Constructors of SecretUnstable-0.Item
        ...
        // Owm methods of SecretUnstable-0.Item
    ...
    class Prompt extends Gio.DBusProxy {
        // Owm methods of SecretUnstable-0.Prompt
    ...
    class Service extends Gio.DBusProxy {
        // Owm methods of SecretUnstable-0.Service
         ...
         */
        lock_dbus_paths_finish(result: Gio.AsyncResult): number;
        /**
         * Lock items or collections in the secret service.
         *
         * The items or collections are represented by their D-Bus object paths. If you
         ...
         * @returns the number of items or collections that were locked
         */
        lock_dbus_paths_sync(paths: string, cancellable: Gio.Cancellable): number;
        /**
         * Complete asynchronous operation to lock items or collections in the secret
         * service.
         *
         ...
         * @returns the number of items or collections that were locked
         */
        lock_sync(objects: Gio.DBusProxy[], cancellable: Gio.Cancellable): number;
        /**
         ...
         */
        search_for_dbus_paths_finish(result: Gio.AsyncResult): boolean;
        /**
         ...
         */
        unlock_dbus_paths_finish(result: Gio.AsyncResult): number;
        /**
         * Unlock items or collections in the secret service.
         *
         * The items or collections are represented by their D-Bus object paths. If you
         ...
         * @returns the number of items or collections that were unlocked
         */
        unlock_dbus_paths_sync(paths: string, cancellable: Gio.Cancellable): number;
        /**
         * Complete asynchronous operation to unlock items or collections in the secret
         * service.
         *
         ...
         * @returns the number of items or collections that were unlocked
         */
        unlock_sync(objects: Gio.DBusProxy[], cancellable: Gio.Cancellable): number;
    }
     ...
     */
    class ServiceClass {
        // Own fields of SecretUnstable-0.ServiceClass
     ...
     */
    class Value {
        // Constructors of SecretUnstable-0.Value
        ...
        // Owm methods of SecretUnstable-0.Value

/**
 * The GIR-derived widget VOCABULARY for SecretUnstable-0.
 *
...
import type SecretUnstable from './secretunstable-0.js';
...
export interface SecretCollectionProps extends GDBusProxyProps, GAsyncInitableProps, GDBusInterfaceProps, GInitableProps {
    ...
    service?: SecretUnstable.Service;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type SecretCollectionConstructOnly = GDBusProxyConstructOnly | GAsyncInitableConstructOnly | GDBusInterfaceConstructOnly | GInitableConstructOnly | 'service';

/** A proxy object representing a secret item in the Secret Service. */
export interface SecretItemProps extends GDBusProxyProps, GAsyncInitableProps, GDBusInterfaceProps, GInitableProps {
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type SecretItemConstructOnly = GDBusProxyConstructOnly | GAsyncInitableConstructOnly | GDBusInterfaceConstructOnly | GInitableConstructOnly | 'service';
...
export interface SecretServiceProps extends GDBusProxyProps, GAsyncInitableProps, GDBusInterfaceProps, GInitableProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type SecretServiceConstructOnly = GDBusProxyConstructOnly | GAsyncInitableConstructOnly | GDBusInterfaceConstructOnly | GInitableConstructOnly;

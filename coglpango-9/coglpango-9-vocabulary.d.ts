/**
 * The GIR-derived widget VOCABULARY for CoglPango-9.
 *
 * GENERATED — do not edit. Provenance: CoglPango-9 — dropped empty base(s): Pango.Renderer — prop(s) no TypeScript value satisfies: CoglPango.Renderer.context
 *

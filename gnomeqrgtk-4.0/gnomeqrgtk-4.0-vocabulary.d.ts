/**
 * The GIR-derived widget VOCABULARY for GnomeQRGtk-4.0.
 *
 * GENERATED — do not edit. Provenance: GnomeQRGtk-4.0
 *
 * 1 instantiable GTypes (of which 1 concrete widgets), 1 declarations, 1 enum nick unions, 0 slot candidates.
 *
...
import type GnomeQRGtk from './gnomeqrgtk-4.0.js';
...
export type GnomeQrEccLevelNick = 'low' | 'medium' | 'quartile' | 'high';
...
export interface GnomeQrWidgetProps extends GtkWidgetProps, GtkAccessibleProps, GtkBuildableProps, GtkConstraintTargetProps {
    /** @default QR Code */
    'alternative-text'?: string | null;
    /** @default GNOME_QR_ECC_LEVEL_MEDIUM */
    'ecc-level'?: GnomeQrEccLevelNick | GnomeQR.EccLevel;
    /** @default 0 */
    size?: bigint | number;
    /** @default NULL */
    text?: string | null;
...
export type GnomeQrWidgetConstructOnly = GtkWidgetConstructOnly | GtkAccessibleConstructOnly | GtkBuildableConstructOnly | GtkConstraintTargetConstructOnly;
...
export interface Widgets {
    GnomeQrWidget: {
        class: GnomeQRGtk.Widget;
        props: GnomeQrWidgetProps;
        signals: GnomeQRGtk.Widget.SignalSignatures;
        constructOnly: GnomeQrWidgetConstructOnly;
        slotCandidates: {};
    };
}

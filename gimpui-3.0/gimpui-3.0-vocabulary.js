...
export const PROP_TYPES = {
    'GimpAspectPreview.drawable': 'GimpDrawable',
    'GimpBusyBox.message': 'gchararray',
    'GimpCellRendererColor.color': 'GeglColor',
    'GimpCellRendererColor.icon-size': 'gint',
    'GimpCellRendererColor.opaque': 'gboolean',
    'GimpCellRendererToggle.icon-name': 'gchararray',
    'GimpCellRendererToggle.icon-size': 'gint',
    'GimpCellRendererToggle.override-background': 'gboolean',
    'GimpChainButton.active': 'gboolean',
    'GimpChainButton.icon-size': 'GtkIconSize',
    'GimpChainButton.position': 'GimpChainPosition',
    'GimpColorArea.color': 'GeglColor',
    'GimpColorArea.drag-mask': 'GdkModifierType',
    'GimpColorArea.draw-border': 'gboolean',
    'GimpColorArea.type': 'GimpColorAreaType',
    'GimpColorButton.area-height': 'gint',
    'GimpColorButton.area-width': 'gint',
    'GimpColorButton.color': 'GeglColor',
    'GimpColorButton.color-config': 'GimpColorConfig',
    'GimpColorButton.continuous-update': 'gboolean',
    'GimpColorButton.title': 'gchararray',
    'GimpColorButton.type': 'GimpColorAreaType',
    'GimpColorProfileComboBox.dialog': 'GtkDialog',
    'GimpColorProfileComboBox.model': 'GimpColorProfileStore',
    'GimpColorProfileStore.history': 'GFile',
    'GimpColorScale.channel': 'GimpColorSelectorChannel',
    'GimpColorScales.show-hsv': 'gboolean',
    'GimpColorScales.show-rgb-u8': 'gboolean',
    'GimpColorSelection.config': 'GimpColorConfig',
    'GimpDialog.help-func': 'gpointer',
    'GimpDialog.help-id': 'gchararray',
    'GimpDialog.parent': 'GtkWidget',
    'GimpDrawableChooser.drawable': 'GimpDrawable',
    'GimpDrawableChooser.drawable-type': 'GType',
    'GimpDrawableChooser.label': 'gchararray',
    'GimpDrawableChooser.title': 'gchararray',
    'GimpDrawablePreview.drawable': 'GimpDrawable',
    'GimpEnumComboBox.model': 'GimpEnumStore',
    'GimpEnumLabel.enum-type': 'GType',
    'GimpEnumLabel.enum-value': 'gint',
    'GimpEnumStore.enum-type': 'GType',
    'GimpFileChooser.action': 'GimpFileChooserAction',
    'GimpFileChooser.file': 'GFile',
    'GimpFileChooser.label': 'gchararray',
    'GimpFileChooser.title': 'gchararray',
    'GimpHintBox.hint': 'gchararray',
    'GimpHintBox.icon-name': 'gchararray',
    'GimpImageChooser.image': 'GimpImage',
    'GimpImageChooser.label': 'gchararray',
    'GimpImageChooser.title': 'gchararray',
    'GimpIntComboBox.ellipsize': 'PangoEllipsizeMode',
    'GimpIntComboBox.label': 'gchararray',
    'GimpIntComboBox.layout': 'GimpIntComboBoxLayout',
    'GimpIntComboBox.value': 'gint',
    'GimpIntRadioFrame.store': 'GimpIntStore',
    'GimpIntRadioFrame.value': 'gint',
    'GimpIntStore.user-data-type': 'GType',
    'GimpItemChooser.item': 'GimpItem',
    'GimpItemChooser.item-type': 'GType',
    'GimpItemChooser.label': 'gchararray',
    'GimpItemChooser.title': 'gchararray',
    'GimpLabelColor.editable': 'gboolean',
    'GimpLabelColor.value': 'GeglColor',
    'GimpLabelEntry.value': 'gchararray',
    'GimpLabelIntWidget.value': 'gint',
    'GimpLabelIntWidget.widget': 'GtkWidget',
    'GimpLabelSpin.digits': 'gint',
    'GimpLabelSpin.lower': 'gdouble',
    'GimpLabelSpin.upper': 'gdouble',
    'GimpLabelSpin.value': 'gdouble',
    'GimpLabelStringWidget.value': 'gchararray',
    'GimpLabelStringWidget.widget': 'GtkWidget',
    'GimpLabeled.label': 'gchararray',
    'GimpNumberPairEntry.allow-simplification': 'gboolean',
    'GimpNumberPairEntry.aspect': 'GimpAspectType',
    'GimpNumberPairEntry.default-left-number': 'gdouble',
    'GimpNumberPairEntry.default-right-number': 'gdouble',
    'GimpNumberPairEntry.default-text': 'gchararray',
    'GimpNumberPairEntry.left-number': 'gdouble',
    'GimpNumberPairEntry.max-valid-value': 'gdouble',
    'GimpNumberPairEntry.min-valid-value': 'gdouble',
    'GimpNumberPairEntry.ratio': 'gdouble',
    'GimpNumberPairEntry.right-number': 'gdouble',
    'GimpNumberPairEntry.separators': 'gchararray',
    'GimpNumberPairEntry.user-override': 'gboolean',
    'GimpPageSelector.n-pages': 'gint',
    'GimpPageSelector.target': 'GimpPageSelectorTarget',
    'GimpPreview.update': 'gboolean',
    'GimpPreviewArea.check-custom-color1': 'GeglColor',
    'GimpPreviewArea.check-custom-color2': 'GeglColor',
    'GimpPreviewArea.check-size': 'GimpCheckSize',
    'GimpPreviewArea.check-type': 'GimpCheckType',
    'GimpProcedureDialog.config': 'GimpProcedureConfig',
    'GimpProcedureDialog.procedure': 'GimpProcedure',
    'GimpResourceChooser.label': 'gchararray',
    'GimpResourceChooser.resource': 'GimpResource',
    'GimpResourceChooser.title': 'gchararray',
    'GimpRuler.lower': 'gdouble',
    'GimpRuler.max-size': 'gdouble',
    'GimpRuler.orientation': 'GtkOrientation',
    'GimpRuler.position': 'gdouble',
    'GimpRuler.unit': 'GimpUnit',
    'GimpRuler.upper': 'gdouble',
    'GimpSpinScale.label': 'gchararray',
    'GimpStringComboBox.ellipsize': 'PangoEllipsizeMode',
    'GimpStringComboBox.id-column': 'gint',
    'GimpStringComboBox.label-column': 'gint',
    'GimpStringComboBox.value': 'gchararray',
    'GimpUnitStore.has-percent': 'gboolean',
    'GimpUnitStore.has-pixels': 'gboolean',
    'GimpUnitStore.long-format': 'gchararray',
    'GimpUnitStore.num-values': 'gint',
    'GimpUnitStore.short-format': 'gchararray',
    'GimpZoomModel.maximum': 'gdouble',
    'GimpZoomModel.minimum': 'gdouble',
    'GimpZoomModel.value': 'gdouble',
    'GimpZoomPreview.drawable': 'GimpDrawable',
    'GimpZoomPreview.model': 'GimpZoomModel',
};

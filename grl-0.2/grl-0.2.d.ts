...
export namespace Grl {
    ...
    function operation_set_private_data(
        operation_id: number,
        private_data: any | null,
        cancel_cb: OperationCancelCb,
    ): void;
    /**
    ...
    class Caps extends GObject.Object {
        // Constructors of Grl-0.2.Caps

        static ['new'](): Caps;

        // Owm methods of Grl-0.2.Caps
    ...
    class Config extends GObject.Object {
        // Constructors of Grl-0.2.Config

        static ['new'](plugin: string, source?: string | null): Config;

        // Owm methods of Grl-0.2.Config
    ...
    class Data extends GObject.Object {
        // Constructors of Grl-0.2.Data

        static ['new'](): Data;

        // Owm methods of Grl-0.2.Data
    ...
    class Media extends Data {
        // Constructors of Grl-0.2.Media

        static ['new'](): Media;

        // Owm methods of Grl-0.2.Media
         ...
         * @returns the ISO-3166-1 of the region where the media was published (owned by @media).
         */
        get_region_data_nth(index: number): string;
        get_site(): string;
        get_size(): number;
        get_source(): string;
        ...
        get_url(): string;
        get_url_data(): string;
        get_url_data_nth(index: number): string;
        /**
    ...
    class MediaAudio extends Media {
        // Constructors of Grl-0.2.MediaAudio

        static ['new'](): MediaAudio;

        // Owm methods of Grl-0.2.MediaAudio
    ...
    class MediaBox extends Media {
        // Constructors of Grl-0.2.MediaBox

        static ['new'](): MediaBox;

        // Owm methods of Grl-0.2.MediaBox
    ...
    class MediaImage extends Media {
        // Constructors of Grl-0.2.MediaImage

        static ['new'](): MediaImage;

        // Owm methods of Grl-0.2.MediaImage
        ...
        get_url_data(width: number, height: number): string;
        get_url_data_nth(index: number, width: number, height: number): string;
        get_width(): number;
    ...
    class MediaVideo extends Media {
        // Constructors of Grl-0.2.MediaVideo

        static ['new'](): MediaVideo;

        // Owm methods of Grl-0.2.MediaVideo
        ...
        get_season(): number;
        get_show(): string;
        get_url_data(framerate: number, width: number, height: number): string;
        get_url_data_nth(index: number, framerate: number, width: number, height: number): string;
        get_width(): number;
        /**
    ...
    class OperationOptions extends GObject.Object {
        // Constructors of Grl-0.2.OperationOptions

        static ['new'](caps?: Caps | null): OperationOptions;

        // Owm methods of Grl-0.2.OperationOptions
         ...
         * @param key a #GrlKeyID
         */
        get_key_range_filter(key: KeyID): void;
    ...
    class Plugin extends GObject.Object {
        // Own properties of Grl-0.2.Plugin
    ...
    class Registry extends GObject.Object {
        // Owm methods of Grl-0.2.Registry
    ...
    class RelatedKeys extends GObject.Object {
        // Constructors of Grl-0.2.RelatedKeys

        static ['new'](): RelatedKeys;

        // Owm methods of Grl-0.2.RelatedKeys
    ...
    abstract class Source extends GObject.Object {
        // Own properties of Grl-0.2.Source
    ...
    class LogDomain {
        // Owm methods of Grl-0.2.LogDomain
     ...
     */
    class MediaVideoClass {}

    /**
     * Grilo Operation Options class.
     */
    class OperationOptionsClass {}
    ...
    class PluginDescriptor {
        // Own fields of Grl-0.2.PluginDescriptor
    ...
    class SourceBrowseSpec {
        // Own fields of Grl-0.2.SourceBrowseSpec
    ...
    class SourceMediaFromUriSpec {
        // Own fields of Grl-0.2.SourceMediaFromUriSpec
    ...
    class SourceQuerySpec {
        // Own fields of Grl-0.2.SourceQuerySpec
    ...
    class SourceRemoveSpec {
        // Own fields of Grl-0.2.SourceRemoveSpec
    ...
    class SourceResolveSpec {
        // Own fields of Grl-0.2.SourceResolveSpec
    ...
    class SourceSearchSpec {
        // Own fields of Grl-0.2.SourceSearchSpec
    ...
    class SourceStoreMetadataSpec {
        // Own fields of Grl-0.2.SourceStoreMetadataSpec
    ...
    class SourceStoreSpec {
        // Own fields of Grl-0.2.SourceStoreSpec

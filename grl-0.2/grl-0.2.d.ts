...
function marshal_VOID__BOXED_ENUM_BOOLEAN(closure: GObject.Closure, return_value: GObject.Value, n_param_values: number, param_values: GObject.Value, invocation_hint?: (any | null), marshal_data?: (any | null)): void
/**
...
function range_value_hashtable_insert(hash_table: GLib.HashTable<any, any>, key: (any | null), min: GObject.Value, max: GObject.Value): void
...
_init(...args: any[]): void;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'content-changed', callback: ((_source: this, changed_medias: Media[], change_type: SourceChangeType, location_unknown: boolean) => void)): number
    connect_after(signal: 'content-changed', callback: ((_source: this, changed_medias: Media[], change_type: SourceChangeType, location_unknown: boolean) => void)): number
    emit(signal: 'content-changed', changed_medias: Media[], change_type: SourceChangeType, location_unknown: boolean): void
...
static ["new"](min: GObject.Value, max: GObject.Value): RangeValue;
    ...
    static hashtable_insert(hash_table: GLib.HashTable<any, any>, key: (any | null), min: GObject.Value, max: GObject.Value): void

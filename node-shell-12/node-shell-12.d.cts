 ...
 */
export function getFileContentsUtf8Sync(path: string | null): string | null
/**
 ...
 * @param rowstride 
 */
export function utilCreatePixbufFromData(data: Uint8Array, colorspace: GdkPixbuf.Colorspace, hasAlpha: boolean, bitsPerSample: number, width: number, height: number, rowstride: number): GdkPixbuf.Pixbuf
/**
 ...
 */
export function utilGetTranslatedFolderName(name: string | null): string | null
/**
 ...
 */
export function utilHasX11DisplayExtension(display: Meta.Display, extension: string | null): boolean
/**
 ...
 */
export function utilRegexEscape(str: string | null): string | null
...
export function utilStartSystemdUnit(unit: string | null, mode: string | null, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void
export function utilStartSystemdUnitFinish(res: Gio.AsyncResult): boolean
export function utilStopSystemdUnit(unit: string | null, mode: string | null, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void
export function utilStopSystemdUnitFinish(res: Gio.AsyncResult): boolean
export function utilSystemdUnitExists(unit: string | null, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void
 ...
 */
export function utilTranslateTimeString(str: string | null): string | null
/**
 ...
 */
export function writeStringToStream(stream: Gio.OutputStream, str: string | null): boolean

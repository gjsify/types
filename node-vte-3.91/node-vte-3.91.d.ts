...
import './node-vte-3.91-import.d.ts';
...
interface Terminal extends Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Scrollable {
     ...
     */
    checkHyperlinkAt(x: number, y: number): string | null
    /**
     ...
     */
    checkMatchAt(x: number, y: number): [ /* returnType */ string | null, /* tag */ number ]
    /**
     ...
     */
    checkRegexSimpleAt(x: number, y: number, regexes: Regex[], matchFlags: number): string[] | null

...
export namespace ECalendar {
    ...
    class Cal extends GObject.Object {
        // Own fields of ECalendar-1.2.Cal

        object: GObject.Object;

        // Constructors of ECalendar-1.2.Cal

        static ['new'](source: EDataServer.Source, type: CalSourceType): Cal;

        // Owm methods of ECalendar-1.2.Cal
         ...
         * @returns TRUE if the operation was successful, FALSE otherwise.
         */
        get_object_list(query: string): boolean;
        /**
    ...
    class CalClient extends EDataServer.Client {
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_attachment_uris_sync(uid: string, rid: string, cancellable: Gio.Cancellable): boolean;
        /**
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_object_list_as_comps_sync(sexp: string, cancellable: Gio.Cancellable): boolean;
        /**
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_objects_for_uid_sync(uid: string, cancellable: Gio.Cancellable): boolean;
        /**
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_view_sync(sexp: string, cancellable: Gio.Cancellable): boolean;
        /**
    ...
    class CalClientView extends GObject.Object {
        // Own properties of ECalendar-1.2.CalClientView

        client: CalClient;
        view: any;

        // Own fields of ECalendar-1.2.CalClientView

        object: GObject.Object;

        // Owm methods of ECalendar-1.2.CalClientView
    ...
    class CalComponent extends GObject.Object {
        // Own fields of ECalendar-1.2.CalComponent

        object: GObject.Object;

        // Constructors of ECalendar-1.2.CalComponent

        static ['new'](): CalComponent;

        static new_from_string(calobj: string): CalComponent;

        // Owm methods of ECalendar-1.2.CalComponent
    ...
    class CalView extends GObject.Object {
        // Own properties of ECalendar-1.2.CalView

        client: Cal;
        view: any;

        // Own fields of ECalendar-1.2.CalView

        object: GObject.Object;

        // Owm methods of ECalendar-1.2.CalView
     ...
     */
    class CalChange {
        // Own fields of ECalendar-1.2.CalChange
    ...
    class CalClientClass {}

    class CalClientPrivate {}

    class CalClientViewClass {}

    class CalClientViewPrivate {}

    class CalComponentAlarm {
        // Owm methods of ECalendar-1.2.CalComponentAlarm
    ...
    class CalComponentAlarmInstance {
        // Own fields of ECalendar-1.2.CalComponentAlarmInstance
        ...
        // Constructors of ECalendar-1.2.CalComponentAlarmInstance
    ...
    class CalComponentAlarmRepeat {
        // Own fields of ECalendar-1.2.CalComponentAlarmRepeat

        repetitions: number;
        duration: any;

        // Constructors of ECalendar-1.2.CalComponentAlarmRepeat
    ...
    class CalComponentAlarmTrigger {
        // Own fields of ECalendar-1.2.CalComponentAlarmTrigger

        type: CalComponentAlarmTriggerType;
    }

    class CalComponentAlarms {
        // Own fields of ECalendar-1.2.CalComponentAlarms

        comp: CalComponent;
        alarms: any[];

        // Owm methods of ECalendar-1.2.CalComponentAlarms
    ...
    class CalComponentAttendee {
        // Own fields of ECalendar-1.2.CalComponentAttendee
        ...
        // Constructors of ECalendar-1.2.CalComponentAttendee
    ...
    class CalComponentClass {}

    class CalComponentDateTime {
        // Own fields of ECalendar-1.2.CalComponentDateTime

        value: any;
        tzid: string;

        // Constructors of ECalendar-1.2.CalComponentDateTime
    ...
    class CalComponentId {
        // Own fields of ECalendar-1.2.CalComponentId

        uid: string;
        rid: string;

        // Constructors of ECalendar-1.2.CalComponentId
    ...
    class CalComponentOrganizer {
        // Own fields of ECalendar-1.2.CalComponentOrganizer
        ...
        // Constructors of ECalendar-1.2.CalComponentOrganizer
    ...
    class CalComponentPeriod {
        // Own fields of ECalendar-1.2.CalComponentPeriod
    ...
    class CalComponentRange {
        // Own fields of ECalendar-1.2.CalComponentRange
    ...
    class CalComponentText {
        // Own fields of ECalendar-1.2.CalComponentText

        value: string;
        altrep: string;

        // Constructors of ECalendar-1.2.CalComponentText

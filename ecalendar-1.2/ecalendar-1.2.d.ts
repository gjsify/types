...
static ["new"](source: EDataServer.Source, type: CalSourceType): Cal;
    ...
    connect(signal: 'cal-set-mode', callback: ((_source: this, object: CalSetModeStatusEnum, p0: unknown) => void)): number
    connect_after(signal: 'cal-set-mode', callback: ((_source: this, object: CalSetModeStatusEnum, p0: unknown) => void)): number
    ...
    static marshal_VOID__ENUM_ENUM(closure: GObject.Closure, return_value: GObject.Value, n_param_values: number, param_values: GObject.Value, invocation_hint: any, marshal_data: any): void
    static marshal_VOID__STRING_UINT(closure: GObject.Closure, return_value: GObject.Value, n_param_values: number, param_values: GObject.Value, invocation_hint: any, marshal_data: any): void
    static marshal_VOID__UINT_STRING(closure: GObject.Closure, return_value: GObject.Value, n_param_values: number, param_values: GObject.Value, invocation_hint: any, marshal_data: any): void
    /**
...
static ["new"](source: EDataServer.Source, source_type: CalClientSourceType): CalClient;
     ...
     * @param callback callback to call when a result is ready
     */
    get_free_busy(start: number, end: number, users: string[], cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback<this>): void
    /**

...
GJS TypeScript type definitions for JavaScriptCore-6.0, generated from library version 2.39.90 using [ts-for-gir](https://github.com/gjsify/ts-for-gjs) v3.0.0-beta.12.

// The widget vocabulary of Meta-16 as runtime data.
//
...
export const PROVENANCE = {
    ...
    requiredVocabularies: ['@girs/clutter-16/vocabulary', '@girs/gio-2.0/vocabulary', '@girs/gobject-2.0/vocabulary'],
};
...
export const OWN_SIGNALS = {
    ...
    MetaOrientationManager: ['orientation-changed'],

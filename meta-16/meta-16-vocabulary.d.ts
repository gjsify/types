/**
 * The GIR-derived widget VOCABULARY for Meta-16.
 *
 * GENERATED — do not edit. Provenance: Meta-16 — dropped empty base(s): Atk.ImplementorIface — inlined base(s) their owner's vocabulary does not emit: Gio.DBusInterfaceSkeleton
 *
 * 36 instantiable GTypes (of which 0 concrete widgets), 37 declarations (1 inlined from a namespace whose vocabulary does not emit them), 32 enum nick unions, 0 slot candidates.
 *
...
import type Meta from './meta-16.js';
import type Mtk from '@girs/mtk-16';
import type { ClutterActorConstructOnly, ClutterActorProps, ClutterAnimatableConstructOnly, ClutterAnimatableProps, ClutterContentConstructOnly, ClutterContentProps, ClutterStageConstructOnly, ClutterStageProps } from '@girs/clutter-16/vocabulary';

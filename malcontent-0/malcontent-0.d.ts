...
import './malcontent-0-import.d.ts';
/**
 * Malcontent-0
 */
...
export namespace Malcontent {
    ...
    class ManagerError extends GLib.Error {
        // Own fields of Malcontent-0.ManagerError
        ...
        // Constructors of Malcontent-0.ManagerError

        constructor(options: { message: string; code: number });

        // Owm methods of Malcontent-0.ManagerError
    ...
    class Manager extends GObject.Object {
        // Own properties of Malcontent-0.Manager
        ...
        // Constructors of Malcontent-0.Manager

        static ['new'](connection: Gio.DBusConnection): Manager;

        // Owm methods of Malcontent-0.Manager
     ...
     */
    class AppFilter {
        // Own fields of Malcontent-0.AppFilter
        ...
        // Owm methods of Malcontent-0.AppFilter
    ...
    class AppFilterBuilder {
        // Constructors of Malcontent-0.AppFilterBuilder

        constructor(properties?: Partial<{}>);

        static ['new'](): AppFilterBuilder;

        // Owm methods of Malcontent-0.AppFilterBuilder
     ...
     */
    class SessionLimits {
        // Own fields of Malcontent-0.SessionLimits
        ...
        // Owm methods of Malcontent-0.SessionLimits
         ...
         */
        check_time_remaining(now_usecs: number): boolean;
        /**
    ...
    class SessionLimitsBuilder {
        // Constructors of Malcontent-0.SessionLimitsBuilder

        constructor(properties?: Partial<{}>);

        static ['new'](): SessionLimitsBuilder;

        // Owm methods of Malcontent-0.SessionLimitsBuilder

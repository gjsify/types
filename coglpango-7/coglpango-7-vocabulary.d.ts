/**
 * The GIR-derived widget VOCABULARY for CoglPango-7.
 *
 * GENERATED — do not edit. Provenance: CoglPango-7 — dropped empty base(s): Pango.Renderer — prop(s) no TypeScript value satisfies: CoglPango.Renderer.context
 *

...
export namespace GstRtsp {
     ...
     */
    function rtsp_connection_accept(socket: Gio.Socket, cancellable?: Gio.Cancellable | null): RTSPResult;
    /**
     ...
     * @returns #GST_RTSP_OK when @conn contains a valid connection.
     */
    function rtsp_connection_create(url: RTSPUrl): RTSPResult;
    /**
     ...
     */
    function rtsp_message_new(): RTSPResult;
    /**
     ...
     * @returns a #GstRTSPResult.
     */
    function rtsp_message_new_data(channel: number): RTSPResult;
    /**
     ...
     * @returns a #GstRTSPResult.
     */
    function rtsp_message_new_request(method: RTSPMethod, uri: string): RTSPResult;
    /**
     ...
     */
    function rtsp_range_get_times(range: RTSPTimeRange): boolean;
    /**
     * Parse `rangestr` to a #GstRTSPTimeRange.
     * @param rangestr a range string to parse
     * @returns #GST_RTSP_OK on success.
     */
    function rtsp_range_parse(rangestr: string): RTSPResult;
    /**
     ...
     * @returns #GST_RTSP_OK.
     */
    function rtsp_transport_get_manager(trans: RTSPTransMode, option: number): RTSPResult;
    /**
     ...
     * @returns #GST_RTSP_OK.
     */
    function rtsp_transport_get_mime(trans: RTSPTransMode): RTSPResult;
    /**
     * Initialize `transport` so that it can be used.
     * @returns #GST_RTSP_OK.
     */
    function rtsp_transport_init(): RTSPResult;
    /**
     * Allocate a new initialized #GstRTSPTransport. Use gst_rtsp_transport_free()
     * after usage.
     * @returns a #GstRTSPResult.
     */
    function rtsp_transport_new(): RTSPResult;
    /**
     * Parse the RTSP transport string `str` into `transport`.
     * @param str a transport string
     * @returns a #GstRTSPResult.
     */
    function rtsp_transport_parse(str: string): RTSPResult;
    /**
     ...
     * @returns a #GstRTSPResult.
     */
    function rtsp_url_parse(urlstr: string): RTSPResult;
    /**
    ...
    class RTSPAuthCredential {
        // Own fields of GstRtsp-1.0.RTSPAuthCredential
     ...
     */
    class RTSPAuthParam {
        // Own fields of GstRtsp-1.0.RTSPAuthParam

        name: string;
        value: string;

        // Constructors of GstRtsp-1.0.RTSPAuthParam
        ...
        // Owm methods of GstRtsp-1.0.RTSPAuthParam
    ...
    class RTSPConnection {
        // Owm methods of GstRtsp-1.0.RTSPConnection
         ...
         * @param cancellable a #GCancellable to cancel the operation
         */
        static accept(socket: Gio.Socket, cancellable?: Gio.Cancellable | null): RTSPResult;
        /**
         * Create a newly allocated #GstRTSPConnection from `url` and store it in `conn`.
         * The connection will not yet attempt to connect to `url,` use
         * gst_rtsp_connection_connect().
         ...
         * @param url a #GstRTSPUrl
         */
        static create(url: RTSPUrl): RTSPResult;
        /**
         * Create a new #GstRTSPConnection for handling communication on the existing
         * socket `socket`. The `initial_buffer` contains zero terminated data already
         * read from `socket` which should be used before starting to read new data.
         ...
         * @param initial_buffer data already read from @fd
         */
        static create_from_socket(socket: Gio.Socket, ip: string, port: number, initial_buffer: string): RTSPResult;
         ...
         * @returns #GST_RTSP_OK on success.
         */
        poll(events: RTSPEvent, timeout: GLib.TimeVal): RTSPResult;
        /**
         * Wait up to the specified `timeout` for the connection to become available for
         * at least one of the operations specified in `events`. When the function returns
         * with #GST_RTSP_OK, `revents` will contain a bitmask of available operations on
         ...
         * @returns #GST_RTSP_OK on success.
         */
        poll_usec(events: RTSPEvent, timeout: number): RTSPResult;
        /**
     ...
     */
    class RTSPMessage {
        // Own fields of GstRtsp-1.0.RTSPMessage

        type: RTSPMsgType;

        // Owm methods of GstRtsp-1.0.RTSPMessage
     ...
     */
    class RTSPRange {
        // Own fields of GstRtsp-1.0.RTSPRange

        min: number;
        max: number;

        // Constructors of GstRtsp-1.0.RTSPRange
        ...
        // Owm methods of GstRtsp-1.0.RTSPRange
         ...
         * @param range a #GstRTSPTimeRange
         */
        static get_times(range: RTSPTimeRange): boolean;
        /**
         * Parse `rangestr` to a #GstRTSPTimeRange.
         * @param rangestr a range string to parse
         */
        static parse(rangestr: string): RTSPResult;
        /**
         * Convert `range` into a string representation.
         * @param range a #GstRTSPTimeRange
         */
     ...
     */
    class RTSPTime {
        // Own fields of GstRtsp-1.0.RTSPTime
     ...
     */
    class RTSPTime2 {
        // Own fields of GstRtsp-1.0.RTSPTime2
        ...
        // Constructors of GstRtsp-1.0.RTSPTime2
     ...
     */
    class RTSPTimeRange {
        // Own fields of GstRtsp-1.0.RTSPTimeRange
     ...
     */
    class RTSPTransport {
        // Own fields of GstRtsp-1.0.RTSPTransport
        ...
        // Owm methods of GstRtsp-1.0.RTSPTransport
         ...
         * @param option option index.
         */
        static get_manager(trans: RTSPTransMode, option: number): RTSPResult;
        /**
         * Get the mime type of the transport mode `trans`. This mime type is typically
         * used to generate #GstCaps events.
         * @param trans a #GstRTSPTransMode
         */
        static get_mime(trans: RTSPTransMode): RTSPResult;
        /**
         * Initialize `transport` so that it can be used.
         */
        static init(): RTSPResult;
        /**
         * Allocate a new initialized #GstRTSPTransport. Use gst_rtsp_transport_free()
         * after usage.
         */
        static new(): RTSPResult;
        /**
         * Parse the RTSP transport string `str` into `transport`.
         * @param str a transport string
         */
        static parse(str: string): RTSPResult;
     ...
     */
    class RTSPUrl {
        // Own fields of GstRtsp-1.0.RTSPUrl
        ...
        // Owm methods of GstRtsp-1.0.RTSPUrl
         ...
         * @param urlstr the url string to parse
         */
        static parse(urlstr: string): RTSPResult;
     ...
     */
    class RTSPWatch {
        // Owm methods of GstRtsp-1.0.RTSPWatch
    ...
    class RTSPWatchFuncs {
        // Constructors of GstRtsp-1.0.RTSPWatchFuncs

        constructor(properties?: Partial<{}>);
    }

    interface RTSPExtension {
        // Owm methods of GstRtsp-1.0.RTSPExtension
        ...
        // Own virtual methods of GstRtsp-1.0.RTSPExtension

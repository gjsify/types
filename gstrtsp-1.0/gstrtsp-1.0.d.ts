...
import './gstrtsp-1.0-ambient.d.ts';
import './gstrtsp-1.0-import.d.ts';
/**
 * GstRtsp-1.0
 */
 ...
 */
function rtsp_connection_accept(socket: Gio.Socket, cancellable: Gio.Cancellable | null): [ /* returnType */ RTSPResult, /* conn */ RTSPConnection | null ]
/**
 ...
 * @returns #GST_RTSP_OK when @conn contains a valid connection.
 */
function rtsp_connection_create_from_socket(socket: Gio.Socket, ip: string | null, port: number, initial_buffer: string | null): [ /* returnType */ RTSPResult, /* conn */ RTSPConnection | null ]
/**
 ...
 */
function rtsp_find_header_field(header: string | null): RTSPHeaderField
/**
 * Convert `method` to a #GstRTSPMethod.
 * @param method a method
 * @returns a #GstRTSPMethod for @method or #GST_RTSP_INVALID if the method is unknown.
 */
function rtsp_find_method(method: string | null): RTSPMethod
/**
 ...
 */
function rtsp_generate_digest_auth_response(algorithm: string | null, method: string | null, realm: string | null, username: string | null, password: string | null, uri: string | null, nonce: string | null): string | null
/**
 * Calculates the digest auth response from the values given by the server and
 ...
 * @returns Authentication response or %NULL if unsupported
 */
function rtsp_generate_digest_auth_response_from_md5(algorithm: string | null, method: string | null, md5: string | null, uri: string | null, nonce: string | null): string | null
/**
 ...
 */
function rtsp_message_init(): [ /* returnType */ RTSPResult, /* msg */ RTSPMessage ]
/**
 * Initialize a new data #GstRTSPMessage for `channel`.
 * @param channel a channel
 * @returns a #GstRTSPResult.
 */
function rtsp_message_init_data(channel: number): [ /* returnType */ RTSPResult, /* msg */ RTSPMessage ]
/**
 ...
 * @returns a #GstRTSPResult.
 */
function rtsp_message_init_request(method: RTSPMethod, uri: string | null): [ /* returnType */ RTSPResult, /* msg */ RTSPMessage ]
/**
 ...
 * @returns a #GstRTSPResult.
 */
function rtsp_message_init_response(code: RTSPStatusCode, reason: string | null, request: RTSPMessage | null): [ /* returnType */ RTSPResult, /* msg */ RTSPMessage ]
/**
 ...
 * @returns a #GstRTSPResult.
 */
function rtsp_message_new_request(method: RTSPMethod, uri: string | null): [ /* returnType */ RTSPResult, /* msg */ RTSPMessage ]
/**
 ...
 */
function rtsp_options_as_text(options: RTSPMethod): string | null
/**
 ...
 */
function rtsp_options_from_text(options: string | null): RTSPMethod
/**
 ...
 */
function rtsp_range_parse(rangestr: string | null): [ /* returnType */ RTSPResult, /* range */ RTSPTimeRange ]
/**
 * Convert `range` into a string representation.
 * @param range a #GstRTSPTimeRange
 * @returns The string representation of @range. g_free() after usage.
 */
function rtsp_range_to_string(range: RTSPTimeRange): string | null
/**
 * Convert `code` to a string.
 * @param code a #GstRTSPStatusCode
 * @returns a string representation of @code.
 */
function rtsp_status_as_text(code: RTSPStatusCode): string | null
/**
 * Convert `result` in a human readable string.
 * @param result a #GstRTSPResult
 * @returns a newly allocated string. g_free() after usage.
 */
function rtsp_strresult(result: RTSPResult): string | null
/**
 ...
 * @returns #GST_RTSP_OK.
 */
function rtsp_transport_get_mime(trans: RTSPTransMode): [ /* returnType */ RTSPResult, /* mime */ string | null ]
/**
 * Initialize `transport` so that it can be used.
 * @returns #GST_RTSP_OK.
 */
function rtsp_transport_init(): [ /* returnType */ RTSPResult, /* transport */ RTSPTransport ]
/**
 * Allocate a new initialized #GstRTSPTransport. Use gst_rtsp_transport_free()
 * after usage.
 * @returns a #GstRTSPResult.
 */
function rtsp_transport_new(): [ /* returnType */ RTSPResult, /* transport */ RTSPTransport ]
/**
 * Parse the RTSP transport string `str` into `transport`.
 * @param str a transport string
 * @returns a #GstRTSPResult.
 */
function rtsp_transport_parse(str: string | null): [ /* returnType */ RTSPResult, /* transport */ RTSPTransport ]
/**
 ...
 * @returns a #GstRTSPResult.
 */
function rtsp_url_parse(urlstr: string | null): [ /* returnType */ RTSPResult, /* url */ RTSPUrl | null ]
/**
 * Convert `version` to a string.
 * @param version a #GstRTSPVersion
 * @returns a string representation of @version.
 */
function rtsp_version_as_text(version: RTSPVersion): string | null
...
module RTSPExtension {
     ...
     */
    interface SendSignalCallback {
        ($obj: RTSPExtension, object: any | null, p0: any | null): RTSPResult
    }
...
interface RTSPExtension {
    ...
    get_transports(protocols: RTSPLowerTrans, transport: string | null): RTSPResult
    ...
    vfunc_get_transports(protocols: RTSPLowerTrans, transport: string | null): RTSPResult
    ...
    connect_after(sigName: "send", callback: RTSPExtension.SendSignalCallback): number
    emit(sigName: "send", object: any | null, p0: any | null, ...args: any[]): void
...
interface RTSPConnection {
     ...
     * @returns #GST_RTSP_OK on success.
     */
    poll_usec(events: RTSPEvent, timeout: number): [ /* returnType */ RTSPResult, /* revents */ RTSPEvent ]
    /**
     ...
     * @returns #GST_RTSP_OK on success.
     */
    receive_usec(timeout: number): [ /* returnType */ RTSPResult, /* message */ RTSPMessage ]
    /**
...
interface RTSPExtensionInterface {
    ...
    get_transports: (ext: RTSPExtension, protocols: RTSPLowerTrans, transport: string | null) => RTSPResult
...
interface RTSPMessage {
     ...
     */
    get_header(field: RTSPHeaderField, indx: number): [ /* returnType */ RTSPResult, /* value */ string | null ]
    /**
     ...
     * @returns a #GstRTSPResult.
     */
    take_header(field: RTSPHeaderField, value: string | null): RTSPResult
    /**
...
class RTSPRange {
     ...
     * @returns The string representation of @range. g_free() after usage.
     */
    static to_string(range: RTSPTimeRange): string | null
}

 ...
 */
export function rtsp_connection_accept(socket: Gio.Socket, cancellable: Gio.Cancellable | null): [ /* returnType */ RTSPResult, /* conn */ RTSPConnection | null ]
/**
 ...
 */
export function rtsp_message_init(): [ /* returnType */ RTSPResult, /* msg */ RTSPMessage ]
/**
 * Initialize a new data #GstRTSPMessage for `channel`.
 * @param channel a channel
 * @returns a #GstRTSPResult.
 */
export function rtsp_message_init_data(channel: number): [ /* returnType */ RTSPResult, /* msg */ RTSPMessage ]
/**
 ...
 * @returns a #GstRTSPResult.
 */
export function rtsp_message_init_request(method: RTSPMethod, uri: string | null): [ /* returnType */ RTSPResult, /* msg */ RTSPMessage ]
/**
 ...
 * @returns a #GstRTSPResult.
 */
export function rtsp_message_init_response(code: RTSPStatusCode, reason: string | null, request: RTSPMessage | null): [ /* returnType */ RTSPResult, /* msg */ RTSPMessage ]
/**
 ...
 */
export function rtsp_options_as_text(options: RTSPMethod): string | null
/**
 ...
 */
export function rtsp_range_to_string(range: RTSPTimeRange): string | null
/**
 ...
 */
export function rtsp_strresult(result: RTSPResult): string | null
/**
 ...
 * @returns #GST_RTSP_OK.
 */
export function rtsp_transport_init(): [ /* returnType */ RTSPResult, /* transport */ RTSPTransport ]
/**
 * Allocate a new initialized #GstRTSPTransport. Use gst_rtsp_transport_free()
 * after usage.
 * @returns a #GstRTSPResult.
 */
export function rtsp_transport_new(): [ /* returnType */ RTSPResult, /* transport */ RTSPTransport ]
/**

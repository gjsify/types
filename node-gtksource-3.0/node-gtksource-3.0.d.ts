...
module CompletionInfo {
     ...
     */
    interface BeforeShowSignalCallback {
        (): void
    }
...
interface CompletionInfo extends Atk.ImplementorIface, Gtk.Buildable {
    ...
    on(sigName: "before-show", callback: CompletionInfo.BeforeShowSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "before-show", callback: CompletionInfo.BeforeShowSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "before-show", callback: CompletionInfo.BeforeShowSignalCallback): NodeJS.EventEmitter

...
import './node-shell-14-import.d.ts';
    
/**
 * Shell-14
 */

import type St from '@girs/node-st-14';
...
import type Cally from '@girs/node-cally-14';
...
export interface App {
     ...
     * with a valid id.
     * @param actionName the name of an action to activate
     ...
     */
    activateAction(actionName: string, parameter: GLib.Variant | null, timestamp: number, workspace: number, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void
    /**
     ...
     */
    activateActionFinish(result: Gio.AsyncResult): boolean
    /**
...
export module SquareBin {
    ...
    export interface ConstructorProperties extends Atk.ImplementorIface.ConstructorProperties, Clutter.Animatable.ConstructorProperties, St.Bin.ConstructorProperties {
    }

}

export interface SquareBin extends Atk.ImplementorIface, Clutter.Animatable {
...
export module Stack {
    ...
    export interface ConstructorProperties extends Atk.ImplementorIface.ConstructorProperties, Clutter.Animatable.ConstructorProperties, St.Widget.ConstructorProperties {
    }

}

export interface Stack extends Atk.ImplementorIface, Clutter.Animatable {
...
export module TrayIcon {
    ...
    export interface ConstructorProperties extends Atk.ImplementorIface.ConstructorProperties, Clutter.Animatable.ConstructorProperties, Clutter.Clone.ConstructorProperties {
    }

}

export interface TrayIcon extends Atk.ImplementorIface, Clutter.Animatable {
...
export interface WindowPreview extends Atk.ImplementorIface, Clutter.Animatable {
...
export interface WorkspaceBackground extends Atk.ImplementorIface, Clutter.Animatable {

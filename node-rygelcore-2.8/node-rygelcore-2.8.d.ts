...
import './node-rygelcore-2.8-import.d.ts';
...
interface Configuration extends GObject.Object {
    ...
    getStringListWithDefault(section: string, key: string, default_: Gee.ArrayList): Gee.ArrayList
...
class RootDevice extends GUPnP.RootDevice {
     ...
     */
    static new(context: GUPnP.Context, descriptionPath: string, descriptionFolder: string): GUPnP.RootDevice
...
interface CmdlineConfig extends Configuration {
    ...
    setOptions(args: GLib.VariantDict): void
...
class XMLUtils {
    ...
    constructor() 
    static new(): XMLUtils
    static getNamespace(root: any | null, href: string, prefix: string): any | null
}
...
interface Dlna150HacksClass {
}

abstract class Dlna150HacksClass {

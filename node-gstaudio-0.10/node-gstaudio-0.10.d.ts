 ...
 */
function audioCheckChannelPositions(pos: AudioChannelPosition, channels: number): boolean
/**
 ...
 * @returns the length.
 */
function audioDurationFromPadBuffer(pad: Gst.Pad, buf: Gst.Buffer): Gst.ClockTime
/**
 ...
 */
function audioFixateChannelPositions(str: Gst.Structure): AudioChannelPosition
/**
 * Calculate byte size of an audio frame.
 * @param pad the #GstPad to get the caps from
 * @returns the byte size, or 0 if there was an error
 */
function audioFrameByteSize(pad: Gst.Pad): number
/**
 ...
 */
function audioFrameLength(pad: Gst.Pad, buf: Gst.Buffer): number
/**
 ...
 */
function audioGetChannelPositions(str: Gst.Structure): AudioChannelPosition
/**
 ...
 */
function audioIsBufferFramed(pad: Gst.Pad, buf: Gst.Buffer): boolean
/**
 ...
 */
function audioSetCapsChannelPositionsList(caps: Gst.Caps, pos: AudioChannelPosition, numPositions: number): void
/**
 ...
 */
function audioSetChannelPositions(str: Gst.Structure, pos: AudioChannelPosition): void
/**
 * Sets a (possibly non-fixed) list of possible audio channel
 ...
 * @param numPositions the number of values in pos.
 */
function audioSetStructureChannelPositionsList(str: Gst.Structure, pos: AudioChannelPosition, numPositions: number): void
/**
 * Do not use anymore.
 * @param structure a #GstStructure
 * @param flag a set of #GstAudioFieldFlag
 */
function audioStructureSetInt(structure: Gst.Structure, flag: AudioFieldFlag): void
/**
...
module AudioFilter {
    ...
    interface ConstructorProperties extends Gst.BaseTransform.ConstructorProperties {
    }
...
module AudioSink {
    ...
    interface ConstructorProperties extends BaseAudioSink.ConstructorProperties {
    }
...
module AudioSrc {
    ...
    interface ConstructorProperties extends BaseAudioSrc.ConstructorProperties {
    }
...
module BaseAudioSink {

    // Constructor properties interface

    interface ConstructorProperties extends Gst.BaseSink.ConstructorProperties {
...
module BaseAudioSrc {
    ...
    interface ConstructorProperties extends Gst.PushSrc.ConstructorProperties {
...
interface RingBufferSpec {
    ...
    silenceSample: Uint8Array
    seglatency: number
    gstReserved: Uint8Array
}

...
export namespace TotemPlParser {
    ...
    class ParserError extends GLib.Error {
        // Own fields of TotemPlParser-1.0.ParserError
         ...
         */
        EMPTY_PLAYLIST: number;

        // Constructors of TotemPlParser-1.0.ParserError

        constructor(options: { message: string; code: number });

        // Owm methods of TotemPlParser-1.0.ParserError
    ...
    class Parser extends GObject.Object {
        // Own properties of TotemPlParser-1.0.Parser
        ...
        // Constructors of TotemPlParser-1.0.Parser

        static ['new'](): Parser;

        // Owm methods of TotemPlParser-1.0.Parser
    ...
    class Playlist extends GObject.Object {
        // Constructors of TotemPlParser-1.0.Playlist

        static ['new'](): Playlist;

        // Owm methods of TotemPlParser-1.0.Playlist
     ...
     */
    class PlaylistIter {
        // Constructors of TotemPlParser-1.0.PlaylistIter

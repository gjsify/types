...
static ["new"](): Parser;
    ...
    connect(signal: 'entry-parsed', callback: ((_source: this, uri: string, metadata: GLib.HashTable<string, string>) => void)): number
    connect_after(signal: 'entry-parsed', callback: ((_source: this, uri: string, metadata: GLib.HashTable<string, string>) => void)): number
    ...
    connect(signal: 'playlist-started', callback: ((_source: this, uri: string, metadata: GLib.HashTable<string, string>) => void)): number
    connect_after(signal: 'playlist-started', callback: ((_source: this, uri: string, metadata: GLib.HashTable<string, string>) => void)): number

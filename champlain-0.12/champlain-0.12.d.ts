...
static ["new"](): Marker;
    ...
    connect(signal: 'drag-motion', callback: ((_source: this, dx: number, dy: number, event: Clutter.Event) => void)): number
    connect_after(signal: 'drag-motion', callback: ((_source: this, dx: number, dy: number, event: Clutter.Event) => void)): number
...
static new_full(x: number, y: number, size: number, zoom_level: number): Tile;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'render-complete', callback: ((_source: this, data: any | null, size: number, error: boolean) => void)): number
    connect_after(signal: 'render-complete', callback: ((_source: this, data: any | null, size: number, error: boolean) => void)): number

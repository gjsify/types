...
export namespace Gda {
    ...
    /**
     * Defines the kind of notification which can be obtained when reading from te {@link GLib.IOChannel}
     ...
     * @returns a {@link Gda.DataHandler} which must not be modified or destroyed.
     * @since 4.2.3
     */
    ...
    /**
     * @param timegda a pointer to a {@link Gda.Time} structure which will be filled
     ...
     * @param out_stmt a place to store the new {@link Gda.Statement}, or `null`
     ...
     * several threads at once (locking is ensured by the {@link Gda.Connection} itself). Depending on the database provider's
    ...
    class Batch extends GObject.Object {
         ...
         * added multiple times to a {@link Gda.Batch} object.
    ...
    abstract class BlobOp extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof BlobOp.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<BlobOp.SignalSignatures[K]>): void;
         ...
         * @virtual
         */
        vfunc_read(blob: Blob, offset: number, size: number): bigint | number;
         ...
         * @virtual
         */
        vfunc_write(blob: Blob, offset: number): bigint | number;
    ...
    class Column extends GObject.Object {
         ...
         * @returns a read-only {@link GObject.Value}, or `null` if not attribute named `attribute` has been set for `column`
         */
         ...
         */
        set_attribute(attribute: string, value: GObject.Value | any | null): void;
    ...
    namespace Connection {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
            ...
            "notify::is-wrapper": (pspec: GObject.ParamSpec) => void;
            "notify::meta-store": (pspec: GObject.ParamSpec) => void;
            "notify::monitor-wrapped-in-mainloop": (pspec: GObject.ParamSpec) => void;
            "notify::provider": (pspec: GObject.ParamSpec) => void;
            "notify::thread-owner": (pspec: GObject.ParamSpec) => void;
        }
    ...
    class Connection extends GObject.Object implements Lockable {
         ...
         * a {@link Gda.Connection} object which "proxies" all the calls to another connection which executes in a sub
         * thread.
         * 
         ...
         * @since 4.2
         */
        get is_wrapper(): boolean;
        set is_wrapper(val: boolean);
         ...
         * @since 4.2
         */
        get monitor_wrapped_in_mainloop(): boolean;
        set monitor_wrapped_in_mainloop(val: boolean);
         ...
         * @since 4.2
         */
        get monitorWrappedInMainloop(): boolean;
        set monitorWrappedInMainloop(val: boolean);
         ...
         * as the <parameter>auth_params</parameter> member of the {@link Gda.ProviderInfo} structure for each installed
         ...
         * 
         * This method may fail with a GDA_CONNECTION_ERROR domain error (see the {@link Gda.ConnectionError} error codes)
         * or a `GDA_CONFIG_ERROR` domain error (see the {@link Gda.ConfigError} error codes).
         ...
         * {@link Gda.ConnectionOptions.THREAD_ISOLATED} flag when opening the connection to be sure it is opened in a separate thread
         ...
         * @param level the requested transaction level ({@link Gda.TransactionIsolation.UNKNOWN} if not specified)
         ...
         * provider used by `cnc` supports it) a new {@link Gda.Set} object composed of value holders named "+&lt;column number&gt;"
    ...
    class ConnectionEvent extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof ConnectionEvent.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<ConnectionEvent.SignalSignatures[K]>): void;
    ...
    class DataAccessWrapper extends GObject.Object implements DataModel {
        ...
        /** @signal */
        emit<K extends keyof DataAccessWrapper.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<DataAccessWrapper.SignalSignatures[K]>): void;
         ...
         * @virtual
         */
        vfunc_i_append_values(values: unknown[] | null): number;
         ...
         * @virtual
         */
        vfunc_i_find_row(values: unknown[], cols_index: number[]): number;
         ...
         * @virtual
         */
        vfunc_i_get_value_at(col: number, row: number): GObject.Value | any | null;
         ...
         * @virtual
         */
        vfunc_i_send_hint(hint: DataModelHint, hint_value: unknown | null): void;
         ...
         * @virtual
         */
        vfunc_i_set_value_at(col: number, row: number, value: unknown): boolean;
         ...
         * @virtual
         */
        vfunc_i_set_values(row: number, values: unknown[] | null): boolean;
    ...
    class DataComparator extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof DataComparator.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<DataComparator.SignalSignatures[K]>): void;
    ...
    class DataModelArray extends GObject.Object implements DataModel {
        ...
        /** @signal */
        emit<K extends keyof DataModelArray.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<DataModelArray.SignalSignatures[K]>): void;
    ...
    class DataModelDir extends GObject.Object implements DataModel {
        ...
        /** @signal */
        emit<K extends keyof DataModelDir.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<DataModelDir.SignalSignatures[K]>): void;
    ...
    class DataModelImport extends GObject.Object implements DataModel {
        ...
        /** @signal */
        emit<K extends keyof DataModelImport.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<DataModelImport.SignalSignatures[K]>): void;
    ...
    namespace DataModelIter {
        ...
        interface SignalSignatures extends Set.SignalSignatures {
            ...
            "notify::forced-model": (pspec: GObject.ParamSpec) => void;
    ...
    class DataModelIter extends Set {
        ...
        get forced_model(): DataModel;
        set forced_model(val: DataModel);

        get forcedModel(): DataModel;
        set forcedModel(val: DataModel);
        ...
        /** @signal */
        emit<K extends keyof DataModelIter.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<DataModelIter.SignalSignatures[K]>): void;
        ...
        // Methods
        /**
         * Get the column number in the {@link Gda.DataModel} for which `iter` is an iterator as
    ...
    class DataModelLdap extends GObject.Object implements DataModel {
         ...
         * @internal
         */
        $signals: DataModelLdap.SignalSignatures;

        // Fields
        object: GObject.Object;

        // Constructors
        constructor(properties?: Partial<DataModelLdap.ConstructorProps>, ...args: any[]);
        ...
        // Signals
        /** @signal */
        connect<K extends keyof DataModelLdap.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, DataModelLdap.SignalSignatures[K]>): number;

        /** @signal */
        connect_after<K extends keyof DataModelLdap.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, DataModelLdap.SignalSignatures[K]>): number;

        /** @signal */
        emit<K extends keyof DataModelLdap.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<DataModelLdap.SignalSignatures[K]>): void;

        // Static methods
        /**
         * Computes the {@link Gda.Column} of the data model which would be created using `attributes` when calling
    ...
    class DataPivot extends GObject.Object implements DataModel {
        ...
        /** @signal */
        emit<K extends keyof DataPivot.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<DataPivot.SignalSignatures[K]>): void;
    ...
    class DataProxy extends GObject.Object implements DataModel {
        ...
        /** @signal */
        emit<K extends keyof DataProxy.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<DataProxy.SignalSignatures[K]>): void;
    ...
    abstract class DataSelect extends GObject.Object implements DataModel {
        ...
        /** @signal */
        emit<K extends keyof DataSelect.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<DataSelect.SignalSignatures[K]>): void;
    ...
    class HandlerBin extends GObject.Object implements DataHandler {
        ...
        /** @signal */
        emit<K extends keyof HandlerBin.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<HandlerBin.SignalSignatures[K]>): void;
    ...
    class HandlerBoolean extends GObject.Object implements DataHandler {
        ...
        /** @signal */
        emit<K extends keyof HandlerBoolean.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<HandlerBoolean.SignalSignatures[K]>): void;
    ...
    class HandlerNumerical extends GObject.Object implements DataHandler {
        ...
        /** @signal */
        emit<K extends keyof HandlerNumerical.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<HandlerNumerical.SignalSignatures[K]>): void;
    ...
    class HandlerString extends GObject.Object implements DataHandler {
        ...
        /** @signal */
        emit<K extends keyof HandlerString.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<HandlerString.SignalSignatures[K]>): void;
    ...
    class HandlerTime extends GObject.Object implements DataHandler {
        ...
        /** @signal */
        emit<K extends keyof HandlerTime.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<HandlerTime.SignalSignatures[K]>): void;
    ...
    class HandlerType extends GObject.Object implements DataHandler {
        ...
        /** @signal */
        emit<K extends keyof HandlerType.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<HandlerType.SignalSignatures[K]>): void;
    ...
    namespace Holder {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
             ...
             * @run-first
             */
            "attribute-changed": (att_name: string, att_value: unknown) => void;
            /**
    ...
    class Holder extends GObject.Object implements Lockable {
        ...
        /** @signal */
        emit<K extends keyof Holder.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<Holder.SignalSignatures[K]>): void;
         ...
         * @virtual
         */
        vfunc_att_changed(att_name: string, att_value: unknown): void;
         ...
         * Attributes can have any name, but Libgda proposes some default names, see <link linkend="libgda-40-Attributes-manager.synopsis">this section</link>.
         * @param attribute attribute name as a string
         * @returns a read-only {@link GObject.Value}, or `null` if not attribute named `attribute` has been set for `holder`
         */
        get_attribute(attribute: string): unknown;
    ...
    class MetaStore extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof MetaStore.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<MetaStore.SignalSignatures[K]>): void;
    ...
    class MetaStruct extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof MetaStruct.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<MetaStruct.SignalSignatures[K]>): void;
         ...
         * @throws GLib.Error
         */
        complement(type: MetaDbObjectType, catalog: GObject.Value | any | null, schema: GObject.Value | any | null, name: GObject.Value | any): MetaDbObject;
         ...
         */
        get_db_object(catalog: GObject.Value | any | null, schema: GObject.Value | any | null, name: GObject.Value | any): MetaDbObject;
    ...
    abstract class PStmt extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof PStmt.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<PStmt.SignalSignatures[K]>): void;
    ...
    class RepetitiveStatement extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof RepetitiveStatement.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<RepetitiveStatement.SignalSignatures[K]>): void;
    ...
    class Row extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof Row.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<Row.SignalSignatures[K]>): void;
    ...
    abstract class ServerProvider extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof ServerProvider.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<ServerProvider.SignalSignatures[K]>): void;
    ...
    class Short {
        ...
        /** @signal */
        emit<K extends keyof Short.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<Short.SignalSignatures[K]>): void;
    }
    ...
    class SqlBuilder extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof SqlBuilder.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<SqlBuilder.SignalSignatures[K]>): void;
    ...
    class SqlParser extends GObject.Object implements Lockable {
        ...
        /** @signal */
        emit<K extends keyof SqlParser.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<SqlParser.SignalSignatures[K]>): void;
    ...
    namespace Statement {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
             ...
             * @run-first
             */
            checked: (object: Connection, p0: boolean) => void;
            /**
    ...
    class Statement extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof Statement.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<Statement.SignalSignatures[K]>): void;
         ...
         * @param context a {@link Gda.SqlRenderingContext} context
         * @returns a new string, or `null` if an error occurred
         * @throws GLib.Error
         */
    ...
    class ThreadWrapper extends GObject.Object {
         ...
         * @internal
         */
        $signals: ThreadWrapper.SignalSignatures;

        // Fields
        object: GObject.Object;

        // Constructors
        constructor(properties?: Partial<ThreadWrapper.ConstructorProps>, ...args: any[]);
        ...
        // Signals
        /** @signal */
        connect<K extends keyof ThreadWrapper.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, ThreadWrapper.SignalSignatures[K]>): number;

        /** @signal */
        connect_after<K extends keyof ThreadWrapper.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, ThreadWrapper.SignalSignatures[K]>): number;

        /** @signal */
        emit<K extends keyof ThreadWrapper.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<ThreadWrapper.SignalSignatures[K]>): void;
         ...
         * <itemizedlist>
         *  <listitem><para>the `callback` argument is not a {@link GObject.Callback} function, so the callback signature is not
    ...
    // Conflicted with GObject.Object.disconnect
         ...
         * readable through a new {@link GLib.IOChannel}. This function is useful when the notification needs
         ...
         * 
         * The returned {@link GLib.IOChannel} will have something to read everytime an execution job is finished
         * for an execution job submitted from the calling thread. The user whould read {@link Gda.ThreadNotification}
         ...
         * 
         * Note2: this function will return the same {@link GLib.IOChannel} everytime it's called from the same thread.
         * 
         * Note3: if the usage of the returned {@link GLib.IOChannel} reveals an error, then `g_io_channel_shutdown()` and
    ...
    class TransactionStatus extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof TransactionStatus.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<TransactionStatus.SignalSignatures[K]>): void;
    ...
    class TreeManager extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof TreeManager.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<TreeManager.SignalSignatures[K]>): void;
    ...
    class TreeMgrColumns extends TreeManager {
        ...
        /** @signal */
        emit<K extends keyof TreeMgrColumns.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<TreeMgrColumns.SignalSignatures[K]>): void;
    }
    ...
    class TreeMgrLabel extends TreeManager {
        ...
        /** @signal */
        emit<K extends keyof TreeMgrLabel.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<TreeMgrLabel.SignalSignatures[K]>): void;
    }
    ...
    namespace TreeMgrLdap {
        // Signal signatures
        interface SignalSignatures extends TreeManager.SignalSignatures {
            "notify::dn": (pspec: GObject.ParamSpec) => void;
            "notify::func": (pspec: GObject.ParamSpec) => void;
            "notify::recursive": (pspec: GObject.ParamSpec) => void;
        }
    ...
    class TreeMgrLdap extends TreeManager {
         ...
         * @internal
         */
        $signals: TreeMgrLdap.SignalSignatures;

        // Fields
        object: TreeManager;

        // Constructors
        constructor(properties?: Partial<TreeMgrLdap.ConstructorProps>, ...args: any[]);
        ...
        // Signals
        /** @signal */
        connect<K extends keyof TreeMgrLdap.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, TreeMgrLdap.SignalSignatures[K]>): number;

        /** @signal */
        connect_after<K extends keyof TreeMgrLdap.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, TreeMgrLdap.SignalSignatures[K]>): number;

        /** @signal */
        emit<K extends keyof TreeMgrLdap.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<TreeMgrLdap.SignalSignatures[K]>): void;
    }
    ...
    class TreeMgrSchemas extends TreeManager {
        ...
        /** @signal */
        emit<K extends keyof TreeMgrSchemas.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<TreeMgrSchemas.SignalSignatures[K]>): void;
    }
    ...
    class TreeMgrSelect extends TreeManager {
        ...
        /** @signal */
        emit<K extends keyof TreeMgrSelect.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<TreeMgrSelect.SignalSignatures[K]>): void;
    }
    ...
    class TreeMgrTables extends TreeManager {
        ...
        /** @signal */
        emit<K extends keyof TreeMgrTables.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<TreeMgrTables.SignalSignatures[K]>): void;
    }
    ...
    class UShort {
        ...
        /** @signal */
        emit<K extends keyof UShort.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<UShort.SignalSignatures[K]>): void;
    }
    ...
    class XaTransaction extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof XaTransaction.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<XaTransaction.SignalSignatures[K]>): void;
    ...
    class MetaTableColumn {
         ...
         * @param func a {@link Gda.AttributesManagerFunc} function
         */
    ...
    /**
     * Specifies the context in which a {@link Gda.SqlStatement} is being converted to SQL.
     * @gir-type Struct
     */
    ...
    /**
     * A notification to be read through the {@link GLib.IOChannel} which is returned by `gda_thread_wrapper_get_io_channel()`,
     * for example:
     * <programlisting><![CDATA[
     * gboolean

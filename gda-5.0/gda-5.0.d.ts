 ...
 */
function get_application_exec_path(app_name: string | null): string | null
/**
...
function parse_formatted_time(timegda: Time, value: string | null, sep: number): boolean
/**
 ...
 * @returns %TRUE if @value has been sucessfuly parsed as a valid date (see g_date_valid()).
 */
function parse_formatted_timestamp(timestamp: Timestamp, value: string | null, first: GLib.DateDMY, second: GLib.DateDMY, third: GLib.DateDMY, sep: number): boolean
/**
 ...
 * @returns %TRUE if no error occurred
 */
function parse_iso8601_time(timegda: Time, value: string | null): boolean
/**
 ...
 */
function parse_iso8601_timestamp(timestamp: Timestamp, value: string | null): boolean
/**
...
module Connection {
     ...
     */
    interface ConnClosedSignalCallback {
        ($obj: Connection): void
    }
     ...
     */
    interface ConnOpenedSignalCallback {
        ($obj: Connection): void
    }
     ...
     */
    interface ConnToCloseSignalCallback {
        ($obj: Connection): void
    }
...
module Holder {
     ...
     */
    interface AttributeChangedSignalCallback {

// The widget vocabulary of Clutter-51 as runtime data.
//
...
export const OWN_PROPS = {
    ...
    ClutterInputDevice: ['bus-type', 'capabilities', 'device-node', 'device-type', 'n-buttons', 'n-dials', 'n-mode-groups', 'n-rings', 'n-strips', 'name', 'product-id', 'seat', 'vendor-id'],
    ClutterInterval: ['final', 'initial', 'value-type'],
    ClutterKeyController: ['im-focus', 'trigger-keybindings'],
    ClutterPageTurnEffect: ['angle', 'period', 'radius'],
    ClutterPanGesture: ['begin-threshold', 'max-n-points', 'min-n-points', 'pan-axis', 'required-button'],
    ...
    ClutterSprite: ['role', 'sequence', 'sprite-device'],
...
export const OWN_SIGNALS = {
    ...
    ClutterKeyController: ['key-press', 'key-release', 'modifier-change'],
    ClutterLayoutManager: ['layout-changed'],
    ClutterMotionController: ['enter', 'leave', 'motion'],
...
export const DECLS = {
    ...
    ClutterColorOp3DLut: ['ClutterColorOp3DLut', 'ClutterColorOp', 'GObject'],
    ClutterColorOpClampUnit: ['ClutterColorOpClampUnit', 'ClutterColorOp', 'GObject'],
    ClutterColorOpCurve1D: ['ClutterColorOpCurve1D', 'ClutterColorOp', 'GObject'],
    ClutterColorOpGammaPower: ['ClutterColorOpGammaPower', 'ClutterColorOp', 'GObject'],
    ClutterColorOpMatrix4x4: ['ClutterColorOpMatrix4x4', 'ClutterColorOp', 'GObject'],
    ClutterColorOpMultiply: ['ClutterColorOpMultiply', 'ClutterColorOp', 'GObject'],
    ClutterColorOpPqEotf: ['ClutterColorOpPqEotf', 'ClutterColorOp', 'GObject'],
    ClutterColorOpPqInvEotf: ['ClutterColorOpPqInvEotf', 'ClutterColorOp', 'GObject'],
    ClutterColorOpPremultiply: ['ClutterColorOpPremultiply', 'ClutterColorOp', 'GObject'],
    ClutterColorOpSrgbPiecewiseEotf: ['ClutterColorOpSrgbPiecewiseEotf', 'ClutterColorOp', 'GObject'],
    ClutterColorOpSrgbPiecewiseInvEotf: ['ClutterColorOpSrgbPiecewiseInvEotf', 'ClutterColorOp', 'GObject'],
    ClutterColorOpUnpremultiply: ['ClutterColorOpUnpremultiply', 'ClutterColorOp', 'GObject'],
    ClutterColorOpYcbcrMatrix: ['ClutterColorOpYcbcrMatrix', 'ClutterColorOp', 'GObject'],
    ClutterColorPipeline: ['ClutterColorPipeline', 'GObject'],
    ...
    ClutterColorTransform: ['ClutterColorTransform', 'GObject'],
    ...
    ClutterKeyController: ['ClutterKeyController', 'ClutterAction', 'ClutterActorMeta', 'GInitiallyUnowned', 'GObject'],
    ...
    ClutterMotionController: ['ClutterMotionController', 'ClutterAction', 'ClutterActorMeta', 'GInitiallyUnowned', 'GObject'],
    ...
    ClutterScrollController: ['ClutterScrollController', 'ClutterAction', 'ClutterActorMeta', 'GInitiallyUnowned', 'GObject'],
...
export const ENUM_NICKS = {
    ...
    ClutterEventPhase: ['capture', 'target', 'bubble'],
    ...
    ClutterInputAction: ['submit', 'last'],
    ...
    ClutterPipelineCapability: ['color-state', 'shader-effect'],
    ...
    ClutterPreeditStyleHint: ['none', 'whole', 'selection', 'prediction', 'prefix', 'suffix', 'spelling-error', 'compose-error'],
    ...
    ClutterSpriteRole: ['pointer', 'tablet', 'touchpoint'],
    ...
    ClutterTransferFunction: ['srgb-piecewise', 'gamma22', 'pq', 'bt1886', 'linear'],
    ClutterYcbcrCoefficients: ['identity-limited', 'bt601-full', 'bt601-limited', 'bt709-full', 'bt709-limited', 'bt2020-full', 'bt2020-limited'],
...
export const ENUM_VALUES = {
    ...
    'ClutterEventPhase.bubble': 2,
    'ClutterEventPhase.capture': 0,
    'ClutterEventPhase.target': 1,
    ...
    'ClutterInputAction.last': 1,
    'ClutterInputAction.submit': 0,
    ...
    'ClutterPipelineCapability.color-state': 0,
    'ClutterPipelineCapability.shader-effect': 1,
    ...
    'ClutterPreeditStyleHint.compose-error': 7,
    'ClutterPreeditStyleHint.none': 0,
    'ClutterPreeditStyleHint.prediction': 3,
    'ClutterPreeditStyleHint.prefix': 4,
    'ClutterPreeditStyleHint.selection': 2,
    'ClutterPreeditStyleHint.spelling-error': 6,
    'ClutterPreeditStyleHint.suffix': 5,
    'ClutterPreeditStyleHint.whole': 1,
    ...
    'ClutterSpriteRole.pointer': 0,
    'ClutterSpriteRole.tablet': 1,
    'ClutterSpriteRole.touchpoint': 2,
    ...
    'ClutterTransferFunction.bt1886': 3,
    'ClutterTransferFunction.gamma22': 1,
    'ClutterTransferFunction.linear': 4,
    'ClutterTransferFunction.pq': 2,
    'ClutterTransferFunction.srgb-piecewise': 0,
    'ClutterYcbcrCoefficients.bt2020-full': 5,
    'ClutterYcbcrCoefficients.bt2020-limited': 6,
    'ClutterYcbcrCoefficients.bt601-full': 1,
    'ClutterYcbcrCoefficients.bt601-limited': 2,
    'ClutterYcbcrCoefficients.bt709-full': 3,
    'ClutterYcbcrCoefficients.bt709-limited': 4,
    'ClutterYcbcrCoefficients.identity-limited': 0,
...
export const FLAG_VALUES = {
    ...
    'ClutterInputActionFlags.all': 1,
    'ClutterInputActionFlags.none': 0,
    'ClutterInputActionFlags.submit': 1,
    ...
    'ClutterScrollControllerFlags.discrete': 4,
    'ClutterScrollControllerFlags.none': 0,
    'ClutterScrollControllerFlags.physical-direction': 8,
    'ClutterScrollControllerFlags.scroll-horizontal': 2,
    'ClutterScrollControllerFlags.scroll-vertical': 1,
...
export const PROP_ENUMS = {
    ...
    'ClutterActor.cursor-type': 'ClutterCursorType',
    ...
    'ClutterScrollController.flags': 'ClutterScrollControllerFlags',
    'ClutterSnapConstraint.from-edge': 'ClutterSnapEdge',
    'ClutterSnapConstraint.to-edge': 'ClutterSnapEdge',
    'ClutterSprite.role': 'ClutterSpriteRole',
...
export const PROP_TYPES = {
    ...
    'ClutterKeyController.im-focus': 'ClutterInputFocus',
    'ClutterKeyController.trigger-keybindings': 'gboolean',
    ...
    'ClutterPanGesture.pan-axis': 'ClutterPanAxis',
    'ClutterPanGesture.required-button': 'guint',
    ...
    'ClutterSnapConstraint.to-edge': 'ClutterSnapEdge',
    'ClutterSprite.role': 'ClutterSpriteRole',
    'ClutterSprite.sprite-device': 'ClutterInputDevice',
    ...
    'ClutterText.input-hints': 'ClutterInputContentHintFlags',
    'ClutterText.input-interceptor': 'ClutterActor',
    'ClutterText.input-purpose': 'ClutterInputContentPurpose',

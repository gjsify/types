...
module Portal {
    ...
    interface LocationUpdated {
        (latitude: number, longitude: number, altitude: number, accuracy: number, speed: number, heading: number, description: string, timestamp_s: number, timestamp_ms: number): void
    }
    ...
    interface UpdateProgress {
        (n_ops: number, op: number, progress: number, status: UpdateStatus, error: string, error_message: string): void
    }
...
static ["new"](): Portal;
    ...
    connect(signal: 'location-updated', callback: ((_source: this, latitude: number, longitude: number, altitude: number, accuracy: number, speed: number, heading: number, description: string, timestamp_s: number, timestamp_ms: number) => void)): number
    connect_after(signal: 'location-updated', callback: ((_source: this, latitude: number, longitude: number, altitude: number, accuracy: number, speed: number, heading: number, description: string, timestamp_s: number, timestamp_ms: number) => void)): number
    emit(signal: 'location-updated', latitude: number, longitude: number, altitude: number, accuracy: number, speed: number, heading: number, description: string, timestamp_s: number, timestamp_ms: number): void
    connect(signal: 'notification-action-invoked', callback: ((_source: this, id: string, action: string, parameter: GLib.Variant | null) => void)): number
    connect_after(signal: 'notification-action-invoked', callback: ((_source: this, id: string, action: string, parameter: GLib.Variant | null) => void)): number
    emit(signal: 'notification-action-invoked', id: string, action: string, parameter?: (GLib.Variant | null)): void
    connect(signal: 'session-state-changed', callback: ((_source: this, screensaver_active: boolean, session_state: LoginSessionState) => void)): number
    connect_after(signal: 'session-state-changed', callback: ((_source: this, screensaver_active: boolean, session_state: LoginSessionState) => void)): number
    ...
    connect_after(signal: 'spawn-exited', callback: ((_source: this, pid: number, exit_status: number) => void)): number
    emit(signal: 'spawn-exited', pid: number, exit_status: number): void
    connect(signal: 'update-available', callback: ((_source: this, running_commit: string, local_commit: string, remote_commit: string) => void)): number
    connect_after(signal: 'update-available', callback: ((_source: this, running_commit: string, local_commit: string, remote_commit: string) => void)): number
    emit(signal: 'update-available', running_commit: string, local_commit: string, remote_commit: string): void
    connect(signal: 'update-progress', callback: ((_source: this, n_ops: number, op: number, progress: number, status: UpdateStatus, error: string, error_message: string) => void)): number
    connect_after(signal: 'update-progress', callback: ((_source: this, n_ops: number, op: number, progress: number, status: UpdateStatus, error: string, error_message: string) => void)): number
    emit(signal: 'update-progress', n_ops: number, op: number, progress: number, status: UpdateStatus, error: string, error_message: string): void

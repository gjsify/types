...
module Portal {
     ...
     */
    interface NotificationActionInvokedSignalCallback {
     ...
     */
    interface SessionStateChangedSignalCallback {
     ...
     */
    interface SpawnExitedSignalCallback {
     ...
     */
    interface UpdateAvailableSignalCallback {
     ...
     */
    interface UpdateProgressSignalCallback {
...
interface Portal extends Gio.Initable {
     ...
     */
    dynamic_launcher_get_desktop_entry(desktop_file_id: string): string | null
    /**
     ...
     */
    dynamic_launcher_request_install_token(name: string, icon_v: GLib.Variant): string | null
    /**

 ...
 */
function date_parse(date: string | null, timet: number): boolean
 ...
 */
function named_dest_from_bytestring(data: Uint8Array): string | null
/**
 ...
 */
function named_dest_to_bytestring(name: string | null): Uint8Array | null
/**
...
module AnnotCircle {
    ...
    interface ConstructorProperties extends AnnotMarkup.ConstructorProperties {
    }
...
module AnnotMarkup {
    ...
    interface ConstructorProperties extends Annot.ConstructorProperties {
    }

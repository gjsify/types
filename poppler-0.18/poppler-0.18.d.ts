...
export namespace Poppler {
    ...
    class Error extends GLib.Error {
        // Own fields of Poppler-0.18.Error
        ...
        // Constructors of Poppler-0.18.Error

        constructor(options: { message: string; code: number });

        // Owm methods of Poppler-0.18.Error
    ...
    class Annot extends GObject.Object {
        // Owm methods of Poppler-0.18.Annot
    ...
    class AnnotCircle extends AnnotMarkup {
        // Constructors of Poppler-0.18.AnnotCircle

        static ['new'](doc: Document, rect: Rectangle): AnnotCircle;

        // Owm methods of Poppler-0.18.AnnotCircle
    ...
    class AnnotFileAttachment extends AnnotMarkup {
        // Owm methods of Poppler-0.18.AnnotFileAttachment
    ...
    class AnnotFreeText extends AnnotMarkup {
        // Owm methods of Poppler-0.18.AnnotFreeText
    ...
    class AnnotLine extends AnnotMarkup {
        // Constructors of Poppler-0.18.AnnotLine

        static ['new'](doc: Document, rect: Rectangle, start: Point, end: Point): AnnotLine;

        // Owm methods of Poppler-0.18.AnnotLine
    ...
    class AnnotMarkup extends Annot {
        // Owm methods of Poppler-0.18.AnnotMarkup
    ...
    class AnnotMovie extends Annot {
        // Owm methods of Poppler-0.18.AnnotMovie
    ...
    class AnnotScreen extends Annot {
        // Owm methods of Poppler-0.18.AnnotScreen
    ...
    class AnnotSquare extends AnnotMarkup {
        // Constructors of Poppler-0.18.AnnotSquare

        static ['new'](doc: Document, rect: Rectangle): AnnotSquare;

        // Owm methods of Poppler-0.18.AnnotSquare
    ...
    class AnnotStamp extends Annot {
        // Constructors of Poppler-0.18.AnnotStamp

        static ['new'](doc: Document, rect: Rectangle): AnnotStamp;

        // Owm methods of Poppler-0.18.AnnotStamp
    ...
    class AnnotText extends AnnotMarkup {
        // Constructors of Poppler-0.18.AnnotText

        static ['new'](doc: Document, rect: Rectangle): AnnotText;

        // Owm methods of Poppler-0.18.AnnotText
    ...
    class AnnotTextMarkup extends AnnotMarkup {
        // Constructors of Poppler-0.18.AnnotTextMarkup
        ...
        // Owm methods of Poppler-0.18.AnnotTextMarkup
    ...
    class Attachment extends GObject.Object {
        // Own fields of Poppler-0.18.Attachment
        ...
        // Owm methods of Poppler-0.18.Attachment
    ...
    class Document extends GObject.Object {
        // Own properties of Poppler-0.18.Document
        ...
        // Constructors of Poppler-0.18.Document
        ...
        // Owm methods of Poppler-0.18.Document
    ...
    class FontInfo extends GObject.Object {
        // Constructors of Poppler-0.18.FontInfo

        static ['new'](document: Document): FontInfo;

        // Owm methods of Poppler-0.18.FontInfo
    ...
    class FormField extends GObject.Object {
        // Owm methods of Poppler-0.18.FormField
    ...
    class Layer extends GObject.Object {
        // Owm methods of Poppler-0.18.Layer
    ...
    class Media extends GObject.Object {
        // Owm methods of Poppler-0.18.Media
    ...
    class Movie extends GObject.Object {
        // Owm methods of Poppler-0.18.Movie
    ...
    class PSFile extends GObject.Object {
        // Constructors of Poppler-0.18.PSFile
        ...
        // Owm methods of Poppler-0.18.PSFile
    ...
    class Page extends GObject.Object {
        // Own properties of Poppler-0.18.Page
        ...
        // Owm methods of Poppler-0.18.Page
         ...
         * @returns %TRUE if the page contains text, %FALSE otherwise
         */
        get_text_layout_for_area(area: Rectangle): boolean;
        /**
    ...
    class StructureElement extends GObject.Object {
        // Owm methods of Poppler-0.18.StructureElement
         ...
         * @returns %TRUE if a color is defined for the element,    %FALSE otherwise.
         */
        get_text_decoration_color(): boolean;
        /**
     ...
     */
    class ActionAny {
        // Own fields of Poppler-0.18.ActionAny
    ...
    class ActionGotoDest {
        // Own fields of Poppler-0.18.ActionGotoDest
    ...
    class ActionGotoRemote {
        // Own fields of Poppler-0.18.ActionGotoRemote
    ...
    class ActionJavascript {
        // Own fields of Poppler-0.18.ActionJavascript
     ...
     */
    class ActionLaunch {
        // Own fields of Poppler-0.18.ActionLaunch
     ...
     */
    class ActionLayer {
        // Own fields of Poppler-0.18.ActionLayer
     ...
     */
    class ActionMovie {
        // Own fields of Poppler-0.18.ActionMovie
     ...
     */
    class ActionNamed {
        // Own fields of Poppler-0.18.ActionNamed
    ...
    class ActionOCGState {
        // Own fields of Poppler-0.18.ActionOCGState
    ...
    class ActionRendition {
        // Own fields of Poppler-0.18.ActionRendition
    ...
    class ActionResetForm {
        // Own fields of Poppler-0.18.ActionResetForm
     ...
     */
    class ActionUri {
        // Own fields of Poppler-0.18.ActionUri
    ...
    class AnnotCalloutLine {
        // Own fields of Poppler-0.18.AnnotCalloutLine
        ...
        // Constructors of Poppler-0.18.AnnotCalloutLine
        ...
        // Owm methods of Poppler-0.18.AnnotCalloutLine
     ...
     */
    class AnnotMapping {
        // Own fields of Poppler-0.18.AnnotMapping

        area: Rectangle;
        annot: Annot;

        // Constructors of Poppler-0.18.AnnotMapping
        ...
        // Owm methods of Poppler-0.18.AnnotMapping
    ...
    class CertificateInfo {
        // Constructors of Poppler-0.18.CertificateInfo

        constructor(properties?: Partial<{}>);

        static ['new'](): CertificateInfo;

        // Owm methods of Poppler-0.18.CertificateInfo
     ...
     */
    class Color {
        // Own fields of Poppler-0.18.Color

        red: number;
        green: number;
        blue: number;

        // Constructors of Poppler-0.18.Color
        ...
        // Owm methods of Poppler-0.18.Color
     ...
     */
    class Dest {
        // Own fields of Poppler-0.18.Dest
        ...
        // Owm methods of Poppler-0.18.Dest
    ...
    class FontsIter {
        // Owm methods of Poppler-0.18.FontsIter
    ...
    class FormFieldMapping {
        // Own fields of Poppler-0.18.FormFieldMapping

        area: Rectangle;
        field: FormField;

        // Constructors of Poppler-0.18.FormFieldMapping
        ...
        // Owm methods of Poppler-0.18.FormFieldMapping
     ...
     */
    class ImageMapping {
        // Own fields of Poppler-0.18.ImageMapping

        area: Rectangle;
        image_id: number;

        // Constructors of Poppler-0.18.ImageMapping
        ...
        // Owm methods of Poppler-0.18.ImageMapping
    ...
    class IndexIter {
        // Constructors of Poppler-0.18.IndexIter

        constructor(document: Document);

        static ['new'](document: Document): IndexIter;

        // Owm methods of Poppler-0.18.IndexIter
    ...
    class LayersIter {
        // Constructors of Poppler-0.18.LayersIter

        constructor(document: Document);

        static ['new'](document: Document): LayersIter;

        // Owm methods of Poppler-0.18.LayersIter
     ...
     */
    class LinkMapping {
        // Own fields of Poppler-0.18.LinkMapping

        area: Rectangle;

        // Constructors of Poppler-0.18.LinkMapping
        ...
        // Owm methods of Poppler-0.18.LinkMapping
     ...
     */
    class PageRange {
        // Own fields of Poppler-0.18.PageRange

        start_page: number;
        end_page: number;

        // Constructors of Poppler-0.18.PageRange
    ...
    class PageTransition {
        // Own fields of Poppler-0.18.PageTransition
        ...
        // Constructors of Poppler-0.18.PageTransition
        ...
        // Owm methods of Poppler-0.18.PageTransition
     ...
     */
    class Point {
        // Own fields of Poppler-0.18.Point

        x: number;
        y: number;

        // Constructors of Poppler-0.18.Point
        ...
        // Owm methods of Poppler-0.18.Point
     ...
     */
    class Quadrilateral {
        // Own fields of Poppler-0.18.Quadrilateral
        ...
        // Constructors of Poppler-0.18.Quadrilateral
        ...
        // Owm methods of Poppler-0.18.Quadrilateral
     ...
     */
    class Rectangle {
        // Own fields of Poppler-0.18.Rectangle
        ...
        // Constructors of Poppler-0.18.Rectangle
        ...
        // Owm methods of Poppler-0.18.Rectangle
     ...
     */
    class SignatureInfo {
        // Owm methods of Poppler-0.18.SignatureInfo
    ...
    class SigningData {
        // Constructors of Poppler-0.18.SigningData

        constructor(properties?: Partial<{}>);

        static ['new'](): SigningData;

        // Owm methods of Poppler-0.18.SigningData
    ...
    class StructureElementIter {
        // Constructors of Poppler-0.18.StructureElementIter

        constructor(poppler_document: Document);

        static ['new'](poppler_document: Document): StructureElementIter;

        // Owm methods of Poppler-0.18.StructureElementIter
    ...
    class TextAttributes {
        // Own fields of Poppler-0.18.TextAttributes
        ...
        // Constructors of Poppler-0.18.TextAttributes
        ...
        // Owm methods of Poppler-0.18.TextAttributes
    ...
    class TextSpan {
        // Owm methods of Poppler-0.18.TextSpan
     ...
     */
    class Action {
        // Own fields of Poppler-0.18.Action

        type: ActionType;

        // Owm methods of Poppler-0.18.Action

...
export const PROP_TYPES = {
    'ECalClient.default-timezone': 'ICalTimezone',
    'ECalClient.source-type': 'ECalClientSourceType',
    'ECalClientView.client': 'ECalClient',
    'ECalClientView.connection': 'GDBusConnection',
    'ECalClientView.object-path': 'gchararray',
    'ECalComponentBag.timezone': 'ICalTimezone',
    'EClient.online': 'gboolean',
    'EClient.source': 'ESource',
    'EReminderWatcher.default-zone': 'ICalTimezone',
    'EReminderWatcher.registry': 'ESourceRegistry',
    'EReminderWatcher.timers-enabled': 'gboolean',
};

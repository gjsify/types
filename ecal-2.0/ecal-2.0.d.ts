...
export namespace ECal {
     ...
     */
    function util_clamp_vtimezone(vtimezone: ICalGLib.Component, from: ICalGLib.Time, to?: ICalGLib.Time | null): void;
    /**
     ...
     */
    function util_clamp_vtimezone_by_component(vtimezone: ICalGLib.Component, component: ICalGLib.Component): void;
    /**
     ...
     */
    function util_diff_categories(old_comp: ICalGLib.Component | null, new_comp: ICalGLib.Component | null): void;
    /**
     ...
     */
    function util_get_default_name_and_address(registry: EDataServer.SourceRegistry): boolean;
    /**
    ...
    class Client extends EDataServer.Client {
        // Own properties of ECal-2.0.Client
        ...
        // Owm methods of ECal-2.0.Client
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        create_object_finish(result: Gio.AsyncResult): boolean;
        /**
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        create_objects_finish(result: Gio.AsyncResult): boolean;
        /**
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_attachment_uris_finish(result: Gio.AsyncResult): boolean;
        /**
         * Queries a calendar for a specified component's object attachment URIs.
         * The list should be freed with e_client_util_free_string_slist().
         * @param uid Unique identifier for a calendar component
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_attachment_uris_sync(uid: string, rid: string | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_default_object_finish(result: Gio.AsyncResult): boolean;
        /**
         * Retrives an #ICalComponent from the backend that contains the default
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_default_object_sync(cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_object_finish(result: Gio.AsyncResult): boolean;
        /**
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_object_list_as_comps_finish(result: Gio.AsyncResult): boolean;
        /**
         * Gets a list of objects from the calendar that match the query specified
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_object_list_as_comps_sync(sexp: string, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_object_list_finish(result: Gio.AsyncResult): boolean;
        /**
         * Gets a list of objects from the calendar that match the query specified
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_object_list_sync(sexp: string, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_object_sync(uid: string, rid: string | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_objects_for_uid_finish(result: Gio.AsyncResult): boolean;
        /**
         * Queries a calendar for all calendar components with the given unique
         * ID. This will return any recurring event and all its detached recurrences.
         * For non-recurring events, it will just return the object with that ID.
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_objects_for_uid_sync(uid: string, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_timezone_finish(result: Gio.AsyncResult): boolean;
        /**
         * Retrieves a timezone object from the calendar backend.
         * This object is owned by the `client,` thus do not free it.
         * @param tzid ID of the timezone to retrieve
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_timezone_sync(tzid: string, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_view_finish(result: Gio.AsyncResult): boolean;
        /**
         * Query `client` with `sexp,` creating an #ECalClientView.
         * If successful, then the `out_view` is set to newly allocated #ECalClientView,
         * which should be freed with g_object_unref().
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_view_sync(sexp: string, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        send_objects_finish(result: Gio.AsyncResult): boolean;
        /**
         * Requests a calendar backend to send meeting information stored in `icalcomp`.
    ...
    class ClientView extends GObject.Object {
        // Own properties of ECal-2.0.ClientView
        ...
        // Owm methods of ECal-2.0.ClientView
    ...
    class Component extends GObject.Object {
        // Constructors of ECal-2.0.Component
        ...
        // Owm methods of ECal-2.0.Component
    ...
    class ReminderWatcher extends GObject.Object {
        // Own properties of ECal-2.0.ReminderWatcher
        ...
        // Constructors of ECal-2.0.ReminderWatcher

        static ['new'](registry: EDataServer.SourceRegistry): ReminderWatcher;

        // Owm methods of ECal-2.0.ReminderWatcher
    ...
    class ClientTzlookupICalCompData {
        // Constructors of ECal-2.0.ClientTzlookupICalCompData

        constructor(icomp: ICalGLib.Component);

        static ['new'](icomp: ICalGLib.Component): ClientTzlookupICalCompData;

        // Owm methods of ECal-2.0.ClientTzlookupICalCompData
    ...
    class ComponentAlarm {
        // Constructors of ECal-2.0.ComponentAlarm
        ...
        // Owm methods of ECal-2.0.ComponentAlarm
    ...
    class ComponentAlarmInstance {
        // Constructors of ECal-2.0.ComponentAlarmInstance
        ...
        // Owm methods of ECal-2.0.ComponentAlarmInstance
    ...
    class ComponentAlarmRepeat {
        // Constructors of ECal-2.0.ComponentAlarmRepeat
        ...
        // Owm methods of ECal-2.0.ComponentAlarmRepeat
    ...
    class ComponentAlarmTrigger {
        // Constructors of ECal-2.0.ComponentAlarmTrigger
        ...
        // Owm methods of ECal-2.0.ComponentAlarmTrigger
    ...
    class ComponentAlarms {
        // Constructors of ECal-2.0.ComponentAlarms

        constructor(comp?: Component | null);

        static ['new'](comp?: Component | null): ComponentAlarms;

        // Owm methods of ECal-2.0.ComponentAlarms
    ...
    class ComponentAttendee {
        // Constructors of ECal-2.0.ComponentAttendee
        ...
        // Owm methods of ECal-2.0.ComponentAttendee
    ...
    class ComponentDateTime {
        // Constructors of ECal-2.0.ComponentDateTime
        ...
        // Owm methods of ECal-2.0.ComponentDateTime
     ...
     */
    class ComponentId {
        // Constructors of ECal-2.0.ComponentId
        ...
        // Owm methods of ECal-2.0.ComponentId
    ...
    class ComponentOrganizer {
        // Constructors of ECal-2.0.ComponentOrganizer
        ...
        // Owm methods of ECal-2.0.ComponentOrganizer
    ...
    class ComponentParameterBag {
        // Constructors of ECal-2.0.ComponentParameterBag
        ...
        // Owm methods of ECal-2.0.ComponentParameterBag
    ...
    class ComponentPeriod {
        // Constructors of ECal-2.0.ComponentPeriod
        ...
        // Owm methods of ECal-2.0.ComponentPeriod
    ...
    class ComponentPropertyBag {
        // Constructors of ECal-2.0.ComponentPropertyBag
        ...
        // Owm methods of ECal-2.0.ComponentPropertyBag
    ...
    class ComponentRange {
        // Constructors of ECal-2.0.ComponentRange
        ...
        // Owm methods of ECal-2.0.ComponentRange
     ...
     */
    class ComponentText {
        // Constructors of ECal-2.0.ComponentText
        ...
        // Owm methods of ECal-2.0.ComponentText
     ...
     */
    class ReminderData {
        // Constructors of ECal-2.0.ReminderData
        ...
        // Owm methods of ECal-2.0.ReminderData
    ...
    class ReminderWatcherClass {
        // Own fields of ECal-2.0.ReminderWatcherClass
    ...
    class TimezoneCacheInterface {
        // Own fields of ECal-2.0.TimezoneCacheInterface

        reserved_signals: any[];
    }

    interface TimezoneCache {
        // Owm methods of ECal-2.0.TimezoneCache
        ...
        // Own virtual methods of ECal-2.0.TimezoneCache

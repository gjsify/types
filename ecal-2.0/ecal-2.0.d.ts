 ...
 */
function util_generate_alarms_for_list(comps: Component[], start: number, end: number, omit: ComponentAlarmAction, resolve_tzid: RecurResolveTimezoneCb, default_timezone: ICalGLib.Timezone): [number, ComponentAlarms[]]
/**
 ...
 * @returns a list of all the alarms found    for the given component in the given time range.
 */
function util_generate_alarms_for_uid_sync(client: (any | null), uid: string, start: number, end: number, omit: ComponentAlarmAction, resolve_tzid: RecurResolveTimezoneCb, default_timezone: ICalGLib.Timezone, cancellable?: (Gio.Cancellable | null)): (ComponentAlarms | null)
/**
...
_init(...args: any[]): void;
    ...
    connect_after(signal: 'free-busy-data', callback: ((_source: this, free_busy_ecalcomps: Component[]) => void)): number
     ...
     * @param cb Callback for each generated instance
     */
    generate_instances_for_uid_sync(uid: string, start: number, end: number, cancellable: (Gio.Cancellable | null), cb: RecurInstanceCb): void
    /**
     * Does a combination of e_cal_client_get_object_list() and
     ...
     * @returns %TRUE if successful, %FALSE otherwise.
     */
    get_free_busy_sync(start: number, end: number, users: string[], cancellable?: (Gio.Cancellable | null)): [boolean, Component[]]
    /**
...
static ["new"](registry: EDataServer.SourceRegistry): ReminderWatcher;
    ...
    connect(signal: 'format-time', callback: ((_source: this, rd: ReminderData, itt: ICalGLib.Time, inout_buffer: any, buffer_size: number) => void)): number
    connect_after(signal: 'format-time', callback: ((_source: this, rd: ReminderData, itt: ICalGLib.Time, inout_buffer: any, buffer_size: number) => void)): number
    emit(signal: 'format-time', rd: ReminderData, itt: ICalGLib.Time, inout_buffer: any, buffer_size: number): void
    connect(signal: 'triggered', callback: ((_source: this, reminders: ReminderData[], snoozed: boolean) => void)): number
    connect_after(signal: 'triggered', callback: ((_source: this, reminders: ReminderData[], snoozed: boolean) => void)): number

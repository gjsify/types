 ...
 */
function bufferAddRtpSourceMeta(buffer: Gst.Buffer, ssrc: number | null, csrc: number[] | null): RTPSourceMeta
/**
 * Find the #GstRTPSourceMeta on `buffer`.
 * @param buffer a #GstBuffer
 * @returns the #GstRTPSourceMeta or %NULL when there is no such metadata on @buffer.
 */
function bufferGetRtpSourceMeta(buffer: Gst.Buffer): RTPSourceMeta | null
/**
 ...
 */
function rtcpBufferNewCopyData(data: number[]): Gst.Buffer
/**
 ...
 */
function rtcpBufferNewTakeData(data: number[]): Gst.Buffer
/**
 ...
 */
function rtcpBufferValidateData(data: number[]): boolean
/**
 ...
 * @returns TRUE if the data points to a valid RTCP packet.
 */
function rtcpBufferValidateDataReduced(data: number[]): boolean
/**
 * Check if the data pointed to by `buffer` is a valid RTCP packet using
 ...
 */
function rtpBufferGetExtensionOnebyteHeaderFromBytes(bytes: any, bitPattern: number, id: number, nth: number): [ /* returnType */ boolean, /* data */ number[] ]
/**
 ...
 * @returns A newly allocated buffer with a copy of @data and of size @len.
 */
function rtpBufferNewCopyData(data: number[]): Gst.Buffer
/**
 * Create a new buffer and set the data and size of the buffer to `data` and `len`
 * respectively. `data` will be freed when the buffer is unreffed, so this
 * function transfers ownership of `data` to the new buffer.
 ...
 */
function rtpHdrextGetNtp56(data: number[]): [ /* returnType */ boolean, /* ntptime */ number ]
/**
 ...
 * @returns %TRUE on success.
 */
function rtpHdrextGetNtp64(data: number[]): [ /* returnType */ boolean, /* ntptime */ number ]
/**
 ...
 * @returns %TRUE on success.
 */
function rtpHdrextSetNtp56(data: any | null, size: number, ntptime: number): boolean
/**
 ...
 * @returns %TRUE on success.
 */
function rtpHdrextSetNtp64(data: any | null, size: number, ntptime: number): boolean
/**
 ...
 */
function rtpPayloadInfoForName(media: string, encodingName: string): RTPPayloadInfo | null
/**
 ...
 * @returns a #GstRTPPayloadInfo or NULL when no info could be found.
 */
function rtpPayloadInfoForPt(payloadType: number): RTPPayloadInfo | null
function rtpSourceMetaApiGetType(): GObject.GType
...
interface RTPBaseAudioPayload {
     ...
     * @returns a #GstFlowReturn
     */
    push(data: number[], timestamp: Gst.ClockTime): Gst.FlowReturn
...
interface RTPHeaderExtension {
    ...
    getUri(): string | null
    // Has conflict: read(readFlags: RTPHeaderExtensionFlags, data: number[], buffer: Gst.Buffer): boolean
    /**
    ...
    // Has conflict: write(inputMeta: Gst.Buffer, writeFlags: RTPHeaderExtensionFlags, output: Gst.Buffer, data: number[]): number
     ...
     */
    read(readFlags: RTPHeaderExtensionFlags, data: number[], buffer: Gst.Buffer): boolean
    setAttributes(direction: RTPHeaderExtensionDirection, attributes: string): boolean
    /**
     * gst_rtp_header_extension_set_id() must have been called with a valid
     * extension id that is contained in these caps.
     * 
     ...
     */
    write(inputMeta: Gst.Buffer, writeFlags: RTPHeaderExtensionFlags, output: Gst.Buffer, data: number[]): number
...
class RTPHeaderExtension extends Gst.Element {
     ...
     */
    static setUri(klass: RTPHeaderExtension | Function | GObject.GType, uri: string): void
}
...
class RTCPBuffer {
     ...
     * @returns A newly allocated buffer with a copy of @data and of size @len.
     */
    static newCopyData(data: number[]): Gst.Buffer
    /**
     * Create a new buffer and set the data and size of the buffer to `data` and `len`
     * respectively. `data` will be freed when the buffer is unreffed, so this
     * function transfers ownership of `data` to the new buffer.
     ...
     * @returns TRUE if the data points to a valid RTCP packet.
     */
    static validateDataReduced(data: number[]): boolean
    /**
     * Check if the data pointed to by `buffer` is a valid RTCP packet using
     * gst_rtcp_buffer_validate_reduced().
     * @param buffer the buffer to validate
...
interface RTCPPacket {
     ...
     */
    addProfileSpecificExt(data: number[]): boolean
    /**
     ...
     */
    copyProfileSpecificExt(): [ /* returnType */ boolean, /* data */ number[] ]
    /**
     ...
     */
    getPadding(): boolean
    getProfileSpecificExt(): [ /* returnType */ boolean, /* data */ number[] ]
     ...
     */
    sdesAddEntry(type: RTCPSDESType, data: number[]): boolean
    /**
     ...
     * @returns %TRUE if there was valid data.
     */
    sdesCopyEntry(type: RTCPSDESType): [ /* returnType */ boolean, /* data */ number[] ]
    /**
     ...
     * @returns %TRUE if there was valid data.
     */
    sdesGetEntry(type: RTCPSDESType): [ /* returnType */ boolean, /* data */ number[] ]
    /**
...
interface RTPBuffer {
     ...
     */
    addExtensionOnebyteHeader(id: number, data: number[]): boolean
    /**
     ...
     * @returns %TRUE if header extension could be added
     */
    addExtensionTwobytesHeader(appbits: number, id: number, data: number[]): boolean
    /**
     ...
     */
    getExtensionOnebyteHeader(id: number, nth: number): [ /* returnType */ boolean, /* data */ number[] ]
    /**
     ...
     * @returns TRUE if @buffer had the requested header extension
     */
    getExtensionTwobytesHeader(id: number, nth: number): [ /* returnType */ boolean, /* appbits */ number, /* data */ number[] ]
    /**
...
class RTPBuffer {
     ...
     * @returns TRUE if @bytes had the requested header extension
     */
    static getExtensionOnebyteHeaderFromBytes(bytes: any, bitPattern: number, id: number, nth: number): [ /* returnType */ boolean, /* data */ number[] ]
    /**
     * Map the contents of `buffer` into `rtp`.
     * @param buffer a #GstBuffer
     * @param flags #GstMapFlags
...
interface RTPHeaderExtensionClass {
    ...
    write: (ext: RTPHeaderExtension, inputMeta: Gst.Buffer, writeFlags: RTPHeaderExtensionFlags, output: Gst.Buffer, data: number[]) => number
    read: (ext: RTPHeaderExtension, readFlags: RTPHeaderExtensionFlags, data: number[], buffer: Gst.Buffer) => boolean
...
class RTPPayloadInfo {
     ...
     * @returns a #GstRTPPayloadInfo or NULL when no info could be found.
     */
    static forName(media: string, encodingName: string): RTPPayloadInfo | null
    /**
     * Get the #GstRTPPayloadInfo for `payload_type`. This function is
     * mostly used to get the default clock-rate and bandwidth for static payload
     * types specified with `payload_type`.

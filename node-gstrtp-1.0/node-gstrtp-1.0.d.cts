 ...
 */
export function rtcpBufferNewCopyData(data: number[]): Gst.Buffer
/**
 ...
 */
export function rtcpBufferNewTakeData(data: number[]): Gst.Buffer
/**
 ...
 */
export function rtcpBufferValidateData(data: number[]): boolean
/**
 ...
 * @returns TRUE if the data points to a valid RTCP packet.
 */
export function rtcpBufferValidateDataReduced(data: number[]): boolean
/**
 * Check if the data pointed to by `buffer` is a valid RTCP packet using
 ...
 */
export function rtpBufferGetExtensionOnebyteHeaderFromBytes(bytes: any, bitPattern: number, id: number, nth: number): [ /* returnType */ boolean, /* data */ number[] ]
/**
 ...
 * @returns A newly allocated buffer with a copy of @data and of size @len.
 */
export function rtpBufferNewCopyData(data: number[]): Gst.Buffer
/**
 * Create a new buffer and set the data and size of the buffer to `data` and `len`
 * respectively. `data` will be freed when the buffer is unreffed, so this
 * function transfers ownership of `data` to the new buffer.
 ...
 * @returns A newly allocated buffer with @data and of size @len.
 */
export function rtpBufferNewTakeData(data: number[]): Gst.Buffer
/**
 ...
 */
export function rtpHdrextGetNtp56(data: number[]): [ /* returnType */ boolean, /* ntptime */ number ]
/**
 ...
 * @returns %TRUE on success.
 */
export function rtpHdrextGetNtp64(data: number[]): [ /* returnType */ boolean, /* ntptime */ number ]
/**
 ...
 */
export function rtpPayloadInfoForName(media: string, encodingName: string): RTPPayloadInfo | null
/**

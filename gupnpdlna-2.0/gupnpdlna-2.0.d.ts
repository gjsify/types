...
_init(...args: any[]): void;
    ...
    connect_after(signal: 'done', callback: ((_source: this, info: Information, error: GLib.Error | null) => void)): number
...
static ["new"](relaxed_mode: boolean, extended_mode: boolean): ProfileGuesser;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'done', callback: ((_source: this, info: Information, dlna: Profile | null, error: GLib.Error | null) => void)): number
    connect_after(signal: 'done', callback: ((_source: this, info: Information, dlna: Profile | null, error: GLib.Error | null) => void)): number

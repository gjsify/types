 ...
 */
function uriDecode(part: string): string | null
/**
 ...
 */
function uriEncode(part: string, escapeExtra: string | null): string | null
/**
 ...
 */
function uriNormalize(part: string, unescapeExtra: string | null): string | null
/**
 ...
 * @returns the text of the methodCall, or %NULL on error.
 */
function xmlrpcBuildRequest(methodName: string, params: GLib.Variant): string | null
/**
 * This creates a (successful) XML-RPC methodResponse and returns it
 ...
 * @returns success or failure.
 */
function xmlrpcParseMethodCall(methodCall: string, length: number): [ /* returnType */ boolean, /* methodName */ string | null, /* params */ GObject.ValueArray ]
/**
 ...
 */
function xmlrpcParseRequest(methodCall: string, length: number): [ /* returnType */ string | null, /* params */ XMLRPCParams ]
/**
...
interface AuthDomain {
    ...
    // Has conflict: checkPassword(msg: Message, username: string, password: string): boolean
    /**
    ...
    accepts(msg: Message, header: string): string | null
    /**
...
interface Socket extends Gio.Initable {
     ...
     */
    readUntil(buffer: number[], boundary: any | null, boundaryLen: number, cancellable: Gio.Cancellable | null): [ /* returnType */ SocketIOStatus, /* nread */ number, /* gotBoundary */ boolean ]
    /**
...
class Buffer {
     ...
     * @returns the new #SoupBuffer.
     */
    static newWithOwner(data: number[], owner: any | null, ownerDnotify: GLib.DestroyNotify | null): Buffer
}
...
class URI {
     ...
     * @returns the normalized URI part
     */
    static normalize(part: string, unescapeExtra: string | null): string | null
}

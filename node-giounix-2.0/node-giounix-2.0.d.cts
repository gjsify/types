 ...
 */
export function desktopAppInfoLookupGetDefaultForUriScheme(lookup: any, uriScheme: string): any | null
/**
 * Gets the underlying file descriptor.
 * @param fdBased a #GFileDescriptorBased.
 * @returns The file descriptor
 */
export function fileDescriptorBasedGetFd(fdBased: any): number
/**
 ...
 */
export function mountAt(mountPath: string): [ /* returnType */ any | null, /* timeRead */ number ]
/**
 ...
 */
export function mountCompare(mount1: any, mount2: any): number
/**
 * Makes a copy of `mount_entry`.
 * @param mountEntry a #GUnixMountEntry.
 * @returns a new #GUnixMountEntry
 */
export function mountCopy(mountEntry: any): any
/**
 ...
 * @returns a #GUnixMountEntry.
 */
export function mountFor(filePath: string): [ /* returnType */ any | null, /* timeRead */ number ]
/**
 * Frees a unix mount.
 * @param mountEntry a #GUnixMountEntry.
 */
export function mountFree(mountEntry: any): void
/**
 * Gets the device path for a unix mount.
 * @param mountEntry a #GUnixMount.
 * @returns a string containing the device path.
 */
export function mountGetDevicePath(mountEntry: any): string
/**
 * Gets the filesystem type for the unix mount.
 * @param mountEntry a #GUnixMount.
 * @returns a string containing the file system type.
 */
export function mountGetFsType(mountEntry: any): string
/**
 * Gets the mount path for a unix mount.
 * @param mountEntry input #GUnixMountEntry to get the mount path for.
 * @returns the mount path for @mount_entry.
 */
export function mountGetMountPath(mountEntry: any): string
/**
 ...
 */
export function mountGetOptions(mountEntry: any): string | null
/**
 ...
 */
export function mountGetRootPath(mountEntry: any): string | null
/**
 * Guesses whether a Unix mount can be ejected.
 * @param mountEntry a #GUnixMountEntry
 * @returns %TRUE if @mount_entry is deemed to be ejectable.
 */
export function mountGuessCanEject(mountEntry: any): boolean
/**
 * Guesses the icon of a Unix mount.
 * @param mountEntry a #GUnixMountEntry
 * @returns a #GIcon
 */
export function mountGuessIcon(mountEntry: any): any
/**
 ...
 */
export function mountGuessName(mountEntry: any): string | null
/**
 * Guesses whether a Unix mount should be displayed in the UI.
 * @param mountEntry a #GUnixMountEntry
 * @returns %TRUE if @mount_entry is deemed to be displayable.
 */
export function mountGuessShouldDisplay(mountEntry: any): boolean
/**
 * Guesses the symbolic icon of a Unix mount.
 * @param mountEntry a #GUnixMountEntry
 * @returns a #GIcon
 */
export function mountGuessSymbolicIcon(mountEntry: any): any
/**
 * Checks if a unix mount is mounted read only.
 * @param mountEntry a #GUnixMount.
 * @returns %TRUE if @mount_entry is read only.
 */
export function mountIsReadonly(mountEntry: any): boolean
/**
 ...
 */
export function mountIsSystemInternal(mountEntry: any): boolean
/**
 ...
 */
export function mountPointAt(mountPath: string): [ /* returnType */ any | null, /* timeRead */ number ]
/**
 ...
 * @returns 1, 0 or -1 if @mount1 is greater than, equal to, or less than @mount2, respectively.
 */
export function mountPointCompare(mount1: any, mount2: any): number
/**
 * Makes a copy of `mount_point`.
 * @param mountPoint a #GUnixMountPoint.
 * @returns a new #GUnixMountPoint
 */
export function mountPointCopy(mountPoint: any): any
/**
 * Frees a unix mount point.
 * @param mountPoint unix mount point to free.
 */
export function mountPointFree(mountPoint: any): void
/**
 * Gets the device path for a unix mount point.
 * @param mountPoint a #GUnixMountPoint.
 * @returns a string containing the device path.
 */
export function mountPointGetDevicePath(mountPoint: any): string
/**
 * Gets the file system type for the mount point.
 * @param mountPoint a #GUnixMountPoint.
 * @returns a string containing the file system type.
 */
export function mountPointGetFsType(mountPoint: any): string
/**
 * Gets the mount path for a unix mount point.
 * @param mountPoint a #GUnixMountPoint.
 * @returns a string containing the mount path.
 */
export function mountPointGetMountPath(mountPoint: any): string
/**
 * Gets the options for the mount point.
 * @param mountPoint a #GUnixMountPoint.
 * @returns a string containing the options.
 */
export function mountPointGetOptions(mountPoint: any): string | null
/**
 * Guesses whether a Unix mount point can be ejected.
 * @param mountPoint a #GUnixMountPoint
 * @returns %TRUE if @mount_point is deemed to be ejectable.
 */
export function mountPointGuessCanEject(mountPoint: any): boolean
/**
 * Guesses the icon of a Unix mount point.
 * @param mountPoint a #GUnixMountPoint
 * @returns a #GIcon
 */
export function mountPointGuessIcon(mountPoint: any): any
/**
 ...
 * @returns A newly allocated string that must     be freed with g_free()
 */
export function mountPointGuessName(mountPoint: any): string | null
/**
 * Guesses the symbolic icon of a Unix mount point.
 * @param mountPoint a #GUnixMountPoint
 * @returns a #GIcon
 */
export function mountPointGuessSymbolicIcon(mountPoint: any): any
/**
 * Checks if a unix mount point is a loopback device.
 * @param mountPoint a #GUnixMountPoint.
 * @returns %TRUE if the mount point is a loopback. %FALSE otherwise.
 */
export function mountPointIsLoopback(mountPoint: any): boolean
/**
 * Checks if a unix mount point is read only.
 * @param mountPoint a #GUnixMountPoint.
 * @returns %TRUE if a mount point is read only.
 */
export function mountPointIsReadonly(mountPoint: any): boolean
/**
 * Checks if a unix mount point is mountable by the user.
 * @param mountPoint a #GUnixMountPoint.
 * @returns %TRUE if the mount point is user mountable.
 */
export function mountPointIsUserMountable(mountPoint: any): boolean
/**
 ...
 */
export function mountPointsGet(): [ /* returnType */ any[], /* timeRead */ number ]
/**
 ...
 */
export function mountsGet(): [ /* returnType */ any[], /* timeRead */ number ]
/**

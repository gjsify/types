/**
 * The GIR-derived widget VOCABULARY for St-9.
 *
 * GENERATED — do not edit. Provenance: St-9 — dropped empty base(s): Atk.ImplementorIface
 *
 * 25 instantiable GTypes (of which 0 concrete widgets), 26 declarations, 11 enum nick unions, 0 slot candidates.
 *
...
export type StAlignNick = 'start' | 'middle' | 'end';
...
export interface StScrollViewProps extends StBinProps, ClutterAnimatableProps, ClutterContainerProps, ClutterScriptableProps {
    'content-padding'?: Clutter.Margin;

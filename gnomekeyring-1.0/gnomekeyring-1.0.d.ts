...
export namespace GnomeKeyring {
     ...
     * @returns %GNOME_KEYRING_RESULT_OK if the operation was succcessful or an error result otherwise.
     */
    function find_items_sync(type: ItemType, attributes: AttributeList): Result;
    /**
     ...
     * @returns %GNOME_KEYRING_RESULT_OK if the operation was succcessful or an error result otherwise.
     */
    function get_default_keyring_sync(): Result;
    /**
     ...
     * @returns %GNOME_KEYRING_RESULT_OK if the operation was succcessful or an error result otherwise.
     */
    function get_info_sync(keyring: string | null): Result;
    /**
    ...
    function item_get_acl_sync(keyring: string | null, id: number): Result;
    /**
     ...
     * @returns %GNOME_KEYRING_RESULT_OK if the operation was succcessful or an error result otherwise.
     */
    function item_get_info_full_sync(keyring: string | null, id: number, flags: number): Result;
    /**
     ...
     * @returns %GNOME_KEYRING_RESULT_OK if the operation was succcessful or an error result otherwise.
     */
    function item_get_info_sync(keyring: string | null, id: number): Result;
    /**
     ...
     * @returns %GNOME_KEYRING_RESULT_OK if the operation was succcessful or an error result otherwise.
     */
    function list_item_ids_sync(keyring: string | null): Result;
    /**
     ...
     * @returns %GNOME_KEYRING_RESULT_OK if the operation was succcessful or an error result otherwise.
     */
    function list_keyring_names_sync(): Result;
    /**
     ...
     */
    class AccessControl {
        // Constructors of GnomeKeyring-1.0.AccessControl
        ...
        // Owm methods of GnomeKeyring-1.0.AccessControl
    ...
    class ApplicationRef {
        // Constructors of GnomeKeyring-1.0.ApplicationRef

        constructor(properties?: Partial<{}>);

        static ['new'](): ApplicationRef;

        // Owm methods of GnomeKeyring-1.0.ApplicationRef
     ...
     */
    class Attribute {
        // Own fields of GnomeKeyring-1.0.Attribute

        name: string;
        type: AttributeType;

        // Owm methods of GnomeKeyring-1.0.Attribute
     ...
     */
    class Found {
        // Own fields of GnomeKeyring-1.0.Found
        ...
        // Constructors of GnomeKeyring-1.0.Found
        ...
        // Owm methods of GnomeKeyring-1.0.Found
    ...
    class Info {
        // Owm methods of GnomeKeyring-1.0.Info
    ...
    class ItemInfo {
        // Constructors of GnomeKeyring-1.0.ItemInfo

        constructor(properties?: Partial<{}>);

        static ['new'](): ItemInfo;

        // Owm methods of GnomeKeyring-1.0.ItemInfo
    ...
    class NetworkPasswordData {
        // Own fields of GnomeKeyring-1.0.NetworkPasswordData
        ...
        // Constructors of GnomeKeyring-1.0.NetworkPasswordData
    ...
    class PasswordSchema {
        // Own fields of GnomeKeyring-1.0.PasswordSchema
    ...
    class PasswordSchemaAttribute {
        // Own fields of GnomeKeyring-1.0.PasswordSchemaAttribute

/**
 * The GIR-derived widget VOCABULARY for TrackerMiner-2.0.
 *
 * GENERATED — do not edit. Provenance: TrackerMiner-2.0
 *
...
import type TrackerMiner from './trackerminer-2.0.js';
...
export interface TrackerIndexingTreeProps extends GObjectProps {
    /** @default FALSE */
    'filter-hidden'?: boolean;
    root?: Gio.File;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type TrackerIndexingTreeConstructOnly = GObjectConstructOnly | 'root';

export interface TrackerMinerProxyProps extends GObjectProps, GInitableProps {
    'dbus-connection'?: Gio.DBusConnection;
    /** @default NULL */
    'dbus-path'?: string;
    miner?: TrackerMiner.Miner;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type TrackerMinerProxyConstructOnly = GObjectConstructOnly | GInitableConstructOnly | 'dbus-connection' | 'dbus-path' | 'miner';

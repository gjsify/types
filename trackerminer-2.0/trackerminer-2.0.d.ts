...
_init(...args: any[]): void;
    ...
    connect(signal: 'move-file', callback: ((_source: this, object: Gio.File, p0: Gio.File, p1: boolean) => string)): number
    connect_after(signal: 'move-file', callback: ((_source: this, object: Gio.File, p0: Gio.File, p1: boolean) => string)): number
    ...
    connect_after(signal: 'process-file', callback: ((_source: this, file: Gio.File, builder: Gio.Task) => boolean)): number
    emit(signal: 'process-file', file: Gio.File, builder: Gio.Task): void
    connect(signal: 'process-file-attributes', callback: ((_source: this, file: Gio.File, builder: Gio.Task) => boolean)): number
    connect_after(signal: 'process-file-attributes', callback: ((_source: this, file: Gio.File, builder: Gio.Task) => boolean)): number

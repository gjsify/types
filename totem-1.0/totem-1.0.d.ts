...
_init(...args: any[]): void;
    ...
    connect(signal: 'metadata-updated', callback: ((_source: this, artist: string, title: string, album: string, track_number: number) => void)): number
    connect_after(signal: 'metadata-updated', callback: ((_source: this, artist: string, title: string, album: string, track_number: number) => void)): number
    ...
    // Own virtual methods of Totem.Object

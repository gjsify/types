 ...
 */
function remove_async<Z = unknown>(artist: string, album: string | null, io_priority: number, source_object: GObject.Object | null, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback<Z> | null): void
 ...
 */
function remove_async<Z = unknown>(artist: string, album: string | null, io_priority: number, source_object: GObject.Object | null, cancellable: Gio.Cancellable | null): globalThis.Promise<boolean>
/**

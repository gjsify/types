...
import './mediaart-2.0-ambient.d.ts';
import './mediaart-2.0-import.d.ts';
/**
 * MediaArt-2.0
 */
 ...
 */
function buffer_to_jpeg(buffer: Uint8Array, buffer_mime: string | null, target: string | null): boolean
/**
 ...
 * @returns %TRUE if conversion was successful, otherwise %FALSE is returned if @error is set.
 */
function file_to_jpeg(filename: string | null, target: string | null): boolean
/**
 ...
 */
function remove(artist: string | null, album: string | null, cancellable: Gio.Cancellable | null): boolean
/**
 ...
 */
function remove_async<Z = unknown>(artist: string | null, album: string | null, io_priority: number, source_object: GObject.Object | null, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback<Z> | null): void
 ...
 */
function remove_async<Z = unknown>(artist: string | null, album: string | null, io_priority: number, source_object: GObject.Object | null, cancellable: Gio.Cancellable | null): globalThis.Promise<boolean>
/**
 ...
 */
function strip_invalid_entities(original: string | null): string | null
module Process {

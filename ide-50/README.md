...
GJS TypeScript type definitions for Ide-50, generated from library version 50.0.0 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v4.7.0.
...
Referencing `@girs/ide-50/ambient` instead pulls in these declarations
...
import { OWN_PROPS, ENUM_NICKS, PROVENANCE } from '@girs/ide-50/vocabulary';
```

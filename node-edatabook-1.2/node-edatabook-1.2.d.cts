 ...
 */
export function ebsqlGetContactExtraUnlocked(ebsql: BookSqlite, uid: string | null): [ /* returnType */ boolean, /* retExtra */ string | null ]
/**
 ...
 * @returns %TRUE on success, otherwise %FALSE is returned and @error is set appropriately.
 */
export function ebsqlGetContactUnlocked(ebsql: BookSqlite, uid: string | null, metaContact: boolean): [ /* returnType */ boolean, /* contact */ EBookContacts.Contact ]
/**
 ...
 * @returns %TRUE on success, otherwise %FALSE is returned and @error is set appropriately.
 */
export function ebsqlGetVcardUnlocked(ebsql: BookSqlite, uid: string | null, metaContact: boolean): [ /* returnType */ boolean, /* retVcard */ string | null ]
/**

 ...
 */
function ebsqlGetContactExtraUnlocked(ebsql: BookSqlite, uid: string): [ /* returnType */ boolean, /* retExtra */ string | null ]
/**
 ...
 * @returns %TRUE on success, otherwise %FALSE is returned and @error is set appropriately.
 */
function ebsqlGetVcardUnlocked(ebsql: BookSqlite, uid: string, metaContact: boolean): [ /* returnType */ boolean, /* retVcard */ string | null ]
/**

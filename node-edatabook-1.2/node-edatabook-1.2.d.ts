...
class BookBackendSExp extends GObject.Object {
     ...
     */
    static utilPhoneCompare(phoneValue: string | null, lookupValue: string | null, compareKind: BookBackendSexpCompareKind): boolean
}
...
interface BookCache extends EDataServer.Extensible {
     ...
     * @returns Whether succeeded.
     */
    dupSummaryField(summaryField: EBookContacts.ContactField, uid: string | null, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* outValue */ string | null ]
    /**
...
interface DataBookView extends Gio.Initable {
     ...
     * @param uid a contact UID
     */
    claimContactUid(uid: string | null): void
    /**
...
module DataBookViewWatcherCache {
    ...
    interface ConstructorProperties extends EBookContacts.BookIndicesUpdater.ConstructorProperties {
    }

}

interface DataBookViewWatcherCache {
...
interface DataBookViewWatcherMemory {
...
interface DataBookViewWatcherSqlite {
...
interface DataBookViewWatcherCacheClass {
}

abstract class DataBookViewWatcherCacheClass {
...
interface DataBookViewWatcherCachePrivate {
}
...
interface DataBookViewWatcherMemoryClass {
}

abstract class DataBookViewWatcherMemoryClass {
...
interface DataBookViewWatcherMemoryPrivate {
}
...
interface DataBookViewWatcherSqliteClass {
}

abstract class DataBookViewWatcherSqliteClass {
...
interface DataBookViewWatcherSqlitePrivate {
}

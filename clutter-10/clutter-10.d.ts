 ...
 */
class Actor<A extends LayoutManager = LayoutManager, B extends Content = Content> extends GObject.InitiallyUnowned implements Atk.ImplementorIface, Animatable, Container, Scriptable {
 ...
 * and should be accessed using the provided API
 */
class Clone<A extends Actor = Actor> extends Actor implements Atk.ImplementorIface, Animatable, Container, Scriptable {
...
module ScrollActor {
    ...
    interface ConstructorProps extends Actor.ConstructorProps, Atk.ImplementorIface.ConstructorProps, Animatable.ConstructorProps, Container.ConstructorProps, Scriptable.ConstructorProps {
 ...
 * and should be accessed using the provided API
 */
class Stage extends Actor implements Atk.ImplementorIface, Animatable, Container, Scriptable {

...
static with_backend_store(store: BackendStore): IndividualAggregator;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'individuals-changed', callback: ((_source: this, added: Gee.Set, removed: Gee.Set, message: string | null, actor: Persona | null, reason: GroupDetailsChangeReason) => void)): number
    connect_after(signal: 'individuals-changed', callback: ((_source: this, added: Gee.Set, removed: Gee.Set, message: string | null, actor: Persona | null, reason: GroupDetailsChangeReason) => void)): number
    emit(signal: 'individuals-changed', added: Gee.Set, removed: Gee.Set, message: (string | null), actor: (Persona | null), reason: GroupDetailsChangeReason): void
    ...
    add_persona_from_details(parent: (Individual | null), persona_store: PersonaStore, details: GLib.HashTable<string, GObject.Value>, _callback_?: (Gio.AsyncReadyCallback<this> | null)): void
...
static ["new"](personas?: (Gee.Set | null)): Individual;
    ...
    connect_after(signal: 'removed', callback: ((_source: this, replacement_individual: Individual | null) => void)): number
...
_init(...args: any[]): void;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'personas-changed', callback: ((_source: this, added: Gee.Set, removed: Gee.Set, message: string | null, actor: Persona | null, reason: GroupDetailsChangeReason) => void)): number
    connect_after(signal: 'personas-changed', callback: ((_source: this, added: Gee.Set, removed: Gee.Set, message: string | null, actor: Persona | null, reason: GroupDetailsChangeReason) => void)): number
    emit(signal: 'personas-changed', added: Gee.Set, removed: Gee.Set, message: (string | null), actor: (Persona | null), reason: GroupDetailsChangeReason): void
    ...
    add_persona_from_details(details: GLib.HashTable<string, GObject.Value>, _callback_?: (Gio.AsyncReadyCallback<this> | null)): void
    add_persona_from_details_finish(_res_: Gio.AsyncResult): (Persona | null)
    remove_persona(persona: Persona, _callback_?: (Gio.AsyncReadyCallback<this> | null)): void
    remove_persona_finish(_res_: Gio.AsyncResult): void
    get_type_id(): string

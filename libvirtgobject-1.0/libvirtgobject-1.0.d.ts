...
export namespace LibvirtGObject {
    ...
    function init_object(argv?: string[] | null): void;
    function init_object_check(argv?: string[] | null): boolean;
    ...
    class Connection extends GObject.Object {
        // Own properties of LibvirtGObject-1.0.Connection

        handle: ConnectionHandle;
        uri: string;

        // Constructors of LibvirtGObject-1.0.Connection

        static ['new'](uri: string): Connection;

        // Owm methods of LibvirtGObject-1.0.Connection
    ...
    class Domain extends GObject.Object {
        // Own properties of LibvirtGObject-1.0.Domain

        handle: DomainHandle;
        readonly persistent: boolean;

        // Owm methods of LibvirtGObject-1.0.Domain
        ...
        get_has_current_snapshot(flags: number): boolean;
        get_id(): number;
        get_info(): DomainInfo;
        /**
    ...
    abstract class DomainDevice extends GObject.Object {
        // Own properties of LibvirtGObject-1.0.DomainDevice

        config: LibvirtGConfig.DomainDevice;
        domain: Domain;

        // Owm methods of LibvirtGObject-1.0.DomainDevice
    ...
    class DomainDisk extends DomainDevice {
        // Owm methods of LibvirtGObject-1.0.DomainDisk
    ...
    class DomainInterface extends DomainDevice {
        // Owm methods of LibvirtGObject-1.0.DomainInterface
    ...
    class DomainSnapshot extends GObject.Object {
        // Own properties of LibvirtGObject-1.0.DomainSnapshot

        handle: DomainSnapshotHandle;

        // Owm methods of LibvirtGObject-1.0.DomainSnapshot
        ...
        get_is_current(flags: number): boolean;
        get_name(): string;
    ...
    class Interface extends GObject.Object {
        // Own properties of LibvirtGObject-1.0.Interface

        handle: InterfaceHandle;

        // Owm methods of LibvirtGObject-1.0.Interface
    ...
    class Manager extends GObject.Object {
        // Constructors of LibvirtGObject-1.0.Manager

        static ['new'](): Manager;

        // Owm methods of LibvirtGObject-1.0.Manager
    ...
    class Network extends GObject.Object {
        // Own properties of LibvirtGObject-1.0.Network

        handle: NetworkHandle;

        // Owm methods of LibvirtGObject-1.0.Network
    ...
    class NetworkDHCPLease extends GObject.Object {
        // Own properties of LibvirtGObject-1.0.NetworkDHCPLease

        handle: any;

        // Owm methods of LibvirtGObject-1.0.NetworkDHCPLease
    ...
    class NetworkFilter extends GObject.Object {
        // Own properties of LibvirtGObject-1.0.NetworkFilter

        handle: NetworkFilterHandle;

        // Owm methods of LibvirtGObject-1.0.NetworkFilter
    ...
    class NodeDevice extends GObject.Object {
        // Own properties of LibvirtGObject-1.0.NodeDevice

        handle: NodeDeviceHandle;

        // Owm methods of LibvirtGObject-1.0.NodeDevice
    ...
    class Secret extends GObject.Object {
        // Own properties of LibvirtGObject-1.0.Secret

        handle: SecretHandle;

        // Owm methods of LibvirtGObject-1.0.Secret
    ...
    class StoragePool extends GObject.Object {
        // Own properties of LibvirtGObject-1.0.StoragePool

        handle: StoragePoolHandle;

        // Owm methods of LibvirtGObject-1.0.StoragePool
    ...
    class StorageVol extends GObject.Object {
        // Own properties of LibvirtGObject-1.0.StorageVol

        handle: StorageVolHandle;
        pool: StoragePool;

        // Owm methods of LibvirtGObject-1.0.StorageVol
    ...
    class Stream extends Gio.IOStream {
        // Own properties of LibvirtGObject-1.0.Stream

        handle: StreamHandle;

        // Owm methods of LibvirtGObject-1.0.Stream
    ...
    class ConnectionClass {
        // Own fields of LibvirtGObject-1.0.ConnectionClass
    ...
    class DomainClass {
        // Own fields of LibvirtGObject-1.0.DomainClass

        padding: any[];
    }

    class DomainDeviceClass {
        // Own fields of LibvirtGObject-1.0.DomainDeviceClass
    ...
    class DomainDiskClass {
        // Own fields of LibvirtGObject-1.0.DomainDiskClass
    ...
    class DomainDiskStats {
        // Own fields of LibvirtGObject-1.0.DomainDiskStats
        ...
        // Constructors of LibvirtGObject-1.0.DomainDiskStats
    ...
    class DomainInfo {
        // Own fields of LibvirtGObject-1.0.DomainInfo
    ...
    class DomainInterfaceClass {
        // Own fields of LibvirtGObject-1.0.DomainInterfaceClass
    ...
    class DomainInterfaceStats {
        // Own fields of LibvirtGObject-1.0.DomainInterfaceStats
        ...
        // Constructors of LibvirtGObject-1.0.DomainInterfaceStats
    ...
    class DomainSnapshotClass {
        // Own fields of LibvirtGObject-1.0.DomainSnapshotClass
    ...
    class InterfaceClass {
        // Own fields of LibvirtGObject-1.0.InterfaceClass
    ...
    class ManagerClass {
        // Own fields of LibvirtGObject-1.0.ManagerClass
    ...
    class NetworkClass {
        // Own fields of LibvirtGObject-1.0.NetworkClass

        padding: any[];
    }

    class NetworkDHCPLeaseClass {
        // Own fields of LibvirtGObject-1.0.NetworkDHCPLeaseClass
    ...
    class NetworkFilterClass {
        // Own fields of LibvirtGObject-1.0.NetworkFilterClass
    ...
    class NodeDeviceClass {
        // Own fields of LibvirtGObject-1.0.NodeDeviceClass
    ...
    class NodeInfo {
        // Own fields of LibvirtGObject-1.0.NodeInfo
        ...
        // Constructors of LibvirtGObject-1.0.NodeInfo
    ...
    class SecretClass {
        // Own fields of LibvirtGObject-1.0.SecretClass
    ...
    class StoragePoolClass {
        // Own fields of LibvirtGObject-1.0.StoragePoolClass

        padding: any[];
    }

    class StoragePoolInfo {
        // Own fields of LibvirtGObject-1.0.StoragePoolInfo
    ...
    class StorageVolClass {
        // Own fields of LibvirtGObject-1.0.StorageVolClass

        padding: any[];
    }

    class StorageVolInfo {
        // Own fields of LibvirtGObject-1.0.StorageVolInfo
    ...
    class StreamClass {
        // Own fields of LibvirtGObject-1.0.StreamClass

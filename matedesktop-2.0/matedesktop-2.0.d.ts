...
export namespace MateDesktop {
     ...
     * @param flags 
     */
    function desktop_item_find_icon(icon_theme: Gtk.IconTheme, icon: string, desired_size: number, flags: number): string;
    ...
    class BG extends GObject.Object {
         ...
         * @param root 
         */
        create_surface_scale(window: Gdk.Window, width: number, height: number, scale: number, root: boolean): cairo.Surface;

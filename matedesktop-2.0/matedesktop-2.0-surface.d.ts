...
export type MateColorSelectionConstructOnly = GtkBoxConstructOnly | GtkBuildableConstructOnly | GtkOrientableConstructOnly;

export interface MateColorSelectionDialogProps extends GtkDialogProps, GtkBuildableProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MateHSVConstructOnly = GtkWidgetConstructOnly | GtkBuildableConstructOnly;

export interface MateImageMenuItemProps extends GtkMenuItemProps, GtkActionableProps, GtkActivatableProps, GtkBuildableProps {
...
export interface Widgets {
    MateColorSelection: {
        class: MateDesktop.ColorSelection;
        props: MateColorSelectionProps;
        signals: MateDesktop.ColorSelection.SignalSignatures;
        constructOnly: MateColorSelectionConstructOnly;
        slotCandidates: {};
    };
    MateColorSelectionDialog: {
        class: MateDesktop.ColorSelectionDialog;
        props: MateColorSelectionDialogProps;
        signals: MateDesktop.ColorSelectionDialog.SignalSignatures;
        constructOnly: MateColorSelectionDialogConstructOnly;
        slotCandidates: {};
    };
    MateHSV: {
        class: MateDesktop.HSV;
        props: MateHSVProps;
        signals: MateDesktop.HSV.SignalSignatures;
        constructOnly: MateHSVConstructOnly;
        slotCandidates: {};
    };
    MateImageMenuItem: {
        class: MateDesktop.ImageMenuItem;
        props: MateImageMenuItemProps;
        signals: MateDesktop.ImageMenuItem.SignalSignatures;
        constructOnly: MateImageMenuItemConstructOnly;
        slotCandidates: {
        'image': 'set_image';
        };
    };

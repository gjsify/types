...
export const PROP_TYPES = {
    'MateBGCrossfade.height': 'gint',
    'MateBGCrossfade.width': 'gint',
    'MateColorSelection.current-alpha': 'guint',
    'MateColorSelection.has-opacity-control': 'gboolean',
    'MateColorSelection.has-palette': 'gboolean',
    'MateImageMenuItem.image': 'GtkWidget',
    'MateRRConfig.screen': 'MateRRScreen',
    'MateRRLabeler.config': 'MateRRConfig',
    'MateRRScreen.gdk-screen': 'GdkScreen',
};

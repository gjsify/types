...
import './node-meta-14-import.d.ts';
...
export interface Backend extends Gio.Initable {
    ...
    setKeymap(layouts: string, variants: string, options: string, model: string): void
...
export interface BackgroundActor extends Atk.ImplementorIface, Clutter.Animatable {
...
export interface BackgroundGroup extends Atk.ImplementorIface, Clutter.Animatable {
...
export module Display {
     ...
     */
    export interface FocusWindowSignalCallback {
...
export interface Display {
    ...
    setInputFocus(window: Window, timestamp: number): void
    /**
    ...
    on(sigName: "focus-window", callback: Display.FocusWindowSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "focus-window", callback: Display.FocusWindowSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "focus-window", callback: Display.FocusWindowSignalCallback): NodeJS.EventEmitter
    emit(sigName: "focus-window", p0: number, ...args: any[]): void
...
export module Stage {
    ...
    export interface ConstructorProperties extends Atk.ImplementorIface.ConstructorProperties, Clutter.Animatable.ConstructorProperties, Clutter.Stage.ConstructorProperties {
    }

}

export interface Stage extends Atk.ImplementorIface, Clutter.Animatable {
...
export module WaylandSurface {
     ...
     */
    export interface ActorChangedSignalCallback {
        (): void
    }
     ...
     */
    export interface ConfigureSignalCallback {
        (): void
    }
     ...
     */
    export interface PreStateAppliedSignalCallback {
        (): void
    }
     ...
     */
    export interface ShortcutsInhibitedSignalCallback {
        (): void
    }
     ...
     */
    export interface ShortcutsRestoredSignalCallback {
        (): void
    }
...
export interface WaylandSurface {
    ...
    on(sigName: "actor-changed", callback: WaylandSurface.ActorChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "actor-changed", callback: WaylandSurface.ActorChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "actor-changed", callback: WaylandSurface.ActorChangedSignalCallback): NodeJS.EventEmitter
    emit(sigName: "actor-changed", ...args: any[]): void
    connect(sigName: "configure", callback: WaylandSurface.ConfigureSignalCallback): number
    on(sigName: "configure", callback: WaylandSurface.ConfigureSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "configure", callback: WaylandSurface.ConfigureSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "configure", callback: WaylandSurface.ConfigureSignalCallback): NodeJS.EventEmitter
    emit(sigName: "configure", ...args: any[]): void
    connect(sigName: "destroy", callback: WaylandSurface.DestroySignalCallback): number
    on(sigName: "destroy", callback: WaylandSurface.DestroySignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "destroy", callback: WaylandSurface.DestroySignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "destroy", callback: WaylandSurface.DestroySignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "geometry-changed", callback: WaylandSurface.GeometryChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "geometry-changed", callback: WaylandSurface.GeometryChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "geometry-changed", callback: WaylandSurface.GeometryChangedSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "pre-state-applied", callback: WaylandSurface.PreStateAppliedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "pre-state-applied", callback: WaylandSurface.PreStateAppliedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "pre-state-applied", callback: WaylandSurface.PreStateAppliedSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "shortcuts-inhibited", callback: WaylandSurface.ShortcutsInhibitedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "shortcuts-inhibited", callback: WaylandSurface.ShortcutsInhibitedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "shortcuts-inhibited", callback: WaylandSurface.ShortcutsInhibitedSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "shortcuts-restored", callback: WaylandSurface.ShortcutsRestoredSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "shortcuts-restored", callback: WaylandSurface.ShortcutsRestoredSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "shortcuts-restored", callback: WaylandSurface.ShortcutsRestoredSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "unmapped", callback: WaylandSurface.UnmappedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "unmapped", callback: WaylandSurface.UnmappedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "unmapped", callback: WaylandSurface.UnmappedSignalCallback): NodeJS.EventEmitter
...
export class WaylandSurface extends GObject.Object {
...
export interface Window extends Gio.Initable {
    ...
    beginGrabOp(op: GrabOp, device: Clutter.InputDevice | null, sequence: Clutter.EventSequence | null, timestamp: number, posHint: Graphene.Point | null): boolean
    canClose(): boolean
    canMaximize(): boolean
    canMinimize(): boolean
     ...
     */
    getFrameBounds(): Mtk.Region | null
    /**
     ...
     */
    raiseAndMakeRecentOnWorkspace(workspace: Workspace): void
...
export interface WindowActor extends Atk.ImplementorIface, Clutter.Animatable {
...
export interface WindowGroup extends Atk.ImplementorIface, Clutter.Animatable {
...
export interface WorkspaceManager {
    ...
    getLayoutColumns(): number
    getLayoutRows(): number
...
export interface X11Display {
    ...
    lookupXwindow(window: Window): xlib.Window
...
export interface Shadow {
     ...
     */
    paint(framebuffer: Cogl.Framebuffer, windowX: number, windowY: number, windowWidth: number, windowHeight: number, opacity: number, clip: Mtk.Region | null, clipStrictly: boolean): void
    ref(): Shadow
    unref(): void
}
...
export interface WaylandSurfaceClass {
...
export abstract class WaylandSurfaceClass {
...
export interface WindowShape {
     ...
     */
    toRegion(centerWidth: number, centerHeight: number): Mtk.Region
    unref(): void
}

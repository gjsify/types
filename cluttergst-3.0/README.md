...
GJS TypeScript type definitions for ClutterGst-3.0, generated from library version 3.0.27 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v4.0.0-beta.16.

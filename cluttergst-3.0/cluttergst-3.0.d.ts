...
_init(...args: any[]): void;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'capture-resolution-changed', callback: ((_source: this, width: number, height: number) => void)): number
    connect_after(signal: 'capture-resolution-changed', callback: ((_source: this, width: number, height: number) => void)): number

...
export const ENUM_VALUES = {
    ...
    'XfceScreenPosition.e': 8,
    'XfceScreenPosition.floating-h': 13,
    'XfceScreenPosition.floating-v': 14,
    'XfceScreenPosition.n': 2,
    'XfceScreenPosition.ne-h': 3,
    'XfceScreenPosition.ne-v': 7,
    'XfceScreenPosition.none': 0,
    'XfceScreenPosition.nw-h': 1,
    'XfceScreenPosition.nw-v': 4,
    'XfceScreenPosition.s': 11,
    'XfceScreenPosition.se-h': 12,
    'XfceScreenPosition.se-v': 9,
    'XfceScreenPosition.sw-h': 10,
    'XfceScreenPosition.sw-v': 6,
    'XfceScreenPosition.w': 5,
};
...
export const PROP_ENUMS = {
    'XfceArrowButton.arrow-type': 'GtkArrowType',
};
...
export const PROP_TYPES = {
    'XfceArrowButton.arrow-type': 'GtkArrowType',
    'XfcePanelImage.pixbuf': 'GdkPixbuf',
    'XfcePanelImage.size': 'gint',
    'XfcePanelImage.source': 'gchararray',
    'XfcePanelPlugin.comment': 'gchararray',
    'XfcePanelPlugin.dark-mode': 'gboolean',
    'XfcePanelPlugin.display-name': 'gchararray',
    'XfcePanelPlugin.expand': 'gboolean',
    'XfcePanelPlugin.name': 'gchararray',
    'XfcePanelPlugin.shrink': 'gboolean',
    'XfcePanelPlugin.small': 'gboolean',
    'XfcePanelPlugin.unique-id': 'gint',
};

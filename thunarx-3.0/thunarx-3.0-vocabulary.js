...
export const OWN_PROPS = {
    ThunarxMenuItem: ['icon', 'label', 'menu', 'name', 'priority', 'sensitive', 'tooltip'],
    ThunarxPropertyPage: ['label', 'label-widget'],
    ThunarxProviderPlugin: ['resident'],
};

export const OWN_SIGNALS = {
    ThunarxMenuItem: ['activate'],
};
...
export const PROP_TYPES = {
    'ThunarxMenuItem.icon': 'gchararray',
    'ThunarxMenuItem.label': 'gchararray',
    'ThunarxMenuItem.menu': 'ThunarxMenu',
    'ThunarxMenuItem.name': 'gchararray',
    'ThunarxMenuItem.priority': 'gboolean',
    'ThunarxMenuItem.sensitive': 'gboolean',
    'ThunarxMenuItem.tooltip': 'gchararray',
    'ThunarxPropertyPage.label': 'gchararray',
    'ThunarxPropertyPage.label-widget': 'GtkWidget',
    'ThunarxProviderPlugin.resident': 'gboolean',
};

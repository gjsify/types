 ...
 */
export function aatLayoutFeatureTypeGetSelectorInfos(face: face_t, featureType: aat_layout_feature_type_t, startOffset: number): [ /* returnType */ number, /* selectors */ aat_layout_feature_selector_info_t[], /* defaultIndex */ number ]
/**
 ...
 */
export function bufferAddLatin1(buffer: buffer_t, text: number[], itemOffset: number, itemLength: number): void
/**
 ...
 * @param itemLength The number of characters to add to the `buffer,` or -1 for the               end of `text` (assuming it is `NULL` terminated).
 */
export function bufferAddUtf8(buffer: buffer_t, text: number[], itemOffset: number, itemLength: number): void
/**
 ...
 */
export function bufferSerialize(buffer: buffer_t, start: number, end: number, font: font_t | null, format: buffer_serialize_format_t, flags: buffer_serialize_flags_t): [ /* returnType */ number, /* buf */ number[], /* bufConsumed */ number ]
/**
 ...
 */
export function bufferSerializeFormatFromString(str: number[]): buffer_serialize_format_t
/**
 ...
 * @returns The number of serialized items.
 */
export function bufferSerializeUnicode(buffer: buffer_t, start: number, end: number, format: buffer_serialize_format_t, flags: buffer_serialize_flags_t): [ /* returnType */ number, /* buf */ number[], /* bufConsumed */ number ]
/**
 ...
 */
export function colorLineGetColorStops(colorLine: color_line_t, start: number): [ /* returnType */ number, /* colorStops */ color_stop_t[] ]
/**
 ...
 */
export function directionFromString(str: number[]): direction_t
/**
 ...
 */
export function drawClosePath(dfuncs: draw_funcs_t, drawData: any | null, st: draw_state_t): void
/**
 ...
 * @param toY Y component of target point
 */
export function drawLineTo(dfuncs: draw_funcs_t, drawData: any | null, st: draw_state_t, toX: number, toY: number): void
/**
 ...
 * @param toY Y component of target point
 */
export function drawMoveTo(dfuncs: draw_funcs_t, drawData: any | null, st: draw_state_t, toX: number, toY: number): void
/**
 ...
 * @param toY Y component of target point
 */
export function drawQuadraticTo(dfuncs: draw_funcs_t, drawData: any | null, st: draw_state_t, controlX: number, controlY: number, toX: number, toY: number): void
/**
 ...
 */
export function featureFromString(str: number[]): [ /* returnType */ bool_t, /* feature */ feature_t ]
/**
 ...
 */
export function fontDrawGlyph(font: font_t, glyph: codepoint_t, dfuncs: draw_funcs_t, drawData: any | null): void
/**
 ...
 * @param drawData User data to pass to draw callbacks
 */
export function fontGetGlyphShape(font: font_t, glyph: codepoint_t, dfuncs: draw_funcs_t, drawData: any | null): void
/**
 * Fetches the advance for a glyph ID in the specified font,
 ...
 * @returns `true` if data found, `false` otherwise
 */
export function fontGlyphFromString(font: font_t, s: number[]): [ /* returnType */ bool_t, /* glyph */ codepoint_t ]
/**
 ...
 */
export function fontPaintGlyph(font: font_t, glyph: codepoint_t, pfuncs: paint_funcs_t, paintData: any | null, paletteIndex: number, foreground: color_t): void
/**
 ...
 */
export function fontSetFuncsData(font: font_t, fontData: any | null): void
/**
 ...
 */
export function ftFaceCreate(ftFace: freetype2.Face): face_t
/**
 * Creates an #hb_face_t face object from the specified FT_Face.
 * 
 * Note that this is using the FT_Face object just to get at the underlying
 ...
 */
export function ftFontCreate(ftFace: freetype2.Face): font_t
/**
 * Creates an #hb_font_t font object from the specified FT_Face.
 * 
 * <note>Note: You must set the face size on `ft_face` before calling
 ...
 */
export function mapNext(map: map_t, idx: number): [ /* returnType */ bool_t, /* idx */ number, /* key */ codepoint_t, /* value */ codepoint_t ]
/**
 ...
 * @param metricsTag tag of metrics value you like to fetch.
 */
export function otMetricsGetPositionWithFallback(font: font_t, metricsTag: ot_metrics_tag_t): /* position */ position_t
/**
 ...
 */
export function otTagsFromScriptAndLanguage(script: script_t, language: language_t | null, scriptCount?: number, languageCount?: number): [ /* scriptCount */ number, /* scriptTags */ tag_t, /* languageCount */ number, /* languageTags */ tag_t ]
/**
 ...
 */
export function otTagsToScriptAndLanguage(scriptTag: tag_t, languageTag: tag_t): [ /* script */ script_t, /* language */ language_t ]
/**
 ...
 */
export function paintColor(funcs: paint_funcs_t, paintData: any | null, isForeground: bool_t, color: color_t): void
/**
 ...
 * @param font the font
 */
export function paintColorGlyph(funcs: paint_funcs_t, paintData: any | null, glyph: codepoint_t, font: font_t): bool_t
/**
 ...
 */
export function paintCustomPaletteColor(funcs: paint_funcs_t, paintData: any | null, colorIndex: number): [ /* returnType */ bool_t, /* color */ color_t ]
/**
 ...
 */
export function paintImage(funcs: paint_funcs_t, paintData: any | null, image: blob_t, width: number, height: number, format: tag_t, slant: number, extents: glyph_extents_t | null): void
/**
 ...
 */
export function paintLinearGradient(funcs: paint_funcs_t, paintData: any | null, colorLine: color_line_t, x0: number, y0: number, x1: number, y1: number, x2: number, y2: number): void
/**
 * Perform a "pop-clip" paint operation.
 * @param funcs paint functions
 * @param paintData associated data passed by the caller
 */
export function paintPopClip(funcs: paint_funcs_t, paintData: any | null): void
/**
 ...
 */
export function paintPopGroup(funcs: paint_funcs_t, paintData: any | null, mode: paint_composite_mode_t): void
/**
 * Perform a "pop-transform" paint operation.
 * @param funcs paint functions
 * @param paintData associated data passed by the caller
 */
export function paintPopTransform(funcs: paint_funcs_t, paintData: any | null): void
/**
 ...
 * @param font the font
 */
export function paintPushClipGlyph(funcs: paint_funcs_t, paintData: any | null, glyph: codepoint_t, font: font_t): void
/**
 ...
 */
export function paintPushClipRectangle(funcs: paint_funcs_t, paintData: any | null, xmin: number, ymin: number, xmax: number, ymax: number): void
/**
 * Perform a "push-group" paint operation.
 * @param funcs paint functions
 * @param paintData associated data passed by the caller
 */
export function paintPushGroup(funcs: paint_funcs_t, paintData: any | null): void
/**
 ...
 */
export function paintPushTransform(funcs: paint_funcs_t, paintData: any | null, xx: number, yx: number, xy: number, yy: number, dx: number, dy: number): void
/**
 ...
 */
export function paintRadialGradient(funcs: paint_funcs_t, paintData: any | null, colorLine: color_line_t, x0: number, y0: number, r0: number, x1: number, y1: number, r1: number): void
/**
 ...
 */
export function paintSweepGradient(funcs: paint_funcs_t, paintData: any | null, colorLine: color_line_t, x0: number, y0: number, startAngle: number, endAngle: number): void
/**
 ...
 * @returns An #hb_script_t corresponding to the ISO 15924 tag.
 */
export function scriptFromString(str: number[]): script_t
/**
 ...
 */
export function shapeJustify(font: font_t, buffer: buffer_t, features: feature_t[] | null, shaperList: string[] | null, minTargetAdvance: number, maxTargetAdvance: number, advance: number): [ /* returnType */ bool_t, /* advance */ number, /* varTag */ tag_t, /* varValue */ number ]
/**
 ...
 */
export function tagFromString(str: number[]): tag_t
/**
 * Converts an #hb_tag_t to a string and returns it in `buf`.
 * Strings will be four characters long.
 * @param tag #hb_tag_t to convert
 */
export function tagToString(tag: tag_t): /* buf */ number[]
/**
 ...
 * @returns `true` if @str is successfully parsed, `false` otherwise
 */
export function variationFromString(str: number[]): [ /* returnType */ bool_t, /* variation */ variation_t ]
/**

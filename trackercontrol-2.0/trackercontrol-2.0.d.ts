...
static new_full(auto_start: boolean): MinerManager;
    ...
    connect(signal: 'miner-progress', callback: ((_source: this, miner: string, status: string, progress: number, remaining_time: number) => void)): number
    connect_after(signal: 'miner-progress', callback: ((_source: this, miner: string, status: string, progress: number, remaining_time: number) => void)): number

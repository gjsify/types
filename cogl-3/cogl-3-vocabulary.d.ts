/**
 * The GIR-derived widget VOCABULARY for Cogl-3.
 *
...
export interface CoglBitmapProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type CoglBitmapConstructOnly = never;

export interface CoglOffscreenProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type CoglOffscreenConstructOnly = never;

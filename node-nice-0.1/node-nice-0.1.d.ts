 ...
 */
function candidateTransportToString(transport: CandidateTransport): string | null
/**
 * Useful for debugging functions, just returns a static string with the
 * candidate type.
 ...
 */
function candidateTypeToString(type: CandidateType): string | null
/**
 ...
 */
function componentStateToString(state: ComponentState): string | null
/**
 ...
 */
function interfacesGetIpForInterface(interfaceName: string | null): string | null
/**

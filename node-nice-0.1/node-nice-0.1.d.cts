...
import './node-nice-0.1-import.d.ts';
...
export interface Agent {
     ...
     */
    parseRemoteStreamSdp(streamId: number, sdp: string, ufrag: string | null, pwd: string | null): Candidate[]
    /**
     ...
     */
    recv(streamId: number, componentId: number, cancellable: Gio.Cancellable | null): [ /* returnType */ number, /* buf */ number[] ]
    /**
     ...
     */
    recvNonblocking(streamId: number, componentId: number, cancellable: Gio.Cancellable | null): [ /* returnType */ number, /* buf */ number[] ]
    /**

...
export namespace RygelServer {
    ...
    class WritableContainerError extends GLib.Error {
        // Own fields of RygelServer-2.6.WritableContainerError

        NOT_IMPLEMENTED: number;

        // Constructors of RygelServer-2.6.WritableContainerError

        constructor(options: { message: string; code: number });
    }

    class MediaEngineError extends GLib.Error {
        // Own fields of RygelServer-2.6.MediaEngineError

        NOT_FOUND: number;

        // Constructors of RygelServer-2.6.MediaEngineError

        constructor(options: { message: string; code: number });
    }

    class HTTPSeekRequestError extends GLib.Error {
        // Own fields of RygelServer-2.6.HTTPSeekRequestError

        INVALID_RANGE: number;
        BAD_REQUEST: number;
        OUT_OF_RANGE: number;

        // Constructors of RygelServer-2.6.HTTPSeekRequestError

        constructor(options: { message: string; code: number });
    }

    class DataSourceError extends GLib.Error {
        // Own fields of RygelServer-2.6.DataSourceError

        GENERAL: number;
        SEEK_FAILED: number;
        PLAYSPEED_FAILED: number;

        // Constructors of RygelServer-2.6.DataSourceError

        constructor(options: { message: string; code: number });
    }

    class HTTPRequestError extends GLib.Error {
        // Own fields of RygelServer-2.6.HTTPRequestError
        ...
        // Constructors of RygelServer-2.6.HTTPRequestError

        constructor(options: { message: string; code: number });
    }

    class PlaySpeedError extends GLib.Error {
        // Own fields of RygelServer-2.6.PlaySpeedError

        INVALID_SPEED_FORMAT: number;
        SPEED_NOT_PRESENT: number;

        // Constructors of RygelServer-2.6.PlaySpeedError
    ...
    class AudioItem extends MediaFileItem {
        // Own properties of RygelServer-2.6.AudioItem
    ...
    class ImageItem extends MediaFileItem {
        // Constructors of RygelServer-2.6.ImageItem
    ...
    class LogicalExpression extends SearchExpression {
        // Constructors of RygelServer-2.6.LogicalExpression
    ...
    class MediaArtStore extends GObject.Object {
        // Owm methods of RygelServer-2.6.MediaArtStore
    ...
    class MediaObjects extends Gee.ArrayList {
        // Constructors of RygelServer-2.6.MediaObjects

        static ['new'](): MediaObjects;

        // Owm methods of RygelServer-2.6.MediaObjects
    ...
    class MusicItem extends AudioItem {
        // Own properties of RygelServer-2.6.MusicItem
    ...
    class PhotoItem extends ImageItem {
        // Constructors of RygelServer-2.6.PhotoItem
    ...
    class RelationalExpression extends SearchExpression {
        // Constructors of RygelServer-2.6.RelationalExpression

        static ['new'](): RelationalExpression;

        // Owm methods of RygelServer-2.6.RelationalExpression
    ...
    class SimpleContainer extends MediaContainer {
        // Own fields of RygelServer-2.6.SimpleContainer

        children: MediaObjects;

        // Constructors of RygelServer-2.6.SimpleContainer

        static ['new'](id: string, parent: MediaContainer | null, title: string): SimpleContainer;

        static root(title: string): SimpleContainer;

        // Owm methods of RygelServer-2.6.SimpleContainer
    ...
    class Subtitle {
        // Own fields of RygelServer-2.6.Subtitle
    ...
    class VideoItem extends AudioItem {
        // Own properties of RygelServer-2.6.VideoItem

        author: string;
        subtitles: Gee.ArrayList;

        // Constructors of RygelServer-2.6.VideoItem

        static ['new'](id: string, parent: MediaContainer, title: string, upnp_class: string): VideoItem;

        // Owm methods of RygelServer-2.6.VideoItem
    ...
    abstract class MediaContainer extends MediaObject {
        // Own properties of RygelServer-2.6.MediaContainer
        ...
        // Own fields of RygelServer-2.6.MediaContainer

        update_id: number;
        storage_used: number;
        total_deleted_child_count: number;

        // Owm methods of RygelServer-2.6.MediaContainer
    ...
    abstract class MediaItem extends MediaObject {
        // Own properties of RygelServer-2.6.MediaItem

        description: string;

        // Owm methods of RygelServer-2.6.MediaItem
    ...
    abstract class MediaFileItem extends MediaItem {
        // Own properties of RygelServer-2.6.MediaFileItem
        ...
        // Own fields of RygelServer-2.6.MediaFileItem

        rygel_media_file_item_mime_to_ext: Gee.HashMap;

        // Owm methods of RygelServer-2.6.MediaFileItem
    ...
    abstract class MediaObject extends GObject.Object {
        // Own properties of RygelServer-2.6.MediaObject
        ...
        // Own fields of RygelServer-2.6.MediaObject

        parent_ptr: MediaContainer;

        // Owm methods of RygelServer-2.6.MediaObject
    ...
    class MediaResource extends GObject.Object {
        // Own properties of RygelServer-2.6.MediaResource
        ...
        // Own fields of RygelServer-2.6.MediaResource

        play_speeds: string[];
        play_speeds_length1: number;

        // Constructors of RygelServer-2.6.MediaResource
        ...
        // Owm methods of RygelServer-2.6.MediaResource
    ...
    abstract class MediaServerPlugin extends RygelCore.Plugin {
        // Own properties of RygelServer-2.6.MediaServerPlugin
        ...
        // Owm methods of RygelServer-2.6.MediaServerPlugin
    ...
    abstract class SearchExpression {
        // Own fields of RygelServer-2.6.SearchExpression
        ...
        // Owm methods of RygelServer-2.6.SearchExpression
    ...
    class MediaServer extends RygelCore.MediaDevice {
        // Own properties of RygelServer-2.6.MediaServer

        root_container: MediaContainer;
        rootContainer: MediaContainer;

        // Constructors of RygelServer-2.6.MediaServer
    ...
    abstract class MediaEngine extends GObject.Object {
        // Owm methods of RygelServer-2.6.MediaEngine
    ...
    class PlaylistItem extends MediaFileItem {
        // Constructors of RygelServer-2.6.PlaylistItem
    ...
    class ContentDirectory extends GUPnP.Service {
        // Own fields of RygelServer-2.6.ContentDirectory
        ...
        // Constructors of RygelServer-2.6.ContentDirectory
    ...
    class HTTPByteSeekRequest extends HTTPSeekRequest {
        // Own properties of RygelServer-2.6.HTTPByteSeekRequest
        ...
        // Constructors of RygelServer-2.6.HTTPByteSeekRequest

        static ['new'](msg: Soup.Message, handler: HTTPGetHandler): HTTPByteSeekRequest;

        // Owm methods of RygelServer-2.6.HTTPByteSeekRequest
    ...
    class HTTPByteSeekResponse extends HTTPResponseElement {
        // Own properties of RygelServer-2.6.HTTPByteSeekResponse
        ...
        // Constructors of RygelServer-2.6.HTTPByteSeekResponse
        ...
        // Owm methods of RygelServer-2.6.HTTPByteSeekResponse
    ...
    abstract class HTTPGetHandler extends GObject.Object {
        // Own properties of RygelServer-2.6.HTTPGetHandler

        cancellable: Gio.Cancellable;

        // Owm methods of RygelServer-2.6.HTTPGetHandler
    ...
    class HTTPGet extends HTTPRequest {
        // Own fields of RygelServer-2.6.HTTPGet

        seek: HTTPSeekRequest;
        speed_request: PlaySpeedRequest;
        handler: HTTPGetHandler;

        // Constructors of RygelServer-2.6.HTTPGet
    ...
    class HTTPItemURI extends GObject.Object {
        // Own properties of RygelServer-2.6.HTTPItemURI
        ...
        // Own fields of RygelServer-2.6.HTTPItemURI

        rygel_http_item_uri_mime_to_ext: Gee.HashMap;

        // Constructors of RygelServer-2.6.HTTPItemURI
        ...
        // Owm methods of RygelServer-2.6.HTTPItemURI
    ...
    abstract class HTTPRequest extends GObject.Object {
        // Own fields of RygelServer-2.6.HTTPRequest
        ...
        // Owm methods of RygelServer-2.6.HTTPRequest
    ...
    class HTTPResponse extends GObject.Object {
        // Own properties of RygelServer-2.6.HTTPResponse

        server: Soup.Server;
        readonly priority: number;

        // Own fields of RygelServer-2.6.HTTPResponse

        msg: Soup.Message;
        seek: HTTPSeekRequest;
        speed: PlaySpeedRequest;

        // Constructors of RygelServer-2.6.HTTPResponse

        static ['new'](request: HTTPGet, request_handler: HTTPGetHandler, src: DataSource): HTTPResponse;

        // Owm methods of RygelServer-2.6.HTTPResponse
    ...
    abstract class HTTPResponseElement extends GObject.Object {
        // Owm methods of RygelServer-2.6.HTTPResponseElement
    ...
    class HTTPServer extends GObject.Object {
        // Own properties of RygelServer-2.6.HTTPServer
        ...
        // Own fields of RygelServer-2.6.HTTPServer

        root_container: MediaContainer;
        context: GUPnP.Context;

        // Constructors of RygelServer-2.6.HTTPServer

        static ['new'](content_dir: ContentDirectory, name: string): HTTPServer;

        // Owm methods of RygelServer-2.6.HTTPServer
    ...
    class HTTPTimeSeekRequest extends HTTPSeekRequest {
        // Own fields of RygelServer-2.6.HTTPTimeSeekRequest
        ...
        // Owm methods of RygelServer-2.6.HTTPTimeSeekRequest
    ...
    class HTTPTimeSeekResponse extends HTTPResponseElement {
        // Own properties of RygelServer-2.6.HTTPTimeSeekResponse
        ...
        // Constructors of RygelServer-2.6.HTTPTimeSeekResponse
        ...
        // Owm methods of RygelServer-2.6.HTTPTimeSeekResponse
    ...
    class Serializer extends GObject.Object {
        // Own properties of RygelServer-2.6.Serializer

        serializer_type: SerializerType;
        serializerType: SerializerType;

        // Constructors of RygelServer-2.6.Serializer

        static ['new'](type: SerializerType): Serializer;

        // Owm methods of RygelServer-2.6.Serializer
    ...
    class PlaySpeed {
        // Own fields of RygelServer-2.6.PlaySpeed

        ref_count: number;
        numerator: number;
        denominator: number;

        // Constructors of RygelServer-2.6.PlaySpeed

        static ['new'](numerator: number, denominator: number): PlaySpeed;

        static from_string(speed: string): PlaySpeed;

        // Owm methods of RygelServer-2.6.PlaySpeed
    ...
    class PlaySpeedRequest extends GObject.Object {
        // Own properties of RygelServer-2.6.PlaySpeedRequest

        speed: PlaySpeed;

        // Constructors of RygelServer-2.6.PlaySpeedRequest

        static ['new'](numerator: number, denominator: number): PlaySpeedRequest;

        static from_string(speed: string): PlaySpeedRequest;

        // Owm methods of RygelServer-2.6.PlaySpeedRequest
    ...
    class PlaySpeedResponse extends HTTPResponseElement {
        // Own fields of RygelServer-2.6.PlaySpeedResponse

        framerate: number;

        // Constructors of RygelServer-2.6.PlaySpeedResponse
        ...
        // Owm methods of RygelServer-2.6.PlaySpeedResponse
    ...
    class DTCPCleartextRequest extends HTTPSeekRequest {
        // Own properties of RygelServer-2.6.DTCPCleartextRequest
        ...
        // Constructors of RygelServer-2.6.DTCPCleartextRequest

        static ['new'](message: Soup.Message, handler: HTTPGetHandler): DTCPCleartextRequest;

        // Owm methods of RygelServer-2.6.DTCPCleartextRequest
    ...
    class DTCPCleartextResponse extends HTTPResponseElement {
        // Own properties of RygelServer-2.6.DTCPCleartextResponse
        ...
        // Constructors of RygelServer-2.6.DTCPCleartextResponse
        ...
        // Owm methods of RygelServer-2.6.DTCPCleartextResponse
    ...
    class DLNAAvailableSeekRangeRequest extends HTTPSeekRequest {
        // Owm methods of RygelServer-2.6.DLNAAvailableSeekRangeRequest
    ...
    class DLNAAvailableSeekRangeResponse extends HTTPResponseElement {
        // Own properties of RygelServer-2.6.DLNAAvailableSeekRangeResponse
        ...
        // Constructors of RygelServer-2.6.DLNAAvailableSeekRangeResponse
        ...
        // Owm methods of RygelServer-2.6.DLNAAvailableSeekRangeResponse
    ...
    interface SearchableContainer {
        // Own properties of RygelServer-2.6.SearchableContainer

        search_classes: Gee.ArrayList;
        searchClasses: Gee.ArrayList;

        // Owm methods of RygelServer-2.6.SearchableContainer
        ...
        // Own virtual methods of RygelServer-2.6.SearchableContainer
    ...
    interface TrackableContainer {
        // Owm methods of RygelServer-2.6.TrackableContainer
        ...
        // Own virtual methods of RygelServer-2.6.TrackableContainer
    ...
    interface TrackableItem {
        // Owm methods of RygelServer-2.6.TrackableItem

        changed(): void;
    }

    interface VisualItem {
        // Own properties of RygelServer-2.6.VisualItem
        ...
        // Owm methods of RygelServer-2.6.VisualItem
        ...
        // Own virtual methods of RygelServer-2.6.VisualItem
    ...
    interface WritableContainer {
        // Own properties of RygelServer-2.6.WritableContainer

        create_classes: Gee.ArrayList;
        createClasses: Gee.ArrayList;

        // Owm methods of RygelServer-2.6.WritableContainer
        ...
        // Own virtual methods of RygelServer-2.6.WritableContainer
    ...
    interface DataSource {
        // Owm methods of RygelServer-2.6.DataSource
        ...
        // Own virtual methods of RygelServer-2.6.DataSource
    ...
    interface UpdatableObject {
        // Owm methods of RygelServer-2.6.UpdatableObject

        commit(_callback_?: Gio.AsyncReadyCallback<this> | null): void;
        commit_finish(_res_: Gio.AsyncResult): void;

        // Own virtual methods of RygelServer-2.6.UpdatableObject

// The widget vocabulary of RygelServer-2.6 as runtime data.
//
...
export const PROVENANCE = {
    ...
    requiredVocabularies: ['@girs/gee-0.8/vocabulary', '@girs/gobject-2.0/vocabulary', '@girs/gupnp-1.2/vocabulary', '@girs/rygelcore-2.6/vocabulary'],
};
...
export const OWN_PROPS = {
    ...
    RygelMusicItem: ['album-art', 'track-number'],

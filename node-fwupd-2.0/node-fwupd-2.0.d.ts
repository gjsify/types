 ...
 */
function buildMachineId(salt: string): string | null
/**
 ...
 */
function buildUserAgent(packageName: string, packageVersion: string): string | null
/**
 * Formats a checksum for display.
 * @param checksum A checksum
 * @returns text, or %NULL for invalid
 */
function checksumFormatForDisplay(checksum: string): string | null
/**
 ...
 */
function guidHashString(str: string): string | null
/**

 ...
 */
export function buildHistoryReportJson(devices: Device[]): string | null
/**
 ...
 */
export function guidHashData(data: number, datasz: number, flags: GuidFlags): string | null
/**
 ...
 * @returns A new GUID
 */
export function guidToString(guid: number, flags: GuidFlags): string | null
/**

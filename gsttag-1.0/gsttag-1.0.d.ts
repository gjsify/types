 ...
 */
message_full(type: Gst.MessageType, domain: GLib.Quark, code: number, text: (string | null), debug: (string | null), file: string, _function: string, line: number): void
/**
 * Post an error, warning or info message on the bus from inside an element.
 * 
 * `type` must be of #GST_MESSAGE_ERROR, #GST_MESSAGE_WARNING or
 ...
 */
message_full_with_details(type: Gst.MessageType, domain: GLib.Quark, code: number, text: (string | null), debug: (string | null), file: string, _function: string, line: number, structure: Gst.Structure): void
/**

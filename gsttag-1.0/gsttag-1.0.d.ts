...
export namespace GstTag {
     ...
     */
    function tag_parse_extended_comment(ext_comment: string, fail_if_no_key: boolean): boolean;
    /**
    ...
    abstract class TagDemux extends Gst.Element {
        // Own fields of GstTag-1.0.TagDemux
     ...
     *    function.
     */
    abstract class TagMux extends Gst.Element {
        // Own fields of GstTag-1.0.TagMux
     ...
     */
    class TagDemuxClass {
        // Own fields of GstTag-1.0.TagDemuxClass
    ...
    interface TagXmpWriter {
        // Owm methods of GstTag-1.0.TagXmpWriter

...
export namespace GPaste {
    ...
    /**
     * @default org.gnome.GPaste
     */
    const BUS_NAME: string;

    /**
     * @default close-on-select
     */
    ...
    /**
     * @default DeletePassword
     */
    const DAEMON_DELETE_PASSWORD: string;

    /**
     * @default EmptyHistory
     */
    ...
    /**
     * @default GetElementAtIndex
     */
    const DAEMON_GET_ELEMENT_AT_INDEX: string;

    /**
     * @default GetElementKind
     */
    ...
    /**
     * @default OnExtensionStateChanged
     */
    ...
    /**
     * @default empty-history-confirmation
     */
    ...
    /**
     * @default org.gnome.Shell
     */
    const GNOME_SHELL_BUS_NAME: string;

    /**
     * @default growing-lines
     */
    ...
    /**
     * @default make-password
     */
    const MAKE_PASSWORD_SETTING: string;

    /**
     * @default max-displayed-history-size
     */
    ...
    /**
     * @default org.gnome.Shell.SearchProvider2
     */
    const SEARCH_PROVIDER_INTERFACE_NAME: string;

    /**
     * @default LaunchSearch
     */
    const SEARCH_PROVIDER_LAUNCH_SEARCH: string;

    /**
     * @default /org/gnome/GPaste/SearchProvider
     */
    ...
    /**
     * @default synchronize-clipboards
     */
    const SYNCHRONIZE_CLIPBOARDS_SETTING: string;

    /**
     * @default sync-clipboard-to-primary
     */
    const SYNC_CLIPBOARD_TO_PRIMARY_SETTING: string;

    /**
     * @default sync-primary-to-clipboard
     */
    ...
    namespace Client {
        ...
        interface SignalSignatures extends Gio.DBusProxy.SignalSignatures {
             ...
             * @run-last
             */
            "empty-history": (history: string) => void;
            /**
             ...
             * @run-last
             */
            "switch-history": (history: string) => void;
            /**
             * @signal
             * @run-last
             */
            tracking: (object: boolean) => void;
            /**
             ...
             * @run-last
             */
            update: (action: UpdateAction, target: UpdateTarget, index: number) => void;
    ...
    namespace GnomeShellClient {
        ...
        interface SignalSignatures extends Gio.DBusProxy.SignalSignatures {
             ...
             * @run-last
             */
            "accelerator-activated": (id: number) => void;
            "notify::g-bus-type": (pspec: GObject.ParamSpec) => void;
            "notify::g-connection": (pspec: GObject.ParamSpec) => void;
            "notify::g-default-timeout": (pspec: GObject.ParamSpec) => void;
            "notify::g-flags": (pspec: GObject.ParamSpec) => void;
    ...
    namespace ScreensaverClient {
        ...
        interface SignalSignatures extends Gio.DBusProxy.SignalSignatures {
             ...
             * @run-last
             */
            "active-changed": (active: boolean) => void;
            "notify::g-bus-type": (pspec: GObject.ParamSpec) => void;
            "notify::g-connection": (pspec: GObject.ParamSpec) => void;
            "notify::g-default-timeout": (pspec: GObject.ParamSpec) => void;
            "notify::g-flags": (pspec: GObject.ParamSpec) => void;
    ...
    namespace Settings {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
             ...
             * @run-last
             */
            track: (tracking_state: boolean) => void;
            [key: `changed::${string}`]: (key: string) => void;
            [key: `rebind::${string}`]: (key: string) => void;
        }

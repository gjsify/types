...
interface Session {
     ...
     * @returns true on success, false on error
     */
    hivexNodeSetValue(nodeh: number, key: string | null, t: number, val: Uint8Array): boolean
    /**
     ...
     * @returns an array of binary data, or NULL on error
     */
    initrdCat(initrdpath: string, filename: string | null): Uint8Array
    /**
     ...
     * @returns true on success, false on error
     */
    internalTest(str: string | null, optstr: string | null, strlist: string[], b: boolean, integer: number, integer64: number, filein: string, fileout: string, bufferin: Uint8Array, optargs: InternalTest | null, cancellable: Gio.Cancellable | null): boolean
    /**
     * internal test function - do not use
     * 
     * This is an internal test function which is used to test whether the
     ...
     * @returns an array of binary data, or NULL on error
     */
    internalTestRbufferout(val: string | null): Uint8Array
    /**
     * internal test function - do not use
     * 
     * This is an internal test function which is used to test whether the

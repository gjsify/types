...
export namespace NMClient {
    ...
    /**
     * Describes errors that may result from operations involving a {@link NMClient.Client}.
     * @gir-type Struct
     */
    ...
    /**
     * {@link NMClient.ClientPermission} values indicate various permissions that NetworkManager
    ...
    /**
     * {@link NMClient.ClientPermissionResult} values indicate what authorizations and permissions
     * the user requires to obtain a given {@link NMClient.ClientPermission}
     * @gir-type Enum
     */
    ...
    class DeviceAdslError extends GLib.Error {
         ...
         */
        static NOTADSLCONNECTION: number;
        ...
        // Static methods
        /**
         * Registers an error quark for {@link NMClient.DeviceAdsl} if necessary.
         */
        static quark(): GLib.Quark;
    }
    ...
    class DeviceBondError extends GLib.Error {
         ...
         */
        static NOTBONDCONNECTION: number;

        /**
         * the bond connection was invalid
         */
        static INVALIDBONDCONNECTION: number;
        ...
        // Static methods
        /**
         * Registers an error quark for {@link NMClient.DeviceBond} if necessary.
         */
        static quark(): GLib.Quark;
    }
    ...
    class DeviceBridgeError extends GLib.Error {
         ...
         */
        static NOTBRIDGECONNECTION: number;

        /**
         * the bridge connection was invalid
         */
        static INVALIDBRIDGECONNECTION: number;
    ...
    class DeviceBtError extends GLib.Error {
         ...
         */
        static NOTBTCONNECTION: number;

        /**
         * the bluetooth connection was invalid
         */
        static INVALIDBTCONNECTION: number;

        /**
         * the device's MAC was invalid
         */
        static INVALIDDEVICEMAC: number;
        ...
        // Static methods
        /**
         * Registers an error quark for {@link NMClient.DeviceBt} if necessary.
         */
        static quark(): GLib.Quark;
    }
    ...
    class DeviceEthernetError extends GLib.Error {
         ...
         */
        static NOTETHERNETCONNECTION: number;

        /**
         * the Ethernet connection was invalid
         */
        static INVALIDETHERNETCONNECTION: number;
        ...
        // Static methods
        /**
         * Registers an error quark for {@link NMClient.DeviceEthernet} if necessary.
         */
        static quark(): GLib.Quark;
    }
    ...
    class DeviceGenericError extends GLib.Error {
         ...
         */
        static NOTGENERICCONNECTION: number;
    ...
    class DeviceInfinibandError extends GLib.Error {
         ...
         */
        static NOTINFINIBANDCONNECTION: number;

        /**
         * the InfiniBand connection was invalid
         */
        static INVALIDINFINIBANDCONNECTION: number;
        ...
        // Static methods
        /**
         * Registers an error quark for {@link NMClient.DeviceInfiniband} if necessary.
         */
        static quark(): GLib.Quark;
    }
    ...
    class DeviceModemError extends GLib.Error {
         ...
         */
        static NOTMODEMCONNECTION: number;

        /**
         * the modem connection was invalid
         */
        static INVALIDMODEMCONNECTION: number;
        ...
        // Static methods
        /**
         * Registers an error quark for {@link NMClient.DeviceModem} if necessary.
         */
        static quark(): GLib.Quark;
    }
    ...
    class DeviceOlpcMeshError extends GLib.Error {
         ...
         */
        static NOTOLPCMESHCONNECTION: number;
        ...
        // Static methods
        /**
         * Registers an error quark for {@link NMClient.DeviceOlpcMesh} if necessary.
         */
        static quark(): GLib.Quark;
    }
    ...
    class DeviceTeamError extends GLib.Error {
         ...
         */
        static NOTTEAMCONNECTION: number;

        /**
         * the team connection was invalid
         */
        static INVALIDTEAMCONNECTION: number;
    ...
    class DeviceVlanError extends GLib.Error {
        ...
        // Static methods
        /**
         * Registers an error quark for {@link NMClient.DeviceVlan} if necessary.
         */
        static quark(): GLib.Quark;
    }
    ...
    class DeviceWifiError extends GLib.Error {
         ...
         */
        static NOTWIFICONNECTION: number;

        /**
         * the Wi-Fi connection was invalid
         */
        static INVALIDWIFICONNECTION: number;
         ...
         */
        static MISSINGDEVICEWPACAPS: number;
        ...
        // Static methods
        /**
         * Registers an error quark for {@link NMClient.DeviceWifi} if necessary.
         */
        static quark(): GLib.Quark;
    }
    ...
    class DeviceWimaxError extends GLib.Error {
         ...
         */
        static NOTWIMAXCONNECTION: number;

        /**
         * the WiMax connection was invalid
         */
        static INVALIDWIMAXCONNECTION: number;
    ...
    /**
     * Describes errors that may result from operations involving a {@link NMClient.Object}.
     * @gir-type Struct
     */
    class ObjectError extends GLib.Error {
        ...
        /**
         * an error ocured while creating an {@link NMClient.Object}
         */
        ...
        // Static methods
        /**
         * Registers an error quark for {@link NMClient.Object} if necessary.
         */
        static quark(): GLib.Quark;
    }
    ...
    class RemoteConnectionError extends GLib.Error {
        ...
        // Static methods
        /**
         * Registers an error quark for {@link NMClient.RemoteConnection} if necessary.
         */
        static quark(): GLib.Quark;
    }
    ...
    /**
     * Describes errors that may result from operations involving a {@link NMClient.RemoteSettings}.
     * @gir-type Struct
     */
    class RemoteSettingsError extends GLib.Error {
        ...
        /**
         * the {@link NMClient.RemoteConnection} object
         *   was removed before it was completely initialized
         */
        static CONNECTIONREMOVED: number;

        /**
         * the {@link NMClient.RemoteConnection} object
         *   is not visible or otherwise unreadable
         */
        static CONNECTIONUNAVAILABLE: number;
        ...
        // Static methods
        /**
         * Registers an error quark for {@link NMClient.RemoteSettings} if necessary.
         */
        static quark(): GLib.Quark;
    }
    ...
    /**
     * {@link NMClient.SecretAgentError} values are passed by secret agents back to NetworkManager
    ...
    /**
     * Registers an error quark for {@link NMClient.Client} if necessary.
     * @returns the error quark used for {@link NMClient.Client} errors.
     * @since 0.9.10
     */
    ...
    /**
     * Registers an error quark for {@link NMClient.DeviceAdsl} if necessary.
     * @returns the error quark used for {@link NMClient.DeviceAdsl} errors.
     */
    function device_adsl_error_quark(): GLib.Quark;

    /**
     * Registers an error quark for {@link NMClient.DeviceBond} if necessary.
     * @returns the error quark used for {@link NMClient.DeviceBond} errors.
     */
    function device_bond_error_quark(): GLib.Quark;

    /**
     * Registers an error quark for {@link NMClient.DeviceBridge} if necessary.
     * @returns the error quark used for {@link NMClient.DeviceBridge} errors.
     * @since 0.9.8
     */
    ...
    /**
     * Registers an error quark for {@link NMClient.DeviceBt} if necessary.
     * @returns the error quark used for {@link NMClient.DeviceBt} errors.
     */
    function device_bt_error_quark(): GLib.Quark;

    /**
     * Registers an error quark for {@link NMClient.Device} if necessary.
     * @returns the error quark used for {@link NMClient.Device} errors.
     * @since 0.9.10
     */
    ...
    /**
     * Registers an error quark for {@link NMClient.DeviceEthernet} if necessary.
     * @returns the error quark used for {@link NMClient.DeviceEthernet} errors.
     */
    function device_ethernet_error_quark(): GLib.Quark;

    /**
     * Registers an error quark for {@link NMClient.DeviceGeneric} if necessary.
     * @returns the error quark used for {@link NMClient.DeviceGeneric} errors.
     * @since 0.9.10
     */
    ...
    /**
     * Registers an error quark for {@link NMClient.DeviceInfiniband} if necessary.
     * @returns the error quark used for {@link NMClient.DeviceInfiniband} errors.
     */
    function device_infiniband_error_quark(): GLib.Quark;

    /**
     * Registers an error quark for {@link NMClient.DeviceModem} if necessary.
     * @returns the error quark used for {@link NMClient.DeviceModem} errors.
     */
    function device_modem_error_quark(): GLib.Quark;

    /**
     * Registers an error quark for {@link NMClient.DeviceOlpcMesh} if necessary.
     * @returns the error quark used for {@link NMClient.DeviceOlpcMesh} errors.
     */
    function device_olpc_mesh_error_quark(): GLib.Quark;

    /**
     * Registers an error quark for {@link NMClient.DeviceTeam} if necessary.
     * @returns the error quark used for {@link NMClient.DeviceTeam} errors.
     * @since 0.9.10
     */
    ...
    /**
     * Registers an error quark for {@link NMClient.DeviceVlan} if necessary.
     * @returns the error quark used for {@link NMClient.DeviceVlan} errors.
     */
    function device_vlan_error_quark(): GLib.Quark;

    /**
     * Registers an error quark for {@link NMClient.DeviceWifi} if necessary.
     * @returns the error quark used for {@link NMClient.DeviceWifi} errors.
     */
    function device_wifi_error_quark(): GLib.Quark;

    /**
     * Registers an error quark for {@link NMClient.DeviceWimax} if necessary.
     * @returns the error quark used for {@link NMClient.DeviceWimax} errors.
    ...
    /**
     * Registers an error quark for {@link NMClient.Object} if necessary.
     * @returns the error quark used for {@link NMClient.Object} errors.
     */
    function object_error_quark(): GLib.Quark;

    /**
     * Registers an error quark for {@link NMClient.RemoteConnection} if necessary.
     * @returns the error quark used for {@link NMClient.RemoteConnection} errors.
     */
    function remote_connection_error_quark(): GLib.Quark;

    /**
     * Registers an error quark for {@link NMClient.RemoteSettings} if necessary.
     * @returns the error quark used for {@link NMClient.RemoteSettings} errors.
     */
    ...
    /**
     * {@link NMClient.SecretAgentCapabilities} indicate various capabilities of the agent.
     * @gir-type Flags
     * @since 0.9.10
     */
    ...
    /**
     * {@link NMClient.SecretAgentGetSecretsFlags} values modify the behavior of a GetSecrets request.
     * @gir-type Flags
     */
    ...
    class AccessPoint extends Object implements Gio.AsyncInitable<AccessPoint>, Gio.Initable {
         ...
         * channel, band, etc.
         * @param connection an {@link NetworkManager.Connection} to validate against `ap`
        ...
        /**
         * Filters a given list of connections for a given {@link NMClient.AccessPoint} object and
         ...
         * for a given {@link NMClient.Device} using `nm_device_filter_connections()` and finally
         * filter that list with this function.
         * @param connections a list of {@link NetworkManager.Connection} objects to filter
         * @returns a list of {@link NetworkManager.Connection} objects that could be activated with the given `ap`. The elements of the list are owned by their creator and should not be freed by the caller, but the returned list itself is owned by the caller and should be freed with `g_slist_free()` when it is no longer required.
         */
         ...
         * @returns the {@link GLib.ByteArray} containing the SSID. This is the internal copy used by the access point, and must not be modified.
         */
        get_ssid(): Uint8Array;
    ...
    namespace ActiveConnection {
        ...
        interface ConstructorProps extends Object.ConstructorProps, Gio.AsyncInitable.ConstructorProps, Gio.Initable.ConstructorProps {
            ...
            default6: boolean;
            devices: ObjectArray;
            dhcp4_config: DHCP4Config;
            dhcp4Config: DHCP4Config;
            dhcp6_config: DHCP6Config;
            dhcp6Config: DHCP6Config;
            id: string;
            ip4_config: IP4Config;
            ip4Config: IP4Config;
    ...
    class ActiveConnection extends Object implements Gio.AsyncInitable<ActiveConnection>, Gio.Initable {
        ...
        // Methods
        /**
         * Gets the {@link NetworkManager.Connection}'s DBus object path.  This is often used with
         * `nm_remote_settings_get_connection_by_path()` to retrieve the
         * {@link NMClient.RemoteConnection} object that describes the connection.
         * @returns the object path of the {@link NetworkManager.Connection} which this {@link NMClient.ActiveConnection} is an active instance of.  This is the internal string used by the connection, and must not be modified.
         */
         ...
         * @param args 
         */
    // Conflicted with NMClient.Object.get_connection
        get_connection(...args: never[]): any;
         ...
         * @returns the {@link GLib.PtrArray} containing `NMDevices`. This is the internal copy used by the connection, and must not be modified.
         */
        get_devices(): Device[];
        ...
        /**
         * Gets the path to the master {@link NMClient.Device} of the connection.
         * @returns the path of the master {@link NMClient.Device} of the {@link NMClient.ActiveConnection}. This is the internal string used by the connection, and must not be modified.
         */
        get_master(): string;
        ...
        /**
         * Gets the {@link NetworkManager.Connection}'s UUID.
         * @returns the UUID of the {@link NetworkManager.Connection} that backs the {@link NMClient.ActiveConnection}. This is the internal string used by the connection, and must not be modified.
         */
        get_uuid(): string;
    ...
    class Client extends Object implements Gio.AsyncInitable<Client>, Gio.Initable {
        ...
        // Static methods
        /**
         * Creates a new {@link NMClient.Client} and begins asynchronously initializing it.
         ...
         * 
         * NOTE: {@link NMClient.Client} provides information about devices and a mechanism to
         * control them.  To access and modify network configuration data, use the
         * {@link NMClient.RemoteSettings} object.
         ...
         * specific object, like an {@link NMClient.AccessPoint} for Wi-Fi connections, or an
         * {@link NMClient.WimaxNsp} for WiMAX connections, to which you wish to connect.  If the
         ...
         * {@link NMClient.ActiveConnection} object (in particular, {@link NMClient.ActiveConnection.state}) to
         * track the activation to its completion.
         * @param connection an {@link NetworkManager.Connection}
         * @param device the {@link NMClient.Device}
         * @param specific_object the object path of a connection-type-specific   object this activation should use. This parameter is currently ignored for   wired and mobile broadband connections, and the value of `null` should be used   (ie, no specific object).  For Wi-Fi or WiMAX connections, pass the object   path of a {@link NMClient.AccessPoint} or {@link NMClient.WimaxNsp} owned by `device`, which you can   get using `nm_object_get_path()`, and which will be used to complete the   details of the newly added connection.
         ...
         * {@link NMClient.ActiveConnection} object (in particular, {@link NMClient.ActiveConnection.state}) to
         * track the activation to its completion.
         * @param partial an {@link NetworkManager.Connection} to add; the connection may be   partially filled (or even `null`) and will be completed by NetworkManager   using the given `device` and `specific_object` before being added
         * @param device the {@link NMClient.Device}
         * @param specific_object the object path of a connection-type-specific   object this activation should use. This parameter is currently ignored for   wired and mobile broadband connections, and the value of `null` should be used   (ie, no specific object).  For Wi-Fi or WiMAX connections, pass the object   path of a {@link NMClient.AccessPoint} or {@link NMClient.WimaxNsp} owned by `device`, which you can   get using `nm_object_get_path()`, and which will be used to complete the   details of the newly added connection.
         * @param callback the function to call when the call is done
         */
        ...
        /**
         * Deactivates an active {@link NMClient.ActiveConnection}.
         * @param active the {@link NMClient.ActiveConnection} to deactivate
         */
        deactivate_connection(active: ActiveConnection): void;

        /**
         * Gets the {@link NMClient.ActiveConnection} corresponding to a
         ...
         * @returns a {@link GLib.PtrArray}  containing all the active `NMActiveConnections`. The returned array is owned by the client and should not be modified.
         */
        ...
        /**
         * Gets a {@link NMClient.Device} from a {@link NMClient.Client}.
         * @param iface the interface name to search for
         * @returns the {@link NMClient.Device} for the given `iface` or `null` if none is found.
         */
         ...
         * @returns the {@link NMClient.Device} for the given `object_path` or `null` if none is found.
         */
         ...
         * @param permission the permission for which to return the result, one of {@link NMClient.ClientPermission}
         * @returns the permission's result, one of {@link NMClient.ClientPermissionResult}
         */
        get_permission_result(permission: ClientPermission): ClientPermissionResult;

        /**
         * Gets the {@link NMClient.ActiveConnection} corresponding to the primary active
         * network device.
         * 
    ...
    namespace Device {
        ...
        interface ConstructorProps extends Object.ConstructorProps, Gio.AsyncInitable.ConstructorProps, Gio.Initable.ConstructorProps {
            ...
            autoconnect: boolean;
            available_connections: ObjectArray;
            availableConnections: ObjectArray;
            capabilities: number;
            device_type: number;
            deviceType: number;
            dhcp4_config: DHCP4Config;
    ...
    class Device extends Object implements Gio.AsyncInitable<Device>, Gio.Initable {
        ...
        // Virtual methods
        /**
         * Validates a given connection for a given {@link NMClient.Device} object and returns
    ...
    // Conflicted with GObject.Object.disconnect
        ...
        /**
         * Filters a given list of connections for a given {@link NMClient.Device} object and return
         ...
         * @param connections a list of {@link NetworkManager.Connection} objects to filter
         * @returns a list of {@link NetworkManager.Connection} objects that could be activated with the given `device`. The elements of the list are owned by their creator and should not be freed by the caller, but the returned list itself is owned by the caller and should be freed with `g_slist_free()` when it is no longer required.
         */
        filter_connections(connections: NetworkManager.Connection[]): NetworkManager.Connection[];

        /**
         * Gets the {@link NMClient.ActiveConnection} object which owns this device during activation.
         * @returns the {@link NMClient.ActiveConnection} or `null` if the device is not part of an active connection
         */
        get_active_connection(): ActiveConnection;

        /**
         * Whether the {@link NMClient.Device} can be autoconnected.
        ...
        /**
         * Returns the numeric type of the {@link NMClient.Device}, ie Ethernet, Wi-Fi, etc.
         * @returns the device type
         */
        get_device_type(): NetworkManager.DeviceType;

        /**
         * Gets the current {@link NMClient.DHCP4Config} associated with the {@link NMClient.Device}.
         * 
         ...
         * connections.
         * @returns the {@link NMClient.DHCP4Config} or `null` if the device is not activated or not using DHCP.
         */
        get_dhcp4_config(): DHCP4Config;

        /**
         * Gets the current {@link NMClient.DHCP6Config} associated with the {@link NMClient.Device}.
         * 
         * Note that as of NetworkManager 0.9.10, you can alternatively use
         * `nm_active_connection_get_dhcp6_config()`, which also works with VPN
         * connections.
         * @returns the {@link NMClient.DHCP6Config} or `null` if the device is not activated or not using DHCP.
         */
        get_dhcp6_config(): DHCP6Config;

        /**
         * Gets the driver of the {@link NMClient.Device}.
         * @returns the driver of the device. This is the internal string used by the device, and must not be modified.
         */
        get_driver(): string;

        /**
         * Gets the driver version of the {@link NMClient.Device}.
        ...
        /**
         * Gets the firmware version of the {@link NMClient.Device}.
        ...
        /**
         * Gets the interface name of the {@link NMClient.Device}.
         * @returns the interface of the device. This is the internal string used by the device, and must not be modified.
         */
        get_iface(): string;

        /**
         * Gets the current {@link NMClient.IP4Config} associated with the {@link NMClient.Device}.
         * 
         * Note that as of NetworkManager 0.9.10, you can alternatively use
         * `nm_active_connection_get_ip4_config()`, which also works with VPN
         * connections.
         * @returns the {@link NMClient.IP4Config} or `null` if the device is not activated.
         */
        get_ip4_config(): IP4Config;

        /**
         * Gets the current {@link NMClient.IP6Config} associated with the {@link NMClient.Device}.
         * 
         * Note that as of NetworkManager 0.9.10, you can alternatively use
         * `nm_active_connection_get_ip6_config()`, which also works with VPN
         * connections.
         * @returns the {@link NMClient.IP6Config} or `null` if the device is not activated.
         */
        get_ip6_config(): IP6Config;

        /**
         * Gets the IP interface name of the {@link NMClient.Device} over which IP traffic flows
        ...
        /**
         * Whether the {@link NMClient.Device} is managed by NetworkManager.
        ...
        /**
         * Gets the physical port ID of the {@link NMClient.Device}. If non-`null`, this is
        ...
        /**
         * Gets the product string of the {@link NMClient.Device}.
        ...
        /**
         * Gets the current {@link NMClient.Device} state.
         * @returns the current device state
         */
        get_state(): NetworkManager.DeviceState;

        /**
         * Gets the current {@link NMClient.Device} state (return value) and the reason for entering
        ...
        /**
         * Gets the Unique Device Identifier of the {@link NMClient.Device}.
        ...
        /**
         * Gets the vendor string of the {@link NMClient.Device}.
        ...
        /**
         * Enables or disables automatic activation of the {@link NMClient.Device}.
    ...
    namespace DeviceAdsl {
        ...
        // Constructor properties interface
        interface ConstructorProps extends Device.ConstructorProps, Gio.AsyncInitable.ConstructorProps, Gio.Initable.ConstructorProps {
            carrier: boolean;
        }
    }
    ...
    class DeviceAdsl extends Device implements Gio.AsyncInitable<DeviceAdsl>, Gio.Initable {
         ...
         * @param args 
         */
        // Conflicted with NMClient.Device.disconnect
        disconnect(...args: never[]): any;
    }
    ...
    class DeviceBond extends Device implements Gio.AsyncInitable<DeviceBond>, Gio.Initable {
        ...
        /**
         * Gets the hardware (MAC) address of the {@link NMClient.DeviceBond}
    ...
    class DeviceBt extends Device implements Gio.AsyncInitable<DeviceBt>, Gio.Initable {
         ...
         * @returns a combination of {@link NetworkManager.BluetoothCapabilities}
         */
         ...
         * @param args 
         */
    // Conflicted with NMClient.Device.get_capabilities
        get_capabilities(...args: never[]): any;

        /**
         * Gets the hardware (MAC) address of the {@link NMClient.DeviceBt}
         * @returns the hardware address. This is the internal string used by the device, and must not be modified.
         */
        get_hw_address(): string;

        /**
         * Gets the name of the {@link NMClient.DeviceBt}.
    ...
    class DeviceEthernet extends Device implements Gio.AsyncInitable<DeviceEthernet>, Gio.Initable {
        ...
        /**
         * Gets the active hardware (MAC) address of the {@link NMClient.DeviceEthernet}
         * @returns the active hardware address. This is the internal string used by the device, and must not be modified.
         */
        get_hw_address(): string;

        /**
         * Gets the permanent hardware (MAC) address of the {@link NMClient.DeviceEthernet}
        ...
        /**
         * Gets the speed of the {@link NMClient.DeviceEthernet} in Mbit/s.
    ...
    class DeviceInfiniband extends Device implements Gio.AsyncInitable<DeviceInfiniband>, Gio.Initable {
        ...
        /**
         * Gets the hardware (MAC) address of the {@link NMClient.DeviceInfiniband}
         * @returns the hardware address. This is the internal string used by the device, and must not be modified.
         */
        get_hw_address(): string;
    ...
    class DeviceOlpcMesh extends Device implements Gio.AsyncInitable<DeviceOlpcMesh>, Gio.Initable {
        ...
        // Methods
        /**
         * Returns the active channel of the {@link NMClient.DeviceOlpcMesh} device.
         * @returns active channel of the device
         */
        get_active_channel(): number;

        /**
         * Gets the companion device of the {@link NMClient.DeviceOlpcMesh}.
         * @returns the companion of the device of `null`
         */
        get_companion(): DeviceWifi;

        /**
         * Gets the hardware (MAC) address of the {@link NMClient.DeviceOlpcMesh}
         * @returns the hardware address. This is the internal string used by the device, and must not be modified.
         */
        get_hw_address(): string;
    ...
    class DeviceVlan extends Device implements Gio.AsyncInitable<DeviceVlan>, Gio.Initable {
        ...
        /**
         * Gets the hardware (MAC) address of the {@link NMClient.DeviceVlan}
         * @returns the hardware address. This is the internal string used by the device, and must not be modified.
         */
        get_hw_address(): string;
    ...
    class DeviceWifi extends Device implements Gio.AsyncInitable<DeviceWifi>, Gio.Initable {
        ...
        // Methods
        /**
         * Gets a {@link NMClient.AccessPoint} by path.
        ...
        /**
         * Gets all the scanned access points of the {@link NMClient.DeviceWifi}.
         * @returns a {@link GLib.PtrArray} containing all the scanned `NMAccessPoints`. The returned array is owned by the client and should not be modified.
         */
        get_access_points(): AccessPoint[];

        /**
         * Gets the active {@link NMClient.AccessPoint}.
         * @returns the access point or `null` if none is active
         */
        get_active_access_point(): AccessPoint;

        /**
         * Gets the bit rate of the {@link NMClient.DeviceWifi} in kbit/s.
         * @returns the bit rate (kbit/s)
         */
        get_bitrate(): number;

        /**
         * Gets the Wi-Fi capabilities of the {@link NMClient.DeviceWifi}.
         * @returns the capabilities
         */
    ...
    // Conflicted with NMClient.Device.get_capabilities
        ...
        /**
         * Gets the actual hardware (MAC) address of the {@link NMClient.DeviceWifi}
         * @returns the actual hardware address. This is the internal string used by the device, and must not be modified.
         */
        get_hw_address(): string;

        /**
         * Gets the {@link NMClient.DeviceWifi} mode.
         * @returns the mode
         */
        get_mode(): NetworkManager.__80211Mode;

        /**
         * Gets the permanent hardware (MAC) address of the {@link NMClient.DeviceWifi}
         * @returns the permanent hardware address. This is the internal string used by the device, and must not be modified.
         */
        get_permanent_hw_address(): string;

        /**
         * Request NM to scan for access points on the {@link NMClient.DeviceWifi}. This function only
    ...
    class IP4Config extends Object implements Gio.AsyncInitable<IP4Config>, Gio.Initable {
         ...
         * @returns the {@link GLib.SList} containing {@link NetworkManager.IP4Address}<!-- -->es. This is the internal copy used by the configuration and must not be modified.
         */
        get_addresses(): NetworkManager.IP4Address[];

        /**
         * Gets the domain names.
         * @returns the {@link GLib.PtrArray} containing domains as strings. This is the internal copy used by the configuration, and must not be modified.
         */
        get_domains(): string[];
         ...
         * @returns the {@link GLib.Array} containing #guint32s. This is the internal copy used by the configuration and must not be modified.
         */
        get_nameservers(): number[];

        /**
         * Gets the routes.
         * @returns the {@link GLib.SList} containing {@link NetworkManager.IP4Route}<!-- -->s. This is the internal copy used by the configuration, and must not be modified.
         */
    ...
    namespace IP6Config {
        ...
        interface ConstructorProps extends Object.ConstructorProps, Gio.AsyncInitable.ConstructorProps, Gio.Initable.ConstructorProps {
            ...
            domains: StringArray;
            gateway: string;
            nameservers: IP6AddressArray;
            routes: IP6RouteObjectArray;
            searches: StringArray;
        }
    }
    ...
    class IP6Config extends Object implements Gio.AsyncInitable<IP6Config>, Gio.Initable {
         ...
         * @returns the {@link GLib.SList} containing {@link NetworkManager.IP6Address}<!-- -->es. This is the internal copy used by the configuration and must not be modified.
         */
        ...
        /**
         * Gets the routes.
         * @returns the {@link GLib.SList} containing {@link NetworkManager.IP6Route}<!-- -->s. This is the internal copy used by the configuration, and must not be modified.
         */
    ...
    namespace Object {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
            /**
             * Indicates that an error occurred while creating an {@link NMClient.Object} object
    ...
    abstract class Object extends GObject.Object implements Gio.AsyncInitable<Object>, Gio.Initable {
        ...
        // Methods
        /**
         * Gets the {@link NMClient.Object}'s DBusGConnection.
         * @returns the connection
         */
        get_connection(): DBusGLib.Connection;

        /**
         * Gets the DBus path of the {@link NMClient.Object}.
    ...
    namespace RemoteConnection {
        ...
        // Constructor properties interface
        interface ConstructorProps extends NetworkManager.Connection.ConstructorProps, Gio.AsyncInitable.ConstructorProps, Gio.Initable.ConstructorProps {
            dbus_path: string;
            dbusPath: string;
            unsaved: boolean;
        }
     ...
     * @gir-type Class
     */
    class RemoteConnection extends NetworkManager.Connection implements Gio.AsyncInitable<RemoteConnection>, Gio.Initable {
        ...
        // Conflicted with NetworkManager.Connection.new
         ...
         * @param setting_name the {@link NetworkManager.Setting} object name to get secrets for
    ...
    class RemoteSettings extends GObject.Object implements Gio.AsyncInitable<RemoteSettings>, Gio.Initable {
         ...
         * add.  The {@link NMClient.RemoteConnection} object that represents what NetworkManager
         * actually added is returned to `callback` when the addition operation is complete.
         * 
         * Note that the {@link NMClient.RemoteConnection} returned in `callback` may not contain
    ...
    abstract class SecretAgent extends GObject.Object {
         ...
         * `connection`.
         * @param connection a {@link NetworkManager.Connection}
         * @param connection_path 
         ...
         * @param connection the {@link NetworkManager.Connection} for which we're asked secrets
         * @param connection_path 
        ...
        /**
         * Registers the {@link NMClient.SecretAgent} with the NetworkManager secret manager,
        ...
        /**
         * Unregisters the {@link NMClient.SecretAgent} with the NetworkManager secret manager,
    ...
    namespace VPNConnection {
        ...
        // Constructor properties interface
        interface ConstructorProps extends ActiveConnection.ConstructorProps, Gio.AsyncInitable.ConstructorProps, Gio.Initable.ConstructorProps {
            banner: string;
            vpn_state: number;
            vpnState: number;
        }
    ...
    class VPNConnection extends ActiveConnection implements Gio.AsyncInitable<VPNConnection>, Gio.Initable {
        ...
        // Methods
        /**
         * Gets the VPN login banner of the active {@link NMClient.VPNConnection}.
        ...
        /**
         * Gets the current {@link NMClient.VPNConnection} state.
    ...
    class WimaxNsp extends Object implements Gio.AsyncInitable<WimaxNsp>, Gio.Initable {
         ...
         * @param connection an {@link NetworkManager.Connection} to validate against `nsp`
         * @returns `true` if the connection may be activated with this WiMAX NSP, `false` if it cannot be.
         */
        connection_valid(connection: NetworkManager.Connection): boolean;

        /**
         * Filters a given list of connections for a given {@link NMClient.WimaxNsp} object and
         * return connections which may be activated with the access point.  Any
         * returned connections will match the `nsp`'s network name and other attributes.
         * @param connections a list of {@link NetworkManager.Connection} objects to filter
         * @returns a list of {@link NetworkManager.Connection} objects that could be activated with the given `nsp`. The elements of the list are owned by their creator and should not be freed by the caller, but the returned list itself is owned by the caller and should be freed with `g_slist_free()` when it is no longer required.
         */
        filter_connections(connections: NetworkManager.Connection[]): NetworkManager.Connection[];
     ...
     * @gir-type Alias
     */
    type DHCP4ConfigClass = typeof DHCP4Config;

    /**
     * @gir-type Alias
     */
    type DHCP6ConfigClass = typeof DHCP6Config;
     ...
     * @gir-type Alias
     */
    type IP4ConfigClass = typeof IP4Config;

    /**
     * @gir-type Alias
     */
    type IP6ConfigClass = typeof IP6Config;
     ...
     * @gir-type Alias
     */
    type RemoteSettingsClass = typeof RemoteSettings;

    /**
     * @gir-type Alias
     */
    type SecretAgentClass = typeof SecretAgent;

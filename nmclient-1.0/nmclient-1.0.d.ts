...
static new_finish(...args: never[]): any;
    ...
    connect(signal: 'permission-changed', callback: ((_source: this, permission: number, result: number) => void)): number
    connect_after(signal: 'permission-changed', callback: ((_source: this, permission: number, result: number) => void)): number
...
static ["new"](connection: DBusGLib.Connection, path: string): Device;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'state-changed', callback: ((_source: this, new_state: number, old_state: number, reason: number) => void)): number
    connect_after(signal: 'state-changed', callback: ((_source: this, new_state: number, old_state: number, reason: number) => void)): number
...
_init(...args: any[]): void;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'object-creation-failed', callback: ((_source: this, error: any | null, failed_path: any | null) => void)): number
    connect_after(signal: 'object-creation-failed', callback: ((_source: this, error: any | null, failed_path: any | null) => void)): number

...
export namespace NMClient {
    ...
    class Client extends Object implements Gio.AsyncInitable<Client>, Gio.Initable {
        ...
        check_connectivity_async(
            cancellable: Gio.Cancellable | null,
        ): globalThis.Promise<NetworkManager.ConnectivityState>;
        /**
         * Asynchronously updates the network connectivity state and invokes
         * `callback` when complete. Contrast `nm_client_get_connectivity()`,
         * which (immediately) returns the most recent known state without
        ...
        check_connectivity_async(
            cancellable: Gio.Cancellable | null,
            callback?: Gio.AsyncReadyCallback<this> | null,
        ): globalThis.Promise<NetworkManager.ConnectivityState> | void;
        /**
    ...
    class Device extends Object implements Gio.AsyncInitable<Device>, Gio.Initable {
         ...
         */
        vfunc_state_changed(
            new_state: NetworkManager.DeviceState,
            old_state: NetworkManager.DeviceState,
    ...
    abstract class SecretAgent extends GObject.Object {
        ...
        vfunc_delete_secrets(
            ...
            callback: SecretAgentDeleteSecretsFunc,
        ): void;
        /**

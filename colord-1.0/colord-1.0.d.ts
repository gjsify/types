...
export namespace Colord {
    ...
    class Client extends GObject.Object {
        // Own properties of Colord-1.0.Client
        ...
        // Constructors of Colord-1.0.Client

        static ['new'](): Client;

        // Owm methods of Colord-1.0.Client
    ...
    class Device extends GObject.Object {
        // Own properties of Colord-1.0.Device
        ...
        // Constructors of Colord-1.0.Device

        static ['new'](): Device;

        static new_with_object_path(object_path: string): Device;

        // Owm methods of Colord-1.0.Device
    ...
    class Edid extends GObject.Object {
        // Constructors of Colord-1.0.Edid

        static ['new'](): Edid;

        // Owm methods of Colord-1.0.Edid
    ...
    class Icc extends GObject.Object {
        // Own properties of Colord-1.0.Icc
        ...
        // Constructors of Colord-1.0.Icc

        static ['new'](): Icc;

        // Owm methods of Colord-1.0.Icc
    ...
    class It8 extends GObject.Object {
        // Own properties of Colord-1.0.It8
        ...
        // Constructors of Colord-1.0.It8

        static ['new'](): It8;

        static new_with_kind(kind: It8Kind): It8;

        // Owm methods of Colord-1.0.It8
    ...
    class Profile extends GObject.Object {
        // Own properties of Colord-1.0.Profile
        ...
        // Constructors of Colord-1.0.Profile

        static ['new'](): Profile;

        static new_with_object_path(object_path: string): Profile;

        // Owm methods of Colord-1.0.Profile
    ...
    class Sensor extends GObject.Object {
        // Own properties of Colord-1.0.Sensor
        ...
        // Constructors of Colord-1.0.Sensor

        static ['new'](): Sensor;

        static new_with_object_path(object_path: string): Sensor;

        // Owm methods of Colord-1.0.Sensor
    ...
    class ColorLab {
        // Own fields of Colord-1.0.ColorLab

        L: number;
        a: number;
        b: number;

        // Constructors of Colord-1.0.ColorLab
        ...
        // Owm methods of Colord-1.0.ColorLab
    ...
    class ColorRGB {
        // Own fields of Colord-1.0.ColorRGB

        R: number;
        G: number;
        B: number;

        // Constructors of Colord-1.0.ColorRGB
        ...
        // Owm methods of Colord-1.0.ColorRGB
    ...
    class ColorRGB8 {
        // Own fields of Colord-1.0.ColorRGB8

        R: number;
        G: number;
        B: number;

        // Constructors of Colord-1.0.ColorRGB8
    ...
    class ColorSwatch {
        // Constructors of Colord-1.0.ColorSwatch

        constructor(properties?: Partial<{}>);

        static ['new'](): ColorSwatch;

        // Owm methods of Colord-1.0.ColorSwatch
    ...
    class ColorUVW {
        // Own fields of Colord-1.0.ColorUVW

        U: number;
        V: number;
        W: number;

        // Constructors of Colord-1.0.ColorUVW
        ...
        // Owm methods of Colord-1.0.ColorUVW
    ...
    class ColorXYZ {
        // Own fields of Colord-1.0.ColorXYZ

        X: number;
        Y: number;
        Z: number;

        // Constructors of Colord-1.0.ColorXYZ
        ...
        // Owm methods of Colord-1.0.ColorXYZ
    ...
    class ColorYxy {
        // Own fields of Colord-1.0.ColorYxy

        Y: number;
        x: number;
        y: number;

        // Constructors of Colord-1.0.ColorYxy
        ...
        // Owm methods of Colord-1.0.ColorYxy
    ...
    class Mat3x3 {
        // Own fields of Colord-1.0.Mat3x3
        ...
        // Constructors of Colord-1.0.Mat3x3
    ...
    class Spectrum {
        // Constructors of Colord-1.0.Spectrum
        ...
        // Owm methods of Colord-1.0.Spectrum
    ...
    class Vec3 {
        // Own fields of Colord-1.0.Vec3

        v0: number;
        v1: number;
        v2: number;

        // Constructors of Colord-1.0.Vec3
        ...
        // Owm methods of Colord-1.0.Vec3

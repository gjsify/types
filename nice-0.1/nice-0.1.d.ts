...
static new_reliable(ctx: GLib.MainContext, compat: Compatibility): Agent;
    ...
    connect(signal: 'component-state-changed', callback: ((_source: this, stream_id: number, component_id: number, state: number) => void)): number
    connect_after(signal: 'component-state-changed', callback: ((_source: this, stream_id: number, component_id: number, state: number) => void)): number
    ...
    connect_after(signal: 'initial-binding-request-received', callback: ((_source: this, stream_id: number) => void)): number
    emit(signal: 'initial-binding-request-received', stream_id: number): void
    connect(signal: 'new-candidate', callback: ((_source: this, stream_id: number, component_id: number, foundation: string) => void)): number
    connect_after(signal: 'new-candidate', callback: ((_source: this, stream_id: number, component_id: number, foundation: string) => void)): number
    ...
    connect(signal: 'new-remote-candidate', callback: ((_source: this, stream_id: number, component_id: number, foundation: string) => void)): number
    connect_after(signal: 'new-remote-candidate', callback: ((_source: this, stream_id: number, component_id: number, foundation: string) => void)): number
    ...
    connect(signal: 'new-selected-pair', callback: ((_source: this, stream_id: number, component_id: number, lfoundation: string, rfoundation: string) => void)): number
    connect_after(signal: 'new-selected-pair', callback: ((_source: this, stream_id: number, component_id: number, lfoundation: string, rfoundation: string) => void)): number
    emit(signal: 'new-selected-pair', stream_id: number, component_id: number, lfoundation: string, rfoundation: string): void
    connect(signal: 'new-selected-pair-full', callback: ((_source: this, stream_id: number, component_id: number, lcandidate: Candidate, rcandidate: Candidate) => void)): number
    connect_after(signal: 'new-selected-pair-full', callback: ((_source: this, stream_id: number, component_id: number, lcandidate: Candidate, rcandidate: Candidate) => void)): number
    emit(signal: 'new-selected-pair-full', stream_id: number, component_id: number, lcandidate: Candidate, rcandidate: Candidate): void
    connect(signal: 'reliable-transport-writable', callback: ((_source: this, stream_id: number, component_id: number) => void)): number
    connect_after(signal: 'reliable-transport-writable', callback: ((_source: this, stream_id: number, component_id: number) => void)): number

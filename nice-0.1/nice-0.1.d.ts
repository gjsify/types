...
export namespace Nice {
    ...
    class Agent extends GObject.Object {
        // Own properties of Nice-0.1.Agent
        ...
        // Constructors of Nice-0.1.Agent
         ...
         */
        get_local_credentials(stream_id: number): boolean;
        /**
         ...
         */
        recv(stream_id: number, component_id: number, cancellable?: Gio.Cancellable | null): number;
        /**
         ...
         */
        recv_messages(stream_id: number, component_id: number, cancellable?: Gio.Cancellable | null): number;
        /**
         ...
         */
        recv_nonblocking(stream_id: number, component_id: number, cancellable?: Gio.Cancellable | null): number;
        /**
    ...
    class PseudoTcpSocket extends GObject.Object {
        // Own properties of Nice-0.1.PseudoTcpSocket
        ...
        // Constructors of Nice-0.1.PseudoTcpSocket

        static ['new'](conversation: number, callbacks: PseudoTcpCallbacks): PseudoTcpSocket;

        // Owm methods of Nice-0.1.PseudoTcpSocket
     ...
     */
    class Address {
        // Constructors of Nice-0.1.Address

        constructor(properties?: Partial<{}>);

        static ['new'](): Address;

        // Owm methods of Nice-0.1.Address
     ...
     */
    class Candidate {
        // Own fields of Nice-0.1.Candidate
     ...
     */
    class InputMessage {
        // Own fields of Nice-0.1.InputMessage
     ...
     */
    class OutputMessage {
        // Own fields of Nice-0.1.OutputMessage

        buffers: Gio.OutputVector[];
        n_buffers: number;

        // Constructors of Nice-0.1.OutputMessage
    ...
    class PseudoTcpCallbacks {
        // Own fields of Nice-0.1.PseudoTcpCallbacks

        user_data: any;

        // Constructors of Nice-0.1.PseudoTcpCallbacks

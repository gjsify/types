/**
 * The GIR-derived widget VOCABULARY for Nice-0.1.
 *
 ...
 *
 * 2 instantiable GTypes (of which 0 concrete widgets), 2 declarations, 0 enum nick unions, 0 slot candidates.
 *
...
export interface NiceAgentProps extends GObjectProps {
    /**
     * This property defines whether receive/send operations over a TCP socket, in reliable mode, are considered as packetized or as bytestream.
     * @since 0.1.8
     * @default FALSE
     */
    'bytestream-tcp'?: boolean;
    /**
     * Whether to omit performing retransmissions and wait for a response for the 0-lifetime refresh request that is sent by nice_agent_close_async().
     * @since 0.1.23
     * @default FALSE
     */
    ...
    /**
     * Whether to perform periodic consent freshness checks as specified in RFC 7675.
     * @since 0.1.19
     * @default FALSE
     */
    'consent-freshness'?: boolean;
    /**
     * Whether the agent has the controlling role.
     * @default FALSE
     */
    'controlling-mode'?: boolean;
    /**
     * Force all traffic to go through a relay for added privacy, this allows hiding the local IP address.
     * @since 0.1.14
     * @default FALSE
     */
    'force-relay'?: boolean;
    ...
    'idle-timeout'?: number;
    /**
     * Use binding requests as keepalives instead of binding indications.
     * @since 0.1.8
     * @default FALSE
     */
     ...
     * @since 0.1.20
     */
    'proxy-extra-headers'?: GLib.HashTable;
    /**
    ...
    reliable?: boolean;
    /**
     * The initial timeout (msecs) of the STUN binding requests used in the gathering stage, to find our local candidates.
     * @since 0.1.15
     * @default 500
     */
    'stun-initial-timeout'?: number;
    /**
     * The maximum number of retransmissions of the STUN binding requests used in the gathering stage, to find our local candidates, and used in the connection check stage, to test the validity of each cons…
     * @since 0.1.15
     * @default 3
     */
    ...
    /**
     * Support RENOMINATION STUN attribute proposed here: https://tools.ietf.org/html/draft-thatcher-ice-renomination-00 As soon as RENOMINATION attribute is received from remote candidate's address, corres…
     * @default FALSE
     */
...
export type NiceAgentConstructOnly = GObjectConstructOnly | 'close-forced' | 'compatibility' | 'full-mode' | 'main-context' | 'reliable';

/** The #PseudoTcpSocket is the GObject implementing the Pseudo TCP Socket */
export interface PseudoTcpSocketProps extends GObjectProps {
    /** @default 100 */
    'ack-delay'?: number;
    callbacks?: never;
    /** @default 0 */
    ...
    'snd-buf'?: number;
    /**
     * Whether to support the FIN–ACK extension to the pseudo-TCP protocol for this socket.
     * @since 0.1.8
     * @default TRUE
     */
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type PseudoTcpSocketConstructOnly = GObjectConstructOnly | 'conversation' | 'support-fin-ack';

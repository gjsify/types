 ...
 */
export function codecUtilsOpusCreateCaps(rate: number, channels: number, channelMappingFamily: number, streamCount: number, coupledCount: number, channelMapping: Uint8Array | null): Gst.Caps | null
/**
 ...
 */
export function codecUtilsOpusCreateHeader(rate: number, channels: number, channelMappingFamily: number, streamCount: number, coupledCount: number, channelMapping: Uint8Array | null, preSkip: number, outputGain: number): Gst.Buffer | null
/**

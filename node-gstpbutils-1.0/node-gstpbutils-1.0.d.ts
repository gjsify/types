 ...
 */
function codecUtilsAacCapsSetLevelAndProfile(caps: Gst.Caps, audioConfig: number[]): boolean
/**
 ...
 */
function codecUtilsAacGetChannels(audioConfig: number[]): number
/**
 ...
 */
function codecUtilsAacGetLevel(audioConfig: number[]): string | null
/**
 ...
 */
function codecUtilsAacGetProfile(audioConfig: number[]): string | null
/**
 ...
 */
function codecUtilsAacGetSampleRate(audioConfig: number[]): number
/**
 * Translates the sample rate index found in AAC headers to the actual sample
 * rate.
 ...
 * @returns %TRUE if the level and profile could be set, %FALSE otherwise.
 */
function codecUtilsH264CapsSetLevelAndProfile(caps: Gst.Caps, sps: number[]): boolean
/**
 ...
 */
function codecUtilsH264GetLevel(sps: number[]): string | null
/**
 ...
 */
function codecUtilsH264GetProfile(sps: number[]): string | null
/**
 ...
 */
function codecUtilsH264GetProfileFlagsLevel(codecData: number[]): [ /* returnType */ boolean, /* profile */ number, /* flags */ number, /* level */ number ]
/**
 ...
 */
function codecUtilsH265CapsSetLevelTierAndProfile(caps: Gst.Caps, profileTierLevel: number[]): boolean
/**
 ...
 * @returns The level as a const string, or %NULL if there is an error.
 */
function codecUtilsH265GetLevel(profileTierLevel: number[]): string | null
/**
 * Transform a level string from the caps into the level_idc
 * @param level A level string from caps
 * @returns the level_idc or 0 if the level is unknown
 ...
 * @returns The profile as a const string, or %NULL if there is an error.
 */
function codecUtilsH265GetProfile(profileTierLevel: number[]): string | null
/**
 ...
 */
function codecUtilsH265GetTier(profileTierLevel: number[]): string | null
/**
 ...
 * @returns %TRUE if the level and profile could be set, %FALSE otherwise.
 */
function codecUtilsMpeg4videoCapsSetLevelAndProfile(caps: Gst.Caps, visObjSeq: number[]): boolean
/**
 ...
 * @returns The level as a const string, or NULL if there is an error.
 */
function codecUtilsMpeg4videoGetLevel(visObjSeq: number[]): string | null
/**
 ...
 * @returns The profile as a const string, or NULL if there is an error.
 */
function codecUtilsMpeg4videoGetProfile(visObjSeq: number[]): string | null
/**
 ...
 */
function codecUtilsOpusCreateCaps(rate: number, channels: number, channelMappingFamily: number, streamCount: number, coupledCount: number, channelMapping: number[] | null): Gst.Caps | null
/**
 ...
 */
function codecUtilsOpusCreateHeader(rate: number, channels: number, channelMappingFamily: number, streamCount: number, coupledCount: number, channelMapping: number[] | null, preSkip: number, outputGain: number): Gst.Buffer | null
/**
 * Parses Opus caps and fills the different fields with defaults if possible.
 * @param caps the #GstCaps to parse the data from
 * @returns %TRUE if parsing was successful, %FALSE otherwise.
 */
function codecUtilsOpusParseCaps(caps: Gst.Caps): [ /* returnType */ boolean, /* rate */ number, /* channels */ number, /* channelMappingFamily */ number, /* streamCount */ number, /* coupledCount */ number, /* channelMapping */ number[] ]
/**
 * Parses the OpusHead header.
 * @param header the OpusHead #GstBuffer
 * @returns %TRUE if parsing was successful, %FALSE otherwise.
 */
function codecUtilsOpusParseHeader(header: Gst.Buffer): [ /* returnType */ boolean, /* rate */ number, /* channels */ number, /* channelMappingFamily */ number, /* streamCount */ number, /* coupledCount */ number, /* channelMapping */ number[], /* preSkip */ number, /* outputGain */ number ]
/**
 ...
 * @returns a newly-allocated detail string. Free string          with g_free() when not needed any longer.
 */
function missingElementInstallerDetailNew(factoryName: string): string | null
/**
 * Creates a missing-plugin message for `element` to notify the application
 ...
 * @returns a newly-allocated detail string. Free string          with g_free() when not needed any longer.
 */
function missingUriSinkInstallerDetailNew(protocol: string): string | null
/**
 * Creates a missing-plugin message for `element` to notify the application
 ...
 * @returns a newly-allocated detail string. Free string          with g_free() when not needed any longer.
 */
function missingUriSourceInstallerDetailNew(protocol: string): string | null
/**
 * Creates a missing-plugin message for `element` to notify the application
 ...
 * @returns a newly-allocated description string. Free          string with g_free() when not needed any longer.
 */
function pbUtilsGetElementDescription(factoryName: string): string | null
/**
 ...
 * @returns a newly-allocated description string. Free          string with g_free() when not needed any longer.
 */
function pbUtilsGetSinkDescription(protocol: string): string | null
/**
 ...
 * @returns a newly-allocated description string. Free          string with g_free() when not needed any longer.
 */
function pbUtilsGetSourceDescription(protocol: string): string | null
/**

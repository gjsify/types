...
import './node-tepl-6-import.d.ts';
 ...
 * @param fontStr a string representation of a #PangoFontDescription, or   %NULL to undo the effect of previous calls to this function on `widget`.
 */
...
export interface InfoBar extends Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
    ...
    parent: Gtk.InfoBar & Gtk.Box & Gtk.Container & Gtk.Container
    priv: InfoBarPrivate
     ...
     * @param handleCloseResponse the new value.
     */
    ...
    connect(sigName: "notify::handle-close-response", callback: (...args: any[]) => void): number
    on(sigName: "notify::handle-close-response", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::handle-close-response", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    ...
    connect(sigName: "notify::icon-from-message-type", callback: (...args: any[]) => void): number
    on(sigName: "notify::icon-from-message-type", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::icon-from-message-type", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
...
export module ProgressInfoBar {
    ...
    export interface ConstructorProperties extends Atk.ImplementorIface.ConstructorProperties, Gtk.Buildable.ConstructorProperties, Gtk.Orientable.ConstructorProperties, InfoBar.ConstructorProperties {
...
export interface ProgressInfoBar extends Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
    ...
    parent: InfoBar & Gtk.InfoBar & Gtk.Box & Gtk.Container & Gtk.Container
    priv: any
...
export class ProgressInfoBar extends InfoBar {
    ...
    constructor(iconName: string | null, markup: string | null, hasCancelButton: boolean) 
...
export interface ProgressInfoBarPrivate {
}

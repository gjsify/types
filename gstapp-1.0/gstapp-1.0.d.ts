...
_init(...args: any[]): void;
    ...
    connect_after(signal: 'try-pull-object', callback: ((_source: this, timeout: number) => (Gst.MiniObject | null))): number
...
_init(...args: any[]): void;
    ...
    connect(signal: 'push-buffer-list', callback: ((_source: this, buffer_list: Gst.BufferList) => Gst.FlowReturn)): number
    connect_after(signal: 'push-buffer-list', callback: ((_source: this, buffer_list: Gst.BufferList) => Gst.FlowReturn)): number

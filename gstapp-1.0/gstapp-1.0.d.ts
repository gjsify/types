...
module AppSink {
     ...
     */
    interface NewPrerollSignalCallback {
     ...
     */
    interface NewSampleSignalCallback {
        ($obj: AppSink): Gst.FlowReturn
    }
     ...
     */
    interface NewSerializedEventSignalCallback {
        ($obj: AppSink): boolean
    }
     ...
     */
    interface ProposeAllocationSignalCallback {
     ...
     */
    interface PullPrerollSignalCallback {
     ...
     */
    interface PullSampleSignalCallback {
        ($obj: AppSink): Gst.Sample | null
    }
     ...
     */
    interface TryPullObjectSignalCallback {
     ...
     */
    interface TryPullPrerollSignalCallback {
     ...
     */
    interface TryPullSampleSignalCallback {
        ($obj: AppSink, timeout: number): Gst.Sample | null
    }
    ...
    interface ConstructorProperties extends Gst.URIHandler.ConstructorProperties, GstBase.BaseSink.ConstructorProperties {
...
module AppSrc {
     ...
     */
    interface EnoughDataSignalCallback {
        ($obj: AppSrc): void
    }
     ...
     */
    interface NeedDataSignalCallback {
     ...
     */
    interface PushBufferSignalCallback {
     ...
     */
    interface PushBufferListSignalCallback {
     ...
     */
    interface PushSampleSignalCallback {
     ...
     */
    interface SeekDataSignalCallback {
    ...
    interface ConstructorProperties extends Gst.URIHandler.ConstructorProperties, GstBase.BaseSrc.ConstructorProperties {

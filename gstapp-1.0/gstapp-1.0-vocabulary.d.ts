/**
 * The GIR-derived widget VOCABULARY for GstApp-1.0.
 *
 ...
 *
 * 2 instantiable GTypes (of which 0 concrete widgets), 3 declarations (1 inlined from a namespace whose vocabulary does not emit them), 2 enum nick unions, 0 slot candidates.
 *
...
import type GstApp from './gstapp-1.0.js';
import type { GInitiallyUnownedConstructOnly, GInitiallyUnownedProps, GObjectConstructOnly, GObjectProps } from '@girs/gobject-2.0/vocabulary';
import type { GstElementConstructOnly, GstElementProps, GstFormatNick, GstObjectConstructOnly, GstObjectProps } from '@girs/gst-1.0/vocabulary';
import type { GstBaseSrcConstructOnly, GstBaseSrcProps } from '@girs/gstbase-1.0/vocabulary';
...
export type GstAppLeakyTypeNick = 'none' | 'upstream' | 'downstream';
export type GstAppStreamTypeNick = 'stream' | 'seekable' | 'random-access';
...
export interface GstAppSinkProps extends GstBaseSinkProps {
    /** @default FALSE */
    'buffer-list'?: boolean;
    caps?: Gst.Caps | null;
    /**
    ...
    /**
     * When set to any other value than GST_APP_LEAKY_TYPE_NONE then the appsink will drop any buffers that are pushed into it once its internal queue is full.
     * @since 1.28
     * @default GST_APP_LEAKY_TYPE_NONE
     */
    'leaky-type'?: GstAppLeakyTypeNick | GstApp.AppLeakyType;
    /**
...
export type GstAppSinkConstructOnly = GstBaseSinkConstructOnly;

/** The appsrc element can be used by applications to insert data into a GStreamer pipeline. */
export interface GstAppSrcProps extends GstBaseSrcProps {
    /**
     ...
     */
    format?: GstFormatNick | Gst.Format;
    /**
     * When enabled, appsrc will check GstSegment in GstSample which was pushed via gst_app_src_push_sample() or "push-sample" signal action.
     * @since 1.18
     * @default FALSE
     */
     ...
     */
    'stream-type'?: GstAppStreamTypeNick | GstApp.AppStreamType;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GstAppSrcConstructOnly = GstBaseSrcConstructOnly;

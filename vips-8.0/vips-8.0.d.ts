 ...
 */
function filename_get_filename(vips_filename: string): string | null
/**
 * Given a vips filename like "fred.jpg[Q=90]", return a new string of
 ...
 */
function filename_get_options(vips_filename: string): string | null
/**
 ...
 */
function path_filename7(path: string): string | null
/**
 * Return the mode part of a vips7 path. For testing only.
 * @param path path to split
 */
function path_mode7(path: string): string | null
/**

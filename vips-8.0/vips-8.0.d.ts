...
export namespace Vips {
     ...
     * @returns 0 if OK, -1 otherwise.
     */
    function check_matrix(domain: string, im: Image): number;
    /**
     ...
     */
    function col_Lab2XYZ(L: number, a: number, b: number): void;
    /**
     ...
     */
    function col_XYZ2Lab(X: number, Y: number, Z: number): void;
    /**
     * Turn XYZ into scRGB.
     *
     ...
     */
    function col_XYZ2scRGB(X: number, Y: number, Z: number): number;
     ...
     */
    function col_scRGB2XYZ(R: number, G: number, B: number): number;
     ...
     */
    function value_get_area(value: GObject.Value): any | null;
    /**
     ...
     */
    function value_get_array(value: GObject.Value): any | null;
    /**
     ...
     * @returns The pointer held by @value.
     */
    function value_get_blob(value: GObject.Value): any | null;
    /**
     * Get the C string held internally by the %GValue.
     * @param value %GValue to get from
     * @returns The C string held by @value.
     */
    function value_get_ref_string(value: GObject.Value): string;
    /**
     * Get the C string held internally by the GValue.
     * @param value GValue to get from
     * @returns The C string held by @value.
     ...
     */
    function value_set_array(n: number, type: GObject.GType, sizeof_type: number): void;
    /**
     ...
     * @param n the number of elements
     */
    function value_set_array_object(n: number): void;
    /**
     ...
     */
    function value_set_blob(free_fn: CallbackFn, length: number): void;
    /**
     ...
     */
    function value_set_ref_string(str: string): void;
    /**
     ...
     * @param str C string to copy into the GValue
     */
    function value_set_save_string(str: string): void;
    /**
    ...
    abstract class Foreign extends Operation {
        // Own fields of Vips-8.0.Foreign

        parent_object: Operation;

        // Owm methods of Vips-8.0.Foreign
    ...
    abstract class ForeignLoad extends Foreign {
        // Own properties of Vips-8.0.ForeignLoad
        ...
        // Own fields of Vips-8.0.ForeignLoad
    ...
    abstract class ForeignSave extends Foreign {
        // Own properties of Vips-8.0.ForeignSave
        ...
        // Own fields of Vips-8.0.ForeignSave
    ...
    class Image extends Object {
        // Own properties of Vips-8.0.Image
        ...
        // Constructors of Vips-8.0.Image
         ...
         * @returns 0 on success, -1 otherwise.
         */
        get_array_double(name: string): number;
        /**
         * Gets `out` from `im` under the name `name`.
         * The field must be of type
         * #VIPS_TYPE_ARRAY_INT.
         ...
         * @returns 0 on success, -1 otherwise.
         */
        get_array_int(name: string): number;
        /**
         ...
         * @returns 0 on success, -1 otherwise.
         */
        get_as_string(name: string): number;
        get_bands(): number;
        /**
         ...
         * @returns 0 on success, -1 on error.
         */
        icc_ac2rc(profile_filename: string): number;
        /**
    ...
    abstract class Interpolate extends Object {
        // Own fields of Vips-8.0.Interpolate

        parent_object: Object;

        // Constructors of Vips-8.0.Interpolate

        static ['new'](nickname: string): Interpolate;

        // Owm methods of Vips-8.0.Interpolate
    ...
    abstract class Object extends GObject.Object {
        // Own properties of Vips-8.0.Object

        description: string;
        nickname: string;

        // Own fields of Vips-8.0.Object
    ...
    abstract class Operation extends Object {
        // Own fields of Vips-8.0.Operation

        hash: number;
        found_hash: boolean;
        pixels: number;

        // Constructors of Vips-8.0.Operation

        static ['new'](name: string): Operation;

        // Owm methods of Vips-8.0.Operation
    ...
    class Region extends Object {
        // Own fields of Vips-8.0.Region

        parent_object: Object;
        im: Image;
        valid: Rect;

        // Constructors of Vips-8.0.Region

        static ['new'](image: Image): Region;

        // Owm methods of Vips-8.0.Region
         ...
         */
        copy(dest: Region, r: Rect, x: number, y: number): void;
        /**
         ...
         */
        shrink_method(to: Region, target: Rect, method: RegionShrink): number;
        width(): number;
    }

    class Area {
        // Own fields of Vips-8.0.Area

        data: any;
        length: number;
        n: number;

        // Constructors of Vips-8.0.Area
    ...
    class Argument {
        // Own fields of Vips-8.0.Argument

        pspec: GObject.ParamSpec;
    }

    class ArgumentClass {
        // Own fields of Vips-8.0.ArgumentClass

        flags: ArgumentFlags;
        priority: number;
        offset: number;

        // Owm methods of Vips-8.0.ArgumentClass

        needsstring(): boolean;
    }

    class ArgumentInstance {
        // Own fields of Vips-8.0.ArgumentInstance
    ...
    class ArrayDouble {
        // Constructors of Vips-8.0.ArrayDouble

        constructor(array: number[]);

        static ['new'](array: number[]): ArrayDouble;

        // Owm methods of Vips-8.0.ArrayDouble
    ...
    class ArrayImage {
        // Constructors of Vips-8.0.ArrayImage
        ...
        // Owm methods of Vips-8.0.ArrayImage
    ...
    class ArrayInt {
        // Constructors of Vips-8.0.ArrayInt

        constructor(array: number[]);

        static ['new'](array: number[]): ArrayInt;

        // Owm methods of Vips-8.0.ArrayInt
    ...
    class ForeignClass {
        // Own fields of Vips-8.0.ForeignClass

        priority: number;
        suffs: string;
    }

    class ForeignLoadClass {}

    class ForeignSaveClass {
        // Own fields of Vips-8.0.ForeignSaveClass
    ...
    class InterpolateClass {
        // Own fields of Vips-8.0.InterpolateClass
    ...
    class ObjectClass {
        // Own fields of Vips-8.0.ObjectClass
        ...
        // Owm methods of Vips-8.0.ObjectClass

        install_argument(pspec: GObject.ParamSpec, flags: ArgumentFlags, priority: number, offset: number): void;
    }

    class OperationClass {
        // Own fields of Vips-8.0.OperationClass
     ...
     */
    class Progress {
        // Own fields of Vips-8.0.Progress
        ...
        // Owm methods of Vips-8.0.Progress
    ...
    class Rect {
         ...
         * @param r2 input rectangle 2
         */
        unionrect(r2: Rect): void;
    }

    class RefString {
        // Constructors of Vips-8.0.RefString

        constructor(str: string);

        static ['new'](str: string): RefString;

        // Owm methods of Vips-8.0.RefString
    ...
    class Thing {
        // Own fields of Vips-8.0.Thing

        i: number;

        // Constructors of Vips-8.0.Thing

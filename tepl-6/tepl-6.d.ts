...
export namespace Tepl {
    ...
    class LineColumnIndicator extends Gtk.Bin {
        // Constructors of Tepl-6.LineColumnIndicator

        static ['new'](): LineColumnIndicator;

        // Owm methods of Tepl-6.LineColumnIndicator
    ...
    class OverwriteIndicator extends Gtk.Bin {
        // Own properties of Tepl-6.OverwriteIndicator
        ...
        // Constructors of Tepl-6.OverwriteIndicator

        static ['new'](): OverwriteIndicator;

        // Owm methods of Tepl-6.OverwriteIndicator
    ...
    class Panel1 extends Gtk.Grid {
        // Constructors of Tepl-6.Panel1

        static ['new'](): Panel1;

        static new_for_left_side_panel(): Panel1;

        // Owm methods of Tepl-6.Panel1
    ...
    class PanelContainer extends Gtk.Bin {
        // Constructors of Tepl-6.PanelContainer

        static ['new'](): PanelContainer;

        // Owm methods of Tepl-6.PanelContainer
    ...
    class PanelSwitcherMenu extends Gtk.Bin {
        // Constructors of Tepl-6.PanelSwitcherMenu
    ...
    class PrefsDialog extends Gtk.Dialog {
        // Owm methods of Tepl-6.PrefsDialog
    ...
    class Settings extends GObject.Object {
        // Owm methods of Tepl-6.Settings
         ...
         */
        static get_range_uint(settings: Gio.Settings, key: string): boolean;
    ...
    class StatusMenuButton extends Gtk.MenuButton {
        // Constructors of Tepl-6.StatusMenuButton

        static ['new'](): StatusMenuButton;

        // Owm methods of Tepl-6.StatusMenuButton
     ...
     */
    class Encoding {
        // Owm methods of Tepl-6.Encoding
    ...
    class EncodingIconv {
        // Owm methods of Tepl-6.EncodingIconv
    ...
    class LineColumnIndicatorClass {
        // Own fields of Tepl-6.LineColumnIndicatorClass

        padding: any[];
    }

    class LineColumnIndicatorPrivate {}
    ...
    class OverwriteIndicatorClass {
        // Own fields of Tepl-6.OverwriteIndicatorClass

        padding: any[];
    }

    class OverwriteIndicatorPrivate {}

    class Panel1Class {
        // Own fields of Tepl-6.Panel1Class
    ...
    class PanelContainerClass {
        // Own fields of Tepl-6.PanelContainerClass

        padding: any[];
    }

    class PanelContainerPrivate {}
     ...
     */
    class PanelItemInterface {}

    class PanelSwitcherMenuClass {
        // Own fields of Tepl-6.PanelSwitcherMenuClass

        padding: any[];
    }

    class PanelSwitcherMenuPrivate {}

    class PrefsDialogClass {
        // Own fields of Tepl-6.PrefsDialogClass

        padding: any[];
    }

    class PrefsDialogPrivate {}
    ...
    class SettingsClass {
        // Own fields of Tepl-6.SettingsClass
    ...
    class StatusMenuButtonClass {
        // Own fields of Tepl-6.StatusMenuButtonClass

        padding: any[];
    }

    class StatusMenuButtonPrivate {}
    ...
    interface Panel {
        ...
        // Own virtual methods of Tepl-6.Panel
    ...
    interface PanelItem {
        // Owm methods of Tepl-6.PanelItem
        ...
        // Own virtual methods of Tepl-6.PanelItem

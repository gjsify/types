...
export namespace Tepl {
     ...
     * @since 6.2
     */
    function prefs_create_display_line_numbers_checkbutton(settings: Gio.Settings, display_line_numbers_key: string): Gtk.Widget;
     ...
     * @since 6.10
     */
    function prefs_create_display_statusbar_checkbutton(settings: Gio.Settings, display_statusbar_key: string): Gtk.Widget;
     ...
     * @since 6.2
     */
    function prefs_create_files_component(settings: Gio.Settings, create_backup_copy_key: string, auto_save_key: string, auto_save_interval: string): Gtk.Widget;
     ...
     * @since 6.2
     */
    function prefs_create_font_component(settings: Gio.Settings, use_default_font_key: string, editor_font_key: string): Gtk.Widget;
     ...
     * @since 6.2
     */
    function prefs_create_highlighting_component(settings: Gio.Settings, highlight_current_line_key: string, highlight_matching_brackets_key: string): Gtk.Widget;
     ...
     * @since 6.2
     */
    function prefs_create_insert_spaces_component(settings: Gio.Settings, insert_spaces_key: string, smart_backspace_key: string): Gtk.Widget;
     ...
     * @since 6.10
     */
    function prefs_create_right_margin_component(settings: Gio.Settings, display_right_margin_key: string, right_margin_position_key: string): Gtk.Widget;
    ...
    namespace ProgressInfoBar {
        ...
        // Constructor properties interface
        interface ConstructorProps extends InfoBar.ConstructorProps, Atk.ImplementorIface.ConstructorProps, Gtk.Buildable.ConstructorProps, Gtk.Orientable.ConstructorProps {
    ...
    class Settings extends GObject.Object {
         ...
         */
        provide_style_scheme_settings(style_scheme_settings: Gio.Settings, key_for_light_theme_variant: string, key_for_dark_theme_variant: string): void;
    }
     ...
     * @gir-type Class
     */
    class StatusMenuButton extends Gtk.MenuButton implements Atk.ImplementorIface, Gtk.Actionable, Gtk.Activatable, Gtk.Buildable {

 ...
 */
function utils_markup_escape_text(src: string | null): string | null
/**
...
module ProgressInfoBar {
    ...
    interface ConstructorProperties extends Atk.ImplementorIface.ConstructorProperties, Gtk.Buildable.ConstructorProperties, Gtk.Orientable.ConstructorProperties, InfoBar.ConstructorProperties {

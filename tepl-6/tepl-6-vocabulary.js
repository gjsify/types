...
export const DECLS = {
    ...
    TeplCodeCommentView: ['TeplCodeCommentView'],
    TeplFile: ['TeplFile'],
    ...
    TeplPanelItem: ['TeplPanelItem'],
    TeplPanelNotebook: ['TeplPanelNotebook'],
    TeplPanelSimple: ['TeplPanelSimple', 'TeplPanel'],
    TeplPanelStack: ['TeplPanelStack'],

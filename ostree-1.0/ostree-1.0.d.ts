 ...
 */
function object_from_string(str: string): [ /* out_checksum */ string | null, /* out_objtype */ ObjectType ]
/**
...
function object_to_string(checksum: string, objtype: ObjectType): string | null
/**
 ...
 */
function parse_refspec(refspec: string): [ /* returnType */ boolean, /* out_remote */ string, /* out_ref */ string ]
/**

...
const COMMIT_GVARIANT_STRING: string | null
const DIRMETA_GVARIANT_STRING: string | null
const FILEMETA_GVARIANT_STRING: string | null
/**
...
const SUMMARY_GVARIANT_STRING: string | null
const SUMMARY_SIG_GVARIANT_STRING: string | null
/**
...
const TREE_GVARIANT_STRING: string | null
const WITH_AUTOCLEANUPS: number
function checksum_b64_from_bytes(csum: Uint8Array): string | null
function checksum_b64_to_bytes(checksum: string | null): Uint8Array
 ...
 */
function checksum_file_async<Z = unknown>(f: Gio.File, objtype: ObjectType, io_priority: number, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback<Z> | null): void
/**
...
function checksum_from_bytes(csum: Uint8Array): string | null
function checksum_from_bytes_v(csum_v: GLib.Variant): string | null
/**
 ...
 */
function checksum_inplace_to_bytes(checksum: string | null, buf: number): void
function checksum_to_bytes(checksum: string | null): Uint8Array
function checksum_to_bytes_v(checksum: string | null): GLib.Variant
 ...
 * @param cancellable Cancellable
 */
function content_file_parse_at(compressed: boolean, parent_dfd: number, path: string | null, trusted: boolean, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* out_input */ Gio.InputStream, /* out_file_info */ Gio.FileInfo, /* out_xattrs */ GLib.Variant ]
/**
 ...
 */
function object_from_string(str: string | null): [ /* out_checksum */ string | null, /* out_objtype */ ObjectType ]
/**
 ...
 */
function object_name_deserialize(variant: GLib.Variant): [ /* out_checksum */ string | null, /* out_objtype */ ObjectType ]
function object_name_serialize(checksum: string | null, objtype: ObjectType): GLib.Variant
function object_to_string(checksum: string | null, objtype: ObjectType): string | null
/**
 * The reverse of ostree_object_type_to_string().
 * @param str A stringified version of #OstreeObjectType
 */
function object_type_from_string(str: string | null): ObjectType
/**
 * Serialize `objtype` to a string; this is used for file extensions.
 * @param objtype an #OstreeObjectType
 */
function object_type_to_string(objtype: ObjectType): string | null
/**
 ...
 */
function parse_refspec(refspec: string | null): [ /* returnType */ boolean, /* out_remote */ string | null, /* out_ref */ string | null ]
/**
 ...
 */
function validate_checksum_string(sha256: string | null): boolean
function validate_rev(rev: string | null): boolean
function validate_structureof_checksum_string(checksum: string | null): boolean
/**
...
module Repo {
     ...
     */
    interface GpgVerifyResultSignalCallback {
...
module RepoFile {
    ...
    interface ConstructorProperties extends Gio.File.ConstructorProperties, GObject.Object.ConstructorProperties {
    }

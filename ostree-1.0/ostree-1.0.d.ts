...
export namespace OSTree {
    ...
    class ChecksumInputStream extends Gio.FilterInputStream {
        // Own properties of OSTree-1.0.ChecksumInputStream

        checksum: any;

        // Constructors of OSTree-1.0.ChecksumInputStream
    ...
    class ChecksumInputStreamClass {}
    ...
    class RollsumMatches {
        // Own fields of OSTree-1.0.RollsumMatches

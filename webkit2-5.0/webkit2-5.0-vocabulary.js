...
export const OWN_PROPS = {
    ...
    WebKitWebContext: ['local-storage-directory', 'memory-pressure-settings', 'process-swap-on-cross-site-navigation-enabled', 'time-zone-override', 'website-data-manager'],
    ...
    WebKitWebsiteDataManager: ['base-cache-directory', 'base-data-directory', 'disk-cache-directory', 'dom-cache-directory', 'hsts-cache-directory', 'indexeddb-directory', 'is-ephemeral', 'itp-directory', 'local-storage-directory', 'offline-application-cache-directory', 'service-worker-registrations-directory', 'websql-directory'],
...
export const DECLS = {
    ...
    WebKitWebView: ['WebKitWebView', 'WebKitWebViewBase', 'GtkWidget', 'GInitiallyUnowned', 'GObject', 'GtkAccessible', 'GtkBuildable', 'GtkConstraintTarget'],
    WebKitWebViewBase: ['WebKitWebViewBase', 'GtkWidget', 'GInitiallyUnowned', 'GObject', 'GtkAccessible', 'GtkBuildable', 'GtkConstraintTarget'],

...
static ["new"](): UserContentManager;
    ...
    connect_after(signal: 'script-message-received', callback: ((_source: this, js_result: JavascriptResult) => void)): number
...
module WebView {
    ...
    interface ConstructorProps extends WebViewBase.ConstructorProps, Gtk.Accessible.ConstructorProps, Gtk.Buildable.ConstructorProps, Gtk.ConstraintTarget.ConstructorProps {
...
class WebViewBase extends Gtk.Widget implements Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget {
    ...
    // Own fields of WebKit2.WebViewBase

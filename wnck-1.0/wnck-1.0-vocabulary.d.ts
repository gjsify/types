/**
 * The GIR-derived widget VOCABULARY for Wnck-1.0.
 *
 * GENERATED — do not edit. Provenance: Wnck-1.0 — library 2.31.0 — dropped empty base(s): Atk.ImplementorIface — prop(s) no TypeScript value satisfies: Wnck.ActionMenu.window
 *
 * 9 instantiable GTypes (of which 4 concrete widgets), 9 declarations, 7 enum nick unions, 0 slot candidates.
 *
...
import type Wnck from './wnck-1.0.js';
import type { GInitiallyUnownedConstructOnly, GInitiallyUnownedProps, GObjectConstructOnly, GObjectProps } from '@girs/gobject-2.0/vocabulary';
import type { GtkBuildableConstructOnly, GtkBuildableProps, GtkContainerConstructOnly, GtkContainerProps, GtkMenuBarConstructOnly, GtkMenuBarProps, GtkMenuConstructOnly, GtkMenuProps, GtkMenuShellConstructOnly, GtkMenuShellProps, GtkObjectConstructOnly, GtkObjectProps, GtkWidgetConstructOnly, GtkWidgetProps } from '@girs/gtk-2.0/vocabulary';
...
export type WnckClientTypeNick = 'application' | 'pager';
export type WnckMotionDirectionNick = 'up' | 'down' | 'left' | 'right';
export type WnckPagerDisplayModeNick = 'name' | 'content';
export type WnckPagerLayoutPolicyNick = 'automatic' | 'width-for-height' | 'height-for-width';
export type WnckTasklistGroupingTypeNick = 'never-group' | 'auto-group' | 'always-group';
export type WnckWindowGravityNick = 'current' | 'northwest' | 'north' | 'northeast' | 'west' | 'center' | 'east' | 'southwest' | 'south' | 'southeast' | 'static';
export type WnckWindowTypeNick = 'normal' | 'desktop' | 'dock' | 'dialog' | 'toolbar' | 'menu' | 'utility' | 'splashscreen';
...
export interface WnckActionMenuProps extends GtkMenuProps, GtkBuildableProps {
    window?: never;
}
...
export interface WnckPagerProps extends GtkWidgetProps, GtkBuildableProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type WnckPagerConstructOnly = GtkWidgetConstructOnly | GtkBuildableConstructOnly;
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type WnckSelectorConstructOnly = GtkMenuBarConstructOnly | GtkBuildableConstructOnly;

/** The #WnckTasklist struct contains only private fields and should not be directly accessed. */
export interface WnckTasklistProps extends GtkContainerProps, GtkBuildableProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type WnckTasklistConstructOnly = GtkContainerConstructOnly | GtkBuildableConstructOnly;
...
export interface Widgets {
    WnckActionMenu: {
        class: Wnck.ActionMenu;
        props: WnckActionMenuProps;
        signals: Wnck.ActionMenu.SignalSignatures;
        constructOnly: WnckActionMenuConstructOnly;
        slotCandidates: {};
    };
    WnckPager: {
        class: Wnck.Pager;
        props: WnckPagerProps;
        signals: Wnck.Pager.SignalSignatures;
        constructOnly: WnckPagerConstructOnly;
        slotCandidates: {};
    };
    WnckSelector: {
        class: Wnck.Selector;
        props: WnckSelectorProps;
        signals: Wnck.Selector.SignalSignatures;
        constructOnly: WnckSelectorConstructOnly;
        slotCandidates: {};
    };
    WnckTasklist: {
        class: Wnck.Tasklist;
        props: WnckTasklistProps;
        signals: Wnck.Tasklist.SignalSignatures;
        constructOnly: WnckTasklistConstructOnly;
        slotCandidates: {};
    };
}

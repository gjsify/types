...
static ["new"](): ElementAddedNotifier;
    ...
    connect_after(signal: 'element-added', callback: ((_source: this, bin: Gst.Bin, element: Gst.Element) => void)): number
...
_init(...args: any[]): void;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'error', callback: ((_source: this, object: GObject.Object, error_no: Error, error_msg: string) => void)): number
    connect_after(signal: 'error', callback: ((_source: this, object: GObject.Object, error_no: Error, error_msg: string) => void)): number
...
_init(...args: any[]): void;
    ...
    connect_after(signal: 'error', callback: ((_source: this, errorno: Error, error_msg: string) => void)): number
    emit(signal: 'error', errorno: Error, error_msg: string): void
    connect(signal: 'known-source-packet-received', callback: ((_source: this, component: number, buffer: any) => void)): number
    connect_after(signal: 'known-source-packet-received', callback: ((_source: this, component: number, buffer: any) => void)): number
    ...
    connect(signal: 'new-active-candidate-pair', callback: ((_source: this, local_candidate: Candidate, remote_candidate: Candidate) => void)): number
    connect_after(signal: 'new-active-candidate-pair', callback: ((_source: this, local_candidate: Candidate, remote_candidate: Candidate) => void)): number
    ...
    connect_after(signal: 'state-changed', callback: ((_source: this, component: number, state: StreamState) => void)): number
...
class RtpHeaderExtension {
    ...
    // Own fields of Farstream.RtpHeaderExtension

id: number
direction: StreamDirection
uri: string

    // Constructors of Farstream.RtpHeaderExtension
...
static ["new"](id: number, direction: StreamDirection, uri: string): RtpHeaderExtension;
    ...
    // Own methods of Farstream.RtpHeaderExtension

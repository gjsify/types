...
import './node-gstsdp-1.0-import.d.ts';
 ...
 */
function sdpAddressIsMulticast(nettype: string | null, addrtype: string | null, addr: string | null): boolean
/**
 ...
 */
function sdpMakeKeymgmt(uri: string | null, base64: string | null): string | null
/**
 ...
 */
function sdpMediaInit(): [ /* returnType */ SDPResult, /* media */ SDPMedia ]
/**
 ...
 * @returns a #GstSDPResult.
 */
function sdpMediaSetMediaFromCaps(caps: Gst.Caps): [ /* returnType */ SDPResult, /* media */ SDPMedia ]
/**
 ...
 */
function sdpMessageAsUri(scheme: string | null, msg: SDPMessage): string | null
/**
 ...
 * @returns a #GstSDPResult.
 */
function sdpMessageInit(): [ /* returnType */ SDPResult, /* msg */ SDPMessage ]
/**
 ...
 * @returns a #GstSDPResult.
 */
function sdpMessageNewFromText(text: string | null): [ /* returnType */ SDPResult, /* msg */ SDPMessage ]
/**
 ...
 */
function sdpMessageParseBuffer(data: number[], msg: SDPMessage): SDPResult
/**
 ...
 * @returns #GST_SDP_OK on success.
 */
function sdpMessageParseUri(uri: string | null, msg: SDPMessage): SDPResult
...
interface MIKEYMessage {
     ...
     * @returns %TRUE on success
     */
    addT(type: MIKEYTSType, tsValue: number[]): boolean
    /**
...
class MIKEYMessage {
     ...
     */
    static newFromData(data: number[], info: MIKEYDecryptInfo): MIKEYMessage
}
...
interface MIKEYPayload {
     ...
     * @returns %TRUE on success
     */
    keyDataSetInterval(vfData: number[], vtData: number[]): boolean
    /**
     ...
     * @returns %TRUE on success
     */
    keyDataSetKey(keyType: MIKEYKeyDataType, keyData: number[]): boolean
    /**
     ...
     * @returns %TRUE on success
     */
    spAddParam(type: number, val: number[]): boolean
    /**
     ...
     * @returns %TRUE on success
     */
    tSet(type: MIKEYTSType, tsValue: number[]): boolean
}
...
class SDPMessage {
     ...
     * @returns #GST_SDP_OK on success.
     */
    static parseBuffer(data: number[], msg: SDPMessage): SDPResult
    /**
     * Parse the null-terminated `uri` and store the result in `msg`.
     * 
     * The uri should be of the form:

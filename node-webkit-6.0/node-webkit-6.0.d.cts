...
export module UserContentManager {
    ...
    export interface ScriptMessageWithReplyReceivedSignalCallback {
        (jsResult: JavascriptResult, reply: ScriptMessageReply): boolean
    }
...
export interface UserContentManager {
     ...
     */
    registerScriptMessageHandler(name: string | null, worldName: string | null): boolean
    /**
     ...
     */
    unregisterScriptMessageHandler(name: string | null, worldName: string | null): void
...
export interface WebView extends Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget {
     ...
     */
    callAsyncJavascriptFunctionFinish(result: Gio.AsyncResult): JavascriptResult
    /**
     ...
     */
    evaluateJavascriptFinish(result: Gio.AsyncResult): JavascriptResult
    /**

...
export namespace RygelCore {
    ...
    class Dlna150Hacks extends GObject.Object {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof Dlna150Hacks.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, Dlna150Hacks.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof Dlna150Hacks.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, Dlna150Hacks.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof Dlna150Hacks.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<Dlna150Hacks.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;

...
export const OWN_PROPS = {
    ...
    XfceSMClient: ['argc', 'argv', 'client-id', 'current-directory', 'desktop-file', 'priority', 'restart-command'],
    XfceScreensaver: ['heartbeat-command', 'lock-command', 'lock-on-sleep'],
    XfceTitledDialog: ['subtitle'],
};

export const OWN_SIGNALS = {
    XfceFilenameInput: ['text-invalid', 'text-valid'],
    XfceSMClient: ['quit', 'quit-cancelled', 'quit-requested', 'save-state', 'save-state-extended'],
};
...
export const PROP_TYPES = {
    'XfceFilenameInput.max-text-length': 'gint',
    'XfceFilenameInput.original-filename': 'gchararray',
    'XfceSMClient.argc': 'gint',
    'XfceSMClient.client-id': 'gchararray',
    'XfceSMClient.current-directory': 'gchararray',
    'XfceSMClient.desktop-file': 'gchararray',
    'XfceSMClient.priority': 'guchar',
    'XfceScreensaver.heartbeat-command': 'gchararray',
    'XfceScreensaver.lock-command': 'gchararray',
    'XfceScreensaver.lock-on-sleep': 'gboolean',
    'XfceTitledDialog.subtitle': 'gchararray',
};
...
export const SINCE = {
    ...
    'XfceFilenameInput::text-invalid': '4.16',
    'XfceFilenameInput::text-valid': '4.16',
};

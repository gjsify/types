 ...
 * @param _callback_ 
 */
function io_open_from_dirs<Z = unknown>(filename: string | null, dirs: string[], _callback_?: Gio.AsyncReadyCallback<Z> | null): void
 ...
 * @param _callback_ 
 */
function io_open_from_data_dirs<Z = unknown>(filename: string | null, _callback_?: Gio.AsyncReadyCallback<Z> | null): void

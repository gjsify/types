...
static ["new"](search_string: string, hints: GLib.HashTable<string, GLib.Variant>, results_model: Dee.SerializableModel): LensSearch;
...
static ["new"](dbus_path_: string): Scope;
    ...
    connect_after(signal: 'active_sources_changed', callback: ((_source: this, active_ids: string[]) => void)): number
    emit(signal: 'active_sources_changed', active_ids: string[]): void
    connect(signal: 'search_changed', callback: ((_source: this, search: LensSearch, search_type: SearchType, cancellable: Gio.Cancellable) => void)): number
    connect_after(signal: 'search_changed', callback: ((_source: this, search: LensSearch, search_type: SearchType, cancellable: Gio.Cancellable) => void)): number

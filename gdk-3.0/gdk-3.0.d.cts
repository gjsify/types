 ...
 */
export function atom_intern(atom_name: string | null, only_if_exists: boolean): Atom
/**
 * Finds or creates an atom corresponding to a given string.
 * 
 ...
 * @returns the atom corresponding to @atom_name
 */
export function atom_intern_static_string(atom_name: string | null): Atom
/**
...
export interface DeviceManager {
    ...
    connect(sigName: "device-changed", callback: DeviceManager.DeviceChangedSignalCallback): number
    connect_after(sigName: "device-changed", callback: DeviceManager.DeviceChangedSignalCallback): number
...
export module Display {
     ...
     */
    export interface MonitorAddedSignalCallback {
     ...
     */
    export interface MonitorRemovedSignalCallback {
        ($obj: Display, monitor: Monitor): void
    }
...
export interface Display {
    ...
    connect(sigName: "monitor-added", callback: Display.MonitorAddedSignalCallback): number
    connect_after(sigName: "monitor-added", callback: Display.MonitorAddedSignalCallback): number
    emit(sigName: "monitor-added", monitor: Monitor, ...args: any[]): void
    connect(sigName: "monitor-removed", callback: Display.MonitorRemovedSignalCallback): number
    connect_after(sigName: "monitor-removed", callback: Display.MonitorRemovedSignalCallback): number
...
export module DragContext {
     ...
     */
    export interface ActionChangedSignalCallback {
...
export interface DragContext {
    ...
    connect(sigName: "action-changed", callback: DragContext.ActionChangedSignalCallback): number
    connect_after(sigName: "action-changed", callback: DragContext.ActionChangedSignalCallback): number
    emit(sigName: "action-changed", action: DragAction, ...args: any[]): void
    connect(sigName: "cancel", callback: DragContext.CancelSignalCallback): number
    connect_after(sigName: "cancel", callback: DragContext.CancelSignalCallback): number
    emit(sigName: "cancel", reason: DragCancelReason, ...args: any[]): void
    connect(sigName: "dnd-finished", callback: DragContext.DndFinishedSignalCallback): number
    connect_after(sigName: "dnd-finished", callback: DragContext.DndFinishedSignalCallback): number
    emit(sigName: "dnd-finished", ...args: any[]): void
    connect(sigName: "drop-performed", callback: DragContext.DropPerformedSignalCallback): number
    connect_after(sigName: "drop-performed", callback: DragContext.DropPerformedSignalCallback): number
...
export class DrawingContext extends GObject.Object {
    ...
    constructor(config?: DrawingContext.ConstructorProperties) 
    _init(config?: DrawingContext.ConstructorProperties): void
}
...
export module Window {
     ...
     */
    export interface CreateSurfaceSignalCallback {
     ...
     */
    export interface MovedToRectSignalCallback {
        ($obj: Window, flipped_rect: any | null, final_rect: any | null, flipped_x: boolean, flipped_y: boolean): void
    }
...
export interface Window {
    ...
    connect(sigName: "create-surface", callback: Window.CreateSurfaceSignalCallback): number
    connect_after(sigName: "create-surface", callback: Window.CreateSurfaceSignalCallback): number
    ...
    connect(sigName: "moved-to-rect", callback: Window.MovedToRectSignalCallback): number
    connect_after(sigName: "moved-to-rect", callback: Window.MovedToRectSignalCallback): number
    emit(sigName: "moved-to-rect", flipped_rect: any | null, final_rect: any | null, flipped_x: boolean, flipped_y: boolean, ...args: any[]): void
...
export class Atom {
     ...
     * @returns the atom corresponding to @atom_name.
     */
    static intern(atom_name: string | null, only_if_exists: boolean): Atom
    /**
     * Finds or creates an atom corresponding to a given string.
     * 
     * Note that this function is identical to gdk_atom_intern() except
     ...
     * @returns the atom corresponding to @atom_name
     */
    static intern_static_string(atom_name: string | null): Atom
}
...
export interface DrawingContextClass {
}

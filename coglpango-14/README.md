...
GJS TypeScript type definitions for CoglPango-14 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v4.7.0.
...
| Import | What you get |
|---|---|
| `@girs/coglpango-14` | the namespace as a default export, plus the ambient and global declarations |
...
Referencing `@girs/coglpango-14/ambient` instead pulls in these declarations
alone. See [ambient modules](https://github.com/gjsify/ts-for-gir/tree/main/packages/cli#ambient-modules).

### As `imports.gi`

GJS's global object works the same way, via `@girs/coglpango-14/import`:

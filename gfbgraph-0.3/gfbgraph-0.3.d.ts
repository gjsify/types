...
import './gfbgraph-0.3-ambient.d.ts';
import './gfbgraph-0.3-import.d.ts';
/**
 * GFBGraph-0.3
 */
...
export namespace GFBGraph {
    ...
    class Album extends Node {
        // Own properties of GFBGraph-0.3.Album
        ...
        // Constructors of GFBGraph-0.3.Album

        static ['new'](): Album;

        static new_from_id(authorizer: Authorizer, id: string): Album;

        // Owm methods of GFBGraph-0.3.Album
    ...
    class Node extends GObject.Object {
        // Own properties of GFBGraph-0.3.Node
    ...
    class Photo extends Node {
        // Own properties of GFBGraph-0.3.Photo
        ...
        // Constructors of GFBGraph-0.3.Photo

        static ['new'](): Photo;

        static new_from_id(authorizer: Authorizer, id: string): Photo;

        // Owm methods of GFBGraph-0.3.Photo
    ...
    class SimpleAuthorizer extends GObject.Object {
        // Own properties of GFBGraph-0.3.SimpleAuthorizer

        access_token: string;
        accessToken: string;

        // Constructors of GFBGraph-0.3.SimpleAuthorizer
    ...
    class User extends Node {
        // Own properties of GFBGraph-0.3.User
        ...
        // Constructors of GFBGraph-0.3.User

        static ['new'](): User;

        static new_from_id(authorizer: Authorizer, id: string): User;

        // Owm methods of GFBGraph-0.3.User
     ...
     */
    class PhotoImage {
        // Own fields of GFBGraph-0.3.PhotoImage

        width: number;
        height: number;
        source: string;

        // Constructors of GFBGraph-0.3.PhotoImage
    ...
    interface Authorizer {
        // Owm methods of GFBGraph-0.3.Authorizer
        ...
        // Own virtual methods of GFBGraph-0.3.Authorizer
    ...
    interface Connectable {
        // Owm methods of GFBGraph-0.3.Connectable
        ...
        // Own virtual methods of GFBGraph-0.3.Connectable

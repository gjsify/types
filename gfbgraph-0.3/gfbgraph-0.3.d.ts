 ...
 */
default_deserialize_property(property_name: string, value: GObject.Value, pspec: GObject.ParamSpec, property_node: Json.Node): boolean
/**
 ...
 */
default_serialize_property(property_name: string, value: GObject.Value, pspec: GObject.ParamSpec): (Json.Node | null)
/**
 ...
 * @param property_node the JSON node containing the serialized property
 */
vfunc_deserialize_property(property_name: string, pspec: GObject.ParamSpec, property_node: Json.Node): [boolean, unknown]
/**
 * Calls the [vfunc`Json`.Serializable.find_property] implementation on
 * the `JsonSerializable` instance, which will return the property
 * description for the given name.

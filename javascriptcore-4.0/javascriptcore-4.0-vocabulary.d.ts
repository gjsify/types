/**
 * The GIR-derived widget VOCABULARY for JavaScriptCore-4.0.
 *
 * GENERATED — do not edit. Provenance: JavaScriptCore-4.0 — library 2.47.2
 *
...
import type JavaScriptCore from './javascriptcore-4.0.js';
...
export interface JSCClassProps extends GObjectProps {
...
export type JSCClassConstructOnly = GObjectConstructOnly | 'context' | 'name' | 'parent';
...
export interface JSCContextProps extends GObjectProps {
    /** The #JSCVirtualMachine in which the context was created. */
    'virtual-machine'?: JavaScriptCore.VirtualMachine;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type JSCContextConstructOnly = GObjectConstructOnly | 'virtual-machine';

/** JSCException represents a JavaScript exception. */
export interface JSCExceptionProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type JSCExceptionConstructOnly = GObjectConstructOnly;

/** JSCValue represents a reference to a value in a #JSCContext. */
export interface JSCValueProps extends GObjectProps {
    /** The #JSCContext in which the value was created. */
    context?: JavaScriptCore.Context;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type JSCValueConstructOnly = GObjectConstructOnly | 'context';

/** JSCVirtualMachine represents a group of JSCContext<!-- -->s. */
export interface JSCVirtualMachineProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type JSCVirtualMachineConstructOnly = GObjectConstructOnly;

/** JSCWeakValue represents a weak reference to a value in a #JSCContext. */
export interface JSCWeakValueProps extends GObjectProps {
    /** The #JSCValue referencing the JavaScript value. */
    value?: JavaScriptCore.Value;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type JSCWeakValueConstructOnly = GObjectConstructOnly | 'value';

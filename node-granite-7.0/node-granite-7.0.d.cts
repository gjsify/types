...
export function dateTimeGetDefaultDateFormat(withWeekday: boolean, withDay: boolean, withYear: boolean): string | null
export function dateTimeSecondsToTime(seconds: number): string | null
...
export function accelToString(accel: string | null): string | null
export function markupAccelTooltip(accels: string[] | null, description: string | null): string | null

...
import type { GtkBuildableConstructOnly, GtkBuildableProps, GtkContainerConstructOnly, GtkContainerProps, GtkScrollableConstructOnly, GtkScrollableProps, GtkUnitNick, GtkWidgetConstructOnly, GtkWidgetProps } from '@girs/gtk-3.0/surface';

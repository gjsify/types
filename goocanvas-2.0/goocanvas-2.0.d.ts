...
static ["new"](): Canvas;
    ...
    connect(signal: 'item-created', callback: ((_source: this, item: CanvasItem, model: CanvasItemModel) => void)): number
    connect_after(signal: 'item-created', callback: ((_source: this, item: CanvasItem, model: CanvasItemModel) => void)): number
    ...
    static marshal_BOOLEAN__BOXED(closure: GObject.Closure, return_value: GObject.Value, n_param_values: number, param_values: GObject.Value, invocation_hint?: (any | null), marshal_data?: (any | null)): void
    static marshal_BOOLEAN__DOUBLE_DOUBLE_BOOLEAN_OBJECT(closure: GObject.Closure, return_value: GObject.Value, n_param_values: number, param_values: GObject.Value, invocation_hint?: (any | null), marshal_data?: (any | null)): void
    static marshal_BOOLEAN__OBJECT_BOXED(closure: GObject.Closure, return_value: GObject.Value, n_param_values: number, param_values: GObject.Value, invocation_hint?: (any | null), marshal_data?: (any | null)): void
    static marshal_VOID__INT_INT(closure: GObject.Closure, return_value: GObject.Value, n_param_values: number, param_values: GObject.Value, invocation_hint?: (any | null), marshal_data?: (any | null)): void
    static marshal_VOID__OBJECT_OBJECT(closure: GObject.Closure, return_value: GObject.Value, n_param_values: number, param_values: GObject.Value, invocation_hint?: (any | null), marshal_data?: (any | null)): void
    /**
...
vfunc_get_child_property(child: CanvasItem, property_id: number, value: GObject.Value, pspec: GObject.ParamSpec): void
/**
 * Returns %TRUE if the item is static. Static items do not move or change
 * size when the canvas is scrolled or the scale changes.
 */
...
vfunc_set_child_property(child: CanvasItem, property_id: number, value: GObject.Value, pspec: GObject.ParamSpec): void
/**
 * Notifies the item that it is static. Static items do not move or change
 * size when the canvas is scrolled or the scale changes.
 * 
...
vfunc_get_child_property(child: CanvasItemModel, property_id: number, value: GObject.Value, pspec: GObject.ParamSpec): void
/**
 * Gets the number of children of the container.
 */
vfunc_get_n_children(): number
 ...
 */
vfunc_remove_child(child_num: number): void
vfunc_set_child_property(child: CanvasItemModel, property_id: number, value: GObject.Value, pspec: GObject.ParamSpec): void
/**
 * This function is only intended to be used when implementing new canvas
 * item models (specifically container models such as #GooCanvasGroupModel).
 * It sets the parent of the child model.

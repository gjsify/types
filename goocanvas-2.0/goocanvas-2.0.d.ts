...
export namespace GooCanvas {
    ...
    /**
     * {@link GooCanvas.CanvasAnimateType} is used to specify what happens when the end of an
    ...
    /**
     * The {@link GooCanvas.CanvasItemVisibility} enumeration is used to specify when a canvas
     * item is visible.
     * @gir-type Enum
     */
    ...
    class Canvas extends Gtk.Container implements Atk.ImplementorIface, Gtk.Buildable, Gtk.Scrollable {
         ...
         * @param item a {@link GooCanvas.CanvasItem}.
    ...
    // Conflicted with Gtk.Widget.grab_focus
         ...
         * @param time the time of the event that lead to the keyboard grab. This should  come from the relevant {@link Gdk.Event}.
    ...
    class CanvasEllipse extends CanvasItemSimple implements CanvasItem {
         ...
         * by layout items such as {@link GooCanvas.CanvasTable}.
         ...
         * To do that use the {@link GooCanvas.CanvasItem.parent} property.
         * </para></note>
    ...
    class CanvasEllipseModel extends CanvasItemModelSimple implements CanvasItemModel {
         ...
         * To do that use the {@link GooCanvas.CanvasItemModel.parent} property.
         * </para></note>
     ...
     * {@link GooCanvas.CanvasItemModelSimple.line_width} properties, enabling different styles
     ...
     * `set_parent()` or `allocate_area()` if special code is needed. ({@link GooCanvas.CanvasWidget}
     * does this to make sure the {@link Gtk.Widget} is embedded in the {@link GooCanvas.Canvas} widget
     * correctly.)
     * @gir-type Class
     */
     ...
     * or above the {@link GooCanvas.CanvasWidget}.
     * </para></listitem><listitem><para>
    ...
    /**
     * {@link GooCanvas.CanvasItem} defines the interface that canvas items must implement,

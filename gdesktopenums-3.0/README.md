...
GJS TypeScript type definitions for GDesktopEnums-3.0 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v4.6.0.
...
Referencing `@girs/gdesktopenums-3.0/ambient` instead pulls in these declarations

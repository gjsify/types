...
export namespace Meta {
    ...
    namespace BackgroundActor {
        ...
        // Constructor properties interface
        interface ConstructorProps extends Clutter.Actor.ConstructorProps<Clutter.LayoutManager, BackgroundContent>, Atk.ImplementorIface.ConstructorProps, Clutter.Animatable.ConstructorProps, Clutter.Container.ConstructorProps, Clutter.Scriptable.ConstructorProps {
            meta_display: Display;
            metaDisplay: Display;
            monitor: number;
        }
     ...
     * @gir-type Class
     */
    class BackgroundActor extends Clutter.Actor<Clutter.LayoutManager, BackgroundContent> implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
    ...
    class Display extends GObject.Object {
         ...
         * @returns the current grab operation, or {@link Meta.GrabOp.NONE} if Mutter doesn't currently have a grab.
         */
        get_grab_op(): GrabOp;

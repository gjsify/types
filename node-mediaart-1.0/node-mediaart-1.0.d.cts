 ...
 */
export function bufferToJpeg(buffer: number, len: number, bufferMime: string | null, target: string | null): boolean
 ...
 */
export function stripInvalidEntities(original: string | null): string | null
...
export interface Process extends Gio.Initable {
     ...
     */
    buffer(type: Type, flags: ProcessFlags, relatedFile: Gio.File, buffer: Uint8Array | null, mime: string | null, artist: string | null, title: string | null): boolean
    /**

 ...
 */
function boxedDeserialize(gboxedType: GObject.GType, node: Node): any | null
/**
 ...
 */
function boxedSerialize(gboxedType: GObject.GType, boxed: any | null): Node | null
/**
 ...
 */
function constructGobject(gtype: GObject.GType, data: string | null, length: number): GObject.Object | null
/**
 ...
 */
function fromString(str: string | null): Node | null
/**
 ...
 * @returns a new object instance of the given type
 */
function gobjectFromData(gtype: GObject.GType, data: string | null, length: number): GObject.Object | null
/**
 ...
 */
function gobjectToData(gobject: GObject.Object): [ /* returnType */ string | null, /* length */ number ]
/**
 ...
 */
function gvariantDeserializeData(json: string | null, length: number, signature: string | null): GLib.Variant | null
/**
 ...
 */
function gvariantSerializeData(variant: GLib.Variant): [ /* returnType */ string | null, /* length */ number ]
 ...
 * @returns a JSON data stream representing the given object
 */
function serializeGobject(gobject: GObject.Object): [ /* returnType */ string | null, /* length */ number ]
/**
 ...
 */
function toString(node: Node, pretty: boolean): string | null
/**
...
module Parser {
    ...
    interface ObjectMemberSignalCallback {
        (object: Object, memberName: string | null): void
    }
...
interface Parser {
    ...
    arrayElement(array: Array, index: number): void
    arrayEnd(array: Array): void
    arrayStart(): void
    ...
    on(sigName: "array-element", callback: Parser.ArrayElementSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "array-element", callback: Parser.ArrayElementSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "array-element", callback: Parser.ArrayElementSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "array-end", callback: Parser.ArrayEndSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "array-end", callback: Parser.ArrayEndSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "array-end", callback: Parser.ArrayEndSignalCallback): NodeJS.EventEmitter
    emit(sigName: "array-end", ...args: any[]): void
    connect(sigName: "array-start", callback: Parser.ArrayStartSignalCallback): number
    on(sigName: "array-start", callback: Parser.ArrayStartSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "array-start", callback: Parser.ArrayStartSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "array-start", callback: Parser.ArrayStartSignalCallback): NodeJS.EventEmitter
    emit(sigName: "array-start", ...args: any[]): void
    connect(sigName: "error", callback: Parser.ErrorSignalCallback): number
    on(sigName: "error", callback: Parser.ErrorSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "error", callback: Parser.ErrorSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "error", callback: Parser.ErrorSignalCallback): NodeJS.EventEmitter
    emit(sigName: "error", ...args: any[]): void
    connect(sigName: "object-end", callback: Parser.ObjectEndSignalCallback): number
    on(sigName: "object-end", callback: Parser.ObjectEndSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "object-end", callback: Parser.ObjectEndSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "object-end", callback: Parser.ObjectEndSignalCallback): NodeJS.EventEmitter
    emit(sigName: "object-end", ...args: any[]): void
    connect(sigName: "object-member", callback: Parser.ObjectMemberSignalCallback): number
    on(sigName: "object-member", callback: Parser.ObjectMemberSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "object-member", callback: Parser.ObjectMemberSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "object-member", callback: Parser.ObjectMemberSignalCallback): NodeJS.EventEmitter
    emit(sigName: "object-member", memberName: string | null, ...args: any[]): void
    connect(sigName: "object-start", callback: Parser.ObjectStartSignalCallback): number
    on(sigName: "object-start", callback: Parser.ObjectStartSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "object-start", callback: Parser.ObjectStartSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "object-start", callback: Parser.ObjectStartSignalCallback): NodeJS.EventEmitter
    emit(sigName: "object-start", ...args: any[]): void
    connect(sigName: "parse-end", callback: Parser.ParseEndSignalCallback): number
    on(sigName: "parse-end", callback: Parser.ParseEndSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "parse-end", callback: Parser.ParseEndSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "parse-end", callback: Parser.ParseEndSignalCallback): NodeJS.EventEmitter
    emit(sigName: "parse-end", ...args: any[]): void
    connect(sigName: "parse-start", callback: Parser.ParseStartSignalCallback): number
    on(sigName: "parse-start", callback: Parser.ParseStartSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "parse-start", callback: Parser.ParseStartSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "parse-start", callback: Parser.ParseStartSignalCallback): NodeJS.EventEmitter

...
export interface BraseroDriveProps {
    /** @default NULL */
    device?: string;
    gdrive?: Gio.Drive;
    /** @default NULL */
...
export type BraseroDriveConstructOnly = 'device' | 'udi';
...
export interface BraseroMediumProps {
    drive?: BraseroMedia.Drive;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type BraseroMediumConstructOnly = 'drive';

export interface BraseroMediumMonitorProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type BraseroMediumMonitorConstructOnly = never;

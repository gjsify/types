...
export interface BraseroDriveProps extends GObjectProps {
    /** @default NULL */
    device?: string;
    gdrive?: Gio.Drive;
    /** @default NULL */
...
export type BraseroDriveConstructOnly = GObjectConstructOnly | 'device' | 'udi';
...
export interface BraseroMediumProps extends GObjectProps {
    drive?: BraseroMedia.Drive;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type BraseroMediumConstructOnly = GObjectConstructOnly | 'drive';

export interface BraseroMediumMonitorProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type BraseroMediumMonitorConstructOnly = GObjectConstructOnly;
...
export interface BraseroVolumeProps extends BraseroMediumProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type BraseroVolumeConstructOnly = BraseroMediumConstructOnly;

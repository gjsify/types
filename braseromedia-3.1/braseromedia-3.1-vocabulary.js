...
export const OWN_PROPS = {
    BraseroDrive: ['device', 'gdrive', 'udi'],
...
export const OWN_SIGNALS = {
    BraseroDrive: ['medium-added', 'medium-removed'],
    BraseroDriveSelection: ['drive-changed'],
    BraseroMedium: ['probed'],
    BraseroMediumMonitor: ['drive-added', 'drive-removed', 'medium-added', 'medium-removed'],
...
export const PROP_TYPES = {
    'BraseroDrive.device': 'gchararray',
    'BraseroDrive.gdrive': 'GDrive',
    'BraseroDrive.udi': 'gchararray',
    'BraseroDriveSelection.Drive': 'BraseroDrive',
    'BraseroDriveSelection.drive-type': 'guint',
    'BraseroMedium.drive': 'BraseroDrive',
    'BraseroMediumSelection.media-type': 'guint',
    'BraseroMediumSelection.medium': 'BraseroMedium',
};

...
import type GstRtsp from '@girs/node-gstrtsp-1.0';
...
import type GstNet from '@girs/node-gstnet-1.0';
...
module RTSPClient {
     ...
     */
    interface AnnounceRequestSignalCallback {
     ...
     */
    interface CheckRequirementsSignalCallback {
     ...
     */
    interface DescribeRequestSignalCallback {
        (ctx: RTSPContext): void
    }
     ...
     */
    interface GetParameterRequestSignalCallback {
        (ctx: RTSPContext): void
    }
     ...
     */
    interface HandleResponseSignalCallback {
        (ctx: RTSPContext): void
    }
     ...
     */
    interface NewSessionSignalCallback {
     ...
     */
    interface OptionsRequestSignalCallback {
        (ctx: RTSPContext): void
    }
     ...
     */
    interface PauseRequestSignalCallback {
        (ctx: RTSPContext): void
    }
     ...
     */
    interface PlayRequestSignalCallback {
        (ctx: RTSPContext): void
    }
     ...
     */
    interface PreAnnounceRequestSignalCallback {
     ...
     */
    interface PreDescribeRequestSignalCallback {
        (ctx: RTSPContext): GstRtsp.RTSPStatusCode
    }
     ...
     */
    interface PreGetParameterRequestSignalCallback {
        (ctx: RTSPContext): GstRtsp.RTSPStatusCode
    }
     ...
     */
    interface PreOptionsRequestSignalCallback {
        (ctx: RTSPContext): GstRtsp.RTSPStatusCode
    }
     ...
     */
    interface PrePauseRequestSignalCallback {
        (ctx: RTSPContext): GstRtsp.RTSPStatusCode
    }
     ...
     */
    interface PrePlayRequestSignalCallback {
        (ctx: RTSPContext): GstRtsp.RTSPStatusCode
    }
     ...
     */
    interface PreRecordRequestSignalCallback {
        (ctx: RTSPContext): GstRtsp.RTSPStatusCode
    }
     ...
     */
    interface PreSetParameterRequestSignalCallback {
        (ctx: RTSPContext): GstRtsp.RTSPStatusCode
    }
     ...
     */
    interface PreSetupRequestSignalCallback {
        (ctx: RTSPContext): GstRtsp.RTSPStatusCode
    }
     ...
     */
    interface PreTeardownRequestSignalCallback {
        (ctx: RTSPContext): GstRtsp.RTSPStatusCode
    }
     ...
     */
    interface RecordRequestSignalCallback {
        (ctx: RTSPContext): void
    }
     ...
     */
    interface SendMessageSignalCallback {
     ...
     */
    interface SetParameterRequestSignalCallback {
        (ctx: RTSPContext): void
    }
     ...
     */
    interface SetupRequestSignalCallback {
        (ctx: RTSPContext): void
    }
     ...
     */
    interface TeardownRequestSignalCallback {
        (ctx: RTSPContext): void
    }
...
module RTSPMedia {
     ...
     */
    interface HandleMessageSignalCallback {
     ...
     */
    interface NewStateSignalCallback {
        (object: number): void
    }
     ...
     */
    interface NewStreamSignalCallback {
     ...
     */
    interface PreparedSignalCallback {
        (): void
    }
     ...
     */
    interface RemovedStreamSignalCallback {
        (object: RTSPStream): void
    }
     ...
     */
    interface TargetStateSignalCallback {
        (object: number): void
    }
     ...
     */
    interface UnpreparedSignalCallback {
        (): void
    }
...
module RTSPMediaFactory {
     ...
     */
    interface MediaConfigureSignalCallback {
     ...
     */
    interface MediaConstructedSignalCallback {
        (object: RTSPMedia): void
    }
...
module RTSPMediaFactoryURI {
    ...
    interface ConstructorProperties extends RTSPMediaFactory.ConstructorProperties {
...
module RTSPOnvifClient {
    ...
    interface ConstructorProperties extends RTSPClient.ConstructorProperties {
    }
...
module RTSPOnvifMedia {
    ...
    interface ConstructorProperties extends RTSPMedia.ConstructorProperties {
    }
...
module RTSPOnvifServer {
    ...
    interface ConstructorProperties extends RTSPServer.ConstructorProperties {
    }
...
module RTSPServer {
     ...
     */
    interface ClientConnectedSignalCallback {
...
module RTSPSessionPool {
     ...
     */
    interface SessionRemovedSignalCallback {
        (object: RTSPSession): void
    }
...
module RTSPStream {
     ...
     */
    interface NewRtcpEncoderSignalCallback {
     ...
     */
    interface NewRtpEncoderSignalCallback {
        (object: Gst.Element): void
    }
     ...
     */
    interface NewRtpRtcpDecoderSignalCallback {
        (object: Gst.Element): void
    }

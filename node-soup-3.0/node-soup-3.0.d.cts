 ...
 */
export function cookieParse(header: string | null, origin: GLib.Uri | null): Cookie | null
/**
 ...
 */
export function cookiesToCookieHeader(cookies: Cookie[]): string | null
/**
 ...
 */
export function dateTimeNewFromHttpString(dateString: string | null): GLib.DateTime | null
/**
 ...
 */
export function dateTimeToString(date: GLib.DateTime, format: DateFormat): string | null
/**
 * Decodes `form`.
 * 
 ...
 */
export function formDecode(encodedForm: string | null): GLib.HashTable
/**
 ...
 */
export function formDecodeMultipart(multipart: Multipart, fileControlName: string | null): [ /* returnType */ GLib.HashTable | null, /* filename */ string | null, /* contentType */ string | null, /* file */ any ]
/**
 ...
 */
export function formEncodeDatalist(formDataSet: GLib.Data): string | null
/**
 * Encodes `form_data_set` into a value of type
 * "application/x-www-form-urlencoded".
 * 
 ...
 * @returns the encoded form
 */
export function formEncodeHash(formDataSet: GLib.HashTable): string | null
/**
 ...
 */
export function headerContains(header: string | null, token: string | null): boolean
/**
 * Frees `param_list`.
 ...
 */
export function headerGStringAppendParam(string: GLib.String, name: string | null, value: string | null): void
/**
 ...
 */
export function headerGStringAppendParamQuoted(string: GLib.String, name: string | null, value: string | null): void
/**
 ...
 */
export function headerParseList(header: string | null): string[]
/**
 ...
 */
export function headerParseParamList(header: string | null): GLib.HashTable
/**
 ...
 */
export function headerParseParamListStrict(header: string | null): GLib.HashTable | null
/**
 ...
 */
export function headerParseQualityList(header: string | null): [ /* returnType */ string[], /* unacceptable */ string[] ]
/**
 ...
 * @returns a   #GHashTable of list elements, which can be freed with   [func@header_free_param_list].
 */
export function headerParseSemiParamList(header: string | null): GLib.HashTable
/**
 ...
 * @returns    a #GHashTable of list elements, which can be freed with   [func@header_free_param_list] or %NULL if there are duplicate   elements.
 */
export function headerParseSemiParamListStrict(header: string | null): GLib.HashTable | null
/**
 ...
 */
export function headersParse(str: string | null, len: number, dest: MessageHeaders): boolean
/**
 ...
 */
export function headersParseRequest(str: string | null, len: number, reqHeaders: MessageHeaders): [ /* returnType */ number, /* reqMethod */ string | null, /* reqPath */ string | null, /* ver */ HTTPVersion ]
/**
 ...
 * @returns success or failure.
 */
export function headersParseResponse(str: string | null, len: number, headers: MessageHeaders): [ /* returnType */ boolean, /* ver */ HTTPVersion, /* statusCode */ number, /* reasonPhrase */ string | null ]
/**
 ...
 */
export function headersParseStatusLine(statusLine: string | null): [ /* returnType */ boolean, /* ver */ HTTPVersion, /* statusCode */ number, /* reasonPhrase */ string | null ]
/**
 ...
 */
export function statusGetPhrase(statusCode: number): string | null
/**
 ...
 */
export function tldDomainIsPublicSuffix(domain: string | null): boolean
/**
 ...
 */
export function tldGetBaseDomain(hostname: string | null): string | null
/**
 ...
 */
export function uriDecodeDataUri(uri: string | null): [ /* returnType */ any, /* contentType */ string | null ]
/**
...
export interface AuthDomain {
    ...
    // Has conflict: checkPassword(msg: ServerMessage, username: string | null, password: string | null): boolean
    /**
    ...
    accepts(msg: ServerMessage, header: string | null): string | null
    /**
     ...
     * @param msg a #SoupServerMessage
     */
    challenge(msg: ServerMessage): string | null
    /**
     ...
     */
    checkPassword(msg: ServerMessage, username: string | null, password: string | null): boolean
...
export interface ContentSniffer extends SessionFeature {
     ...
     */
    sniff(msg: Message, buffer: any): [ /* returnType */ string | null, /* params */ GLib.HashTable | null ]
...
export interface CookieJar extends SessionFeature {
     ...
     */
    setCookie(uri: GLib.Uri, cookie: string | null): void
    /**
     * Adds `cookie` to `jar,` exactly as though it had appeared in a
     * Set-Cookie header returned from a request to `uri`.
     * 
     ...
     * @param cookie the stringified cookie to set
     */
    setCookieWithFirstParty(uri: GLib.Uri, firstParty: GLib.Uri, cookie: string | null): void
...
export module Message {
     ...
     */
    export interface GotBodyDataSignalCallback {
...
export interface Message {
     ...
     */
    getTlsCiphersuiteName(): string | null
    /**
     ...
     */
    setForceHttp1(value: boolean): void
    /**
    ...
    on(sigName: "accept-certificate", callback: Message.AcceptCertificateSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "accept-certificate", callback: Message.AcceptCertificateSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "accept-certificate", callback: Message.AcceptCertificateSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "authenticate", callback: Message.AuthenticateSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "authenticate", callback: Message.AuthenticateSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "authenticate", callback: Message.AuthenticateSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "got-body-data", callback: Message.GotBodyDataSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "got-body-data", callback: Message.GotBodyDataSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "got-body-data", callback: Message.GotBodyDataSignalCallback): NodeJS.EventEmitter
    emit(sigName: "got-body-data", ...args: any[]): void
    ...
    on(sigName: "hsts-enforced", callback: Message.HstsEnforcedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "hsts-enforced", callback: Message.HstsEnforcedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "hsts-enforced", callback: Message.HstsEnforcedSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "request-certificate", callback: Message.RequestCertificateSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "request-certificate", callback: Message.RequestCertificateSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "request-certificate", callback: Message.RequestCertificateSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "request-certificate-password", callback: Message.RequestCertificatePasswordSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "request-certificate-password", callback: Message.RequestCertificatePasswordSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "request-certificate-password", callback: Message.RequestCertificatePasswordSignalCallback): NodeJS.EventEmitter
...
export class Message extends GObject.Object {
     ...
     */
    static newFromEncodedForm(method: string | null, uriString: string | null, encodedForm: string | null): Message
    /**
     ...
     */
    static newFromMultipart(uriString: string | null, multipart: Multipart): Message
    /**
     * Creates a new empty #SoupMessage, which will connect to `uri`.
     * @constructor 
     * @param method the HTTP method for the created request
     ...
     */
    static newFromUri(method: string | null, uri: GLib.Uri): Message
    /**
...
export interface ServerMessage {
    ...
    on(sigName: "accept-certificate", callback: ServerMessage.AcceptCertificateSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "accept-certificate", callback: ServerMessage.AcceptCertificateSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "accept-certificate", callback: ServerMessage.AcceptCertificateSignalCallback): NodeJS.EventEmitter
    emit(sigName: "accept-certificate", tlsPeerErrors: Gio.TlsCertificateFlags, ...args: any[]): void
    connect(sigName: "connected", callback: ServerMessage.ConnectedSignalCallback): number
    on(sigName: "connected", callback: ServerMessage.ConnectedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "connected", callback: ServerMessage.ConnectedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "connected", callback: ServerMessage.ConnectedSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "disconnected", callback: ServerMessage.DisconnectedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "disconnected", callback: ServerMessage.DisconnectedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "disconnected", callback: ServerMessage.DisconnectedSignalCallback): NodeJS.EventEmitter
    emit(sigName: "disconnected", ...args: any[]): void
    connect(sigName: "finished", callback: ServerMessage.FinishedSignalCallback): number
    on(sigName: "finished", callback: ServerMessage.FinishedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "finished", callback: ServerMessage.FinishedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "finished", callback: ServerMessage.FinishedSignalCallback): NodeJS.EventEmitter
    emit(sigName: "finished", ...args: any[]): void
    connect(sigName: "got-body", callback: ServerMessage.GotBodySignalCallback): number
    on(sigName: "got-body", callback: ServerMessage.GotBodySignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "got-body", callback: ServerMessage.GotBodySignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "got-body", callback: ServerMessage.GotBodySignalCallback): NodeJS.EventEmitter
    emit(sigName: "got-body", ...args: any[]): void
    connect(sigName: "got-chunk", callback: ServerMessage.GotChunkSignalCallback): number
    on(sigName: "got-chunk", callback: ServerMessage.GotChunkSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "got-chunk", callback: ServerMessage.GotChunkSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "got-chunk", callback: ServerMessage.GotChunkSignalCallback): NodeJS.EventEmitter
    emit(sigName: "got-chunk", ...args: any[]): void
    connect(sigName: "got-headers", callback: ServerMessage.GotHeadersSignalCallback): number
    on(sigName: "got-headers", callback: ServerMessage.GotHeadersSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "got-headers", callback: ServerMessage.GotHeadersSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "got-headers", callback: ServerMessage.GotHeadersSignalCallback): NodeJS.EventEmitter
    emit(sigName: "got-headers", ...args: any[]): void
    connect(sigName: "wrote-body", callback: ServerMessage.WroteBodySignalCallback): number
    on(sigName: "wrote-body", callback: ServerMessage.WroteBodySignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "wrote-body", callback: ServerMessage.WroteBodySignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "wrote-body", callback: ServerMessage.WroteBodySignalCallback): NodeJS.EventEmitter
    emit(sigName: "wrote-body", ...args: any[]): void
    connect(sigName: "wrote-body-data", callback: ServerMessage.WroteBodyDataSignalCallback): number
    on(sigName: "wrote-body-data", callback: ServerMessage.WroteBodyDataSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "wrote-body-data", callback: ServerMessage.WroteBodyDataSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "wrote-body-data", callback: ServerMessage.WroteBodyDataSignalCallback): NodeJS.EventEmitter
    emit(sigName: "wrote-body-data", ...args: any[]): void
    connect(sigName: "wrote-chunk", callback: ServerMessage.WroteChunkSignalCallback): number
    on(sigName: "wrote-chunk", callback: ServerMessage.WroteChunkSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "wrote-chunk", callback: ServerMessage.WroteChunkSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "wrote-chunk", callback: ServerMessage.WroteChunkSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "wrote-headers", callback: ServerMessage.WroteHeadersSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "wrote-headers", callback: ServerMessage.WroteHeadersSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "wrote-headers", callback: ServerMessage.WroteHeadersSignalCallback): NodeJS.EventEmitter
    emit(sigName: "wrote-headers", ...args: any[]): void
    connect(sigName: "wrote-informational", callback: ServerMessage.WroteInformationalSignalCallback): number
    on(sigName: "wrote-informational", callback: ServerMessage.WroteInformationalSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "wrote-informational", callback: ServerMessage.WroteInformationalSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "wrote-informational", callback: ServerMessage.WroteInformationalSignalCallback): NodeJS.EventEmitter
...
export interface Session {
     ...
     */
    sendAndSplice(msg: Message, outStream: Gio.OutputStream, flags: Gio.OutputStreamSpliceFlags, cancellable: Gio.Cancellable | null): number
    /**
     ...
     * @param callback the callback to invoke
     */
    sendAndSpliceAsync(msg: Message, outStream: Gio.OutputStream, flags: Gio.OutputStreamSpliceFlags, ioPriority: number, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void
    /**
     * Gets the response to a [method`Session`.send_and_splice_async].
     * @param result the #GAsyncResult passed to your callback
     * @returns a #gssize containing the size of the data spliced, or -1 if an error occurred.
     */
    sendAndSpliceFinish(result: Gio.AsyncResult): number
    /**
     ...
     */
    setAcceptLanguage(acceptLanguage: string | null): void
    /**
...
export interface WebsocketConnection {
     ...
     */
    sendBinary(data: number[] | null): void
    /**
...
export interface AuthDomainClass {
    ...
    checkPassword: (domain: AuthDomain, msg: ServerMessage, username: string | null, password: string | null) => boolean
    padding: any[]
}
...
export class HSTSPolicy {
     ...
     * @returns a new #SoupHSTSPolicy.
     */
    static newFull(domain: string | null, maxAge: number, expires: GLib.DateTime, includeSubdomains: boolean): HSTSPolicy
    /**
...
export interface Multipart {
     ...
     */
    appendFormFile(controlName: string | null, filename: string | null, contentType: string | null, body: any): void
    /**

...
export namespace Gck {
    ...
    class Error extends GLib.Error {
        ...
        // Constructors of Gck.Error

        constructor(options: { message: string; code: number });
        _init(...args: any[]): void;

        // Own static methods of Gck.Error
    ...
    class UriError extends GLib.Error {
        ...
        // Constructors of Gck.UriError

        constructor(options: { message: string; code: number });
        _init(...args: any[]): void;

        // Own static methods of Gck.UriError
    ...
    class UriData {
        ...
        // Own static methods of Gck.UriData

...
| Import | What you get |
|---|---|
| `@girs/metatest-12` | the namespace as a default export, plus the ambient and global declarations |
| `@girs/metatest-12/ambient` | only the `gi://` module declarations |
| `@girs/metatest-12/import` | only the `imports.gi` declarations |
| `@girs/metatest-12/metatest-12` | the namespace, without the side-effecting declarations |
| `@girs/metatest-12/vocabulary` | GIR-derived widget data: settable properties, enum nicks, slot candidates |
...
Referencing `@girs/metatest-12/ambient` instead pulls in these declarations
alone. See [ambient modules](https://github.com/gjsify/ts-for-gir/tree/main/packages/cli#ambient-modules).

### As `imports.gi`

GJS's global object works the same way, via `@girs/metatest-12/import`:
...
`metatest-12` declares widgets, so it also carries what the GIR says about them, as
types and as values a test can read:

```ts
import type { Widgets, PropsOf } from '@girs/metatest-12/vocabulary';
import { OWN_PROPS, ENUM_NICKS, PROVENANCE } from '@girs/metatest-12/vocabulary';
```

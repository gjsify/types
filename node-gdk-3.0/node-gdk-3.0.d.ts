...
import './node-gdk-3.0-import.d.ts';
 ...
 */
function cairoGetClipRectangle(cr: cairo.Context): [ /* returnType */ boolean, /* rect */ Rectangle ]
/**
 ...
 * @param forWindow The window this will be drawn to, or %NULL
 ...
 * @param confineTo If non-%NULL, the pointer will be confined to this              window during the grab. If the pointer is outside `confine_to,` it will              automatically be moved to the closest edge of `confine_to` and enter              and leave events will be generated as necessary.
 ...
 * @param time the timestamp of the event which led to this pointer grab. This usually         comes from a #GdkEventButton struct, though %GDK_CURRENT_TIME can be used if         the time isn’t known.
 * @returns %GDK_GRAB_SUCCESS if the grab was successful.
 */
 ...
 */
function propertyGet(window: Window, property: Atom, type: Atom, offset: number, length: number, pdelete: number): [ /* returnType */ boolean, /* actualPropertyType */ Atom, /* actualFormat */ number, /* data */ number[] ]
/**
 ...
 */
function textPropertyToUtf8ListForDisplay(display: Display, encoding: Atom, format: number, text: number[]): [ /* returnType */ number, /* list */ string[] ]
/**
...
interface Cursor {
     ...
     */
    getSurface(): [ /* returnType */ cairo.Surface | null, /* xHot */ number, /* yHot */ number ]
    /**
...
interface Device {
     ...
     */
    getPosition(): [ /* screen */ Screen, /* x */ number, /* y */ number ]
    /**
     ...
     * unless there is an ongoing grab on them. See gdk_device_grab().
     */
    getPositionDouble(): [ /* screen */ Screen, /* x */ number, /* y */ number ]
    /**
     ...
     */
    getWindowAtPosition(): [ /* returnType */ Window | null, /* winX */ number, /* winY */ number ]
    /**
     ...
     * @returns the #GdkWindow under the   device position, or %NULL.
     */
    getWindowAtPositionDouble(): [ /* returnType */ Window | null, /* winX */ number, /* winY */ number ]
    /**
     ...
     * @param time the timestamp of the event which led to this pointer grab. This         usually comes from the #GdkEvent struct, though %GDK_CURRENT_TIME         can be used if the time isn’t known.
     * @returns %GDK_GRAB_SUCCESS if the grab was successful.
     */
...
interface DeviceManager {
    ...
    on(sigName: "device-changed", callback: DeviceManager.DeviceChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "device-changed", callback: DeviceManager.DeviceChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "device-changed", callback: DeviceManager.DeviceChangedSignalCallback): NodeJS.EventEmitter
...
interface Display {
     ...
     */
    getWindowAtPointer(): [ /* returnType */ Window | null, /* winX */ number, /* winY */ number ]
    /**
    ...
    on(sigName: "monitor-added", callback: Display.MonitorAddedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "monitor-added", callback: Display.MonitorAddedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "monitor-added", callback: Display.MonitorAddedSignalCallback): NodeJS.EventEmitter
    emit(sigName: "monitor-added", ...args: any[]): void
    connect(sigName: "monitor-removed", callback: Display.MonitorRemovedSignalCallback): number
    on(sigName: "monitor-removed", callback: Display.MonitorRemovedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "monitor-removed", callback: Display.MonitorRemovedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "monitor-removed", callback: Display.MonitorRemovedSignalCallback): NodeJS.EventEmitter
    emit(sigName: "monitor-removed", ...args: any[]): void
...
interface DragContext {
    ...
    on(sigName: "action-changed", callback: DragContext.ActionChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "action-changed", callback: DragContext.ActionChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "action-changed", callback: DragContext.ActionChangedSignalCallback): NodeJS.EventEmitter
    emit(sigName: "action-changed", ...args: any[]): void
    connect(sigName: "cancel", callback: DragContext.CancelSignalCallback): number
    on(sigName: "cancel", callback: DragContext.CancelSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "cancel", callback: DragContext.CancelSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "cancel", callback: DragContext.CancelSignalCallback): NodeJS.EventEmitter
    emit(sigName: "cancel", ...args: any[]): void
    connect(sigName: "dnd-finished", callback: DragContext.DndFinishedSignalCallback): number
    on(sigName: "dnd-finished", callback: DragContext.DndFinishedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "dnd-finished", callback: DragContext.DndFinishedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "dnd-finished", callback: DragContext.DndFinishedSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "drop-performed", callback: DragContext.DropPerformedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "drop-performed", callback: DragContext.DropPerformedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "drop-performed", callback: DragContext.DropPerformedSignalCallback): NodeJS.EventEmitter
...
interface Keymap {
     ...
     */
    getEntriesForKeycode(hardwareKeycode: number): [ /* returnType */ boolean, /* keys */ KeymapKey[], /* keyvals */ number[] ]
    /**
...
interface Screen {
     ...
     */
    getMonitorGeometry(monitorNum: number): /* dest */ Rectangle
    /**
     ...
     * @param monitorNum the monitor number
     */
    getMonitorWorkarea(monitorNum: number): /* dest */ Rectangle
    /**
...
interface Seat {
     ...
     * @param prepareFunc function to                prepare the window to be grabbed, it can be %NULL if `window` is                visible before this call.
     * @returns %GDK_GRAB_SUCCESS if the grab was successful.
     */
...
module Window {
    ...
    interface MovedToRectSignalCallback {
        (flippedRect: any | null, finalRect: any | null, flippedX: boolean, flippedY: boolean): void
    }
...
interface Window {
     ...
     * @returns      list of child windows inside @window
     */
    getChildrenWithUserData(userData: any | null): Window[]
    /**
     ...
     */
    getDevicePosition(device: Device): [ /* returnType */ Window | null, /* x */ number, /* y */ number, /* mask */ ModifierType ]
    /**
     ...
     * @returns The window underneath @device (as with gdk_device_get_window_at_position()), or %NULL if the window is not known to GDK.
     */
    getDevicePositionDouble(device: Device): [ /* returnType */ Window | null, /* x */ number, /* y */ number, /* mask */ ModifierType ]
    /**
     ...
     */
    getDragProtocol(): [ /* returnType */ DragProtocol, /* target */ Window ]
    /**
     ...
     */
    getOrigin(): [ /* returnType */ number, /* x */ number, /* y */ number ]
    /**
     ...
     */
    getPointer(): [ /* returnType */ Window | null, /* x */ number, /* y */ number, /* mask */ ModifierType ]
    /**
     ...
     * @param rectAnchorDx horizontal offset to shift `window,` i.e. `rect'`s anchor                  point
    ...
    createSurface(width: number, height: number): cairo.Surface
    fromEmbedder(embedderX: number, embedderY: number, offscreenX: number, offscreenY: number): void
    toEmbedder(offscreenX: number, offscreenY: number, embedderX: number, embedderY: number): void

    // Own signals of Gdk-3.0.Gdk.Window

    connect(sigName: "create-surface", callback: Window.CreateSurfaceSignalCallback): number
    on(sigName: "create-surface", callback: Window.CreateSurfaceSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "create-surface", callback: Window.CreateSurfaceSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "create-surface", callback: Window.CreateSurfaceSignalCallback): NodeJS.EventEmitter
    emit(sigName: "create-surface", height: number, ...args: any[]): void
    ...
    on(sigName: "moved-to-rect", callback: Window.MovedToRectSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "moved-to-rect", callback: Window.MovedToRectSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "moved-to-rect", callback: Window.MovedToRectSignalCallback): NodeJS.EventEmitter
    emit(sigName: "moved-to-rect", finalRect: any | null, flippedX: boolean, flippedY: boolean, ...args: any[]): void
...
class Window extends GObject.Object {
     ...
     */
    constructor(parent: Window | null, attributes: WindowAttr, attributesMask: WindowAttributesType) 
    /**
     * Creates a new #GdkWindow using the attributes from
     * `attributes`. See #GdkWindowAttr and #GdkWindowAttributesType for
     * more details.  Note: to use this on displays other than the default
     ...
     */
    static atPointer(): [ /* returnType */ Window, /* winX */ number, /* winY */ number ]
    /**

 ...
 */
export function atomIntern(atomName: string | null, onlyIfExists: boolean): Atom
/**
 * Finds or creates an atom corresponding to a given string.
 * 
 ...
 * @returns the atom corresponding to @atom_name
 */
export function atomInternStaticString(atomName: string | null): Atom
/**
 ...
 */
export function propertyGet(window: Window, property: Atom, type: Atom, offset: number, length: number, pdelete: number): [ /* returnType */ boolean, /* actualPropertyType */ Atom, /* actualFormat */ number, /* data */ number[] ]
/**
 ...
 */
export function textPropertyToUtf8ListForDisplay(display: Display, encoding: Atom, format: number, text: number[]): [ /* returnType */ number, /* list */ string[] ]
/**

...
export const OWN_PROPS = {
    ...
    IdoTimeline: ['duration', 'fps', 'loop', 'screen'],
};
...
export const OWN_SIGNALS = {
    ...
    IdoTimeline: ['finished', 'frame', 'paused', 'started'],
};
...
export const PROP_TYPES = {
    'IdoScaleMenuItem.adjustment': 'GtkAdjustment',
    'IdoScaleMenuItem.reverse-scroll-events': 'gboolean',
    'IdoTimeline.duration': 'guint',
    'IdoTimeline.fps': 'guint',
    'IdoTimeline.loop': 'gboolean',
    'IdoTimeline.screen': 'GdkScreen',
};

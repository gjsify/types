...
export namespace AyatanaIdo3 {
     ...
     * @gir-type Class
     */
    class CalendarMenuItem extends Gtk.MenuItem implements Atk.ImplementorIface, Gtk.Actionable, Gtk.Activatable, Gtk.Buildable {
     ...
     * @gir-type Class
     */
    class EntryMenuItem extends Gtk.MenuItem implements Atk.ImplementorIface, Gtk.Actionable, Gtk.Activatable, Gtk.Buildable {
     ...
     * @gir-type Class
     */
    class ScaleMenuItem extends Gtk.MenuItem implements Atk.ImplementorIface, Gtk.Actionable, Gtk.Activatable, Gtk.Buildable {
        ...
        static new_with_range(label: string, size: RangeStyle, value: number, min: number, max: number, step: number): ScaleMenuItem;
    ...
    namespace SwitchMenuItem {
        ...
        // Constructor properties interface
        interface ConstructorProps extends Gtk.CheckMenuItem.ConstructorProps, Atk.ImplementorIface.ConstructorProps, Gtk.Actionable.ConstructorProps, Gtk.Activatable.ConstructorProps, Gtk.Buildable.ConstructorProps {
     ...
     * @gir-type Class
     */
    class SwitchMenuItem extends Gtk.CheckMenuItem implements Atk.ImplementorIface, Gtk.Actionable, Gtk.Activatable, Gtk.Buildable {

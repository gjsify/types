...
export namespace Xmlb {
    ...
    class Builder extends GObject.Object {
        // Constructors of Xmlb-2.0.Builder

        static ['new'](): Builder;

        // Owm methods of Xmlb-2.0.Builder
    ...
    class BuilderFixup extends GObject.Object {
        // Constructors of Xmlb-2.0.BuilderFixup

        static ['new'](id: string, func: BuilderFixupFunc): BuilderFixup;

        // Owm methods of Xmlb-2.0.BuilderFixup
    ...
    class BuilderNode extends GObject.Object {
        // Constructors of Xmlb-2.0.BuilderNode

        static ['new'](element: string): BuilderNode;

        // Owm methods of Xmlb-2.0.BuilderNode
    ...
    class BuilderSource extends GObject.Object {
        // Constructors of Xmlb-2.0.BuilderSource

        static ['new'](): BuilderSource;

        // Owm methods of Xmlb-2.0.BuilderSource
    ...
    class BuilderSourceCtx extends GObject.Object {
        // Owm methods of Xmlb-2.0.BuilderSourceCtx
    ...
    class Machine extends GObject.Object {
        // Constructors of Xmlb-2.0.Machine

        static ['new'](): Machine;

        // Owm methods of Xmlb-2.0.Machine
         ...
         */
        opcode_func_init(func_name: string): boolean;
        /**
         ...
         */
        run(opcodes: Stack, exec_data?: any | null): boolean;
        /**
         ...
         * @returns a new #XbOpcode, or %NULL
         */
        run_with_bindings(opcodes: Stack, bindings: ValueBindings | null, exec_data?: any | null): boolean;
        /**
         ...
         */
        stack_push(stack: Stack): boolean;
        /**
    ...
    class Silo extends GObject.Object {
        // Own properties of Xmlb-2.0.Silo
        ...
        // Constructors of Xmlb-2.0.Silo

        static ['new'](): Silo;

        static new_from_xml(xml: string): Silo;

        // Owm methods of Xmlb-2.0.Silo
    ...
    class BuilderFixupClass {}

    class BuilderNodeClass {}

    class BuilderSourceClass {}

    class BuilderSourceCtxClass {}
     ...
     */
    class NodeAttrIter {
        // Constructors of Xmlb-2.0.NodeAttrIter

        constructor(properties?: Partial<{}>);

        // Owm methods of Xmlb-2.0.NodeAttrIter
     ...
     */
    class NodeChildIter {
        // Constructors of Xmlb-2.0.NodeChildIter

        constructor(properties?: Partial<{}>);

        // Owm methods of Xmlb-2.0.NodeChildIter
    ...
    class Opcode {
        // Owm methods of Xmlb-2.0.Opcode
     ...
     */
    class QueryContext {
        // Constructors of Xmlb-2.0.QueryContext

        constructor(properties?: Partial<{}>);

        // Owm methods of Xmlb-2.0.QueryContext
     ...
     */
    class ValueBindings {
        // Constructors of Xmlb-2.0.ValueBindings

        constructor(properties?: Partial<{}>);

        // Owm methods of Xmlb-2.0.ValueBindings
         ...
         * @returns %TRUE if @idx was bound, %FALSE otherwise
         */
        lookup_opcode(idx: number): boolean;
    }

...
GJS TypeScript type definitions for Xmlb-2.0, generated from library version 2.0.0 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v4.0.0.
...
```ts
const Xmlb = require('@girs/xmlb-2.0');
```

...
export namespace GstRtspServer {
    ...
    class RTSPAddressPool extends GObject.Object {
        // Constructors of GstRtspServer-1.0.RTSPAddressPool

        static ['new'](): RTSPAddressPool;

        // Owm methods of GstRtspServer-1.0.RTSPAddressPool
         ...
         */
        reserve_address(ip_address: string, port: number, n_ports: number, ttl: number): RTSPAddressPoolResult;
    }
    ...
    class RTSPAuth extends GObject.Object {
        // Constructors of GstRtspServer-1.0.RTSPAuth

        static ['new'](): RTSPAuth;

        // Owm methods of GstRtspServer-1.0.RTSPAuth
    ...
    class RTSPClient extends GObject.Object {
        // Own properties of GstRtspServer-1.0.RTSPClient
        ...
        // Constructors of GstRtspServer-1.0.RTSPClient

        static ['new'](): RTSPClient;

        // Owm methods of GstRtspServer-1.0.RTSPClient
    ...
    class RTSPMedia extends GObject.Object {
        // Own properties of GstRtspServer-1.0.RTSPMedia
        ...
        // Constructors of GstRtspServer-1.0.RTSPMedia

        static ['new'](element: Gst.Element): RTSPMedia;

        // Owm methods of GstRtspServer-1.0.RTSPMedia
         ...
         * `pad` should be a pad of an element inside `media-&`gt;element.
    ...
    class RTSPMediaFactory extends GObject.Object {
        // Own properties of GstRtspServer-1.0.RTSPMediaFactory
        ...
        // Constructors of GstRtspServer-1.0.RTSPMediaFactory

        static ['new'](): RTSPMediaFactory;

        // Owm methods of GstRtspServer-1.0.RTSPMediaFactory
    ...
    class RTSPMediaFactoryURI extends RTSPMediaFactory {
        // Own properties of GstRtspServer-1.0.RTSPMediaFactoryURI

        uri: string;
        use_gstpay: boolean;
        useGstpay: boolean;

        // Constructors of GstRtspServer-1.0.RTSPMediaFactoryURI

        static ['new'](): RTSPMediaFactoryURI;

        // Owm methods of GstRtspServer-1.0.RTSPMediaFactoryURI
    ...
    class RTSPMountPoints extends GObject.Object {
        // Constructors of GstRtspServer-1.0.RTSPMountPoints

        static ['new'](): RTSPMountPoints;

        // Owm methods of GstRtspServer-1.0.RTSPMountPoints
         ...
         */
        match(path: string): RTSPMediaFactory;
        /**
    ...
    class RTSPOnvifClient extends RTSPClient {
        // Constructors of GstRtspServer-1.0.RTSPOnvifClient
    ...
    class RTSPOnvifMedia extends RTSPMedia {
        // Owm methods of GstRtspServer-1.0.RTSPOnvifMedia
    ...
    class RTSPOnvifMediaFactory extends RTSPMediaFactory {
        // Constructors of GstRtspServer-1.0.RTSPOnvifMediaFactory

        static ['new'](): RTSPOnvifMediaFactory;

        // Owm methods of GstRtspServer-1.0.RTSPOnvifMediaFactory
    ...
    class RTSPOnvifServer extends RTSPServer {
        // Constructors of GstRtspServer-1.0.RTSPOnvifServer
    ...
    class RTSPServer extends GObject.Object {
        // Own properties of GstRtspServer-1.0.RTSPServer
        ...
        // Constructors of GstRtspServer-1.0.RTSPServer

        static ['new'](): RTSPServer;

        // Owm methods of GstRtspServer-1.0.RTSPServer
    ...
    class RTSPSession extends GObject.Object {
        // Own properties of GstRtspServer-1.0.RTSPSession
        ...
        // Constructors of GstRtspServer-1.0.RTSPSession

        static ['new'](sessionid: string): RTSPSession;

        // Owm methods of GstRtspServer-1.0.RTSPSession
         ...
         */
        dup_media(path: string): RTSPSessionMedia | null;
        /**
         ...
         */
        get_media(path: string): RTSPSessionMedia | null;
        /**
    ...
    class RTSPSessionMedia extends GObject.Object {
        // Constructors of GstRtspServer-1.0.RTSPSessionMedia

        static ['new'](path: string, media: RTSPMedia): RTSPSessionMedia;

        // Owm methods of GstRtspServer-1.0.RTSPSessionMedia
    ...
    class RTSPSessionPool extends GObject.Object {
        // Own properties of GstRtspServer-1.0.RTSPSessionPool

        max_sessions: number;
        maxSessions: number;

        // Constructors of GstRtspServer-1.0.RTSPSessionPool

        static ['new'](): RTSPSessionPool;

        // Owm methods of GstRtspServer-1.0.RTSPSessionPool
    ...
    class RTSPStream extends GObject.Object {
        // Own properties of GstRtspServer-1.0.RTSPStream

        control: string;
        profiles: GstRtsp.RTSPProfile;
        protocols: GstRtsp.RTSPLowerTrans;

        // Constructors of GstRtspServer-1.0.RTSPStream

        static ['new'](idx: number, payloader: Gst.Element, pad: Gst.Pad): RTSPStream;

        // Owm methods of GstRtspServer-1.0.RTSPStream
         ...
         */
        get_server_port(family: Gio.SocketFamily): void;
        /**
    ...
    class RTSPStreamTransport extends GObject.Object {
        // Constructors of GstRtspServer-1.0.RTSPStreamTransport

        static ['new'](stream: RTSPStream, tr: GstRtsp.RTSPTransport): RTSPStreamTransport;

        // Owm methods of GstRtspServer-1.0.RTSPStreamTransport
    ...
    class RTSPThreadPool extends GObject.Object {
        // Own properties of GstRtspServer-1.0.RTSPThreadPool

        max_threads: number;
        maxThreads: number;

        // Constructors of GstRtspServer-1.0.RTSPThreadPool

        static ['new'](): RTSPThreadPool;

        // Owm methods of GstRtspServer-1.0.RTSPThreadPool
     ...
     */
    class RTSPAddress {
        // Own fields of GstRtspServer-1.0.RTSPAddress
        ...
        // Owm methods of GstRtspServer-1.0.RTSPAddress
     ...
     */
    class RTSPContext {
        // Own fields of GstRtspServer-1.0.RTSPContext
        ...
        // Owm methods of GstRtspServer-1.0.RTSPContext
     ...
     */
    class RTSPMediaFactoryURIClass {}
     ...
     */
    class RTSPMountPointsClass {}

    class RTSPMountPointsPrivate {}

    class RTSPOnvifClientClass {}

    class RTSPOnvifMediaClass {}

    class RTSPOnvifMediaFactoryClass {}

    class RTSPOnvifMediaFactoryPrivate {}

    class RTSPOnvifMediaPrivate {}

    class RTSPOnvifServerClass {}
    ...
    class RTSPPermissions {
        // Constructors of GstRtspServer-1.0.RTSPPermissions
        ...
        // Owm methods of GstRtspServer-1.0.RTSPPermissions
    ...
    class RTSPSessionClass {}

    class RTSPSessionMediaClass {}

    class RTSPSessionMediaPrivate {}

    class RTSPSessionPoolClass {}

    class RTSPSessionPoolPrivate {}

    class RTSPSessionPrivate {}

    class RTSPStreamClass {}

    class RTSPStreamPrivate {}

    class RTSPStreamTransportClass {}
     ...
     */
    class RTSPThread {
        // Own fields of GstRtspServer-1.0.RTSPThread

        type: RTSPThreadType;

        // Constructors of GstRtspServer-1.0.RTSPThread

        constructor(type: RTSPThreadType);

        static ['new'](type: RTSPThreadType): RTSPThread;

        // Owm methods of GstRtspServer-1.0.RTSPThread
     ...
     */
    class RTSPToken {
        // Constructors of GstRtspServer-1.0.RTSPToken
        ...
        // Owm methods of GstRtspServer-1.0.RTSPToken
    ...
    class SDPInfo {
        // Own fields of GstRtspServer-1.0.SDPInfo

        is_ipv6: boolean;
        server_ip: string;

        // Constructors of GstRtspServer-1.0.SDPInfo

...
static ["new"](): RTSPAuth;
    ...
    connect(signal: 'accept-certificate', callback: ((_source: this, connection: Gio.TlsConnection, peer_cert: Gio.TlsCertificate, errors: Gio.TlsCertificateFlags) => boolean)): number
    connect_after(signal: 'accept-certificate', callback: ((_source: this, connection: Gio.TlsConnection, peer_cert: Gio.TlsCertificate, errors: Gio.TlsCertificateFlags) => boolean)): number
    emit(signal: 'accept-certificate', connection: Gio.TlsConnection, peer_cert: Gio.TlsCertificate, errors: Gio.TlsCertificateFlags): void
...
static ["new"](): RTSPClient;
    ...
    connect_after(signal: 'check-requirements', callback: ((_source: this, ctx: RTSPContext, arr: string[]) => string)): number
    ...
    connect(signal: 'pre-announce-request', callback: ((_source: this, ctx: RTSPContext) => GstRtsp.RTSPStatusCode)): number
    connect_after(signal: 'pre-announce-request', callback: ((_source: this, ctx: RTSPContext) => GstRtsp.RTSPStatusCode)): number
    emit(signal: 'pre-announce-request', ctx: RTSPContext): void
    connect(signal: 'pre-describe-request', callback: ((_source: this, ctx: RTSPContext) => GstRtsp.RTSPStatusCode)): number
    connect_after(signal: 'pre-describe-request', callback: ((_source: this, ctx: RTSPContext) => GstRtsp.RTSPStatusCode)): number
    emit(signal: 'pre-describe-request', ctx: RTSPContext): void
    connect(signal: 'pre-get-parameter-request', callback: ((_source: this, ctx: RTSPContext) => GstRtsp.RTSPStatusCode)): number
    connect_after(signal: 'pre-get-parameter-request', callback: ((_source: this, ctx: RTSPContext) => GstRtsp.RTSPStatusCode)): number
    emit(signal: 'pre-get-parameter-request', ctx: RTSPContext): void
    connect(signal: 'pre-options-request', callback: ((_source: this, ctx: RTSPContext) => GstRtsp.RTSPStatusCode)): number
    connect_after(signal: 'pre-options-request', callback: ((_source: this, ctx: RTSPContext) => GstRtsp.RTSPStatusCode)): number
    ...
    connect_after(signal: 'pre-pause-request', callback: ((_source: this, ctx: RTSPContext) => GstRtsp.RTSPStatusCode)): number
    ...
    connect_after(signal: 'pre-play-request', callback: ((_source: this, ctx: RTSPContext) => GstRtsp.RTSPStatusCode)): number
    emit(signal: 'pre-play-request', ctx: RTSPContext): void
    connect(signal: 'pre-record-request', callback: ((_source: this, ctx: RTSPContext) => GstRtsp.RTSPStatusCode)): number
    connect_after(signal: 'pre-record-request', callback: ((_source: this, ctx: RTSPContext) => GstRtsp.RTSPStatusCode)): number
    emit(signal: 'pre-record-request', ctx: RTSPContext): void
    connect(signal: 'pre-set-parameter-request', callback: ((_source: this, ctx: RTSPContext) => GstRtsp.RTSPStatusCode)): number
    connect_after(signal: 'pre-set-parameter-request', callback: ((_source: this, ctx: RTSPContext) => GstRtsp.RTSPStatusCode)): number
    ...
    connect_after(signal: 'pre-setup-request', callback: ((_source: this, ctx: RTSPContext) => GstRtsp.RTSPStatusCode)): number
    emit(signal: 'pre-setup-request', ctx: RTSPContext): void
    connect(signal: 'pre-teardown-request', callback: ((_source: this, ctx: RTSPContext) => GstRtsp.RTSPStatusCode)): number
    connect_after(signal: 'pre-teardown-request', callback: ((_source: this, ctx: RTSPContext) => GstRtsp.RTSPStatusCode)): number
    ...
    connect(signal: 'send-message', callback: ((_source: this, session: RTSPSession, message: GstRtsp.RTSPMessage) => void)): number
    connect_after(signal: 'send-message', callback: ((_source: this, session: RTSPSession, message: GstRtsp.RTSPMessage) => void)): number

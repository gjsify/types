 ...
 */
export function fingerprintFromAttributes(attrs: Gck.Attributes, checksumType: GLib.ChecksumType): Uint8Array | null
/**
 ...
 * @returns the          fingerprint or %NULL if the input was invalid.
 */
export function fingerprintFromSubjectPublicKeyInfo(keyInfo: Uint8Array, checksumType: GLib.ChecksumType): Uint8Array | null
/**

// The widget vocabulary of GXml-0.14 as runtime data.
//
// GENERATED — do not edit. Provenance: GXml-0.14 — dropped empty base(s): Gee.MapIterator Gee.Iterator Gee.BidirIterator Gee.ListIterator Gee.BidirListIterator — inlined base(s) their owner's vocabulary does not emit: Gee.MapEntry — prop(s) no TypeScript value satisfies: Gee.MapEntry.value
//
...
export const OWN_PROPS = {
    ...
    GXmlSerializableArrayList: ['ignored-serializable-properties', 'properties'],
    GXmlSerializableDualKeyMap: ['ignored-serializable-properties', 'properties'],
    GXmlSerializableHashMap: ['ignored-serializable-properties', 'properties'],
    GXmlSerializableTreeMap: ['ignored-serializable-properties', 'properties'],
    GXmlTNode: ['value'],
    GXmlText: ['str'],
...
export const DECLS = {
    ...
    GXmlGomDocumentType: ['GXmlGomDocumentType', 'GXmlGomNode', 'GObject', 'GXmlDomNode', 'GXmlDomChildNode', 'GXmlDomDocumentType', 'GXmlDomEventTarget'],
    ...
    GXmlHtmlDocument: ['GXmlHtmlDocument', 'GXmlGDocument', 'GXmlGNode', 'GObject', 'GXmlDocument', 'GXmlDomParentNode', 'GXmlDomNonElementParentNode', 'GXmlDomDocument', 'GXmlDomXMLDocument', 'GXmlXPathContext', 'GXmlDomEventTarget', 'GXmlDomNode', 'GXmlNode'],

/**
 * The GIR-derived widget VOCABULARY for GXml-0.14.
 *
 ...
 *
 * 127 instantiable GTypes (of which 0 concrete widgets), 177 declarations (1 inlined from a namespace whose vocabulary does not emit them), 6 enum nick unions, 0 slot candidates.
 *
...
import type GXml from './gxml-0.14.js';
...
export interface GXmlGomDocumentTypeProps extends GXmlGomNodeProps, GXmlDomNodeProps, GXmlDomChildNodeProps, GXmlDomDocumentTypeProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GXmlGomDocumentTypeConstructOnly = GXmlGomNodeConstructOnly | GXmlDomNodeConstructOnly | GXmlDomChildNodeConstructOnly | GXmlDomDocumentTypeConstructOnly;
...
export interface GXmlHtmlDocumentProps extends GXmlGDocumentProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GXmlHtmlDocumentConstructOnly = GXmlGDocumentConstructOnly;

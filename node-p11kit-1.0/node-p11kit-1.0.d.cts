...
export const PIN_FALLBACK: string | null
export const URI_SCHEME: string | null
 ...
 */
export function spaceStrdup(string: number, maxLength: number): string | null
/**
 * In PKCS\#11 structures many strings are encoded in a strange way. The string
 * is placed in a fixed length buffer and then padded with spaces.
 * 
 ...
 */
export function uriMessage(code: number): string | null
/**
 ...
 */
export function uriParse(string: string | null, uriType: UriType, uri: Uri): number
/**

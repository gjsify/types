...
function add_missing_uri_relocation_uri(uri: string | null, recurse: boolean): boolean
/**
 ...
 */
function find_formatter_for_uri(uri: string | null): Asset
/**
...
function track_type_name(type: TrackType): string | null

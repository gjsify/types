 ...
 */
function check_element_push_buffer(element_name: string | null, buffer_in: Gst.Buffer, caps_in: Gst.Caps, buffer_out: Gst.Buffer, caps_out: Gst.Caps): void
/**
 ...
 */
function check_element_push_buffer_list(element_name: string | null, buffer_in: Gst.Buffer[], caps_in: Gst.Caps, buffer_out: Gst.Buffer[], caps_out: Gst.Caps, last_flow_return: Gst.FlowReturn): void
function check_init(argc: number, argv: string | null): void
 ...
 */
function check_setup_element(factory: string | null): Gst.Element
/**
 ...
 */
function check_setup_events_with_stream_id(srcpad: Gst.Pad, element: Gst.Element, caps: Gst.Caps | null, format: Gst.Format, stream_id: string | null): void
/**
 ...
 * @returns a new pad that can be used to check the output of @element
 */
function check_setup_sink_pad_by_name(element: Gst.Element, tmpl: Gst.StaticPadTemplate, name: string | null): Gst.Pad
function check_setup_sink_pad_by_name_from_template(element: Gst.Element, tmpl: Gst.PadTemplate, name: string | null): Gst.Pad
 ...
 * @returns A new pad that can be used to inject data on @element
 */
function check_setup_src_pad_by_name(element: Gst.Element, tmpl: Gst.StaticPadTemplate, name: string | null): Gst.Pad
function check_setup_src_pad_by_name_from_template(element: Gst.Element, tmpl: Gst.PadTemplate, name: string | null): Gst.Pad
...
function check_teardown_pad_by_name(element: Gst.Element, name: string | null): void
...
module TestClock {
    ...
    interface ConstructorProperties extends Gst.Clock.ConstructorProperties {

...
export namespace GstCheck {
    ...
    class TestClock extends Gst.Clock {
        // Own properties of GstCheck-1.0.TestClock
    ...
    class CheckABIStruct {
        // Own fields of GstCheck-1.0.CheckABIStruct

        name: string;
        size: number;
        abi_size: number;

        // Constructors of GstCheck-1.0.CheckABIStruct
     ...
     */
    class Harness {
        // Own fields of GstCheck-1.0.Harness

        element: Gst.Element;
        srcpad: Gst.Pad;
        sinkpad: Gst.Pad;

        // Owm methods of GstCheck-1.0.Harness

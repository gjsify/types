// The widget vocabulary of Clutter-5 as runtime data.
//
...
export const OWN_PROPS = {
    ...
    ClutterStage: ['accept-focus', 'color', 'cursor-visible', 'fog', 'key-focus', 'no-clear-hint', 'perspective', 'title', 'use-alpha', 'use-fog'],

/**
 * The GIR-derived widget VOCABULARY for Clutter-5.
 *
 * GENERATED — do not edit. Provenance: Clutter-5 — dropped empty base(s): Atk.ImplementorIface
 *
 * 67 instantiable GTypes (of which 0 concrete widgets), 81 declarations, 50 enum nick unions, 0 slot candidates.
 *
...
import type Clutter from './clutter-5.js';

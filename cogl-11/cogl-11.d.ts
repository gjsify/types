...
export namespace Cogl {
    ...
    class ScanoutError extends GLib.Error {
        // Own fields of Cogl-11.ScanoutError

        SCANOUT_ERROR_INHIBITED: number;

        // Constructors of Cogl-11.ScanoutError
    ...
    class Bitmap extends Object {
        // Constructors of Cogl-11.Bitmap

        static new_from_file(filename: string): Bitmap;

        // Owm methods of Cogl-11.Bitmap
    ...
    class Context extends Object {
        // Owm methods of Cogl-11.Context
    ...
    class FrameInfo extends Object {
        // Owm methods of Cogl-11.FrameInfo
    ...
    abstract class Framebuffer extends GObject.Object {
        // Own properties of Cogl-11.Framebuffer
        ...
        // Owm methods of Cogl-11.Framebuffer
    ...
    class Offscreen extends Framebuffer {
        // Constructors of Cogl-11.Offscreen
    ...
    class Onscreen extends Framebuffer {
        // Owm methods of Cogl-11.Onscreen
    ...
    class Pipeline extends Object {
        // Constructors of Cogl-11.Pipeline

        static ['new'](context: Context): Pipeline;

        // Owm methods of Cogl-11.Pipeline
    ...
    class Texture2D extends Object {
        // Constructors of Cogl-11.Texture2D

        static new_from_bitmap(bitmap: Bitmap): Texture2D;

        // Owm methods of Cogl-11.Texture2D
    ...
    class Texture2DSliced extends Object {
        // Constructors of Cogl-11.Texture2DSliced
     ...
     */
    class Color {
        // Constructors of Cogl-11.Color

        constructor(properties?: Partial<{}>);

        static ['new'](): Color;

        // Owm methods of Cogl-11.Color
    ...
    class DebugObjectTypeInfo {
        // Own fields of Cogl-11.DebugObjectTypeInfo

        name: string;
        instance_count: number;

        // Constructors of Cogl-11.DebugObjectTypeInfo
    ...
    class OnscreenDirtyInfo {
        // Own fields of Cogl-11.OnscreenDirtyInfo
        ...
        // Constructors of Cogl-11.OnscreenDirtyInfo
    ...
    class Scanout {
        // Owm methods of Cogl-11.Scanout
     ...
     */
    class TextureVertex {
        // Own fields of Cogl-11.TextureVertex
    ...
    class TraceHead {
        // Own fields of Cogl-11.TraceHead

        begin_time: number;
        name: string;
        description: string;

        // Constructors of Cogl-11.TraceHead
     ...
     */
    class UserDataKey {
        // Own fields of Cogl-11.UserDataKey

        unused: number;

        // Constructors of Cogl-11.UserDataKey
    ...
    class _ColorSizeCheck {
        // Own fields of Cogl-11._ColorSizeCheck

        compile_time_assert_CoglColor_size: number[];

        // Constructors of Cogl-11._ColorSizeCheck
    ...
    class _TextureVertexSizeCheck {
        // Own fields of Cogl-11._TextureVertexSizeCheck

        compile_time_assert_CoglTextureVertex_size: number[];

        // Constructors of Cogl-11._TextureVertexSizeCheck
    ...
    interface Texture {
        // Owm methods of Cogl-11.Texture

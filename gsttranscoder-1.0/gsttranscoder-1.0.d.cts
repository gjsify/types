 ...
 */
export function transcoder_error_get_name(error: TranscoderError): string | null
 ...
 */
export function transcoder_message_get_name(message: TranscoderMessage): string | null
/**
 ...
 */
export function transcoder_state_get_name(state: TranscoderState): string | null

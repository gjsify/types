/**
 * The GIR-derived widget VOCABULARY for GstTranscoder-1.0.
 *
 * GENERATED — do not edit. Provenance: GstTranscoder-1.0
 *
 * 2 instantiable GTypes (of which 0 concrete widgets), 2 declarations, 2 enum nick unions, 0 slot candidates.
 *
...
export type GstTranscoderMessageNick = 'position-updated' | 'duration-changed' | 'state-changed' | 'done' | 'error' | 'warning';
export type GstTranscoderStateNick = 'stopped' | 'paused' | 'playing';
...
export interface GstTranscoderProps extends GstObjectProps {
    /**
...
export type GstTranscoderConstructOnly = GstObjectConstructOnly | 'dest-uri' | 'profile' | 'src-uri';

/** Transforms #GstTranscoder bus messages to signals from the adapter object. */
export interface GstTranscoderSignalAdapterProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GstTranscoderSignalAdapterConstructOnly = GObjectConstructOnly;

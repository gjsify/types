...
export namespace GstTranscoder {
    ...
    class Transcoder extends Gst.Object {
        ...
        /** @signal */
        emit<K extends keyof Transcoder.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<Transcoder.SignalSignatures[K]>): void;
    ...
    class TranscoderSignalAdapter extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof TranscoderSignalAdapter.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<TranscoderSignalAdapter.SignalSignatures[K]>): void;

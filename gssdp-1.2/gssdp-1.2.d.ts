...
class Client extends GObject.Object implements Gio.Initable {
    ...
    set host_mask(val: Gio.InetAddressMask);
    /**
     * The network mask of the assoicated network interface.
     */
    get hostMask(): Gio.InetAddressMask;
    set hostMask(val: Gio.InetAddressMask);
    /**
...
static ["new"](client: Client, target: string): ResourceBrowser;
    ...
    connect(signal: 'resource-update', callback: ((_source: this, usn: string, boot_id: number, next_boot_id: number) => void)): number
    connect_after(signal: 'resource-update', callback: ((_source: this, usn: string, boot_id: number, next_boot_id: number) => void)): number

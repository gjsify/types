...
import './node-retro-0.14-import.d.ts';
...
module Core {
     ...
     */
    interface AudioOutputSignalCallback {
        (data: number[], sampleRate: number): void
    }
    ...
    interface MessageSignalCallback {
        (message: string | null, frames: number): boolean
    }

    /**
     * Signal callback interface for `options-set`
     */
    interface OptionsSetSignalCallback {
        (): void
    }
...
interface Core {
    ...
    on(sigName: "audio-output", callback: Core.AudioOutputSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "audio-output", callback: Core.AudioOutputSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "audio-output", callback: Core.AudioOutputSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "options-set", callback: Core.OptionsSetSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "options-set", callback: Core.OptionsSetSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "options-set", callback: Core.OptionsSetSignalCallback): NodeJS.EventEmitter

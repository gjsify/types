...
export namespace Accounts {
    ...
    class AccountsError extends GLib.Error {
        // Own fields of Accounts-1.0.AccountsError
        ...
        // Constructors of Accounts-1.0.AccountsError
    ...
    class Account extends GObject.Object {
        // Own properties of Accounts-1.0.Account
        ...
        // Owm methods of Accounts-1.0.Account
         ...
         */
        get_value(key: string, value: GObject.Value): SettingSource;
        /**
         ...
         */
        get_variant(key: string): GLib.Variant;
        /**
    ...
    class AccountService extends GObject.Object {
        // Own properties of Accounts-1.0.AccountService
        ...
        // Constructors of Accounts-1.0.AccountService

        static ['new'](account: Account, service?: Service | null): AccountService;

        // Owm methods of Accounts-1.0.AccountService
         ...
         */
        static settings_iter_next(iter: AccountSettingIter): boolean;
    ...
    class Manager extends GObject.Object {
        // Own properties of Accounts-1.0.Manager
        ...
        // Constructors of Accounts-1.0.Manager

        static ['new'](): Manager;

        static new_for_service_type(service_type: string): Manager;

        // Owm methods of Accounts-1.0.Manager
    ...
    class AccountSettingIter {
        // Own fields of Accounts-1.0.AccountSettingIter

        account: Account;

        // Owm methods of Accounts-1.0.AccountSettingIter
     ...
     */
    class Application {
        // Owm methods of Accounts-1.0.Application
     ...
     */
    class AuthData {
        // Owm methods of Accounts-1.0.AuthData
     ...
     */
    class Provider {
        // Owm methods of Accounts-1.0.Provider
     ...
     */
    class Service {
        // Owm methods of Accounts-1.0.Service
     ...
     */
    class ServiceType {
        // Owm methods of Accounts-1.0.ServiceType

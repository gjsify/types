/**
 * The GIR-derived widget VOCABULARY for Accounts-1.0.
 *
 * GENERATED — do not edit. Provenance: Accounts-1.0
 *
...
import type Accounts from './accounts-1.0.js';
...
/** Opaque structure. */
export interface AgAccountProps extends GObjectProps, GInitableProps {
    /** @default FALSE */
    foreign?: boolean;
    /**
...
export type AgAccountConstructOnly = GObjectConstructOnly | GInitableConstructOnly | 'foreign' | 'id' | 'manager' | 'provider';

/** Opaque structure. */
export interface AgAccountServiceProps extends GObjectProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type AgAccountServiceConstructOnly = GObjectConstructOnly | 'account' | 'service';

/** Opaque structure. */
export interface AgManagerProps extends GObjectProps, GInitableProps {
    /**
     * Whether to abort the application when a database timeout occurs.
     * @default FALSE
     */
    'abort-on-db-timeout'?: boolean;
    /**
    ...
    'db-timeout'?: number;
    /**
     * If the service type is set, certain operations on the #AgManager, such as ag_manager_list() and ag_manager_list_services(), will be restricted to only affect accounts or services with that service ty…
     * @default NULL
     */
    'service-type'?: string;
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type AgManagerConstructOnly = GObjectConstructOnly | GInitableConstructOnly | 'service-type' | 'use-dbus';

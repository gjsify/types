// The widget vocabulary of Unity-7.0 as runtime data.
//
...
export const OWN_PROPS = {
    ...
    UnityAggregatorActivation: ['action-type', 'channel-id', 'hints', 'scope-id', 'scope-result'],
    UnityAggregatorScope: ['automatic-flushing', 'merge-mode', 'proxy-filter-hints'],
    UnityAnnotatedIcon: ['category', 'icon', 'ribbon', 'size-hint'],
    UnityApplicationPreview: ['app-icon', 'copyright', 'last-update', 'license'],
    UnityCategory: ['content-type', 'default-renderer', 'icon-hint', 'id', 'name', 'renderer-hint'],
    UnityDeprecatedScopeBase: ['categories', 'dbus-path', 'filters', 'id', 'is-master', 'schema', 'search-hint', 'search-in-global', 'sources', 'visible'],
    UnityDeprecatedScopeSearch: ['channel-id', 'hints', 'owner', 'results-model'],
    ...
    UnityMasterScope: ['no-content-hint'],
    ...
    UnityOptionsFilter: ['show-all-button', 'sort-type'],
    UnityPaymentPreview: ['email', 'header', 'payment-method', 'preview-type', 'purchase-prize', 'purchase-type'],
    UnityPlaylist: ['creation-date', 'icon', 'id', 'last-play-date', 'modification-date', 'name'],
    UnityPreferencesManager: ['always-search', 'disabled-scopes', 'home-lens-default-view', 'home-lens-priority', 'remote-content-search'],
    ...
    UnityProgressSourceProvider: ['dbus-name', 'dbus-path'],
    UnityRatingsFilter: ['rating'],
    UnityScopeDBusConnector: ['scope'],
    UnitySimpleScope: ['category-set', 'filter-set', 'group-name', 'schema', 'search-hint', 'unique-name'],
...
export const OWN_SIGNALS = {
    UnityAbstractScope: ['results-invalidated-internal'],
    UnityAggregatedScopeSearch: ['category-order-changed', 'transaction-complete'],
    UnityAppInfoManager: ['changed'],
    UnityDeprecatedScope: ['activate-uri', 'generate-search-key', 'preview-uri', 'search-changed'],
    UnityDeprecatedScopeBase: ['active-sources-changed'],
    UnityDeprecatedScopeSearch: ['finished'],
    UnityFilter: ['changed'],
    UnityLauncherFavorites: ['changed'],
    UnityMusicPlayer: ['activate-playlist', 'next', 'play-pause', 'previous', 'raise'],
...
export const DECLS = {
    UnityActivationResponse: ['UnityActivationResponse', 'GObject'],
    UnityAggregatedScopeSearch: ['UnityAggregatedScopeSearch', 'UnityDeprecatedScopeSearch', 'UnityScopeSearchBase', 'GObject'],
    UnityAggregatorActivation: ['UnityAggregatorActivation', 'GObject'],
    UnityAnnotatedIcon: ['UnityAnnotatedIcon', 'GObject'],
    UnityAppInfoManager: ['UnityAppInfoManager', 'GObject'],
    UnityApplicationPreview: ['UnityApplicationPreview', 'UnityPreview', 'UnityAbstractPreview', 'GObject', 'DeeSerializable'],
    UnityCategory: ['UnityCategory', 'GObject'],
    UnityCategorySet: ['UnityCategorySet', 'GObject'],
    UnityCheckOptionFilter: ['UnityCheckOptionFilter', 'UnityOptionsFilter', 'UnityFilter', 'GObject', 'DeeSerializable'],
    UnityCheckOptionFilterCompact: ['UnityCheckOptionFilterCompact', 'UnityOptionsFilter', 'UnityFilter', 'GObject', 'DeeSerializable'],
    UnityDeprecatedScope: ['UnityDeprecatedScope', 'UnityDeprecatedScopeBase', 'GObject'],
    UnityDeprecatedScopeSearch: ['UnityDeprecatedScopeSearch', 'UnityScopeSearchBase', 'GObject'],
    UnityFilterOption: ['UnityFilterOption', 'GObject'],
    UnityFilterSet: ['UnityFilterSet', 'GObject'],
    UnityGenericPreview: ['UnityGenericPreview', 'UnityPreview', 'UnityAbstractPreview', 'GObject', 'DeeSerializable'],
    UnityGeoCoordinate: ['UnityGeoCoordinate', 'GObject'],
    ...
    UnityMasterScope: ['UnityMasterScope', 'UnityAggregatorScope', 'UnityDeprecatedScopeBase', 'GObject'],
    UnityMoviePreview: ['UnityMoviePreview', 'UnityPreview', 'UnityAbstractPreview', 'GObject', 'DeeSerializable'],
    UnityMultiRangeFilter: ['UnityMultiRangeFilter', 'UnityOptionsFilter', 'UnityFilter', 'GObject', 'DeeSerializable'],
    UnityMusicPlayer: ['UnityMusicPlayer', 'GObject'],
    UnityMusicPreview: ['UnityMusicPreview', 'UnityPreview', 'UnityAbstractPreview', 'GObject', 'DeeSerializable'],
    UnityOptionsFilter: ['UnityOptionsFilter', 'UnityFilter', 'GObject', 'DeeSerializable'],
    UnityPaymentPreview: ['UnityPaymentPreview', 'UnityPreview', 'UnityAbstractPreview', 'GObject', 'DeeSerializable'],
    ...
    UnityProgressSourceProvider: ['UnityProgressSourceProvider', 'UnityMetadataProvider', 'GObject'],
    UnityRadioOptionFilter: ['UnityRadioOptionFilter', 'UnityOptionsFilter', 'UnityFilter', 'GObject', 'DeeSerializable'],
    UnityRatingsFilter: ['UnityRatingsFilter', 'UnityFilter', 'GObject', 'DeeSerializable'],
    UnitySchema: ['UnitySchema', 'GObject'],
    UnityScopeDBusConnector: ['UnityScopeDBusConnector', 'GObject'],
    UnityScopeLoader: ['UnityScopeLoader', 'GObject'],
    UnitySearchMetadata: ['UnitySearchMetadata', 'GObject'],
    UnitySimpleScope: ['UnitySimpleScope', 'UnityAbstractScope', 'GObject'],
    UnitySocialPreview: ['UnitySocialPreview', 'UnityPreview', 'UnityAbstractPreview', 'GObject', 'DeeSerializable'],
...
export const ENUM_NICKS = {
    UnityAggregatorScopeMergeMode: ['category-id', 'owner-scope'],
    UnityAggregatorScopeSortFlags: ['ascending', 'descending', 'case-insensitive'],
    UnityCategoryContentType: ['default', 'applications', 'music', 'video', 'places', 'social', 'weather'],
    UnityCategoryRenderer: ['default', 'grid', 'carousel', 'list', 'dynamic', 'special', 'vertical-tile', 'horizontal-tile'],
    ...
    UnityHandledType: ['not-handled', 'show-dash', 'hide-dash', 'goto-dash-uri', 'show-preview', 'perform-search'],
    ...
    UnityPaymentPreviewType: ['application', 'music', 'error'],
    UnityPlaybackState: ['playing', 'paused'],
    UnityPreferencesManagerRemoteContent: ['all', 'none'],
    UnityResultType: ['default', 'personal', 'semi-personal'],
    UnitySchemaFieldType: ['optional', 'required'],
    UnitySearchType: ['default', 'global', 'n-types'],
    UnitySerializationType: ['binary', 'json'],
};
...
export const ENUM_VALUES = {
    'UnityAggregatorScopeMergeMode.category-id': 0,
    'UnityAggregatorScopeMergeMode.owner-scope': 1,
    'UnityAggregatorScopeSortFlags.ascending': 0,
    'UnityAggregatorScopeSortFlags.descending': 1,
    'UnityCategoryContentType.applications': 1,
    'UnityCategoryContentType.default': 0,
    'UnityCategoryContentType.music': 2,
    'UnityCategoryContentType.places': 4,
    'UnityCategoryContentType.social': 5,
    'UnityCategoryContentType.video': 3,
    'UnityCategoryContentType.weather': 6,
    'UnityCategoryRenderer.carousel': 2,
    'UnityCategoryRenderer.default': 0,
    'UnityCategoryRenderer.dynamic': 1000,
    'UnityCategoryRenderer.grid': 1,
    'UnityCategoryRenderer.horizontal-tile': 1,
    'UnityCategoryRenderer.list': 3,
    'UnityCategoryRenderer.special': 1001,
    ...
    'UnityHandledType.perform-search': 5,
    ...
    'UnityPaymentPreviewType.application': 0,
    'UnityPaymentPreviewType.error': 2,
    'UnityPaymentPreviewType.music': 1,
    ...
    'UnityResultType.default': 0,
    'UnityResultType.personal': 1,
    'UnityResultType.semi-personal': 2,
    'UnitySchemaFieldType.optional': 0,
    'UnitySchemaFieldType.required': 1,
    'UnitySearchType.default': 0,
    'UnitySearchType.global': 1,
    'UnitySearchType.n-types': 2,
    'UnitySerializationType.binary': 0,
    'UnitySerializationType.json': 1,
};
...
export const ENUM_VALUES_UNREADABLE = {
    'UnityAggregatorScopeSortFlags.case-insensitive': '(null)',
};
...
export const PROP_ENUMS = {
    ...
    'UnityAggregatorScope.merge-mode': 'UnityAggregatorScopeMergeMode',
    'UnityAnnotatedIcon.category': 'UnityCategoryType',
    'UnityAnnotatedIcon.size-hint': 'UnityIconSizeHint',
    'UnityCategory.content-type': 'UnityCategoryContentType',
    ...
    'UnityPaymentPreview.preview-type': 'UnityPaymentPreviewType',
...
export const PROP_TYPES = {
    ...
    'UnityActivationResponse.handled': 'UnityHandledType',
    'UnityAggregatorActivation.action-type': 'guint',
    'UnityAggregatorActivation.channel-id': 'gchararray',
    'UnityAggregatorActivation.scope-id': 'gchararray',
    'UnityAggregatorScope.automatic-flushing': 'gboolean',
    'UnityAggregatorScope.merge-mode': 'UnityAggregatorScopeMergeMode',
    'UnityAggregatorScope.proxy-filter-hints': 'gboolean',
    'UnityAnnotatedIcon.category': 'UnityCategoryType',
    ...
    'UnityCategory.id': 'gchararray',
    'UnityCategory.name': 'gchararray',
    'UnityCategory.renderer-hint': 'gchararray',
    'UnityDeprecatedScopeBase.categories': 'UnityCategorySet',
    'UnityDeprecatedScopeBase.dbus-path': 'gchararray',
    'UnityDeprecatedScopeBase.filters': 'UnityFilterSet',
    'UnityDeprecatedScopeBase.id': 'gchararray',
    'UnityDeprecatedScopeBase.is-master': 'gboolean',
    'UnityDeprecatedScopeBase.schema': 'UnitySchema',
    'UnityDeprecatedScopeBase.search-hint': 'gchararray',
    'UnityDeprecatedScopeBase.search-in-global': 'gboolean',
    'UnityDeprecatedScopeBase.sources': 'UnityOptionsFilter',
    'UnityDeprecatedScopeBase.visible': 'gboolean',
    'UnityDeprecatedScopeSearch.channel-id': 'gchararray',
    'UnityDeprecatedScopeSearch.owner': 'UnityDeprecatedScopeBase',
    'UnityDeprecatedScopeSearch.results-model': 'DeeSerializableModel',
    ...
    'UnityMasterScope.no-content-hint': 'gchararray',
    ...
    'UnityOptionsFilter.show-all-button': 'gboolean',
    'UnityOptionsFilter.sort-type': 'UnityOptionsFilterSortType',
    'UnityPaymentPreview.email': 'gchararray',
    'UnityPaymentPreview.header': 'gchararray',
    'UnityPaymentPreview.payment-method': 'gchararray',
    'UnityPaymentPreview.preview-type': 'UnityPaymentPreviewType',
    'UnityPaymentPreview.purchase-prize': 'gchararray',
    'UnityPaymentPreview.purchase-type': 'gchararray',
    ...
    'UnityPreviewAction.layout-hint': 'UnityLayoutHint',
    'UnityProgressSourceProvider.dbus-name': 'gchararray',
    'UnityProgressSourceProvider.dbus-path': 'gchararray',
    'UnityRatingsFilter.rating': 'gfloat',
    'UnityScopeDBusConnector.scope': 'UnityAbstractScope',
    'UnitySimpleScope.category-set': 'UnityCategorySet',
    'UnitySimpleScope.filter-set': 'UnityFilterSet',
    'UnitySimpleScope.group-name': 'gchararray',
    'UnitySimpleScope.schema': 'UnitySchema',
    'UnitySimpleScope.search-hint': 'gchararray',
    'UnitySimpleScope.unique-name': 'gchararray',

...
_init(...args: any[]): void;
    ...
    connect_after(signal: 'changed', callback: ((_source: this, id: string, new_appinfo: Gio.AppInfo) => void)): number
...
static ["new"](owner: AggregatorScope, channel_id: string, hints: GLib.HashTable<string, GLib.Variant>, results_model: Dee.SerializableModel): AggregatedScopeSearch;
    ...
    connect_after(signal: 'transaction-complete', callback: ((_source: this, origin_scope_id: string) => void)): number
    emit(signal: 'transaction-complete', origin_scope_id: string): void
    connect(signal: 'category-order-changed', callback: ((_source: this, category_indices: number[]) => void)): number
    connect_after(signal: 'category-order-changed', callback: ((_source: this, category_indices: number[]) => void)): number
    emit(signal: 'category-order-changed', category_indices: number[]): void

    // Own methods of Unity.AggregatedScopeSearch

    search_scope(scope_id: string, search_string: string, search_type: SearchType, hints: GLib.HashTable<string, GLib.Variant>, _callback_: Gio.AsyncReadyCallback<this>): void
...
_init(...args: any[]): void;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'results-invalidated-internal', callback: ((_source: this, search_type: SearchType) => void)): number
    connect_after(signal: 'results-invalidated-internal', callback: ((_source: this, search_type: SearchType) => void)): number
...
_init(...args: any[]): void;
    ...
    connect_after(signal: 'active-sources-changed', callback: ((_source: this, active_ids: string[]) => void)): number
...
static ["new"](dbus_path_: string, id_: string): DeprecatedScope;
    ...
    connect(signal: 'generate-search-key', callback: ((_source: this, search: DeprecatedScopeSearch) => string)): number
    connect_after(signal: 'generate-search-key', callback: ((_source: this, search: DeprecatedScopeSearch) => string)): number
    emit(signal: 'generate-search-key', search: DeprecatedScopeSearch): void
    connect(signal: 'search-changed', callback: ((_source: this, search: DeprecatedScopeSearch, search_type: SearchType, cancellable: Gio.Cancellable) => void)): number
    connect_after(signal: 'search-changed', callback: ((_source: this, search: DeprecatedScopeSearch, search_type: SearchType, cancellable: Gio.Cancellable) => void)): number
    emit(signal: 'search-changed', search: DeprecatedScopeSearch, search_type: SearchType, cancellable: Gio.Cancellable): void
...
_init(...args: any[]): void;
    ...
    static create(uri: string, icon_hint: string, category: number, result_type: ResultType, mimetype: string, title: string, comment: string, dnd_uri: string, metadata: GLib.HashTable<string, GLib.Variant>): ScopeResult
...
_init(...args: any[]): void;
    ...
    static create(search_query: string, search_type: SearchType, filter_state: FilterSet, metadata: GLib.HashTable<string, GLib.Variant>, result_set: ResultSet, cancellable: Cancellable): SearchContext

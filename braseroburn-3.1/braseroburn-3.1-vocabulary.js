...
export const OWN_PROPS = {
    ...
    BraseroBurnSession: ['flags', 'speed', 'tmpdir'],
};

export const OWN_SIGNALS = {
    BraseroBurn: ['action-changed', 'blank-failure', 'disable-joliet', 'dummy-success', 'eject-failure', 'insert-media', 'install-missing', 'location-request', 'progress-changed', 'warn-audio-to-appendable', 'warn-data-loss', 'warn-previous-session-loss', 'warn-rewritable'],
    BraseroBurnSession: ['output-changed', 'tag-changed', 'track-added', 'track-changed', 'track-removed'],
    BraseroSessionCfg: ['is-valid', 'wrong-extension'],
    BraseroTrack: ['changed'],
    BraseroTrackDataCfg: ['deep-directory', 'icon-changed', 'image-uri', 'joliet-rename', 'name-collision', 'recursive-sym', 'session-available', 'session-loaded', 'source-loaded', 'source-loading', 'unknown-uri', 'unreadable-uri'],
};
...
export const PROP_TYPES = {
    'BraseroBurnOptions.session': 'BraseroBurnSession',
    'BraseroBurnSession.flags': 'gint',
    'BraseroBurnSession.speed': 'gint64',
    'BraseroBurnSession.tmpdir': 'gchararray',
};

...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type BraseroSessionCfgConstructOnly = BraseroSessionSpanConstructOnly;

export interface BraseroSessionSpanProps extends BraseroBurnSessionProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type BraseroTrackDataConstructOnly = BraseroTrackConstructOnly;

export interface BraseroTrackDataCfgProps extends BraseroTrackDataProps, GtkTreeDragDestProps, GtkTreeDragSourceProps, GtkTreeModelProps, GtkTreeSortableProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type BraseroTrackDataCfgConstructOnly = BraseroTrackDataConstructOnly | GtkTreeDragDestConstructOnly | GtkTreeDragSourceConstructOnly | GtkTreeModelConstructOnly | GtkTreeSortableConstructOnly;

export interface BraseroTrackDiscProps extends BraseroTrackProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type BraseroTrackDiscConstructOnly = BraseroTrackConstructOnly;

export interface BraseroTrackImageProps extends BraseroTrackProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type BraseroTrackImageConstructOnly = BraseroTrackConstructOnly;

export interface BraseroTrackImageCfgProps extends BraseroTrackImageProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type BraseroTrackImageCfgConstructOnly = BraseroTrackImageConstructOnly;

export interface BraseroTrackStreamProps extends BraseroTrackProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type BraseroTrackStreamConstructOnly = BraseroTrackConstructOnly;

export interface BraseroTrackStreamCfgProps extends BraseroTrackStreamProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type BraseroTrackStreamCfgConstructOnly = BraseroTrackStreamConstructOnly;

/**
 * The GIR-derived widget VOCABULARY for CoglPango-10.
 *
 * GENERATED — do not edit. Provenance: CoglPango-10 — dropped empty base(s): Pango.Renderer — prop(s) no TypeScript value satisfies: CoglPango.Renderer.context
 *

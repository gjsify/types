 ...
 */
export function namedDestFromBytestring(data: number[]): string | null
/**
 ...
 */
export function namedDestToBytestring(name: string | null): number[] | null
/**
...
export class Document extends GObject.Object {
     ...
     * @returns A newly created #PopplerDocument, or %NULL
     */
    static newFromData(data: number[], password: string | null): Document
    /**

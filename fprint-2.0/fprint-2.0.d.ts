...
export namespace FPrint {
    ...
    abstract class Device extends GObject.Object implements Gio.AsyncInitable<Device> {
         ...
         * @deprecated since 1.92.0: Use `fp_device_has_feature()` instead.
         */
        has_storage(): boolean;
    ...
    abstract class ImageDevice extends Device implements Gio.AsyncInitable<ImageDevice> {
        ...
        /** @signal */
        emit<K extends keyof ImageDevice.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<ImageDevice.SignalSignatures[K]>): void;
    ...
    class Print extends GObject.InitiallyUnowned {
        ...
        /** @signal */
        emit<K extends keyof Print.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<Print.SignalSignatures[K]>): void;

...
export interface GdStyledTextRendererProps extends GtkCellRendererTextProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GdStyledTextRendererConstructOnly = GtkCellRendererTextConstructOnly;
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GdTogglePixbufRendererConstructOnly = GtkCellRendererPixbufConstructOnly;

export interface GdTwoLinesRendererProps extends GtkCellRendererTextProps {
    'line-two'?: string;
    'text-lines'?: number;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GdTwoLinesRendererConstructOnly = GtkCellRendererTextConstructOnly;

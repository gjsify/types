...
import './gtkspell-3.0-import.d.ts';
/**
 * GtkSpell-3.0
 */
...
export namespace GtkSpell {
    ...
    class Error extends GLib.Error {
        // Own fields of GtkSpell-3.0.Error
        ...
        // Constructors of GtkSpell-3.0.Error

        constructor(options: { message: string; code: number });

        // Owm methods of GtkSpell-3.0.Error
    ...
    class Checker extends GObject.InitiallyUnowned {
        // Own properties of GtkSpell-3.0.Checker

        decode_language_codes: boolean;
        decodeLanguageCodes: boolean;

        // Constructors of GtkSpell-3.0.Checker

        static ['new'](): Checker;

        // Owm methods of GtkSpell-3.0.Checker

...
export namespace RygelRendererGst {
    class PlaybinPlayerError extends GLib.Error {
        // Own fields of RygelRendererGst-2.6.PlaybinPlayerError

        NO_ELEMENT: number;

        // Constructors of RygelRendererGst-2.6.PlaybinPlayerError
    ...
    class PlaybinPlayer extends GObject.Object {
        // Own properties of RygelRendererGst-2.6.PlaybinPlayer

        playbin: Gst.Element;
        readonly supported_profiles: RygelCore.DLNAProfile[];
        readonly supportedProfiles: RygelCore.DLNAProfile[];

        // Owm methods of RygelRendererGst-2.6.PlaybinPlayer
    ...
    class PlaybinRenderer extends RygelRenderer.MediaRenderer {
        // Constructors of RygelRendererGst-2.6.PlaybinRenderer

        static ['new'](title: string): PlaybinRenderer;

        // Owm methods of RygelRendererGst-2.6.PlaybinRenderer

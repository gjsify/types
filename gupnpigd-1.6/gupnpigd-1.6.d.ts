...
import './gupnpigd-1.6-ambient.d.ts';
import './gupnpigd-1.6-import.d.ts';
/**
 * GUPnPIgd-1.6
 */
...
export namespace GUPnPIgd {
    ...
    class SimpleIgd extends GObject.Object {
        // Own properties of GUPnPIgd-1.6.SimpleIgd

        readonly main_context: any;
        readonly mainContext: any;

        // Constructors of GUPnPIgd-1.6.SimpleIgd

        static ['new'](): SimpleIgd;

        // Owm methods of GUPnPIgd-1.6.SimpleIgd
    ...
    class SimpleIgdThread extends SimpleIgd {
        // Constructors of GUPnPIgd-1.6.SimpleIgdThread

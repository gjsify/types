...
_init(...args: any[]): void;
     ...
     * @returns a string, or %NULL.  g_free() after use.
     */
    get_icon_url(requested_mime_type: (string | null), requested_depth: number, requested_width: number, requested_height: number, prefer_bigger: boolean): [string, string, number, number, number]
    /**
...
_init(...args: any[]): void;
    ...
    connect(signal: 'notify-failed', callback: ((_source: this, callback_url: Soup.URI[], reason: GLib.Error) => void)): number
    connect_after(signal: 'notify-failed', callback: ((_source: this, callback_url: Soup.URI[], reason: GLib.Error) => void)): number
...
_init(...args: any[]): void;
     ...
     */
    begin_action_list(action: string, in_names: string[], in_values: GObject.Value[], callback: ServiceProxyActionCallback): ServiceProxyAction
    /**
     ...
     * @returns %TRUE on success.
     */
    end_action_hash(action: ServiceProxyAction, error: GLib.Error): [boolean, GLib.HashTable<string, GObject.Value>]
    /**
     * See gupnp_service_proxy_end_action(); this version takes a #GHashTable for
     * runtime generated parameter lists.
     * @param action A #GUPnPServiceProxyAction handle
     ...
     * @returns %TRUE on success.
     */
    end_action_hash(action: ServiceProxyAction, hash: GLib.HashTable<string, GObject.Value>): [boolean, GLib.HashTable<string, GObject.Value>]
    /**
     ...
     * @returns %TRUE on success.
     */
    end_action_list(action: ServiceProxyAction, out_names: string[], out_types: GObject.GType[]): [boolean, GObject.Value[]]
    /**
     ...
     */
    send_action_list(action: string, in_names: string[], in_values: GObject.Value[], out_names: string[], out_types: GObject.GType[]): [boolean, GObject.Value[]]
    /**
...
class WhiteList extends GObject.Object {
    ...
    // Own properties of GUPnP.WhiteList
    ...
    // Constructors of GUPnP.WhiteList
...
static ["new"](): WhiteList;
    ...
    // Own methods of GUPnP.WhiteList
...
abstract class ContextManagerPrivate {
    ...
    // Constructors of GUPnP.ContextManagerPrivate
...
abstract class ContextPrivate {
    ...
    // Constructors of GUPnP.ContextPrivate
...
abstract class ControlPointPrivate {
    ...
    // Constructors of GUPnP.ControlPointPrivate
...
abstract class DeviceInfoPrivate {
    ...
    // Constructors of GUPnP.DeviceInfoPrivate
...
abstract class DevicePrivate {
    ...
    // Constructors of GUPnP.DevicePrivate
...
abstract class DeviceProxyPrivate {
    ...
    // Constructors of GUPnP.DeviceProxyPrivate
...
abstract class ResourceFactoryPrivate {
    ...
    // Constructors of GUPnP.ResourceFactoryPrivate
...
abstract class RootDevicePrivate {
    ...
    // Constructors of GUPnP.RootDevicePrivate
...
abstract class ServiceInfoPrivate {
    ...
    // Constructors of GUPnP.ServiceInfoPrivate
...
abstract class ServiceIntrospectionPrivate {
    ...
    // Constructors of GUPnP.ServiceIntrospectionPrivate
...
abstract class ServicePrivate {
    ...
    // Constructors of GUPnP.ServicePrivate
...
abstract class ServiceProxyPrivate {
    ...
    // Constructors of GUPnP.ServiceProxyPrivate
...
abstract class WhiteListPrivate {
    ...
    // Constructors of GUPnP.WhiteListPrivate

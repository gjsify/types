...
interface WebView extends Atk.ImplementorIface, Gtk.Buildable {
     ...
     */
    call_async_javascript_function(body: string, length: number, arguments_: GLib.Variant | null, world_name: string | null, source_uri: string | null, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback<this> | null): void
    /**

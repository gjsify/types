 ...
 */
const EDITING_COMMAND_COPY: string | null
/**
 ...
 */
const EDITING_COMMAND_CREATE_LINK: string | null
/**
 ...
 */
const EDITING_COMMAND_CUT: string | null
/**
 ...
 */
const EDITING_COMMAND_INSERT_IMAGE: string | null
/**
 ...
 */
const EDITING_COMMAND_PASTE: string | null
/**
 ...
 * and clipboard is not empty.
 */
const EDITING_COMMAND_PASTE_AS_PLAIN_TEXT: string | null
/**
 ...
 */
const EDITING_COMMAND_REDO: string | null
/**
 ...
 */
const EDITING_COMMAND_SELECT_ALL: string | null
/**
 ...
 */
const EDITING_COMMAND_UNDO: string | null
/**
 ...
 */
function media_key_system_permission_get_name(request: MediaKeySystemPermissionRequest): string | null
/**
 ...
 */
function uri_for_display(uri: string | null): string | null
/**
...
interface ClipboardPermissionRequest extends PermissionRequest {
    ...
    // Own fields of WebKit2-4.1.WebKit2.ClipboardPermissionRequest

    parent: GObject.Object
    priv: ClipboardPermissionRequestPrivate

    // Class property signals of WebKit2-4.1.WebKit2.ClipboardPermissionRequest
...
class ClipboardPermissionRequest extends GObject.Object {
    ...
    // Own properties of WebKit2-4.1.WebKit2.ClipboardPermissionRequest

    static name: string
    static $gtype: GObject.GType<ClipboardPermissionRequest>

    // Constructors of WebKit2-4.1.WebKit2.ClipboardPermissionRequest
...
interface PrintCustomWidget {
    ...
    connect_after(sigName: "apply", callback: PrintCustomWidget.ApplySignalCallback): number
    emit(sigName: "apply", ...args: any[]): void
    connect(sigName: "update", callback: PrintCustomWidget.UpdateSignalCallback): number
    connect_after(sigName: "update", callback: PrintCustomWidget.UpdateSignalCallback): number
...
interface PrintOperation {
    ...
    connect_after(sigName: "create-custom-widget", callback: PrintOperation.CreateCustomWidgetSignalCallback): number
...
module UserContentManager {
    ...
    interface ScriptMessageReceivedSignalCallback {
        ($obj: UserContentManager, value: JavascriptResult): void
    }
...
interface UserContentManager {
    ...
    emit(sigName: "script-message-received", value: JavascriptResult, ...args: any[]): void
...
module WebContext {
     ...
     */
    interface InitializeWebExtensionsSignalCallback {
        ($obj: WebContext): void
    }
...
interface WebContext {
    ...
    connect_after(sigName: "download-started", callback: WebContext.DownloadStartedSignalCallback): number
...
interface WebResource {
    ...
    connect_after(sigName: "received-data", callback: WebResource.ReceivedDataSignalCallback): number
    emit(sigName: "received-data", data_length: number, ...args: any[]): void
...
module WebView {
     ...
     */
    interface WebProcessCrashedSignalCallback {
        ($obj: WebView): boolean
    }
    ...
    interface ConstructorProperties extends Atk.ImplementorIface.ConstructorProperties, Gtk.Buildable.ConstructorProperties, WebViewBase.ConstructorProperties {
...
interface WebView extends Atk.ImplementorIface, Gtk.Buildable {
    ...
    connect_after(sigName: "web-process-crashed", callback: WebView.WebProcessCrashedSignalCallback): number
...
interface WebViewBase extends Atk.ImplementorIface, Gtk.Buildable {
...
module WebsiteDataManager {
    ...
    interface ConstructorProperties extends GObject.Object.ConstructorProperties {
         ...
         * means WebKit will use the default quota (1 GiB).
         */
        originStorageRatio?: number | null
        /**
         * The directory where service workers registrations will be stored.
         */
...
interface ClipboardPermissionRequestClass {
    ...
    // Own fields of WebKit2-4.1.WebKit2.ClipboardPermissionRequestClass
...
abstract class ClipboardPermissionRequestClass {
    ...
    // Own properties of WebKit2-4.1.WebKit2.ClipboardPermissionRequestClass
...
class ClipboardPermissionRequestPrivate {
    ...
    // Own properties of WebKit2-4.1.WebKit2.ClipboardPermissionRequestPrivate
...
interface Feature {
    ...
    // Owm methods of WebKit2-4.1.WebKit2.Feature
...
class Feature {
    ...
    // Own properties of WebKit2-4.1.WebKit2.Feature
...
interface FeatureList {
    ...
    // Owm methods of WebKit2-4.1.WebKit2.FeatureList
...
class FeatureList {
    ...
    // Own properties of WebKit2-4.1.WebKit2.FeatureList
...
interface InputMethodContextClass {
    ...
    filter_key_event: (context: InputMethodContext, key_event: Gdk.EventKey) => boolean
...
interface WebViewClass {
    ...
    show_option_menu: (web_view: WebView, menu: OptionMenu, event: Gdk.Event, rectangle: Gdk.Rectangle) => boolean

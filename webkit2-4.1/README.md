...
GJS TypeScript type definitions for WebKit2-4.1, generated from library version 2.44.1 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v4.0.0-beta.3.

 ...
 */
function codecListFromKeyfile(filename: string | null): Codec[]
 ...
 */
function mediaTypeToString(mediaType: MediaType): string | null
/**
 ...
 */
function parseError(object: GObject.Object, message: Gst.Message): [ /* returnType */ boolean, /* error */ Error, /* errorMsg */ string | null ]
/**
 ...
 */
function rtpHeaderExtensionListFromKeyfile(filename: string | null, mediaType: MediaType): RtpHeaderExtension[]
/**

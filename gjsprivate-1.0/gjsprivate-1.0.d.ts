...
export namespace GjsPrivate {
     ...
     * @param from_callback 
     */
    function g_binding_group_bind_full(source: GObject.BindingGroup, source_property: string, target: GObject.Object, target_property: string, flags: GObject.BindingFlags, to_callback: BindingTransformFunc, from_callback: BindingTransformFunc): void;
     ...
     * @param from_callback 
     */
    function g_object_bind_property_full(source: GObject.Object, source_property: string, target: GObject.Object, target_property: string, flags: GObject.BindingFlags, to_callback: BindingTransformFunc, from_callback: BindingTransformFunc): GObject.Binding;
     ...
     * @param compare_func 
     */
    function list_store_insert_sorted(store: Gio.ListStore, item: GObject.Object, compare_func: CompareDataFunc): number;
    ...
    class DBusImplementation extends Gio.DBusInterfaceSkeleton implements Gio.DBusInterface {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof DBusImplementation.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, DBusImplementation.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof DBusImplementation.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, DBusImplementation.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof DBusImplementation.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<DBusImplementation.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;

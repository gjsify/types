/**
 * The GIR-derived widget VOCABULARY for Clutter-8.
 *
 * GENERATED — do not edit. Provenance: Clutter-8 — dropped empty base(s): Atk.ImplementorIface
 *
 * 59 instantiable GTypes (of which 0 concrete widgets), 72 declarations, 50 enum nick unions, 0 slot candidates.
 *
...
import type Clutter from './clutter-8.js';
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type ClutterStageViewConstructOnly = GObjectConstructOnly | 'name' | 'offscreen' | 'stage' | 'use-shadowfb';

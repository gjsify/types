// The widget vocabulary of AtrilDocument-1.5.0 as runtime data.
//
// GENERATED — do not edit. Provenance: AtrilDocument-1.5.0 — library 1.28.6 — prop(s) no TypeScript value satisfies: AtrilDocument.Annotation.color AtrilDocument.Attachment.data AtrilDocument.Link.action AtrilDocument.LinkAction.dest AtrilDocument.LinkAction.hide-list AtrilDocument.LinkAction.show-list AtrilDocument.LinkAction.toggle-list
//
...
export const PROVENANCE = {
    ...
    droppedBases: [],
    inlinedBases: [],
    unsettableProps: ['AtrilDocument.Annotation.color', 'AtrilDocument.Attachment.data', 'AtrilDocument.Link.action', 'AtrilDocument.LinkAction.dest', 'AtrilDocument.LinkAction.hide-list', 'AtrilDocument.LinkAction.show-list', 'AtrilDocument.LinkAction.toggle-list'],
    unresolvedProps: [],
...
export const OWN_PROPS = {
    EvAnnotation: ['color', 'contents', 'modified', 'name', 'page', 'rgba'],
    EvAnnotationAttachment: ['attachment'],
    EvAnnotationMarkup: ['has-popup', 'label', 'opacity', 'popup-is-open', 'rectangle'],
    EvAnnotationText: ['icon', 'is-open'],
    EvAnnotationTextMarkup: ['type'],
    EvAttachment: ['ctime', 'data', 'description', 'mtime', 'name', 'size'],
    EvLink: ['action', 'title'],
    EvLinkAction: ['dest', 'filename', 'hide-list', 'name', 'params', 'show-list', 'toggle-list', 'type', 'uri'],
    EvLinkDest: ['bottom', 'change', 'left', 'named', 'page', 'page-label', 'right', 'top', 'type', 'zoom'],
    EvTransitionEffect: ['alignment', 'angle', 'direction', 'duration', 'rectangular', 'scale', 'type'],
};
...
export const ENUM_NICKS = {
    ...
    EvLinkActionType: ['goto-dest', 'goto-remote', 'external-uri', 'launch', 'named', 'layers-state'],
    EvLinkDestType: ['page', 'xyz', 'fit', 'fith', 'fitv', 'fitr', 'named', 'page-label', 'hlink', 'unknown'],
...
export const FLAG_VALUES = {
    'EvAnnotationsSaveMask.all': 511,
    'EvAnnotationsSaveMask.attachment': 256,
    'EvAnnotationsSaveMask.color': 2,
    'EvAnnotationsSaveMask.contents': 1,
    'EvAnnotationsSaveMask.label': 4,
    'EvAnnotationsSaveMask.none': 0,
    'EvAnnotationsSaveMask.opacity': 8,
    'EvAnnotationsSaveMask.popup-is-open': 32,
    'EvAnnotationsSaveMask.popup-rect': 16,
    'EvAnnotationsSaveMask.text-icon': 128,
    'EvAnnotationsSaveMask.text-is-open': 64,
...
export const PROP_TYPES = {
    'EvAnnotation.color': 'gpointer',
    'EvAnnotation.contents': 'gchararray',
    'EvAnnotation.modified': 'gchararray',
    'EvAnnotation.name': 'gchararray',
    'EvAnnotation.page': 'EvPage',
    'EvAnnotationAttachment.attachment': 'EvAttachment',
    'EvAnnotationMarkup.has-popup': 'gboolean',
    'EvAnnotationMarkup.label': 'gchararray',
    'EvAnnotationMarkup.opacity': 'gdouble',
    'EvAnnotationMarkup.popup-is-open': 'gboolean',
    'EvAnnotationText.icon': 'EvAnnotationTextIcon',
    'EvAnnotationText.is-open': 'gboolean',
    'EvAnnotationTextMarkup.type': 'EvAnnotationTextMarkupType',
    'EvAttachment.ctime': 'gulong',
    'EvAttachment.data': 'gpointer',
    'EvAttachment.description': 'gchararray',
    'EvAttachment.mtime': 'gulong',
    'EvAttachment.name': 'gchararray',
    'EvAttachment.size': 'guint',
    'EvLink.action': 'gpointer',
    'EvLink.title': 'gchararray',
    'EvLinkAction.dest': 'gpointer',
    'EvLinkAction.filename': 'gchararray',
    'EvLinkAction.hide-list': 'gpointer',
    'EvLinkAction.name': 'gchararray',
    'EvLinkAction.params': 'gchararray',
    'EvLinkAction.show-list': 'gpointer',
    'EvLinkAction.toggle-list': 'gpointer',
    'EvLinkAction.type': 'EvLinkActionType',
    'EvLinkAction.uri': 'gchararray',
    'EvLinkDest.bottom': 'gdouble',
    'EvLinkDest.change': 'guint',
    'EvLinkDest.left': 'gdouble',
    'EvLinkDest.named': 'gchararray',
    'EvLinkDest.page': 'gint',
    'EvLinkDest.page-label': 'gchararray',
    'EvLinkDest.right': 'gdouble',
    'EvLinkDest.top': 'gdouble',
    'EvLinkDest.type': 'EvLinkDestType',
    'EvLinkDest.zoom': 'gdouble',
    'EvTransitionEffect.alignment': 'EvTransitionEffectAlignment',
    'EvTransitionEffect.angle': 'gint',
    'EvTransitionEffect.direction': 'EvTransitionEffectDirection',
    'EvTransitionEffect.duration': 'gint',
    'EvTransitionEffect.rectangular': 'gboolean',
    'EvTransitionEffect.scale': 'gdouble',
    'EvTransitionEffect.type': 'EvTransitionEffectType',
};

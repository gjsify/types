...
GJS TypeScript type definitions for AtrilDocument-1.5.0, generated from library version 1.28.1 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v4.0.0-beta.44.

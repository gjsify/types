...
export const PROVENANCE = {
    ...
    unsettableProps: [],
    unresolvedProps: [],
    identifierPrefixes: ['Gitg'],
    requiredVocabularies: ['@girs/ggit-1.0/vocabulary', '@girs/gio-2.0/vocabulary', '@girs/gobject-2.0/vocabulary', '@girs/gtk-3.0/vocabulary'],
};
...
export const DECLS = {
    GitgAsync: ['GitgAsync'],
    GitgAuthenticationDialog: ['GitgAuthenticationDialog', 'GtkDialog', 'GtkWindow', 'GtkBin', 'GtkContainer', 'GtkWidget', 'GInitiallyUnowned', 'GObject', 'GtkBuildable'],
    GitgAvatarCache: ['GitgAvatarCache', 'GObject'],
    GitgBranchBase: ['GitgBranchBase', 'GgitBranch', 'GgitRef', 'GgitNative', 'GgitObjectFactoryBase', 'GObject', 'GitgRef', 'GitgBranch'],
    GitgCellRendererLanes: ['GitgCellRendererLanes', 'GtkCellRendererText', 'GtkCellRenderer', 'GInitiallyUnowned', 'GObject'],
    GitgColor: ['GitgColor', 'GObject'],
    GitgCommit: ['GitgCommit', 'GgitCommit', 'GgitObject', 'GgitNative', 'GgitObjectFactoryBase', 'GObject'],
    GitgCommitListView: ['GitgCommitListView', 'GtkTreeView', 'GtkContainer', 'GtkWidget', 'GInitiallyUnowned', 'GObject', 'GtkBuildable', 'GtkScrollable'],
    GitgCommitModel: ['GitgCommitModel', 'GObject', 'GtkTreeModel'],
    GitgCredentialsManager: ['GitgCredentialsManager'],
    GitgDate: ['GitgDate', 'GObject', 'GInitable'],
    GitgDiffStat: ['GitgDiffStat', 'GtkDrawingArea', 'GtkWidget', 'GInitiallyUnowned', 'GObject', 'GtkBuildable'],
    GitgDiffView: ['GitgDiffView', 'GtkGrid', 'GtkContainer', 'GtkWidget', 'GInitiallyUnowned', 'GObject', 'GtkBuildable', 'GtkOrientable'],
    GitgDiffViewOptions: ['GitgDiffViewOptions', 'GtkToolbar', 'GtkContainer', 'GtkWidget', 'GInitiallyUnowned', 'GObject', 'GtkBuildable', 'GtkOrientable', 'GtkToolShell'],
    GitgEntryHistory: ['GitgEntryHistory', 'GtkEntry', 'GtkWidget', 'GInitiallyUnowned', 'GObject', 'GtkBuildable', 'GtkCellEditable', 'GtkEditable'],
    GitgFontManager: ['GitgFontManager', 'GObject'],
    GitgGPGUtils: ['GitgGPGUtils'],
    GitgHook: ['GitgHook', 'GObject'],
    GitgLabelRenderer: ['GitgLabelRenderer'],
    GitgLane: ['GitgLane', 'GObject'],
    GitgLanes: ['GitgLanes', 'GObject'],
    GitgParsedRefName: ['GitgParsedRefName', 'GObject'],
    GitgPatchSet: ['GitgPatchSet'],
    GitgProgressBin: ['GitgProgressBin', 'GtkBin', 'GtkContainer', 'GtkWidget', 'GInitiallyUnowned', 'GObject', 'GtkBuildable'],
    GitgRefBase: ['GitgRefBase', 'GgitRef', 'GgitNative', 'GgitObjectFactoryBase', 'GObject', 'GitgRef'],
    GitgRemote: ['GitgRemote', 'GgitRemote', 'GgitNative', 'GgitObjectFactoryBase', 'GObject'],
    GitgRepository: ['GitgRepository', 'GgitRepository', 'GgitNative', 'GgitObjectFactoryBase', 'GObject', 'GInitable'],
    GitgRepositoryListBox: ['GitgRepositoryListBox', 'GtkListBox', 'GtkContainer', 'GtkWidget', 'GInitiallyUnowned', 'GObject', 'GtkBuildable'],
    GitgRepositoryListBoxRow: ['GitgRepositoryListBoxRow', 'GtkListBoxRow', 'GtkBin', 'GtkContainer', 'GtkWidget', 'GInitiallyUnowned', 'GObject', 'GtkActionable', 'GtkBuildable'],
    GitgResource: ['GitgResource'],
    GitgSidebar: ['GitgSidebar', 'GtkTreeView', 'GtkContainer', 'GtkWidget', 'GInitiallyUnowned', 'GObject', 'GtkBuildable', 'GtkScrollable'],
    GitgSidebarStore: ['GitgSidebarStore', 'GtkTreeStore', 'GObject', 'GtkBuildable', 'GtkTreeDragDest', 'GtkTreeDragSource', 'GtkTreeModel', 'GtkTreeSortable'],
    GitgSidebarStoreSidebarHeader: ['GitgSidebarStoreSidebarHeader', 'GitgSidebarStoreSidebarText', 'GObject', 'GitgSidebarItem'],
    GitgSidebarStoreSidebarText: ['GitgSidebarStoreSidebarText', 'GObject', 'GitgSidebarItem'],
    GitgStage: ['GitgStage', 'GObject'],
    GitgStageStatusEnumerator: ['GitgStageStatusEnumerator', 'GObject'],
    GitgStageStatusFile: ['GitgStageStatusFile', 'GObject', 'GitgStageStatusItem'],
    GitgStageStatusSubmodule: ['GitgStageStatusSubmodule', 'GObject', 'GitgStageStatusItem'],
    GitgTextConv: ['GitgTextConv'],
    GitgTheme: ['GitgTheme', 'GtkWidget', 'GInitiallyUnowned', 'GObject', 'GtkBuildable'],
    GitgUtils: ['GitgUtils'],

...
interface Branch extends Ggit.Branch, Ref {
    ...
    parent_instance: Ggit.Ref & Ggit.Native & Ggit.ObjectFactoryBase & GObject.Object
...
interface Ref extends Ggit.Ref {
    ...
    parent_instance: Ggit.Native & Ggit.ObjectFactoryBase & GObject.Object
...
interface SidebarItem extends GObject.Object {
    ...
    connect_after(sigName: "activated", callback: SidebarItem.ActivatedSignalCallback): number
...
class Async {
    ...
    constructor() 
    static new(): Async
    static thread(func: any, _callback_: Gio.AsyncReadyCallback<Async> | null): void
    static thread_finish(_res_: Gio.AsyncResult): void
    static thread_try(func: any, _callback_: Gio.AsyncReadyCallback<Async> | null): void
...
interface BranchBase extends Ref, Branch {
    ...
    parent_instance: Ggit.Native & Ggit.ObjectFactoryBase & GObject.Object & Ggit.Ref
...
interface CommitModel extends Gtk.TreeModel {
    ...
    connect_after(sigName: "started", callback: CommitModel.StartedSignalCallback): number
    emit(sigName: "started", ...args: any[]): void
    connect(sigName: "update", callback: CommitModel.UpdateSignalCallback): number
    connect_after(sigName: "update", callback: CommitModel.UpdateSignalCallback): number
    ...
    connect_after(sigName: "finished", callback: CommitModel.FinishedSignalCallback): number
    emit(sigName: "finished", ...args: any[]): void
    connect(sigName: "begin-clear", callback: CommitModel.BeginClearSignalCallback): number
    connect_after(sigName: "begin-clear", callback: CommitModel.BeginClearSignalCallback): number
    emit(sigName: "begin-clear", ...args: any[]): void
    connect(sigName: "end-clear", callback: CommitModel.EndClearSignalCallback): number
    connect_after(sigName: "end-clear", callback: CommitModel.EndClearSignalCallback): number
...
interface Commit {
    ...
    parent_instance: Ggit.Object & Ggit.Native & Ggit.ObjectFactoryBase & GObject.Object
    ...
    get_lane(): Lane
    get_format_patch_name(): string | null
    get_committer_date_for_display(): string | null
    get_author_date_for_display(): string | null
...
interface DiffView {
    ...
    connect_after(sigName: "options-changed", callback: DiffView.OptionsChangedSignalCallback): number
...
interface RepositoryListBox {
    ...
    connect_after(sigName: "repository-activated", callback: RepositoryListBox.RepositoryActivatedSignalCallback): number
...
interface RepositoryListBoxRow {
    ...
    connect_after(sigName: "request-remove", callback: RepositoryListBoxRow.RequestRemoveSignalCallback): number
    ...
    connect_after(sigName: "request-delete-source", callback: RepositoryListBoxRow.RequestDeleteSourceSignalCallback): number
...
interface Repository {
    ...
    parent_instance: Ggit.ObjectFactoryBase & GObject.Object & GObject.Object

    // Owm methods of Gitg-1.0.Gitg.Repository

    clear_refs_cache(): void
    refs_for_id(id: Ggit.OId): Ref[]
    lookup(t_type: GObject.GType, t_dup_func: GObject.BoxedCopyFunc, t_destroy_func: GLib.DestroyNotify, id: Ggit.OId): any | null
...
interface Sidebar {
    ...
    get_selected_item(t_type: GObject.GType, t_dup_func: GObject.BoxedCopyFunc, t_destroy_func: GLib.DestroyNotify): any | null
    get_selected_items(t_dup_func: GObject.BoxedCopyFunc, t_destroy_func: GLib.DestroyNotify): [ /* returnType */ any[], /* result_length1 */ number ]
    ...
    connect_after(sigName: "deselected", callback: Sidebar.DeselectedSignalCallback): number
    emit(sigName: "deselected", ...args: any[]): void
    connect(sigName: "populate-popup", callback: Sidebar.PopulatePopupSignalCallback): number
    connect_after(sigName: "populate-popup", callback: Sidebar.PopulatePopupSignalCallback): number
...
interface SidebarItemIface {
    ...
    get_text: (self: SidebarItem) => string | null
...
interface StageStatusItemIface {
    ...
    get_path: (self: StageStatusItem) => string | null

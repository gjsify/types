...
static ["new"](): Remote;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect_after(signal: 'tip-updated', callback: ((_source: this, refname: string, a: Ggit.OId, b: Ggit.OId) => void)): number
...
static ["new"](): RepositoryListBox;
    ...
    connect(signal: 'show-error', callback: ((_source: this, primary_message: string, secondary_message: string) => void)): number
    connect_after(signal: 'show-error', callback: ((_source: this, primary_message: string, secondary_message: string) => void)): number

...
import './node-gkbd-3.0-import.d.ts';
...
import type Xkl from '@girs/node-xkl-1.0';
...
interface Configuration {
    ...
    extractLayoutName(group: number): string | null
    freeImages(images: GdkPixbuf.Pixbuf[]): void
    getAllObjects(): GObject.Object[]
    getCapsLockState(): boolean
    getCurrentGroup(): number
    getCurrentTooltip(): string | null
    getGroupName(group: number): string | null
    getGroupNames(): string[]
    getImageFilename(group: number): string | null
    ...
    on(sigName: "group-changed", callback: Configuration.GroupChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "group-changed", callback: Configuration.GroupChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "group-changed", callback: Configuration.GroupChangedSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "indicators-changed", callback: Configuration.IndicatorsChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "indicators-changed", callback: Configuration.IndicatorsChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "indicators-changed", callback: Configuration.IndicatorsChangedSignalCallback): NodeJS.EventEmitter
...
class Configuration extends GObject.Object {
    ...
    static createLabelTitle(group: number, ln2cntMap: GLib.HashTable, layoutName: string | null): string | null
...
interface Indicator extends Atk.ImplementorIface, Gtk.Buildable {
    ...
    on(sigName: "reinit-ui", callback: Indicator.ReinitUiSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "reinit-ui", callback: Indicator.ReinitUiSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "reinit-ui", callback: Indicator.ReinitUiSignalCallback): NodeJS.EventEmitter
...
class Indicator extends Gtk.Notebook {
    ...
    static getImageFilename(group: number): string | null
...
interface KeyboardDrawing extends Atk.ImplementorIface, Gtk.Buildable {
    ...
    on(sigName: "bad-keycode", callback: KeyboardDrawing.BadKeycodeSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "bad-keycode", callback: KeyboardDrawing.BadKeycodeSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "bad-keycode", callback: KeyboardDrawing.BadKeycodeSignalCallback): NodeJS.EventEmitter
...
interface IndicatorConfig {
    ...
    getFgColorForWidget(widget: Gtk.Widget): string | null
    getFontForWidget(widget: Gtk.Widget, fontFamily: string | null, fontSize: number): void
    getImagesFile(kbdConfig: KeyboardConfig, group: number): string | null
    init(engine: Xkl.Engine): void
    load(): void
...
interface StatusClass {
    ...
    parentClass: Gtk.StatusIconClass
}

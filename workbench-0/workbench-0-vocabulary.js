...
export const OWN_PROPS = {
    WorkbenchCompletionRequest: ['cancellable', 'context', 'provider'],
};
...
export const ENUM_NICKS = {
    WorkbenchRequestState: ['unknown', 'cancelled', 'complete'],
};
...
export const ENUM_VALUES = {
    'WorkbenchRequestState.cancelled': 1,
    'WorkbenchRequestState.complete': 2,
    'WorkbenchRequestState.unknown': 0,
};
...
export const PROP_TYPES = {
    'WorkbenchCompletionRequest.cancellable': 'GCancellable',
    'WorkbenchCompletionRequest.context': 'GtkSourceCompletionContext',
    'WorkbenchCompletionRequest.provider': 'GtkSourceCompletionProvider',
};

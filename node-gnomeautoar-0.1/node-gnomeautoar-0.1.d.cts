...
export const EMPTY_ARCHIVE_ERRNO: number
export const NOT_AN_ARCHIVE_ERRNO: number
export const PASSPHRASE_REQUIRED_ERRNO: number
/**
 ...
 */
export function filterGetDescriptionLibarchive(filter: Filter): string | null
/**
 ...
 */
export function formatFilterGetDescription(format: Format, filter: Filter): string | null
/**
 ...
 */
export function formatFilterGetExtension(format: Format, filter: Filter): string | null
/**
 ...
 */
export function formatFilterGetMimeType(format: Format, filter: Filter): string | null
/**
 ...
 */
export function formatGetDescriptionLibarchive(format: Format): string | null
/**

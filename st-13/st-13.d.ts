...
export namespace St {
     ...
     * @gir-type Class
     */
    class Bin<A extends Clutter.Actor = Clutter.Actor> extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container<A>, Clutter.Scriptable {
         ...
         * @returns the {@link Clutter.ChildMeta} for the `actor` child   of `container` or `null` if the specific actor does not exist or the   container is not configured to provide {@link Clutter.ChildMeta}s
         */
    ...
    namespace BoxLayout {
        ...
        // Constructor properties interface
        interface ConstructorProps<A extends Clutter.Actor = Clutter.Actor> extends Viewport.ConstructorProps<Clutter.BoxLayout>, Atk.ImplementorIface.ConstructorProps, Clutter.Animatable.ConstructorProps, Clutter.Container.ConstructorProps, Clutter.Scriptable.ConstructorProps, Scrollable.ConstructorProps {
            pack_start: boolean;
            packStart: boolean;
            vertical: boolean;
        }
     ...
     * @gir-type Class
     */
    class BoxLayout<A extends Clutter.Actor = Clutter.Actor> extends Viewport<Clutter.BoxLayout> implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container<A>, Clutter.Scriptable, Scrollable {
    ...
    namespace Button {
        ...
        // Constructor properties interface
        interface ConstructorProps<A extends Clutter.Actor = Clutter.Actor> extends Bin.ConstructorProps<A>, Atk.ImplementorIface.ConstructorProps, Clutter.Animatable.ConstructorProps, Clutter.Container.ConstructorProps, Clutter.Scriptable.ConstructorProps {
     ...
     * @gir-type Class
     */
    class Button<A extends Clutter.Actor = Clutter.Actor> extends Bin<A> implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container<A>, Clutter.Scriptable {
     ...
     * @gir-type Class
     */
    class DrawingArea<A extends Clutter.Actor = Clutter.Actor> extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container<A>, Clutter.Scriptable {
     ...
     * @gir-type Class
     */
    class Entry<A extends Clutter.Actor = Clutter.Actor> extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container<A>, Clutter.Scriptable {
     ...
     * @gir-type Class
     */
    class Icon<A extends Clutter.Actor = Clutter.Actor> extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container<A>, Clutter.Scriptable {
    ...
    class IconTheme extends GObject.Object {
         ...
         * @returns a {@link St.IconInfo} object containing information about the icon, or `null` if the icon wasn’t found.
         */
         ...
         * @param size desired icon size
         * @param flags flags modifying the behavior of the icon lookup
         * @returns a {@link St.IconInfo} containing     information about the icon, or `null` if the icon wasn’t     found. Unref with `g_object_unref()`
         */
     ...
     * @gir-type Class
     */
    class Label<A extends Clutter.Actor = Clutter.Actor> extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container<A>, Clutter.Scriptable {
    ...
    namespace PasswordEntry {
        ...
        // Constructor properties interface
        interface ConstructorProps<A extends Clutter.Actor = Clutter.Actor> extends Entry.ConstructorProps<A>, Atk.ImplementorIface.ConstructorProps, Clutter.Animatable.ConstructorProps, Clutter.Container.ConstructorProps, Clutter.Scriptable.ConstructorProps {
     ...
     * @gir-type Class
     */
    class PasswordEntry<A extends Clutter.Actor = Clutter.Actor> extends Entry<A> implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container<A>, Clutter.Scriptable {
     ...
     * @gir-type Class
     */
    class ScrollBar<A extends Clutter.Actor = Clutter.Actor> extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container<A>, Clutter.Scriptable {
     ...
     * @gir-type Class
     */
    class ScrollView<A extends Clutter.Actor = Clutter.Actor> extends Bin<A> implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container<A>, Clutter.Scriptable {
    ...
    namespace Viewport {
        ...
        // Constructor properties interface
        interface ConstructorProps<A extends Clutter.LayoutManager = Clutter.LayoutManager, B extends Clutter.Content = Clutter.Content, C extends Clutter.Actor = Clutter.Actor> extends Widget.ConstructorProps<A, B>, Atk.ImplementorIface.ConstructorProps, Clutter.Animatable.ConstructorProps, Clutter.Container.ConstructorProps, Clutter.Scriptable.ConstructorProps, Scrollable.ConstructorProps {
     ...
     * @gir-type Class
     */
    class Viewport<A extends Clutter.LayoutManager = Clutter.LayoutManager, B extends Clutter.Content = Clutter.Content, C extends Clutter.Actor = Clutter.Actor> extends Widget<A, B> implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container<C>, Clutter.Scriptable, Scrollable {
    ...
    namespace Widget {
        ...
        // Constructor properties interface
        interface ConstructorProps<A extends Clutter.LayoutManager = Clutter.LayoutManager, B extends Clutter.Content = Clutter.Content, C extends Clutter.Actor = Clutter.Actor> extends Clutter.Actor.ConstructorProps<A, B>, Atk.ImplementorIface.ConstructorProps, Clutter.Animatable.ConstructorProps, Clutter.Container.ConstructorProps, Clutter.Scriptable.ConstructorProps {
     ...
     * @gir-type Class
     */
    class Widget<A extends Clutter.LayoutManager = Clutter.LayoutManager, B extends Clutter.Content = Clutter.Content, C extends Clutter.Actor = Clutter.Actor> extends Clutter.Actor<A, B> implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container<C>, Clutter.Scriptable {

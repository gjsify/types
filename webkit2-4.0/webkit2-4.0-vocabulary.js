// The widget vocabulary of WebKit2-4.0 as runtime data.
//
...
export const DECLS = {
    WebKitAuthenticationRequest: ['WebKitAuthenticationRequest', 'GObject'],
    WebKitAutomationSession: ['WebKitAutomationSession', 'GObject'],
    WebKitBackForwardList: ['WebKitBackForwardList', 'GObject'],
    WebKitBackForwardListItem: ['WebKitBackForwardListItem', 'GInitiallyUnowned', 'GObject'],
    WebKitClipboardPermissionRequest: ['WebKitClipboardPermissionRequest', 'GObject', 'WebKitPermissionRequest'],
    WebKitColorChooserRequest: ['WebKitColorChooserRequest', 'GObject'],
    WebKitContextMenu: ['WebKitContextMenu', 'GObject'],
    WebKitContextMenuItem: ['WebKitContextMenuItem', 'GInitiallyUnowned', 'GObject'],
    WebKitCookieManager: ['WebKitCookieManager', 'GObject'],
    WebKitDeviceInfoPermissionRequest: ['WebKitDeviceInfoPermissionRequest', 'GObject', 'WebKitPermissionRequest'],
    WebKitDownload: ['WebKitDownload', 'GObject'],
    WebKitEditorState: ['WebKitEditorState', 'GObject'],
    WebKitFaviconDatabase: ['WebKitFaviconDatabase', 'GObject'],
    WebKitFileChooserRequest: ['WebKitFileChooserRequest', 'GObject'],
    WebKitFindController: ['WebKitFindController', 'GObject'],
    WebKitFormSubmissionRequest: ['WebKitFormSubmissionRequest', 'GObject'],
    WebKitGeolocationManager: ['WebKitGeolocationManager', 'GObject'],
    WebKitGeolocationPermissionRequest: ['WebKitGeolocationPermissionRequest', 'GObject', 'WebKitPermissionRequest'],
    WebKitHitTestResult: ['WebKitHitTestResult', 'GObject'],
    WebKitInstallMissingMediaPluginsPermissionRequest: ['WebKitInstallMissingMediaPluginsPermissionRequest', 'GObject', 'WebKitPermissionRequest'],
    WebKitMediaKeySystemPermissionRequest: ['WebKitMediaKeySystemPermissionRequest', 'GObject', 'WebKitPermissionRequest'],
    WebKitNavigationPolicyDecision: ['WebKitNavigationPolicyDecision', 'WebKitPolicyDecision', 'GObject'],
    WebKitNotification: ['WebKitNotification', 'GObject'],
    WebKitNotificationPermissionRequest: ['WebKitNotificationPermissionRequest', 'GObject', 'WebKitPermissionRequest'],
    WebKitOptionMenu: ['WebKitOptionMenu', 'GObject'],
    WebKitPlugin: ['WebKitPlugin', 'GObject'],
    WebKitPointerLockPermissionRequest: ['WebKitPointerLockPermissionRequest', 'GObject', 'WebKitPermissionRequest'],
    WebKitPrintCustomWidget: ['WebKitPrintCustomWidget', 'GObject'],
    WebKitPrintOperation: ['WebKitPrintOperation', 'GObject'],
    WebKitResponsePolicyDecision: ['WebKitResponsePolicyDecision', 'WebKitPolicyDecision', 'GObject'],
    WebKitSecurityManager: ['WebKitSecurityManager', 'GObject'],
    WebKitSettings: ['WebKitSettings', 'GObject'],
    WebKitURIRequest: ['WebKitURIRequest', 'GObject'],
    WebKitURIResponse: ['WebKitURIResponse', 'GObject'],
    WebKitURISchemeRequest: ['WebKitURISchemeRequest', 'GObject'],
    WebKitURISchemeResponse: ['WebKitURISchemeResponse', 'GObject'],
    WebKitUserContentFilterStore: ['WebKitUserContentFilterStore', 'GObject'],
    WebKitUserContentManager: ['WebKitUserContentManager', 'GObject'],
    WebKitUserMediaPermissionRequest: ['WebKitUserMediaPermissionRequest', 'GObject', 'WebKitPermissionRequest'],
    WebKitUserMessage: ['WebKitUserMessage', 'GInitiallyUnowned', 'GObject'],
    WebKitWebContext: ['WebKitWebContext', 'GObject'],
    WebKitWebInspector: ['WebKitWebInspector', 'GObject'],
    WebKitWebResource: ['WebKitWebResource', 'GObject'],
    WebKitWebView: ['WebKitWebView', 'WebKitWebViewBase', 'GtkContainer', 'GtkWidget', 'GInitiallyUnowned', 'GObject', 'GtkBuildable'],
    WebKitWebViewBase: ['WebKitWebViewBase', 'GtkContainer', 'GtkWidget', 'GInitiallyUnowned', 'GObject', 'GtkBuildable'],
    WebKitWebsiteDataAccessPermissionRequest: ['WebKitWebsiteDataAccessPermissionRequest', 'GObject', 'WebKitPermissionRequest'],
    WebKitWebsiteDataManager: ['WebKitWebsiteDataManager', 'GObject'],
    WebKitWebsitePolicies: ['WebKitWebsitePolicies', 'GObject'],
    WebKitWindowProperties: ['WebKitWindowProperties', 'GObject'],
};
...
export const PROP_TYPES = {
    'WebKitAutomationSession.id': 'gchararray',
    'WebKitDownload.allow-overwrite': 'gboolean',
    'WebKitFindController.web-view': 'WebKitWebView',
    ...
    'WebKitPrintCustomWidget.title': 'gchararray',
    'WebKitPrintCustomWidget.widget': 'GtkWidget',
    'WebKitPrintOperation.page-setup': 'GtkPageSetup',
    'WebKitPrintOperation.print-settings': 'GtkPrintSettings',
    'WebKitPrintOperation.web-view': 'WebKitWebView',
    'WebKitSettings.allow-file-access-from-file-urls': 'gboolean',
    'WebKitSettings.allow-modal-dialogs': 'gboolean',
    'WebKitSettings.allow-top-navigation-to-data-urls': 'gboolean',
    'WebKitSettings.allow-universal-access-from-file-urls': 'gboolean',
    'WebKitSettings.auto-load-images': 'gboolean',
    'WebKitSettings.cursive-font-family': 'gchararray',
    'WebKitSettings.default-charset': 'gchararray',
    'WebKitSettings.default-font-family': 'gchararray',
    'WebKitSettings.default-font-size': 'guint',
    'WebKitSettings.default-monospace-font-size': 'guint',
    'WebKitSettings.disable-web-security': 'gboolean',
    'WebKitSettings.draw-compositing-indicators': 'gboolean',
    'WebKitSettings.enable-2d-canvas-acceleration': 'gboolean',
    'WebKitSettings.enable-accelerated-2d-canvas': 'gboolean',
    'WebKitSettings.enable-back-forward-navigation-gestures': 'gboolean',
    'WebKitSettings.enable-caret-browsing': 'gboolean',
    'WebKitSettings.enable-developer-extras': 'gboolean',
    'WebKitSettings.enable-dns-prefetching': 'gboolean',
    'WebKitSettings.enable-encrypted-media': 'gboolean',
    'WebKitSettings.enable-frame-flattening': 'gboolean',
    'WebKitSettings.enable-fullscreen': 'gboolean',
    'WebKitSettings.enable-html5-database': 'gboolean',
    'WebKitSettings.enable-html5-local-storage': 'gboolean',
    'WebKitSettings.enable-hyperlink-auditing': 'gboolean',
    'WebKitSettings.enable-java': 'gboolean',
    'WebKitSettings.enable-javascript': 'gboolean',
    'WebKitSettings.enable-javascript-markup': 'gboolean',
    'WebKitSettings.enable-media': 'gboolean',
    'WebKitSettings.enable-media-capabilities': 'gboolean',
    'WebKitSettings.enable-media-stream': 'gboolean',
    'WebKitSettings.enable-mediasource': 'gboolean',
    'WebKitSettings.enable-mock-capture-devices': 'gboolean',
    'WebKitSettings.enable-offline-web-application-cache': 'gboolean',
    'WebKitSettings.enable-page-cache': 'gboolean',
    'WebKitSettings.enable-plugins': 'gboolean',
    'WebKitSettings.enable-private-browsing': 'gboolean',
    'WebKitSettings.enable-resizable-text-areas': 'gboolean',
    'WebKitSettings.enable-site-specific-quirks': 'gboolean',
    'WebKitSettings.enable-smooth-scrolling': 'gboolean',
    'WebKitSettings.enable-spatial-navigation': 'gboolean',
    'WebKitSettings.enable-tabs-to-links': 'gboolean',
    'WebKitSettings.enable-webaudio': 'gboolean',
    'WebKitSettings.enable-webgl': 'gboolean',
    'WebKitSettings.enable-webrtc': 'gboolean',
    'WebKitSettings.enable-write-console-messages-to-stdout': 'gboolean',
    'WebKitSettings.enable-xss-auditor': 'gboolean',
    'WebKitSettings.fantasy-font-family': 'gchararray',
    'WebKitSettings.hardware-acceleration-policy': 'WebKitHardwareAccelerationPolicy',
    'WebKitSettings.javascript-can-access-clipboard': 'gboolean',
    'WebKitSettings.javascript-can-open-windows-automatically': 'gboolean',
    'WebKitSettings.load-icons-ignoring-image-load-setting': 'gboolean',
    'WebKitSettings.media-content-types-requiring-hardware-support': 'gchararray',
    'WebKitSettings.media-playback-allows-inline': 'gboolean',
    'WebKitSettings.media-playback-requires-user-gesture': 'gboolean',
    'WebKitSettings.minimum-font-size': 'guint',
    'WebKitSettings.monospace-font-family': 'gchararray',
    'WebKitSettings.pictograph-font-family': 'gchararray',
    'WebKitSettings.print-backgrounds': 'gboolean',
    'WebKitSettings.sans-serif-font-family': 'gchararray',
    'WebKitSettings.serif-font-family': 'gchararray',
    'WebKitSettings.user-agent': 'gchararray',
    'WebKitSettings.webrtc-udp-ports-range': 'gchararray',
    'WebKitSettings.zoom-text-only': 'gboolean',
    'WebKitURIRequest.uri': 'gchararray',
    'WebKitURISchemeResponse.stream': 'GInputStream',
    'WebKitURISchemeResponse.stream-length': 'gint64',
    'WebKitUserContentFilterStore.path': 'gchararray',
    'WebKitUserMessage.fd-list': 'GUnixFDList',
    'WebKitUserMessage.name': 'gchararray',
    'WebKitWebContext.local-storage-directory': 'gchararray',
    'WebKitWebContext.process-swap-on-cross-site-navigation-enabled': 'gboolean',
    'WebKitWebContext.time-zone-override': 'gchararray',
    'WebKitWebContext.use-system-appearance-for-scrollbars': 'gboolean',
    'WebKitWebContext.website-data-manager': 'WebKitWebsiteDataManager',
    'WebKitWebView.automation-presentation-type': 'WebKitAutomationBrowsingContextPresentation',
    'WebKitWebView.camera-capture-state': 'WebKitMediaCaptureState',
    'WebKitWebView.default-content-security-policy': 'gchararray',
    'WebKitWebView.display-capture-state': 'WebKitMediaCaptureState',
    'WebKitWebView.editable': 'gboolean',
    'WebKitWebView.is-controlled-by-automation': 'gboolean',
    'WebKitWebView.is-ephemeral': 'gboolean',
    'WebKitWebView.is-muted': 'gboolean',
    'WebKitWebView.microphone-capture-state': 'WebKitMediaCaptureState',
    'WebKitWebView.related-view': 'WebKitWebView',
    'WebKitWebView.settings': 'WebKitSettings',
    'WebKitWebView.user-content-manager': 'WebKitUserContentManager',
    'WebKitWebView.web-context': 'WebKitWebContext',
    'WebKitWebView.web-extension-mode': 'WebKitWebExtensionMode',
    'WebKitWebView.website-policies': 'WebKitWebsitePolicies',
    'WebKitWebView.zoom-level': 'gdouble',
    'WebKitWebsiteDataManager.base-cache-directory': 'gchararray',
    'WebKitWebsiteDataManager.base-data-directory': 'gchararray',
    'WebKitWebsiteDataManager.disk-cache-directory': 'gchararray',
    'WebKitWebsiteDataManager.dom-cache-directory': 'gchararray',
    'WebKitWebsiteDataManager.hsts-cache-directory': 'gchararray',
    'WebKitWebsiteDataManager.indexeddb-directory': 'gchararray',
    'WebKitWebsiteDataManager.is-ephemeral': 'gboolean',
    'WebKitWebsiteDataManager.itp-directory': 'gchararray',
    'WebKitWebsiteDataManager.local-storage-directory': 'gchararray',
    'WebKitWebsiteDataManager.offline-application-cache-directory': 'gchararray',
    'WebKitWebsiteDataManager.origin-storage-ratio': 'gdouble',
    'WebKitWebsiteDataManager.service-worker-registrations-directory': 'gchararray',
    'WebKitWebsiteDataManager.total-storage-ratio': 'gdouble',
    'WebKitWebsiteDataManager.websql-directory': 'gchararray',
    'WebKitWebsitePolicies.autoplay': 'WebKitAutoplayPolicy',
    'WebKitWindowProperties.fullscreen': 'gboolean',
    'WebKitWindowProperties.locationbar-visible': 'gboolean',
    'WebKitWindowProperties.menubar-visible': 'gboolean',
    'WebKitWindowProperties.resizable': 'gboolean',
    'WebKitWindowProperties.scrollbars-visible': 'gboolean',
    'WebKitWindowProperties.statusbar-visible': 'gboolean',
    'WebKitWindowProperties.toolbar-visible': 'gboolean',
};

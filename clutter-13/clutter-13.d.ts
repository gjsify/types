 ...
 */
function container_class_find_child_property(klass: typeof GObject.Object, property_name: string): GObject.ParamSpec
/**
...
interface ScriptConnectFunc<A = GObject.Object, B = GObject.Object> {
    (script: Script, object: A, signal_name: string, handler_name: string, connect_object: B, flags: GObject.ConnectFlags): void
}
...
module Actor {
    ...
    interface ConstructorProps<A extends LayoutManager = LayoutManager, B extends Content = Content> extends GObject.InitiallyUnowned.ConstructorProps, Atk.ImplementorIface.ConstructorProps, Animatable.ConstructorProps, Container.ConstructorProps, Scriptable.ConstructorProps {
actions: Action;
    allocation: ActorBox;
 ...
 * ```
 */
class Actor<A extends LayoutManager = LayoutManager, B extends Content = Content> extends GObject.InitiallyUnowned implements Atk.ImplementorIface, Animatable, Container<Actor>, Scriptable {
...
class ActorNode extends PaintNode {
    ...
    // Constructors of Clutter.ActorNode
...
class BlitNode extends PaintNode {
    ...
    // Constructors of Clutter.BlitNode
...
static ["new"](src: Cogl.Framebuffer): BlitNode;
    ...
    // Own methods of Clutter.BlitNode
...
class BlurNode extends LayerNode {
    ...
    // Constructors of Clutter.BlurNode
...
module Clone {
    ...
    interface ConstructorProps<A extends Actor = Actor> extends Actor.ConstructorProps, Atk.ImplementorIface.ConstructorProps, Animatable.ConstructorProps, Container.ConstructorProps, Scriptable.ConstructorProps {
source: A;
    }
 ...
 * implementation.
 */
class Clone<A extends Actor = Actor> extends Actor implements Atk.ImplementorIface, Animatable, Container<A>, Scriptable {
...
class ColorState extends GObject.Object {
    ...
    // Own properties of Clutter.ColorState
    ...
    // Constructors of Clutter.ColorState
...
static ["new"](colorspace: Colorspace): ColorState;
    ...
    // Own methods of Clutter.ColorState
...
_init(...args: any[]): void;
     ...
     */
    vfunc_update_preferred_size(actor: Actor, direction: Orientation, for_size: number, minimum_size: number, natural_size: number): [number, number]

    // Own methods of Clutter.Constraint
     ...
     * @param natural_size the natural size to modify
     */
    update_preferred_size(actor: Actor, direction: Orientation, for_size: number, minimum_size: number, natural_size: number): [number, number]
}
...
class FrameClock extends GObject.Object {
    ...
    // Constructors of Clutter.FrameClock
...
_init(...args: any[]): void;
    ...
    // Own signals of Clutter.FrameClock
    ...
    // Own methods of Clutter.FrameClock
...
_init(...args: any[]): void;
    ...
    // Own virtual methods of Clutter.InputDevice
...
abstract class InputDeviceTool extends GObject.Object {
    ...
    // Own properties of Clutter.InputDeviceTool
    ...
    // Constructors of Clutter.InputDeviceTool
...
_init(...args: any[]): void;
    ...
    // Own methods of Clutter.InputDeviceTool
...
abstract class InputFocus extends GObject.Object {
    ...
    // Constructors of Clutter.InputFocus
...
_init(...args: any[]): void;
    ...
    // Own virtual methods of Clutter.InputFocus
    ...
    // Own methods of Clutter.InputFocus
...
abstract class InputMethod extends GObject.Object {
    ...
    // Own properties of Clutter.InputMethod
    ...
    // Constructors of Clutter.InputMethod
...
_init(...args: any[]): void;
    ...
    // Own signals of Clutter.InputMethod
    ...
    // Own virtual methods of Clutter.InputMethod
    ...
    // Own methods of Clutter.InputMethod
...
abstract class Keymap extends GObject.Object {
    ...
    // Own properties of Clutter.Keymap
    ...
    // Constructors of Clutter.Keymap
...
_init(...args: any[]): void;
    ...
    // Own virtual methods of Clutter.Keymap

    vfunc_get_direction(): Pango.Direction

    // Own methods of Clutter.Keymap
...
class LayerNode extends PaintNode {
    ...
    // Constructors of Clutter.LayerNode
...
class RootNode extends PaintNode {
    ...
    // Constructors of Clutter.RootNode
 ...
 */
class ScrollActor<A extends Actor = Actor> extends Actor implements Atk.ImplementorIface, Animatable, Container<A>, Scriptable {
...
abstract class Seat extends GObject.Object {
    ...
    // Own properties of Clutter.Seat
...
_init(...args: any[]): void;
    ...
    connect(signal: 'kbd-a11y-flags-changed', callback: ((_source: this, settings_flags: number, changed_mask: number) => void)): number
    connect_after(signal: 'kbd-a11y-flags-changed', callback: ((_source: this, settings_flags: number, changed_mask: number) => void)): number
    emit(signal: 'kbd-a11y-flags-changed', settings_flags: number, changed_mask: number): void
    connect(signal: 'kbd-a11y-mods-state-changed', callback: ((_source: this, latched_mask: number, locked_mask: number) => void)): number
    connect_after(signal: 'kbd-a11y-mods-state-changed', callback: ((_source: this, latched_mask: number, locked_mask: number) => void)): number
    emit(signal: 'kbd-a11y-mods-state-changed', latched_mask: number, locked_mask: number): void
    connect(signal: 'ptr-a11y-dwell-click-type-changed', callback: ((_source: this, click_type: PointerA11yDwellClickType) => void)): number
    connect_after(signal: 'ptr-a11y-dwell-click-type-changed', callback: ((_source: this, click_type: PointerA11yDwellClickType) => void)): number
    emit(signal: 'ptr-a11y-dwell-click-type-changed', click_type: PointerA11yDwellClickType): void
    connect(signal: 'ptr-a11y-timeout-started', callback: ((_source: this, device: InputDevice, timeout_type: PointerA11yTimeoutType, delay: number) => void)): number
    connect_after(signal: 'ptr-a11y-timeout-started', callback: ((_source: this, device: InputDevice, timeout_type: PointerA11yTimeoutType, delay: number) => void)): number
    emit(signal: 'ptr-a11y-timeout-started', device: InputDevice, timeout_type: PointerA11yTimeoutType, delay: number): void
    connect(signal: 'ptr-a11y-timeout-stopped', callback: ((_source: this, device: InputDevice, timeout_type: PointerA11yTimeoutType, clicked: boolean) => void)): number
    connect_after(signal: 'ptr-a11y-timeout-stopped', callback: ((_source: this, device: InputDevice, timeout_type: PointerA11yTimeoutType, clicked: boolean) => void)): number
    emit(signal: 'ptr-a11y-timeout-stopped', device: InputDevice, timeout_type: PointerA11yTimeoutType, clicked: boolean): void

    // Own virtual methods of Clutter.Seat
    ...
    vfunc_query_state(device: InputDevice, sequence?: (EventSequence | null)): [boolean, Graphene.Point | null, ModifierType | null]
    vfunc_ungrab(time: number): void
    vfunc_warp_pointer(x: number, y: number): void

    // Own methods of Clutter.Seat
    ...
    query_state(device: InputDevice, sequence?: (EventSequence | null)): [boolean, Graphene.Point | null, ModifierType | null]
    /**
 ...
 */
class Stage<A extends Actor = Actor> extends Actor implements Atk.ImplementorIface, Animatable, Container<A>, Scriptable {
...
_init(...args: any[]): void;
    ...
    connect(signal: 'paint-view', callback: ((_source: this, view: StageView, redraw_clip: cairo.Region, frame: Frame) => void)): number
    connect_after(signal: 'paint-view', callback: ((_source: this, view: StageView, redraw_clip: cairo.Region, frame: Frame) => void)): number
    ...
    connect_after(signal: 'presented', callback: ((_source: this, view: StageView, frame_info: any | null) => void)): number
     ...
     */
    paint_to_buffer(rect: Mtk.Rectangle, scale: number, data: Uint8Array, stride: number, format: Cogl.PixelFormat, paint_flags: PaintFlag): boolean
    /**
    ...
    paint_to_framebuffer(framebuffer: Cogl.Framebuffer, rect: Mtk.Rectangle, scale: number, paint_flags: PaintFlag): void
    /**
    ...
    update_device(device: InputDevice, sequence: EventSequence, source_device: InputDevice, point: Graphene.Point, time: number, new_actor: Actor, region: cairo.Region, emit_crossing: boolean): void
...
class StageView extends GObject.Object {
    ...
    // Own properties of Clutter.StageView
    ...
    // Constructors of Clutter.StageView
...
_init(...args: any[]): void;
    ...
    // Own signals of Clutter.StageView
    ...
    // Own virtual methods of Clutter.StageView
    ...
    vfunc_transform_rect_to_onscreen(src_rect: Mtk.Rectangle, dst_width: number, dst_height: number, dst_rect: Mtk.Rectangle): void

    // Own methods of Clutter.StageView
 ...
 */
class Text<A extends Actor = Actor> extends Actor implements Atk.ImplementorIface, Animatable, Container<A>, Scriptable {
...
class TextureContent extends GObject.Object implements Content {
    ...
    // Constructors of Clutter.TextureContent
...
_init(...args: any[]): void;
    ...
    // Own static methods of Clutter.TextureContent
    ...
    // Own methods of Clutter.TextureContent
...
class TransformNode extends PaintNode {
    ...
    // Constructors of Clutter.TransformNode
...
class VirtualInputDevice extends GObject.Object {
    ...
    // Own properties of Clutter.VirtualInputDevice

    get device_type(): InputDeviceType;
    get deviceType(): InputDeviceType;
    get seat(): Seat;

    // Constructors of Clutter.VirtualInputDevice
...
_init(...args: any[]): void;
    ...
    // Own virtual methods of Clutter.VirtualInputDevice
    ...
    // Own methods of Clutter.VirtualInputDevice
...
static ["new"](): ZoomAction;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'zoom', callback: ((_source: this, actor: Actor, focal_point: Graphene.Point, factor: number) => boolean)): number
    connect_after(signal: 'zoom', callback: ((_source: this, actor: Actor, focal_point: Graphene.Point, factor: number) => boolean)): number
...
class Capture {
    ...
    // Own fields of Clutter.Capture

rect: Mtk.Rectangle

    // Constructors of Clutter.Capture
...
abstract class Context {
    ...
    // Constructors of Clutter.Context

_init(...args: any[]): void;


    // Own methods of Clutter.Context
...
abstract class DeviceEvent {
    ...
    // Constructors of Clutter.DeviceEvent
...
_init(...args: any[]): void;
    ...
    // Own methods of Clutter.EventSequence
...
abstract class Frame {
    ...
    // Constructors of Clutter.Frame

_init(...args: any[]): void;


    // Own methods of Clutter.Frame
...
abstract class Grab {
    ...
    // Constructors of Clutter.Grab

_init(...args: any[]): void;


    // Own methods of Clutter.Grab
...
abstract class IMEvent {
    ...
    // Constructors of Clutter.IMEvent
...
abstract class PadButtonEvent {
    ...
    // Constructors of Clutter.PadButtonEvent
...
abstract class PadRingEvent {
    ...
    // Constructors of Clutter.PadRingEvent
...
abstract class PadStripEvent {
    ...
    // Constructors of Clutter.PadStripEvent
...
_init(...args: any[]): void;
    ...
    // Own methods of Clutter.PaintContext
...
abstract class PickContext {
    ...
    // Constructors of Clutter.PickContext

_init(...args: any[]): void;


    // Own methods of Clutter.PickContext
...
class PointerA11ySettings {
    ...
    // Own fields of Clutter.PointerA11ySettings
...
dwell_threshold: number
    ...
    // Constructors of Clutter.PointerA11ySettings
...
abstract class ProximityEvent {
    ...
    // Constructors of Clutter.ProximityEvent
...
abstract class TouchpadHoldEvent {
    ...
    // Constructors of Clutter.TouchpadHoldEvent
...
static ["new"](type: EventType): Event;
     ...
     */
    get_related(): Actor
    get_relative_motion(dx: number, dy: number, dx_unaccel: number, dy_unaccel: number, dx_constrained: number, dy_constrained: number): boolean
    /**
...
module Container {
    ...
    interface ConstructorProps<A extends Actor = Actor> extends GObject.Object.ConstructorProps {
...
interface Container<A extends Actor = Actor> extends GObject.Object {

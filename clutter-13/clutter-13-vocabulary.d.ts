/**
 * The GIR-derived widget VOCABULARY for Clutter-13.
 *
 * GENERATED — do not edit. Provenance: Clutter-13 — dropped empty base(s): Atk.ImplementorIface
 *
 * 61 instantiable GTypes (of which 0 concrete widgets), 74 declarations, 48 enum nick unions, 0 slot candidates.
 *

...
export function alloc_trace_get(name: string | null): AllocTrace
...
export function caps_from_string(string: string | null): Caps
...
export function child_proxy_get_property(object: Object, name: string | null, value: any): void
export function child_proxy_lookup(object: Object, name: string | null, target: Object, pspec: GObject.ParamSpec): boolean
export function child_proxy_set_property(object: Object, name: string | null, value: any): void
export function class_signal_connect(klass: ObjectClass, name: string | null, func: any, func_data: any): number
export function class_signal_emit_by_name(object: Object, name: string | null, self: libxml2.NodePtr): void
export function debug_add_log_function(func: LogFunction): void
export function debug_construct_term_color(colorinfo: number): string | null
...
export function debug_level_get_name(level: DebugLevel): string | null
export function debug_log_default(category: DebugCategory, level: DebugLevel, file: string | null, function_: string | null, line: number, object: GObject.Object, message: DebugMessage, unused: any): void
export function debug_print_stack_trace(): void
export function debug_remove_log_function(func: LogFunction): number
export function debug_remove_log_function_by_data(data: any): number
...
export function debug_set_threshold_for_name(name: string | null, level: DebugLevel): void
export function debug_unset_threshold_for_name(name: string | null): void
export function default_registry_check_feature_version(feature_name: string | null, min_major: number, min_minor: number, min_micro: number): boolean
export function deinit(): void
export function error_get_message(domain: GLib.Quark, code: number): string | null
export function flow_get_name(ret: FlowReturn): string | null
export function flow_to_quark(ret: FlowReturn): GLib.Quark
export function format_get_by_nick(nick: string | null): Format
...
export function format_register(nick: string | null, description: string | null): Format
...
export function implements_interface_cast(from: any, type: GObject.GType): any
export function implements_interface_check(from: any, type: GObject.GType): boolean
...
export function is_tag_list(p: any): boolean
export function param_spec_fraction(name: string | null, nick: string | null, blurb: string | null, min_num: number, min_denom: number, max_num: number, max_denom: number, default_num: number, default_denom: number, flags: GObject.ParamFlags): GObject.ParamSpec
export function param_spec_mini_object(name: string | null, nick: string | null, blurb: string | null, object_type: GObject.GType, flags: GObject.ParamFlags): GObject.ParamSpec
export function parse_bin_from_description(bin_description: string | null, ghost_unlinked_pads: boolean): Element
export function parse_bin_from_description_full(bin_description: string | null, ghost_unlinked_pads: boolean, context: ParseContext, flags: ParseFlags): Element
export function parse_launch(pipeline_description: string | null): Element
export function parse_launch_full(pipeline_description: string | null, context: ParseContext, flags: ParseFlags): Element
...
export function structure_empty_new(name: string | null): Structure
export function structure_from_string(string: string | null, end: string[]): Structure
export function structure_id_empty_new(quark: GLib.Quark): Structure
export function tag_exists(tag: string | null): boolean
export function tag_get_description(tag: string | null): string | null
export function tag_get_flag(tag: string | null): TagFlag
export function tag_get_nick(tag: string | null): string | null
export function tag_get_type(tag: string | null): GObject.GType
export function tag_is_fixed(tag: string | null): boolean
export function tag_list_copy_value(dest: any, list: TagList, tag: string | null): boolean
...
export function tag_register(name: string | null, flag: TagFlag, type: GObject.GType, nick: string | null, blurb: string | null, func: TagMergeFunc): void
...
export function type_find_helper_for_extension(obj: Object, extension: string | null): Caps
...
export function type_find_helper_get_range_ext(obj: Object, func: TypeFindHelperGetRangeFunction, size: number, extension: string | null, prob: TypeFindProbability): Caps
export function type_find_register(plugin: Plugin, name: string | null, rank: number, func: TypeFindFunction, extensions: string[], possible_caps: Caps, data: any, data_notify: GLib.DestroyNotify): boolean
export function type_register_static_full(parent_type: GObject.GType, type_name: string | null, class_size: number, base_init: GObject.BaseInitFunc, base_finalize: GObject.BaseFinalizeFunc, class_init: GObject.ClassInitFunc, class_finalize: GObject.ClassFinalizeFunc, instance_size: number, n_preallocs: number, instance_init: GObject.InstanceInitFunc, value_table: GObject.TypeValueTable, flags: GObject.TypeFlags): GObject.GType
export function update_registry(): boolean
export function uri_construct(protocol: string | null, location: string | null): string | null
export function uri_get_location(uri: string | null): string | null
export function uri_get_protocol(uri: string | null): string | null
export function uri_has_protocol(uri: string | null, protocol: string | null): boolean
export function uri_is_valid(uri: string | null): boolean
export function uri_protocol_is_supported(type: URIType, protocol: string | null): boolean
export function uri_protocol_is_valid(protocol: string | null): boolean
export function util_array_binary_search(array: any, num_elements: number, element_size: number, search_func: GLib.CompareDataFunc, mode: SearchMode, search_data: any, user_data: any): any
...
export function util_set_object_arg(object: GObject.Object, name: string | null, value: string | null): void
export function util_set_value_from_string(value: any, value_str: string | null): void
...
export function value_deserialize(dest: any, src: string | null): boolean
...
export function value_register_intersect_func(type1: GObject.GType, type2: GObject.GType, func: ValueIntersectFunc): void
export function value_register_subtract_func(minuend_type: GObject.GType, subtrahend_type: GObject.GType, func: ValueSubtractFunc): void
export function value_register_union_func(type1: GObject.GType, type2: GObject.GType, func: ValueUnionFunc): void

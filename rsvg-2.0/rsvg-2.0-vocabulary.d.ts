/**
 * The GIR-derived widget VOCABULARY for Rsvg-2.0.
 *
 * GENERATED — do not edit. Provenance: Rsvg-2.0 — library 2.62.3
 *
...
export interface RsvgHandleProps extends GObjectProps {
    /**
...
export type RsvgHandleConstructOnly = GObjectConstructOnly | 'flags';

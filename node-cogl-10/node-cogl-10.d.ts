...
import './node-cogl-10-import.d.ts';
 ...
 * @param internalFormat the #CoglPixelFormat to use for the GPU storage of the texture
 * @returns A newly created #CoglTexture or               %NULL on failure
 */
function textureNewFromBitmap(bitmap: Bitmap, flags: TextureFlags, internalFormat: PixelFormat): Texture
/**
 ...
 * @param internalFormat the #CoglPixelFormat that will be used for storing    the buffer on the GPU. If COGL_PIXEL_FORMAT_ANY is given then a    premultiplied format similar to the format of the source data will    be used. The default blending equations of Cogl expect premultiplied    color data; the main use of passing a non-premultiplied format here    is if you have non-premultiplied source data and are going to adjust    the blend mode (see cogl_material_set_blend()) or use the data for    something other than straight blending.
 ...
 * @returns A newly created #CoglTexture or               %NULL on failure
 */
function textureNewFromData(width: number, height: number, flags: TextureFlags, format: PixelFormat, internalFormat: PixelFormat, rowstride: number, data: Uint8Array): Texture
/**
 * Creates a #CoglTexture from an image file.
 * @param filename the file to load
 * @param flags Optional flags for the texture, or %COGL_TEXTURE_NONE
 * @param internalFormat the #CoglPixelFormat to use for the GPU storage of the    texture. If %COGL_PIXEL_FORMAT_ANY is given then a premultiplied    format similar to the format of the source data will be used. The    default blending equations of Cogl expect premultiplied color data;    the main use of passing a non-premultiplied format here is if you    have non-premultiplied source data and are going to adjust the blend    mode (see cogl_material_set_blend()) or use the data for something    other than straight blending.
 * @returns A newly created #CoglTexture or               %NULL on failure
 */
function textureNewFromFile(filename: string | null, flags: TextureFlags, internalFormat: PixelFormat): Texture
...
class Texture extends GObject.Object {
     ...
     * @returns A newly created #CoglTexture or               %NULL on failure
     */
    static newFromData(width: number, height: number, flags: TextureFlags, format: PixelFormat, internalFormat: PixelFormat, rowstride: number, data: Uint8Array): Texture
    /**
     * Creates a #CoglTexture from an image file.
     * @param filename the file to load
     * @param flags Optional flags for the texture, or %COGL_TEXTURE_NONE
     ...
     * @returns A newly created #CoglTexture or               %NULL on failure
     */
    static newFromFile(filename: string | null, flags: TextureFlags, internalFormat: PixelFormat): Texture

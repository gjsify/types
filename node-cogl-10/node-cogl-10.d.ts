 ...
 * @returns A newly created #CoglTexture or               %NULL on failure
 */
function textureNewFromData(width: number, height: number, flags: TextureFlags, format: PixelFormat, internalFormat: PixelFormat, rowstride: number, data: number[]): Texture
/**
...
class Texture extends GObject.Object {
     ...
     * @returns A newly created #CoglTexture or               %NULL on failure
     */
    static newFromData(width: number, height: number, flags: TextureFlags, format: PixelFormat, internalFormat: PixelFormat, rowstride: number, data: number[]): Texture
    /**
     * Creates a #CoglTexture from an image file.
     * @param filename the file to load
     * @param flags Optional flags for the texture, or %COGL_TEXTURE_NONE

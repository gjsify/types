 ...
 * @returns A newly created #CoglTexture or               %NULL on failure
 */
export function textureNewFromData(width: number, height: number, flags: TextureFlags, format: PixelFormat, internalFormat: PixelFormat, rowstride: number, data: number[]): Texture
/**

 ...
 * @returns A newly created #CoglTexture or               %NULL on failure
 */
export function textureNewFromData(width: number, height: number, flags: TextureFlags, format: PixelFormat, internalFormat: PixelFormat, rowstride: number, data: Uint8Array): Texture
/**
 ...
 * @returns A newly created #CoglTexture or               %NULL on failure
 */
export function textureNewFromFile(filename: string | null, flags: TextureFlags, internalFormat: PixelFormat): Texture

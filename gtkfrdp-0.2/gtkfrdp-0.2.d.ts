...
export namespace GtkFrdp {
    ...
    class Display extends Gtk.DrawingArea implements Atk.ImplementorIface, Gtk.Buildable {
         ...
         * @param flags 
         */
        certificate_change_verify_ex(host: string, port: number, common_name: string, subject: string, issuer: string, fingerprint: string, old_subject: string, old_issuer: string, old_fingerprint: string, flags: number): number;
         ...
         * @param flags 
         */
        certificate_verify_ex(host: string, port: number, common_name: string, subject: string, issuer: string, fingerprint: string, flags: number): number;

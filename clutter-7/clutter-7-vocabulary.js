// The widget vocabulary of Clutter-7 as runtime data.
//
...
export const OWN_PROPS = {
    ClutterActor: ['actions', 'background-color', 'clip-rect', 'clip-to-allocation', 'constraints', 'content', 'content-gravity', 'content-repeat', 'effect', 'fixed-position-set', 'fixed-x', 'fixed-y', 'height', 'layout-manager', 'magnification-filter', 'margin-bottom', 'margin-left', 'margin-right', 'margin-top', 'min-height', 'min-height-set', 'min-width', 'min-width-set', 'minification-filter', 'name', 'natural-height', 'natural-height-set', 'natural-width', 'natural-width-set', 'offscreen-redirect', 'opacity', 'pivot-point', 'pivot-point-z', 'position', 'reactive', 'request-mode', 'rotation-angle-x', 'rotation-angle-y', 'rotation-angle-z', 'scale-x', 'scale-y', 'scale-z', 'show-on-set-parent', 'size', 'text-direction', 'translation-x', 'translation-y', 'translation-z', 'visible', 'width', 'x', 'x-align', 'x-expand', 'y', 'y-align', 'y-expand', 'z-position'],
    ...
    ClutterStageView: ['layout', 'name', 'refresh-rate', 'scale', 'stage', 'use-shadowfb'],
...
export const OWN_SIGNALS = {
    ClutterActor: ['button-press-event', 'button-release-event', 'captured-event', 'destroy', 'enter-event', 'event', 'hide', 'key-focus-in', 'key-focus-out', 'key-press-event', 'key-release-event', 'leave-event', 'motion-event', 'paint', 'parent-set', 'pick', 'queue-redraw', 'queue-relayout', 'realize', 'resource-scale-changed', 'scroll-event', 'show', 'stage-views-changed', 'touch-event', 'transition-stopped', 'transitions-completed', 'unrealize'],
    ClutterCanvas: ['draw'],
...
export const ENUM_VALUES = {
    ...
    'ClutterEventType.device-added': 24,
    'ClutterEventType.device-removed': 25,
    'ClutterEventType.enter': 4,
    'ClutterEventType.event-last': 29,
    'ClutterEventType.im-commit': 26,
    'ClutterEventType.im-delete': 27,
    'ClutterEventType.im-preedit': 28,
    ...
    'ClutterEventType.pad-button-press': 20,
    'ClutterEventType.pad-button-release': 21,
    'ClutterEventType.pad-ring': 23,
    'ClutterEventType.pad-strip': 22,
    'ClutterEventType.proximity-in': 18,
    'ClutterEventType.proximity-out': 19,
    'ClutterEventType.scroll': 8,
    'ClutterEventType.stage-state': 9,
    'ClutterEventType.touch-begin': 12,
    'ClutterEventType.touch-cancel': 15,
    'ClutterEventType.touch-end': 14,
    'ClutterEventType.touch-update': 13,
    'ClutterEventType.touchpad-pinch': 16,
    'ClutterEventType.touchpad-swipe': 17,

/**
 * The GIR-derived widget VOCABULARY for Clutter-7.
 *
 * GENERATED — do not edit. Provenance: Clutter-7 — dropped empty base(s): Atk.ImplementorIface
 *
 * 57 instantiable GTypes (of which 0 concrete widgets), 70 declarations, 50 enum nick unions, 0 slot candidates.
 *
...
import type Clutter from './clutter-7.js';
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type ClutterStageViewConstructOnly = GObjectConstructOnly | 'name' | 'stage' | 'use-shadowfb';

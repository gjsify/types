/**
 * The GIR-derived widget VOCABULARY for Translit-1.0.
 *
 * GENERATED — do not edit. Provenance: Translit-1.0
 *
...
export interface TranslitTransliteratorProps extends GObjectProps {
    /**
...
export type TranslitTransliteratorConstructOnly = GObjectConstructOnly | 'name';

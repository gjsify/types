 ...
 * @param xOffset left edge of the clip rectangle
 * @param yOffset top edge of the clip rectangle
 ...
 * The rectangle is intersected with the current clip region. To undo
 * the effect of this function, call cogl_clip_pop().
 * @param xOffset left edge of the clip rectangle in window coordinates
 * @param yOffset top edge of the clip rectangle in window coordinates
 * @param width width of the clip rectangle
 * @param height height of the clip rectangle
 */
 ...
 */
function isOffscreen(object: any | null): Bool
/**
 ...
 * @param nVertices The length of the vertices array
 * @param useColor %TRUE if the color member of #CoglTextureVertex should be used
 */
 ...
 * @param uniformNo the uniform to set.
 * @param value the new value of the uniform.
 */
 ...
 */
function pushSource(material: any | null): void
/**
 ...
 * @param texCoords An array containing groups of   4 float values: [tx1, ty1, tx2, ty2] that are interpreted as two texture   coordinates; one for the upper left texel, and one for the lower right   texel. Each value should be between 0.0 and 1.0, where the coordinate   (0.0, 0.0) represents the top left of the texture, and (1.0, 1.0) the   bottom right.
 * @param texCoordsLen The length of the tex_coords array. (e.g. for one layer   and one group of texture coordinates, this would be 4)
 */
 ...
 * @param nRects number of rectangles to draw
 */
 ...
 * @param zNear Position along Z axis where no fogging should be applied
 * @param zFar Position along Z axis where full fogging should be applied
 */
 ...
 * @param material A #CoglMaterial
 */
function setSource(material: any | null): void
/**
 ...
 */
function shaderGetInfoLog(handle: Handle): string | null
/**
 ...
 * @param nComponents The number of components per attribute and must be 1, 2,   3 or 4
 ...
 * @param minIndex Specifies the minimum vertex index contained in indices
 * @param maxIndex Specifies the maximum vertex index contained in indices
 * @param indicesOffset An offset into named indices. The offset marks the first    index to use for drawing.
 * @param count Specifies the number of vertices you want to draw.
 */
 ...
 * </figure>
 * @param nIndices the number of indices in the vertex buffer.
 ...
 * @param nVertices The number of vertices that your attributes will correspond to.
...
class Offscreen {
     ...
     * @returns a newly instantiated #CoglOffscreen   framebuffer or %NULL if it wasn't possible to create the   buffer.
     */
...
interface Material {
     ...
     * @param alphaFunc A `CoglMaterialAlphaFunc` constant
     ...
     * @param layerIndex the index for the layer inside `material`

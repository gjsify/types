...
export namespace St {
    ...
    class Adjustment extends GObject.Object {
        // Own properties of St-1.0.Adjustment
        ...
        // Constructors of St-1.0.Adjustment
        ...
        // Owm methods of St-1.0.Adjustment
    ...
    class Bin<A extends Clutter.Actor = Clutter.Actor> extends Widget {
        // Own properties of St-1.0.Bin
        ...
        // Constructors of St-1.0.Bin

        static ['new'](): Bin;

        // Owm methods of St-1.0.Bin
    ...
    class BorderImage extends GObject.Object {
        // Constructors of St-1.0.BorderImage
        ...
        // Owm methods of St-1.0.BorderImage
     ...
     */
    class BoxLayout<A extends Clutter.Actor = Clutter.Actor> extends Viewport<Clutter.BoxLayout> {
        // Own properties of St-1.0.BoxLayout
        ...
        // Constructors of St-1.0.BoxLayout

        static ['new'](): BoxLayout;

        // Owm methods of St-1.0.BoxLayout
    ...
    class Button<A extends Clutter.Actor = Clutter.Actor> extends Bin<A> {
        // Own properties of St-1.0.Button
        ...
        // Constructors of St-1.0.Button

        static ['new'](): Button;

        static new_with_label(text: string): Button;

        // Owm methods of St-1.0.Button
    ...
    class Clipboard extends GObject.Object {
        // Owm methods of St-1.0.Clipboard
    ...
    class DrawingArea<A extends Clutter.Actor = Clutter.Actor> extends Widget {
        // Owm methods of St-1.0.DrawingArea
    ...
    class Entry<A extends Clutter.Actor = Clutter.Actor> extends Widget {
        // Own properties of St-1.0.Entry
        ...
        // Constructors of St-1.0.Entry

        static ['new'](text?: string | null): Entry;

        // Owm methods of St-1.0.Entry
    ...
    class FocusManager extends GObject.Object {
        // Owm methods of St-1.0.FocusManager
    ...
    class GenericAccessible extends WidgetAccessible {
        // Constructors of St-1.0.GenericAccessible
     ...
     * through the public API.
     */
    class Icon<A extends Clutter.Actor = Clutter.Actor> extends Widget {
        // Own properties of St-1.0.Icon
        ...
        // Constructors of St-1.0.Icon

        static ['new'](): Icon;

        // Owm methods of St-1.0.Icon
    ...
    class ImageContent extends Clutter.Image {
        // Own properties of St-1.0.ImageContent
        ...
        // Owm methods of St-1.0.ImageContent
     ...
     * the provided API.
     */
    class Label<A extends Clutter.Actor = Clutter.Actor> extends Widget {
        // Own properties of St-1.0.Label
        ...
        // Constructors of St-1.0.Label

        static ['new'](text?: string | null): Label;

        // Owm methods of St-1.0.Label
    ...
    class PasswordEntry<A extends Clutter.Actor = Clutter.Actor> extends Entry<A> {
        // Own properties of St-1.0.PasswordEntry
        ...
        // Constructors of St-1.0.PasswordEntry

        static ['new'](): PasswordEntry;

        // Owm methods of St-1.0.PasswordEntry
    ...
    class ScrollBar<A extends Clutter.Actor = Clutter.Actor> extends Widget {
        // Own properties of St-1.0.ScrollBar
        ...
        // Constructors of St-1.0.ScrollBar

        static ['new'](adjustment: Adjustment): ScrollBar;

        // Owm methods of St-1.0.ScrollBar
     ...
     * through the public API.
     */
    class ScrollView<A extends Clutter.Actor = Clutter.Actor> extends Bin<A> {
        // Own properties of St-1.0.ScrollView
        ...
        // Constructors of St-1.0.ScrollView

        static ['new'](): ScrollView;

        // Owm methods of St-1.0.ScrollView
    ...
    class ScrollViewFade extends Clutter.ShaderEffect {
        // Own properties of St-1.0.ScrollViewFade
        ...
        // Constructors of St-1.0.ScrollViewFade
    ...
    class Settings extends GObject.Object {
        // Own properties of St-1.0.Settings
         ...
         * The current GTK theme
         */
        readonly gtk_theme_variant: string;
        /**
         * The current GTK theme
         */
        readonly gtkThemeVariant: string;
        /**
         ...
         * The current GTK theme
         */
        readonly shell_color_scheme: string;
        /**
         * The current GTK theme
         */
        readonly shellColorScheme: string;
        /**
        ...
        // Owm methods of St-1.0.Settings
    ...
    class TextureCache extends GObject.Object {
        // Owm methods of St-1.0.TextureCache
    ...
    class Theme extends GObject.Object {
        // Own properties of St-1.0.Theme
    ...
    class ThemeContext extends GObject.Object {
        // Own properties of St-1.0.ThemeContext
        ...
        // Constructors of St-1.0.ThemeContext

        static ['new'](): ThemeContext;

        // Owm methods of St-1.0.ThemeContext
    ...
    class ThemeNode extends GObject.Object {
        // Constructors of St-1.0.ThemeNode
        ...
        // Owm methods of St-1.0.ThemeNode
    ...
    > extends Widget<A, B> {
        // Own properties of St-1.0.Viewport
    ...
    > extends Clutter.Actor<A, B> {
        // Own properties of St-1.0.Widget
     ...
     */
    class IconColors {
        // Own fields of St-1.0.IconColors
        ...
        // Constructors of St-1.0.IconColors
        ...
        // Owm methods of St-1.0.IconColors
    ...
    class ShadowHelper {
        // Constructors of St-1.0.ShadowHelper

        constructor(shadow: Shadow);

        static ['new'](shadow: Shadow): ShadowHelper;

        // Owm methods of St-1.0.ShadowHelper
    ...
    class ThemeNodePaintState {
        // Own fields of St-1.0.ThemeNodePaintState
        ...
        // Owm methods of St-1.0.ThemeNodePaintState
    ...
    interface Scrollable {
        // Own properties of St-1.0.Scrollable
        ...
        // Owm methods of St-1.0.Scrollable
        ...
        // Own virtual methods of St-1.0.Scrollable

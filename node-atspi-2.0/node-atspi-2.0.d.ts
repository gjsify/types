 ...
 */
function deregisterDeviceEventListener(listener: DeviceListener, filter: any | null): boolean
/**
 ...
 * @returns %TRUE if successful, otherwise %FALSE.
 */
function generateMouseEvent(x: number, y: number, name: string | null): boolean
/**
 ...
 */
function generateMouseEventAsync(x: number, y: number, name: string | null, callback: GenerateMouseEventCB | null): void
/**
 ...
 */
function registerDeviceEventListener(listener: DeviceListener, eventTypes: DeviceEventMask, filter: any | null): boolean
/**
 ...
 */
function roleGetLocalizedName(role: Role): string | null
/**
 ...
 */
function roleGetName(role: Role): string | null
/**

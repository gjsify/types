 ...
 */
export function utilsHwaddrAtoba(asc: string | null, type: number): Uint8Array
/**
 ...
 */
export function utilsRsaKeyEncrypt(data: Uint8Array, inPassword: string | null): [ /* returnType */ Uint8Array, /* outPassword */ string | null ]
/**
 * Encrypts the given RSA private key data with the given password (or generates
 * a password if no password was given) and converts the data to PEM format
 ...
 * @returns on success, PEM-formatted data suitable for writing to a PEM-formatted certificate/private key file.
 */
export function utilsRsaKeyEncryptAes(data: Uint8Array, inPassword: string | null): [ /* returnType */ Uint8Array, /* outPassword */ string | null ]
/**
 ...
 */
export function utilsSameSsid(ssid1: Uint8Array, ssid2: Uint8Array, ignoreTrailingNull: boolean): boolean
/**
 * Given a set of device capabilities, and a desired security type to check
 ...
 */
export function utilsSsidToUtf8(ssid: Uint8Array): string | null

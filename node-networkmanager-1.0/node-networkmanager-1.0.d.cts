 ...
 */
export function utilsBin2hexstr(bytes: string, len: number, finalLen: number): string | null
/**
 ...
 */
export function utilsHexstr2bin(hex: string, len: number): string | null
/**
 ...
 */
export function utilsHwaddrAtoba(asc: string, type: number): number[]
/**
 ...
 */
export function utilsHwaddrAton(asc: string, type: number, buffer: any | null): number
/**
 ...
 */
export function utilsHwaddrAtonLen(asc: string, buffer: any | null, length: number): number
/**
 ...
 */
export function utilsRsaKeyEncrypt(data: number[], inPassword: string | null): [ /* returnType */ number[], /* outPassword */ string ]
/**
 * Encrypts the given RSA private key data with the given password (or generates
 * a password if no password was given) and converts the data to PEM format
 ...
 * @returns on success, PEM-formatted data suitable for writing to a PEM-formatted certificate/private key file.
 */
export function utilsRsaKeyEncryptAes(data: number[], inPassword: string | null): [ /* returnType */ number[], /* outPassword */ string ]
/**
 ...
 */
export function utilsUuidGenerateFromString(s: string): string | null
/**

 ...
 */
function utilsCheckVirtualDeviceCompatibility(virtualType: GObject.GType, otherType: GObject.GType): boolean
/**
 ...
 */
function utilsHwaddrNtoa(addr: any | null, type: number): string | null
/**
 * Converts `addr` to textual form.
 * @param addr a binary hardware address
 ...
 * @returns the textual form of @addr
 */
function utilsHwaddrNtoaLen(addr: any | null, length: number): string | null
/**
 ...
 */
function utilsSameSsid(ssid1: number[], ssid2: number[], ignoreTrailingNull: boolean): boolean
/**
 * Given a set of device capabilities, and a desired security type to check
 ...
 */
function utilsSsidToUtf8(ssid: number[]): string | null
function utilsUuidGenerate(): string | null
/**
 ...
 */
function utilsWifiFindNextChannel(channel: number, direction: number, band: string | null): number
/**

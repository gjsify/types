...
export namespace Gdk {
     ...
     */
    function drag_find_window(context: DragContext, drag_window: Window, x_root: number, y_root: number): void;
    /**
     * Finds the destination window and DND protocol to use at the
     * given pointer position.
     *
     ...
     */
    function window_at_pointer(): Window;
    /**
     ...
     */
    function window_constrain_size(geometry: Geometry, flags: number, width: number, height: number): void;
    /**
    ...
    class AppLaunchContext extends Gio.AppLaunchContext {
        // Constructors of Gdk-2.0.AppLaunchContext

        static ['new'](): AppLaunchContext;

        // Owm methods of Gdk-2.0.AppLaunchContext
    ...
    class Colormap extends GObject.Object {
        // Own fields of Gdk-2.0.Colormap

        size: number;
        colors: Color;

        // Constructors of Gdk-2.0.Colormap

        static ['new'](visual: Visual, allocate: boolean): Colormap;

        // Owm methods of Gdk-2.0.Colormap
    ...
    class Display extends GObject.Object {
        // Owm methods of Gdk-2.0.Display
    ...
    class DisplayManager extends GObject.Object {
        // Own properties of Gdk-2.0.DisplayManager

        default_display: Display;
        defaultDisplay: Display;

        // Owm methods of Gdk-2.0.DisplayManager
    ...
    class DragContext extends GObject.Object {
        // Own fields of Gdk-2.0.DragContext
        ...
        // Constructors of Gdk-2.0.DragContext

        static ['new'](): DragContext;

        // Owm methods of Gdk-2.0.DragContext
    ...
    abstract class Drawable extends GObject.Object {
        // Owm methods of Gdk-2.0.Drawable
    ...
    class GC extends GObject.Object {
         ...
         * only the pixel values of the `values-&`gt;foreground and `values-&`gt;background
         ...
         * Note that this function uses `color-&`gt;pixel, use
    ...
    class Keymap extends GObject.Object {
        // Own fields of Gdk-2.0.Keymap

        display: Display;

        // Owm methods of Gdk-2.0.Keymap
         ...
         */
        get_entries_for_keycode(hardware_keycode: number, n_entries: number): boolean;
        /**
    ...
    class PangoRenderer extends Pango.Renderer {
        // Own properties of Gdk-2.0.PangoRenderer

        screen: Screen;

        // Constructors of Gdk-2.0.PangoRenderer

        static ['new'](screen: Screen): PangoRenderer;

        // Owm methods of Gdk-2.0.PangoRenderer
    ...
    class Pixmap extends Drawable {
        // Constructors of Gdk-2.0.Pixmap
         ...
         * @param filename the filename of a file containing XPM data.
         */
        static create_from_xpm(drawable: Drawable, transparent_color: Color, filename: string): Pixmap;
        /**
         ...
         * @param data Pointer to a string containing the XPM data.
         */
        static create_from_xpm_d(drawable: Drawable, transparent_color: Color, data: string): Pixmap;
    ...
    class Screen extends GObject.Object {
        // Own properties of Gdk-2.0.Screen

        font_options: any;
        fontOptions: any;
        resolution: number;

        // Own fields of Gdk-2.0.Screen
    ...
    class Window extends Drawable {
        // Own properties of Gdk-2.0.Window
         ...
         */
        get_root_coords(x: number, y: number): void;
        /**
    ...
    class Color {
         ...
         * @param spec the string specifying the color.
         */
        static parse(spec: string): boolean;
        /**
         * Returns the white color for a given colormap. The resulting
         * value has already allocated been allocated.
         * @param colormap a #GdkColormap.
    ...
    class Cursor {
        // Own fields of Gdk-2.0.Cursor

        type: CursorType;

        // Constructors of Gdk-2.0.Cursor
    ...
    class DeviceAxis {
        // Own fields of Gdk-2.0.DeviceAxis
    ...
    class DeviceKey {
        // Own fields of Gdk-2.0.DeviceKey
    ...
    class EventAny {
        // Own fields of Gdk-2.0.EventAny
    ...
    class EventButton {
        // Own fields of Gdk-2.0.EventButton
    ...
    class EventClient {
        // Own fields of Gdk-2.0.EventClient
    ...
    class EventConfigure {
        // Own fields of Gdk-2.0.EventConfigure
    ...
    class EventCrossing {
        // Own fields of Gdk-2.0.EventCrossing
    ...
    class EventDND {
        // Own fields of Gdk-2.0.EventDND
    ...
    class EventExpose {
        // Own fields of Gdk-2.0.EventExpose
    ...
    class EventFocus {
        // Own fields of Gdk-2.0.EventFocus
    ...
    class EventGrabBroken {
        // Own fields of Gdk-2.0.EventGrabBroken
    ...
    class EventKey {
        // Own fields of Gdk-2.0.EventKey
    ...
    class EventMotion {
        // Own fields of Gdk-2.0.EventMotion
    ...
    class EventNoExpose {
        // Own fields of Gdk-2.0.EventNoExpose
    ...
    class EventOwnerChange {
        // Own fields of Gdk-2.0.EventOwnerChange
    ...
    class EventProperty {
        // Own fields of Gdk-2.0.EventProperty
    ...
    class EventProximity {
        // Own fields of Gdk-2.0.EventProximity
    ...
    class EventScroll {
        // Own fields of Gdk-2.0.EventScroll
    ...
    class EventSelection {
        // Own fields of Gdk-2.0.EventSelection
    ...
    class EventSetting {
        // Own fields of Gdk-2.0.EventSetting
    ...
    class EventVisibility {
        // Own fields of Gdk-2.0.EventVisibility
    ...
    class EventWindowState {
        // Own fields of Gdk-2.0.EventWindowState
    ...
    class Font {
        // Own fields of Gdk-2.0.Font

        type: FontType;
        ascent: number;
        descent: number;

        // Owm methods of Gdk-2.0.Font
    ...
    class GCValues {
        // Own fields of Gdk-2.0.GCValues
    ...
    class Geometry {
        // Own fields of Gdk-2.0.Geometry
    ...
    class KeyboardGrabInfo {
        // Own fields of Gdk-2.0.KeyboardGrabInfo
        ...
        // Owm methods of Gdk-2.0.KeyboardGrabInfo
    ...
    class KeymapKey {
        // Own fields of Gdk-2.0.KeymapKey

        keycode: number;
        group: number;
        level: number;

        // Constructors of Gdk-2.0.KeymapKey
    ...
    class PangoAttrEmbossColor {
        // Own fields of Gdk-2.0.PangoAttrEmbossColor

        color: Pango.Color;

        // Owm methods of Gdk-2.0.PangoAttrEmbossColor
    ...
    class PangoAttrEmbossed {
        // Own fields of Gdk-2.0.PangoAttrEmbossed

        embossed: boolean;

        // Owm methods of Gdk-2.0.PangoAttrEmbossed
    ...
    class PangoAttrStipple {
        // Owm methods of Gdk-2.0.PangoAttrStipple
    ...
    class PixmapObject {
        // Own fields of Gdk-2.0.PixmapObject
    ...
    class Point {
        // Own fields of Gdk-2.0.Point

        x: number;
        y: number;

        // Constructors of Gdk-2.0.Point
    ...
    class PointerWindowInfo {
        // Own fields of Gdk-2.0.PointerWindowInfo
    ...
    class Rectangle {
        // Own fields of Gdk-2.0.Rectangle
        ...
        // Constructors of Gdk-2.0.Rectangle
        ...
        // Owm methods of Gdk-2.0.Rectangle
    ...
    class RgbCmap {
        // Own fields of Gdk-2.0.RgbCmap

        colors: number[];
        n_colors: number;

        // Constructors of Gdk-2.0.RgbCmap
        ...
        // Owm methods of Gdk-2.0.RgbCmap
    ...
    class Segment {
        ...
        // Constructors of Gdk-2.0.Segment
    ...
    class Span {
        // Own fields of Gdk-2.0.Span

        x: number;
        y: number;
        width: number;

        // Constructors of Gdk-2.0.Span
    ...
    class TimeCoord {
        // Own fields of Gdk-2.0.TimeCoord

        time: number;
        axes: number[];

        // Constructors of Gdk-2.0.TimeCoord
    ...
    class Trapezoid {
        // Own fields of Gdk-2.0.Trapezoid
        ...
        // Constructors of Gdk-2.0.Trapezoid
    ...
    class WindowAttr {
        // Own fields of Gdk-2.0.WindowAttr
    ...
    class Event {
        // Own fields of Gdk-2.0.Event

        type: EventType;

        // Constructors of Gdk-2.0.Event

        constructor(type: EventType);

        static ['new'](type: EventType): Event;

        // Owm methods of Gdk-2.0.Event

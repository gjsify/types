/**
 * The GIR-derived widget VOCABULARY for Meta-4.
 *
 * GENERATED — do not edit. Provenance: Meta-4 — library 3.32.2 — dropped empty base(s): Atk.ImplementorIface
 *
 * 24 instantiable GTypes (of which 0 concrete widgets), 24 declarations, 27 enum nick unions, 0 slot candidates.
 *
...
import type Meta from './meta-4.js';
import type { ClutterActorConstructOnly, ClutterActorProps, ClutterAnimatableConstructOnly, ClutterAnimatableProps, ClutterContainerConstructOnly, ClutterContainerProps, ClutterGroupConstructOnly, ClutterGroupProps, ClutterScriptableConstructOnly, ClutterScriptableProps, ClutterStageConstructOnly, ClutterStageProps } from '@girs/clutter-4/vocabulary';
...
export interface MetaShapedTextureProps extends ClutterActorProps, ClutterAnimatableProps, ClutterContainerProps, ClutterScriptableProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MetaShapedTextureConstructOnly = ClutterActorConstructOnly | ClutterAnimatableConstructOnly | ClutterContainerConstructOnly | ClutterScriptableConstructOnly;

/**
 * The GIR-derived widget VOCABULARY for CMenu-3.0.
 *
 * GENERATED — do not edit. Provenance: CMenu-3.0 — dropped empty base(s): Gio.AppInfo
 *
...
export interface GMenuDesktopAppInfoProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GMenuDesktopAppInfoConstructOnly = GObjectConstructOnly;

export interface GMenuTreeProps extends GObjectProps {
    /**
     * Flags controlling the content of the menu.
     * @default GMENU_TREE_FLAGS_NONE
     */
    flags?: number;
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GMenuTreeConstructOnly = GObjectConstructOnly | 'flags' | 'menu-basename' | 'menu-path';

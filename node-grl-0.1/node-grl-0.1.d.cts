...
export function marshalVOIDBOXEDENUMBOOLEAN(closure: GObject.TClosure, returnValue: any, nParamValues: number, paramValues: any, invocationHint: any, marshalData: any): void
/**
 * Retrieves the description associated with the key
 * @param key key to look up
 * @returns the description of the key
 */
export function metadataKeyGetDesc(key: GObject.ParamSpec): string | null
/**
 * Retrieves the name associated with the key
 * @param key key to look up
 * @returns The name of the key
 */
export function metadataKeyGetName(key: GObject.ParamSpec): string | null
 ...
 */
export function multipleGetMediaFromUri(uri: string | null, keys: KeyID[], flags: MetadataResolutionFlags, callback: MediaSourceMetadataCb): void
/**
 ...
 */
export function multipleSearch(sources: MediaSource[] | null, text: string | null, keys: GObject.ParamSpec[], count: number, flags: MetadataResolutionFlags, callback: MediaSourceResultCb): number
/**
 * Search for `text` in all the sources specified in `sources`.
 * 
 ...
 */
export function multipleSearchSync(sources: MediaSource[] | null, text: string | null, keys: GObject.ParamSpec[], count: number, flags: MetadataResolutionFlags): Media[]
/**
 * Cancel an operation.
 ...
 */
export function operationGetData(operationId: number): any
/**
 * Attach a pointer to the specific operation.
 * @param operationId the identifier of a running operation
 * @param userData the data to attach
 */
export function operationSetData(operationId: number, userData: any): void
/**

...
export namespace EDataServer {
    ...
    class CollatorError extends GLib.Error {
        // Own fields of EDataServer-1.2.CollatorError
         ...
         */
        INVALID_LOCALE: number;

        // Constructors of EDataServer-1.2.CollatorError
     ...
     */
    function oauth2_service_util_compile_value(compile_value: string, out_glob_buff_size: number): string;
    /**
     ...
     */
    function oauth2_service_util_extract_from_uri(in_uri: string): boolean;
    /**
     ...
     * @returns %TRUE on success, %FALSE on error
     */
    function secret_store_lookup_sync(uid: string, cancellable?: Gio.Cancellable | null): boolean;
    /**
     ...
     */
    function time_parse_date_format(value: string, format: string): TimeParseStatus;
    /**
     ...
     */
    function util_change_uri_component(inout_uri: GLib.Uri, component: Soup.URIComponent, value?: string | null): void;
    /**
     ...
     */
    function util_change_uri_port(inout_uri: GLib.Uri, port: number): void;
    /**
     ...
     */
    function webdav_discover_sources_finish(source: Source, result: Gio.AsyncResult): boolean;
    /**
    ...
    /**
     * Calls g_hash_table_foreach_remove() on `hash&`lt;!-- --&gt;'s internal hash
    ...
    abstract class Client extends GObject.Object {
        // Own properties of EDataServer-1.2.Client
        ...
        // Owm methods of EDataServer-1.2.Client
         ...
         */
        get_backend_property_finish(result: Gio.AsyncResult): boolean;
        /**
         * Queries `client'`s backend for a property of name `prop_name`.
         * @param prop_name property name, whose value to retrieve; cannot be %NULL
         * @param cancellable a #GCancellable; can be %NULL
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_backend_property_sync(prop_name: string, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        retrieve_capabilities_finish(result: Gio.AsyncResult): boolean;
        /**
         * Initiates retrieval of capabilities on the `client`. This is usually
         * required only once, after the `client` is opened. The returned value
         * is cached and any subsequent call of e_client_get_capabilities() and
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        retrieve_capabilities_sync(cancellable?: Gio.Cancellable | null): boolean;
        /**
    ...
    abstract class Extension extends GObject.Object {
        // Own properties of EDataServer-1.2.Extension

        extensible: Extensible;

        // Owm methods of EDataServer-1.2.Extension
    ...
    class GDataSession extends SoupSession {
        // Constructors of EDataServer-1.2.GDataSession

        static ['new'](source: Source): GDataSession;

        // Owm methods of EDataServer-1.2.GDataSession
         ...
         * @returns whether succeeded
         */
        tasklists_get_sync(tasklist_id: string, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns whether succeeded
         */
        tasklists_insert_sync(title: string, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns whether succeeded
         */
        tasks_get_sync(tasklist_id: string, task_id: string, cancellable?: Gio.Cancellable | null): boolean;
        /**
    ...
    class Module extends GObject.TypeModule {
        // Own properties of EDataServer-1.2.Module
        ...
        // Constructors of EDataServer-1.2.Module

        static ['new'](filename: string): Module;

        // Owm methods of EDataServer-1.2.Module
    ...
    class NetworkMonitor extends GObject.Object {
        // Own properties of EDataServer-1.2.NetworkMonitor
        ...
        // Owm methods of EDataServer-1.2.NetworkMonitor
    ...
    class OAuth2Services extends GObject.Object {
        // Constructors of EDataServer-1.2.OAuth2Services

        static ['new'](): OAuth2Services;

        // Owm methods of EDataServer-1.2.OAuth2Services
    ...
    class SoupAuthBearer extends Soup.Auth {
        // Owm methods of EDataServer-1.2.SoupAuthBearer
    ...
    class SoupSession extends Soup.Session {
        // Own properties of EDataServer-1.2.SoupSession
        ...
        // Constructors of EDataServer-1.2.SoupSession

        static ['new'](source: Source): SoupSession;

        // Owm methods of EDataServer-1.2.SoupSession
         ...
         * @param message a #SoupMessage
         */
        static util_ref_message_request_body(message: Soup.Message): Gio.InputStream | null;
        /**
         ...
         */
        handle_authentication_failure(credentials: NamedParameters | null, op_error: GLib.Error): void;
        /**
         ...
         */
        send_message_finish(result: Gio.AsyncResult): Gio.InputStream | null;
        /**
    ...
    class Source extends GObject.Object {
        // Own properties of EDataServer-1.2.Source
        ...
        // Constructors of EDataServer-1.2.Source
        ...
        // Owm methods of EDataServer-1.2.Source
         ...
         * @returns %TRUE on success, %FALSE on error
         */
        get_last_credentials_required_arguments_finish(result: Gio.AsyncResult): boolean;
        /**
         ...
         * @returns %TRUE on success, %FALSE on error
         */
        get_last_credentials_required_arguments_sync(cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns %TRUE on success, %FALSE on error
         */
        get_oauth2_access_token_finish(result: Gio.AsyncResult): boolean;
        /**
         ...
         * @returns %TRUE on success, %FALSE on error
         */
        get_oauth2_access_token_sync(cancellable: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns %TRUE on success, %FALSE on error
         */
        lookup_password_finish(result: Gio.AsyncResult): boolean;
        /**
         ...
         * @returns %TRUE on success, %FALSE on error
         */
        lookup_password_sync(cancellable: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns %TRUE on success, %FALSE on failure
         */
        mail_signature_load_finish(result: Gio.AsyncResult): boolean;
        /**
         ...
         * @returns %TRUE on success, %FALSE on failure
         */
        mail_signature_load_sync(cancellable?: Gio.Cancellable | null): boolean;
        /**
    ...
    class SourceAddressBook extends SourceBackend {
        // Own properties of EDataServer-1.2.SourceAddressBook

        order: number;

        // Owm methods of EDataServer-1.2.SourceAddressBook
    ...
    class SourceAlarms extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceAlarms
        ...
        // Owm methods of EDataServer-1.2.SourceAlarms
    ...
    class SourceAuthentication extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceAuthentication
        ...
        // Owm methods of EDataServer-1.2.SourceAuthentication
    ...
    class SourceAutocomplete extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceAutocomplete

        include_me: boolean;
        includeMe: boolean;

        // Owm methods of EDataServer-1.2.SourceAutocomplete
    ...
    class SourceAutoconfig extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceAutoconfig

        revision: string;

        // Owm methods of EDataServer-1.2.SourceAutoconfig
    ...
    abstract class SourceBackend extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceBackend

        backend_name: string;
        backendName: string;

        // Owm methods of EDataServer-1.2.SourceBackend
    ...
    abstract class SourceCamel extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceCamel

        readonly settings: Camel.Settings;

        // Owm methods of EDataServer-1.2.SourceCamel
    ...
    class SourceCollection extends SourceBackend {
        // Own properties of EDataServer-1.2.SourceCollection
        ...
        // Owm methods of EDataServer-1.2.SourceCollection
    ...
    class SourceContacts extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceContacts

        include_me: boolean;
        includeMe: boolean;

        // Owm methods of EDataServer-1.2.SourceContacts
    ...
    class SourceCredentialsProvider extends GObject.Object {
        // Own properties of EDataServer-1.2.SourceCredentialsProvider
        ...
        // Constructors of EDataServer-1.2.SourceCredentialsProvider

        static ['new'](registry: SourceRegistry): SourceCredentialsProvider;

        // Owm methods of EDataServer-1.2.SourceCredentialsProvider
         ...
         * @returns %TRUE on success, %FALSE on error
         */
        lookup_finish(result: Gio.AsyncResult): boolean;
        /**
         ...
         * @returns %TRUE on success, %FALSE on error
         */
        lookup_sync(source: Source, cancellable: Gio.Cancellable | null): boolean;
        /**
    ...
    abstract class SourceCredentialsProviderImpl extends Extension {
        // Owm methods of EDataServer-1.2.SourceCredentialsProviderImpl
    ...
    abstract class SourceExtension extends GObject.Object {
        // Own properties of EDataServer-1.2.SourceExtension

        source: Source;

        // Owm methods of EDataServer-1.2.SourceExtension
    ...
    class SourceGoa extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceGoa
        ...
        // Owm methods of EDataServer-1.2.SourceGoa
    ...
    class SourceLDAP extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceLDAP
        ...
        // Owm methods of EDataServer-1.2.SourceLDAP
    ...
    class SourceLocal extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceLocal
        ...
        // Owm methods of EDataServer-1.2.SourceLocal
    ...
    class SourceMDN extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceMDN

        response_policy: MdnResponsePolicy;
        responsePolicy: MdnResponsePolicy;

        // Owm methods of EDataServer-1.2.SourceMDN
    ...
    class SourceMailAccount extends SourceBackend {
        // Own properties of EDataServer-1.2.SourceMailAccount
        ...
        // Owm methods of EDataServer-1.2.SourceMailAccount
    ...
    class SourceMailComposition extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceMailComposition
        ...
        // Owm methods of EDataServer-1.2.SourceMailComposition
    ...
    class SourceMailIdentity extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceMailIdentity
        ...
        // Owm methods of EDataServer-1.2.SourceMailIdentity
    ...
    class SourceMailSignature extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceMailSignature

        readonly file: Gio.File;
        mime_type: string;
        mimeType: string;

        // Owm methods of EDataServer-1.2.SourceMailSignature
    ...
    class SourceMailSubmission extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceMailSubmission
        ...
        // Owm methods of EDataServer-1.2.SourceMailSubmission
    ...
    class SourceOffline extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceOffline

        stay_synchronized: boolean;
        staySynchronized: boolean;

        // Owm methods of EDataServer-1.2.SourceOffline
    ...
    class SourceOpenPGP extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceOpenPGP
        ...
        // Owm methods of EDataServer-1.2.SourceOpenPGP
    ...
    class SourceProxy extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceProxy
        ...
        // Owm methods of EDataServer-1.2.SourceProxy
    ...
    class SourceRefresh extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceRefresh
        ...
        // Owm methods of EDataServer-1.2.SourceRefresh
    ...
    class SourceRegistry extends GObject.Object {
        // Own properties of EDataServer-1.2.SourceRegistry
    ...
    class SourceRegistryWatcher extends GObject.Object {
        // Own properties of EDataServer-1.2.SourceRegistryWatcher
        ...
        // Constructors of EDataServer-1.2.SourceRegistryWatcher

        static ['new'](registry: SourceRegistry, extension_name?: string | null): SourceRegistryWatcher;

        // Owm methods of EDataServer-1.2.SourceRegistryWatcher
    ...
    class SourceResource extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceResource

        identity: string;

        // Owm methods of EDataServer-1.2.SourceResource
    ...
    class SourceRevisionGuards extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceRevisionGuards

        enabled: boolean;

        // Owm methods of EDataServer-1.2.SourceRevisionGuards
    ...
    class SourceSMIME extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceSMIME
        ...
        // Owm methods of EDataServer-1.2.SourceSMIME
    ...
    class SourceSecurity extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceSecurity

        method: string;
        secure: boolean;

        // Owm methods of EDataServer-1.2.SourceSecurity
    ...
    abstract class SourceSelectable extends SourceBackend {
        // Own properties of EDataServer-1.2.SourceSelectable

        color: string;
        order: number;
        selected: boolean;

        // Owm methods of EDataServer-1.2.SourceSelectable
    ...
    class SourceUoa extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceUoa

        account_id: number;
        accountId: number;

        // Owm methods of EDataServer-1.2.SourceUoa
    ...
    class SourceWeather extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceWeather

        location: string;
        units: SourceWeatherUnits;

        // Owm methods of EDataServer-1.2.SourceWeather
    ...
    class SourceWebDAVNotes extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceWebDAVNotes

        default_ext: string;
        defaultExt: string;

        // Owm methods of EDataServer-1.2.SourceWebDAVNotes
    ...
    class SourceWebdav extends SourceExtension {
        // Own properties of EDataServer-1.2.SourceWebdav
        ...
        // Owm methods of EDataServer-1.2.SourceWebdav
    ...
    class WebDAVSession extends SoupSession {
        // Constructors of EDataServer-1.2.WebDAVSession

        static ['new'](source: Source): WebDAVSession;

        // Owm methods of EDataServer-1.2.WebDAVSession
         ...
         */
        static util_maybe_dequote(text: string): string;
         ...
         * @returns Whether succeeded.
         */
        get_acl_restrictions_sync(uri: string | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        get_acl_sync(uri: string | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        get_current_user_privilege_set_full_sync(uri: string | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
         * Gets current user privileges for the `uri,` or, in case it's %NULL, for the URI
         * defined in associated #ESource.
         *
         ...
         * @returns Whether succeeded.
         */
        get_current_user_privilege_set_sync(uri: string | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        get_data_sync(uri: string, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        get_principal_collection_set_sync(uri: string | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        get_supported_privilege_set_sync(uri: string | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        get_sync(uri: string, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        getctag_sync(uri: string | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        list_sync(uri: string | null, depth: string, flags: number, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        options_sync(uri: string | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
    ...
    class XmlDocument extends GObject.Object {
        // Constructors of EDataServer-1.2.XmlDocument

        static ['new'](ns_href: string | null, root_element: string): XmlDocument;

        // Owm methods of EDataServer-1.2.XmlDocument
    ...
    class ClientErrorsList {
        // Constructors of EDataServer-1.2.ClientErrorsList
     ...
     */
    class Collator {
        // Constructors of EDataServer-1.2.Collator
        ...
        // Owm methods of EDataServer-1.2.Collator
         ...
         */
        collate(str_a: string | null, str_b: string | null): boolean;
        /**
    ...
    class ExtensionClass {
        // Own fields of EDataServer-1.2.ExtensionClass
    ...
    class FreeFormExpSymbol {
        // Own fields of EDataServer-1.2.FreeFormExpSymbol
    ...
    class GDataQuery {
        // Constructors of EDataServer-1.2.GDataQuery

        constructor(properties?: Partial<{}>);

        static ['new'](): GDataQuery;

        // Owm methods of EDataServer-1.2.GDataQuery
    ...
    class GDataSessionClass {
        // Own fields of EDataServer-1.2.GDataSessionClass
    ...
    class NamedParameters {
        // Constructors of EDataServer-1.2.NamedParameters
        ...
        // Owm methods of EDataServer-1.2.NamedParameters
    ...
    class OAuth2ServiceBaseClass {}

    class OAuth2ServiceGoogleClass {}

    class OAuth2ServiceInterface {
        // Own fields of EDataServer-1.2.OAuth2ServiceInterface

        reserved: any[];
    }

    class OAuth2ServiceOutlookClass {}

    class OAuth2ServiceYahooClass {}

    class OAuth2ServicesClass {
        // Own fields of EDataServer-1.2.OAuth2ServicesClass
     ...
     */
    class OperationPool {
        // Owm methods of EDataServer-1.2.OperationPool
    ...
    class SoupAuthBearerClass {}

    class SoupAuthBearerPrivate {}

    class SoupSessionClass {
        // Own fields of EDataServer-1.2.SoupSessionClass
    ...
    class SourceAddressBookClass {}

    class SourceAddressBookPrivate {}

    class SourceAlarmsClass {}

    class SourceAlarmsPrivate {}

    class SourceAuthenticationClass {}

    class SourceAuthenticationPrivate {}

    class SourceAutocompleteClass {}

    class SourceAutocompletePrivate {}

    class SourceAutoconfigClass {}

    class SourceAutoconfigPrivate {}

    class SourceBackendClass {}

    class SourceBackendPrivate {}

    class SourceCalendarClass {}

    class SourceCalendarPrivate {}

    class SourceCamelClass {
        // Own fields of EDataServer-1.2.SourceCamelClass
    ...
    class SourceClass {
        // Own fields of EDataServer-1.2.SourceClass
    ...
    class SourceContactsClass {}

    class SourceContactsPrivate {}

    class SourceCredentialsProviderClass {}

    class SourceCredentialsProviderImplClass {}

    class SourceCredentialsProviderImplOAuth2Class {}

    class SourceCredentialsProviderImplOAuth2Private {}

    class SourceCredentialsProviderImplPasswordClass {}
    ...
    class SourceExtensionClass {
        // Own fields of EDataServer-1.2.SourceExtensionClass
    ...
    class SourceRegistryWatcherClass {}

    class SourceRegistryWatcherPrivate {}

    class SourceResourceClass {}

    class SourceResourcePrivate {}

    class SourceRevisionGuardsClass {}

    class SourceRevisionGuardsPrivate {}

    class SourceSMIMEClass {}

    class SourceSMIMEPrivate {}

    class SourceSecurityClass {}

    class SourceSecurityPrivate {}

    class SourceSelectableClass {}

    class SourceSelectablePrivate {}

    class SourceTaskListClass {}

    class SourceTaskListPrivate {}

    class SourceUoaClass {}

    class SourceUoaPrivate {}

    class SourceWeatherClass {}

    class SourceWeatherPrivate {}

    class SourceWebDAVNotesClass {}

    class SourceWebDAVNotesPrivate {}

    class SourceWebdavClass {}

    class SourceWebdavPrivate {}

    class WebDAVAccessControlEntry {
        // Own fields of EDataServer-1.2.WebDAVAccessControlEntry
        ...
        // Constructors of EDataServer-1.2.WebDAVAccessControlEntry
        ...
        // Owm methods of EDataServer-1.2.WebDAVAccessControlEntry
    ...
    class WebDAVDiscoveredSource {
        // Own fields of EDataServer-1.2.WebDAVDiscoveredSource
        ...
        // Constructors of EDataServer-1.2.WebDAVDiscoveredSource
        ...
        // Owm methods of EDataServer-1.2.WebDAVDiscoveredSource
    ...
    class WebDAVPrivilege {
        // Own fields of EDataServer-1.2.WebDAVPrivilege
        ...
        // Constructors of EDataServer-1.2.WebDAVPrivilege
        ...
        // Owm methods of EDataServer-1.2.WebDAVPrivilege
    ...
    class WebDAVPropertyChange {
        // Own fields of EDataServer-1.2.WebDAVPropertyChange
        ...
        // Constructors of EDataServer-1.2.WebDAVPropertyChange
        ...
        // Owm methods of EDataServer-1.2.WebDAVPropertyChange
    ...
    class WebDAVResource {
        // Own fields of EDataServer-1.2.WebDAVResource
        ...
        // Constructors of EDataServer-1.2.WebDAVResource
        ...
        // Owm methods of EDataServer-1.2.WebDAVResource
    ...
    class WebDAVSessionClass {
        // Own fields of EDataServer-1.2.WebDAVSessionClass
    ...
    class XmlDocumentClass {
        // Own fields of EDataServer-1.2.XmlDocumentClass
    ...
    interface Extensible {
        // Owm methods of EDataServer-1.2.Extensible
    ...
    interface OAuth2Service {
        // Owm methods of EDataServer-1.2.OAuth2Service
        ...
        // Own virtual methods of EDataServer-1.2.OAuth2Service

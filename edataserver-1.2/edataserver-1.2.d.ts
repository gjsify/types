 ...
 */
function binding_transform_enum_nick_to_value(binding: GObject.Binding, source_value: GObject.Value, target_value: GObject.Value, not_used?: (any | null)): boolean
/**
 ...
 */
function binding_transform_enum_value_to_nick(binding: GObject.Binding, source_value: GObject.Value, target_value: GObject.Value, not_used?: (any | null)): boolean
/**
 ...
 */
function oauth2_service_util_set_to_form(form: GLib.HashTable<string, string>, name: string, value?: (string | null)): void
/**
 ...
 * @param value a property value
 */
function oauth2_service_util_take_to_form(form: GLib.HashTable<string, string>, name: string, value?: (string | null)): void
/**
...
_init(...args: any[]): void;
    ...
    connect_after(signal: 'backend-property-changed', callback: ((_source: this, object: string, p0: string) => void)): number
...
module Source {
    ...
    interface CredentialsRequired {
        (reason: SourceCredentialsReason, certificate_pem: string, certificate_errors: Gio.TlsCertificateFlags, error: GLib.Error): void
    }
...
static new_with_uid(uid: string, main_context?: (GLib.MainContext | null)): Source;
    ...
    connect(signal: 'credentials-required', callback: ((_source: this, reason: SourceCredentialsReason, certificate_pem: string, certificate_errors: Gio.TlsCertificateFlags, error: GLib.Error) => void)): number
    connect_after(signal: 'credentials-required', callback: ((_source: this, reason: SourceCredentialsReason, certificate_pem: string, certificate_errors: Gio.TlsCertificateFlags, error: GLib.Error) => void)): number
    emit(signal: 'credentials-required', reason: SourceCredentialsReason, certificate_pem: string, certificate_errors: Gio.TlsCertificateFlags, error: GLib.Error): void
...
module SourceRegistry {
    ...
    interface CredentialsRequired {
        (source: Source, reason: SourceCredentialsReason, certificate_pem: string, certificate_errors: Gio.TlsCertificateFlags, op_error: GLib.Error): void
    }
...
static new_sync(cancellable?: (Gio.Cancellable | null)): SourceRegistry;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'credentials-required', callback: ((_source: this, source: Source, reason: SourceCredentialsReason, certificate_pem: string, certificate_errors: Gio.TlsCertificateFlags, op_error: GLib.Error) => void)): number
    connect_after(signal: 'credentials-required', callback: ((_source: this, source: Source, reason: SourceCredentialsReason, certificate_pem: string, certificate_errors: Gio.TlsCertificateFlags, op_error: GLib.Error) => void)): number
    emit(signal: 'credentials-required', source: Source, reason: SourceCredentialsReason, certificate_pem: string, certificate_errors: Gio.TlsCertificateFlags, op_error: GLib.Error): void
...
static ["new"](...args: never[]): any;
     ...
     * @returns Whether succeeded.
     */
    post_sync(uri: (string | null), data: string, data_length: number, in_content_type: (string | null), in_headers: (Soup.MessageHeaders | null), cancellable?: (Gio.Cancellable | null)): [boolean, string, Soup.MessageHeaders | null, Uint8Array | null]
    /**
     ...
     * @returns Whether succeeded.
     */
    put_data_sync(uri: string, etag: (string | null), content_type: string, in_headers: (Soup.MessageHeaders | null), bytes: string, length: number, cancellable?: (Gio.Cancellable | null)): [boolean, string, string, Soup.MessageHeaders | null]
    /**
     ...
     * @returns Whether succeeded.
     */
    put_sync(uri: string, etag: (string | null), content_type: string, in_headers: (Soup.MessageHeaders | null), stream: Gio.InputStream, stream_length: number, cancellable?: (Gio.Cancellable | null)): [boolean, string, string, Soup.MessageHeaders | null]
    /**

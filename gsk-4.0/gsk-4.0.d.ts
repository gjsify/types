...
export namespace Gsk {
    ...
    class SerializationError extends GLib.Error {
        // Own fields of Gsk-4.0.SerializationError
        ...
        // Constructors of Gsk-4.0.SerializationError

        constructor(options: { message: string; code: number });

        // Owm methods of Gsk-4.0.SerializationError
     ...
     */
    function transform_parse(string: string): boolean;
    /**
    ...
    class BlurNode extends RenderNode {
        // Constructors of Gsk-4.0.BlurNode

        static ['new'](child: RenderNode, radius: number): BlurNode;

        // Owm methods of Gsk-4.0.BlurNode
    ...
    class BroadwayRenderer extends Renderer {
        // Constructors of Gsk-4.0.BroadwayRenderer
    ...
    class CairoNode extends RenderNode {
        // Constructors of Gsk-4.0.CairoNode

        static ['new'](bounds: Graphene.Rect): CairoNode;

        // Owm methods of Gsk-4.0.CairoNode
    ...
    class CairoRenderer extends Renderer {
        // Constructors of Gsk-4.0.CairoRenderer
    ...
    class ClipNode extends RenderNode {
        // Constructors of Gsk-4.0.ClipNode

        static ['new'](child: RenderNode, clip: Graphene.Rect): ClipNode;

        // Owm methods of Gsk-4.0.ClipNode
    ...
    class ColorNode extends RenderNode {
        // Constructors of Gsk-4.0.ColorNode

        static ['new'](rgba: Gdk.RGBA, bounds: Graphene.Rect): ColorNode;

        // Owm methods of Gsk-4.0.ColorNode
    ...
    class ConicGradientNode extends RenderNode {
        // Constructors of Gsk-4.0.ConicGradientNode
        ...
        // Owm methods of Gsk-4.0.ConicGradientNode
    ...
    class ContainerNode extends RenderNode {
        // Constructors of Gsk-4.0.ContainerNode

        static ['new'](children: RenderNode[]): ContainerNode;

        // Owm methods of Gsk-4.0.ContainerNode
    ...
    class CrossFadeNode extends RenderNode {
        // Constructors of Gsk-4.0.CrossFadeNode

        static ['new'](start: RenderNode, end: RenderNode, progress: number): CrossFadeNode;

        // Owm methods of Gsk-4.0.CrossFadeNode
    ...
    class DebugNode extends RenderNode {
        // Constructors of Gsk-4.0.DebugNode

        static ['new'](child: RenderNode, message: string): DebugNode;

        // Owm methods of Gsk-4.0.DebugNode
    ...
    class GLRenderer extends Renderer {
        // Constructors of Gsk-4.0.GLRenderer
    ...
    class GLShader extends GObject.Object {
        // Own properties of Gsk-4.0.GLShader
    ...
    class GLShaderNode extends RenderNode {
        // Constructors of Gsk-4.0.GLShaderNode
        ...
        // Owm methods of Gsk-4.0.GLShaderNode
    ...
    class InsetShadowNode extends RenderNode {
        // Constructors of Gsk-4.0.InsetShadowNode
        ...
        // Owm methods of Gsk-4.0.InsetShadowNode
    ...
    class LinearGradientNode extends RenderNode {
        // Constructors of Gsk-4.0.LinearGradientNode
        ...
        // Owm methods of Gsk-4.0.LinearGradientNode
    ...
    class NglRenderer extends Renderer {
        // Constructors of Gsk-4.0.NglRenderer
    ...
    class OpacityNode extends RenderNode {
        // Constructors of Gsk-4.0.OpacityNode

        static ['new'](child: RenderNode, opacity: number): OpacityNode;

        // Owm methods of Gsk-4.0.OpacityNode
    ...
    class OutsetShadowNode extends RenderNode {
        // Constructors of Gsk-4.0.OutsetShadowNode
        ...
        // Owm methods of Gsk-4.0.OutsetShadowNode
    ...
    class RadialGradientNode extends RenderNode {
        // Constructors of Gsk-4.0.RadialGradientNode
        ...
        // Owm methods of Gsk-4.0.RadialGradientNode
    ...
    abstract class RenderNode {
        // Owm methods of Gsk-4.0.RenderNode
    ...
    abstract class Renderer extends GObject.Object {
        // Own properties of Gsk-4.0.Renderer
        ...
        // Constructors of Gsk-4.0.Renderer

        static new_for_surface(surface: Gdk.Surface): Renderer;

        // Owm methods of Gsk-4.0.Renderer
    ...
    class RepeatingLinearGradientNode extends RenderNode {
        // Constructors of Gsk-4.0.RepeatingLinearGradientNode
    ...
    class RepeatingRadialGradientNode extends RenderNode {
        // Constructors of Gsk-4.0.RepeatingRadialGradientNode
    ...
    class RoundedClipNode extends RenderNode {
        // Constructors of Gsk-4.0.RoundedClipNode

        static ['new'](child: RenderNode, clip: RoundedRect): RoundedClipNode;

        // Owm methods of Gsk-4.0.RoundedClipNode
    ...
    class ShadowNode extends RenderNode {
        // Constructors of Gsk-4.0.ShadowNode

        static ['new'](child: RenderNode, shadows: Shadow[]): ShadowNode;

        // Owm methods of Gsk-4.0.ShadowNode
    ...
    class StrokeNode extends RenderNode {
        // Constructors of Gsk-4.0.StrokeNode

        static ['new'](child: RenderNode, path: Path, stroke: Stroke): StrokeNode;

        // Owm methods of Gsk-4.0.StrokeNode
    ...
    class SubsurfaceNode extends RenderNode {
        // Owm methods of Gsk-4.0.SubsurfaceNode
    ...
    class TextureNode extends RenderNode {
        // Constructors of Gsk-4.0.TextureNode

        static ['new'](texture: Gdk.Texture, bounds: Graphene.Rect): TextureNode;

        // Owm methods of Gsk-4.0.TextureNode
    ...
    class TransformNode extends RenderNode {
        // Constructors of Gsk-4.0.TransformNode

        static ['new'](child: RenderNode, transform: Transform): TransformNode;

        // Owm methods of Gsk-4.0.TransformNode
    ...
    class VulkanRenderer extends Renderer {
        // Constructors of Gsk-4.0.VulkanRenderer
     ...
     */
    class ColorStop {
        // Own fields of Gsk-4.0.ColorStop

        offset: number;
        color: Gdk.RGBA;

        // Constructors of Gsk-4.0.ColorStop
     ...
     */
    class ParseLocation {
        // Own fields of Gsk-4.0.ParseLocation
        ...
        // Constructors of Gsk-4.0.ParseLocation
    ...
    class Path {
         ...
         */
        get_closest_point(point: Graphene.Point, threshold: number): boolean;
        /**
         ...
         * @returns `TRUE` if the path has bounds, `FALSE` if the path is known   to be empty and have no bounds.
         */
        get_stroke_bounds(stroke: Stroke): boolean;
        /**
     ...
     */
    class PathBuilder {
        // Constructors of Gsk-4.0.PathBuilder

        constructor(properties?: Partial<{}>);

        static ['new'](): PathBuilder;

        // Owm methods of Gsk-4.0.PathBuilder
     ...
     */
    class PathMeasure {
        // Constructors of Gsk-4.0.PathMeasure
        ...
        // Owm methods of Gsk-4.0.PathMeasure
         ...
         */
        get_point(distance: number): boolean;
        /**
     ...
     */
    class PathPoint {
        // Owm methods of Gsk-4.0.PathPoint
         ...
         */
        get_curvature(path: Path, direction: PathDirection): number;
        /**
         ...
         */
        get_tangent(path: Path, direction: PathDirection): void;
    }
     ...
     */
    class RoundedRect {
        // Own fields of Gsk-4.0.RoundedRect

        bounds: Graphene.Rect;
        corner: Graphene.Size[];

        // Constructors of Gsk-4.0.RoundedRect
        ...
        // Owm methods of Gsk-4.0.RoundedRect
    ...
    class ShaderArgsBuilder {
        // Constructors of Gsk-4.0.ShaderArgsBuilder
        ...
        // Owm methods of Gsk-4.0.ShaderArgsBuilder
    ...
    class Shadow {
        ...
        // Constructors of Gsk-4.0.Shadow
     ...
     */
    class Transform {
        // Constructors of Gsk-4.0.Transform

        constructor(properties?: Partial<{}>);

        static ['new'](): Transform;

        // Owm methods of Gsk-4.0.Transform
         ...
         * @param string the string to parse
         */
        static parse(string: string): boolean;
         ...
         */
        transform_bounds(rect: Graphene.Rect): void;
        /**
         * Transforms a `graphene_point_t` using the given transform `self`.
         * @param point a `graphene_point_t`
         */
        transform_point(point: Graphene.Point): void;
        /**

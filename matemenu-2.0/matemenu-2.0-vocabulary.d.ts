/**
 * The GIR-derived widget VOCABULARY for MateMenu-2.0.
 *
 * GENERATED — do not edit. Provenance: MateMenu-2.0
 *
...
export interface MateMenuTreeProps extends GObjectProps {
    /**
     * Flags controlling the content of the menu.
     * @default MATEMENU_TREE_FLAGS_NONE
     */
    flags?: number;
    /**
     * The name of the menu file; must be a basename or a relative path.
     * @default applications.menu
     */
    'menu-basename'?: string;
    /**
     * The full path of the menu file.
     * @default NULL
     */
    'menu-path'?: string;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MateMenuTreeConstructOnly = GObjectConstructOnly | 'flags' | 'menu-basename' | 'menu-path';

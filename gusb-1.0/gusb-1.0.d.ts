...
_init(...args: any[]): void;
     ...
     * @returns %TRUE on success
     */
    bulk_transfer(endpoint: number, data: Uint8Array, timeout: number, cancellable?: (Gio.Cancellable | null)): [boolean, number]
    /**
     ...
     * @returns %TRUE on success
     */
    control_transfer(direction: DeviceDirection, request_type: DeviceRequestType, recipient: DeviceRecipient, request: number, value: number, idx: number, data: Uint8Array, timeout: number, cancellable?: (Gio.Cancellable | null)): [boolean, number]
    /**
     ...
     * @returns %TRUE on success
     */
    interrupt_transfer(endpoint: number, data: Uint8Array, timeout: number, cancellable?: (Gio.Cancellable | null)): [boolean, number]
    /**

...
module Terminal {
     ...
     */
    interface TextDeletedSignalCallback {
        (): void
    }
     ...
     */
    interface TextInsertedSignalCallback {
        (): void
    }
     ...
     */
    interface TextModifiedSignalCallback {
        (): void
    }
     ...
     */
    interface TextScrolledSignalCallback {
        (delta: number): void
    }
...
interface Terminal extends Atk.ImplementorIface, Gtk.Buildable, Gtk.Scrollable {
     ...
     */
    feed(data: number[] | null): void
    /**
     * Sends a block of UTF-8 text to the child as if it were entered by the user
     * at the keyboard.
     * @param text data to send to the child
     */
    feedChild(text: number[] | null): void
    /**
     * Sends a block of binary data to the child.
     * @param data data to send to the child
     */
    feedChildBinary(data: number[] | null): void
    /**

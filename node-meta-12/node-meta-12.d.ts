 ...
 */
function acceleratorName(acceleratorMods: Clutter.ModifierType, acceleratorKey: number): string | null
function addClutterDebugFlags(debugFlags: Clutter.DebugFlag, drawFlags: Clutter.DrawDebugFlag, pickFlags: Clutter.PickDebugFlag): void
function addDebugPaintFlag(flag: DebugPaintFlag): void
/**
 * Ensure log messages for the given topic `topic`
 * will be printed.
 * @param topic Topic for which logging will be started
 */
function addVerboseTopic(topic: DebugTopic): void
function clutterInit(): void
/**
 * Create a context.
 * @param name Human readable name of display server or window manager
 * @returns A new context instance.
 */
function createContext(name: string | null): Context
/**
 ...
 */
function disableUnredirectForDisplay(display: Display): void
/**
 * Enables unredirection which reduces the overhead for apps like games.
 * @param display a #MetaDisplay
 */
function enableUnredirectForDisplay(display: Display): void
function exit(code: ExitCode): void
function externalBindingNameForAction(keybindingAction: number): string | null
function focusStageWindow(display: Display, timestamp: number): void
/**
 ...
 */
function frameTypeToString(type: FrameType): string | null
function gUtf8Strndup(src: string | null, n: number): string | null
function getClutterDebugFlags(): [ /* debugFlags */ Clutter.DebugFlag, /* drawFlags */ Clutter.DrawDebugFlag, /* pickFlags */ Clutter.PickDebugFlag ]
function getDebugPaintFlags(): DebugPaintFlag
function getFeedbackGroupForDisplay(display: Display): Clutter.Actor
function getLocaleDirection(): LocaleDirection
function getStageForDisplay(display: Display): Clutter.Actor
function getTopWindowGroupForDisplay(display: Display): Clutter.Actor
function getWindowActors(display: Display): Clutter.Actor[]
function getWindowGroupForDisplay(display: Display): Clutter.Actor
function gravityToString(gravity: Gravity): string | null
/**
 ...
 */
function isRestart(): boolean
function isTopicEnabled(topic: DebugTopic): boolean
 ...
 */
function keybindingsSetCustomHandler(name: string | null, handler: KeyHandlerFunc | null): boolean
function popNoMsgPrefix(): void
function preferenceToString(pref: Preference): string | null
function prefsBellIsAudible(): boolean
function prefsChangeWorkspaceName(i: number, name: string | null): void
function prefsGetActionDoubleClickTitlebar(): GDesktopEnums.TitlebarAction
function prefsGetActionMiddleClickTitlebar(): GDesktopEnums.TitlebarAction
function prefsGetActionRightClickTitlebar(): GDesktopEnums.TitlebarAction
function prefsGetAttachModalDialogs(): boolean
function prefsGetAutoMaximize(): boolean
function prefsGetAutoRaise(): boolean
function prefsGetAutoRaiseDelay(): number
function prefsGetButtonLayout(): /* buttonLayout */ ButtonLayout
function prefsGetCenterNewWindows(): boolean
function prefsGetCheckAliveTimeout(): number
function prefsGetCompositingManager(): boolean
function prefsGetCursorSize(): number
function prefsGetCursorTheme(): string | null
function prefsGetDisableWorkarounds(): boolean
function prefsGetDragThreshold(): number
function prefsGetDraggableBorderWidth(): number
function prefsGetDynamicWorkspaces(): boolean
function prefsGetEdgeTiling(): boolean
function prefsGetFocusChangeOnPointerRest(): boolean
function prefsGetFocusMode(): GDesktopEnums.FocusMode
function prefsGetFocusNewWindows(): GDesktopEnums.FocusNewWindows
function prefsGetForceFullscreen(): boolean
function prefsGetGnomeAccessibility(): boolean
function prefsGetGnomeAnimations(): boolean
function prefsGetKeybindingAction(name: string | null): KeyBindingAction
function prefsGetKeybindingLabel(name: string | null): string | null
function prefsGetMouseButtonMenu(): number
function prefsGetMouseButtonMods(): Clutter.ModifierType
function prefsGetMouseButtonResize(): number
function prefsGetNumWorkspaces(): number
function prefsGetRaiseOnClick(): boolean
function prefsGetShowFallbackAppMenu(): boolean
function prefsGetTitlebarFont(): Pango.FontDescription
function prefsGetVisualBell(): boolean
function prefsGetVisualBellType(): GDesktopEnums.VisualBellType
function prefsGetWorkspaceName(i: number): string | null
function prefsGetWorkspacesOnlyOnPrimary(): boolean
function prefsSetForceFullscreen(whether: boolean): void
function prefsSetNumWorkspaces(nWorkspaces: number): void
function prefsSetShowFallbackAppMenu(whether: boolean): void
function pushNoMsgPrefix(): void
function rect(x: number, y: number, width: number, height: number): Rectangle
function removeClutterDebugFlags(debugFlags: Clutter.DebugFlag, drawFlags: Clutter.DrawDebugFlag, pickFlags: Clutter.PickDebugFlag): void
function removeDebugPaintFlag(flag: DebugPaintFlag): void
/**
 ...
 */
function removeVerboseTopic(topic: DebugTopic): void
/**
...
function topicToString(topic: DebugTopic): string | null
function unsignedLongEqual(v1: any | null, v2: any | null): number
function unsignedLongHash(v: any | null): number
function x11ErrorTrapPop(x11Display: X11Display): void
function x11ErrorTrapPopWithReturn(x11Display: X11Display): number
function x11ErrorTrapPush(x11Display: X11Display): void

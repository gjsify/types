/**
 * The GIR-derived widget VOCABULARY for PangoFT2-1.0.
 *
 * GENERATED — do not edit. Provenance: PangoFT2-1.0 — dropped empty base(s): PangoFc.FontMap Pango.FontMap
 *
...
export interface PangoFT2FontMapProps extends GListModelProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type PangoFT2FontMapConstructOnly = GListModelConstructOnly;

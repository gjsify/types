...
export interface GtdBinLayoutProps extends GtkLayoutManagerProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GtdBinLayoutConstructOnly = GtkLayoutManagerConstructOnly;

export interface GtdClockProps extends GtdObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GtdManagerConstructOnly = GtdObjectConstructOnly;

export interface GtdMaxSizeLayoutProps extends GtkLayoutManagerProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GtdMaxSizeLayoutConstructOnly = GtkLayoutManagerConstructOnly;
...
export interface GtdNotificationProps extends GtdObjectProps {
    'secondary-action-name'?: string;
    text?: string;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
...
export interface GtdTaskProps extends GtdObjectProps {
    /** @default FALSE */
    complete?: boolean;
    'creation-date'?: GLib.DateTime;
    /** @default NULL */
    description?: string;
    'due-date'?: GLib.DateTime | null;
    /** @default FALSE */
    important?: boolean;
    list?: Gtd.TaskList;
    /** @default 0 */

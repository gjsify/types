...
static ["new"](): MockBackend;
     ...
     */
    add_forward_result(params: GLib.HashTable<string, GObject.Value>, results?: (Place[] | null), error?: (GLib.Error | null)): void
    /**
     * Add a query and corresponding result (or error) to the mock backend, meaning
     ...
     */
    add_reverse_result(params: GLib.HashTable<string, GObject.Value>, results?: (Place[] | null), error?: (GLib.Error | null)): void
    /**
 ...
 * @param callback a #GAsyncReadyCallback to call when the request is satisfied
 */
forward_search_async(params: GLib.HashTable<string, GObject.Value>, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<this> | null)): void
/**
 ...
 * @param callback a #GAsyncReadyCallback to call when the request is satisfied.
 */
reverse_resolve_async(params: GLib.HashTable<string, GObject.Value>, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<this> | null)): void
/**

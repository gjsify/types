...
export const PROP_TYPES = {
    'GtefActionInfoStore.application': 'GtkApplication',
    'GtefApplication.application': 'GtkApplication',
    'GtefApplicationWindow.application-window': 'GtkApplicationWindow',
    'GtefApplicationWindow.statusbar': 'GtkStatusbar',
    'GtefBuffer.gtef-style-scheme-id': 'gchararray',
    'GtefFile.location': 'GFile',
    'GtefFileLoader.buffer': 'GtefBuffer',
    'GtefFileLoader.chunk-size': 'gint64',
    'GtefFileLoader.file': 'GtefFile',
    'GtefFileLoader.location': 'GFile',
    'GtefFileLoader.max-size': 'gint64',
    'GtefFileMetadata.file': 'GtefFile',
    'GtefFileSaver.buffer': 'GtkSourceBuffer',
    'GtefFileSaver.compression-type': 'GtkSourceCompressionType',
    'GtefFileSaver.file': 'GtefFile',
    'GtefFileSaver.flags': 'GtefFileSaverFlags',
    'GtefFileSaver.location': 'GFile',
    'GtefFileSaver.newline-type': 'GtkSourceNewlineType',
    'GtefFoldRegion.buffer': 'GtkTextBuffer',
    'GtefFoldRegion.folded': 'gboolean',
    'GtefMenuShell.menu-shell': 'GtkMenuShell',
};

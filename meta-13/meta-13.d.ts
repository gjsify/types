...
_init(...args: any[]): void;
    ...
    connect(signal: 'show-resize-popup', callback: ((_source: this, object: boolean, p0: Mtk.Rectangle, p1: number, p2: number) => boolean)): number
    connect_after(signal: 'show-resize-popup', callback: ((_source: this, object: boolean, p0: Mtk.Rectangle, p1: number, p2: number) => boolean)): number
...
_init(...args: any[]): void;
    ...
    connect(signal: 'power-save-mode-changed', callback: ((_source: this, object: PowerSaveChangeReason) => void)): number
    connect_after(signal: 'power-save-mode-changed', callback: ((_source: this, object: PowerSaveChangeReason) => void)): number

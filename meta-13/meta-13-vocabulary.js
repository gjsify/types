// The widget vocabulary of Meta-13 as runtime data.
//
// GENERATED — do not edit. Provenance: Meta-13 — dropped empty base(s): Atk.ImplementorIface
//
...
export const PROVENANCE = {
    ...
    requiredVocabularies: ['@girs/clutter-13/vocabulary', '@girs/gio-2.0/vocabulary', '@girs/gobject-2.0/vocabulary'],
};
...
export const OWN_PROPS = {
    ...
    MetaBarrier: ['backend', 'directions', 'display', 'flags', 'x1', 'x2', 'y1', 'y2'],

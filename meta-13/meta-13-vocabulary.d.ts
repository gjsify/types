/**
 * The GIR-derived widget VOCABULARY for Meta-13.
 *
 * GENERATED — do not edit. Provenance: Meta-13 — dropped empty base(s): Atk.ImplementorIface
 *
 * 33 instantiable GTypes (of which 0 concrete widgets), 33 declarations, 33 enum nick unions, 0 slot candidates.
 *
...
export type MetaMultiTextureFormatNick = 'invalid' | 'simple' | 'yuyv' | 'nv12' | 'p010' | 'yuv420';
export type MetaPadDirectionNick = 'up' | 'down' | 'cw' | 'ccw';
export type MetaPadFeatureTypeNick = 'ring' | 'strip';
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MetaBarrierConstructOnly = GObjectConstructOnly | GInitableConstructOnly | 'backend' | 'directions' | 'display' | 'flags' | 'x1' | 'x2' | 'y1' | 'y2';

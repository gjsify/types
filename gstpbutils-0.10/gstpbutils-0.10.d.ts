...
function gst_install_plugins_return_get_name(ret: GstInstallPluginsReturn): string | null
...
function gst_missing_decoder_installer_detail_new(decode_caps: Gst.Caps): string | null
function gst_missing_decoder_message_new(element: Gst.Element, decode_caps: Gst.Caps): Gst.Message
function gst_missing_element_installer_detail_new(factory_name: string | null): string | null
function gst_missing_element_message_new(element: Gst.Element, factory_name: string | null): Gst.Message
function gst_missing_encoder_installer_detail_new(encode_caps: Gst.Caps): string | null
function gst_missing_encoder_message_new(element: Gst.Element, encode_caps: Gst.Caps): Gst.Message
function gst_missing_plugin_message_get_description(msg: Gst.Message): string | null
function gst_missing_plugin_message_get_installer_detail(msg: Gst.Message): string | null
function gst_missing_uri_sink_installer_detail_new(protocol: string | null): string | null
function gst_missing_uri_sink_message_new(element: Gst.Element, protocol: string | null): Gst.Message
function gst_missing_uri_source_installer_detail_new(protocol: string | null): string | null
function gst_missing_uri_source_message_new(element: Gst.Element, protocol: string | null): Gst.Message
function gst_pb_utils_add_codec_description_to_tag_list(taglist: Gst.TagList, codec_tag: string | null, caps: Gst.Caps): boolean
function gst_pb_utils_get_codec_description(caps: Gst.Caps): string | null
function gst_pb_utils_get_decoder_description(caps: Gst.Caps): string | null
function gst_pb_utils_get_element_description(factory_name: string | null): string | null
function gst_pb_utils_get_encoder_description(caps: Gst.Caps): string | null
function gst_pb_utils_get_sink_description(protocol: string | null): string | null
function gst_pb_utils_get_source_description(protocol: string | null): string | null

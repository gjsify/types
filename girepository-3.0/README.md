...
GJS TypeScript type definitions for GIRepository-3.0, generated from library version 3.0.0 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v4.0.0-beta.1.
...
```ts
const GIRepository = require('@girs/girepository-3.0');
```

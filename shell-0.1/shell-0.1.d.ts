...
export namespace Shell {
    ...
    class App extends GObject.Object {
        // Own properties of Shell-0.1.App
    ...
    class AppSystem extends GObject.Object {
        // Owm methods of Shell-0.1.AppSystem
    ...
    class AppUsage extends GObject.Object {
        // Owm methods of Shell-0.1.AppUsage
    ...
    class BlurEffect extends Clutter.Effect {
        // Own properties of Shell-0.1.BlurEffect

        brightness: number;
        mode: BlurMode;
        sigma: number;

        // Constructors of Shell-0.1.BlurEffect

        static ['new'](): BlurEffect;

        // Owm methods of Shell-0.1.BlurEffect
    ...
    class EmbeddedWindow extends Gtk.Window {
        // Constructors of Shell-0.1.EmbeddedWindow
    ...
    class GLSLEffect extends Clutter.OffscreenEffect {
        // Owm methods of Shell-0.1.GLSLEffect
    ...
    class Global extends GObject.Object {
        // Own properties of Shell-0.1.Global
        ...
        // Owm methods of Shell-0.1.Global
    ...
    class GtkEmbed<A extends Clutter.Actor = Clutter.Actor> extends Clutter.Clone<A> {
        // Own properties of Shell-0.1.GtkEmbed

        window: EmbeddedWindow;

        // Constructors of Shell-0.1.GtkEmbed
    ...
    class InvertLightnessEffect extends Clutter.OffscreenEffect {
        // Constructors of Shell-0.1.InvertLightnessEffect
    ...
    class KeyringPrompt extends GObject.Object {
        // Own properties of Shell-0.1.KeyringPrompt
        ...
        // Constructors of Shell-0.1.KeyringPrompt

        static ['new'](): KeyringPrompt;

        // Owm methods of Shell-0.1.KeyringPrompt
    ...
    class MountOperation extends Gio.MountOperation {
        // Constructors of Shell-0.1.MountOperation

        static ['new'](): MountOperation;

        // Owm methods of Shell-0.1.MountOperation
    ...
    class NetworkAgent extends NM.SecretAgentOld {
        // Owm methods of Shell-0.1.NetworkAgent
    ...
    class PerfLog extends GObject.Object {
        // Owm methods of Shell-0.1.PerfLog
    ...
    class PolkitAuthenticationAgent extends PolkitAgent.Listener {
        // Constructors of Shell-0.1.PolkitAuthenticationAgent

        static ['new'](): PolkitAuthenticationAgent;

        // Owm methods of Shell-0.1.PolkitAuthenticationAgent
    ...
    class Screenshot extends GObject.Object {
        // Constructors of Shell-0.1.Screenshot

        static ['new'](): Screenshot;

        // Owm methods of Shell-0.1.Screenshot
    ...
    class SecureTextBuffer extends Clutter.TextBuffer {
        // Constructors of Shell-0.1.SecureTextBuffer
    ...
    class SquareBin<A extends Clutter.Actor = Clutter.Actor> extends St.Bin<A> {}

    module Stack {
        // Constructor properties interface
    }

    class Stack<A extends Clutter.Actor = Clutter.Actor> extends St.Widget {}

    module TrayIcon {
        // Constructor properties interface
    }

    class TrayIcon<A extends Clutter.Actor = Clutter.Actor> extends GtkEmbed<A> {
        // Own properties of Shell-0.1.TrayIcon
        ...
        // Constructors of Shell-0.1.TrayIcon

        static ['new'](window: EmbeddedWindow): TrayIcon;

        // Owm methods of Shell-0.1.TrayIcon
    ...
    class TrayManager extends GObject.Object {
        // Own properties of Shell-0.1.TrayManager

        bg_color: Clutter.Color;
        bgColor: Clutter.Color;

        // Constructors of Shell-0.1.TrayManager

        static ['new'](): TrayManager;

        // Owm methods of Shell-0.1.TrayManager
    ...
    class WM extends GObject.Object {
        // Constructors of Shell-0.1.WM

        static ['new'](plugin: Meta.Plugin): WM;

        // Owm methods of Shell-0.1.WM
    ...
    class WindowPreview<A extends Clutter.Actor = Clutter.Actor> extends St.Widget {
        // Own properties of Shell-0.1.WindowPreview
    ...
    class WindowPreviewLayout extends Clutter.LayoutManager {
        // Own properties of Shell-0.1.WindowPreviewLayout

        readonly bounding_box: Clutter.ActorBox;
        readonly boundingBox: Clutter.ActorBox;

        // Owm methods of Shell-0.1.WindowPreviewLayout
    ...
    class WindowTracker extends GObject.Object {
        // Own properties of Shell-0.1.WindowTracker

        readonly focus_app: App;
        readonly focusApp: App;

        // Owm methods of Shell-0.1.WindowTracker
    ...
    class WorkspaceBackground<A extends Clutter.Actor = Clutter.Actor> extends St.Widget {
        // Own properties of Shell-0.1.WorkspaceBackground
    ...
    class GLSLEffectClass {
        // Own fields of Shell-0.1.GLSLEffectClass
    ...
    class MemoryInfo {
        // Own fields of Shell-0.1.MemoryInfo
        ...
        // Constructors of Shell-0.1.MemoryInfo

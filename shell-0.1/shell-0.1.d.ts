...
class GtkEmbed<A extends Clutter.Actor = Clutter.Actor> extends Clutter.Clone<A> implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container<A>, Clutter.Scriptable {
    ...
    // Constructors of Shell.GtkEmbed
...
static ["new"](plugin: Meta.Plugin): WM;
    ...
    connect_after(signal: 'create-close-dialog', callback: ((_source: this, window: Meta.Window) => Meta.CloseDialog)): number
    emit(signal: 'create-close-dialog', window: Meta.Window): void
    connect(signal: 'create-inhibit-shortcuts-dialog', callback: ((_source: this, window: Meta.Window) => Meta.InhibitShortcutsDialog)): number
    connect_after(signal: 'create-inhibit-shortcuts-dialog', callback: ((_source: this, window: Meta.Window) => Meta.InhibitShortcutsDialog)): number
    ...
    connect(signal: 'show-tile-preview', callback: ((_source: this, object: Meta.Window, p0: Meta.Rectangle, p1: number) => void)): number
    connect_after(signal: 'show-tile-preview', callback: ((_source: this, object: Meta.Window, p0: Meta.Rectangle, p1: number) => void)): number
    emit(signal: 'show-tile-preview', object: Meta.Window, p0: Meta.Rectangle, p1: number): void
    connect(signal: 'show-window-menu', callback: ((_source: this, object: Meta.Window, p0: number, p1: Meta.Rectangle) => void)): number
    connect_after(signal: 'show-window-menu', callback: ((_source: this, object: Meta.Window, p0: number, p1: Meta.Rectangle) => void)): number
    emit(signal: 'show-window-menu', object: Meta.Window, p0: number, p1: Meta.Rectangle): void
    connect(signal: 'size-change', callback: ((_source: this, object: Meta.WindowActor, p0: Meta.SizeChange, p1: Meta.Rectangle, p2: Meta.Rectangle) => void)): number
    connect_after(signal: 'size-change', callback: ((_source: this, object: Meta.WindowActor, p0: Meta.SizeChange, p1: Meta.Rectangle, p2: Meta.Rectangle) => void)): number
    emit(signal: 'size-change', object: Meta.WindowActor, p0: Meta.SizeChange, p1: Meta.Rectangle, p2: Meta.Rectangle): void
...
_init(...args: any[]): void;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'startup-sequence-changed', callback: ((_source: this, object: Meta.StartupSequence) => void)): number
    connect_after(signal: 'startup-sequence-changed', callback: ((_source: this, object: Meta.StartupSequence) => void)): number

...
export namespace Shell {
    ...
    class EmbeddedWindow extends Gtk.Window implements Atk.ImplementorIface, Gtk.Buildable {
        ...
        /** @signal */
        emit<K extends keyof EmbeddedWindow.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<EmbeddedWindow.SignalSignatures[K]>): void;
    }
    ...
    class GtkEmbed<A extends Clutter.Actor = Clutter.Actor> extends Clutter.Clone<A> implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container<A>, Clutter.Scriptable {
        ...
        /** @signal */
        emit<K extends keyof GtkEmbed.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<GtkEmbed.SignalSignatures[K]>): void;

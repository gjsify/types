...
export namespace Shell {
    ...
    class EmbeddedWindow extends Gtk.Window implements Atk.ImplementorIface, Gtk.Buildable {
         ...
         * @internal
         */
        $signals: EmbeddedWindow.SignalSignatures;
        ...
        // Signals
        /** @signal */
        connect<K extends keyof EmbeddedWindow.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, EmbeddedWindow.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof EmbeddedWindow.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, EmbeddedWindow.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof EmbeddedWindow.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<EmbeddedWindow.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
    }
    ...
    namespace Global {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
            ...
            "notify::debug-flags": (pspec: GObject.ParamSpec) => void;
    ...
    class Global extends GObject.Object {
        ...
        get debug_flags(): string;
        set debug_flags(val: string);

        get debugFlags(): string;
        set debugFlags(val: string);
         ...
         * @param rectangles a list of {@link Meta.Rectangle} describing the input region.
         */
    ...
    namespace GtkEmbed {
        ...
        // Constructor properties interface
        interface ConstructorProps<A extends Clutter.Actor = Clutter.Actor> extends Clutter.Clone.ConstructorProps<A>, Atk.ImplementorIface.ConstructorProps, Clutter.Animatable.ConstructorProps, Clutter.Container.ConstructorProps, Clutter.Scriptable.ConstructorProps {
     ...
     * @gir-type Class
     */
    class GtkEmbed<A extends Clutter.Actor = Clutter.Actor> extends Clutter.Clone<A> implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container<A>, Clutter.Scriptable {
         ...
         * @internal
         */
        $signals: GtkEmbed.SignalSignatures;

        // Constructors
        constructor(properties?: Partial<GtkEmbed.ConstructorProps>, ...args: any[]);
        ...
        // Signals
        /** @signal */
        connect<K extends keyof GtkEmbed.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, GtkEmbed.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof GtkEmbed.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, GtkEmbed.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof GtkEmbed.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<GtkEmbed.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
    ...
    namespace Screenshot {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
             ...
             * @run-last
             */
            "screenshot-taken": (object: Meta.Rectangle) => void;
        }
    ...
    class Screenshot extends GObject.Object {
         ...
         * @param callback function to call returning success or failure of the async grabbing
         */
        screenshot(include_cursor: boolean, stream: Gio.OutputStream, callback?: Gio.AsyncReadyCallback<this> | null): globalThis.Promise<cairo.RectangleInt> | void;
         ...
         * @param stream The stream for the screenshot
         */
        screenshot_area(x: number, y: number, width: number, height: number, stream: Gio.OutputStream): globalThis.Promise<cairo.RectangleInt>;
         ...
         * @param callback function to call returning success or failure of the async grabbing
         */
        screenshot_area(x: number, y: number, width: number, height: number, stream: Gio.OutputStream, callback?: Gio.AsyncReadyCallback<this> | null): globalThis.Promise<cairo.RectangleInt> | void;
         ...
         * @param stream The stream for the screenshot
         */
        screenshot_window(include_frame: boolean, include_cursor: boolean, stream: Gio.OutputStream): globalThis.Promise<cairo.RectangleInt>;
         ...
         * @param callback function to call returning success or failure of the async grabbing
         */
        screenshot_window(include_frame: boolean, include_cursor: boolean, stream: Gio.OutputStream, callback?: Gio.AsyncReadyCallback<this> | null): globalThis.Promise<cairo.RectangleInt> | void;
    ...
    namespace TrayIcon {
        ...
        // Constructor properties interface
        interface ConstructorProps<A extends Clutter.Actor = Clutter.Actor> extends GtkEmbed.ConstructorProps<A>, Atk.ImplementorIface.ConstructorProps, Clutter.Animatable.ConstructorProps, Clutter.Container.ConstructorProps, Clutter.Scriptable.ConstructorProps {
            pid: number;
            title: string;
            wm_class: string;
            wmClass: string;
     ...
     * @gir-type Class
     */
    class TrayIcon<A extends Clutter.Actor = Clutter.Actor> extends GtkEmbed<A> implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container<A>, Clutter.Scriptable {
    ...
    namespace WM {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
             ...
             * @run-last
             */
            "show-tile-preview": (object: Meta.Window, p0: Meta.Rectangle, p1: number) => void;
            /**
             * @signal
             * @run-last
             */
            "show-window-menu": (object: Meta.Window, p0: number, p1: Meta.Rectangle) => void;
            /**
             * @signal
             * @run-last
             */
            "size-change": (object: Meta.WindowActor, p0: Meta.SizeChange, p1: Meta.Rectangle, p2: Meta.Rectangle) => void;
            /**
             * @signal
             * @run-last
             */
     ...
     * @gir-type Alias
     */
    type EmbeddedWindowClass = typeof EmbeddedWindow;
     ...
     * @gir-type Alias
     */
    type GtkEmbedClass = typeof GtkEmbed;

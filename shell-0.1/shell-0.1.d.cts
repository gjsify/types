...
export interface EmbeddedWindow extends Atk.ImplementorIface, Gtk.Buildable {
...
export class EmbeddedWindow extends Gtk.Window {
...
export interface GtkEmbed extends Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
...
export class GtkEmbed extends Clutter.Clone {
...
export module TrayIcon {
    ...
    export interface ConstructorProperties extends Atk.ImplementorIface.ConstructorProperties, Clutter.Animatable.ConstructorProperties, Clutter.Container.ConstructorProperties, Clutter.Scriptable.ConstructorProperties, GtkEmbed.ConstructorProperties {
    }
...
export class TrayIcon extends GtkEmbed {
...
export interface EmbeddedWindowClass {
...
export interface GtkEmbedClass {

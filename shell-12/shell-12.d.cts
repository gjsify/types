...
export const KEYRING_SK_TAG: string | null
export const KEYRING_SN_TAG: string | null
export const KEYRING_UUID_TAG: string | null
/**
 ...
 */
export function get_file_contents_utf8_sync(path: string | null): string | null
/**
 ...
 */
export function util_get_translated_folder_name(name: string | null): string | null
/**
 ...
 */
export function util_has_x11_display_extension(display: Meta.Display, extension: string | null): boolean
/**
 ...
 */
export function util_regex_escape(str: string | null): string | null
...
export function util_start_systemd_unit<Z = unknown>(unit: string | null, mode: string | null, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback<Z> | null): void
export function util_start_systemd_unit_finish(res: Gio.AsyncResult): boolean
export function util_stop_systemd_unit<Z = unknown>(unit: string | null, mode: string | null, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback<Z> | null): void
 ...
 */
export function util_translate_time_string(str: string | null): string | null
/**
 ...
 */
export function write_string_to_stream(stream: Gio.OutputStream, str: string | null): boolean

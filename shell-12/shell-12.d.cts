 ...
 */
export function get_file_contents_utf8_sync(path: string): string | null
/**
 ...
 */
export function util_regex_escape(str: string): string | null
...
export function util_start_systemd_unit<Z = unknown>(unit: string, mode: string, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback<Z> | null): void
export function util_start_systemd_unit_finish(res: Gio.AsyncResult): boolean
export function util_stop_systemd_unit<Z = unknown>(unit: string, mode: string, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback<Z> | null): void
export function util_stop_systemd_unit_finish(res: Gio.AsyncResult): boolean
export function util_systemd_unit_exists<Z = unknown>(unit: string, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback<Z> | null): void

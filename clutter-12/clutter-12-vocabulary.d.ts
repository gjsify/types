/**
 * The GIR-derived widget VOCABULARY for Clutter-12.
 *
 * GENERATED — do not edit. Provenance: Clutter-12 — dropped empty base(s): Atk.ImplementorIface
 *
...
import type Clutter from './clutter-12.js';

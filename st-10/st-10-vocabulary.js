// The widget vocabulary of St-10 as runtime data.
//
...
export const PROVENANCE = {
    ...
    requiredVocabularies: ['@girs/atk-1.0/vocabulary', '@girs/cally-10/vocabulary', '@girs/clutter-10/vocabulary', '@girs/gio-2.0/vocabulary', '@girs/gobject-2.0/vocabulary'],
};
...
export const OWN_PROPS = {
    ...
    StButton: ['button-mask', 'checked', 'label', 'toggle-mode'],
    ...
    StScrollView: ['content-padding', 'enable-mouse-scrolling', 'hscrollbar-policy', 'overlay-scrollbars', 'vscrollbar-policy'],

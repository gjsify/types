...
// Module dependencies
import type Meta from '@girs/meta-10';
...
import type Cally from '@girs/cally-10';
...
export namespace St {
    ...
    class Adjustment extends GObject.Object implements Clutter.Animatable {
         ...
         * {@link St.Adjustment.SignalSignatures.changed | St.Adjustment::changed} signals. See `st_adjustment_set_lower()` for an
         * alternative way of compressing multiple emissions of {@link GObject.Object.SignalSignatures.notify | GObject.Object::notify} into
         * one.
         * @param value the new value
    ...
    namespace Bin {
        ...
        // Constructor properties interface
        interface ConstructorProps extends Widget.ConstructorProps, Atk.ImplementorIface.ConstructorProps, Clutter.Animatable.ConstructorProps, Clutter.Container.ConstructorProps, Clutter.Scriptable.ConstructorProps {
     ...
     * @gir-type Class
     */
    class Bin extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
    ...
    namespace BoxLayout {
        ...
        // Constructor properties interface
        interface ConstructorProps extends Viewport.ConstructorProps, Atk.ImplementorIface.ConstructorProps, Clutter.Animatable.ConstructorProps, Clutter.Container.ConstructorProps, Clutter.Scriptable.ConstructorProps, Scrollable.ConstructorProps {
            pack_start: boolean;
            packStart: boolean;
            vertical: boolean;
        }
     ...
     * @gir-type Class
     */
    class BoxLayout extends Viewport implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Scrollable {
    ...
    namespace Button {
        ...
        // Constructor properties interface
        interface ConstructorProps extends Bin.ConstructorProps, Atk.ImplementorIface.ConstructorProps, Clutter.Animatable.ConstructorProps, Clutter.Container.ConstructorProps, Clutter.Scriptable.ConstructorProps {
     ...
     * @gir-type Class
     */
    class Button extends Bin implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
     ...
     * @gir-type Class
     */
    class DrawingArea extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
         ...
         * from a signal handler or virtual function for the {@link St.DrawingArea.SignalSignatures.repaint | St.DrawingArea::repaint}
         * signal.
         * 
        ...
        /**
         * Will cause the actor to emit a {@link St.DrawingArea.SignalSignatures.repaint | St.DrawingArea::repaint} signal before it is
     ...
     * @gir-type Class
     */
    class Entry extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
    ...
    /**
     * The {@link St.FocusManager} struct contains only private data
     * @gir-type Class
     */
     ...
     * @gir-type Class
     */
    class Icon extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
    ...
    namespace ImageContent {
        ...
        // Constructor properties interface
        interface ConstructorProps extends Clutter.Image.ConstructorProps, Clutter.Content.ConstructorProps, Gio.Icon.ConstructorProps, Gio.LoadableIcon.ConstructorProps {
     ...
     * @gir-type Class
     */
    class Label extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
    ...
    namespace PasswordEntry {
        ...
        // Constructor properties interface
        interface ConstructorProps extends Entry.ConstructorProps, Atk.ImplementorIface.ConstructorProps, Clutter.Animatable.ConstructorProps, Clutter.Container.ConstructorProps, Clutter.Scriptable.ConstructorProps {
     ...
     * @gir-type Class
     */
    class PasswordEntry extends Entry implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
     ...
     * @gir-type Class
     */
    class ScrollBar extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
     ...
     * @gir-type Class
     */
    class ScrollView extends Bin implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
    ...
    class TextureCache extends GObject.Object {
        ...
        // Methods
        /**
         * Create a {@link Gio.Icon} which tracks the {@link cairo.Surface} value of a GObject property
         * named by `property_name`.  Unlike other methods in StTextureCache, the underlying
         * {@link Cogl.Texture} is not shared by default with other invocations to this method.
         * 
         * If the source object is destroyed, the texture will continue to show the last
         * value of the property.
         * @param object A {@link GObject.Object} with a property `property_name` of type {@link cairo.Surface}
    ...
    namespace Viewport {
        ...
        // Constructor properties interface
        interface ConstructorProps extends Widget.ConstructorProps, Atk.ImplementorIface.ConstructorProps, Clutter.Animatable.ConstructorProps, Clutter.Container.ConstructorProps, Clutter.Scriptable.ConstructorProps, Scrollable.ConstructorProps {
     ...
     * @gir-type Class
     */
    class Viewport extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Scrollable {
     ...
     * @gir-type Class
     */
    class Widget extends Clutter.Actor implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
        ...
        /**
         * Gets the {@link Atk.Role} for this widget. See
         * `st_widget_set_accessible_role()` for more information.
         * @returns accessible {@link Atk.Role} for this widget
         */
         ...
         * {@link St.WidgetAccessible} at the javascript code.
         * 
         ...
         * @param accessible an accessible ({@link Atk.Object})
         */
         ...
         * object (ie: a {@link St.Button} has by default a push button role). This
         ...
         * used in an unusual way (ie: a {@link St.Button} used as a togglebutton), or
    ...
    class ShadowHelper {
         ...
         * @param framebuffer a {@link Cogl.Framebuffer}

...
import './gstrtp-1.0-ambient.d.ts';
import './gstrtp-1.0-import.d.ts';
/**
 * GstRtp-1.0
 */
...
export namespace GstRtp {
     ...
     */
    function rtp_buffer_ext_timestamp(exttimestamp: number, timestamp: number): number;
    /**
     ...
     */
    function rtp_buffer_map(buffer: Gst.Buffer, flags: Gst.MapFlags): boolean;
    /**
     ...
     */
    function rtp_hdrext_get_ntp_56(data: Uint8Array): boolean;
    /**
     ...
     * @returns %TRUE on success.
     */
    function rtp_hdrext_get_ntp_64(data: Uint8Array): boolean;
    /**
    ...
    class RTPBaseAudioPayload extends RTPBasePayload {
        // Own properties of GstRtp-1.0.RTPBaseAudioPayload

        buffer_list: boolean;
        bufferList: boolean;

        // Own fields of GstRtp-1.0.RTPBaseAudioPayload
        ...
        // Owm methods of GstRtp-1.0.RTPBaseAudioPayload
    ...
    abstract class RTPBaseDepayload extends Gst.Element {
        // Own properties of GstRtp-1.0.RTPBaseDepayload
        ...
        // Own fields of GstRtp-1.0.RTPBaseDepayload
        ...
        // Owm methods of GstRtp-1.0.RTPBaseDepayload
    ...
    abstract class RTPBasePayload extends Gst.Element {
        // Own properties of GstRtp-1.0.RTPBasePayload
        ...
        // Own fields of GstRtp-1.0.RTPBasePayload

        element: Gst.Element;

        // Owm methods of GstRtp-1.0.RTPBasePayload
    ...
    abstract class RTPHeaderExtension extends Gst.Element {
        // Owm methods of GstRtp-1.0.RTPHeaderExtension
     ...
     */
    class RTCPBuffer {
        // Owm methods of GstRtp-1.0.RTCPBuffer
     ...
     */
    class RTCPPacket {
        // Own fields of GstRtp-1.0.RTCPPacket

        offset: number;

        // Owm methods of GstRtp-1.0.RTCPPacket
         ...
         */
        copy_profile_specific_ext(): boolean;
        /**
         ...
         */
        get_padding(): boolean;
        get_profile_specific_ext(): boolean;
         ...
         * @returns %TRUE if there was valid data.
         */
        sdes_copy_entry(type: RTCPSDESType): boolean;
        /**
         ...
         * @returns %TRUE if there was valid data.
         */
        sdes_get_entry(type: RTCPSDESType): boolean;
        /**
     ...
     */
    class RTPBuffer {
        // Own fields of GstRtp-1.0.RTPBuffer

        state: number;
        data: any[];
        size: number[];

        // Owm methods of GstRtp-1.0.RTPBuffer
         ...
         * @param timestamp a new timestamp
         */
        static ext_timestamp(exttimestamp: number, timestamp: number): number;
        /**
         * Similar to gst_rtp_buffer_get_extension_onebyte_header, but working
         * on the #GBytes you get from gst_rtp_buffer_get_extension_bytes.
         * Parses RFC 5285 style header extensions with a one byte header. It will
         ...
         * @param flags #GstMapFlags
         */
        static map(buffer: Gst.Buffer, flags: Gst.MapFlags): boolean;
        /**
         * Allocate a new #GstBuffer with enough data to hold an RTP packet with
         * `csrc_count` CSRCs, a payload length of `payload_len` and padding of `pad_len`.
         * All other RTP header fields will be set to 0/FALSE.
         ...
         */
        get_extension_data(): GLib.Bytes | null;
        /**
         * Parses RFC 5285 style header extensions with a one byte header. It will
         * return the nth extension with the requested id.
         * @param id The ID of the header extension to be read (between 1 and 14).
     ...
     */
    class RTPHeaderExtensionClass {
        // Owm methods of GstRtp-1.0.RTPHeaderExtensionClass
    ...
    class RTPPayloadInfo {
        // Own fields of GstRtp-1.0.RTPPayloadInfo
        ...
        // Constructors of GstRtp-1.0.RTPPayloadInfo
        ...
        // Owm methods of GstRtp-1.0.RTPPayloadInfo
     ...
     */
    class RTPSourceMeta {
        // Own fields of GstRtp-1.0.RTPSourceMeta
        ...
        // Owm methods of GstRtp-1.0.RTPSourceMeta

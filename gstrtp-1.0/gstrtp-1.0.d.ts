...
_init(...args: any[]): void;
    ...
    connect(signal: 'request-extension', callback: ((_source: this, ext_id: number, ext_uri: string | null) => (RTPHeaderExtension | null))): number
    connect_after(signal: 'request-extension', callback: ((_source: this, ext_id: number, ext_uri: string | null) => (RTPHeaderExtension | null))): number
...
_init(...args: any[]): void;
    ...
    connect_after(signal: 'clear-extensions', callback: ((_source: this) => void)): number
    emit(signal: 'clear-extensions'): void
    connect(signal: 'request-extension', callback: ((_source: this, ext_id: number, ext_uri: string) => (RTPHeaderExtension | null))): number
    connect_after(signal: 'request-extension', callback: ((_source: this, ext_id: number, ext_uri: string) => (RTPHeaderExtension | null))): number

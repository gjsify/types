...
export const OWN_PROPS = {
    EvDocumentModel: ['continuous', 'document', 'dual-odd-left', 'dual-page', 'fullscreen', 'inverted-colors', 'page', 'rotation', 'rtl', 'scale', 'sizing-mode'],
...
export const ENUM_VALUES = {
    ...
    'EvSizingMode.free': 2,
    'EvViewSelectionMode.rectangle': 1,
    'EvViewSelectionMode.text': 0,
};
...
export const FLAG_VALUES = {
    'EvJobPageDataFlags.all': 127,
    'EvJobPageDataFlags.annots': 64,
    'EvJobPageDataFlags.forms': 32,
    'EvJobPageDataFlags.images': 16,

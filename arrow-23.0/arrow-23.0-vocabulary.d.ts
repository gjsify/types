/**
 * The GIR-derived widget VOCABULARY for Arrow-23.0.
 *
 * GENERATED — do not edit. Provenance: Arrow-23.0 — library 23.0.1 — prop(s) no TypeScript value satisfies: Arrow.Array.array Arrow.ArrayBuilder.array-builder Arrow.ArrayStatistics.statistics Arrow.Buffer.buffer Arrow.CSVReader.csv-table-reader Arrow.ChunkedArray.chunked-array Arrow.Codec.codec Arrow.DataType.data-type Arrow.Datum.datum Arrow.Decimal128.decimal128 Arrow.Decimal256.decimal256 Arrow.Decimal32.decimal32 Arrow.Decimal64.decimal64 Arrow.ExecuteNode.node Arrow.ExecuteNodeOptions.options Arrow.ExecutePlan.plan Arrow.Executor.executor Arrow.ExtensionDataTypeRegistry.registry Arrow.FeatherFileReader.feather-reader Arrow.Field.field Arrow.FileSystem.file-system Arrow.Function.function Arrow.FunctionDoc.doc Arrow.InputStream.input-stream Arrow.JSONReader.json-table-reader Arrow.MemoryPool.memory-pool Arrow.ORCFileReader.orc-file-reader Arrow.OutputStream.output-stream Arrow.RecordBatch.record-batch Arrow.RecordBatchBuilder.record-batch-builder Arrow.RecordBatchFileReader.record-batch-file-reader Arrow.RecordBatchIterator.iterator Arrow.RecordBatchReader.record-batch-reader Arrow.RecordBatchReader.sources Arrow.RecordBatchWriter.record-batch-writer Arrow.Scalar.scalar Arrow.Schema.schema Arrow.StreamDecoder.decoder Arrow.Table.table Arrow.Tensor.tensor Arrow.TimestampParser.parser
 *
 * 316 instantiable GTypes (of which 0 concrete widgets), 342 declarations, 27 enum nick unions, 0 slot candidates.
 *
...
import type Arrow from './arrow-23.0.js';
...
export type GArrowAssumeTimezoneAmbiguousNick = 'raise' | 'earliest' | 'latest';
export type GArrowAssumeTimezoneNonexistentNick = 'raise' | 'earliest' | 'latest';
export type GArrowCSVQuotingStyleNick = 'needed' | 'all-valid' | 'none';
export type GArrowCalendarUnitNick = 'nanosecond' | 'microsecond' | 'millisecond' | 'second' | 'minute' | 'hour' | 'day' | 'week' | 'month' | 'quarter' | 'year';
...
export type GArrowDictionaryEncodeNullEncodingBehaviorNick = 'encode' | 'mask';
...
export type GArrowJoinNullHandlingBehaviorNick = 'emit-null' | 'skip' | 'replace';
export type GArrowJoinTypeNick = 'left-semi' | 'right-semi' | 'left-anti' | 'right-anti' | 'inner' | 'left-outer' | 'right-outer' | 'full-outer';
export type GArrowListSliceReturnFixedSizeListNick = 'auto' | 'false' | 'true';
export type GArrowMapLookupOccurrenceNick = 'first' | 'last' | 'all';
export type GArrowMetadataVersionNick = 'v1' | 'v2' | 'v3';
export type GArrowNullPlacementNick = 'at-start' | 'at-end';
export type GArrowPivotWiderUnexpectedKeyBehaviorNick = 'ignore' | 'raise';
...
export type GArrowTypeNick = 'na' | 'boolean' | 'uint8' | 'int8' | 'uint16' | 'int16' | 'uint32' | 'int32' | 'uint64' | 'int64' | 'half-float' | 'float' | 'double' | 'string' | 'binary' | 'fixed-size-binary' | 'date32' | 'date64' | 'timestamp' | 'time32' | 'time64' | 'month-interval' | 'day-time-interval' | 'decimal128' | 'decimal256' | 'list' | 'struct' | 'sparse-union' | 'dense-union' | 'dictionary' | 'map' | 'extension' | 'fixed-size-list' | 'duration' | 'large-string' | 'large-binary' | 'large-list' | 'month-day-nano-interval' | 'run-end-encoded' | 'string-view' | 'binary-view' | 'decimal32' | 'decimal64';
...
export interface GArrowArrayStatisticsProps extends GObjectProps {
    statistics?: never;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowArrayStatisticsConstructOnly = GObjectConstructOnly | 'statistics';

export interface GArrowAssumeTimezoneOptionsProps extends GArrowFunctionOptionsProps {
    /**
     * How to interpret ambiguous local times (due to DST shifts).
     * @since 23.0.0
     * @default GARROW_ASSUME_TIMEZONE_AMBIGUOUS_RAISE
     */
    ambiguous?: GArrowAssumeTimezoneAmbiguousNick | Arrow.AssumeTimezoneAmbiguous;
    /**
     * How to interpret nonexistent local times (due to DST shifts).
     * @since 23.0.0
     * @default GARROW_ASSUME_TIMEZONE_NONEXISTENT_RAISE
     */
    nonexistent?: GArrowAssumeTimezoneNonexistentNick | Arrow.AssumeTimezoneNonexistent;
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowAssumeTimezoneOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;

export interface GArrowAzureFileSystemProps extends GArrowFileSystemProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowAzureFileSystemConstructOnly = GArrowFileSystemConstructOnly;
...
export interface GArrowBaseListDataTypeProps extends GArrowDataTypeProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowBaseListDataTypeConstructOnly = GArrowDataTypeConstructOnly;
...
export interface GArrowBinaryViewArrayProps extends GArrowArrayProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowBinaryViewArrayConstructOnly = GArrowArrayConstructOnly;

export interface GArrowBinaryViewDataTypeProps extends GArrowDataTypeProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowBinaryViewDataTypeConstructOnly = GArrowDataTypeConstructOnly;
...
export interface GArrowCSVWriteOptionsProps extends GObjectProps {
    /**
     ...
     * @since 23.0.0
     * @default GARROW_CSV_QUOTING_STYLE_NEEDED
     */
    'quoting-header'?: GArrowCSVQuotingStyleNick | Arrow.CSVQuotingStyle;
    /**
     * Quoting style.
     * @since 23.0.0
     * @default GARROW_CSV_QUOTING_STYLE_NEEDED
     */
    'quoting-style'?: GArrowCSVQuotingStyleNick | Arrow.CSVQuotingStyle;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowCSVWriteOptionsConstructOnly = GObjectConstructOnly;

export interface GArrowCSVWriterProps extends GArrowRecordBatchWriterProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowCSVWriterConstructOnly = GArrowRecordBatchWriterConstructOnly;
...
export interface GArrowCumulativeOptionsProps extends GArrowFunctionOptionsProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowCumulativeOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;
...
export interface GArrowDayOfWeekOptionsProps extends GArrowFunctionOptionsProps {
    /**
     * Number days from 0 if true and from 1 if false.
     * @since 23.0.0
     * @default TRUE
     */
    'count-from-zero'?: boolean;
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowDayOfWeekOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;
...
export interface GArrowDecimal32Props extends GObjectProps {
    decimal32?: never;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowDecimal32ConstructOnly = GObjectConstructOnly | 'decimal32';

export interface GArrowDecimal32ArrayProps extends GArrowFixedSizeBinaryArrayProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowDecimal32ArrayConstructOnly = GArrowFixedSizeBinaryArrayConstructOnly;

export interface GArrowDecimal32ArrayBuilderProps extends GArrowFixedSizeBinaryArrayBuilderProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowDecimal32ArrayBuilderConstructOnly = GArrowFixedSizeBinaryArrayBuilderConstructOnly;

export interface GArrowDecimal32DataTypeProps extends GArrowDecimalDataTypeProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowDecimal32DataTypeConstructOnly = GArrowDecimalDataTypeConstructOnly;

export interface GArrowDecimal32ScalarProps extends GArrowScalarProps {
    /**
     * The value of the scalar.
     * @since 19.0.0
     */
    value?: Arrow.Decimal32;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowDecimal32ScalarConstructOnly = GArrowScalarConstructOnly | 'value';

export interface GArrowDecimal64Props extends GObjectProps {
    decimal64?: never;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowDecimal64ConstructOnly = GObjectConstructOnly | 'decimal64';

export interface GArrowDecimal64ArrayProps extends GArrowFixedSizeBinaryArrayProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowDecimal64ArrayConstructOnly = GArrowFixedSizeBinaryArrayConstructOnly;

export interface GArrowDecimal64ArrayBuilderProps extends GArrowFixedSizeBinaryArrayBuilderProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowDecimal64ArrayBuilderConstructOnly = GArrowFixedSizeBinaryArrayBuilderConstructOnly;

export interface GArrowDecimal64DataTypeProps extends GArrowDecimalDataTypeProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowDecimal64DataTypeConstructOnly = GArrowDecimalDataTypeConstructOnly;

export interface GArrowDecimal64ScalarProps extends GArrowScalarProps {
    /**
     * The value of the scalar.
     * @since 19.0.0
     */
    value?: Arrow.Decimal64;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowDecimal64ScalarConstructOnly = GArrowScalarConstructOnly | 'value';
...
export interface GArrowDictionaryEncodeOptionsProps extends GArrowFunctionOptionsProps {
    /**
     * How null values will be encoded.
     * @since 23.0.0
     * @default GARROW_DICTIONARY_ENCODE_NULL_ENCODING_MASK
     */
    'null-encoding-behavior'?: GArrowDictionaryEncodeNullEncodingBehaviorNick | Arrow.DictionaryEncodeNullEncodingBehavior;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowDictionaryEncodeOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;
...
export interface GArrowDurationArrayProps extends GArrowNumericArrayProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowDurationArrayConstructOnly = GArrowNumericArrayConstructOnly;

export interface GArrowDurationArrayBuilderProps extends GArrowArrayBuilderProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowDurationArrayBuilderConstructOnly = GArrowArrayBuilderConstructOnly;

export interface GArrowDurationDataTypeProps extends GArrowTemporalDataTypeProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowDurationDataTypeConstructOnly = GArrowTemporalDataTypeConstructOnly;

export interface GArrowDurationScalarProps extends GArrowScalarProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowDurationScalarConstructOnly = GArrowScalarConstructOnly;

export interface GArrowElementWiseAggregateOptionsProps extends GArrowFunctionOptionsProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowElementWiseAggregateOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;
...
export interface GArrowExecuteContextProps extends GObjectProps {
     ...
     * @since 23.0.0
     */
    executor?: Arrow.Executor;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowExecuteContextConstructOnly = GObjectConstructOnly | 'executor';
...
export interface GArrowExecutorProps extends GObjectProps {
    executor?: never;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowExecutorConstructOnly = GObjectConstructOnly | 'executor';
...
export interface GArrowExtractRegexOptionsProps extends GArrowFunctionOptionsProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowExtractRegexOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;

export interface GArrowExtractRegexSpanOptionsProps extends GArrowFunctionOptionsProps {
    /**
     * Regular expression with named capture fields.
     * @since 23.0.0
     */
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowExtractRegexSpanOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;
...
export interface GArrowFixedShapeTensorDataTypeProps extends GArrowExtensionDataTypeProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowFixedShapeTensorDataTypeConstructOnly = GArrowExtensionDataTypeConstructOnly;
...
export interface GArrowFixedSizeListArrayProps extends GArrowArrayProps {
    'raw-values'?: Arrow.Array;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowFixedSizeListArrayConstructOnly = GArrowArrayConstructOnly | 'raw-values';

export interface GArrowFixedSizeListArrayBuilderProps extends GArrowArrayBuilderProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowFixedSizeListArrayBuilderConstructOnly = GArrowArrayBuilderConstructOnly;

export interface GArrowFixedSizeListDataTypeProps extends GArrowBaseListDataTypeProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowFixedSizeListDataTypeConstructOnly = GArrowBaseListDataTypeConstructOnly;
...
export interface GArrowJoinOptionsProps extends GArrowFunctionOptionsProps {
    /**
     * How to handle null values.
     * @since 23.0.0
     * @default GARROW_JOIN_NULL_HANDLING_EMIT_NULL
     */
    'null-handling'?: GArrowJoinNullHandlingBehaviorNick | Arrow.JoinNullHandlingBehavior;
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowJoinOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;
...
export interface GArrowListDataTypeProps extends GArrowBaseListDataTypeProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowListDataTypeConstructOnly = GArrowBaseListDataTypeConstructOnly;

export interface GArrowListFlattenOptionsProps extends GArrowFunctionOptionsProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowListFlattenOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;
...
export interface GArrowListSliceOptionsProps extends GArrowFunctionOptionsProps {
    /**
     * Whether to return a FixedSizeListArray.
     * @since 23.0.0
     * @default GARROW_LIST_SLICE_RETURN_FIXED_SIZE_LIST_AUTO
     */
    'return-fixed-size-list'?: GArrowListSliceReturnFixedSizeListNick | Arrow.ListSliceReturnFixedSizeList;
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowListSliceOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;
...
export interface GArrowMakeStructOptionsProps extends GArrowFunctionOptionsProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowMakeStructOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;
...
export interface GArrowMapLookupOptionsProps extends GArrowFunctionOptionsProps {
    /**
     * Whether to return the first, last, or all matching values.
     * @since 23.0.0
     * @default GARROW_MAP_LOOKUP_OCCURRENCE_FIRST
     */
    occurrence?: GArrowMapLookupOccurrenceNick | Arrow.MapLookupOccurrence;
    /**
     * The key to lookup in the map.
     * @since 23.0.0
     */
    'query-key'?: Arrow.Scalar;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowMapLookupOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;
...
export interface GArrowModeOptionsProps extends GArrowFunctionOptionsProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowModeOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;
...
export interface GArrowNullOptionsProps extends GArrowFunctionOptionsProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowNullOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;
...
export interface GArrowPadOptionsProps extends GArrowFunctionOptionsProps {
    /**
     * What to do if there is an odd number of padding characters (in case of centered padding).
     * @since 23.0.0
     * @default TRUE
     */
    'lean-left-on-odd-padding'?: boolean;
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowPadOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;

export interface GArrowPairwiseOptionsProps extends GArrowFunctionOptionsProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowPairwiseOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;

export interface GArrowPartitionNthOptionsProps extends GArrowFunctionOptionsProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowPartitionNthOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;

export interface GArrowPivotWiderOptionsProps extends GArrowFunctionOptionsProps {
    /**
     ...
     * @since 23.0.0
     * @default GARROW_PIVOT_WIDER_UNEXPECTED_KEY_BEHAVIOR_IGNORE
     */
    'unexpected-key-behavior'?: GArrowPivotWiderUnexpectedKeyBehaviorNick | Arrow.PivotWiderUnexpectedKeyBehavior;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowPivotWiderOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;
...
export interface GArrowRankQuantileOptionsProps extends GArrowFunctionOptionsProps {
    /**
     * Whether nulls and NaNs are placed at the start or at the end.
     * @since 23.0.0
     * @default GARROW_NULL_PLACEMENT_AT_END
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowRankQuantileOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;
...
export interface GArrowReplaceSliceOptionsProps extends GArrowFunctionOptionsProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowReplaceSliceOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;

export interface GArrowReplaceSubstringOptionsProps extends GArrowFunctionOptionsProps {
    /**
     * Max number of substrings to replace (-1 means unbounded).
     * @since 23.0.0
     * @default -1
     */
    'max-replacements'?: bigint | number;
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowReplaceSubstringOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;
...
export interface GArrowRoundBinaryOptionsProps extends GArrowFunctionOptionsProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowRoundBinaryOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;
...
export interface GArrowRoundTemporalOptionsProps extends GArrowFunctionOptionsProps {
     ...
     * @since 23.0.0
     * @default GARROW_CALENDAR_UNIT_DAY
     */
    unit?: GArrowCalendarUnitNick | Arrow.CalendarUnit;
    /**
     * What day does the week start with (Monday=true, Sunday=false).
     * @since 23.0.0
     * @default TRUE
     */
    'week-starts-monday'?: boolean;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowRoundTemporalOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;
...
export interface GArrowSelectKOptionsProps extends GArrowFunctionOptionsProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowSelectKOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;
...
export interface GArrowSkewOptionsProps extends GArrowFunctionOptionsProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowSkewOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;

export interface GArrowSliceOptionsProps extends GArrowFunctionOptionsProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowSliceOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;
...
export interface GArrowSplitOptionsProps extends GArrowFunctionOptionsProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowSplitOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;
...
export interface GArrowStreamDecoderProps extends GObjectProps {
    decoder?: never;
    /**
     * A listener that receives decoded events.
     * @since 18.0.0
     */
    listener?: Arrow.StreamListener;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowStreamDecoderConstructOnly = GObjectConstructOnly | 'decoder' | 'listener';
...
export interface GArrowStringViewArrayProps extends GArrowBinaryViewArrayProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowStringViewArrayConstructOnly = GArrowBinaryViewArrayConstructOnly;

export interface GArrowStringViewDataTypeProps extends GArrowBinaryViewDataTypeProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowStringViewDataTypeConstructOnly = GArrowBinaryViewDataTypeConstructOnly;
...
export interface GArrowTDigestOptionsProps extends GArrowFunctionOptionsProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowTDigestOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;
...
export interface GArrowThreadPoolProps extends GArrowExecutorProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowThreadPoolConstructOnly = GArrowExecutorConstructOnly;
...
export interface GArrowTrimOptionsProps extends GArrowFunctionOptionsProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowTrimOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;
...
export interface GArrowUUIDDataTypeProps extends GArrowExtensionDataTypeProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowUUIDDataTypeConstructOnly = GArrowExtensionDataTypeConstructOnly;
...
export interface GArrowWeekOptionsProps extends GArrowFunctionOptionsProps {
    /**
     ...
     * @default FALSE
     */
    'first-week-is-fully-in-year'?: boolean;
    /**
     * What day does the week start with (Monday=true, Sunday=false).
     * @since 23.0.0
     * @default TRUE
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowWeekOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;

export interface GArrowWinsorizeOptionsProps extends GArrowFunctionOptionsProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowWinsorizeOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;
...
export interface GArrowZeroFillOptionsProps extends GArrowFunctionOptionsProps {
    /**
     * What to pad the string with.
     * @since 23.0.0
     * @default 0
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GArrowZeroFillOptionsConstructOnly = GArrowFunctionOptionsConstructOnly;

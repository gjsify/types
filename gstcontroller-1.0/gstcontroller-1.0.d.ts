...
export namespace GstController {
    ...
    class ARGBControlBinding extends Gst.ControlBinding {
        // Own properties of GstController-1.0.ARGBControlBinding
        ...
        // Constructors of GstController-1.0.ARGBControlBinding
    ...
    class DirectControlBinding extends Gst.ControlBinding {
        // Own properties of GstController-1.0.DirectControlBinding

        absolute: boolean;
        control_source: Gst.ControlSource;
        controlSource: Gst.ControlSource;

        // Constructors of GstController-1.0.DirectControlBinding
    ...
    class InterpolationControlSource extends TimedValueControlSource {
        // Own properties of GstController-1.0.InterpolationControlSource

        mode: InterpolationMode;

        // Constructors of GstController-1.0.InterpolationControlSource
    ...
    class LFOControlSource extends Gst.ControlSource {
        // Own properties of GstController-1.0.LFOControlSource
        ...
        // Constructors of GstController-1.0.LFOControlSource
    ...
    class ProxyControlBinding extends Gst.ControlBinding {
        // Constructors of GstController-1.0.ProxyControlBinding
    ...
    abstract class TimedValueControlSource extends Gst.ControlSource {
        // Own fields of GstController-1.0.TimedValueControlSource

        nvalues: number;
        valid_cache: boolean;

        // Owm methods of GstController-1.0.TimedValueControlSource
    ...
    class TriggerControlSource extends TimedValueControlSource {
        // Own properties of GstController-1.0.TriggerControlSource

        tolerance: number;

        // Constructors of GstController-1.0.TriggerControlSource
     ...
     */
    class ControlPoint {
        // Own fields of GstController-1.0.ControlPoint

        timestamp: Gst.ClockTime;
        value: number;

        // Constructors of GstController-1.0.ControlPoint
        ...
        // Owm methods of GstController-1.0.ControlPoint

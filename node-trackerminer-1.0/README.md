...
![version](https://img.shields.io/npm/v/@girs/node-trackerminer-1.0)
![downloads/week](https://img.shields.io/npm/dw/@girs/node-trackerminer-1.0)


Node.js TypeScript type definitions for TrackerMiner-1.0, generated from library version 1.0.0 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v3.2.0.

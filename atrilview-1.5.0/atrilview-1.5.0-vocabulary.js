...
export const OWN_PROPS = {
    EvDocumentModel: ['continuous', 'document', 'dual-odd-left', 'dual-page', 'fullscreen', 'inverted-colors', 'page', 'page-layout', 'rotation', 'scale', 'sizing-mode'],
    EvViewPresentation: ['current-page', 'document', 'inverted-colors', 'rotation'],
};

export const OWN_SIGNALS = {
    EvDocumentModel: ['page-changed'],
    EvJob: ['cancelled', 'finished'],
    EvJobFind: ['updated'],
    EvJobFonts: ['updated'],
...
export const ENUM_VALUES = {
    'EvJobPriority.n-priorities': 4,
    'EvJobPriority.priority-high': 1,
    'EvJobPriority.priority-low': 2,
    'EvJobPriority.priority-none': 3,
    'EvJobPriority.priority-urgent': 0,
    'EvJobRunMode.main-loop': 1,
    'EvJobRunMode.thread': 0,
    'EvPageLayout.automatic': 2,
    'EvPageLayout.dual': 1,
    'EvPageLayout.single': 0,
    'EvSizingMode.automatic': 3,
    'EvSizingMode.best-fit': 0,
    'EvSizingMode.fit-page': 0,
    'EvSizingMode.fit-width': 1,
    'EvSizingMode.free': 2,
};
...
export const FLAG_VALUES = {
    'EvJobPageDataFlags.all': 511,
    'EvJobPageDataFlags.annots': 256,
    'EvJobPageDataFlags.forms': 128,
    'EvJobPageDataFlags.images': 64,
    'EvJobPageDataFlags.links': 1,
    'EvJobPageDataFlags.none': 0,
    'EvJobPageDataFlags.text': 2,
    'EvJobPageDataFlags.text-attrs': 16,
    'EvJobPageDataFlags.text-layout': 8,
    'EvJobPageDataFlags.text-log-attrs': 32,
    'EvJobPageDataFlags.text-mapping': 4,
};
...
export const PROP_ENUMS = {
    'EvDocumentModel.page-layout': 'EvPageLayout',
    'EvDocumentModel.sizing-mode': 'EvSizingMode',
};
...
export const PROP_TYPES = {
    'EvDocumentModel.continuous': 'gboolean',
    'EvDocumentModel.document': 'EvDocument',
    'EvDocumentModel.dual-odd-left': 'gboolean',
    'EvDocumentModel.dual-page': 'gboolean',
    'EvDocumentModel.fullscreen': 'gboolean',
    'EvDocumentModel.inverted-colors': 'gboolean',
    'EvDocumentModel.page': 'gint',
    'EvDocumentModel.page-layout': 'EvPageLayout',
    'EvDocumentModel.rotation': 'gint',
    'EvDocumentModel.scale': 'gdouble',
    'EvDocumentModel.sizing-mode': 'EvSizingMode',
    'EvViewPresentation.current-page': 'guint',
    'EvViewPresentation.document': 'EvDocument',
    'EvViewPresentation.inverted-colors': 'gboolean',
    'EvViewPresentation.rotation': 'guint',
};

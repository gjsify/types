...
export const PROVENANCE = {
    ...
    requiredVocabularies: ['@girs/gio-2.0/vocabulary', '@girs/gobject-2.0/vocabulary', '@girs/gtk-2.0/vocabulary'],
};

export const OWN_PROPS = {
    VtePty: ['fd', 'flags', 'term'],
...
export const DECLS = {
    ...
    VteTerminal: ['VteTerminal', 'GtkWidget', 'GtkObject', 'GInitiallyUnowned', 'GObject', 'GtkBuildable'],
};
...
export const ENUM_VALUES = {
    'VteTerminalAntiAlias.force-disable': 2,
    'VteTerminalAntiAlias.force-enable': 1,
    'VteTerminalAntiAlias.use-default': 0,
    'VteTerminalCursorBlinkMode.off': 2,
    'VteTerminalCursorBlinkMode.on': 1,
    'VteTerminalCursorBlinkMode.system': 0,
    'VteTerminalCursorShape.block': 0,
    'VteTerminalCursorShape.ibeam': 1,
    'VteTerminalCursorShape.underline': 2,
    'VteTerminalEraseBinding.ascii-backspace': 1,
    'VteTerminalEraseBinding.ascii-delete': 2,
    'VteTerminalEraseBinding.auto': 0,
    'VteTerminalEraseBinding.delete-sequence': 3,
    'VteTerminalEraseBinding.tty': 4,
    'VteTerminalWriteFlags.default': 0,
};
...
export const PROP_ENUMS = {
    ...
    'VteTerminal.backspace-binding': 'VteTerminalEraseBinding',
    'VteTerminal.cursor-blink-mode': 'VteTerminalCursorBlinkMode',
    'VteTerminal.cursor-shape': 'VteTerminalCursorShape',
    'VteTerminal.delete-binding': 'VteTerminalEraseBinding',
};
...
export const PROP_TYPES = {
    'VtePty.fd': 'gint',
    'VtePty.flags': 'VtePtyFlags',
    'VtePty.term': 'gchararray',
    'VteTerminal.allow-bold': 'gboolean',
    'VteTerminal.audible-bell': 'gboolean',
    'VteTerminal.background-image-file': 'gchararray',
    'VteTerminal.background-image-pixbuf': 'GdkPixbuf',
    'VteTerminal.background-opacity': 'gdouble',
    'VteTerminal.background-saturation': 'gdouble',
    'VteTerminal.background-transparent': 'gboolean',
    'VteTerminal.backspace-binding': 'VteTerminalEraseBinding',
    'VteTerminal.cursor-blink-mode': 'VteTerminalCursorBlinkMode',
    'VteTerminal.cursor-shape': 'VteTerminalCursorShape',
    'VteTerminal.delete-binding': 'VteTerminalEraseBinding',
    'VteTerminal.emulation': 'gchararray',
    'VteTerminal.encoding': 'gchararray',
    'VteTerminal.pointer-autohide': 'gboolean',
    'VteTerminal.pty': 'gint',
    'VteTerminal.pty-object': 'VtePty',
    'VteTerminal.scroll-background': 'gboolean',
    'VteTerminal.scroll-on-keystroke': 'gboolean',
    'VteTerminal.scroll-on-output': 'gboolean',
    'VteTerminal.scrollback-lines': 'guint',
    'VteTerminal.visible-bell': 'gboolean',
    'VteTerminal.word-chars': 'gchararray',
};

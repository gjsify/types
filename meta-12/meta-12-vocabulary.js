// The widget vocabulary of Meta-12 as runtime data.
//
// GENERATED — do not edit. Provenance: Meta-12 — dropped empty base(s): Atk.ImplementorIface
//
...
export const PROVENANCE = {
    ...
    requiredVocabularies: ['@girs/clutter-12/vocabulary', '@girs/gio-2.0/vocabulary', '@girs/gobject-2.0/vocabulary'],
};
...
export const OWN_PROPS = {
    ...
    MetaBarrier: ['backend', 'directions', 'display', 'x1', 'x2', 'y1', 'y2'],
...
export const FLAG_VALUES = {
    ...
    'MetaFrameFlags.allows-move': 512,
    'MetaFrameFlags.allows-vertical-resize': 16,
    'MetaFrameFlags.fullscreen': 1024,
    'MetaFrameFlags.has-focus': 64,
    'MetaFrameFlags.maximized': 256,
    'MetaFrameFlags.stuck': 128,
    'MetaFrameFlags.tiled-left': 4096,
    'MetaFrameFlags.tiled-right': 8192,

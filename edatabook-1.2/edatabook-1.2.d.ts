...
static new_full(filename: string, source?: (EDataServer.Source | null), setup?: (EBookContacts.SourceBackendSummarySetup | null), cancellable?: (Gio.Cancellable | null)): BookCache;
    ...
    connect_after(signal: 'dup-contact-revision', callback: ((_source: this, object: EBookContacts.Contact) => string)): number
    emit(signal: 'dup-contact-revision', object: EBookContacts.Contact): void
    connect(signal: 'e164-changed', callback: ((_source: this, object: EBookContacts.Contact, p0: boolean) => void)): number
    connect_after(signal: 'e164-changed', callback: ((_source: this, object: EBookContacts.Contact, p0: boolean) => void)): number
...
module BookSqlite {
    ...
    interface BeforeInsertContact {
        (object: (any | null), p0: EBookContacts.Contact, p1: string, p2: boolean, p3: GObject.Object, p4?: (any | null)): boolean
    }
...
static new_full(path: string, source?: (EDataServer.Source | null), setup?: (EBookContacts.SourceBackendSummarySetup | null), vcard_callback?: (bSqlVCardCallback | null), change_callback?: (bSqlChangeCallback | null), user_data_destroy?: (GLib.DestroyNotify | null), cancellable?: (Gio.Cancellable | null)): BookSqlite;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'before-insert-contact', callback: ((_source: this, object: any | null, p0: EBookContacts.Contact, p1: string, p2: boolean, p3: GObject.Object, p4: any | null) => boolean)): number
    connect_after(signal: 'before-insert-contact', callback: ((_source: this, object: any | null, p0: EBookContacts.Contact, p1: string, p2: boolean, p3: GObject.Object, p4: any | null) => boolean)): number
    emit(signal: 'before-insert-contact', object: (any | null), p0: EBookContacts.Contact, p1: string, p2: boolean, p3: GObject.Object, p4?: (any | null)): void
    connect(signal: 'before-remove-contact', callback: ((_source: this, object: any | null, p0: string, p1: Gio.Cancellable | null, p2: any | null) => boolean)): number
    connect_after(signal: 'before-remove-contact', callback: ((_source: this, object: any | null, p0: string, p1: Gio.Cancellable | null, p2: any | null) => boolean)): number
    emit(signal: 'before-remove-contact', object: (any | null), p0: string, p1?: (Gio.Cancellable | null), p2?: (any | null)): void
...
module DataBookFactory {
    ...
    interface ConstructorProps extends EBackend.DataFactory.ConstructorProps, EDataServer.Extensible.ConstructorProps, Gio.Initable.ConstructorProps {

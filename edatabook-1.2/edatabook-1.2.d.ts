...
export namespace EDataBook {
     ...
     */
    function ebsql_get_contact_extra_unlocked(ebsql: BookSqlite, uid: string): boolean;
    /**
     ...
     * @returns %TRUE on success, otherwise %FALSE is returned and @error is set appropriately.
     */
    function ebsql_get_contact_unlocked(ebsql: BookSqlite, uid: string, meta_contact: boolean): boolean;
    /**
     ...
     * @returns %TRUE on success, otherwise %FALSE is returned and @error is set appropriately.
     */
    function ebsql_get_vcard_unlocked(ebsql: BookSqlite, uid: string, meta_contact: boolean): boolean;
    ...
    class BookBackend extends EBackend.Backend {
        // Own properties of EDataBook-1.2.BookBackend
        ...
        // Owm methods of EDataBook-1.2.BookBackend
    ...
    class BookBackendSExp extends GObject.Object {
        // Constructors of EDataBook-1.2.BookBackendSExp

        static ['new'](text: string): BookBackendSExp;

        // Owm methods of EDataBook-1.2.BookBackendSExp
    ...
    class BookBackendSync extends BookBackend {
        // Owm methods of EDataBook-1.2.BookBackendSync
         ...
         * @returns %TRUE on success, %FALSE on failure
         */
        create_contacts(vcards: string, opflags: number, cancellable?: Gio.Cancellable | null): boolean;
        /**
         * Obtains an #EContact for `uid`.
         *
         * The returned #EContact is referenced for thread-safety and must be
         ...
         * @returns %TRUE on success, %FALSE on failure
         */
        get_contact_list(query: string, cancellable?: Gio.Cancellable | null): boolean;
        /**
         * Obtains a set of ID strings for contacts which satisfy the criteria
         * specified in `query,` and deposits them in `out_uids`.
         *
         ...
         * @returns %TRUE on success, %FALSE on failure
         */
        get_contact_list_uids(query: string, cancellable?: Gio.Cancellable | null): boolean;
        /**
         * Modifies one or more contacts according to `vcards`.
         *
         * If an error occurs, the function will set `error` and return %FALSE.
         ...
         * @returns %TRUE on success, %FALSE on failure
         */
        modify_contacts(vcards: string, opflags: number, cancellable?: Gio.Cancellable | null): boolean;
        /**
         * "Opens" the `backend`.  Opening a backend is something of an outdated
         * concept, but the operation is hanging around for a little while longer.
         * This usually involves some custom initialization logic, and testing of
         ...
         * @returns %TRUE on success, %FALSE on failure
         */
        remove_contacts(uids: string, opflags: number, cancellable?: Gio.Cancellable | null): boolean;
    }
    ...
    class BookCache extends EBackend.Cache {
        // Own properties of EDataBook-1.2.BookCache

        readonly locale: string;

        // Constructors of EDataBook-1.2.BookCache
        ...
        // Owm methods of EDataBook-1.2.BookCache
         ...
         */
        count_query(sexp: string | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         */
        cursor_calculate(cursor: BookCacheCursor, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         */
        cursor_compare_contact(cursor: BookCacheCursor, contact: EBookContacts.Contact): number;
        /**
         ...
         * @returns %TRUE on success, otherwise %FALSE is returned and @error is set appropriately.
         */
        get_contact(uid: string, meta_contact: boolean, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        get_contact_custom_flags(uid: string, cancellable?: Gio.Cancellable | null): boolean;
        /**
         * Fetches the extra data previously set for `uid,` either with
         ...
         * @returns %TRUE on success, otherwise %FALSE is returned and @error is set appropriately.
         */
        get_contact_extra(uid: string, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        get_uids_with_extra(extra: string, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns %TRUE on success, otherwise %FALSE is returned and @error is set appropriately.
         */
        get_vcard(uid: string, meta_contact: boolean, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns %TRUE on success, otherwise %FALSE is returned and @error is set appropriately.
         */
        search(sexp: string | null, meta_contacts: boolean, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns %TRUE on success, otherwise %FALSE is returned and @error is set appropriately.
         */
        search_uids(sexp: string | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
    ...
    abstract class BookMetaBackend extends BookBackendSync {
        // Own properties of EDataBook-1.2.BookMetaBackend
        ...
        // Owm methods of EDataBook-1.2.BookMetaBackend
         ...
         * @returns Whether succeeded.
         */
        connect_sync(credentials: EDataServer.NamedParameters | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        list_existing_sync(cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        load_contact_sync(uid: string, extra: string | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        search_sync(expr: string | null, meta_contact: boolean, cancellable?: Gio.Cancellable | null): boolean;
        /**
         * Searches `meta_backend` with given expression `expr` and returns
         ...
         * @returns Whether succeeded.
         */
        search_uids_sync(expr: string | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        split_changes_sync(objects: BookMetaBackendInfo[], cancellable?: Gio.Cancellable | null): boolean;
        /**
    ...
    class BookSqlite extends GObject.Object {
        // Constructors of EDataBook-1.2.BookSqlite
        ...
        // Owm methods of EDataBook-1.2.BookSqlite
         ...
         * @returns %TRUE on success, otherwise %FALSE is returned and @error is set appropriately.
         */
        get_contact(uid: string, meta_contact: boolean): boolean;
        /**
         * Fetches the extra data previously set for `uid,` either with
         * e_book_sqlite_set_contact_extra() or when adding contacts.
         * @param uid The uid of the contact to fetch the extra data for
    ...
    class DataBook extends GObject.Object {
        // Own properties of EDataBook-1.2.DataBook
    ...
    abstract class DataBookCursor extends GObject.Object {
        // Own properties of EDataBook-1.2.DataBookCursor

        backend: BookBackend;
        readonly position: number;
        readonly total: number;

        // Owm methods of EDataBook-1.2.DataBookCursor
         ...
         */
        load_locale(cancellable?: Gio.Cancellable | null): boolean;
        /**
    ...
    class DataBookCursorCache extends DataBookCursor {
        // Own properties of EDataBook-1.2.DataBookCursorCache

        book_cache: BookCache;
        bookCache: BookCache;
        cursor: any;

        // Constructors of EDataBook-1.2.DataBookCursorCache
    ...
    class DataBookCursorSqlite extends DataBookCursor {
        // Own properties of EDataBook-1.2.DataBookCursorSqlite
        ...
        // Constructors of EDataBook-1.2.DataBookCursorSqlite
    ...
    class DataBookDirect extends GObject.Object {
        // Constructors of EDataBook-1.2.DataBookDirect

        static ['new'](backend_path: string, backend_factory_name: string, config: string): DataBookDirect;

        // Owm methods of EDataBook-1.2.DataBookDirect
    ...
    class DataBookFactory extends EBackend.DataFactory {
        // Constructors of EDataBook-1.2.DataBookFactory
    ...
    class DataBookView extends GObject.Object {
        // Own properties of EDataBook-1.2.DataBookView
        ...
        // Constructors of EDataBook-1.2.DataBookView
        ...
        // Owm methods of EDataBook-1.2.DataBookView
    ...
    class DataBookViewWatcherCache extends EBookContacts.BookIndicesUpdater {
        // Constructors of EDataBook-1.2.DataBookViewWatcherCache

        static ['new'](backend: BookBackend, cache: BookCache, view: DataBookView): DataBookViewWatcherCache;

        // Owm methods of EDataBook-1.2.DataBookViewWatcherCache
    ...
    class DataBookViewWatcherMemory extends EBookContacts.BookIndicesUpdater {
        // Constructors of EDataBook-1.2.DataBookViewWatcherMemory

        static ['new'](backend: BookBackend, view: DataBookView): DataBookViewWatcherMemory;

        // Owm methods of EDataBook-1.2.DataBookViewWatcherMemory
    ...
    class DataBookViewWatcherSqlite extends EBookContacts.BookIndicesUpdater {
        // Constructors of EDataBook-1.2.DataBookViewWatcherSqlite

        static ['new'](backend: BookBackend, ebsql: BookSqlite, view: DataBookView): DataBookViewWatcherSqlite;

        // Owm methods of EDataBook-1.2.DataBookViewWatcherSqlite
    ...
    class SubprocessBookFactory extends EBackend.SubprocessFactory {
        // Constructors of EDataBook-1.2.SubprocessBookFactory
    ...
    class SystemLocaleWatcher extends GObject.Object {
        // Own properties of EDataBook-1.2.SystemLocaleWatcher
        ...
        // Constructors of EDataBook-1.2.SystemLocaleWatcher

        static ['new'](): SystemLocaleWatcher;

        // Owm methods of EDataBook-1.2.SystemLocaleWatcher
     ...
     */
    class BookBackendClass {
        // Own fields of EDataBook-1.2.BookBackendClass
     ...
     */
    class BookBackendFactoryClass {
        // Own fields of EDataBook-1.2.BookBackendFactoryClass
     ...
     * an addressbook backend.
     */
    class BookBackendSyncClass {
        // Own fields of EDataBook-1.2.BookBackendSyncClass
     ...
     */
    class BookCacheClass {}

    /**
     * An opaque cursor pointer
     */
    class BookCacheCursor {
        // Constructors of EDataBook-1.2.BookCacheCursor
    ...
    class BookCacheSearchData {
        // Own fields of EDataBook-1.2.BookCacheSearchData

        uid: string;
        vcard: string;
        extra: string;

        // Constructors of EDataBook-1.2.BookCacheSearchData
        ...
        // Owm methods of EDataBook-1.2.BookCacheSearchData
    ...
    class BookMetaBackendInfo {
        // Own fields of EDataBook-1.2.BookMetaBackendInfo
        ...
        // Constructors of EDataBook-1.2.BookMetaBackendInfo
        ...
        // Owm methods of EDataBook-1.2.BookMetaBackendInfo
     ...
     */
    class DataBookCursorCacheClass {}
     ...
     */
    class DataBookCursorClass {
        // Own fields of EDataBook-1.2.DataBookCursorClass
     ...
     */
    class DataBookCursorSqliteClass {}

    class DataBookCursorSqlitePrivate {}

    class DataBookDirectClass {}

    class DataBookDirectPrivate {}

    class DataBookFactoryClass {}

    class DataBookFactoryPrivate {}

    class DataBookPrivate {}

    class DataBookViewClass {}

    class DataBookViewPrivate {}

    class DataBookViewWatcherCacheClass {}

    class DataBookViewWatcherCachePrivate {}

    class DataBookViewWatcherMemoryClass {}

    class DataBookViewWatcherMemoryPrivate {}

    class DataBookViewWatcherSqliteClass {}

    class DataBookViewWatcherSqlitePrivate {}

    class SubprocessBookFactoryClass {}

    class SubprocessBookFactoryPrivate {}

    class SystemLocaleWatcherClass {}
    ...
    class bSqlSearchData {
        // Own fields of EDataBook-1.2.bSqlSearchData

        uid: string;
        vcard: string;
        extra: string;

        // Constructors of EDataBook-1.2.bSqlSearchData

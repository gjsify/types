...
export const OWN_PROPS = {
    ...
    GspellEntry: ['entry', 'inline-spell-checking'],
    GspellEntryBuffer: ['buffer', 'spell-checker'],
    GspellLanguageChooser: ['language', 'language-code'],
    GspellNavigatorTextView: ['view'],
    GspellTextBuffer: ['buffer', 'spell-checker'],
    GspellTextView: ['enable-language-menu', 'inline-spell-checking', 'view'],
};

export const OWN_SIGNALS = {
    GspellChecker: ['session-cleared', 'word-added-to-personal', 'word-added-to-session'],
};
...
export const PROP_TYPES = {
    'GspellCheckerDialog.spell-navigator': 'GspellNavigator',
    'GspellEntry.entry': 'GtkEntry',
    'GspellEntry.inline-spell-checking': 'gboolean',
    'GspellEntryBuffer.buffer': 'GtkEntryBuffer',
    'GspellEntryBuffer.spell-checker': 'GspellChecker',
    'GspellLanguageChooser.language-code': 'gchararray',
    'GspellNavigatorTextView.view': 'GtkTextView',
    'GspellTextBuffer.buffer': 'GtkTextBuffer',
    'GspellTextBuffer.spell-checker': 'GspellChecker',
    'GspellTextView.enable-language-menu': 'gboolean',
    'GspellTextView.inline-spell-checking': 'gboolean',
    'GspellTextView.view': 'GtkTextView',
};
...
export const SINCE = {
    'GspellEntry.entry': '1.4',
    'GspellEntry.inline-spell-checking': '1.4',
    'GspellEntryBuffer.buffer': '1.4',
    'GspellEntryBuffer.spell-checker': '1.4',
    'GspellTextView.enable-language-menu': '1.2',
};

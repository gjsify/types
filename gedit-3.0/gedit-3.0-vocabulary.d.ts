...
import type { TeplViewConstructOnly, TeplViewProps } from '@girs/tepl-6/vocabulary';
...
export interface GeditEncodingsComboBoxProps extends GtkComboBoxProps, GtkBuildableProps, GtkCellEditableProps, GtkCellLayoutProps {
    /**
     * Whether the combo box should be used for saving a content.
     * @default FALSE
     */
    'save-mode'?: boolean;
}
...
export interface Widgets {
    ...
    GeditTab: {
        class: Gedit.Tab;
        props: GeditTabProps;
        signals: Gedit.Tab.SignalSignatures;
        constructOnly: GeditTabConstructOnly;
        slotCandidates: {
    ...
    GeditView: {
        class: Gedit.View;
        props: GeditViewProps;
        signals: Gedit.View.SignalSignatures;
        constructOnly: GeditViewConstructOnly;
        slotCandidates: {};
    };
    GeditWindow: {
        class: Gedit.Window;
        props: GeditWindowProps;
        signals: Gedit.Window.SignalSignatures;
        constructOnly: GeditWindowConstructOnly;
        slotCandidates: {

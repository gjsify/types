...
static ["new"](): MessageBus;
    ...
    connect_after(signal: 'registered', callback: ((_source: this, object_path: string, method: string) => void)): number
    emit(signal: 'registered', object_path: string, method: string): void
    connect_after(signal: 'unregistered', callback: ((_source: this, object_path: string, method: string) => void)): number

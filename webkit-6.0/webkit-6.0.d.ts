...
static ["new"](): UserContentManager;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'script-message-received', callback: ((_source: this, value: JavaScriptCore.Value) => void)): number
    connect_after(signal: 'script-message-received', callback: ((_source: this, value: JavaScriptCore.Value) => void)): number
    emit(signal: 'script-message-received', value: JavaScriptCore.Value): void
...
static ["new"](): WebContext;
    ...
    connect(signal: 'initialize-web-process-extensions', callback: ((_source: this) => void)): number
    connect_after(signal: 'initialize-web-process-extensions', callback: ((_source: this) => void)): number
    emit(signal: 'initialize-web-process-extensions'): void
...
static ["new"](): WebView;
    ...
    connect_after(signal: 'close', callback: ((_source: this) => void)): number
    emit(signal: 'close'): void
    connect(signal: 'context-menu', callback: ((_source: this, context_menu: ContextMenu, hit_test_result: HitTestResult) => boolean)): number
    connect_after(signal: 'context-menu', callback: ((_source: this, context_menu: ContextMenu, hit_test_result: HitTestResult) => boolean)): number
    emit(signal: 'context-menu', context_menu: ContextMenu, hit_test_result: HitTestResult): void
    ...
    connect(signal: 'show-option-menu', callback: ((_source: this, menu: OptionMenu, rectangle: Gdk.Rectangle) => boolean)): number
    connect_after(signal: 'show-option-menu', callback: ((_source: this, menu: OptionMenu, rectangle: Gdk.Rectangle) => boolean)): number
    emit(signal: 'show-option-menu', menu: OptionMenu, rectangle: Gdk.Rectangle): void

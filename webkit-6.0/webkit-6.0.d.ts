...
export namespace WebKit {
    ...
    class FindController extends GObject.Object {
         ...
         * @read-only
         * @default WebKit.FindOptions.NONE
         */
    ...
    abstract class InputMethodContext extends GObject.Object {
         ...
         * @since 2.28
         * @default WebKit.InputHints.NONE
         */
         ...
         * @since 2.28
         * @default WebKit.InputPurpose.FREE_FORM
         */
    ...
    class NetworkSession extends GObject.Object {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof NetworkSession.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, NetworkSession.SignalSignatures[K]>): number;

        /** @signal */
        connect_after<K extends keyof NetworkSession.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, NetworkSession.SignalSignatures[K]>): number;

        /** @signal */
        emit<K extends keyof NetworkSession.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<NetworkSession.SignalSignatures[K]>): void;
    ...
    class Settings extends GObject.Object {
         ...
         * @since 2.16
         * @default WebKit.HardwareAccelerationPolicy.ALWAYS
         */
    ...
    class WebView extends WebViewBase implements Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget {
         ...
         * @since 2.38
         * @construct-only
         * @default WebKit.WebExtensionMode.NONE
         */

 ...
 *
 * GENERATED — do not edit. Provenance: WebKit-6.0 — library 2.52.1 — dropped empty base(s): GObject.InitiallyUnowned GObject.Object
 *
...
import type { GtkAccessibleConstructOnly, GtkAccessibleProps, GtkBuildableConstructOnly, GtkBuildableProps, GtkConstraintTargetConstructOnly, GtkConstraintTargetProps, GtkWidgetConstructOnly, GtkWidgetProps } from '@girs/gtk-4.0/surface';
...
export type WebKitHardwareAccelerationPolicyNick = 'always' | 'never';
...
export type WebKitXRSessionModeNick = 'inline' | 'immersive-vr' | 'immersive-ar';
...
export interface WebKitWebViewProps extends WebKitWebViewBaseProps, GtkAccessibleProps, GtkBuildableProps, GtkConstraintTargetProps {
     ...
     * @since 2.28
     */
    'automation-presentation-type'?: WebKitAutomationBrowsingContextPresentationNick | WebKit.AutomationBrowsingContextPresentation;
    /**
     * Capture state of the camera device.
     * @since 2.34
     */
    'camera-capture-state'?: WebKitMediaCaptureStateNick | WebKit.MediaCaptureState;
    /**
     ...
     * @since 2.34
     */
    'display-capture-state'?: WebKitMediaCaptureStateNick | WebKit.MediaCaptureState;
    /**
     ...
     * @since 2.34
     */
    'microphone-capture-state'?: WebKitMediaCaptureStateNick | WebKit.MediaCaptureState;
    /**
     ...
     * @since 2.6
     */
    'user-content-manager'?: WebKit.UserContentManager;
    /** The #WebKitWebContext of the view. */
    'web-context'?: WebKit.WebContext;
    /**
     * This configures @web_view to treat the content as a WebExtension.
     * @since 2.38
     */
    'web-extension-mode'?: WebKitWebExtensionModeNick | WebKit.WebExtensionMode;
    /**
     * The #WebKitWebsitePolicies for the view.
     * @since 2.30
     */
    'website-policies'?: WebKit.WebsitePolicies;
    /** The zoom level of the #WebKitWebView content. */
    'zoom-level'?: number;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type WebKitWebViewConstructOnly = WebKitWebViewBaseConstructOnly | GtkAccessibleConstructOnly | GtkBuildableConstructOnly | GtkConstraintTargetConstructOnly | 'automation-presentation-type' | 'default-content-security-policy' | 'is-controlled-by-automation' | 'network-session' | 'related-view' | 'user-content-manager' | 'web-context' | 'web-extension-mode' | 'website-policies';
...
export interface Widgets {
    ...
    WebKitWebViewBase: {
        class: WebKit.WebViewBase;
        props: WebKitWebViewBaseProps;
        signals: WebKit.WebViewBase.SignalSignatures;

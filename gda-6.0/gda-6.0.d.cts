...
export function column_attributes_from_string(str: string | null): ColumnAttributes
...
export function foreign_key_match_from_string(str: string | null): ForeignKeyMatch
...
export function foreign_key_rule_from_string(str: string | null): ForeignKeyRule
...
export function parse_formatted_time(value: string | null, sep: number): Time
/**
 ...
 */
export function parse_formatted_timestamp(value: string | null, first: GLib.DateDMY, second: GLib.DateDMY, third: GLib.DateDMY, sep: number): GLib.DateTime | null
/**
 ...
 */
export function parse_iso8601_time(value: string | null): Time
 ...
 */
export function sql_identifier_force_quotes(str: string | null): string | null
/**
 ...
 */
export function sql_statement_string_to_type(type: string | null): SqlStatementType
/**
 ...
 */
export function sql_statement_type_to_string(type: SqlStatementType): string | null
/**
 ...
 * @returns the newly created #GValue. Free-function: gda_value_free
 */
export function value_new_blob_from_file(filename: string | null): any
/**
 ...
 */
export function value_new_from_string(as_string: string | null, type: GObject.GType): any
/**
 ...
 */
export function value_set_from_string(value: any, as_string: string | null, type: GObject.GType): boolean
/**

...
export function clutter_winsys_has_feature(feature: WinsysFeature): boolean
/**
 ...
 */
export function create_program(): Program
/**
 ...
 */
export function create_shader(shader_type: ShaderType): Shader
/**
 ...
 */
export function graphene_matrix_project_point(matrix: Graphene.Matrix, x: number, y: number, z: number, w: number): [ /* x */ number, /* y */ number, /* z */ number, /* w */ number ]
/**
 ...
 */
export function graphene_matrix_project_points(matrix: Graphene.Matrix, n_components: number, stride_in: number, points_in: any | null, stride_out: number, points_out: any | null, n_points: number): void
/**
 ...
 * @param n_points The number of points to transform.
 */
export function graphene_matrix_transform_points(matrix: Graphene.Matrix, n_components: number, stride_in: number, points_in: any | null, stride_out: number, points_out: any | null, n_points: number): void
/**
 ...
 */
export function meta_texture_foreach_in_region(texture: Texture, tx_1: number, ty_1: number, tx_2: number, ty_2: number, wrap_s: PipelineWrapMode, wrap_t: PipelineWrapMode, callback: MetaTextureCallback): void
/**
...
export function set_tracing_enabled_on_thread(data: any | null, group: string): void

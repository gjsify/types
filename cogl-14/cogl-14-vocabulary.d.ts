/**
 * The GIR-derived widget VOCABULARY for Cogl-14.
 *
 * GENERATED — do not edit. Provenance: Cogl-14 — prop(s) no TypeScript value satisfies: Cogl.Framebuffer.driver-config Cogl.Texture.loader
 *
 * 26 instantiable GTypes (of which 0 concrete widgets), 29 declarations, 4 enum nick unions, 0 slot candidates.
 *
...
import type Cogl from './cogl-14.js';
...
export type CoglBufferErrorNick = 'map';
...
export interface CoglOnscreenTemplateProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type CoglOnscreenTemplateConstructOnly = GObjectConstructOnly;

/** Information about an output device The #CoglOutput object holds information about an output device such as a monitor or laptop display. */
export interface CoglOutputProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type CoglOutputConstructOnly = GObjectConstructOnly;
...
export interface CoglSwapChainProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type CoglSwapChainConstructOnly = GObjectConstructOnly;

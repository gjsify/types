// The widget vocabulary of Cogl-14 as runtime data.
//
...
export const DECLS = {
    ...
    CoglOnscreenTemplate: ['CoglOnscreenTemplate', 'GObject'],
    CoglOutput: ['CoglOutput', 'GObject'],
    ...
    CoglSwapChain: ['CoglSwapChain', 'GObject'],

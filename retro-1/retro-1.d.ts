...
export namespace Retro {
    ...
    class ControllerIterator extends GObject.Object {
        // Owm methods of Retro-1.ControllerIterator
    ...
    class Core extends GObject.Object {
        // Own properties of Retro-1.Core
        ...
        // Constructors of Retro-1.Core

        static ['new'](filename: string): Core;

        // Owm methods of Retro-1.Core
    ...
    class CoreDescriptor extends GObject.Object {
        // Constructors of Retro-1.CoreDescriptor

        static ['new'](filename: string): CoreDescriptor;

        // Owm methods of Retro-1.CoreDescriptor
    ...
    class CoreView extends Gtk.EventBox {
        // Own properties of Retro-1.CoreView
        ...
        // Constructors of Retro-1.CoreView

        static ['new'](): CoreView;

        // Owm methods of Retro-1.CoreView
    ...
    class KeyJoypadMapping extends GObject.Object {
        // Constructors of Retro-1.KeyJoypadMapping

        static ['new'](): KeyJoypadMapping;

        static new_default(): KeyJoypadMapping;

        // Owm methods of Retro-1.KeyJoypadMapping
    ...
    class ModuleIterator extends GObject.Object {
        // Constructors of Retro-1.ModuleIterator

        static ['new'](lookup_paths: string[], recursive: boolean): ModuleIterator;

        // Owm methods of Retro-1.ModuleIterator
    ...
    class ModuleQuery extends GObject.Object {
        // Constructors of Retro-1.ModuleQuery

        static ['new'](recursive: boolean): ModuleQuery;

        // Owm methods of Retro-1.ModuleQuery
    ...
    class OptionIterator extends GObject.Object {
        // Owm methods of Retro-1.OptionIterator
    ...
    class Pixdata {
        // Owm methods of Retro-1.Pixdata
    ...
    class Input {
        // Constructors of Retro-1.Input

        constructor(properties?: Partial<{}>);

        static ['new'](): Input;

        // Owm methods of Retro-1.Input
    ...
    interface Controller {
        // Owm methods of Retro-1.Controller
        ...
        // Own virtual methods of Retro-1.Controller

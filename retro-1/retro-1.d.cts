 ...
 */
export function g_log(sender: Core, log_domain: string | null, log_level: GLib.LogLevelFlags, message: string | null): void
 ...
 */
export function video_filter_from_string(filter: string | null): VideoFilter

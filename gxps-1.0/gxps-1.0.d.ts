...
export namespace Gxps {
    ...
    class Error extends GLib.Error {
        ...
        // Constructors of Gxps-1.0.Error
    ...
    class CoreProperties extends GObject.Object {
        // Own properties of Gxps-1.0.CoreProperties

        source: string;

        // Owm methods of Gxps-1.0.CoreProperties
    ...
    class Document extends GObject.Object {
        // Own properties of Gxps-1.0.Document

        source: string;

        // Owm methods of Gxps-1.0.Document
    ...
    class DocumentStructure extends GObject.Object {
        // Own properties of Gxps-1.0.DocumentStructure

        source: string;

        // Owm methods of Gxps-1.0.DocumentStructure
    ...
    class File extends GObject.Object {
        // Own properties of Gxps-1.0.File

        file: Gio.File;

        // Constructors of Gxps-1.0.File

        static ['new'](filename: Gio.File): File;

        // Owm methods of Gxps-1.0.File
    ...
    class Page extends GObject.Object {
        // Own properties of Gxps-1.0.Page

        source: string;

        // Owm methods of Gxps-1.0.Page
     ...
     */
    class LinkTarget {
        // Owm methods of Gxps-1.0.LinkTarget
     ...
     */
    class OutlineIter {
        // Constructors of Gxps-1.0.OutlineIter

        constructor(properties?: Partial<{}>);

        // Owm methods of Gxps-1.0.OutlineIter

...
export const ENUM_VALUES = {
    ...
    'XAppIconSize.48': 48,
    'XAppIconSize.96': 96,
    'XAppScrollDirection.down': 1,
    'XAppScrollDirection.left': 2,
    'XAppScrollDirection.right': 3,
    'XAppScrollDirection.up': 0,
    'XAppStatusIconState.fallback': 1,
    'XAppStatusIconState.native': 0,
    'XAppStatusIconState.no-support': 2,
};
...
export const PROP_TYPES = {
    'GDBusInterfaceSkeleton.g-flags': 'GDBusInterfaceSkeletonFlags',
    'XAppIconChooserButton.category': 'gchararray',
    'XAppIconChooserButton.icon': 'gchararray',
    'XAppIconChooserButton.icon-size': 'GtkIconSize',
    'XAppIconChooserDialog.allow-paths': 'gboolean',
    'XAppIconChooserDialog.default-icon': 'gchararray',
    'XAppIconChooserDialog.icon-size': 'XAppIconSize',
    'XAppObject.status-icon-interface': 'XAppStatusIconInterface',
    'XAppStackSidebar.stack': 'GtkStack',
    'XAppStatusIcon.icon-size': 'gint',
    'XAppStatusIcon.name': 'gchararray',
    'XAppStatusIcon.primary-menu': 'GtkWidget',
    'XAppStatusIcon.secondary-menu': 'GtkWidget',
    'XAppStatusIconInterface.icon-name': 'gchararray',
    'XAppStatusIconInterface.icon-size': 'gint',
    'XAppStatusIconInterface.label': 'gchararray',
    'XAppStatusIconInterface.metadata': 'gchararray',
    'XAppStatusIconInterface.name': 'gchararray',
    'XAppStatusIconInterface.primary-menu-is-open': 'gboolean',
    'XAppStatusIconInterface.secondary-menu-is-open': 'gboolean',
    'XAppStatusIconInterface.tooltip-text': 'gchararray',
    'XAppStatusIconInterface.visible': 'gboolean',
    'XAppStyleManager.widget': 'GtkWidget',
    'XAppSwitcherooControl.has-dual-gpu': 'gboolean',
    'XAppSwitcherooControl.num-gpus': 'guint',
};

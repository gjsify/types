/**
 * The GIR-derived widget VOCABULARY for Clutter-14.
 *
 * GENERATED — do not edit. Provenance: Clutter-14 — dropped empty base(s): Atk.ImplementorIface
 *
 * 58 instantiable GTypes (of which 0 concrete widgets), 69 declarations, 43 enum nick unions, 0 slot candidates.
 *
...
import type Clutter from './clutter-14.js';
...
export type ClutterColorspaceNick = 'unknown' | 'srgb' | 'bt2020';
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type ClutterActorConstructOnly = GInitiallyUnownedConstructOnly | ClutterAnimatableConstructOnly;
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type ClutterColorStateConstructOnly = GObjectConstructOnly | 'colorspace';
...
export interface ClutterDeformEffectProps extends ClutterOffscreenEffectProps {
    /** A material to be used when painting the back of the actor to which this effect has been applied By default, no material will be used */
    'back-material'?: Cogl.Pipeline;
    /**
...
/** An actor for displaying a portion of its children #ClutterScrollActor is an actor that can be used to display a portion of the contents of its children. */
export interface ClutterScrollActorProps extends ClutterActorProps, ClutterAnimatableProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type ClutterScrollActorConstructOnly = ClutterActorConstructOnly | ClutterAnimatableConstructOnly;
...
/** Maintains the list of stages #ClutterStageManager is a singleton object, owned by Clutter, which maintains the list of currently active stages Every newly-created [class@Stage] will cause the emissio… */
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type ClutterStageViewConstructOnly = GObjectConstructOnly | 'name' | 'offscreen' | 'stage' | 'use-shadowfb' | 'vblank-duration-us';

...
export namespace Clutter {
    ...
    abstract class LayoutManager extends GObject.InitiallyUnowned {
         ...
         */
        child_get_property(container: Actor, actor: Actor, property_name: string, value: GObject.Value): void;
        /**
         ...
         */
        child_set_property(container: Actor, actor: Actor, property_name: string, value: GObject.Value): void;
        /**

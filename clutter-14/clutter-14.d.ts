...
module Actor {
     ...
     */
    interface ClonedSignalCallback {
     ...
     */
    interface DeclonedSignalCallback {
        ($obj: Actor, object: Clone): void
    }
    ...
    interface ConstructorProperties extends Atk.ImplementorIface.ConstructorProperties, Animatable.ConstructorProperties, GObject.InitiallyUnowned.ConstructorProperties {
...
module Clone {
    ...
    interface ConstructorProperties extends Atk.ImplementorIface.ConstructorProperties, Animatable.ConstructorProperties, Actor.ConstructorProperties {
...
interface Clone extends Atk.ImplementorIface, Animatable {
...
module Gesture {
     ...
     */
    interface MayRecognizeSignalCallback {
        ($obj: Gesture): boolean
    }
     ...
     */
    interface RecognizeSignalCallback {
        ($obj: Gesture): void
    }
     ...
     */
    interface ShouldHandleSequenceSignalCallback {
...
module KeyframeTransition {
    ...
    interface ConstructorProperties extends PropertyTransition.ConstructorProperties {
    }
 ...
 * @class 
 */
class LayoutMeta extends GObject.Object {
...
module PropertyTransition {
    ...
    interface ConstructorProperties extends Transition.ConstructorProperties {
...
interface ScrollActor extends Atk.ImplementorIface, Animatable {
...
interface Stage extends Atk.ImplementorIface, Animatable {
...
interface Text extends Atk.ImplementorIface, Animatable {
...
module Transition {
    ...
    interface ConstructorProperties extends Timeline.ConstructorProperties {

...
import './gstvideo-1.0-ambient.d.ts';
import './gstvideo-1.0-import.d.ts';
/**
 * GstVideo-1.0
 */
 ...
 */
export function buffer_add_video_sei_user_data_unregistered_meta(buffer: Gst.Buffer, uuid: number, data: number, size: number): VideoSEIUserDataUnregisteredMeta
/**
 ...
 * @returns the #GstVideoTimeCodeMeta on @buffer, or (since 1.16) %NULL if the timecode was invalid.
 */
export function buffer_add_video_time_code_meta_full(buffer: Gst.Buffer, fps_n: number, fps_d: number, latest_daily_jam: GLib.DateTime, flags: VideoTimeCodeFlags, hours: number, minutes: number, seconds: number, frames: number, field_count: number): VideoTimeCodeMeta | null
/**
 ...
 */
export function buffer_get_video_region_of_interest_meta_id(buffer: Gst.Buffer, id: number): VideoRegionOfInterestMeta | null
/**
 ...
 */
export function navigation_event_get_coordinates(event: Gst.Event): [ /* returnType */ boolean, /* x */ number, /* y */ number ]
/**
 ...
 * @returns a new #GstEvent
 */
export function navigation_event_new_mouse_button_press(button: number, x: number, y: number, state: NavigationModifierType): Gst.Event
/**
 ...
 * @returns a new #GstEvent
 */
export function navigation_event_new_mouse_button_release(button: number, x: number, y: number, state: NavigationModifierType): Gst.Event
/**
 ...
 * @returns a new #GstEvent
 */
export function navigation_event_new_mouse_scroll(x: number, y: number, delta_x: number, delta_y: number, state: NavigationModifierType): Gst.Event
/**
 ...
 * @returns a new #GstEvent
 */
export function navigation_event_new_touch_down(identifier: number, x: number, y: number, pressure: number, state: NavigationModifierType): Gst.Event
/**
 ...
 * @returns a new #GstEvent
 */
export function navigation_event_new_touch_motion(identifier: number, x: number, y: number, pressure: number, state: NavigationModifierType): Gst.Event
/**
 ...
 * @returns a new #GstEvent
 */
export function navigation_event_new_touch_up(identifier: number, x: number, y: number, state: NavigationModifierType): Gst.Event
/**
 ...
 */
export function navigation_event_parse_command(event: Gst.Event): [ /* returnType */ boolean, /* command */ NavigationCommand ]
/**
 ...
 */
export function navigation_event_parse_mouse_button_event(event: Gst.Event): [ /* returnType */ boolean, /* button */ number, /* x */ number, /* y */ number ]
/**
 ...
 */
export function navigation_event_parse_mouse_move_event(event: Gst.Event): [ /* returnType */ boolean, /* x */ number, /* y */ number ]
/**
 ...
 */
export function navigation_event_parse_mouse_scroll_event(event: Gst.Event): [ /* returnType */ boolean, /* x */ number, /* y */ number, /* delta_x */ number, /* delta_y */ number ]
/**
 ...
 */
export function navigation_event_parse_touch_event(event: Gst.Event): [ /* returnType */ boolean, /* identifier */ number, /* x */ number, /* y */ number, /* pressure */ number ]
/**
 * Retrieve the details of a #GstNavigation touch-up event.
 * @param event A #GstEvent to inspect.
 * @returns TRUE if all details could be extracted, otherwise FALSE.
 */
export function navigation_event_parse_touch_up_event(event: Gst.Event): [ /* returnType */ boolean, /* identifier */ number, /* x */ number, /* y */ number ]
/**
 ...
 */
export function navigation_message_parse_angles_changed(message: Gst.Message): [ /* returnType */ boolean, /* cur_angle */ number, /* n_angles */ number ]
/**
 ...
 * @returns %TRUE if the message could be successfully parsed. %FALSE if not.
 */
export function navigation_message_parse_event(message: Gst.Message): [ /* returnType */ boolean, /* event */ Gst.Event ]
/**
 ...
 * @returns %TRUE if the message could be successfully parsed. %FALSE if not.
 */
export function navigation_message_parse_mouse_over(message: Gst.Message): [ /* returnType */ boolean, /* active */ boolean ]
/**
 ...
 */
export function navigation_query_parse_angles(query: Gst.Query): [ /* returnType */ boolean, /* cur_angle */ number, /* n_angles */ number ]
/**
 * Parse the number of commands in the #GstNavigation commands `query`.
 * @param query a #GstQuery
 * @returns %TRUE if the query could be successfully parsed. %FALSE if not.
 */
export function navigation_query_parse_commands_length(query: Gst.Query): [ /* returnType */ boolean, /* n_cmds */ number ]
/**
 ...
 * @returns %TRUE if the query could be successfully parsed. %FALSE if not.
 */
export function navigation_query_parse_commands_nth(query: Gst.Query, nth: number): [ /* returnType */ boolean, /* cmd */ NavigationCommand ]
/**
 ...
 */
export function video_color_primaries_is_equivalent(primaries: VideoColorPrimaries, other: VideoColorPrimaries): boolean
/**
 ...
 */
export function video_convert_sample(sample: Gst.Sample, to_caps: Gst.Caps, timeout: Gst.ClockTime): Gst.Sample | null
/**
 * Converts a raw video buffer into the specified output caps.
 * 
 * The output caps can be any raw video formats or any image formats (jpeg, png, ...).
 ...
 */
export function video_dma_drm_fourcc_from_format(format: VideoFormat): number
/**
 ...
 */
export function video_dma_drm_fourcc_to_format(fourcc: number): VideoFormat
/**
 ...
 */
export function video_dma_drm_fourcc_to_string(fourcc: number, modifier: number): string | null
/**
 ...
 */
export function video_format_get_palette(format: VideoFormat): [ /* returnType */ any | null, /* size */ number ]
/**
 ...
 */
export function video_guess_framerate(duration: Gst.ClockTime): [ /* returnType */ boolean, /* dest_n */ number, /* dest_d */ number ]
/**
 ...
 */
export function video_info_dma_drm_from_caps(caps: Gst.Caps): [ /* returnType */ boolean, /* drm_info */ VideoInfoDmaDrm ]
/**
 ...
 */
export function video_info_dma_drm_from_video_info(info: VideoInfo, modifier: number): [ /* returnType */ boolean, /* drm_info */ VideoInfoDmaDrm ]
/**
 * Initialize `drm_info` with default values.
 */
export function video_info_dma_drm_init(): /* drm_info */ VideoInfoDmaDrm
/**
 ...
 */
export function video_is_dma_drm_caps(caps: Gst.Caps): boolean
/**
 ...
 */
export function video_sei_user_data_unregistered_parse_precision_time_stamp(user_data: VideoSEIUserDataUnregisteredMeta): [ /* returnType */ boolean, /* status */ number, /* precision_time_stamp */ number ]
/**
...
export class VideoInfoDmaDrm {
     ...
     * @returns TRUE if @caps could be parsed
     */
    static from_caps(caps: Gst.Caps): [ /* returnType */ boolean, /* drm_info */ VideoInfoDmaDrm ]
    /**
     * Fills `drm_info` if `info'`s format has a valid drm format and `modifier` is also
     * valid
     * @param info a #GstVideoInfo
     ...
     * @returns %TRUE if @drm_info is filled correctly.
     */
    static from_video_info(info: VideoInfo, modifier: number): [ /* returnType */ boolean, /* drm_info */ VideoInfoDmaDrm ]
    /**
     * Initialize `drm_info` with default values.
     */
    static init(): /* drm_info */ VideoInfoDmaDrm
}

...
export namespace GstVideo {
     ...
     */
    function video_info_dma_drm_from_caps(caps: Gst.Caps): boolean;
    /**
     ...
     */
    function video_info_dma_drm_from_video_info(info: VideoInfo, modifier: number): boolean;
    /**
     * Initialize `drm_info` with default values.
     */
    function video_info_dma_drm_init(): void;
    /**
    ...
    class VideoInfoDmaDrm {
        // Own fields of GstVideo-1.0.VideoInfoDmaDrm

        drm_fourcc: number;
        drm_modifier: number;

        // Constructors of GstVideo-1.0.VideoInfoDmaDrm
        ...
        // Owm methods of GstVideo-1.0.VideoInfoDmaDrm
         ...
         * @param modifier the associated modifier value.
         */
        static from_video_info(info: VideoInfo, modifier: number): boolean;
        /**
         * Initialize `drm_info` with default values.
         */
        static init(): void;

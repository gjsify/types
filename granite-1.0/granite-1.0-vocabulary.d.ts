...
export interface GraniteWidgetsCellRendererBadgeProps extends GtkCellRendererProps {
    text?: string;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GraniteWidgetsCellRendererBadgeConstructOnly = GtkCellRendererConstructOnly;

export interface GraniteWidgetsCellRendererExpanderProps extends GtkCellRendererProps {
    'is-category-expander'?: boolean;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GraniteWidgetsCellRendererExpanderConstructOnly = GtkCellRendererConstructOnly;
...
export interface GraniteWidgetsSourceListExpandableItemProps extends GraniteWidgetsSourceListItemProps {
    collapsible?: boolean;
    expanded?: boolean;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
...
export interface GraniteWidgetsSourceListItemProps {
    ...
    markup?: string | null;
    name?: string;
    parent?: Granite.WidgetsSourceListExpandableItem;
    selectable?: boolean;
    tooltip?: string | null;
    visible?: boolean;
}

...
static new_for_name_full(name: string, application: string, domain: string): Consumer;
    ...
    connect(signal: 'publisher-resolved', callback: ((_source: this, object: Protocol, p0: string, p1: number) => void)): number
    connect_after(signal: 'publisher-resolved', callback: ((_source: this, object: Protocol, p0: string, p1: number) => void)): number
...
static new_for_types_strv(domain: string, types: string): ServiceMonitor;
    ...
    connect_after(signal: 'service-found', callback: ((_source: this, object: string, p0: ServiceInfo) => void)): number

/**
 * The GIR-derived widget VOCABULARY for GCab-1.0.
 *
 * GENERATED — do not edit. Provenance: GCab-1.0
 *
 * 3 instantiable GTypes (of which 0 concrete widgets), 3 declarations, 2 enum nick unions, 0 slot candidates.
 *
...
export type GCabCompressionNick = 'none' | 'mszip' | 'quantum' | 'lzx' | 'mask';
export type GCabFileAttributeNick = 'rdonly' | 'hidden' | 'system' | 'arch' | 'exec' | 'name-is-utf';
...
export interface GCabCabinetProps extends GObjectProps {
    reserved?: Uint8Array[];
    signature?: Uint8Array[];
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GCabCabinetConstructOnly = GObjectConstructOnly;

/** An opaque object, referencing a file in a Cabinet. */
export interface GCabFileProps extends GObjectProps {
    bytes?: GLib.Bytes;
    file?: Gio.File;
    /** @default NULL */
    name?: string;
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GCabFileConstructOnly = GObjectConstructOnly;

/** An opaque object, referencing a folder in a Cabinet. */
export interface GCabFolderProps extends GObjectProps {
    /** @default 0 */
    comptype?: number;
    reserved?: Uint8Array[];
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GCabFolderConstructOnly = GObjectConstructOnly | 'comptype';

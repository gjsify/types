...
GJS TypeScript type definitions for XreaderDocument-1.5, generated from library version 4.0.2 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v4.0.0-beta.5.

...
GJS TypeScript type definitions for XreaderDocument-1.5, generated from library version 4.6.4 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v5.2.0.

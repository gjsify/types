// The widget vocabulary of XreaderDocument-1.5 as runtime data.
//
...
export const PROVENANCE = {
    ...
    version: '1.5',
    libraryVersion: '4.6.4',
    childHolders: 0,
    droppedBases: [],
    inlinedBases: [],
    unsettableProps: ['XreaderDocument.Annotation.color', 'XreaderDocument.Attachment.data', 'XreaderDocument.LinkAction.hide-list', 'XreaderDocument.LinkAction.show-list', 'XreaderDocument.LinkAction.toggle-list'],
    unresolvedProps: [],
...
export const PROP_TYPES = {
    ...
    'EvAnnotationMarkup.can-have-popup': 'gboolean',

...
export const PROP_TYPES = {
    'GXmlBaseProperty.value': 'gchararray',
    'GXmlCollection.element': 'GXmlDomElement',
    'GXmlCollection.items-type': 'GType',
    'GXmlCssAttributeSelector.local-name': 'gchararray',
    'GXmlCssAttributeSelector.prefix': 'gchararray',
    'GXmlCssElementSelector.local-name': 'gchararray',
    'GXmlCssElementSelector.prefix': 'gchararray',
    'GXmlCssSelector.combiner': 'GXmlCssCombiner',
    'GXmlCssSelector.name': 'gchararray',
    'GXmlCssSelector.selector-type': 'GXmlCssSelectorType',
    'GXmlCssSelector.value': 'gchararray',
    'GXmlDateTime.format': 'gchararray',
    ...
    'GXmlDouble.decimals': 'guint',
    'GXmlElement.parse-children': 'gboolean',
    'GXmlElement.read-buffer': 'GMemoryOutputStream',
    'GXmlElement.unparsed': 'gchararray',
    'GXmlEnum.camel-case': 'gboolean',
    'GXmlEnum.enum-type': 'GType',
    'GXmlEnum.upper-case': 'gboolean',
    'GXmlEnum.use-nick': 'gboolean',
    'GXmlHtmlDocument.html': 'GXmlDomElement',
    ...
    'GXmlParser.cancellable': 'GCancellable',
    'GXmlParser.indent': 'gboolean',
    'GXmlProperty.value': 'gchararray',
    ...
    'GXmlXCharacterData.str': 'gchararray',
    'GXmlXDocument.backup': 'gboolean',
    'GXmlXDocument.file': 'GFile',
    'GXmlXDocument.indent': 'gboolean',
    'GXmlXDocument.ns-top': 'gboolean',
    'GXmlXDocument.prefix-default-ns': 'gboolean',
    'GXmlXElement.content': 'gchararray',
    'GXmlXNode.value': 'gchararray',
    'GXmlXProcessingInstruction.data': 'gchararray',
    'GXmlXsdArrayString.simple-type': 'gchararray',
    'GXmlXsdArrayString.source': 'GFile',
    'GXmlXsdBaseAttribute.anotation': 'GXmlXsdAnnotation',
    'GXmlXsdBaseContent.anotation': 'GXmlXsdAnnotation',
    'GXmlXsdBaseType.anotation': 'GXmlXsdAnnotation',
    'GXmlXsdComplexType.abstract': 'gboolean',
    'GXmlXsdComplexType.block': 'gchararray',
    'GXmlXsdComplexType.content-type': 'GXmlXsdBaseContent',
    'GXmlXsdComplexType.default-attributes-apply': 'gboolean',
    'GXmlXsdComplexType.final': 'gchararray',
    'GXmlXsdComplexType.mixed': 'gboolean',
    'GXmlXsdComplexType.name': 'gchararray',
    'GXmlXsdElement.abstract': 'gboolean',
    'GXmlXsdElement.anotation': 'GXmlXsdAnnotation',
    'GXmlXsdElement.block': 'gchararray',
    'GXmlXsdElement.complex-type': 'GXmlXsdComplexType',
    'GXmlXsdElement.default': 'gchararray',
    'GXmlXsdElement.final': 'gchararray',
    'GXmlXsdElement.fixed': 'gchararray',
    'GXmlXsdElement.form': 'gchararray',
    'GXmlXsdElement.max-occurs': 'gchararray',
    'GXmlXsdElement.min-occurs': 'gchararray',
    'GXmlXsdElement.name': 'gchararray',
    'GXmlXsdElement.nillable': 'gboolean',
    'GXmlXsdElement.object-type': 'gchararray',
    'GXmlXsdElement.ref': 'gchararray',
    'GXmlXsdElement.simple-type': 'GXmlXsdSimpleType',
    'GXmlXsdElement.substitution-group': 'GXmlDomTokenList',
    'GXmlXsdElement.target-namespace': 'gchararray',
    'GXmlXsdExtension.base': 'gchararray',
    'GXmlXsdSchema.complex-type-definitions': 'GXmlXsdListComplexTypes',
    'GXmlXsdSchema.element-definitions': 'GXmlXsdListElements',
    'GXmlXsdSchema.simple-type-definitions': 'GXmlXsdListSimpleTypes',
    'GXmlXsdSimpleType.annotation': 'GXmlXsdAnnotation',
    'GXmlXsdSimpleType.final': 'gchararray',
    'GXmlXsdSimpleType.list': 'GXmlXsdTypeList',
    'GXmlXsdSimpleType.name': 'gchararray',
    'GXmlXsdSimpleType.restriction': 'GXmlXsdTypeRestriction',
    'GXmlXsdSimpleType.union': 'GXmlXsdTypeUnion',
    'GXmlXsdTypeDefinition.annotation': 'GXmlXsdAnnotation',
    'GXmlXsdTypeRestriction.base': 'gchararray',
    'GXmlXsdTypeRestriction.enumerations': 'GXmlXsdListTypeRestrictionEnumerations',
    'GXmlXsdTypeRestriction.simple-type': 'GXmlXsdSimpleType',
    'GXmlXsdTypeRestriction.white-spaces': 'GXmlXsdListTypeRestrictionWhiteSpaces',
    'GXmlXsdTypeRestrictionDef.annotation': 'GXmlXsdAnnotation',
    'GXmlXsdTypeRestrictionEnumeration.value': 'gchararray',
    'GXmlXsdTypeRestrictionWhiteSpace.fixed': 'GXmlXsdTypeRestrictionWhiteSpaceFixed',
    'GXmlXsdTypeRestrictionWhiteSpace.value': 'gchararray',

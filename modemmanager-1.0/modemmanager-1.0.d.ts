...
class CdmaActivationError extends GLib.Error {
    ...
    // Own fields of ModemManager-1.0.CdmaActivationError

NONE: number
UNKNOWN: number
ROAMING: number
WRONGRADIOINTERFACE: number
COULDNOTCONNECT: number
SECURITYAUTHENTICATIONFAILED: number
PROVISIONINGFAILED: number
NOSIGNAL: number
TIMEDOUT: number
STARTFAILED: number

    // Constructors of ModemManager-1.0.CdmaActivationError

constructor(options: { message: string, code: number});

    // Owm methods of ModemManager-1.0.CdmaActivationError
...
class ConnectionError extends GLib.Error {
    ...
    // Own fields of ModemManager-1.0.ConnectionError
...
NOANSWER: number
    ...
    // Constructors of ModemManager-1.0.ConnectionError

constructor(options: { message: string, code: number});

    // Owm methods of ModemManager-1.0.ConnectionError
...
class CoreError extends GLib.Error {
    ...
    // Own fields of ModemManager-1.0.CoreError
...
RETRY: number
EXISTS: number
WRONGSIMSTATE: number
RESETRETRY: number

    // Constructors of ModemManager-1.0.CoreError

constructor(options: { message: string, code: number});

    // Owm methods of ModemManager-1.0.CoreError
...
class MessageError extends GLib.Error {
    ...
    // Own fields of ModemManager-1.0.MessageError

MEFAILURE: number
SMSSERVICERESERVED: number
NOTALLOWED: number
NOTSUPPORTED: number
INVALIDPDUPARAMETER: number
INVALIDTEXTPARAMETER: number
SIMNOTINSERTED: number
SIMPIN: number
PHSIMPIN: number
SIMFAILURE: number
SIMBUSY: number
...
SIMPIN2: number
SIMPUK2: number
MEMORYFAILURE: number
INVALIDINDEX: number
MEMORYFULL: number
SMSCADDRESSUNKNOWN: number
NONETWORK: number
NETWORKTIMEOUT: number
NOCNMAACKEXPECTED: number
UNKNOWN: number

    // Constructors of ModemManager-1.0.MessageError

constructor(options: { message: string, code: number});

    // Owm methods of ModemManager-1.0.MessageError
...
class MobileEquipmentError extends GLib.Error {
    ...
    // Own fields of ModemManager-1.0.MobileEquipmentError
...
TEXTTOOLONG: number
INVALIDCHARS: number
DIALSTRINGTOOLONG: number
DIALSTRINGINVALID: number
NONETWORK: number
NETWORKTIMEOUT: number
NETWORKNOTALLOWED: number
NETWORKPIN: number
NETWORKPUK: number
NETWORKSUBSETPIN: number
NETWORKSUBSETPUK: number
SERVICEPIN: number
SERVICEPUK: number
CORPPIN: number
CORPPUK: number
HIDDENKEYREQUIRED: number
EAPMETHODNOTSUPPORTED: number
INCORRECTPARAMETERS: number
COMMANDDISABLED: number
COMMANDABORTED: number
NOTATTACHEDRESTRICTED: number
NOTALLOWEDEMERGENCYONLY: number
NOTALLOWEDRESTRICTED: number
FIXEDDIALNUMBERONLY: number
TEMPORARILYOUTOFSERVICE: number
LANGUAGEORALPHABETNOTSUPPORTED: number
UNEXPECTEDDATAVALUE: number
SYSTEMFAILURE: number
DATAMISSING: number
CALLBARRED: number
MESSAGEWAITINGINDICATIONSUBSCRIPTIONFAILURE: number
UNKNOWN: number
IMSIUNKNOWNINHSS: number
ILLEGALUE: number
IMSIUNKNOWNINVLR: number
IMEINOTACCEPTED: number
ILLEGALME: number
PSSERVICESNOTALLOWED: number
PSANDNONPSSERVICESNOTALLOWED: number
UEIDENTITYNOTDERIVEDFROMNETWORK: number
IMPLICITLYDETACHED: number
PLMNNOTALLOWED: number
AREANOTALLOWED: number
ROAMINGNOTALLOWEDINAREA: number
PSSERVICESNOTALLOWEDINPLMN: number
NOCELLSINAREA: number
MSCTEMPORARILYNOTREACHABLE: number
NETWORKFAILUREATTACH: number
CSDOMAINUNAVAILABLE: number
ESMFAILURE: number
CONGESTION: number
MBMSBEARERCAPABILITIESINSUFFICIENTFORSERVICE: number
NOTAUTHORIZEDFORCSG: number
INSUFFICIENTRESOURCES: number
MISSINGORUNKNOWNAPN: number
UNKNOWNPDPADDRESSORTYPE: number
USERAUTHENTICATIONFAILED: number
ACTIVATIONREJECTEDBYGGSNORGW: number
ACTIVATIONREJECTEDUNSPECIFIED: number
SERVICEOPTIONNOTSUPPORTED: number
SERVICEOPTIONNOTSUBSCRIBED: number
SERVICEOPTIONOUTOFORDER: number
NSAPIORPTIALREADYINUSE: number
REGULARDEACTIVATION: number
QOSNOTACCEPTED: number
CALLCANNOTBEIDENTIFIED: number
CSSERVICETEMPORARILYUNAVAILABLE: number
FEATURENOTSUPPORTED: number
SEMANTICERRORINTFTOPERATION: number
SYNTACTICALERRORINTFTOPERATION: number
UNKNOWNPDPCONTEXT: number
SEMANTICERRORSINPACKETFILTER: number
SYNTACTICALERRORSINPACKETFILTER: number
PDPCONTEXTWITHOUTTFTALREADYACTIVATED: number
MULTICASTGROUPMEMBERSHIPTIMEOUT: number
GPRSUNKNOWN: number
PDPAUTHFAILURE: number
INVALIDMOBILECLASS: number
LASTPDNDISCONNECTIONNOTALLOWEDLEGACY: number
LASTPDNDISCONNECTIONNOTALLOWED: number
SEMANTICALLYINCORRECTMESSAGE: number
INVALIDMANDATORYINFORMATION: number
MESSAGETYPENOTIMPLEMENTED: number
CONDITIONALIEERROR: number
UNSPECIFIEDPROTOCOLERROR: number
OPERATORDETERMINEDBARRING: number
MAXIMUMNUMBEROFBEARERSREACHED: number
REQUESTEDAPNNOTSUPPORTED: number
REQUESTREJECTEDBCMVIOLATION: number
UNSUPPORTEDQCIOR5QIVALUE: number
USERDATAVIACONTROLPLANECONGESTED: number
SMSPROVIDEDVIAGPRSINROUTINGAREA: number
INVALIDPTIVALUE: number
NOBEARERACTIVATED: number
MESSAGENOTCOMPATIBLEWITHPROTOCOLSTATE: number
RECOVERYONTIMEREXPIRY: number
INVALIDTRANSACTIONIDVALUE: number
SERVICEOPTIONNOTAUTHORIZEDINPLMN: number
NETWORKFAILUREACTIVATION: number
REACTIVATIONREQUESTED: number
IPV4ONLYALLOWED: number
IPV6ONLYALLOWED: number
SINGLEADDRESSBEARERSONLYALLOWED: number
COLLISIONWITHNETWORKINITIATEDREQUEST: number
IPV4V6ONLYALLOWED: number
NONIPONLYALLOWED: number
BEARERHANDLINGUNSUPPORTED: number
APNRESTRICTIONINCOMPATIBLE: number
MULTIPLEACCESSTOPDNCONNECTIONNOTALLOWED: number
ESMINFORMATIONNOTRECEIVED: number
PDNCONNECTIONNONEXISTENT: number
MULTIPLEPDNCONNECTIONSAMEAPNNOTALLOWED: number
SEVERENETWORKFAILURE: number
INSUFFICIENTRESOURCESFORSLICEANDDNN: number
UNSUPPORTEDSSCMODE: number
INSUFFICIENTRESOURCESFORSLICE: number
MESSAGETYPENOTCOMPATIBLEWITHPROTOCOLSTATE: number
IENOTIMPLEMENTED: number
N1MODENOTALLOWED: number
RESTRICTEDSERVICEAREA: number
LADNUNAVAILABLE: number
MISSINGORUNKNOWNDNNINSLICE: number
NKGSIALREADYINUSE: number
PAYLOADNOTFORWARDED: number
NON3GPPACCESSTO5GCNNOTALLOWED: number
SERVINGNETWORKNOTAUTHORIZED: number
DNNNOTSUPPORTEDINSLICE: number
INSUFFICIENTUSERPLANERESOURCESFORPDUSESSION: number
OUTOFLADNSERVICEAREA: number
PTIMISMATCH: number
MAXDATARATEFORUSERPLANEINTEGRITYTOOLOW: number
SEMANTICERRORINQOSOPERATION: number
SYNTACTICALERRORINQOSOPERATION: number
INVALIDMAPPEDEPSBEARERIDENTITY: number
REDIRECTIONTO5GCNREQUIRED: number
REDIRECTIONTOEPCREQUIRED: number
TEMPORARILYUNAUTHORIZEDFORSNPN: number
PERMANENTLYUNAUTHORIZEDFORSNPN: number
ETHERNETONLYALLOWED: number
UNAUTHORIZEDFORCAG: number
NONETWORKSLICESAVAILABLE: number
WIRELINEACCESSAREANOTALLOWED: number

    // Constructors of ModemManager-1.0.MobileEquipmentError

constructor(options: { message: string, code: number});

    // Owm methods of ModemManager-1.0.MobileEquipmentError
...
class SerialError extends GLib.Error {
    ...
    // Own fields of ModemManager-1.0.SerialError

UNKNOWN: number
OPENFAILED: number
SENDFAILED: number
RESPONSETIMEOUT: number
OPENFAILEDNODEVICE: number
FLASHFAILED: number
NOTOPEN: number
PARSEFAILED: number
FRAMENOTFOUND: number

    // Constructors of ModemManager-1.0.SerialError

constructor(options: { message: string, code: number});

    // Owm methods of ModemManager-1.0.SerialError
 ...
 */
function gdbus_bearer_override_properties(klass: GObject.ObjectClass, property_id_begin: number): number
/**
 ...
 * @returns The last property id.
 */
function gdbus_call_override_properties(klass: GObject.ObjectClass, property_id_begin: number): number
/**
 ...
 * @returns The last property id.
 */
function gdbus_modem3gpp_override_properties(klass: GObject.ObjectClass, property_id_begin: number): number
/**
 ...
 * @returns The last property id.
 */
function gdbus_modem3gpp_profile_manager_override_properties(klass: GObject.ObjectClass, property_id_begin: number): number
/**
 ...
 * @returns The last property id.
 */
function gdbus_modem3gpp_ussd_override_properties(klass: GObject.ObjectClass, property_id_begin: number): number
/**
 ...
 * @returns The last property id.
 */
function gdbus_modem_cdma_override_properties(klass: GObject.ObjectClass, property_id_begin: number): number
/**
 ...
 * @returns The last property id.
 */
function gdbus_modem_firmware_override_properties(klass: GObject.ObjectClass, property_id_begin: number): number
/**
 ...
 * @returns The last property id.
 */
function gdbus_modem_location_override_properties(klass: GObject.ObjectClass, property_id_begin: number): number
/**
 ...
 * @returns The last property id.
 */
function gdbus_modem_messaging_override_properties(klass: GObject.ObjectClass, property_id_begin: number): number
/**
 ...
 * @returns The last property id.
 */
function gdbus_modem_oma_override_properties(klass: GObject.ObjectClass, property_id_begin: number): number
/**
 ...
 * @returns The last property id.
 */
function gdbus_modem_override_properties(klass: GObject.ObjectClass, property_id_begin: number): number
/**
 ...
 * @returns The last property id.
 */
function gdbus_modem_sar_override_properties(klass: GObject.ObjectClass, property_id_begin: number): number
/**
 ...
 * @returns The last property id.
 */
function gdbus_modem_signal_override_properties(klass: GObject.ObjectClass, property_id_begin: number): number
/**
 ...
 * @returns The last property id.
 */
function gdbus_modem_simple_override_properties(klass: GObject.ObjectClass, property_id_begin: number): number
/**
 ...
 * @returns The last property id.
 */
function gdbus_modem_time_override_properties(klass: GObject.ObjectClass, property_id_begin: number): number
/**
 ...
 * @returns The last property id.
 */
function gdbus_modem_voice_override_properties(klass: GObject.ObjectClass, property_id_begin: number): number
/**
 ...
 * @returns The last property id.
 */
function gdbus_org_freedesktop_modem_manager1_override_properties(klass: GObject.ObjectClass, property_id_begin: number): number
/**
 ...
 * @returns The last property id.
 */
function gdbus_sim_override_properties(klass: GObject.ObjectClass, property_id_begin: number): number
/**
 ...
 * @returns The last property id.
 */
function gdbus_sms_override_properties(klass: GObject.ObjectClass, property_id_begin: number): number
...
class __3gppProfile extends GObject.Object {
    ...
    // Constructors of ModemManager-1.0.__3gppProfile


static ["new"](): __3gppProfile;

    // Owm methods of ModemManager-1.0.__3gppProfile
 ...
 */
class Bearer extends GdbusBearerProxy {

    // Owm methods of ModemManager-1.0.Bearer
...
class BearerIpConfig extends GObject.Object {
    ...
    // Owm methods of ModemManager-1.0.BearerIpConfig
...
class BearerProperties extends GObject.Object {
    ...
    // Constructors of ModemManager-1.0.BearerProperties


static ["new"](): BearerProperties;

    // Owm methods of ModemManager-1.0.BearerProperties
...
class BearerStats extends GObject.Object {
    ...
    // Owm methods of ModemManager-1.0.BearerStats
 ...
 * using the provided API.
 */
class Call extends GdbusCallProxy {

    // Owm methods of ModemManager-1.0.Call
...
class CallAudioFormat extends GObject.Object {
    ...
    // Owm methods of ModemManager-1.0.CallAudioFormat
...
class CallProperties extends GObject.Object {
    ...
    // Constructors of ModemManager-1.0.CallProperties
...
static new_from_string(str: string): CallProperties;
    ...
    // Owm methods of ModemManager-1.0.CallProperties
...
class CdmaManualActivationProperties extends GObject.Object {
    ...
    // Constructors of ModemManager-1.0.CdmaManualActivationProperties


static ["new"](): CdmaManualActivationProperties;

    // Owm methods of ModemManager-1.0.CdmaManualActivationProperties
...
class CellInfo extends GObject.Object {
    ...
    // Owm methods of ModemManager-1.0.CellInfo
...
class CellInfoCdma extends CellInfo {
    ...
    // Owm methods of ModemManager-1.0.CellInfoCdma
...
class CellInfoGsm extends CellInfo {
    ...
    // Owm methods of ModemManager-1.0.CellInfoGsm
...
class CellInfoLte extends CellInfo {
    ...
    // Owm methods of ModemManager-1.0.CellInfoLte
...
class CellInfoNr5g extends CellInfo {
    ...
    // Owm methods of ModemManager-1.0.CellInfoNr5g
...
class CellInfoTdscdma extends CellInfo {
    ...
    // Owm methods of ModemManager-1.0.CellInfoTdscdma
...
class CellInfoUmts extends CellInfo {
    ...
    // Owm methods of ModemManager-1.0.CellInfoUmts
...
class FirmwareProperties extends GObject.Object {
    ...
    // Constructors of ModemManager-1.0.FirmwareProperties
...
static new_from_dictionary(dictionary: GLib.Variant): FirmwareProperties;
    ...
    // Owm methods of ModemManager-1.0.FirmwareProperties
...
class FirmwareUpdateSettings extends GObject.Object {
    ...
    // Owm methods of ModemManager-1.0.FirmwareUpdateSettings
 ...
 */
class GdbusBearerProxy extends Gio.DBusProxy {

    // Constructors of ModemManager-1.0.GdbusBearerProxy
...
static new_sync(connection: Gio.DBusConnection, flags: Gio.DBusProxyFlags, name: (string | null), object_path: string, cancellable?: (Gio.Cancellable | null)): GdbusBearerProxy;
    ...
    // Owm methods of ModemManager-1.0.GdbusBearerProxy
 ...
 */
class GdbusBearerSkeleton extends Gio.DBusInterfaceSkeleton {

    // Constructors of ModemManager-1.0.GdbusBearerSkeleton
 ...
 */
class GdbusCallProxy extends Gio.DBusProxy {

    // Constructors of ModemManager-1.0.GdbusCallProxy
...
static new_sync(connection: Gio.DBusConnection, flags: Gio.DBusProxyFlags, name: (string | null), object_path: string, cancellable?: (Gio.Cancellable | null)): GdbusCallProxy;
    ...
    // Owm methods of ModemManager-1.0.GdbusCallProxy
 ...
 */
class GdbusCallSkeleton extends Gio.DBusInterfaceSkeleton {

    // Constructors of ModemManager-1.0.GdbusCallSkeleton
 ...
 */
class GdbusModem3gppProfileManagerProxy extends Gio.DBusProxy {

    // Constructors of ModemManager-1.0.GdbusModem3gppProfileManagerProxy
...
static new_sync(connection: Gio.DBusConnection, flags: Gio.DBusProxyFlags, name: (string | null), object_path: string, cancellable?: (Gio.Cancellable | null)): GdbusModem3gppProfileManagerProxy;
    ...
    // Owm methods of ModemManager-1.0.GdbusModem3gppProfileManagerProxy
 ...
 */
class GdbusModem3gppProfileManagerSkeleton extends Gio.DBusInterfaceSkeleton {

    // Constructors of ModemManager-1.0.GdbusModem3gppProfileManagerSkeleton
 ...
 */
class GdbusModem3gppProxy extends Gio.DBusProxy {

    // Constructors of ModemManager-1.0.GdbusModem3gppProxy
...
static new_sync(connection: Gio.DBusConnection, flags: Gio.DBusProxyFlags, name: (string | null), object_path: string, cancellable?: (Gio.Cancellable | null)): GdbusModem3gppProxy;
    ...
    // Owm methods of ModemManager-1.0.GdbusModem3gppProxy
 ...
 */
class GdbusModem3gppSkeleton extends Gio.DBusInterfaceSkeleton {

    // Constructors of ModemManager-1.0.GdbusModem3gppSkeleton
 ...
 */
class GdbusModem3gppUssdProxy extends Gio.DBusProxy {

    // Constructors of ModemManager-1.0.GdbusModem3gppUssdProxy
...
static new_sync(connection: Gio.DBusConnection, flags: Gio.DBusProxyFlags, name: (string | null), object_path: string, cancellable?: (Gio.Cancellable | null)): GdbusModem3gppUssdProxy;
    ...
    // Owm methods of ModemManager-1.0.GdbusModem3gppUssdProxy
 ...
 */
class GdbusModem3gppUssdSkeleton extends Gio.DBusInterfaceSkeleton {

    // Constructors of ModemManager-1.0.GdbusModem3gppUssdSkeleton
 ...
 */
class GdbusModemCdmaProxy extends Gio.DBusProxy {

    // Constructors of ModemManager-1.0.GdbusModemCdmaProxy
...
static new_sync(connection: Gio.DBusConnection, flags: Gio.DBusProxyFlags, name: (string | null), object_path: string, cancellable?: (Gio.Cancellable | null)): GdbusModemCdmaProxy;
    ...
    // Owm methods of ModemManager-1.0.GdbusModemCdmaProxy
 ...
 */
class GdbusModemCdmaSkeleton extends Gio.DBusInterfaceSkeleton {

    // Constructors of ModemManager-1.0.GdbusModemCdmaSkeleton
 ...
 */
class GdbusModemFirmwareProxy extends Gio.DBusProxy {

    // Constructors of ModemManager-1.0.GdbusModemFirmwareProxy
...
static new_sync(connection: Gio.DBusConnection, flags: Gio.DBusProxyFlags, name: (string | null), object_path: string, cancellable?: (Gio.Cancellable | null)): GdbusModemFirmwareProxy;
    ...
    // Owm methods of ModemManager-1.0.GdbusModemFirmwareProxy
 ...
 */
class GdbusModemFirmwareSkeleton extends Gio.DBusInterfaceSkeleton {

    // Constructors of ModemManager-1.0.GdbusModemFirmwareSkeleton
 ...
 */
class GdbusModemLocationProxy extends Gio.DBusProxy {

    // Constructors of ModemManager-1.0.GdbusModemLocationProxy
...
static new_sync(connection: Gio.DBusConnection, flags: Gio.DBusProxyFlags, name: (string | null), object_path: string, cancellable?: (Gio.Cancellable | null)): GdbusModemLocationProxy;
    ...
    // Owm methods of ModemManager-1.0.GdbusModemLocationProxy
 ...
 */
class GdbusModemLocationSkeleton extends Gio.DBusInterfaceSkeleton {

    // Constructors of ModemManager-1.0.GdbusModemLocationSkeleton
 ...
 */
class GdbusModemMessagingProxy extends Gio.DBusProxy {

    // Constructors of ModemManager-1.0.GdbusModemMessagingProxy
...
static new_sync(connection: Gio.DBusConnection, flags: Gio.DBusProxyFlags, name: (string | null), object_path: string, cancellable?: (Gio.Cancellable | null)): GdbusModemMessagingProxy;
    ...
    // Owm methods of ModemManager-1.0.GdbusModemMessagingProxy
 ...
 */
class GdbusModemMessagingSkeleton extends Gio.DBusInterfaceSkeleton {

    // Constructors of ModemManager-1.0.GdbusModemMessagingSkeleton
 ...
 */
class GdbusModemOmaProxy extends Gio.DBusProxy {

    // Constructors of ModemManager-1.0.GdbusModemOmaProxy
...
static new_sync(connection: Gio.DBusConnection, flags: Gio.DBusProxyFlags, name: (string | null), object_path: string, cancellable?: (Gio.Cancellable | null)): GdbusModemOmaProxy;
    ...
    // Owm methods of ModemManager-1.0.GdbusModemOmaProxy
 ...
 */
class GdbusModemOmaSkeleton extends Gio.DBusInterfaceSkeleton {

    // Constructors of ModemManager-1.0.GdbusModemOmaSkeleton
 ...
 */
class GdbusModemProxy extends Gio.DBusProxy {

    // Constructors of ModemManager-1.0.GdbusModemProxy
...
static new_sync(connection: Gio.DBusConnection, flags: Gio.DBusProxyFlags, name: (string | null), object_path: string, cancellable?: (Gio.Cancellable | null)): GdbusModemProxy;
    ...
    // Owm methods of ModemManager-1.0.GdbusModemProxy
 ...
 */
class GdbusModemSarProxy extends Gio.DBusProxy {

    // Constructors of ModemManager-1.0.GdbusModemSarProxy
...
static new_sync(connection: Gio.DBusConnection, flags: Gio.DBusProxyFlags, name: (string | null), object_path: string, cancellable?: (Gio.Cancellable | null)): GdbusModemSarProxy;
    ...
    // Owm methods of ModemManager-1.0.GdbusModemSarProxy
 ...
 */
class GdbusModemSarSkeleton extends Gio.DBusInterfaceSkeleton {

    // Constructors of ModemManager-1.0.GdbusModemSarSkeleton
 ...
 */
class GdbusModemSignalProxy extends Gio.DBusProxy {

    // Constructors of ModemManager-1.0.GdbusModemSignalProxy
...
static new_sync(connection: Gio.DBusConnection, flags: Gio.DBusProxyFlags, name: (string | null), object_path: string, cancellable?: (Gio.Cancellable | null)): GdbusModemSignalProxy;
    ...
    // Owm methods of ModemManager-1.0.GdbusModemSignalProxy
 ...
 */
class GdbusModemSignalSkeleton extends Gio.DBusInterfaceSkeleton {

    // Constructors of ModemManager-1.0.GdbusModemSignalSkeleton
 ...
 */
class GdbusModemSimpleProxy extends Gio.DBusProxy {

    // Constructors of ModemManager-1.0.GdbusModemSimpleProxy
...
static new_sync(connection: Gio.DBusConnection, flags: Gio.DBusProxyFlags, name: (string | null), object_path: string, cancellable?: (Gio.Cancellable | null)): GdbusModemSimpleProxy;
    ...
    // Owm methods of ModemManager-1.0.GdbusModemSimpleProxy
 ...
 */
class GdbusModemSimpleSkeleton extends Gio.DBusInterfaceSkeleton {

    // Constructors of ModemManager-1.0.GdbusModemSimpleSkeleton
 ...
 */
class GdbusModemSkeleton extends Gio.DBusInterfaceSkeleton {

    // Constructors of ModemManager-1.0.GdbusModemSkeleton
 ...
 */
class GdbusModemTimeProxy extends Gio.DBusProxy {

    // Constructors of ModemManager-1.0.GdbusModemTimeProxy
...
static new_sync(connection: Gio.DBusConnection, flags: Gio.DBusProxyFlags, name: (string | null), object_path: string, cancellable?: (Gio.Cancellable | null)): GdbusModemTimeProxy;
    ...
    // Owm methods of ModemManager-1.0.GdbusModemTimeProxy
 ...
 */
class GdbusModemTimeSkeleton extends Gio.DBusInterfaceSkeleton {

    // Constructors of ModemManager-1.0.GdbusModemTimeSkeleton
 ...
 */
class GdbusModemVoiceProxy extends Gio.DBusProxy {

    // Constructors of ModemManager-1.0.GdbusModemVoiceProxy
...
static new_sync(connection: Gio.DBusConnection, flags: Gio.DBusProxyFlags, name: (string | null), object_path: string, cancellable?: (Gio.Cancellable | null)): GdbusModemVoiceProxy;
    ...
    // Owm methods of ModemManager-1.0.GdbusModemVoiceProxy
 ...
 */
class GdbusModemVoiceSkeleton extends Gio.DBusInterfaceSkeleton {

    // Constructors of ModemManager-1.0.GdbusModemVoiceSkeleton
 ...
 */
class GdbusObjectManagerClient extends Gio.DBusObjectManagerClient {

    // Constructors of ModemManager-1.0.GdbusObjectManagerClient
...
static new_sync(connection: Gio.DBusConnection, flags: Gio.DBusObjectManagerClientFlags, name: (string | null), object_path: string, cancellable?: (Gio.Cancellable | null)): GdbusObjectManagerClient;
    ...
    // Owm methods of ModemManager-1.0.GdbusObjectManagerClient
 ...
 */
class GdbusObjectProxy extends Gio.DBusObjectProxy {

    // Constructors of ModemManager-1.0.GdbusObjectProxy
 ...
 */
class GdbusObjectSkeleton extends Gio.DBusObjectSkeleton {

    // Constructors of ModemManager-1.0.GdbusObjectSkeleton


static ["new"](object_path: string): GdbusObjectSkeleton;

    // Owm methods of ModemManager-1.0.GdbusObjectSkeleton
 ...
 */
class GdbusOrgFreedesktopModemManager1Proxy extends Gio.DBusProxy {

    // Constructors of ModemManager-1.0.GdbusOrgFreedesktopModemManager1Proxy
...
static new_sync(connection: Gio.DBusConnection, flags: Gio.DBusProxyFlags, name: (string | null), object_path: string, cancellable?: (Gio.Cancellable | null)): GdbusOrgFreedesktopModemManager1Proxy;
    ...
    // Owm methods of ModemManager-1.0.GdbusOrgFreedesktopModemManager1Proxy
 ...
 */
class GdbusOrgFreedesktopModemManager1Skeleton extends Gio.DBusInterfaceSkeleton {

    // Constructors of ModemManager-1.0.GdbusOrgFreedesktopModemManager1Skeleton
 ...
 */
class GdbusSimProxy extends Gio.DBusProxy {

    // Constructors of ModemManager-1.0.GdbusSimProxy
...
static new_sync(connection: Gio.DBusConnection, flags: Gio.DBusProxyFlags, name: (string | null), object_path: string, cancellable?: (Gio.Cancellable | null)): GdbusSimProxy;
    ...
    // Owm methods of ModemManager-1.0.GdbusSimProxy
 ...
 */
class GdbusSimSkeleton extends Gio.DBusInterfaceSkeleton {

    // Constructors of ModemManager-1.0.GdbusSimSkeleton
 ...
 */
class GdbusSmsProxy extends Gio.DBusProxy {

    // Constructors of ModemManager-1.0.GdbusSmsProxy
...
static new_sync(connection: Gio.DBusConnection, flags: Gio.DBusProxyFlags, name: (string | null), object_path: string, cancellable?: (Gio.Cancellable | null)): GdbusSmsProxy;
    ...
    // Owm methods of ModemManager-1.0.GdbusSmsProxy
 ...
 */
class GdbusSmsSkeleton extends Gio.DBusInterfaceSkeleton {

    // Constructors of ModemManager-1.0.GdbusSmsSkeleton
...
class KernelEventProperties extends GObject.Object {
    ...
    // Constructors of ModemManager-1.0.KernelEventProperties


static ["new"](): KernelEventProperties;

    // Owm methods of ModemManager-1.0.KernelEventProperties
...
class Location3gpp extends GObject.Object {
    ...
    // Owm methods of ModemManager-1.0.Location3gpp
...
class LocationCdmaBs extends GObject.Object {
    ...
    // Owm methods of ModemManager-1.0.LocationCdmaBs
...
class LocationGpsNmea extends GObject.Object {
    ...
    // Owm methods of ModemManager-1.0.LocationGpsNmea
...
class LocationGpsRaw extends GObject.Object {
    ...
    // Owm methods of ModemManager-1.0.LocationGpsRaw
 ...
 * using the provided API.
 */
class Manager extends GdbusObjectManagerClient {

    // Constructors of ModemManager-1.0.Manager
...
static new_sync(connection: Gio.DBusConnection, flags: Gio.DBusObjectManagerClientFlags, cancellable?: (Gio.Cancellable | null)): Manager;
    ...
    // Owm methods of ModemManager-1.0.Manager
 ...
 * using the provided API.
 */
class Modem extends GdbusModemProxy {

    // Owm methods of ModemManager-1.0.Modem

    /**
     * Gets the list of pending network-initiated OMA sessions.
     * @param self A #MMModem.
     */
    static get_pending_network_initiated_sessions(self: ModemOma): boolean
    /**
     * Gets the list of pending network-initiated OMA sessions.
     * @param self A #MMModem.
     */
    static peek_pending_network_initiated_sessions(self: ModemOma): boolean
     ...
     */
    get_supported_capabilities(): boolean
    /**
     ...
     * @returns %TRUE if @bands and @n_bands are set, %FALSE otherwise.
     */
    peek_supported_bands(): boolean
    /**
     * Gets the list of combinations of generic families of access technologies
     * supported by this #MMModem.
     * @returns %TRUE if @capabilities and @n_capabilities are set, %FALSE otherwise.
     */
    peek_supported_capabilities(): boolean
    /**
     * Gets the list of supported mode combinations.
     * @returns %TRUE if @modes and @n_modes are set, %FALSE otherwise.
     */
    peek_supported_modes(): boolean
    /**
     * Gets a #MMUnlockRetries object, which provides, for each
     * &lt;link linkend="MMModemLock"&gt;MMModemLock&lt;/link&gt; handled by the modem, the
     * number of PIN tries remaining before the code becomes blocked (requiring a
 ...
 * using the provided API.
 */
class Modem3gpp extends GdbusModem3gppProxy {

    // Owm methods of ModemManager-1.0.Modem3gpp
 ...
 * using the provided API.
 */
class Modem3gppProfileManager extends GdbusModem3gppProfileManagerProxy {

    // Owm methods of ModemManager-1.0.Modem3gppProfileManager
     ...
     * @param callback A #GAsyncReadyCallback to call when the request is satisfied or  %NULL.
     */
    delete(profile: 3gppProfile, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<this> | null)): void
    /**
     ...
     * @returns %TRUE if the operation was successful, %FALSE if @error is set.
     */
    delete_sync(profile: 3gppProfile, cancellable?: (Gio.Cancellable | null)): boolean
    /**
     ...
     */
    list_finish(res: Gio.AsyncResult): boolean
    /**
     ...
     * @returns %TRUE if the list was correctly retrieved, %FALSE if @error is set.
     */
    list_sync(cancellable?: (Gio.Cancellable | null)): boolean
    /**
     ...
     * @param callback A #GAsyncReadyCallback to call when the request is satisfied or  %NULL.
     */
    set(requested: 3gppProfile, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<this> | null)): void
    /**
     ...
     */
    set_finish(res: Gio.AsyncResult): 3gppProfile
    /**
     ...
     * @returns A #MM3gppProfile with the stored settings, or %NULL if @error is set.
     */
    set_sync(requested: 3gppProfile, cancellable?: (Gio.Cancellable | null)): 3gppProfile
}
 ...
 * using the provided API.
 */
class Modem3gppUssd extends GdbusModem3gppUssdProxy {

    // Owm methods of ModemManager-1.0.Modem3gppUssd
 ...
 * using the provided API.
 */
class ModemCdma extends GdbusModemCdmaProxy {

    // Owm methods of ModemManager-1.0.ModemCdma
 ...
 * using the provided API.
 */
class ModemFirmware extends GdbusModemFirmwareProxy {

    // Owm methods of ModemManager-1.0.ModemFirmware
 ...
 * using the provided API.
 */
class ModemLocation extends GdbusModemLocationProxy {

    // Owm methods of ModemManager-1.0.ModemLocation
     ...
     */
    get_full_finish(res: Gio.AsyncResult): boolean
    /**
     ...
     */
    get_full_sync(cancellable?: (Gio.Cancellable | null)): boolean
    /**
     ...
     * @param callback A #GAsyncReadyCallback to call when the request is satisfied or  %NULL.
     */
    inject_assistance_data(data: Uint8Array, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<this> | null)): void
    /**
     * Finishes an operation started with
 ...
 * using the provided API.
 */
class ModemMessaging extends GdbusModemMessagingProxy {

    // Owm methods of ModemManager-1.0.ModemMessaging
     ...
     */
    get_supported_storages(): boolean
    /**
     ...
     * @returns %TRUE if @storages and @n_storages are set, %FALSE otherwise.
     */
    peek_supported_storages(): boolean
}
 ...
 * using the provided API.
 */
class ModemOma extends GdbusModemOmaProxy {

    // Owm methods of ModemManager-1.0.ModemOma
     ...
     */
    get_pending_network_initiated_sessions(): boolean
    /**
     ...
     * @returns %TRUE if @sessions and @n_sessions are set, %FALSE otherwise.
     */
    peek_pending_network_initiated_sessions(): boolean
    /**
 ...
 * using the provided API.
 */
class ModemSar extends GdbusModemSarProxy {

    // Owm methods of ModemManager-1.0.ModemSar
 ...
 * using the provided API.
 */
class ModemSignal extends GdbusModemSignalProxy {

    // Owm methods of ModemManager-1.0.ModemSignal
 ...
 * using the provided API.
 */
class ModemSimple extends GdbusModemSimpleProxy {

    // Owm methods of ModemManager-1.0.ModemSimple
 ...
 * using the provided API.
 */
class ModemTime extends GdbusModemTimeProxy {

    // Owm methods of ModemManager-1.0.ModemTime
 ...
 * using the provided API.
 */
class ModemVoice extends GdbusModemVoiceProxy {

    // Owm methods of ModemManager-1.0.ModemVoice
...
class NetworkTimezone extends GObject.Object {
    ...
    // Owm methods of ModemManager-1.0.NetworkTimezone
...
class Nr5gRegistrationSettings extends GObject.Object {
    ...
    // Constructors of ModemManager-1.0.Nr5gRegistrationSettings


static ["new"](): Nr5gRegistrationSettings;

    // Owm methods of ModemManager-1.0.Nr5gRegistrationSettings
 ...
 * using the provided API.
 */
class Object extends GdbusObjectProxy {

    // Owm methods of ModemManager-1.0.Object
...
class Pco extends GObject.Object {
    ...
    // Owm methods of ModemManager-1.0.Pco
...
class Signal extends GObject.Object {
    ...
    // Owm methods of ModemManager-1.0.Signal
...
class SignalThresholdProperties extends GObject.Object {
    ...
    // Constructors of ModemManager-1.0.SignalThresholdProperties


static ["new"](): SignalThresholdProperties;

    // Owm methods of ModemManager-1.0.SignalThresholdProperties
 ...
 * using the provided API.
 */
class Sim extends GdbusSimProxy {

    // Owm methods of ModemManager-1.0.Sim
...
class SimpleConnectProperties extends GObject.Object {
    ...
    // Constructors of ModemManager-1.0.SimpleConnectProperties


static ["new"](): SimpleConnectProperties;

    // Owm methods of ModemManager-1.0.SimpleConnectProperties
...
class SimpleStatus extends GObject.Object {
    ...
    // Own properties of ModemManager-1.0.SimpleStatus
    ...
    // Owm methods of ModemManager-1.0.SimpleStatus
 ...
 * using the provided API.
 */
class Sms extends GdbusSmsProxy {

    // Owm methods of ModemManager-1.0.Sms
...
class SmsProperties extends GObject.Object {
    ...
    // Constructors of ModemManager-1.0.SmsProperties


static ["new"](): SmsProperties;

    // Owm methods of ModemManager-1.0.SmsProperties
...
class UnlockRetries extends GObject.Object {
    ...
    // Owm methods of ModemManager-1.0.UnlockRetries
...
class __3gppProfileClass {
}

class __3gppProfilePrivate {
}

class BearerClass {
}

class BearerIpConfigClass {
}
...
class BearerPropertiesClass {
}

class BearerPropertiesPrivate {
}

class BearerStatsClass {
}

class BearerStatsPrivate {
}

class CallAudioFormatClass {
}
...
class CallPropertiesClass {
}

class CallPropertiesPrivate {
}

class CdmaManualActivationPropertiesClass {
}

class CdmaManualActivationPropertiesPrivate {
}

class CellInfoCdmaClass {
}
...
class CellInfoGsmClass {
}

class CellInfoGsmPrivate {
}

class CellInfoLteClass {
}

class CellInfoLtePrivate {
}

class CellInfoNr5gClass {
}
...
class CellInfoTdscdmaClass {
}

class CellInfoTdscdmaPrivate {
}

class CellInfoUmtsClass {
}

class CellInfoUmtsPrivate {
}

class FirmwarePropertiesClass {
}

class FirmwarePropertiesPrivate {
}

class FirmwareUpdateSettingsClass {
}
 ...
 */
class GdbusBearerIface {
}

/**
 * Class structure for #MmGdbusBearerProxy.
 */
class GdbusBearerProxyClass {
}
 ...
 */
class GdbusBearerSkeletonClass {
}
 ...
 */
class GdbusCallIface {
}

/**
 * Class structure for #MmGdbusCallProxy.
 */
class GdbusCallProxyClass {
}
 ...
 */
class GdbusModem3gppProfileManagerIface {
}

/**
 * Class structure for #MmGdbusModem3gppProfileManagerProxy.
 */
class GdbusModem3gppProfileManagerProxyClass {
}
 ...
 */
class GdbusModem3gppProfileManagerSkeletonClass {
}
 ...
 */
class GdbusModem3gppProxyClass {
}
 ...
 */
class GdbusModem3gppSkeletonClass {
}
 ...
 */
class GdbusModem3gppUssdIface {
}

/**
 * Class structure for #MmGdbusModem3gppUssdProxy.
 */
class GdbusModem3gppUssdProxyClass {
}
 ...
 */
class GdbusModem3gppUssdSkeletonClass {
}
 ...
 */
class GdbusModemCdmaIface {
}

/**
 * Class structure for #MmGdbusModemCdmaProxy.
 */
class GdbusModemCdmaProxyClass {
}
 ...
 */
class GdbusModemCdmaSkeletonClass {
}
 ...
 */
class GdbusModemFirmwareIface {
}

/**
 * Class structure for #MmGdbusModemFirmwareProxy.
 */
class GdbusModemFirmwareProxyClass {
}
 ...
 */
class GdbusModemFirmwareSkeletonClass {
}
 ...
 */
class GdbusModemLocationIface {
}

/**
 * Class structure for #MmGdbusModemLocationProxy.
 */
class GdbusModemLocationProxyClass {
}
 ...
 */
class GdbusModemLocationSkeletonClass {
}
 ...
 */
class GdbusModemMessagingIface {
}

/**
 * Class structure for #MmGdbusModemMessagingProxy.
 */
class GdbusModemMessagingProxyClass {
}
 ...
 */
class GdbusModemMessagingSkeletonClass {
}
 ...
 */
class GdbusModemOmaIface {
}

/**
 * Class structure for #MmGdbusModemOmaProxy.
 */
class GdbusModemOmaProxyClass {
}
 ...
 */
class GdbusModemOmaSkeletonClass {
}
 ...
 */
class GdbusModemSarIface {
}

/**
 * Class structure for #MmGdbusModemSarProxy.
 */
class GdbusModemSarProxyClass {
}
 ...
 */
class GdbusModemSarSkeletonClass {
}
 ...
 */
class GdbusModemSignalIface {
}

/**
 * Class structure for #MmGdbusModemSignalProxy.
 */
class GdbusModemSignalProxyClass {
}
 ...
 */
class GdbusModemSignalSkeletonClass {
}
 ...
 */
class GdbusModemSimpleIface {
}

/**
 * Class structure for #MmGdbusModemSimpleProxy.
 */
class GdbusModemSimpleProxyClass {
}
 ...
 */
class GdbusModemSimpleSkeletonClass {
}
 ...
 */
class GdbusModemTimeIface {
}

/**
 * Class structure for #MmGdbusModemTimeProxy.
 */
class GdbusModemTimeProxyClass {
}
 ...
 */
class GdbusModemTimeSkeletonClass {
}
 ...
 */
class GdbusModemVoiceIface {
}

/**
 * Class structure for #MmGdbusModemVoiceProxy.
 */
class GdbusModemVoiceProxyClass {
}
 ...
 */
class GdbusModemVoiceSkeletonClass {
}
 ...
 */
class GdbusObjectIface {
}

/**
 * Class structure for #MmGdbusObjectManagerClient.
 */
class GdbusObjectManagerClientClass {
}
 ...
 */
class GdbusObjectSkeletonClass {
}
 ...
 */
class GdbusOrgFreedesktopModemManager1Iface {
}

/**
 * Class structure for #MmGdbusOrgFreedesktopModemManager1Proxy.
 */
class GdbusOrgFreedesktopModemManager1ProxyClass {
}
 ...
 */
class GdbusOrgFreedesktopModemManager1SkeletonClass {
}
 ...
 */
class GdbusSmsSkeletonClass {
}

class GdbusSmsSkeletonPrivate {
}

class KernelEventPropertiesClass {
}

class KernelEventPropertiesPrivate {
}

class Location3gppClass {
}

class Location3gppPrivate {
}

class LocationCdmaBsClass {
}

class LocationCdmaBsPrivate {
}

class LocationGpsNmeaClass {
}

class LocationGpsNmeaPrivate {
}

class LocationGpsRawClass {
}
...
class Modem3gppNetwork {
    ...
    // Owm methods of ModemManager-1.0.Modem3gppNetwork
...
class Modem3gppProfileManagerClass {
}

class Modem3gppUssdClass {
}

class ModemCdmaClass {
}

class ModemClass {
}

class ModemFirmwareClass {
}

class ModemFirmwarePrivate {
}

class ModemLocationClass {
}

class ModemLocationPrivate {
}

class ModemMessagingClass {
}
...
class ModemModeCombination {
    ...
    // Own fields of ModemManager-1.0.ModemModeCombination
...
class ModemPortInfo {
    ...
    // Own fields of ModemManager-1.0.ModemPortInfo

name: string
type: ModemPortType

    // Owm methods of ModemManager-1.0.ModemPortInfo
...
class ModemSignalClass {
}

class ModemSignalPrivate {
}

class ModemSimpleClass {
}

class ModemTimeClass {
}

class ModemTimePrivate {
}

class ModemVoiceClass {
}

class ModemVoicePrivate {
}

class NetworkTimezoneClass {
}

class NetworkTimezonePrivate {
}

class Nr5gRegistrationSettingsClass {
}
...
class OmaPendingNetworkInitiatedSession {
    ...
    // Own fields of ModemManager-1.0.OmaPendingNetworkInitiatedSession
...
class SignalThresholdPropertiesClass {
}
...
class SimPreferredNetwork {
    ...
    // Constructors of ModemManager-1.0.SimPreferredNetwork
...
static ["new"](): SimPreferredNetwork;
    ...
    // Owm methods of ModemManager-1.0.SimPreferredNetwork
...
class SimpleConnectPropertiesClass {
}
...
class SmsPropertiesClass {
}

class SmsPropertiesPrivate {
}

class UnlockRetriesClass {
}

class UnlockRetriesPrivate {
}

interface GdbusBearer {

    // Own properties of ModemManager-1.0.GdbusBearer
    ...
    // Owm methods of ModemManager-1.0.GdbusBearer
    ...
    // Own virtual methods of ModemManager-1.0.GdbusBearer
...
interface GdbusCall {
    ...
    // Own properties of ModemManager-1.0.GdbusCall
    ...
    // Owm methods of ModemManager-1.0.GdbusCall
    ...
    // Own virtual methods of ModemManager-1.0.GdbusCall
...
interface GdbusModem {

    // Own properties of ModemManager-1.0.GdbusModem
    ...
    // Owm methods of ModemManager-1.0.GdbusModem
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_command_finish(res: Gio.AsyncResult): boolean
    /**
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_command_sync(arg_cmd: string, arg_timeout: number, cancellable?: (Gio.Cancellable | null)): boolean
    /**
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_create_bearer_finish(res: Gio.AsyncResult): boolean
    /**
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_create_bearer_sync(arg_properties: GLib.Variant, cancellable?: (Gio.Cancellable | null)): boolean
    /**
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_get_cell_info_finish(res: Gio.AsyncResult): boolean
    /**
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_get_cell_info_sync(cancellable?: (Gio.Cancellable | null)): boolean
    /**
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_list_bearers_finish(res: Gio.AsyncResult): boolean
    /**
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_list_bearers_sync(cancellable?: (Gio.Cancellable | null)): boolean
    /**
    ...
    // Own virtual methods of ModemManager-1.0.GdbusModem
...
interface GdbusModem3gpp {

    // Own properties of ModemManager-1.0.GdbusModem3gpp
    ...
    // Owm methods of ModemManager-1.0.GdbusModem3gpp
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_scan_finish(res: Gio.AsyncResult): boolean
    /**
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_scan_sync(cancellable?: (Gio.Cancellable | null)): boolean
    /**
    ...
    // Own virtual methods of ModemManager-1.0.GdbusModem3gpp
...
interface GdbusModem3gppProfileManager {

    // Own properties of ModemManager-1.0.GdbusModem3gppProfileManager
    ...
    // Owm methods of ModemManager-1.0.GdbusModem3gppProfileManager
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_list_finish(res: Gio.AsyncResult): boolean
    /**
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_list_sync(cancellable?: (Gio.Cancellable | null)): boolean
    /**
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_set_finish(res: Gio.AsyncResult): boolean
    /**
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_set_sync(arg_requested_properties: GLib.Variant, cancellable?: (Gio.Cancellable | null)): boolean
    /**
    ...
    // Own virtual methods of ModemManager-1.0.GdbusModem3gppProfileManager
...
interface GdbusModem3gppUssd {

    // Own properties of ModemManager-1.0.GdbusModem3gppUssd
    ...
    // Owm methods of ModemManager-1.0.GdbusModem3gppUssd
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_initiate_finish(res: Gio.AsyncResult): boolean
    /**
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_initiate_sync(arg_command: string, cancellable?: (Gio.Cancellable | null)): boolean
    /**
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_respond_finish(res: Gio.AsyncResult): boolean
    /**
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_respond_sync(arg_response: string, cancellable?: (Gio.Cancellable | null)): boolean
    /**
     * Helper function used in service implementations to finish handling invocations of the &lt;link linkend="gdbus-method-org-freedesktop-ModemManager1-Modem-Modem3gpp-Ussd.Cancel"&gt;Cancel()&lt;/link&gt; D-Bus method. If you instead want to finish handling an invocation by returning an error, use g_dbus_method_invocation_return_error() or similar.
     * 
     * This method will free `invocation,` you cannot use it afterwards.
    ...
    // Own virtual methods of ModemManager-1.0.GdbusModem3gppUssd
...
interface GdbusModemCdma {

    // Own properties of ModemManager-1.0.GdbusModemCdma
    ...
    // Owm methods of ModemManager-1.0.GdbusModemCdma
    ...
    // Own virtual methods of ModemManager-1.0.GdbusModemCdma
...
interface GdbusModemFirmware {

    // Own properties of ModemManager-1.0.GdbusModemFirmware
    ...
    // Owm methods of ModemManager-1.0.GdbusModemFirmware
    ...
    // Own virtual methods of ModemManager-1.0.GdbusModemFirmware

    vfunc_handle_list(invocation: Gio.DBusMethodInvocation): boolean
    vfunc_handle_select(invocation: Gio.DBusMethodInvocation, arg_uniqueid: string): boolean
}

interface GdbusModemLocation {

    // Own properties of ModemManager-1.0.GdbusModemLocation
    ...
    // Owm methods of ModemManager-1.0.GdbusModemLocation
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_get_location_finish(res: Gio.AsyncResult): boolean
    /**
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_get_location_sync(cancellable?: (Gio.Cancellable | null)): boolean
    /**
    ...
    // Own virtual methods of ModemManager-1.0.GdbusModemLocation
...
interface GdbusModemMessaging {

    // Own properties of ModemManager-1.0.GdbusModemMessaging
    ...
    // Owm methods of ModemManager-1.0.GdbusModemMessaging
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_create_finish(res: Gio.AsyncResult): boolean
    /**
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_create_sync(arg_properties: GLib.Variant, cancellable?: (Gio.Cancellable | null)): boolean
    /**
    ...
    // Own virtual methods of ModemManager-1.0.GdbusModemMessaging
...
interface GdbusModemOma {

    // Own properties of ModemManager-1.0.GdbusModemOma
    ...
    // Owm methods of ModemManager-1.0.GdbusModemOma
    ...
    // Own virtual methods of ModemManager-1.0.GdbusModemOma
...
interface GdbusModemSar {

    // Own properties of ModemManager-1.0.GdbusModemSar
    ...
    // Owm methods of ModemManager-1.0.GdbusModemSar
    ...
    // Own virtual methods of ModemManager-1.0.GdbusModemSar

    vfunc_handle_enable(invocation: Gio.DBusMethodInvocation, arg_enable: boolean): boolean
    vfunc_handle_set_power_level(invocation: Gio.DBusMethodInvocation, arg_level: number): boolean
}

interface GdbusModemSignal {

    // Own properties of ModemManager-1.0.GdbusModemSignal
    ...
    // Owm methods of ModemManager-1.0.GdbusModemSignal
    ...
    // Own virtual methods of ModemManager-1.0.GdbusModemSignal
...
interface GdbusModemSimple {

    // Owm methods of ModemManager-1.0.GdbusModemSimple
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_connect_sync(arg_properties: GLib.Variant, cancellable?: (Gio.Cancellable | null)): boolean
    /**
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_get_status_finish(res: Gio.AsyncResult): boolean
    /**
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_get_status_sync(cancellable?: (Gio.Cancellable | null)): boolean
    /**
    ...
    // Own virtual methods of ModemManager-1.0.GdbusModemSimple
...
interface GdbusModemTime {

    // Own properties of ModemManager-1.0.GdbusModemTime
    ...
    // Owm methods of ModemManager-1.0.GdbusModemTime
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_get_network_time_finish(res: Gio.AsyncResult): boolean
    /**
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_get_network_time_sync(cancellable?: (Gio.Cancellable | null)): boolean
    /**
    ...
    // Own virtual methods of ModemManager-1.0.GdbusModemTime

    vfunc_handle_get_network_time(invocation: Gio.DBusMethodInvocation): boolean
    vfunc_network_time_changed(arg_time: string): void
}

interface GdbusModemVoice {

    // Own properties of ModemManager-1.0.GdbusModemVoice
    ...
    // Owm methods of ModemManager-1.0.GdbusModemVoice
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_call_waiting_query_finish(res: Gio.AsyncResult): boolean
    /**
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_call_waiting_query_sync(cancellable?: (Gio.Cancellable | null)): boolean
    /**
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_create_call_finish(res: Gio.AsyncResult): boolean
    /**
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_create_call_sync(arg_properties: GLib.Variant, cancellable?: (Gio.Cancellable | null)): boolean
    /**
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_list_calls_finish(res: Gio.AsyncResult): boolean
    /**
     ...
     * @returns %TRUE if the call succeeded, %FALSE if @error is set.
     */
    call_list_calls_sync(cancellable?: (Gio.Cancellable | null)): boolean
    /**
    ...
    // Own virtual methods of ModemManager-1.0.GdbusModemVoice
...
interface GdbusObject {
    ...
    // Own properties of ModemManager-1.0.GdbusObject
    ...
    // Owm methods of ModemManager-1.0.GdbusObject
...
interface GdbusOrgFreedesktopModemManager1 {

    // Own properties of ModemManager-1.0.GdbusOrgFreedesktopModemManager1
    ...
    // Owm methods of ModemManager-1.0.GdbusOrgFreedesktopModemManager1
    ...
    // Own virtual methods of ModemManager-1.0.GdbusOrgFreedesktopModemManager1
...
interface GdbusSim {
    ...
    // Own properties of ModemManager-1.0.GdbusSim
    ...
    // Owm methods of ModemManager-1.0.GdbusSim
    ...
    // Own virtual methods of ModemManager-1.0.GdbusSim
...
interface GdbusSms {
    ...
    // Own properties of ModemManager-1.0.GdbusSms
    ...
    // Owm methods of ModemManager-1.0.GdbusSms
    ...
    // Own virtual methods of ModemManager-1.0.GdbusSms

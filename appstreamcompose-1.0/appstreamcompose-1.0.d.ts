...
export namespace AppStreamCompose {
    ...
    class CanvasError extends GLib.Error {
        // Own fields of AppStreamCompose-1.0.CanvasError
        ...
        // Constructors of AppStreamCompose-1.0.CanvasError

        constructor(options: { message: string; code: number });

        // Owm methods of AppStreamCompose-1.0.CanvasError
    ...
    class ComposeError extends GLib.Error {
        // Own fields of AppStreamCompose-1.0.ComposeError
        ...
        // Constructors of AppStreamCompose-1.0.ComposeError

        constructor(options: { message: string; code: number });

        // Owm methods of AppStreamCompose-1.0.ComposeError
    ...
    class ImageError extends GLib.Error {
        // Own fields of AppStreamCompose-1.0.ImageError
        ...
        // Constructors of AppStreamCompose-1.0.ImageError

        constructor(options: { message: string; code: number });

        // Owm methods of AppStreamCompose-1.0.ImageError
    ...
    class Canvas extends GObject.Object {
        // Constructors of AppStreamCompose-1.0.Canvas

        static ['new'](width: number, height: number): Canvas;

        // Owm methods of AppStreamCompose-1.0.Canvas
    ...
    class Compose extends GObject.Object {
        // Constructors of AppStreamCompose-1.0.Compose

        static ['new'](): Compose;

        // Owm methods of AppStreamCompose-1.0.Compose
    ...
    class DirectoryUnit extends Unit {
        // Constructors of AppStreamCompose-1.0.DirectoryUnit

        static ['new'](root_dir: string): DirectoryUnit;

        // Owm methods of AppStreamCompose-1.0.DirectoryUnit
    ...
    class Hint extends GObject.Object {
        // Constructors of AppStreamCompose-1.0.Hint

        static ['new'](): Hint;

        static new_for_tag(tag: string): Hint;

        // Owm methods of AppStreamCompose-1.0.Hint
    ...
    class IconPolicy extends GObject.Object {
        // Constructors of AppStreamCompose-1.0.IconPolicy

        static ['new'](): IconPolicy;

        // Owm methods of AppStreamCompose-1.0.IconPolicy
    ...
    class Image extends GObject.Object {
        // Constructors of AppStreamCompose-1.0.Image
        ...
        // Owm methods of AppStreamCompose-1.0.Image
    ...
    class Result extends GObject.Object {
        // Constructors of AppStreamCompose-1.0.Result

        static ['new'](): Result;

        // Owm methods of AppStreamCompose-1.0.Result
    ...
    class Unit extends GObject.Object {
        // Constructors of AppStreamCompose-1.0.Unit

        static ['new'](): Unit;

        // Owm methods of AppStreamCompose-1.0.Unit
    ...
    class DirectoryUnitClass {}

    class HintClass {}

    class IconPolicyClass {}
    ...
    class IconPolicyIter {
        // Constructors of AppStreamCompose-1.0.IconPolicyIter

        constructor(properties?: Partial<{}>);

        // Owm methods of AppStreamCompose-1.0.IconPolicyIter

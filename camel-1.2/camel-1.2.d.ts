...
export namespace Camel {
    ...
    /**
     * Authentication result codes used by {@link Camel.Service}.
     * @gir-type Enum
     * @since 3.4
     */
    ...
    /**
     * Defines type of a {@link Camel.SExpResult}.
     * @gir-type Enum
     * @since 3.4
     */
    enum SExpResultType {
    ...
    /**
     * Defines type of a {@link Camel.SExpTerm} and partly also {@link Camel.SExpSymbol}
     * @gir-type Enum
     * @since 3.4
     */
    enum SExpTermType {
    ...
    enum ServiceConnectionStatus {
        /**
         * {@link Camel.Service} is disconnected from a remote server.
         */
        DISCONNECTED = 0,
        /**
         * {@link Camel.Service} is connecting to a remote server.
         */
        CONNECTING = 1,
        /**
         * {@link Camel.Service} is connected to a remote server.
         */
        CONNECTED = 2,
        /**
         * {@link Camel.Service} is disconnecting from a remote server.
         */
        DISCONNECTING = 3,
    }
    ...
    enum StoreDBCountKind {
         ...
         */
        NOT_JUNK_NOT_DELETED = 5,
        /**
         * all unread, except of junk and deleted messages
         */
        NOT_JUNK_NOT_DELETED_UNREAD = 6,
        /**
     ...
     * like in {@link Camel.OfflineSettings}.
     * @gir-type Enum
     * @since 3.24
     */
    enum TimeUnit {
     ...
     * on a {@link Camel.CipherCertInfo}.
     * @since 3.22
     ...
     * @default EDS_CAMEL_PROVIDER_DIR
     */
    ...
    /**
     * @default Account:Mail Account:archive-folder:f
     */
    const STORE_SETUP_ARCHIVE_FOLDER: string;

    /**
     * @default Submission:Mail Composition:drafts-folder:f
     */
    const STORE_SETUP_DRAFTS_FOLDER: string;

    /**
     * @default Submission:Mail Submission:sent-folder:f
     */
    const STORE_SETUP_SENT_FOLDER: string;

    /**
     * @default Submission:Mail Composition:templates-folder:f
     */
    ...
    /**
     * @default .#evolution/Junk
     */
    const VJUNK_NAME: string;

    /**
     * @default .#evolution/Trash
     */
     ...
     * @since 3.16
     */
    function binding_bind_property_full(source: GObject.Object, source_property: string, target: GObject.Object, target_property: string, flags: GObject.BindingFlags, transform_to: GObject.Closure, transform_from: GObject.Closure): GObject.Binding;
    ...
    /**
     * @param isocharset a canonicalised ISO charset
     ...
     * @returns 0 on success, -1 on failure.
     */
    function file_util_decode_off_t(_in: null, dest: never): number;
     ...
     * @returns 0 on success, -1 on error.
     */
    function file_util_encode_off_t(out: null, value: never): number;
     ...
     * `camel_folder_info_build()` will create additional {@link Camel.FolderInfo} with
     ...
     * @param folders an array of {@link Camel.FolderInfo}
     ...
     * @param addr the {@link Camel.HeaderAddress} to add
     */
     ...
     * TODO: Document me.
     * @param addrlistp a NULL-terminated list of {@link Camel.HeaderAddress} objects
     * @param addrs a NULL-terminated list of {@link Camel.HeaderAddress} to add
     */
    ...
    /**
     * TODO: Document me.
     * @param addrlist a NULL-terminated list of {@link Camel.HeaderAddress} objects
     */
     ...
     * @param headers a {@link Camel.NameValueArray} with headers
     ...
     * @param type a {@link Camel.LockType}
     * @returns -1 on error.
     * @throws GLib.Error
     */
     ...
     * 
     * The returned {@link Camel.Provider} is owned by Camel and should not be
     * modified or freed.
     * @param protocol a {@link Camel.Provider} protocol name
     * @returns a {@link Camel.Provider} for `protocol`, or `null` on error
     * @throws GLib.Error
     */
     ...
     * 
     * Free the returned list with `g_list_free()`.  The {@link Camel.Provider} structs
     ...
     * @returns a {@link GLib.List} of {@link Camel.Provider} structs
     */
     ...
     */
    function quoted_decode_step(_in: Uint8Array | string, out: Uint8Array | string, saveme: number[]): [number, Uint8Array, number[]];
     ...
     */
    function quoted_encode_close(_in: Uint8Array | string, out: Uint8Array | string, save: number[]): [number, Uint8Array, number[]];
     ...
     * @returns the number of bytes encoded
     */
    function quoted_encode_step(_in: Uint8Array | string, out: Uint8Array | string, save: number[]): [number, Uint8Array, number[]];
    ...
    /**
     * @param message a `CamelMessage`
     * @returns All headers of the `message`, decoded where needed.    Free the returned pointer with `g_free()` when done with it.
     * @since 3.22
     */
    ...
    /**
     * @param headers a {@link Camel.NameValueArray}
     * @param default_charset default charset to use; or `null`, to detect from Content-Type of `headers`
     ...
     * @since 3.58
     */
    function search_util_add_months(t: bigint | number, months: number): number;
     ...
     * @since 3.58
     */
    function search_util_compare_date(datetime1: bigint | number, datetime2: bigint | number): number;
    ...
    /**
     * @param str a string to check, or `null`
    ...
    /**
     * @param name name of a system flag
     ...
     * @param unit a {@link Camel.TimeUnit}
     ...
     * @since 3.24
     */
    function time_value_apply(src_time: bigint | number, unit: TimeUnit, value: number): number;
     ...
     * @param bdata_str a {@link GLib.String} to store a backend specific data (bdata)
     ...
     * @param headers a {@link Camel.NameValueArray} with the headers to read from
     ...
     * @returns `true` if `error` is a network/connection error, `false` otherwise    (including when `error` is `null`)
     * @since 3.62
     */
    function util_is_network_error(error: GLib.Error | null): boolean;
     ...
     * @returns the number of bytes decoded
     */
    function uudecode_step(_in: Uint8Array | string, out: Uint8Array | string, save: number[]): [number, Uint8Array, number[]];
     ...
     * @returns the number of bytes encoded
     */
    function uuencode_close(_in: Uint8Array | string, out: Uint8Array | string, uubuf: Uint8Array | string, save: number[]): [number, Uint8Array, Uint8Array, number[]];
     ...
     * @returns the number of bytes encoded
     */
    function uuencode_step(_in: Uint8Array | string, out: Uint8Array | string, uubuf: Uint8Array | string, save: number[]): [number, Uint8Array, Uint8Array, number[]];
    ...
    interface DBSelectCB {
        (user_data: null, colvalues: string[], colnames: string[]): boolean;
    }
    ...
    enum FolderInfoFlags {
        ...
        FLAGGED = 262144,
        /**
         * The last define bit of the flags. The {@link Camel.Provider} can use this and
    ...
    enum MimeFilterToHTMLFlags {
         ...
         *     Cannot be used together with {@link Camel.MimeFilterToHTMLFlags.DIV}.
         */
        PRE = 1,
        /**
        ...
        CITE = 128,
        /**
         * This flag is not used by {@link Camel.MimeFilterToHTML}.
         */
        PRESERVE_8BIT = 256,
        /**
         * This flag is not used by {@link Camel.MimeFilterToHTML}.
         ...
         *     Cannot be used together with {@link Camel.MimeFilterToHTMLFlags.PRE}.
         */
        DIV = 2048,
        /**
         * Set in combination with {@link Camel.MimeFilterToHTMLFlags.CONVERT_SPACES},
     ...
     * 
     * {@link Camel.Address} is a base abstract class for address types used in mail
    ...
    class Address extends GObject.Object {
         ...
         * be of the same type.
         * @param source source {@link Camel.Address} object
         * @virtual
         */
    ...
    class BlockFile extends GObject.Object {
        ...
        /**
         * @param id a {@link Camel._block_t}
         */
    ...
    class CertDB extends GObject.Object {
        ...
        /**
         * Gathers a list of known certificates. Each certificate in the returned {@link GLib.SList}
     ...
     * 
     * {@link Camel.CipherContext} is an abstract base class that provides a unified
     * interface for encrypting, signing, decrypting, and verifying {@link Camel.MimePart}
     * message parts.
     * 
     * Concrete implementations include {@link Camel.GpgContext} for OpenPGP/GnuPG and
     * {@link Camel.SMIMEContext} for S/MIME.
     * 
     ...
     * as a tree of {@link Camel.CipherValidity} structures, each describing the
    ...
    class DataCache extends GObject.Object {
         ...
         * temporary file is renamed to its final location, and a new {@link Gio.IOStream}
        ...
        /**
         * Lookup an item in the cache.  If the item exists, a {@link Gio.IOStream} is returned
         ...
         * 
         * The returned {@link Gio.IOStream} is referenced for thread-safety and must be
         * unreferenced with `g_object_unref()` when finished with it.
         * @param path Path to the (sub) cache the item exists in.
         * @param key Key for the cache item.
         * @returns a {@link Gio.IOStream} for the requested cache item, or `null` on error
         * @throws GLib.Error
         */
     ...
     * 
     * {@link Camel.DataWrapper} is the base class used to implement structured MIME data
     * access. It serves as the programmatic interface for creating and reading
     * MIME-encoded data, primarily RFC 822 messages.
     * 
     * The class hierarchy rooted at {@link Camel.DataWrapper} closely parallels the
     * structure of a MIME message:
     * 
     * - {@link Camel.DataWrapper} itself holds unstructured leaf data (e.g. an attachment
     *   body) together with its content-type and transfer encoding.
     * 
     * - {@link Camel.Medium} extends it with named headers and a separate content object.
     * 
     * - {@link Camel.MimePart} adds structured accessors for all standard Content-*
     *   headers (Content-Type, Content-Disposition, Content-Transfer-Encoding,
     *   etc.) and can be constructed from a {@link Camel.MimeParser}.
     * 
     * - {@link Camel.MimeMessage} is a fully-fledged RFC 822 message with From/To/Subject
     *   and other message-level headers, built on top of {@link Camel.MimePart}.
     * 
     * - {@link Camel.Multipart} and its subclasses ({@link Camel.MultipartSigned},
     *   {@link Camel.MultipartEncrypted}) handle multipart MIME containers.
     * 
     ...
     * 
     * {@link Camel.FilterDriver} manages the filtering process. Given a set of filter
     ...
     * message in turn.
     * 
     * Filter rules use two s-expressions evaluated by {@link Camel.SExp}:
     * 
    ...
    class FilterDriver extends GObject.Object {
         ...
         * @param match a code ({@link Camel.SExp}) to execute to check whether the rule can be applied
         * @param action an action code ({@link Camel.SExp}) to execute, when the `match` evaluates to `true`
         */
     ...
     * 
     * {@link Camel.FilterInputStream} is similar to {@link Gio.ConverterInputStream}, except it
     * operates on a {@link Camel.MimeFilter} instead of a {@link Gio.Converter}.
     * 
     * This class is meant to be a temporary solution until all of Camel's MIME
     * filters are ported to the {@link Gio.Converter} interface.
     * @gir-type Class
     */
     ...
     * 
     * {@link Camel.FilterOutputStream} is similar to {@link Gio.ConverterOutputStream}, except it
     * operates on a {@link Camel.MimeFilter} instead of a {@link Gio.Converter}.
     * 
     * This class is meant to be a temporary solution until all of Camel's MIME
     * filters are ported to the {@link Gio.Converter} interface.
     ...
     * 
     * {@link Camel.Folder} is the object used to abstract a mail folder that stores
     * messages. Folders are obtained from {@link Camel.Store} instances and provide
     * the primary interface for working with mail:
     * 
     * - Retrieving information about messages in the folder (via
     *   {@link Camel.FolderSummary} and {@link Camel.MessageInfo}).
     ...
     * 
     * {@link Camel.Folder} itself handles the client-facing interface. Implementations
     * use {@link Camel.FolderSummary} to manage the message list and cached metadata,
    ...
    abstract class Folder extends GObject.Object {
        ...
        /**
         * Folder flags (bit-or of {@link Camel.FolderFlags}).
         * @since 3.62
         * @default 0
         */
        get flags(): number;
        ...
        /**
         * A {@link Camel.ThreeState} persistent option of the folder,
        ...
        /**
         * Retrieve the {@link Camel.MessageInfo} for the specified `uid`.
         ...
         * {@link Camel.FolderQuotaInfo} struct with `camel_folder_quota_info_free()`.
         * 
         ...
         * 
         * This also emits the {@link Camel.Folder.SignalSignatures.renamed | Camel.Folder::renamed} signal from an idle source on
        ...
        /**
         * @param uid the UID of a message in `folder`
         * @returns the {@link Camel.MessageFlags} that are set on the indicated message.
         */
         ...
         * Free the returned {@link Camel.FolderQuotaInfo} struct with
    ...
    namespace FolderSummary {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
             ...
             * @run-first
             */
            "info-flags-changed": (uid: string, new_flags: number) => void;
     ...
     * 
     * {@link Camel.FolderSummary} manages lists of lightweight {@link Camel.MessageInfo}
     ...
     * 
     * If a {@link Camel.Index} is set via `camel_folder_summary_set_index()`, the
    ...
    class FolderSummary extends GObject.Object {
         ...
         * @param message a {@link Camel.MimeMessage} object
         * @virtual
         */
         ...
         * the message.
         * @param parser a {@link Camel.MimeParser} object
         * @virtual
         */
     ...
     * 
     * {@link Camel.FolderThread} computes conversation threads from a list of messages
     ...
     * 
     * Because threading operates on pre-computed hashes from {@link Camel.MessageInfo}
     * rather than parsing raw message content, it is very fast.
     * 
     * The result is a tree of {@link Camel.FolderThreadNode} structures accessible via
     * the `tree` field of the {@link Camel.FolderThread} object. Each node carries a
     * pointer to its {@link Camel.MessageInfo} and links to its parent, next sibling,
     ...
     * 
     * {@link Camel.Index} is an abstract base class that provides a content-indexing
     ...
     * message files.
     * 
     * The concrete implementation is {@link Camel.TextIndex}, which stores the index
     * on disk using a partition-table and block-file based format.
     * 
     * When a {@link Camel.Index} is attached to a {@link Camel.FolderSummary} (via
    ...
    class Index extends GObject.Object {
        ...
        /**
         * @param name a name to add
         * @returns a {@link Camel.IndexName} with    added given `name`, or `null`, when the `name` could not be    added.
         */
        ...
        /**
         * @param word a word to find
         * @returns a {@link Camel.IndexCursor} object with    the given `word`, or `null`, when not found
         */
        find(word: string): IndexCursor | null;

        /**
         * @param name a name to find
         * @returns a {@link Camel.IndexCursor} with    the given `name`, or `null`< when not found.
         */
        ...
        /**
         * @returns a {@link Camel.IndexCursor} containing    all words of the `index`, or `null`, when there are none
         */
     ...
     * 
     * {@link Camel.InternetAddress} is a {@link Camel.Address} subclass for handling RFC 822
    ...
    class KeyFile extends GObject.Object {
         ...
         * @param parent a {@link Camel._block_t}
         * @param records an array of {@link Camel._key_t} to write
     ...
     * 
     * {@link Camel.Medium} extends {@link Camel.DataWrapper} with support for named message
     * headers and a separate content object. It is the common ancestor of
     * {@link Camel.MimePart} and ultimately {@link Camel.MimeMessage}.
     * 
     ...
     * 
     * The content object is a {@link Camel.DataWrapper} instance accessible via
    ...
    abstract class Medium extends DataWrapper {
        ...
        // Virtual methods
        /**
         * Adds a header to a {@link Camel.Medium}.
         ...
         * Gets a data wrapper that represents the content of the medium,
         * without its headers.
         * @returns a {@link Camel.DataWrapper} containing `medium`'s content. Can return `null`.
         */
    ...
    abstract class MessageInfo extends GObject.Object {
        ...
        // Virtual methods
        /**
         * Clones the `mi` as a new {@link Camel.MessageInfo} and eventually assigns
     ...
     * 
     * {@link Camel.MimeFilter} is an abstract base class for stream-processing modules
     ...
     * 
     * - **Attached to a stream** — add to a {@link Camel.StreamFilter} so that data
     *   read from or written to the stream is automatically transformed.
     * 
     * - **Attached to a parser** — register with {@link Camel.MimeParser} for pipelined
     ...
     * ({@link Camel.MimeFilterCharset}), base64 and quoted-printable encoding
     * ({@link Camel.MimeFilterBasic}), line-ending canonicalisation
     * ({@link Camel.MimeFilterCRLF}), gzip compression ({@link Camel.MimeFilterGZip}), HTML
     * conversion (`CamelMimeFilterToHtml`), From-line escaping
     * ({@link Camel.MimeFilterFrom}), and many others.
     * @gir-type Class
     */
    ...
    class MimeFilterIndex extends MimeFilter {
        ...
        /**
         * Set `index` on `filter`.
         * @param index a {@link Camel.Index} object
         */
        set_index(index: Index): void;

        /**
         * Set the match name for any indexed words.
         * @param name a {@link Camel.IndexName} object
         */
     ...
     * 
     * {@link Camel.MimeMessage} is a {@link Camel.MimePart} subclass that represents a complete
     ...
     * date.
     * 
     * Recipient lists (To, Cc, Bcc) are exposed as {@link Camel.InternetAddress} objects
     * accessed via `camel_mime_message_get_recipients()`. The From and Reply-To
     * headers are similarly accessible as {@link Camel.InternetAddress} objects.
     * 
     * Because {@link Camel.MimeMessage} is a full {@link Camel.MimePart}, it can also hold a
     ...
     * 
     * {@link Camel.MimeParser} is the core mail parsing object in Camel. It parses
     ...
     * - Drive {@link Camel.MimeFilter} instances in a pipelined fashion for zero-copy
     *   decoding.
     * 
     * Because {@link Camel.MimeParser} does its own I/O buffering, initialising it from
    ...
    class MimeParser extends GObject.Object {
         ...
         * @param stream a {@link Camel.Stream} to init with
         * @returns -1 on error.
         * @throws GLib.Error
         */
     ...
     * 
     * {@link Camel.MimePart} is a {@link Camel.Medium} subclass that represents one part of a
     ...
     * interoperability.
     * 
     * A {@link Camel.MimePart} can be constructed directly from a {@link Camel.MimeParser} via
    ...
    class MimePart extends Medium {
         ...
         * @default null
         */
        get content_location(): string | null;
        set content_location(val: string | null);

        /**
         * @default null
         */
        get contentLocation(): string | null;
        set contentLocation(val: string | null);
         ...
         * @returns a {@link GLib.List} of languages
         */
         ...
         * @returns the parsed {@link Camel.ContentType} of the MIME part
         */
         ...
         * @returns a {@link Camel.TransferEncoding}
         */
        get_encoding(): TransferEncoding;
     ...
     * 
     * {@link Camel.Multipart} is a {@link Camel.DataWrapper} subclass that represents a
     * multipart/... MIME container. It holds an ordered list of {@link Camel.MimePart}
     * children separated by a boundary string.
     * 
     * Subclasses include {@link Camel.MultipartSigned} for multipart/signed (signed
     * messages) and {@link Camel.MultipartEncrypted} for multipart/encrypted (encrypted
     * messages).
     * 
    ...
    class Multipart extends DataWrapper {
         ...
         * @param part a {@link Camel.MimePart} to add
         * @virtual
         */
     ...
     * 
     * {@link Camel.MultipartEncrypted} is a {@link Camel.Multipart} subclass for handling
     ...
     * with {@link Camel.CipherContext} to decrypt or encrypt message content.
     * @gir-type Class
     */
     ...
     * 
     * {@link Camel.MultipartSigned} is a {@link Camel.Multipart} subclass for handling
     ...
     * {@link Camel.CipherContext} to verify or create signatures.
     * 
     * The signed content is accessible via the standard {@link Camel.Multipart} part
     * accessors, and the signature validity result (a {@link Camel.CipherValidity}) can
     ...
     * 
     * {@link Camel.NNTPAddress} is a {@link Camel.Address} subclass for handling lists of NNTP
     ...
     * Null output stream.
     * 
     * {@link Camel.NullOutputStream} is analogous to writing to /dev/null, except it
     ...
     * 
     * {@link Camel.OfflineFolder} is a {@link Camel.Folder} subclass that should be used by any
     * folder in an offline-capable ({@link Camel.OfflineStore}) backend.
     * 
     ...
     * 
     * {@link Camel.OfflineStore} is a {@link Camel.Store} subclass that any remote backend
     * supporting offline operation should extend instead of {@link Camel.Store} directly.
     * 
     ...
     * implementation synchronises all {@link Camel.OfflineFolder} instances that are
     * currently active.
     * 
     * Backends using {@link Camel.OfflineStore} should also provide
     * {@link Camel.OfflineFolder}-based folders for any folders representing remote data,
    ...
    class OfflineStore extends Store implements Gio.Initable {
        ...
        // Virtual methods
        /**
         * Returns a {@link GLib.PtrArray} of {@link Camel.Folder} objects which should be checked
    ...
    namespace Operation {
        ...
        interface SignalSignatures extends Gio.Cancellable.SignalSignatures {
             ...
             * @run-last
             */
            "push-message": (object: string) => void;
            /**
             * @signal
             * @run-last
             */
            status: (object: string, p0: number) => void;
        }
     ...
     * 
     * {@link Camel.Operation} is a bi-directional rendezvous mechanism used to communicate
    ...
    class PartitionTable extends GObject.Object {
        ...
        /**
         * Sets the {@link Camel.KeyTable} to use for resolving hash collisions.
     ...
     * 
     * {@link Camel.SExp} implements the s-expression matching functions used by
     * {@link Camel.FilterDriver} to evaluate filter rules against messages.
     * 
     ...
     * 
     * {@link Camel.Sasl} is an abstract base class for pluggable authentication
     ...
     * design (such as LOGIN and NTLM) are also wrapped in {@link Camel.Sasl} subclasses
    ...
    abstract class Sasl extends GObject.Object {
        ...
        /**
         * @param include_plain whether or not to include the PLAIN mechanism
         */
        static authtype_list(include_plain: boolean): ServiceAuthType[];

        /**
         * Checks whether exists a {@link Camel.Sasl} method for the `mechanism` and
         ...
         * 
         * Free the returned {@link GLib.ByteArray} with `g_byte_array_free()`.
     ...
     * 
     * {@link Camel.Service} is an abstract base class that is the common parent of
     * {@link Camel.Store} (mail storage and retrieval) and {@link Camel.Transport} (mail
     * sending). It defines the common operations associated with a configured
     * mail service.
     * 
     * Service instances are always created and managed by {@link Camel.Session} via
     * `camel_session_get_service()`. The session uses the GType stored in the
     * {@link Camel.Provider} descriptor to instantiate the correct subclass.
     * 
     * {@link Camel.Service} manages the connection lifecycle:
     * - `camel_service_connect()` establishes a connection to the remote resource.
     * - `camel_service_disconnect()` tears it down.
     * - Connection and authentication settings are conveyed via a {@link Camel.URL}
     ...
     * 
     * The connection state is exposed as a {@link Camel.ServiceConnectionStatus} and
    ...
    abstract class Service extends GObject.Object implements Gio.Initable {
         ...
         * `service`'s {@link Camel.Service.password} property.  The function makes only
         ...
         * 
         * Generally this function should only be called from a {@link Camel.Session}
         ...
         * if necessary, `service`'s {@link Camel.Service.password} property.  The function
    ...
    // Conflicted with GObject.Object.disconnect
        ...
        /**
         * Gets the {@link Camel.Provider} associated with the service.
         * @returns the {@link Camel.Provider}
         */
         ...
         * 
         * This is primarily intended for use by {@link Camel.Store}, {@link Camel.Transport} and
        ...
        /**
         * Returns the {@link Gio.ProxyResolver} for `service`.  If an application needs to
        ...
        /**
         * Returns the {@link Camel.Session} associated with the service.
         * 
        ...
        /**
         * Returns the {@link Camel.Settings} instance associated with the service.
         * 
        ...
        /**
         * Sets the {@link Gio.ProxyResolver} for `service`.  If an application needs to
         * override this, it should do so prior to calling functions on `service`
         * that may require a network connection.
         ...
         * {@link Camel.ServiceClass}.  If `settings` is `null`, a new {@link Camel.Settings}
    ...
    namespace Session {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
             ...
             * @run-last
             */
            "job-finished": (object: Gio.Cancellable | null, p0: GLib.Error) => void;
            /**
             * @signal
             * @run-last
             */
            "job-started": (object: Gio.Cancellable | null) => void;
            /**
             ...
             * @run-last
             */
            "user-alert": (service: Service, type: SessionAlertType, message: string) => void;
     ...
     * 
     * {@link Camel.Session} is a partially abstract class that provides the application
     * context for a Camel mail session. Client applications must subclass it and
     * override various virtual methods before any {@link Camel.Provider} backends can
     * function.
     * 
     * A session provides:
     * 
     * - **Service resolution** — `camel_session_ref_service()` looks up an
     *   already-registered {@link Camel.Service} by UID, while `camel_session_add_service()`
     *   registers a new service (instantiating the correct {@link Camel.Store} or
     *   {@link Camel.Transport} subclass based on the {@link Camel.Provider}).
     * 
     ...
     *   configured {@link Camel.FilterDriver} for automatic message filtering.
     * 
    ...
    class Session extends GObject.Object {
        ...
        // Virtual methods
        /**
         * Instantiates a new {@link Camel.Service} for `session`.  The `uid` identifies the
         * service for future lookup.  The `protocol` indicates which {@link Camel.Provider}
         * holds the {@link GObject.GType} of the {@link Camel.Service} subclass to instantiate.  The `type`
         * explicitly designates the service as a {@link Camel.Store} or {@link Camel.Transport}.
         * 
         * If the given `uid` has already been added, the existing {@link Camel.Service}
         * with that `uid` is returned regardless of whether it agrees with the
         * given `protocol` and `type`.
         * 
         * If no {@link Camel.Provider} is available to handle the given `protocol`, or
         * if the {@link Camel.Provider} does not specify a valid {@link GObject.GType} for `type`, the
         ...
         * A {@link Camel.Session} subclass is largely responsible for implementing this,
         ...
         * @param service the {@link Camel.Service} rejecting the password
         ...
         * @param folder the {@link Camel.Folder} where `message` is located
         ...
         * session.
         * 
         * The authenticator should set `error` to {@link Gio.IOErrorEnum.CANCELLED} if
         * the user did not provide the information. The caller must `g_free()`
         * the information returned when it is done with it.
         * @param service the {@link Camel.Service} this query is being made by
        ...
        /**
         * Emits a {@link Camel.Session.user_alert} signal from an idle source on the main
         ...
         * 
         * Note that {@link Camel.JunkFilter} itself is just an interface.  The application
         ...
         * and attaches it to `session`'s own {@link Camel.Session.main_context} using
         * `g_source_attach()`.
         * 
        ...
        /**
         * Returns a list of all {@link Camel.Service} objects previously added using
        ...
        /**
         * References a {@link Gio.NetworkMonitor} instance, which had been previously set
         * by `camel_session_set_network_monitor()`. If none is set, then the default
         * {@link Gio.NetworkMonitor} is returned, as provided by `g_network_monitor_get_default()`.
        ...
        /**
         * Looks up a {@link Camel.Service} by its unique identifier string.  The service
        ...
        /**
         * Removes all {@link Camel.Service} instances added by `camel_session_add_service()`.
         * 
        ...
        /**
         * Installs the {@link Camel.JunkFilter} instance used to classify messages as
         * junk or not junk during filtering.
         * 
         * Note that {@link Camel.JunkFilter} itself is just an interface.  The application
         * must implement the interface and install a {@link Camel.JunkFilter} instance for
         ...
         * 
         * 1) The {@link Camel.Session.job_started} signal is emitted from the thread
         *    in which `session` was created.  This is typically the same thread
         *    that hosts the global default {@link GLib.MainContext}, or "main" thread.
         * 
         ...
         *    is emitted from the same thread as {@link Camel.Session.job_started} was
         *    emitted.
         * 
    ...
    class Settings extends GObject.Object {
         ...
         * 
         * By default, equality requires both instances to have the same {@link GObject.GType}
    ...
    namespace Store {
        ...
        interface SignalSignatures extends Service.SignalSignatures {
             ...
             * @run-first
             */
            "folder-created": (object: FolderInfo) => void;
            /**
             * @signal
             * @run-first
             */
            "folder-deleted": (object: FolderInfo) => void;
            /**
             * This signal indicates significant changes have occurred to
             * the folder hierarchy of `store`, and that previously fetched
             * {@link Camel.FolderInfo} data should be considered stale.
             * 
             * Applications should handle this signal by replacing cached
             * {@link Camel.FolderInfo} data for `store` with fresh data by way of
             ...
             * @run-first
             */
            "folder-opened": (object: Folder) => void;
            /**
             * @signal
             * @run-first
             */
            "folder-renamed": (object: string, p0: FolderInfo) => void;
            "notify::connection-status": (pspec: GObject.ParamSpec) => void;
            "notify::display-name": (pspec: GObject.ParamSpec) => void;
            "notify::password": (pspec: GObject.ParamSpec) => void;
            "notify::provider": (pspec: GObject.ParamSpec) => void;
     ...
     * 
     * {@link Camel.Store} is the base class for backends that support storage and
     * retrieval of mail messages. It is a {@link Camel.Service} subclass that manages
     * a connection and a collection of {@link Camel.Folder} objects.
     * 
     * {@link Camel.Store} provides:
     ...
     *   {@link Camel.FolderInfo} describing the available folders.
     ...
     *   the {@link Camel.Subscribable} interface).
     * 
     * By default, stores set the {@link Camel.StoreFlags.VTRASH} and {@link Camel.StoreFlags.VJUNK}
     * flags, which cause the base class to implement the trash and junk folders
     * as virtual ({@link Camel.VeeFolder}) folders.
     * 
    ...
    abstract class Store extends Service implements Gio.Initable {
         ...
         * The returned {@link Camel.FolderInfo} struct should be freed with
        ...
        /**
         * Emits the {@link Camel.Store.SignalSignatures.folder_deleted | Camel.Store::folder-deleted} signal from an idle source on
         * the main loop.  The idle source's priority is #G_PRIORITY_HIGH_IDLE.
         * 
         * This function is only intended for Camel providers.
        ...
        /**
         * Emits the {@link Camel.Store.SignalSignatures.folder_info_stale | Camel.Store::folder-info-stale} signal from an idle source
         * on the main loop.  The idle source's priority is #G_PRIORITY_LOW.
         * 
         * See the {@link Camel.Store.SignalSignatures.folder_info_stale | Camel.Store::folder-info-stale} documentation for details on
        ...
        /**
         * Emits the {@link Camel.Store.SignalSignatures.folder_opened | Camel.Store::folder-opened} signal from an idle source on
         * the main loop.  The idle source's priority is #G_PRIORITY_HIGH_IDLE.
         * 
         * This function is only intended for Camel providers.
        ...
        /**
         * Emits the {@link Camel.Store.SignalSignatures.folder_renamed | Camel.Store::folder-renamed} signal from an idle source on
         * the main loop.  The idle source's priority is #G_PRIORITY_HIGH_IDLE.
         * 
         * This function is only intended for Camel providers.
         ...
         * starting with `top`, and returns a tree of {@link Camel.FolderInfo}
         * structures. If `flags` includes {@link Camel.StoreGetFolderInfoFlags.SUBSCRIBED},
         ...
         * {@link Camel.StoreGetFolderInfoFlags.RECURSIVE}, the returned tree will include
         * all levels of hierarchy below `top`. If not, it will only include
         * the immediate subfolders of `top`. If `flags` includes
         * {@link Camel.StoreGetFolderInfoFlags.FAST}, the unread_message_count fields of
         * some or all of the structures may be set to -1, if the store cannot
         * determine that information quickly.  If `flags` includes
         * {@link Camel.StoreGetFolderInfoFlags.NO_VIRTUAL}, don't include special virtual
         * folders (such as vTrash or vJunk).
         * 
         * The returned {@link Camel.FolderInfo} tree should be freed with
         * `camel_folder_info_free()`.
         * 
         ...
         * Returns {@link Gio.IOErrorEnum.NOT_SUPPORTED} when the store does not support this operation.
    ...
    /**
     * A {@link Camel.Store} database.
     * 
     * The {@link Camel.StoreDB} is a descendant of the {@link Camel.DB}, which takes care
    ...
    /**
     * Search between multiple folders of one {@link Camel.Store}.
     * 
     * The {@link Camel.StoreSearch} allows to search between multiple folders
     * of a single {@link Camel.Store}. It's primarily meant to be used by
     * the search folders ({@link Camel.VeeFolder}), but it can be used without
     * it too.
     * 
     * It can run only one search at a time, using `camel_store_search_rebuild_sync()`.
     * 
     * The {@link Camel.StoreSearch} is not thread safe, it's meant to be created, used and
     ...
     * 
     * {@link Camel.StoreSummary} is a helper class used by {@link Camel.Store} implementations
     * to cache the list of known folders and their metadata (name, flags, unread
     * count, etc.). Like {@link Camel.FolderSummary} for messages, it avoids the need to
     ...
     * per-folder fields.
     * 
     * Backends subclass {@link Camel.StoreSummary} to store additional information
    ...
    class StoreSummary extends GObject.Object {
        ...
        /**
         * Allocate a new {@link Camel.StoreInfo}, suitable for adding to this
         * summary.
     ...
     * 
     * {@link Camel.Stream} is an abstract base class that implements a simple read/write
     ...
     * 
     * - **{@link Camel.StreamBuffer}** — provides line-buffering on top of another stream,
     *   including a convenient `camel_stream_buffer_read_line()` function.
     * 
     * - **{@link Camel.StreamFilter}** — a sophisticated stream that runs data through a
     *   chain of {@link Camel.MimeFilter} instances for efficient pipelined processing.
     * 
     * - **{@link Camel.StreamFs}** — a file-descriptor-backed stream.
     * 
     * - **{@link Camel.StreamMem}** — a memory-backed stream backed by a {@link GLib.ByteArray}.
     * 
     * - **{@link Camel.StreamNull}** — a null stream that discards all output; useful for
     *   measuring encoded output size.
     * 
     * - **{@link Camel.StreamProcess}** — a stream backed by a child process.
     * 
    ...
    class Stream extends GObject.Object implements Gio.Seekable {
        ...
        /**
         * Replaces the {@link Gio.IOStream} passed to `camel_stream_new()` with `base_stream`.
         ...
         * blocking fashion.
         * @param output_stream destination {@link Camel.Stream} object
         * @param cancellable optional {@link Gio.Cancellable} object, or `null`
     ...
     * 
     * {@link Camel.StreamBuffer} wraps another {@link Camel.Stream} and provides buffering.
     ...
     * 
     * {@link Camel.StreamFilter} wraps another {@link Camel.Stream} and passes all data read
     * from or written to it through an ordered chain of {@link Camel.MimeFilter}
    ...
    class StreamFilter extends Stream implements Gio.Seekable {
        ...
        // Methods
        /**
         * Add a new {@link Camel.MimeFilter} to execute during the processing of this
         ...
         * @param filter a {@link Camel.MimeFilter} object
    ...
    class StreamMem extends Stream implements Gio.Seekable {
        ...
        /**
         * Set `buffer` to be the backing data to the existing {@link Camel.StreamMem}, `mem`.
         * 
         * Note: `buffer` will be copied into an internal {@link GLib.ByteArray} structure
         ...
         * @param buffer a {@link GLib.ByteArray}
         */
     ...
     * 
     * {@link Camel.Transport} is the base class for backends that support sending mail
     * messages. It is a {@link Camel.Service} subclass and adds a single core virtual
    ...
    abstract class Transport extends Service implements Gio.Initable {
         ...
         * @param message a {@link Camel.MimeMessage} to send
     ...
     * 
     * {@link Camel.VeeFolder} is a {@link Camel.Folder} subclass that implements virtual folders.
     ...
     * 
     * Virtual folders are normally parented to a {@link Camel.VeeStore}. The special
    ...
    class VeeFolder extends Folder {
         ...
         * @param vinfo a {@link Camel.VeeMessageInfo} to search for
         * @returns a real (not virtual) {@link Camel.Folder}, which the `vinfo` is for.
         */
     ...
     * 
     * {@link Camel.VeeStore} is a {@link Camel.Store} subclass that manages a list of virtual
     * ({@link Camel.VeeFolder}) folders. It handles the store-level operations such as
     * folder creation, renaming, and deletion for virtual folders.
     * 
     * {@link Camel.VeeStore} manages the virtual folder list entirely at run-time; the
     ...
     * 
     * {@link Camel.VeeStore} also automatically maintains an UNMATCHED virtual folder
     ...
     * 
     * {@link Camel.AsyncClosure} provides a simple way to run an asynchronous function
     * synchronously without blocking the current thread.
     * 
     * 1) Create a {@link Camel.AsyncClosure} with `camel_async_closure_new()`.
     * 
     * 2) Call the asynchronous function passing `camel_async_closure_callback()`
     *    as the {@link Gio.AsyncReadyCallback} argument and the {@link Camel.AsyncClosure} as the
     *    data argument.
     * 
     * 3) Call `camel_async_closure_wait()` and collect the {@link Gio.AsyncResult}.
     * 
     * 4) Call the corresponding asynchronous "finish" function, passing the
     *    {@link Gio.AsyncResult} returned by `camel_async_closure_wait()`.
     * 
     * 5) If needed, repeat steps 2-4 for additional asynchronous functions
     *    using the same {@link Camel.AsyncClosure}.
     * 
     * 6) Finally, free the {@link Camel.AsyncClosure} with `camel_async_closure_free()`.
     * @gir-type Struct
     * @since 3.12
     */
    ...
    class CipherValidity {
         ...
         * @param mode a {@link Camel.CipherValidityMode}, where to add the additional certificate information
         * @param name a name to add
         ...
         * another one.
         * @param valid a new {@link Camel.CipherValidity} to conglomerate the `parent` with
         */
    ...
    class ContentType {
        ...
        /**
         * Searches the params on s {@link Camel.ContentType} for a param named `name`
         * and gets the value.
         * @param name name of param to find
         * @returns the value of the `name` param
         */
    ...
    class FolderChangeInfo {
         ...
         * too.
         * @param src a {@link Camel.FolderChangeInfo} to append from
         */
    ...
    class FolderInfo {
         ...
         * @returns the cloned {@link Camel.FolderInfo} tree.
         */
        clone(): FolderInfo;
    ...
    class HeaderAddress {
        ...
        /**
         * TODO: Document me.
         * @param group a NULL-terminated list of {@link Camel.HeaderAddress}
         */
    ...
    class MessageContentInfo {
        ...
        /**
         * Calls the `func` for each {@link Camel.MessageContentInfo}, including the top one.
         * The `func` can return `true` to continue processing or `false` to stop it.
         * @param func a {@link Camel.MessageContentInfoTraverseCallback}
    ...
    class NameValueArray {
        ...
        /**
         * Compares content of the two {@link Camel.NameValueArray} and returns whether
    ...
    class NamedFlags {
        ...
        /**
         * Compares content of the two {@link Camel.NamedFlags} and returns whether
     ...
     * 
     * {@link Camel.Provider} is the plugin descriptor structure that describes a mail
     ...
     * mechanisms.
     * 
     * Key fields in the {@link Camel.Provider} structure:
     ...
     * - `object_types`: The {@link Camel.Store} and/or {@link Camel.Transport} GTypes to
     ...
     * registered, {@link Camel.Session} uses the provider's `object_types` to instantiate
     * the appropriate {@link Camel.Service} subclass when `camel_session_get_service()` is
     ...
     * of the provider's {@link Camel.Settings} descendant.
     * @gir-type Struct
     */
     ...
     * 
     * {@link Camel.URL} provides a URI parser, encoder, and logic for merging relative
     ...
     * memory correctly.
     * 
     * `camel_url_to_string()` serialises a {@link Camel.URL} back to a string,
     * with optional flags to hide sensitive fields such as URI parameters
     * (e.g. {@link Camel.URLFlags.PARAMS}) or authentication details
     * (e.g. {@link Camel.URLFlags.AUTH}).
     * 
     * `camel_url_new_with_base()` creates a new URI by resolving a relative URI
     * string against a base {@link Camel.URL}, following all relevant RFC rules.
     * 
    ...
    class URL {
        ...
        // Methods
        /**
         * Copy a {@link Camel.URL}.
         * @returns a duplicate copy of `in`
         */
        copy(): URL;

        /**
         * @param u2 the URL to compare
        ...
        /**
         * Set the path component of a {@link Camel.URL}.
         * @param path path
         */
        set_path(path: string): void;

        /**
         * Set the port on a {@link Camel.URL}.
         * @param port port
         */
        set_port(port: number): void;

        /**
         * Set the protocol of a {@link Camel.URL}.
         * @param protocol protocol schema
         */
        set_protocol(protocol: string): void;

        /**
         * Set the query of a {@link Camel.URL}.
         * @param query url query
         */
        set_query(query: string): void;

        /**
         * Set the user of a {@link Camel.URL}.
         * @param user username
         */
        set_user(user: string): void;

        /**
         * Flatten a {@link Camel.URL} into a string.
    ...
    interface NetworkService extends Service {
         ...
         * {@link Camel.NetworkService.connectable} property can be reached, without actually
         ...
         * to an appropriate error (such as {@link Gio.IOErrorEnum.HOST_UNREACHABLE}).
         * 
    ...
    // Conflicted with Camel.Service.connect_sync
         ...
         * {@link Camel.NetworkService.connectable}.
         * 
    ...
    namespace Subscribable {
        ...
        interface Interface {
            ...
            /**
             * Emits the {@link Camel.Subscribable.SignalSignatures.folder_subscribed | Camel.Subscribable::folder-subscribed} signal from an idle source
            ...
            /**
             * Emits the {@link Camel.Subscribable.SignalSignatures.folder_unsubscribed | Camel.Subscribable::folder-unsubscribed} signal from an idle source
             * on the main loop.  The idle source's priority is #G_PRIORITY_HIGH_IDLE.
             * 
             * This function is only intended for Camel providers.

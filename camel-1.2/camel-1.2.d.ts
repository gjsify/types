...
export namespace Camel {
    ...
    class DataCache extends GObject.Object {
        ...
        // Methods
        /**
         * Add a new item to the cache, returning a {@link Gio.IOStream} to the new item.
         * 
         ...
         * @returns a {@link Gio.IOStream} for the new cache item, or `null` on error
         */
    ...
    class FolderSearch extends GObject.Object {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof FolderSearch.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, FolderSearch.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof FolderSearch.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, FolderSearch.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof FolderSearch.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<FolderSearch.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
    ...
    class VeeDataCache extends GObject.Object {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof VeeDataCache.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, VeeDataCache.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof VeeDataCache.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, VeeDataCache.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof VeeDataCache.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<VeeDataCache.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
    ...
    class VeeMessageInfoData extends GObject.Object {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof VeeMessageInfoData.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, VeeMessageInfoData.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof VeeMessageInfoData.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, VeeMessageInfoData.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof VeeMessageInfoData.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<VeeMessageInfoData.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
    ...
    class VeeSubfolderData extends GObject.Object {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof VeeSubfolderData.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, VeeSubfolderData.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof VeeSubfolderData.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, VeeSubfolderData.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof VeeSubfolderData.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<VeeSubfolderData.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;

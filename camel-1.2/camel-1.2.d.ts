 ...
 * @returns the number of bytes encoded
 */
function uuencode_close(_in: Uint8Array, out: Uint8Array, uubuf: Uint8Array, save: number[]): [number, Uint8Array, Uint8Array, number[]]
/**
 ...
 * @returns the number of bytes encoded
 */
function uuencode_step(_in: Uint8Array, out: Uint8Array, uubuf: Uint8Array, save: number[]): [number, Uint8Array, Uint8Array, number[]]
/**
...
static ["new"](filename: string): DB;
     ...
     */
    static get_column_ident(hash: GLib.HashTable<any, any>, index: number, col_names: string[]): [DBKnownColumnNames, GLib.HashTable<any, any>]
     ...
     * @returns 0 on success, -1 on error
     */
    get_folder_uids(folder_name: string, sort_by: (string | null), collate: (string | null), hash: GLib.HashTable<string, number>): number
    /**
...
static ["new"](session?: (Session | null)): GpgContext;
     ...
     * @returns whether succeeded
     */
    get_key_data_info_sync(data: number, data_size: number, flags: number, cancellable?: (Gio.Cancellable | null)): [boolean, GpgKeyInfo[]]
    /**
...
_init(...args: any[]): void;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'job-finished', callback: ((_source: this, object: Gio.Cancellable | null, p0: GLib.Error) => void)): number
    connect_after(signal: 'job-finished', callback: ((_source: this, object: Gio.Cancellable | null, p0: GLib.Error) => void)): number
    ...
    connect(signal: 'user-alert', callback: ((_source: this, service: Service, type: SessionAlertType, message: string) => void)): number
    connect_after(signal: 'user-alert', callback: ((_source: this, service: Service, type: SessionAlertType, message: string) => void)): number

/**
 * The GIR-derived widget VOCABULARY for Meta-14.
 *
 * GENERATED — do not edit. Provenance: Meta-14 — dropped empty base(s): Atk.ImplementorIface
 *
 * 34 instantiable GTypes (of which 0 concrete widgets), 34 declarations, 33 enum nick unions, 0 slot candidates.
 *
...
import type Meta from './meta-14.js';
import type { ClutterActorConstructOnly, ClutterActorProps, ClutterAnimatableConstructOnly, ClutterAnimatableProps, ClutterContentConstructOnly, ClutterContentProps, ClutterStageConstructOnly, ClutterStageProps } from '@girs/clutter-14/vocabulary';

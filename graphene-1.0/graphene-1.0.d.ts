...
export namespace Graphene {
     ...
     */
    class Box {
        // Constructors of Graphene-1.0.Box

        constructor(properties?: Partial<{}>);

        static alloc(): Box;

        // Owm methods of Graphene-1.0.Box
         ...
         */
        expand_scalar(scalar: number): void;
        /**
     ...
     */
    class Euler {
        // Constructors of Graphene-1.0.Euler

        constructor(properties?: Partial<{}>);

        static alloc(): Euler;

        // Owm methods of Graphene-1.0.Euler
     ...
     */
    class Frustum {
        // Constructors of Graphene-1.0.Frustum

        constructor(properties?: Partial<{}>);

        static alloc(): Frustum;

        // Owm methods of Graphene-1.0.Frustum
     ...
     */
    class Matrix {
        // Constructors of Graphene-1.0.Matrix

        constructor(properties?: Partial<{}>);

        static alloc(): Matrix;

        // Owm methods of Graphene-1.0.Matrix
         ...
         */
        interpolate(b: Matrix, factor: number): void;
        /**
         ...
         * @param r a #graphene_rect_t
         */
        project_rect_bounds(r: Rect): void;
        /**
         ...
         */
        unproject_point3d(modelview: Matrix, point: Point3D): void;
        /**
         ...
         */
        untransform_bounds(r: Rect, bounds: Rect): void;
        /**
         ...
         */
        untransform_point(p: Point, bounds: Rect): boolean;
    }
     ...
     */
    class Plane {
        // Constructors of Graphene-1.0.Plane

        constructor(properties?: Partial<{}>);

        static alloc(): Plane;

        // Owm methods of Graphene-1.0.Plane
         ...
         */
        transform(matrix: Matrix, normal_matrix: Matrix | null): void;
    }
     ...
     */
    class Point {
        // Own fields of Graphene-1.0.Point

        x: number;
        y: number;

        // Constructors of Graphene-1.0.Point
        ...
        // Owm methods of Graphene-1.0.Point
         ...
         * @param factor the linear interpolation factor
         */
        interpolate(b: Point, factor: number): void;
        /**
     ...
     */
    class Point3D {
        // Own fields of Graphene-1.0.Point3D

        x: number;
        y: number;
        z: number;

        // Constructors of Graphene-1.0.Point3D
        ...
        // Owm methods of Graphene-1.0.Point3D
         ...
         */
        interpolate(b: Point3D, factor: number): void;
        /**
         ...
         */
        normalize_viewport(viewport: Rect, z_near: number, z_far: number): void;
        /**
     ...
     */
    class Quad {
        // Constructors of Graphene-1.0.Quad

        constructor(properties?: Partial<{}>);

        static alloc(): Quad;

        // Owm methods of Graphene-1.0.Quad
     ...
     */
    class Quaternion {
        // Constructors of Graphene-1.0.Quaternion

        constructor(properties?: Partial<{}>);

        static alloc(): Quaternion;

        // Owm methods of Graphene-1.0.Quaternion

        /**
         * Adds two #graphene_quaternion_t `a` and `b`.
         * @param b a #graphene_quaternion_t
         */
        add(b: Quaternion): void;
        /**
         ...
         * @param factor the linear interpolation factor
         */
        slerp(b: Quaternion, factor: number): void;
        /**
     ...
     */
    class Ray {
        // Constructors of Graphene-1.0.Ray

        constructor(properties?: Partial<{}>);

        static alloc(): Ray;

        // Owm methods of Graphene-1.0.Ray
         ...
         * @param p a #graphene_point3d_t
         */
        get_closest_point_to_point(p: Point3D): void;
        /**
         ...
         */
        intersect_box(b: Box): RayIntersectionKind;
        /**
         * Intersects the given #graphene_ray_t `r` with the given
         * #graphene_sphere_t `s`.
         * @param s a #graphene_sphere_t
         * @returns the type of intersection
         */
        intersect_sphere(s: Sphere): RayIntersectionKind;
        /**
         * Intersects the given #graphene_ray_t `r` with the given
         ...
         * @returns the type of intersection
         */
        intersect_triangle(t: Triangle): RayIntersectionKind;
        /**
     ...
     */
    class Rect {
        // Own fields of Graphene-1.0.Rect

        origin: Point;
        size: Size;

        // Constructors of Graphene-1.0.Rect
        ...
        // Owm methods of Graphene-1.0.Rect
         ...
         */
        get_bottom_left(): void;
        /**
         * Retrieves the coordinates of the bottom-right corner of the given rectangle.
         */
        get_bottom_right(): void;
        /**
         ...
         * @param d_y the vertical inset
         */
        inset_r(d_x: number, d_y: number): void;
        /**
         ...
         * @param factor the linear interpolation factor
         */
        interpolate(b: Rect, factor: number): void;
        /**
         ...
         * @param d_y the vertical offset
         */
        offset_r(d_x: number, d_y: number): void;
        /**
         ...
         */
        scale(s_h: number, s_v: number): void;
        /**
    ...
    class Simd4F {
        // Constructors of Graphene-1.0.Simd4F
     ...
     */
    class Size {
        // Own fields of Graphene-1.0.Size

        width: number;
        height: number;

        // Constructors of Graphene-1.0.Size
        ...
        // Owm methods of Graphene-1.0.Size
         ...
         * @param factor the linear interpolation factor
         */
        interpolate(b: Size, factor: number): void;
        /**
     ...
     */
    class Sphere {
        // Constructors of Graphene-1.0.Sphere

        constructor(properties?: Partial<{}>);

        static alloc(): Sphere;

        // Owm methods of Graphene-1.0.Sphere
     ...
     */
    class Triangle {
        // Constructors of Graphene-1.0.Triangle

        constructor(properties?: Partial<{}>);

        static alloc(): Triangle;

        // Owm methods of Graphene-1.0.Triangle
         ...
         */
        get_barycoords(p: Point3D | null): boolean;
        /**
         ...
         */
        get_uv(p: Point3D | null, uv_a: Vec2, uv_b: Vec2, uv_c: Vec2): boolean;
        /**
     ...
     */
    class Vec2 {
        // Constructors of Graphene-1.0.Vec2

        constructor(properties?: Partial<{}>);

        static alloc(): Vec2;

        // Owm methods of Graphene-1.0.Vec2
         ...
         * @param factor the interpolation factor
         */
        interpolate(v2: Vec2, factor: number): void;
        /**
     ...
     */
    class Vec3 {
        // Constructors of Graphene-1.0.Vec3

        constructor(properties?: Partial<{}>);

        static alloc(): Vec3;

        // Owm methods of Graphene-1.0.Vec3
         ...
         * @param factor the interpolation factor
         */
        interpolate(v2: Vec3, factor: number): void;
        /**
     ...
     */
    class Vec4 {
        // Constructors of Graphene-1.0.Vec4

        constructor(properties?: Partial<{}>);

        static alloc(): Vec4;

        // Owm methods of Graphene-1.0.Vec4
         ...
         * @param factor the interpolation factor
         */
        interpolate(v2: Vec4, factor: number): void;
        /**

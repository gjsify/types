...
export function functions_get_equal_func_for(t: GObject.GType): [ /* returnType */ EqualDataFunc, /* result_target */ any, /* result_target_destroy_notify */ GLib.DestroyNotify ]
export function functions_get_hash_func_for(t: GObject.GType): [ /* returnType */ HashDataFunc, /* result_target */ any, /* result_target_destroy_notify */ GLib.DestroyNotify ]
export function functions_get_compare_func_for(t: GObject.GType): [ /* returnType */ GLib.CompareDataFunc, /* result_target */ any, /* result_target_destroy_notify */ GLib.DestroyNotify ]
...
export function task(g_type: GObject.GType, g_dup_func: GObject.BoxedCopyFunc, g_destroy_func: GLib.DestroyNotify, task: Task): Future

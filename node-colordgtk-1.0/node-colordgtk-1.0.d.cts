...
import './node-colordgtk-1.0-import.d.ts';
...
export interface Window {
    ...
    on(sigName: "changed", callback: Window.ChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "changed", callback: Window.ChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "changed", callback: Window.ChangedSignalCallback): NodeJS.EventEmitter

...
export namespace PackageKitPlugin {
    ...
    class Backend extends GObject.Object {
        // Constructors of PackageKitPlugin-1.0.Backend

        static ['new'](conf: GLib.KeyFile): Backend;

        // Owm methods of PackageKitPlugin-1.0.Backend
    ...
    class BackendJob extends GObject.Object {
        // Constructors of PackageKitPlugin-1.0.BackendJob

        static ['new'](conf: GLib.KeyFile): BackendJob;

        // Owm methods of PackageKitPlugin-1.0.BackendJob
    ...
    class Transaction extends GObject.Object {
        // Constructors of PackageKitPlugin-1.0.Transaction

        static ['new'](conf: GLib.KeyFile, introspection: Gio.DBusNodeInfo): Transaction;

        // Owm methods of PackageKitPlugin-1.0.Transaction
    ...
    class Plugin {
        // Own fields of PackageKitPlugin-1.0.Plugin

        backend: Backend;
        job: BackendJob;

        // Owm methods of PackageKitPlugin-1.0.Plugin

/**
 * The GIR-derived widget VOCABULARY for PackageKitPlugin-1.0.
 *
 * GENERATED — do not edit. Provenance: PackageKitPlugin-1.0
 *
...
export interface PkBackendProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type PkBackendConstructOnly = GObjectConstructOnly;

export interface PkBackendJobProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type PkBackendJobConstructOnly = GObjectConstructOnly;

export interface PkTransactionProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type PkTransactionConstructOnly = GObjectConstructOnly;

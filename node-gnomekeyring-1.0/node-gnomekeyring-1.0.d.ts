 ...
 */
function cancelRequest(request: any): void
/**
 ...
 */
function freePassword(password: string | null): void
/**
 ...
 * @returns %GNOME_KEYRING_RESULT_OK if the operation was succcessful or an error result otherwise.
 */
function getDefaultKeyringSync(): [ /* returnType */ Result, /* keyring */ string | null ]
/**
 ...
 */
function itemAcGetDisplayName(ac: AccessControl): string | null
/**
 * Get the access control application's full path name.
 * @param ac A #GnomeKeyringAccessControl pointer.
 * @returns A newly allocated string containing the display name.
 */
function itemAcGetPathName(ac: AccessControl): string | null
/**

/**
 * The GIR-derived widget VOCABULARY for Fcitx-1.0.
 *
 * GENERATED — do not edit. Provenance: Fcitx-1.0
 *
...
import type Fcitx from './fcitx-1.0.js';
...
export interface FcitxClientProps extends GObjectProps {
    connection?: Fcitx.Connection;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type FcitxClientConstructOnly = GObjectConstructOnly | 'connection';

/** A FcitxConnection allow to create a input context via DBus */
export interface FcitxConnectionProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type FcitxConnectionConstructOnly = GObjectConstructOnly;

/** A #FcitxInputMethod allow you to control fcitx via DBus. */
export interface FcitxInputMethodProps extends GDBusProxyProps, GAsyncInitableProps, GDBusInterfaceProps, GInitableProps {
    /** The current IM. */
    'current-im'?: string;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type FcitxInputMethodConstructOnly = GDBusProxyConstructOnly | GAsyncInitableConstructOnly | GDBusInterfaceConstructOnly | GInitableConstructOnly;

/** A #FcitxKbd allow you to control fcitx via DBus. */
export interface FcitxKbdProps extends GDBusProxyProps, GAsyncInitableProps, GDBusInterfaceProps, GInitableProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type FcitxKbdConstructOnly = GDBusProxyConstructOnly | GAsyncInitableConstructOnly | GDBusInterfaceConstructOnly | GInitableConstructOnly;

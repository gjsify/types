...
export const PROP_TYPES = {
    'AgsCartesian.center': 'gdouble',
    'AgsCartesian.font-size': 'gdouble',
    'AgsCartesian.line-width': 'gdouble',
    'AgsCartesian.plot': 'gpointer',
    'AgsCartesian.point-radius': 'gdouble',
    'AgsCartesian.surface': 'gpointer',
    'AgsCartesian.translate-data': 'gpointer',
    'AgsCartesian.x-big-scale-factor': 'gdouble',
    'AgsCartesian.x-end': 'gdouble',
    'AgsCartesian.x-label': 'gpointer',
    'AgsCartesian.x-label-data': 'gpointer',
    'AgsCartesian.x-label-factor': 'gdouble',
    'AgsCartesian.x-label-precision': 'gdouble',
    'AgsCartesian.x-label-start': 'gdouble',
    'AgsCartesian.x-label-step-width': 'gdouble',
    'AgsCartesian.x-margin': 'gdouble',
    'AgsCartesian.x-scale-data': 'gpointer',
    'AgsCartesian.x-scale-step-width': 'gdouble',
    'AgsCartesian.x-small-scale-factor': 'gdouble',
    'AgsCartesian.x-start': 'gdouble',
    'AgsCartesian.x-step': 'gdouble',
    'AgsCartesian.x-step-data': 'gpointer',
    'AgsCartesian.x-step-factor': 'gdouble',
    'AgsCartesian.x-step-width': 'gdouble',
    'AgsCartesian.x-translate-point': 'gdouble',
    'AgsCartesian.x-unit': 'gchararray',
    'AgsCartesian.x-unit-size': 'gdouble',
    'AgsCartesian.x-unit-x0': 'gdouble',
    'AgsCartesian.x-unit-y0': 'gdouble',
    'AgsCartesian.y-big-scale-factor': 'gdouble',
    'AgsCartesian.y-end': 'gdouble',
    'AgsCartesian.y-label': 'gpointer',
    'AgsCartesian.y-label-data': 'gpointer',
    'AgsCartesian.y-label-factor': 'gdouble',
    'AgsCartesian.y-label-precision': 'gdouble',
    'AgsCartesian.y-label-start': 'gdouble',
    'AgsCartesian.y-label-step-height': 'gdouble',
    'AgsCartesian.y-margin': 'gdouble',
    'AgsCartesian.y-scale-data': 'gpointer',
    'AgsCartesian.y-scale-step-height': 'gdouble',
    'AgsCartesian.y-small-scale-factor': 'gdouble',
    'AgsCartesian.y-start': 'gdouble',
    'AgsCartesian.y-step': 'gdouble',
    'AgsCartesian.y-step-data': 'gpointer',
    'AgsCartesian.y-step-factor': 'gdouble',
    'AgsCartesian.y-step-height': 'gdouble',
    'AgsCartesian.y-translate-point': 'gdouble',
    'AgsCartesian.y-unit': 'gchararray',
    'AgsCartesian.y-unit-size': 'gdouble',
    'AgsCartesian.y-unit-x0': 'gdouble',
    'AgsCartesian.y-unit-y0': 'gdouble',
    'AgsDial.adjustment': 'GObject',
    'AgsDial.button-height': 'gint',
    'AgsDial.button-width': 'gint',
    'AgsDial.font-name': 'gchararray',
    'AgsDial.font-size': 'guint',
    'AgsDial.margin-left': 'gint',
    'AgsDial.margin-right': 'gint',
    'AgsDial.outline-strength': 'guint',
    'AgsDial.radius': 'guint',
    'AgsDial.scale-precision': 'guint',
    'AgsFileDialog.file-widget': 'gpointer',
    'AgsFileEntry.filename': 'gchararray',
    'AgsFileEntry.im-module': 'gchararray',
    'AgsFileWidget.app-generic-path': 'gchararray',
    'AgsFileWidget.app-home-path': 'gchararray',
    'AgsFileWidget.bookmark-filename': 'gchararray',
    'AgsFileWidget.current-path': 'gchararray',
    'AgsFileWidget.default-bundle': 'gchararray',
    'AgsFileWidget.default-path': 'gchararray',
    'AgsFileWidget.file-magic-executable': 'gchararray',
    'AgsFileWidget.home-path': 'gchararray',
    'AgsFileWidget.recently-used-filename': 'gchararray',
    'AgsIconLink.action': 'gchararray',
    'AgsIndicator.adjustment': 'GObject',
    'AgsIndicator.segment-count': 'guint',
    'AgsIndicator.segment-height': 'guint',
    'AgsIndicator.segment-padding': 'guint',
    'AgsIndicator.segment-width': 'guint',
    'AgsLed.segment-height': 'guint',
    'AgsLed.segment-width': 'guint',
    'AgsLedArray.led-count': 'guint',
    'AgsLedArray.segment-height': 'guint',
    'AgsLedArray.segment-width': 'guint',
    'AgsLevel.data-format': 'guint',
    'AgsLevel.lower': 'gdouble',
    'AgsLevel.normalized-volume': 'gdouble',
    'AgsLevel.samplerate': 'guint',
    'AgsLevel.upper': 'gdouble',
    'AgsNotebook.tab-height': 'guint',
    'AgsNotebook.tab-width': 'guint',
    'AgsPiano.base-key-code': 'guint',
    'AgsPiano.base-note': 'gchararray',
    'AgsPiano.key-count': 'guint',
    'AgsPiano.key-height': 'guint',
    'AgsPiano.key-width': 'guint',
    'AgsRuler.adjustment': 'GObject',
    'AgsRuler.factor': 'gdouble',
    'AgsRuler.font-size': 'guint',
    'AgsRuler.large-step': 'guint',
    'AgsRuler.precision': 'gdouble',
    'AgsRuler.scale-precision': 'gdouble',
    'AgsRuler.small-step': 'guint',
    'AgsRuler.step': 'guint',
    'AgsScale.control-name': 'gchararray',
    'AgsScale.default-value': 'gdouble',
    'AgsScale.lower': 'gdouble',
    'AgsScale.upper': 'gdouble',
    'AgsTempo.control-name': 'gchararray',
    'AgsTempo.default-value': 'gdouble',
    'AgsTempo.lower': 'gdouble',
    'AgsTempo.upper': 'gdouble',
};

...
export namespace AgsGui {
    ...
    class FileEntry extends Gtk.Box implements Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Orientable {
        ...
        /** @signal */
        connect<K extends keyof FileEntry.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, FileEntry.SignalSignatures[K]>,
        ): number;
        connect(signal: string, callback: (...args: any[]) => any): number;
        /** @signal */
        connect_after<K extends keyof FileEntry.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, FileEntry.SignalSignatures[K]>,
        ): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;
        /** @signal */
        emit<K extends keyof FileEntry.SignalSignatures>(
            signal: K,
            ...args: GObject.GjsParameters<FileEntry.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never
        ): void;
        emit(signal: string, ...args: any[]): void;

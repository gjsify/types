...
export namespace Atk {
    ...
    class GObjectAccessible extends Object {
        // Owm methods of Atk-1.0.GObjectAccessible
    ...
    class Hyperlink extends GObject.Object {
        // Own properties of Atk-1.0.Hyperlink
        ...
        // Owm methods of Atk-1.0.Hyperlink
    ...
    class NoOpObject extends Object {
        // Constructors of Atk-1.0.NoOpObject
    ...
    class NoOpObjectFactory extends ObjectFactory {
        // Constructors of Atk-1.0.NoOpObjectFactory
    ...
    class Object extends GObject.Object {
        // Own properties of Atk-1.0.Object
    ...
    class ObjectFactory extends GObject.Object {
        // Owm methods of Atk-1.0.ObjectFactory
    ...
    class Plug extends Object {
        // Constructors of Atk-1.0.Plug

        static ['new'](): Plug;

        // Owm methods of Atk-1.0.Plug
    ...
    class Registry extends GObject.Object {
        // Owm methods of Atk-1.0.Registry
    ...
    class Relation extends GObject.Object {
        // Own properties of Atk-1.0.Relation

        relation_type: RelationType;
        relationType: RelationType;
        target: GObject.ValueArray;

        // Own fields of Atk-1.0.Relation

        relationship: RelationType;

        // Constructors of Atk-1.0.Relation

        static ['new'](targets: Object[], relationship: RelationType): Relation;

        // Owm methods of Atk-1.0.Relation
    ...
    class RelationSet extends GObject.Object {
        // Own fields of Atk-1.0.RelationSet

        relations: any[];

        // Constructors of Atk-1.0.RelationSet

        static ['new'](): RelationSet;

        // Owm methods of Atk-1.0.RelationSet
    ...
    class Socket extends Object {
        // Constructors of Atk-1.0.Socket

        static ['new'](): Socket;

        // Owm methods of Atk-1.0.Socket
    ...
    class StateSet extends GObject.Object {
        // Constructors of Atk-1.0.StateSet

        static ['new'](): StateSet;

        // Owm methods of Atk-1.0.StateSet
     ...
     */
    class Attribute {
        // Own fields of Atk-1.0.Attribute

        name: string;
        value: string;

        // Constructors of Atk-1.0.Attribute
        ...
        // Owm methods of Atk-1.0.Attribute
    ...
    class GObjectAccessibleClass {
        // Own fields of Atk-1.0.GObjectAccessibleClass
    ...
    class HyperlinkClass {
        // Own fields of Atk-1.0.HyperlinkClass
    ...
    class Implementor {
        // Owm methods of Atk-1.0.Implementor
    ...
    class KeyEventStruct {
        // Own fields of Atk-1.0.KeyEventStruct
        ...
        // Constructors of Atk-1.0.KeyEventStruct
     ...
     */
    class MiscClass {
        // Own fields of Atk-1.0.MiscClass
    ...
    class ObjectClass {
        // Own fields of Atk-1.0.ObjectClass

        pad1: Function;
    }

    class ObjectFactoryClass {
        // Own fields of Atk-1.0.ObjectFactoryClass
    ...
    class PropertyValues {
        // Own fields of Atk-1.0.PropertyValues
     ...
     */
    class Rectangle {
        // Own fields of Atk-1.0.Rectangle
        ...
        // Constructors of Atk-1.0.Rectangle
    ...
    class RelationSetClass {
        // Own fields of Atk-1.0.RelationSetClass
    ...
    class StreamableContentIface {
        // Own fields of Atk-1.0.StreamableContentIface
     ...
     */
    class TextRange {
        // Own fields of Atk-1.0.TextRange
        ...
        // Constructors of Atk-1.0.TextRange
     ...
     */
    class TextRectangle {
        // Own fields of Atk-1.0.TextRectangle
        ...
        // Constructors of Atk-1.0.TextRectangle
    ...
    interface Action {
        ...
        // Own virtual methods of Atk-1.0.Action
    ...
    interface Component {
        // Owm methods of Atk-1.0.Component
         ...
         * @param coord_type specifies whether the coordinates are relative to the screen or to the components top level window
         */
        get_extents(coord_type: CoordType): void;
        /**
         ...
         * @param coord_type specifies whether the coordinates are relative to the screen or to the components top level window
         */
        get_position(coord_type: CoordType): void;
        /**
        ...
        // Own virtual methods of Atk-1.0.Component
         ...
         * @param coord_type specifies whether the coordinates are relative to the screen or to the components top level window
         */
        vfunc_get_extents(coord_type: CoordType): void;
        /**
         * Gets the layer of the component.
         */
         ...
         * @param coord_type specifies whether the coordinates are relative to the screen or to the components top level window
         */
        vfunc_get_position(coord_type: CoordType): void;
        /**
         * Gets the size of the `component` in terms of width and height.
         *
         * If the size can not be obtained (e.g. a non-embedded plug or missing
    ...
    interface Document {
        // Owm methods of Atk-1.0.Document
        ...
        // Own virtual methods of Atk-1.0.Document
    ...
    interface EditableText {
        // Owm methods of Atk-1.0.EditableText
        ...
        // Own virtual methods of Atk-1.0.EditableText
    ...
    interface HyperlinkImpl {
        // Owm methods of Atk-1.0.HyperlinkImpl
        ...
        // Own virtual methods of Atk-1.0.HyperlinkImpl
    ...
    interface Hypertext {
        // Owm methods of Atk-1.0.Hypertext
        ...
        // Own virtual methods of Atk-1.0.Hypertext
    ...
    interface Image {
         ...
         * @param coord_type specifies whether the coordinates are relative to the screen or to the components top level window
         */
        get_image_position(coord_type: CoordType): void;
        /**
        ...
        // Own virtual methods of Atk-1.0.Image
         ...
         * @param coord_type specifies whether the coordinates are relative to the screen or to the components top level window
         */
        vfunc_get_image_position(coord_type: CoordType): void;
        /**
         * Get the width and height in pixels for the specified image.
         * The values of `width` and `height` are returned as -1 if the
         * values cannot be obtained (for instance, if the object is not onscreen).
    ...
    interface Selection {
        // Owm methods of Atk-1.0.Selection
        ...
        // Own virtual methods of Atk-1.0.Selection
    ...
    interface StreamableContent {
        // Owm methods of Atk-1.0.StreamableContent
        ...
        // Own virtual methods of Atk-1.0.StreamableContent
    ...
    interface Table {
        ...
        // Own virtual methods of Atk-1.0.Table
    ...
    interface TableCell {
        // Owm methods of Atk-1.0.TableCell
        ...
        // Own virtual methods of Atk-1.0.TableCell
         ...
         * on the object.
         */
        vfunc_get_row_column_span(): boolean;
        /**
         * Returns the row headers as an array of cell accessibles.
         */
    ...
    interface Text {
         ...
         */
        get_character_extents(offset: number, coords: CoordType): void;
        /**
        ...
        // Own virtual methods of Atk-1.0.Text
         ...
         * @param coords specify whether coordinates are relative to the screen or widget window
         */
        vfunc_get_character_extents(offset: number, coords: CoordType): void;
        /**
         * Creates an #AtkAttributeSet which consists of the default values of
         * attributes for the text. See the enum AtkTextAttribute for types of text
         * attributes that can be returned. Note that other attributes may also be
         ...
         * @param coord_type Specify whether coordinates are relative to the screen or widget window.
         */
        vfunc_get_range_extents(start_offset: number, end_offset: number, coord_type: CoordType): void;
        /**
         * Creates an #AtkAttributeSet which consists of the attributes explicitly
         * set at the position `offset` in the text. `start_offset` and `end_offset` are
         * set to the start and end of the range around `offset` where the attributes are
         ...
         * @param offset the character offset at which to get the attributes, -1 means the offset of the character to be inserted at the caret location.
         */
        vfunc_get_run_attributes(offset: number): AttributeSet;
        /**
         * Gets the text from the specified selection.
         * @param selection_num The selection number.  The selected regions are assigned numbers that correspond to how far the region is from the start of the text.  The selected region closest to the beginning of the text region is assigned the number 0, etc.  Note that adding, moving or deleting a selected region can change the numbering.
         */
        vfunc_get_selection(selection_num: number): string;
        /**
         * Gets a portion of the text exposed through an #AtkText according to a given `offset`
         * and a specific `granularity,` along with the start and end offsets defining the
         * boundaries of such a portion of text.
         ...
         * @param granularity An #AtkTextGranularity
         */
        vfunc_get_string_at_offset(offset: number, granularity: TextGranularity): string | null;
        /**
         * Gets the specified text.
         * @param start_offset a starting character offset within @text
         * @param end_offset an ending character offset within @text, or -1 for the end of the string.
         ...
         * @param boundary_type An #AtkTextBoundary
         */
        vfunc_get_text_after_offset(offset: number, boundary_type: TextBoundary): string;
        /**
         * Gets the specified text.
         *
         * If the boundary_type if ATK_TEXT_BOUNDARY_CHAR the character at the
         ...
         * @param boundary_type An #AtkTextBoundary
         */
        vfunc_get_text_at_offset(offset: number, boundary_type: TextBoundary): string;
        /**
         * Gets the specified text.
         * @param offset position
         * @param boundary_type An #AtkTextBoundary
         */
        vfunc_get_text_before_offset(offset: number, boundary_type: TextBoundary): string;
        /**
         * Removes the specified selection.
         * @param selection_num The selection number.  The selected regions are assigned numbers that correspond to how far the region is from the start of the text.  The selected region closest to the beginning of the text region is assigned the number 0, etc.  Note that adding, moving or deleting a selected region can change the numbering.
         */
    ...
    interface Value {
        ...
        // Own virtual methods of Atk-1.0.Value

        /**
         * Gets the value of this object.
         */
        vfunc_get_current_value(): void;
        /**
         * Gets the minimum increment by which the value of this object may be
         * changed.  If zero, the minimum increment is undefined, which may
         * mean that it is limited only by the floating point precision of the
         ...
         * Gets the maximum value of this object.
         */
        vfunc_get_maximum_value(): void;
        /**
         * Gets the minimum increment by which the value of this object may be changed.  If zero,
         * the minimum increment is undefined, which may mean that it is limited only by the
         * floating point precision of the platform.
         */
        vfunc_get_minimum_increment(): void;
        /**
         * Gets the minimum value of this object.
         */
        vfunc_get_minimum_value(): void;
        /**
         * Gets the range of this object.
         */

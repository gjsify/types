...
GJS TypeScript type definitions for GtkSessionLock-0.1, generated from library version 0.1.0 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v4.0.0-rc.13.

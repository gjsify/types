/**
 * The GIR-derived widget VOCABULARY for GtkSessionLock-0.1.
 *
...
export interface GtkSessionLockLockProps extends GObjectProps {
    'lock-manager'?: never;
    'lock-obj'?: never;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GtkSessionLockLockConstructOnly = GObjectConstructOnly | 'lock-manager';

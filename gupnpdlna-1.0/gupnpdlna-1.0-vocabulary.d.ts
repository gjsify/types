/**
 * The GIR-derived widget VOCABULARY for GUPnPDLNA-1.0.
 *
...
import type { GstDiscovererConstructOnly, GstDiscovererProps } from '@girs/gstpbutils-1.0/vocabulary';
...
export interface GUPnPDLNADiscovererProps extends GstDiscovererProps {
    'extended-mode'?: boolean;
    'relaxed-mode'?: boolean;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GUPnPDLNADiscovererConstructOnly = GstDiscovererConstructOnly | 'extended-mode' | 'relaxed-mode';

export interface GUPnPDLNAInformationProps extends GObjectProps {
    info?: GstPbutils.DiscovererInfo;
    mime?: string;
    name?: string;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GUPnPDLNAInformationConstructOnly = GObjectConstructOnly | 'info' | 'mime' | 'name';
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GUPnPDLNAProfileConstructOnly = GObjectConstructOnly | 'extended' | 'mime' | 'name';

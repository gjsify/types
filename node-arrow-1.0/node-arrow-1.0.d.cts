...
export interface WritableFile {
    ...
    writeAt(position: number, data: number[]): boolean
...
export interface BufferInputStream extends File, Readable {
     ...
     */
    read(cancellable: Gio.Cancellable | null): [ /* returnType */ number, /* buffer */ number[] ]
    readBytes(nBytes: number): any | null
    /**
...
export interface Decimal128ArrayBuilder {
    ...
    appendValue(value: number[] | null): boolean
    /**
     * Append multiple values at once. It's more efficient than multiple
     * `append` and `append_null` calls.
...
export class DenseUnionDataType extends UnionDataType {
    ...
    constructor(fields: Field[], typeCodes: number[]) 
    static new(fields: Field[], typeCodes: number[]): DenseUnionDataType
...
export interface MutableBuffer {
    ...
    setData(offset: number, data: number[]): boolean
...
export class MutableBuffer extends Buffer {
    ...
    constructor(data: number[]) 
    static new(data: number[]): MutableBuffer
...
export class Scalar extends GObject.Object {
    ...
    static parse(dataType: DataType, data: number[]): Scalar | null
}
...
export class SparseUnionDataType extends UnionDataType {
    ...
    constructor(fields: Field[], typeCodes: number[]) 
    static new(fields: Field[], typeCodes: number[]): SparseUnionDataType

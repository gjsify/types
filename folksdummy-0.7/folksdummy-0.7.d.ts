...
module Backend {
    ...
    interface ConstructorProperties extends Folks.Backend.ConstructorProperties {
    }
...
module Persona {
    ...
    interface ConstructorProperties extends Folks.Persona.ConstructorProperties {

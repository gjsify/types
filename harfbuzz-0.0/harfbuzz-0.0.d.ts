 ...
 */
function ot_layout_lookup_collect_glyphs(face: face_t, table_tag: tag_t, lookup_index: number): [set_t, set_t, set_t, set_t]
/**
 ...
 */
function ot_tags_from_script_and_language(script: script_t, language?: (language_t | null), script_count?: number, language_count?: number): [number, tag_t | null, number, tag_t | null]
/**

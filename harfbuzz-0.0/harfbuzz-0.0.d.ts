...
export namespace HarfBuzz {
     ...
     */
    function aat_layout_get_feature_types(face: face_t, start_offset: number): number;
    /**
     ...
     * @returns `true` if parse was successful, `false` if an error occurred.
     */
    function buffer_deserialize_unicode(buffer: buffer_t, buf: string[], format: buffer_serialize_format_t): bool_t;
    /**
     ...
     */
    function color_line_get_color_stops(color_line: color_line_t, start: number): number;
    /**
     ...
     */
    function face_collect_nominal_glyph_mapping(face: face_t): void;
    /**
     * Collects all of the Unicode characters covered by `face` and adds
     * them to the #hb_set_t set `out`.
     * @param face A face object
     */
    function face_collect_unicodes(face: face_t): void;
    /**
     * Collects all Unicode "Variation Selector" characters covered by `face` and adds
     * them to the #hb_set_t set `out`.
     * @param face A face object
     */
    function face_collect_variation_selectors(face: face_t): void;
    /**
     ...
     */
    function face_collect_variation_unicodes(face: face_t, variation_selector: codepoint_t): void;
    /**
     ...
     */
    function feature_from_string(str: Uint8Array): bool_t;
    /**
     ...
     */
    function feature_to_string(feature: feature_t): void;
    /**
     ...
     * @param direction The direction of the text segment
     */
    function font_get_glyph_advance_for_direction(font: font_t, glyph: codepoint_t, direction: direction_t): void;
    /**
     ...
     * @returns `true` if data found, `false` otherwise
     */
    function font_get_glyph_from_name(font: font_t, name: string[]): bool_t;
    /**
     ...
     * @param direction The direction of the text segment
     */
    function font_get_glyph_origin_for_direction(font: font_t, glyph: codepoint_t, direction: direction_t): void;
    /**
     ...
     * @param font #hb_font_t to work upon
     */
    function font_get_ppem(font: font_t): void;
    /**
     ...
     * @param font #hb_font_t to work upon
     */
    function font_get_scale(font: font_t): void;
    /**
     ...
     * @param font #hb_font_t to work upon
     */
    function font_get_synthetic_bold(font: font_t): void;
    /**
     ...
     */
    function font_get_var_coords_design(font: font_t): number;
    /**
     ...
     * @returns coordinates array
     */
    function font_get_var_coords_normalized(font: font_t): number;
    /**
     ...
     * @returns `true` if data found, `false` otherwise
     */
    function font_glyph_from_string(font: font_t, s: Uint8Array): bool_t;
    /**
     ...
     * @param glyph The glyph ID to query
     */
    function font_glyph_to_string(font: font_t, glyph: codepoint_t): void;
    /**
     ...
     */
    function map_next(map: map_t, idx: number): bool_t;
    /**
     ...
     */
    function ot_color_glyph_get_layers(face: face_t, glyph: codepoint_t, start_offset: number): number;
    /**
     ...
     */
    function ot_layout_get_glyphs_in_class(face: face_t, klass: ot_layout_glyph_class_t): void;
    /**
     ...
     */
    function ot_layout_lookup_collect_glyphs(face: face_t, table_tag: tag_t, lookup_index: number): void;
    /**
     ...
     * @param lookup_index index of the feature lookup to query
     */
    function ot_layout_lookup_substitute_closure(face: face_t, lookup_index: number): void;
    /**
     ...
     */
    function ot_layout_lookups_substitute_closure(face: face_t, lookups: set_t): void;
    /**
     ...
     * @returns Number of all available feature types.
     */
    function ot_meta_get_entry_tags(face: face_t, start_offset: number): number;
    /**
     ...
     * @param metrics_tag tag of metrics value you like to fetch.
     */
    function ot_metrics_get_position_with_fallback(font: font_t, metrics_tag: ot_metrics_tag_t): void;
    /**
     ...
     */
    function ot_name_get_utf16(face: face_t, name_id: ot_name_id_t, language: language_t): number;
    /**
     * Fetches a font name from the OpenType 'name' table.
     * If `language` is #HB_LANGUAGE_INVALID, English ("en") is assumed.
     ...
     * @returns full length of the requested string, or 0 if not found.
     */
    function ot_name_get_utf32(face: face_t, name_id: ot_name_id_t, language: language_t): number;
    /**
     * Fetches a font name from the OpenType 'name' table.
     * If `language` is #HB_LANGUAGE_INVALID, English ("en") is assumed.
     ...
     * @returns full length of the requested string, or 0 if not found.
     */
    function ot_name_get_utf8(face: face_t, name_id: ot_name_id_t, language: language_t): number;
    /**
     ...
     */
    function ot_shape_glyphs_closure(font: font_t, buffer: buffer_t, features: feature_t[]): void;
    /**
     ...
     */
    function ot_tags_from_script(script: script_t): void;
    /**
     ...
     */
    function ot_tags_to_script_and_language(script_tag: tag_t, language_tag: tag_t): void;
    /**
     ...
     */
    function ot_var_find_axis(face: face_t, axis_tag: tag_t, axis_index: number): bool_t;
    /**
     * Fetches the variation-axis information corresponding to the specified axis tag
     * in the specified face.
     * @param face #hb_face_t to work upon
     ...
     * @returns `true` if data found, `false` otherwise
     */
    function ot_var_find_axis_info(face: face_t, axis_tag: tag_t): bool_t;
    /**
     ...
     * @param start_offset offset of the first lookup to retrieve
     */
    function ot_var_get_axes(face: face_t, start_offset: number): number;
    /**
     ...
     */
    function ot_var_get_axis_infos(face: face_t, start_offset: number): number;
    /**
     ...
     */
    function ot_var_normalize_variations(face: face_t, variations: variation_t, variations_length: number): void;
    /**
     ...
     */
    function paint_custom_palette_color(funcs: paint_funcs_t, paint_data: any | null, color_index: number): bool_t;
    /**
     ...
     */
    function set_next_range(set: set_t, last: codepoint_t): bool_t;
    /**
     ...
     */
    function set_previous_range(set: set_t, first: codepoint_t): bool_t;
    /**
     ...
     * @returns `true` if @str is successfully parsed, `false` otherwise
     */
    function variation_from_string(str: Uint8Array): bool_t;
    /**
     ...
     */
    function variation_to_string(variation: variation_t): void;
    ...
    class aat_layout_feature_selector_info_t {
        // Own fields of HarfBuzz-0.0.aat_layout_feature_selector_info_t
     ...
     */
    class color_line_t {
        // Own fields of HarfBuzz-0.0.color_line_t
     ...
     */
    class color_stop_t {
        // Own fields of HarfBuzz-0.0.color_stop_t

        offset: number;
        is_foreground: bool_t;
        color: color_t;

        // Constructors of HarfBuzz-0.0.color_stop_t
     ...
     */
    class draw_state_t {
        // Own fields of HarfBuzz-0.0.draw_state_t
        ...
        // Constructors of HarfBuzz-0.0.draw_state_t
     ...
     */
    class feature_t {
        // Own fields of HarfBuzz-0.0.feature_t
        ...
        // Constructors of HarfBuzz-0.0.feature_t
        ...
        // Owm methods of HarfBuzz-0.0.feature_t
    ...
    class font_extents_t {
        // Own fields of HarfBuzz-0.0.font_extents_t

        ascender: position_t;
        descender: position_t;
        line_gap: position_t;

        // Constructors of HarfBuzz-0.0.font_extents_t
    ...
    class glyph_extents_t {
        // Own fields of HarfBuzz-0.0.glyph_extents_t
        ...
        // Constructors of HarfBuzz-0.0.glyph_extents_t
     ...
     */
    class glyph_info_t {
        // Own fields of HarfBuzz-0.0.glyph_info_t

        codepoint: codepoint_t;
        cluster: number;

        // Constructors of HarfBuzz-0.0.glyph_info_t
    ...
    class glyph_position_t {
        // Own fields of HarfBuzz-0.0.glyph_position_t
        ...
        // Constructors of HarfBuzz-0.0.glyph_position_t
     ...
     */
    class language_t {
        // Owm methods of HarfBuzz-0.0.language_t
    ...
    class ot_color_layer_t {
        // Own fields of HarfBuzz-0.0.ot_color_layer_t

        glyph: codepoint_t;
        color_index: number;

        // Constructors of HarfBuzz-0.0.ot_color_layer_t
    ...
    class ot_math_glyph_part_t {
        // Own fields of HarfBuzz-0.0.ot_math_glyph_part_t
    ...
    class ot_math_glyph_variant_t {
        // Own fields of HarfBuzz-0.0.ot_math_glyph_variant_t

        glyph: codepoint_t;
        advance: position_t;

        // Constructors of HarfBuzz-0.0.ot_math_glyph_variant_t
    ...
    class ot_math_kern_entry_t {
        // Own fields of HarfBuzz-0.0.ot_math_kern_entry_t

        max_correction_height: position_t;
        kern_value: position_t;

        // Constructors of HarfBuzz-0.0.ot_math_kern_entry_t
    ...
    class ot_name_entry_t {
        // Own fields of HarfBuzz-0.0.ot_name_entry_t
     ...
     */
    class ot_var_axis_t {
        // Own fields of HarfBuzz-0.0.ot_var_axis_t
        ...
        // Constructors of HarfBuzz-0.0.ot_var_axis_t
    ...
    class segment_properties_t {
        // Own fields of HarfBuzz-0.0.segment_properties_t
    ...
    class user_data_key_t {
        // Constructors of HarfBuzz-0.0.user_data_key_t
     ...
     */
    class variation_t {
        // Own fields of HarfBuzz-0.0.variation_t

        tag: tag_t;
        value: number;

        // Constructors of HarfBuzz-0.0.variation_t
        ...
        // Owm methods of HarfBuzz-0.0.variation_t
    ...
    class var_int_t {
        // Own fields of HarfBuzz-0.0.var_int_t
        ...
        // Constructors of HarfBuzz-0.0.var_int_t
    ...
    class var_num_t {
        // Own fields of HarfBuzz-0.0.var_num_t
        ...
        // Constructors of HarfBuzz-0.0.var_num_t

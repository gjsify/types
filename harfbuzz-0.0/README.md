...
GJS TypeScript type definitions for HarfBuzz-0.0, generated from library version 8.4.0 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v4.0.0-beta.6.

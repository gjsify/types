 ...
 * @returns #GstMpegtsDescriptor, %NULL on failure
 */
export function descriptorFromRegistration(formatIdentifier: string | null, additionalInfo: Uint8Array | null): Descriptor
 ...
 * @returns a #GType
 */
export function pesMetadataMetaApiGetType(): GObject.GType
/**
 * Gets the global #GstMetaInfo describing the #GstMpegtsPESMetadataMeta meta.
 * @returns The #GstMetaInfo
 */
export function pesMetadataMetaGetInfo(): Gst.MetaInfo
/**
...
export class Descriptor {
     ...
     * @returns #GstMpegtsDescriptor, %NULL on failure
     */
    static fromRegistration(formatIdentifier: string | null, additionalInfo: Uint8Array | null): Descriptor

 ...
 */
export function descriptorFromCustom(tag: number, data: number[]): Descriptor
/**
 ...
 * @returns #GstMpegtsDescriptor
 */
export function descriptorFromCustomWithExtension(tag: number, tagExtension: number, data: number[]): Descriptor
/**

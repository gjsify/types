/**
 * The GIR-derived widget VOCABULARY for GstGLWayland-1.0.
 *
 * GENERATED — do not edit. Provenance: GstGLWayland-1.0
 *
...
export interface GstGLDisplayWaylandProps extends GstGLDisplayProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GstGLDisplayWaylandConstructOnly = GstGLDisplayConstructOnly;

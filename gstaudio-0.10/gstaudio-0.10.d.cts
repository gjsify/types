...
import './gstaudio-0.10-ambient.d.ts';
import './gstaudio-0.10-import.d.ts';
/**
 * GstAudio-0.10
 */
...
export const AUDIO_FLOAT_PAD_TEMPLATE_CAPS: string
export const AUDIO_FLOAT_STANDARD_PAD_TEMPLATE_CAPS: string
export const AUDIO_INT_PAD_TEMPLATE_CAPS: string
export const AUDIO_INT_STANDARD_PAD_TEMPLATE_CAPS: string
/**
 ...
 */
export function audio_check_channel_positions(pos: AudioChannelPosition, channels: number): boolean
/**
 ...
 * @returns the length.
 */
export function audio_duration_from_pad_buffer(pad: Gst.Pad, buf: Gst.Buffer): Gst.ClockTime
/**
 ...
 */
export function audio_fixate_channel_positions(str: Gst.Structure): AudioChannelPosition
/**
 * Calculate byte size of an audio frame.
 * @param pad the #GstPad to get the caps from
 * @returns the byte size, or 0 if there was an error
 */
export function audio_frame_byte_size(pad: Gst.Pad): number
/**
 ...
 */
export function audio_frame_length(pad: Gst.Pad, buf: Gst.Buffer): number
/**
 ...
 */
export function audio_get_channel_positions(str: Gst.Structure): AudioChannelPosition
/**
 ...
 */
export function audio_is_buffer_framed(pad: Gst.Pad, buf: Gst.Buffer): boolean
/**
 ...
 */
export function audio_set_caps_channel_positions_list(caps: Gst.Caps, pos: AudioChannelPosition, num_positions: number): void
/**
 ...
 */
export function audio_set_channel_positions(str: Gst.Structure, pos: AudioChannelPosition): void
/**
 * Sets a (possibly non-fixed) list of possible audio channel
 ...
 * @param num_positions the number of values in pos.
 */
export function audio_set_structure_channel_positions_list(str: Gst.Structure, pos: AudioChannelPosition, num_positions: number): void
/**
 * Do not use anymore.
 * @param structure a #GstStructure
 * @param flag a set of #GstAudioFieldFlag
 */
export function audio_structure_set_int(structure: Gst.Structure, flag: AudioFieldFlag): void
/**
...
export class AudioClock extends Gst.SystemClock {
     ...
     */
    static new_full(name: string | null, func: AudioClockGetTimeFunc): AudioClock
...
export interface AudioSink {
    ...
    vfunc_write(data: any, length: number): number
...
export interface AudioSrc {
    ...
    vfunc_create(offset: number, size: number, buf: Gst.Buffer): Gst.FlowReturn
    vfunc_create(offset: number, size: number, buf: Gst.Buffer): Gst.FlowReturn
    ...
    vfunc_open(): boolean
    vfunc_prepare(spec: RingBufferSpec): boolean
    vfunc_read(data: any, length: number): number
    vfunc_reset(): void
    vfunc_unprepare(): boolean

 ...
 */
function generate_nonce(): string | null
/**
 ...
 * @returns the result
 */
function is_host_in_domain(host: string | null, domain: string | null): boolean
/**
 ...
 */
function wipe_directory(dirname: string | null): boolean
/**
 ...
 * @returns TRUE if wiping and removal was successful.
 */
function wipe_file(filename: string | null): boolean
module Plugin {

...
export namespace GSignond {
    ...
    class Error extends GLib.Error {
        // Own fields of GSignond-1.0.Error
        ...
        // Constructors of GSignond-1.0.Error
    ...
    class AccessControlManager extends GObject.Object {
        // Own properties of GSignond-1.0.AccessControlManager

        config: Config;

        // Owm methods of GSignond-1.0.AccessControlManager
    ...
    class Config extends GObject.Object {
        // Constructors of GSignond-1.0.Config

        static ['new'](): Config;

        // Owm methods of GSignond-1.0.Config
    ...
    class Credentials extends GObject.Object {
        // Constructors of GSignond-1.0.Credentials

        static ['new'](): Credentials;

        // Owm methods of GSignond-1.0.Credentials
    ...
    class Dictionary extends GObject.Object {
        // Constructors of GSignond-1.0.Dictionary

        static ['new'](): Dictionary;

        static new_from_variant(variant: GLib.Variant): Dictionary;

        // Owm methods of GSignond-1.0.Dictionary
         ...
         * @returns %TRUE if the value was retrieved successfully, %FALSE otherwise.
         */
        get_int32(key: string): boolean;
        /**
         * Retrieves a int64 value.
         * @param key key to look up
         * @returns %TRUE if the value was retrieved successfully, %FALSE otherwise.
         */
        get_int64(key: string): boolean;
        /**
         ...
         * @returns %TRUE if the value was retrieved successfully, %FALSE otherwise.
         */
        get_uint32(key: string): boolean;
        /**
         * Retrieves a uint64 value.
         * @param key key to look up
         * @returns %TRUE if the value was retrieved successfully, %FALSE otherwise.
         */
        get_uint64(key: string): boolean;
        /**
    ...
    class Extension extends GObject.Object {
        // Owm methods of GSignond-1.0.Extension
    ...
    class SecretStorage extends GObject.Object {
        // Own properties of GSignond-1.0.SecretStorage

        config: Config;

        // Owm methods of GSignond-1.0.SecretStorage
    ...
    class SessionData extends Dictionary {
        // Constructors of GSignond-1.0.SessionData

        static ['new'](): SessionData;

        static new_from_variant(variant: GLib.Variant): SessionData;

        // Owm methods of GSignond-1.0.SessionData
    ...
    class SignonuiData extends Dictionary {
        // Constructors of GSignond-1.0.SignonuiData

        static ['new'](): SignonuiData;

        static new_from_variant(variant: GLib.Variant): SignonuiData;

        // Owm methods of GSignond-1.0.SignonuiData
    ...
    class StorageManager extends GObject.Object {
        // Own properties of GSignond-1.0.StorageManager

        config: Config;

        // Own fields of GSignond-1.0.StorageManager

        location: string;

        // Owm methods of GSignond-1.0.StorageManager
    ...
    class SecurityContext {
        // Own fields of GSignond-1.0.SecurityContext

        sys_ctx: string;
        app_ctx: string;

        // Constructors of GSignond-1.0.SecurityContext
        ...
        // Owm methods of GSignond-1.0.SecurityContext
    ...
    interface Plugin {
        // Own properties of GSignond-1.0.Plugin
        ...
        // Owm methods of GSignond-1.0.Plugin
        ...
        // Own virtual methods of GSignond-1.0.Plugin

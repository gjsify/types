 ...
 */
export function login_async<Z = unknown>(username: string, password: string, otp: string | null, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback<Z> | null): void
 ...
 */
export function login_async<Z = unknown>(username: string, password: string, otp: string | null, cancellable: Gio.Cancellable | null): globalThis.Promise<AuthData>
/**

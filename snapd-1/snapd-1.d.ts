...
static new_from_socket(socket: Gio.Socket): Client;
     ...
     * @param callback a #GAsyncReadyCallback to call when the request is satisfied.
     */
    set_snap_conf_async(name: string, key_values: GLib.HashTable<string, GLib.Variant>, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<this> | null)): void
    /**
     ...
     * @returns %TRUE if configuration successfully applied.
     */
    set_snap_conf_sync(name: string, key_values: GLib.HashTable<string, GLib.Variant>, cancellable?: (Gio.Cancellable | null)): boolean
    /**

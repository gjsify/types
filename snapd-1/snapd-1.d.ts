...
export namespace Snapd {
    ...
    class Error extends GLib.Error {
        ...
        // Constructors of Snapd-1.Error

        constructor(options: { message: string; code: number });

        // Owm methods of Snapd-1.Error
    ...
    class Alias extends GObject.Object {
        // Own properties of Snapd-1.Alias
    ...
    class Assertion extends GObject.Object {
        // Own properties of Snapd-1.Assertion

        content: string;

        // Constructors of Snapd-1.Assertion

        static ['new'](content: string): Assertion;

        // Owm methods of Snapd-1.Assertion
    ...
    class AuthData extends GObject.Object {
        // Own properties of Snapd-1.AuthData

        discharges: string[];
        macaroon: string;

        // Constructors of Snapd-1.AuthData

        static ['new'](macaroon: string, discharges: string[]): AuthData;

        // Owm methods of Snapd-1.AuthData
    ...
    class Change extends GObject.Object {
        // Own properties of Snapd-1.Change
    ...
    class Channel extends GObject.Object {
        // Own properties of Snapd-1.Channel
        ...
        // Owm methods of Snapd-1.Channel
    ...
    class Client extends GObject.Object {
        // Constructors of Snapd-1.Client

        static ['new'](): Client;

        static new_from_socket(socket: Gio.Socket): Client;

        // Owm methods of Snapd-1.Client
         ...
         */
        find_finish(result: Gio.AsyncResult): Snap[];
        /**
         ...
         * @returns an array of #SnapdSnap or %NULL on error.
         */
        find_section_finish(result: Gio.AsyncResult): Snap[];
        /**
         ...
         * @returns an array of #SnapdSnap or %NULL on error.
         */
        find_sync(flags: FindFlags, query: string, cancellable?: Gio.Cancellable | null): Snap[];
        /**
         ...
         * @returns %TRUE on success or %FALSE on error.
         */
        get_connections2_finish(result: Gio.AsyncResult): boolean;
        /**
         ...
         * @returns %TRUE on success or %FALSE on error.
         */
        get_connections_finish(result: Gio.AsyncResult): boolean;
        /**
         * Get the installed snap connections.
         * @param cancellable a #GCancellable or %NULL.
         * @returns %TRUE on success or %FALSE on error.
         */
        get_connections_sync(cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns %TRUE on success or %FALSE on error.
         */
        get_interfaces_finish(result: Gio.AsyncResult): boolean;
        /**
         * Get the installed snap interfaces.
         * @param cancellable a #GCancellable or %NULL.
         * @returns %TRUE on success or %FALSE on error.
         */
        get_interfaces_sync(cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns %TRUE on success or %FALSE on error.
         */
        run_snapctl_finish(result: Gio.AsyncResult): boolean;
        /**
         ...
         * @returns %TRUE on success or %FALSE on error.
         */
        run_snapctl_sync(context_id: string, args: string[], cancellable?: Gio.Cancellable | null): boolean;
        /**
    ...
    class Connection extends GObject.Object {
        // Own properties of Snapd-1.Connection
        ...
        // Owm methods of Snapd-1.Connection
         ...
         */
        get_plug_attribute_names(): string[];
        /**
         ...
         * @returns a string array of attribute names. Free with g_strfreev().
         */
        get_slot_attribute_names(): string[];
        /**
    ...
    class Icon extends GObject.Object {
        // Own properties of Snapd-1.Icon

        data: GLib.Bytes;
        mime_type: string;
        mimeType: string;

        // Owm methods of Snapd-1.Icon
    ...
    class Interface extends GObject.Object {
        // Own properties of Snapd-1.Interface
        ...
        // Owm methods of Snapd-1.Interface
    ...
    class Maintenance extends GObject.Object {
        // Own properties of Snapd-1.Maintenance

        kind: MaintenanceKind;
        message: string;

        // Owm methods of Snapd-1.Maintenance
    ...
    class MarkdownNode extends GObject.Object {
        // Own properties of Snapd-1.MarkdownNode
        ...
        // Owm methods of Snapd-1.MarkdownNode
    ...
    class MarkdownParser extends GObject.Object {
        // Constructors of Snapd-1.MarkdownParser

        static ['new'](version: MarkdownVersion): MarkdownParser;

        // Owm methods of Snapd-1.MarkdownParser
    ...
    class Media extends GObject.Object {
        // Own properties of Snapd-1.Media
    ...
    class Plug extends GObject.Object {
        // Own properties of Snapd-1.Plug
    ...
    class PlugRef extends GObject.Object {
        // Own properties of Snapd-1.PlugRef

        plug: string;
        snap: string;

        // Owm methods of Snapd-1.PlugRef
    ...
    class Price extends GObject.Object {
        // Own properties of Snapd-1.Price

        amount: number;
        currency: string;

        // Owm methods of Snapd-1.Price
    ...
    class Screenshot extends GObject.Object {
        // Own properties of Snapd-1.Screenshot

        height: number;
        url: string;
        width: number;

        // Owm methods of Snapd-1.Screenshot
    ...
    class Slot extends GObject.Object {
        // Own properties of Snapd-1.Slot
    ...
    class SlotRef extends GObject.Object {
        // Own properties of Snapd-1.SlotRef

        slot: string;
        snap: string;

        // Owm methods of Snapd-1.SlotRef
    ...
    class Snap extends GObject.Object {
        // Own properties of Snapd-1.Snap
    ...
    class SystemInformation extends GObject.Object {
        // Own properties of Snapd-1.SystemInformation
        ...
        // Owm methods of Snapd-1.SystemInformation
    ...
    class Task extends GObject.Object {
        // Own properties of Snapd-1.Task
    ...
    class UserInformation extends GObject.Object {
        // Own properties of Snapd-1.UserInformation
        ...
        // Owm methods of Snapd-1.UserInformation

...
export interface ERemindersWidgetProps extends GtkGridProps, EExtensibleProps, GtkAccessibleProps, GtkBuildableProps, GtkConstraintTargetProps, GtkOrientableProps {
    watcher?: ECal.ReminderWatcher;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type ERemindersWidgetConstructOnly = GtkGridConstructOnly | EExtensibleConstructOnly | GtkAccessibleConstructOnly | GtkBuildableConstructOnly | GtkConstraintTargetConstructOnly | GtkOrientableConstructOnly | 'watcher';

export interface EWebDAVDiscoverContentProps extends GtkGridProps, GtkAccessibleProps, GtkBuildableProps, GtkConstraintTargetProps, GtkOrientableProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type EWebDAVDiscoverContentConstructOnly = GtkGridConstructOnly | GtkAccessibleConstructOnly | GtkBuildableConstructOnly | GtkConstraintTargetConstructOnly | GtkOrientableConstructOnly;

export interface EWebDAVDiscoverDialogProps extends GtkDialogProps, GtkAccessibleProps, GtkBuildableProps, GtkConstraintTargetProps, GtkNativeProps, GtkRootProps, GtkShortcutManagerProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type EWebDAVDiscoverDialogConstructOnly = GtkDialogConstructOnly | GtkAccessibleConstructOnly | GtkBuildableConstructOnly | GtkConstraintTargetConstructOnly | GtkNativeConstructOnly | GtkRootConstructOnly | GtkShortcutManagerConstructOnly;
...
export interface Widgets {
    ECertificateWidget: {
        class: EDataServerUI4.CertificateWidget;
        props: ECertificateWidgetProps;
        signals: EDataServerUI4.CertificateWidget.SignalSignatures;
        constructOnly: ECertificateWidgetConstructOnly;
        slotCandidates: {};
    };
    ERemindersWidget: {
        class: EDataServerUI4.RemindersWidget;
        props: ERemindersWidgetProps;
        signals: EDataServerUI4.RemindersWidget.SignalSignatures;
        constructOnly: ERemindersWidgetConstructOnly;
        slotCandidates: {};
    };
    EWebDAVDiscoverContent: {
        class: EDataServerUI4.WebDAVDiscoverContent;
        props: EWebDAVDiscoverContentProps;
        signals: EDataServerUI4.WebDAVDiscoverContent.SignalSignatures;
        constructOnly: EWebDAVDiscoverContentConstructOnly;
        slotCandidates: {};
    };
    EWebDAVDiscoverDialog: {
        class: EDataServerUI4.WebDAVDiscoverDialog;
        props: EWebDAVDiscoverDialogProps;
        signals: EDataServerUI4.WebDAVDiscoverDialog.SignalSignatures;

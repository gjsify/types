...
class CertificateWidget extends Gtk.Box implements Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Orientable {
...
static ["new"](registry: EDataServer.SourceRegistry): CredentialsPrompter;
    ...
    connect(signal: 'get-dialog-parent-full', callback: ((_source: this, auth_source: EDataServer.Source | null) => (Gtk.Window | null))): number
    connect_after(signal: 'get-dialog-parent-full', callback: ((_source: this, auth_source: EDataServer.Source | null) => (Gtk.Window | null))): number
...
_init(...args: any[]): void;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'prompt-finished', callback: ((_source: this, prompt_id: any | null, credentials: EDataServer.NamedParameters | null) => void)): number
    connect_after(signal: 'prompt-finished', callback: ((_source: this, prompt_id: any | null, credentials: EDataServer.NamedParameters | null) => void)): number
...
module RemindersWidget {
    ...
    interface ConstructorProps extends Gtk.Grid.ConstructorProps, EDataServer.Extensible.ConstructorProps, Gtk.Accessible.ConstructorProps, Gtk.Buildable.ConstructorProps, Gtk.ConstraintTarget.ConstructorProps, Gtk.Orientable.ConstructorProps {
empty: boolean;
 ...
 * the functions below.
 */
class RemindersWidget extends Gtk.Grid implements EDataServer.Extensible, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Orientable {
...
class WebDAVDiscoverContent extends Gtk.Grid implements Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Orientable {
...
class WebDAVDiscoverDialog extends Gtk.Dialog implements Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Native, Gtk.Root, Gtk.ShortcutManager {

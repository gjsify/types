...
export namespace EBookContacts {
    ...
    class BookClientError extends GLib.Error {
        // Own fields of EBookContacts-1.2.BookClientError
         ...
         */
        CONTACT_ID_ALREADY_EXISTS: number;
        /**
         * Referred #ESource does not exist
         */
        NO_SUCH_SOURCE: number;
        /**
         * Out of disk space
         */
        NO_SPACE: number;

        // Constructors of EBookContacts-1.2.BookClientError
    ...
    class PhoneNumberError extends GLib.Error {
        // Own fields of EBookContacts-1.2.PhoneNumberError
        ...
        // Constructors of EBookContacts-1.2.PhoneNumberError
     ...
     */
    function book_util_diff_categories(old_contact: Contact | null, new_contact: Contact | null): void;
    /**
    ...
    abstract class BookIndicesUpdater extends GObject.Object {
        // Owm methods of EBookContacts-1.2.BookIndicesUpdater
    ...
    class Contact extends VCard {
        // Own properties of EBookContacts-1.2.Contact
        ...
        // Constructors of EBookContacts-1.2.Contact
        ...
        // Owm methods of EBookContacts-1.2.Contact
    ...
    class SourceBackendSummarySetup extends EDataServer.SourceExtension {
        // Own properties of EBookContacts-1.2.SourceBackendSummarySetup
        ...
        // Owm methods of EBookContacts-1.2.SourceBackendSummarySetup
         ...
         */
        get_indexed_fields(): ContactField;
        /**
         ...
         */
        get_summary_fields(): ContactField;
        /**
    ...
    class VCard extends GObject.Object {
        // Constructors of EBookContacts-1.2.VCard

        static ['new'](): VCard;

        static new_from_string(str: string): VCard;

        // Owm methods of EBookContacts-1.2.VCard
    ...
    class AddressWestern {
        // Own fields of EBookContacts-1.2.AddressWestern
        ...
        // Constructors of EBookContacts-1.2.AddressWestern
        ...
        // Owm methods of EBookContacts-1.2.AddressWestern
     ...
     */
    class BookChange {
        // Own fields of EBookContacts-1.2.BookChange
    ...
    class BookClientViewSortFields {
        // Own fields of EBookContacts-1.2.BookClientViewSortFields
     ...
     */
    class BookIndices {
        // Own fields of EBookContacts-1.2.BookIndices

        chr: string;
        index: number;

        // Constructors of EBookContacts-1.2.BookIndices
        ...
        // Owm methods of EBookContacts-1.2.BookIndices
    ...
    class BookIndicesUpdaterClass {}

    class BookIndicesUpdaterPrivate {}

    class BookQuery {
        // Owm methods of EBookContacts-1.2.BookQuery
    ...
    class ContactAddress {
        // Own fields of EBookContacts-1.2.ContactAddress
        ...
        // Constructors of EBookContacts-1.2.ContactAddress
        ...
        // Owm methods of EBookContacts-1.2.ContactAddress
    ...
    class ContactCert {
        // Own fields of EBookContacts-1.2.ContactCert

        length: number;
        data: string;

        // Constructors of EBookContacts-1.2.ContactCert
        ...
        // Owm methods of EBookContacts-1.2.ContactCert
    ...
    class ContactDate {
        // Own fields of EBookContacts-1.2.ContactDate

        year: number;
        month: number;
        day: number;

        // Constructors of EBookContacts-1.2.ContactDate
        ...
        // Owm methods of EBookContacts-1.2.ContactDate
    ...
    class ContactGeo {
        // Own fields of EBookContacts-1.2.ContactGeo

        latitude: number;
        longitude: number;

        // Constructors of EBookContacts-1.2.ContactGeo
        ...
        // Owm methods of EBookContacts-1.2.ContactGeo
    ...
    class ContactName {
        // Own fields of EBookContacts-1.2.ContactName
        ...
        // Constructors of EBookContacts-1.2.ContactName
        ...
        // Owm methods of EBookContacts-1.2.ContactName
    ...
    class ContactPhoto {
        // Own fields of EBookContacts-1.2.ContactPhoto

        type: ContactPhotoType;

        // Constructors of EBookContacts-1.2.ContactPhoto
        ...
        // Owm methods of EBookContacts-1.2.ContactPhoto
    ...
    class NameWestern {
        // Own fields of EBookContacts-1.2.NameWestern
        ...
        // Constructors of EBookContacts-1.2.NameWestern
        ...
        // Owm methods of EBookContacts-1.2.NameWestern
     ...
     */
    class PhoneNumber {
        // Owm methods of EBookContacts-1.2.PhoneNumber
    ...
    class VCardAttributeParam {
        // Constructors of EBookContacts-1.2.VCardAttributeParam

        constructor(name: string);

        static ['new'](name: string): VCardAttributeParam;

        // Owm methods of EBookContacts-1.2.VCardAttributeParam

...
static ["new"](): Connection;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'vnc-auth-choose-subtype', callback: ((_source: this, object: number, p0: GObject.ValueArray) => void)): number
    connect_after(signal: 'vnc-auth-choose-subtype', callback: ((_source: this, object: number, p0: GObject.ValueArray) => void)): number
    ...
    connect_after(signal: 'vnc-auth-choose-type', callback: ((_source: this, object: GObject.ValueArray) => void)): number
    ...
    connect(signal: 'vnc-framebuffer-update', callback: ((_source: this, object: number, p0: number, p1: number, p2: number) => void)): number
    connect_after(signal: 'vnc-framebuffer-update', callback: ((_source: this, object: number, p0: number, p1: number, p2: number) => void)): number
    ...
    connect_after(signal: 'vnc-pixel-format-changed', callback: ((_source: this, object: PixelFormat) => void)): number

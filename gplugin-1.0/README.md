...
GJS TypeScript type definitions for GPlugin-1.0, generated from library version 0.43.2 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v4.0.0-beta.10.

/**
 * The GIR-derived widget VOCABULARY for Geoclue-2.0.
 *
 * GENERATED — do not edit. Provenance: Geoclue-2.0 — inlined base(s) their owner's vocabulary does not emit: Gio.DBusInterfaceSkeleton
 *
 * 7 instantiable GTypes (of which 0 concrete widgets), 11 declarations (1 inlined from a namespace whose vocabulary does not emit them), 1 enum nick unions, 0 slot candidates.
 *
...
import type Geoclue from './geoclue-2.0.js';
...
export type GClueAccuracyLevelNick = 'none' | 'country' | 'city' | 'neighborhood' | 'street' | 'exact';
...
export interface GClueClientProps extends GObjectProps {
    /**
...
export type GClueClientConstructOnly = GObjectConstructOnly;

/** The #GClueClientProxy structure contains only private data and should only be accessed using the provided API. */
export interface GClueClientProxyProps extends GDBusProxyProps, GClueClientProps, GAsyncInitableProps, GDBusInterfaceProps, GInitableProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GClueClientProxyConstructOnly = GDBusProxyConstructOnly | GClueClientConstructOnly | GAsyncInitableConstructOnly | GDBusInterfaceConstructOnly | GInitableConstructOnly;

/** The #GClueClientSkeleton structure contains only private data and should only be accessed using the provided API. */
export interface GClueClientSkeletonProps extends GDBusInterfaceSkeletonProps, GClueClientProps, GDBusInterfaceProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GClueClientSkeletonConstructOnly = GDBusInterfaceSkeletonConstructOnly | GClueClientConstructOnly | GDBusInterfaceConstructOnly;
...
export interface GClueLocationProps extends GObjectProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GClueLocationConstructOnly = GObjectConstructOnly;

/** The #GClueLocationProxy structure contains only private data and should only be accessed using the provided API. */
export interface GClueLocationProxyProps extends GDBusProxyProps, GClueLocationProps, GAsyncInitableProps, GDBusInterfaceProps, GInitableProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GClueLocationProxyConstructOnly = GDBusProxyConstructOnly | GClueLocationConstructOnly | GAsyncInitableConstructOnly | GDBusInterfaceConstructOnly | GInitableConstructOnly;

/** The #GClueLocationSkeleton structure contains only private data and should only be accessed using the provided API. */
export interface GClueLocationSkeletonProps extends GDBusInterfaceSkeletonProps, GClueLocationProps, GDBusInterfaceProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GClueLocationSkeletonConstructOnly = GDBusInterfaceSkeletonConstructOnly | GClueLocationConstructOnly | GDBusInterfaceConstructOnly;
...
export interface GClueManagerProps extends GObjectProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GClueManagerConstructOnly = GObjectConstructOnly;

/** The #GClueManagerProxy structure contains only private data and should only be accessed using the provided API. */
export interface GClueManagerProxyProps extends GDBusProxyProps, GClueManagerProps, GAsyncInitableProps, GDBusInterfaceProps, GInitableProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GClueManagerProxyConstructOnly = GDBusProxyConstructOnly | GClueManagerConstructOnly | GAsyncInitableConstructOnly | GDBusInterfaceConstructOnly | GInitableConstructOnly;

/** The #GClueManagerSkeleton structure contains only private data and should only be accessed using the provided API. */
export interface GClueManagerSkeletonProps extends GDBusInterfaceSkeletonProps, GClueManagerProps, GDBusInterfaceProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GClueManagerSkeletonConstructOnly = GDBusInterfaceSkeletonConstructOnly | GClueManagerConstructOnly | GDBusInterfaceConstructOnly;

export interface GClueSimpleProps extends GObjectProps, GAsyncInitableProps {
    /**
     * The requested maximum accuracy level.
     * @default GCLUE_ACCURACY_LEVEL_NONE
     */
    'accuracy-level'?: GClueAccuracyLevelNick | Geoclue.AccuracyLevel;
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GClueSimpleConstructOnly = GObjectConstructOnly | GAsyncInitableConstructOnly | 'accuracy-level' | 'desktop-id' | 'distance-threshold' | 'time-threshold';

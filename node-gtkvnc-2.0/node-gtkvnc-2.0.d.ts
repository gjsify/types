...
import './node-gtkvnc-2.0-import.d.ts';
...
class CairoFramebuffer extends GVnc.BaseFramebuffer {
     ...
     */
    static new(buffer: number[], width: number, height: number, rowstride: number, localFormat: GVnc.PixelFormat, remoteFormat: GVnc.PixelFormat): GVnc.BaseFramebuffer

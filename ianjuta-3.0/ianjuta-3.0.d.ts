...
export namespace IAnjuta {
    ...
    enum BuildableCommand {
         ...
         */
        COMMAND_IS_BUILT = 8,
        COMMAND_AUTORECONF = 9,
        /**
         * make distclean
         */
        COMMAND_DISTCLEAN = 10,
        /**
         * make check
         */
        COMMAND_CHECK = 11,
    ...
    enum MarkableMarker {
         ...
         */
        BREAKPOINT_DISABLED = 3,
        /**
         * a enabled breakpoint
         */
        BREAKPOINT_ENABLED = 4,
        /**

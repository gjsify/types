 ...
 */
export function check_mime_type_supported(mime_type: string | null): boolean
/**
 ...
 */
export function filter_get_description(filter: Filter): string | null
/**
 ...
 */
export function filter_get_description_libarchive(filter: Filter): string | null
/**
 * Gets the file name extension of the filter from the internal static data.
 * @param filter an #AutoarFilter
 * @returns a file name extension
 */
export function filter_get_extension(filter: Filter): string | null
/**
 ...
 */
export function filter_get_mime_type(filter: Filter): string | null
/**
 ...
 */
export function format_filter_get_description(format: Format, filter: Filter): string | null
/**
 ...
 */
export function format_filter_get_extension(format: Format, filter: Filter): string | null
/**
 ...
 */
export function format_filter_get_mime_type(format: Format, filter: Filter): string | null
/**
 * Gets description of the format from the internal static data.
 * @param format an #AutoarFormat
 * @returns description about the format
 */
export function format_get_description(format: Format): string | null
/**
 ...
 */
export function format_get_description_libarchive(format: Format): string | null
/**
 * Gets the file name extension of the format from the internal static data.
 * @param format an #AutoarFormat
 * @returns a file name extension
 */
export function format_get_extension(format: Format): string | null
/**
 ...
 * @returns an MIME type
 */
export function format_get_mime_type(format: Format): string | null
/**

...
static ["new"](source_files: Gio.File[], output_file: Gio.File, format: Format, filter: Filter, create_top_level_directory: boolean): Compressor;
    ...
    connect(signal: 'progress', callback: ((_source: this, completed_size: number, completed_files: number) => void)): number
    connect_after(signal: 'progress', callback: ((_source: this, completed_size: number, completed_files: number) => void)): number
...
static ["new"](source_file: Gio.File, output_file: Gio.File): Extractor;
    ...
    connect_after(signal: 'conflict', callback: ((_source: this, file: Gio.File, new_file: any | null) => number)): number
    emit(signal: 'conflict', file: Gio.File, new_file?: (any | null)): void
    connect(signal: 'decide-destination', callback: ((_source: this, destination: Gio.File, files: any | null) => GObject.Object)): number
    connect_after(signal: 'decide-destination', callback: ((_source: this, destination: Gio.File, files: any | null) => GObject.Object)): number

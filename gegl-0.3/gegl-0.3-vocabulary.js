// The widget vocabulary of Gegl-0.3 as runtime data.
//
...
export const OWN_PROPS = {
    ...
    GeglBuffer: ['abyss-height', 'abyss-width', 'abyss-x', 'abyss-y', 'backend', 'format', 'height', 'path', 'shift-x', 'shift-y', 'tile-height', 'tile-width', 'width', 'x', 'y'],
    GeglColor: ['string'],
    GeglConfig: ['application-license', 'chunk-size', 'quality', 'queue-size', 'swap', 'threads', 'tile-cache-size', 'tile-height', 'tile-width', 'use-opencl'],
    GeglNode: ['dont-cache', 'gegl-operation', 'name', 'operation', 'passthrough', 'use-opencl'],
...
export const ENUM_NICKS = {
    ...
    GeglDitherMethod: ['none', 'floyd-steinberg', 'bayer', 'random', 'random-covariant', 'add', 'add-covariant', 'xor', 'xor-covariant'],

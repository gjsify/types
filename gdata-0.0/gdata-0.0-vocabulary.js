...
export const PROP_TYPES = {
    'GDataAccessRule.role': 'gchararray',
    'GDataAccessRule.scope-type': 'gchararray',
    'GDataAccessRule.scope-value': 'gchararray',
    'GDataAuthor.email-address': 'gchararray',
    'GDataAuthor.name': 'gchararray',
    'GDataAuthor.uri': 'gchararray',
    'GDataAuthorizationDomain.scope': 'gchararray',
    'GDataAuthorizationDomain.service-name': 'gchararray',
    'GDataBatchOperation.authorization-domain': 'GDataAuthorizationDomain',
    'GDataBatchOperation.feed-uri': 'gchararray',
    'GDataBatchOperation.service': 'GDataService',
    'GDataCalendarCalendar.is-hidden': 'gboolean',
    'GDataCalendarCalendar.is-selected': 'gboolean',
    'GDataCalendarCalendar.timezone': 'gchararray',
    'GDataCalendarEvent.anyone-can-add-self': 'gboolean',
    'GDataCalendarEvent.guests-can-invite-others': 'gboolean',
    'GDataCalendarEvent.guests-can-modify': 'gboolean',
    'GDataCalendarEvent.guests-can-see-guests': 'gboolean',
    'GDataCalendarEvent.recurrence': 'gchararray',
    'GDataCalendarEvent.sequence': 'guint',
    'GDataCalendarEvent.status': 'gchararray',
    'GDataCalendarEvent.transparency': 'gchararray',
    'GDataCalendarEvent.uid': 'gchararray',
    'GDataCalendarEvent.visibility': 'gchararray',
    'GDataCalendarQuery.future-events': 'gboolean',
    'GDataCalendarQuery.max-attendees': 'guint',
    'GDataCalendarQuery.order-by': 'gchararray',
    'GDataCalendarQuery.show-deleted': 'gboolean',
    'GDataCalendarQuery.single-events': 'gboolean',
    'GDataCalendarQuery.start-max': 'gint64',
    'GDataCalendarQuery.start-min': 'gint64',
    'GDataCalendarQuery.timezone': 'gchararray',
    'GDataCategory.label': 'gchararray',
    'GDataCategory.scheme': 'gchararray',
    'GDataCategory.term': 'gchararray',
    'GDataDocumentsEntry.is-deleted': 'gboolean',
    'GDataDocumentsEntry.writers-can-invite': 'gboolean',
    'GDataDocumentsProperty.etag': 'gchararray',
    'GDataDocumentsProperty.key': 'gchararray',
    'GDataDocumentsProperty.value': 'gchararray',
    'GDataDocumentsProperty.visibility': 'gchararray',
    'GDataDocumentsQuery.exact-title': 'gboolean',
    'GDataDocumentsQuery.folder-id': 'gchararray',
    'GDataDocumentsQuery.show-deleted': 'gboolean',
    'GDataDocumentsQuery.show-folders': 'gboolean',
    'GDataDocumentsQuery.title': 'gchararray',
    'GDataDocumentsUploadQuery.convert': 'gboolean',
    'GDataDocumentsUploadQuery.folder': 'GDataDocumentsFolder',
    'GDataDownloadStream.authorization-domain': 'GDataAuthorizationDomain',
    'GDataDownloadStream.cancellable': 'GCancellable',
    'GDataDownloadStream.download-uri': 'gchararray',
    'GDataDownloadStream.service': 'GDataService',
    'GDataEntry.content': 'gchararray',
    'GDataEntry.content-uri': 'gchararray',
    'GDataEntry.etag': 'gchararray',
    'GDataEntry.id': 'gchararray',
    'GDataEntry.rights': 'gchararray',
    'GDataEntry.summary': 'gchararray',
    'GDataEntry.title': 'gchararray',
    'GDataGContactCalendar.is-primary': 'gboolean',
    'GDataGContactCalendar.label': 'gchararray',
    'GDataGContactCalendar.relation-type': 'gchararray',
    'GDataGContactCalendar.uri': 'gchararray',
    'GDataGContactEvent.label': 'gchararray',
    'GDataGContactEvent.relation-type': 'gchararray',
    'GDataGContactExternalID.label': 'gchararray',
    'GDataGContactExternalID.relation-type': 'gchararray',
    'GDataGContactExternalID.value': 'gchararray',
    'GDataGContactJot.content': 'gchararray',
    'GDataGContactJot.relation-type': 'gchararray',
    'GDataGContactLanguage.code': 'gchararray',
    'GDataGContactLanguage.label': 'gchararray',
    'GDataGContactRelation.label': 'gchararray',
    'GDataGContactRelation.name': 'gchararray',
    'GDataGContactRelation.relation-type': 'gchararray',
    'GDataGContactWebsite.is-primary': 'gboolean',
    'GDataGContactWebsite.label': 'gchararray',
    'GDataGContactWebsite.relation-type': 'gchararray',
    'GDataGContactWebsite.uri': 'gchararray',
    'GDataGDEmailAddress.address': 'gchararray',
    'GDataGDEmailAddress.display-name': 'gchararray',
    'GDataGDEmailAddress.is-primary': 'gboolean',
    'GDataGDEmailAddress.label': 'gchararray',
    'GDataGDEmailAddress.relation-type': 'gchararray',
    'GDataGDIMAddress.address': 'gchararray',
    'GDataGDIMAddress.is-primary': 'gboolean',
    'GDataGDIMAddress.label': 'gchararray',
    'GDataGDIMAddress.protocol': 'gchararray',
    'GDataGDIMAddress.relation-type': 'gchararray',
    'GDataGDName.additional-name': 'gchararray',
    'GDataGDName.family-name': 'gchararray',
    'GDataGDName.full-name': 'gchararray',
    'GDataGDName.given-name': 'gchararray',
    'GDataGDName.prefix': 'gchararray',
    'GDataGDName.suffix': 'gchararray',
    'GDataGDOrganization.department': 'gchararray',
    'GDataGDOrganization.is-primary': 'gboolean',
    'GDataGDOrganization.job-description': 'gchararray',
    'GDataGDOrganization.label': 'gchararray',
    'GDataGDOrganization.location': 'GDataGDWhere',
    'GDataGDOrganization.name': 'gchararray',
    'GDataGDOrganization.relation-type': 'gchararray',
    'GDataGDOrganization.symbol': 'gchararray',
    'GDataGDOrganization.title': 'gchararray',
    'GDataGDPhoneNumber.is-primary': 'gboolean',
    'GDataGDPhoneNumber.label': 'gchararray',
    'GDataGDPhoneNumber.number': 'gchararray',
    'GDataGDPhoneNumber.relation-type': 'gchararray',
    'GDataGDPhoneNumber.uri': 'gchararray',
    'GDataGDPostalAddress.address': 'gchararray',
    'GDataGDPostalAddress.agent': 'gchararray',
    'GDataGDPostalAddress.city': 'gchararray',
    'GDataGDPostalAddress.house-name': 'gchararray',
    'GDataGDPostalAddress.is-primary': 'gboolean',
    'GDataGDPostalAddress.label': 'gchararray',
    'GDataGDPostalAddress.mail-class': 'gchararray',
    'GDataGDPostalAddress.neighborhood': 'gchararray',
    'GDataGDPostalAddress.po-box': 'gchararray',
    'GDataGDPostalAddress.postcode': 'gchararray',
    'GDataGDPostalAddress.region': 'gchararray',
    'GDataGDPostalAddress.relation-type': 'gchararray',
    'GDataGDPostalAddress.street': 'gchararray',
    'GDataGDPostalAddress.subregion': 'gchararray',
    'GDataGDPostalAddress.usage': 'gchararray',
    'GDataGDReminder.absolute-time': 'gint64',
    'GDataGDReminder.method': 'gchararray',
    'GDataGDReminder.relative-time': 'gint',
    'GDataGDWhen.end-time': 'gint64',
    'GDataGDWhen.is-date': 'gboolean',
    'GDataGDWhen.start-time': 'gint64',
    'GDataGDWhen.value-string': 'gchararray',
    'GDataGDWhere.label': 'gchararray',
    'GDataGDWhere.relation-type': 'gchararray',
    'GDataGDWhere.value-string': 'gchararray',
    'GDataGDWho.email-address': 'gchararray',
    'GDataGDWho.relation-type': 'gchararray',
    'GDataGDWho.value-string': 'gchararray',
    'GDataGoaAuthorizer.goa-object': 'GoaObject',
    'GDataLink.content-type': 'gchararray',
    'GDataLink.language': 'gchararray',
    'GDataLink.length': 'gint',
    'GDataLink.relation-type': 'gchararray',
    'GDataLink.title': 'gchararray',
    'GDataLink.uri': 'gchararray',
    'GDataMediaCategory.category': 'gchararray',
    'GDataMediaCategory.label': 'gchararray',
    'GDataMediaCategory.scheme': 'gchararray',
    'GDataOAuth2Authorizer.client-id': 'gchararray',
    'GDataOAuth2Authorizer.client-secret': 'gchararray',
    'GDataOAuth2Authorizer.locale': 'gchararray',
    'GDataOAuth2Authorizer.proxy-resolver': 'GProxyResolver',
    'GDataOAuth2Authorizer.redirect-uri': 'gchararray',
    'GDataOAuth2Authorizer.refresh-token': 'gchararray',
    'GDataOAuth2Authorizer.timeout': 'guint',
    'GDataParsable.constructed-from-xml': 'gboolean',
    'GDataPicasaWebAlbum.album-id': 'gchararray',
    'GDataPicasaWebAlbum.is-commenting-enabled': 'gboolean',
    'GDataPicasaWebAlbum.latitude': 'gdouble',
    'GDataPicasaWebAlbum.location': 'gchararray',
    'GDataPicasaWebAlbum.longitude': 'gdouble',
    'GDataPicasaWebAlbum.timestamp': 'gint64',
    'GDataPicasaWebAlbum.visibility': 'GDataPicasaWebVisibility',
    'GDataPicasaWebFile.album-id': 'gchararray',
    'GDataPicasaWebFile.caption': 'gchararray',
    'GDataPicasaWebFile.checksum': 'gchararray',
    'GDataPicasaWebFile.file-id': 'gchararray',
    'GDataPicasaWebFile.is-commenting-enabled': 'gboolean',
    'GDataPicasaWebFile.latitude': 'gdouble',
    'GDataPicasaWebFile.longitude': 'gdouble',
    'GDataPicasaWebFile.rotation': 'guint',
    'GDataPicasaWebFile.timestamp': 'gint64',
    'GDataPicasaWebFile.version': 'gchararray',
    'GDataPicasaWebQuery.image-size': 'gchararray',
    'GDataPicasaWebQuery.location': 'gchararray',
    'GDataPicasaWebQuery.tag': 'gchararray',
    'GDataPicasaWebQuery.thumbnail-size': 'gchararray',
    'GDataPicasaWebQuery.visibility': 'gint',
    'GDataQuery.author': 'gchararray',
    'GDataQuery.categories': 'gchararray',
    'GDataQuery.etag': 'gchararray',
    'GDataQuery.is-strict': 'gboolean',
    'GDataQuery.max-results': 'guint',
    'GDataQuery.published-max': 'gint64',
    'GDataQuery.published-min': 'gint64',
    'GDataQuery.q': 'gchararray',
    'GDataQuery.start-index': 'guint',
    'GDataQuery.updated-max': 'gint64',
    'GDataQuery.updated-min': 'gint64',
    'GDataService.authorizer': 'GDataAuthorizer',
    'GDataService.locale': 'gchararray',
    'GDataService.proxy-resolver': 'GProxyResolver',
    'GDataService.timeout': 'guint',
    'GDataTasksQuery.completed-max': 'gint64',
    'GDataTasksQuery.completed-min': 'gint64',
    'GDataTasksQuery.due-max': 'gint64',
    'GDataTasksQuery.due-min': 'gint64',
    'GDataTasksQuery.show-completed': 'gboolean',
    'GDataTasksQuery.show-deleted': 'gboolean',
    'GDataTasksQuery.show-hidden': 'gboolean',
    'GDataTasksTask.completed': 'gint64',
    'GDataTasksTask.due': 'gint64',
    'GDataTasksTask.is-deleted': 'gboolean',
    'GDataTasksTask.notes': 'gchararray',
    'GDataTasksTask.parent': 'gchararray',
    'GDataTasksTask.position': 'gchararray',
    'GDataTasksTask.status': 'gchararray',
    'GDataUploadStream.authorization-domain': 'GDataAuthorizationDomain',
    'GDataUploadStream.cancellable': 'GCancellable',
    'GDataUploadStream.content-length': 'gint64',
    'GDataUploadStream.content-type': 'gchararray',
    'GDataUploadStream.entry': 'GDataEntry',
    'GDataUploadStream.method': 'gchararray',
    'GDataUploadStream.service': 'GDataService',
    'GDataUploadStream.slug': 'gchararray',
    'GDataUploadStream.upload-uri': 'gchararray',
    'GDataYouTubeComment.parent-comment-uri': 'gchararray',
    'GDataYouTubeQuery.age': 'GDataYouTubeAge',
    'GDataYouTubeQuery.latitude': 'gdouble',
    'GDataYouTubeQuery.license': 'gchararray',
    'GDataYouTubeQuery.location-radius': 'gdouble',
    'GDataYouTubeQuery.longitude': 'gdouble',
    'GDataYouTubeQuery.order-by': 'gchararray',
    'GDataYouTubeQuery.restriction': 'gchararray',
    'GDataYouTubeQuery.safe-search': 'GDataYouTubeSafeSearch',
    'GDataYouTubeService.developer-key': 'gchararray',
    'GDataYouTubeState.help-uri': 'gchararray',
    'GDataYouTubeState.message': 'gchararray',
    'GDataYouTubeState.name': 'gchararray',
    'GDataYouTubeState.reason-code': 'gchararray',
    'GDataYouTubeVideo.aspect-ratio': 'gchararray',
    'GDataYouTubeVideo.category': 'GDataMediaCategory',
    'GDataYouTubeVideo.description': 'gchararray',
    'GDataYouTubeVideo.is-private': 'gboolean',
    'GDataYouTubeVideo.latitude': 'gdouble',
    'GDataYouTubeVideo.location': 'gchararray',
    'GDataYouTubeVideo.longitude': 'gdouble',
    'GDataYouTubeVideo.recorded': 'gint64',
};

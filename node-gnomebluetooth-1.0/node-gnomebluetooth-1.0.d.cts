 ...
 */
export const CHOOSER_COMBO_FIRST_DEVICE: string | null
/**
 ...
 */
export function sendToAddress(address: string | null, alias: string | null): void
/**
...
export interface Chooser extends Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
     ...
     */
    getSelectedDeviceIcon(): string | null
    /**
    ...
    on(sigName: "selected-device-activated", callback: Chooser.SelectedDeviceActivatedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "selected-device-activated", callback: Chooser.SelectedDeviceActivatedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "selected-device-activated", callback: Chooser.SelectedDeviceActivatedSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "selected-device-changed", callback: Chooser.SelectedDeviceChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "selected-device-changed", callback: Chooser.SelectedDeviceChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "selected-device-changed", callback: Chooser.SelectedDeviceChangedSignalCallback): NodeJS.EventEmitter
...
export interface ChooserButton extends Atk.ImplementorIface, Gtk.Actionable, Gtk.Activatable, Gtk.Buildable {
    ...
    on(sigName: "chooser-created", callback: ChooserButton.ChooserCreatedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "chooser-created", callback: ChooserButton.ChooserCreatedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "chooser-created", callback: ChooserButton.ChooserCreatedSignalCallback): NodeJS.EventEmitter
...
export interface ChooserCombo extends Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
    ...
    on(sigName: "chooser-created", callback: ChooserCombo.ChooserCreatedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "chooser-created", callback: ChooserCombo.ChooserCreatedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "chooser-created", callback: ChooserCombo.ChooserCreatedSignalCallback): NodeJS.EventEmitter
    emit(sigName: "chooser-created", ...args: any[]): void
...
export interface SettingsWidget extends Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
    ...
    on(sigName: "adapter-status-changed", callback: SettingsWidget.AdapterStatusChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "adapter-status-changed", callback: SettingsWidget.AdapterStatusChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "adapter-status-changed", callback: SettingsWidget.AdapterStatusChangedSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "panel-changed", callback: SettingsWidget.PanelChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "panel-changed", callback: SettingsWidget.PanelChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "panel-changed", callback: SettingsWidget.PanelChangedSignalCallback): NodeJS.EventEmitter

 ...
 */
export interface WebProcessExtensionInitializeFunction {
 ...
 */
export interface WebProcessExtensionInitializeWithUserDataFunction {
...
export module WebProcessExtension {
    ...
    export interface PageCreatedSignalCallback {
        ($obj: WebProcessExtension, web_page: WebPage): void
    }
     ...
     */
    export interface UserMessageReceivedSignalCallback {
        ($obj: WebProcessExtension, message: UserMessage): void
    }
...
export interface WebProcessExtension {
    ...
    connect_after(sigName: "page-created", callback: WebProcessExtension.PageCreatedSignalCallback): number
    ...
    connect_after(sigName: "user-message-received", callback: WebProcessExtension.UserMessageReceivedSignalCallback): number
    emit(sigName: "user-message-received", message: UserMessage, ...args: any[]): void
 ...
 * @class 
 */
export class WebProcessExtension extends GObject.Object {
...
export interface WebProcessExtensionClass {
...
export abstract class WebProcessExtensionClass {

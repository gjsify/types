/**
 * The GIR-derived widget VOCABULARY for WebKitWebProcessExtension-6.0.
 *
 * GENERATED — do not edit. Provenance: WebKitWebProcessExtension-6.0
 *
 * 13 instantiable GTypes (of which 0 concrete widgets), 13 declarations, 2 enum nick unions, 0 slot candidates.
 *
...
export interface WebKitWebHitTestResultProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type WebKitWebHitTestResultConstructOnly = GObjectConstructOnly;
...
export interface WebKitWebProcessExtensionProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type WebKitWebProcessExtensionConstructOnly = GObjectConstructOnly;

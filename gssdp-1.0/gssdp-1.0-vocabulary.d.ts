/**
 * The GIR-derived widget VOCABULARY for GSSDP-1.0.
 *
 * GENERATED — do not edit. Provenance: GSSDP-1.0
 *
...
import type GSSDP from './gssdp-1.0.js';
...
export type GSSDPClientConstructOnly = GObjectConstructOnly | GInitableConstructOnly | 'interface' | 'msearch-port' | 'socket-ttl';

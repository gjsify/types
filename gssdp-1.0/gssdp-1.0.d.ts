...
static new_with_port(iface: (string | null), msearch_port: number): Client;
    ...
    connect(signal: 'message-received', callback: ((_source: this, from_ip: string, from_port: number, type: number, headers: Soup.MessageHeaders) => void)): number
    connect_after(signal: 'message-received', callback: ((_source: this, from_ip: string, from_port: number, type: number, headers: Soup.MessageHeaders) => void)): number
    emit(signal: 'message-received', from_ip: string, from_port: number, type: number, headers: Soup.MessageHeaders): void
...
static ["new"](client: Client, target: string): ResourceBrowser;
    ...
    connect_after(signal: 'resource-available', callback: ((_source: this, usn: string, locations: string[]) => void)): number

// The widget vocabulary of Clutter-9 as runtime data.
//
...
export const OWN_PROPS = {
    ...
    ClutterInputDevice: ['backend', 'device-mode', 'device-node', 'device-type', 'has-cursor', 'n-buttons', 'n-mode-groups', 'n-rings', 'n-strips', 'name', 'product-id', 'seat', 'vendor-id'],
...
export const OWN_SIGNALS = {
    ...
    ClutterStage: ['activate', 'after-paint', 'after-update', 'before-paint', 'before-update', 'deactivate', 'gl-video-memory-purged', 'paint-view', 'presented'],
...
export const ENUM_VALUES = {
    ...
    'ClutterEventType.device-added': 21,
    'ClutterEventType.device-removed': 22,
    'ClutterEventType.enter': 4,
    'ClutterEventType.event-last': 26,
    'ClutterEventType.im-commit': 23,
    'ClutterEventType.im-delete': 24,
    'ClutterEventType.im-preedit': 25,
    ...
    'ClutterEventType.pad-button-press': 17,
    'ClutterEventType.pad-button-release': 18,
    'ClutterEventType.pad-ring': 20,
    'ClutterEventType.pad-strip': 19,
    'ClutterEventType.proximity-in': 15,
    'ClutterEventType.proximity-out': 16,

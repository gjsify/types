 ...
 */
export function isodateFromTimeT(t: number): string | null
/**
 ...
 */
export function matchTzid(tzid: string | null): string | null
/**
...
export function recurGetLocalizedNth(nth: number): string | null
 ...
 */
export function timeFromIsodate(str: string | null): number
/**
 ...
 */
export function utilComponentDupXProperty(icalcomp: ICalGLib.Component, xName: string | null): string | null
/**
 ...
 */
export function utilComponentFindPropertyForLocale(icalcomp: ICalGLib.Component, propKind: ICalGLib.PropertyKind, locale: string | null): ICalGLib.Property | null
/**
 * Searches for an X property named `x_name` within X properties
 ...
 */
export function utilComponentFindXProperty(icalcomp: ICalGLib.Component, xName: string | null): ICalGLib.Property | null
 ...
 */
export function utilComponentHasXProperty(icalcomp: ICalGLib.Component, xName: string | null): boolean
/**
 ...
 */
export function utilComponentRemoveXProperty(icalcomp: ICalGLib.Component, xName: string | null): boolean
/**
 ...
 */
export function utilComponentSetXProperty(icalcomp: ICalGLib.Component, xName: string | null, value: string | null): void
/**
 ...
 */
export function utilDiffCategories(oldComp: ICalGLib.Component | null, newComp: ICalGLib.Component | null): [ /* outAdded */ GLib.HashTable, /* outRemoved */ GLib.HashTable ]
/**
 ...
 */
export function utilEmailAddressesEqual(email1: string | null, email2: string | null): boolean
/**
 ...
 */
export function utilForeachCategory(comp: ICalGLib.Component, func: UtilForeachCategoryFunc): void
/**
 ...
 * @returns a list of all the alarms found    for the given component in the given time range.
 */
export function utilGenerateAlarmsForUidSync(client: any | null, uid: string | null, start: number, end: number, omit: ComponentAlarmAction, resolveTzid: RecurResolveTimezoneCb, defaultTimezone: ICalGLib.Timezone, cancellable: Gio.Cancellable | null): ComponentAlarms | null
/**
 ...
 */
export function utilGetAttendeeEmail(attendee: ComponentAttendee | null): string | null
/**
 ...
 */
export function utilGetDefaultNameAndAddress(registry: EDataServer.SourceRegistry): [ /* returnType */ boolean, /* outName */ string | null, /* outAddress */ string | null ]
/**
 ...
 */
export function utilGetOrganizerEmail(organizer: ComponentOrganizer | null): string | null
/**
 ...
 */
export function utilGetPropertyEmail(prop: ICalGLib.Property): string | null
/**
 ...
 */
export function utilHasAlarmsInRange(comp: Component, start: number, end: number, omit: ComponentAlarmAction, resolveTzid: RecurResolveTimezoneCb, defaultTimezone: ICalGLib.Timezone): boolean
/**
 ...
 */
export function utilIcaltimeToTm(itt: ICalGLib.Time): any | null
/**
 ...
 * @returns The converted time as a struct tm. All fields will be    set properly except for tm.tm_yday.
 */
export function utilIcaltimeToTmWithZone(itt: ICalGLib.Time, fromZone: ICalGLib.Timezone, toZone: ICalGLib.Timezone): any | null
/**
 ...
 */
export function utilParseIcsFile(filename: string | null): ICalGLib.Component | null
/**
 ...
 */
export function utilParseIcsString(string: string | null): ICalGLib.Component | null
/**
 ...
 */
export function utilPriorityFromString(string: string | null): number
/**
 ...
 */
export function utilPriorityToString(priority: number): string | null
/**
 ...
 */
export function utilSecondsToString(seconds: number): string | null
/**
 ...
 * @returns Whether succeeded.
 */
export function utilSetAlarmAcknowledged(component: Component, auid: string | null, when: number): boolean
/**
 ...
 */
export function utilStripMailto(address: string | null): string | null
/**
 ...
 */
export function utilTmToIcaltime(tm: any | null, isDate: boolean): ICalGLib.Time
/**

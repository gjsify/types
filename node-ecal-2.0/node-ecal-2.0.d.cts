 ...
 * @returns a list of all the alarms found    for the given component in the given time range.
 */
export function utilGenerateAlarmsForUidSync(client: any | null, uid: string, start: number, end: number, omit: ComponentAlarmAction, resolveTzid: RecurResolveTimezoneCb, defaultTimezone: ICalGLib.Timezone, cancellable: Gio.Cancellable | null): ComponentAlarms | null
/**
 ...
 */
export function utilGetDefaultNameAndAddress(registry: EDataServer.SourceRegistry): [ /* returnType */ boolean, /* outName */ string, /* outAddress */ string ]
/**
 ...
 */
export function utilStripMailto(address: string | null): string
/**

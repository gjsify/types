 ...
 *
 * 23 instantiable GTypes (of which 19 concrete widgets), 23 declarations, 6 enum nick unions, 6 slot candidates.
 *
...
export interface GraniteStyleManagerProps {
    'color-scheme'?: GraniteSettingsColorSchemeNick | Granite.SettingsColorScheme;
    display?: Gdk.Display;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GraniteStyleManagerConstructOnly = 'display';

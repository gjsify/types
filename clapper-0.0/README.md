...
GJS TypeScript type definitions for Clapper-0.0, generated from library version 0.6.0 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v4.0.0-beta.14.

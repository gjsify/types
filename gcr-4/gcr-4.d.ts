 ...
 * @param callback a #GAsyncReadyCallback to call when the operation completes
 */
function trust_is_certificate_distrusted_async(serial_nr: Uint8Array, issuer: Uint8Array, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<Uint8Array> | null)): void
/**
 * Finishes an asynchronous operation started by

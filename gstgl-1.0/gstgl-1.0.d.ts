...
static ["new"](display: GLDisplay): GLWindow;
    ...
    connect(signal: 'scroll-event', callback: ((_source: this, x: number, y: number, delta_x: number, delta_y: number) => void)): number
    connect_after(signal: 'scroll-event', callback: ((_source: this, x: number, y: number, delta_x: number, delta_y: number) => void)): number

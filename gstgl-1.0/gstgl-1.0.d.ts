...
export namespace GstGL {
    class GLBaseMemoryError extends GLib.Error {
        // Own fields of GstGL-1.0.GLBaseMemoryError
        ...
        // Constructors of GstGL-1.0.GLBaseMemoryError

        constructor(options: { message: string; code: number });

        // Owm methods of GstGL-1.0.GLBaseMemoryError
    ...
    class GLContextError extends GLib.Error {
        // Own fields of GstGL-1.0.GLContextError
        ...
        // Constructors of GstGL-1.0.GLContextError

        constructor(options: { message: string; code: number });

        // Owm methods of GstGL-1.0.GLContextError
    ...
    class GLSLError extends GLib.Error {
        // Own fields of GstGL-1.0.GLSLError
        ...
        // Constructors of GstGL-1.0.GLSLError

        constructor(options: { message: string; code: number });

        // Owm methods of GstGL-1.0.GLSLError
    ...
    class GLWindowError extends GLib.Error {
        // Own fields of GstGL-1.0.GLWindowError
        ...
        // Constructors of GstGL-1.0.GLWindowError

        constructor(options: { message: string; code: number });

        // Owm methods of GstGL-1.0.GLWindowError
     ...
     */
    function gl_format_type_from_sized_gl_format(format: GLFormat): void;
     ...
     */
    function gl_get_affine_transformation_meta_as_ndc(meta: GstVideo.VideoAffineTransformationMeta | null): void;
    /**
     ...
     */
    function gl_handle_set_context(element: Gst.Element, context: Gst.Context): boolean;
    /**
     ...
     */
    function gl_multiply_matrix4(a: number[], b: number[]): void;
     ...
     */
    function glsl_string_get_version_profile(s: string): boolean;
     ...
     * @returns TRUE if a valid `#version` string was found, FALSE otherwise
     */
    function glsl_version_profile_from_string(string: string): boolean;
    ...
    class GLBaseFilter extends GstBase.BaseTransform {
        // Own properties of GstGL-1.0.GLBaseFilter

        readonly context: GLContext;

        // Own fields of GstGL-1.0.GLBaseFilter

        display: GLDisplay;

        // Owm methods of GstGL-1.0.GLBaseFilter
    ...
    abstract class GLBaseMixer extends GstVideo.VideoAggregator {
        // Own properties of GstGL-1.0.GLBaseMixer
        ...
        // Own fields of GstGL-1.0.GLBaseMixer

        display: GLDisplay;

        // Owm methods of GstGL-1.0.GLBaseMixer
    ...
    abstract class GLBaseSrc extends GstBase.PushSrc {
        // Own properties of GstGL-1.0.GLBaseSrc

        timestamp_offset: number;
        timestampOffset: number;

        // Own fields of GstGL-1.0.GLBaseSrc
    ...
    class GLBufferPool extends Gst.BufferPool {
        // Own fields of GstGL-1.0.GLBufferPool

        bufferpool: Gst.BufferPool;
        context: GLContext;

        // Constructors of GstGL-1.0.GLBufferPool

        static ['new'](context: GLContext): GLBufferPool;

        // Owm methods of GstGL-1.0.GLBufferPool
    ...
    class GLColorConvert extends Gst.Object {
        // Constructors of GstGL-1.0.GLColorConvert

        static ['new'](context: GLContext): GLColorConvert;

        // Owm methods of GstGL-1.0.GLColorConvert
    ...
    abstract class GLContext extends Gst.Object {
        // Constructors of GstGL-1.0.GLContext
        ...
        // Owm methods of GstGL-1.0.GLContext
         ...
         */
        static get_current_gl_api(platform: GLPlatform): GLAPI;
    ...
    class GLDisplay extends Gst.Object {
        // Constructors of GstGL-1.0.GLDisplay

        static ['new'](): GLDisplay;

        static new_with_type(type: GLDisplayType): GLDisplay;

        // Owm methods of GstGL-1.0.GLDisplay
         ...
         */
        create_context(other_context: GLContext | null): boolean;
         ...
         */
        ensure_context(other_context?: GLContext | null, context?: GLContext | null): boolean;
        /**
    ...
    class GLFramebuffer extends Gst.Object {
        // Constructors of GstGL-1.0.GLFramebuffer
        ...
        // Owm methods of GstGL-1.0.GLFramebuffer
    ...
    class GLMemoryAllocator extends GLBaseMemoryAllocator {
        // Owm methods of GstGL-1.0.GLMemoryAllocator
    ...
    abstract class GLMixer extends GLBaseMixer {
        // Owm methods of GstGL-1.0.GLMixer
    ...
    class GLMixerPad extends GLBaseMixerPad {
        // Own fields of GstGL-1.0.GLMixerPad
    ...
    class GLOverlayCompositor extends Gst.Object {
        // Own properties of GstGL-1.0.GLOverlayCompositor

        yinvert: boolean;

        // Constructors of GstGL-1.0.GLOverlayCompositor

        static ['new'](context: GLContext): GLOverlayCompositor;

        // Owm methods of GstGL-1.0.GLOverlayCompositor
    ...
    class GLSLStage extends Gst.Object {
        // Constructors of GstGL-1.0.GLSLStage
        ...
        // Owm methods of GstGL-1.0.GLSLStage
    ...
    class GLShader extends Gst.Object {
        // Own properties of GstGL-1.0.GLShader

        readonly linked: boolean;

        // Own fields of GstGL-1.0.GLShader

        context: GLContext;

        // Constructors of GstGL-1.0.GLShader

        static ['new'](context: GLContext): GLShader;

        static new_default(context: GLContext): GLShader;

        // Owm methods of GstGL-1.0.GLShader
    ...
    class GLUpload extends Gst.Object {
        // Own fields of GstGL-1.0.GLUpload

        context: GLContext;

        // Constructors of GstGL-1.0.GLUpload

        static ['new'](context: GLContext): GLUpload;

        // Owm methods of GstGL-1.0.GLUpload
         ...
         */
        perform_with_buffer(buffer: Gst.Buffer): GLUploadReturn;
        /**
    ...
    class GLViewConvert extends Gst.Object {
        // Own properties of GstGL-1.0.GLViewConvert
        ...
        // Own fields of GstGL-1.0.GLViewConvert
        ...
        // Constructors of GstGL-1.0.GLViewConvert

        static ['new'](): GLViewConvert;

        // Owm methods of GstGL-1.0.GLViewConvert
    ...
    abstract class GLWindow extends Gst.Object {
        // Constructors of GstGL-1.0.GLWindow

        static ['new'](display: GLDisplay): GLWindow;

        // Owm methods of GstGL-1.0.GLWindow
    ...
    class GLAllocationParams {
        // Own fields of GstGL-1.0.GLAllocationParams
        ...
        // Owm methods of GstGL-1.0.GLAllocationParams
     ...
     */
    class GLAsyncDebug {
        // Owm methods of GstGL-1.0.GLAsyncDebug
    ...
    class GLBaseFilterClass {
        // Own fields of GstGL-1.0.GLBaseFilterClass
     ...
     */
    class GLBaseMemory {
        // Own fields of GstGL-1.0.GLBaseMemory
        ...
        // Owm methods of GstGL-1.0.GLBaseMemory
    ...
    class GLBaseMemoryAllocatorClass {
        // Own fields of GstGL-1.0.GLBaseMemoryAllocatorClass
    ...
    class GLBaseMixerClass {
        // Own fields of GstGL-1.0.GLBaseMixerClass

        supported_gl_api: GLAPI;
    }

    class GLBaseMixerPadClass {}
     ...
     */
    class GLBaseSrcClass {
        // Own fields of GstGL-1.0.GLBaseSrcClass
     ...
     */
    class GLBuffer {
        // Own fields of GstGL-1.0.GLBuffer

        id: number;
        target: number;
        usage_hints: number;

        // Owm methods of GstGL-1.0.GLBuffer
    ...
    class GLBufferAllocationParams {
        // Own fields of GstGL-1.0.GLBufferAllocationParams

        gl_target: number;
        gl_usage: number;

        // Constructors of GstGL-1.0.GLBufferAllocationParams
     ...
     */
    class GLMemory {
        // Own fields of GstGL-1.0.GLMemory
        ...
        // Owm methods of GstGL-1.0.GLMemory
    ...
    class GLMemoryAllocatorClass {
        // Own fields of GstGL-1.0.GLMemoryAllocatorClass
     ...
     */
    class GLMemoryPBO {
        // Owm methods of GstGL-1.0.GLMemoryPBO
    ...
    class GLMixerClass {
        // Owm methods of GstGL-1.0.GLMixerClass
     ...
     */
    class GLQuery {
        // Owm methods of GstGL-1.0.GLQuery
         ...
         * @param context_ptr location containing the current and/or resulting                      #GstGLContext
         */
        static local_gl_context(element: Gst.Element, direction: Gst.PadDirection, context_ptr: GLContext): boolean;
    ...
    class GLRenderbuffer {
        // Own fields of GstGL-1.0.GLRenderbuffer
        ...
        // Owm methods of GstGL-1.0.GLRenderbuffer
    ...
    class GLRenderbufferAllocationParams {
        // Own fields of GstGL-1.0.GLRenderbufferAllocationParams

        renderbuffer_format: GLFormat;
        width: number;
        height: number;

        // Constructors of GstGL-1.0.GLRenderbufferAllocationParams
     ...
     */
    class GLSyncMeta {
        // Own fields of GstGL-1.0.GLSyncMeta

        context: GLContext;
        data: any;

        // Owm methods of GstGL-1.0.GLSyncMeta
    ...
    class GLVideoAllocationParams {
        // Own fields of GstGL-1.0.GLVideoAllocationParams
        ...
        // Constructors of GstGL-1.0.GLVideoAllocationParams
        ...
        // Owm methods of GstGL-1.0.GLVideoAllocationParams

 ...
 */
export function buffer_pool_config_set_gl_allocation_params(config: Gst.Structure, params: GLAllocationParams | null): void
export function context_get_gl_display(context: Gst.Context): [ /* returnType */ boolean, /* display */ GLDisplay | null ]
/**
...
export function gl_api_from_string(api_s: string | null): GLAPI
export function gl_api_to_string(api: GLAPI): string | null
...
export function gl_check_extension(name: string | null, ext: string | null): boolean
 ...
 */
export function gl_ensure_element_data(element: Gst.Element, display_ptr: GLDisplay, other_context_ptr: GLContext): [ /* returnType */ boolean, /* display_ptr */ GLDisplay, /* other_context_ptr */ GLContext ]
 ...
 */
export function gl_handle_set_context(element: Gst.Element, context: Gst.Context): [ /* returnType */ boolean, /* display */ GLDisplay, /* other_context */ GLContext ]
/**
...
export function gl_platform_from_string(platform_s: string | null): GLPlatform
export function gl_platform_to_string(platform: GLPlatform): string | null
/**
...
export function gl_texture_target_from_string(str: string | null): GLTextureTarget
...
export function glsl_profile_from_string(string: string | null): GLSLProfile
 ...
 */
export function glsl_string_get_version_profile(s: string | null): [ /* returnType */ boolean, /* version */ GLSLVersion, /* profile */ GLSLProfile ]
export function glsl_version_from_string(string: string | null): GLSLVersion
/**
 ...
 * @returns TRUE if a valid `#version` string was found, FALSE otherwise
 */
export function glsl_version_profile_from_string(string: string | null): [ /* returnType */ boolean, /* version_ret */ GLSLVersion, /* profile_ret */ GLSLProfile ]
...
export module GLBaseMixer {

    // Constructor properties interface

    export interface ConstructorProperties extends GstVideo.VideoAggregator.ConstructorProperties {
    }

}

export interface GLBaseMixer {
 ...
 * @class 
 */
export class GLBaseMixer extends GstVideo.VideoAggregator {
...
export module GLBaseMixerPad {

    // Constructor properties interface

    export interface ConstructorProperties extends GstVideo.VideoAggregatorPad.ConstructorProperties {
    }

}

export interface GLBaseMixerPad {
...
export class GLBaseMixerPad extends GstVideo.VideoAggregatorPad {
...
export module GLMixer {

    // Constructor properties interface

    export interface ConstructorProperties extends GLBaseMixer.ConstructorProperties {
    }
 ...
 * @class 
 */
export class GLMixer extends GLBaseMixer {
...
export module GLMixerPad {

    // Constructor properties interface

    export interface ConstructorProperties extends GLBaseMixerPad.ConstructorProperties {
    }

}

export interface GLMixerPad {
...
export class GLMixerPad extends GLBaseMixerPad {
...
export interface GLBaseMixerClass {
...
export abstract class GLBaseMixerClass {
...
export interface GLBaseMixerPadClass {
...
export abstract class GLBaseMixerPadClass {
...
export interface GLBaseMixerPrivate {
}

export class GLBaseMixerPrivate {
...
export abstract class GLMixerClass {
...
export interface GLMixerPadClass {
...
export abstract class GLMixerPadClass {
...
export interface GLMixerPrivate {
}

export class GLMixerPrivate {

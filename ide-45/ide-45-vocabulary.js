...
export const OWN_PROPS = {
    ...
    IdeTreeNode: ['children-possible', 'destroy-item', 'expanded-icon', 'expanded-icon-name', 'flags', 'has-error', 'icon', 'icon-name', 'is-header', 'item', 'parent', 'reset-on-collapse', 'title', 'use-markup'],

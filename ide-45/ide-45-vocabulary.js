// The widget vocabulary of Ide-45 as runtime data.
//
...
export const OWN_PROPS = {
    ...
    IdeTreeExpander: ['expanded-icon', 'expanded-icon-name', 'icon', 'icon-name', 'list-row', 'menu-model', 'suffix', 'title', 'use-markup'],
...
export const DECLS = {
    ...
    IdeSourceView: ['IdeSourceView', 'GtkSourceView', 'GtkTextView', 'GtkWidget', 'GtkAccessible', 'GtkBuildable', 'GtkConstraintTarget', 'GtkScrollable', 'GtkAccessibleText'],
    IdeTerminal: ['IdeTerminal', 'VteTerminal', 'GtkWidget', 'GtkAccessible', 'GtkBuildable', 'GtkConstraintTarget', 'GtkScrollable', 'GtkAccessibleText'],

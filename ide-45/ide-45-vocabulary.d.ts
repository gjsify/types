 ...
 *
 * 179 instantiable GTypes (of which 36 concrete widgets), 195 declarations (1 inlined from a namespace whose vocabulary does not emit them), 21 enum nick unions, 9 slot candidates.
 *

...
export namespace GConf {
    ...
    class Error extends GLib.Error {
        ...
        LOCAL_ENGINE: number;
        LOCK_FAILED: number;
        NO_WRITABLE_DATABASE: number;
        IN_SHUTDOWN: number;

        // Constructors of GConf-2.0.Error

        constructor(options: { message: string; code: number });

        // Owm methods of GConf-2.0.Error
    ...
    class Client extends GObject.Object {
        // Own fields of GConf-2.0.Client

        object: GObject.Object;

        // Owm methods of GConf-2.0.Client
    ...
    class ChangeSet {
        // Constructors of GConf-2.0.ChangeSet

        constructor(properties?: Partial<{}>);

        static ['new'](): ChangeSet;

        // Owm methods of GConf-2.0.ChangeSet
    ...
    class ClientClass {
        // Own fields of GConf-2.0.ClientClass
    ...
    class Entry {
        // Own fields of GConf-2.0.Entry

        key: string;

        // Constructors of GConf-2.0.Entry
        ...
        // Owm methods of GConf-2.0.Entry
    ...
    class EnumStringPair {
        // Own fields of GConf-2.0.EnumStringPair

        enum_value: number;
        str: string;

        // Constructors of GConf-2.0.EnumStringPair
    ...
    class Value {
        // Own fields of GConf-2.0.Value

        type: ValueType;

        // Constructors of GConf-2.0.Value
        ...
        // Owm methods of GConf-2.0.Value

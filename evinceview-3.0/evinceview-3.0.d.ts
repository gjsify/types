...
static ["new"](): View;
    ...
    connect_after(signal: 'annot-changed', callback: ((_source: this, object: EvinceDocument.Annotation) => void)): number
    ...
    connect_after(signal: 'annot-removed', callback: ((_source: this, object: EvinceDocument.Annotation) => void)): number
    ...
    connect(signal: 'move-cursor', callback: ((_source: this, object: Gtk.MovementStep, p0: number, p1: boolean) => boolean)): number
    connect_after(signal: 'move-cursor', callback: ((_source: this, object: Gtk.MovementStep, p0: number, p1: boolean) => boolean)): number
    ...
    connect_after(signal: 'scroll', callback: ((_source: this, object: Gtk.ScrollType, p0: Gtk.Orientation) => void)): number

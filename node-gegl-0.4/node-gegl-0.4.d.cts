 ...
 * @param pathRoot path in filesystem to use as relative root
 */
export function createChainArgv(ops: string | null, opStart: Node, opEnd: Node, time: number, relDim: number, pathRoot: string): void
/**
...
export function serialize(start: Node, end: Node, basepath: string, serializeFlags: SerializeFlag): string | null
/**

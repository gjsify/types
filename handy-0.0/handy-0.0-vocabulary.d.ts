...
export interface HdyArrowsProps extends GtkDrawingAreaProps, GtkBuildableProps {
    /** @default 1 */
    count?: number;
    /** @default HDY_ARROWS_DIRECTION_UP */
...
export interface HdyLeafletProps extends GtkContainerProps, GtkBuildableProps, GtkOrientableProps, HdySwipeableProps {
     ...
     * @default HDY_LEAFLET_CHILD_TRANSITION_TYPE_NONE
     * @deprecated since 0.0.12: Use #HdyLeaflet:transition-type instead
     */
     ...
     * @default HDY_LEAFLET_MODE_TRANSITION_TYPE_NONE
     * @deprecated since 0.0.12: Use #HdyLeaflet:transition-type instead
     */
     ...
     * @since 0.0.12
     * @default HDY_LEAFLET_TRANSITION_TYPE_NONE
     */
...
export interface HdyPaginatorProps extends GtkEventBoxProps, GtkBuildableProps, GtkOrientableProps, HdySwipeableProps {
     ...
     * @since 0.0.11
     * @default HDY_PAGINATOR_INDICATOR_STYLE_NONE
     */

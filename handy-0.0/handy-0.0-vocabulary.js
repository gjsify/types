...
export const ENUM_VALUES = {
    ...
    'HdyArrowsDirection.up': 0,
    'HdyCenteringPolicy.loose': 0,
    'HdyCenteringPolicy.strict': 1,
    'HdyFold.folded': 1,
    'HdyFold.unfolded': 0,
    'HdyLeafletChildTransitionType.crossfade': 1,
    'HdyLeafletChildTransitionType.none': 0,
    'HdyLeafletChildTransitionType.over': 3,
    'HdyLeafletChildTransitionType.slide': 2,
    'HdyLeafletChildTransitionType.under': 4,
    'HdyLeafletModeTransitionType.none': 0,
    'HdyLeafletModeTransitionType.slide': 1,
    'HdyLeafletTransitionType.none': 0,
    'HdyLeafletTransitionType.over': 2,
    'HdyLeafletTransitionType.slide': 1,
    'HdyLeafletTransitionType.under': 3,
    'HdyPaginatorIndicatorStyle.dots': 1,
    'HdyPaginatorIndicatorStyle.lines': 2,
    'HdyPaginatorIndicatorStyle.none': 0,
...
export const PROP_ENUMS = {
    'HdyArrows.direction': 'HdyArrowsDirection',
    'HdyDialer.relief': 'GtkReliefStyle',
    'HdyHeaderBar.centering-policy': 'HdyCenteringPolicy',
    'HdyLeaflet.child-transition-type': 'HdyLeafletChildTransitionType',
    'HdyLeaflet.mode-transition-type': 'HdyLeafletModeTransitionType',
    'HdyLeaflet.transition-type': 'HdyLeafletTransitionType',
    'HdyPaginator.indicator-style': 'HdyPaginatorIndicatorStyle',
...
export const PROP_TYPES = {
    ...
    'HdyActionRow.title': 'gchararray',
    'HdyActionRow.use-underline': 'gboolean',
    'HdyArrows.count': 'guint',
    'HdyArrows.direction': 'HdyArrowsDirection',
    'HdyArrows.duration': 'guint',
    'HdyColumn.linear-growth-width': 'gint',
    'HdyColumn.maximum-width': 'gint',
    'HdyComboRow.selected-index': 'gint',
    'HdyComboRow.use-subtitle': 'gboolean',
    'HdyDialer.column-spacing': 'guint',
    'HdyDialer.number': 'gchararray',
    'HdyDialer.relief': 'GtkReliefStyle',
    'HdyDialer.row-spacing': 'guint',
    'HdyDialer.show-action-buttons': 'gboolean',
    'HdyDialerButton.symbols': 'gchararray',
    'HdyDialerCycleButton.cycle-timeout': 'gint',
    ...
    'HdyHeaderGroup.focus': 'GtkHeaderBar',
    'HdyKeypad.entry': 'GtkWidget',
    'HdyKeypad.left-action': 'GtkWidget',
    'HdyKeypad.only-digits': 'gboolean',
    'HdyKeypad.right-action': 'GtkWidget',
    'HdyKeypad.show-symbols': 'gboolean',
    ...
    'HdyPaginator.allow-mouse-drag': 'gboolean',
    'HdyPaginator.animation-duration': 'guint',
    'HdyPaginator.center-content': 'gboolean',
    'HdyPaginator.indicator-spacing': 'guint',
    'HdyPaginator.indicator-style': 'HdyPaginatorIndicatorStyle',
    'HdyPaginator.interactive': 'gboolean',
    'HdyPaginator.spacing': 'guint',
    ...
    'HdyViewSwitcher.icon-size': 'gint',
    'HdyViewSwitcher.narrow-ellipsize': 'PangoEllipsizeMode',
    'HdyViewSwitcher.policy': 'HdyViewSwitcherPolicy',
    'HdyViewSwitcher.stack': 'GtkStack',
    'HdyViewSwitcherBar.icon-size': 'gint',
    'HdyViewSwitcherBar.policy': 'HdyViewSwitcherPolicy',
...
export const SINCE = {
    ...
    'HdyPaginator::page-changed': '0.0.12',

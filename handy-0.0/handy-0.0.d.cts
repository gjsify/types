 ...
 */
export function enum_value_row_name(value: EnumValueObject, user_data: any | null): string | null
/**
 ...
 */
export function list_box_separator_header(row: Gtk.ListBoxRow, before: Gtk.ListBoxRow | null, unused_user_data: any | null): void
/**

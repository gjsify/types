 ...
 *
 * 3 instantiable GTypes (of which 3 concrete widgets), 3 declarations, 0 enum nick unions, 0 slot candidates.
 *
...
import type { AdwBinConstructOnly, AdwBinProps, AdwDialogConstructOnly, AdwDialogProps, AdwPreferencesDialogConstructOnly, AdwPreferencesDialogProps } from '@girs/adw-1/vocabulary';
import type { GInitiallyUnownedConstructOnly, GInitiallyUnownedProps, GObjectConstructOnly, GObjectProps } from '@girs/gobject-2.0/vocabulary';
import type { GtkAccessibleConstructOnly, GtkAccessibleProps, GtkBoxConstructOnly, GtkBoxProps, GtkBuildableConstructOnly, GtkBuildableProps, GtkConstraintTargetConstructOnly, GtkConstraintTargetProps, GtkOrientableConstructOnly, GtkOrientableProps, GtkShortcutManagerConstructOnly, GtkShortcutManagerProps, GtkWidgetConstructOnly, GtkWidgetProps } from '@girs/gtk-4.0/vocabulary';
import type { MctUserTypeNick } from '@girs/malcontent-0/vocabulary';

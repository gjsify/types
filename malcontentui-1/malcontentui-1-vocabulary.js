...
export const PROP_ENUMS = {
    'MctUserControls.user-account-type': 'MctUserType',
};
...
export const PROP_TYPES = {
    'MctRestrictApplicationsDialog.user-display-name': 'gchararray',
    'MctRestrictApplicationsSelector.search': 'gchararray',
    'MctUserControls.dbus-connection': 'GDBusConnection',
    'MctUserControls.description': 'gchararray',
    'MctUserControls.permission': 'GPermission',
    'MctUserControls.user': 'MctUser',
    'MctUserControls.user-account-type': 'MctUserType',
    'MctUserControls.user-display-name': 'gchararray',
    'MctUserControls.user-locale': 'gchararray',
};

...
export namespace MalcontentUi {
     ...
     *
     * The dialog contains a single {@link MalcontentUi.RestrictApplicationsSelector}. It takes a
     * {@link MalcontentUi.RestrictApplicationsDialog.user} and
     * {@link MalcontentUi.RestrictApplicationsDialog.app_filter} as input to set up the UI, and
     * returns its output as set of modifications to a given {@link Malcontent.AppFilterBuilder}
        ...
        implements Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Native, Gtk.Root, Gtk.ShortcutManager
    {
         ...
         * the given `builder`.
         *
         * Typically this will be called in the handler for {@link Gtk.Dialog.SignalSignatures.response | Gtk.Dialog::response}.
        ...
        /**
         * Get the value of {@link MalcontentUi.RestrictApplicationsDialog.app_filter}. If the property
        ...
        /**
         * Get the value of {@link MalcontentUi.RestrictApplicationsDialog.user_display_name}.
         * @returns the display name of the user the dialog    is configured for, or `null` if unknown
         */
        get_user_display_name(): string | null;
        /**
         * Set the value of {@link MalcontentUi.RestrictApplicationsDialog.app_filter}.
        ...
        /**
         * Set the value of {@link MalcontentUi.RestrictApplicationsDialog.user_display_name}.
     ...
     * allows the given user to be prevented from running each application.
     *
     * The selector takes an {@link MalcontentUi.RestrictApplicationsSelector.app_filter} as input
        ...
        implements Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Orientable
    {
        ...
        build_app_filter(builder: Malcontent.AppFilterBuilder): void;
        /**
         * Get the value of {@link MalcontentUi.RestrictApplicationsSelector.app_filter}. If the property
         * was originally set to `null`, this will be the empty app filter.
         * @returns the initial app filter used to    populate the selector
         */
        get_app_filter(): Malcontent.AppFilter;
        /**
         * Set the value of {@link MalcontentUi.RestrictApplicationsSelector.app_filter}.
         *
     ...
     * user.
     *
     * If {@link MalcontentUi.UserControls.user} is set, the current parental controls settings for
     ...
     * timeout).
     *
     * If {@link MalcontentUi.UserControls.user} is unset (for example, if setting the parental
     ...
     *
     * When {@link MalcontentUi.UserControls.user} is unset, changes made to the parental controls
     ...
     * using polkit. {@link MalcontentUi.UserControls.permission} is used to query the current
     * permissions for getting/setting parental controls. If it’s `null`, or if
     * permissions are not currently granted, the {@link MalcontentUi.UserControls} will be
     * insensitive.
     * @gir-type Class
     * @since 0.5.0
     */
    class UserControls extends Adw.Bin implements Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget {
        ...
        build_app_filter(builder: Malcontent.AppFilterBuilder): void;
        /**
         * Get the value of {@link MalcontentUi.UserControls.app_filter}. If the app filter is unknown
         * or could not be retrieved from {@link MalcontentUi.UserControls.user}, this will be `null`.
         ...
         * saved automatically if {@link MalcontentUi.UserControls.user} is set.

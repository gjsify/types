/**
 * The GIR-derived widget VOCABULARY for Clutter-18.
 *
 * GENERATED — do not edit. Provenance: Clutter-18 — dropped empty base(s): Atk.ImplementorIface
 *
 * 62 instantiable GTypes (of which 0 concrete widgets), 75 declarations, 49 enum nick unions, 0 slot candidates.
 *
...
import type Clutter from './clutter-18.js';
...
import type { CoglShaderTypeNick } from '@girs/cogl-18/vocabulary';
...
export interface ClutterShaderEffectProps extends ClutterOffscreenEffectProps {
     ...
     * @default COGL_SHADER_TYPE_FRAGMENT
     */
    'shader-type'?: CoglShaderTypeNick | Cogl.ShaderType;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */

...
static ["new"](): DIDLLiteParser;
    ...
    connect_after(signal: 'container-available', callback: ((_source: this, container: DIDLLiteContainer) => void)): number
...
static ["new"](): SearchCriteriaParser;
    ...
    connect(signal: 'expression', callback: ((_source: this, property: string, op: SearchCriteriaOp, value: string, error: any | null) => boolean)): number
    connect_after(signal: 'expression', callback: ((_source: this, property: string, op: SearchCriteriaOp, value: string, error: any | null) => boolean)): number

...
Node.js TypeScript type definitions for JavaScriptCore-5.0, generated from library version 2.38.5 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v3.0.0-beta.15.
...
```ts
const JavaScriptCore = require('@girs/javascriptcore-5.0');
```

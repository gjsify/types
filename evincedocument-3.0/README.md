...
GJS TypeScript type definitions for EvinceDocument-3.0, generated from library version 48.1.0 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v4.0.0-rc.2.

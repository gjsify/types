...
static AUTOCONNECT: number
    ...
    // Constructors of GUPnP.ServiceError

constructor(options: { message: string, code: number});
_init(...args: any[]): void;


    // Own static methods of GUPnP.ServiceError
...
static OTHER: number
    ...
    // Constructors of GUPnP.ServiceIntrospectionError

constructor(options: { message: string, code: number});
_init(...args: any[]): void;


    // Own static methods of GUPnP.ServiceIntrospectionError
...
_init(...args: any[]): void;
    ...
    connect(signal: 'notify-failed', callback: ((_source: this, callback_url: GLib.Uri[], reason: GLib.Error) => void)): number
    connect_after(signal: 'notify-failed', callback: ((_source: this, callback_url: GLib.Uri[], reason: GLib.Error) => void)): number
    emit(signal: 'notify-failed', callback_url: GLib.Uri[], reason: GLib.Error): void
    connect(signal: 'query-variable', callback: ((_source: this, variable: string, value: GObject.Value) => void)): number
    connect_after(signal: 'query-variable', callback: ((_source: this, variable: string, value: GObject.Value) => void)): number

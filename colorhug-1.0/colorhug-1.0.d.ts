...
export namespace ColorHug {
     ...
     */
    function device_get_adc_calibration_neg(device: GUsb.Device, cancellable?: Gio.Cancellable | null): boolean;
    /**
     * Gets the ADC positive calibration value.
     * @param device A #GUsbDevice
     * @param cancellable a #GCancellable, or %NULL
     * @returns %TRUE for success
     */
    function device_get_adc_calibration_pos(device: GUsb.Device, cancellable?: Gio.Cancellable | null): boolean;
    /**
     ...
     * @returns %TRUE for success
     */
    function device_get_error(device: GUsb.Device, cancellable?: Gio.Cancellable | null): boolean;
    /**
     ...
     * @returns %TRUE for success
     */
    function device_get_illuminants(device: GUsb.Device, cancellable?: Gio.Cancellable | null): boolean;
    /**
     ...
     * @returns %TRUE for success
     */
    function device_get_integral_time(device: GUsb.Device, cancellable?: Gio.Cancellable | null): boolean;
    /**
     ...
     * @returns %TRUE for success
     */
    function device_get_leds(device: GUsb.Device, cancellable?: Gio.Cancellable | null): boolean;
     ...
     * @returns %TRUE for success
     */
    function device_get_pcb_errata(device: GUsb.Device, cancellable?: Gio.Cancellable | null): boolean;
    /**
     ...
     * @returns %TRUE for success
     */
    function device_get_serial_number(device: GUsb.Device, cancellable?: Gio.Cancellable | null): boolean;
    /**
     ...
     * @returns %TRUE for success
     */
    function device_get_temperature(device: GUsb.Device, cancellable?: Gio.Cancellable | null): boolean;
    ...
    class DeviceQueue extends GObject.Object {
        // Constructors of ColorHug-1.0.DeviceQueue

        static ['new'](): DeviceQueue;

        // Owm methods of ColorHug-1.0.DeviceQueue
    ...
    class DeviceQueueClass {}

    class Sha1 {
        // Own fields of ColorHug-1.0.Sha1

        bytes: Uint8Array;

        // Constructors of ColorHug-1.0.Sha1
        ...
        // Owm methods of ColorHug-1.0.Sha1

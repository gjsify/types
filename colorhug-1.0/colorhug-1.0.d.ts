 ...
 */
function device_write_command_async(device: GUsb.Device, cmd: number, buffer_in: number, buffer_in_len: number, buffer_out: number, buffer_out_len: number, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<GUsb.Device> | null)): void
/**
...
static ["new"](): DeviceQueue;
    ...
    connect_after(signal: 'device-failed', callback: ((_source: this, object: GObject.Object, p0: string) => void)): number

/**
 * The GIR-derived widget VOCABULARY for Libxfce4windowing-0.0.
 *
 * GENERATED — do not edit. Provenance: Libxfce4windowing-0.0 — library 4.20.7
 *
 * 1 instantiable GTypes (of which 0 concrete widgets), 1 declarations, 4 enum nick unions, 0 slot candidates.
 *
...
export type XfwDirectionNick = 'up' | 'down' | 'left' | 'right';
export type XfwMonitorSubpixelNick = 'unknown' | 'none' | 'hrgb' | 'hbgr' | 'vrgb' | 'vbgr';
export type XfwMonitorTransformNick = 'normal' | '90' | '180' | '270' | 'flipped' | 'flipped-90' | 'flipped-180' | 'flipped-270';
export type XfwWindowTypeNick = 'normal' | 'desktop' | 'dock' | 'dialog' | 'toolbar' | 'menu' | 'utility' | 'splashscreen';
...
export interface XfwSeatProps extends GObjectProps {
    /**
...
export type XfwSeatConstructOnly = GObjectConstructOnly | 'name';

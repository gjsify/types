 ...
 */
export enum CarrierLockModemState {
    /**
     * Modem deregistered.
     */
    DEREGISTERED,
 ...
 */
export function cellular_class_build_string_from_mask(mask: CellularClass): string | null
/**
 ...
 * @returns a string with the list of nicknames, or %NULL if none given. The returned value should be freed with g_free().
 */
export function ctrl_caps_build_string_from_mask(mask: CtrlCaps): string | null
/**
 * Builds a string containing a comma-separated list of nicknames for
 ...
 * @returns a string with the list of nicknames, or %NULL if none given. The returned value should be freed with g_free().
 */
export function data_class_build_string_from_mask(mask: DataClass): string | null
/**
 * Builds a string containing a comma-separated list of nicknames for
 ...
 * @returns a string with the list of nicknames, or %NULL if none given. The returned value should be freed with g_free().
 */
export function data_class_v3_build_string_from_mask(mask: DataClassV3): string | null
/**
 * Builds a string containing a comma-separated list of nicknames for
 ...
 * @returns a string with the list of nicknames, or %NULL if none given. The returned value should be freed with g_free().
 */
export function data_subclass_build_string_from_mask(mask: DataSubclass): string | null
/**
 ...
 * @returns a string with the list of nicknames, or %NULL if none given. The returned value should be freed with g_free().
 */
export function frequency_range_build_string_from_mask(mask: FrequencyRange): string | null
/**
 ...
 */
export function intel_rfim_frequency_value_array_free(array: IntelRfimFrequencyValueArray): void
/**
 ...
 * @returns a string with the list of nicknames, or %NULL if none given. The returned value should be freed with g_free().
 */
export function ip_configuration_available_flag_build_string_from_mask(mask: IPConfigurationAvailableFlag): string | null
/**
 ...
 */
export function lte_attach_status_free(var_: DeprecatedLteAttachStatus): void
/**
 ...
 * @returns a string with the list of nicknames, or %NULL if none given. The returned value should be freed with g_free().
 */
export function provider_state_build_string_from_mask(mask: ProviderState): string | null
/**
 ...
 * @returns a string with the list of nicknames, or %NULL if none given. The returned value should be freed with g_free().
 */
export function ready_info_flag_build_string_from_mask(mask: ReadyInfoFlag): string | null
/**
 ...
 * @returns a string with the list of nicknames, or %NULL if none given. The returned value should be freed with g_free().
 */
export function registration_flag_build_string_from_mask(mask: RegistrationFlag): string | null
/**
 ...
 * @returns a string with the list of nicknames, or %NULL if none given. The returned value should be freed with g_free().
 */
export function sim_class_build_string_from_mask(mask: SimClass): string | null
/**
 ...
 * @returns a string with the list of nicknames, or %NULL if none given. The returned value should be freed with g_free().
 */
export function sms_caps_build_string_from_mask(mask: SmsCaps): string | null
/**
 ...
 * @returns a string with the list of nicknames, or %NULL if none given. The returned value should be freed with g_free().
 */
export function sms_status_flag_build_string_from_mask(mask: SmsStatusFlag): string | null
/**
 ...
 * @returns a string with the list of nicknames, or %NULL if none given. The returned value should be freed with g_free().
 */
export function subscriber_ready_status_flag_build_string_from_mask(mask: SubscriberReadyStatusFlag): string | null
/**
 ...
 */
export function uicc_application_array_free(array: UiccApplicationArray): void
/**
 ...
 */
export function utils_get_show_personal_info(): boolean
/**
 ...
 */
export function utils_set_show_personal_info(show_personal_info: boolean): void
/**
...
export interface Device extends Gio.AsyncInitable {
     ...
     */
    add_link_finish(res: Gio.AsyncResult, session_id: number): string | null
    /**
    ...
    connect_after(sigName: "device-error", callback: Device.DeviceErrorSignalCallback): number
    ...
    connect_after(sigName: "device-indicate-status", callback: Device.DeviceIndicateStatusSignalCallback): number
    ...
    connect_after(sigName: "device-removed", callback: Device.DeviceRemovedSignalCallback): number
    emit(sigName: "device-removed", ...args: any[]): void

    // Class property signals of Mbim-1.0.Mbim.Device

    connect(sigName: "notify::device-consecutive-timeouts", callback: (($obj: Device, pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::device-consecutive-timeouts", callback: (($obj: Device, pspec: GObject.ParamSpec) => void)): number
...
export interface Message {
     ...
     * @returns %TRUE if the message was correctly parsed, %FALSE if @error is set.
     */
    google_carrier_lock_notification_parse(): [ /* returnType */ boolean, /* out_carrier_lock_status */ CarrierLockStatus, /* out_carrier_lock_modem_state */ CarrierLockModemState, /* out_carrier_lock_cause */ CarrierLockCause ]
    /**
     * Parses and returns parameters of the 'Carrier Lock' response command in the 'Google' service.
     * @returns %TRUE if the message was correctly parsed, %FALSE if @error is set.
     */
    google_carrier_lock_response_parse(): [ /* returnType */ boolean, /* out_carrier_lock_status */ CarrierLockStatus, /* out_carrier_lock_modem_state */ CarrierLockModemState, /* out_carrier_lock_cause */ CarrierLockCause ]
    /**
     ...
     * @returns %TRUE if the message was correctly parsed, %FALSE if @error is set.
     */
    intel_mutual_authentication_fcc_lock_response_parse(): [ /* returnType */ boolean, /* out_challenge_present */ boolean, /* out_challenge */ number ]
    /**
     * Parses and returns parameters of the 'RFIM' notification command in the 'Intel Thermal RF' service.
     * @returns %TRUE if the message was correctly parsed, %FALSE if @error is set.
     */
    intel_thermal_rf_rfim_notification_parse(): [ /* returnType */ boolean, /* out_rfim_frequency_values_count */ number, /* out_rfim_frequency_values */ IntelRfimFrequencyValue[] ]
    /**
     * Parses and returns parameters of the 'RFIM' response command in the 'Intel Thermal RF' service.
     * @returns %TRUE if the message was correctly parsed, %FALSE if @error is set.
     */
    intel_thermal_rf_rfim_response_parse(): [ /* returnType */ boolean, /* out_rfim_frequency_values_count */ number, /* out_rfim_frequency_values */ IntelRfimFrequencyValue[] ]
    /**
     * Parses and returns parameters of the 'Trace Config' response command in the 'Intel Tools' service.
     * @returns %TRUE if the message was correctly parsed, %FALSE if @error is set.
     */
    intel_tools_trace_config_response_parse(): [ /* returnType */ boolean, /* out_trace_cmd */ TraceCommand, /* out_result */ number ]
    /**
     ...
     * @returns %TRUE if the message was correctly parsed, %FALSE if @error is set.
     */
    ms_uicc_low_level_access_application_list_response_parse(): [ /* returnType */ boolean, /* out_version */ number, /* out_application_count */ number, /* out_active_application_index */ number, /* out_application_list_size_bytes */ number, /* out_applications */ UiccApplication[] ]
    /**
     * Parses and returns parameters of the 'ATR' response command in the 'MS UICC Low Level Access' service.
     * @returns %TRUE if the message was correctly parsed, %FALSE if @error is set.
     */
    ms_uicc_low_level_access_atr_response_parse(): [ /* returnType */ boolean, /* out_atr */ Uint8Array ]
    /**
     ...
     * @returns %TRUE if the message was correctly parsed, %FALSE if @error is set.
     */
    ms_uicc_low_level_access_file_status_response_parse(): [ /* returnType */ boolean, /* out_version */ number, /* out_status_word1 */ number, /* out_status_word2 */ number, /* out_file_accessibility */ UiccFileAccessibility, /* out_file_type */ UiccFileType, /* out_file_structure */ UiccFileStructure, /* out_file_item_count */ number, /* out_file_item_size */ number, /* out_access_condition_read */ PinType, /* out_access_condition_update */ PinType, /* out_access_condition_activate */ PinType, /* out_access_condition_deactivate */ PinType ]
    /**
     ...
     * @returns %TRUE if the message was correctly parsed, %FALSE if @error is set.
     */
    ms_uicc_low_level_access_read_binary_response_parse(): [ /* returnType */ boolean, /* out_version */ number, /* out_status_word1 */ number, /* out_status_word2 */ number, /* out_data */ Uint8Array ]
    /**
     * Parses and returns parameters of the 'Read Record' response command in the 'MS UICC Low Level Access' service.
     * @returns %TRUE if the message was correctly parsed, %FALSE if @error is set.
     */
    ms_uicc_low_level_access_read_record_response_parse(): [ /* returnType */ boolean, /* out_version */ number, /* out_status_word1 */ number, /* out_status_word2 */ number, /* out_data */ Uint8Array ]
    /**
     ...
     * @returns %TRUE if the message was correctly parsed, %FALSE if @error is set.
     */
    ms_voice_extensions_nitz_notification_parse(): [ /* returnType */ boolean, /* out_year */ number, /* out_month */ number, /* out_day */ number, /* out_hour */ number, /* out_minute */ number, /* out_second */ number, /* out_time_zone_offset_minutes */ number, /* out_daylight_saving_time_offset_minutes */ number, /* out_data_class */ DataClass ]
    /**
     * Parses and returns parameters of the 'NITZ' response command in the 'MS Voice Extensions' service.
     * @returns %TRUE if the message was correctly parsed, %FALSE if @error is set.
     */
    ms_voice_extensions_nitz_response_parse(): [ /* returnType */ boolean, /* out_year */ number, /* out_month */ number, /* out_day */ number, /* out_hour */ number, /* out_minute */ number, /* out_second */ number, /* out_time_zone_offset_minutes */ number, /* out_daylight_saving_time_offset_minutes */ number, /* out_data_class */ DataClass ]
    /**
...
export class Message {
     ...
     * @constructor 
     * @param boot_mode the 'BootMode' field, given as a #MbimIntelBootMode.
     ...
     * @constructor 
     * @param response_present the 'ResponsePresent' field, given as a #gboolean.
     ...
     * @constructor 
     * @param activation_state the 'ActivationState' field, given as a #gboolean.
     * @returns a newly allocated #MbimMessage, which should be freed with mbim_message_unref().
     */
     ...
     * @constructor 
     * @param trace_cmd the 'TraceCmd' field, given as a #MbimTraceCommand.
     * @returns a newly allocated #MbimMessage, which should be freed with mbim_message_unref().
     */
     ...
     * @constructor 
     * @param trace_cmd the 'TraceCmd' field, given as a #MbimTraceCommand.
     * @param trace_value the 'TraceValue' field, given as a #guint32.
     * @returns a newly allocated #MbimMessage, which should be freed with mbim_message_unref().
     */
     ...
     * @param application_id the 'ApplicationId' field, given as an array of #guint8 values.
     * @param file_path the 'FilePath' field, given as an array of #guint8 values.
     * @returns a newly allocated #MbimMessage, which should be freed with mbim_message_unref().
     */
    static ms_uicc_low_level_access_file_status_query_new(version: number, application_id: Uint8Array, file_path: Uint8Array): Message
    /**
     ...
     * @param application_id the 'ApplicationId' field, given as an array of #guint8 values.
     * @param file_path the 'FilePath' field, given as an array of #guint8 values.
     * @param read_offset the 'ReadOffset' field, given as a #guint32.
     * @param read_size the 'ReadSize' field, given as a #guint32.
     * @param local_pin the 'LocalPin' field, given as a string.
     * @param data the 'Data' field, given as an array of #guint8 values.
     * @returns a newly allocated #MbimMessage, which should be freed with mbim_message_unref().
     */
     ...
     * @param application_id the 'ApplicationId' field, given as an array of #guint8 values.
     * @param file_path the 'FilePath' field, given as an array of #guint8 values.
     * @param record_number the 'RecordNumber' field, given as a #guint32.
     * @param local_pin the 'LocalPin' field, given as a string.
     * @param data the 'Data' field, given as an array of #guint8 values.
     * @returns a newly allocated #MbimMessage, which should be freed with mbim_message_unref().
     */

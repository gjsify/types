// The widget vocabulary of CoglGst-2.0 as runtime data.
//
// GENERATED — do not edit. Provenance: CoglGst-2.0 — inlined base(s) their owner's vocabulary does not emit: GstBase.BaseSink
//
...
export const OWN_SIGNALS = {
    CoglGstVideoSink: ['new-frame', 'pipeline-ready'],
};
...
export const DECLS = {
    CoglGstVideoSink: ['CoglGstVideoSink', 'GstBaseSink', 'GstElement', 'GstObject', 'GInitiallyUnowned', 'GObject'],
};
...
export const PROP_TYPES = {
    'CoglGstVideoSink.update-priority': 'gint',
...
export const SINCE = {
    'CoglGstVideoSink': '1.16',
    'CoglGstVideoSink::new-frame': '1.16',
    'CoglGstVideoSink::pipeline-ready': '1.16',

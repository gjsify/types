...
export namespace CoglGst {
    ...
    class VideoSink extends GstBase.BaseSink {
        // Own properties of CoglGst-2.0.VideoSink

        update_priority: number;
        updatePriority: number;

        // Constructors of CoglGst-2.0.VideoSink

        static ['new'](ctx: Cogl.Context): VideoSink;

        // Owm methods of CoglGst-2.0.VideoSink
         ...
         */
        fit_size(available: Rectangle, output: Rectangle): void;
        /**
     ...
     */
    class Rectangle {
        // Own fields of CoglGst-2.0.Rectangle
        ...
        // Constructors of CoglGst-2.0.Rectangle

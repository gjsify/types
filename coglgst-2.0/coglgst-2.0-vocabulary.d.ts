/**
 * The GIR-derived widget VOCABULARY for CoglGst-2.0.
 *
...
export interface CoglGstVideoSinkProps extends GstBaseSinkProps {
    'update-priority'?: number;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type CoglGstVideoSinkConstructOnly = GstBaseSinkConstructOnly;

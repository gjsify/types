/**
 * The GIR-derived widget VOCABULARY for FcitxG-1.0.
 *
...
import type FcitxG from './fcitxg-1.0.js';
...
export interface FcitxGClientProps extends GObjectProps {
    watcher?: FcitxG.Watcher;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type FcitxGClientConstructOnly = GObjectConstructOnly | 'watcher';

/** A FcitxGWatcher allow to create a input context via DBus */
export interface FcitxGWatcherProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type FcitxGWatcherConstructOnly = GObjectConstructOnly;

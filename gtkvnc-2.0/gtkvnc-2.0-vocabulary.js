...
export const ENUM_VALUES = {
    'VncDisplayCredential.ca-cert-data': 3,
    'VncDisplayCredential.clientname': 2,
    'VncDisplayCredential.password': 0,
    'VncDisplayCredential.username': 1,
    'VncDisplayDepthColor.default': 0,
    'VncDisplayDepthColor.full': 1,
    'VncDisplayDepthColor.low': 3,
    'VncDisplayDepthColor.medium': 2,
    'VncDisplayDepthColor.ultra-low': 4,
    'VncDisplayKeyEvent.click': 3,
    'VncDisplayKeyEvent.press': 1,
    'VncDisplayKeyEvent.release': 2,
};
...
export const PROP_ENUMS = {
    'VncDisplay.depth': 'VncDisplayDepthColor',
};
...
export const PROP_TYPES = {
    'VncCairoFramebuffer.surface': 'gpointer',
    'VncDisplay.allow-resize': 'gboolean',
    'VncDisplay.depth': 'VncDisplayDepthColor',
    'VncDisplay.force-size': 'gboolean',
    'VncDisplay.grab-keyboard': 'gboolean',
    'VncDisplay.grab-pointer': 'gboolean',
    'VncDisplay.keep-aspect-ratio': 'gboolean',
    'VncDisplay.local-pointer': 'gboolean',
    'VncDisplay.lossy-encoding': 'gboolean',
    'VncDisplay.read-only': 'gboolean',
    'VncDisplay.rotation': 'guint',
    'VncDisplay.scaling': 'gboolean',
    'VncDisplay.shared-flag': 'gboolean',
    'VncDisplay.smoothing': 'gboolean',
    'VncDisplay.zoom-level': 'guint',
};

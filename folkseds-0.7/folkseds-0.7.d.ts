...
export namespace FolksEds {
    ...
    class PersonaStore extends Folks.PersonaStore {
        // Own properties of FolksEds-0.7.PersonaStore

        source: EDataServer.Source;

        // Constructors of FolksEds-0.7.PersonaStore
        ...
        // Owm methods of FolksEds-0.7.PersonaStore
    ...
    class Persona extends Folks.Persona {
        // Own properties of FolksEds-0.7.Persona
        ...
        // Constructors of FolksEds-0.7.Persona

        static ['new'](store: PersonaStore, contact: EBookContacts.Contact): Persona;

        // Owm methods of FolksEds-0.7.Persona

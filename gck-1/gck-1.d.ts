 ...
 */
function uri_build(uri_data: UriData, flags: UriFlags): string | null
 ...
 */
function uri_parse(string: string | null, flags: UriFlags): UriData
/**
...
interface Enumerator {
     ...
     * @param max_objects The maximum number of objects to get
     * @param cancellable A #GCancellable or %NULL
     * @returns A Promise of: The list of objects, which should be freed with gck_list_unref_free()
     */
...
module Module {
     ...
     */
    interface AuthenticateObjectSignalCallback {
        ($obj: Module, object: Object, label: string | null, password: any | null): boolean
    }

    /**
     * Signal callback interface for `authenticate-slot`
     */
    interface AuthenticateSlotSignalCallback {
        ($obj: Module, slot: Slot, string: string | null, password: any | null): boolean
    }
...
interface Module {
    ...
    connect_after(sigName: "authenticate-object", callback: Module.AuthenticateObjectSignalCallback): number
    emit(sigName: "authenticate-object", object: Object, label: string | null, password: any | null, ...args: any[]): void
    connect(sigName: "authenticate-slot", callback: Module.AuthenticateSlotSignalCallback): number
    connect_after(sigName: "authenticate-slot", callback: Module.AuthenticateSlotSignalCallback): number
    emit(sigName: "authenticate-slot", slot: Slot, string: string | null, password: any | null, ...args: any[]): void

...
_init(...args: any[]): void;
    ...
    connect(signal: 'authenticate-object', callback: ((_source: this, object: Object, label: string, password: any | null) => boolean)): number
    connect_after(signal: 'authenticate-object', callback: ((_source: this, object: Object, label: string, password: any | null) => boolean)): number
    emit(signal: 'authenticate-object', object: Object, label: string, password?: (any | null)): void
    connect(signal: 'authenticate-slot', callback: ((_source: this, slot: Slot, string: string, password: any | null) => boolean)): number
    connect_after(signal: 'authenticate-slot', callback: ((_source: this, slot: Slot, string: string, password: any | null) => boolean)): number

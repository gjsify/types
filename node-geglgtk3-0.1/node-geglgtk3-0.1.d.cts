...
import './node-geglgtk3-0.1-import.d.ts';
...
import type Gegl from '@girs/node-gegl-0.4';
...
export interface View extends Atk.ImplementorIface, Gtk.Buildable {
    ...
    on(sigName: "draw-background", callback: View.DrawBackgroundSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "draw-background", callback: View.DrawBackgroundSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "draw-background", callback: View.DrawBackgroundSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "draw-overlay", callback: View.DrawOverlaySignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "draw-overlay", callback: View.DrawOverlaySignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "draw-overlay", callback: View.DrawOverlaySignalCallback): NodeJS.EventEmitter
    emit(sigName: "draw-overlay", rect: Gdk.Rectangle, ...args: any[]): void

    // Class property signals of GeglGtk3-0.1.GeglGtk3.View

    connect(sigName: "notify::autoscale-policy", callback: (...args: any[]) => void): number
    on(sigName: "notify::autoscale-policy", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::autoscale-policy", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter

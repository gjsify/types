...
export namespace EDataCal {
    ...
    class CalBackend extends EBackend.Backend {
        // Own properties of EDataCal-2.0.CalBackend
        ...
        // Owm methods of EDataCal-2.0.CalBackend
    ...
    class CalBackendSExp extends GObject.Object {
        // Constructors of EDataCal-2.0.CalBackendSExp

        static ['new'](text: string): CalBackendSExp;

        // Owm methods of EDataCal-2.0.CalBackendSExp
    ...
    class CalBackendSync extends CalBackend {
        // Owm methods of EDataCal-2.0.CalBackendSync
         ...
         */
        get_object(cal: DataCal, cancellable: Gio.Cancellable | null, uid: string, rid: string | null): void;
        /**
         ...
         */
        get_object_list(cal: DataCal, cancellable: Gio.Cancellable | null, sexp: string): void;
        /**
    ...
    class CalCache extends EBackend.Cache {
        // Constructors of EDataCal-2.0.CalCache

        static ['new'](filename: string, cancellable?: Gio.Cancellable | null): CalCache;

        // Owm methods of EDataCal-2.0.CalCache
         ...
         * @returns Whether succeeded.
         */
        dup_timezone_as_string(tzid: string, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        get_component(uid: string, rid: string | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
         * Gets a component identified by `uid,` and optionally by the `rid,`
         ...
         * @returns Whether succeeded.
         */
        get_component_as_string(uid: string, rid: string | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        get_component_custom_flags(uid: string, rid: string | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        get_component_extra(uid: string, rid: string | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        get_components_by_uid(uid: string, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        get_components_by_uid_as_string(uid: string, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        get_components_in_range(range_start: number, range_end: number, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        get_ids_with_extra(extra: string, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        get_timezone(tzid: string, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        list_timezones(cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        search(sexp: string | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
         * Searches the `cal_cache` with the given `sexp` and
         * returns those components which satisfy the search
         ...
         * @returns Whether succeeded.
         */
        search_components(sexp: string | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        search_ids(sexp: string | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
     ...
     * the functions below.
     */
    abstract class CalMetaBackend extends CalBackendSync {
        // Own properties of EDataCal-2.0.CalMetaBackend
        ...
        // Owm methods of EDataCal-2.0.CalMetaBackend
         ...
         * @returns Whether succeeded.
         */
        load_component_sync(uid: string, extra: string | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        search_components_sync(expr: string | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
         * Searches `meta_backend` with given expression `expr` and returns
         ...
         * @returns Whether succeeded.
         */
        search_sync(expr: string | null, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns Whether succeeded.
         */
        split_changes_sync(objects: CalMetaBackendInfo[], cancellable?: Gio.Cancellable | null): boolean;
        /**
    ...
    class DataCal extends GObject.Object {
        // Own properties of EDataCal-2.0.DataCal
    ...
    class DataCalFactory extends EBackend.DataFactory {
        // Constructors of EDataCal-2.0.DataCalFactory
    ...
    class DataCalView extends GObject.Object {
        // Own properties of EDataCal-2.0.DataCalView
        ...
        // Constructors of EDataCal-2.0.DataCalView
        ...
        // Owm methods of EDataCal-2.0.DataCalView
    ...
    class IntervalTree extends GObject.Object {
        // Constructors of EDataCal-2.0.IntervalTree

        static ['new'](): IntervalTree;

        // Owm methods of EDataCal-2.0.IntervalTree
    ...
    class SubprocessCalFactory extends EBackend.SubprocessFactory {
        // Constructors of EDataCal-2.0.SubprocessCalFactory
     ...
     * a calendar backend.
     */
    class CalBackendClass {
        // Own fields of EDataCal-2.0.CalBackendClass
     ...
     */
    class CalBackendFactoryClass {
        // Own fields of EDataCal-2.0.CalBackendFactoryClass
     ...
     */
    class CalBackendSyncClass {
        // Own fields of EDataCal-2.0.CalBackendSyncClass
    ...
    class CalCacheOfflineChange {
        // Own fields of EDataCal-2.0.CalCacheOfflineChange
        ...
        // Constructors of EDataCal-2.0.CalCacheOfflineChange
        ...
        // Owm methods of EDataCal-2.0.CalCacheOfflineChange
    ...
    class CalCacheSearchData {
        // Own fields of EDataCal-2.0.CalCacheSearchData
        ...
        // Constructors of EDataCal-2.0.CalCacheSearchData
        ...
        // Owm methods of EDataCal-2.0.CalCacheSearchData
    ...
    class CalMetaBackendInfo {
        // Own fields of EDataCal-2.0.CalMetaBackendInfo
        ...
        // Constructors of EDataCal-2.0.CalMetaBackendInfo
        ...
        // Owm methods of EDataCal-2.0.CalMetaBackendInfo
    ...
    class DataCalFactoryClass {}

    class DataCalFactoryPrivate {}

    class DataCalPrivate {}

    class DataCalViewClass {}
     ...
     */
    class IntervalTreeClass {}

    class IntervalTreePrivate {}

    class SubprocessCalFactoryClass {}

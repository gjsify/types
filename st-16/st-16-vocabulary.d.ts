/**
 * The GIR-derived widget VOCABULARY for St-16.
 *
 * GENERATED — do not edit. Provenance: St-16 — dropped empty base(s): Atk.ImplementorIface
 *
 * 28 instantiable GTypes (of which 0 concrete widgets), 29 declarations, 12 enum nick unions, 0 slot candidates.
 *
...
import type { ClutterActorAccessibleConstructOnly, ClutterActorAccessibleProps, ClutterActorConstructOnly, ClutterActorMetaConstructOnly, ClutterActorMetaProps, ClutterActorProps, ClutterAnimatableConstructOnly, ClutterAnimatableProps, ClutterContentConstructOnly, ClutterContentProps, ClutterEffectConstructOnly, ClutterEffectProps, ClutterInputContentPurposeNick, ClutterOffscreenEffectConstructOnly, ClutterOffscreenEffectProps, ClutterOrientationNick, ClutterShaderEffectConstructOnly, ClutterShaderEffectProps } from '@girs/clutter-16/vocabulary';

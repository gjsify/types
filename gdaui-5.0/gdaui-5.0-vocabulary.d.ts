...
export interface GdauiDataProxyProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GdauiDataProxyConstructOnly = GObjectConstructOnly;

...
export namespace Gdaui {
    ...
    class DataEntryError extends GLib.Error {
        // Own fields of Gdaui-5.0.DataEntryError

        FILE_NOT_FOUND_ERROR: number;
        INVALID_DATA_ERROR: number;

        // Constructors of Gdaui-5.0.DataEntryError
    ...
    class BasicForm extends Gtk.Box {
        // Own properties of Gdaui-5.0.BasicForm
        ...
        // Own fields of Gdaui-5.0.BasicForm

        object: Gtk.Box;

        // Constructors of Gdaui-5.0.BasicForm
        ...
        // Owm methods of Gdaui-5.0.BasicForm
    ...
    class Cloud extends Gtk.Box {
        // Own properties of Gdaui-5.0.Cloud
        ...
        // Own fields of Gdaui-5.0.Cloud

        object: Gtk.Box;

        // Constructors of Gdaui-5.0.Cloud

        static ['new'](model: Gda.DataModel, label_column: number, weight_column: number): Cloud;

        // Owm methods of Gdaui-5.0.Cloud
    ...
    class Combo extends Gtk.ComboBox {
        // Own properties of Gdaui-5.0.Combo

        as_list: boolean;
        asList: boolean;
        model: Gda.DataModel;

        // Own fields of Gdaui-5.0.Combo

        object: Gtk.ComboBox;

        // Constructors of Gdaui-5.0.Combo

        static ['new'](): Combo;

        static new_with_model(model: Gda.DataModel, n_cols: number, cols_index: number): Combo;

        // Owm methods of Gdaui-5.0.Combo
    ...
    class DataCellRendererBin extends Gtk.CellRendererPixbuf {
        // Own properties of Gdaui-5.0.DataCellRendererBin
        ...
        // Constructors of Gdaui-5.0.DataCellRendererBin
    ...
    class DataCellRendererBoolean extends Gtk.CellRendererToggle {
        // Own properties of Gdaui-5.0.DataCellRendererBoolean
        ...
        // Constructors of Gdaui-5.0.DataCellRendererBoolean
    ...
    class DataCellRendererCombo extends Gtk.CellRendererText {
        // Own properties of Gdaui-5.0.DataCellRendererCombo
        ...
        // Constructors of Gdaui-5.0.DataCellRendererCombo
    ...
    class DataCellRendererInfo extends Gtk.CellRenderer {
        // Own properties of Gdaui-5.0.DataCellRendererInfo
        ...
        // Constructors of Gdaui-5.0.DataCellRendererInfo
    ...
    class DataCellRendererTextual extends Gtk.CellRendererText {
        // Own properties of Gdaui-5.0.DataCellRendererTextual
        ...
        // Constructors of Gdaui-5.0.DataCellRendererTextual
    ...
    class DataFilter extends Gtk.Box {
        // Own properties of Gdaui-5.0.DataFilter

        data_widget: DataProxy;
        dataWidget: DataProxy;

        // Own fields of Gdaui-5.0.DataFilter

        object: Gtk.Box;

        // Constructors of Gdaui-5.0.DataFilter
    ...
    class DataProxyInfo extends Gtk.Box {
        // Own properties of Gdaui-5.0.DataProxyInfo
        ...
        // Own fields of Gdaui-5.0.DataProxyInfo

        object: Gtk.Box;

        // Constructors of Gdaui-5.0.DataProxyInfo
    ...
    class DataStore extends GObject.Object {
        // Own properties of Gdaui-5.0.DataStore
        ...
        // Own fields of Gdaui-5.0.DataStore

        object: GObject.Object;

        // Owm methods of Gdaui-5.0.DataStore
    ...
    class Entry extends Gtk.Entry {
        // Own properties of Gdaui-5.0.Entry

        prefix: string;
        suffix: string;

        // Own fields of Gdaui-5.0.Entry

        entry: Gtk.Entry;

        // Constructors of Gdaui-5.0.Entry

        static ['new'](prefix?: string | null, suffix?: string | null): Entry;

        // Owm methods of Gdaui-5.0.Entry
    ...
    class EntryBin extends EntryWrapper {
        // Own fields of Gdaui-5.0.EntryBin

        object: EntryWrapper;

        // Constructors of Gdaui-5.0.EntryBin
    ...
    class EntryBoolean extends EntryWrapper {
        // Own fields of Gdaui-5.0.EntryBoolean

        object: EntryWrapper;

        // Constructors of Gdaui-5.0.EntryBoolean
    ...
    class EntryCombo extends EntryShell {
        // Own properties of Gdaui-5.0.EntryCombo

        set_default_if_invalid: boolean;
        setDefaultIfInvalid: boolean;

        // Own fields of Gdaui-5.0.EntryCombo

        object: EntryShell;

        // Constructors of Gdaui-5.0.EntryCombo

        static ['new'](paramlist: Set, source: SetSource): EntryCombo;

        // Owm methods of Gdaui-5.0.EntryCombo
    ...
    class EntryCommonTime extends EntryWrapper {
        // Own properties of Gdaui-5.0.EntryCommonTime

        editing_canceled: boolean;
        editingCanceled: boolean;
        type: number;

        // Own fields of Gdaui-5.0.EntryCommonTime
    ...
    class EntryDate extends EntryCommonTime {
        // Own fields of Gdaui-5.0.EntryDate

        object: EntryCommonTime;

        // Constructors of Gdaui-5.0.EntryDate
    ...
    class EntryNone extends EntryWrapper {
        // Own fields of Gdaui-5.0.EntryNone

        object: EntryWrapper;

        // Constructors of Gdaui-5.0.EntryNone
    ...
    class EntryNumber extends EntryWrapper {
        // Own properties of Gdaui-5.0.EntryNumber

        editing_canceled: boolean;
        editingCanceled: boolean;
        options: string;

        // Own fields of Gdaui-5.0.EntryNumber

        object: EntryWrapper;

        // Constructors of Gdaui-5.0.EntryNumber

        static ['new'](dh: Gda.DataHandler, type: GObject.GType, options: string): EntryNumber;

        // Owm methods of Gdaui-5.0.EntryNumber
    ...
    class EntryShell extends Gtk.Viewport {
        // Own properties of Gdaui-5.0.EntryShell
        ...
        // Own fields of Gdaui-5.0.EntryShell

        object: Gtk.Viewport;

        // Owm methods of Gdaui-5.0.EntryShell
    ...
    class EntryString extends EntryWrapper {
        // Own properties of Gdaui-5.0.EntryString
        ...
        // Own fields of Gdaui-5.0.EntryString

        object: EntryWrapper;

        // Constructors of Gdaui-5.0.EntryString
    ...
    class EntryTime extends EntryCommonTime {
        // Own fields of Gdaui-5.0.EntryTime

        object: EntryCommonTime;

        // Constructors of Gdaui-5.0.EntryTime
    ...
    class EntryTimestamp extends EntryCommonTime {
        // Own fields of Gdaui-5.0.EntryTimestamp

        object: EntryCommonTime;

        // Constructors of Gdaui-5.0.EntryTimestamp
    ...
    class EntryWrapper extends EntryShell {
        // Own properties of Gdaui-5.0.EntryWrapper

        set_default_if_invalid: boolean;
        setDefaultIfInvalid: boolean;

        // Own fields of Gdaui-5.0.EntryWrapper

        object: EntryShell;

        // Owm methods of Gdaui-5.0.EntryWrapper
    ...
    class Form extends Gtk.Box {
        // Own properties of Gdaui-5.0.Form
        ...
        // Own fields of Gdaui-5.0.Form

        object: Gtk.Box;

        // Constructors of Gdaui-5.0.Form
    ...
    class FormattedEntry extends Entry {
        // Own properties of Gdaui-5.0.FormattedEntry

        format: string;
        mask: string;

        // Own fields of Gdaui-5.0.FormattedEntry

        entry: Entry;

        // Constructors of Gdaui-5.0.FormattedEntry

        static ['new'](format: string, mask?: string | null): FormattedEntry;

        // Owm methods of Gdaui-5.0.FormattedEntry
    ...
    class Grid extends Gtk.Box {
        // Own properties of Gdaui-5.0.Grid
        ...
        // Own fields of Gdaui-5.0.Grid

        object: Gtk.Box;

        // Constructors of Gdaui-5.0.Grid

        static ['new'](model?: Gda.DataModel | null): Grid;

        // Owm methods of Gdaui-5.0.Grid
    ...
    class Login extends Gtk.Box {
        // Own properties of Gdaui-5.0.Login

        dsn: string;
        readonly valid: boolean;

        // Constructors of Gdaui-5.0.Login

        static ['new'](dsn?: string | null): Login;

        // Owm methods of Gdaui-5.0.Login
    ...
    class NumericEntry extends Entry {
        // Own properties of Gdaui-5.0.NumericEntry
        ...
        // Own fields of Gdaui-5.0.NumericEntry

        entry: Entry;

        // Constructors of Gdaui-5.0.NumericEntry

        static ['new'](type: GObject.GType): NumericEntry;

        // Owm methods of Gdaui-5.0.NumericEntry
    ...
    class ProviderSelector extends Combo {
        // Constructors of Gdaui-5.0.ProviderSelector

        static ['new'](): ProviderSelector;

        // Owm methods of Gdaui-5.0.ProviderSelector
    ...
    class RawForm extends BasicForm {
        // Own properties of Gdaui-5.0.RawForm

        model: Gda.DataModel;

        // Own fields of Gdaui-5.0.RawForm

        object: BasicForm;

        // Constructors of Gdaui-5.0.RawForm
    ...
    class RawGrid extends Gtk.TreeView {
        // Own properties of Gdaui-5.0.RawGrid
        ...
        // Own fields of Gdaui-5.0.RawGrid

        object: Gtk.TreeView;

        // Constructors of Gdaui-5.0.RawGrid

        static ['new'](model: Gda.DataModel): RawGrid;

        // Owm methods of Gdaui-5.0.RawGrid
    ...
    class RtEditor extends Gtk.Box {
        // Own properties of Gdaui-5.0.RtEditor
        ...
        // Own fields of Gdaui-5.0.RtEditor

        object: Gtk.Box;

        // Constructors of Gdaui-5.0.RtEditor

        static ['new'](): RtEditor;

        // Owm methods of Gdaui-5.0.RtEditor
    ...
    class ServerOperation extends Gtk.Box {
        // Own properties of Gdaui-5.0.ServerOperation
        ...
        // Own fields of Gdaui-5.0.ServerOperation

        object: Gtk.Box;

        // Constructors of Gdaui-5.0.ServerOperation
    ...
    class Set extends GObject.Object {
        // Own properties of Gdaui-5.0.Set

        set: Gda.Set;

        // Own fields of Gdaui-5.0.Set

        object: GObject.Object;

        // Constructors of Gdaui-5.0.Set

        static ['new'](set: Gda.Set): Set;

        // Owm methods of Gdaui-5.0.Set
    ...
    class TreeStore extends GObject.Object {
        // Own properties of Gdaui-5.0.TreeStore

        tree: Gda.Tree;

        // Own fields of Gdaui-5.0.TreeStore

        object: GObject.Object;

        // Owm methods of Gdaui-5.0.TreeStore
     ...
     */
    class Plugin {
        // Own fields of Gdaui-5.0.Plugin
        ...
        // Owm methods of Gdaui-5.0.Plugin
     ...
     */
    class SetSource {
        // Own fields of Gdaui-5.0.SetSource
    ...
    interface DataEntry {
        // Owm methods of Gdaui-5.0.DataEntry
        ...
        // Own virtual methods of Gdaui-5.0.DataEntry
    ...
    interface DataProxy {
        // Owm methods of Gdaui-5.0.DataProxy
        ...
        // Own virtual methods of Gdaui-5.0.DataProxy
    ...
    interface DataSelector {
        // Owm methods of Gdaui-5.0.DataSelector
        ...
        // Own virtual methods of Gdaui-5.0.DataSelector

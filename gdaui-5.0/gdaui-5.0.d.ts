...
export namespace Gdaui {
    ...
    namespace DataCellRendererInfo {
        ...
        interface SignalSignatures extends Gtk.CellRenderer.SignalSignatures {
             ...
             * @run-last
             */
            "status-changed": (object: string, p0: unknown) => void;
            "notify::editable": (pspec: GObject.ParamSpec) => void;
    ...
    namespace EntryBin {
        // Signal signatures
        interface SignalSignatures extends EntryWrapper.SignalSignatures, DataEntry.SignalSignatures {
            "notify::set-default-if-invalid": (pspec: GObject.ParamSpec) => void;
    ...
    class EntryBin extends EntryWrapper implements Atk.ImplementorIface, DataEntry, Gtk.Buildable, Gtk.Scrollable {
         ...
         * @since 4.2
         * @deprecated since 5.2: use the GtkWidget::hexpand, GtkWidget::wexpand or GtkWidget::expand properties
         */
    ...
    namespace EntryCombo {
        // Signal signatures
        interface SignalSignatures extends EntryShell.SignalSignatures, DataEntry.SignalSignatures {
            "notify::set-default-if-invalid": (pspec: GObject.ParamSpec) => void;
            "notify::actions": (pspec: GObject.ParamSpec) => void;
            "notify::handler": (pspec: GObject.ParamSpec) => void;
            "notify::is-cell-renderer": (pspec: GObject.ParamSpec) => void;
    ...
    namespace EntryCommonTime {
        // Signal signatures
        interface SignalSignatures extends EntryWrapper.SignalSignatures, DataEntry.SignalSignatures, Gtk.CellEditable.SignalSignatures {
            "notify::editing-canceled": (pspec: GObject.ParamSpec) => void;
            "notify::type": (pspec: GObject.ParamSpec) => void;
            "notify::set-default-if-invalid": (pspec: GObject.ParamSpec) => void;
            "notify::actions": (pspec: GObject.ParamSpec) => void;
    ...
    class EntryShell extends Gtk.Viewport implements Atk.ImplementorIface, Gtk.Buildable, Gtk.Scrollable {
        ...
        /** @signal */
        emit<K extends keyof EntryShell.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<EntryShell.SignalSignatures[K]>): void;
    ...
    class EntryWrapper extends EntryShell implements Atk.ImplementorIface, DataEntry, Gtk.Buildable, Gtk.Scrollable {
        ...
        /** @signal */
        emit<K extends keyof EntryWrapper.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<EntryWrapper.SignalSignatures[K]>): void;
    ...
    namespace Set {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
             ...
             * @run-first
             */
            "source-model-changed": (object: null) => void;
    ...
    namespace DataEntry {
        ...
        interface SignalSignatures {
             ...
             * @run-last
             */
            "contents-valid": (error: null) => boolean | void;
            /**
             * @signal
             * @run-first
             */

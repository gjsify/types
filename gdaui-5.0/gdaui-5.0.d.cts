...
export interface DataEntry extends Gtk.Widget {
    ...
    emit(sigName: "contents-valid", error: any | null, ...args: any[]): void
...
export interface DataCellRendererInfo {
    ...
    emit(sigName: "status-changed", object: string | null, p0: any, ...args: any[]): void
...
export interface ProviderSelector extends Atk.ImplementorIface, DataSelector, Gtk.Buildable, Gtk.CellEditable, Gtk.CellLayout {
    ...
    model: any
    parent_instance: GObject.InitiallyUnowned & Gtk.Bin
...
export interface Set {
    ...
    emit(sigName: "source-model-changed", object: any | null, ...args: any[]): void

...
export namespace Rest {
    ...
    class OAuth2Error extends GLib.Error {
        // Own fields of Rest-1.0.OAuth2Error

        NO_REFRESH_TOKEN: number;
        ACCESS_TOKEN_EXPIRED: number;

        // Constructors of Rest-1.0.OAuth2Error
    ...
    class ProxyCallError extends GLib.Error {
        // Own fields of Rest-1.0.ProxyCallError
        ...
        // Constructors of Rest-1.0.ProxyCallError

        constructor(options: { message: string; code: number });

        // Owm methods of Rest-1.0.ProxyCallError
    ...
    class ProxyError extends GLib.Error {
        // Own fields of Rest-1.0.ProxyError
        ...
        // Constructors of Rest-1.0.ProxyError

        constructor(options: { message: string; code: number });

        // Owm methods of Rest-1.0.ProxyError
    ...
    class OAuth2Proxy extends Proxy {
        // Own properties of Rest-1.0.OAuth2Proxy
        ...
        // Constructors of Rest-1.0.OAuth2Proxy
        ...
        // Owm methods of Rest-1.0.OAuth2Proxy

        build_authorization_url(code_challenge: string, scope: string | null): string;
    ...
    class Proxy extends GObject.Object {
        // Own properties of Rest-1.0.Proxy
        ...
        // Constructors of Rest-1.0.Proxy
    ...
    class ProxyAuth extends GObject.Object {
        // Owm methods of Rest-1.0.ProxyAuth
    ...
    class ProxyCall extends GObject.Object {
        // Own properties of Rest-1.0.ProxyCall

        proxy: Proxy;

        // Owm methods of Rest-1.0.ProxyCall
    ...
    class XmlParser extends GObject.Object {
        // Constructors of Rest-1.0.XmlParser

        static ['new'](): XmlParser;

        // Owm methods of Rest-1.0.XmlParser
    ...
    class OAuth2ProxyClass {
        // Own fields of Rest-1.0.OAuth2ProxyClass

        padding: any[];
    }

    class Param {
        // Constructors of Rest-1.0.Param
    ...
    class Params {
        // Constructors of Rest-1.0.Params

        constructor(properties?: Partial<{}>);

        static ['new'](): Params;

        // Owm methods of Rest-1.0.Params
    ...
    class ParamsIter {
        // Owm methods of Rest-1.0.ParamsIter
    ...
    class PkceCodeChallenge {
        // Constructors of Rest-1.0.PkceCodeChallenge

        constructor(properties?: Partial<{}>);

        static new_random(): PkceCodeChallenge;

        // Owm methods of Rest-1.0.PkceCodeChallenge
     ...
     */
    class XmlNode {
        // Own fields of Rest-1.0.XmlNode

        name: string;
        content: string;

        // Owm methods of Rest-1.0.XmlNode

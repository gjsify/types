...
import './node-gitg-1.0-import.d.ts';
...
export module RepositoryListBoxRow {
     ...
     */
    export interface RequestDeleteSourceSignalCallback {
        (): void
    }
...
export class TextConv {
    ...
    static getTextconvContent(repository: Repository, file: Ggit.DiffFile): number[]
    static getTextconvContentFromRaw(repository: Repository, file: Ggit.DiffFile, rawContent: number[] | null): number[]
}
...
export interface GPGUtilsClass {
}

export abstract class GPGUtilsClass {
...
export interface GPGUtilsPrivate {
}

export class GPGUtilsPrivate {

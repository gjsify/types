...
export namespace Mx {
     ...
     * function for actors that implement the {@link Mx.Focusable} interface, to
     * pass the correct {@link Mx.FocusHint} to their children when calling
     * `mx_focusable_accept_focus()`.
     * 
     * {@link Mx.FocusDirection.UP} maps to {@link Mx.FocusHint.FROM_BELOW},
     * {@link Mx.FocusDirection.DOWN} maps to {@link Mx.FocusHint.FROM_ABOVE},
     * {@link Mx.FocusDirection.LEFT} maps to {@link Mx.FocusHint.FROM_RIGHT},
     * {@link Mx.FocusDirection.RIGHT} maps to {@link Mx.FocusHint.FROM_LEFT},
     * {@link Mx.FocusDirection.NEXT} maps to {@link Mx.FocusHint.FIRST},
     * {@link Mx.FocusDirection.PREVIOUS} maps to {@link Mx.FocusHint.LAST} and
     * anything else maps to {@link Mx.FocusHint.PRIOR}.
     * @param direction A {@link Mx.FocusDirection}
     * @returns A {@link Mx.FocusHint}
     * @since 1.2
     */
    ...
    class ActorManager extends GObject.Object {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof ActorManager.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, ActorManager.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof ActorManager.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, ActorManager.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof ActorManager.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<ActorManager.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;

        // Static methods
        /**
         * Get the MxActorManager associated with a stage, or creates one if this is the
         * first call to the function with the given {@link Clutter.Stage}.
         * 
         ...
         * @virtual
         */
        vfunc_actor_added(id: number, container: Clutter.Container, actor: Clutter.Actor): void;
         ...
         * @virtual
         */
        vfunc_actor_removed(id: number, container: Clutter.Container, actor: Clutter.Actor): void;
         ...
         * 
         * On successful completion, the {@link Mx.ActorManager.SignalSignatures.actor_added | Mx.ActorManager::actor_added} signal will
         * be fired.
         * @param container A {@link Clutter.Container}
         ...
         * 
         * On successful completion, the {@link Mx.ActorManager.SignalSignatures.actor_removed | Mx.ActorManager::actor_removed} signal will
         * be fired.
         * 
         * <note><para>
    ...
    namespace Adjustment {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
            ...
            "notify::elastic": (pspec: GObject.ParamSpec) => void;
     ...
     * the {@link Mx.Adjustment} are private and should be accessed using the
     * public API.
     * @gir-type Class
     */
    class Adjustment extends GObject.Object {
        ...
        /**
         * Get the value of the {@link Mx.Adjustment.elastic} property.
         * @returns the current value of the "elastic" property.
         */
        get_elastic(): boolean;

        /**
         * Get the value of the {@link Mx.Adjustment.lower} property.
        ...
        /**
         * Get the value of the {@link Mx.Adjustment.page_size} property.
        ...
        /**
         * Get the value of the {@link Mx.Adjustment.upper} property.
         * @returns the current value of the "upper" property.
         */
        get_upper(): number;

        /**
         * Get the current value of the {@link Mx.Adjustment.value} property
         ...
         */
        get_values(value: number, lower: number, upper: number, step_increment: number, page_increment: number, page_size: number): void;

        /**
         * Interpolate {@link Mx.Adjustment.value} to the new value specified by `value`, using
        ...
        /**
         * Set the value of the {@link Mx.Adjustment.elastic} property.
         * @param elastic A `gboolean`
         */
        set_elastic(elastic: boolean): void;

        /**
         * Set the value of the {@link Mx.Adjustment.lower} property.
         * @param lower A `gdouble`
         */
        set_lower(lower: number): void;

        /**
         * Set the value of the {@link Mx.Adjustment.page_increment} property.
         * @param increment A `gdouble`
         */
        set_page_increment(increment: number): void;

        /**
         * Set the {@link Mx.Adjustment.page_size} property.
         * @param page_size A `gdouble`
         */
        set_page_size(page_size: number): void;

        /**
         * Set the value of the {@link Mx.Adjustment.step_increment} property.
         * @param increment A `gdouble`
         */
        set_step_increment(increment: number): void;

        /**
         * Set the value of the {@link Mx.Adjustment.upper} property.
         * @param upper A `gdouble`
         */
        set_upper(upper: number): void;

        /**
         * Set the value of the {@link Mx.Adjustment.value} property.
         * @param value A `gdouble`
         */
    ...
    class Application extends GObject.Object {
         ...
         * @param action an {@link Mx.Action}
         */
         ...
         * @param window The {@link Mx.Window} to add to the application
         */
        add_window(window: Window): void;

        /**
         * Creates a window and associates it with the application.
         * @returns An {@link Mx.Window}.
         */
        create_window(): Window;

        /**
         * Retrieves all actions registered on `application`.
         * @returns a list of {@link Mx.Action}<!-- -->s. Use `g_list_free()` on the returned list when done.
         */
        get_actions(): Action[];
         ...
         * @returns a list of {@link Mx.Window}<!-- -->s. The returned list is owned by `application` and must not be altered.
         */
        get_windows(): Window[];
        ...
        /**
         * Query whether {@link Mx.Application} is running. This will also return `TRUE` if the
         * given {@link Mx.Application} is single instance and there is an instance already
         * running.
         ...
         * @param window an {@link Mx.Window}
         */
    ...
    namespace Bin {
        ...
        interface SignalSignatures extends Widget.SignalSignatures, Clutter.Container.SignalSignatures, Stylable.SignalSignatures {
            ...
            "notify::y-fill": (pspec: GObject.ParamSpec) => void;
            ...
            "notify::style-pseudo-class": (pspec: GObject.ParamSpec) => void;
        }
    ...
    /**
     * The {@link Mx.Bin} struct contains only private data
     * @gir-type Class
     */
    abstract class Bin extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Focusable, Stylable {
        static $gtype: GObject.GType<Bin>;

        // Properties
        /**
         * The child {@link Clutter.Actor} of the {@link Mx.Bin} container.
         */
    ...
    // This accessor conflicts with another accessor's type in a parent class or interface.
        ...
        // Methods
        /**
         * Allocates the child of an {@link Mx.Bin} using the width and height from `box`.
         * This function should usually only be called by subclasses of {@link Mx.Bin}.
         * 
         * This function can be used to allocate the child of an {@link Mx.Bin} if no special
         * allocation requirements are needed. It is similar to
         * `mx_allocate_align_fill`, except that it reads the alignment, padding and
         * fill values from the {@link Mx.Bin}, and will call `clutter_actor_allocate` on the
         * child.
         * @param box The allocation box of the parent actor.
         * @param flags {@link Clutter.AllocationFlags}, usually provided by the. clutter_actor_allocate function.
         */
         ...
         * inside a {@link Mx.Bin}, as set by `mx_bin_set_alignment()`.
         */
        ...
        /** @category Inherited from Mx.Stylable */
        get style(): Style;
        set style(val: Style);
        ...
        /**
         * Accept the focus
         * @param hint A {@link Mx.FocusHint}
        ...
        /**
         * Finds the {@link GObject.ParamSpec} installed by `stylable` for the property
         * with `property_name`.
         * @param property_name the name of the property to find
         * @returns a {@link GObject.ParamSpec} for the given property, or `null` if no property with that name was found
         */
        ...
        /**
         * Retrieves the {@link Mx.Style} used by `stylable`. This function does not
         * alter the reference count of the returned object.
         * @returns a {@link Mx.Style}
         */
        get_style(): Style;

        /**
         * Get the current style class name
         * @returns the class name string. The string is owned by the {@link Mx.Widget} and should not be modified or freed.
         */
         ...
         * names, separated by ':'.
         * @returns the pseudo class string. The string is owned by the {@link Mx.Widget} and should not be modified or freed.
         */
        get_style_pseudo_class(): string;

        /**
         * Retrieves all the {@link GObject.ParamSpec}<!-- -->s installed by `stylable`.
         * @returns an array of {@link GObject.ParamSpec}<!-- -->s. Free it with  `g_free()` when done.
         */
        list_properties(): GObject.ParamSpec[];

        /**
         * Sets `style` as the new {@link Mx.Style} to be used by `stylable`.
         * 
         * The {@link Mx.Stylable} will take ownership of the passed {@link Mx.Style}.
         * 
         * After the {@link Mx.Style} has been set, the MxStylable::style-set signal
         * will be emitted.
         ...
         * 
         * If `stylable` is a {@link Clutter.Container} then the "style-changed" notification is
    ...
    namespace BoxLayout {
        ...
        interface SignalSignatures extends Widget.SignalSignatures, Clutter.Container.SignalSignatures, Stylable.SignalSignatures {
            ...
            "notify::y-expand": (pspec: GObject.ParamSpec) => void;
            "notify::z-position": (pspec: GObject.ParamSpec) => void;
            "notify::horizontal-adjustment": (pspec: GObject.ParamSpec) => void;
            "notify::vertical-adjustment": (pspec: GObject.ParamSpec) => void;
            "notify::style": (pspec: GObject.ParamSpec) => void;
            "notify::style-class": (pspec: GObject.ParamSpec) => void;
            "notify::style-pseudo-class": (pspec: GObject.ParamSpec) => void;
        }
        ...
        // Constructor properties interface
        interface ConstructorProps extends Widget.ConstructorProps, Atk.ImplementorIface.ConstructorProps, Clutter.Animatable.ConstructorProps, Clutter.Container.ConstructorProps, Clutter.Scriptable.ConstructorProps, Focusable.ConstructorProps, Scrollable.ConstructorProps, Stylable.ConstructorProps {
     ...
     * @gir-type Class
     */
    class BoxLayout extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Focusable, Scrollable, Stylable {
         ...
         * @param actor the {@link Clutter.Actor} actor to add to the box layout
    ...
    // Conflicted with Clutter.Container.add_actor
        ...
        /**
         * Get the value of the {@link Mx.BoxLayoutChild.expand} property
        ...
        /**
         * Get the value of the {@link Mx.BoxLayoutChild.x_align} property
         * @param child A {@link Clutter.Actor}
        ...
        /**
         * Get the value of the {@link Mx.BoxLayoutChild.x_fill} property.
         * @param child A {@link Clutter.Actor}
        ...
        /**
         * Get the value of the {@link Mx.BoxLayoutChild.y_align} property.
         * @param child A {@link Clutter.Actor}
        ...
        /**
         * Get the value of the {@link Mx.BoxLayoutChild.y_fill} property
         * @param child A {@link Clutter.Actor}
        ...
        /**
         * Set the value of the {@link Mx.BoxLayoutChild.expand} property.
         * @param child A {@link Clutter.Actor}
        ...
        /**
         * Set the value of the {@link Mx.BoxLayoutChild.x_align} property.
         * @param child A {@link Clutter.Actor}
        ...
        /**
         * Set the value of the {@link Mx.BoxLayoutChild.x_fill} property.
         * @param child A {@link Clutter.Actor}
        ...
        /**
         * Set the value of the {@link Mx.BoxLayoutChild.y_align} property.
         * @param child A {@link Clutter.Actor}
        ...
        /**
         * Set the value of the {@link Mx.BoxLayoutChild.y_fill} property.
         * @param child A {@link Clutter.Actor}
        ...
        /**
         * Get the value of the {@link Mx.BoxLayout.enable_animations} property.
         * @returns `TRUE` if animations enabled
         */
        get_enable_animations(): boolean;

        /**
         * Get the value of the {@link Mx.BoxLayout.orientation} property.
        ...
        /** @category Inherited from Mx.Scrollable */
    ...
    namespace BoxLayoutChild {
        // Signal signatures
        interface SignalSignatures extends Clutter.ChildMeta.SignalSignatures {
    ...
    class BoxLayoutChild extends Clutter.ChildMeta {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof BoxLayoutChild.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, BoxLayoutChild.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof BoxLayoutChild.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, BoxLayoutChild.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof BoxLayoutChild.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<BoxLayoutChild.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
    }
    ...
    namespace Button {
        ...
        interface SignalSignatures extends Bin.SignalSignatures, Clutter.Container.SignalSignatures, Stylable.SignalSignatures {
            ...
            "notify::icon-position": (pspec: GObject.ParamSpec) => void;
            "notify::icon-size": (pspec: GObject.ParamSpec) => void;
            "notify::icon-visible": (pspec: GObject.ParamSpec) => void;
            "notify::is-toggle": (pspec: GObject.ParamSpec) => void;
            "notify::label": (pspec: GObject.ParamSpec) => void;
            "notify::label-visible": (pspec: GObject.ParamSpec) => void;
            "notify::toggled": (pspec: GObject.ParamSpec) => void;
            "notify::child": (pspec: GObject.ParamSpec) => void;
            "notify::x-align": (pspec: GObject.ParamSpec) => void;
            "notify::x-fill": (pspec: GObject.ParamSpec) => void;
            "notify::y-align": (pspec: GObject.ParamSpec) => void;
     ...
     * @gir-type Class
     */
    class Button extends Bin implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Focusable, Stylable {
    ...
    namespace ButtonGroup {
        // Signal signatures
        interface SignalSignatures extends GObject.InitiallyUnowned.SignalSignatures {
            "notify::active-button": (pspec: GObject.ParamSpec) => void;
            "notify::allow-no-active": (pspec: GObject.ParamSpec) => void;
        }
    ...
    class ButtonGroup extends GObject.InitiallyUnowned {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof ButtonGroup.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, ButtonGroup.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof ButtonGroup.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, ButtonGroup.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof ButtonGroup.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<ButtonGroup.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;

        // Methods
        /**
         * Add `button` to the {@link Mx.ButtonGroup}.
         * @param button A {@link Mx.Button}
         */
        add(button: Button): void;

        /**
         * Calls `callback` for each button in the group.
         * @param callback A {@link Clutter.Callback}
         */
        ...
        /**
         * Get the value of the {@link Mx.ButtonGroup.allow_no_active} property.
         ...
         * @returns a list of buttons. The list is owned by the {@link Mx.ButtonGroup} and should not be modified by the application.
         */
        get_buttons(): Button[];

        /**
         * Remove `button` from the {@link Mx.ButtonGroup}
         * @param button A {@link Mx.Button}
         */
         ...
         * have {@link Mx.Button.toggled} set to `FALSE`.
         * @param button A {@link Mx.Button}
         */
        set_active_button(button: Button): void;

        /**
         * Set the value of the {@link Mx.ButtonGroup.allow_no_active} property.
    ...
    class Clipboard extends GObject.Object {
        ...
        // Static methods
        /**
         * Get the global {@link Mx.Clipboard} object that represents the clipboard.
         */
     ...
     * @gir-type Class
     */
    class ComboBox extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Focusable, Stylable {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof ComboBox.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, ComboBox.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof ComboBox.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, ComboBox.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof ComboBox.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<ComboBox.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
    ...
    namespace DeformBowTie {
        // Signal signatures
        interface SignalSignatures extends DeformTexture.SignalSignatures, Clutter.Container.SignalSignatures, Stylable.SignalSignatures {
            "notify::flip-back": (pspec: GObject.ParamSpec) => void;
            "notify::period": (pspec: GObject.ParamSpec) => void;
            "notify::back": (pspec: GObject.ParamSpec) => void;
            "notify::front": (pspec: GObject.ParamSpec) => void;
            "notify::tiles-x": (pspec: GObject.ParamSpec) => void;
            "notify::tiles-y": (pspec: GObject.ParamSpec) => void;
            "notify::disabled": (pspec: GObject.ParamSpec) => void;
            "notify::menu": (pspec: GObject.ParamSpec) => void;
            "notify::tooltip-delay": (pspec: GObject.ParamSpec) => void;
            "notify::tooltip-text": (pspec: GObject.ParamSpec) => void;
        ...
        // Constructor properties interface
        interface ConstructorProps extends DeformTexture.ConstructorProps, Atk.ImplementorIface.ConstructorProps, Clutter.Animatable.ConstructorProps, Clutter.Container.ConstructorProps, Clutter.Scriptable.ConstructorProps, Stylable.ConstructorProps {
            flip_back: boolean;
            flipBack: boolean;
            period: number;
        }
     ...
     * @gir-type Class
     */
    class DeformBowTie extends DeformTexture implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Stylable {
        static $gtype: GObject.GType<DeformBowTie>;

        // Properties
        get flip_back(): boolean;
        set flip_back(val: boolean);

        get flipBack(): boolean;
        set flipBack(val: boolean);
         ...
         * @internal
         */
        $signals: DeformBowTie.SignalSignatures;

        // Constructors
        constructor(properties?: Partial<DeformBowTie.ConstructorProps>, ...args: any[]);
        ...
        // Signals
        /** @signal */
        connect<K extends keyof DeformBowTie.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, DeformBowTie.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof DeformBowTie.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, DeformBowTie.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof DeformBowTie.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<DeformBowTie.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
     ...
     * @gir-type Class
     */
    class DeformPageTurn extends DeformTexture implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Stylable {
         ...
         * @internal
         */
        $signals: DeformPageTurn.SignalSignatures;

        // Constructors
        constructor(properties?: Partial<DeformPageTurn.ConstructorProps>, ...args: any[]);
        ...
        // Signals
        /** @signal */
        connect<K extends keyof DeformPageTurn.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, DeformPageTurn.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof DeformPageTurn.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, DeformPageTurn.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof DeformPageTurn.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<DeformPageTurn.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
     ...
     * @gir-type Class
     */
    abstract class DeformTexture extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Stylable {
        static $gtype: GObject.GType<DeformTexture>;

        // Properties
        get back(): Clutter.Texture;
        set back(val: Clutter.Texture);

        get front(): Clutter.Texture;
        set front(val: Clutter.Texture);

        get tiles_x(): number;
        set tiles_x(val: number);

        get tilesX(): number;
        set tilesX(val: number);

        get tiles_y(): number;
        set tiles_y(val: number);

        get tilesY(): number;
        set tilesY(val: number);
         ...
         * @internal
         */
        $signals: DeformTexture.SignalSignatures;

        // Constructors
        constructor(properties?: Partial<DeformTexture.ConstructorProps>, ...args: any[]);

        _init(...args: any[]): void;

        // Signals
        /** @signal */
        connect<K extends keyof DeformTexture.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, DeformTexture.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof DeformTexture.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, DeformTexture.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof DeformTexture.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<DeformTexture.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
         ...
         * @virtual
         */
        vfunc_deform(vertex: Cogl.TextureVertex, width: number, height: number): void;
         ...
         */
        get_resolution(): [number, number];

        /**
         * Retrieves the textures used by `texture`.
         */
        get_textures(): [Clutter.Texture | null, Clutter.Texture | null];
         ...
         * @param front {@link Clutter.Texture} to use for the front-face.
         * @param back {@link Clutter.Texture} to use for the back-face.
         */
     ...
     * @gir-type Class
     */
    class DeformWaves extends DeformTexture implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Stylable {
         ...
         * @internal
         */
        $signals: DeformWaves.SignalSignatures;

        // Constructors
        constructor(properties?: Partial<DeformWaves.ConstructorProps>, ...args: any[]);
        ...
        // Signals
        /** @signal */
        connect<K extends keyof DeformWaves.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, DeformWaves.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof DeformWaves.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, DeformWaves.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof DeformWaves.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<DeformWaves.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
     ...
     * @gir-type Class
     */
    class Dialog extends Bin implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Focusable, Stylable {
    ...
    namespace Entry {
        ...
        interface SignalSignatures extends Widget.SignalSignatures, Clutter.Container.SignalSignatures, Stylable.SignalSignatures {
            ...
            "notify::icon-highlight-suffix": (pspec: GObject.ParamSpec) => void;
     ...
     * @gir-type Class
     */
    class Entry extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Focusable, Stylable {
         ...
         * @returns the {@link Clutter.Text} used by {@link Mx.Entry}. The entry is owned by the {@link Mx.Entry} and should not be unref'ed by the application.
         */
        get_clutter_text(): Clutter.Actor;

        /**
         * Gets the text that is displayed when the entry is empty and unfocused
         * @returns the current value of the hint property. This string is owned by the {@link Mx.Entry} and should not be freed or modified.
         */
         ...
         * of the icon.
         * @returns the highlight filename suffix. This string is owned by the {@link Mx.Entry} and should not be freed or modified.
         */
         ...
         * and the suffix to "-highlight" {@link Mx.Entry} will look for
     ...
     * @gir-type Class
     */
    class Expander extends Bin implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Focusable, Stylable {
        ...
        // Methods
        /**
         * Get the current state of the expander (the value of {@link Mx.Expander.expanded})
         * @returns `TRUE` if the expander is open, `FALSE` if it is closed
         */
        get_expanded(): boolean;

        /**
         * Set the state (the {@link Mx.Expander.expanded} property) of the expander. 
    ...
    namespace FadeEffect {
        ...
        interface SignalSignatures extends Clutter.OffscreenEffect.SignalSignatures {
            "notify::border-bottom": (pspec: GObject.ParamSpec) => void;
            "notify::border-left": (pspec: GObject.ParamSpec) => void;
            "notify::border-right": (pspec: GObject.ParamSpec) => void;
            "notify::border-top": (pspec: GObject.ParamSpec) => void;
            "notify::bounds-height": (pspec: GObject.ParamSpec) => void;
            "notify::bounds-width": (pspec: GObject.ParamSpec) => void;
            "notify::bounds-x": (pspec: GObject.ParamSpec) => void;
            "notify::bounds-y": (pspec: GObject.ParamSpec) => void;
            "notify::color": (pspec: GObject.ParamSpec) => void;
            "notify::freeze-update": (pspec: GObject.ParamSpec) => void;
            "notify::actor": (pspec: GObject.ParamSpec) => void;
            "notify::enabled": (pspec: GObject.ParamSpec) => void;
            "notify::name": (pspec: GObject.ParamSpec) => void;
        }
    ...
    class FadeEffect extends Clutter.OffscreenEffect {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof FadeEffect.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, FadeEffect.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof FadeEffect.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, FadeEffect.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof FadeEffect.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<FadeEffect.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
         ...
         * use the width or height of the {@link Clutter.Actor} the effect is attached to.
         * 
         * <note><para>
     ...
     * @gir-type Class
     */
    abstract class FloatingWidget extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Stylable {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof FloatingWidget.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, FloatingWidget.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof FloatingWidget.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, FloatingWidget.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof FloatingWidget.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<FloatingWidget.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
    ...
    class FocusManager extends GObject.Object {
        ...
        // Methods
        /**
         * Get the currently focused {@link Mx.Focusable}
         * @returns MxFocusable
         */
        ...
        /**
         * Sets the currently focused actor, with an {@link Mx.FocusHint} of
         * {@link Mx.FocusHint.PRIOR}.
         * 
     ...
     * @gir-type Class
     */
    class Frame extends Bin implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Focusable, Stylable {
    ...
    namespace Grid {
        ...
        interface SignalSignatures extends Widget.SignalSignatures, Clutter.Container.SignalSignatures, Stylable.SignalSignatures {
            ...
            "notify::child-yalign": (pspec: GObject.ParamSpec) => void;
            "notify::column-spacing": (pspec: GObject.ParamSpec) => void;
            "notify::homogenous-columns": (pspec: GObject.ParamSpec) => void;
            "notify::homogenous-rows": (pspec: GObject.ParamSpec) => void;
            "notify::line-alignment": (pspec: GObject.ParamSpec) => void;
            "notify::max-stride": (pspec: GObject.ParamSpec) => void;
            "notify::orientation": (pspec: GObject.ParamSpec) => void;
     ...
     * @gir-type Class
     */
    class Grid extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Focusable, Scrollable, Stylable {
     ...
     * @gir-type Class
     */
    class Icon extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Stylable {
    ...
    namespace IconTheme {
        // Signal signatures
        interface SignalSignatures extends GObject.Object.SignalSignatures {
            "notify::theme-name": (pspec: GObject.ParamSpec) => void;
        }
    ...
    class IconTheme extends GObject.Object {
        ...
        // Static methods
        /**
         * Return the default {@link Mx.IconTheme} object used by the toolkit.
         */
        static get_default(): IconTheme;

        // Methods
        /**
         * Gets the directories the {@link Mx.IconTheme} will search in to find icons.
         * @returns the search paths
         */
        get_search_paths(): string[];

        /**
         * Get the value of the {@link Mx.IconTheme.theme_name} property.
        ...
        /**
         * If the icon is available, returns a {@link Cogl.Handle} of the icon.
         * @param icon_name The name of the icon
         * @param size The desired size of the icon
         * @returns a {@link Cogl.Handle} of the icon, or `null`.
         */
        lookup(icon_name: string, size: number): Cogl.Handle;

        /**
         * If the icon is available, returns a {@link Clutter.Texture} of the icon.
         * @param icon_name The name of the icon
         * @param size The desired size of the icon
         * @returns a {@link Clutter.Texture} of the icon, or `null`.
         */
        lookup_texture(icon_name: string, size: number): Clutter.Texture;

        /**
         * Sets the directories the {@link Mx.IconTheme} will search in to find icons.
        ...
        /**
         * Set the value of the {@link Mx.IconTheme.theme_name} property. This will cause the
    ...
    namespace Image {
        ...
        interface SignalSignatures extends Widget.SignalSignatures, Clutter.Container.SignalSignatures, Stylable.SignalSignatures {
            ...
            "notify::image-rotation": (pspec: GObject.ParamSpec) => void;
            "notify::load-async": (pspec: GObject.ParamSpec) => void;
            "notify::scale-height-threshold": (pspec: GObject.ParamSpec) => void;
            "notify::scale-mode": (pspec: GObject.ParamSpec) => void;
            "notify::scale-width-threshold": (pspec: GObject.ParamSpec) => void;
     ...
     * @gir-type Class
     */
    class Image extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Stylable {
        ...
        // Methods
        /**
         * Sets the value of {@link Mx.Image.scale_mode} to `scale_mode` and animates the
         ...
         * @param pixel_format The {@link Cogl.PixelFormat} of the buffer
         ...
         * return immediately as successful. The {@link Mx.Image.SignalSignatures.image_loaded | Mx.Image::image-loaded} and
    ...
    namespace ItemView {
        ...
        // Constructor properties interface
        interface ConstructorProps extends Grid.ConstructorProps, Atk.ImplementorIface.ConstructorProps, Clutter.Animatable.ConstructorProps, Clutter.Container.ConstructorProps, Clutter.Scriptable.ConstructorProps, Focusable.ConstructorProps, Scrollable.ConstructorProps, Stylable.ConstructorProps {
     ...
     * @gir-type Class
     */
    class ItemView extends Grid implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Focusable, Scrollable, Stylable {
        ...
        /**
         * Gets the {@link Mx.ItemFactory} used for creating new items.
         * @returns A {@link Mx.ItemFactory}.
         */
        ...
        /**
         * Get the model currently used by the {@link Mx.ItemView}
         * @returns the current {@link Clutter.Model}
         */
        get_model(): Clutter.Model;

        /**
         * Sets `factory` to be the factory used for creating new items
         * @param factory A {@link Mx.ItemFactory}
         */
         ...
         * model
         * @param item_type A {@link GObject.GType}
         */
        set_item_type(item_type: GObject.GType): void;

        /**
         * Set the model used by the {@link Mx.ItemView}
         * @param model A {@link Clutter.Model}
         */
    ...
    namespace KineticScrollView {
        ...
        // Constructor properties interface
        interface ConstructorProps extends Bin.ConstructorProps, Atk.ImplementorIface.ConstructorProps, Clutter.Animatable.ConstructorProps, Clutter.Container.ConstructorProps, Clutter.Scriptable.ConstructorProps, Focusable.ConstructorProps, Scrollable.ConstructorProps, Stylable.ConstructorProps {
     ...
     * @gir-type Class
     */
    class KineticScrollView extends Bin implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Focusable, Scrollable, Stylable {
         ...
         * @returns A {@link Mx.ScrollPolicy}
         */
         ...
         * @param policy A {@link Mx.ScrollPolicy}
         */
    ...
    namespace Label {
        ...
        interface SignalSignatures extends Widget.SignalSignatures, Clutter.Container.SignalSignatures, Stylable.SignalSignatures {
            ...
            "notify::show-tooltip": (pspec: GObject.ParamSpec) => void;
            "notify::text": (pspec: GObject.ParamSpec) => void;
     ...
     * @gir-type Class
     */
    class Label extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Stylable {
        ...
        /**
         * Whether to wrap the lines of {@link Mx.Label.text} if the contents
         ...
         * to `true`, this will also cause the {@link Clutter.Actor.reactive} property to be
         * enabled.
         * @since 1.4
         */
    ...
    // This accessor conflicts with another accessor's type in a parent class or interface.
        ...
        /**
         * Retrieve the internal {@link Clutter.Text} so that extra parameters can be set
         * @returns the {@link Clutter.Text} used by {@link Mx.Label}. The label is owned by the {@link Mx.Label} and should not be unref'ed by the application.
         */
        get_clutter_text(): Clutter.Actor;
    ...
    namespace ListView {
        ...
        // Constructor properties interface
        interface ConstructorProps extends BoxLayout.ConstructorProps, Atk.ImplementorIface.ConstructorProps, Clutter.Animatable.ConstructorProps, Clutter.Container.ConstructorProps, Clutter.Scriptable.ConstructorProps, Focusable.ConstructorProps, Scrollable.ConstructorProps, Stylable.ConstructorProps {
            factory: GObject.Object;
            item_type: GObject.GTypeInput;
            itemType: GObject.GTypeInput;
            model: Clutter.Model;
     ...
     * @gir-type Class
     */
    class ListView extends BoxLayout implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Focusable, Scrollable, Stylable {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof ListView.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, ListView.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof ListView.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, ListView.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof ListView.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<ListView.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
        ...
        /**
         * Gets the {@link Mx.ItemFactory} used for creating new list items.
         * @returns A {@link Mx.ItemFactory}.
         */
        get_factory(): ItemFactory;
        ...
        /**
         * Get the model currently used by the {@link Mx.ListView}
         * @returns the current {@link Clutter.Model}
         */
        get_model(): Clutter.Model;
        ...
        /**
         * Set the model used by the {@link Mx.ListView}
         * @param model A {@link Clutter.Model}
         */
        set_model(model: Clutter.Model): void;
     ...
     * @gir-type Class
     */
    class Menu extends FloatingWidget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Focusable, Stylable {
    ...
    namespace Notebook {
        ...
        interface SignalSignatures extends Widget.SignalSignatures, Clutter.Container.SignalSignatures, Stylable.SignalSignatures {
            ...
            "notify::enable-gestures": (pspec: GObject.ParamSpec) => void;
            "notify::disabled": (pspec: GObject.ParamSpec) => void;
            "notify::menu": (pspec: GObject.ParamSpec) => void;
            "notify::tooltip-delay": (pspec: GObject.ParamSpec) => void;
            "notify::tooltip-text": (pspec: GObject.ParamSpec) => void;
     ...
     * @gir-type Class
     */
    class Notebook extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Focusable, Stylable {
        ...
        set enable_gestures(val: boolean);

        get enableGestures(): boolean;
        set enableGestures(val: boolean);
    ...
    namespace Offscreen {
        ...
        interface SignalSignatures extends Clutter.Texture.SignalSignatures, Clutter.Container.SignalSignatures {
            "notify::accumulation-enabled": (pspec: GObject.ParamSpec) => void;
            "notify::accumulation-material": (pspec: GObject.ParamSpec) => void;
            "notify::auto-update": (pspec: GObject.ParamSpec) => void;
            "notify::buffer": (pspec: GObject.ParamSpec) => void;
            "notify::child": (pspec: GObject.ParamSpec) => void;
            "notify::pick-child": (pspec: GObject.ParamSpec) => void;
            "notify::redirect-enabled": (pspec: GObject.ParamSpec) => void;
     ...
     * @gir-type Class
     */
    class Offscreen extends Clutter.Texture implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Focusable {
        ...
        get pick_child(): boolean;
        set pick_child(val: boolean);

        get pickChild(): boolean;
        set pickChild(val: boolean);

        get redirect_enabled(): boolean;
        set redirect_enabled(val: boolean);

        get redirectEnabled(): boolean;
        set redirectEnabled(val: boolean);
         ...
         * @virtual
         */
        vfunc_paint_child(): void;

        // Methods
        /**
         * Gets the value of the {@link Mx.Offscreen.accumulation_enabled} property.
        ...
        /**
         * Gets the {@link Mx.Offscreen.accumulation_material} property.
         * @returns The {@link Cogl.Handle} for the material used for the accumulation buffer
         * @since 1.2
         */
        get_accumulation_material(): Cogl.Handle;

        /**
         * Gets the value of the {@link Mx.Offscreen.auto_update} property.
         * @returns `TRUE` if automatic updating of the offscreen surface is enabled
         */
        get_auto_update(): boolean;

        /**
         * Gets the value of the {@link Mx.Offscreen.buffer} property.
         * @returns the {@link Cogl.Handle} for the offscreen buffer object
         * @since 1.2
         */
        get_buffer(): Cogl.Handle;

        /**
         * Gets the value of the {@link Mx.Offscreen.child} property.
         * @returns The child of the offscreen widget
         */
        get_child(): Clutter.Actor;

        /**
         * Gets the value of the {@link Mx.Offscreen.pick_child} property.
         * @returns `TRUE` if picking of the child is enabled.
         */
        get_pick_child(): boolean;

        /**
         * Gets the value of the {@link Mx.Offscreen.redirect_enabled} property.
        ...
        /**
         * Sets the value of the {@link Mx.Offscreen.redirect_enabled} property. When
     ...
     * @gir-type Class
     */
    class PathBar extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Focusable, Stylable {
        ...
        /**
         * Get the value of the {@link Mx.PathBar.clear_on_change} property
         * @returns the value of the "clear-on-change" property
         */
        get_clear_on_change(): boolean;

        /**
         * Get the value of the {@link Mx.PathBar.editable} property.
        ...
        /**
         * Set theh value of the {@link Mx.PathBar.clear_on_change} property
         * @param clear_on_change the new value of the property
         */
        set_clear_on_change(clear_on_change: boolean): void;

        /**
         * Set the value of the {@link Mx.PathBar.editable} property.
        ...
        /**
         * Set the text in the editable area of the {@link Mx.PathBar}
     ...
     * @gir-type Class
     */
    class ProgressBar extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Stylable {
     ...
     * @gir-type Class
     */
    class ScrollBar extends Bin implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Focusable, Stylable {
     ...
     * @gir-type Class
     */
    class ScrollView extends Bin implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Focusable, Stylable {
    ...
    namespace Settings {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
            ...
            "notify::long-press-timeout": (pspec: GObject.ParamSpec) => void;
            "notify::small-screen": (pspec: GObject.ParamSpec) => void;
        }
    ...
    namespace Slider {
        // Signal signatures
        interface SignalSignatures extends Widget.SignalSignatures, Clutter.Container.SignalSignatures, Stylable.SignalSignatures {
            "notify::buffer-value": (pspec: GObject.ParamSpec) => void;
            "notify::value": (pspec: GObject.ParamSpec) => void;
            "notify::disabled": (pspec: GObject.ParamSpec) => void;
            "notify::menu": (pspec: GObject.ParamSpec) => void;
            "notify::tooltip-delay": (pspec: GObject.ParamSpec) => void;
     ...
     * @gir-type Class
     */
    class Slider extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Focusable, Stylable {
     ...
     * @gir-type Class
     */
    class Spinner extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Stylable {
     ...
     * @gir-type Class
     */
    class Stack extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Focusable, Stylable {
    ...
    namespace StackChild {
        // Signal signatures
        interface SignalSignatures extends Clutter.ChildMeta.SignalSignatures {
            "notify::crop": (pspec: GObject.ParamSpec) => void;
            "notify::fit": (pspec: GObject.ParamSpec) => void;
            "notify::x-align": (pspec: GObject.ParamSpec) => void;
            "notify::x-fill": (pspec: GObject.ParamSpec) => void;
            "notify::y-align": (pspec: GObject.ParamSpec) => void;
            "notify::y-fill": (pspec: GObject.ParamSpec) => void;
    ...
    class StackChild extends Clutter.ChildMeta {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof StackChild.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, StackChild.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof StackChild.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, StackChild.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof StackChild.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<StackChild.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
    }
    ...
    class Style extends GObject.Object {
         ...
         * @param pspec a {@link GObject.ParamSpec} describing the property required
         */
     ...
     * @gir-type Class
     */
    class Table extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Focusable, Stylable {
    ...
    // Conflicted with Clutter.Container.add_actor
         ...
         * @param child A {@link Clutter.Actor}
         * @returns An {@link Mx.Align} value
         */
        child_get_x_align(child: Clutter.Actor): Align;
         ...
         * @param child An {@link Clutter.Actor}
         ...
         * @param child A {@link Clutter.Actor}
         * @param align A {@link Mx.Align} value
         */
    ...
    namespace TableChild {
        ...
        interface SignalSignatures extends Clutter.ChildMeta.SignalSignatures {
            ...
            "notify::column-span": (pspec: GObject.ParamSpec) => void;
    ...
    class TableChild extends Clutter.ChildMeta {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof TableChild.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, TableChild.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof TableChild.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, TableChild.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof TableChild.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<TableChild.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
    }
    ...
    class TextureCache extends GObject.Object {
        ...
        /**
         * Create a {@link Cogl.Handle} representing a texture of the specified image. Adds
         * the image to the cache if the image had not been previously loaded.
         * Subsequent calls with the same image URI/path will return the {@link Cogl.Handle} of
         * the previously loaded image with an increased reference count.
         * @param uri A URI or path to an image file
         * @returns a {@link Cogl.Handle} to the cached texture
         */
        get_cogl_texture(uri: string): Cogl.Handle;

        /**
         * Retrieves the {@link Cogl.Handle} of the previously added image associated
     ...
     * @gir-type Class
     */
    class TextureFrame extends Clutter.Actor implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof TextureFrame.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, TextureFrame.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof TextureFrame.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, TextureFrame.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof TextureFrame.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<TextureFrame.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
        ...
        /**
         * Return the texture used by the {@link Mx.TextureFrame}
         * @returns a {@link Clutter.Texture} owned by the {@link Mx.TextureFrame}
         */
        ...
        /**
         * Set the {@link Clutter.Texture} used by this {@link Mx.TextureFrame}
         * @param texture A {@link Clutter.Texture}
         */
     ...
     * @gir-type Class
     */
    class Toggle extends Widget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Stylable {
     ...
     * @gir-type Class
     */
    class Toolbar extends Bin implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Focusable, Stylable {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof Toolbar.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, Toolbar.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof Toolbar.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, Toolbar.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof Toolbar.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<Toolbar.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
        ...
        // Methods
        /**
         * Get the value of the {@link Mx.Toolbar.has_close_button} property.
         * @returns the current value of the "hast-close-button" property.
         */
        get_has_close_button(): boolean;

        /**
         * Set the {@link Mx.Toolbar.has_close_button} property
    ...
    namespace Tooltip {
        ...
        // Constructor properties interface
        interface ConstructorProps extends FloatingWidget.ConstructorProps, Atk.ImplementorIface.ConstructorProps, Clutter.Animatable.ConstructorProps, Clutter.Container.ConstructorProps, Clutter.Scriptable.ConstructorProps, Stylable.ConstructorProps {
            text: string;
     ...
     * @gir-type Class
     */
    class Tooltip extends FloatingWidget implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Stylable {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof Tooltip.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, Tooltip.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof Tooltip.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, Tooltip.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof Tooltip.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<Tooltip.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
         ...
         * @returns the {@link Clutter.Geometry}, owned by the tooltip which must not be freed by the application.
         */
         ...
         * @param area A {@link Clutter.Geometry}
         */
    ...
    namespace Viewport {
        ...
        interface SignalSignatures extends Bin.SignalSignatures, Clutter.Container.SignalSignatures, Stylable.SignalSignatures {
            ...
            "notify::z-origin": (pspec: GObject.ParamSpec) => void;
            "notify::child": (pspec: GObject.ParamSpec) => void;
            "notify::x-align": (pspec: GObject.ParamSpec) => void;
            "notify::x-fill": (pspec: GObject.ParamSpec) => void;
            "notify::y-align": (pspec: GObject.ParamSpec) => void;
     ...
     * @gir-type Class
     */
    class Viewport extends Bin implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Focusable, Scrollable, Stylable {
    ...
    namespace Widget {
        ...
        // Constructor properties interface
        interface ConstructorProps extends Clutter.Actor.ConstructorProps, Atk.ImplementorIface.ConstructorProps, Clutter.Animatable.ConstructorProps, Clutter.Container.ConstructorProps, Clutter.Scriptable.ConstructorProps, Stylable.ConstructorProps {
            disabled: boolean;
            menu: Menu;
    ...
    /**
     * Base class for stylable actors. The contents of the {@link Mx.Widget}
     * structure are private and should only be accessed through the
     * public API.
     * @gir-type Class
     */
    abstract class Widget extends Clutter.Actor implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Stylable {
        ...
        /**
         * {@link Mx.Menu} associated with the widget.
         */
        get menu(): Menu;
        set menu(val: Menu);
         ...
         * @virtual
         */
        vfunc_apply_style(style: Style): void;
         ...
         * @virtual
         */
        vfunc_paint_background(background: Clutter.Actor, color: Clutter.Color): void;
         ...
         * to padding.
         * @param allocation A {@link Clutter.ActorBox}
         * @param area A {@link Clutter.ActorBox}
         */
        ...
        /**
         * Get the object in the {@link Mx.Widget.menu} property.
         ...
         * @returns The current tooltip string, owned by the {@link Mx.Widget}
         */
        ...
        /**
         * Invokes {@link Mx.Widget.SignalSignatures.paint_background | Mx.Widget::paint_background}() using the default background
         * image and/or color from the `widget` style
         * 
         * This function should be used by subclasses of {@link Mx.Widget} that override
        ...
        /**
         * Set the value of the {@link Mx.Widget.menu} property.
         * @param menu A {@link Mx.Menu}
         */
    ...
    namespace Window {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
            ...
            destroy: () => void;
            "notify::child": (pspec: GObject.ParamSpec) => void;
            "notify::clutter-stage": (pspec: GObject.ParamSpec) => void;
            "notify::fullscreen": (pspec: GObject.ParamSpec) => void;
            "notify::has-toolbar": (pspec: GObject.ParamSpec) => void;
            "notify::icon-cogl-texture": (pspec: GObject.ParamSpec) => void;
            "notify::icon-name": (pspec: GObject.ParamSpec) => void;
            "notify::small-screen": (pspec: GObject.ParamSpec) => void;
            "notify::title": (pspec: GObject.ParamSpec) => void;
            "notify::toolbar": (pspec: GObject.ParamSpec) => void;
            "notify::window-rotation": (pspec: GObject.ParamSpec) => void;
            "notify::window-rotation-angle": (pspec: GObject.ParamSpec) => void;
            "notify::window-rotation-timeline": (pspec: GObject.ParamSpec) => void;
        }
    ...
    class Window extends GObject.Object {
        ...
        // Static methods
        /**
         * Gets the {@link Mx.Window} parent of the {@link Clutter.Stage}, if it exists.
         * @param stage A {@link Clutter.Stage}
         */
        ...
        /**
         * Gets the {@link Clutter.Stage} managed by the window.
         * @returns A {@link Clutter.Stage}
         */
         ...
         * @param texture A {@link Cogl.Handle} for a texture
         */

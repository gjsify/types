/**
 * The GIR-derived widget VOCABULARY for Mx-1.0.
 *
 ...
 *
 * 49 instantiable GTypes (of which 0 concrete widgets), 57 declarations (1 inlined from a namespace whose vocabulary does not emit them), 15 enum nick unions, 0 slot candidates.
 *
...
import type Mx from './mx-1.0.js';
import type { ClutterActorConstructOnly, ClutterActorMetaConstructOnly, ClutterActorMetaProps, ClutterActorProps, ClutterAnimatableConstructOnly, ClutterAnimatableProps, ClutterContainerConstructOnly, ClutterContainerProps, ClutterEffectConstructOnly, ClutterEffectProps, ClutterOffscreenEffectConstructOnly, ClutterOffscreenEffectProps, ClutterScriptableConstructOnly, ClutterScriptableProps, ClutterTextureConstructOnly, ClutterTextureProps } from '@girs/clutter-1.0/vocabulary';
import type { GActionConstructOnly, GActionProps } from '@girs/gio-2.0/vocabulary';
...
export type MxScrollPolicyNick = 'none' | 'horizontal' | 'vertical' | 'both';
export type MxStyleErrorNick = 'invalid-file';
...
/** The contents of this structure are private and should only be accessed through the public API. */
export interface MxApplicationProps extends GObjectProps {
    'application-name'?: string;
    flags?: number;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MxApplicationConstructOnly = GObjectConstructOnly | 'application-name' | 'flags';
...
export interface MxButtonProps extends MxBinProps, ClutterAnimatableProps, ClutterContainerProps, ClutterScriptableProps, MxFocusableProps, MxStylableProps {
    action?: Mx.Action;
    'icon-name'?: string;
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MxButtonConstructOnly = MxBinConstructOnly | ClutterAnimatableConstructOnly | ClutterContainerConstructOnly | ClutterScriptableConstructOnly | MxFocusableConstructOnly | MxStylableConstructOnly;
...
/** The contents of this structure is private and should only be accessed using the provided API. */
export interface MxDeformBowTieProps extends MxDeformTextureProps, ClutterAnimatableProps, ClutterContainerProps, ClutterScriptableProps, MxStylableProps {
    'flip-back'?: boolean;
    period?: number;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MxDeformBowTieConstructOnly = MxDeformTextureConstructOnly | ClutterAnimatableConstructOnly | ClutterContainerConstructOnly | ClutterScriptableConstructOnly | MxStylableConstructOnly;

/** The contents of this structure is private and should only be accessed using the provided API. */
export interface MxDeformPageTurnProps extends MxDeformTextureProps, ClutterAnimatableProps, ClutterContainerProps, ClutterScriptableProps, MxStylableProps {
    angle?: number;
    period?: number;
    radius?: number;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MxDeformPageTurnConstructOnly = MxDeformTextureConstructOnly | ClutterAnimatableConstructOnly | ClutterContainerConstructOnly | ClutterScriptableConstructOnly | MxStylableConstructOnly;

/** The contents of this structure is private and should only be accessed using the provided API. */
export interface MxDeformTextureProps extends MxWidgetProps, ClutterAnimatableProps, ClutterContainerProps, ClutterScriptableProps, MxStylableProps {
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MxDeformTextureConstructOnly = MxWidgetConstructOnly | ClutterAnimatableConstructOnly | ClutterContainerConstructOnly | ClutterScriptableConstructOnly | MxStylableConstructOnly;

/** The contents of this structure is private and should only be accessed using the provided API. */
export interface MxDeformWavesProps extends MxDeformTextureProps, ClutterAnimatableProps, ClutterContainerProps, ClutterScriptableProps, MxStylableProps {
    amplitude?: number;
    angle?: number;
    period?: number;
    radius?: number;
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MxDeformWavesConstructOnly = MxDeformTextureConstructOnly | ClutterAnimatableConstructOnly | ClutterContainerConstructOnly | ClutterScriptableConstructOnly | MxStylableConstructOnly;

/** The contents of this structure is private and should only be accessed using the provided API. */
export interface MxDialogProps extends MxBinProps, ClutterAnimatableProps, ClutterContainerProps, ClutterScriptableProps, MxFocusableProps, MxStylableProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MxDialogConstructOnly = MxBinConstructOnly | ClutterAnimatableConstructOnly | ClutterContainerConstructOnly | ClutterScriptableConstructOnly | MxFocusableConstructOnly | MxStylableConstructOnly;
...
export interface MxExpanderProps extends MxBinProps, ClutterAnimatableProps, ClutterContainerProps, ClutterScriptableProps, MxFocusableProps, MxStylableProps {
    expanded?: boolean;
    label?: string;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MxExpanderConstructOnly = MxBinConstructOnly | ClutterAnimatableConstructOnly | ClutterContainerConstructOnly | ClutterScriptableConstructOnly | MxFocusableConstructOnly | MxStylableConstructOnly;
...
/** The contents of this structure are private and should only be accessed through the public API. */
export interface MxFrameProps extends MxBinProps, ClutterAnimatableProps, ClutterContainerProps, ClutterScriptableProps, MxFocusableProps, MxStylableProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MxFrameConstructOnly = MxBinConstructOnly | ClutterAnimatableConstructOnly | ClutterContainerConstructOnly | ClutterScriptableConstructOnly | MxFocusableConstructOnly | MxStylableConstructOnly;
...
/** The contents of this structure is private and should only be accessed using the provided API. */
export interface MxKineticScrollViewProps extends MxBinProps, ClutterAnimatableProps, ClutterContainerProps, ClutterScriptableProps, MxFocusableProps, MxScrollableProps, MxStylableProps {
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MxKineticScrollViewConstructOnly = MxBinConstructOnly | ClutterAnimatableConstructOnly | ClutterContainerConstructOnly | ClutterScriptableConstructOnly | MxFocusableConstructOnly | MxScrollableConstructOnly | MxStylableConstructOnly;
...
/** The contents of this structure is private and should only be accessed using the provided API. */
export interface MxOffscreenProps extends ClutterTextureProps, ClutterAnimatableProps, ClutterContainerProps, ClutterScriptableProps, MxFocusableProps {
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MxOffscreenConstructOnly = ClutterTextureConstructOnly | ClutterAnimatableConstructOnly | ClutterContainerConstructOnly | ClutterScriptableConstructOnly | MxFocusableConstructOnly;
...
/** The contents of this structure are private and should only be accessed through the public API. */
export interface MxScrollBarProps extends MxBinProps, ClutterAnimatableProps, ClutterContainerProps, ClutterScriptableProps, MxFocusableProps, MxStylableProps {
    adjustment?: Mx.Adjustment;
    orientation?: MxOrientationNick | Mx.Orientation;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MxScrollBarConstructOnly = MxBinConstructOnly | ClutterAnimatableConstructOnly | ClutterContainerConstructOnly | ClutterScriptableConstructOnly | MxFocusableConstructOnly | MxStylableConstructOnly;

/** The contents of this structure are private and should only be accessed through the public API. */
export interface MxScrollViewProps extends MxBinProps, ClutterAnimatableProps, ClutterContainerProps, ClutterScriptableProps, MxFocusableProps, MxStylableProps {
    'enable-gestures'?: boolean;
    'enable-mouse-scrolling'?: boolean;
    'scroll-policy'?: MxScrollPolicyNick | Mx.ScrollPolicy;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MxScrollViewConstructOnly = MxBinConstructOnly | ClutterAnimatableConstructOnly | ClutterContainerConstructOnly | ClutterScriptableConstructOnly | MxFocusableConstructOnly | MxStylableConstructOnly;
...
/** The contents of this structure is private and should only be accessed using the provided API. */
export interface MxToggleProps extends MxWidgetProps, ClutterAnimatableProps, ClutterContainerProps, ClutterScriptableProps, MxStylableProps {
    active?: boolean;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MxToggleConstructOnly = MxWidgetConstructOnly | ClutterAnimatableConstructOnly | ClutterContainerConstructOnly | ClutterScriptableConstructOnly | MxStylableConstructOnly;

/** The contents of this structure are private and should only be accessed through the public API. */
export interface MxToolbarProps extends MxBinProps, ClutterAnimatableProps, ClutterContainerProps, ClutterScriptableProps, MxFocusableProps, MxStylableProps {
    'has-close-button'?: boolean;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MxToolbarConstructOnly = MxBinConstructOnly | ClutterAnimatableConstructOnly | ClutterContainerConstructOnly | ClutterScriptableConstructOnly | MxFocusableConstructOnly | MxStylableConstructOnly;

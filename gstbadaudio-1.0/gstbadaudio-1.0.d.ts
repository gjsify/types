...
export namespace GstBadAudio {
    ...
    abstract class NonstreamAudioDecoder extends Gst.Element {
        // Own properties of GstBadAudio-1.0.NonstreamAudioDecoder
        ...
        // Own fields of GstBadAudio-1.0.NonstreamAudioDecoder
        ...
        // Owm methods of GstBadAudio-1.0.NonstreamAudioDecoder
    ...
    class PlanarAudioAdapter extends GObject.Object {
        // Constructors of GstBadAudio-1.0.PlanarAudioAdapter

        static ['new'](): PlanarAudioAdapter;

        // Owm methods of GstBadAudio-1.0.PlanarAudioAdapter
     ...
     */
    class NonstreamAudioDecoderClass {
        // Own fields of GstBadAudio-1.0.NonstreamAudioDecoderClass

        loads_from_sinkpad: boolean;
    }

    class PlanarAudioAdapterClass {}

 ...
 */
export const NONSTREAM_AUDIO_DECODER_SINK_NAME: string | null
/**
 * The name of the template for the source pad.
 */
export const NONSTREAM_AUDIO_DECODER_SRC_NAME: string | null
 ...
 * @class 
 */
export class NonstreamAudioDecoder extends Gst.Element {
...
export interface PlanarAudioAdapter {
...
export interface NonstreamAudioDecoderClass {
...
export interface PlanarAudioAdapterClass {
}

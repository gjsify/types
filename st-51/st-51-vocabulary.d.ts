/**
 * The GIR-derived widget VOCABULARY for St-51.
 *
 ...
 *
 * 30 instantiable GTypes (of which 0 concrete widgets), 33 declarations (2 inlined from a namespace whose vocabulary does not emit them), 13 enum nick unions, 0 slot candidates.
 *
...
import type { ClutterActionConstructOnly, ClutterActionProps, ClutterActorAccessibleConstructOnly, ClutterActorAccessibleProps, ClutterActorConstructOnly, ClutterActorMetaConstructOnly, ClutterActorMetaProps, ClutterActorProps, ClutterAnimatableConstructOnly, ClutterAnimatableProps, ClutterContentConstructOnly, ClutterContentProps, ClutterCursorTypeNick, ClutterEffectConstructOnly, ClutterEffectProps, ClutterGestureConstructOnly, ClutterGestureProps, ClutterInputContentPurposeNick, ClutterOffscreenEffectConstructOnly, ClutterOffscreenEffectProps, ClutterOrientationNick, ClutterShaderEffectConstructOnly, ClutterShaderEffectProps } from '@girs/clutter-51/vocabulary';
...
export type StReducedMotionNick = 'no-preference' | 'reduce';
...
export type StTextAlignNick = 'left' | 'center' | 'right' | 'start' | 'end' | 'justify';
...
export interface ClutterCursorProps extends GObjectProps {
...
export type ClutterCursorConstructOnly = GObjectConstructOnly | 'color-state' | 'cursor-type';

export interface MetaCursorProps extends ClutterCursorProps {
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MetaCursorConstructOnly = ClutterCursorConstructOnly | 'backend' | 'size' | 'theme-name';
...
export interface StCursorProps extends MetaCursorProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type StCursorConstructOnly = MetaCursorConstructOnly;
...
export interface StScrollViewProps extends StWidgetProps, ClutterAnimatableProps {
     ...
     * @default TRUE
     */
    'enable-touch-scrolling'?: boolean;
    /**

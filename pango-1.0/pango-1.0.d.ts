...
export namespace Pango {
    ...
    class LayoutDeserializeError extends GLib.Error {
        // Own fields of Pango-1.0.LayoutDeserializeError
        ...
        // Constructors of Pango-1.0.LayoutDeserializeError

        constructor(options: { message: string; code: number });

        // Owm methods of Pango-1.0.LayoutDeserializeError
     ...
     */
    function parse_enum(type: GObject.GType, str: string | null, warn: boolean): boolean;
    /**
     ...
     * @returns %FALSE if @error is set, otherwise %TRUE
     */
    function parse_markup(markup_text: string, length: number, accel_marker: number): boolean;
    /**
     ...
     */
    function scan_int(pos: string): boolean;
    /**
    ...
    class Context extends GObject.Object {
        // Constructors of Pango-1.0.Context

        static ['new'](): Context;

        // Owm methods of Pango-1.0.Context
    ...
    class Coverage extends GObject.Object {
        // Constructors of Pango-1.0.Coverage

        static ['new'](): Coverage;

        // Owm methods of Pango-1.0.Coverage
    ...
    abstract class Font extends GObject.Object {
         ...
         */
        get_features(num_features: number): void;
        /**
    ...
    abstract class FontFace extends GObject.Object {
        // Owm methods of Pango-1.0.FontFace
     ...
     */
    abstract class FontFamily<A extends GObject.Object = GObject.Object> extends GObject.Object {
        // Own properties of Pango-1.0.FontFamily
        ...
        // Owm methods of Pango-1.0.FontFamily
     ...
     */
    abstract class FontMap<A extends GObject.Object = GObject.Object> extends GObject.Object {
        // Own properties of Pango-1.0.FontMap
        ...
        // Owm methods of Pango-1.0.FontMap
    ...
    abstract class Fontset extends GObject.Object {
        // Owm methods of Pango-1.0.Fontset
    ...
    class FontsetSimple extends Fontset {
        // Constructors of Pango-1.0.FontsetSimple

        static ['new'](language: Language): FontsetSimple;

        // Owm methods of Pango-1.0.FontsetSimple
    ...
    class Layout extends GObject.Object {
        // Constructors of Pango-1.0.Layout

        static ['new'](context: Context): Layout;

        // Owm methods of Pango-1.0.Layout
         ...
         */
        set_markup_with_accel(markup: string, length: number, accel_marker: number): void;
        /**
    ...
    abstract class Renderer extends GObject.Object {
        // Own fields of Pango-1.0.Renderer

        matrix: Matrix;

        // Owm methods of Pango-1.0.Renderer
     ...
     */
    class Analysis {
        // Own fields of Pango-1.0.Analysis
     ...
     */
    class AttrClass {
        // Own fields of Pango-1.0.AttrClass
     ...
     */
    class AttrColor {
        // Own fields of Pango-1.0.AttrColor
     ...
     */
    class AttrFloat {
        // Own fields of Pango-1.0.AttrFloat
     ...
     */
    class AttrFontDesc {
        // Owm methods of Pango-1.0.AttrFontDesc
    ...
    class AttrFontFeatures {
        // Own fields of Pango-1.0.AttrFontFeatures

        features: string;

        // Owm methods of Pango-1.0.AttrFontFeatures
     ...
     */
    class AttrInt {
        // Own fields of Pango-1.0.AttrInt
     ...
     */
    class AttrIterator {
        // Owm methods of Pango-1.0.AttrIterator
     ...
     */
    class AttrLanguage {
        // Owm methods of Pango-1.0.AttrLanguage
     ...
     */
    class AttrList {
        // Constructors of Pango-1.0.AttrList

        constructor(properties?: Partial<{}>);

        static ['new'](): AttrList;

        // Owm methods of Pango-1.0.AttrList
     ...
     */
    class AttrShape {
        // Own fields of Pango-1.0.AttrShape
        ...
        // Owm methods of Pango-1.0.AttrShape
     ...
     */
    class AttrSize {
        // Own fields of Pango-1.0.AttrSize

        size: number;
        absolute: number;

        // Owm methods of Pango-1.0.AttrSize
     ...
     */
    class AttrString {
        // Own fields of Pango-1.0.AttrString
     ...
     */
    class Attribute {
        // Own fields of Pango-1.0.Attribute

        start_index: number;
        end_index: number;

        // Owm methods of Pango-1.0.Attribute
     ...
     */
    class Color {
        // Own fields of Pango-1.0.Color

        red: number;
        green: number;
        blue: number;

        // Constructors of Pango-1.0.Color
        ...
        // Owm methods of Pango-1.0.Color
    ...
    class FontDescription {
        // Constructors of Pango-1.0.FontDescription

        constructor(properties?: Partial<{}>);

        static ['new'](): FontDescription;

        // Owm methods of Pango-1.0.FontDescription
     ...
     */
    class FontMapClass {
        // Own fields of Pango-1.0.FontMapClass
    ...
    class FontMetrics {
        ...
        // Owm methods of Pango-1.0.FontMetrics
     ...
     */
    class GlyphGeometry {
        // Own fields of Pango-1.0.GlyphGeometry

        width: GlyphUnit;
        x_offset: GlyphUnit;
        y_offset: GlyphUnit;

        // Constructors of Pango-1.0.GlyphGeometry
     ...
     */
    class GlyphInfo {
        // Own fields of Pango-1.0.GlyphInfo

        glyph: Glyph;
        geometry: GlyphGeometry;
        attr: GlyphVisAttr;

        // Constructors of Pango-1.0.GlyphInfo
     ...
     */
    class GlyphItem {
        // Own fields of Pango-1.0.GlyphItem
        ...
        // Owm methods of Pango-1.0.GlyphItem
     ...
     */
    class GlyphItemIter {
        // Own fields of Pango-1.0.GlyphItemIter
        ...
        // Owm methods of Pango-1.0.GlyphItemIter
     ...
     */
    class GlyphString {
        // Own fields of Pango-1.0.GlyphString

        num_glyphs: number;
        glyphs: GlyphInfo[];
        log_clusters: number;

        // Constructors of Pango-1.0.GlyphString
        ...
        // Owm methods of Pango-1.0.GlyphString
     ...
     */
    class GlyphVisAttr {
        // Own fields of Pango-1.0.GlyphVisAttr

        is_cluster_start: number;
        is_color: number;

        // Constructors of Pango-1.0.GlyphVisAttr
     ...
     */
    class Item {
        // Own fields of Pango-1.0.Item

        offset: number;
        length: number;
        num_chars: number;

        // Constructors of Pango-1.0.Item
     ...
     */
    class Language {
        // Owm methods of Pango-1.0.Language
     ...
     */
    class LayoutIter {
        // Owm methods of Pango-1.0.LayoutIter
     ...
     */
    class LayoutLine {
        // Own fields of Pango-1.0.LayoutLine
        ...
        // Owm methods of Pango-1.0.LayoutLine
         ...
         */
        get_x_ranges(start_index: number, end_index: number): void;
        /**
         ...
         */
        x_to_index(x_pos: number): boolean;
    }
     ...
     */
    class LogAttr {
        // Own fields of Pango-1.0.LogAttr
        ...
        // Constructors of Pango-1.0.LogAttr
     ...
     */
    class Matrix {
        // Own fields of Pango-1.0.Matrix
        ...
        // Constructors of Pango-1.0.Matrix
        ...
        // Owm methods of Pango-1.0.Matrix
     ...
     */
    class Rectangle {
        // Own fields of Pango-1.0.Rectangle
        ...
        // Constructors of Pango-1.0.Rectangle
     ...
     */
    class TabArray {
        // Constructors of Pango-1.0.TabArray
        ...
        // Owm methods of Pango-1.0.TabArray

 ...
 */
export function attr_break(text: string | null, length: number, attr_list: AttrList, offset: number, attrs: LogAttr[]): void
/**
 ...
 * @returns the newly allocated   `PangoAttribute`, which should be freed with   [method@Pango.Attribute.destroy]
 */
export function attr_family_new(family: string | null): Attribute
/**
 ...
 * @returns the newly allocated   `PangoAttribute`, which should be freed with   [method@Pango.Attribute.destroy]
 */
export function attr_font_features_new(features: string | null): Attribute
/**
 ...
 */
export function attr_list_from_string(text: string | null): AttrList | null
/**
 ...
 * @returns the newly allocated   `PangoAttribute`, which should be freed with   [method@Pango.Attribute.destroy]
 */
export function attr_shape_new_with_data(ink_rect: Rectangle, logical_rect: Rectangle, data: any | null, copy_func: AttrDataCopyFunc | null): Attribute
/**
 ...
 */
export function attr_type_register(name: string | null): AttrType
/**
 ...
 */
export function break_TODO(text: string | null, length: number, analysis: Analysis, attrs: LogAttr[]): void
/**
 ...
 */
export function default_break(text: string | null, length: number, analysis: Analysis | null, attrs: LogAttr, attrs_len: number): void
/**
 ...
 */
export function find_base_dir(text: string | null, length: number): Direction
/**
 ...
 */
export function find_paragraph_boundary(text: string | null, length: number): [ /* paragraph_delimiter_index */ number, /* next_paragraph_start */ number ]
/**
 ...
 */
export function font_description_from_string(str: string | null): FontDescription
/**
 ...
 * @param attrs array with one `PangoLogAttr`   per character in `text,` plus one extra, to be filled in
 */
export function get_log_attrs(text: string | null, length: number, level: number, language: Language, attrs: LogAttr[]): void
/**
 ...
 */
export function itemize(context: Context, text: string | null, start_index: number, length: number, attrs: AttrList, cached_iter: AttrIterator | null): Item[]
/**
 ...
 */
export function itemize_with_base_dir(context: Context, base_dir: Direction, text: string | null, start_index: number, length: number, attrs: AttrList, cached_iter: AttrIterator | null): Item[]
/**
 ...
 */
export function log2vis_get_embedding_levels(text: string | null, length: number, pbase_dir: Direction): number
/**
 ...
 */
export function markup_parser_finish(context: GLib.MarkupParseContext): [ /* returnType */ boolean, /* attr_list */ AttrList, /* text */ string | null, /* accel_char */ string ]
/**
 ...
 */
export function parse_enum(type: GObject.GType, str: string | null, warn: boolean): [ /* returnType */ boolean, /* value */ number, /* possible_values */ string | null ]
/**
 ...
 * @returns %FALSE if @error is set, otherwise %TRUE
 */
export function parse_markup(markup_text: string | null, length: number, accel_marker: string): [ /* returnType */ boolean, /* attr_list */ AttrList, /* text */ string | null, /* accel_char */ string ]
/**
 ...
 * @returns %TRUE if @str was successfully parsed.
 */
export function parse_stretch(str: string | null, warn: boolean): [ /* returnType */ boolean, /* stretch */ Stretch ]
/**
 * Parses a font style.
 * 
 ...
 * @returns %TRUE if @str was successfully parsed.
 */
export function parse_style(str: string | null, warn: boolean): [ /* returnType */ boolean, /* style */ Style ]
/**
 ...
 * @returns %TRUE if @str was successfully parsed.
 */
export function parse_variant(str: string | null, warn: boolean): [ /* returnType */ boolean, /* variant */ Variant ]
/**
 ...
 * @returns %TRUE if @str was successfully parsed.
 */
export function parse_weight(str: string | null, warn: boolean): [ /* returnType */ boolean, /* weight */ Weight ]
/**
 ...
 */
export function scan_int(pos: string | null): [ /* returnType */ boolean, /* pos */ string | null, /* out */ number ]
/**
 ...
 * @returns %FALSE if a parse error occurred
 */
export function scan_string(pos: string | null, out: GLib.String): [ /* returnType */ boolean, /* pos */ string | null ]
/**
 ...
 * @returns %FALSE if a parse error occurred
 */
export function scan_word(pos: string | null, out: GLib.String): [ /* returnType */ boolean, /* pos */ string | null ]
/**
 ...
 */
export function shape(text: string | null, length: number, analysis: Analysis, glyphs: GlyphString): void
/**
 * Convert the characters in `text` into glyphs.
 * 
 * Given a segment of text and the corresponding `PangoAnalysis` structure
 ...
 * @param glyphs glyph string in which to store results.
 */
export function shape_full(item_text: string | null, item_length: number, paragraph_text: string | null, paragraph_length: number, analysis: Analysis, glyphs: GlyphString): void
/**
 ...
 */
export function shape_item(item: Item, paragraph_text: string | null, paragraph_length: number, log_attrs: LogAttr | null, glyphs: GlyphString, flags: ShapeFlags): void
/**
 * Convert the characters in `text` into glyphs.
 * 
 * Given a segment of text and the corresponding `PangoAnalysis` structure
 ...
 * @param flags flags influencing the shaping process
 */
export function shape_with_flags(item_text: string | null, item_length: number, paragraph_text: string | null, paragraph_length: number, analysis: Analysis, glyphs: GlyphString, flags: ShapeFlags): void
/**
 * Skips 0 or more characters of white space.
 * @param pos in/out string position
 * @returns %FALSE if skipping the white space leaves   the position at a '\0' character.
 */
export function skip_space(pos: string | null): [ /* returnType */ boolean, /* pos */ string | null ]
/**
 ...
 */
export function split_file_list(str: string | null): string[]
/**
 ...
 */
export function tab_array_from_string(text: string | null): TabArray | null
/**
 ...
 * @param attrs array with one `PangoLogAttr`   per character in `text,` plus one extra, to be filled in
 */
export function tailor_break(text: string | null, length: number, analysis: Analysis, offset: number, attrs: LogAttr[]): void
/**
 * Trims leading and trailing whitespace from a string.
 * @param str a string
 * @returns A newly-allocated string that must be freed with g_free()
 */
export function trim_string(str: string | null): string | null
/**
...
export interface FontFamily extends Gio.ListModel {

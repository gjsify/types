/**
 * The GIR-derived widget VOCABULARY for Pango-1.0.
 *
 * GENERATED — do not edit. Provenance: Pango-1.0 — library 1.58.2
 *
 * 4 instantiable GTypes (of which 0 concrete widgets), 5 declarations, 23 enum nick unions, 0 slot candidates.
 *
...
export type PangoTabAlignNick = 'left' | 'right' | 'center' | 'decimal';
...
export type PangoWidthNick = 'ultra-condensed' | 'extra-condensed' | 'condensed' | 'semi-condensed' | 'normal' | 'semi-expanded' | 'expanded' | 'extra-expanded' | 'ultra-expanded';
...
export interface PangoContextProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type PangoContextConstructOnly = GObjectConstructOnly;

/** A `PangoCoverage` structure is a map from Unicode characters to [enum@Pango.CoverageLevel] values. */
export interface PangoCoverageProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type PangoCoverageConstructOnly = GObjectConstructOnly;

/** A `PangoFontset` represents a set of `PangoFont` to use when rendering text. */
export interface PangoFontsetProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type PangoFontsetConstructOnly = GObjectConstructOnly;

/** `PangoFontsetSimple` is a implementation of the abstract `PangoFontset` base class as an array of fonts. */
export interface PangoFontsetSimpleProps extends PangoFontsetProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type PangoFontsetSimpleConstructOnly = PangoFontsetConstructOnly;

/** A `PangoLayout` structure represents an entire paragraph of text. */
export interface PangoLayoutProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type PangoLayoutConstructOnly = GObjectConstructOnly;

...
export const BUFFER_COPY_ALL: number
...
export const CLOCK_TIME_NONE: number
export const DEBUG_BG_MASK: number
export const DEBUG_FG_MASK: number
export const DEBUG_FORMAT_MASK: number
export const DISABLE_ALLOC_TRACE: number
export const DISABLE_GST_DEBUG: number
export const DISABLE_LOADSAVE: number
export const DISABLE_LOADSAVE_REGISTRY: number
export const DISABLE_PARSE: number
export const DISABLE_PLUGIN: number
export const DISABLE_REGISTRY: number
export const DISABLE_TRACE: number
export const DISABLE_XML: number
export const ERROR_SYSTEM: string
export const EVENT_TRACE_NAME: string
export const EVENT_TYPE_BOTH: number
export const EVENT_TYPE_SHIFT: number
export const FOURCC_FORMAT: string
export const HAVE_GLIB_2_8: number
export const HAVE_UNALIGNED_ACCESS: number
export const INDEX_ID_INVALID: number
export const LICENSE_UNKNOWN: string
export const MESSAGE_TRACE_NAME: string
export const MSECOND: number
export const M_PI: number
export const NSECOND: number
export const PADDING: number
export const PADDING_LARGE: number
export const PAD_LINK_CHECK_DEFAULT: number
...
export function allocTraceGet(name: string | null): AllocTrace
...
export function capsFromString(string: string | null): Caps
...
export function childProxyGetProperty(object: Object, name: string | null, value: any): void
export function childProxyLookup(object: Object, name: string | null, target: Object, pspec: GObject.ParamSpec): boolean
export function childProxySetProperty(object: Object, name: string | null, value: any): void
export function classSignalConnect(klass: ObjectClass, name: string | null, func: any, funcData: any): number
export function classSignalEmitByName(object: Object, name: string | null, self: libxml2.NodePtr): void
export function debugAddLogFunction(func: LogFunction): void
export function debugConstructTermColor(colorinfo: number): string | null
...
export function debugLevelGetName(level: DebugLevel): string | null
export function debugLogDefault(category: DebugCategory, level: DebugLevel, file: string | null, function_: string | null, line: number, object: GObject.Object, message: DebugMessage, unused: any): void
export function debugPrintStackTrace(): void
export function debugRemoveLogFunction(func: LogFunction): number
export function debugRemoveLogFunctionByData(data: any): number
...
export function debugSetThresholdForName(name: string | null, level: DebugLevel): void
export function debugUnsetThresholdForName(name: string | null): void
export function defaultRegistryCheckFeatureVersion(featureName: string | null, minMajor: number, minMinor: number, minMicro: number): boolean
export function deinit(): void
export function errorGetMessage(domain: GLib.Quark, code: number): string | null
export function flowGetName(ret: FlowReturn): string | null
export function flowToQuark(ret: FlowReturn): GLib.Quark
export function formatGetByNick(nick: string | null): Format
...
export function formatRegister(nick: string | null, description: string | null): Format
...
export function implementsInterfaceCast(from: any, type: GObject.GType): any
export function implementsInterfaceCheck(from: any, type: GObject.GType): boolean
...
export function isTagList(p: any): boolean
export function paramSpecFraction(name: string | null, nick: string | null, blurb: string | null, minNum: number, minDenom: number, maxNum: number, maxDenom: number, defaultNum: number, defaultDenom: number, flags: GObject.ParamFlags): GObject.ParamSpec
export function paramSpecMiniObject(name: string | null, nick: string | null, blurb: string | null, objectType: GObject.GType, flags: GObject.ParamFlags): GObject.ParamSpec
export function parseBinFromDescription(binDescription: string | null, ghostUnlinkedPads: boolean): Element
export function parseBinFromDescriptionFull(binDescription: string | null, ghostUnlinkedPads: boolean, context: ParseContext, flags: ParseFlags): Element
export function parseLaunch(pipelineDescription: string | null): Element
export function parseLaunchFull(pipelineDescription: string | null, context: ParseContext, flags: ParseFlags): Element
...
export function structureEmptyNew(name: string | null): Structure
export function structureFromString(string: string | null, end: string[]): Structure
export function structureIdEmptyNew(quark: GLib.Quark): Structure
export function tagExists(tag: string | null): boolean
export function tagGetDescription(tag: string | null): string | null
export function tagGetFlag(tag: string | null): TagFlag
export function tagGetNick(tag: string | null): string | null
export function tagGetType(tag: string | null): GObject.GType
export function tagIsFixed(tag: string | null): boolean
export function tagListCopyValue(dest: any, list: TagList, tag: string | null): boolean
export function tagMergeStringsWithComma(dest: any, src: any): void
export function tagMergeUseFirst(dest: any, src: any): void
export function tagRegister(name: string | null, flag: TagFlag, type: GObject.GType, nick: string | null, blurb: string | null, func: TagMergeFunc): void
...
export function typeFindHelperForExtension(obj: Object, extension: string | null): Caps
...
export function typeFindHelperGetRangeExt(obj: Object, func: TypeFindHelperGetRangeFunction, size: number, extension: string | null, prob: TypeFindProbability): Caps
export function typeFindRegister(plugin: Plugin, name: string | null, rank: number, func: TypeFindFunction, extensions: string[], possibleCaps: Caps, data: any, dataNotify: GLib.DestroyNotify): boolean
...
export function uriConstruct(protocol: string | null, location: string | null): string | null
export function uriGetLocation(uri: string | null): string | null
export function uriGetProtocol(uri: string | null): string | null
export function uriHasProtocol(uri: string | null, protocol: string | null): boolean
export function uriIsValid(uri: string | null): boolean
export function uriProtocolIsSupported(type: URIType, protocol: string | null): boolean
export function uriProtocolIsValid(protocol: string | null): boolean
export function utilArrayBinarySearch(array: any, numElements: number, elementSize: number, searchFunc: GLib.CompareDataFunc, mode: SearchMode, searchData: any, userData: any): any
export function utilDoubleToFraction(src: number): [ /* destN */ number, /* destD */ number ]
export function utilDumpMem(mem: number[], size: number): void
...
export function utilSetObjectArg(object: GObject.Object, name: string | null, value: string | null): void
export function utilSetValueFromString(value: any, valueStr: string | null): void
...
export function valueDeserialize(dest: any, src: string | null): boolean

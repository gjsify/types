 ...
 */
export function get_encoding_supported(encoding: string | null): boolean
/**
 ...
 */
export function get_features(): string | null
/**
...
export interface Terminal extends Atk.ImplementorIface, Gtk.Buildable, Gtk.Scrollable {
    ...
    connect_after(sigName: "text-deleted", callback: Terminal.TextDeletedSignalCallback): number
    emit(sigName: "text-deleted", ...args: any[]): void
    connect(sigName: "text-inserted", callback: Terminal.TextInsertedSignalCallback): number
    connect_after(sigName: "text-inserted", callback: Terminal.TextInsertedSignalCallback): number
    ...
    connect_after(sigName: "text-modified", callback: Terminal.TextModifiedSignalCallback): number
    ...
    connect_after(sigName: "text-scrolled", callback: Terminal.TextScrolledSignalCallback): number

...
export namespace Vte {
    ...
    class PtyError extends GLib.Error {
        // Own fields of Vte-2.91.PtyError
        ...
        // Constructors of Vte-2.91.PtyError

        constructor(options: { message: string; code: number });

        // Owm methods of Vte-2.91.PtyError
    ...
    class RegexError extends GLib.Error {
        // Own fields of Vte-2.91.RegexError
        ...
        // Constructors of Vte-2.91.RegexError

        constructor(options: { message: string; code: number });

        // Owm methods of Vte-2.91.RegexError
    ...
    class Pty extends GObject.Object {
        // Own properties of Vte-2.91.Pty
    ...
    class Terminal extends Gtk.Widget {
        // Own properties of Vte-2.91.Terminal
        ...
        // Own fields of Vte-2.91.Terminal

        widget: Gtk.Widget;

        // Constructors of Vte-2.91.Terminal

        static ['new'](): Terminal;

        // Owm methods of Vte-2.91.Terminal
         ...
         * @returns %FALSE
         */
        event_check_gregex_simple(event: Gdk.Event, regexes: GLib.Regex[], match_flags: GLib.RegexMatchFlags): boolean;
        /**
         ...
         */
        get_color_background_for_draw(): void;
         ...
         */
        get_geometry_hints(min_rows: number, min_columns: number): void;
        /**
         ...
         * @returns a newly allocated string containing the selected text, or %NULL if there is no selection or the format is not supported
         */
        get_text_selected_full(format: Format): string | null;
         ...
         */
        match_check_event(event: Gdk.Event): string | null;
        /**
    ...
    class CharAttributes {
        // Constructors of Vte-2.91.CharAttributes
    ...
    class Regex {
        // Constructors of Vte-2.91.Regex

 ...
 *
 * GENERATED — do not edit. Provenance: Vte-2.91 — library 0.84.1 — dropped empty base(s): Atk.ImplementorIface
 *
 * 2 instantiable GTypes (of which 1 concrete widgets), 2 declarations, 10 enum nick unions, 2 slot candidates.
 *
...
import type { GtkBuildableConstructOnly, GtkBuildableProps, GtkScrollableConstructOnly, GtkScrollableProps, GtkWidgetConstructOnly, GtkWidgetProps } from '@girs/gtk-3.0/vocabulary';

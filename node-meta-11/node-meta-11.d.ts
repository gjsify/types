 ...
 */
function laterAdd(when: LaterType, func: GLib.SourceFunc): number
/**
 * Removes a callback added with meta_later_add()
 * @param laterId the integer ID returned from meta_later_add()
 */
function laterRemove(laterId: number): void
...
function prefsGetMouseButtonMods(): VirtualModifier
...
function x11InitGdkDisplay(): boolean

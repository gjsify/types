/**
 * The GIR-derived widget VOCABULARY for St-17.
 *
...
import type { ClutterActionConstructOnly, ClutterActionProps, ClutterActorAccessibleConstructOnly, ClutterActorAccessibleProps, ClutterActorConstructOnly, ClutterActorMetaConstructOnly, ClutterActorMetaProps, ClutterActorProps, ClutterAnimatableConstructOnly, ClutterAnimatableProps, ClutterContentConstructOnly, ClutterContentProps, ClutterEffectConstructOnly, ClutterEffectProps, ClutterGestureConstructOnly, ClutterGestureProps, ClutterInputContentPurposeNick, ClutterOffscreenEffectConstructOnly, ClutterOffscreenEffectProps, ClutterOrientationNick, ClutterShaderEffectConstructOnly, ClutterShaderEffectProps } from '@girs/clutter-17/vocabulary';

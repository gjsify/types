...
_init(...args: any[]): void;
    ...
    contacts_query_open_view(query: string, params: GLib.HashTable<string, string>, cb: ClientServiceContactsQueryOpenViewCallback): void
    ...
    query_open_view(query: string, params: GLib.HashTable<string, string>, cb: ClientServiceQueryOpenViewCallback): void
    request_avatar(): void
    update_status(cb: ClientServiceUpdateStatusCallback, status_msg: string): void
    update_status_with_fields(cb: ClientServiceUpdateStatusCallback, status_msg: string, fields: GLib.HashTable<string, string>): void

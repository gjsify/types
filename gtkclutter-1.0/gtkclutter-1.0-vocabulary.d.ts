...
export interface GtkClutterActorProps extends ClutterActorProps, ClutterAnimatableProps, ClutterContainerProps, ClutterScriptableProps {
    /** The #GtkWidget to be embedded into the #GtkClutterActor */
    contents?: Gtk.Widget;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GtkClutterActorConstructOnly = ClutterActorConstructOnly | ClutterAnimatableConstructOnly | ClutterContainerConstructOnly | ClutterScriptableConstructOnly;
...
export interface GtkClutterTextureProps extends ClutterTextureProps, ClutterAnimatableProps, ClutterContainerProps, ClutterScriptableProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GtkClutterTextureConstructOnly = ClutterTextureConstructOnly | ClutterAnimatableConstructOnly | ClutterContainerConstructOnly | ClutterScriptableConstructOnly;

...
export namespace Json {
    ...
    class ParserError extends GLib.Error {
        // Own fields of Json-1.0.ParserError
         ...
         */
        TRAILING_COMMA: number;
        /**
         * expected comma
         */
        MISSING_COMMA: number;
        /**
         * expected colon
         */
        MISSING_COLON: number;
        /**
         * invalid bareword
         */
        INVALID_BAREWORD: number;
        /**
         * empty member name (Since: 0.16)
         */
        EMPTY_MEMBER_NAME: number;
        /**
        ...
        // Constructors of Json-1.0.ParserError

        constructor(options: { message: string; code: number });

        // Owm methods of Json-1.0.ParserError
    ...
    class PathError extends GLib.Error {
        // Own fields of Json-1.0.PathError
        ...
        // Constructors of Json-1.0.PathError

        constructor(options: { message: string; code: number });

        // Owm methods of Json-1.0.PathError
    ...
    class ReaderError extends GLib.Error {
        // Own fields of Json-1.0.ReaderError
        ...
        // Constructors of Json-1.0.ReaderError

        constructor(options: { message: string; code: number });

        // Owm methods of Json-1.0.ReaderError
     ...
     */
    function boxed_can_serialize(gboxed_type: GObject.GType): boolean;
    /**
    ...
    class Builder extends GObject.Object {
        // Own properties of Json-1.0.Builder
        ...
        // Constructors of Json-1.0.Builder

        static ['new'](): Builder;

        static new_immutable(): Builder;

        // Owm methods of Json-1.0.Builder
    ...
    class Generator extends GObject.Object {
        // Own properties of Json-1.0.Generator
        ...
        // Constructors of Json-1.0.Generator

        static ['new'](): Generator;

        // Owm methods of Json-1.0.Generator
    ...
    class Parser extends GObject.Object {
        // Own properties of Json-1.0.Parser
        ...
        // Constructors of Json-1.0.Parser

        static ['new'](): Parser;

        static new_immutable(): Parser;

        // Owm methods of Json-1.0.Parser
    ...
    class Path extends GObject.Object {
        // Constructors of Json-1.0.Path

        static ['new'](): Path;

        // Owm methods of Json-1.0.Path
    ...
    class Reader extends GObject.Object {
        // Own properties of Json-1.0.Reader
        ...
        // Constructors of Json-1.0.Reader

        static ['new'](node?: Node | null): Reader;

        // Owm methods of Json-1.0.Reader
     ...
     */
    class Array {
        // Constructors of Json-1.0.Array
     ...
     */
    class Object {
        // Constructors of Json-1.0.Object

        constructor(properties?: Partial<{}>);

        static ['new'](): Object;

        // Owm methods of Json-1.0.Object
     ...
     */
    class ObjectIter {
        // Constructors of Json-1.0.ObjectIter

        constructor(properties?: Partial<{}>);

        // Owm methods of Json-1.0.ObjectIter
    ...
    interface Serializable {
        // Owm methods of Json-1.0.Serializable
         ...
         * @returns `TRUE` if the property was successfully deserialized
         */
        deserialize_property(property_name: string, pspec: GObject.ParamSpec, property_node: Node): boolean;
        /**
         ...
         * @param pspec a property description
         */
        get_property(pspec: GObject.ParamSpec): void;
        /**
        ...
        // Own virtual methods of Json-1.0.Serializable
         ...
         * @param property_node the JSON node containing the serialized property
         */
        vfunc_deserialize_property(property_name: string, pspec: GObject.ParamSpec, property_node: Node): boolean;
        /**
         * Calls the [vfunc`Json`.Serializable.find_property] implementation on
         * the `JsonSerializable` instance, which will return the property
         * description for the given name.
         ...
         * @param pspec a property description
         */
        vfunc_get_property(pspec: GObject.ParamSpec): void;
        /**
         * Asks a `JsonSerializable` implementation to serialize an object
         * property into a JSON node.
         * @param property_name the name of the property to serialize

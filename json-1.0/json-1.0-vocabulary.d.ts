/**
 * The GIR-derived widget VOCABULARY for Json-1.0.
 *
 * GENERATED — do not edit. Provenance: Json-1.0 — library 1.10.8
 *
...
export type JsonNodeTypeNick = 'object' | 'array' | 'value' | 'null';
...
export interface JsonBuilderProps extends GObjectProps {
    /**
...
export type JsonBuilderConstructOnly = GObjectConstructOnly | 'immutable';
...
export interface JsonGeneratorProps extends GObjectProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type JsonGeneratorConstructOnly = GObjectConstructOnly;

/** `JsonParser` provides an object for parsing a JSON data stream, either inside a file or inside a static buffer. */
export interface JsonParserProps extends GObjectProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type JsonParserConstructOnly = GObjectConstructOnly | 'immutable';

/** `JsonPath` is a simple class implementing the JSONPath syntax for extracting data out of a JSON tree. */
export interface JsonPathProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type JsonPathConstructOnly = GObjectConstructOnly;

/** `JsonReader` provides a simple, cursor-based API for parsing a JSON DOM. */
export interface JsonReaderProps extends GObjectProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type JsonReaderConstructOnly = GObjectConstructOnly;

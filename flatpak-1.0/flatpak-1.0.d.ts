...
static new_for_installation(installation: Installation, cancellable?: (Gio.Cancellable | null)): Transaction;
    ...
    connect(signal: 'add-new-remote', callback: ((_source: this, reason: TransactionRemoteReason, from_id: string, suggested_remote_name: string, url: string) => boolean)): number
    connect_after(signal: 'add-new-remote', callback: ((_source: this, reason: TransactionRemoteReason, from_id: string, suggested_remote_name: string, url: string) => boolean)): number
    emit(signal: 'add-new-remote', reason: TransactionRemoteReason, from_id: string, suggested_remote_name: string, url: string): void
    connect(signal: 'basic-auth-start', callback: ((_source: this, remote: string, realm: string, options: GLib.Variant, id: number) => boolean)): number
    connect_after(signal: 'basic-auth-start', callback: ((_source: this, remote: string, realm: string, options: GLib.Variant, id: number) => boolean)): number
    emit(signal: 'basic-auth-start', remote: string, realm: string, options: GLib.Variant, id: number): void
    connect(signal: 'choose-remote-for-ref', callback: ((_source: this, for_ref: string, runtime_ref: string, remotes: string[]) => number)): number
    connect_after(signal: 'choose-remote-for-ref', callback: ((_source: this, for_ref: string, runtime_ref: string, remotes: string[]) => number)): number
    emit(signal: 'choose-remote-for-ref', for_ref: string, runtime_ref: string, remotes: string[]): void
    connect(signal: 'end-of-lifed', callback: ((_source: this, ref: string, reason: string, rebase: string) => void)): number
    connect_after(signal: 'end-of-lifed', callback: ((_source: this, ref: string, reason: string, rebase: string) => void)): number
    emit(signal: 'end-of-lifed', ref: string, reason: string, rebase: string): void
    connect(signal: 'end-of-lifed-with-rebase', callback: ((_source: this, remote: string, ref: string, reason: string, rebased_to_ref: string, previous_ids: string[]) => boolean)): number
    connect_after(signal: 'end-of-lifed-with-rebase', callback: ((_source: this, remote: string, ref: string, reason: string, rebased_to_ref: string, previous_ids: string[]) => boolean)): number
    emit(signal: 'end-of-lifed-with-rebase', remote: string, ref: string, reason: string, rebased_to_ref: string, previous_ids: string[]): void
    connect(signal: 'install-authenticator', callback: ((_source: this, remote: string, authenticator_ref: string) => void)): number
    connect_after(signal: 'install-authenticator', callback: ((_source: this, remote: string, authenticator_ref: string) => void)): number
    emit(signal: 'install-authenticator', remote: string, authenticator_ref: string): void
    connect(signal: 'new-operation', callback: ((_source: this, operation: TransactionOperation, progress: TransactionProgress) => void)): number
    connect_after(signal: 'new-operation', callback: ((_source: this, operation: TransactionOperation, progress: TransactionProgress) => void)): number
    emit(signal: 'new-operation', operation: TransactionOperation, progress: TransactionProgress): void
    connect(signal: 'operation-done', callback: ((_source: this, operation: TransactionOperation, commit: string, result: TransactionResult) => void)): number
    connect_after(signal: 'operation-done', callback: ((_source: this, operation: TransactionOperation, commit: string, result: TransactionResult) => void)): number
    emit(signal: 'operation-done', operation: TransactionOperation, commit: string, result: TransactionResult): void
    connect(signal: 'operation-error', callback: ((_source: this, operation: TransactionOperation, error: GLib.Error, details: TransactionErrorDetails) => boolean)): number
    connect_after(signal: 'operation-error', callback: ((_source: this, operation: TransactionOperation, error: GLib.Error, details: TransactionErrorDetails) => boolean)): number
    emit(signal: 'operation-error', operation: TransactionOperation, error: GLib.Error, details: TransactionErrorDetails): void
    ...
    connect(signal: 'webflow-start', callback: ((_source: this, remote: string, url: string, options: GLib.Variant, id: number) => boolean)): number
    connect_after(signal: 'webflow-start', callback: ((_source: this, remote: string, url: string, options: GLib.Variant, id: number) => boolean)): number

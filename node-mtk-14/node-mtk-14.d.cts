...
export function rectangleFromGrapheneRect(rect: Graphene.Rect, roundingStrategy: RoundingStrategy): /* dest */ Rectangle
export function regionCreate(): Region
export function regionCreateRectangle(rect: Rectangle): Region
export function regionCreateRectangles(rects: Rectangle, nRects: number): Region
export function x11ErrorsDeinit(): void

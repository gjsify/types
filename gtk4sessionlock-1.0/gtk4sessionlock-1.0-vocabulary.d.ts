/**
 * The GIR-derived widget VOCABULARY for Gtk4SessionLock-1.0.
 *
 * GENERATED — do not edit. Provenance: Gtk4SessionLock-1.0
 *
...
export interface GtkSessionLockInstanceProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GtkSessionLockInstanceConstructOnly = GObjectConstructOnly;

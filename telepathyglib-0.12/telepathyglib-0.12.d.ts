 ...
 */
function dbus_properties_mixin_get(self: GObject.Object, interface_name: string, property_name: string, value: GObject.Value): boolean
/**
 ...
 */
function dbus_properties_mixin_getter_gobject_properties(object: GObject.Object, iface: GLib.Quark, name: GLib.Quark, value: GObject.Value, getter_data?: (any | null)): void
/**
 ...
 */
function dbus_properties_mixin_set(self: GObject.Object, interface_name: string, property_name: string, value: GObject.Value): boolean
/**
 ...
 * @returns %TRUE
 */
function dbus_properties_mixin_setter_gobject_properties(object: GObject.Object, iface: GLib.Quark, name: GLib.Quark, value: GObject.Value, setter_data?: (any | null)): boolean
/**
 ...
 */
function list_connection_managers_async(dbus_daemon?: (DBusDaemon | null), callback?: (Gio.AsyncReadyCallback<(DBusDaemon | null)> | null)): void
/**
...
interface ConnectionHoldHandlesCb<A = GObject.Object> {
    (connection: Connection, handle_type: HandleType, n_handles: number, handles: Handle, error: GLib.Error, weak_object: A): void
}
...
interface ConnectionRequestHandlesCb<A = GObject.Object> {
    (connection: Connection, handle_type: HandleType, handles: number[], ids: string[], error: GLib.Error, weak_object: A): void
}
...
module Account {
    ...
    interface StatusChanged {
        (old_status: number, new_status: number, reason: number, dbus_error_name: (string | null), details: GLib.HashTable<string, GObject.Value>): void
    }
...
static ["new"](bus_daemon: DBusDaemon, object_path: string): Account;
    ...
    connect(signal: 'presence-changed', callback: ((_source: this, presence: number, status: string, status_message: string) => void)): number
    connect_after(signal: 'presence-changed', callback: ((_source: this, presence: number, status: string, status_message: string) => void)): number
    emit(signal: 'presence-changed', presence: number, status: string, status_message: string): void
    connect(signal: 'status-changed', callback: ((_source: this, old_status: number, new_status: number, reason: number, dbus_error_name: string | null, details: GLib.HashTable<string, GObject.Value>) => void)): number
    connect_after(signal: 'status-changed', callback: ((_source: this, old_status: number, new_status: number, reason: number, dbus_error_name: string | null, details: GLib.HashTable<string, GObject.Value>) => void)): number
    emit(signal: 'status-changed', old_status: number, new_status: number, reason: number, dbus_error_name: (string | null), details: GLib.HashTable<string, GObject.Value>): void
     ...
     * @param callback a callback to call when the request is satisfied
     */
    request_presence_async(type: ConnectionPresenceType, status: string, message: string, callback?: (Gio.AsyncReadyCallback<this> | null)): void
    /**
     ...
     * @param callback a callback to call when the request is satisfied
     */
    set_automatic_presence_async(type: ConnectionPresenceType, status: string, message: string, callback?: (Gio.AsyncReadyCallback<this> | null)): void
    /**
     ...
     * @param callback a callback to call when the request is satisfied
     */
    set_uri_scheme_association_async(scheme: string, associate: boolean, callback?: (Gio.AsyncReadyCallback<this> | null)): void
    /**
     ...
     * @param callback a callback to call when the request is satisfied
     */
    update_parameters_async(parameters: GLib.HashTable<string, GObject.Value>, unset_parameters: string, callback?: (Gio.AsyncReadyCallback<this> | null)): void
    /**
...
static ["new"](account: Account, request: GLib.HashTable<string, GObject.Value>, user_action_time: number): AccountChannelRequest;
...
static new_vardict(account: Account, request: GLib.Variant, user_action_time: number): AccountChannelRequest;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 're-handled', callback: ((_source: this, channel: Channel, user_action_time: number, context: HandleChannelsContext) => void)): number
    connect_after(signal: 're-handled', callback: ((_source: this, channel: Channel, user_action_time: number, context: HandleChannelsContext) => void)): number
     ...
     * @param callback a callback to call when the request is satisfied
     */
    create_and_observe_channel_async(preferred_handler: string, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<this> | null)): void
    /**
     * Finishes an async channel creation started using
     ...
     * @param callback a callback to call when the request is satisfied
     */
    create_channel_async(preferred_handler: string, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<this> | null)): void
    /**
     * Finishes an async channel creation started using
     ...
     * @param callback a callback to call when the request is satisfied
     */
    ensure_and_observe_channel_async(preferred_handler: string, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<this> | null)): void
    /**
     * Finishes an async channel creation started using
     * tp_account_channel_request_create_and_observe_channel_async().
     * @param result a #GAsyncResult
     ...
     * @param callback a callback to call when the request is satisfied
     */
    ensure_channel_async(preferred_handler: string, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<this> | null)): void
    /**
     * Finishes an async channel creation started using
...
static new_with_factory(factory: SimpleClientFactory): AccountManager;
    ...
    connect(signal: 'account-validity-changed', callback: ((_source: this, account: Account, valid: boolean) => void)): number
    connect_after(signal: 'account-validity-changed', callback: ((_source: this, account: Account, valid: boolean) => void)): number
    emit(signal: 'account-validity-changed', account: Account, valid: boolean): void
    connect(signal: 'most-available-presence-changed', callback: ((_source: this, presence: number, status: string, message: string) => void)): number
    connect_after(signal: 'most-available-presence-changed', callback: ((_source: this, presence: number, status: string, message: string) => void)): number
     ...
     * @param callback a callback to call when the request is satisfied
     */
    create_account_async(connection_manager: string, protocol: string, display_name: string, parameters: GLib.HashTable<string, GObject.Value>, properties: GLib.HashTable<string, GObject.Value>, callback?: (Gio.AsyncReadyCallback<this> | null)): void
    /**
...
_init(...args: any[]): void;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'request-added', callback: ((_source: this, account: Account, request: ChannelRequest) => void)): number
    connect_after(signal: 'request-added', callback: ((_source: this, account: Account, request: ChannelRequest) => void)): number
    emit(signal: 'request-added', account: Account, request: ChannelRequest): void
    connect(signal: 'request-removed', callback: ((_source: this, request: ChannelRequest, error: string, message: string) => void)): number
    connect_after(signal: 'request-removed', callback: ((_source: this, request: ChannelRequest, error: string, message: string) => void)): number
     ...
     * @param callback a callback to call when the request is satisfied
     */
    delegate_channels_async(channels: Channel[], user_action_time: number, preferred_handler: string, callback?: (Gio.AsyncReadyCallback<this> | null)): void
    /**
...
module CallChannel {
    ...
    interface StateChanged {
        (state: number, flags: number, reason: CallStateReason, details: GLib.HashTable<string, GObject.Value>): void
    }
...
_init(...args: any[]): void;
    ...
    connect(signal: 'content-removed', callback: ((_source: this, content: GObject.Object, reason: CallStateReason) => void)): number
    connect_after(signal: 'content-removed', callback: ((_source: this, content: GObject.Object, reason: CallStateReason) => void)): number
    emit(signal: 'content-removed', content: GObject.Object, reason: CallStateReason): void
    connect(signal: 'members-changed', callback: ((_source: this, updates: GLib.HashTable<Contact, number>, removed: Contact[], reason: CallStateReason) => void)): number
    connect_after(signal: 'members-changed', callback: ((_source: this, updates: GLib.HashTable<Contact, number>, removed: Contact[], reason: CallStateReason) => void)): number
    emit(signal: 'members-changed', updates: GLib.HashTable<Contact, number>, removed: Contact[], reason: CallStateReason): void
    connect(signal: 'state-changed', callback: ((_source: this, state: number, flags: number, reason: CallStateReason, details: GLib.HashTable<string, GObject.Value>) => void)): number
    connect_after(signal: 'state-changed', callback: ((_source: this, state: number, flags: number, reason: CallStateReason, details: GLib.HashTable<string, GObject.Value>) => void)): number
    emit(signal: 'state-changed', state: number, flags: number, reason: CallStateReason, details: GLib.HashTable<string, GObject.Value>): void
     ...
     * @param callback a callback to call when the operation finishes
     */
    add_content_async(name: string, type: MediaStreamType, initial_direction: MediaStreamDirection, callback?: (Gio.AsyncReadyCallback<this> | null)): void
    /**
     ...
     * @param callback a callback to call when the operation finishes
     */
    hangup_async(reason: CallStateChangeReason, detailed_reason: string, message: string, callback?: (Gio.AsyncReadyCallback<this> | null)): void
    /**
     ...
     * @param callback a callback to call when the operation finishes
     */
    send_tones_async(tones: string, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<this> | null)): void
    /**
...
_init(...args: any[]): void;
    ...
    connect(signal: 'streams-removed', callback: ((_source: this, streams: CallStream[], reason: CallStateReason) => void)): number
    connect_after(signal: 'streams-removed', callback: ((_source: this, streams: CallStream[], reason: CallStateReason) => void)): number
...
_init(...args: any[]): void;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'local-sending-state-changed', callback: ((_source: this, state: number, reason: CallStateReason) => void)): number
    connect_after(signal: 'local-sending-state-changed', callback: ((_source: this, state: number, reason: CallStateReason) => void)): number
    emit(signal: 'local-sending-state-changed', state: number, reason: CallStateReason): void
    connect(signal: 'remote-members-changed', callback: ((_source: this, updates: GLib.HashTable<Contact, number>, removed: Contact[], reason: CallStateReason) => void)): number
    connect_after(signal: 'remote-members-changed', callback: ((_source: this, updates: GLib.HashTable<Contact, number>, removed: Contact[], reason: CallStateReason) => void)): number
    emit(signal: 'remote-members-changed', updates: GLib.HashTable<Contact, number>, removed: Contact[], reason: CallStateReason): void
...
module Channel {
    ...
    interface GroupContactsChanged {
        (added: Contact[], removed: Contact[], local_pending: Contact[], remote_pending: Contact[], actor: Contact, details: GLib.HashTable<string, GObject.Value>): void
    }
    ...
    interface GroupMembersChanged {
        (message: string, added: unknown, removed: unknown, local_pending: unknown, remote_pending: unknown, actor: number, reason: number): void
    }

    interface GroupMembersChangedDetailed {
        (added: number[], removed: number[], local_pending: number[], remote_pending: number[], details: GLib.HashTable<string, GObject.Value>): void
    }
...
static new_from_properties(conn: Connection, object_path: string, immutable_properties: GLib.HashTable<string, GObject.Value>): Channel;
    ...
    connect_after(signal: 'chat-state-changed', callback: ((_source: this, contact: number, state: number) => void)): number
    emit(signal: 'chat-state-changed', contact: number, state: number): void
    connect(signal: 'group-contacts-changed', callback: ((_source: this, added: Contact[], removed: Contact[], local_pending: Contact[], remote_pending: Contact[], actor: Contact, details: GLib.HashTable<string, GObject.Value>) => void)): number
    connect_after(signal: 'group-contacts-changed', callback: ((_source: this, added: Contact[], removed: Contact[], local_pending: Contact[], remote_pending: Contact[], actor: Contact, details: GLib.HashTable<string, GObject.Value>) => void)): number
    emit(signal: 'group-contacts-changed', added: Contact[], removed: Contact[], local_pending: Contact[], remote_pending: Contact[], actor: Contact, details: GLib.HashTable<string, GObject.Value>): void
    connect(signal: 'group-flags-changed', callback: ((_source: this, added: number, removed: number) => void)): number
    connect_after(signal: 'group-flags-changed', callback: ((_source: this, added: number, removed: number) => void)): number
    emit(signal: 'group-flags-changed', added: number, removed: number): void
    connect(signal: 'group-members-changed', callback: ((_source: this, message: string, added: unknown, removed: unknown, local_pending: unknown, remote_pending: unknown, actor: number, reason: number) => void)): number
    connect_after(signal: 'group-members-changed', callback: ((_source: this, message: string, added: unknown, removed: unknown, local_pending: unknown, remote_pending: unknown, actor: number, reason: number) => void)): number
    emit(signal: 'group-members-changed', message: string, added: unknown, removed: unknown, local_pending: unknown, remote_pending: unknown, actor: number, reason: number): void
    connect(signal: 'group-members-changed-detailed', callback: ((_source: this, added: number[], removed: number[], local_pending: number[], remote_pending: number[], details: GLib.HashTable<string, GObject.Value>) => void)): number
    connect_after(signal: 'group-members-changed-detailed', callback: ((_source: this, added: number[], removed: number[], local_pending: number[], remote_pending: number[], details: GLib.HashTable<string, GObject.Value>) => void)): number
    emit(signal: 'group-members-changed-detailed', added: number[], removed: number[], local_pending: number[], remote_pending: number[], details: GLib.HashTable<string, GObject.Value>): void
     ...
     */
    group_get_local_pending_contact_info(local_pending: Contact): [boolean, Contact | null, ChannelGroupChangeReason | null, string]
    /**
     ...
     * @returns %TRUE if the contact is in fact local-pending
     */
    group_get_local_pending_info(local_pending: Handle): [boolean, Handle | null, ChannelGroupChangeReason | null, string]
    /**
     * If `self` is a group and the %TP_CHANNEL_FEATURE_GROUP feature has been
...
static ["new"](bus_daemon: DBusDaemon, object_path: string, immutable_properties: GLib.HashTable<any, any>): ChannelDispatchOperation;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'channel-lost', callback: ((_source: this, channel: Channel, domain: number, code: number, message: string) => void)): number
    connect_after(signal: 'channel-lost', callback: ((_source: this, channel: Channel, domain: number, code: number, message: string) => void)): number
     ...
     * @param callback a callback to call when the request has been satisfied
     */
    leave_channels_async(reason: ChannelGroupChangeReason, message: string, callback?: (Gio.AsyncReadyCallback<this> | null)): void
    /**
     * Finishes an async operation initiated using
...
static ["new"](bus_daemon: DBusDaemon, object_path: string, immutable_properties: GLib.HashTable<any, any>): ChannelRequest;
    ...
    connect(signal: 'succeeded-with-channel', callback: ((_source: this, connection: Connection, channel: Channel) => void)): number
    connect_after(signal: 'succeeded-with-channel', callback: ((_source: this, connection: Connection, channel: Channel) => void)): number
...
static ["new"](dbus: DBusDaemon, bus_name?: (string | null), object_path?: (string | null)): Connection;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'balance-changed', callback: ((_source: this, balance: number, balance_scale: number, balance_currency: string) => void)): number
    connect_after(signal: 'balance-changed', callback: ((_source: this, balance: number, balance_scale: number, balance_currency: string) => void)): number
    emit(signal: 'balance-changed', balance: number, balance_scale: number, balance_currency: string): void
    connect(signal: 'blocked-contacts-changed', callback: ((_source: this, added: Contact[], removed: Contact[]) => void)): number
    connect_after(signal: 'blocked-contacts-changed', callback: ((_source: this, added: Contact[], removed: Contact[]) => void)): number
    emit(signal: 'blocked-contacts-changed', added: Contact[], removed: Contact[]): void
    connect(signal: 'contact-list-changed', callback: ((_source: this, added: Contact[], removed: Contact[]) => void)): number
    connect_after(signal: 'contact-list-changed', callback: ((_source: this, added: Contact[], removed: Contact[]) => void)): number
    ...
    connect_after(signal: 'group-renamed', callback: ((_source: this, old_name: string, new_name: string) => void)): number
     ...
     */
    dup_contact_by_id_async(id: string, features?: (ContactFeature[] | null), callback?: (Gio.AsyncReadyCallback<this> | null)): void
    /**
     ...
     * @param callback a callback to call when the operation finishes
     */
    request_subscription_async(contacts: Contact[], message: string, callback?: (Gio.AsyncReadyCallback<this> | null)): void
    /**
...
_init(...args: any[]): void;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'contact-groups-changed', callback: ((_source: this, added: string[], removed: string[]) => void)): number
    connect_after(signal: 'contact-groups-changed', callback: ((_source: this, added: string[], removed: string[]) => void)): number
    emit(signal: 'contact-groups-changed', added: string[], removed: string[]): void
    connect(signal: 'presence-changed', callback: ((_source: this, type: number, status: string, message: string) => void)): number
    connect_after(signal: 'presence-changed', callback: ((_source: this, type: number, status: string, message: string) => void)): number
    emit(signal: 'presence-changed', type: number, status: string, message: string): void
    connect(signal: 'subscription-states-changed', callback: ((_source: this, subscribe: number, publish: number, publish_request: string) => void)): number
    connect_after(signal: 'subscription-states-changed', callback: ((_source: this, subscribe: number, publish: number, publish_request: string) => void)): number
...
static new_finish(...args: never[]): any;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'search-results-received', callback: ((_source: this, results: ContactSearchResult[]) => void)): number
    connect_after(signal: 'search-results-received', callback: ((_source: this, results: ContactSearchResult[]) => void)): number
     ...
     */
    static new_async(account: Account, server: string, limit: number, callback?: (Gio.AsyncReadyCallback<ContactSearch> | null)): void
...
static ["new"](conn: Connection, object_path: string, immutable_properties: GLib.HashTable<string, GObject.Value>): FileTransferChannel;
...
static ["new"](dbus: DBusDaemon, cm_name: string, protocol_name: string, immutable_properties: GLib.HashTable<any, any>): Protocol;
...
static new_vardict(dbus: DBusDaemon, cm_name: string, protocol_name: string, immutable_properties: GLib.Variant): Protocol;
     ...
     * @param callback a callback to call when  the request is satisfied
     */
    normalize_contact_async(contact: string, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<this> | null)): void
    /**
     ...
     * @param callback a callback to call when the request is satisfied
     */
    normalize_contact_uri_async(uri: string, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<this> | null)): void
    /**
     ...
     * @param callback a callback to call when the request is satisfied
     */
    normalize_vcard_address_async(field: string, value: string, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<this> | null)): void
    /**
...
_init(...args: any[]): void;
    ...
    connect(signal: 'invalidated', callback: ((_source: this, domain: number, code: number, message: string) => void)): number
    connect_after(signal: 'invalidated', callback: ((_source: this, domain: number, code: number, message: string) => void)): number
...
static ["new"](dbus?: (DBusDaemon | null)): SimpleClientFactory;
     ...
     */
    ensure_channel(connection: Connection, object_path: string, immutable_properties: GLib.HashTable<string, GObject.Value>): Channel
    /**
     ...
     * @param callback a callback to call when the operation finishes
     */
    ensure_contact_by_id_async(connection: Connection, identifier: string, callback?: (Gio.AsyncReadyCallback<this> | null)): void
    /**
...
static ["new"](conn: Connection, object_path: string, immutable_properties: GLib.HashTable<string, GObject.Value>): StreamTubeChannel;
// Conflicted with TelepathyGLib.Channel.new
...
static ["new"](conn: Connection, object_path: string, immutable_properties: GLib.HashTable<string, GObject.Value>): TextChannel;
// Conflicted with TelepathyGLib.Channel.new
...
static ["new"](...args: never[]): any;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'contact-chat-state-changed', callback: ((_source: this, contact: Contact, state: number) => void)): number
    connect_after(signal: 'contact-chat-state-changed', callback: ((_source: this, contact: Contact, state: number) => void)): number
    ...
    connect(signal: 'message-sent', callback: ((_source: this, message: SignalledMessage, flags: number, token: string) => void)): number
    connect_after(signal: 'message-sent', callback: ((_source: this, message: SignalledMessage, flags: number, token: string) => void)): number
    ...
    connect_after(signal: 'pending-message-removed', callback: ((_source: this, message: SignalledMessage) => void)): number

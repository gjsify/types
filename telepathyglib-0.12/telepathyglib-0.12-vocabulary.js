...
export const PROP_TYPES = {
    'TpAccountChannelRequest.account': 'TpAccount',
    'TpAccountChannelRequest.user-action-time': 'gint64',
    'TpAccountRequest.account-manager': 'TpAccountManager',
    'TpAccountRequest.connection-manager': 'gchararray',
    'TpAccountRequest.display-name': 'gchararray',
    'TpAccountRequest.protocol': 'gchararray',
    'TpAddDispatchOperationContext.account': 'TpAccount',
    'TpAddDispatchOperationContext.connection': 'TpConnection',
    'TpAddDispatchOperationContext.dispatch-operation': 'TpChannelDispatchOperation',
    'TpBaseClient.account-manager': 'TpAccountManager',
    'TpBaseClient.channel-factory': 'GObject',
    'TpBaseClient.dbus-daemon': 'TpDBusDaemon',
    'TpBaseClient.factory': 'TpSimpleClientFactory',
    'TpBaseClient.name': 'gchararray',
    'TpBaseClient.uniquify-name': 'gboolean',
    'TpCallContent.channel': 'TpCallChannel',
    'TpCallContent.connection': 'TpConnection',
    'TpCallStream.connection': 'TpConnection',
    'TpCallStream.content': 'TpCallContent',
    'TpCapabilities.contact-specific': 'gboolean',
    'TpChannel.connection': 'TpConnection',
    'TpChannelDispatchOperation.account': 'TpAccount',
    'TpChannelDispatchOperation.connection': 'TpConnection',
    'TpChannelRequest.channel-factory': 'GObject',
    'TpConnectionManager.always-introspect': 'gboolean',
    'TpConnectionManager.manager-file': 'gchararray',
    'TpContactSearch.account': 'TpAccount',
    'TpContactSearch.limit': 'guint',
    'TpContactSearch.server': 'gchararray',
    'TpContactSearchResult.identifier': 'gchararray',
    'TpHandleChannelsContext.account': 'TpAccount',
    'TpHandleChannelsContext.connection': 'TpConnection',
    'TpHandleChannelsContext.user-action-time': 'gint64',
    'TpObserveChannelsContext.account': 'TpAccount',
    'TpObserveChannelsContext.connection': 'TpConnection',
    'TpObserveChannelsContext.dispatch-operation': 'TpChannelDispatchOperation',
    'TpProtocol.cm-name': 'gchararray',
    'TpProtocol.protocol-name': 'gchararray',
    'TpProxy.bus-name': 'gchararray',
    'TpProxy.dbus-daemon': 'TpDBusDaemon',
    'TpProxy.factory': 'TpSimpleClientFactory',
    'TpProxy.object-path': 'gchararray',
    'TpRoomList.account': 'TpAccount',
    'TpRoomList.server': 'gchararray',
    'TpSignalledMessage.sender': 'TpContact',
    'TpSimpleApprover.callback': 'gpointer',
    'TpSimpleApprover.destroy': 'gpointer',
    'TpSimpleApprover.user-data': 'gpointer',
    'TpSimpleClientFactory.dbus-daemon': 'TpDBusDaemon',
    'TpSimpleHandler.bypass-approval': 'gboolean',
    'TpSimpleHandler.callback': 'gpointer',
    'TpSimpleHandler.destroy': 'gpointer',
    'TpSimpleHandler.requests': 'gboolean',
    'TpSimpleHandler.user-data': 'gpointer',
    'TpSimpleObserver.callback': 'gpointer',
    'TpSimpleObserver.destroy': 'gpointer',
    'TpSimpleObserver.recover': 'gboolean',
    'TpSimpleObserver.user-data': 'gpointer',
    'TpStreamTubeConnection.channel': 'TpStreamTubeChannel',
    'TpStreamTubeConnection.contact': 'TpContact',
    'TpStreamTubeConnection.socket-connection': 'GSocketConnection',
    'TpTLSCertificate.parent': 'TpProxy',
    'TpTLSCertificateRejection.dbus-error': 'gchararray',
    'TpTLSCertificateRejection.reason': 'guint',
};

/**
 * The GIR-derived widget VOCABULARY for TelepathyFarstream-0.6.
 *
...
export interface TfChannelProps extends GObjectProps, GAsyncInitableProps {
    channel?: TelepathyGLib.Channel;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type TfChannelConstructOnly = GObjectConstructOnly | GAsyncInitableConstructOnly | 'channel';

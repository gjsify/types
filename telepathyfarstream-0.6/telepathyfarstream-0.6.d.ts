...
static new_finish(...args: never[]): any;
    ...
    connect_after(signal: 'fs-conference-added', callback: ((_source: this, conf: Farstream.Conference) => void)): number
    ...
    connect_after(signal: 'fs-conference-removed', callback: ((_source: this, conf: Farstream.Conference) => void)): number
...
_init(...args: any[]): void;
    ...
    connect(signal: 'src-pad-added', callback: ((_source: this, handle: number, stream: Farstream.Stream, pad: Gst.Pad, codec: Farstream.Codec) => void)): number
    connect_after(signal: 'src-pad-added', callback: ((_source: this, handle: number, stream: Farstream.Stream, pad: Gst.Pad, codec: Farstream.Codec) => void)): number
    emit(signal: 'src-pad-added', handle: number, stream: Farstream.Stream, pad: Gst.Pad, codec: Farstream.Codec): void
    connect(signal: 'start-receiving', callback: ((_source: this, handles: any, handle_count: number) => boolean)): number
    connect_after(signal: 'start-receiving', callback: ((_source: this, handles: any, handle_count: number) => boolean)): number
    ...
    connect(signal: 'stop-receiving', callback: ((_source: this, handles: any, handle_count: number) => void)): number
    connect_after(signal: 'stop-receiving', callback: ((_source: this, handles: any, handle_count: number) => void)): number

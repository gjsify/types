...
function backendsManagerGetDocument(mimeType: string | null): Document
function backendsManagerGetDocumentModuleName(document: Document): string | null
 ...
 */
function fileCompress(uri: string | null, type: CompressionType): string | null
/**
 ...
 */
function fileCopyMetadata(from: string | null, to: string | null): boolean
function fileGetMimeType(uri: string | null, fast: boolean): string | null
function fileGetMimeTypeFromFd(fd: number): string | null
 ...
 * @returns a newly allocated string URI, or %NULL on error
 */
function fileUncompress(uri: string | null, type: CompressionType): string | null
function getLocaleDir(): string | null
/**
 ...
 */
function mkstemp(tmpl: string | null, fileName: string | null): number
/**
 ...
 */
function mkstempFile(tmpl: string | null): Gio.File
...
function tmpFilenameUnlink(filename: string | null): void
function tmpUriUnlink(uri: string | null): void
/**
 ...
 */
function xferUriSimple(from: string | null, to: string | null): boolean
function xmpParse(xmp: string | null, size: number, info: DocumentInfo): boolean

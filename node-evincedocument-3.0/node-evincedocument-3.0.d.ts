 ...
 */
function fileCompress(uri: string, type: CompressionType): string | null
/**
...
function fileGetMimeType(uri: string, fast: boolean): string | null
 ...
 * @returns a newly allocated string URI, or %NULL on error
 */
function fileUncompress(uri: string, type: CompressionType): string | null
 ...
 */
function mkstemp(tmpl: string, fileName: string | null): number
/**

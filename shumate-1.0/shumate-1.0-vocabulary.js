...
export const ENUM_VALUES = {
    ...
    'ShumateGeometryType.multipolygon': 6,
    'ShumateGeometryType.point': 1,
    'ShumateGeometryType.polygon': 5,
    'ShumateGeometryType.unknown': 0,
    'ShumateMapProjection.mercator': 0,
    'ShumateState.done': 3,
    'ShumateState.loaded': 2,
    'ShumateState.loading': 1,
    'ShumateState.none': 0,
    'ShumateUnit.both': 0,
    'ShumateUnit.imperial': 2,
    'ShumateUnit.metric': 1,
    'ShumateVectorValueType.array': 5,
    'ShumateVectorValueType.boolean': 2,
    'ShumateVectorValueType.collator': 8,
    'ShumateVectorValueType.color': 4,
    'ShumateVectorValueType.formatted-string': 7,
    'ShumateVectorValueType.null': 0,
    'ShumateVectorValueType.number': 1,
    'ShumateVectorValueType.resolved-image': 6,
    'ShumateVectorValueType.string': 3,
};

...
_init(...args: any[]): void;
    ...
    connect(signal: 'received-data', callback: ((_source: this, x: number, y: number, zoom_level: number, bytes: GLib.Bytes) => void)): number
    connect_after(signal: 'received-data', callback: ((_source: this, x: number, y: number, zoom_level: number, bytes: GLib.Bytes) => void)): number
    emit(signal: 'received-data', x: number, y: number, zoom_level: number, bytes: GLib.Bytes): void

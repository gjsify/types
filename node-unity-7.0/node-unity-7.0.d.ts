...
function categoryRendererFromString(rendererName: string | null): CategoryRenderer
function categoryRendererToString(val: CategoryRenderer): string | null
function categoryContentTypeFromString(contentType: string | null): CategoryContentType
function categoryContentTypeToString(val: CategoryContentType): string | null
function filterRendererToString(renderer: FilterRenderer): string | null
function filterRendererFromString(rendererName: string | null): FilterRenderer
function scopeModuleGetVersion(): number
function scopeModuleLoadScopes(): AbstractScope[]
function objectUnref(object?: any | null): void

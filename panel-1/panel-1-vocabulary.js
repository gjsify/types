...
export const OWN_PROPS = {
    ...
    PanelGSettingsActionGroup: ['settings'],
    PanelLayeredSettings: ['path', 'schema-id'],
    PanelOmniBar: ['action-tooltip', 'icon-name', 'menu-model', 'popover', 'progress'],
    PanelPosition: ['area', 'area-set', 'column', 'column-set', 'depth', 'depth-set', 'row', 'row-set'],
    PanelSaveDelegate: ['icon', 'icon-name', 'is-draft', 'progress', 'subtitle', 'title'],
    PanelSaveDialog: ['close-after-save'],
    PanelSessionItem: ['id', 'module-name', 'position', 'type-hint', 'workspace'],
    PanelSettings: ['identifier', 'path', 'path-prefix', 'path-suffix', 'schema-id', 'schema-id-prefix'],
...
export const OWN_SIGNALS = {
    ...
    PanelLayeredSettings: ['changed'],
    PanelSaveDelegate: ['close', 'discard', 'save'],
    PanelSettings: ['changed'],
    PanelWidget: ['get-default-focus', 'presented'],
    PanelWorkbench: ['activate'],
};

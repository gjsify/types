...
export namespace Jcat {
    ...
    class BtCheckpoint extends GObject.Object {
        // Constructors of Jcat-1.0.BtCheckpoint

        static ['new'](blob: GLib.Bytes): BtCheckpoint;

        // Owm methods of Jcat-1.0.BtCheckpoint
    ...
    class BtVerifier extends GObject.Object {
        // Constructors of Jcat-1.0.BtVerifier

        static ['new'](blob: GLib.Bytes): BtVerifier;

        // Owm methods of Jcat-1.0.BtVerifier
    ...
    class Context extends GObject.Object {
        // Constructors of Jcat-1.0.Context

        static ['new'](): Context;

        // Owm methods of Jcat-1.0.Context
    ...
    class Engine extends GObject.Object {
        // Own properties of Jcat-1.0.Engine

        context: Context;
        kind: number;
        method: number;
        readonly verify_kind: number;
        readonly verifyKind: number;

        // Owm methods of Jcat-1.0.Engine
    ...
    class File extends GObject.Object {
        // Constructors of Jcat-1.0.File

        static ['new'](): File;

        // Owm methods of Jcat-1.0.File
    ...
    class Item extends GObject.Object {
        // Constructors of Jcat-1.0.Item

        static ['new'](id: string): Item;

        // Owm methods of Jcat-1.0.Item
    ...
    class Result extends GObject.Object {
        // Own properties of Jcat-1.0.Result

        authority: string;
        engine: Engine;
        timestamp: number;

        // Owm methods of Jcat-1.0.Result
    ...
    class BlobClass {
        // Own fields of Jcat-1.0.BlobClass

        padding: any[];
    }

    class BtCheckpointClass {}

    class BtVerifierClass {}

    class ContextClass {
        // Own fields of Jcat-1.0.ContextClass

        padding: any[];
    }

    class EngineClass {
        // Own fields of Jcat-1.0.EngineClass

        padding: any[];
    }

    class FileClass {
        // Own fields of Jcat-1.0.FileClass

        padding: any[];
    }

    class ItemClass {
        // Own fields of Jcat-1.0.ItemClass

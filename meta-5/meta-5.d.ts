...
export namespace Meta {
    ...
    class CursorTracker extends GObject.Object {
        ...
        /**
         * @returns `false` if the Wayland focus surface of the pointer will be forced to NULL while the pointer is hidden, `true` otherwise. This function is only meant to be used by the magnifier of the shell and will be removed in a future release.
         */
        get_keep_focus_while_hidden(): boolean;
        /**
         * @param x
         * @param y
         * @param mods
         ...
         * @param keep_focus whether to keep the cursor focus while hidden
         */
        set_keep_focus_while_hidden(keep_focus: boolean): void;
        /**
         * @param visible
         */

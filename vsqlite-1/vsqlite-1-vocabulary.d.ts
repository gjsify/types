/**
 * The GIR-derived widget VOCABULARY for Vsqlite-1.
 *
...
export interface VsqliteConnectionProps extends GObjectProps, VdaConnectionProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type VsqliteConnectionConstructOnly = GObjectConstructOnly | VdaConnectionConstructOnly;

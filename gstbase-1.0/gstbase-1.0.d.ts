...
import './gstbase-1.0-ambient.d.ts';
import './gstbase-1.0-import.d.ts';
/**
 * GstBase-1.0
 */
...
export namespace GstBase {
    ...
    class Adapter extends GObject.Object {
        // Constructors of GstBase-1.0.Adapter

        static ['new'](): Adapter;

        // Owm methods of GstBase-1.0.Adapter
    ...
    abstract class Aggregator extends Gst.Element {
        // Own properties of GstBase-1.0.Aggregator
        ...
        // Own fields of GstBase-1.0.Aggregator

        srcpad: Gst.Pad;

        // Owm methods of GstBase-1.0.Aggregator
    ...
    class AggregatorPad extends Gst.Pad {
        // Own properties of GstBase-1.0.AggregatorPad
        ...
        // Owm methods of GstBase-1.0.AggregatorPad
    ...
    abstract class BaseParse extends Gst.Element {
        // Own properties of GstBase-1.0.BaseParse
        ...
        // Own fields of GstBase-1.0.BaseParse
        ...
        // Owm methods of GstBase-1.0.BaseParse
         ...
         */
        convert_default(src_format: Gst.Format, src_value: number, dest_format: Gst.Format): boolean;
        /**
    ...
    abstract class BaseSink extends Gst.Element {
        // Own properties of GstBase-1.0.BaseSink
        ...
        // Own fields of GstBase-1.0.BaseSink
        ...
        // Owm methods of GstBase-1.0.BaseSink
    ...
    abstract class BaseSrc extends Gst.Element {
        // Own properties of GstBase-1.0.BaseSrc
        ...
        // Own fields of GstBase-1.0.BaseSrc
        ...
        // Owm methods of GstBase-1.0.BaseSrc
    ...
    abstract class BaseTransform extends Gst.Element {
        // Own properties of GstBase-1.0.BaseTransform

        qos: boolean;

        // Own fields of GstBase-1.0.BaseTransform
        ...
        // Owm methods of GstBase-1.0.BaseTransform
    ...
    class CollectPads extends Gst.Object {
        // Own fields of GstBase-1.0.CollectPads

        object: Gst.Object;

        // Constructors of GstBase-1.0.CollectPads

        static ['new'](): CollectPads;

        // Owm methods of GstBase-1.0.CollectPads
    ...
    class DataQueue extends GObject.Object {
        // Own properties of GstBase-1.0.DataQueue
        ...
        // Own fields of GstBase-1.0.DataQueue
    ...
    class BaseParseFrame {
        // Own fields of GstBase-1.0.BaseParseFrame

        flags: number;
        offset: number;
        overhead: number;

        // Constructors of GstBase-1.0.BaseParseFrame
        ...
        // Owm methods of GstBase-1.0.BaseParseFrame
    ...
    class BaseTransformClass {
        // Own fields of GstBase-1.0.BaseTransformClass
     ...
     */
    class BitReader {
        // Own fields of GstBase-1.0.BitReader
        ...
        // Constructors of GstBase-1.0.BitReader
        ...
        // Owm methods of GstBase-1.0.BitReader
         ...
         */
        get_bits_uint16(nbits: number): boolean;
        /**
         * Read `nbits` bits into `val` and update the current position.
         * @param nbits number of bits to read
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_bits_uint32(nbits: number): boolean;
        /**
         * Read `nbits` bits into `val` and update the current position.
         * @param nbits number of bits to read
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_bits_uint64(nbits: number): boolean;
        /**
         * Read `nbits` bits into `val` and update the current position.
         * @param nbits number of bits to read
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_bits_uint8(nbits: number): boolean;
        /**
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        peek_bits_uint16(nbits: number): boolean;
        /**
         * Read `nbits` bits into `val` but keep the current position.
         * @param nbits number of bits to read
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        peek_bits_uint32(nbits: number): boolean;
        /**
         * Read `nbits` bits into `val` but keep the current position.
         * @param nbits number of bits to read
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        peek_bits_uint64(nbits: number): boolean;
        /**
         * Read `nbits` bits into `val` but keep the current position.
         * @param nbits number of bits to read
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        peek_bits_uint8(nbits: number): boolean;
        /**
     ...
     */
    class BitWriter {
        // Own fields of GstBase-1.0.BitWriter

        data: number;
        bit_size: number;

        // Constructors of GstBase-1.0.BitWriter
        ...
        // Owm methods of GstBase-1.0.BitWriter
     ...
     */
    class ByteReader {
        // Own fields of GstBase-1.0.ByteReader

        data: Uint8Array;
        size: number;
        'byte': number;

        // Constructors of GstBase-1.0.ByteReader
        ...
        // Owm methods of GstBase-1.0.ByteReader
     ...
     */
    class ByteWriter {
        // Own fields of GstBase-1.0.ByteWriter

        alloc_size: number;
        fixed: boolean;
        owned: boolean;

        // Constructors of GstBase-1.0.ByteWriter
        ...
        // Owm methods of GstBase-1.0.ByteWriter
     ...
     */
    class CollectData {
        // Own fields of GstBase-1.0.CollectData
     ...
     */
    class FlowCombiner {
        // Constructors of GstBase-1.0.FlowCombiner

        constructor(properties?: Partial<{}>);

        static ['new'](): FlowCombiner;

        // Owm methods of GstBase-1.0.FlowCombiner

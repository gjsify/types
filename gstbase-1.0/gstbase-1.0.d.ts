 ...
 * @returns the #GstCaps corresponding to the data,     or %NULL if no type could be found. The caller should free the caps     returned with gst_caps_unref().
 */
function type_find_helper_for_data(obj: (Gst.Object | null), data: Uint8Array): [(Gst.Caps | null), Gst.TypeFindProbability | null]
/**
 ...
 * @returns the #GstCaps corresponding to the data,     or %NULL if no type could be found. The caller should free the caps     returned with gst_caps_unref().
 */
function type_find_helper_for_data_with_caps(obj: (Gst.Object | null), data: Uint8Array, caps: Gst.Caps): [(Gst.Caps | null), Gst.TypeFindProbability | null]
/**
 * Tries to find what type of data is contained in the given `data,` the
 * assumption being that the data represents the beginning of the stream or
 * file.
 ...
 * @returns the #GstCaps corresponding to the data,     or %NULL if no type could be found. The caller should free the caps     returned with gst_caps_unref().
 */
function type_find_helper_for_data_with_extension(obj: (Gst.Object | null), data: Uint8Array, extension?: (string | null)): [(Gst.Caps | null), Gst.TypeFindProbability | null]
/**
 ...
 * @returns the #GstCaps corresponding to the data     stream.  Returns %NULL if no #GstCaps matches the data stream.
 */
function type_find_helper_get_range(obj: Gst.Object, parent: (Gst.Object | null), func: TypeFindHelperGetRangeFunction, size: number, extension?: (string | null)): [(Gst.Caps | null), Gst.TypeFindProbability | null]
/**
 * Utility function to do pull-based typefinding. Unlike gst_type_find_helper()
 * however, this function will use the specified function `func` to obtain the
 * data needed by the typefind functions, rather than operating on a given
 ...
 */
function type_find_helper_get_range_full(obj: Gst.Object, parent: (Gst.Object | null), func: TypeFindHelperGetRangeFunction, size: number, extension: (string | null)): [Gst.FlowReturn, Gst.Caps, Gst.TypeFindProbability | null]
/**
...
_init(...args: any[]): void;
    ...
    connect(signal: 'samples-selected', callback: ((_source: this, segment: Gst.Segment, pts: number, dts: number, duration: number, info: Gst.Structure | null) => void)): number
    connect_after(signal: 'samples-selected', callback: ((_source: this, segment: Gst.Segment, pts: number, dts: number, duration: number, info: Gst.Structure | null) => void)): number
    emit(signal: 'samples-selected', segment: Gst.Segment, pts: number, dts: number, duration: number, info?: (Gst.Structure | null)): void
...
_init(...args: any[]): void;
    ...
    vfunc_transform_size(direction: Gst.PadDirection, caps: Gst.Caps, size: number, othercaps: Gst.Caps): [boolean, number]

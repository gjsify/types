 ...
 * @returns the #GstCaps corresponding to the data,     or %NULL if no type could be found. The caller should free the caps     returned with gst_caps_unref().
 */
function type_find_helper_for_buffer_with_caps(obj: Gst.Object | null, buf: Gst.Buffer, caps: Gst.Caps): [ /* returnType */ Gst.Caps | null, /* prob */ Gst.TypeFindProbability ]
/**
 * Tries to find what type of data is contained in the given #GstBuffer, the
 * assumption being that the buffer represents the beginning of the stream or
 * file.
 ...
 * @returns the #GstCaps corresponding to the data,     or %NULL if no type could be found. The caller should free the caps     returned with gst_caps_unref().
 */
function type_find_helper_for_data_with_caps(obj: Gst.Object | null, data: Uint8Array, caps: Gst.Caps): [ /* returnType */ Gst.Caps | null, /* prob */ Gst.TypeFindProbability ]
/**
 * Tries to find what type of data is contained in the given `data,` the
 * assumption being that the data represents the beginning of the stream or
 * file.
 ...
 */
function type_find_helper_for_extension(obj: Gst.Object | null, extension: string | null): Gst.Caps | null
/**
...
interface Aggregator {
    ...
    connect_after(sigName: "samples-selected", callback: Aggregator.SamplesSelectedSignalCallback): number
...
interface AggregatorPad {
    ...
    connect_after(sigName: "buffer-consumed", callback: AggregatorPad.BufferConsumedSignalCallback): number
...
interface CollectPads {
     ...
     */
    clip_running_time(cdata: CollectData, buf: Gst.Buffer, user_data: any | null): [ /* returnType */ Gst.FlowReturn, /* outbuf */ Gst.Buffer ]
    /**
...
interface QueueArray {
    ...
    push_tail_struct(p_struct: any | null): void
}

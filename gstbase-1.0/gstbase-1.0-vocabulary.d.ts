/**
 * The GIR-derived widget VOCABULARY for GstBase-1.0.
 *
 * GENERATED — do not edit. Provenance: GstBase-1.0
 *
 * 5 instantiable GTypes (of which 0 concrete widgets), 6 declarations, 1 enum nick unions, 0 slot candidates.
 *
...
export type GstAggregatorStartTimeSelectionNick = 'zero' | 'first' | 'set' | 'now';
...
export interface GstAggregatorPadProps extends GstPadProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GstAggregatorPadConstructOnly = GstPadConstructOnly;

 ...
 */
interface Parser_EntryParsedSignalCallback {
    ($obj: Parser, uri: string, metadata: GLib.HashTable): void
}

/**
 * Signal callback interface for `playlist-ended`
 */
interface Parser_PlaylistEndedSignalCallback {
    ($obj: Parser, uri: string): void
}

/**
 * Signal callback interface for `playlist-started`
 */
interface Parser_PlaylistStartedSignalCallback {
    ($obj: Parser, uri: string, metadata: GLib.HashTable): void
}
...
interface Parser {
    ...
    connect(sigName: "entry-parsed", callback: Parser_EntryParsedSignalCallback): number
    connect_after(sigName: "entry-parsed", callback: Parser_EntryParsedSignalCallback): number
    emit(sigName: "entry-parsed", uri: string, metadata: GLib.HashTable, ...args: any[]): void
    connect(sigName: "playlist-ended", callback: Parser_PlaylistEndedSignalCallback): number
    connect_after(sigName: "playlist-ended", callback: Parser_PlaylistEndedSignalCallback): number
    emit(sigName: "playlist-ended", uri: string, ...args: any[]): void
    connect(sigName: "playlist-started", callback: Parser_PlaylistStartedSignalCallback): number
    connect_after(sigName: "playlist-started", callback: Parser_PlaylistStartedSignalCallback): number
    emit(sigName: "playlist-started", uri: string, metadata: GLib.HashTable, ...args: any[]): void

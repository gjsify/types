...
function marshal_VOID__BOXED_ENUM_BOOLEAN(closure: GObject.TClosure, return_value: any, n_param_values: number, param_values: any, invocation_hint: object, marshal_data: object): void
/**
...
interface MediaSource_ContentChangedSignalCallback {
    ($obj: MediaSource, changed_medias: object[], change_type: MediaSourceChangeType, location_unknown: boolean): void
}
...
interface MediaSource {
    ...
    connect_after(sigName: "content-changed", callback: MediaSource_ContentChangedSignalCallback): number
    emit(sigName: "content-changed", changed_medias: object[], change_type: MediaSourceChangeType, location_unknown: boolean, ...args: any[]): void
...
interface PluginRegistry {
    ...
    connect_after(sigName: "source-added", callback: PluginRegistry_SourceAddedSignalCallback): number
    ...
    connect_after(sigName: "source-removed", callback: PluginRegistry_SourceRemovedSignalCallback): number

...
interface AsyncProgress {
    ...
    connect_after(sigName: "changed", callback: AsyncProgress_ChangedSignalCallback): number
...
interface Repo_GpgVerifyResultSignalCallback {
    ($obj: Repo, checksum: string, result: GpgVerifyResult): void
}
...
interface Repo {
    ...
    readonly remotes_config_dir: string

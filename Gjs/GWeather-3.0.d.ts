 ...
 */
interface Info_UpdatedSignalCallback {
    ($obj: Info): void
}
...
interface Info {
    ...
    connect(sigName: "updated", callback: Info_UpdatedSignalCallback): number
    connect_after(sigName: "updated", callback: Info_UpdatedSignalCallback): number
...
interface LocationEntry_ConstructProps extends Atk.ImplementorIface_ConstructProps, Gtk.Buildable_ConstructProps, Gtk.CellEditable_ConstructProps, Gtk.Editable_ConstructProps, Gtk.SearchEntry_ConstructProps {
...
interface TimezoneMenu_ConstructProps extends Atk.ImplementorIface_ConstructProps, Gtk.Buildable_ConstructProps, Gtk.CellEditable_ConstructProps, Gtk.CellLayout_ConstructProps, Gtk.ComboBox_ConstructProps {

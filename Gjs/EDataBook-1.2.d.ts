...
interface BookBackend_ClosedSignalCallback {
    ($obj: BookBackend, sender: string): void
}
...
interface BookBackendSync {
     ...
     */
    contains_email(email_address: string, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    contains_email(...args: any[]): any
    contains_email(args_or_email_address: any[] | string, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): boolean | void | any
    /**
     * Creates one or more new contacts from `vcards,` and deposits an #EContact
     * instance for each newly-created contact in `out_contacts`.
     * 
     ...
     */
    create_contacts(vcards: string, opflags?: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    create_contacts(...args: any[]): any
    create_contacts(args_or_vcards: any[] | string, opflags?: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): boolean | void | any
    /**
     * Obtains an #EContact for `uid`.
     * 
     * The returned #EContact is referenced for thread-safety and must be
     ...
     */
    get_contact(uid: string, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    get_contact(...args: any[]): any
    get_contact(args_or_uid: any[] | string, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): EBookContacts.Contact | void | any
    /**
     * Obtains a set of #EContact instances which satisfy the criteria specified
     * in `query,` and deposits them in `out_contacts`.
     * 
     ...
     */
    get_contact_list(query: string, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    get_contact_list(...args: any[]): any
    get_contact_list(args_or_query: any[] | string, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): boolean | void | any
    /**
     * Obtains a set of ID strings for contacts which satisfy the criteria
     * specified in `query,` and deposits them in `out_uids`.
     * 
     ...
     */
    get_contact_list_uids(query: string, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    get_contact_list_uids(...args: any[]): any
    get_contact_list_uids(args_or_query: any[] | string, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): boolean | void | any
    /**
     * Modifies one or more contacts according to `vcards`.
     * 
     * If an error occurs, the function will set `error` and return %FALSE.
     ...
     */
    modify_contacts(vcards: string, opflags?: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    modify_contacts(...args: any[]): any
    modify_contacts(args_or_vcards: any[] | string, opflags?: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): boolean | void | any
    /**
     * "Opens" the `backend`.  Opening a backend is something of an outdated
     * concept, but the operation is hanging around for a little while longer.
     * This usually involves some custom initialization logic, and testing of
     ...
     */
    remove_contacts(uids: string[], opflags?: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    remove_contacts(...args: any[]): any
    remove_contacts(args_or_uids: any[] | string[], opflags?: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): boolean | void | any
...
interface BookCache_DupContactRevisionSignalCallback {
    ($obj: BookCache, object: EBookContacts.Contact): string
}
...
interface BookCache extends EDataServer.Extensible {
    ...
    connect_after(sigName: "dup-contact-revision", callback: BookCache_DupContactRevisionSignalCallback): number
    ...
    connect_after(sigName: "e164-changed", callback: BookCache_E164ChangedSignalCallback): number
...
interface BookMetaBackend {
    ...
    connect_after(sigName: "refresh-completed", callback: BookMetaBackend_RefreshCompletedSignalCallback): number
    ...
    connect_after(sigName: "source-changed", callback: BookMetaBackend_SourceChangedSignalCallback): number
...
interface BookSqlite_BeforeInsertContactSignalCallback {
    ($obj: BookSqlite, object: object | null, p0: EBookContacts.Contact, p1: string, p2: boolean, p3: GObject.Object, p4: object | null): boolean
}
...
interface BookSqlite_BeforeRemoveContactSignalCallback {
    ($obj: BookSqlite, object: object | null, p0: string, p1: Gio.Cancellable | null, p2: object | null): boolean
}
...
interface BookSqlite extends EDataServer.Extensible {
    ...
    connect_after(sigName: "before-insert-contact", callback: BookSqlite_BeforeInsertContactSignalCallback): number
    emit(sigName: "before-insert-contact", object: object | null, p0: EBookContacts.Contact, p1: string, p2: boolean, p3: GObject.Object, p4: object | null, ...args: any[]): void
    connect(sigName: "before-remove-contact", callback: BookSqlite_BeforeRemoveContactSignalCallback): number
    connect_after(sigName: "before-remove-contact", callback: BookSqlite_BeforeRemoveContactSignalCallback): number
    emit(sigName: "before-remove-contact", object: object | null, p0: string, p1: Gio.Cancellable | null, p2: object | null, ...args: any[]): void

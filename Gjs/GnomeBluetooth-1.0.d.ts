...
interface Chooser_SelectedDeviceActivatedSignalCallback {
    ($obj: Chooser, address: string): void
}
...
interface Chooser extends Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
    ...
    connect_after(sigName: "selected-device-activated", callback: Chooser_SelectedDeviceActivatedSignalCallback): number
    emit(sigName: "selected-device-activated", address: string, ...args: any[]): void
    connect(sigName: "selected-device-changed", callback: Chooser_SelectedDeviceChangedSignalCallback): number
    connect_after(sigName: "selected-device-changed", callback: Chooser_SelectedDeviceChangedSignalCallback): number
    emit(sigName: "selected-device-changed", address: string, ...args: any[]): void
...
interface ChooserButton extends Atk.ImplementorIface, Gtk.Actionable, Gtk.Activatable, Gtk.Buildable {
    ...
    connect_after(sigName: "chooser-created", callback: ChooserButton_ChooserCreatedSignalCallback): number
...
interface ChooserCombo extends Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
    ...
    connect_after(sigName: "chooser-created", callback: ChooserCombo_ChooserCreatedSignalCallback): number
    emit(sigName: "chooser-created", chooser: GObject.Object, ...args: any[]): void
...
interface Client {
    ...
    emit(sigName: "device-removed", device: string, ...args: any[]): void
...
interface SettingsWidget_PanelChangedSignalCallback {
    ($obj: SettingsWidget, panel: string): void
}
...
interface SettingsWidget extends Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
    ...
    connect_after(sigName: "adapter-status-changed", callback: SettingsWidget_AdapterStatusChangedSignalCallback): number
    ...
    connect_after(sigName: "panel-changed", callback: SettingsWidget_PanelChangedSignalCallback): number
    emit(sigName: "panel-changed", panel: string, ...args: any[]): void

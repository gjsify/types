...
interface Identity {
    ...
    connect_after(sigName: "removed", callback: Identity_RemovedSignalCallback): number
    emit(sigName: "removed", ...args: any[]): void
    connect(sigName: "signout", callback: Identity_SignoutSignalCallback): number
    connect_after(sigName: "signout", callback: Identity_SignoutSignalCallback): number

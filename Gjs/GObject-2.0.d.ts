...
interface Object {
    ...
    connect_after(sigName: "notify", callback: Object_NotifySignalCallback): number
...
interface SignalGroup {
    ...
    connect_after(sigName: "bind", callback: SignalGroup_BindSignalCallback): number
    emit(sigName: "bind", instance: Object, ...args: any[]): void
    connect(sigName: "unbind", callback: SignalGroup_UnbindSignalCallback): number
    connect_after(sigName: "unbind", callback: SignalGroup_UnbindSignalCallback): number

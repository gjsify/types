...
class Source {
     ...
     * @param changed_medias a #GPtrArray with the medias that changed or a common ancestor of them of type #GrlMedia.
     * @param change_type the kind of change that ocurred
     * @param location_unknown `TRUE` if the change happened in `media` itself or in one of its direct children (when `media` is a #GrlMedia). `FALSE` otherwise
     */

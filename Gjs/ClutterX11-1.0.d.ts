...
interface TexturePixmap extends Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
    ...
    connect_after(sigName: "queue-damage-redraw", callback: TexturePixmap_QueueDamageRedrawSignalCallback): number
    ...
    connect_after(sigName: "update-area", callback: TexturePixmap_UpdateAreaSignalCallback): number

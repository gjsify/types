...
interface CredentialsPrompter extends EDataServer.Extensible {
    ...
    connect_after(sigName: "get-dialog-parent", callback: CredentialsPrompter_GetDialogParentSignalCallback): number
    ...
    connect_after(sigName: "get-dialog-parent-full", callback: CredentialsPrompter_GetDialogParentFullSignalCallback): number
...
interface CredentialsPrompterImpl_PromptFinishedSignalCallback {
    ($obj: CredentialsPrompterImpl, prompt_id: object | null, credentials: EDataServer.NamedParameters | null): void
}
...
interface CredentialsPrompterImpl {
    ...
    connect_after(sigName: "prompt-finished", callback: CredentialsPrompterImpl_PromptFinishedSignalCallback): number
    emit(sigName: "prompt-finished", prompt_id: object | null, credentials: EDataServer.NamedParameters | null, ...args: any[]): void
...
interface RemindersWidget extends Atk.ImplementorIface, EDataServer.Extensible, Gtk.Buildable, Gtk.Orientable {
    ...
    get_settings(...args: any[]): Gio.Settings | Gtk.Settings | any
    ...
    connect_after(sigName: "activated", callback: RemindersWidget_ActivatedSignalCallback): number
    ...
    connect_after(sigName: "changed", callback: RemindersWidget_ChangedSignalCallback): number

...
class SimpleIgd {
     ...
     * @param external_port the external port requested in gupnp_simple_igd_add_port()
     * @param local_ip internal ip this is forwarded to
     ...
     * @param replaces_external_ip if this mapping replaces another mapping,  this is the old external IP
     * @param external_port the external port that was allocated
     * @param local_ip IP address that the router should forward the packets to. It  could be the address of another machine on the local network
     * @param local_port the local port

...
interface ElementAddedNotifier {
    ...
    connect_after(sigName: "element-added", callback: ElementAddedNotifier_ElementAddedSignalCallback): number
 ...
 * @class 
 */
class Participant extends Gst.Object {
...
interface Session {
    ...
    connect_after(sigName: "error", callback: Session_ErrorSignalCallback): number
 ...
 * @class 
 */
class Session extends Gst.Object {
...
interface Stream {
    ...
    connect_after(sigName: "error", callback: Stream_ErrorSignalCallback): number
    ...
    connect_after(sigName: "src-pad-added", callback: Stream_SrcPadAddedSignalCallback): number
...
interface StreamTransmitter_KnownSourcePacketReceivedSignalCallback {
    ($obj: StreamTransmitter, component: number, buffer: object): void
}
...
interface StreamTransmitter {
    ...
    connect_after(sigName: "error", callback: StreamTransmitter_ErrorSignalCallback): number
    emit(sigName: "error", errorno: Error, error_msg: string, ...args: any[]): void
    connect(sigName: "known-source-packet-received", callback: StreamTransmitter_KnownSourcePacketReceivedSignalCallback): number
    connect_after(sigName: "known-source-packet-received", callback: StreamTransmitter_KnownSourcePacketReceivedSignalCallback): number
    emit(sigName: "known-source-packet-received", component: number, buffer: object, ...args: any[]): void
    connect(sigName: "local-candidates-prepared", callback: StreamTransmitter_LocalCandidatesPreparedSignalCallback): number
    connect_after(sigName: "local-candidates-prepared", callback: StreamTransmitter_LocalCandidatesPreparedSignalCallback): number
    ...
    connect_after(sigName: "new-active-candidate-pair", callback: StreamTransmitter_NewActiveCandidatePairSignalCallback): number
    ...
    connect_after(sigName: "new-local-candidate", callback: StreamTransmitter_NewLocalCandidateSignalCallback): number
    ...
    connect_after(sigName: "state-changed", callback: StreamTransmitter_StateChangedSignalCallback): number
 ...
 * @class 
 */
class StreamTransmitter extends Gst.Object {
 ...
 */
interface Transmitter_GetRecvonlyFilterSignalCallback {
...
interface Transmitter {
    ...
    connect_after(sigName: "error", callback: Transmitter_ErrorSignalCallback): number
    emit(sigName: "error", errorno: Error, error_msg: string, ...args: any[]): void
    connect(sigName: "get-recvonly-filter", callback: Transmitter_GetRecvonlyFilterSignalCallback): number
    connect_after(sigName: "get-recvonly-filter", callback: Transmitter_GetRecvonlyFilterSignalCallback): number
 ...
 * @class 
 */
class Transmitter extends Gst.Object {

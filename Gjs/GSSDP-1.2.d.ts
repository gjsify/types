...
interface ResourceBrowser_ResourceUpdateSignalCallback {
    ($obj: ResourceBrowser, usn: string, boot_id: number, next_boot_id: number): void
}
...
interface ResourceBrowser {
    ...
    connect_after(sigName: "resource-update", callback: ResourceBrowser_ResourceUpdateSignalCallback): number
    emit(sigName: "resource-update", usn: string, boot_id: number, next_boot_id: number, ...args: any[]): void

...
interface RTPBaseAudioPayload {
    ...
    push(...args: any[]): any
    push(args_or_buffer: any[] | Gst.Buffer): Gst.FlowReturn | any
    /**
 ...
 */
interface RTPBaseDepayload_AddExtensionSignalCallback {
 ...
 */
interface RTPBaseDepayload_ClearExtensionsSignalCallback {
 ...
 */
interface RTPBaseDepayload_RequestExtensionSignalCallback {
    ($obj: RTPBaseDepayload, ext_id: number, ext_uri: string | null): RTPHeaderExtension
}
...
interface RTPBaseDepayload {
    ...
    connect(sigName: "add-extension", callback: RTPBaseDepayload_AddExtensionSignalCallback): number
    connect_after(sigName: "add-extension", callback: RTPBaseDepayload_AddExtensionSignalCallback): number
    emit(sigName: "add-extension", ext: RTPHeaderExtension, ...args: any[]): void
    connect(sigName: "clear-extensions", callback: RTPBaseDepayload_ClearExtensionsSignalCallback): number
    connect_after(sigName: "clear-extensions", callback: RTPBaseDepayload_ClearExtensionsSignalCallback): number
    emit(sigName: "clear-extensions", ...args: any[]): void
    connect(sigName: "request-extension", callback: RTPBaseDepayload_RequestExtensionSignalCallback): number
    connect_after(sigName: "request-extension", callback: RTPBaseDepayload_RequestExtensionSignalCallback): number
 ...
 * Signal callback interface for `add-extension`
 */
interface RTPBasePayload_AddExtensionSignalCallback {
 ...
 * Signal callback interface for `clear-extensions`
 */
interface RTPBasePayload_ClearExtensionsSignalCallback {
 ...
 * Signal callback interface for `request-extension`
 */
interface RTPBasePayload_RequestExtensionSignalCallback {
    ($obj: RTPBasePayload, ext_id: number, ext_uri: string): RTPHeaderExtension
}
...
interface RTPBasePayload {
    ...
    connect(sigName: "add-extension", callback: RTPBasePayload_AddExtensionSignalCallback): number
    connect_after(sigName: "add-extension", callback: RTPBasePayload_AddExtensionSignalCallback): number
    emit(sigName: "add-extension", ext: RTPHeaderExtension, ...args: any[]): void
    connect(sigName: "clear-extensions", callback: RTPBasePayload_ClearExtensionsSignalCallback): number
    connect_after(sigName: "clear-extensions", callback: RTPBasePayload_ClearExtensionsSignalCallback): number
    emit(sigName: "clear-extensions", ...args: any[]): void
    connect(sigName: "request-extension", callback: RTPBasePayload_RequestExtensionSignalCallback): number
    connect_after(sigName: "request-extension", callback: RTPBasePayload_RequestExtensionSignalCallback): number
    emit(sigName: "request-extension", ext_id: number, ext_uri: string, ...args: any[]): void

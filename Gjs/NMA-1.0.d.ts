...
interface BarCodeWidget_ConstructProps extends Atk.ImplementorIface_ConstructProps, Gtk.Buildable_ConstructProps, Gtk.Orientable_ConstructProps, Gtk.Box_ConstructProps {
...
interface CertChooser_ConstructProps extends Atk.ImplementorIface_ConstructProps, Gtk.Buildable_ConstructProps, Gtk.Orientable_ConstructProps, Gtk.Grid_ConstructProps {
 ...
 */
interface CertChooser_CertPasswordValidateSignalCallback {
 ...
 */
interface CertChooser_CertValidateSignalCallback {
    ($obj: CertChooser): GLib.Error
}
 ...
 */
interface CertChooser_ChangedSignalCallback {
 ...
 */
interface CertChooser_KeyPasswordValidateSignalCallback {
    ($obj: CertChooser): GLib.Error
}
 ...
 */
interface CertChooser_KeyValidateSignalCallback {
    ($obj: CertChooser): GLib.Error
}
...
interface CertChooser extends Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
    ...
    connect(sigName: "cert-password-validate", callback: CertChooser_CertPasswordValidateSignalCallback): number
    connect_after(sigName: "cert-password-validate", callback: CertChooser_CertPasswordValidateSignalCallback): number
    emit(sigName: "cert-password-validate", ...args: any[]): void
    connect(sigName: "cert-validate", callback: CertChooser_CertValidateSignalCallback): number
    connect_after(sigName: "cert-validate", callback: CertChooser_CertValidateSignalCallback): number
    emit(sigName: "cert-validate", ...args: any[]): void
    connect(sigName: "changed", callback: CertChooser_ChangedSignalCallback): number
    connect_after(sigName: "changed", callback: CertChooser_ChangedSignalCallback): number
    emit(sigName: "changed", ...args: any[]): void
    connect(sigName: "key-password-validate", callback: CertChooser_KeyPasswordValidateSignalCallback): number
    connect_after(sigName: "key-password-validate", callback: CertChooser_KeyPasswordValidateSignalCallback): number
    emit(sigName: "key-password-validate", ...args: any[]): void
    connect(sigName: "key-validate", callback: CertChooser_KeyValidateSignalCallback): number
    connect_after(sigName: "key-validate", callback: CertChooser_KeyValidateSignalCallback): number

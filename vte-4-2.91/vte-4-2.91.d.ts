...
export namespace Vte {
    ...
    class PtyError extends GLib.Error {
        // Own fields of Vte-4-2.91.PtyError

        /**
         * Obsolete. Deprecated: 0.42
         */
        PTY_HELPER_FAILED: number;
        /**
         * failure when using PTY98 to allocate the PTY
         */
        PTY98_FAILED: number;

        // Constructors of Vte-4-2.91.PtyError

        constructor(options: { message: string; code: number });

        // Owm methods of Vte-4-2.91.PtyError
    ...
    class RegexError extends GLib.Error {
        // Own fields of Vte-4-2.91.RegexError
        ...
        // Constructors of Vte-4-2.91.RegexError

        constructor(options: { message: string; code: number });

        // Owm methods of Vte-4-2.91.RegexError
    ...
    class Pty extends GObject.Object {
        // Own properties of Vte-4-2.91.Pty
        ...
        // Constructors of Vte-4-2.91.Pty
    ...
    class Terminal extends Gtk.Widget {
        // Own properties of Vte-4-2.91.Terminal
        ...
        // Own fields of Vte-4-2.91.Terminal

        widget: Gtk.Widget;

        // Constructors of Vte-4-2.91.Terminal

        static ['new'](): Terminal;

        // Owm methods of Vte-4-2.91.Terminal
         ...
         */
        get_text(is_selected?: SelectionFunc | null): string | null;
        /**
         ...
         * @returns a newly allocated text string, or %NULL.
         */
        get_text_include_trailing_spaces(is_selected: SelectionFunc | null): string;
        /**
         * Extracts a view of the visible part of the terminal.  If `is_selected` is not
         * %NULL, characters will only be read if `is_selected` returns %TRUE after being
         * passed the column and row, respectively.  A #VteCharAttributes structure
         ...
         */
        match_check(column: number, row: number): string | null;
        /**
    ...
    class CharAttributes {
        // Constructors of Vte-4-2.91.CharAttributes
    ...
    class Regex {
        // Constructors of Vte-4-2.91.Regex
        ...
        // Owm methods of Vte-4-2.91.Regex

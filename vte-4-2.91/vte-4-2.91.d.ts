 ...
 */
function get_encoding_supported(encoding: string | null): boolean
/**
 ...
 */
function get_features(): string | null
/**
...
module Pty {
    ...
    interface ConstructorProperties extends Gio.Initable.ConstructorProperties, GObject.Object.ConstructorProperties {
        ...
        // Own constructor properties of Vte-4-2.91.Vte.Pty
...
interface Pty extends Gio.Initable {
    ...
    // Own properties of Vte-4-2.91.Vte.Pty
    ...
    // Owm methods of Vte-4-2.91.Vte.Pty
    ...
    // Class property signals of Vte-4-2.91.Vte.Pty
...
class Pty extends GObject.Object {
    ...
    // Constructors of Vte-4-2.91.Vte.Pty
...
module Terminal {
    ...
    interface ConstructorProperties extends Gtk.Accessible.ConstructorProperties, Gtk.Buildable.ConstructorProperties, Gtk.ConstraintTarget.ConstructorProperties, Gtk.Scrollable.ConstructorProperties, Gtk.Widget.ConstructorProperties {
        ...
        // Own constructor properties of Vte-4-2.91.Vte.Terminal
...
interface Terminal extends Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Scrollable {
    ...
    // Own properties of Vte-4-2.91.Vte.Terminal
    ...
    // Own fields of Vte-4-2.91.Vte.Terminal

    widget: Gtk.Widget

    // Owm methods of Vte-4-2.91.Vte.Terminal
     ...
     * @returns a newly allocated text string, or %NULL.
     */
    get_text_include_trailing_spaces(is_selected: SelectionFunc | null): [ /* returnType */ string | null, /* attributes */ CharAttributes[] ]
    /**
     * Extracts a view of the visible part of the terminal.  If `is_selected` is not
     * %NULL, characters will only be read if `is_selected` returns %TRUE after being
     * passed the column and row, respectively.  A #VteCharAttributes structure
     ...
     */
    match_set_cursor_name(tag: number, cursor_name: string | null): void
    /**
     ...
     */
    paste_text(text: string | null): void
    /**
     ...
     */
    set_word_char_exceptions(exceptions: string | null): void
    /**
    ...
    // Own signals of Vte-4-2.91.Vte.Terminal
    ...
    // Class property signals of Vte-4-2.91.Vte.Terminal
...
class Terminal extends Gtk.Widget {
    ...
    // Constructors of Vte-4-2.91.Vte.Terminal
...
class CharAttributes {
    ...
    // Own properties of Vte-4-2.91.Vte.CharAttributes
...
abstract class PtyClass {
    ...
    // Own properties of Vte-4-2.91.Vte.PtyClass
...
interface Regex {
    ...
    // Owm methods of Vte-4-2.91.Vte.Regex
...
class Regex {
    ...
    // Own properties of Vte-4-2.91.Vte.Regex

    static name: string

    // Constructors of Vte-4-2.91.Vte.Regex
     ...
     */
    static new_for_match(pattern: string | null, pattern_length: number, flags: number): Regex
    /**
     ...
     * @returns a newly created #VteRegex, or %NULL with @error filled in
     */
    static new_for_search(pattern: string | null, pattern_length: number, flags: number): Regex
}

interface TerminalClass {

    // Own fields of Vte-4-2.91.Vte.TerminalClass
...
abstract class TerminalClass {
    ...
    // Own properties of Vte-4-2.91.Vte.TerminalClass
...
class TerminalClassPrivate {
    ...
    // Own properties of Vte-4-2.91.Vte.TerminalClassPrivate

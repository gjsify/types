...
static ["new"](): Terminal;
    ...
    connect_after(signal: 'char-size-changed', callback: ((_source: this, width: number, height: number) => void)): number
    ...
    connect(signal: 'hyperlink-hover-uri-changed', callback: ((_source: this, uri: string, bbox: Gdk.Rectangle) => void)): number
    connect_after(signal: 'hyperlink-hover-uri-changed', callback: ((_source: this, uri: string, bbox: Gdk.Rectangle) => void)): number
     ...
     * @returns a newly allocated text string, or %NULL.
     */
    get_text_range(start_row: number, start_col: number, end_row: number, end_col: number, is_selected?: (SelectionFunc | null)): [(string | null), CharAttributes[] | null]

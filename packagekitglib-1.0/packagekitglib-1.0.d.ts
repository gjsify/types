...
export namespace PackageKitGlib {
    ...
    class ClientError extends GLib.Error {
        // Own fields of PackageKitGlib-1.0.ClientError
         ...
         */
        DECLINED_SIMULATION: number;
        /**
         * the user declined interaction on the task
         */
        DECLINED_INTERACTION: number;
        LAST: number;

        // Constructors of PackageKitGlib-1.0.ClientError

        constructor(options: { message: string; code: number });

        // Owm methods of PackageKitGlib-1.0.ClientError
    ...
    class ControlError extends GLib.Error {
        // Own fields of PackageKitGlib-1.0.ControlError
        ...
        // Constructors of PackageKitGlib-1.0.ControlError

        constructor(options: { message: string; code: number });

        // Owm methods of PackageKitGlib-1.0.ControlError
    ...
    class OfflineError extends GLib.Error {
        // Own fields of PackageKitGlib-1.0.OfflineError
        ...
        // Constructors of PackageKitGlib-1.0.OfflineError

        constructor(options: { message: string; code: number });

        // Owm methods of PackageKitGlib-1.0.OfflineError
    ...
    class Category extends Source {
        // Own properties of PackageKitGlib-1.0.Category
        ...
        // Constructors of PackageKitGlib-1.0.Category

        static ['new'](): Category;

        // Owm methods of PackageKitGlib-1.0.Category
    ...
    class Client extends GObject.Object {
        // Own properties of PackageKitGlib-1.0.Client
        ...
        // Constructors of PackageKitGlib-1.0.Client

        static ['new'](): Client;

        // Owm methods of PackageKitGlib-1.0.Client
    ...
    class ClientHelper extends GObject.Object {
        // Constructors of PackageKitGlib-1.0.ClientHelper

        static ['new'](): ClientHelper;

        // Owm methods of PackageKitGlib-1.0.ClientHelper
    ...
    class Control extends GObject.Object {
        // Own properties of PackageKitGlib-1.0.Control
        ...
        // Constructors of PackageKitGlib-1.0.Control

        static ['new'](): Control;

        // Owm methods of PackageKitGlib-1.0.Control
    ...
    class Desktop extends GObject.Object {
        // Constructors of PackageKitGlib-1.0.Desktop

        static ['new'](): Desktop;

        // Owm methods of PackageKitGlib-1.0.Desktop
    ...
    class Details extends Source {
        // Own properties of PackageKitGlib-1.0.Details
        ...
        // Constructors of PackageKitGlib-1.0.Details

        static ['new'](): Details;

        // Owm methods of PackageKitGlib-1.0.Details
    ...
    class DistroUpgrade extends Source {
        // Own properties of PackageKitGlib-1.0.DistroUpgrade

        name: string;
        state: DistroUpgradeEnum;
        summary: string;

        // Constructors of PackageKitGlib-1.0.DistroUpgrade

        static ['new'](): DistroUpgrade;

        // Owm methods of PackageKitGlib-1.0.DistroUpgrade
    ...
    class Error extends Source {
        // Own properties of PackageKitGlib-1.0.Error

        code: ErrorEnum;
        details: string;

        // Constructors of PackageKitGlib-1.0.Error

        static ['new'](): Error;

        // Owm methods of PackageKitGlib-1.0.Error
    ...
    class EulaRequired extends Source {
        // Own properties of PackageKitGlib-1.0.EulaRequired
        ...
        // Constructors of PackageKitGlib-1.0.EulaRequired

        static ['new'](): EulaRequired;

        // Owm methods of PackageKitGlib-1.0.EulaRequired
    ...
    class Files extends Source {
        // Own properties of PackageKitGlib-1.0.Files

        files: string[];
        package_id: string;
        packageId: string;

        // Constructors of PackageKitGlib-1.0.Files

        static ['new'](): Files;

        // Owm methods of PackageKitGlib-1.0.Files
    ...
    class ItemProgress extends Source {
        // Own properties of PackageKitGlib-1.0.ItemProgress
        ...
        // Constructors of PackageKitGlib-1.0.ItemProgress

        static ['new'](): ItemProgress;

        // Owm methods of PackageKitGlib-1.0.ItemProgress
    ...
    class MediaChangeRequired extends Source {
        // Own properties of PackageKitGlib-1.0.MediaChangeRequired
        ...
        // Constructors of PackageKitGlib-1.0.MediaChangeRequired
    ...
    class Package extends Source {
        // Own properties of PackageKitGlib-1.0.Package
        ...
        // Constructors of PackageKitGlib-1.0.Package

        static ['new'](): Package;

        // Owm methods of PackageKitGlib-1.0.Package
    ...
    class PackageSack extends GObject.Object {
        // Constructors of PackageKitGlib-1.0.PackageSack

        static ['new'](): PackageSack;

        // Owm methods of PackageKitGlib-1.0.PackageSack
    ...
    class Progress extends GObject.Object {
        // Own properties of PackageKitGlib-1.0.Progress
        ...
        // Constructors of PackageKitGlib-1.0.Progress

        static ['new'](): Progress;

        // Owm methods of PackageKitGlib-1.0.Progress
    ...
    class RepoDetail extends Source {
        // Own properties of PackageKitGlib-1.0.RepoDetail
        ...
        // Constructors of PackageKitGlib-1.0.RepoDetail

        static ['new'](): RepoDetail;

        // Owm methods of PackageKitGlib-1.0.RepoDetail
    ...
    class RepoSignatureRequired extends Source {
        // Own properties of PackageKitGlib-1.0.RepoSignatureRequired
        ...
        // Constructors of PackageKitGlib-1.0.RepoSignatureRequired
    ...
    class RequireRestart extends Source {
        // Own properties of PackageKitGlib-1.0.RequireRestart

        package_id: string;
        packageId: string;
        restart: RestartEnum;

        // Constructors of PackageKitGlib-1.0.RequireRestart
    ...
    class Results extends GObject.Object {
        // Own properties of PackageKitGlib-1.0.Results
        ...
        // Constructors of PackageKitGlib-1.0.Results

        static ['new'](): Results;

        // Owm methods of PackageKitGlib-1.0.Results
    ...
    class Source extends GObject.Object {
        // Own properties of PackageKitGlib-1.0.Source

        role: RoleEnum;
        transaction_id: string;
        transactionId: string;

        // Constructors of PackageKitGlib-1.0.Source
    ...
    class Task extends Client {
        // Own properties of PackageKitGlib-1.0.Task
        ...
        // Constructors of PackageKitGlib-1.0.Task

        static ['new'](): Task;

        // Owm methods of PackageKitGlib-1.0.Task
    ...
    class TransactionList extends GObject.Object {
        // Constructors of PackageKitGlib-1.0.TransactionList

        static ['new'](): TransactionList;

        // Owm methods of PackageKitGlib-1.0.TransactionList
    ...
    class TransactionPast extends Source {
        // Own properties of PackageKitGlib-1.0.TransactionPast
        ...
        // Constructors of PackageKitGlib-1.0.TransactionPast

        static ['new'](): TransactionPast;

        // Owm methods of PackageKitGlib-1.0.TransactionPast
    ...
    class UpdateDetail extends Source {
        // Own properties of PackageKitGlib-1.0.UpdateDetail
        ...
        // Constructors of PackageKitGlib-1.0.UpdateDetail

        static ['new'](): UpdateDetail;

        // Owm methods of PackageKitGlib-1.0.UpdateDetail
     ...
     */
    class EnumMatch {
        // Own fields of PackageKitGlib-1.0.EnumMatch

        value: number;
        string: string;

        // Constructors of PackageKitGlib-1.0.EnumMatch
    ...
    class MediaChangeRequiredClass {}
    ...
    class RepoSignatureRequiredClass {}

// The widget vocabulary of Shell-13 as runtime data.
//
// GENERATED — do not edit. Provenance: Shell-13 — dropped empty base(s): Atk.ImplementorIface — inlined base(s) their owner's vocabulary does not emit: NM.SecretAgentOld — prop(s) whose type the model cannot resolve: Shell.App.app-info: Gio.DesktopAppInfo
//
...
export const PROVENANCE = {
    ...
    requiredVocabularies: ['@girs/clutter-13/vocabulary', '@girs/gcr-4/vocabulary', '@girs/gio-2.0/vocabulary', '@girs/gobject-2.0/vocabulary', '@girs/polkitagent-1.0/vocabulary', '@girs/st-13/vocabulary'],
};
...
export const DECLS = {
    ...
    ShellTrayIcon: ['ShellTrayIcon', 'ClutterClone', 'ClutterActor', 'GInitiallyUnowned', 'GObject', 'ClutterAnimatable', 'ClutterContainer', 'ClutterScriptable'],
...
export const PROP_TYPES = {
    ...
    'ShellGlobal.automation-script': 'GFile',
    'ShellGlobal.force-animations': 'gboolean',

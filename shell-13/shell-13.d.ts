...
class TrayIcon<A extends Clutter.Actor = Clutter.Actor> extends Clutter.Clone<A> implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container<A>, Clutter.Scriptable {
...
static ["new"](plugin: Meta.Plugin): WM;
    ...
    connect(signal: 'show-tile-preview', callback: ((_source: this, object: Meta.Window, p0: Mtk.Rectangle, p1: number) => void)): number
    connect_after(signal: 'show-tile-preview', callback: ((_source: this, object: Meta.Window, p0: Mtk.Rectangle, p1: number) => void)): number
    emit(signal: 'show-tile-preview', object: Meta.Window, p0: Mtk.Rectangle, p1: number): void
    connect(signal: 'show-window-menu', callback: ((_source: this, object: Meta.Window, p0: number, p1: Mtk.Rectangle) => void)): number
    connect_after(signal: 'show-window-menu', callback: ((_source: this, object: Meta.Window, p0: number, p1: Mtk.Rectangle) => void)): number
    emit(signal: 'show-window-menu', object: Meta.Window, p0: number, p1: Mtk.Rectangle): void
    connect(signal: 'size-change', callback: ((_source: this, object: Meta.WindowActor, p0: Meta.SizeChange, p1: Mtk.Rectangle, p2: Mtk.Rectangle) => void)): number
    connect_after(signal: 'size-change', callback: ((_source: this, object: Meta.WindowActor, p0: Meta.SizeChange, p1: Mtk.Rectangle, p2: Mtk.Rectangle) => void)): number
    emit(signal: 'size-change', object: Meta.WindowActor, p0: Meta.SizeChange, p1: Mtk.Rectangle, p2: Mtk.Rectangle): void

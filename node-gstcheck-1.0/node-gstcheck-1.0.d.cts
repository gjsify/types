 ...
 */
export function checkBufferData(buffer: Gst.Buffer, data: any | null, size: number): void
/**
 ...
 */
export function checkObjectDestroyedOnUnref(objectToUnref: any | null): void
/**

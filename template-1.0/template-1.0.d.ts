...
export namespace Template {
    class Error extends GLib.Error {
        // Own fields of Template-1.0.Error

        INVALID_STATE: number;
        TEMPLATE_NOT_FOUND: number;
        CIRCULAR_INCLUDE: number;
        SYNTAX_ERROR: number;
        LEXER_FAILURE: number;
        TYPE_MISMATCH: number;
        INVALID_OP_CODE: number;
        DIVIDE_BY_ZERO: number;
        MISSING_SYMBOL: number;
        SYMBOL_REDEFINED: number;
        NOT_AN_OBJECT: number;
        NULL_POINTER: number;
        ...
        NOT_A_VALUE: number;
        NOT_A_FUNCTION: number;

        // Constructors of Template-1.0.Error

        constructor(options: { message: string; code: number });

        // Owm methods of Template-1.0.Error
    ...
    class Template extends GObject.Object {
        // Own properties of Template-1.0.Template

        locator: TemplateLocator;

        // Constructors of Template-1.0.Template

        static ['new'](locator?: TemplateLocator | null): Template;

        // Owm methods of Template-1.0.Template
    ...
    class TemplateLocator extends GObject.Object {
        // Constructors of Template-1.0.TemplateLocator

        static ['new'](): TemplateLocator;

        // Owm methods of Template-1.0.TemplateLocator
    ...
    class Scope {
        // Constructors of Template-1.0.Scope

        constructor(properties?: Partial<{}>);

        static ['new'](): Scope;

        // Owm methods of Template-1.0.Scope
    ...
    class Symbol {
        // Constructors of Template-1.0.Symbol

        constructor(properties?: Partial<{}>);

        static ['new'](): Symbol;

        // Owm methods of Template-1.0.Symbol
    ...
    class TemplateLocatorClass {}

    class Expr {
        // Constructors of Template-1.0.Expr
        ...
        // Owm methods of Template-1.0.Expr

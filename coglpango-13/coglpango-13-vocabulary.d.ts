/**
 * The GIR-derived widget VOCABULARY for CoglPango-13.
 *
 * GENERATED — do not edit. Provenance: CoglPango-13 — dropped empty base(s): Pango.Renderer — prop(s) no TypeScript value satisfies: CoglPango.Renderer.context
 *

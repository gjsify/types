 ...
 */
function build_history_report_json(devices: Device[]): string | null
/**
 ...
 */
function build_machine_id(salt: string | null): string | null
/**
 ...
 */
function build_user_agent(package_name: string | null, package_version: string | null): string | null
/**
 * Formats a checksum for display.
 * @param checksum A checksum
 * @returns text, or %NULL for invalid
 */
function checksum_format_for_display(checksum: string | null): string | null
/**
 ...
 */
function checksum_get_best(checksums: string[]): string | null
/**
 ...
 */
function checksum_get_by_kind(checksums: string[], kind: GLib.ChecksumType): string | null
/**
 ...
 */
function error_to_string(error: Error): string | null
/**
 ...
 * @returns identifier string
 */
function feature_flag_to_string(feature_flag: FeatureFlags): string | null
/**
 ...
 */
function guid_hash_data(data: number, datasz: number, flags: GuidFlags): string | null
/**
 ...
 */
function guid_hash_string(str: string | null): string | null
/**
 ...
 */
function guid_is_valid(guid: string | null): boolean
/**
 ...
 * @returns A new GUID
 */
function guid_to_string(guid: number, flags: GuidFlags): string | null
/**
 ...
 */
function keyring_kind_to_string(keyring_kind: KeyringKind): string | null
/**
 ...
 * @returns identifier string
 */
function status_to_string(status: Status): string | null
/**
 ...
 * @returns identifier string
 */
function trust_flag_to_string(trust_flag: TrustFlags): string | null
/**
 ...
 * @returns identifier string
 */
function update_state_to_string(update_state: UpdateState): string | null
/**
 ...
 */
function version_format_to_string(kind: VersionFormat): string | null
module Client {

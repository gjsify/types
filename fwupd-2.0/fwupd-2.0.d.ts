...
export namespace Fwupd {
    ...
    class Error extends GLib.Error {
         ...
         */
        BROKEN_SYSTEM: number;
        /**
         * The system battery level is too low
         */
        BATTERY_LEVEL_TOO_LOW: number;
        /**
        ...
        // Constructors of Fwupd-2.0.Error
    ...
    class BiosSetting extends GObject.Object {
        // Constructors of Fwupd-2.0.BiosSetting

        static ['new'](name?: string | null, path?: string | null): BiosSetting;

        // Owm methods of Fwupd-2.0.BiosSetting
    ...
    class Client extends GObject.Object {
        // Own properties of Fwupd-2.0.Client
         ...
         */
        readonly only_trusted: boolean;
        /**
         * If the daemon is verifying signatures from a trusted authority.
         */
        readonly onlyTrusted: boolean;
        /**
        ...
        // Constructors of Fwupd-2.0.Client

        static ['new'](): Client;

        // Owm methods of Fwupd-2.0.Client
         ...
         * @returns %TRUE for success
         */
        emulation_load(data: GLib.Bytes, cancellable?: Gio.Cancellable | null): boolean;
        /**
         * Loads an emulated device into the daemon backend that has the phases set by the JSON data,
         * for instance, having one USB device emulated for the bootloader and another emulated for the
         * runtime interface.
         ...
         * @returns %TRUE for success
         */
        modify_bios_setting(settings: GLib.HashTable<any, any>, cancellable?: Gio.Cancellable | null): boolean;
        /**
         * Modifies a BIOS setting using kernel API.
         * The daemon will only respond to this request with proper permissions.
         * @param settings BIOS settings
        ...
        modify_bios_setting_async(
            settings: GLib.HashTable<any, any>,
            cancellable?: Gio.Cancellable | null,
            callback?: Gio.AsyncReadyCallback<this> | null,
        ): void;
        /**
    ...
    class Device extends GObject.Object {
        // Own properties of Fwupd-2.0.Device
        ...
        // Constructors of Fwupd-2.0.Device

        static ['new'](): Device;

        // Owm methods of Fwupd-2.0.Device
    ...
    class Plugin extends GObject.Object {
        // Own properties of Fwupd-2.0.Plugin
        ...
        // Constructors of Fwupd-2.0.Plugin

        static ['new'](): Plugin;

        // Owm methods of Fwupd-2.0.Plugin
    ...
    class Release extends GObject.Object {
        // Own properties of Fwupd-2.0.Release
        ...
        // Constructors of Fwupd-2.0.Release

        static ['new'](): Release;

        // Owm methods of Fwupd-2.0.Release
    ...
    class Remote extends GObject.Object {
        // Own properties of Fwupd-2.0.Remote
        ...
        // Constructors of Fwupd-2.0.Remote

        static ['new'](): Remote;

        // Owm methods of Fwupd-2.0.Remote
    ...
    class Report extends GObject.Object {
        // Own properties of Fwupd-2.0.Report
        ...
        // Constructors of Fwupd-2.0.Report

        static ['new'](): Report;

        // Owm methods of Fwupd-2.0.Report
    ...
    class Request extends GObject.Object {
        // Own properties of Fwupd-2.0.Request
        ...
        // Constructors of Fwupd-2.0.Request

        static ['new'](): Request;

        // Owm methods of Fwupd-2.0.Request
    ...
    class SecurityAttr extends GObject.Object {
        // Constructors of Fwupd-2.0.SecurityAttr

        static ['new'](appstream_id?: string | null): SecurityAttr;

        // Owm methods of Fwupd-2.0.SecurityAttr

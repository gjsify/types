...
export namespace Phosh {
     ...
     * @gir-type Class
     */
    class DBusScreenshotProxy extends Gio.DBusProxy implements Gio.AsyncInitable<DBusScreenshotProxy>, Gio.DBusInterface, Gio.Initable, DBusScreenshot {
    ...
    // Conflicted with Gio.DBusProxy.new_for_bus
         ...
         */
        complete_select_area(invocation: Gio.DBusMethodInvocation, x: number, y: number, width: number, height: number): void;
         ...
         * @virtual
         */
        vfunc_handle_flash_area(invocation: Gio.DBusMethodInvocation, arg_x: number, arg_y: number, arg_width: number, arg_height: number): boolean;
         ...
         * @virtual
         */
        vfunc_handle_screenshot(invocation: Gio.DBusMethodInvocation, arg_include_cursor: boolean, arg_flash: boolean, arg_filename: string): boolean;
         ...
         * @virtual
         */
        vfunc_handle_screenshot_area(invocation: Gio.DBusMethodInvocation, arg_x: number, arg_y: number, arg_width: number, arg_height: number, arg_flash: boolean, arg_filename: string): boolean;
         ...
         * @virtual
         */
        vfunc_handle_screenshot_window(invocation: Gio.DBusMethodInvocation, arg_include_frame: boolean, arg_include_cursor: boolean, arg_flash: boolean, arg_filename: string): boolean;
    ...
    namespace Lockscreen {
        ...
        // Constructor properties interface
        interface ConstructorProps extends LayerSurface.ConstructorProps, Atk.ImplementorIface.ConstructorProps, Gtk.Buildable.ConstructorProps {
            page: LockscreenPage;
    ...
    class Lockscreen extends LayerSurface implements Atk.ImplementorIface, Gtk.Buildable {
         ...
         * @param page 
         */
        set_default_page(page: LockscreenPage): void;
         ...
         * @param page 
         */
        set_page(page: LockscreenPage): void;
    ...
    class LockscreenManager extends GObject.Object {
         ...
         * @param page 
         */
        set_page(page: LockscreenPage): boolean;
    }
    ...
    namespace Shell {
        ...
        // Constructor properties interface
        interface ConstructorProps extends GObject.Object.ConstructorProps, Gio.ActionGroup.ConstructorProps, Gio.ActionMap.ConstructorProps {
            docked: boolean;
            locked: boolean;
            log_domains: string[];
            logDomains: string[];
    ...
    class StatusIcon extends Gtk.Bin implements Atk.ImplementorIface, Gtk.Buildable {
         ...
         * @deprecated since 0.47: Use {@link Phosh.StatusIcon.get_pixel_size}.
         */
         ...
         * @deprecated since 0.47: Use {@link Phosh.StatusIcon.set_pixel_size}.
         */
    ...
    class WallClock extends GObject.Object {
         ...
         */
        string_for_datetime(datetime: GLib.DateTime, clock_format: GDesktopEnums.ClockFormat, show_full_date: boolean): string;
    }

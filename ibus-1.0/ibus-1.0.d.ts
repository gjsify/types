...
static new_async(): Bus;
    ...
    connect(signal: 'name-owner-changed', callback: ((_source: this, name: string, old_owner: string, new_owner: string) => void)): number
    connect_after(signal: 'name-owner-changed', callback: ((_source: this, name: string, old_owner: string, new_owner: string) => void)): number
...
static new_async_finish(res: Gio.AsyncResult): Config;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'value-changed', callback: ((_source: this, section: string, name: string, value: GLib.Variant) => void)): number
    connect_after(signal: 'value-changed', callback: ((_source: this, section: string, name: string, value: GLib.Variant) => void)): number
...
static new_with_type(engine_type: GObject.GType, engine_name: string, object_path: string, connection: Gio.DBusConnection): Engine;
    ...
    connect(signal: 'candidate-clicked', callback: ((_source: this, index: number, button: number, state: number) => void)): number
    connect_after(signal: 'candidate-clicked', callback: ((_source: this, index: number, button: number, state: number) => void)): number
    ...
    connect(signal: 'process-hand-writing-event', callback: ((_source: this, coordinates: any, coordinates_len: number) => void)): number
    connect_after(signal: 'process-hand-writing-event', callback: ((_source: this, coordinates: any, coordinates_len: number) => void)): number
    emit(signal: 'process-hand-writing-event', coordinates: any, coordinates_len: number): void
    connect(signal: 'process-key-event', callback: ((_source: this, keyval: number, keycode: number, state: number) => boolean)): number
    connect_after(signal: 'process-key-event', callback: ((_source: this, keyval: number, keycode: number, state: number) => boolean)): number
    ...
    connect_after(signal: 'set-content-type', callback: ((_source: this, purpose: number, hints: number) => void)): number
    emit(signal: 'set-content-type', purpose: number, hints: number): void
    connect(signal: 'set-cursor-location', callback: ((_source: this, x: number, y: number, w: number, h: number) => void)): number
    connect_after(signal: 'set-cursor-location', callback: ((_source: this, x: number, y: number, w: number, h: number) => void)): number
    emit(signal: 'set-cursor-location', x: number, y: number, w: number, h: number): void
    connect(signal: 'set-surrounding-text', callback: ((_source: this, text: GObject.Object, cursor_pos: number, anchor_pos: number) => void)): number
    connect_after(signal: 'set-surrounding-text', callback: ((_source: this, text: GObject.Object, cursor_pos: number, anchor_pos: number) => void)): number
...
static new_async_finish(res: Gio.AsyncResult): InputContext;
    ...
    connect(signal: 'delete-surrounding-text', callback: ((_source: this, offset: number, n_chars: number) => void)): number
    connect_after(signal: 'delete-surrounding-text', callback: ((_source: this, offset: number, n_chars: number) => void)): number
    ...
    connect(signal: 'forward-key-event', callback: ((_source: this, keyval: number, keycode: number, modifiers: number) => void)): number
    connect_after(signal: 'forward-key-event', callback: ((_source: this, keyval: number, keycode: number, modifiers: number) => void)): number
    ...
    connect_after(signal: 'update-auxiliary-text', callback: ((_source: this, text: Text, visible: boolean) => void)): number
    emit(signal: 'update-auxiliary-text', text: Text, visible: boolean): void
    connect(signal: 'update-lookup-table', callback: ((_source: this, table: LookupTable, visible: boolean) => void)): number
    connect_after(signal: 'update-lookup-table', callback: ((_source: this, table: LookupTable, visible: boolean) => void)): number
    emit(signal: 'update-lookup-table', table: LookupTable, visible: boolean): void
    connect(signal: 'update-preedit-text', callback: ((_source: this, text: Text, cursor_pos: number, visible: boolean) => void)): number
    connect_after(signal: 'update-preedit-text', callback: ((_source: this, text: Text, cursor_pos: number, visible: boolean) => void)): number
...
static ["new"](...args: never[]): any;
    ...
    connect_after(signal: 'update-auxiliary-text', callback: ((_source: this, text: Text, visible: boolean) => void)): number
    emit(signal: 'update-auxiliary-text', text: Text, visible: boolean): void
    connect(signal: 'update-lookup-table', callback: ((_source: this, lookup_table: LookupTable, visible: boolean) => void)): number
    connect_after(signal: 'update-lookup-table', callback: ((_source: this, lookup_table: LookupTable, visible: boolean) => void)): number

/**
 * The GIR-derived widget VOCABULARY for Meta-17.
 *
 ...
 *
 * 38 instantiable GTypes (of which 0 concrete widgets), 39 declarations (1 inlined from a namespace whose vocabulary does not emit them), 35 enum nick unions, 0 slot candidates.
 *
...
import type Meta from './meta-17.js';
import type Mtk from '@girs/mtk-17';
import type { ClutterActorConstructOnly, ClutterActorProps, ClutterAnimatableConstructOnly, ClutterAnimatableProps, ClutterContentConstructOnly, ClutterContentProps, ClutterStageConstructOnly, ClutterStageProps } from '@girs/clutter-17/vocabulary';

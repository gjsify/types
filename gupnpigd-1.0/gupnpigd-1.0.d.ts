...
module SimpleIgd {
    ...
    interface ErrorMappingPort {
        (error: GLib.Error, proto: string, external_port: number, local_ip: string, local_port: number, description: string): void
    }

    interface MappedExternalPort {
        (proto: string, external_ip: string, replaces_external_ip: string, external_port: number, local_ip: string, local_port: number, description: string): void
    }
...
static ["new"](): SimpleIgd;
    ...
    connect(signal: 'error-mapping-port', callback: ((_source: this, error: GLib.Error, proto: string, external_port: number, local_ip: string, local_port: number, description: string) => void)): number
    connect_after(signal: 'error-mapping-port', callback: ((_source: this, error: GLib.Error, proto: string, external_port: number, local_ip: string, local_port: number, description: string) => void)): number
    emit(signal: 'error-mapping-port', error: GLib.Error, proto: string, external_port: number, local_ip: string, local_port: number, description: string): void
    connect(signal: 'mapped-external-port', callback: ((_source: this, proto: string, external_ip: string, replaces_external_ip: string, external_port: number, local_ip: string, local_port: number, description: string) => void)): number
    connect_after(signal: 'mapped-external-port', callback: ((_source: this, proto: string, external_ip: string, replaces_external_ip: string, external_port: number, local_ip: string, local_port: number, description: string) => void)): number
    emit(signal: 'mapped-external-port', proto: string, external_ip: string, replaces_external_ip: string, external_port: number, local_ip: string, local_port: number, description: string): void

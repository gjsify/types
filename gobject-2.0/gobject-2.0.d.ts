 ...
 * @returns a newly created parameter specification
 */
function param_spec_unichar(name: string, nick: (string | null), blurb: (string | null), default_value: number, flags: ParamFlags): ParamSpec
/**
 ...
 */
function signal_add_emission_hook(signal_id: number, detail: GLib.Quark, data_destroy?: (GLib.DestroyNotify | null)): number
/**
 ...
 */
function signal_emitv(instance_and_params: Value[], signal_id: number, detail: GLib.Quark, return_value?: Value): unknown
/**
...
_init(...args: any[]): void;
    ...
    static ["char"](name: string, nick: string, blurb: string, flags: (ParamFlags | number), minimum: number, maximum: number, defaultValue: number): ParamSpec<number>
    static uchar(name: string, nick: string, blurb: string, flags: (ParamFlags | number), minimum: number, maximum: number, defaultValue: number): ParamSpec<number>
    static int(name: string, nick: string, blurb: string, flags: (ParamFlags | number), minimum: number, maximum: number, defaultValue: number): ParamSpec<number>
    static uint(name: string, nick: string, blurb: string, flags: (ParamFlags | number), minimum: number, maximum: number, defaultValue: number): ParamSpec<number>
    static long(name: string, nick: string, blurb: string, flags: (ParamFlags | number), minimum: number, maximum: number, defaultValue: number): ParamSpec<number>
    static ulong(name: string, nick: string, blurb: string, flags: (ParamFlags | number), minimum: number, maximum: number, defaultValue: number): ParamSpec<number>
    static int64(name: string, nick: string, blurb: string, flags: (ParamFlags | number), minimum: number, maximum: number, defaultValue: number): ParamSpec<number>
    static uint64(name: string, nick: string, blurb: string, flags: (ParamFlags | number), minimum: number, maximum: number, defaultValue: number): ParamSpec<number>
    static float(name: string, nick: string, blurb: string, flags: (ParamFlags | number), minimum: number, maximum: number, defaultValue: number): ParamSpec<number>
    static ["boolean"](name: string, nick: string, blurb: string, flags: (ParamFlags | number), defaultValue: boolean): ParamSpec<boolean>
    static ["enum"]<T>(name: string, nick: string, blurb: string, flags: (ParamFlags | number), enumType: GType<T> | { $gtype: GType<T> }, defaultValue: any): ParamSpec<T>
    static double(name: string, nick: string, blurb: string, flags: (ParamFlags | number), minimum: number, maximum: number, defaultValue: number): ParamSpec<number>
    static string(name: string, nick: string, blurb: string, flags: (ParamFlags | number), defaultValue: string): ParamSpec<string>
    static boxed<T>(name: string, nick: string, blurb: string, flags: (ParamFlags | number), boxedType: GType<T> | { $gtype: GType<T> }): ParamSpec<T>
    static object<T>(name: string, nick: string, blurb: string, flags: string, objectType: GType<T> | { $gtype: GType<T> }): ParamSpec<T>

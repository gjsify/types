...
export namespace Soup {
    ...
    class RequestError extends GLib.Error {
        // Own fields of Soup-2.4.RequestError
        ...
        // Constructors of Soup-2.4.RequestError

        constructor(options: { message: string; code: number });

        // Owm methods of Soup-2.4.RequestError

        static quark(): GLib.Quark;
    }

    class RequesterError extends GLib.Error {
        // Own fields of Soup-2.4.RequesterError

        BAD_URI: number;
        UNSUPPORTED_URI_SCHEME: number;

        // Constructors of Soup-2.4.RequesterError

        constructor(options: { message: string; code: number });

        // Owm methods of Soup-2.4.RequesterError
    ...
    class TLDError extends GLib.Error {
        // Own fields of Soup-2.4.TLDError
        ...
        // Constructors of Soup-2.4.TLDError

        constructor(options: { message: string; code: number });

        // Owm methods of Soup-2.4.TLDError
    ...
    class XMLRPCError extends GLib.Error {
        // Own fields of Soup-2.4.XMLRPCError

        ARGUMENTS: number;
        RETVAL: number;

        // Constructors of Soup-2.4.XMLRPCError

        constructor(options: { message: string; code: number });

        // Owm methods of Soup-2.4.XMLRPCError
    ...
    ): GLib.HashTable<string, string> | null;
    /**
    ...
    /**
     * Appends something like &lt;literal&gt;`name=``value&`lt;/literal&gt; to `string,`
    ...
    class Address extends GObject.Object {
        // Own properties of Soup-2.4.Address
        ...
        // Constructors of Soup-2.4.Address
        ...
        // Owm methods of Soup-2.4.Address
    ...
    abstract class Auth extends GObject.Object {
        // Own properties of Soup-2.4.Auth
    ...
    abstract class AuthDomain extends GObject.Object {
        // Own properties of Soup-2.4.AuthDomain
        ...
        // Owm methods of Soup-2.4.AuthDomain
    ...
    class AuthDomainBasic extends AuthDomain {
        // Own properties of Soup-2.4.AuthDomainBasic
        ...
        // Owm methods of Soup-2.4.AuthDomainBasic
    ...
    class AuthDomainDigest extends AuthDomain {
        // Own properties of Soup-2.4.AuthDomainDigest
        ...
        // Owm methods of Soup-2.4.AuthDomainDigest
    ...
    class AuthManager extends GObject.Object {
        // Owm methods of Soup-2.4.AuthManager
    ...
    class AuthNegotiate extends Auth {
        // Owm methods of Soup-2.4.AuthNegotiate
    ...
    class Cache extends GObject.Object {
        // Own properties of Soup-2.4.Cache
        ...
        // Constructors of Soup-2.4.Cache

        static ['new'](cache_dir: string | null, cache_type: CacheType): Cache;

        // Owm methods of Soup-2.4.Cache
    ...
    class ContentSniffer extends GObject.Object {
        // Constructors of Soup-2.4.ContentSniffer

        static ['new'](): ContentSniffer;

        // Owm methods of Soup-2.4.ContentSniffer
    ...
    class CookieJar extends GObject.Object {
        // Own properties of Soup-2.4.CookieJar
        ...
        // Constructors of Soup-2.4.CookieJar

        static ['new'](): CookieJar;

        // Owm methods of Soup-2.4.CookieJar
    ...
    class CookieJarDB extends CookieJar {
        // Own properties of Soup-2.4.CookieJarDB

        filename: string;

        // Constructors of Soup-2.4.CookieJarDB
    ...
    class CookieJarText extends CookieJar {
        // Own properties of Soup-2.4.CookieJarText

        filename: string;

        // Constructors of Soup-2.4.CookieJarText
    ...
    class HSTSEnforcer extends GObject.Object {
        // Constructors of Soup-2.4.HSTSEnforcer

        static ['new'](): HSTSEnforcer;

        // Owm methods of Soup-2.4.HSTSEnforcer
    ...
    class HSTSEnforcerDB extends HSTSEnforcer {
        // Own properties of Soup-2.4.HSTSEnforcerDB
        ...
        // Constructors of Soup-2.4.HSTSEnforcerDB
    ...
    class Logger extends GObject.Object {
        // Own properties of Soup-2.4.Logger
        ...
        // Constructors of Soup-2.4.Logger

        static ['new'](level: LoggerLogLevel, max_body_size: number): Logger;

        // Owm methods of Soup-2.4.Logger
    ...
    class Message extends GObject.Object {
        // Own properties of Soup-2.4.Message
    ...
    class MultipartInputStream extends Gio.FilterInputStream {
        // Own properties of Soup-2.4.MultipartInputStream

        message: Message;

        // Constructors of Soup-2.4.MultipartInputStream

        static ['new'](msg: Message, base_stream: Gio.InputStream): MultipartInputStream;

        // Owm methods of Soup-2.4.MultipartInputStream
    ...
    class ProxyResolverDefault extends GObject.Object {
        // Own properties of Soup-2.4.ProxyResolverDefault
    ...
    class Request extends GObject.Object {
        // Own properties of Soup-2.4.Request
        ...
        // Owm methods of Soup-2.4.Request
    ...
    class RequestFile extends Request {
        // Owm methods of Soup-2.4.RequestFile
    ...
    class RequestHTTP extends Request {
        // Owm methods of Soup-2.4.RequestHTTP
    ...
    class Requester extends GObject.Object {
        // Constructors of Soup-2.4.Requester

        static ['new'](): Requester;

        // Owm methods of Soup-2.4.Requester
    ...
    class Server extends GObject.Object {
        // Own properties of Soup-2.4.Server
        ...
        // Owm methods of Soup-2.4.Server
    ...
    class Session extends GObject.Object {
        // Own properties of Soup-2.4.Session
        ...
        // Constructors of Soup-2.4.Session

        static ['new'](): Session;

        // Owm methods of Soup-2.4.Session
    ...
    class SessionAsync extends Session {
        // Constructors of Soup-2.4.SessionAsync
    ...
    class SessionSync extends Session {
        // Constructors of Soup-2.4.SessionSync
    ...
    class Socket extends GObject.Object {
        // Own properties of Soup-2.4.Socket
        ...
        // Owm methods of Soup-2.4.Socket
         ...
         */
        read(buffer: Uint8Array, cancellable?: Gio.Cancellable | null): SocketIOStatus;
        /**
         ...
         */
        write(buffer: Uint8Array, cancellable?: Gio.Cancellable | null): SocketIOStatus;
    }
    ...
    class WebsocketConnection extends GObject.Object {
        // Own properties of Soup-2.4.WebsocketConnection
        ...
        // Constructors of Soup-2.4.WebsocketConnection
        ...
        // Owm methods of Soup-2.4.WebsocketConnection
    ...
    abstract class WebsocketExtension extends GObject.Object {
        // Owm methods of Soup-2.4.WebsocketExtension
    ...
    class AuthClass {
        // Own fields of Soup-2.4.AuthClass
     ...
     */
    class Buffer {
        // Own fields of Soup-2.4.Buffer

        data: any;
        length: number;

        // Constructors of Soup-2.4.Buffer
        ...
        // Owm methods of Soup-2.4.Buffer
     ...
     */
    class ClientContext {
        // Owm methods of Soup-2.4.ClientContext
    ...
    class Cookie {
        ...
        // Constructors of Soup-2.4.Cookie
        ...
        // Owm methods of Soup-2.4.Cookie
     ...
     */
    class HSTSPolicy {
        // Own fields of Soup-2.4.HSTSPolicy
        ...
        // Constructors of Soup-2.4.HSTSPolicy
        ...
        // Owm methods of Soup-2.4.HSTSPolicy
     ...
     */
    class MessageBody {
        // Own fields of Soup-2.4.MessageBody

        data: string;
        length: number;

        // Constructors of Soup-2.4.MessageBody
        ...
        // Owm methods of Soup-2.4.MessageBody
    ...
    class MessageHeaders {
         ...
         */
        get_content_disposition(): boolean;
        /**
         ...
         */
        get_ranges(total_length: number): boolean;
        /**
    ...
    class MessageHeadersIter {
        // Constructors of Soup-2.4.MessageHeadersIter

        constructor(properties?: Partial<{}>);

        // Owm methods of Soup-2.4.MessageHeadersIter

        /**
         * Initializes `iter` for iterating `hdrs`.
         * @param hdrs a %SoupMessageHeaders
         */
        static init(hdrs: MessageHeaders): void;
     ...
     */
    class Multipart {
        // Constructors of Soup-2.4.Multipart
        ...
        // Owm methods of Soup-2.4.Multipart
     ...
     */
    class Range {
        // Own fields of Soup-2.4.Range

        start: number;
        end: number;

        // Constructors of Soup-2.4.Range
    ...
    class RequestClass {
        // Own fields of Soup-2.4.RequestClass
    ...
    class WebsocketExtensionClass {
        // Own fields of Soup-2.4.WebsocketExtensionClass
     ...
     */
    class XMLRPCParams {
        // Owm methods of Soup-2.4.XMLRPCParams
    ...
    interface PasswordManager {
        // Owm methods of Soup-2.4.PasswordManager
        ...
        // Own virtual methods of Soup-2.4.PasswordManager
    ...
    interface ProxyResolver {
        // Owm methods of Soup-2.4.ProxyResolver
        ...
        // Own virtual methods of Soup-2.4.ProxyResolver
        ...
        vfunc_get_proxy_sync(msg: Message, cancellable: Gio.Cancellable | null): number;
    }

    interface ProxyURIResolver {
        // Owm methods of Soup-2.4.ProxyURIResolver
        ...
        // Own virtual methods of Soup-2.4.ProxyURIResolver
         ...
         * @param cancellable a #GCancellable, or %NULL
         */
        vfunc_get_proxy_uri_sync(uri: URI, cancellable: Gio.Cancellable | null): number;
    }

    interface SessionFeature {
        // Owm methods of Soup-2.4.SessionFeature
        ...
        // Own virtual methods of Soup-2.4.SessionFeature

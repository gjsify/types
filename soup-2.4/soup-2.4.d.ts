...
static ENCODING: number
    ...
    // Constructors of Soup.RequestError

constructor(options: { message: string, code: number});
_init(...args: any[]): void;


    // Own static methods of Soup.RequestError
...
static UNSUPPORTED_URI_SCHEME: number
    ...
    // Constructors of Soup.RequesterError

constructor(options: { message: string, code: number});
_init(...args: any[]): void;


    // Own static methods of Soup.RequesterError
...
static NO_PSL_DATA: number
    ...
    // Constructors of Soup.TLDError

constructor(options: { message: string, code: number});
_init(...args: any[]): void;


    // Own static methods of Soup.TLDError
...
static RETVAL: number
    ...
    // Constructors of Soup.XMLRPCError
 ...
 */
function form_decode_multipart(msg: Message, file_control_name: (string | null)): [(GLib.HashTable<string, string> | null), string, string, Buffer | null]
/**
 ...
 * @returns the new %SoupMessage
 */
function form_request_new_from_hash(method: string, uri: string, form_data_set: GLib.HashTable<string, string>): Message
/**
 ...
 * @param value a value
 */
function value_hash_insert_value(hash: GLib.HashTable<string, GObject.Value>, key: string, value: GObject.Value): void
/**
...
interface ServerCallback {
    (server: Server, msg: Message, path: string, query: (GLib.HashTable<string, string> | null), client: ClientContext): void
}
...
static ["new"](type: GObject.GType, msg: Message, auth_header: string): Auth;
    ...
    // Own virtual methods of Soup.Auth
...
abstract class AuthDomain extends GObject.Object {
    ...
    // Constructors of Soup.AuthDomain
...
_init(...args: any[]): void;
    ...
    // Own virtual methods of Soup.AuthDomain
    ...
    // Own methods of Soup.AuthDomain
...
class AuthDomainBasic extends AuthDomain {
    ...
    // Constructors of Soup.AuthDomainBasic
...
_init(...args: any[]): void;
    ...
    // Own methods of Soup.AuthDomainBasic
...
class AuthDomainDigest extends AuthDomain {
    ...
    // Constructors of Soup.AuthDomainDigest
...
_init(...args: any[]): void;
    ...
    // Own static methods of Soup.AuthDomainDigest
    ...
    // Own methods of Soup.AuthDomainDigest
...
_init(...args: any[]): void;
    ...
    // Own signals of Soup.AuthManager

    connect(id: string, callback: (...args: any[]) => any): number
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'authenticate', callback: ((_source: this, msg: Message, auth: Auth, retrying: boolean) => void)): number
    connect_after(signal: 'authenticate', callback: ((_source: this, msg: Message, auth: Auth, retrying: boolean) => void)): number
    emit(signal: 'authenticate', msg: Message, auth: Auth, retrying: boolean): void

    // Own virtual methods of Soup.AuthManager

    vfunc_authenticate(msg: Message, auth: Auth, retrying: boolean): void

    // Own methods of Soup.AuthManager
...
_init(...args: any[]): void;
    ...
    // Own static methods of Soup.AuthNegotiate
...
static ["new"](cache_dir: (string | null), cache_type: CacheType): Cache;
    ...
    // Own virtual methods of Soup.Cache

    vfunc_get_cacheability(msg: Message): Cacheability

    // Own methods of Soup.Cache
...
static ["new"](): ContentSniffer;
    ...
    // Own virtual methods of Soup.ContentSniffer
    ...
    // Own methods of Soup.ContentSniffer
...
class CookieJar extends GObject.Object implements SessionFeature {
    ...
    // Constructors of Soup.CookieJar
...
static ["new"](): CookieJar;
    ...
    // Own virtual methods of Soup.CookieJar
...
class CookieJarDB extends CookieJar implements SessionFeature {
    ...
    // Constructors of Soup.CookieJarDB
...
class CookieJarText extends CookieJar implements SessionFeature {
    ...
    // Constructors of Soup.CookieJarText
...
static ["new"](): HSTSEnforcer;
    ...
    // Own signals of Soup.HSTSEnforcer

    connect(id: string, callback: (...args: any[]) => any): number
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'changed', callback: ((_source: this, old_policy: HSTSPolicy, new_policy: HSTSPolicy) => void)): number
    connect_after(signal: 'changed', callback: ((_source: this, old_policy: HSTSPolicy, new_policy: HSTSPolicy) => void)): number
    ...
    // Own methods of Soup.HSTSEnforcer
...
class HSTSEnforcerDB extends HSTSEnforcer implements SessionFeature {
    ...
    // Constructors of Soup.HSTSEnforcerDB
...
static new_from_uri(method: string, uri: URI): Message;
    ...
    // Own signals of Soup.Message

    connect(id: string, callback: (...args: any[]) => any): number
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'content-sniffed', callback: ((_source: this, type: string, params: GLib.HashTable<string, string>) => void)): number
    connect_after(signal: 'content-sniffed', callback: ((_source: this, type: string, params: GLib.HashTable<string, string>) => void)): number
    ...
    connect(signal: 'network-event', callback: ((_source: this, event: Gio.SocketClientEvent, connection: Gio.IOStream) => void)): number
    connect_after(signal: 'network-event', callback: ((_source: this, event: Gio.SocketClientEvent, connection: Gio.IOStream) => void)): number
    ...
    // Own virtual methods of Soup.Message
...
class MultipartInputStream extends Gio.FilterInputStream implements Gio.PollableInputStream {
    ...
    // Constructors of Soup.MultipartInputStream
...
static ["new"](msg: Message, base_stream: Gio.InputStream): MultipartInputStream;
    ...
    // Own methods of Soup.MultipartInputStream
 ...
 */
close_async(io_priority: number, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<this> | null)): void
/**
 ...
 * @param callback callback to call when the request is satisfied
 */
read_all_async(io_priority: number, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<this> | null)): Uint8Array
/**
 ...
 * @param callback callback to call when the request is satisfied
 */
read_async(io_priority: number, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<this> | null)): Uint8Array
/**
 ...
 * @param callback callback to call when the request is satisfied
 */
read_bytes_async(count: number, io_priority: number, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<this> | null)): void
/**
 ...
 * @param callback callback to call when the request is satisfied
 */
skip_async(count: number, io_priority: number, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<this> | null)): void
/**
 ...
 * @param callback callback to call when the request is satisfied
 */
vfunc_close_async(io_priority: number, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<this> | null)): void
/**
 * Finishes closing a stream asynchronously, started from g_input_stream_close_async().
 * @param result a #GAsyncResult.
 */
 ...
 * @param callback callback to call when the request is satisfied
 */
vfunc_read_async(io_priority: number, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<this> | null)): Uint8Array | null
/**
 * Finishes an asynchronous stream read operation.
 * @param result a #GAsyncResult.
 */
 ...
 * @param callback callback to call when the request is satisfied
 */
vfunc_skip_async(count: number, io_priority: number, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<this> | null)): void
/**
 * Finishes a stream skip operation.
 * @param result a #GAsyncResult.
 */
...
class ProxyResolverDefault extends GObject.Object implements ProxyURIResolver, SessionFeature {
    ...
    // Constructors of Soup.ProxyResolverDefault
...
_init(...args: any[]): void;
    ...
    // Own virtual methods of Soup.Request
...
_init(...args: any[]): void;
    ...
    // Own methods of Soup.RequestFile
...
_init(...args: any[]): void;
    ...
    // Own methods of Soup.RequestHTTP
...
_init(...args: any[]): void;
    ...
    // Own signals of Soup.Server

    connect(id: string, callback: (...args: any[]) => any): number
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'request-aborted', callback: ((_source: this, message: Message, client: ClientContext) => void)): number
    connect_after(signal: 'request-aborted', callback: ((_source: this, message: Message, client: ClientContext) => void)): number
    emit(signal: 'request-aborted', message: Message, client: ClientContext): void
    connect(signal: 'request-finished', callback: ((_source: this, message: Message, client: ClientContext) => void)): number
    connect_after(signal: 'request-finished', callback: ((_source: this, message: Message, client: ClientContext) => void)): number
    ...
    connect_after(signal: 'request-read', callback: ((_source: this, message: Message, client: ClientContext) => void)): number
    emit(signal: 'request-read', message: Message, client: ClientContext): void
    connect(signal: 'request-started', callback: ((_source: this, message: Message, client: ClientContext) => void)): number
    connect_after(signal: 'request-started', callback: ((_source: this, message: Message, client: ClientContext) => void)): number
    emit(signal: 'request-started', message: Message, client: ClientContext): void

    // Own virtual methods of Soup.Server
...
static ["new"](): Session;
    ...
    // Own virtual methods of Soup.Session
...
_init(...args: any[]): void;
    ...
    connect(signal: 'event', callback: ((_source: this, event: Gio.SocketClientEvent, connection: Gio.IOStream) => void)): number
    connect_after(signal: 'event', callback: ((_source: this, event: Gio.SocketClientEvent, connection: Gio.IOStream) => void)): number
    ...
    // Own virtual methods of Soup.Socket
     ...
     */
    read(buffer: Uint8Array, cancellable?: (Gio.Cancellable | null)): [SocketIOStatus, number]
    /**
     ...
     */
    read_until(buffer: Uint8Array, boundary: (any | null), boundary_len: number, cancellable?: (Gio.Cancellable | null)): [SocketIOStatus, number, boolean]
    /**
     ...
     */
    write(buffer: Uint8Array, cancellable?: (Gio.Cancellable | null)): [SocketIOStatus, number]
...
class WebsocketConnection extends GObject.Object {
    ...
    // Constructors of Soup.WebsocketConnection
...
static new_with_extensions(stream: Gio.IOStream, uri: URI, type: WebsocketConnectionType, origin: (string | null), protocol: (string | null), extensions: WebsocketExtension[]): WebsocketConnection;
    ...
    // Own signals of Soup.WebsocketConnection
    ...
    // Own virtual methods of Soup.WebsocketConnection
...
_init(...args: any[]): void;
    ...
    // Own virtual methods of Soup.WebsocketExtension
...
static ["new"](use: MemoryUse, data: Uint8Array): Buffer;
...
_init(...args: any[]): void;
    ...
    // Own methods of Soup.ClientContext
...
static ["new"](name: string, value: string, domain: string, path: string, max_age: number): Cookie;
    ...
    // Own static methods of Soup.Cookie
...
static new_session_policy(domain: string, include_subdomains: boolean): HSTSPolicy;
    ...
    // Own methods of Soup.HSTSPolicy
...
length: number
    ...
    // Constructors of Soup.MessageBody
...
static ["new"](): MessageBody;
    ...
    // Own methods of Soup.MessageBody
...
static ["new"](type: MessageHeadersType): MessageHeaders;
    ...
    // Own methods of Soup.MessageHeaders
...
_init(...args: any[]): void;
    ...
    // Own static methods of Soup.MessageHeadersIter
    ...
    // Own methods of Soup.MessageHeadersIter
...
static new_with_base(base: URI, uri_string: string): URI;
    ...
    // Own static methods of Soup.URI
...
_init(...args: any[]): void;
    ...
    // Own methods of Soup.XMLRPCParams
...
interface PasswordManager extends SessionFeature {
    ...
    // Own methods of Soup.PasswordManager
    ...
    // Own virtual methods of Soup.PasswordManager
...
interface ProxyResolver extends SessionFeature {
    ...
    // Own methods of Soup.ProxyResolver
    ...
    // Own virtual methods of Soup.ProxyResolver
...
interface ProxyURIResolver extends SessionFeature {
    ...
    // Own methods of Soup.ProxyURIResolver
    ...
    // Own virtual methods of Soup.ProxyURIResolver
...
interface SessionFeature extends GObject.Object {
    ...
    // Own methods of Soup.SessionFeature
    ...
    // Own virtual methods of Soup.SessionFeature

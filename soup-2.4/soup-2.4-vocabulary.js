...
export const PROP_TYPES = {
    'SoupAddress.family': 'SoupAddressFamily',
    'SoupAddress.name': 'gchararray',
    'SoupAddress.port': 'gint',
    'SoupAddress.protocol': 'gchararray',
    'SoupAddress.sockaddr': 'gpointer',
    'SoupAuth.host': 'gchararray',
    'SoupAuth.is-for-proxy': 'gboolean',
    'SoupAuth.realm': 'gchararray',
    'SoupAuthDomain.add-path': 'gchararray',
    ...
    'SoupAuthDomain.remove-path': 'gchararray',
    ...
    'SoupMessage.priority': 'SoupMessagePriority',
    'SoupMessage.reason-phrase': 'gchararray',
    'SoupMessage.server-side': 'gboolean',
    'SoupMessage.status-code': 'guint',
    'SoupMessage.tls-certificate': 'GTlsCertificate',
    'SoupMessage.tls-errors': 'GTlsCertificateFlags',
    'SoupMultipartInputStream.message': 'SoupMessage',
    'SoupProxyResolverDefault.gproxy-resolver': 'GProxyResolver',
    'SoupRequest.session': 'SoupSession',
    'SoupServer.async-context': 'gpointer',
    'SoupServer.interface': 'SoupAddress',
    'SoupServer.port': 'guint',
    'SoupServer.raw-paths': 'gboolean',
    'SoupServer.server-header': 'gchararray',
    'SoupServer.ssl-cert-file': 'gchararray',
    'SoupServer.ssl-key-file': 'gchararray',
    ...
    'SoupSession.async-context': 'gpointer',
    'SoupSession.idle-timeout': 'guint',
    'SoupSession.local-address': 'SoupAddress',
    'SoupSession.max-conns': 'gint',
    'SoupSession.max-conns-per-host': 'gint',
    'SoupSession.proxy-resolver': 'GProxyResolver',
    'SoupSession.ssl-ca-file': 'gchararray',
    'SoupSession.ssl-strict': 'gboolean',
    'SoupSession.ssl-use-system-ca-file': 'gboolean',
    'SoupSession.timeout': 'guint',
    'SoupSession.tls-database': 'GTlsDatabase',
    'SoupSession.tls-interaction': 'GTlsInteraction',
    'SoupSession.use-ntlm': 'gboolean',
    'SoupSession.use-thread-context': 'gboolean',
    'SoupSession.user-agent': 'gchararray',
    'SoupSocket.async-context': 'gpointer',
    'SoupSocket.fd': 'gint',
    'SoupSocket.gsocket': 'GSocket',
    'SoupSocket.iostream': 'GIOStream',
    'SoupSocket.ipv6-only': 'gboolean',
    'SoupSocket.local-address': 'SoupAddress',
    'SoupSocket.non-blocking': 'gboolean',
    'SoupSocket.remote-address': 'SoupAddress',
    'SoupSocket.ssl-creds': 'gpointer',
    'SoupSocket.ssl-fallback': 'gboolean',
    'SoupSocket.ssl-strict': 'gboolean',
    'SoupSocket.timeout': 'guint',
    'SoupSocket.use-thread-context': 'gboolean',
    'SoupWebsocketConnection.connection-type': 'SoupWebsocketConnectionType',

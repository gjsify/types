// The widget vocabulary of Gvc-1.0 as runtime data.
//
// GENERATED — do not edit. Provenance: Gvc-1.0 — prop(s) no TypeScript value satisfies: Gvc.MixerCard.pa-context Gvc.MixerStream.pa-context Gvc.MixerUIDevice.card
//
...
export const PROVENANCE = {
    ...
    droppedBases: [],
    inlinedBases: [],
    unsettableProps: ['Gvc.MixerCard.pa-context', 'Gvc.MixerStream.pa-context', 'Gvc.MixerUIDevice.card'],
    unresolvedProps: [],

...
static ["new"](): PreviewPlayer;
    ...
    connect(signal: 'progress', callback: ((_source: this, uri: string, state: Unity.MusicPreviewTrackState, progress: number) => void)): number
    connect_after(signal: 'progress', callback: ((_source: this, uri: string, state: Unity.MusicPreviewTrackState, progress: number) => void)): number

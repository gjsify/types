...
export namespace UnityExtras {
     ...
     * @param _callback_ 
     */
    function show_in_folder(uri: string, _callback_: Gio.AsyncReadyCallback<string> | null): globalThis.Promise<void> | void;
    ...
    class PreviewPlayer extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof PreviewPlayer.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<PreviewPlayer.SignalSignatures[K]>): void;
         ...
         * @param _callback_ 
         */
        video_properties(uri: string, _callback_?: Gio.AsyncReadyCallback<this> | null): globalThis.Promise<{ [key: string]: GLib.Variant }> | void;

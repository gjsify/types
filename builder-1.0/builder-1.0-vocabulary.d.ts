 ...
 *
 * 10 instantiable GTypes (of which 6 concrete widgets), 11 declarations (1 inlined from a namespace whose vocabulary does not emit them), 1 enum nick unions, 3 slot candidates.
 *
...
export interface GbApplicationProps extends GtkApplicationProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GbApplicationConstructOnly = GtkApplicationConstructOnly;
...
export interface GbMenuExtensionProps {
    menu?: Gio.Menu;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GbMenuExtensionConstructOnly = 'menu';
...
export interface GbTreeBuilderProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GbTreeBuilderConstructOnly = never;

export interface GbTreeNodeProps {
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GbTreeNodeConstructOnly = never;

 ...
 *
 * 10 instantiable GTypes (of which 6 concrete widgets), 10 declarations, 1 enum nick unions, 3 slot candidates.
 *
...
export interface GbApplicationProps extends GtkApplicationProps, GActionGroupProps, GActionMapProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GbApplicationConstructOnly = GtkApplicationConstructOnly | GActionGroupConstructOnly | GActionMapConstructOnly;
...
export interface GbMenuExtensionProps extends GObjectProps {
    menu?: Gio.Menu;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GbMenuExtensionConstructOnly = GObjectConstructOnly | 'menu';
...
export interface GbTreeBuilderProps extends GInitiallyUnownedProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GbTreeBuilderConstructOnly = GInitiallyUnownedConstructOnly;

export interface GbTreeNodeProps extends GInitiallyUnownedProps {
    ...
    tree?: Builder.Tree;
    'use-dim-label'?: boolean;
    /** If the "text" property includes #GMarkup. */
    'use-markup'?: boolean;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GbTreeNodeConstructOnly = GInitiallyUnownedConstructOnly;
...
export interface GbWorkbenchProps extends GtkApplicationWindowProps, GActionGroupProps, GActionMapProps, GtkBuildableProps {
    /** The "context" property is the #IdeContext that shall be worked upon in the #GbWorkbench. */
    context?: Ide.Context;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GbWorkbenchConstructOnly = GtkApplicationWindowConstructOnly | GActionGroupConstructOnly | GActionMapConstructOnly | GtkBuildableConstructOnly | 'context';

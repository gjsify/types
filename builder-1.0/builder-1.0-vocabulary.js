...
export const ENUM_VALUES = {
    'GbViewGridSplit.left': 1,
    'GbViewGridSplit.move-left': 3,
    'GbViewGridSplit.move-right': 4,
    'GbViewGridSplit.right': 2,
};
...
export const PROP_TYPES = {
    'GbMenuExtension.menu': 'GMenu',
    'GbTree.root': 'GbTreeNode',
    'GbTree.selection': 'GbTreeNode',
    'GbTree.show-icons': 'gboolean',
    'GbTreeNode.children-possible': 'gboolean',
    'GbTreeNode.icon-name': 'gchararray',
    'GbTreeNode.item': 'GObject',
    'GbTreeNode.text': 'gchararray',
    'GbTreeNode.tree': 'GbTree',
    'GbTreeNode.use-dim-label': 'gboolean',
    'GbTreeNode.use-markup': 'gboolean',
    'GbViewStack.active-view': 'GbView',
    'GbWorkbench.context': 'IdeContext',
};

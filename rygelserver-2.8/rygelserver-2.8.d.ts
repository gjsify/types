...
module MediaContainer {
    ...
    interface ContainerUpdated {
        (container: MediaContainer, object: MediaObject, event_type: ObjectEventType, sub_tree_update: boolean): void
    }
...
_init(...args: any[]): void;
    ...
    connect(signal: 'container-updated', callback: ((_source: this, container: MediaContainer, object: MediaObject, event_type: ObjectEventType, sub_tree_update: boolean) => void)): number
    connect_after(signal: 'container-updated', callback: ((_source: this, container: MediaContainer, object: MediaObject, event_type: ObjectEventType, sub_tree_update: boolean) => void)): number
    emit(signal: 'container-updated', container: MediaContainer, object: MediaObject, event_type: ObjectEventType, sub_tree_update: boolean): void
    connect(signal: 'sub-tree-updates-finished', callback: ((_source: this, sub_tree_root: MediaObject) => void)): number
    connect_after(signal: 'sub-tree-updates-finished', callback: ((_source: this, sub_tree_root: MediaObject) => void)): number
...
_init(...args: any[]): void;
    ...
    static apply_replacements(replacement_pairs: GLib.HashTable<string, string>, source_string?: (string | null)): (string | null)
...
_init(...args: any[]): void;
    ...
    create_data_source_for_resource(item: MediaObject, resource: MediaResource, replacements: GLib.HashTable<string, string>): (DataSource | null)

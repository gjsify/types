 ...
 */
export function categoriesDupIconFileFor(category: string): string | null
/**
 ...
 */
export function gdataTaskAddId(builder: Json.Builder, value: string): void
/**
 ...
 */
export function gdataTaskAddTitle(builder: Json.Builder, value: string): void
/**
 ...
 */
export function gdataTasklistAddId(builder: Json.Builder, value: string): void
/**
 ...
 */
export function gdataTasklistAddTitle(builder: Json.Builder, value: string): void
/**
 ...
 */
export function oauth2ServiceUtilCompileValue(compileValue: string, outGlobBuffSize: number): [ /* returnType */ string, /* outGlobBuff */ string | null ]
/**
 ...
 */
export function oauth2ServiceUtilExtractFromUri(inUri: string): [ /* returnType */ boolean, /* outAuthorizationCode */ string | null, /* outErrorCode */ string | null, /* outErrorDescription */ string | null ]
/**
 ...
 * @returns %TRUE on success, %FALSE on error
 */
export function secretStoreLookupSync(uid: string, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* outSecret */ string | null ]
/**
 ...
 */
export function timeParseDate(value: string, result: any | null): TimeParseStatus
/**
 ...
 */
export function timeParseDateAndTime(value: string, result: any | null): TimeParseStatus
/**
 * Parses a string `value` containing a date and a time and stores the
 * result in `result`. The date in `value` is expected to be in a format
 * like "Wed 3/13/00 14:20:00", though gettext() is used to support the
 ...
 * @returns E_TIME_PARSE_OK if the string was successfully parsed,          E_TIME_PARSE_NONE if the string was empty, or          E_TIME_PARSE_INVALID if the string could not be parsed.
 */
export function timeParseDateAndTimeEx(value: string, result: any | null, twoDigitYear: boolean): TimeParseStatus
/**
 * Takes in a date string entered by the user and tries to convert it to
 * a struct #tm.
 * @param value A date string.
 ...
 * @returns An #ETimeParseStatus result code indicating whether @value was an empty string, a valid date, or an invalid date.
 */
export function timeParseDateEx(value: string, result: any | null, twoDigitYear: boolean): TimeParseStatus
/**
 ...
 */
export function timeParseDateFormat(value: string, format: string): [ /* returnType */ TimeParseStatus, /* outResult */ any | null, /* outTwoDigitYear */ boolean ]
/**
 ...
 * @returns An #ETimeParseStatus result code indicating whether @value was an empty string, a valid date, or an invalid date.
 */
export function timeParseTime(value: string, result: any | null): TimeParseStatus
/**
 ...
 * @returns The number of characters placed in @s.
 */
export function utf8Strftime(string: string | null, max: number, fmt: string, tm: any | null): number
/**
 ...
 */
export function utilEnsureGdbusString(str: string | null, gdbusStr: string | null): string
/**
 ...
 */
export function utilUtf8Decompose(text: string): string | null
/**

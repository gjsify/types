...
export namespace Lasem {
     ...
     * @param y 
     */
    function cairo_elliptical_arc(cairo: cairo.Context, rx: number, ry: number, x_axis_rotation: number, large_arc_flag: boolean, sweep_flag: boolean, x: number, y: number): void;
     ...
     * @param dy 
     */
    function cairo_rel_elliptical_arc(cairo: cairo.Context, rx: number, ry: number, x_axis_rotation: number, large_arc_flag: boolean, sweep_flag: boolean, dx: number, dy: number): void;
     ...
     * @since 0.4
     */
    function cairo_set_source_pixbuf(cairo: cairo.Context, pixbuf: GdkPixbuf.Pixbuf, pixbuf_x: number, pixbuf_y: number): void;

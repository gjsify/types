 ...
 */
function uriDataParse(string: string, flags: UriFlags): UriData
 ...
 */
function valueToBoolean(value: number[]): [ /* returnType */ boolean, /* result */ boolean ]
/**
 * Convert `CK_ULONG` type memory to a boolean.
 * @param value memory to convert
 * @returns Whether the conversion was successful.
 */
function valueToUlong(value: number[]): [ /* returnType */ boolean, /* result */ number ]
/**

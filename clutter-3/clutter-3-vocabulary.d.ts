/**
 * The GIR-derived widget VOCABULARY for Clutter-3.
 *
 * GENERATED — do not edit. Provenance: Clutter-3 — library 1.26.1 — dropped empty base(s): Atk.ImplementorIface
 *
 * 72 instantiable GTypes (of which 0 concrete widgets), 87 declarations, 46 enum nick unions, 0 slot candidates.
 *
...
import type Clutter from './clutter-3.js';

...
export namespace RB {
    ...
    /**
     * Predefined column types to use in {@link RB.EntryView}<!-- -->s.  Use
     * `rb_entry_view_append_column` to add these to an entry view.
     * The predefined column names map directly to the {@link RB.RhythmDBEntry} properties
     * the columns display.
     * @gir-type Enum
     */
     ...
     */
    function builder_load(file: string, user_data: null): Gtk.Builder;
     ...
     * @returns {@link Gtk.Builder} object built from the file
     */
    function builder_load_plugin_file(plugin: GObject.Object, file: string, user_data: null): Gtk.Builder;
     ...
     * All URIs passed to {@link RB.RhythmDB} functions should be canonicalised.
     ...
     * bytes available.
     * @param dir a {@link Gio.File} to check
     ...
     */
    function combo_box_hyphen_separator_func(model: Gtk.TreeModel, iter: Gtk.TreeIter, data: null): boolean;
     ...
     * @param parent parent {@link Gtk.Window} for the file chooser
     * @param action the {@link Gtk.FileChooserAction}
     ...
     * @param file a {@link Gio.File} to find an extant ancestor of
     ...
     * @param taglist a {@link Gst.TagList} containing an image
     ...
     * @param taglist a {@link Gst.TagList} containing a string tag
     * @param tag tag name
     * @param field returns the {@link RB.MetaDataField} corresponding to the tag
     ...
     */
    function refstring_equal(ap: null, bp: null): boolean;
     ...
     */
    function refstring_hash(p: null): number;
     ...
     * @param pixbuf the {@link GdkPixbuf.Pixbuf} containing the original image
     ...
     * @param treeview the {@link Gtk.TreeView} containing the column
     * @param column the {@link Gtk.TreeViewColumn} to size
     * @param renderer the {@link Gtk.CellRenderer} used in the column
    ...
    interface AsyncCopyCallback {
        (copy: AsyncCopy, success: boolean, data: null): void;
    }
    ...
    interface AsyncCopyProgressCallback {
        (copy: AsyncCopy, position: number, total: number, data: null): void;
    }
    ...
    interface DelayedSyncFunc {
        (settings: Gio.Settings, data: null): void;
    }
    ...
    interface RhythmDBEntryForeachFunc {
        (entry: RhythmDBEntry, data: null): void;
    }
    ...
    interface SegmentedBarValueFormatter {
        (percent: number, data: null): string;
    }
    ...
    interface SourceAddCallback {
        (source: Source, uri: string, data: null): void;
    }
    ...
    interface UriRecurseFunc {
        (file: Gio.File, info: Gio.FileInfo, data: null): boolean;
    }
    ...
    class AsyncCopy extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof AsyncCopy.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<AsyncCopy.SignalSignatures[K]>): void;
    ...
    class AutoPlaylistSource extends PlaylistSource implements Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
        ...
        /** @signal */
        emit<K extends keyof AutoPlaylistSource.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<AutoPlaylistSource.SignalSignatures[K]>): void;
    }
    ...
    abstract class BrowserSource extends Source implements Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
        ...
        /** @signal */
        emit<K extends keyof BrowserSource.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<BrowserSource.SignalSignatures[K]>): void;
    ...
    class ButtonBar extends Gtk.Grid implements Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
        ...
        /** @signal */
        emit<K extends keyof ButtonBar.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<ButtonBar.SignalSignatures[K]>): void;
    ...
    class CellRendererPixbuf extends Gtk.CellRendererPixbuf {
        ...
        /** @signal */
        emit<K extends keyof CellRendererPixbuf.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<CellRendererPixbuf.SignalSignatures[K]>): void;
    ...
    class CellRendererRating extends Gtk.CellRenderer {
        ...
        /** @signal */
        emit<K extends keyof CellRendererRating.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<CellRendererRating.SignalSignatures[K]>): void;
    ...
    class ChunkLoader extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof ChunkLoader.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<ChunkLoader.SignalSignatures[K]>): void;
    ...
    abstract class DisplayPage extends Gtk.Box implements Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
        ...
        /** @signal */
        emit<K extends keyof DisplayPage.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<DisplayPage.SignalSignatures[K]>): void;
         ...
         * @param prefs the {@link RB.ShellPreferences} object
         * @virtual
         */
    ...
    class DisplayPageGroup extends DisplayPage implements Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
        ...
        /** @signal */
        emit<K extends keyof DisplayPageGroup.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<DisplayPageGroup.SignalSignatures[K]>): void;
    ...
    class DisplayPageModel extends Gtk.TreeModelFilter implements Gtk.TreeDragSource, Gtk.TreeModel {
        ...
        /** @signal */
        emit<K extends keyof DisplayPageModel.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<DisplayPageModel.SignalSignatures[K]>): void;
         ...
         * @param page the {@link RB.DisplayPage} to add
         ...
         * with the {@link RB.DisplayPageModel}.
         * @param page the {@link RB.DisplayPage} to find
         * @param iter returns a {@link Gtk.TreeIter} for the page
    ...
    class DisplayPageTree extends Gtk.Grid implements Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
        ...
        /** @signal */
        emit<K extends keyof DisplayPageTree.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<DisplayPageTree.SignalSignatures[K]>): void;
    ...
    class EncoderFactory extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof EncoderFactory.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<EncoderFactory.SignalSignatures[K]>): void;
    ...
    class EntryView extends Gtk.Box implements Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
        ...
        /** @signal */
        emit<K extends keyof EntryView.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<EntryView.SignalSignatures[K]>): void;
         ...
         * @param targets an array of {@link Gtk.TargetEntry} structures defining the drag data targets
         ...
         * @param column a {@link RB.EntryViewColumn} to update
    ...
    class ExtDB extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof ExtDB.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<ExtDB.SignalSignatures[K]>): void;
         ...
         * the album art cache expects {@link GdkPixbuf.Pixbuf} objects here, rather than buffers
         ...
         * store, either as a string or as a {@link GLib.ByteArray}.
         * @param key metadata storage key
         * @param source_type metadata source type
         * @param data data to store
         */
    ...
    class FadingImage extends Gtk.Widget implements Atk.ImplementorIface, Gtk.Buildable {
        ...
        /** @signal */
        emit<K extends keyof FadingImage.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<FadingImage.SignalSignatures[K]>): void;
    ...
    class LibraryBrowser extends Gtk.Box implements Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
        ...
        /** @signal */
        emit<K extends keyof LibraryBrowser.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<LibraryBrowser.SignalSignatures[K]>): void;
         ...
         * @param model the new input {@link RB.RhythmDBQueryModel}
    ...
    class ListModel extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof ListModel.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<ListModel.SignalSignatures[K]>): void;
    ...
    class MediaPlayerEntryType extends RhythmDBEntryType {
        ...
        /** @signal */
        emit<K extends keyof MediaPlayerEntryType.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<MediaPlayerEntryType.SignalSignatures[K]>): void;
    }
    ...
    class MediaPlayerSource extends BrowserSource implements Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
        ...
        /** @signal */
        emit<K extends keyof MediaPlayerSource.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<MediaPlayerSource.SignalSignatures[K]>): void;
    ...
    class MetaData extends GObject.Object {
         ...
         * @param field the {@link RB.MetaDataField} to retrieve
         ...
         * @param field the {@link RB.MetaDataField} to set
    ...
    class PlayOrder extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof PlayOrder.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<PlayOrder.SignalSignatures[K]>): void;
    ...
    class PlaylistManager extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof PlaylistManager.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<PlaylistManager.SignalSignatures[K]>): void;
         ...
         * to the source list.
         * @param data the {@link Gtk.SelectionData} from which to create a playlist
    ...
    abstract class PlaylistSource extends Source implements Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
        ...
        /** @signal */
        emit<K extends keyof PlaylistSource.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<PlaylistSource.SignalSignatures[K]>): void;
         ...
         * @param entry_view the new {@link RB.EntryView} to set up
         */
    ...
    class PodcastManager extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof PodcastManager.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<PodcastManager.SignalSignatures[K]>): void;
    ...
    class PodcastSearch extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof PodcastSearch.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<PodcastSearch.SignalSignatures[K]>): void;
    ...
    class PodcastSearchITunes extends PodcastSearch {
        ...
        /** @signal */
        emit<K extends keyof PodcastSearchITunes.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<PodcastSearchITunes.SignalSignatures[K]>): void;
    }
    ...
    class PropertyView extends Gtk.ScrolledWindow implements Atk.ImplementorIface, Gtk.Buildable {
        ...
        /** @signal */
        emit<K extends keyof PropertyView.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<PropertyView.SignalSignatures[K]>): void;
         ...
         * @param mode the new {@link Gtk.SelectionMode} for the property view
         */
    ...
    class Rating extends Gtk.Widget implements Atk.ImplementorIface, Gtk.Buildable {
        ...
        /** @signal */
        emit<K extends keyof Rating.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<Rating.SignalSignatures[K]>): void;
    ...
    namespace RemovableMediaManager {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
             ...
             * corresponding {@link RB.Source}.  The first signal handler that returns a
    ...
    class RemovableMediaManager extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof RemovableMediaManager.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<RemovableMediaManager.SignalSignatures[K]>): void;
    ...
    /**
     * RhythmDB is an in-memory database containing {@link RB.RhythmDBEntry} items.  It
     * runs queries represented as {@link GLib.PtrArray}<!-- -->s containing query criteria,
    ...
    abstract class RhythmDB extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof RhythmDB.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<RhythmDB.SignalSignatures[K]>): void;
         ...
         * @param type the {@link RB.RhythmDBEntryType} to use for new entries
         ...
         * query is complete.
         * @param results a {@link RB.RhythmDBQueryResults} instance to feed results to
         ...
         * is determined by signal connection order, with {@link GObject.ConnectFlags.AFTER} providing a
         * second, lower rank of priority.
         * A handler returning a value should do so in a {@link GObject.Value} allocated on the heap;
         * the accumulator will take ownership. The caller should unset and free the
         * {@link GObject.Value} if non-`null` when finished with it.
         * @param entry a {@link RB.RhythmDBEntry}
         * @param property_name the metadata predicate
    ...
    class RhythmDBEntryType extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof RhythmDBEntryType.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<RhythmDBEntryType.SignalSignatures[K]>): void;
    ...
    class RhythmDBImportJob extends GObject.Object implements TaskProgress {
        ...
        /** @signal */
        emit<K extends keyof RhythmDBImportJob.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<RhythmDBImportJob.SignalSignatures[K]>): void;
    ...
    class RhythmDBPropertyModel extends GObject.Object implements Gtk.TreeModel {
        ...
        /** @signal */
        emit<K extends keyof RhythmDBPropertyModel.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<RhythmDBPropertyModel.SignalSignatures[K]>): void;
         ...
         * @param iter a {@link Gtk.TreeIter} to point to the row
    ...
    namespace RhythmDBQueryModel {
        ...
        interface ConstructorProps extends GObject.Object.ConstructorProps, Gtk.TreeModel.ConstructorProps, RhythmDBQueryResults.ConstructorProps {
            ...
            sort_data: never;
            sortData: never;
            sort_data_destroy: never;
            sortDataDestroy: never;
            sort_func: never;
            sortFunc: never;
    ...
    class RhythmDBQueryModel extends GObject.Object implements Gtk.TreeModel, RhythmDBQueryResults {
        ...
        get sort_data(): null;
        set sort_data(val: never);

        get sortData(): null;
        set sortData(val: never);

        get sort_data_destroy(): null;
        set sort_data_destroy(val: never);

        get sortDataDestroy(): null;
        set sortDataDestroy(val: never);

        get sort_func(): null;
        set sort_func(val: never);

        get sortFunc(): null;
        set sortFunc(val: never);
        ...
        /** @signal */
        emit<K extends keyof RhythmDBQueryModel.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<RhythmDBQueryModel.SignalSignatures[K]>): void;
         ...
         * @param data nothing
         */
        static album_sort_func(a: RhythmDBEntry, b: RhythmDBEntry, data: null): number;
         ...
         * @param data nothing
         */
        static artist_sort_func(a: RhythmDBEntry, b: RhythmDBEntry, data: null): number;
         ...
         * @param data nothing
         */
        static bitrate_sort_func(a: RhythmDBEntry, b: RhythmDBEntry, data: null): number;
         ...
         * @param data nothing
         */
        static composer_sort_func(a: RhythmDBEntry, b: RhythmDBEntry, data: null): number;
         ...
         * @param data nothing
         */
        static date_sort_func(a: RhythmDBEntry, b: RhythmDBEntry, data: null): number;
         ...
         */
        static double_ceiling_sort_func(a: RhythmDBEntry, b: RhythmDBEntry, data: null): number;
         ...
         * @param data nothing
         */
        static genre_sort_func(a: RhythmDBEntry, b: RhythmDBEntry, data: null): number;
         ...
         * @param data nothing
         */
        static location_sort_func(a: RhythmDBEntry, b: RhythmDBEntry, data: null): number;
         ...
         * @param data property to sort on
         */
        static string_sort_func(a: RhythmDBEntry, b: RhythmDBEntry, data: null): number;
         ...
         * @param data nothing
         */
        static title_sort_func(a: RhythmDBEntry, b: RhythmDBEntry, data: null): number;
         ...
         * @param data nothing
         */
        static track_sort_func(a: RhythmDBEntry, b: RhythmDBEntry, data: null): number;
         ...
         * @param data property to sort on
         */
        static ulong_sort_func(a: RhythmDBEntry, b: RhythmDBEntry, data: null): number;
         ...
         * @param entry a {@link RB.RhythmDBEntry} to add
         ...
         * base model.
         * @param base the {@link RB.RhythmDBQueryModel} to chain it to
         ...
         * @param iter holds the returned {@link Gtk.TreeIter}
         ...
         * @param entry_iter a {@link Gtk.TreeIter} to dereference
         ...
         * @param entry the {@link RB.RhythmDBEntry} to move
    ...
    class RhythmDBQueryResultList extends GObject.Object implements RhythmDBQueryResults {
        ...
        /** @signal */
        emit<K extends keyof RhythmDBQueryResultList.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<RhythmDBQueryResultList.SignalSignatures[K]>): void;
    ...
    class SearchEntry extends Gtk.Box implements Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
        ...
        /** @signal */
        emit<K extends keyof SearchEntry.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<SearchEntry.SignalSignatures[K]>): void;
    ...
    class SegmentedBar extends Gtk.Widget implements Atk.ImplementorIface, Gtk.Buildable {
        ...
        /** @signal */
        emit<K extends keyof SegmentedBar.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<SegmentedBar.SignalSignatures[K]>): void;
    ...
    namespace Shell {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
            /**
             * Emitted when creating a new {@link RB.SongInfo} window.  Signal handlers can
    ...
    class Shell extends GObject.Object {
         ...
         * @param widget the {@link Gtk.Widget} to insert into the main window
         ...
         * @param source the {@link RB.Source} to register
    ...
    class ShellPlayer extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof ShellPlayer.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<ShellPlayer.SignalSignatures[K]>): void;
         ...
         * @param order_type the {@link GObject.GType} of the play order class
    ...
    class ShellPreferences extends Gtk.Dialog implements Atk.ImplementorIface, Gtk.Buildable {
        ...
        /** @signal */
        emit<K extends keyof ShellPreferences.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<ShellPreferences.SignalSignatures[K]>): void;
         ...
         * @param widget the {@link Gtk.Widget} to insert into the preferences window
         * @param location the location at which to insert the widget
         * @param expand whether the widget should be given extra space
         * @param fill whether the widget should fill all space allocated to it
         */
    ...
    class SongInfo extends Gtk.Dialog implements Atk.ImplementorIface, Gtk.Buildable {
        ...
        /** @signal */
        emit<K extends keyof SongInfo.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<SongInfo.SignalSignatures[K]>): void;
         ...
         * @param page the page {@link Gtk.Widget}
    ...
    abstract class Source extends DisplayPage implements Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
         ...
         * @param entries a list of {@link RB.RhythmDBEntry} objects to paste in
         * @virtual
         */
         ...
         * browser (if any).
         * @param search the active {@link RB.SourceSearch} instance
         ...
         * @param paned the {@link Gtk.Paned} containing the entry view and the browser
         ...
         * @param db the {@link RB.RhythmDB} instance
         * @param entry the {@link RB.RhythmDBEntry} to update
         */
    ...
    class SourceSearch extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof SourceSearch.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<SourceSearch.SignalSignatures[K]>): void;
    ...
    class SourceSearchBasic extends SourceSearch {
        ...
        /** @signal */
        emit<K extends keyof SourceSearchBasic.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<SourceSearchBasic.SignalSignatures[K]>): void;
         ...
         * @param menu the {@link Gio.Menu} to populate
    ...
    class SourceToolbar extends Gtk.Grid implements Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
        ...
        /** @signal */
        emit<K extends keyof SourceToolbar.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<SourceToolbar.SignalSignatures[K]>): void;
    ...
    class StaticPlaylistSource extends PlaylistSource implements Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
        ...
        /** @signal */
        emit<K extends keyof StaticPlaylistSource.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<StaticPlaylistSource.SignalSignatures[K]>): void;
    ...
    class StreamingSource extends Source implements Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
        ...
        /** @signal */
        emit<K extends keyof StreamingSource.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<StreamingSource.SignalSignatures[K]>): void;
    ...
    class StringValueMap extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof StringValueMap.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<StringValueMap.SignalSignatures[K]>): void;
    ...
    class TaskProgressSimple extends GObject.Object implements TaskProgress {
        ...
        /** @signal */
        emit<K extends keyof TaskProgressSimple.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<TaskProgressSimple.SignalSignatures[K]>): void;
    ...
    class TrackTransferBatch extends GObject.Object implements TaskProgress {
        ...
        /** @signal */
        emit<K extends keyof TrackTransferBatch.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<TrackTransferBatch.SignalSignatures[K]>): void;
    ...
    class TrackTransferQueue extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof TrackTransferQueue.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<TrackTransferQueue.SignalSignatures[K]>): void;
         ...
         * @param source the {@link RB.Source} to search for
         ...
         * @param batch the {@link RB.TrackTransferBatch} to add to the queue
         */
    ...
    class URIDialog extends Gtk.Dialog implements Atk.ImplementorIface, Gtk.Buildable {
        ...
        /** @signal */
        emit<K extends keyof URIDialog.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<URIDialog.SignalSignatures[K]>): void;
    ...
    abstract class ExtDBKey {
         ...
         * @param b second {@link RB.ExtDBKey}
    ...
    class RefString {
         ...
         * @param bp another `RBRefstring`
         */
        static equal(ap: null, bp: null): boolean;
    ...
    class RhythmDBEntry {
         ...
         * track related data.
         * @param prop the primary {@link RB.RhythmDBPropType} for metadata lookups
         ...
         */
        get_type_data(expected_size: number): null;
    ...
    namespace Player {
        ...
        interface Interface {
             ...
             * @virtual
             */
            vfunc_buffering(stream_data: null, progress: number): void;
             ...
             * @virtual
             */
            vfunc_eos(stream_data: null, early: boolean): void;
             ...
             * @virtual
             */
            vfunc_error(stream_data: null, error: GLib.Error): void;
             ...
             * @virtual
             */
            vfunc_event(stream_data: null, data: null): void;
             ...
             * @virtual
             */
            vfunc_image(stream_data: null, image: GdkPixbuf.Pixbuf): void;
             ...
             * @virtual
             */
            vfunc_info(stream_data: null, field: MetaDataField, value: unknown): void;
             ...
             * @virtual
             */
            vfunc_open(uri: string, stream_data: null): boolean;
             ...
             * @virtual
             */
            vfunc_playing_stream(stream_data: null): void;
             ...
             * @virtual
             */
            vfunc_redirect(stream_data: null, uri: string): void;
             ...
             * @virtual
             */
            vfunc_tick(stream_data: null, elapsed: number, duration: number): void;
    ...
    namespace TransferTarget {
        ...
        interface Interface {
             ...
             * the source entry.
             * @param entry a {@link RB.RhythmDBEntry} being transferred
             ...
             * will be skipped.
             * @param entry a {@link RB.RhythmDBEntry} to consider transferring
             * @virtual
             */
    ...
    interface TransferTarget extends GObject.Object, TransferTarget.Interface {
         ...
         * @param settings {@link Gio.Settings} instance holding encoding settings
         * @param entries a {@link GLib.List} of entries to transfer
         * @param defer if `true`, don't start the transfer until
         * @returns an {@link RB.TrackTransferBatch}, or NULL
         */

...
export const SURFACE_PROVENANCE = 'RB-3.0 — dropped empty base(s): GObject.InitiallyUnowned GObject.Object Atk.ImplementorIface';
...
export const OWN_SIGNALS = {
    ...
    RBEntryView: ['entries-replaced', 'entry-activated', 'entry-added', 'entry-deleted', 'have-selection-changed', 'selection-changed', 'show-popup'],

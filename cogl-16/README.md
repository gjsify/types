...
GJS TypeScript type definitions for Cogl-16 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v4.7.0.
...
| Import | What you get |
|---|---|
| `@girs/cogl-16` | the namespace as a default export, plus the ambient and global declarations |
...
Referencing `@girs/cogl-16/ambient` instead pulls in these declarations
alone. See [ambient modules](https://github.com/gjsify/ts-for-gir/tree/main/packages/cli#ambient-modules).

### As `imports.gi`

GJS's global object works the same way, via `@girs/cogl-16/import`:

...
export namespace Xed {
     ...
     * @param window a #XedWindow
     * @param location a #GFile to be loaded
     ...
     * @param window a #XedWindow.
     * @param document the #XedDocument to save.
     */
    ...
    function marshal_BOOLEAN__OBJECT(
    ...
    function marshal_VOID__BOOLEAN_POINTER(
        closure: GObject.Closure,
        return_value: GObject.Value | any,
        n_param_values: number,
        param_values: GObject.Value | any,
    ...
    function marshal_VOID__BOXED_BOXED(
        closure: GObject.Closure,
        return_value: GObject.Value | any,
        n_param_values: number,
        param_values: GObject.Value | any,
    ...
    function marshal_VOID__OBJECT_BOXED_FLAGS(
        closure: GObject.Closure,
        return_value: GObject.Value | any,
        n_param_values: number,
        param_values: GObject.Value | any,
    ...
    function marshal_VOID__OBJECT_BOXED_INT_BOOLEAN(
        closure: GObject.Closure,
        return_value: GObject.Value | any,
        n_param_values: number,
        param_values: GObject.Value | any,
    ...
    function marshal_VOID__UINT64_UINT64(
        closure: GObject.Closure,
        return_value: GObject.Value | any,
        n_param_values: number,
        param_values: GObject.Value | any,
    ...
    class App extends Gtk.Application implements Gio.ActionGroup, Gio.ActionMap {
         ...
         * @returns a newly allocated list of #XedWindow objects
         */
        get_main_windows(): Window[];
        /**
         * Returns all the views currently present in #XedApp.
         * @returns a newly allocated list of #XedView objects
         */
        get_views(): View[];
        ...
        implements Atk.ImplementorIface, Gtk.Buildable, Gtk.FileChooser
    {
        ...
        connect<K extends keyof FileChooserDialog.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, FileChooserDialog.SignalSignatures[K]>,
        ): number;
        connect(signal: string, callback: (...args: any[]) => any): number;
        connect_after<K extends keyof FileChooserDialog.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, FileChooserDialog.SignalSignatures[K]>,
        ): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;
        emit<K extends keyof FileChooserDialog.SignalSignatures>(
            signal: K,
            ...args: GObject.GjsParameters<FileChooserDialog.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never
        ): void;
        emit(signal: string, ...args: any[]): void;
        ...
        set_newline_type(newline_type: GtkSource.NewlineType | null): void;
    ...
    class MessageBus extends GObject.Object {
         ...
         * @param object_path the object path
         * @param method the method
         * @returns the registered #XedMessageType or %NULL if no message type               is registered for @method at @object_path
         */
         ...
         * @param message_type the #XedMessageType to unregister
         */
    ...
    class Searchbar extends Gtk.Box implements Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
        ...
        show(search_mode: SearchMode | null): void;
        ...
        implements Atk.ImplementorIface, Gio.ActionGroup, Gio.ActionMap, Gtk.Buildable
    {
        ...
        /**
         * Closes the `tab`.
         * @param tab the #XedTab to close
         */
        close_tab(tab: Tab): void;
        /**
         * Closes all tabs specified by `tabs`.
         * @param tabs a list of #XedTab
         */
         ...
         * @param jump_to %TRUE to set the new #XedTab as active
         ...
         * @param encoding a #GtkSourceEncoding
         ...
         * @returns the #XedMessageBus associated with @window
         */
        get_message_bus(): MessageBus;
        /**
         * Gets the #XedSearchbar of the `window`.
         * @returns the #XedSearchbar of the @window.
         */
         ...
         * @returns a list of #XedDocument that need to be saved before closing the window
         */

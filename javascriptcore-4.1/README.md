...
GJS TypeScript type definitions for JavaScriptCore-4.1, generated from library version 2.38.5 using [ts-for-gir](https://github.com/gjsify/ts-for-gjs) v3.0.0-beta.12.

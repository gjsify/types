/**
 * The GIR-derived widget VOCABULARY for DBusGLib-1.0.
 *
 * GENERATED — do not edit. Provenance: DBusGLib-1.0
 *
...
export interface DBusGProxyProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type DBusGProxyConstructOnly = GObjectConstructOnly;

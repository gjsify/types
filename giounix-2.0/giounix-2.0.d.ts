 ...
 */
function desktop_app_info_lookup_get_default_for_uri_scheme(lookup: any, uri_scheme: string): any | null
/**
 * Gets the underlying file descriptor.
 * @param fd_based a #GFileDescriptorBased.
 * @returns The file descriptor
 */
function file_descriptor_based_get_fd(fd_based: any): number
/**
 ...
 */
function mount_at(mount_path: string): [ /* returnType */ any | null, /* time_read */ number ]
/**
 ...
 */
function mount_compare(mount1: any, mount2: any): number
/**
 * Makes a copy of `mount_entry`.
 * @param mount_entry a #GUnixMountEntry.
 * @returns a new #GUnixMountEntry
 */
function mount_copy(mount_entry: any): any
/**
 ...
 * @returns a #GUnixMountEntry.
 */
function mount_for(file_path: string): [ /* returnType */ any | null, /* time_read */ number ]
/**
 * Frees a unix mount.
 * @param mount_entry a #GUnixMountEntry.
 */
function mount_free(mount_entry: any): void
/**
 * Gets the device path for a unix mount.
 * @param mount_entry a #GUnixMount.
 * @returns a string containing the device path.
 */
function mount_get_device_path(mount_entry: any): string
/**
 * Gets the filesystem type for the unix mount.
 * @param mount_entry a #GUnixMount.
 * @returns a string containing the file system type.
 */
function mount_get_fs_type(mount_entry: any): string
/**
 * Gets the mount path for a unix mount.
 * @param mount_entry input #GUnixMountEntry to get the mount path for.
 * @returns the mount path for @mount_entry.
 */
function mount_get_mount_path(mount_entry: any): string
/**
 ...
 */
function mount_get_options(mount_entry: any): string | null
/**
 ...
 */
function mount_get_root_path(mount_entry: any): string | null
/**
 * Guesses whether a Unix mount can be ejected.
 * @param mount_entry a #GUnixMountEntry
 * @returns %TRUE if @mount_entry is deemed to be ejectable.
 */
function mount_guess_can_eject(mount_entry: any): boolean
/**
 * Guesses the icon of a Unix mount.
 * @param mount_entry a #GUnixMountEntry
 * @returns a #GIcon
 */
function mount_guess_icon(mount_entry: any): any
/**
 ...
 */
function mount_guess_name(mount_entry: any): string | null
/**
 * Guesses whether a Unix mount should be displayed in the UI.
 * @param mount_entry a #GUnixMountEntry
 * @returns %TRUE if @mount_entry is deemed to be displayable.
 */
function mount_guess_should_display(mount_entry: any): boolean
/**
 * Guesses the symbolic icon of a Unix mount.
 * @param mount_entry a #GUnixMountEntry
 * @returns a #GIcon
 */
function mount_guess_symbolic_icon(mount_entry: any): any
/**
 * Checks if a unix mount is mounted read only.
 * @param mount_entry a #GUnixMount.
 * @returns %TRUE if @mount_entry is read only.
 */
function mount_is_readonly(mount_entry: any): boolean
/**
 ...
 */
function mount_is_system_internal(mount_entry: any): boolean
/**
 ...
 */
function mount_point_at(mount_path: string): [ /* returnType */ any | null, /* time_read */ number ]
/**
 ...
 * @returns 1, 0 or -1 if @mount1 is greater than, equal to, or less than @mount2, respectively.
 */
function mount_point_compare(mount1: any, mount2: any): number
/**
 * Makes a copy of `mount_point`.
 * @param mount_point a #GUnixMountPoint.
 * @returns a new #GUnixMountPoint
 */
function mount_point_copy(mount_point: any): any
/**
 * Frees a unix mount point.
 * @param mount_point unix mount point to free.
 */
function mount_point_free(mount_point: any): void
/**
 * Gets the device path for a unix mount point.
 * @param mount_point a #GUnixMountPoint.
 * @returns a string containing the device path.
 */
function mount_point_get_device_path(mount_point: any): string
/**
 * Gets the file system type for the mount point.
 * @param mount_point a #GUnixMountPoint.
 * @returns a string containing the file system type.
 */
function mount_point_get_fs_type(mount_point: any): string
/**
 * Gets the mount path for a unix mount point.
 * @param mount_point a #GUnixMountPoint.
 * @returns a string containing the mount path.
 */
function mount_point_get_mount_path(mount_point: any): string
/**
 * Gets the options for the mount point.
 * @param mount_point a #GUnixMountPoint.
 * @returns a string containing the options.
 */
function mount_point_get_options(mount_point: any): string | null
/**
 * Guesses whether a Unix mount point can be ejected.
 * @param mount_point a #GUnixMountPoint
 * @returns %TRUE if @mount_point is deemed to be ejectable.
 */
function mount_point_guess_can_eject(mount_point: any): boolean
/**
 * Guesses the icon of a Unix mount point.
 * @param mount_point a #GUnixMountPoint
 * @returns a #GIcon
 */
function mount_point_guess_icon(mount_point: any): any
/**
 ...
 * @returns A newly allocated string that must     be freed with g_free()
 */
function mount_point_guess_name(mount_point: any): string | null
/**
 * Guesses the symbolic icon of a Unix mount point.
 * @param mount_point a #GUnixMountPoint
 * @returns a #GIcon
 */
function mount_point_guess_symbolic_icon(mount_point: any): any
/**
 * Checks if a unix mount point is a loopback device.
 * @param mount_point a #GUnixMountPoint.
 * @returns %TRUE if the mount point is a loopback. %FALSE otherwise.
 */
function mount_point_is_loopback(mount_point: any): boolean
/**
 * Checks if a unix mount point is read only.
 * @param mount_point a #GUnixMountPoint.
 * @returns %TRUE if a mount point is read only.
 */
function mount_point_is_readonly(mount_point: any): boolean
/**
 * Checks if a unix mount point is mountable by the user.
 * @param mount_point a #GUnixMountPoint.
 * @returns %TRUE if the mount point is user mountable.
 */
function mount_point_is_user_mountable(mount_point: any): boolean
/**
 ...
 */
function mount_points_get(): [ /* returnType */ any[], /* time_read */ number ]
/**
 ...
 */
function mounts_get(): [ /* returnType */ any[], /* time_read */ number ]
/**

...
export namespace GioUnix {
     ...
     * @param lookup a {@link GioUnix.DesktopAppInfoLookup}
     * @param uri_scheme a string containing a URI scheme.
     * @returns {@link Gio.AppInfo} for given `uri_scheme` or    `null` on error.
     * @deprecated since 2.28: The {@link GioUnix.DesktopAppInfoLookup} interface is deprecated and    unused by GIO.
     */
    function desktop_app_info_lookup_get_default_for_uri_scheme(lookup: never, uri_scheme: string): Gio.AppInfo | null;
    /**
     * Gets the underlying file descriptor.
     * @param fd_based a {@link GioUnix.FileDescriptorBased}.
     * @returns The file descriptor
     * @since 2.24
     */
    function file_descriptor_based_get_fd(fd_based: never): number;
    /**
    ...
    /**
     * Gets a {@link GioUnix.MountEntry} for a given mount path. If `time_read`
     ...
     */
    function mount_at(mount_path: string): [never | null, number];
    /**
     ...
     */
    function mount_compare(mount1: never, mount2: never): number;
    /**
     ...
     * @since 2.54
     */
    function mount_copy(mount_entry: never): never;
    /**
     * Gets a {@link GioUnix.MountEntry} for a given file path. If `time_read`
     * is set, it will be filled with a unix timestamp for checking
     * if the mounts have changed since with `g_unix_mounts_changed_since()`.
     *
     * If more mounts have the same mount path, the last matching mount
     ...
     * @since 2.52
     */
    function mount_for(file_path: string): [never | null, number];
    /**
     * Frees a unix mount.
     * @param mount_entry a {@link GioUnix.MountEntry}.
     */
    function mount_free(mount_entry: never): void;
    /**
     * Gets the device path for a unix mount.
     * @param mount_entry a `GUnixMount`.
     * @returns a string containing the device path.
     */
    function mount_get_device_path(mount_entry: never): string;
    /**
     * Gets the filesystem type for the unix mount.
     * @param mount_entry a `GUnixMount`.
     * @returns a string containing the file system type.
     */
    function mount_get_fs_type(mount_entry: never): string;
    /**
     * Gets the mount path for a unix mount.
     * @param mount_entry input {@link GioUnix.MountEntry} to get the mount path for.
     * @returns the mount path for `mount_entry`.
     */
    function mount_get_mount_path(mount_entry: never): string;
    /**
     ...
     * @since 2.58
     */
    function mount_get_options(mount_entry: never): string | null;
    /**
     ...
     * @since 2.60
     */
    function mount_get_root_path(mount_entry: never): string | null;
    /**
     * Guesses whether a Unix mount can be ejected.
     * @param mount_entry a {@link GioUnix.MountEntry}
     * @returns `true` if `mount_entry` is deemed to be ejectable.
     */
    function mount_guess_can_eject(mount_entry: never): boolean;
    /**
     * Guesses the icon of a Unix mount.
     * @param mount_entry a {@link GioUnix.MountEntry}
     * @returns a {@link Gio.Icon}
     */
    function mount_guess_icon(mount_entry: never): Gio.Icon;
    /**
     ...
     */
    function mount_guess_name(mount_entry: never): string;
    /**
     * Guesses whether a Unix mount should be displayed in the UI.
     * @param mount_entry a {@link GioUnix.MountEntry}
     * @returns `true` if `mount_entry` is deemed to be displayable.
     */
    function mount_guess_should_display(mount_entry: never): boolean;
    /**
     ...
     * @since 2.34
     */
    function mount_guess_symbolic_icon(mount_entry: never): Gio.Icon;
    /**
     * Checks if a unix mount is mounted read only.
     * @param mount_entry a `GUnixMount`.
     * @returns `true` if `mount_entry` is read only.
     */
    function mount_is_readonly(mount_entry: never): boolean;
    /**
     ...
     */
    function mount_is_system_internal(mount_entry: never): boolean;
    /**
     * Gets a {@link GioUnix.MountPoint} for a given mount path. If `time_read` is set, it
     ...
     * @since 2.66
     */
    function mount_point_at(mount_path: string): [never | null, number];
    /**
     ...
     * @returns 1, 0 or -1 if `mount1` is greater than, equal to, or less than `mount2`, respectively.
     */
    function mount_point_compare(mount1: never, mount2: never): number;
    /**
     * Makes a copy of `mount_point`.
     * @param mount_point a {@link GioUnix.MountPoint}.
     * @returns a new {@link GioUnix.MountPoint}
     * @since 2.54
     */
    function mount_point_copy(mount_point: never): never;
    /**
     * Frees a unix mount point.
     * @param mount_point unix mount point to free.
     */
    function mount_point_free(mount_point: never): void;
    /**
     * Gets the device path for a unix mount point.
     * @param mount_point a {@link GioUnix.MountPoint}.
     * @returns a string containing the device path.
     */
    function mount_point_get_device_path(mount_point: never): string;
    /**
     * Gets the file system type for the mount point.
     * @param mount_point a {@link GioUnix.MountPoint}.
     * @returns a string containing the file system type.
     */
    function mount_point_get_fs_type(mount_point: never): string;
    /**
     * Gets the mount path for a unix mount point.
     * @param mount_point a {@link GioUnix.MountPoint}.
     * @returns a string containing the mount path.
     */
    function mount_point_get_mount_path(mount_point: never): string;
    /**
     ...
     * @since 2.32
     */
    function mount_point_get_options(mount_point: never): string | null;
    /**
     * Guesses whether a Unix mount point can be ejected.
     * @param mount_point a {@link GioUnix.MountPoint}
     * @returns `true` if `mount_point` is deemed to be ejectable.
     */
    function mount_point_guess_can_eject(mount_point: never): boolean;
    /**
     * Guesses the icon of a Unix mount point.
     * @param mount_point a {@link GioUnix.MountPoint}
     * @returns a {@link Gio.Icon}
     */
    function mount_point_guess_icon(mount_point: never): Gio.Icon;
    /**
     ...
     * @returns A newly allocated string that must     be freed with `g_free()`
     */
    function mount_point_guess_name(mount_point: never): string;
    /**
     ...
     * @since 2.34
     */
    function mount_point_guess_symbolic_icon(mount_point: never): Gio.Icon;
    /**
     * Checks if a unix mount point is a loopback device.
     * @param mount_point a {@link GioUnix.MountPoint}.
     * @returns `true` if the mount point is a loopback. `false` otherwise.
     */
    function mount_point_is_loopback(mount_point: never): boolean;
    /**
     * Checks if a unix mount point is read only.
     * @param mount_point a {@link GioUnix.MountPoint}.
     * @returns `true` if a mount point is read only.
     */
    function mount_point_is_readonly(mount_point: never): boolean;
    /**
     * Checks if a unix mount point is mountable by the user.
     * @param mount_point a {@link GioUnix.MountPoint}.
     * @returns `true` if the mount point is user mountable.
     */
    function mount_point_is_user_mountable(mount_point: never): boolean;
    /**
    ...
    /**
     * Gets a {@link GLib.List} of {@link GioUnix.MountPoint} containing the unix mount points.
     * If `time_read` is set, it will be filled with the mount timestamp,
     * allowing for checking if the mounts have changed with
     * `g_unix_mount_points_changed_since()`.
     * @returns a {@link GLib.List} of the UNIX mountpoints.
     */
    function mount_points_get(): [never[], number];
    /**
    ...
    /**
     * Gets a {@link GLib.List} of {@link GioUnix.MountEntry} containing the unix mounts.
     * If `time_read` is set, it will be filled with the mount
     * timestamp, allowing for checking if the mounts have changed
     * with `g_unix_mounts_changed_since()`.
     * @returns a {@link GLib.List} of the UNIX mounts.
     */
    function mounts_get(): [never[], number];
    /**
     * @gir-type Callback
     */
    interface DesktopAppLaunchCallback {
        (appinfo: never, pid: GLib.Pid): void;
    }
    ...
    class DesktopAppInfo extends GObject.Object implements Gio.AppInfo {
         ...
         * action.
         * @param info a {@link GioUnix.DesktopAppInfo}
         * @param action_name the name of the action as from   `g_desktop_app_info_list_actions()`
         */
        static get_action_name(info: never, action_name: string): string;
        /**
         ...
         */
        static get_boolean(info: never, key: string): boolean;
        /**
         * Gets the categories from the desktop file.
         * @param info a {@link GioUnix.DesktopAppInfo}
         */
        static get_categories(info: never): string | null;
        /**
         * When `info` was created from a known filename, return it.  In some
         * situations such as the {@link GioUnix.DesktopAppInfo} returned from
         * `g_desktop_app_info_new_from_keyfile()`, this function will return `null`.
         * @param info a {@link GioUnix.DesktopAppInfo}
         */
        static get_filename(info: never): string | null;
        /**
         * Gets the generic name from the desktop file.
         * @param info a {@link GioUnix.DesktopAppInfo}
         */
        static get_generic_name(info: never): string | null;
        /**
         ...
         */
        static get_implementations(_interface: string): never[];
        /**
         * A desktop file is hidden if the Hidden key in it is
         * set to True.
         * @param info a {@link GioUnix.DesktopAppInfo}.
         */
        static get_is_hidden(info: never): boolean;
        /**
         * Gets the keywords from the desktop file.
         * @param info a {@link GioUnix.DesktopAppInfo}
         */
        static get_keywords(info: never): string[];
        /**
         ...
         * @param key the key to look up
         */
        static get_locale_string(info: never, key: string): string | null;
        /**
         ...
         * @param info a {@link GioUnix.DesktopAppInfo}
         */
        static get_nodisplay(info: never): boolean;
        /**
         ...
         */
        static get_show_in(info: never, desktop_env?: string | null): boolean;
        /**
         * Retrieves the StartupWMClass field from `info`. This represents the
         * WM_CLASS property of the main window of the application, if launched
         * through `info`.
         * @param info a {@link GioUnix.DesktopAppInfo} that supports startup notify
         */
        static get_startup_wm_class(info: never): string | null;
        /**
         ...
         * @param key the key to look up
         */
        static get_string(info: never, key: string): string | null;
        /**
         ...
         * @param key the key to look up
         */
        static get_string_list(info: never, key: string): string[];
        /**
         ...
         * @param key the key to look up
         */
        static has_key(info: never, key: string): boolean;
        /**
         ...
         */
        static launch_action(info: never, action_name: string, launch_context?: Gio.AppLaunchContext | null): void;
        /**
         ...
         * @param appinfo a {@link GioUnix.DesktopAppInfo}
         ...
         * @param info a {@link GioUnix.DesktopAppInfo}
         */
        static list_actions(info: never): string[];
        /**
         ...
         * subsequently creating a {@link GioUnix.DesktopAppInfo} for each result.
    ...
    class FDMessage extends Gio.SocketControlMessage {
         ...
         * @param message a {@link GioUnix.FDMessage}
         * @param fd a valid open file descriptor
         */
        static append_fd(message: never, fd: number): boolean;
        /**
         ...
         * @param message a {@link GioUnix.FDMessage}
         */
        static get_fd_list(message: never): Gio.UnixFDList;
        /**
         ...
         * @param message a {@link GioUnix.FDMessage}
         */
        static steal_fds(message: never): number[];
    }
    ...
    class InputStream extends Gio.InputStream implements Gio.PollableInputStream, FileDescriptorBased {
         ...
         * @param stream a {@link GioUnix.InputStream}
         */
        static get_close_fd(stream: never): boolean;
        /**
         * Return the UNIX file descriptor that the stream reads from.
         * @param stream a {@link GioUnix.InputStream}
         */
        static get_fd(stream: never): number;
        /**
         * @param args
         */
        // Conflicted with GioUnix.FileDescriptorBased.get_fd
        static get_fd(...args: never[]): any;
        /**
         ...
         */
        static set_close_fd(stream: never, close_fd: boolean): void;
        /**
    ...
    class MountMonitor extends GObject.Object {
         ...
         * the monitor.
         * @param mount_monitor a {@link GioUnix.MountMonitor}
         * @param limit_msec a integer with the limit in milliseconds to     poll for changes.
         */
        static set_rate_limit(mount_monitor: never, limit_msec: number): void;
    }
    ...
    class OutputStream extends Gio.OutputStream implements Gio.PollableOutputStream, FileDescriptorBased {
         ...
         * Returns whether the file descriptor of `stream` will be
         * closed when the stream is closed.
         * @param stream a {@link GioUnix.OutputStream}
         */
        static get_close_fd(stream: never): boolean;
        /**
    ...
    abstract class MountPoint {
         ...
         * @param mount_path path for a possible unix mount point.
         */
        static at(mount_path: string): [never | null, number];
        /**
         * Compares two unix mount points.
         * @param mount1 a `GUnixMount`.
         * @param mount2 a `GUnixMount`.
         */
        static compare(mount1: never, mount2: never): number;
        /**
         * Makes a copy of `mount_point`.
         * @param mount_point a {@link GioUnix.MountPoint}.
         */
        static copy(mount_point: never): never;
        /**
         * Frees a unix mount point.
         * @param mount_point unix mount point to free.
         */
        static free(mount_point: never): void;
        /**
         * Gets the device path for a unix mount point.
         * @param mount_point a {@link GioUnix.MountPoint}.
         */
        static get_device_path(mount_point: never): string;
        /**
         * Gets the file system type for the mount point.
         * @param mount_point a {@link GioUnix.MountPoint}.
         */
        static get_fs_type(mount_point: never): string;
        /**
         * Gets the mount path for a unix mount point.
         * @param mount_point a {@link GioUnix.MountPoint}.
         */
        static get_mount_path(mount_point: never): string;
        /**
         * Gets the options for the mount point.
         * @param mount_point a {@link GioUnix.MountPoint}.
         */
        static get_options(mount_point: never): string | null;
        /**
         * Guesses whether a Unix mount point can be ejected.
         * @param mount_point a {@link GioUnix.MountPoint}
         */
        static guess_can_eject(mount_point: never): boolean;
        /**
         * Guesses the icon of a Unix mount point.
         * @param mount_point a {@link GioUnix.MountPoint}
         */
        static guess_icon(mount_point: never): Gio.Icon;
        /**
         * Guesses the name of a Unix mount point.
         * The result is a translated string.
         * @param mount_point a {@link GioUnix.MountPoint}
         */
        static guess_name(mount_point: never): string;
        /**
         * Guesses the symbolic icon of a Unix mount point.
         * @param mount_point a {@link GioUnix.MountPoint}
         */
        static guess_symbolic_icon(mount_point: never): Gio.Icon;
        /**
         * Checks if a unix mount point is a loopback device.
         * @param mount_point a {@link GioUnix.MountPoint}.
         */
        static is_loopback(mount_point: never): boolean;
        /**
         * Checks if a unix mount point is read only.
         * @param mount_point a {@link GioUnix.MountPoint}.
         */
        static is_readonly(mount_point: never): boolean;
        /**
         * Checks if a unix mount point is mountable by the user.
         * @param mount_point a {@link GioUnix.MountPoint}.
         */
        static is_user_mountable(mount_point: never): boolean;
    }
    ...
    export interface DesktopAppInfoLookupNamespace {
         ...
         * @param uri_scheme a string containing a URI scheme.
         */
        get_default_for_uri_scheme(lookup: never, uri_scheme: string): Gio.AppInfo | null;
    }
    /**

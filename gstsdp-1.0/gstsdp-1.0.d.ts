...
import './gstsdp-1.0-ambient.d.ts';
import './gstsdp-1.0-import.d.ts';
/**
 * GstSdp-1.0
 */
...
export namespace GstSdp {
     ...
     */
    function sdp_media_init(): SDPResult;
    /**
     * Allocate a new GstSDPMedia and store the result in `media`.
     * @returns a #GstSDPResult.
     */
    function sdp_media_new(): SDPResult;
    /**
     ...
     * @returns a #GstSDPResult.
     */
    function sdp_media_set_media_from_caps(caps: Gst.Caps): SDPResult;
    /**
     ...
     * @returns a #GstSDPResult.
     */
    function sdp_message_init(): SDPResult;
    /**
     * Allocate a new GstSDPMessage and store the result in `msg`.
     * @returns a #GstSDPResult.
     */
    function sdp_message_new(): SDPResult;
    /**
     ...
     * @returns a #GstSDPResult.
     */
    function sdp_message_new_from_text(text: string): SDPResult;
    /**
     ...
     */
    class MIKEYMapSRTP {
        // Own fields of GstSdp-1.0.MIKEYMapSRTP

        policy: number;
        ssrc: number;
        roc: number;

        // Constructors of GstSdp-1.0.MIKEYMapSRTP
     ...
     */
    class MIKEYMessage {
        // Own fields of GstSdp-1.0.MIKEYMessage
        ...
        // Constructors of GstSdp-1.0.MIKEYMessage
        ...
        // Owm methods of GstSdp-1.0.MIKEYMessage
     ...
     */
    class MIKEYPayload {
        // Own fields of GstSdp-1.0.MIKEYPayload

        type: MIKEYPayloadType;
        len: number;

        // Constructors of GstSdp-1.0.MIKEYPayload

        constructor(type: MIKEYPayloadType);

        static ['new'](type: MIKEYPayloadType): MIKEYPayload;

        // Owm methods of GstSdp-1.0.MIKEYPayload
    ...
    class MIKEYPayloadKEMAC {
        // Own fields of GstSdp-1.0.MIKEYPayloadKEMAC
    ...
    class MIKEYPayloadKeyData {
        // Own fields of GstSdp-1.0.MIKEYPayloadKeyData
    ...
    class MIKEYPayloadPKE {
        // Own fields of GstSdp-1.0.MIKEYPayloadPKE
    ...
    class MIKEYPayloadRAND {
        // Own fields of GstSdp-1.0.MIKEYPayloadRAND
    ...
    class MIKEYPayloadSP {
        // Own fields of GstSdp-1.0.MIKEYPayloadSP
    ...
    class MIKEYPayloadSPParam {
        // Own fields of GstSdp-1.0.MIKEYPayloadSPParam

        type: number;
        len: number;
        val: number;

        // Constructors of GstSdp-1.0.MIKEYPayloadSPParam
     ...
     */
    class MIKEYPayloadT {
        // Own fields of GstSdp-1.0.MIKEYPayloadT
     ...
     */
    class SDPAttribute {
        // Own fields of GstSdp-1.0.SDPAttribute

        key: string;
        value: string;

        // Constructors of GstSdp-1.0.SDPAttribute
        ...
        // Owm methods of GstSdp-1.0.SDPAttribute
     ...
     */
    class SDPBandwidth {
        // Own fields of GstSdp-1.0.SDPBandwidth

        bwtype: string;
        bandwidth: number;

        // Constructors of GstSdp-1.0.SDPBandwidth
        ...
        // Owm methods of GstSdp-1.0.SDPBandwidth
     ...
     */
    class SDPConnection {
        // Own fields of GstSdp-1.0.SDPConnection
        ...
        // Constructors of GstSdp-1.0.SDPConnection
        ...
        // Owm methods of GstSdp-1.0.SDPConnection
     ...
     */
    class SDPKey {
        // Own fields of GstSdp-1.0.SDPKey

        type: string;
        data: string;

        // Constructors of GstSdp-1.0.SDPKey
     ...
     */
    class SDPMedia {
        // Own fields of GstSdp-1.0.SDPMedia
        ...
        // Constructors of GstSdp-1.0.SDPMedia
        ...
        // Owm methods of GstSdp-1.0.SDPMedia
         ...
         * stack), its contents should be set to 0 before calling this function.
         */
        static init(): SDPResult;
        /**
         * Allocate a new GstSDPMedia and store the result in `media`.
         */
        static ['new'](): SDPResult;
        /**
         * Mapping of caps to SDP fields:
         *
         * a=rtpmap:(payload) (encoding_name) or (clock_rate)[or (encoding_params)]
         ...
         * @param caps a #GstCaps
         */
        static set_media_from_caps(caps: Gst.Caps): SDPResult;
     ...
     */
    class SDPMessage {
        // Own fields of GstSdp-1.0.SDPMessage
        ...
        // Constructors of GstSdp-1.0.SDPMessage
        ...
        // Owm methods of GstSdp-1.0.SDPMessage
         ...
         * @param text A dynamically allocated string representing the SDP description
         */
        static new_from_text(text: string): SDPResult;
        /**
         * Parse the contents of `size` bytes pointed to by `data` and store the result in
         * `msg`.
         * @param data the start of the buffer
     ...
     */
    class SDPOrigin {
        // Own fields of GstSdp-1.0.SDPOrigin
        ...
        // Constructors of GstSdp-1.0.SDPOrigin
     ...
     */
    class SDPTime {
        // Own fields of GstSdp-1.0.SDPTime

        start: string;
        stop: string;
        repeat: any[];

        // Constructors of GstSdp-1.0.SDPTime
        ...
        // Owm methods of GstSdp-1.0.SDPTime
     ...
     */
    class SDPZone {
        // Own fields of GstSdp-1.0.SDPZone

        time: string;
        typed_time: string;

        // Constructors of GstSdp-1.0.SDPZone
        ...
        // Owm methods of GstSdp-1.0.SDPZone

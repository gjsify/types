 ...
 */
function aioRead(aioContext: AioContext, fd: number, buffer: any | null, count: number, offset: number): Future
/**
 ...
 */
function aioWrite(aioContext: AioContext, fd: number, buffer: any | null, count: number, offset: number): Future
/**
 * Wrapper for g_bus_get().
 * @param busType 
 * @returns a #DexFuture that resolves to a #GDBusConnection   or rejects with error.
 */
function busGet(busType: Gio.BusType): Future
/**
 ...
 */
function dbusConnectionSendMessageWithReply(connection: Gio.DBusConnection, message: Gio.DBusMessage, flags: Gio.DBusSendMessageFlags, timeoutMsec: number): [ /* returnType */ Future, /* outSerial */ number | null ]
...
function init(): void
function inputStreamClose(self: Gio.InputStream, ioPriority: number): Future
function inputStreamRead(self: Gio.InputStream, buffer: any | null, count: number, ioPriority: number): Future
function inputStreamReadBytes(self: Gio.InputStream, count: number, ioPriority: number): Future
function inputStreamSkip(self: Gio.InputStream, count: number, ioPriority: number): Future
function ioStreamClose(ioStream: Gio.IOStream, ioPriority: number): Future
function outputStreamClose(self: Gio.OutputStream, ioPriority: number): Future
 ...
 */
function valueSetObject(value: any, object: Object | null): void
/**
 * Stores the given `DexObject` inside `value`.
 * 
 ...
 */
function valueTakeObject(value: any, object: Object | null): void
/**

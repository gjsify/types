/**
 * The GIR-derived widget VOCABULARY for Meta-15.
 *
 * GENERATED — do not edit. Provenance: Meta-15 — dropped empty base(s): Atk.ImplementorIface — inlined base(s) their owner's vocabulary does not emit: Gio.DBusInterfaceSkeleton
 *
 * 35 instantiable GTypes (of which 0 concrete widgets), 36 declarations (1 inlined from a namespace whose vocabulary does not emit them), 32 enum nick unions, 0 slot candidates.
 *
...
import type Meta from './meta-15.js';
import type { ClutterActorConstructOnly, ClutterActorProps, ClutterAnimatableConstructOnly, ClutterAnimatableProps, ClutterContentConstructOnly, ClutterContentProps, ClutterStageConstructOnly, ClutterStageProps } from '@girs/clutter-15/vocabulary';

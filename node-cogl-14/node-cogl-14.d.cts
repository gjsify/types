...
import './node-cogl-14-import.d.ts';
...
import type Mtk from '@girs/node-mtk-14';
...
export function clutterWinsysHasFeature(feature: WinsysFeature): boolean
/**
 ...
 */
export function colorEqual(v1: any | null, v2: any | null): boolean
/**
 ...
 * @param shaderType COGL_SHADER_TYPE_VERTEX or COGL_SHADER_TYPE_FRAGMENT.
 * @returns a new shader handle.
 */
export function createShader(shaderType: ShaderType): Shader
/**
...
export function getRectangleIndices(context: Context, nRectangles: number): Indices
/**
 ...
 */
export function grapheneMatrixProjectPoint(matrix: Graphene.Matrix, x: number, y: number, z: number, w: number): [ /* x */ number, /* y */ number, /* z */ number, /* w */ number ]
/**
 ...
 */
export function grapheneMatrixProjectPoints(matrix: Graphene.Matrix, nComponents: number, strideIn: number, pointsIn: any | null, strideOut: number, pointsOut: any | null, nPoints: number): void
/**
 ...
 * @param nPoints The number of points to transform.
 */
export function grapheneMatrixTransformPoints(matrix: Graphene.Matrix, nComponents: number, strideIn: number, pointsIn: any | null, strideOut: number, pointsOut: any | null, nPoints: number): void
/**
 ...
 */
export function isFramebuffer(object: any | null): boolean
/**
 ...
 * @param tx1 The top-left x coordinate of the region to iterate
 * @param ty1 The top-left y coordinate of the region to iterate
 * @param tx2 The bottom-right x coordinate of the region to iterate
 * @param ty2 The bottom-right y coordinate of the region to iterate
 * @param wrapS The wrap mode for the x-axis
 * @param wrapT The wrap mode for the y-axis
 * @param callback A #CoglMetaTextureCallback pointer to be called            for each low-level texture within the specified region.
 */
export function metaTextureForeachInRegion(texture: Texture, tx1: number, ty1: number, tx2: number, ty2: number, wrapS: PipelineWrapMode, wrapT: PipelineWrapMode, callback: MetaTextureCallback): void
/**
...
export function setTracingDisabledOnThread(data: any | null): void
export function setTracingEnabledOnThread(data: any | null, group: string): void
export function startTracingWithFd(fd: number): boolean
export function startTracingWithPath(filename: string): boolean
...
export interface XlibFilterFunc {
    (event: xlib.XEvent, data: any | null): FilterReturn
}
export module ScanoutBuffer {
...
export interface ScanoutBuffer {
...
export class ScanoutBuffer extends GObject.Object {
...
export interface AtlasTexture {
     ...
     */
    getData(format: PixelFormat, rowstride: number, data: number[] | null): number
     ...
     */
    setData(format: PixelFormat, rowstride: number, data: number[], level: number): boolean
    ...
    connect(sigName: "notify::loader", callback: (...args: any[]) => void): number
    on(sigName: "notify::loader", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::loader", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::loader", callback: (...args: any[]) => void): NodeJS.EventEmitter
...
export class Attribute extends GObject.Object {
     ...
     */
    static newConst2x2fv(context: Context, name: string, matrix2x2: number, transpose: boolean): Attribute
    /**
     ...
     * @returns A newly allocated #CoglAttribute          representing the given constant matrix.
     */
    static newConst3x3fv(context: Context, name: string, matrix3x3: number, transpose: boolean): Attribute
    /**
     ...
     * @returns A newly allocated #CoglAttribute          representing the given constant matrix.
     */
    static newConst4x4fv(context: Context, name: string, matrix4x4: number, transpose: boolean): Attribute
...
export interface AttributeBuffer {
     ...
     */
    setData(offset: number, data: number[], size: number): boolean
    ...
    off(sigName: "notify::context", callback: (...args: any[]) => void): NodeJS.EventEmitter
    emit(sigName: "notify::context", ...args: any[]): void
    connect(sigName: "notify::default-target", callback: (...args: any[]) => void): number
    on(sigName: "notify::default-target", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::default-target", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::default-target", callback: (...args: any[]) => void): NodeJS.EventEmitter
    ...
    connect(sigName: "notify::update-hint", callback: (...args: any[]) => void): number
    on(sigName: "notify::update-hint", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::update-hint", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::update-hint", callback: (...args: any[]) => void): NodeJS.EventEmitter
...
export class AttributeBuffer extends Buffer {
     ...
     */
    constructor(context: Context, data: number[]) 
    /**
     * Describes a new #CoglAttributeBuffer of `size` bytes to contain
     * arrays of vertex attribute data and also uploads `size` bytes read
     * from `data` to the new buffer.
     ...
     * @returns A newly allocated #CoglAttributeBuffer (never %NULL)
     */
    static new(context: Context, data: number[]): AttributeBuffer
    /**
     * Describes a new #CoglAttributeBuffer of `size` bytes to contain
 ...
 * @class 
 */
export class Bitmap extends GObject.Object {
...
export module Buffer {
    ...
    export interface ConstructorProperties extends GObject.Object.ConstructorProperties {
        ...
        default_target?: BufferBindTarget | null
        size?: number | null
        update_hint?: BufferUpdateHint | null
    }
...
export interface Buffer {
     ...
     */
    getUpdateHint(): BufferUpdateHint
    /**
     ...
     * @returns A pointer to the mapped memory or        %NULL is the call fails
     */
    mapRange(offset: number, size: number, access: BufferAccess, hints: BufferMapHint): any | null
    /**
     * Updates part of the buffer with new data from `data`. Where to put this new
     * data is controlled by `offset` and `offset` + `data` should be less than the
     * buffer size.
     ...
     */
    setUpdateHint(hint: BufferUpdateHint): void
    /**
...
export interface Context {
    ...
    freeTimestampQuery(query: TimestampQuery): void
    /**
    ...
    timestampQueryGetTimeNs(query: TimestampQuery): number
...
export interface FrameInfo {
    ...
    getRenderingDurationNs(): number
    getSequence(): number
    getTimeBeforeBufferSwapUs(): number
    hasValidGpuRenderingDuration(): boolean
    isHwClock(): boolean
    isVsync(): boolean
    isZeroCopy(): boolean
 ...
 * @class 
 */
export class FrameInfo extends GObject.Object {
...
export interface Framebuffer {
     ...
     */
    addFenceCallback(callback: FenceCallback): FenceClosure | null
    // Has conflict: allocate(): boolean
    /**
    ...
    pushRegionClip(region: Mtk.Region): void
    /**
    ...
    on(sigName: "destroy", callback: Framebuffer.DestroySignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "destroy", callback: Framebuffer.DestroySignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "destroy", callback: Framebuffer.DestroySignalCallback): NodeJS.EventEmitter
    ...
    off(sigName: "notify::context", callback: (...args: any[]) => void): NodeJS.EventEmitter
    emit(sigName: "notify::context", ...args: any[]): void
    connect(sigName: "notify::driver-config", callback: (...args: any[]) => void): number
    on(sigName: "notify::driver-config", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::driver-config", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::driver-config", callback: (...args: any[]) => void): NodeJS.EventEmitter
...
export interface Indices {
    ...
    getBuffer(): IndexBuffer
    getIndicesType(): IndicesType
    getOffset(): number
 ...
 * @class 
 */
export class Indices extends GObject.Object {
...
export interface MatrixStack {
     ...
     */
    getInverse(): [ /* returnType */ boolean, /* inverse */ Graphene.Matrix ]
    /**
 ...
 * @class 
 */
export class MatrixStack extends GObject.Object {
...
export module Offscreen {
    ...
    export interface ConstructorProperties extends Framebuffer.ConstructorProperties {
    }
 ...
 * @class 
 */
export class Offscreen extends Framebuffer {
...
export interface Onscreen {
     ...
     */
    addDirtyCallback(callback: OnscreenDirtyCallback): OnscreenDirtyClosure
    /**
     ...
     */
    addFrameCallback(callback: FrameCallback): FrameClosure
    addFrameInfo(info: FrameInfo): void
    // Has conflict: directScanout(scanout: Scanout, info: FrameInfo, userData: any | null): boolean
    // Has conflict: getBufferAge(): number
    /**
     ...
     */
    hide(): void
    // Has conflict: queueDamageRegion(rectangles: number[]): void
    /**
     ...
     * @param userData 
     */
    swapBuffers(frameInfo: FrameInfo, userData: any | null): void
    // Has conflict: swapBuffersWithDamage(rectangles: number[], info: FrameInfo, userData: any | null): void
    // Has conflict: swapRegion(rectangles: number[], info: FrameInfo, userData: any | null): void

    // Own virtual methods of Cogl-14.Cogl.Onscreen

    bind(): void
    directScanout(scanout: Scanout, info: FrameInfo): boolean
    /**
     ...
     */
    queueDamageRegion(rectangles: number[]): void
    /**
     ...
     * @param info 
     */
    swapBuffersWithDamage(rectangles: number[], info: FrameInfo): void
    /**
     ...
     * @param info 
     */
    swapRegion(rectangles: number[], info: FrameInfo): void
...
export class Onscreen extends Framebuffer {
...
export interface OnscreenTemplate {
...
export class OnscreenTemplate extends GObject.Object {
...
export interface Pipeline {
     ...
     */
    getLayerFilters(layerIndex: number): [ /* minFilter */ PipelineFilter, /* magFilter */ PipelineFilter ]
    /**
     ...
     * @param blendString A Cogl blend string   describing the desired blend function.
     ...
     */
    setDepthState(state: DepthState): boolean
    /**
     * The order of the vertices within a primitive specifies whether it
     * is considered to be front or back facing. This function specifies
     * which order is considered to be the front
     ...
     * @param blendString A Cogl blend string describing the desired  texture combine function.
 ...
 * @class 
 */
export class Pipeline extends GObject.Object {
...
export class PixelBuffer extends Buffer {
     ...
     * @returns a newly allocated #CoglPixelBuffer
     */
    static new(context: Context, data: number[]): PixelBuffer
...
export interface Primitive {
     ...
     */
    setIndices(indices: Indices[]): void
 ...
 * @class 
 */
export class Primitive extends GObject.Object {
     ...
     */
    static newWithAttributes(mode: VerticesMode, nVertices: number, attributes: Attribute[]): Primitive
     ...
     */
    static textureSetAutoMipmap(primitiveTexture: Texture, value: boolean): void
}
...
export interface Program {
     ...
     * `program`.
     * @param uniformLocation the uniform location retrieved from    [method`Program`.get_uniform_location].
     ...
     * @param uniformLocation the uniform location retrieved from    [method`Program`.get_uniform_location].
     * @param nComponents The number of components for the uniform. For example with glsl you'd use 3 for a vec3 or 4 for a vec4.
     * @param value the new value of the uniform[s].
     */
    setUniformFloat(uniformLocation: number, nComponents: number, value: number[]): void
    /**
     ...
     * @param value the new value of the uniform[s].
     */
    setUniformInt(uniformLocation: number, nComponents: number, value: number[]): void
    /**
     ...
     * @param value the new value of the uniform.
     */
    setUniformMatrix(uniformLocation: number, dimensions: number, transpose: boolean, value: number[]): void
...
export class Program extends GObject.Object {
...
export interface Renderer {
     ...
     */
    checkOnscreenTemplate(onscreenTemplate: OnscreenTemplate): boolean
    /**
...
export module Scanout {
     ...
     */
    export interface ScanoutFailedSignalCallback {
...
export interface Scanout {
    ...
    blitToFramebuffer(framebuffer: Framebuffer, x: number, y: number): boolean
    getBuffer(): ScanoutBuffer
    getDstRect(rect: Mtk.Rectangle): void
    getSrcRect(rect: Graphene.Rect): void
    notifyFailed(onscreen: Onscreen): void
    setDstRect(rect: Mtk.Rectangle): void
    setSrcRect(rect: Graphene.Rect): void

    // Own signals of Cogl-14.Cogl.Scanout

    connect(sigName: "scanout-failed", callback: Scanout.ScanoutFailedSignalCallback): number
    on(sigName: "scanout-failed", callback: Scanout.ScanoutFailedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "scanout-failed", callback: Scanout.ScanoutFailedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "scanout-failed", callback: Scanout.ScanoutFailedSignalCallback): NodeJS.EventEmitter
    emit(sigName: "scanout-failed", ...args: any[]): void
...
export class Scanout extends GObject.Object {
    ...
    constructor(scanoutBuffer: ScanoutBuffer) 
    static new(scanoutBuffer: ScanoutBuffer): Scanout
...
export class SwapChain extends GObject.Object {
...
export interface Texture {
     ...
     */
    getGlTexture(): [ /* returnType */ boolean, /* outGlHandle */ number, /* outGlTarget */ number ]
    /**
     ...
     */
    setRegion(srcX: number, srcY: number, dstX: number, dstY: number, dstWidth: number, dstHeight: number, width: number, height: number, format: PixelFormat, rowstride: number, data: number[]): boolean
    /**
...
export class Texture2D extends Texture {
     ...
     */
    static newWithFormat(ctx: Context, width: number, height: number, format: PixelFormat): Texture2D
    /**
     * Creates a low-level #CoglTexture2D texture with a given `width` and
     * `height` that your GPU can texture from directly.
     * 
...
export interface Texture2DSliced {
 ...
 * @class 
 */
export class Texture2DSliced extends Texture {
...
export interface AtlasTextureClass {
}

export abstract class AtlasTextureClass {
...
export interface AttributeBufferClass {
}

export abstract class AttributeBufferClass {
...
export abstract class BitmapClass {
...
export interface DepthState {
     ...
     */
    setTestEnabled(enable: boolean): void
    /**
     ...
     * @param enable The enable state you want
     */
    setWriteEnabled(enable: boolean): void
}
...
export interface FrameInfoClass {
...
export abstract class FrameInfoClass {
...
export interface FramebufferClass {
...
export interface FramebufferDriverConfig {
}
...
export interface IndexBufferClass {
}

export abstract class IndexBufferClass {
...
export abstract class IndicesClass {
...
export interface MatrixEntry {
     ...
     */
    calculateTranslation(entry1: MatrixEntry): [ /* returnType */ boolean, /* x */ number, /* y */ number, /* z */ number ]
    /**
...
export interface MatrixStackClass {
...
export abstract class MatrixStackClass {
...
export interface OffscreenClass {
...
export interface OnscreenClass {

    // Own fields of Cogl-14.Cogl.OnscreenClass

    bind: (onscreen: Onscreen) => void
    swapBuffersWithDamage: (onscreen: Onscreen, rectangles: number[], info: FrameInfo) => void
    swapRegion: (onscreen: Onscreen, rectangles: number[], info: FrameInfo) => void
    queueDamageRegion: (onscreen: Onscreen, rectangles: number[]) => void
...
export interface OnscreenDirtyClosure {
}
...
export interface OnscreenDirtyInfo {
...
export interface OnscreenTemplateClass {
...
export abstract class OnscreenTemplateClass {
...
export interface PixelBufferClass {
}

export abstract class PixelBufferClass {
...
export abstract class PrimitiveClass {
...
export abstract class ProgramClass {
...
export interface ScanoutBufferInterface {

    // Own fields of Cogl-14.Cogl.ScanoutBufferInterface

    parentIface: GObject.TypeInterface
    blitToFramebuffer: (scanout: Scanout, framebuffer: Framebuffer, x: number, y: number) => boolean
    getWidth: (scanoutBuffer: ScanoutBuffer) => number
    getHeight: (scanoutBuffer: ScanoutBuffer) => number
}

export abstract class ScanoutBufferInterface {
...
export abstract class ScanoutClass {
...
export interface SubTextureClass {
}

export abstract class SubTextureClass {
...
export interface SwapChainClass {
...
export abstract class SwapChainClass {
...
export interface Texture2DClass {
}

export abstract class Texture2DClass {
...
export interface Texture2DSlicedClass {
}

export abstract class Texture2DSlicedClass {

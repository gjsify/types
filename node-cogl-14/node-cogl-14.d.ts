 ...
 */
function blitFramebuffer(framebuffer: Framebuffer, dst: Framebuffer, srcX: number, srcY: number, dstX: number, dstY: number, width: number, height: number): boolean
function clutterWinsysHasFeature(feature: WinsysFeature): boolean
/**
 ...
 */
function colorEqual(v1: any | null, v2: any | null): boolean
/**
 ...
 */
function createShader(shaderType: ShaderType): Shader
/**
 ...
 */
function getGraphicsResetStatus(context: Context): GraphicsResetStatus
function getRectangleIndices(context: Context, nRectangles: number): Indices
/**
 ...
 */
function grapheneMatrixProjectPoint(matrix: Graphene.Matrix, x: number, y: number, z: number, w: number): [ /* x */ number, /* y */ number, /* z */ number, /* w */ number ]
/**
 ...
 */
function grapheneMatrixProjectPoints(matrix: Graphene.Matrix, nComponents: number, strideIn: number, pointsIn: any | null, strideOut: number, pointsOut: any | null, nPoints: number): void
/**
 ...
 * @param nPoints The number of points to transform.
 */
function grapheneMatrixTransformPoints(matrix: Graphene.Matrix, nComponents: number, strideIn: number, pointsIn: any | null, strideOut: number, pointsOut: any | null, nPoints: number): void
/**
 ...
 */
function hasFeature(context: Context, feature: FeatureID): boolean
/**
 ...
 */
function isFramebuffer(object: any | null): boolean
/**
 ...
 */
function metaTextureForeachInRegion(texture: Texture, tx1: number, ty1: number, tx2: number, ty2: number, wrapS: PipelineWrapMode, wrapT: PipelineWrapMode, callback: MetaTextureCallback): void
/**
 ...
 */
function pixelFormatGetBytesPerPixel(format: PixelFormat, plane: number): number
/**
 ...
 */
function pixelFormatGetNPlanes(format: PixelFormat): number
/**
...
function setTracingDisabledOnThread(data: any | null): void
function setTracingEnabledOnThread(data: any | null, group: string): void
function startTracingWithFd(fd: number): boolean
function startTracingWithPath(filename: string): boolean

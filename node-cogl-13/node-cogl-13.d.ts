...
import './node-cogl-13-import.d.ts';
...
function setTracingEnabledOnThread(mainContext: GLib.MainContext, group: string | null): void
/**
...
function startTracingWithPath(filename: string | null): boolean

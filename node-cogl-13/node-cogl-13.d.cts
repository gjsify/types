...
export function setTracingEnabledOnThread(mainContext: GLib.MainContext, group: string | null): void
/**
...
export function startTracingWithPath(filename: string | null): boolean

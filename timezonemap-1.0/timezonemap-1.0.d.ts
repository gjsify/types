...
export namespace TimezoneMap {
    ...
    class TimezoneCompletion extends Gtk.EntryCompletion implements Gtk.Buildable, Gtk.CellLayout {
        ...
        /** @signal */
        emit<K extends keyof TimezoneCompletion.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<TimezoneCompletion.SignalSignatures[K]>): void;
    ...
    class TimezoneLocation extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof TimezoneLocation.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<TimezoneLocation.SignalSignatures[K]>): void;
    ...
    class TimezoneMap extends Gtk.Widget implements Atk.ImplementorIface, Gtk.Buildable {
        ...
        /** @signal */
        emit<K extends keyof TimezoneMap.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<TimezoneMap.SignalSignatures[K]>): void;

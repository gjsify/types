/**
 * The GIR-derived widget VOCABULARY for Meta-6.
 *
 * GENERATED — do not edit. Provenance: Meta-6 — library 3.36.6 — dropped empty base(s): Atk.ImplementorIface
 *
 * 27 instantiable GTypes (of which 0 concrete widgets), 27 declarations, 29 enum nick unions, 0 slot candidates.
 *
...
import type Meta from './meta-6.js';
import type { ClutterActorConstructOnly, ClutterActorProps, ClutterAnimatableConstructOnly, ClutterAnimatableProps, ClutterContainerConstructOnly, ClutterContainerProps, ClutterContentConstructOnly, ClutterContentProps, ClutterGroupConstructOnly, ClutterGroupProps, ClutterScriptableConstructOnly, ClutterScriptableProps, ClutterStageConstructOnly, ClutterStageProps } from '@girs/clutter-6/vocabulary';

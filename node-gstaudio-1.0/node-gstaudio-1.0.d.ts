...
import './node-gstaudio-1.0-import.d.ts';
 ...
 * Default is 20 bit.
 */
const AUDIO_CONVERTER_OPT_DITHER_THRESHOLD: string | null
/**
 ...
 */
function audioBufferClip(buffer: Gst.Buffer, segment: Gst.Segment, rate: number, bpf: number): Gst.Buffer | null
/**
 ...
 */
function audioChannelPositionsToString(position: AudioChannelPosition[]): string | null
/**
...
function audioClippingMetaApiGetType(): GObject.GType
function audioClippingMetaGetInfo(): Gst.MetaInfo
function audioDownmixMetaApiGetType(): GObject.GType
 ...
 */
function audioFormatFillSilence(info: AudioFormatInfo, dest: number[]): void
/**
 ...
 */
function audioFormatFromString(format: string | null): AudioFormat
/**
...
function audioFormatInfoGetType(): GObject.GType
function audioFormatToString(format: AudioFormat): string | null
/**
 ...
 */
function audioIec61937Payload(src: number[], dst: number[], spec: AudioRingBufferSpec, endianness: number): boolean
/**
 ...
 * @returns a #GType
 */
function audioLevelMetaApiGetType(): GObject.GType
/**
...
function audioMetaApiGetType(): GObject.GType
 ...
 * @returns %TRUE if the reordering was possible.
 */
function audioReorderChannels(data: number[], format: AudioFormat, from: AudioChannelPosition[], to: AudioChannelPosition[]): boolean
/**
...
interface AudioFormatPack {
    (info: AudioFormatInfo, flags: AudioPackFlags, src: number[], data: number[], length: number): void
}
/**
...
interface AudioFormatUnpack {
    (info: AudioFormatInfo, flags: AudioPackFlags, dest: number[], data: number[], length: number): void
}
/**
...
interface AudioRingBufferCallback {
    (rbuf: AudioRingBuffer, data: number[]): void
}
module StreamVolume {
...
interface AudioRingBuffer {
    ...
    // Has conflict: commit(sample: number, data: number[], outSamples: number, accum: number): [ /* returnType */ number, /* sample */ number, /* accum */ number ]
    /**
     ...
     */
    prepareRead(): [ /* returnType */ boolean, /* segment */ number, /* readptr */ number[] ]
    /**
     ...
     */
    read(sample: number, data: number[]): [ /* returnType */ number, /* timestamp */ Gst.ClockTime ]
     ...
     */
    commit(sample: number, data: number[], outSamples: number, accum: number): [ /* returnType */ number, /* sample */ number, /* accum */ number ]
    /**
...
interface AudioSrc {
     ...
     * @param data the sample data
     */
    read(data: number[]): [ /* returnType */ number, /* timestamp */ Gst.ClockTime ]
    reset(): void
    unprepare(): boolean
...
interface AudioConverter {
     ...
     */
    convert(flags: AudioConverterFlags, in_: number[]): [ /* returnType */ boolean, /* out */ number[] ]
    /**
...
interface AudioRingBufferClass {
    ...
    commit: (buf: AudioRingBuffer, sample: number, data: number[], outSamples: number, accum: number) => [ /* returnType */ number, /* sample */ number, /* accum */ number ]
...
interface AudioSinkClass {
    ...
    write: (sink: AudioSink, data: number[]) => number
...
interface AudioSrcClass {
    ...
    read: (src: AudioSrc, data: number[]) => [ /* returnType */ number, /* timestamp */ Gst.ClockTime ]

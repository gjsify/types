 ...
 */
export function audioFormatFillSilence(info: AudioFormatInfo, dest: number[]): void
/**
 ...
 */
export function audioIec61937Payload(src: number[], dst: number[], spec: AudioRingBufferSpec, endianness: number): boolean
/**
 ...
 * @returns %TRUE if the reordering was possible.
 */
export function audioReorderChannels(data: number[], format: AudioFormat, from: AudioChannelPosition[], to: AudioChannelPosition[]): boolean
/**

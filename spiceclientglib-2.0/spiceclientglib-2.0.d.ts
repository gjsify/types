 ...
 */
function port_write_async(port: PortChannel, buffer: Uint8Array, cancellable?: (Gio.Cancellable | null), callback?: (Gio.AsyncReadyCallback<PortChannel> | null)): void
/**
...
_init(...args: any[]): void;
    ...
    connect_after(signal: 'cursor-set', callback: ((_source: this, width: number, height: number, hot_x: number, hot_y: number, rgba: any | null) => void)): number
...
_init(...args: any[]): void;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect_after(signal: 'display-invalidate', callback: ((_source: this, x: number, y: number, width: number, height: number) => void)): number
    ...
    connect_after(signal: 'display-primary-create', callback: ((_source: this, format: number, width: number, height: number, stride: number, shmid: number, imgdata: any | null) => void)): number
    emit(signal: 'display-primary-create', format: number, width: number, height: number, stride: number, shmid: number, imgdata?: (any | null)): void
    connect_after(signal: 'display-primary-destroy', callback: ((_source: this) => void)): number
    emit(signal: 'display-primary-destroy'): void
    connect_after(signal: 'gl-draw', callback: ((_source: this, x: number, y: number, width: number, height: number) => void)): number
...
_init(...args: any[]): void;
    ...
    connect_after(signal: 'main-clipboard', callback: ((_source: this, type: number, data: any | null, size: number) => void)): number
    emit(signal: 'main-clipboard', type: number, data: (any | null), size: number): void
    connect_after(signal: 'main-clipboard-grab', callback: ((_source: this, types: any | null, ntypes: number) => boolean)): number
    ...
    connect_after(signal: 'main-clipboard-selection', callback: ((_source: this, selection: number, type: number, data: any | null, size: number) => void)): number
    emit(signal: 'main-clipboard-selection', selection: number, type: number, data: (any | null), size: number): void
    connect_after(signal: 'main-clipboard-selection-grab', callback: ((_source: this, selection: number, types: any | null, ntypes: number) => boolean)): number
    emit(signal: 'main-clipboard-selection-grab', selection: number, types: (any | null), ntypes: number): void
    connect_after(signal: 'main-clipboard-selection-release', callback: ((_source: this, selection: number) => void)): number
    emit(signal: 'main-clipboard-selection-release', selection: number): void
    connect_after(signal: 'main-clipboard-selection-request', callback: ((_source: this, selection: number, types: number) => boolean)): number
...
_init(...args: any[]): void;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect_after(signal: 'playback-data', callback: ((_source: this, data: any | null, data_size: number) => void)): number
    ...
    connect_after(signal: 'playback-start', callback: ((_source: this, format: number, channels: number, rate: number) => void)): number
...
_init(...args: any[]): void;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect_after(signal: 'record-start', callback: ((_source: this, format: number, channels: number, rate: number) => void)): number
...
_init(...args: any[]): void;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'auto-connect-failed', callback: ((_source: this, device: UsbDevice, error: GLib.Error) => void)): number
    connect_after(signal: 'auto-connect-failed', callback: ((_source: this, device: UsbDevice, error: GLib.Error) => void)): number
    ...
    connect_after(signal: 'device-error', callback: ((_source: this, device: UsbDevice, error: GLib.Error) => void)): number

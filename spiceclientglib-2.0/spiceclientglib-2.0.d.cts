 ...
 */
export function main_file_copy_async<Z = unknown>(channel: MainChannel, sources: Gio.File[], flags: Gio.FileCopyFlags, cancellable: Gio.Cancellable | null, progress_callback: Gio.FileProgressCallback | null, callback: Gio.AsyncReadyCallback<Z> | null): void
 ...
 */
export function main_file_copy_async<Z = unknown>(channel: MainChannel, sources: Gio.File[], flags: Gio.FileCopyFlags, cancellable: Gio.Cancellable | null, progress_callback: Gio.FileProgressCallback | null): globalThis.Promise<boolean>
/**
 ...
 */
export function port_write_async<Z = unknown>(port: PortChannel, buffer: Uint8Array, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback<Z> | null): void
 ...
 */
export function port_write_async<Z = unknown>(port: PortChannel, buffer: Uint8Array, cancellable: Gio.Cancellable | null): globalThis.Promise<number>
/**
 ...
 */
export function uuid_to_string(uuid: number): string | null

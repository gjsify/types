...
export namespace Sushi {
    ...
    class MediaBin extends Gtk.Box implements Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
        ...
        /** @signal */
        connect<K extends keyof MediaBin.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, MediaBin.SignalSignatures[K]>,
        ): number;
        connect(signal: string, callback: (...args: any[]) => any): number;
        /** @signal */
        connect_after<K extends keyof MediaBin.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, MediaBin.SignalSignatures[K]>,
        ): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;
        /** @signal */
        emit<K extends keyof MediaBin.SignalSignatures>(
            signal: K,
            ...args: GObject.GjsParameters<MediaBin.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never
        ): void;
        emit(signal: string, ...args: any[]): void;

...
export namespace Sushi {
    ...
    class FontWidget extends Gtk.DrawingArea implements Atk.ImplementorIface, Gtk.Buildable {
        ...
        // Own methods of Sushi.FontWidget
    ...
    class MediaBin extends Gtk.Box implements Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
        ...
        // Own properties of Sushi.MediaBin
        ...
        // Constructors of Sushi.MediaBin
        ...
        // Own signals of Sushi.MediaBin

        connect(id: string, callback: (...args: any[]) => any): number;
        connect_after(id: string, callback: (...args: any[]) => any): number;
        emit(id: string, ...args: any[]): void;
        connect(signal: 'error', callback: (_source: this, error: GLib.Error) => boolean): number;
        connect_after(signal: 'error', callback: (_source: this, error: GLib.Error) => boolean): number;
        emit(signal: 'error', error: GLib.Error): void;
        connect(signal: 'seek', callback: (_source: this, object: number) => void): number;
        connect_after(signal: 'seek', callback: (_source: this, object: number) => void): number;
        emit(signal: 'seek', object: number): void;
        connect(signal: 'size-change', callback: (_source: this) => void): number;
        connect_after(signal: 'size-change', callback: (_source: this) => void): number;
        emit(signal: 'size-change'): void;
        connect(signal: 'tags-change', callback: (_source: this) => void): number;
        connect_after(signal: 'tags-change', callback: (_source: this) => void): number;
        emit(signal: 'tags-change'): void;
        connect(signal: 'toggle', callback: (_source: this, object: string) => void): number;
        connect_after(signal: 'toggle', callback: (_source: this, object: string) => void): number;
        emit(signal: 'toggle', object: string): void;

        // Own methods of Sushi.MediaBin

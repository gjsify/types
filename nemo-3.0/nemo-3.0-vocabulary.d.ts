...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type NemoSimpleButtonConstructOnly = GtkButtonConstructOnly | GtkActionableConstructOnly | GtkActivatableConstructOnly | GtkBuildableConstructOnly;
...
export interface Widgets {
    NemoDesktopPreferences: {
        class: Nemo.DesktopPreferences;
        props: NemoDesktopPreferencesProps;
        signals: Nemo.DesktopPreferences.SignalSignatures;
        constructOnly: NemoDesktopPreferencesConstructOnly;
        slotCandidates: {};
    };
    NemoSimpleButton: {
        class: Nemo.SimpleButton;
        props: NemoSimpleButtonProps;
        signals: Nemo.SimpleButton.SignalSignatures;
        constructOnly: NemoSimpleButtonConstructOnly;
        slotCandidates: {};
    };
}

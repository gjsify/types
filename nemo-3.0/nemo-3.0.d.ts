...
export namespace Nemo {
    ...
    class DesktopPreferences extends Gtk.Bin implements Atk.ImplementorIface, Gtk.Buildable {
        ...
        connect<K extends keyof DesktopPreferences.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, DesktopPreferences.SignalSignatures[K]>,
        ): number;
        connect(signal: string, callback: (...args: any[]) => any): number;
        ...
        emit<K extends keyof DesktopPreferences.SignalSignatures>(
            signal: K,
            ...args: GObject.GjsParameters<DesktopPreferences.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never
        ): void;
        emit(signal: string, ...args: any[]): void;
    ...
    class MenuItem extends GObject.Object {
         ...
         * @param menu pointer to a #NemoMenu to attach to the button
         */
        set_submenu(menu: Menu): void;
        /**
         * Sets the custom widget A for this #NemoMenuItem
         * @param widget pointer to a #GtkWidget use in place of text
         */
        ...
        implements Atk.ImplementorIface, Gtk.Actionable, Gtk.Activatable, Gtk.Buildable
    {
        ...
        connect<K extends keyof SimpleButton.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, SimpleButton.SignalSignatures[K]>,
        ): number;
        connect(signal: string, callback: (...args: any[]) => any): number;
        ...
        emit<K extends keyof SimpleButton.SignalSignatures>(
            signal: K,
            ...args: GObject.GjsParameters<SimpleButton.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never
        ): void;
        emit(signal: string, ...args: any[]): void;
    ...
    interface PropertyPageProvider extends GObject.Object {
         ...
         * @param files a #GList of #NemoFileInfo
         * @returns A #GList of allocated #NemoPropertyPage items.
         */

...
export const OWN_SIGNALS = {
    ...
    WnckWindow: ['actions-changed', 'class-changed', 'geometry-changed', 'icon-changed', 'name-changed', 'role-changed', 'state-changed', 'type-changed', 'workspace-changed'],
...
export const ENUM_VALUES = {
    ...
    'WnckPagerScrollMode.1d': 1,
    'WnckPagerScrollMode.2d': 0,
    'WnckPagerScrollMode.none': 2,
...
export const PROP_ENUMS = {
    'WnckHandle.client-type': 'WnckClientType',
};
...
export const PROP_TYPES = {
    'WnckActionMenu.window': 'gpointer',
    'WnckHandle.client-type': 'WnckClientType',
    'WnckPager.handle': 'WnckHandle',
    'WnckSelector.handle': 'WnckHandle',
    'WnckTasklist.handle': 'WnckHandle',
    'WnckTasklist.tooltips-enabled': 'gboolean',
};

 ...
 *
 * 5 concrete widgets, 5 declarations, 7 enum nick unions, 0 slot candidates.
 *
...
export type WnckPagerScrollModeNick = '2d' | '1d' | 'none';
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type WnckImageMenuItemConstructOnly = GtkMenuItemConstructOnly | GtkActionableConstructOnly | GtkActivatableConstructOnly | GtkBuildableConstructOnly;
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type WnckSelectorConstructOnly = GtkMenuBarConstructOnly | GtkBuildableConstructOnly | 'handle';
...
export interface Widgets {
    ...
    WnckImageMenuItem: {
        class: Wnck.ImageMenuItem;
        props: WnckImageMenuItemProps;
        signals: Wnck.ImageMenuItem.SignalSignatures;
        constructOnly: WnckImageMenuItemConstructOnly;
        slotCandidates: {};
    };
    WnckPager: {
        class: Wnck.Pager;

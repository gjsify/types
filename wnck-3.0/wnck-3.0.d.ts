...
export namespace Wnck {
    ...
    class Window extends GObject.Object {
         ...
         *
         * Contrast with wnck_window_get_name(), which returns `window&`lt;!-- --&gt;'s
         ...
         * wnck_window_get_icon_name() is `window&`lt;!-- --&gt;'s name. Only when both
        ...
        shade(): void;
        /**
         * Asks the window manager to keep the `window&`lt;!-- --&gt;'s position fixed on the
         ...
         * does not change `window&`lt;!-- --&gt;'s workspace. If the active workspace
         * is not known for some reason (it should not happen much), sets
         * `window&`lt;!-- --&gt;'s workspace to the first workspace.
         */
        unpin(): void;
        /**
        ...
        unshade(): void;
        /**
         * Asks the window manager to not have `window&`lt;!-- --&gt;'s position fixed on the

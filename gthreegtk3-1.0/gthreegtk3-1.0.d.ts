...
export namespace GthreeGtk3 {
    ...
    class Area extends Gtk.GLArea implements Atk.ImplementorIface, Gtk.Buildable {
        ...
        connect<K extends keyof Area.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, Area.SignalSignatures[K]>,
        ): number;
        connect(signal: string, callback: (...args: any[]) => any): number;
        connect_after<K extends keyof Area.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, Area.SignalSignatures[K]>,
        ): number;
        ...
        emit<K extends keyof Area.SignalSignatures>(
            signal: K,
            ...args: GObject.GjsParameters<Area.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never
        ): void;

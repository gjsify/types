 ...
 */
function trustIsCertificateDistrusted(serialNr: Uint8Array, issuer: Uint8Array, cancellable: Gio.Cancellable | null): boolean
/**
 ...
 * @param callback a #GAsyncReadyCallback to call when the operation completes
 */
function trustIsCertificateDistrustedAsync(serialNr: Uint8Array, issuer: Uint8Array, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void
/**
 * Finishes an asynchronous operation started by
...
interface Certificate {
     ...
     */
    getFingerprint(type: GLib.ChecksumType): Uint8Array | null
    /**
     ...
     */
    getSerialNumber(): Uint8Array | null
    /**

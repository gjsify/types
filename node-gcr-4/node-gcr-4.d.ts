 ...
 */
function fingerprintFromAttributes(attrs: Gck.Attributes, checksumType: GLib.ChecksumType): number[] | null
/**
 ...
 * @returns the          fingerprint or %NULL if the input was invalid.
 */
function fingerprintFromSubjectPublicKeyInfo(keyInfo: number[], checksumType: GLib.ChecksumType): number[] | null
/**
 ...
 */
function pkcs11AddModuleFromFile(modulePath: string, unused: any | null): boolean
/**
 ...
 * @param serialNr The serial number of the certificate
 * @param issuer The raw issuer
 * @param cancellable a #GCancellable or %NULL
 * @returns %TRUE if the certificate is marked as distrusted
 */
function trustIsCertificateDistrusted(serialNr: number[], issuer: number[], cancellable: Gio.Cancellable | null): boolean
/**
 ...
 * @param callback a #GAsyncReadyCallback to call when the operation completes
 */
function trustIsCertificateDistrustedAsync(serialNr: number[], issuer: number[], cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void
/**
 * Finishes an asynchronous operation started by
 ...
 * @returns %TRUE if the certificate is a trust anchor
 */
function trustIsCertificateDistrustedFinish(result: Gio.AsyncResult): boolean
/**
...
interface Certificate {
     ...
     */
    getExpiryDate(): GLib.DateTime | null
    /**
     ...
     */
    getFingerprint(type: GLib.ChecksumType): number[] | null
    /**
     ...
     */
    getInterfaceElements(): CertificateSection[]
    /**
     * Get the issued date of this certificate.
     * @returns A issued date of this certificate.
     */
    getIssuedDate(): GLib.DateTime | null
    /**
    ...
    connect(sigName: "notify::expiry-date", callback: (...args: any[]) => void): number
    on(sigName: "notify::expiry-date", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::expiry-date", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::expiry-date", callback: (...args: any[]) => void): NodeJS.EventEmitter
...
interface CertificateSection {
     ...
     */
    getFields(): Gio.ListModel
    /**
     * Get the flags.
     * @returns the `GcrCertificateSectionFlags`
     */
    getFlags(): CertificateSectionFlags
    /**
...
class Pkcs11Certificate extends Gck.Object {
     ...
     * if an error occurred.
     * @param pkcs11Uri a A PKCS \#11 URI
     * @param cancellable a #GCancellable
     * @returns a new #GcrCertificate, or %NULL
     */
    static newFromUri(pkcs11Uri: string, cancellable: Gio.Cancellable | null): Certificate | null
    /**
     * Lookup a certificate in the PKCS#11 storage by the given URI.
     * 
     * When the operation is finished, callback will be called. You can then call
     ...
     * @param callback a #GAsyncReadyCallback to call when the operation completes
     */
    static newFromUriAsync(pkcs11Uri: string, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void
    /**
     * Finishes an asynchronous operation started by
     ...
     * @returns a new #GcrCertificate, or %NULL
     */
    static newFromUriFinish(result: Gio.AsyncResult): Certificate | null
    /**

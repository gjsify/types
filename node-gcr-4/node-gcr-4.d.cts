 ...
 */
export function trustIsCertificateDistrusted(serialNr: Uint8Array, issuer: Uint8Array, cancellable: Gio.Cancellable | null): boolean
/**
 ...
 * @param callback a #GAsyncReadyCallback to call when the operation completes
 */
export function trustIsCertificateDistrustedAsync(serialNr: Uint8Array, issuer: Uint8Array, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void
/**
 * Finishes an asynchronous operation started by
 ...
 * @returns %TRUE if the certificate is a trust anchor
 */
export function trustIsCertificateDistrustedFinish(result: Gio.AsyncResult): boolean
/**

 ...
 */
export function trustIsCertificateDistrusted(serialNr: number[], issuer: number[], cancellable: Gio.Cancellable | null): boolean
/**
 ...
 * @param callback a #GAsyncReadyCallback to call when the operation completes
 */
export function trustIsCertificateDistrustedAsync(serialNr: number[], issuer: number[], cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void
/**
 * Finishes an asynchronous operation started by

...
export interface GtkSourceCompletionInfoProps extends GtkWindowProps, GtkBuildableProps {
    'max-height'?: number;
    'max-width'?: number;
    'shrink-height'?: boolean;
    'shrink-width'?: boolean;
}
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GtkSourceViewConstructOnly = GtkTextViewConstructOnly | GtkBuildableConstructOnly;

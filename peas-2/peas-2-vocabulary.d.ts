/**
 * The GIR-derived widget VOCABULARY for Peas-2.
 *
...
import type Peas from './peas-2.js';
...
export interface PeasEngineProps extends GObjectProps, GListModelProps {
...
export type PeasEngineConstructOnly = GObjectConstructOnly | GListModelConstructOnly | 'nonglobal-loaders';

/** Proxy for a set of extensions of the same type. */
export interface PeasExtensionSetProps extends GObjectProps, GListModelProps {
    'construct-properties'?: never;
    engine?: Peas.Engine;
    'extension-type'?: GObject.GType;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type PeasExtensionSetConstructOnly = GObjectConstructOnly | GListModelConstructOnly | 'construct-properties' | 'engine' | 'extension-type';

/** Type module which allows extension registration. */
export interface PeasObjectModuleProps {
    /**
     * Whether the module is loaded with local linkage, i.e.
     * @default FALSE
     */
    'local-linkage'?: boolean;
    /** @default NULL */
    'module-name'?: string;
    /** @default NULL */
    path?: string;
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type PeasObjectModuleConstructOnly = 'local-linkage' | 'module-name' | 'path' | 'resident' | 'symbol';

/** A #PeasPluginInfo contains all the information available about a plugin. */
export interface PeasPluginInfoProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type PeasPluginInfoConstructOnly = GObjectConstructOnly;

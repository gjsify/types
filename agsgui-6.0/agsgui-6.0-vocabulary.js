...
//
// GENERATED — do not edit. Provenance: AgsGui-6.0 — prop(s) no TypeScript value satisfies: AgsGui.Cartesian.plot AgsGui.Cartesian.surface AgsGui.Cartesian.translate-data AgsGui.Cartesian.x-label AgsGui.Cartesian.x-label-data AgsGui.Cartesian.x-scale-data AgsGui.Cartesian.x-step-data AgsGui.Cartesian.y-label AgsGui.Cartesian.y-label-data AgsGui.Cartesian.y-scale-data AgsGui.Cartesian.y-step-data AgsGui.FileDialog.file-widget
//
...
export const DECLS = {
    ...
    AgsDial: ['AgsDial', 'GtkWidget', 'GInitiallyUnowned', 'GObject', 'GtkAccessible', 'GtkBuildable', 'GtkConstraintTarget'],
    ...
    AgsIndicator: ['AgsIndicator', 'GtkWidget', 'GInitiallyUnowned', 'GObject', 'GtkAccessible', 'GtkBuildable', 'GtkConstraintTarget', 'GtkOrientable'],

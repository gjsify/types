// The widget vocabulary of GjsDBus-1.0 as runtime data.
//
...
export const DECLS = {
    GjsDBusImplementation: ['GjsDBusImplementation', 'GDBusInterfaceSkeleton', 'GObject', 'GDBusInterface'],
};

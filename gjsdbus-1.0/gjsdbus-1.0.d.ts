...
_init(...args: any[]): void;
    ...
    connect(signal: 'handle-method-call', callback: ((_source: this, object: string, p0: GLib.Variant, p1: Gio.DBusMethodInvocation) => void)): number
    connect_after(signal: 'handle-method-call', callback: ((_source: this, object: string, p0: GLib.Variant, p1: Gio.DBusMethodInvocation) => void)): number
    ...
    connect(signal: 'handle-property-set', callback: ((_source: this, object: string, p0: GLib.Variant) => void)): number
    connect_after(signal: 'handle-property-set', callback: ((_source: this, object: string, p0: GLib.Variant) => void)): number

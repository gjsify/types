...
export namespace Vte {
    ...
    class PtyError extends GLib.Error {
        // Own fields of Vte-3.91.PtyError
        ...
        // Constructors of Vte-3.91.PtyError

        constructor(options: { message: string; code: number });

        // Owm methods of Vte-3.91.PtyError
    ...
    class RegexError extends GLib.Error {
        // Own fields of Vte-3.91.RegexError
        ...
        // Constructors of Vte-3.91.RegexError

        constructor(options: { message: string; code: number });

        // Owm methods of Vte-3.91.RegexError
    ...
    class Pty extends GObject.Object {
        // Own properties of Vte-3.91.Pty
    ...
    class Terminal extends Gtk.Widget {
        // Own properties of Vte-3.91.Terminal
        ...
        // Own fields of Vte-3.91.Terminal

        widget: Gtk.Widget;

        // Constructors of Vte-3.91.Terminal

        static ['new'](): Terminal;

        // Owm methods of Vte-3.91.Terminal
         ...
         */
        check_match_at(x: number, y: number): string | null;
        /**
    ...
    class CharAttributes {
        // Constructors of Vte-3.91.CharAttributes
    ...
    class Regex {
        // Constructors of Vte-3.91.Regex

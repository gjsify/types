 ...
 */
export function codec_utils_aac_get_level(audio_config: Uint8Array): string | null
/**
 ...
 */
export function codec_utils_aac_get_profile(audio_config: Uint8Array): string | null
/**
 ...
 */
export function codec_utils_h264_get_level(sps: Uint8Array): string | null
/**
 ...
 */
export function codec_utils_h264_get_profile(sps: Uint8Array): string | null
/**
 ...
 */
export function codec_utils_h264_get_profile_flags_level(codec_data: Uint8Array): [ /* returnType */ boolean, /* profile */ number, /* flags */ number, /* level */ number ]
/**
 ...
 * @returns The level as a const string, or %NULL if there is an error.
 */
export function codec_utils_h265_get_level(profile_tier_level: Uint8Array): string | null
/**
 * Transform a level string from the caps into the level_idc
 * @param level A level string from caps
 * @returns the level_idc or 0 if the level is unknown
 ...
 * @returns The profile as a const string, or %NULL if there is an error.
 */
export function codec_utils_h265_get_profile(profile_tier_level: Uint8Array): string | null
/**
 ...
 */
export function codec_utils_h265_get_tier(profile_tier_level: Uint8Array): string | null
/**
 ...
 * @returns The level as a const string, or NULL if there is an error.
 */
export function codec_utils_mpeg4video_get_level(vis_obj_seq: Uint8Array): string | null
/**
 ...
 * @returns The profile as a const string, or NULL if there is an error.
 */
export function codec_utils_mpeg4video_get_profile(vis_obj_seq: Uint8Array): string | null
/**
 ...
 */
export function codec_utils_opus_create_caps(rate: number, channels: number, channel_mapping_family: number, stream_count: number, coupled_count: number, channel_mapping: Uint8Array | null): Gst.Caps | null
/**
 ...
 * @returns The #GstCaps.
 */
export function codec_utils_opus_create_caps_from_header(header: Gst.Buffer, comments: Gst.Buffer | null): Gst.Caps | null
/**
 ...
 */
export function codec_utils_opus_create_header(rate: number, channels: number, channel_mapping_family: number, stream_count: number, coupled_count: number, channel_mapping: Uint8Array | null, pre_skip: number, output_gain: number): Gst.Buffer | null
/**
 ...
 */
export function missing_decoder_installer_detail_new(decode_caps: Gst.Caps): string | null
/**
 ...
 * @returns a newly-allocated detail string. Free string          with g_free() when not needed any longer.
 */
export function missing_encoder_installer_detail_new(encode_caps: Gst.Caps): string | null
/**
 * Creates a missing-plugin message for `element` to notify the application
 ...
 */
export function missing_plugin_message_get_description(msg: Gst.Message): string | null
/**
 * Returns an opaque string containing all the details about the missing
 * element to be passed to an external installer called via
 * gst_install_plugins_async() or gst_install_plugins_sync().
 ...
 * @returns a newly-allocated description string. Free          string with g_free() when not needed any longer.
 */
export function pb_utils_get_decoder_description(caps: Gst.Caps): string | null
/**
 ...
 * @returns a newly-allocated description string. Free          string with g_free() when not needed any longer.
 */
export function pb_utils_get_encoder_description(caps: Gst.Caps): string | null
/**
 ...
 */
export function plugins_base_version_string(): string | null
 ...
 * @class 
 */
export class AudioVisualizer extends Gst.Element {
...
export interface DiscovererAudioInfo {
...
export interface DiscovererContainerInfo {
...
export interface DiscovererStreamInfo {
...
export interface DiscovererSubtitleInfo {
...
export interface DiscovererVideoInfo {
...
export interface EncodingAudioProfile {
...
export interface EncodingContainerProfile {
...
export interface EncodingVideoProfile {
...
export interface AudioVisualizerClass {
...
export interface AudioVisualizerPrivate {
}
...
export interface DiscovererPrivate {
}
...
export interface EncodingAudioProfileClass {
}
...
export interface EncodingContainerProfileClass {
}
...
export interface EncodingProfileClass {
}
...
export interface EncodingVideoProfileClass {
}
...
export interface InstallPluginsContext {

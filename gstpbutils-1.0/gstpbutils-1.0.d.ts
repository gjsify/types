...
static ["new"](timeout: Gst.ClockTime): Discoverer;
    ...
    connect(signal: 'discovered', callback: ((_source: this, info: DiscovererInfo, error: GLib.Error | null) => void)): number
    connect_after(signal: 'discovered', callback: ((_source: this, info: DiscovererInfo, error: GLib.Error | null) => void)): number
    ...
    connect(signal: 'load-serialized-info', callback: ((_source: this, uri: string) => (DiscovererInfo | null))): number
    connect_after(signal: 'load-serialized-info', callback: ((_source: this, uri: string) => (DiscovererInfo | null))): number

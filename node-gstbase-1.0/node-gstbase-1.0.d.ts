 ...
 */
const BASE_TRANSFORM_SINK_NAME: string | null
/**
 * The name of the templates for the source pad.
 */
const BASE_TRANSFORM_SRC_NAME: string | null
/**
 ...
 */
function typeFindHelperForBuffer(obj: Gst.Object | null, buf: Gst.Buffer): [ /* returnType */ Gst.Caps | null, /* prob */ Gst.TypeFindProbability ]
/**
 ...
 * @returns the #GstCaps corresponding to the data,     or %NULL if no type could be found. The caller should free the caps     returned with gst_caps_unref().
 */
function typeFindHelperForBufferWithCaps(obj: Gst.Object | null, buf: Gst.Buffer, caps: Gst.Caps): [ /* returnType */ Gst.Caps | null, /* prob */ Gst.TypeFindProbability ]
/**
 * Tries to find what type of data is contained in the given #GstBuffer, the
 * assumption being that the buffer represents the beginning of the stream or
 * file.
 ...
 * @returns the #GstCaps corresponding to the data,     or %NULL if no type could be found. The caller should free the caps     returned with gst_caps_unref().
 */
function typeFindHelperForBufferWithExtension(obj: Gst.Object | null, buf: Gst.Buffer, extension: string | null): [ /* returnType */ Gst.Caps | null, /* prob */ Gst.TypeFindProbability ]
/**
 * Tries to find what type of data is contained in the given `data,` the
 * assumption being that the data represents the beginning of the stream or
 * file.
 ...
 * @returns the #GstCaps corresponding to the data,     or %NULL if no type could be found. The caller should free the caps     returned with gst_caps_unref().
 */
function typeFindHelperForData(obj: Gst.Object | null, data: Uint8Array): [ /* returnType */ Gst.Caps | null, /* prob */ Gst.TypeFindProbability ]
/**
 ...
 * @returns the #GstCaps corresponding to the data,     or %NULL if no type could be found. The caller should free the caps     returned with gst_caps_unref().
 */
function typeFindHelperForDataWithCaps(obj: Gst.Object | null, data: Uint8Array, caps: Gst.Caps): [ /* returnType */ Gst.Caps | null, /* prob */ Gst.TypeFindProbability ]
/**
 * Tries to find what type of data is contained in the given `data,` the
 * assumption being that the data represents the beginning of the stream or
 * file.
 ...
 * @returns the #GstCaps corresponding to the data,     or %NULL if no type could be found. The caller should free the caps     returned with gst_caps_unref().
 */
function typeFindHelperForDataWithExtension(obj: Gst.Object | null, data: Uint8Array, extension: string | null): [ /* returnType */ Gst.Caps | null, /* prob */ Gst.TypeFindProbability ]
/**
 ...
 */
function typeFindHelperForExtension(obj: Gst.Object | null, extension: string | null): Gst.Caps | null
/**
 ...
 * @returns the #GstCaps corresponding to the data     stream.  Returns %NULL if no #GstCaps matches the data stream.
 */
function typeFindHelperGetRange(obj: Gst.Object, parent: Gst.Object | null, func: TypeFindHelperGetRangeFunction, size: number, extension: string | null): [ /* returnType */ Gst.Caps | null, /* prob */ Gst.TypeFindProbability ]
/**
 * Utility function to do pull-based typefinding. Unlike gst_type_find_helper()
 * however, this function will use the specified function `func` to obtain the
 * data needed by the typefind functions, rather than operating on a given
 ...
 */
function typeFindHelperGetRangeFull(obj: Gst.Object, parent: Gst.Object | null, func: TypeFindHelperGetRangeFunction, size: number, extension: string | null): [ /* returnType */ Gst.FlowReturn, /* caps */ Gst.Caps, /* prob */ Gst.TypeFindProbability ]
/**
 ...
 */
function typeFindListFactoriesForCaps(obj: Gst.Object | null, caps: Gst.Caps): Gst.TypeFindFactory[] | null
/**
...
module Aggregator {
     ...
     */
    interface SamplesSelectedSignalCallback {
...
module AggregatorPad {
     ...
     */
    interface BufferConsumedSignalCallback {
    ...
    interface ConstructorProperties extends Gst.Pad.ConstructorProperties {

 ...
 * @returns the #GstCaps corresponding to the data,     or %NULL if no type could be found. The caller should free the caps     returned with gst_caps_unref().
 */
function typeFindHelperForData(obj: Gst.Object | null, data: number[]): [ /* returnType */ Gst.Caps | null, /* prob */ Gst.TypeFindProbability ]
/**
 ...
 * @returns the #GstCaps corresponding to the data,     or %NULL if no type could be found. The caller should free the caps     returned with gst_caps_unref().
 */
function typeFindHelperForDataWithCaps(obj: Gst.Object | null, data: number[], caps: Gst.Caps): [ /* returnType */ Gst.Caps | null, /* prob */ Gst.TypeFindProbability ]
/**
 * Tries to find what type of data is contained in the given `data,` the
 * assumption being that the data represents the beginning of the stream or
 * file.
 ...
 * @returns the #GstCaps corresponding to the data,     or %NULL if no type could be found. The caller should free the caps     returned with gst_caps_unref().
 */
function typeFindHelperForDataWithExtension(obj: Gst.Object | null, data: number[], extension: string | null): [ /* returnType */ Gst.Caps | null, /* prob */ Gst.TypeFindProbability ]
/**

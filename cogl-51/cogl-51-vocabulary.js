// The widget vocabulary of Cogl-51 as runtime data.
//
...
export const DECLS = {
    ...
    CoglContextEGL: ['CoglContextEGL', 'CoglContext', 'GObject'],
    CoglDisplayEGL: ['CoglDisplayEGL', 'CoglDisplay', 'GObject'],
    ...
    CoglOnscreenEgl: ['CoglOnscreenEgl', 'CoglOnscreen', 'CoglFramebuffer', 'GObject'],
    CoglPipeline: ['CoglPipeline', 'GObject'],
    CoglPixelBuffer: ['CoglPixelBuffer', 'CoglBuffer', 'GObject'],
    CoglPrimitive: ['CoglPrimitive', 'GObject'],
    CoglRendererEGL: ['CoglRendererEGL', 'CoglRenderer', 'GObject'],
...
export const ENUM_NICKS = {
    ...
    CoglWinsysFeature: ['swap-region', 'buffer-age', 'sync-fd', 'n-features'],
};
...
export const ENUM_VALUES = {
    ...
    'CoglPixelFormat.rgbx-16161616': 10,
    ...
    'CoglWinsysFeature.buffer-age': 1,
    'CoglWinsysFeature.n-features': 3,
    'CoglWinsysFeature.swap-region': 0,
    'CoglWinsysFeature.sync-fd': 2,
};
...
export const PROP_TYPES = {
    ...
    'CoglBuffer.update-hint': 'CoglBufferUpdateHint',
    'CoglContext.display': 'CoglDisplay',
    'CoglDisplay.renderer': 'CoglRenderer',
    ...
    'CoglRenderer.driver': 'CoglDriver',

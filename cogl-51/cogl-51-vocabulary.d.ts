/**
 * The GIR-derived widget VOCABULARY for Cogl-51.
 *
 * GENERATED — do not edit. Provenance: Cogl-51 — prop(s) no TypeScript value satisfies: Cogl.Framebuffer.driver-config Cogl.Texture.loader
 *
 * 23 instantiable GTypes (of which 0 concrete widgets), 29 declarations, 11 enum nick unions, 0 slot candidates.
 *
...
import type Cogl from './cogl-51.js';
...
export type CoglWinsysFeatureNick = 'swap-region' | 'buffer-age' | 'sync-fd' | 'n-features';
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type CoglContextConstructOnly = GObjectConstructOnly | 'display';

export interface CoglContextEGLProps extends CoglContextProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type CoglContextEGLConstructOnly = CoglContextConstructOnly;
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type CoglDisplayConstructOnly = GObjectConstructOnly | 'renderer';

export interface CoglDisplayEGLProps extends CoglDisplayProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type CoglDisplayEGLConstructOnly = CoglDisplayConstructOnly;
...
export interface CoglOnscreenEglProps extends CoglOnscreenProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type CoglOnscreenEglConstructOnly = CoglOnscreenConstructOnly;
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type CoglRendererConstructOnly = GObjectConstructOnly | 'driver';

export interface CoglRendererEGLProps extends CoglRendererProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type CoglRendererEGLConstructOnly = CoglRendererConstructOnly;

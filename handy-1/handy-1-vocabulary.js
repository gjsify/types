...
export const PROP_TYPES = {
    'HdyActionRow.activatable-widget': 'GtkWidget',
    'HdyActionRow.icon-name': 'gchararray',
    'HdyActionRow.subtitle': 'gchararray',
    'HdyActionRow.subtitle-lines': 'gint',
    'HdyActionRow.title-lines': 'gint',
    'HdyActionRow.use-underline': 'gboolean',
    'HdyAvatar.icon-name': 'gchararray',
    'HdyAvatar.loadable-icon': 'GLoadableIcon',
    'HdyAvatar.show-initials': 'gboolean',
    'HdyAvatar.size': 'gint',
    'HdyAvatar.text': 'gchararray',
    'HdyCarousel.allow-long-swipes': 'gboolean',
    'HdyCarousel.allow-mouse-drag': 'gboolean',
    'HdyCarousel.allow-scroll-wheel': 'gboolean',
    'HdyCarousel.animation-duration': 'guint',
    'HdyCarousel.interactive': 'gboolean',
    'HdyCarousel.reveal-duration': 'guint',
    'HdyCarousel.spacing': 'guint',
    'HdyCarouselIndicatorDots.carousel': 'HdyCarousel',
    'HdyCarouselIndicatorLines.carousel': 'HdyCarousel',
    'HdyClamp.maximum-size': 'gint',
    'HdyClamp.tightening-threshold': 'gint',
    'HdyComboRow.selected-index': 'gint',
    'HdyComboRow.use-subtitle': 'gboolean',
    'HdyDeck.can-swipe-back': 'gboolean',
    'HdyDeck.can-swipe-forward': 'gboolean',
    'HdyDeck.hhomogeneous': 'gboolean',
    'HdyDeck.interpolate-size': 'gboolean',
    'HdyDeck.transition-duration': 'guint',
    'HdyDeck.transition-type': 'HdyDeckTransitionType',
    'HdyDeck.vhomogeneous': 'gboolean',
    'HdyDeck.visible-child': 'GtkWidget',
    'HdyDeck.visible-child-name': 'gchararray',
    'HdyExpanderRow.enable-expansion': 'gboolean',
    'HdyExpanderRow.expanded': 'gboolean',
    'HdyExpanderRow.icon-name': 'gchararray',
    'HdyExpanderRow.show-enable-switch': 'gboolean',
    'HdyExpanderRow.subtitle': 'gchararray',
    'HdyExpanderRow.use-underline': 'gboolean',
    'HdyFlap.content': 'GtkWidget',
    'HdyFlap.flap': 'GtkWidget',
    'HdyFlap.flap-position': 'GtkPackType',
    'HdyFlap.fold-duration': 'guint',
    'HdyFlap.fold-policy': 'HdyFlapFoldPolicy',
    'HdyFlap.locked': 'gboolean',
    'HdyFlap.modal': 'gboolean',
    'HdyFlap.reveal-duration': 'guint',
    'HdyFlap.reveal-flap': 'gboolean',
    'HdyFlap.separator': 'GtkWidget',
    'HdyFlap.swipe-to-close': 'gboolean',
    'HdyFlap.swipe-to-open': 'gboolean',
    'HdyFlap.transition-type': 'HdyFlapTransitionType',
    'HdyHeaderBar.centering-policy': 'HdyCenteringPolicy',
    'HdyHeaderBar.custom-title': 'GtkWidget',
    'HdyHeaderBar.decoration-layout': 'gchararray',
    'HdyHeaderBar.decoration-layout-set': 'gboolean',
    'HdyHeaderBar.has-subtitle': 'gboolean',
    'HdyHeaderBar.interpolate-size': 'gboolean',
    'HdyHeaderBar.show-close-button': 'gboolean',
    'HdyHeaderBar.spacing': 'gint',
    'HdyHeaderBar.subtitle': 'gchararray',
    'HdyHeaderBar.title': 'gchararray',
    'HdyHeaderBar.transition-duration': 'guint',
    'HdyHeaderGroup.decorate-all': 'gboolean',
    'HdyKeypad.column-spacing': 'guint',
    'HdyKeypad.end-action': 'GtkWidget',
    'HdyKeypad.entry': 'GtkEntry',
    'HdyKeypad.letters-visible': 'gboolean',
    'HdyKeypad.row-spacing': 'guint',
    'HdyKeypad.start-action': 'GtkWidget',
    'HdyKeypad.symbols-visible': 'gboolean',
    'HdyLeaflet.can-swipe-back': 'gboolean',
    'HdyLeaflet.can-swipe-forward': 'gboolean',
    'HdyLeaflet.child-transition-duration': 'guint',
    'HdyLeaflet.hhomogeneous-folded': 'gboolean',
    'HdyLeaflet.hhomogeneous-unfolded': 'gboolean',
    'HdyLeaflet.interpolate-size': 'gboolean',
    'HdyLeaflet.mode-transition-duration': 'guint',
    'HdyLeaflet.transition-type': 'HdyLeafletTransitionType',
    'HdyLeaflet.vhomogeneous-folded': 'gboolean',
    'HdyLeaflet.vhomogeneous-unfolded': 'gboolean',
    'HdyLeaflet.visible-child': 'GtkWidget',
    'HdyLeaflet.visible-child-name': 'gchararray',
    'HdyPreferencesGroup.description': 'gchararray',
    'HdyPreferencesGroup.title': 'gchararray',
    'HdyPreferencesGroup.use-markup': 'gboolean',
    'HdyPreferencesPage.icon-name': 'gchararray',
    'HdyPreferencesPage.title': 'gchararray',
    'HdyPreferencesRow.title': 'gchararray',
    'HdyPreferencesRow.use-underline': 'gboolean',
    'HdyPreferencesWindow.can-swipe-back': 'gboolean',
    'HdyPreferencesWindow.search-enabled': 'gboolean',
    'HdySearchBar.search-mode-enabled': 'gboolean',
    'HdySearchBar.show-close-button': 'gboolean',
    'HdySqueezer.homogeneous': 'gboolean',
    'HdySqueezer.interpolate-size': 'gboolean',
    'HdySqueezer.transition-duration': 'guint',
    'HdySqueezer.transition-type': 'HdySqueezerTransitionType',
    'HdySqueezer.xalign': 'gfloat',
    'HdySqueezer.yalign': 'gfloat',
    'HdyStatusPage.description': 'gchararray',
    'HdyStatusPage.icon-name': 'gchararray',
    'HdyStatusPage.title': 'gchararray',
    'HdyStyleManager.color-scheme': 'HdyColorScheme',
    'HdyStyleManager.display': 'GdkDisplay',
    'HdySwipeTracker.allow-long-swipes': 'gboolean',
    'HdySwipeTracker.allow-mouse-drag': 'gboolean',
    'HdySwipeTracker.enabled': 'gboolean',
    'HdySwipeTracker.reversed': 'gboolean',
    'HdySwipeTracker.swipeable': 'HdySwipeable',
    'HdyTabBar.autohide': 'gboolean',
    'HdyTabBar.end-action-widget': 'GtkWidget',
    'HdyTabBar.expand-tabs': 'gboolean',
    'HdyTabBar.inverted': 'gboolean',
    'HdyTabBar.start-action-widget': 'GtkWidget',
    'HdyTabBar.view': 'HdyTabView',
    'HdyTabPage.child': 'GtkWidget',
    'HdyTabPage.icon': 'GIcon',
    'HdyTabPage.indicator-activatable': 'gboolean',
    'HdyTabPage.indicator-icon': 'GIcon',
    'HdyTabPage.loading': 'gboolean',
    'HdyTabPage.needs-attention': 'gboolean',
    'HdyTabPage.parent': 'HdyTabPage',
    'HdyTabPage.title': 'gchararray',
    'HdyTabPage.tooltip': 'gchararray',
    'HdyTabView.default-icon': 'GIcon',
    'HdyTabView.menu-model': 'GMenuModel',
    'HdyTabView.selected-page': 'HdyTabPage',
    'HdyTabView.shortcut-widget': 'GtkWidget',
    'HdyTitleBar.selection-mode': 'gboolean',
    'HdyViewSwitcher.narrow-ellipsize': 'PangoEllipsizeMode',
    'HdyViewSwitcher.policy': 'HdyViewSwitcherPolicy',
    'HdyViewSwitcher.stack': 'GtkStack',
    'HdyViewSwitcherBar.policy': 'HdyViewSwitcherPolicy',
    'HdyViewSwitcherBar.reveal': 'gboolean',
    'HdyViewSwitcherBar.stack': 'GtkStack',
    'HdyViewSwitcherTitle.policy': 'HdyViewSwitcherPolicy',
    'HdyViewSwitcherTitle.stack': 'GtkStack',
    'HdyViewSwitcherTitle.subtitle': 'gchararray',
    'HdyViewSwitcherTitle.title': 'gchararray',
    'HdyViewSwitcherTitle.view-switcher-enabled': 'gboolean',
};

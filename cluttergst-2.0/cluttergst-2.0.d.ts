...
export namespace ClutterGst {
    ...
    class VideoSink extends GstBase.BaseSink implements GstVideo.Navigation {
         ...
         * {@link ClutterGst.VideoTexture}, that implements the {@link Clutter.Media}
         * interface.
         */
    ...
    class VideoTexture extends Clutter.Texture implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Media, Clutter.Scriptable, Player {
        ...
        /** @signal */
        emit<K extends keyof VideoTexture.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<VideoTexture.SignalSignatures[K]>): void;

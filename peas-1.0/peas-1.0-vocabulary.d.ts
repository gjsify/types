/**
 * The GIR-derived widget VOCABULARY for Peas-1.0.
 *
...
import type Peas from './peas-1.0.js';
...
export interface PeasEngineProps extends GObjectProps {
...
export type PeasEngineConstructOnly = GObjectConstructOnly | 'nonglobal-loaders';

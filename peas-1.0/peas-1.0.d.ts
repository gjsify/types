...
export namespace Peas {
    ...
    /**
     * The {@link Peas.Engine} structure contains only private data and should only be
    ...
    /**
     * The {@link Peas.ExtensionSet} structure contains only private data and should only
    ...
    /**
     * The {@link Peas.ObjectModule} structure contains only private data and should only
     * be accessed using the provided API.
     * @gir-type Class
     */

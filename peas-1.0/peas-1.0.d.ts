...
static new_with_nonglobal_loaders(): Engine;
     ...
     */
    create_extension(info: PluginInfo, extension_type: GObject.GType, prop_names: string[], prop_values: GObject.Value[]): Extension
    /**
...
static ["new"](engine: (Engine | null), exten_type: GObject.GType, prop_names: string[], prop_values: GObject.Value[]): ExtensionSet;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'extension-added', callback: ((_source: this, info: PluginInfo, exten: GObject.Object) => void)): number
    connect_after(signal: 'extension-added', callback: ((_source: this, info: PluginInfo, exten: GObject.Object) => void)): number
    emit(signal: 'extension-added', info: PluginInfo, exten: GObject.Object): void
    connect(signal: 'extension-removed', callback: ((_source: this, info: PluginInfo, exten: GObject.Object) => void)): number
    connect_after(signal: 'extension-removed', callback: ((_source: this, info: PluginInfo, exten: GObject.Object) => void)): number

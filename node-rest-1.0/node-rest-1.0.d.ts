 ...
 */
function randomString(length: number): string | null
...
class Param {
     ...
     */
    static newFull(name: string | null, use: MemoryUse, data: Uint8Array, contentType: string | null, filename: string | null): Param
    /**
     ...
     * @returns a new #RestParam.
     */
    static newWithOwner(name: string | null, data: Uint8Array, contentType: string | null, filename: string | null, owner: any | null, ownerDnotify: GLib.DestroyNotify | null): Param
}

/**
 * The GIR-derived widget VOCABULARY for Vgpg-1.
 *
...
export interface VgpgConnectionProps extends VgdaGProviderProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type VgpgConnectionConstructOnly = VgdaGProviderConstructOnly;

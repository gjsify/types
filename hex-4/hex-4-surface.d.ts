...
export interface HexWidgetProps extends GtkWidgetProps, GtkAccessibleProps, GtkBuildableProps, GtkConstraintTargetProps {
    /**
     * Whether ASCII control characters (ASCII characters 0x0 through 0x1F) will be rendered as unicode symbols on the ASCII side of the `HexWidget`.
     * @since 4.10
     */
    'display-control-characters'?: boolean;
    /**
...
export interface Widgets {
    HexWidget: {
        class: Hex.Widget;
        props: HexWidgetProps;
        signals: Hex.Widget.SignalSignatures;
        constructOnly: HexWidgetConstructOnly;
        slotCandidates: {};
    };
}

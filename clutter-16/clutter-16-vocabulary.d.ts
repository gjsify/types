/**
 * The GIR-derived widget VOCABULARY for Clutter-16.
 *
 * GENERATED — do not edit. Provenance: Clutter-16 — dropped empty base(s): Atk.ImplementorIface
 *
 * 59 instantiable GTypes (of which 0 concrete widgets), 70 declarations, 48 enum nick unions, 0 slot candidates.
 *
...
import type Clutter from './clutter-16.js';
...
import type { CoglShaderTypeNick } from '@girs/cogl-16/vocabulary';
...
export type ClutterColorspaceNick = 'srgb' | 'bt2020' | 'ntsc';

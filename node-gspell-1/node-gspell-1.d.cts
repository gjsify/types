...
export function languageLookup(languageCode: string | null): Language | null
...
export interface Checker {
    ...
    on(sigName: "session-cleared", callback: Checker.SessionClearedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "session-cleared", callback: Checker.SessionClearedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "session-cleared", callback: Checker.SessionClearedSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "word-added-to-personal", callback: Checker.WordAddedToPersonalSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "word-added-to-personal", callback: Checker.WordAddedToPersonalSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "word-added-to-personal", callback: Checker.WordAddedToPersonalSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "word-added-to-session", callback: Checker.WordAddedToSessionSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "word-added-to-session", callback: Checker.WordAddedToSessionSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "word-added-to-session", callback: Checker.WordAddedToSessionSignalCallback): NodeJS.EventEmitter

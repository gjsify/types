// The widget vocabulary of GdkX11-4.0 as runtime data.
//
...
export const PROVENANCE = {
    ...
    childHolders: 0,
    droppedBases: [],
    inlinedBases: ['Gdk.Device', 'Gdk.Drag', 'Gdk.Surface'],
    unsettableProps: [],
    unresolvedProps: [],
...
export const OWN_PROPS = {
    ...
    GdkX11DeviceManagerXI2: ['display', 'major', 'minor', 'opcode'],
...
export const DECLS = {
    ...
    GdkX11DeviceManagerXI2: ['GdkX11DeviceManagerXI2', 'GObject'],
    GdkX11DeviceXI2: ['GdkX11DeviceXI2', 'GdkDevice', 'GObject'],
    GdkX11Display: ['GdkX11Display', 'GdkDisplay', 'GObject'],
    GdkX11Drag: ['GdkX11Drag', 'GdkDrag', 'GObject'],
    GdkX11Monitor: ['GdkX11Monitor', 'GdkMonitor', 'GObject'],
    GdkX11Screen: ['GdkX11Screen', 'GObject'],
    GdkX11Surface: ['GdkX11Surface', 'GdkSurface', 'GObject'],
};

/**
 * The GIR-derived widget VOCABULARY for Clutter-1.0.
 *
 * GENERATED — do not edit. Provenance: Clutter-1.0 — library 1.26.5 — dropped empty base(s): Atk.ImplementorIface
 *
 * 71 instantiable GTypes (of which 0 concrete widgets), 86 declarations, 39 enum nick unions, 0 slot candidates.
 *
...
export type ClutterEventTypeNick = 'nothing' | 'key-press' | 'key-release' | 'motion' | 'enter' | 'leave' | 'button-press' | 'button-release' | 'scroll' | 'stage-state' | 'destroy-notify' | 'client-message' | 'delete' | 'touch-begin' | 'touch-update' | 'touch-end' | 'touch-cancel' | 'touchpad-pinch' | 'touchpad-swipe' | 'event-last';
...
export type ClutterInputAxisNick = 'ignore' | 'x' | 'y' | 'pressure' | 'xtilt' | 'ytilt' | 'wheel' | 'distance' | 'last';
export type ClutterInputDeviceTypeNick = 'pointer-device' | 'keyboard-device' | 'extension-device' | 'joystick-device' | 'tablet-device' | 'touchpad-device' | 'touchscreen-device' | 'pen-device' | 'eraser-device' | 'cursor-device' | 'n-device-types';
...
export type ClutterTableAlignmentNick = 'start' | 'center' | 'end';
...
export interface ClutterAnimatorProps extends GObjectProps, ClutterScriptableProps {
    /**
     * The duration of the #ClutterTimeline used by the #ClutterAnimator to drive the animation
     * @since 1.2
     * @default 2000
     * @deprecated since 1.12: Use #ClutterKeyframeTransition instead
     */
    duration?: number;
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type ClutterAnimatorConstructOnly = GObjectConstructOnly | ClutterScriptableConstructOnly;

/** #ClutterBehaviour-struct contains only private data and should be accessed with the functions below. */
export interface ClutterBehaviourProps extends GObjectProps, ClutterScriptableProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type ClutterBehaviourConstructOnly = GObjectConstructOnly | ClutterScriptableConstructOnly;

/** The #ClutterBehaviourDepth structure contains only private data and should be accessed using the provided API */
export interface ClutterBehaviourDepthProps extends ClutterBehaviourProps, ClutterScriptableProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type ClutterBehaviourDepthConstructOnly = ClutterBehaviourConstructOnly | ClutterScriptableConstructOnly;

/** The #ClutterBehaviourEllipse struct contains only private data and should be accessed using the provided API */
export interface ClutterBehaviourEllipseProps extends ClutterBehaviourProps, ClutterScriptableProps {
    /**
     ...
     * @since 0.4
     * @default CLUTTER_ROTATE_CW
     */
    direction?: ClutterRotateDirectionNick | Clutter.RotateDirection;
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type ClutterBehaviourEllipseConstructOnly = ClutterBehaviourConstructOnly | ClutterScriptableConstructOnly;

/** The #ClutterBehaviourOpacity structure contains only private data and should be accessed using the provided API */
export interface ClutterBehaviourOpacityProps extends ClutterBehaviourProps, ClutterScriptableProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type ClutterBehaviourOpacityConstructOnly = ClutterBehaviourConstructOnly | ClutterScriptableConstructOnly;

/** The #ClutterBehaviourPath structure contains only private data and should be accessed using the provided API */
export interface ClutterBehaviourPathProps extends ClutterBehaviourProps, ClutterScriptableProps {
    path?: Clutter.Path;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type ClutterBehaviourPathConstructOnly = ClutterBehaviourConstructOnly | ClutterScriptableConstructOnly;

/** The #ClutterBehaviourRotate struct contains only private data and should be accessed using the provided API */
export interface ClutterBehaviourRotateProps extends ClutterBehaviourProps, ClutterScriptableProps {
    /**
     * The final angle to where the rotation should end.
     * @since 0.4
     * @default 0.000000
     ...
     * @since 0.4
     * @default CLUTTER_Z_AXIS
     */
    axis?: ClutterRotateAxisNick | Clutter.RotateAxis;
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type ClutterBehaviourRotateConstructOnly = ClutterBehaviourConstructOnly | ClutterScriptableConstructOnly;

/** The #ClutterBehaviourScale struct contains only private data and should be accessed using the provided API */
export interface ClutterBehaviourScaleProps extends ClutterBehaviourProps, ClutterScriptableProps {
    /**
     ...
     * @deprecated since 1.6
     */
    'y-scale-start'?: number;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type ClutterBehaviourScaleConstructOnly = ClutterBehaviourConstructOnly | ClutterScriptableConstructOnly;
...
export interface ClutterBinLayoutProps extends ClutterLayoutManagerProps {
     ...
     * @since 1.2
     * @default CLUTTER_BIN_ALIGNMENT_CENTER
...
export interface ClutterCairoTextureProps extends ClutterTextureProps, ClutterAnimatableProps, ClutterContainerProps, ClutterScriptableProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type ClutterCairoTextureConstructOnly = ClutterTextureConstructOnly | ClutterAnimatableConstructOnly | ClutterContainerConstructOnly | ClutterScriptableConstructOnly;
...
export interface ClutterFlowLayoutProps extends ClutterLayoutManagerProps {
     ...
     * @since 1.2
     * @default CLUTTER_FLOW_HORIZONTAL
     */
...
export interface ClutterInputDeviceProps extends GObjectProps {
     ...
     * @since 1.6
     */
    'device-manager'?: Clutter.DeviceManager;
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type ClutterInputDeviceConstructOnly = GObjectConstructOnly | 'backend' | 'device-manager' | 'device-mode' | 'device-type' | 'has-cursor' | 'id' | 'name' | 'product-id' | 'vendor-id';
...
export interface ClutterListModelProps extends ClutterModelProps, ClutterScriptableProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type ClutterListModelConstructOnly = ClutterModelConstructOnly | ClutterScriptableConstructOnly;

/** Base class for list models. */
export interface ClutterModelProps extends GObjectProps, ClutterScriptableProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type ClutterModelConstructOnly = GObjectConstructOnly | ClutterScriptableConstructOnly;
...
export interface ClutterScoreProps extends GObjectProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type ClutterScoreConstructOnly = GObjectConstructOnly;
...
export interface ClutterScrollActorProps extends ClutterActorProps, ClutterAnimatableProps, ClutterContainerProps, ClutterScriptableProps {
     ...
     * @since 1.12
     * @default CLUTTER_SCROLL_HORIZONTALLY | CLUTTER_SCROLL_VERTICALLY
     */
    'scroll-mode'?: number;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
...
export interface ClutterShaderProps extends GObjectProps {
    /**
     * Whether the shader is currently used in the GL rendering pipeline.
     * @since 0.6
     * @default FALSE
     * @deprecated since 1.8: Use #ClutterShaderEffect instead.
     */
    enabled?: boolean;
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type ClutterShaderConstructOnly = GObjectConstructOnly;
...
export interface ClutterStageProps extends ClutterGroupProps, ClutterAnimatableProps, ClutterContainerProps, ClutterScriptableProps {
    ...
    /**
     * The settings for the GL "fog", used only if #ClutterStage:use-fog is set to %TRUE
     * @since 1.0
     * @deprecated since 1.10: This property does not do anything.
     */
    fog?: Clutter.Fog;
    /**
...
export interface ClutterTableLayoutProps extends ClutterLayoutManagerProps {
    /**
     * The spacing between columns of the #ClutterTableLayout, in pixels
     * @since 1.4
     * @default 0
     * @deprecated since 1.18: Use #ClutterGridLayout:column-spacing instead
     */
    'column-spacing'?: number;
    /**
     ...
     * @since 1.4
     * @default 500
     * @deprecated since 1.12: #ClutterTableLayout will honour the easing state of the children when allocating them
     */
    'easing-duration'?: number;
    /**
     ...
     * @since 1.4
     * @default 0
     * @deprecated since 1.18: Use #ClutterGridLayout:row-spacing instead
     */
    'row-spacing'?: number;
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type ClutterTableLayoutConstructOnly = ClutterLayoutManagerConstructOnly;
...
export interface ClutterTextureProps extends ClutterActorProps, ClutterAnimatableProps, ClutterContainerProps, ClutterScriptableProps {
    /** @default FALSE */
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type ClutterTextureConstructOnly = ClutterActorConstructOnly | ClutterAnimatableConstructOnly | ClutterContainerConstructOnly | ClutterScriptableConstructOnly | 'disable-slicing';

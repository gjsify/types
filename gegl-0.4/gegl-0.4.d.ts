...
_init(...args: any[]): void;
    ...
    connect(signal: 'generate-value', callback: ((_source: this, pspec: GObject.ParamSpec, value: GObject.Value) => boolean)): number
    connect_after(signal: 'generate-value', callback: ((_source: this, pspec: GObject.ParamSpec, value: GObject.Value) => boolean)): number
    emit(signal: 'generate-value', pspec: GObject.ParamSpec, value: GObject.Value): void
    connect(signal: 'mapped', callback: ((_source: this, file_module: string, exclude_unmapped: boolean) => void)): number
    connect_after(signal: 'mapped', callback: ((_source: this, file_module: string, exclude_unmapped: boolean) => void)): number
    emit(signal: 'mapped', file_module: string, exclude_unmapped: boolean): void
    connect(signal: 'parse-value', callback: ((_source: this, pspec: GObject.ParamSpec, value: GObject.Value) => boolean)): number
    connect_after(signal: 'parse-value', callback: ((_source: this, pspec: GObject.ParamSpec, value: GObject.Value) => boolean)): number
    ...
    connect_after(signal: 'unmapped', callback: ((_source: this, file_module: string, local_name: string) => void)): number

...
export const PROP_TYPES = {
    'GDBusInterfaceSkeleton.g-flags': 'GDBusInterfaceSkeletonFlags',
    'UDisksBlock.crypto-backing-device': 'gchararray',
    'UDisksBlock.device': 'gchararray',
    'UDisksBlock.device-number': 'guint64',
    'UDisksBlock.drive': 'gchararray',
    'UDisksBlock.hint-auto': 'gboolean',
    'UDisksBlock.hint-icon-name': 'gchararray',
    'UDisksBlock.hint-ignore': 'gboolean',
    'UDisksBlock.hint-name': 'gchararray',
    'UDisksBlock.hint-partitionable': 'gboolean',
    'UDisksBlock.hint-symbolic-icon-name': 'gchararray',
    'UDisksBlock.hint-system': 'gboolean',
    'UDisksBlock.id': 'gchararray',
    'UDisksBlock.id-label': 'gchararray',
    'UDisksBlock.id-type': 'gchararray',
    'UDisksBlock.id-usage': 'gchararray',
    'UDisksBlock.id-uuid': 'gchararray',
    'UDisksBlock.id-version': 'gchararray',
    'UDisksBlock.mdraid': 'gchararray',
    'UDisksBlock.mdraid-member': 'gchararray',
    'UDisksBlock.preferred-device': 'gchararray',
    'UDisksBlock.read-only': 'gboolean',
    'UDisksBlock.size': 'guint64',
    'UDisksBlockLVM2.logical-volume': 'gchararray',
    'UDisksClient.bus-connection': 'GDBusConnection',
    'UDisksDrive.can-power-off': 'gboolean',
    'UDisksDrive.connection-bus': 'gchararray',
    'UDisksDrive.ejectable': 'gboolean',
    'UDisksDrive.id': 'gchararray',
    'UDisksDrive.media': 'gchararray',
    'UDisksDrive.media-available': 'gboolean',
    'UDisksDrive.media-change-detected': 'gboolean',
    'UDisksDrive.media-removable': 'gboolean',
    'UDisksDrive.model': 'gchararray',
    'UDisksDrive.optical': 'gboolean',
    'UDisksDrive.optical-blank': 'gboolean',
    'UDisksDrive.optical-num-audio-tracks': 'guint',
    'UDisksDrive.optical-num-data-tracks': 'guint',
    'UDisksDrive.optical-num-sessions': 'guint',
    'UDisksDrive.optical-num-tracks': 'guint',
    'UDisksDrive.removable': 'gboolean',
    'UDisksDrive.revision': 'gchararray',
    'UDisksDrive.rotation-rate': 'gint',
    'UDisksDrive.seat': 'gchararray',
    'UDisksDrive.serial': 'gchararray',
    'UDisksDrive.sibling-id': 'gchararray',
    'UDisksDrive.size': 'guint64',
    'UDisksDrive.sort-key': 'gchararray',
    'UDisksDrive.time-detected': 'guint64',
    'UDisksDrive.time-media-detected': 'guint64',
    'UDisksDrive.vendor': 'gchararray',
    'UDisksDrive.wwn': 'gchararray',
    'UDisksDriveAta.aam-enabled': 'gboolean',
    'UDisksDriveAta.aam-supported': 'gboolean',
    'UDisksDriveAta.aam-vendor-recommended-value': 'gint',
    'UDisksDriveAta.apm-enabled': 'gboolean',
    'UDisksDriveAta.apm-supported': 'gboolean',
    'UDisksDriveAta.pm-enabled': 'gboolean',
    'UDisksDriveAta.pm-supported': 'gboolean',
    'UDisksDriveAta.read-lookahead-enabled': 'gboolean',
    'UDisksDriveAta.read-lookahead-supported': 'gboolean',
    'UDisksDriveAta.security-enhanced-erase-unit-minutes': 'gint',
    'UDisksDriveAta.security-erase-unit-minutes': 'gint',
    'UDisksDriveAta.security-frozen': 'gboolean',
    'UDisksDriveAta.smart-enabled': 'gboolean',
    'UDisksDriveAta.smart-failing': 'gboolean',
    'UDisksDriveAta.smart-num-attributes-failed-in-the-past': 'gint',
    'UDisksDriveAta.smart-num-attributes-failing': 'gint',
    'UDisksDriveAta.smart-num-bad-sectors': 'gint64',
    'UDisksDriveAta.smart-power-on-seconds': 'guint64',
    'UDisksDriveAta.smart-selftest-percent-remaining': 'gint',
    'UDisksDriveAta.smart-selftest-status': 'gchararray',
    'UDisksDriveAta.smart-supported': 'gboolean',
    'UDisksDriveAta.smart-temperature': 'gdouble',
    'UDisksDriveAta.smart-updated': 'guint64',
    'UDisksDriveAta.write-cache-enabled': 'gboolean',
    'UDisksDriveAta.write-cache-supported': 'gboolean',
    'UDisksDriveLSM.is-ok': 'gboolean',
    'UDisksDriveLSM.is-raid-degraded': 'gboolean',
    'UDisksDriveLSM.is-raid-error': 'gboolean',
    'UDisksDriveLSM.is-raid-reconstructing': 'gboolean',
    'UDisksDriveLSM.is-raid-verifying': 'gboolean',
    'UDisksDriveLSM.min-io-size': 'guint',
    'UDisksDriveLSM.opt-io-size': 'guint',
    'UDisksDriveLSM.raid-disk-count': 'guint',
    'UDisksDriveLSM.raid-type': 'gchararray',
    'UDisksDriveLSM.status-info': 'gchararray',
    'UDisksEncrypted.cleartext-device': 'gchararray',
    'UDisksEncrypted.hint-encryption-type': 'gchararray',
    'UDisksEncrypted.metadata-size': 'guint64',
    'UDisksFilesystem.size': 'guint64',
    'UDisksFilesystemBTRFS.label': 'gchararray',
    'UDisksFilesystemBTRFS.num-devices': 'guint64',
    'UDisksFilesystemBTRFS.used': 'guint64',
    'UDisksFilesystemBTRFS.uuid': 'gchararray',
    'UDisksISCSISession.abort-timeout': 'gint',
    'UDisksISCSISession.address': 'gchararray',
    'UDisksISCSISession.lu-reset-timeout': 'gint',
    'UDisksISCSISession.persistent-address': 'gchararray',
    'UDisksISCSISession.persistent-port': 'gint',
    'UDisksISCSISession.port': 'gint',
    'UDisksISCSISession.recovery-timeout': 'gint',
    'UDisksISCSISession.target-name': 'gchararray',
    'UDisksISCSISession.tgt-reset-timeout': 'gint',
    'UDisksISCSISession.tpgt': 'gint',
    'UDisksJob.bytes': 'guint64',
    'UDisksJob.cancelable': 'gboolean',
    'UDisksJob.expected-end-time': 'guint64',
    'UDisksJob.operation': 'gchararray',
    'UDisksJob.progress': 'gdouble',
    'UDisksJob.progress-valid': 'gboolean',
    'UDisksJob.rate': 'guint64',
    'UDisksJob.start-time': 'guint64',
    'UDisksJob.started-by-uid': 'guint',
    'UDisksLogicalVolume.active': 'gboolean',
    'UDisksLogicalVolume.block-device': 'gchararray',
    'UDisksLogicalVolume.data-allocated-ratio': 'gdouble',
    'UDisksLogicalVolume.layout': 'gchararray',
    'UDisksLogicalVolume.metadata-allocated-ratio': 'gdouble',
    'UDisksLogicalVolume.name': 'gchararray',
    'UDisksLogicalVolume.origin': 'gchararray',
    'UDisksLogicalVolume.size': 'guint64',
    'UDisksLogicalVolume.sync-ratio': 'gdouble',
    'UDisksLogicalVolume.thin-pool': 'gchararray',
    'UDisksLogicalVolume.type': 'gchararray',
    'UDisksLogicalVolume.uuid': 'gchararray',
    'UDisksLogicalVolume.volume-group': 'gchararray',
    'UDisksLoop.autoclear': 'gboolean',
    'UDisksLoop.backing-file': 'gchararray',
    'UDisksLoop.setup-by-uid': 'guint',
    'UDisksMDRaid.bitmap-location': 'gchararray',
    'UDisksMDRaid.chunk-size': 'guint64',
    'UDisksMDRaid.consistency-policy': 'gchararray',
    'UDisksMDRaid.degraded': 'guint',
    'UDisksMDRaid.level': 'gchararray',
    'UDisksMDRaid.name': 'gchararray',
    'UDisksMDRaid.num-devices': 'guint',
    'UDisksMDRaid.running': 'gboolean',
    'UDisksMDRaid.size': 'guint64',
    'UDisksMDRaid.sync-action': 'gchararray',
    'UDisksMDRaid.sync-completed': 'gdouble',
    'UDisksMDRaid.sync-rate': 'guint64',
    'UDisksMDRaid.sync-remaining-time': 'guint64',
    'UDisksMDRaid.uuid': 'gchararray',
    'UDisksManager.default-encryption-type': 'gchararray',
    'UDisksManager.version': 'gchararray',
    'UDisksManagerISCSIInitiator.sessions-supported': 'gboolean',
    'UDisksManagerNVMe.host-id': 'gchararray',
    'UDisksManagerNVMe.host-nqn': 'gchararray',
    'UDisksNVMeController.controller-id': 'guint',
    'UDisksNVMeController.fguid': 'gchararray',
    'UDisksNVMeController.nvme-revision': 'gchararray',
    'UDisksNVMeController.sanitize-percent-remaining': 'gint',
    'UDisksNVMeController.sanitize-status': 'gchararray',
    'UDisksNVMeController.smart-power-on-hours': 'guint64',
    'UDisksNVMeController.smart-selftest-percent-remaining': 'gint',
    'UDisksNVMeController.smart-selftest-status': 'gchararray',
    'UDisksNVMeController.smart-temperature': 'guint',
    'UDisksNVMeController.smart-updated': 'guint64',
    'UDisksNVMeController.state': 'gchararray',
    'UDisksNVMeController.subsystem-nqn': 'gchararray',
    'UDisksNVMeController.unallocated-capacity': 'guint64',
    'UDisksNVMeFabrics.host-id': 'gchararray',
    'UDisksNVMeFabrics.host-nqn': 'gchararray',
    'UDisksNVMeFabrics.transport': 'gchararray',
    'UDisksNVMeFabrics.transport-address': 'gchararray',
    'UDisksNVMeNamespace.eui64': 'gchararray',
    'UDisksNVMeNamespace.format-percent-remaining': 'gint',
    'UDisksNVMeNamespace.namespace-capacity': 'guint64',
    'UDisksNVMeNamespace.namespace-size': 'guint64',
    'UDisksNVMeNamespace.namespace-utilization': 'guint64',
    'UDisksNVMeNamespace.nguid': 'gchararray',
    'UDisksNVMeNamespace.nsid': 'guint',
    'UDisksNVMeNamespace.uuid': 'gchararray',
    'UDisksNVMeNamespace.wwn': 'gchararray',
    'UDisksObject.block': 'UDisksBlock',
    'UDisksObject.block-lvm2': 'UDisksBlockLVM2',
    'UDisksObject.drive': 'UDisksDrive',
    'UDisksObject.drive-ata': 'UDisksDriveAta',
    'UDisksObject.drive-lsm': 'UDisksDriveLSM',
    'UDisksObject.drive-lsm-local': 'UDisksDriveLsmLocal',
    'UDisksObject.encrypted': 'UDisksEncrypted',
    'UDisksObject.filesystem': 'UDisksFilesystem',
    'UDisksObject.filesystem-btrfs': 'UDisksFilesystemBTRFS',
    'UDisksObject.iscsi-session': 'UDisksISCSISession',
    'UDisksObject.job': 'UDisksJob',
    'UDisksObject.logical-volume': 'UDisksLogicalVolume',
    'UDisksObject.loop': 'UDisksLoop',
    'UDisksObject.manager': 'UDisksManager',
    'UDisksObject.manager-btrfs': 'UDisksManagerBTRFS',
    'UDisksObject.manager-iscsi-initiator': 'UDisksManagerISCSIInitiator',
    'UDisksObject.manager-lvm2': 'UDisksManagerLVM2',
    'UDisksObject.manager-nvme': 'UDisksManagerNVMe',
    'UDisksObject.mdraid': 'UDisksMDRaid',
    'UDisksObject.nvme-controller': 'UDisksNVMeController',
    'UDisksObject.nvme-fabrics': 'UDisksNVMeFabrics',
    'UDisksObject.nvme-namespace': 'UDisksNVMeNamespace',
    'UDisksObject.partition': 'UDisksPartition',
    'UDisksObject.partition-table': 'UDisksPartitionTable',
    'UDisksObject.physical-volume': 'UDisksPhysicalVolume',
    'UDisksObject.swapspace': 'UDisksSwapspace',
    'UDisksObject.vdo-volume': 'UDisksVDOVolume',
    'UDisksObject.volume-group': 'UDisksVolumeGroup',
    'UDisksPartition.flags': 'guint64',
    'UDisksPartition.is-contained': 'gboolean',
    'UDisksPartition.is-container': 'gboolean',
    'UDisksPartition.name': 'gchararray',
    'UDisksPartition.number': 'guint',
    'UDisksPartition.offset': 'guint64',
    'UDisksPartition.size': 'guint64',
    'UDisksPartition.table': 'gchararray',
    'UDisksPartition.type': 'gchararray',
    'UDisksPartition.uuid': 'gchararray',
    'UDisksPartitionTable.type': 'gchararray',
    'UDisksPhysicalVolume.free-size': 'guint64',
    'UDisksPhysicalVolume.size': 'guint64',
    'UDisksPhysicalVolume.volume-group': 'gchararray',
    'UDisksSwapspace.active': 'gboolean',
    'UDisksVDOVolume.compression': 'gboolean',
    'UDisksVDOVolume.compression-state': 'gchararray',
    'UDisksVDOVolume.deduplication': 'gboolean',
    'UDisksVDOVolume.index-state': 'gchararray',
    'UDisksVDOVolume.operating-mode': 'gchararray',
    'UDisksVDOVolume.used-size': 'guint64',
    'UDisksVDOVolume.vdo-pool': 'gchararray',
    'UDisksVolumeGroup.extent-size': 'guint64',
    'UDisksVolumeGroup.free-size': 'guint64',
    'UDisksVolumeGroup.name': 'gchararray',
    'UDisksVolumeGroup.needs-polling': 'gboolean',
    'UDisksVolumeGroup.size': 'guint64',
    'UDisksVolumeGroup.uuid': 'gchararray',
};

 ...
 * @param throws TODO
 */
export function callableInfoInvoke(info: CallableInfo, function_: any | null, inArgs: Argument[], outArgs: Argument[], returnValue: Argument, isMethod: boolean, throws: boolean): boolean
/**
 ...
 */
export function callableInfoIterateReturnAttributes(info: CallableInfo, iterator: AttributeIter): [ /* returnType */ boolean, /* iterator */ AttributeIter, /* name */ string | null, /* value */ string | null ]
/**
...
export function cclosureMarshalGeneric(closure: GObject.TClosure, returnGvalue: any, nParamValues: number, paramValues: any, invocationHint: any | null, marshalData: any | null): void
/**
 ...
 */
export function structInfoGetCopyFunction(info: StructInfo): string | null
/**
 ...
 */
export function structInfoGetFreeFunction(info: StructInfo): string | null
/**
 ...
 */
export function typeInfoArgumentFromHashPointer(info: TypeInfo, hashPointer: any | null, arg: Argument): void
/**
 ...
 */
export function typeInfoHashPointerFromArgument(info: TypeInfo, arg: Argument): any | null
/**
 ...
 * @param arg A #GIArgument to fill in
 */
export function typeTagArgumentFromHashPointer(storageType: TypeTag, hashPointer: any | null, arg: Argument): void
/**
 * GLib data structures, such as #GList, #GSList, and #GHashTable, all store
 * data pointers.
 * In the case where the list or hash table is storing single types rather than
 ...
 * @returns the name of the copy function
 */
export function unionInfoGetCopyFunction(info: UnionInfo): string | null
/**
 ...
 * @returns the name of the free function
 */
export function unionInfoGetFreeFunction(info: UnionInfo): string | null
/**
 * Obtain the type information for method with specified index.
 * @param info a #GIUnionInfo
 * @param n a method index
 ...
 */
export function vfuncInfoGetAddress(info: VFuncInfo, implementorGtype: GObject.GType): any | null
/**

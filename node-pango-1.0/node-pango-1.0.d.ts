 ...
 * @returns the newly allocated   `PangoAttribute`, which should be freed with   [method@Pango.Attribute.destroy]
 */
function attrShapeNewWithData(inkRect: Rectangle, logicalRect: Rectangle, data: any | null, copyFunc: AttrDataCopyFunc | null): Attribute
/**
...
class AttrShape {
     ...
     * @returns the newly allocated   `PangoAttribute`, which should be freed with   [method@Pango.Attribute.destroy]
     */
    static newWithData(inkRect: Rectangle, logicalRect: Rectangle, data: any | null, copyFunc: AttrDataCopyFunc | null): Attribute
}

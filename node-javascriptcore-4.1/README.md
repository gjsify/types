...
![version](https://img.shields.io/npm/v/@girs/node-javascriptcore-4.1)
![downloads/week](https://img.shields.io/npm/dw/@girs/node-javascriptcore-4.1)


Node.js TypeScript type definitions for JavaScriptCore-4.1, generated from library version 2.40.0 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v3.0.3.

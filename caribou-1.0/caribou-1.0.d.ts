...
_init(...args: any[]): void;
    ...
    connect(signal: 'group-changed', callback: ((_source: this, gid: number, group: string, variant: string) => void)): number
    connect_after(signal: 'group-changed', callback: ((_source: this, gid: number, group: string, variant: string) => void)): number

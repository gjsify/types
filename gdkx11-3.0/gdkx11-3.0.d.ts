...
import './gdkx11-3.0-ambient.d.ts';
...
export namespace GdkX11 {
    ...
    class X11Cursor extends Gdk.Cursor {
        // Owm methods of GdkX11-3.0.X11Cursor
    ...
    class X11DeviceManagerXI2 extends X11DeviceManagerCore {
        // Own properties of GdkX11-3.0.X11DeviceManagerXI2
    ...
    class X11DeviceXI2 extends Gdk.Device {
        // Own properties of GdkX11-3.0.X11DeviceXI2
    ...
    class X11Display extends Gdk.Display {
        // Owm methods of GdkX11-3.0.X11Display

        /**
         * Retrieves the version of the GLX implementation.
         * @param display a #GdkDisplay
         */
        static get_glx_version(display: Gdk.Display): boolean;
         ...
         */
        string_to_compound_text(str: string): number;
        /**
         ...
         */
        utf8_to_compound_text(str: string): boolean;
    }
    ...
    class X11Keymap extends Gdk.Keymap {
        // Owm methods of GdkX11-3.0.X11Keymap
    ...
    class X11Monitor extends Gdk.Monitor {
        // Owm methods of GdkX11-3.0.X11Monitor
    ...
    class X11Screen extends Gdk.Screen {
        // Owm methods of GdkX11-3.0.X11Screen
    ...
    class X11Visual extends Gdk.Visual {
        // Owm methods of GdkX11-3.0.X11Visual
    ...
    class X11GLContextClass {}

    class X11KeymapClass {}

    class X11MonitorClass {}

...
static ["new"](states: StateSet, statematchtype: CollectionMatchType, attributes: GLib.HashTable<string, string>, attributematchtype: CollectionMatchType, roles: Role[], rolematchtype: CollectionMatchType, interfaces: string[], interfacematchtype: CollectionMatchType, invert: boolean): MatchRule;
}

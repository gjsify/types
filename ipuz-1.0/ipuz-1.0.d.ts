...
export namespace Ipuz {
     ...
     */
    function symmetry_calculate(coord: CellCoord, mirror_coord: CellCoord, puzzle_width: number, puzzle_height: number, symmetry: Symmetry, symmetry_offset: SymmetryOffset): void;

    /**
     * @gir-type Callback
     */
    interface ArrowwordForeachBlocksFunc {
        (arrowword: Arrowword, block_coord: CellCoord, clue: Clue, placement: ArrowwordPlacement, arrow: ArrowwordArrow): void;
    }
    ...
    class Crossword extends Grid implements Clues {
         ...
         * @virtual
         */
        vfunc_check_mirror(src_coord: CellCoord, dest_coord: CellCoord, symmetry: Symmetry, symmetry_offset: SymmetryOffset): boolean;
         ...
         * @virtual
         */
        vfunc_mirror_cell(src_coord: CellCoord, dest_coord: CellCoord, symmetry: Symmetry, symmetry_offset: SymmetryOffset): void;
         ...
         */
        check_mirror(src_coord: CellCoord, dest_coord: CellCoord, symmetry: Symmetry, symmetry_offset: SymmetryOffset): boolean;
         ...
         * @param symmetry_offset The symmetry offset to be observed
         */
        mirror_cell(src_coord: CellCoord, dest_coord: CellCoord, symmetry: Symmetry, symmetry_offset: SymmetryOffset): void;
    ...
    class Grid extends Puzzle {
         ...
         * @virtual
         */
        vfunc_check_stride(direction: ClueDirection, index: number, guesses: Guesses, check_type: GridCheckType): boolean;

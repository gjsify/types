 ...
 */
interface ResourceBrowser_ResourceUpdateSignalCallback {
...
interface ResourceBrowser {
    ...
    connect(sigName: "resource-update", callback: ResourceBrowser_ResourceUpdateSignalCallback): number
    on(sigName: "resource-update", callback: ResourceBrowser_ResourceUpdateSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "resource-update", callback: ResourceBrowser_ResourceUpdateSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "resource-update", callback: ResourceBrowser_ResourceUpdateSignalCallback): NodeJS.EventEmitter

...
class Transcoder {
    ...
    connect(sigName: "notify::avoid-reencoding", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::avoid-reencoding", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::dest-uri", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::dest-uri", callback: ((pspec: GObject.ParamSpec) => void)): number
    on(sigName: "notify::dest-uri", callback: (...args: any[]) => void): NodeJS.EventEmitter
    once(sigName: "notify::dest-uri", callback: (...args: any[]) => void): NodeJS.EventEmitter
    ...
    connect(sigName: "notify::position-update-interval", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::position-update-interval", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::src-uri", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::src-uri", callback: ((pspec: GObject.ParamSpec) => void)): number
    on(sigName: "notify::src-uri", callback: (...args: any[]) => void): NodeJS.EventEmitter
    once(sigName: "notify::src-uri", callback: (...args: any[]) => void): NodeJS.EventEmitter
...
class TranscoderSignalAdapter {
    ...
    connect(sigName: "state-changed", callback: ((object: TranscoderState) => void)): number
    ...
    off(sigName: "notify", callback: (pspec: GObject.ParamSpec) => void): NodeJS.EventEmitter
    emit(sigName: "notify", pspec: GObject.ParamSpec): void
    connect(sigName: "notify::transcoder", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::transcoder", callback: ((pspec: GObject.ParamSpec) => void)): number

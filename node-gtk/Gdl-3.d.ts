...
function marshalVOIDOBJECTENUMBOXED(closure: GObject.TClosure, returnValue: any, nParamValues: number, paramValues: any, invocationHint: object | null, marshalData: object | null): void
function marshalVOIDOBJECTINTINT(closure: GObject.TClosure, returnValue: any, nParamValues: number, paramValues: any, invocationHint: object | null, marshalData: object | null): void
function marshalVOIDUINTUINT(closure: GObject.TClosure, returnValue: any, nParamValues: number, paramValues: any, invocationHint: object | null, marshalData: object | null): void
...
interface Dock extends Atk.ImplementorIface, Gtk.Buildable {
    ...
    on(sigName: "layout-changed", callback: Dock_LayoutChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "layout-changed", callback: Dock_LayoutChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "layout-changed", callback: Dock_LayoutChangedSignalCallback): NodeJS.EventEmitter
...
interface DockBar extends Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
    ...
    getStyle(...args: any[]): DockBarStyle | Gtk.Style | any
    /**
    ...
    setStyle(args_or_style: any[] | Gtk.Style | null): void | any
...
interface DockItem extends Atk.ImplementorIface, Gtk.Buildable {
    ...
    on(sigName: "deselected", callback: DockItem_DeselectedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "deselected", callback: DockItem_DeselectedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "deselected", callback: DockItem_DeselectedSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "dock-drag-begin", callback: DockItem_DockDragBeginSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "dock-drag-begin", callback: DockItem_DockDragBeginSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "dock-drag-begin", callback: DockItem_DockDragBeginSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "dock-drag-end", callback: DockItem_DockDragEndSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "dock-drag-end", callback: DockItem_DockDragEndSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "dock-drag-end", callback: DockItem_DockDragEndSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "dock-drag-motion", callback: DockItem_DockDragMotionSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "dock-drag-motion", callback: DockItem_DockDragMotionSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "dock-drag-motion", callback: DockItem_DockDragMotionSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "move-focus-child", callback: DockItem_MoveFocusChildSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "move-focus-child", callback: DockItem_MoveFocusChildSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "move-focus-child", callback: DockItem_MoveFocusChildSignalCallback): NodeJS.EventEmitter
    emit(sigName: "move-focus-child", ...args: any[]): void
    connect(sigName: "selected", callback: DockItem_SelectedSignalCallback): number
    on(sigName: "selected", callback: DockItem_SelectedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "selected", callback: DockItem_SelectedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "selected", callback: DockItem_SelectedSignalCallback): NodeJS.EventEmitter
...
interface DockMaster {
    ...
    on(sigName: "layout-changed", callback: DockMaster_LayoutChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "layout-changed", callback: DockMaster_LayoutChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "layout-changed", callback: DockMaster_LayoutChangedSignalCallback): NodeJS.EventEmitter
    emit(sigName: "layout-changed", ...args: any[]): void
...
interface DockObject extends Atk.ImplementorIface, Gtk.Buildable {
    ...
    getToplevel(...args: any[]): any
    getToplevel(...args: any[]): Dock | null | Gtk.Widget | any
    /**
    ...
    on(sigName: "detach", callback: DockObject_DetachSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "detach", callback: DockObject_DetachSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "detach", callback: DockObject_DetachSignalCallback): NodeJS.EventEmitter
    emit(sigName: "detach", ...args: any[]): void
    connect(sigName: "dock", callback: DockObject_DockSignalCallback): number
    on(sigName: "dock", callback: DockObject_DockSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "dock", callback: DockObject_DockSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "dock", callback: DockObject_DockSignalCallback): NodeJS.EventEmitter
...
interface DockTablabel extends Atk.ImplementorIface, Gtk.Buildable {
    ...
    on(sigName: "button-pressed-handle", callback: DockTablabel_ButtonPressedHandleSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "button-pressed-handle", callback: DockTablabel_ButtonPressedHandleSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "button-pressed-handle", callback: DockTablabel_ButtonPressedHandleSignalCallback): NodeJS.EventEmitter
...
interface Switcher extends Atk.ImplementorIface, Gtk.Buildable {
    ...
    insertPage(...args: any[]): any
    insertPage(args_or_child: any[] | Gtk.Widget, tabLabel?: Gtk.Widget | null, position?: number): number | any

...
interface Client {
    ...
    on(sigName: "uevent", callback: Client_UeventSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "uevent", callback: Client_UeventSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "uevent", callback: Client_UeventSignalCallback): NodeJS.EventEmitter
...
interface Device {
    ...
    getProperty(args_or_propertyName: any[] | string, value?: any): string | null | void | any
    /**

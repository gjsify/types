...
interface Portal_LocationUpdatedSignalCallback {
    (latitude: number, longitude: number, altitude: number, accuracy: number, speed: number, heading: number, description: string, timestampS: number, timestampMs: number): void
}
...
interface Portal_UpdateAvailableSignalCallback {
    (runningCommit: string, localCommit: string, remoteCommit: string): void
}
...
interface Portal_UpdateProgressSignalCallback {
    (nOps: number, op: number, progress: number, status: UpdateStatus, error: string, errorMessage: string): void
}
...
interface Portal {
    ...
    on(sigName: "location-updated", callback: Portal_LocationUpdatedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "location-updated", callback: Portal_LocationUpdatedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "location-updated", callback: Portal_LocationUpdatedSignalCallback): NodeJS.EventEmitter
    emit(sigName: "location-updated", longitude: number, altitude: number, accuracy: number, speed: number, heading: number, description: string, timestampS: number, timestampMs: number, ...args: any[]): void
    connect(sigName: "notification-action-invoked", callback: Portal_NotificationActionInvokedSignalCallback): number
    on(sigName: "notification-action-invoked", callback: Portal_NotificationActionInvokedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notification-action-invoked", callback: Portal_NotificationActionInvokedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notification-action-invoked", callback: Portal_NotificationActionInvokedSignalCallback): NodeJS.EventEmitter
    emit(sigName: "notification-action-invoked", action: string, parameter: GLib.Variant | null, ...args: any[]): void
    connect(sigName: "session-state-changed", callback: Portal_SessionStateChangedSignalCallback): number
    on(sigName: "session-state-changed", callback: Portal_SessionStateChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "session-state-changed", callback: Portal_SessionStateChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "session-state-changed", callback: Portal_SessionStateChangedSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "spawn-exited", callback: Portal_SpawnExitedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "spawn-exited", callback: Portal_SpawnExitedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "spawn-exited", callback: Portal_SpawnExitedSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "update-available", callback: Portal_UpdateAvailableSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "update-available", callback: Portal_UpdateAvailableSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "update-available", callback: Portal_UpdateAvailableSignalCallback): NodeJS.EventEmitter
    emit(sigName: "update-available", localCommit: string, remoteCommit: string, ...args: any[]): void
    connect(sigName: "update-progress", callback: Portal_UpdateProgressSignalCallback): number
    on(sigName: "update-progress", callback: Portal_UpdateProgressSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "update-progress", callback: Portal_UpdateProgressSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "update-progress", callback: Portal_UpdateProgressSignalCallback): NodeJS.EventEmitter
    emit(sigName: "update-progress", op: number, progress: number, status: UpdateStatus, error: string, errorMessage: string, ...args: any[]): void
...
interface Session {
    ...
    on(sigName: "closed", callback: Session_ClosedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "closed", callback: Session_ClosedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "closed", callback: Session_ClosedSignalCallback): NodeJS.EventEmitter

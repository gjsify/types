...
interface LanguageChooser {
    ...
    on(sigName: "language-activated", callback: LanguageChooser_LanguageActivatedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "language-activated", callback: LanguageChooser_LanguageActivatedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "language-activated", callback: LanguageChooser_LanguageActivatedSignalCallback): NodeJS.EventEmitter
...
interface Buffer {
    ...
    on(sigName: "tepl-cursor-moved", callback: Buffer_TeplCursorMovedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "tepl-cursor-moved", callback: Buffer_TeplCursorMovedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "tepl-cursor-moved", callback: Buffer_TeplCursorMovedSignalCallback): NodeJS.EventEmitter
...
interface Tab extends Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable, TabGroup {
    ...
    on(sigName: "close-request", callback: Tab_CloseRequestSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "close-request", callback: Tab_CloseRequestSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "close-request", callback: Tab_CloseRequestSignalCallback): NodeJS.EventEmitter

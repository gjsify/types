...
class Display {
     ...
     */
    setName(name: string): void
    /* Signals of SpiceClientGtk-3.0.SpiceClientGtk.Display */
    /**
     * Notify when the grab keys have been pressed
     */
    connect(sigName: "grab-keys-pressed", callback: (() => void)): number
    on(sigName: "grab-keys-pressed", callback: () => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "grab-keys-pressed", callback: () => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "grab-keys-pressed", callback: () => void): NodeJS.EventEmitter
    emit(sigName: "grab-keys-pressed"): void
    /**
     * Notify when the keyboard grab is active or not.
     * @param status 1 if grabbed, 0 otherwise.
     */
    connect(sigName: "keyboard-grab", callback: ((status: number) => void)): number
    on(sigName: "keyboard-grab", callback: (status: number) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "keyboard-grab", callback: (status: number) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "keyboard-grab", callback: (status: number) => void): NodeJS.EventEmitter
    emit(sigName: "keyboard-grab", status: number): void
    /**
     * Notify when the mouse grab is active or not.
     * @param status 1 if grabbed, 0 otherwise.
     */
    connect(sigName: "mouse-grab", callback: ((status: number) => void)): number
    on(sigName: "mouse-grab", callback: (status: number) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "mouse-grab", callback: (status: number) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "mouse-grab", callback: (status: number) => void): NodeJS.EventEmitter
    ...
    connect(sigName: "notify::channel-id", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::channel-id", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::disable-inputs", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::disable-inputs", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::grab-keyboard", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::grab-keyboard", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::grab-mouse", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::grab-mouse", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::keypress-delay", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::keypress-delay", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::monitor-id", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::monitor-id", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::only-downscale", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::only-downscale", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::resize-guest", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::resize-guest", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::scaling", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::scaling", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::above-child", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::above-child", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::visible-window", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::visible-window", callback: ((pspec: GObject.ParamSpec) => void)): number
...
class GtkSession {
    ...
    off(sigName: "notify", callback: (pspec: GObject.ParamSpec) => void): NodeJS.EventEmitter
    emit(sigName: "notify", pspec: GObject.ParamSpec): void
    connect(sigName: "notify::auto-clipboard", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::auto-clipboard", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::auto-usbredir", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::auto-usbredir", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::pointer-grabbed", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::pointer-grabbed", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    once(sigName: "notify::session", callback: (...args: any[]) => void): NodeJS.EventEmitter
    off(sigName: "notify::session", callback: (...args: any[]) => void): NodeJS.EventEmitter
    connect(sigName: "notify::sync-modifiers", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::sync-modifiers", callback: ((pspec: GObject.ParamSpec) => void)): number
...
class UsbDeviceWidget {
    /* Properties of SpiceClientGtk-3.0.SpiceClientGtk.UsbDeviceWidget */
    /**
     * Format string to pass to spice_usb_device_get_description() for getting
     * the device USB descriptions.
     */
     ...
     * to the start of `box`.
     * @param child the #GtkWidget to be added to `box`
     * @param expand %TRUE if the new child is to be given extra space allocated     to `box`. The extra space will be divided evenly between all children     that use this option
     * @param fill %TRUE if space given to `child` by the `expand` option is     actually allocated to `child,` rather than just padding it.  This     parameter has no effect if `expand` is set to %FALSE.  A child is     always allocated the full height of a horizontal #GtkBox and the full width     of a vertical #GtkBox. This option affects the other dimension
     * @param padding extra space in pixels to put between this child and its   neighbors, over and above the global amount specified by   #GtkBox:spacing property.  If `child` is a widget at one of the   reference ends of `box,` then `padding` pixels are also put between   `child` and the reference edge of `box`
     */
    ...
    /* Signals of SpiceClientGtk-3.0.SpiceClientGtk.UsbDeviceWidget */
    /**
     ...
     * @param error #GError describing the reason why the connect failed
     */
    connect(sigName: "connect-failed", callback: ((device: SpiceClientGLib.UsbDevice, error: GLib.Error) => void)): number
    on(sigName: "connect-failed", callback: (device: SpiceClientGLib.UsbDevice, error: GLib.Error) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "connect-failed", callback: (device: SpiceClientGLib.UsbDevice, error: GLib.Error) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "connect-failed", callback: (device: SpiceClientGLib.UsbDevice, error: GLib.Error) => void): NodeJS.EventEmitter
    ...
    off(sigName: "notify", callback: (pspec: GObject.ParamSpec) => void): NodeJS.EventEmitter
    emit(sigName: "notify", pspec: GObject.ParamSpec): void
    connect(sigName: "notify::device-format-string", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::device-format-string", callback: ((pspec: GObject.ParamSpec) => void)): number
    on(sigName: "notify::device-format-string", callback: (...args: any[]) => void): NodeJS.EventEmitter
    once(sigName: "notify::device-format-string", callback: (...args: any[]) => void): NodeJS.EventEmitter

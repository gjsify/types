...
interface CertChooser extends Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
    ...
    on(sigName: "cert-password-validate", callback: CertChooser_CertPasswordValidateSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "cert-password-validate", callback: CertChooser_CertPasswordValidateSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "cert-password-validate", callback: CertChooser_CertPasswordValidateSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "cert-validate", callback: CertChooser_CertValidateSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "cert-validate", callback: CertChooser_CertValidateSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "cert-validate", callback: CertChooser_CertValidateSignalCallback): NodeJS.EventEmitter
    emit(sigName: "cert-validate", ...args: any[]): void
    connect(sigName: "changed", callback: CertChooser_ChangedSignalCallback): number
    on(sigName: "changed", callback: CertChooser_ChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "changed", callback: CertChooser_ChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "changed", callback: CertChooser_ChangedSignalCallback): NodeJS.EventEmitter
    emit(sigName: "changed", ...args: any[]): void
    connect(sigName: "key-password-validate", callback: CertChooser_KeyPasswordValidateSignalCallback): number
    on(sigName: "key-password-validate", callback: CertChooser_KeyPasswordValidateSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "key-password-validate", callback: CertChooser_KeyPasswordValidateSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "key-password-validate", callback: CertChooser_KeyPasswordValidateSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "key-validate", callback: CertChooser_KeyValidateSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "key-validate", callback: CertChooser_KeyValidateSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "key-validate", callback: CertChooser_KeyValidateSignalCallback): NodeJS.EventEmitter

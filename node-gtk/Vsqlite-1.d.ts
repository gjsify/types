...
class Connection {
    ...
    typeToGtype(t: number): GObject.Type
    ...
    connect(sigName: "canceled", callback: ((message: string) => void)): number
    ...
    connect(sigName: "timeout", callback: (() => void)): number
    ...
    connect(sigName: "notify::is-opened", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::is-opened", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::connection-string", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::connection-string", callback: ((pspec: GObject.ParamSpec) => void)): number

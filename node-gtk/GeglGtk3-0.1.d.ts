...
class View {
     ...
     * @param cr the #CairoContext to render to
     * @param rect the area that was updated, view coordinates
     */
    connect(sigName: "draw-background", callback: ((cr: cairo.Context, rect: Gdk.Rectangle) => void)): number
    on(sigName: "draw-background", callback: (cr: cairo.Context, rect: Gdk.Rectangle) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "draw-background", callback: (cr: cairo.Context, rect: Gdk.Rectangle) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "draw-background", callback: (cr: cairo.Context, rect: Gdk.Rectangle) => void): NodeJS.EventEmitter
     ...
     * This signal is only available if GEGL-GTK was build with Cairo GObject support.
     * @param cr the #CairoContext to render to
     * @param rect the area that was updated, in view coordinates
     */
    connect(sigName: "draw-overlay", callback: ((cr: cairo.Context, rect: Gdk.Rectangle) => void)): number
    on(sigName: "draw-overlay", callback: (cr: cairo.Context, rect: Gdk.Rectangle) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "draw-overlay", callback: (cr: cairo.Context, rect: Gdk.Rectangle) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "draw-overlay", callback: (cr: cairo.Context, rect: Gdk.Rectangle) => void): NodeJS.EventEmitter
    ...
    connect(sigName: "notify::autoscale-policy", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::autoscale-policy", callback: ((pspec: GObject.ParamSpec) => void)): number
    on(sigName: "notify::autoscale-policy", callback: (...args: any[]) => void): NodeJS.EventEmitter
    once(sigName: "notify::autoscale-policy", callback: (...args: any[]) => void): NodeJS.EventEmitter
    off(sigName: "notify::autoscale-policy", callback: (...args: any[]) => void): NodeJS.EventEmitter

...
interface View extends Atk.ImplementorIface, Gtk.Buildable {
    ...
    on(sigName: "draw-background", callback: View_DrawBackgroundSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "draw-background", callback: View_DrawBackgroundSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "draw-background", callback: View_DrawBackgroundSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "draw-overlay", callback: View_DrawOverlaySignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "draw-overlay", callback: View_DrawOverlaySignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "draw-overlay", callback: View_DrawOverlaySignalCallback): NodeJS.EventEmitter

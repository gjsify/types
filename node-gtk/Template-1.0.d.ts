...
class Template {
    ...
    connect(sigName: "notify::locator", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::locator", callback: ((pspec: GObject.ParamSpec) => void)): number

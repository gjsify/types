...
interface Discoverer {
    ...
    on(sigName: "discovered", callback: Discoverer_DiscoveredSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "discovered", callback: Discoverer_DiscoveredSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "discovered", callback: Discoverer_DiscoveredSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "finished", callback: Discoverer_FinishedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "finished", callback: Discoverer_FinishedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "finished", callback: Discoverer_FinishedSignalCallback): NodeJS.EventEmitter
    emit(sigName: "finished", ...args: any[]): void
    connect(sigName: "source-setup", callback: Discoverer_SourceSetupSignalCallback): number
    on(sigName: "source-setup", callback: Discoverer_SourceSetupSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "source-setup", callback: Discoverer_SourceSetupSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "source-setup", callback: Discoverer_SourceSetupSignalCallback): NodeJS.EventEmitter
    emit(sigName: "source-setup", ...args: any[]): void
    connect(sigName: "starting", callback: Discoverer_StartingSignalCallback): number
    on(sigName: "starting", callback: Discoverer_StartingSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "starting", callback: Discoverer_StartingSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "starting", callback: Discoverer_StartingSignalCallback): NodeJS.EventEmitter

...
interface X11Display {
    ...
    getStartupNotificationId(...args: any[]): any
    getStartupNotificationId(...args: any[]): string | string | null | any
    /**
    ...
    on(sigName: "xevent", callback: X11Display_XeventSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "xevent", callback: X11Display_XeventSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "xevent", callback: X11Display_XeventSignalCallback): NodeJS.EventEmitter
...
class X11Display extends Gdk.Display {
    ...
    static open(args_or_displayName: any[] | string): Gdk.Display | null | any
    /**

...
class Client {
    ...
    connect(sigName: "online-changed", callback: ((object: boolean) => void)): number
...
class ClientContactView {
    ...
    connect(sigName: "contacts-added", callback: ((contacts: Contact[]) => void)): number
    ...
    connect(sigName: "contacts-changed", callback: ((contacts: Contact[]) => void)): number
    ...
    connect(sigName: "contacts-removed", callback: ((contacts: Contact[]) => void)): number
...
class ClientItemView {
    ...
    connect(sigName: "items-added", callback: ((items: Item[]) => void)): number
    ...
    connect(sigName: "items-changed", callback: ((items: Item[]) => void)): number
    ...
    connect(sigName: "items-removed", callback: ((items: Item[]) => void)): number
...
class ClientService {
    ...
    connect(sigName: "avatar-retrieved", callback: ((object: string) => void)): number
    ...
    connect(sigName: "capabilities-changed", callback: ((object: string[]) => void)): number
    ...
    connect(sigName: "status-updated", callback: ((object: boolean) => void)): number
    ...
    connect(sigName: "user-changed", callback: (() => void)): number
...
abstract class ClientServiceClass {
    ...
    readonly parentClass: GObject.ObjectClass
    readonly capabilitiesChanged: (service: ClientService, caps: string) => void
    readonly userChanged: (service: ClientService) => void
    readonly avatarRetrieved: (service: ClientService, path: string) => void
    readonly statusUpdated: (service: ClientService, success: boolean) => void
    static name: string
}
class Contact {

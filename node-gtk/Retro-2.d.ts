...
interface CoreView extends Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget {
    ...
    on(sigName: "controller-state-changed", callback: CoreView_ControllerStateChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "controller-state-changed", callback: CoreView_ControllerStateChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "controller-state-changed", callback: CoreView_ControllerStateChangedSignalCallback): NodeJS.EventEmitter

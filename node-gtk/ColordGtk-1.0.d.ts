...
interface Window {
    ...
    on(sigName: "changed", callback: Window_ChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "changed", callback: Window_ChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "changed", callback: Window_ChangedSignalCallback): NodeJS.EventEmitter

...
interface Connection extends Lockable {
    ...
    on(sigName: "status-changed", callback: Connection_StatusChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "status-changed", callback: Connection_StatusChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "status-changed", callback: Connection_StatusChangedSignalCallback): NodeJS.EventEmitter
...
interface DataModelSelect extends DataModel {
    ...
    on(sigName: "updated", callback: DataModelSelect_UpdatedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "updated", callback: DataModelSelect_UpdatedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "updated", callback: DataModelSelect_UpdatedSignalCallback): NodeJS.EventEmitter
...
interface Holder extends Lockable {
    ...
    on(sigName: "to-default", callback: Holder_ToDefaultSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "to-default", callback: Holder_ToDefaultSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "to-default", callback: Holder_ToDefaultSignalCallback): NodeJS.EventEmitter

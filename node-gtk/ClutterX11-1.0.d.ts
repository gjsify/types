...
interface TexturePixmap_ConstructProps extends Atk.ImplementorIface_ConstructProps, Clutter.Animatable_ConstructProps, Clutter.Container_ConstructProps, Clutter.Scriptable_ConstructProps, Clutter.Texture_ConstructProps {
 ...
 */
interface TexturePixmap_QueueDamageRedrawSignalCallback {
 ...
 */
interface TexturePixmap_UpdateAreaSignalCallback {
    (x: number, y: number, width: number, height: number): void
}
...
interface TexturePixmap extends Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
    ...
    connect(sigName: "queue-damage-redraw", callback: TexturePixmap_QueueDamageRedrawSignalCallback): number
    on(sigName: "queue-damage-redraw", callback: TexturePixmap_QueueDamageRedrawSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "queue-damage-redraw", callback: TexturePixmap_QueueDamageRedrawSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "queue-damage-redraw", callback: TexturePixmap_QueueDamageRedrawSignalCallback): NodeJS.EventEmitter
    emit(sigName: "queue-damage-redraw", y: number, width: number, height: number, ...args: any[]): void
    connect(sigName: "update-area", callback: TexturePixmap_UpdateAreaSignalCallback): number
    on(sigName: "update-area", callback: TexturePixmap_UpdateAreaSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "update-area", callback: TexturePixmap_UpdateAreaSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "update-area", callback: TexturePixmap_UpdateAreaSignalCallback): NodeJS.EventEmitter

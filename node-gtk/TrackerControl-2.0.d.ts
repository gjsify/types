...
class MinerManager {
    /* Properties of TrackerControl-2.0.TrackerControl.MinerManager */
    readonly autoStart: boolean
    readonly domainOntology: string
    ...
    connect(sigName: "notify::domain-ontology", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::domain-ontology", callback: ((pspec: GObject.ParamSpec) => void)): number
    on(sigName: "notify::domain-ontology", callback: (...args: any[]) => void): NodeJS.EventEmitter
    once(sigName: "notify::domain-ontology", callback: (...args: any[]) => void): NodeJS.EventEmitter

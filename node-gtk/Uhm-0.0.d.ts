...
interface Server {
    ...
    on(sigName: "compare-messages", callback: Server_CompareMessagesSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "compare-messages", callback: Server_CompareMessagesSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "compare-messages", callback: Server_CompareMessagesSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "handle-message", callback: Server_HandleMessageSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "handle-message", callback: Server_HandleMessageSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "handle-message", callback: Server_HandleMessageSignalCallback): NodeJS.EventEmitter

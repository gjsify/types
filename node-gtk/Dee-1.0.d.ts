...
interface Peer {
    ...
    on(sigName: "connection-acquired", callback: Peer_ConnectionAcquiredSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "connection-acquired", callback: Peer_ConnectionAcquiredSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "connection-acquired", callback: Peer_ConnectionAcquiredSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "connection-closed", callback: Peer_ConnectionClosedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "connection-closed", callback: Peer_ConnectionClosedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "connection-closed", callback: Peer_ConnectionClosedSignalCallback): NodeJS.EventEmitter
    emit(sigName: "connection-closed", ...args: any[]): void
    connect(sigName: "peer-found", callback: Peer_PeerFoundSignalCallback): number
    on(sigName: "peer-found", callback: Peer_PeerFoundSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "peer-found", callback: Peer_PeerFoundSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "peer-found", callback: Peer_PeerFoundSignalCallback): NodeJS.EventEmitter
    emit(sigName: "peer-found", ...args: any[]): void
    connect(sigName: "peer-lost", callback: Peer_PeerLostSignalCallback): number
    on(sigName: "peer-lost", callback: Peer_PeerLostSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "peer-lost", callback: Peer_PeerLostSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "peer-lost", callback: Peer_PeerLostSignalCallback): NodeJS.EventEmitter
...
interface SharedModel extends Model, Serializable {
    ...
    on(sigName: "begin-transaction", callback: SharedModel_BeginTransactionSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "begin-transaction", callback: SharedModel_BeginTransactionSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "begin-transaction", callback: SharedModel_BeginTransactionSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "end-transaction", callback: SharedModel_EndTransactionSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "end-transaction", callback: SharedModel_EndTransactionSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "end-transaction", callback: SharedModel_EndTransactionSignalCallback): NodeJS.EventEmitter

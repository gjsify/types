...
class Content {
     ...
     */
    connect(sigName: "restart-source", callback: (() => void)): number
     ...
     */
    connect(sigName: "start-sending", callback: (() => boolean)): number
     ...
     * sending media
     */
    connect(sigName: "stop-sending", callback: (() => void)): number
    ...
    off(sigName: "notify", callback: (pspec: GObject.ParamSpec) => void): NodeJS.EventEmitter
    emit(sigName: "notify", pspec: GObject.ParamSpec): void
    connect(sigName: "notify::fs-conference", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::fs-conference", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::fs-session", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::fs-session", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::tf-channel", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::tf-channel", callback: ((pspec: GObject.ParamSpec) => void)): number

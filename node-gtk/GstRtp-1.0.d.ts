...
interface RTPBaseDepayload {
    ...
    on(sigName: "add-extension", callback: RTPBaseDepayload_AddExtensionSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "add-extension", callback: RTPBaseDepayload_AddExtensionSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "add-extension", callback: RTPBaseDepayload_AddExtensionSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "clear-extensions", callback: RTPBaseDepayload_ClearExtensionsSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "clear-extensions", callback: RTPBaseDepayload_ClearExtensionsSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "clear-extensions", callback: RTPBaseDepayload_ClearExtensionsSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "request-extension", callback: RTPBaseDepayload_RequestExtensionSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "request-extension", callback: RTPBaseDepayload_RequestExtensionSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "request-extension", callback: RTPBaseDepayload_RequestExtensionSignalCallback): NodeJS.EventEmitter
...
interface RTPBasePayload {
    ...
    on(sigName: "add-extension", callback: RTPBasePayload_AddExtensionSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "add-extension", callback: RTPBasePayload_AddExtensionSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "add-extension", callback: RTPBasePayload_AddExtensionSignalCallback): NodeJS.EventEmitter
    emit(sigName: "add-extension", ...args: any[]): void
    connect(sigName: "clear-extensions", callback: RTPBasePayload_ClearExtensionsSignalCallback): number
    on(sigName: "clear-extensions", callback: RTPBasePayload_ClearExtensionsSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "clear-extensions", callback: RTPBasePayload_ClearExtensionsSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "clear-extensions", callback: RTPBasePayload_ClearExtensionsSignalCallback): NodeJS.EventEmitter
    emit(sigName: "clear-extensions", ...args: any[]): void
    connect(sigName: "request-extension", callback: RTPBasePayload_RequestExtensionSignalCallback): number
    on(sigName: "request-extension", callback: RTPBasePayload_RequestExtensionSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "request-extension", callback: RTPBasePayload_RequestExtensionSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "request-extension", callback: RTPBasePayload_RequestExtensionSignalCallback): NodeJS.EventEmitter

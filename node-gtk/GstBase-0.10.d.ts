...
interface GstDataQueue {
    ...
    on(sigName: "empty", callback: GstDataQueue_EmptySignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "empty", callback: GstDataQueue_EmptySignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "empty", callback: GstDataQueue_EmptySignalCallback): NodeJS.EventEmitter
    emit(sigName: "empty", ...args: any[]): void
    connect(sigName: "full", callback: GstDataQueue_FullSignalCallback): number
    on(sigName: "full", callback: GstDataQueue_FullSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "full", callback: GstDataQueue_FullSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "full", callback: GstDataQueue_FullSignalCallback): NodeJS.EventEmitter

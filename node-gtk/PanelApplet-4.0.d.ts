...
class Applet {
     ...
     */
    connect(sigName: "change-background", callback: ((pattern: cairo.Pattern) => void)): number
    on(sigName: "change-background", callback: (pattern: cairo.Pattern) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "change-background", callback: (pattern: cairo.Pattern) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "change-background", callback: (pattern: cairo.Pattern) => void): NodeJS.EventEmitter
    emit(sigName: "change-background", pattern: cairo.Pattern): void
    /**
     * Emitted when the #PanelAppletOrient of `applet` has changed.
     */
    connect(sigName: "change-orient", callback: ((orient: number) => void)): number
    on(sigName: "change-orient", callback: (orient: number) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "change-orient", callback: (orient: number) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "change-orient", callback: (orient: number) => void): NodeJS.EventEmitter
    emit(sigName: "change-orient", orient: number): void
    /**
     * Emitted when the size of the panel `applet` is on has changed.
     */
    connect(sigName: "change-size", callback: ((size: number) => void)): number
    on(sigName: "change-size", callback: (size: number) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "change-size", callback: (size: number) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "change-size", callback: (size: number) => void): NodeJS.EventEmitter
    emit(sigName: "change-size", size: number): void
    /**
     * Emitted when the focus is moved out of `applet`. This is an
     * implementation detail.
     */
    connect(sigName: "move-focus-out-of-applet", callback: ((direction: Gtk.DirectionType) => void)): number
    on(sigName: "move-focus-out-of-applet", callback: (direction: Gtk.DirectionType) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "move-focus-out-of-applet", callback: (direction: Gtk.DirectionType) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "move-focus-out-of-applet", callback: (direction: Gtk.DirectionType) => void): NodeJS.EventEmitter
    ...
    connect(sigName: "notify::locked-down", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::locked-down", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::orient", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::orient", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::prefs-key", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::prefs-key", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::settings-path", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::settings-path", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::size-hints", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::size-hints", callback: ((pspec: GObject.ParamSpec) => void)): number
...
abstract class AppletClass {
    ...
    readonly eventBoxClass: Gtk.EventBoxClass
    readonly changeOrient: (applet: Applet, orient: AppletOrient) => void
    readonly changeSize: (applet: Applet, size: number) => void
    readonly changeBackground: (applet: Applet, pattern: cairo.Pattern) => void
    readonly moveFocusOutOfApplet: (frame: Applet, direction: Gtk.DirectionType) => void
    static name: string
}
class AppletPrivate {
    static name: string

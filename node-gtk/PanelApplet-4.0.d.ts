...
class Applet {
     ...
     * @param pattern the new background pattern for `applet,` or %NULL if there is none.
     */
     ...
     * @param orient the new #PanelAppletOrient of `applet`.
     */
     ...
     * @param size the new size of the panel `applet` is on.
     */

...
interface Aggregator {
    ...
    on(sigName: "samples-selected", callback: Aggregator_SamplesSelectedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "samples-selected", callback: Aggregator_SamplesSelectedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "samples-selected", callback: Aggregator_SamplesSelectedSignalCallback): NodeJS.EventEmitter
...
interface AggregatorPad {
    ...
    on(sigName: "buffer-consumed", callback: AggregatorPad_BufferConsumedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "buffer-consumed", callback: AggregatorPad_BufferConsumedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "buffer-consumed", callback: AggregatorPad_BufferConsumedSignalCallback): NodeJS.EventEmitter
...
interface CollectPads {
     ...
     */
    clipRunningTime(cdata: CollectData, buf: Gst.Buffer, userData: object | null): [ /* returnType */ Gst.FlowReturn, /* outbuf */ Gst.Buffer ]
    /**

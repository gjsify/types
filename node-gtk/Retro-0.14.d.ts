...
interface Core_ConstructProps extends GObject.Object_ConstructProps {
    /* Constructor properties of Retro-0.14.Retro.Core */
...
class Core {
     ...
     * by the core.
     */
    connect(sigName: "audio-output", callback: ((data: Uint8Array, sampleRate: number) => void)): number
    on(sigName: "audio-output", callback: (data: Uint8Array, sampleRate: number) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "audio-output", callback: (data: Uint8Array, sampleRate: number) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "audio-output", callback: (data: Uint8Array, sampleRate: number) => void): NodeJS.EventEmitter
    emit(sigName: "audio-output", data: Uint8Array, sampleRate: number): void
    /**
     ...
     */
    connect(sigName: "message", callback: ((message: string, frames: number) => boolean)): number
     ...
     * options during boot.
     */
    connect(sigName: "options-set", callback: (() => void)): number
    on(sigName: "options-set", callback: () => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "options-set", callback: () => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "options-set", callback: () => void): NodeJS.EventEmitter
     ...
     */
    connect(sigName: "shutdown", callback: (() => boolean)): number
    ...
    connect(sigName: "notify::content-directory", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::content-directory", callback: ((pspec: GObject.ParamSpec) => void)): number
    on(sigName: "notify::content-directory", callback: (...args: any[]) => void): NodeJS.EventEmitter
    once(sigName: "notify::content-directory", callback: (...args: any[]) => void): NodeJS.EventEmitter
...
interface CoreView_ConstructProps extends Gtk.EventBox_ConstructProps {
    /* Constructor properties of Retro-0.14.Retro.CoreView */
...
interface MainLoop_ConstructProps extends GObject.Object_ConstructProps {
    /* Constructor properties of Retro-0.14.Retro.MainLoop */
    core?: Core
    speedRate?: number
}
class MainLoop {
    ...
    off(sigName: "notify", callback: (pspec: GObject.ParamSpec) => void): NodeJS.EventEmitter
    emit(sigName: "notify", pspec: GObject.ParamSpec): void
    connect(sigName: "notify::core", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::core", callback: ((pspec: GObject.ParamSpec) => void)): number
    on(sigName: "notify::core", callback: (...args: any[]) => void): NodeJS.EventEmitter
    once(sigName: "notify::core", callback: (...args: any[]) => void): NodeJS.EventEmitter
...
abstract class ControllerInterface {
    ...
    readonly poll: (self: Controller) => void
    ...
    readonly setRumbleState: (self: Controller, effect: RumbleEffect, strength: number) => boolean
    static name: string
}
...
abstract class CoreViewClass {
    ...
    readonly parentClass: Gtk.EventBoxClass
    static name: string
}

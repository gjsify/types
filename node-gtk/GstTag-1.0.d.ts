 ...
 */
function tagListFromVorbiscomment(data: Uint8Array, idData: Uint8Array): [ /* returnType */ Gst.TagList, /* vendorString */ string ]
/**
 * Creates a new tag list that contains the information parsed out of a
 * vorbiscomment packet.
 * @param buffer buffer to convert
 * @param idData identification data at start of stream
 */
function tagListFromVorbiscommentBuffer(buffer: Gst.Buffer, idData: Uint8Array): [ /* returnType */ Gst.TagList, /* vendorString */ string ]
/**

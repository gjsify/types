...
interface Parser {
    ...
    on(sigName: "entry-parsed", callback: Parser_EntryParsedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "entry-parsed", callback: Parser_EntryParsedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "entry-parsed", callback: Parser_EntryParsedSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "playlist-ended", callback: Parser_PlaylistEndedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "playlist-ended", callback: Parser_PlaylistEndedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "playlist-ended", callback: Parser_PlaylistEndedSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "playlist-started", callback: Parser_PlaylistStartedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "playlist-started", callback: Parser_PlaylistStartedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "playlist-started", callback: Parser_PlaylistStartedSignalCallback): NodeJS.EventEmitter

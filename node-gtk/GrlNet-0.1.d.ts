...
interface Wc_ConstructProps extends GObject.Object_ConstructProps {
    /* Constructor properties of GrlNet-0.1.GrlNet.Wc */
    cache?: boolean
    cacheSize?: number
    loglevel?: number
    throttling?: number
...
class Wc {
    ...
    connect(sigName: "notify::loglevel", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::loglevel", callback: ((pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::throttling", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::throttling", callback: ((pspec: GObject.ParamSpec) => void)): number

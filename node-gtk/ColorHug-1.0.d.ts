...
interface DeviceQueue {
    ...
    on(sigName: "device-failed", callback: DeviceQueue_DeviceFailedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "device-failed", callback: DeviceQueue_DeviceFailedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "device-failed", callback: DeviceQueue_DeviceFailedSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "progress-changed", callback: DeviceQueue_ProgressChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "progress-changed", callback: DeviceQueue_ProgressChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "progress-changed", callback: DeviceQueue_ProgressChangedSignalCallback): NodeJS.EventEmitter

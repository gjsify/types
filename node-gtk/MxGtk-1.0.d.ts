...
interface LightSwitch extends Atk.ImplementorIface, Gtk.Buildable {
    ...
    on(sigName: "switch-flipped", callback: LightSwitch_SwitchFlippedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "switch-flipped", callback: LightSwitch_SwitchFlippedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "switch-flipped", callback: LightSwitch_SwitchFlippedSignalCallback): NodeJS.EventEmitter

...
class Persona {
    /* Properties of FolksLibsocialweb-0.6.FolksLibsocialweb.Persona */
    ...
    connect(sigName: "notify::lsw-contact", callback: ((pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::lsw-contact", callback: ((pspec: GObject.ParamSpec) => void)): number
    on(sigName: "notify::lsw-contact", callback: (...args: any[]) => void): NodeJS.EventEmitter
    once(sigName: "notify::lsw-contact", callback: (...args: any[]) => void): NodeJS.EventEmitter
...
class PersonaStore {
    /* Properties of FolksLibsocialweb-0.6.FolksLibsocialweb.PersonaStore */

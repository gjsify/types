...
static ["new"](name: string, startup_id: string): App;
    ...
    connect(signal: 'message-received', callback: ((_source: this, command: number, message_data: MessageData, time_: number) => Response)): number
    connect_after(signal: 'message-received', callback: ((_source: this, command: number, message_data: MessageData, time_: number) => Response)): number

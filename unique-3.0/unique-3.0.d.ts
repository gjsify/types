...
export namespace Unique {
    ...
    class App extends GObject.Object {
        // Own properties of Unique-3.0.App
        ...
        // Constructors of Unique-3.0.App

        static ['new'](name: string, startup_id: string): App;

        // Owm methods of Unique-3.0.App
    ...
    abstract class Backend extends GObject.Object {
        // Owm methods of Unique-3.0.Backend
     ...
     */
    class MessageData {
        // Constructors of Unique-3.0.MessageData

        constructor(properties?: Partial<{}>);

        static ['new'](): MessageData;

        // Owm methods of Unique-3.0.MessageData

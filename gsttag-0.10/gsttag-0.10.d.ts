...
export namespace GstTag {
     ...
     * @param vendor_string 
     */
    function list_to_vorbiscomment_buffer(list: Gst.TagList, id_data: number[], id_data_length: number, vendor_string: string): Gst.Buffer;
    ...
    abstract class Demux extends Gst.Element {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof Demux.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, Demux.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof Demux.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, Demux.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof Demux.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<Demux.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;

...
export function freeform_string_to_utf8(data: string | null, size: number, env_vars: string[]): string | null
export function from_id3_tag(id3_tag: string | null): string | null
export function from_id3_user_tag(type: string | null, id3_user_tag: string | null): string | null
export function from_vorbis_tag(vorbis_tag: string | null): string | null
export function get_language_code_iso_639_1(lang_code: string | null): string | null
export function get_language_code_iso_639_2B(lang_code: string | null): string | null
export function get_language_code_iso_639_2T(lang_code: string | null): string | null
export function get_language_codes(): string[]
export function get_language_name(language_code: string | null): string | null
export function gst_vorbis_tag_add(list: Gst.TagList, tag: string | null, value: string | null): void
export function id3_genre_count(): number
export function id3_genre_get(id: number): string | null
export function image_data_to_image_buffer(image_data: number[], image_data_len: number, image_type: ImageType): Gst.Buffer
export function list_add_id3_image(tag_list: Gst.TagList, image_data: number[], image_data_len: number, id3_picture_type: number): boolean
export function list_from_vorbiscomment_buffer(buffer: Gst.Buffer, id_data: number[], id_data_length: number, vendor_string: string[]): Gst.TagList
export function list_from_xmp_buffer(buffer: Gst.Buffer): Gst.TagList
export function list_new_from_id3v1(data: number[]): Gst.TagList
export function list_to_vorbiscomment_buffer(list: Gst.TagList, id_data: number[], id_data_length: number, vendor_string: string | null): Gst.Buffer
export function list_to_xmp_buffer(list: Gst.TagList, read_only: boolean): Gst.Buffer
export function parse_extended_comment(ext_comment: string | null, key: string[], lang: string[], value: string[], fail_if_no_key: boolean): boolean
export function register_musicbrainz_tags(): void
export function to_id3_tag(gst_tag: string | null): string | null
export function to_vorbis_tag(gst_tag: string | null): string | null
export module Demux {

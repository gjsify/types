...
export const PROP_TYPES = {
    'CoglBuffer.context': 'CoglContext',
    'CoglBuffer.default-target': 'CoglBufferBindTarget',
    'CoglBuffer.size': 'guint64',
    'CoglBuffer.update-hint': 'CoglBufferUpdateHint',
    'CoglFramebuffer.context': 'CoglContext',
    'CoglFramebuffer.driver-config': 'gpointer',
    'CoglFramebuffer.height': 'gint',
    'CoglFramebuffer.width': 'gint',
    'CoglTexture.context': 'CoglContext',
    'CoglTexture.format': 'CoglPixelFormat',
    'CoglTexture.height': 'gint',
    'CoglTexture.loader': 'gpointer',
    'CoglTexture.width': 'gint',
};

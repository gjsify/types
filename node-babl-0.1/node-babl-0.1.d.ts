 ...
 * @param performance 
 */
function fastFish(sourceFormat: any | null, destinationFormat: any | null, performance: string): Object
/**
...
function iccGetKey(iccData: string, iccLength: number, key: string, language: string, country: string): string | null
 ...
 */
function paletteSetPalette(babl: Object, format: Object, data: number[], count: number): void
/**
 ...
 */
function spaceGetIcc(babl: Object): [ /* returnType */ string, /* length */ number ]
/**
...
interface FuncPlanar {
    (conversion: Object, srcBands: number, src: string, srcPitch: number, dstBands: number, dst: string | null, dstPitch: number, n: number): void
}
interface Object {
}

...
function vulkanImageMemoryWrapped(device: VulkanDevice, image: Vulkan.Image, format: Vulkan.Format, width: number, height: number, tiling: Vulkan.ImageTiling, usage: Vulkan.ImageUsageFlags, userData: any | null, notify: GLib.DestroyNotify): Gst.Memory
/**
...
function vulkanMemoryHeapFlagsToString(propBits: Vulkan.MemoryHeapFlags): string | null
/**
...
function vulkanMemoryPropertyFlagsToString(propBits: Vulkan.MemoryPropertyFlags): string | null
function vulkanRunQuery(element: Gst.Element, query: Gst.Query, direction: Gst.PadDirection): boolean
function vulkanSampleCountFlagsToString(sampleCountBits: Vulkan.SampleCountFlags): string | null
function vulkanTrashMiniObjectUnref(device: VulkanDevice, userData: any | null): void
function vulkanTrashObjectUnref(device: VulkanDevice, userData: any | null): void

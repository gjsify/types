...
export namespace Wp {
    ...
    function log_init(flags: number): void;
    ...
    abstract class EventHook extends GObject.Object {
         ...
         * @returns the event dispatcher on which this hook is registered, or NULL if the hook is not registered
         */
        get_dispatcher(): EventDispatcher | null;
        /**
        ...
        set_dispatcher(dispatcher: EventDispatcher): void;
    }
    ...
    class ObjectManager extends GObject.Object {
         ...
         */
        add_interest_full(interest: ObjectInterest): void;
        add_object(object?: any | null): void;
        /**
        ...
        rm_object(object?: any | null): void;
    }

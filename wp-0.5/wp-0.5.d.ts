...
export namespace Wp {
    ...
    class AsyncEventHook extends InterestEventHook {
        ...
        /** @signal */
        emit<K extends keyof AsyncEventHook.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<AsyncEventHook.SignalSignatures[K]>): void;
    }
    ...
    class Conf extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof Conf.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<Conf.SignalSignatures[K]>): void;
    ...
    class EventDispatcher extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof EventDispatcher.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<EventDispatcher.SignalSignatures[K]>): void;
    ...
    abstract class EventHook extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof EventHook.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<EventHook.SignalSignatures[K]>): void;
    ...
    abstract class InterestEventHook extends EventHook {
        ...
        /** @signal */
        emit<K extends keyof InterestEventHook.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<InterestEventHook.SignalSignatures[K]>): void;
    ...
    class SimpleEventHook extends InterestEventHook {
        ...
        /** @signal */
        emit<K extends keyof SimpleEventHook.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<SimpleEventHook.SignalSignatures[K]>): void;
    }

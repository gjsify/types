...
interface SymbolEvent extends Location {
    ...
    connect(sigName: "notify::source-layer", callback: (...args: any[]) => void): number
    on(sigName: "notify::source-layer", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::source-layer", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::source-layer", callback: (...args: any[]) => void): NodeJS.EventEmitter
...
interface VectorRenderer extends Gio.Initable {
     ...
     */
    setSpriteSheetData(spritesPixbuf: GdkPixbuf.Pixbuf, spritesJson: string): boolean
...
class VectorRenderer extends MapSource {
     ...
     */
    constructor(id: string, styleJson: string) 
    /**
     * Creates a new [class`VectorRenderer]` from the given JSON style.
     * 
     * The stylesheet should contain a list of tile sources. Tiles will be
     ...
     * @returns a newly constructed [class@VectorRenderer], or %NULL if @error is set
     */
    static new(id: string, styleJson: string): VectorRenderer

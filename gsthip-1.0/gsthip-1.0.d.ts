...
export namespace GstHip {
     ...
     * @since 1.28
     */
    function hip_ensure_element_data(element: Gst.Element, vendor: HipVendor, device_id: number, device: HipDevice): [boolean, HipDevice];
     ...
     * @since 1.28
     */
    function hip_handle_set_context(element: Gst.Element, context: Gst.Context, vendor: HipVendor, device_id: number, device: HipDevice): [boolean, HipDevice];

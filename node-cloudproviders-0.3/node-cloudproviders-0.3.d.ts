 ...
 */
function dbusAccountInterfaceInfo(): Gio.DBusInterfaceInfo
/**
 ...
 */
function dbusAccountOverrideProperties(klass: GObject.ObjectClass, propertyIdBegin: number): number
/**
 ...
 * @returns A #GDBusInterfaceInfo. Do not free.
 */
function dbusProviderInterfaceInfo(): Gio.DBusInterfaceInfo
/**
 ...
 * @returns The last property id.
 */
function dbusProviderOverrideProperties(klass: GObject.ObjectClass, propertyIdBegin: number): number
module DbusAccount {
...
class AccountExporter extends GObject.Object {
     ...
     */
    constructor(provider: ProviderExporter, busName: string) 
    /**
     * Create a new #CloudProvidersAccountExporter object
     * @constructor 
     * @param provider The provider to which it will be associated.
...
class ProviderExporter extends GObject.Object {
    ...
    constructor(bus: Gio.DBusConnection, busName: string, busPath: string) 

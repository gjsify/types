/**
 * The GIR-derived widget VOCABULARY for PanelApplet-4.0.
 *
 ...
 *
 * 1 instantiable GTypes (of which 1 concrete widgets), 1 declarations, 1 enum nick unions, 1 slot candidates.
 *
...
import type PanelApplet from './panelapplet-4.0.js';
...
export type PanelAppletOrientNick = 'up' | 'down' | 'left' | 'right';
...
export interface PanelAppletProps extends GtkEventBoxProps, GtkBuildableProps {
    ...
    /** The size of the panel the applet is on. */
    size?: number;
    /** The size hints set for the applet. */
    'size-hints'?: never;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type PanelAppletConstructOnly = GtkEventBoxConstructOnly | GtkBuildableConstructOnly;
...
export interface Widgets {
    PanelApplet: {
        class: PanelApplet.Applet;
        props: PanelAppletProps;
        signals: PanelApplet.Applet.SignalSignatures;
        constructOnly: PanelAppletConstructOnly;
        slotCandidates: {

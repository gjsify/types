...
export namespace Ags {
    ...
    namespace Sequencer {
        ...
        interface Interface {
             ...
             * @virtual
             */
            vfunc_set_midi_version(midi_version: SequencerMidiVersion): void;
            /**
    ...
    interface SoundServer extends GObject.Object, SoundServer.Interface {
         ...
         * @returns a new {@link Ags.Sequencer}
         */
        register_sequencer_with_params<T = GObject.Object>(
            is_output: boolean,
            param_strv: string,
            param_value: GObject.Value | any,
        ): T;
         ...
         * @returns a new {@link Ags.Soundcard}
         */
        register_soundcard_with_params<T = GObject.Object>(
            is_output: boolean,
            param_strv: string,
            param_value: GObject.Value | any,
        ): T;

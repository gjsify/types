...
module Cache {
    ...
    interface BeforePut {
        (object: string, p0: string, p1: string, p2: CacheColumnValues, p3: boolean, p4?: (Gio.Cancellable | null), p5?: (any | null)): boolean
    }
...
_init(...args: any[]): void;
    ...
    connect(signal: 'before-put', callback: ((_source: this, object: string, p0: string, p1: string, p2: CacheColumnValues, p3: boolean, p4: Gio.Cancellable | null, p5: any | null) => boolean)): number
    connect_after(signal: 'before-put', callback: ((_source: this, object: string, p0: string, p1: string, p2: CacheColumnValues, p3: boolean, p4: Gio.Cancellable | null, p5: any | null) => boolean)): number
    emit(signal: 'before-put', object: string, p0: string, p1: string, p2: CacheColumnValues, p3: boolean, p4?: (Gio.Cancellable | null), p5?: (any | null)): void
    connect(signal: 'before-remove', callback: ((_source: this, object: string, p0: Gio.Cancellable | null, p1: any | null) => boolean)): number
    connect_after(signal: 'before-remove', callback: ((_source: this, object: string, p0: Gio.Cancellable | null, p1: any | null) => boolean)): number
...
_init(...args: any[]): void;
    ...
    connect_after(signal: 'bus-name-acquired', callback: ((_source: this, connection: Gio.DBusConnection) => void)): number
...
static ["new"](): SourceRegistryServer;
    ...
    connect(signal: 'tweak-key-file', callback: ((_source: this, key_file: GLib.KeyFile, uid: string) => boolean)): number
    connect_after(signal: 'tweak-key-file', callback: ((_source: this, key_file: GLib.KeyFile, uid: string) => boolean)): number
...
module UserPrompterServer {
    ...
    interface Prompt {
        (prompt_id: number, type: (string | null), title: (string | null), primary_text: (string | null), secondary_text: (string | null), use_markup: boolean, button_captions?: (string[] | null)): void
    }
...
static ["new"](): UserPrompterServer;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'prompt', callback: ((_source: this, prompt_id: number, type: string | null, title: string | null, primary_text: string | null, secondary_text: string | null, use_markup: boolean, button_captions: string[] | null) => void)): number
    connect_after(signal: 'prompt', callback: ((_source: this, prompt_id: number, type: string | null, title: string | null, primary_text: string | null, secondary_text: string | null, use_markup: boolean, button_captions: string[] | null) => void)): number
    emit(signal: 'prompt', prompt_id: number, type: (string | null), title: (string | null), primary_text: (string | null), secondary_text: (string | null), use_markup: boolean, button_captions?: (string[] | null)): void

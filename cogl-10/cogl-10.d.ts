...
export namespace Cogl {
    ...
    class ScanoutError extends GLib.Error {
        // Own fields of Cogl-10.ScanoutError

        SCANOUT_ERROR_INHIBITED: number;

        // Constructors of Cogl-10.ScanoutError
    ...
    class Bitmap extends Object {
        // Constructors of Cogl-10.Bitmap

        static new_from_file(filename: string): Bitmap;

        // Owm methods of Cogl-10.Bitmap
    ...
    class Context extends Object {
        // Owm methods of Cogl-10.Context
    ...
    class FrameInfo extends Object {
        // Owm methods of Cogl-10.FrameInfo
    ...
    abstract class Framebuffer extends GObject.Object {
        // Own properties of Cogl-10.Framebuffer
        ...
        // Owm methods of Cogl-10.Framebuffer
    ...
    class Offscreen extends Framebuffer {
        // Constructors of Cogl-10.Offscreen
    ...
    class Onscreen extends Framebuffer {
        // Owm methods of Cogl-10.Onscreen
    ...
    class Pipeline extends Object {
        // Constructors of Cogl-10.Pipeline

        static ['new'](context: Context): Pipeline;

        // Owm methods of Cogl-10.Pipeline
    ...
    class Texture2D extends Object {
        // Constructors of Cogl-10.Texture2D

        static new_from_bitmap(bitmap: Bitmap): Texture2D;

        // Owm methods of Cogl-10.Texture2D
    ...
    class Texture2DSliced extends Object {
        // Constructors of Cogl-10.Texture2DSliced
     ...
     */
    class Color {
        // Constructors of Cogl-10.Color

        constructor(properties?: Partial<{}>);

        static ['new'](): Color;

        // Owm methods of Cogl-10.Color
    ...
    class DebugObjectTypeInfo {
        // Own fields of Cogl-10.DebugObjectTypeInfo

        name: string;
        instance_count: number;

        // Constructors of Cogl-10.DebugObjectTypeInfo
    ...
    class OnscreenDirtyInfo {
        // Own fields of Cogl-10.OnscreenDirtyInfo
        ...
        // Constructors of Cogl-10.OnscreenDirtyInfo
    ...
    class Scanout {
        // Owm methods of Cogl-10.Scanout
     ...
     */
    class TextureVertex {
        // Own fields of Cogl-10.TextureVertex
    ...
    class TraceHead {
        // Own fields of Cogl-10.TraceHead

        begin_time: number;
        name: string;
        description: string;

        // Constructors of Cogl-10.TraceHead
     ...
     */
    class UserDataKey {
        // Own fields of Cogl-10.UserDataKey

        unused: number;

        // Constructors of Cogl-10.UserDataKey
    ...
    class _ColorSizeCheck {
        // Own fields of Cogl-10._ColorSizeCheck

        compile_time_assert_CoglColor_size: number[];

        // Constructors of Cogl-10._ColorSizeCheck
    ...
    class _TextureVertexSizeCheck {
        // Own fields of Cogl-10._TextureVertexSizeCheck

        compile_time_assert_CoglTextureVertex_size: number[];

        // Constructors of Cogl-10._TextureVertexSizeCheck
    ...
    interface Texture {
        // Owm methods of Cogl-10.Texture

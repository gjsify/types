...
_init(...args: any[]): void;
    ...
    connect(signal: 'progress', callback: ((_source: this, status: string, progress: number, remaining_time: number) => void)): number
    connect_after(signal: 'progress', callback: ((_source: this, status: string, progress: number, remaining_time: number) => void)): number
...
module MinerFS {
    ...
    interface Finished {
        (elapsed: number, directories_found: number, directories_ignored: number, files_found: number, files_ignored: number): void
    }
...
_init(...args: any[]): void;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'finished', callback: ((_source: this, elapsed: number, directories_found: number, directories_ignored: number, files_found: number, files_ignored: number) => void)): number
    connect_after(signal: 'finished', callback: ((_source: this, elapsed: number, directories_found: number, directories_ignored: number, files_found: number, files_ignored: number) => void)): number
    emit(signal: 'finished', elapsed: number, directories_found: number, directories_ignored: number, files_found: number, files_ignored: number): void
    ...
    connect(signal: 'ignore-next-update-file', callback: ((_source: this, file: Gio.File, builder: Tracker.SparqlBuilder, cancellable: Gio.Cancellable | null) => boolean)): number
    connect_after(signal: 'ignore-next-update-file', callback: ((_source: this, file: Gio.File, builder: Tracker.SparqlBuilder, cancellable: Gio.Cancellable | null) => boolean)): number
    emit(signal: 'ignore-next-update-file', file: Gio.File, builder: Tracker.SparqlBuilder, cancellable?: (Gio.Cancellable | null)): void
    connect(signal: 'process-file', callback: ((_source: this, file: Gio.File, builder: Tracker.SparqlBuilder, cancellable: Gio.Cancellable | null) => boolean)): number
    connect_after(signal: 'process-file', callback: ((_source: this, file: Gio.File, builder: Tracker.SparqlBuilder, cancellable: Gio.Cancellable | null) => boolean)): number
    emit(signal: 'process-file', file: Gio.File, builder: Tracker.SparqlBuilder, cancellable?: (Gio.Cancellable | null)): void
    connect(signal: 'process-file-attributes', callback: ((_source: this, file: Gio.File, builder: Tracker.SparqlBuilder, cancellable: Gio.Cancellable | null) => boolean)): number
    connect_after(signal: 'process-file-attributes', callback: ((_source: this, file: Gio.File, builder: Tracker.SparqlBuilder, cancellable: Gio.Cancellable | null) => boolean)): number
    emit(signal: 'process-file-attributes', file: Gio.File, builder: Tracker.SparqlBuilder, cancellable?: (Gio.Cancellable | null)): void
    connect(signal: 'remove-file', callback: ((_source: this, file: Gio.File, children_only: boolean, builder: Tracker.SparqlBuilder) => boolean)): number
    connect_after(signal: 'remove-file', callback: ((_source: this, file: Gio.File, children_only: boolean, builder: Tracker.SparqlBuilder) => boolean)): number
    emit(signal: 'remove-file', file: Gio.File, children_only: boolean, builder: Tracker.SparqlBuilder): void
    connect(signal: 'writeback-file', callback: ((_source: this, file: Gio.File, rdf_types: string[], results: string[][], cancellable: Gio.Cancellable | null) => boolean)): number
    connect_after(signal: 'writeback-file', callback: ((_source: this, file: Gio.File, rdf_types: string[], results: string[][], cancellable: Gio.Cancellable | null) => boolean)): number
    emit(signal: 'writeback-file', file: Gio.File, rdf_types: string[], results: string[][], cancellable?: (Gio.Cancellable | null)): void
...
interface Enumerator extends GObject.Object {
    ...
    // Own methods of TrackerMiner.Enumerator
    ...
    // Own virtual methods of TrackerMiner.Enumerator

// The widget vocabulary of Wp-0.4 as runtime data.
//
...
export const OWN_PROPS = {
    WpCore: ['g-main-context', 'properties', 'pw-context'],
    WpDbus: ['bus-type'],
...
export const DECLS = {
    ...
    WpCore: ['WpCore', 'GObject'],
    WpDbus: ['WpDbus', 'WpObject', 'GObject'],
    WpDevice: ['WpDevice', 'WpGlobalProxy', 'WpProxy', 'WpObject', 'GObject', 'WpPipewireObject'],
    WpEndpoint: ['WpEndpoint', 'WpGlobalProxy', 'WpProxy', 'WpObject', 'GObject', 'WpPipewireObject'],
    ...
    WpImplEndpoint: ['WpImplEndpoint', 'WpEndpoint', 'WpGlobalProxy', 'WpProxy', 'WpObject', 'GObject', 'WpPipewireObject'],
...
export const ENUM_NICKS = {
    ...
    WpDBusState: ['closed', 'connecting', 'connected'],
    WpDirection: ['input', 'output'],
    WpLibraryErrorEnum: ['invariant', 'invalid-argument', 'operation-failed'],
...
export const ENUM_VALUES = {
    ...
    'WpDBusState.closed': 0,
    'WpDBusState.connected': 2,
    'WpDBusState.connecting': 1,
    'WpDirection.input': 0,
...
export const FLAG_VALUES = {
    ...
    'WpLinkFeatures.established': 65536,
    'WpLookupDirs.env-config': 1,
    'WpLookupDirs.env-data': 2,
    'WpLookupDirs.etc': 2048,
    'WpLookupDirs.prefix-share': 4096,
    'WpLookupDirs.xdg-config-home': 1024,
...
export const PROP_TYPES = {
    ...
    'WpImplEndpoint.item': 'WpSiEndpoint',

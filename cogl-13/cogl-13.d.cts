...
export function set_tracing_enabled_on_thread(main_context: GLib.MainContext, group: string | null): void
/**
...
export function start_tracing_with_fd(fd: number): boolean
export function start_tracing_with_path(filename: string | null): boolean
export function stop_tracing(): void

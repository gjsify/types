...
export function set_tracing_enabled_on_thread(main_context: GLib.MainContext, group: string): void
/**
...
export function start_tracing_with_path(filename: string): boolean

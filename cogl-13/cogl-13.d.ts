...
export namespace Cogl {
    ...
    class ScanoutError extends GLib.Error {
        // Own fields of Cogl-13.ScanoutError

        SCANOUT_ERROR_INHIBITED: number;

        // Constructors of Cogl-13.ScanoutError
    ...
    class Bitmap extends Object {
        // Constructors of Cogl-13.Bitmap

        static new_from_file(filename: string): Bitmap;

        // Owm methods of Cogl-13.Bitmap
         ...
         */
        static get_size_from_file(filename: string): boolean;
    ...
    class Context extends Object {
        // Owm methods of Cogl-13.Context
    ...
    class FrameInfo extends Object {
        // Owm methods of Cogl-13.FrameInfo
    ...
    abstract class Framebuffer extends GObject.Object {
        // Own properties of Cogl-13.Framebuffer
        ...
        // Owm methods of Cogl-13.Framebuffer
         ...
         */
        get_modelview_matrix(): void;
        /**
         * Stores the current projection matrix in `matrix`.
         */
        get_projection_matrix(): void;
        /**
    ...
    class Offscreen extends Framebuffer {
        // Constructors of Cogl-13.Offscreen
    ...
    class Onscreen extends Framebuffer {
        // Owm methods of Cogl-13.Onscreen
    ...
    class Pipeline extends Object {
        // Constructors of Cogl-13.Pipeline

        static ['new'](context: Context): Pipeline;

        // Owm methods of Cogl-13.Pipeline
    ...
    class Texture2D extends Object {
        // Constructors of Cogl-13.Texture2D

        static new_from_bitmap(bitmap: Bitmap): Texture2D;

        // Owm methods of Cogl-13.Texture2D
    ...
    class Texture2DSliced extends Object {
        // Constructors of Cogl-13.Texture2DSliced
     ...
     */
    class Color {
        // Constructors of Cogl-13.Color

        constructor(properties?: Partial<{}>);

        static ['new'](): Color;

        // Owm methods of Cogl-13.Color
         ...
         * @param luminance luminance value, in the 0 .. 1 range
         */
        static init_from_hsl(hue: number, saturation: number, luminance: number): void;
    ...
    class DebugObjectTypeInfo {
        // Own fields of Cogl-13.DebugObjectTypeInfo

        name: string;
        instance_count: number;

        // Constructors of Cogl-13.DebugObjectTypeInfo
    ...
    class OnscreenDirtyInfo {
        // Own fields of Cogl-13.OnscreenDirtyInfo
        ...
        // Constructors of Cogl-13.OnscreenDirtyInfo
    ...
    class Scanout {
        // Owm methods of Cogl-13.Scanout
     ...
     */
    class TextureVertex {
        // Own fields of Cogl-13.TextureVertex
    ...
    class TraceHead {
        // Own fields of Cogl-13.TraceHead

        begin_time: number;
        name: string;
        description: string;

        // Constructors of Cogl-13.TraceHead
     ...
     */
    class UserDataKey {
        // Own fields of Cogl-13.UserDataKey

        unused: number;

        // Constructors of Cogl-13.UserDataKey
    ...
    class _ColorSizeCheck {
        // Own fields of Cogl-13._ColorSizeCheck

        compile_time_assert_CoglColor_size: number[];

        // Constructors of Cogl-13._ColorSizeCheck
    ...
    class _TextureVertexSizeCheck {
        // Own fields of Cogl-13._TextureVertexSizeCheck

        compile_time_assert_CoglTextureVertex_size: number[];

        // Constructors of Cogl-13._TextureVertexSizeCheck
    ...
    interface Texture {
        // Owm methods of Cogl-13.Texture
         ...
         *
         * &lt;note&gt;The region set can't be larger than the source `data&`lt;/note&gt;

/**
 * The GIR-derived widget VOCABULARY for GSound-1.0.
 *
...
export interface GSoundContextProps extends GObjectProps, GInitableProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GSoundContextConstructOnly = GObjectConstructOnly | GInitableConstructOnly;

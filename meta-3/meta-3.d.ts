...
export namespace Meta {
    ...
    class DBusDisplayConfigSkeleton extends Gio.DBusInterfaceSkeleton implements Gio.DBusInterface {
        ...
        /** @signal */
        connect<K extends keyof DBusDisplayConfigSkeleton.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, DBusDisplayConfigSkeleton.SignalSignatures[K]>,
        ): number;
        connect(signal: string, callback: (...args: any[]) => any): number;
        /** @signal */
        connect_after<K extends keyof DBusDisplayConfigSkeleton.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, DBusDisplayConfigSkeleton.SignalSignatures[K]>,
        ): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;
        /** @signal */
        emit<K extends keyof DBusDisplayConfigSkeleton.SignalSignatures>(
            signal: K,
            ...args: GObject.GjsParameters<DBusDisplayConfigSkeleton.SignalSignatures[K]> extends [any, ...infer Q]
                ? Q
                : never
        ): void;
        emit(signal: string, ...args: any[]): void;

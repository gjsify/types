...
export namespace Meta {
    ...
    function prefs_get_ignore_request_hide_titlebar(): boolean;
     ...
     * @param whether 
     */
    function prefs_set_ignore_request_hide_titlebar(whether: boolean): void;
    ...
    enum FrameFlags {
         ...
         */
        ALLOWS_VERTICAL_RESIZE = 32,
        /**
         * frame allows horizontal resize
         */
        ALLOWS_HORIZONTAL_RESIZE = 64,
        /**
         * frame has focus
         */
        HAS_FOCUS = 128,
    ...
    namespace DBusDisplayConfigSkeleton {
        // Signal signatures
    ...
    /**
     * The {@link Meta.DBusDisplayConfigSkeleton} structure contains only private data and should only be accessed using the provided API.
     * @gir-type Class
     */
    class DBusDisplayConfigSkeleton extends Gio.DBusInterfaceSkeleton implements Gio.DBusInterface {
        static $gtype: GObject.GType<DBusDisplayConfigSkeleton>;
         ...
         * @internal
         */
        $signals: DBusDisplayConfigSkeleton.SignalSignatures;

        // Constructors
        constructor(properties?: Partial<DBusDisplayConfigSkeleton.ConstructorProps>, ...args: any[]);

        _init(...args: any[]): void;

        // Signals
        /** @signal */
        connect<K extends keyof DBusDisplayConfigSkeleton.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, DBusDisplayConfigSkeleton.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof DBusDisplayConfigSkeleton.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, DBusDisplayConfigSkeleton.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof DBusDisplayConfigSkeleton.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<DBusDisplayConfigSkeleton.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
    ...
    namespace Display {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
             ...
             * @run-last
             */
            "startup-sequence-changed": (object: null) => void;
            /**
             * @signal
             * @run-last
             */
    ...
    class Display extends GObject.Object {
         ...
         * @param accelerator 
         */
        grab_accelerator(accelerator: string): number;
    ...
    namespace MonitorManager {
        // Signal signatures
        interface SignalSignatures extends DBusDisplayConfigSkeleton.SignalSignatures {
            /**
             * @signal
             * @run-last
             */
        ...
        // Constructor properties interface
        interface ConstructorProps extends DBusDisplayConfigSkeleton.ConstructorProps, Gio.DBusInterface.ConstructorProps {
            backend: Backend;
        }
    }
     ...
     * @gir-type Class
     */
    abstract class MonitorManager extends DBusDisplayConfigSkeleton implements Gio.DBusInterface {
     ...
     * @gir-type Class
     */
    class WindowActor extends Clutter.Actor implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
    ...
    class Shadow {
         ...
         */
        paint(window_x: number, window_y: number, window_width: number, window_height: number, opacity: number, clip: cairo.Region | null, clip_strictly: boolean): void;

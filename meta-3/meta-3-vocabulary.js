// The widget vocabulary of Meta-3 as runtime data.
//
// GENERATED — do not edit. Provenance: Meta-3 — library 3.30.2 — dropped empty base(s): Atk.ImplementorIface — inlined base(s) their owner's vocabulary does not emit: Gio.DBusInterfaceSkeleton
//
...
export const PROVENANCE = {
    ...
    requiredVocabularies: ['@girs/clutter-3/vocabulary', '@girs/gio-2.0/vocabulary', '@girs/gobject-2.0/vocabulary'],
};
...
export const OWN_PROPS = {
    ...
    MetaWindowActor: ['meta-window', 'shadow-class', 'shadow-mode'],
};
...
export const OWN_SIGNALS = {
    ...
    MetaWindowActor: ['effects-completed', 'first-frame'],
...
export const DECLS = {
    ...
    MetaDBusDisplayConfigSkeleton: ['MetaDBusDisplayConfigSkeleton', 'GDBusInterfaceSkeleton', 'GObject', 'GDBusInterface'],
    ...
    MetaWindowActor: ['MetaWindowActor', 'ClutterActor', 'GInitiallyUnowned', 'GObject', 'ClutterAnimatable', 'ClutterContainer', 'ClutterScriptable'],
...
export const ENUM_NICKS = {
    MetaButtonFunction: ['menu', 'minimize', 'maximize', 'close', 'appmenu', 'last'],
...
export const ENUM_VALUES = {
    'MetaButtonFunction.appmenu': 4,
    'MetaButtonFunction.close': 3,
    'MetaButtonFunction.last': 5,
...
export const FLAG_VALUES = {
    ...
    'MetaFrameFlags.above': 32768,
    'MetaFrameFlags.allows-appmenu': 4,
    'MetaFrameFlags.allows-delete': 1,
    'MetaFrameFlags.allows-horizontal-resize': 64,
    'MetaFrameFlags.allows-maximize': 16,
    'MetaFrameFlags.allows-menu': 2,
    'MetaFrameFlags.allows-minimize': 8,
    'MetaFrameFlags.allows-move': 4096,
    'MetaFrameFlags.allows-shade': 2048,
    'MetaFrameFlags.allows-vertical-resize': 32,
    'MetaFrameFlags.fullscreen': 8192,
    'MetaFrameFlags.has-focus': 128,
    'MetaFrameFlags.is-flashing': 16384,
    'MetaFrameFlags.maximized': 1024,
    'MetaFrameFlags.shaded': 256,
    'MetaFrameFlags.stuck': 512,
    'MetaFrameFlags.tiled-left': 65536,
    'MetaFrameFlags.tiled-right': 131072,
...
export const PROP_ENUMS = {
    ...
    'MetaWindowActor.shadow-mode': 'MetaShadowMode',
};
...
export const PROP_TYPES = {
    ...
    'MetaWindowActor.meta-window': 'MetaWindow',
    'MetaWindowActor.shadow-class': 'gchararray',
    'MetaWindowActor.shadow-mode': 'MetaShadowMode',
};

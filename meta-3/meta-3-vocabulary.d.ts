/**
 * The GIR-derived widget VOCABULARY for Meta-3.
 *
 ...
 *
 * 21 instantiable GTypes (of which 0 concrete widgets), 22 declarations (1 inlined from a namespace whose vocabulary does not emit them), 27 enum nick unions, 0 slot candidates.
 *
...
import type Meta from './meta-3.js';
import type { ClutterActorConstructOnly, ClutterActorProps, ClutterAnimatableConstructOnly, ClutterAnimatableProps, ClutterContainerConstructOnly, ClutterContainerProps, ClutterGroupConstructOnly, ClutterGroupProps, ClutterScriptableConstructOnly, ClutterScriptableProps, ClutterStageConstructOnly, ClutterStageProps } from '@girs/clutter-3/vocabulary';
...
export type MetaButtonFunctionNick = 'menu' | 'minimize' | 'maximize' | 'close' | 'appmenu' | 'last';
...
export interface MetaDBusDisplayConfigSkeletonProps extends GDBusInterfaceSkeletonProps, GDBusInterfaceProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MetaDBusDisplayConfigSkeletonConstructOnly = GDBusInterfaceSkeletonConstructOnly | GDBusInterfaceConstructOnly;
...
/** The <structname>MetaShapedTexture</structname> structure contains only private data and should be accessed using the provided API */
...
export interface MetaWindowActorProps extends ClutterActorProps, ClutterAnimatableProps, ClutterContainerProps, ClutterScriptableProps {
    'meta-window'?: Meta.Window;
    'shadow-class'?: string;
    'shadow-mode'?: MetaShadowModeNick | Meta.ShadowMode;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MetaWindowActorConstructOnly = ClutterActorConstructOnly | ClutterAnimatableConstructOnly | ClutterContainerConstructOnly | ClutterScriptableConstructOnly | 'meta-window';

 ...
 * @returns the number of bytes converted
 */
function base64_decode_step(_in: Uint8Array, len: number, out: Uint8Array, state: number, save: number): [number, number, number]
/**
 ...
 */
function base64_encode_close(_in: Uint8Array, break_lines: boolean, out: Uint8Array, state: number, save: number): [number, number, number]
/**
 ...
 * @returns the number of bytes encoded
 */
function base64_encode_step(_in: Uint8Array, len: number, break_lines: boolean, out: Uint8Array, state: number, save: number): [number, number, number]

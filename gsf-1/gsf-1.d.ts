...
export namespace Gsf {
     ...
     * @returns the number of bytes converted
     */
    function base64_decode_step(_in: Uint8Array, len: number, out: Uint8Array, state: number, save: number): number;
    /**
    ...
    class Blob extends GObject.Object {
        // Own fields of Gsf-1.Blob

        object: GObject.Object;

        // Constructors of Gsf-1.Blob

        static ['new'](data_to_copy: Uint8Array): Blob;

        // Owm methods of Gsf-1.Blob
    ...
    class ClipData extends GObject.Object {
        // Own fields of Gsf-1.ClipData

        object: GObject.Object;

        // Constructors of Gsf-1.ClipData

        static ['new'](format: ClipFormat, data_blob: Blob): ClipData;

        // Owm methods of Gsf-1.ClipData
    ...
    class DocMetaData extends GObject.Object {
        // Constructors of Gsf-1.DocMetaData

        static ['new'](): DocMetaData;

        // Owm methods of Gsf-1.DocMetaData
    ...
    class DocPropVector extends GObject.Object {
        // Constructors of Gsf-1.DocPropVector

        static ['new'](): DocPropVector;

        // Owm methods of Gsf-1.DocPropVector
    ...
    class InfileMSOle extends Infile {
        // Constructors of Gsf-1.InfileMSOle

        static ['new'](source: Input): InfileMSOle;

        // Owm methods of Gsf-1.InfileMSOle
    ...
    class InfileMSVBA extends Infile {
        // Constructors of Gsf-1.InfileMSVBA

        static ['new'](source: Infile): InfileMSVBA;

        // Owm methods of Gsf-1.InfileMSVBA
    ...
    class InfileStdio extends Infile {
        // Constructors of Gsf-1.InfileStdio
    ...
    class InfileTar extends Infile {
        // Own properties of Gsf-1.InfileTar

        source: Input;

        // Constructors of Gsf-1.InfileTar
    ...
    class InfileZip extends Infile {
        // Own properties of Gsf-1.InfileZip
        ...
        // Constructors of Gsf-1.InfileZip
    ...
    class InputGZip extends Input {
        // Own properties of Gsf-1.InputGZip
        ...
        // Constructors of Gsf-1.InputGZip
    ...
    class InputGio extends Input {
        // Constructors of Gsf-1.InputGio
    ...
    class InputHTTP extends Input {
        // Own properties of Gsf-1.InputHTTP

        content_type: string;
        contentType: string;
        url: string;

        // Constructors of Gsf-1.InputHTTP

        static ['new'](url: string): InputHTTP;

        // Owm methods of Gsf-1.InputHTTP
    ...
    class InputMemory extends Input {
        // Constructors of Gsf-1.InputMemory
    ...
    class InputProxy extends Input {
        // Constructors of Gsf-1.InputProxy
    ...
    class InputStdio extends Input {
        // Constructors of Gsf-1.InputStdio
    ...
    class InputTextline extends Input {
        // Constructors of Gsf-1.InputTextline

        static ['new'](source: Input): InputTextline;

        // Owm methods of Gsf-1.InputTextline
    ...
    class ODFOut extends XMLOut {
        // Own properties of Gsf-1.ODFOut

        odf_version: number;
        odfVersion: number;

        // Own fields of Gsf-1.ODFOut

        base: XMLOut;
        priv: any;

        // Owm methods of Gsf-1.ODFOut
    ...
    class OutfileMSOle extends Outfile {
        // Own properties of Gsf-1.OutfileMSOle
    ...
    class OutfileOpenPkg extends Outfile {
        // Own properties of Gsf-1.OutfileOpenPkg
        ...
        // Constructors of Gsf-1.OutfileOpenPkg

        static ['new'](sink: Outfile): OutfileOpenPkg;

        // Owm methods of Gsf-1.OutfileOpenPkg
    ...
    class OutfileStdio extends Outfile {
        // Constructors of Gsf-1.OutfileStdio
    ...
    class OutfileZip extends Outfile {
        // Own properties of Gsf-1.OutfileZip
        ...
        // Constructors of Gsf-1.OutfileZip

        static ['new'](sink: Output): OutfileZip;

        // Owm methods of Gsf-1.OutfileZip
    ...
    abstract class Output extends GObject.Object {
        // Own properties of Gsf-1.Output
    ...
    class OutputBzip extends Output {
        // Constructors of Gsf-1.OutputBzip
    ...
    class OutputCsv extends Output {
        // Own properties of Gsf-1.OutputCsv
        ...
        // Owm methods of Gsf-1.OutputCsv
    ...
    class OutputGZip extends Output {
        // Own properties of Gsf-1.OutputGZip
        ...
        // Constructors of Gsf-1.OutputGZip
    ...
    class OutputGio extends Output {
        // Constructors of Gsf-1.OutputGio
    ...
    class OutputIOChannel extends Output {
        // Constructors of Gsf-1.OutputIOChannel
    ...
    class OutputIconv extends Output {
        // Own properties of Gsf-1.OutputIconv
        ...
        // Constructors of Gsf-1.OutputIconv
    ...
    class OutputMemory extends Output {
        // Constructors of Gsf-1.OutputMemory

        static ['new'](): OutputMemory;

        // Owm methods of Gsf-1.OutputMemory
    ...
    class OutputStdio extends Output {
        // Constructors of Gsf-1.OutputStdio
    ...
    class SharedMemory extends GObject.Object {
        // Own fields of Gsf-1.SharedMemory
        ...
        // Constructors of Gsf-1.SharedMemory
    ...
    class StructuredBlob extends Infile {
        // Owm methods of Gsf-1.StructuredBlob
    ...
    class XMLOut extends GObject.Object {
        // Own properties of Gsf-1.XMLOut

        pretty_print: boolean;
        prettyPrint: boolean;
        sink: Output;

        // Own fields of Gsf-1.XMLOut

        base: GObject.Object;
        output: Output;
        priv: any;

        // Constructors of Gsf-1.XMLOut

        static ['new'](output: Output): XMLOut;

        // Owm methods of Gsf-1.XMLOut
     ...
     */
    class DocProp {
        // Constructors of Gsf-1.DocProp

        constructor(name: string);

        static ['new'](name: string): DocProp;

        // Owm methods of Gsf-1.DocProp
    ...
    class MSOleSortingKey {
        // Constructors of Gsf-1.MSOleSortingKey

        constructor(name: string);

        static ['new'](name: string): MSOleSortingKey;

        // Owm methods of Gsf-1.MSOleSortingKey
    ...
    class OpenPkgRel {
        // Owm methods of Gsf-1.OpenPkgRel
    ...
    class OutputCsvClass {}

    class OutputIconvClass {}

    /**
     * A point in time.
     */
    class Timestamp {
        // Own fields of Gsf-1.Timestamp
        ...
        // Constructors of Gsf-1.Timestamp
        ...
        // Owm methods of Gsf-1.Timestamp
    ...
    class XMLIn {
        // Own fields of Gsf-1.XMLIn

        user_state: any;
        content: GLib.String;

        // Owm methods of Gsf-1.XMLIn
    ...
    class XMLInNS {
        // Own fields of Gsf-1.XMLInNS

        uri: string;
        ns_id: number;

        // Constructors of Gsf-1.XMLInNS

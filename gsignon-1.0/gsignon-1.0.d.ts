...
export namespace gSignon {
    ...
    class Error extends GLib.Error {
        // Own fields of gSignon-1.0.Error
        ...
        // Constructors of gSignon-1.0.Error

        constructor(options: { message: string; code: number });

        // Owm methods of gSignon-1.0.Error
    ...
    class AuthService extends GObject.Object {
        // Constructors of gSignon-1.0.AuthService

        static ['new'](): AuthService;

        // Owm methods of gSignon-1.0.AuthService
    ...
    class AuthSession extends GObject.Object {
        // Own properties of gSignon-1.0.AuthSession

        identity: Identity;

        // Constructors of gSignon-1.0.AuthSession
        ...
        // Owm methods of gSignon-1.0.AuthSession
    ...
    class Identity extends GObject.Object {
        // Own properties of gSignon-1.0.Identity

        app_ctx: string;
        appCtx: string;
        id: number;

        // Constructors of gSignon-1.0.Identity
        ...
        // Owm methods of gSignon-1.0.Identity
     ...
     */
    class IdentityInfo {
        // Constructors of gSignon-1.0.IdentityInfo

        constructor(properties?: Partial<{}>);

        static ['new'](): IdentityInfo;

        // Owm methods of gSignon-1.0.IdentityInfo
    ...
    class SecurityContext {
        // Own fields of gSignon-1.0.SecurityContext

        sys_ctx: string;
        app_ctx: string;

        // Constructors of gSignon-1.0.SecurityContext
        ...
        // Owm methods of gSignon-1.0.SecurityContext

...
static ["new"](): AuthService;
     ...
     * @param cb callback to be invoked.
     */
    query_identities(filter: GLib.HashTable<string, GLib.Variant>, application_context: string, cb: QueryIdentitiesCb): void
    /**
...
static new_for_identity(identity: Identity, method_name: string): AuthSession;
    ...
    connect_after(signal: 'state-changed', callback: ((_source: this, state: number, message: string) => void)): number

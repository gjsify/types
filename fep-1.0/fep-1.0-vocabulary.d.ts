/**
 * The GIR-derived widget VOCABULARY for Fep-1.0.
 *
 * GENERATED — do not edit. Provenance: Fep-1.0
 *
 * 1 instantiable GTypes (of which 0 concrete widgets), 1 declarations, 3 enum nick unions, 0 slot candidates.
 *
...
export type FepGAttrTypeNick = 'underline' | 'foreground' | 'background' | 'none' | 'standout' | 'bold' | 'blink';
export type FepGAttrUnderlineNick = 'none' | 'single' | 'double' | 'low' | 'error';
export type FepGEventTypeNick = 'nothing' | 'key-press' | 'resized';
...
export interface FepGClientProps extends GObjectProps, GInitableProps {
    /** @default NULL */
    address?: string;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type FepGClientConstructOnly = GObjectConstructOnly | GInitableConstructOnly | 'address';

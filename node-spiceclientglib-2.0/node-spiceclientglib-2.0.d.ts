 ...
 */
function portWriteAsync(port: PortChannel, buffer: number[], cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void
/**
 ...
 */
function recordSendData(channel: RecordChannel, data: any | null, bytes: number, time: number): void
/**
 ...
 */
function uuidToString(uuid: number): string | null

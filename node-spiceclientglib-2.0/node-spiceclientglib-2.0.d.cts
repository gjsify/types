...
import './node-spiceclientglib-2.0-import.d.ts';
 ...
 */
export function portWriteAsync(port: PortChannel, buffer: number[], cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void
/**
...
export interface PortChannel {
     ...
     * @param callback callback to call when the request is satisfied
     */
    writeAsync(buffer: number[], cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void
    /**
     * Finishes a port write operation.
     * @param result a #GAsyncResult
     * @returns a #gssize containing the number of bytes written to the stream.

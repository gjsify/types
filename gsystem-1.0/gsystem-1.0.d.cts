 ...
 */
export function dfd_and_name_get_all_xattrs(dfd: number, name: string | null, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* out_xattrs */ GLib.Variant ]
export function dfd_and_name_set_all_xattrs(dfd: number, name: string | null, xattrs: GLib.Variant, cancellable: Gio.Cancellable | null): boolean
export function dirfd_iterator_clear(dfd_iter: DirFdIterator): void
export function dirfd_iterator_init_at(dfd: number, path: string | null, follow: boolean, dfd_iter: DirFdIterator): boolean
 ...
 * @param cancellable a #GCancellable
 */
export function file_create(file: Gio.File, mode: number, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* out_stream */ Gio.OutputStream ]
/**
 ...
 * @param cancellable a #GCancellable
 */
export function file_enumerator_iterate(direnum: Gio.FileEnumerator, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* out_info */ Gio.FileInfo, /* out_child */ Gio.File ]
/**
 ...
 * @param file 
 */
export function file_get_basename_cached(file: Gio.File): string | null
/**
 * Like g_file_get_path(), but returns a constant copy so callers
 * don't need to free the result.
 * @param file 
 */
export function file_get_path_cached(file: Gio.File): string | null
/**
 ...
 */
export function file_get_relpath(one: Gio.File, two: Gio.File): string | null
/**
 ...
 * @param cancellable 
 */
export function file_load_contents_utf8(file: Gio.File, cancellable: Gio.Cancellable | null): string | null
/**
 ...
 * @param cancellable Cancellable
 */
export function file_open_dir_fd_at(parent_dfd: number, name: string | null, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* out_fd */ number ]
/**
 ...
 * @param cancellable 
 */
export function file_open_in_tmpdir(tmpdir: Gio.File, mode: number, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* out_file */ Gio.File, /* out_stream */ Gio.OutputStream ]
/**
 * Like g_file_open_tmp(), except the file will be created in the
 * provided `tmpdir,` and allows specification of the Unix `mode,` which
 * means private files may be created.  Return values will be stored
 ...
 * @param cancellable 
 */
export function file_open_in_tmpdir_at(tmpdir_fd: number, mode: number, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* out_name */ string | null, /* out_stream */ Gio.OutputStream ]
/**
 ...
 * @param cancellable Cancellable
 */
export function file_openat_noatime(dfd: number, name: string | null, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* ret_fd */ number ]
/**
 ...
 */
export function fileutil_gen_tmp_name(prefix: string | null, suffix: string | null): string | null
/**
 ...
 */
export function log_structured(message: string | null, keys: string[] | null): void
/**
 ...
 * @param keys Optional structured data
 */
export function log_structured_print(message: string | null, keys: string[] | null): void
/**
 ...
 * @param out_fd 
 */
export function opendirat(dfd: number, path: string | null, follow: boolean, out_fd: number): boolean
/**
 * Use openat() to open a directory, using a standard set of flags.
 ...
 * @param follow Whether or not to follow symbolic links
 */
export function opendirat_with_errno(dfd: number, path: string | null, follow: boolean): number
/**
 ...
 * @param cancellable Cancellable
 */
export function shutil_rm_rf_at(dfd: number, path: string | null, cancellable: Gio.Cancellable | null): boolean
/**

...
export namespace GSystem {
     ...
     */
    function dfd_and_name_get_all_xattrs(dfd: number, name: string, cancellable?: Gio.Cancellable | null): boolean;
     ...
     * @param cancellable Cancellable
     */
    function fd_get_all_xattrs(fd: number, cancellable?: Gio.Cancellable | null): boolean;
    /**
     ...
     * @param cancellable a #GCancellable
     */
    function file_create(file: Gio.File, mode: number, cancellable?: Gio.Cancellable | null): boolean;
    /**
     ...
     * @param cancellable a #GCancellable
     */
    function file_enumerator_iterate(direnum: Gio.FileEnumerator, cancellable?: Gio.Cancellable | null): boolean;
    /**
     ...
     * @param cancellable Cancellable
     */
    function file_get_all_xattrs(f: Gio.File, cancellable?: Gio.Cancellable | null): boolean;
    /**
     ...
     * @param cancellable Cancellable
     */
    function file_open_dir_fd(path: Gio.File, cancellable?: Gio.Cancellable | null): boolean;
    /**
     * On success, sets `out_fd` to a file descriptor for the directory
     * that can be used with UNIX functions such as openat().
     ...
     * @param cancellable Cancellable
     */
    function file_open_dir_fd_at(parent_dfd: number, name: string, cancellable?: Gio.Cancellable | null): boolean;
    /**
     ...
     * @param cancellable
     */
    function file_open_in_tmpdir(tmpdir: Gio.File, mode: number, cancellable?: Gio.Cancellable | null): boolean;
    /**
     * Like g_file_open_tmp(), except the file will be created in the
     * provided `tmpdir,` and allows specification of the Unix `mode,` which
     * means private files may be created.  Return values will be stored
     ...
     * @param cancellable
     */
    function file_open_in_tmpdir_at(tmpdir_fd: number, mode: number, cancellable?: Gio.Cancellable | null): boolean;
    /**
     ...
     * @param cancellable Cancellable
     */
    function file_openat_noatime(dfd: number, name: string, cancellable?: Gio.Cancellable | null): boolean;
    /**
    ...
    class Console extends GObject.Object {
        // Owm methods of GSystem-1.0.Console
    ...
    class Subprocess extends GObject.Object {
        // Own properties of GSystem-1.0.Subprocess

        context: SubprocessContext;

        // Constructors of GSystem-1.0.Subprocess
        ...
        // Owm methods of GSystem-1.0.Subprocess
         ...
         */
        wait_sync(cancellable?: Gio.Cancellable | null): boolean;
        /**
    ...
    class SubprocessContext extends GObject.Object {
        // Own properties of GSystem-1.0.SubprocessContext
    ...
    class DirFdIterator {
        // Own fields of GSystem-1.0.DirFdIterator

        initialized: boolean;
        fd: number;
        padding_data: any[];

        // Constructors of GSystem-1.0.DirFdIterator

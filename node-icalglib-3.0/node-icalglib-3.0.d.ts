...
import './node-icalglib-3.0-import.d.ts';
 ...
 */
function errorStrerror(e: ErrorEnum): string | null
/**
 * Suppresses the error.
 * @param error The error to be suppressed
 * @returns The error state suppressed
 */
function errorSupress(error: string | null): ErrorState
/**
 ...
 */
function memoryAddTmpBuffer(buf: any | null): void
/**
 ...
 */
function memoryAppendString(buf: number[], pos: number[], str: string | null): [ /* buf */ number[], /* pos */ number[] ]
/**
 * Frees the buffer.
 * @param buf The buffer to be freed
 */
function memoryFreeBuffer(buf: any | null): void
/**
 ...
 */
function memoryNewBuffer(size: number): any | null
/**
 ...
 */
function memoryResizeBuffer(buf: any | null, size: number): any | null
/**
 ...
 */
function memoryStrdup(s: string | null): string | null
/**
 * Creates a buffer with target size.
 * @param size The size of the buffer to be created
 * @returns The newly created buffer
 */
function memoryTmpBuffer(size: number): any | null
/**
 * Like strdup, but the buffer is on the ring.
 * @param str The string to be copied
 * @returns The new copy of the @str.
 */
function memoryTmpCopy(str: string | null): string | null
/**
 ...
 */
function recurExpandRecurrence(rule: string | null, start: number, count: number): number[]
/**
 * Returns the code for a request status.
 * @param stat The #ICalRequestStatus to be queried
 * @returns The code for a request status
 */
function requestStatusCode(stat: RequestStatus): string | null
/**
 ...
 */
function requestStatusDesc(stat: RequestStatus): string | null
/**

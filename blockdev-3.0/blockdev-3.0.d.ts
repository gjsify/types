...
import './blockdev-3.0-ambient.d.ts';
import './blockdev-3.0-import.d.ts';
/**
 * BlockDev-3.0
 */
...
export namespace BlockDev {
    class BtrfsError extends GLib.Error {
        // Own fields of BlockDev-3.0.BtrfsError

        TECH_UNAVAIL: number;
        DEVICE: number;
        PARSE: number;

        // Constructors of BlockDev-3.0.BtrfsError
    ...
    class CryptoError extends GLib.Error {
        // Own fields of BlockDev-3.0.CryptoError

        TECH_UNAVAIL: number;
        DEVICE: number;
        STATE: number;
        INVALID_SPEC: number;
        FORMAT_FAILED: number;
        ...
        NO_KEY: number;
        KEY_SLOT: number;
        NSS_INIT_FAILED: number;
        CERT_DECODE: number;
        ESCROW_FAILED: number;
        INVALID_PARAMS: number;
        KEYRING: number;
        KEYFILE_FAILED: number;
        INVALID_CONTEXT: number;

        // Constructors of BlockDev-3.0.CryptoError
    ...
    class DMError extends GLib.Error {
        // Own fields of BlockDev-3.0.DMError
        ...
        RAID_FAIL: number;
        RAID_NO_DEVS: number;
        RAID_NO_EXIST: number;

        // Constructors of BlockDev-3.0.DMError
    ...
    class FSError extends GLib.Error {
        // Own fields of BlockDev-3.0.FSError
        ...
        NOT_MOUNTED: number;
        AUTH: number;
        LABEL_INVALID: number;
        UUID_INVALID: number;
        UNKNOWN_FS: number;

        // Constructors of BlockDev-3.0.FSError
    ...
    class InitError extends GLib.Error {
        // Own fields of BlockDev-3.0.InitError

        FAILED: number;
        PLUGINS_FAILED: number;
        NOT_IMPLEMENTED: number;

        // Constructors of BlockDev-3.0.InitError
    ...
    class LVMError extends GLib.Error {
        // Own fields of BlockDev-3.0.LVMError
        ...
        NOT_ROOT: number;
        CACHE_INVAL: number;
        CACHE_NOCACHE: number;
        NOT_SUPPORTED: number;
        VDO_POLICY_INVAL: number;
        DEVICES_DISABLED: number;

        // Constructors of BlockDev-3.0.LVMError
    ...
    class LoopError extends GLib.Error {
        // Own fields of BlockDev-3.0.LoopError

        TECH_UNAVAIL: number;
        FAIL: number;
        DEVICE: number;

        // Constructors of BlockDev-3.0.LoopError
    ...
    class MDError extends GLib.Error {
        // Own fields of BlockDev-3.0.MDError
        ...
        // Constructors of BlockDev-3.0.MDError
    ...
    class MpathError extends GLib.Error {
        // Own fields of BlockDev-3.0.MpathError
        ...
        // Constructors of BlockDev-3.0.MpathError
    ...
    class NVDIMMError extends GLib.Error {
        // Own fields of BlockDev-3.0.NVDIMMError

        TECH_UNAVAIL: number;
        NAMESPACE_FAIL: number;
        NAMESPACE_PARSE: number;
        NAMESPACE_NOEXIST: number;
        NAMESPACE_MODE_INVAL: number;

        // Constructors of BlockDev-3.0.NVDIMMError
    ...
    class NVMEError extends GLib.Error {
        // Own fields of BlockDev-3.0.NVMEError

        TECH_UNAVAIL: number;
        FAILED: number;
        BUSY: number;
        INVALID_ARGUMENT: number;
        WOULD_FORMAT_ALL_NS: number;
        SC_GENERIC: number;
        SC_CMD_SPECIFIC: number;
        SC_MEDIA: number;
        SC_PATH: number;
        SC_VENDOR_SPECIFIC: number;
        NO_MATCH: number;
        CONNECT: number;
        CONNECT_ALREADY: number;
        CONNECT_INVALID: number;
        CONNECT_ADDRINUSE: number;
        CONNECT_NODEV: number;
        CONNECT_OPNOTSUPP: number;
        CONNECT_REFUSED: number;

        // Constructors of BlockDev-3.0.NVMEError
    ...
    class PartError extends GLib.Error {
        // Own fields of BlockDev-3.0.PartError
        ...
        // Constructors of BlockDev-3.0.PartError
    ...
    class SwapError extends GLib.Error {
        // Own fields of BlockDev-3.0.SwapError

        TECH_UNAVAIL: number;
        UNKNOWN_STATE: number;
        ACTIVATE: number;
        ACTIVATE_OLD: number;
        ACTIVATE_SUSPEND: number;
        ACTIVATE_UNKNOWN: number;
        ACTIVATE_PAGESIZE: number;

        // Constructors of BlockDev-3.0.SwapError
    ...
    class UtilsDBusError extends GLib.Error {
        // Own fields of BlockDev-3.0.UtilsDBusError

        FAIL: number;
        NOEXIST: number;

        // Constructors of BlockDev-3.0.UtilsDBusError

        constructor(options: { message: string; code: number });
    }

    class UtilsDevUtilsError extends GLib.Error {
        // Own fields of BlockDev-3.0.UtilsDevUtilsError

        UTILS_DEV_UTILS_ERROR_FAILED: number;

        // Constructors of BlockDev-3.0.UtilsDevUtilsError

        constructor(options: { message: string; code: number });
    }

    class UtilsExecError extends GLib.Error {
        // Own fields of BlockDev-3.0.UtilsExecError

        FAILED: number;
        NOOUT: number;
        INVAL_VER: number;
        UTIL_UNAVAILABLE: number;
        UTIL_UNKNOWN_VER: number;
        UTIL_LOW_VER: number;
        UTIL_CHECK_ERROR: number;
        UTIL_FEATURE_CHECK_ERROR: number;
        UTIL_FEATURE_UNAVAILABLE: number;

        // Constructors of BlockDev-3.0.UtilsExecError

        constructor(options: { message: string; code: number });
    }

    class UtilsModuleError extends GLib.Error {
        // Own fields of BlockDev-3.0.UtilsModuleError

        KMOD_INIT_FAIL: number;
        FAIL: number;
        NOEXIST: number;
        MODULE_CHECK_ERROR: number;
        INVALID_PLATFORM: number;

        // Constructors of BlockDev-3.0.UtilsModuleError
     ...
     */
    function fs_can_check(type: string): boolean;
    /**
     ...
     */
    function fs_can_get_free_space(type: string): boolean;
    /**
     ...
     */
    function fs_can_get_size(type: string): boolean;
    /**
     ...
     */
    function fs_can_mkfs(type: string): boolean;
    /**
     ...
     */
    function fs_can_repair(type: string): boolean;
    /**
     ...
     */
    function fs_can_resize(type: string): boolean;
    /**
     ...
     */
    function fs_can_set_label(type: string): boolean;
    /**
     ...
     */
    function fs_can_set_uuid(type: string): boolean;
    /**
    ...
    function try_init(request_plugins?: PluginSpec[] | null, log_func?: UtilsLogFunc | null): boolean;
    function try_reinit(require_plugins: PluginSpec[] | null, reload: boolean, log_func?: UtilsLogFunc | null): boolean;
    /**
     ...
     */
    function utils_exec_and_capture_output(argv: string[], extra: ExtraArg[] | null): boolean;
    ...
    function utils_exec_and_report_status_error(argv: string[], extra: ExtraArg[] | null): boolean;
    ...
    class BtrfsDeviceInfo {
        // Own fields of BlockDev-3.0.BtrfsDeviceInfo
        ...
        // Constructors of BlockDev-3.0.BtrfsDeviceInfo
    ...
    class BtrfsFilesystemInfo {
        // Own fields of BlockDev-3.0.BtrfsFilesystemInfo
        ...
        // Constructors of BlockDev-3.0.BtrfsFilesystemInfo
    ...
    class BtrfsSubvolumeInfo {
        // Own fields of BlockDev-3.0.BtrfsSubvolumeInfo

        id: number;
        parent_id: number;
        path: string;

        // Constructors of BlockDev-3.0.BtrfsSubvolumeInfo
    ...
    class CryptoBITLKInfo {
        // Own fields of BlockDev-3.0.CryptoBITLKInfo
        ...
        // Constructors of BlockDev-3.0.CryptoBITLKInfo
    ...
    class CryptoIntegrityExtra {
        // Own fields of BlockDev-3.0.CryptoIntegrityExtra
        ...
        // Constructors of BlockDev-3.0.CryptoIntegrityExtra
    ...
    class CryptoIntegrityInfo {
        // Own fields of BlockDev-3.0.CryptoIntegrityInfo
        ...
        // Constructors of BlockDev-3.0.CryptoIntegrityInfo
    ...
    class CryptoKeyslotContext {
        // Own fields of BlockDev-3.0.CryptoKeyslotContext

        type: CryptoKeyslotContextType;

        // Constructors of BlockDev-3.0.CryptoKeyslotContext
    ...
    class CryptoLUKSExtra {
        // Own fields of BlockDev-3.0.CryptoLUKSExtra
        ...
        // Constructors of BlockDev-3.0.CryptoLUKSExtra
    ...
    class CryptoLUKSInfo {
        // Own fields of BlockDev-3.0.CryptoLUKSInfo
    ...
    class CryptoLUKSPBKDF {
        // Own fields of BlockDev-3.0.CryptoLUKSPBKDF
        ...
        // Constructors of BlockDev-3.0.CryptoLUKSPBKDF
    ...
    class CryptoLUKSTokenInfo {
        // Own fields of BlockDev-3.0.CryptoLUKSTokenInfo

        id: number;
        type: string;
        keyslot: number;

        // Constructors of BlockDev-3.0.CryptoLUKSTokenInfo
     ...
     */
    class ExtraArg {
        // Own fields of BlockDev-3.0.ExtraArg

        opt: string;
        val: string;

        // Constructors of BlockDev-3.0.ExtraArg
        ...
        // Owm methods of BlockDev-3.0.ExtraArg
    ...
    class FSBtrfsInfo {
        // Own fields of BlockDev-3.0.FSBtrfsInfo
        ...
        // Constructors of BlockDev-3.0.FSBtrfsInfo
    ...
    class FSExfatInfo {
        // Own fields of BlockDev-3.0.FSExfatInfo
        ...
        // Constructors of BlockDev-3.0.FSExfatInfo
    ...
    class FSExt2Info {
        // Own fields of BlockDev-3.0.FSExt2Info
        ...
        // Constructors of BlockDev-3.0.FSExt2Info
    ...
    class FSExt3Info {
        // Own fields of BlockDev-3.0.FSExt3Info
        ...
        // Constructors of BlockDev-3.0.FSExt3Info
    ...
    class FSExt4Info {
        // Own fields of BlockDev-3.0.FSExt4Info
        ...
        // Constructors of BlockDev-3.0.FSExt4Info
    ...
    class FSExtInfo {
        // Own fields of BlockDev-3.0.FSExtInfo
        ...
        // Constructors of BlockDev-3.0.FSExtInfo
    ...
    class FSF2FSInfo {
        // Own fields of BlockDev-3.0.FSF2FSInfo
        ...
        // Constructors of BlockDev-3.0.FSF2FSInfo
    ...
    class FSFeatures {
        // Own fields of BlockDev-3.0.FSFeatures
    ...
    class FSMkfsOptions {
        // Own fields of BlockDev-3.0.FSMkfsOptions
        ...
        // Constructors of BlockDev-3.0.FSMkfsOptions
    ...
    class FSNILFS2Info {
        // Own fields of BlockDev-3.0.FSNILFS2Info
        ...
        // Constructors of BlockDev-3.0.FSNILFS2Info
    ...
    class FSNtfsInfo {
        // Own fields of BlockDev-3.0.FSNtfsInfo
        ...
        // Constructors of BlockDev-3.0.FSNtfsInfo
    ...
    class FSUdfInfo {
        // Own fields of BlockDev-3.0.FSUdfInfo
        ...
        // Constructors of BlockDev-3.0.FSUdfInfo
    ...
    class FSVfatInfo {
        // Own fields of BlockDev-3.0.FSVfatInfo
        ...
        // Constructors of BlockDev-3.0.FSVfatInfo
    ...
    class FSXfsInfo {
        // Own fields of BlockDev-3.0.FSXfsInfo
        ...
        // Constructors of BlockDev-3.0.FSXfsInfo
    ...
    class LVMCacheStats {
        // Own fields of BlockDev-3.0.LVMCacheStats
     ...
     */
    class LVMLVdata {
        // Own fields of BlockDev-3.0.LVMLVdata
        ...
        // Constructors of BlockDev-3.0.LVMLVdata
    ...
    class LVMPVdata {
        // Own fields of BlockDev-3.0.LVMPVdata
        ...
        // Constructors of BlockDev-3.0.LVMPVdata
    ...
    class LVMSEGdata {
        // Own fields of BlockDev-3.0.LVMSEGdata

        size_pe: number;
        pv_start_pe: number;
        pvdev: string;

        // Constructors of BlockDev-3.0.LVMSEGdata
    ...
    class LVMVDOPooldata {
        // Own fields of BlockDev-3.0.LVMVDOPooldata
    ...
    class LVMVDOStats {
        // Own fields of BlockDev-3.0.LVMVDOStats
        ...
        // Constructors of BlockDev-3.0.LVMVDOStats
    ...
    class LVMVGdata {
        // Own fields of BlockDev-3.0.LVMVGdata
        ...
        // Constructors of BlockDev-3.0.LVMVGdata
    ...
    class LoopInfo {
        // Own fields of BlockDev-3.0.LoopInfo
        ...
        // Constructors of BlockDev-3.0.LoopInfo
    ...
    class MDDetailData {
        // Own fields of BlockDev-3.0.MDDetailData
        ...
        // Constructors of BlockDev-3.0.MDDetailData
    ...
    class MDExamineData {
        // Own fields of BlockDev-3.0.MDExamineData
        ...
        // Constructors of BlockDev-3.0.MDExamineData
    ...
    class NVDIMMNamespaceInfo {
        // Own fields of BlockDev-3.0.NVDIMMNamespaceInfo
        ...
        // Constructors of BlockDev-3.0.NVDIMMNamespaceInfo
    ...
    class NVMEControllerInfo {
        // Own fields of BlockDev-3.0.NVMEControllerInfo
    ...
    class NVMEErrorLogEntry {
        // Own fields of BlockDev-3.0.NVMEErrorLogEntry
     ...
     */
    class NVMELBAFormat {
        // Own fields of BlockDev-3.0.NVMELBAFormat
    ...
    class NVMENamespaceInfo {
        // Own fields of BlockDev-3.0.NVMENamespaceInfo
    ...
    class NVMESanitizeLog {
        // Own fields of BlockDev-3.0.NVMESanitizeLog
    ...
    class NVMESelfTestLog {
        // Own fields of BlockDev-3.0.NVMESelfTestLog
    ...
    class NVMESelfTestLogEntry {
        // Own fields of BlockDev-3.0.NVMESelfTestLogEntry
    ...
    class NVMESmartLog {
        // Own fields of BlockDev-3.0.NVMESmartLog
        ...
        // Constructors of BlockDev-3.0.NVMESmartLog
    ...
    class PartDiskSpec {
        // Own fields of BlockDev-3.0.PartDiskSpec
        ...
        // Owm methods of BlockDev-3.0.PartDiskSpec
    ...
    class PartSpec {
        // Own fields of BlockDev-3.0.PartSpec
        ...
        // Constructors of BlockDev-3.0.PartSpec
        ...
        // Owm methods of BlockDev-3.0.PartSpec
    ...
    class PluginSpec {
        // Own fields of BlockDev-3.0.PluginSpec
    ...
    class UtilsLinuxVersion {
        // Own fields of BlockDev-3.0.UtilsLinuxVersion

        major: number;
        minor: number;
        micro: number;

        // Constructors of BlockDev-3.0.UtilsLinuxVersion

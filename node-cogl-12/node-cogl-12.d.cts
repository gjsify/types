...
import './node-cogl-12-import.d.ts';
...
export function handleGetType(): GObject.GType
/**
 ...
 */
export function isFrameInfo(object: any | null): boolean
/**
 ...
 */
export function isPipeline(object: any | null): boolean
/**
 ...
 */
export function isSnippet(object: any | null): boolean
/**
 * Gets whether the given object references a texture object.
 * @param object A #CoglObject pointer
 * @returns %TRUE if the @object references a texture, and   %FALSE otherwise
 */
export function isTexture(object: any | null): boolean
/**
 ...
 */
export function isTexture2d(object: any | null): boolean
/**
 ...
 */
export function isTexture2dSliced(object: any | null): boolean
/**
 ...
 */
export function pixelFormatToString(format: PixelFormat): string | null
/**
 ...
 * @param programHandle a #CoglHandle for a shdaer program.
 * @param shaderHandle a #CoglHandle for a vertex of fragment shader.
 */
 ...
 */
export function programGetUniformLocation(handle: Handle, uniformName: string | null): number
/**
 ...
 * @param uniformLocation the uniform location retrieved from    cogl_program_get_uniform_location().
...
export function setTracingDisabledOnThread(mainContext: GLib.MainContext): void
export function setTracingEnabledOnThread(mainContext: GLib.MainContext, group: string | null, filename: string | null): void
export function setTracingEnabledOnThreadWithFd(mainContext: GLib.MainContext, group: string | null, fd: number): void
/**
 ...
 */
export function shaderSource(shader: Handle, source: string | null): void
export function textureErrorQuark(): number
export function traceDescribe(head: TraceHead, description: string | null): void
export function traceEnd(head: TraceHead): void
/**
...
export interface Texture extends Object {
     ...
     */
    getData(format: PixelFormat, rowstride: number, data: Uint8Array | null): number
     ...
     */
    setData(format: PixelFormat, rowstride: number, data: Uint8Array, level: number): boolean
     ...
     */
    setRegion(srcX: number, srcY: number, dstX: number, dstY: number, dstWidth: number, dstHeight: number, width: number, height: number, format: PixelFormat, rowstride: number, data: Uint8Array): boolean
    /**
...
export interface Onscreen {
     ...
     */
    hide(): void
    // Has conflict: queueDamageRegion(rectangles: number, nRectangles: number): void
    /**
    ...
    // Has conflict: swapBuffersWithDamage(rectangles: number, nRectangles: number, info: FrameInfo, userData: any | null): void
    // Has conflict: swapRegion(rectangles: number, nRectangles: number, info: FrameInfo, userData: any | null): void
     ...
     */
    queueDamageRegion(rectangles: number, nRectangles: number): void
    /**
     ...
     * @param info 
     */
    swapBuffersWithDamage(rectangles: number, nRectangles: number, info: FrameInfo): void
    /**
     ...
     * @param info 
     */
    swapRegion(rectangles: number, nRectangles: number, info: FrameInfo): void
...
export interface Pipeline {
     ...
     * @param minFilter Return location for the filter used when scaling a texture down.
     * @param magFilter Return location for the filter used when magnifying a texture.
     */
    getLayerFilters(layerIndex: number, minFilter: PipelineFilter, magFilter: PipelineFilter): void
    /**
...
export module Texture2D {
    ...
    export interface ConstructorProperties extends Texture.ConstructorProperties, Object.ConstructorProperties {
    }
...
export interface Texture2D extends Texture {
    ...
    eglImageExternalAllocFinish(userData: any | null, destroy: GLib.DestroyNotify): void
...
export class Texture2D extends Object {
...
export interface Texture2DSliced extends Texture {
...
export class Texture2DSliced extends Object {
...
export interface DebugObjectTypeInfo {
...
export interface OnscreenClass {
    ...
    queueDamageRegion: (onscreen: Onscreen, rectangles: number, nRectangles: number) => void
...
export interface _ColorSizeCheck {
...
export interface _TextureVertexSizeCheck {

// The widget vocabulary of Cogl-18 as runtime data.
//
// GENERATED — do not edit. Provenance: Cogl-18 — prop(s) no TypeScript value satisfies: Cogl.Framebuffer.driver-config Cogl.Texture.loader
//
...
export const ENUM_NICKS = {
    ...
    CoglWinsysFeature: ['swap-region', 'buffer-age', 'sync-and-complete-event', 'sync-fd', 'n-features'],
};
...
export const ENUM_VALUES = {
    ...
    'CoglWinsysFeature.n-features': 4,
    'CoglWinsysFeature.swap-region': 0,
    'CoglWinsysFeature.sync-and-complete-event': 2,
    'CoglWinsysFeature.sync-fd': 3,
};

...
export namespace Cogl {
    ...
    abstract class Winsys extends GObject.Object {
        ...
        /** @signal */
        emit<K extends keyof Winsys.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<Winsys.SignalSignatures[K]>): void;
    ...
    abstract class WinsysEGL extends Winsys {
        ...
        /** @signal */
        emit<K extends keyof WinsysEGL.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<WinsysEGL.SignalSignatures[K]>): void;

...
export namespace Cogl {
    ...
    class Renderer extends GObject.Object {
         ...
         * @param winsys 
         */
        set_winsys_data(winsys: null): void;
    }
    ...
    abstract class Winsys extends GObject.Object {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof Winsys.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, Winsys.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof Winsys.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, Winsys.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof Winsys.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<Winsys.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
    ...
    abstract class WinsysEGL extends Winsys {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof WinsysEGL.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, WinsysEGL.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof WinsysEGL.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, WinsysEGL.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof WinsysEGL.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<WinsysEGL.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;

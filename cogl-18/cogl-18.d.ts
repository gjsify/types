...
export namespace Cogl {
    ...
    abstract class Driver extends GObject.Object {
        ...
        /** @signal */
        connect<K extends keyof Driver.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, Driver.SignalSignatures[K]>,
        ): number;
        connect(signal: string, callback: (...args: any[]) => any): number;
        /** @signal */
        connect_after<K extends keyof Driver.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, Driver.SignalSignatures[K]>,
        ): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;
        /** @signal */
        emit<K extends keyof Driver.SignalSignatures>(
            signal: K,
            ...args: GObject.GjsParameters<Driver.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never
        ): void;
        emit(signal: string, ...args: any[]): void;
         ...
         * @param format
         */
        format_supports_upload(format: PixelFormat | null): boolean;
        /**
         ...
         * @param value
         */
        set_feature(feature: FeatureID | null, value: boolean): void;
    }
    ...
    class Offscreen extends Framebuffer {
        ...
        static new_from_formats(
            context: Context,
            formats: PixelFormat,
            n_formats: bigint | number,
            width: number,
            height: number,
        ): Offscreen;
    ...
    class OnscreenEgl extends Onscreen {
        ...
        /** @signal */
        connect<K extends keyof OnscreenEgl.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, OnscreenEgl.SignalSignatures[K]>,
        ): number;
        connect(signal: string, callback: (...args: any[]) => any): number;
        /** @signal */
        connect_after<K extends keyof OnscreenEgl.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, OnscreenEgl.SignalSignatures[K]>,
        ): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;
        /** @signal */
        emit<K extends keyof OnscreenEgl.SignalSignatures>(
            signal: K,
            ...args: GObject.GjsParameters<OnscreenEgl.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never
        ): void;
        emit(signal: string, ...args: any[]): void;
    }
    ...
    class Renderer extends GObject.Object {
        ...
        /**
         * Queries the associated {@link Cogl.Winsys}.
         * @returns The associated {@link Cogl.Winsys}
         */
        get_winsys(): Winsys;
        get_winsys_data(): any | null;
        /**
         ...
         * @param winsys
         */
        set_custom_winsys(winsys: Winsys): void;
        /**
         ...
         * @param winsys
         */
        set_winsys_data(winsys?: any | null): void;
    }
     ...
     * @gir-type Class
     */
    abstract class Winsys extends GObject.Object {
        static $gtype: GObject.GType<Winsys>;
         ...
         * @internal
         */
        $signals: Winsys.SignalSignatures;

        // Constructors

        constructor(properties?: Partial<Winsys.ConstructorProps>, ...args: any[]);
        ...
        /** @signal */
        connect<K extends keyof Winsys.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, Winsys.SignalSignatures[K]>,
        ): number;
        connect(signal: string, callback: (...args: any[]) => any): number;
        /** @signal */
        connect_after<K extends keyof Winsys.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, Winsys.SignalSignatures[K]>,
        ): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;
        /** @signal */
        emit<K extends keyof Winsys.SignalSignatures>(
            signal: K,
            ...args: GObject.GjsParameters<Winsys.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never
        ): void;
        emit(signal: string, ...args: any[]): void;
         ...
         * @virtual
         */
        vfunc_context_init(context: Context): boolean;
        /**
         * @param display
         * @virtual
         */
        vfunc_display_destroy(display: Display): void;
        /**
         * @param display
         * @virtual
         */
        vfunc_display_setup(display: Display): boolean;
        /**
         * @param ctx
         * @virtual
         */
        vfunc_get_sync_fd(ctx: Context): number;
        /**
         * @param renderer
         * @virtual
         */
        vfunc_renderer_bind_api(renderer: Renderer): void;
        /**
         * @param renderer
         * @virtual
         */
        vfunc_renderer_connect(renderer: Renderer): boolean;
        /**
         * @param renderer
         * @virtual
         */
         ...
         * @virtual
         */
        vfunc_renderer_is_dma_buf_supported(renderer: Renderer): boolean;
        /**
         * @param ctx
         * @virtual
         */
        vfunc_update_sync(ctx: Context): void;
    }

    namespace WinsysEGL {
        // Signal signatures
        interface SignalSignatures extends Winsys.SignalSignatures {
            'notify::name': (pspec: GObject.ParamSpec) => void;
        }

        // Constructor properties interface

        interface ConstructorProps extends Winsys.ConstructorProps {}
    }

    /**
     * @gir-type Class
     */
    abstract class WinsysEGL extends Winsys {
        static $gtype: GObject.GType<WinsysEGL>;
         ...
         * @internal
         */
        $signals: WinsysEGL.SignalSignatures;

        // Constructors

        constructor(properties?: Partial<WinsysEGL.ConstructorProps>, ...args: any[]);
        ...
        /** @signal */
        connect<K extends keyof WinsysEGL.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, WinsysEGL.SignalSignatures[K]>,
        ): number;
        connect(signal: string, callback: (...args: any[]) => any): number;
        /** @signal */
        connect_after<K extends keyof WinsysEGL.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, WinsysEGL.SignalSignatures[K]>,
        ): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;
        /** @signal */
        emit<K extends keyof WinsysEGL.SignalSignatures>(
            signal: K,
            ...args: GObject.GjsParameters<WinsysEGL.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never
        ): void;
        emit(signal: string, ...args: any[]): void;
         ...
         * @virtual
         */
        vfunc_cleanup_context(display: Display): void;
        /**
         * @param display
         * @virtual
         */
        vfunc_context_created(display: Display): boolean;
    }
    ...
    class DisplayEGL {
        ...
        constructor(
            properties?: Partial<{
                egl_context: unknown;
                dummy_surface: unknown;
                egl_surface: unknown;
                egl_config: unknown;
                current_read_surface: unknown;
                current_draw_surface: unknown;
    ...
    class RendererEGL {
        ...
        private_features: EGLWinsysFeature;
        platform: any;
     ...
     * @gir-type Alias
     */
    type WinsysClass = typeof Winsys;
    /**
     * @gir-type Alias
     */
    type WinsysEGLClass = typeof WinsysEGL;

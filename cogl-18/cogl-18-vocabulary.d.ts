/**
 * The GIR-derived widget VOCABULARY for Cogl-18.
 *
 ...
 *
 * 25 instantiable GTypes (of which 0 concrete widgets), 28 declarations, 12 enum nick unions, 0 slot candidates.
 *
...
import type Cogl from './cogl-18.js';
...
export type CoglWinsysFeatureNick = 'swap-region' | 'buffer-age' | 'sync-and-complete-event' | 'sync-fd' | 'n-features';

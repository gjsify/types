...
export namespace NMA4 {
    ...
    class BarCode extends GObject.Object {
        // Own properties of NMA4-1.0.BarCode

        readonly size: number;
        text: string;

        // Constructors of NMA4-1.0.BarCode

        static ['new'](text: string): BarCode;

        // Owm methods of NMA4-1.0.BarCode
    ...
    class BarCodeWidget extends Gtk.Box {
        // Own properties of NMA4-1.0.BarCodeWidget
    ...
    class CertChooser extends Gtk.Grid {
        // Own properties of NMA4-1.0.CertChooser

        flags: number;
        title: string;

        // Constructors of NMA4-1.0.CertChooser

        static ['new'](title: string, flags: CertChooserFlags): CertChooser;

        // Owm methods of NMA4-1.0.CertChooser
    ...
    class MobileProvidersDatabase extends GObject.Object {
        // Own properties of NMA4-1.0.MobileProvidersDatabase
        ...
        // Constructors of NMA4-1.0.MobileProvidersDatabase
        ...
        // Owm methods of NMA4-1.0.MobileProvidersDatabase
    ...
    class MobileWizard extends GObject.Object {
        // Owm methods of NMA4-1.0.MobileWizard
    ...
    class VpnPasswordDialog extends Gtk.Dialog {
        // Constructors of NMA4-1.0.VpnPasswordDialog

        static ['new'](title: string, message: string, password: string): VpnPasswordDialog;

        // Owm methods of NMA4-1.0.VpnPasswordDialog
    ...
    class WifiDialog extends Gtk.Dialog {
        // Constructors of NMA4-1.0.WifiDialog
        ...
        // Owm methods of NMA4-1.0.WifiDialog
    ...
    class CountryInfo {
        // Owm methods of NMA4-1.0.CountryInfo
    ...
    class MobileAccessMethod {
        // Owm methods of NMA4-1.0.MobileAccessMethod
    ...
    class MobileProvider {
        // Owm methods of NMA4-1.0.MobileProvider
    ...
    class MobileWizardAccessMethod {
        // Own fields of NMA4-1.0.MobileWizardAccessMethod

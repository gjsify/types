/**
 * The GIR-derived widget VOCABULARY for Tepl-5.
 *
 * GENERATED — do not edit. Provenance: Tepl-5 — dropped empty base(s): Atk.ImplementorIface
 *
 * 23 instantiable GTypes (of which 12 concrete widgets), 25 declarations, 2 enum nick unions, 3 slot candidates.
 *
...
export interface TeplPanelProps extends GtkGridProps, GtkBuildableProps, GtkOrientableProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type TeplPanelConstructOnly = GtkGridConstructOnly | GtkBuildableConstructOnly | GtkOrientableConstructOnly;
...
export interface TeplStyleSchemeChooserWidgetProps extends GtkBinProps, GtkBuildableProps, GtkSourceStyleSchemeChooserProps {
    /**
     * The #GtkSourceStyleSchemeChooser:style-scheme ID, as a string.
     * @since 5.0
     */
    'tepl-style-scheme-id'?: string;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type TeplStyleSchemeChooserWidgetConstructOnly = GtkBinConstructOnly | GtkBuildableConstructOnly | GtkSourceStyleSchemeChooserConstructOnly;
...
export interface Widgets {
    ...
    TeplPanel: {
        class: Tepl.Panel;
        props: TeplPanelProps;
        signals: Tepl.Panel.SignalSignatures;
        constructOnly: TeplPanelConstructOnly;
        slotCandidates: {};
    };
    ...
    TeplStyleSchemeChooserWidget: {
        class: Tepl.StyleSchemeChooserWidget;
        props: TeplStyleSchemeChooserWidgetProps;
        signals: Tepl.StyleSchemeChooserWidget.SignalSignatures;
        constructOnly: TeplStyleSchemeChooserWidgetConstructOnly;
        slotCandidates: {};
    };
    TeplTab: {
        class: Tepl.Tab;

 ...
 */
export function pango_font_description_to_css(desc: Pango.FontDescription): string | null
/**
 ...
 */
export function utils_binding_transform_func_smart_bool(binding: GObject.Binding, from_value: any, to_value: any, user_data: any | null): boolean

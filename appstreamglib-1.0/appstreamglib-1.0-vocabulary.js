// The widget vocabulary of AppStreamGlib-1.0 as runtime data.
//
...
export const OWN_PROPS = {
    AsReview: ['date', 'description', 'flags', 'id', 'locale', 'rating', 'reviewer-id', 'reviewer-name', 'summary', 'version'],
};

export const OWN_SIGNALS = {
    AsStore: ['app-added', 'app-changed', 'app-removed', 'changed'],
};
...
export const SINCE = {
    'AsReview.date': '0.6.1',
    'AsReview.description': '0.6.1',
    'AsReview.flags': '0.6.1',
    'AsReview.id': '0.6.1',
    'AsReview.locale': '0.6.1',
    'AsReview.rating': '0.6.1',
    'AsReview.reviewer-id': '0.6.1',
    'AsReview.reviewer-name': '0.6.1',
    'AsReview.summary': '0.6.1',
    'AsReview.version': '0.6.1',
    'AsStore::app-added': '0.6.5',
    'AsStore::app-changed': '0.6.5',
    'AsStore::app-removed': '0.6.5',
    'AsStore::changed': '0.1.2',
};

 ...
 */
function node_insert_hash(parent: GLib.Node, name: string, attr_key: string, hash: GLib.HashTable<any, any>, insert_flags: NodeInsertFlags): void
/**
 ...
 * @param insert_flags any %AsNodeInsertFlags.
 */
function node_insert_localized(parent: GLib.Node, name: string, localized: GLib.HashTable<any, any>, insert_flags: NodeInsertFlags): void
/**

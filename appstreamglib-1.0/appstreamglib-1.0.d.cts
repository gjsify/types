 ...
 */
export function markup_convert(markup: string, format: MarkupConvertFormat): string | null
/**
 * Converts an XML description into a printable form.
 * @param markup the text to copy.
 * @param format the #AsMarkupConvertFormat, e.g. %AS_MARKUP_CONVERT_FORMAT_MARKDOWN
 ...
 * @returns a newly allocated %NULL terminated string
 */
export function markup_convert_full(markup: string, format: MarkupConvertFormat, flags: MarkupConvertFlag): string | null
/**
 * Converts an XML description into a printable form.
 * @param markup the text to copy.
 * @returns a newly allocated %NULL terminated string
 ...
 */
export function markup_import(text: string, format: MarkupConvertFormat): string | null
/**
 ...
 */
export function utils_appstream_id_build(str: string): string | null
/**
 ...
 * @returns a newly allocated %NULL terminated string
 */
export function utils_find_icon_filename(destdir: string, search: string): string | null
/**
 * Finds an icon filename from a filesystem root.
 * @param destdir the destdir.
 * @param search the icon search name, e.g. "microphone.svg"
 ...
 * @returns a newly allocated %NULL terminated string
 */
export function utils_find_icon_filename_full(destdir: string, search: string, flags: UtilsFindIconFlag): string | null
/**
 ...
 */
export function utils_guid_from_data(namespace_id: string, data: number, data_len: number): string | null
/**
 ...
 */
export function utils_guid_from_string(str: string): string | null
/**
 ...
 */
export function utils_license_to_spdx(license: string): string | null
/**
 ...
 */
export function utils_unique_id_build(scope: AppScope, bundle_kind: BundleKind, origin: string, kind: AppKind, id: string, branch: string): string | null
/**
 ...
 * @returns A version number, e.g. "1.0.3"
 */
export function utils_version_parse(version: string): string | null

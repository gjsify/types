/**
 * The GIR-derived widget VOCABULARY for Passim-1.0.
 *
 * GENERATED — do not edit. Provenance: Passim-1.0 — library 0.1.12
 *
...
/** A shared client. */
export interface PassimClientProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type PassimClientConstructOnly = GObjectConstructOnly;

/** A shared item. */
export interface PassimItemProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type PassimItemConstructOnly = GObjectConstructOnly;

/**
 * The GIR-derived widget VOCABULARY for GXml-0.16.
 *
 ...
 *
 * 129 instantiable GTypes (of which 0 concrete widgets), 180 declarations (1 inlined from a namespace whose vocabulary does not emit them), 7 enum nick unions, 0 slot candidates.
 *
...
import type GXml from './gxml-0.16.js';
...
export interface GXmlBaseCollectionProps extends GObjectProps {
    element?: GXml.GomElement;
    'items-type'?: GObject.GType;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GXmlBaseCollectionConstructOnly = GObjectConstructOnly;
...
export interface GXmlGomArrayListProps extends GXmlBaseCollectionProps, GXmlGomCollectionProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GXmlGomArrayListConstructOnly = GXmlBaseCollectionConstructOnly | GXmlGomCollectionConstructOnly;
...
export interface GXmlGomCollectionProps extends GObjectProps {
    element?: GXml.GomElement;
    'items-type'?: GObject.GType;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GXmlGomCollectionConstructOnly = GObjectConstructOnly;
...
export interface GXmlGomHashMapProps extends GXmlBaseCollectionProps, GXmlGomCollectionProps {
    'attribute-key'?: string;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GXmlGomHashMapConstructOnly = GXmlBaseCollectionConstructOnly | GXmlGomCollectionConstructOnly;

export interface GXmlGomHashPairedMapProps extends GXmlBaseCollectionProps, GXmlGomCollectionProps {
    'attribute-primary-key'?: string;
    'attribute-secondary-key'?: string;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GXmlGomHashPairedMapConstructOnly = GXmlBaseCollectionConstructOnly | GXmlGomCollectionConstructOnly;

export interface GXmlGomHashThreeMapProps extends GXmlBaseCollectionProps, GXmlGomCollectionProps {
    'attribute-primary-key'?: string;
    'attribute-secondary-key'?: string;
    'attribute-third-key'?: string;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GXmlGomHashThreeMapConstructOnly = GXmlBaseCollectionConstructOnly | GXmlGomCollectionConstructOnly;

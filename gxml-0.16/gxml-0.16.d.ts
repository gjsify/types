...
import './gxml-0.16-ambient.d.ts';
import './gxml-0.16-import.d.ts';
/**
 * GXml-0.16
 */
...
export namespace GXml {
    ...
    class CssSelectorError extends GLib.Error {
        // Own fields of GXml-0.16.CssSelectorError
        ...
        // Constructors of GXml-0.16.CssSelectorError

        constructor(options: { message: string; code: number });
    }

    class DocumentError extends GLib.Error {
        // Own fields of GXml-0.16.DocumentError

        INVALID_DOCUMENT_ERROR: number;
        INVALID_FILE: number;

        // Constructors of GXml-0.16.DocumentError

        constructor(options: { message: string; code: number });
    }

    class DomError extends GLib.Error {
        // Own fields of GXml-0.16.DomError
        ...
        // Constructors of GXml-0.16.DomError

        constructor(options: { message: string; code: number });
    }

    class EnumerationError extends GLib.Error {
        // Own fields of GXml-0.16.EnumerationError

        INVALID_VALUE: number;
        INVALID_TEXT: number;

        // Constructors of GXml-0.16.EnumerationError

        constructor(options: { message: string; code: number });
    }

    class Error extends GLib.Error {
        // Own fields of GXml-0.16.Error

        NOT_SUPPORTED: number;
        PARSER: number;
        WRITER: number;

        // Constructors of GXml-0.16.Error

        constructor(options: { message: string; code: number });
    }

    class ParserError extends GLib.Error {
        // Own fields of GXml-0.16.ParserError

        INVALID_DATA_ERROR: number;
        INVALID_FILE_ERROR: number;
        INVALID_STREAM_ERROR: number;

        // Constructors of GXml-0.16.ParserError

        constructor(options: { message: string; code: number });
    }

    class IXsdSchemaError extends GLib.Error {
        // Own fields of GXml-0.16.IXsdSchemaError

        INVALIDATION_ERROR: number;

        // Constructors of GXml-0.16.IXsdSchemaError

        constructor(options: { message: string; code: number });
    }

    class SerializableError extends GLib.Error {
        // Own fields of GXml-0.16.SerializableError

        UNSUPPORTED_TYPE_ERROR: number;
        STR_TO_VALUE_ERROR: number;

        // Constructors of GXml-0.16.SerializableError

        constructor(options: { message: string; code: number });
    }

    class SerializableEnumError extends GLib.Error {
        // Own fields of GXml-0.16.SerializableEnumError

        INVALID_VALUE_ERROR: number;
        PARSE_ERROR: number;

        // Constructors of GXml-0.16.SerializableEnumError

        constructor(options: { message: string; code: number });
    }

    class XPathError extends GLib.Error {
        // Own fields of GXml-0.16.XPathError
        ...
        // Constructors of GXml-0.16.XPathError
    ...
    class CssSelectorData extends GObject.Object {
        // Own properties of GXml-0.16.CssSelectorData
    ...
    class CssSelectorParser extends GObject.Object {
        // Own properties of GXml-0.16.CssSelectorParser

        readonly selectors: Gee.List;

        // Constructors of GXml-0.16.CssSelectorParser

        static ['new'](): CssSelectorParser;

        // Owm methods of GXml-0.16.CssSelectorParser
    ...
    class DomNodeFilter extends GObject.Object {
        // Constructors of GXml-0.16.DomNodeFilter
    ...
    class DomElementList extends Gee.ArrayList {
        // Constructors of GXml-0.16.DomElementList
    ...
    class DomEventInit extends GObject.Object {
        // Own properties of GXml-0.16.DomEventInit

        bubbles: boolean;
        cancelable: boolean;

        // Constructors of GXml-0.16.DomEventInit

        static ['new'](): DomEventInit;

        // Owm methods of GXml-0.16.DomEventInit
    ...
    class DomCustomEventInit extends DomEventInit {
        // Own properties of GXml-0.16.DomCustomEventInit

        detail: GObject.Value;

        // Constructors of GXml-0.16.DomCustomEventInit

        static ['new'](): DomCustomEventInit;

        // Owm methods of GXml-0.16.DomCustomEventInit
    ...
    class DomTimeStamp extends GObject.Object {
        // Own properties of GXml-0.16.DomTimeStamp

        time: GLib.DateTime;

        // Constructors of GXml-0.16.DomTimeStamp

        static ['new'](): DomTimeStamp;

        // Owm methods of GXml-0.16.DomTimeStamp
    ...
    class DomMutationObserverInit extends GObject.Object {
        // Own properties of GXml-0.16.DomMutationObserverInit
        ...
        // Constructors of GXml-0.16.DomMutationObserverInit

        static ['new'](): DomMutationObserverInit;

        // Owm methods of GXml-0.16.DomMutationObserverInit
    ...
    class DomErrorName extends GObject.Object {
        // Constructors of GXml-0.16.DomErrorName

        static ['new'](): DomErrorName;

        // Owm methods of GXml-0.16.DomErrorName
    ...
    class ElementList extends Gee.ArrayList {
        // Constructors of GXml-0.16.ElementList
    ...
    class GHtmlDocument extends GDocument {
        // Own properties of GXml-0.16.GHtmlDocument

        readonly default_options: number;
        readonly defaultOptions: number;

        // Constructors of GXml-0.16.GHtmlDocument

        static from_path(path: string, options: number): GHtmlDocument;

        static from_uri(uri: string, options: number): GHtmlDocument;

        static from_file(file: Gio.File, options: number, cancel: Gio.Cancellable): GHtmlDocument;
        ...
        // Owm methods of GXml-0.16.GHtmlDocument
    ...
    class GomAttr extends GomNode {
        // Constructors of GXml-0.16.GomAttr
    ...
    abstract class BaseCollection extends GObject.Object {
        // Own properties of GXml-0.16.BaseCollection
        ...
        // Owm methods of GXml-0.16.BaseCollection
    ...
    class GomArrayList extends BaseCollection {
        // Constructors of GXml-0.16.GomArrayList
    ...
    class GomHashMap extends BaseCollection {
        // Own properties of GXml-0.16.GomHashMap

        attribute_key: string;
        attributeKey: string;

        // Constructors of GXml-0.16.GomHashMap

        static ['new'](): GomHashMap;

        // Owm methods of GXml-0.16.GomHashMap
    ...
    class GomHashPairedMap extends BaseCollection {
        // Own properties of GXml-0.16.GomHashPairedMap
        ...
        // Constructors of GXml-0.16.GomHashPairedMap

        static ['new'](): GomHashPairedMap;

        // Owm methods of GXml-0.16.GomHashPairedMap
    ...
    class GomHashThreeMap extends BaseCollection {
        // Own properties of GXml-0.16.GomHashThreeMap
        ...
        // Constructors of GXml-0.16.GomHashThreeMap

        static ['new'](): GomHashThreeMap;

        // Owm methods of GXml-0.16.GomHashThreeMap
    ...
    class GomDocument extends GomNode {
        // Constructors of GXml-0.16.GomDocument
        ...
        // Owm methods of GXml-0.16.GomDocument
    ...
    class GomImplementation extends GObject.Object {
        // Constructors of GXml-0.16.GomImplementation
    ...
    class GomDocumentType extends GomNode {
        // Constructors of GXml-0.16.GomDocumentType

        static ['new'](doc: DomDocument, name: string, public_id: string, system_id: string): GomDocumentType;
    ...
    class GomDocumentFragment extends GomNode {
        // Constructors of GXml-0.16.GomDocumentFragment
    ...
    class GomElement extends GomNode {
        // Own properties of GXml-0.16.GomElement

        parse_children: boolean;
        parseChildren: boolean;
        unparsed: string;

        // Constructors of GXml-0.16.GomElement

        static ['new'](): GomElement;

        // Owm methods of GXml-0.16.GomElement
    ...
    class GomElementAttributes extends Gee.HashMap {
        // Constructors of GXml-0.16.GomElementAttributes
    ...
    class GomNode extends GObject.Object {
        // Constructors of GXml-0.16.GomNode
    ...
    class GomNodeList extends Gee.ArrayList {
        // Constructors of GXml-0.16.GomNodeList
    ...
    abstract class GomBaseProperty extends GObject.Object {
        // Own properties of GXml-0.16.GomBaseProperty

        value: string;

        // Owm methods of GXml-0.16.GomBaseProperty
    ...
    class GomString extends GomBaseProperty {
        // Constructors of GXml-0.16.GomString
    ...
    class GomArrayString extends GomBaseProperty {
        // Constructors of GXml-0.16.GomArrayString

        static ['new'](): GomArrayString;

        // Owm methods of GXml-0.16.GomArrayString
    ...
    class GomXsdArrayString extends GomArrayString {
        // Own properties of GXml-0.16.GomXsdArrayString

        simple_type: string;
        simpleType: string;
        source: Gio.File;

        // Constructors of GXml-0.16.GomXsdArrayString

        static ['new'](): GomXsdArrayString;

        // Owm methods of GXml-0.16.GomXsdArrayString
    ...
    class GomDouble extends GomBaseProperty {
        // Own properties of GXml-0.16.GomDouble

        decimals: number;

        // Constructors of GXml-0.16.GomDouble

        static ['new'](): GomDouble;

        // Owm methods of GXml-0.16.GomDouble
    ...
    class GomFloat extends GomDouble {
        // Constructors of GXml-0.16.GomFloat

        static ['new'](): GomFloat;

        // Owm methods of GXml-0.16.GomFloat
    ...
    class GomInt extends GomBaseProperty {
        // Constructors of GXml-0.16.GomInt

        static ['new'](): GomInt;

        // Owm methods of GXml-0.16.GomInt
    ...
    class GomBoolean extends GomBaseProperty {
        // Constructors of GXml-0.16.GomBoolean

        static ['new'](): GomBoolean;

        // Owm methods of GXml-0.16.GomBoolean
    ...
    class GomEnum extends GomBaseProperty {
        // Own properties of GXml-0.16.GomEnum

        enum_type: GObject.GType;
        enumType: GObject.GType;

        // Constructors of GXml-0.16.GomEnum

        static ['new'](): GomEnum;

        // Owm methods of GXml-0.16.GomEnum
    ...
    class GomDate extends GomBaseProperty {
        // Constructors of GXml-0.16.GomDate

        static ['new'](): GomDate;

        // Owm methods of GXml-0.16.GomDate
    ...
    class GomDateTime extends GomBaseProperty {
        // Own properties of GXml-0.16.GomDateTime

        format: string;

        // Constructors of GXml-0.16.GomDateTime

        static ['new'](): GomDateTime;

        // Owm methods of GXml-0.16.GomDateTime
    ...
    class GomXsdSchema extends GomElement {
        // Own properties of GXml-0.16.GomXsdSchema
        ...
        // Constructors of GXml-0.16.GomXsdSchema

        static ['new'](): GomXsdSchema;

        // Owm methods of GXml-0.16.GomXsdSchema
    ...
    class GomXsdSimpleType extends GomElement {
        // Own properties of GXml-0.16.GomXsdSimpleType
        ...
        // Constructors of GXml-0.16.GomXsdSimpleType

        static ['new'](): GomXsdSimpleType;

        // Owm methods of GXml-0.16.GomXsdSimpleType
    ...
    class GomXsdTypeDefinition extends GomElement {
        // Own properties of GXml-0.16.GomXsdTypeDefinition

        annotation: GomXsdAnnotation;

        // Constructors of GXml-0.16.GomXsdTypeDefinition

        static ['new'](): GomXsdTypeDefinition;

        // Owm methods of GXml-0.16.GomXsdTypeDefinition
    ...
    class GomXsdTypeList extends GomXsdTypeDefinition {
        // Constructors of GXml-0.16.GomXsdTypeList
    ...
    class GomXsdTypeUnion extends GomXsdTypeDefinition {
        // Constructors of GXml-0.16.GomXsdTypeUnion
    ...
    class GomXsdTypeRestriction extends GomXsdTypeDefinition {
        // Own properties of GXml-0.16.GomXsdTypeRestriction
        ...
        // Constructors of GXml-0.16.GomXsdTypeRestriction

        static ['new'](): GomXsdTypeRestriction;

        // Owm methods of GXml-0.16.GomXsdTypeRestriction
    ...
    class GomXsdTypeRestrictionDef extends GomElement {
        // Own properties of GXml-0.16.GomXsdTypeRestrictionDef

        annotation: GomXsdAnnotation;

        // Constructors of GXml-0.16.GomXsdTypeRestrictionDef

        static ['new'](): GomXsdTypeRestrictionDef;

        // Owm methods of GXml-0.16.GomXsdTypeRestrictionDef
    ...
    class GomXsdTypeRestrictionMinExclusive extends GomXsdTypeRestrictionDef {
        // Constructors of GXml-0.16.GomXsdTypeRestrictionMinExclusive
    ...
    class GomXsdTypeRestrictionMinInclusive extends GomXsdTypeRestrictionDef {
        // Constructors of GXml-0.16.GomXsdTypeRestrictionMinInclusive
    ...
    class GomXsdTypeRestrictionMaxExclusive extends GomXsdTypeRestrictionDef {
        // Constructors of GXml-0.16.GomXsdTypeRestrictionMaxExclusive
    ...
    class GomXsdTypeRestrictionMaxInclusive extends GomXsdTypeRestrictionDef {
        // Constructors of GXml-0.16.GomXsdTypeRestrictionMaxInclusive
    ...
    class GomXsdTypeRestrictionTotalDigits extends GomXsdTypeRestrictionDef {
        // Constructors of GXml-0.16.GomXsdTypeRestrictionTotalDigits
    ...
    class GomXsdTypeRestrictionFractionDigits extends GomXsdTypeRestrictionDef {
        // Constructors of GXml-0.16.GomXsdTypeRestrictionFractionDigits
    ...
    class GomXsdTypeRestrictionLength extends GomXsdTypeRestrictionDef {
        // Constructors of GXml-0.16.GomXsdTypeRestrictionLength
    ...
    class GomXsdTypeRestrictionMinLength extends GomXsdTypeRestrictionDef {
        // Constructors of GXml-0.16.GomXsdTypeRestrictionMinLength
    ...
    class GomXsdTypeRestrictionMaxLength extends GomXsdTypeRestrictionDef {
        // Constructors of GXml-0.16.GomXsdTypeRestrictionMaxLength
    ...
    class GomXsdTypeRestrictionEnumeration extends GomXsdTypeRestrictionDef {
        // Own properties of GXml-0.16.GomXsdTypeRestrictionEnumeration

        value: string;

        // Constructors of GXml-0.16.GomXsdTypeRestrictionEnumeration

        static ['new'](): GomXsdTypeRestrictionEnumeration;

        // Owm methods of GXml-0.16.GomXsdTypeRestrictionEnumeration
    ...
    class GomXsdTypeRestrictionWhiteSpace extends GomXsdTypeRestrictionDef {
        // Own properties of GXml-0.16.GomXsdTypeRestrictionWhiteSpace

        fixed: GomXsdTypeRestrictionWhiteSpaceFixed;
        value: string;

        // Constructors of GXml-0.16.GomXsdTypeRestrictionWhiteSpace

        static ['new'](): GomXsdTypeRestrictionWhiteSpace;

        // Owm methods of GXml-0.16.GomXsdTypeRestrictionWhiteSpace
    ...
    class GomXsdTypeRestrictionWhiteSpaceFixed extends GomBoolean {
        // Constructors of GXml-0.16.GomXsdTypeRestrictionWhiteSpaceFixed
    ...
    class GomXsdTypeRestrictionPattern extends GomXsdTypeRestrictionDef {
        // Constructors of GXml-0.16.GomXsdTypeRestrictionPattern
    ...
    class GomXsdTypeRestrictionAssertion extends GomXsdTypeRestrictionDef {
        // Constructors of GXml-0.16.GomXsdTypeRestrictionAssertion
    ...
    class GomXsdTypeRestrictionExplicitTimezone extends GomXsdTypeRestrictionDef {
        // Constructors of GXml-0.16.GomXsdTypeRestrictionExplicitTimezone
    ...
    class GomXsdComplexType extends GomXsdBaseType {
        // Own properties of GXml-0.16.GomXsdComplexType
        ...
        // Constructors of GXml-0.16.GomXsdComplexType

        static ['new'](): GomXsdComplexType;

        // Owm methods of GXml-0.16.GomXsdComplexType
    ...
    class GomXsdExtension extends GomElement {
        // Own properties of GXml-0.16.GomXsdExtension

        base: string;

        // Constructors of GXml-0.16.GomXsdExtension

        static ['new'](): GomXsdExtension;

        // Owm methods of GXml-0.16.GomXsdExtension
    ...
    class GomXsdElement extends GomElement {
        // Own properties of GXml-0.16.GomXsdElement
        ...
        // Constructors of GXml-0.16.GomXsdElement

        static ['new'](): GomXsdElement;

        // Owm methods of GXml-0.16.GomXsdElement
    ...
    class GomXsdAnnotation extends GomElement {
        // Constructors of GXml-0.16.GomXsdAnnotation
    ...
    class GomXsdBaseType extends GomElement {
        // Own properties of GXml-0.16.GomXsdBaseType

        anotation: GomXsdAnnotation;

        // Constructors of GXml-0.16.GomXsdBaseType

        static ['new'](): GomXsdBaseType;

        // Owm methods of GXml-0.16.GomXsdBaseType
    ...
    class GomXsdBaseContent extends GomElement {
        // Own properties of GXml-0.16.GomXsdBaseContent

        anotation: GomXsdAnnotation;

        // Constructors of GXml-0.16.GomXsdBaseContent

        static ['new'](): GomXsdBaseContent;

        // Owm methods of GXml-0.16.GomXsdBaseContent
    ...
    class GomXsdSimpleContent extends GomXsdBaseContent {
        // Constructors of GXml-0.16.GomXsdSimpleContent
    ...
    class GomXsdComplexContent extends GomXsdBaseContent {
        // Constructors of GXml-0.16.GomXsdComplexContent
    ...
    class GomXsdOpenContent extends GomXsdBaseContent {
        // Constructors of GXml-0.16.GomXsdOpenContent
    ...
    class GomXsdBaseAttribute extends GomElement {
        // Own properties of GXml-0.16.GomXsdBaseAttribute

        anotation: GomXsdAnnotation;

        // Constructors of GXml-0.16.GomXsdBaseAttribute

        static ['new'](): GomXsdBaseAttribute;

        // Owm methods of GXml-0.16.GomXsdBaseAttribute
    ...
    class GomXsdAttribute extends GomXsdBaseAttribute {
        // Constructors of GXml-0.16.GomXsdAttribute
    ...
    class GomXsdAttributeGroup extends GomXsdBaseAttribute {
        // Constructors of GXml-0.16.GomXsdAttributeGroup
    ...
    class GomXsdList extends GomArrayList {
        // Own properties of GXml-0.16.GomXsdList

        readonly length: number;

        // Constructors of GXml-0.16.GomXsdList

        static ['new'](): GomXsdList;

        // Owm methods of GXml-0.16.GomXsdList
    ...
    class GomXsdListElements extends GomXsdList {
        // Constructors of GXml-0.16.GomXsdListElements
    ...
    class GomXsdListSimpleTypes extends GomXsdList {
        // Constructors of GXml-0.16.GomXsdListSimpleTypes
    ...
    class GomXsdListComplexTypes extends GomXsdList {
        // Constructors of GXml-0.16.GomXsdListComplexTypes
    ...
    class GomXsdListTypeRestrictionEnumerations extends GomXsdList {
        // Constructors of GXml-0.16.GomXsdListTypeRestrictionEnumerations
    ...
    class GomXsdListTypeRestrictionWhiteSpaces extends GomXsdList {
        // Constructors of GXml-0.16.GomXsdListTypeRestrictionWhiteSpaces
    ...
    class GomCharacterData extends GomNode {
        // Constructors of GXml-0.16.GomCharacterData
    ...
    class GomText extends GomCharacterData {
        // Constructors of GXml-0.16.GomText
    ...
    class GomProcessingInstruction extends GomCharacterData {
        // Constructors of GXml-0.16.GomProcessingInstruction
    ...
    class GomComment extends GomCharacterData {
        // Constructors of GXml-0.16.GomComment
    ...
    class GAttribute extends GNode {
        // Constructors of GXml-0.16.GAttribute
    ...
    class GCDATA extends GNode {
        // Constructors of GXml-0.16.GCDATA
    ...
    class GCharacterData extends GNonDocumentChildNode {
        // Constructors of GXml-0.16.GCharacterData
    ...
    class GChildNode extends GNode {
        // Constructors of GXml-0.16.GChildNode
    ...
    class GNonDocumentChildNode extends GChildNode {
        // Constructors of GXml-0.16.GNonDocumentChildNode
    ...
    class GComment extends GCharacterData {
        // Constructors of GXml-0.16.GComment
    ...
    class GDocument extends GNode {
        // Own fields of GXml-0.16.GDocument

        doc: any;

        // Constructors of GXml-0.16.GDocument
        ...
        // Owm methods of GXml-0.16.GDocument
    ...
    class GImplementation extends GObject.Object {
        // Constructors of GXml-0.16.GImplementation
    ...
    class GDocumentType extends GChildNode {
        // Constructors of GXml-0.16.GDocumentType
    ...
    class GDocumentFragment extends GDocument {
        // Constructors of GXml-0.16.GDocumentFragment
    ...
    class GDomNodeIterator extends GObject.Object {
        // Constructors of GXml-0.16.GDomNodeIterator
    ...
    class GDomTreeWalker extends GObject.Object {
        // Constructors of GXml-0.16.GDomTreeWalker
    ...
    class GDomTokenList extends Gee.ArrayList {
        // Constructors of GXml-0.16.GDomTokenList

        static ['new'](e: DomElement, attr: string): GDomTokenList;

        // Owm methods of GXml-0.16.GDomTokenList
    ...
    class GDomSettableTokenList extends GDomTokenList {
        // Constructors of GXml-0.16.GDomSettableTokenList
    ...
    class GDomHTMLCollection extends Gee.ArrayList {
        // Constructors of GXml-0.16.GDomHTMLCollection
    ...
    class GDomEvent extends GObject.Object {
        // Constructors of GXml-0.16.GDomEvent
    ...
    class GDomCustomEvent extends GDomEvent {
        // Own properties of GXml-0.16.GDomCustomEvent

        readonly detail: GObject.Value;

        // Constructors of GXml-0.16.GDomCustomEvent

        static ['new'](): GDomCustomEvent;

        // Owm methods of GXml-0.16.GDomCustomEvent
    ...
    class GDomRange extends GObject.Object {
        // Constructors of GXml-0.16.GDomRange
    ...
    class GElement extends GNonDocumentChildNode {
        // Constructors of GXml-0.16.GElement
    ...
    class GHashMapAttr extends Gee.AbstractMap {
        // Constructors of GXml-0.16.GHashMapAttr
    ...
    class GHashMapAttrEntry extends Gee.MapEntry {
        // Constructors of GXml-0.16.GHashMapAttrEntry
    ...
    class GHashMapAttrIterator extends GObject.Object {
        // Constructors of GXml-0.16.GHashMapAttrIterator
    ...
    class GListChildren extends Gee.AbstractBidirList {
        // Constructors of GXml-0.16.GListChildren
    ...
    class GListChildrenIterator extends GObject.Object {
        // Constructors of GXml-0.16.GListChildrenIterator
    ...
    class GListNamespaces extends Gee.AbstractList {
        // Constructors of GXml-0.16.GListNamespaces
    ...
    class GListNamespacesIterator extends GObject.Object {
        // Constructors of GXml-0.16.GListNamespacesIterator
    ...
    class GNamespace extends GObject.Object {
        // Constructors of GXml-0.16.GNamespace

        static ['new'](ns: any): GNamespace;

        // Owm methods of GXml-0.16.GNamespace
    ...
    abstract class GNode extends GObject.Object {
        // Own properties of GXml-0.16.GNode
        ...
        // Owm methods of GXml-0.16.GNode
    ...
    class GProcessingInstruction extends GCharacterData {
        // Constructors of GXml-0.16.GProcessingInstruction
    ...
    class GText extends GCharacterData {
        // Constructors of GXml-0.16.GText
    ...
    class GXPathObject extends GObject.Object {
        // Constructors of GXml-0.16.GXPathObject
    ...
    class NodeList extends Gee.ArrayList {
        // Constructors of GXml-0.16.NodeList

        static ['new'](): NodeList;

        // Owm methods of GXml-0.16.NodeList
    ...
    class SerializableBool extends GObject.Object {
        // Constructors of GXml-0.16.SerializableBool

        static ['new'](): SerializableBool;

        // Owm methods of GXml-0.16.SerializableBool
    ...
    abstract class SerializableContainer extends SerializableObjectModel {
        // Owm methods of GXml-0.16.SerializableContainer
    ...
    class SerializableDouble extends GObject.Object {
        // Constructors of GXml-0.16.SerializableDouble

        static ['new'](): SerializableDouble;

        // Owm methods of GXml-0.16.SerializableDouble
    ...
    class SerializableEnum extends GObject.Object {
        // Constructors of GXml-0.16.SerializableEnum

        static with_enum(type: GObject.GType): SerializableEnum;

        static ['new'](): SerializableEnum;

        // Owm methods of GXml-0.16.SerializableEnum
    ...
    class SerializableFloat extends SerializableDouble {
        // Constructors of GXml-0.16.SerializableFloat

        static ['new'](): SerializableFloat;

        // Owm methods of GXml-0.16.SerializableFloat
    ...
    class SerializableArrayList extends Gee.ArrayList {
        // Own properties of GXml-0.16.SerializableArrayList
        ...
        // Constructors of GXml-0.16.SerializableArrayList

        static ['new'](): SerializableArrayList;

        // Owm methods of GXml-0.16.SerializableArrayList
    ...
    class SerializableDualKeyMap extends GObject.Object {
        // Own properties of GXml-0.16.SerializableDualKeyMap
        ...
        // Own fields of GXml-0.16.SerializableDualKeyMap

        storage: Gee.HashMultiMap;

        // Constructors of GXml-0.16.SerializableDualKeyMap

        static ['new'](): SerializableDualKeyMap;

        // Owm methods of GXml-0.16.SerializableDualKeyMap
    ...
    class SerializableHashMap extends Gee.HashMap {
        // Own properties of GXml-0.16.SerializableHashMap

        ignored_serializable_properties: GLib.HashTable<string, GObject.ParamSpec>;
        ignoredSerializableProperties: GLib.HashTable<string, GObject.ParamSpec>;

        // Constructors of GXml-0.16.SerializableHashMap

        static ['new'](): SerializableHashMap;

        // Owm methods of GXml-0.16.SerializableHashMap
    ...
    class SerializableTreeMap extends Gee.TreeMap {
        // Own properties of GXml-0.16.SerializableTreeMap

        ignored_serializable_properties: GLib.HashTable<string, GObject.ParamSpec>;
        ignoredSerializableProperties: GLib.HashTable<string, GObject.ParamSpec>;

        // Constructors of GXml-0.16.SerializableTreeMap

        static ['new'](): SerializableTreeMap;

        // Owm methods of GXml-0.16.SerializableTreeMap
    ...
    class SerializableInt extends SerializableDouble {
        // Constructors of GXml-0.16.SerializableInt

        static ['new'](): SerializableInt;

        // Owm methods of GXml-0.16.SerializableInt
    ...
    abstract class SerializableObjectModel extends GObject.Object {
        // Own properties of GXml-0.16.SerializableObjectModel

        ignored_serializable_properties: GLib.HashTable<string, GObject.ParamSpec>;
        ignoredSerializableProperties: GLib.HashTable<string, GObject.ParamSpec>;

        // Owm methods of GXml-0.16.SerializableObjectModel
    ...
    class SerializableValueList extends GObject.Object {
        // Own fields of GXml-0.16.SerializableValueList

        extra: Gee.ArrayList;

        // Constructors of GXml-0.16.SerializableValueList

        static ['new'](): SerializableValueList;

        // Owm methods of GXml-0.16.SerializableValueList
    ...
    class TAttribute extends TNode {
        // Constructors of GXml-0.16.TAttribute
    ...
    class TCDATA extends TNode {
        // Constructors of GXml-0.16.TCDATA
    ...
    class TComment extends TNode {
        // Constructors of GXml-0.16.TComment
    ...
    class TDocument extends TNode {
        // Constructors of GXml-0.16.TDocument
        ...
        // Owm methods of GXml-0.16.TDocument
    ...
    class TElement extends TNode {
        // Constructors of GXml-0.16.TElement
    ...
    class TNamespace extends TNode {
        // Constructors of GXml-0.16.TNamespace
    ...
    abstract class TNode extends GObject.Object {
        // Own properties of GXml-0.16.TNode
        ...
        // Owm methods of GXml-0.16.TNode
    ...
    class TNodeTChildrenList extends Gee.AbstractBidirList {
        // Constructors of GXml-0.16.TNodeTChildrenList
    ...
    class TProcessingInstruction extends TNode {
        // Constructors of GXml-0.16.TProcessingInstruction
    ...
    class TText extends TNode {
        // Constructors of GXml-0.16.TText
    ...
    class XParser extends GObject.Object {
        // Constructors of GXml-0.16.XParser

        static ['new'](node: DomNode): XParser;

        // Owm methods of GXml-0.16.XParser
    ...
    class Enumeration {
        // Constructors of GXml-0.16.Enumeration

        constructor(properties?: Partial<{}>);

        static ['new'](): Enumeration;

        // Owm methods of GXml-0.16.Enumeration
    ...
    interface Attribute {
        // Own properties of GXml-0.16.Attribute

        namespace: Namespace;
        readonly prefix: string;

        // Owm methods of GXml-0.16.Attribute

        get_namespace(): Namespace;
        set_namespace(value: Namespace): void;
        get_prefix(): string;

        // Own virtual methods of GXml-0.16.Attribute
    ...
    interface CDATA {
        // Own properties of GXml-0.16.CDATA

        readonly str: string;

        // Owm methods of GXml-0.16.CDATA

        get_str(): string;

        // Own virtual methods of GXml-0.16.CDATA

        vfunc_get_str(): string;
    }

    interface Character {
        // Own properties of GXml-0.16.Character

        str: string;

        // Owm methods of GXml-0.16.Character

        get_str(): string;
        set_str(value: string): void;

        // Own virtual methods of GXml-0.16.Character
    ...
    interface Comment {
        // Own properties of GXml-0.16.Comment

        str: string;

        // Owm methods of GXml-0.16.Comment

        get_str(): string;
        set_str(value: string): void;

        // Own virtual methods of GXml-0.16.Comment
    ...
    interface Document {
        // Own properties of GXml-0.16.Document
        ...
        // Owm methods of GXml-0.16.Document
        ...
        // Own virtual methods of GXml-0.16.Document
    ...
    interface DomAttr {
        // Own properties of GXml-0.16.DomAttr
        ...
        // Owm methods of GXml-0.16.DomAttr
        ...
        // Own virtual methods of GXml-0.16.DomAttr
    ...
    interface DomCharacterData {
        // Own properties of GXml-0.16.DomCharacterData

        data: string;
        readonly length: number;

        // Owm methods of GXml-0.16.DomCharacterData
        ...
        // Own virtual methods of GXml-0.16.DomCharacterData
    ...
    interface DomText {
        // Own properties of GXml-0.16.DomText

        readonly whole_text: string;
        readonly wholeText: string;

        // Owm methods of GXml-0.16.DomText

        split_text(offset: number): DomText;
        get_whole_text(): string;

        // Own virtual methods of GXml-0.16.DomText
    ...
    interface DomProcessingInstruction {
        // Own properties of GXml-0.16.DomProcessingInstruction

        readonly target: string;

        // Owm methods of GXml-0.16.DomProcessingInstruction

        get_target(): string;

        // Own virtual methods of GXml-0.16.DomProcessingInstruction
    ...
    interface DomNonElementParentNode {
        // Owm methods of GXml-0.16.DomNonElementParentNode

        get_element_by_id(element_id: string): DomElement;

        // Own virtual methods of GXml-0.16.DomNonElementParentNode

        vfunc_get_element_by_id(element_id: string): DomElement;
    }

    interface DomParentNode {
        // Own properties of GXml-0.16.DomParentNode
        ...
        // Owm methods of GXml-0.16.DomParentNode
        ...
        // Own virtual methods of GXml-0.16.DomParentNode
    ...
    interface DomNonDocumentTypeChildNode {
        // Own properties of GXml-0.16.DomNonDocumentTypeChildNode
        ...
        // Owm methods of GXml-0.16.DomNonDocumentTypeChildNode

        get_previous_element_sibling(): DomElement;
        get_next_element_sibling(): DomElement;

        // Own virtual methods of GXml-0.16.DomNonDocumentTypeChildNode
    ...
    interface DomChildNode {
        // Owm methods of GXml-0.16.DomChildNode

        remove(): void;

        // Own virtual methods of GXml-0.16.DomChildNode

        vfunc_remove(): void;
    }

    interface DomNodeList {
        // Own properties of GXml-0.16.DomNodeList

        readonly length: number;

        // Owm methods of GXml-0.16.DomNodeList

        item(index: number): DomNode;
        get_length(): number;

        // Own virtual methods of GXml-0.16.DomNodeList
    ...
    interface DomHTMLCollection {
        // Own properties of GXml-0.16.DomHTMLCollection

        readonly length: number;

        // Owm methods of GXml-0.16.DomHTMLCollection
        ...
        // Own virtual methods of GXml-0.16.DomHTMLCollection
    ...
    interface DomNodeIterator {
        // Own properties of GXml-0.16.DomNodeIterator
        ...
        // Owm methods of GXml-0.16.DomNodeIterator
        ...
        // Own virtual methods of GXml-0.16.DomNodeIterator
    ...
    interface DomTreeWalker {
        // Own properties of GXml-0.16.DomTreeWalker
        ...
        // Owm methods of GXml-0.16.DomTreeWalker
        ...
        // Own virtual methods of GXml-0.16.DomTreeWalker
    ...
    interface DomNamedNodeMap {
        // Own properties of GXml-0.16.DomNamedNodeMap

        readonly length: number;

        // Owm methods of GXml-0.16.DomNamedNodeMap
        ...
        // Own virtual methods of GXml-0.16.DomNamedNodeMap
    ...
    interface DomTokenList {
        // Own properties of GXml-0.16.DomTokenList

        readonly length: number;

        // Owm methods of GXml-0.16.DomTokenList
        ...
        // Own virtual methods of GXml-0.16.DomTokenList
    ...
    interface DomSettableTokenList {
        // Own properties of GXml-0.16.DomSettableTokenList

        value: string;

        // Owm methods of GXml-0.16.DomSettableTokenList

        get_value(): string;
        set_value(value: string): void;

        // Own virtual methods of GXml-0.16.DomSettableTokenList
    ...
    interface DomDocument {
        // Own properties of GXml-0.16.DomDocument
        ...
        // Owm methods of GXml-0.16.DomDocument
        ...
        // Own virtual methods of GXml-0.16.DomDocument
    ...
    interface DomImplementation {
        // Owm methods of GXml-0.16.DomImplementation
        ...
        // Own virtual methods of GXml-0.16.DomImplementation
    ...
    interface DomDocumentType {
        // Own properties of GXml-0.16.DomDocumentType
        ...
        // Owm methods of GXml-0.16.DomDocumentType

        get_name(): string;
        get_public_id(): string;
        get_system_id(): string;

        // Own virtual methods of GXml-0.16.DomDocumentType
    ...
    interface DomHtmlDocument {
        // Owm methods of GXml-0.16.DomHtmlDocument

        read_from_string(str: string): void;
        read_from_string_tolerant(str: string): void;
        to_html(): string;

        // Own virtual methods of GXml-0.16.DomHtmlDocument
    ...
    interface DomElement {
        // Own properties of GXml-0.16.DomElement
        ...
        // Owm methods of GXml-0.16.DomElement
        ...
        // Own virtual methods of GXml-0.16.DomElement
    ...
    interface DomEventTarget {
        // Owm methods of GXml-0.16.DomEventTarget
        ...
        // Own virtual methods of GXml-0.16.DomEventTarget
    ...
    interface DomEventListener {
        // Owm methods of GXml-0.16.DomEventListener

        handle_event(event: DomEvent): void;

        // Own virtual methods of GXml-0.16.DomEventListener

        vfunc_handle_event(event: DomEvent): void;
    }

    interface DomEvent {
        // Own properties of GXml-0.16.DomEvent
        ...
        // Owm methods of GXml-0.16.DomEvent
        ...
        // Own virtual methods of GXml-0.16.DomEvent
    ...
    interface DomCustomEvent {
        // Own properties of GXml-0.16.DomCustomEvent

        readonly detail: GObject.Value;

        // Owm methods of GXml-0.16.DomCustomEvent

        init_custom_event(type: string, bubbles: boolean, cancelable: boolean, detail: GObject.Value): void;
        get_detail(): void;

        // Own virtual methods of GXml-0.16.DomCustomEvent
    ...
    interface DomMutationObserver {
        // Owm methods of GXml-0.16.DomMutationObserver

        observe(target: Node, options: DomMutationObserverInit): void;
        disconnect(): void;
        take_records(): Gee.List;

        // Own virtual methods of GXml-0.16.DomMutationObserver
    ...
    interface DomMutationRecord {
        // Own properties of GXml-0.16.DomMutationRecord
        ...
        // Owm methods of GXml-0.16.DomMutationRecord
        ...
        // Own virtual methods of GXml-0.16.DomMutationRecord
    ...
    interface DomNode {
        // Own properties of GXml-0.16.DomNode
        ...
        // Owm methods of GXml-0.16.DomNode
        ...
        // Own virtual methods of GXml-0.16.DomNode
    ...
    interface DomRange {
        // Own properties of GXml-0.16.DomRange
        ...
        // Owm methods of GXml-0.16.DomRange
        ...
        // Own virtual methods of GXml-0.16.DomRange
    ...
    interface Element {
        // Own properties of GXml-0.16.Element

        readonly tag_name: string;
        readonly tagName: string;
        content: string;

        // Owm methods of GXml-0.16.Element
        ...
        // Own virtual methods of GXml-0.16.Element
    ...
    interface GomCollection {
        // Own properties of GXml-0.16.GomCollection
        ...
        // Owm methods of GXml-0.16.GomCollection
        ...
        // Own virtual methods of GXml-0.16.GomCollection
    ...
    interface MappeableElement {
        // Owm methods of GXml-0.16.MappeableElement

        get_map_key(): string;

        // Own virtual methods of GXml-0.16.MappeableElement

        vfunc_get_map_key(): string;
    }

    interface MappeableElementPairKey {
        // Owm methods of GXml-0.16.MappeableElementPairKey

        get_map_primary_key(): string;
        get_map_secondary_key(): string;

        // Own virtual methods of GXml-0.16.MappeableElementPairKey
    ...
    interface MappeableElementThreeKey {
        // Owm methods of GXml-0.16.MappeableElementThreeKey

        get_map_pkey(): string;
        get_map_skey(): string;
        get_map_tkey(): string;

        // Own virtual methods of GXml-0.16.MappeableElementThreeKey
    ...
    interface GomObject {
        // Owm methods of GXml-0.16.GomObject
        ...
        // Own virtual methods of GXml-0.16.GomObject
    ...
    interface GomProperty {
        // Own properties of GXml-0.16.GomProperty

        value: string;

        // Owm methods of GXml-0.16.GomProperty

        validate_value(val: string): boolean;
        get_value(): string;
        set_value(value: string): void;

        // Own virtual methods of GXml-0.16.GomProperty
    ...
    interface Namespace {
        // Own properties of GXml-0.16.Namespace

        readonly uri: string;
        readonly prefix: string;

        // Owm methods of GXml-0.16.Namespace

        get_uri(): string;
        get_prefix(): string;

        // Own virtual methods of GXml-0.16.Namespace
    ...
    interface Node {
        // Own properties of GXml-0.16.Node
        ...
        // Own virtual methods of GXml-0.16.Node
    ...
    interface Notation {
        // Own properties of GXml-0.16.Notation
        ...
        // Owm methods of GXml-0.16.Notation

        get_public_id(): string;
        get_external_id(): string;

        // Own virtual methods of GXml-0.16.Notation
    ...
    interface Parser {
        // Own properties of GXml-0.16.Parser

        backup: boolean;
        indent: boolean;
        readonly node: DomNode;

        // Owm methods of GXml-0.16.Parser
        ...
        // Own virtual methods of GXml-0.16.Parser
    ...
    interface ProcessingInstruction {
        // Own properties of GXml-0.16.ProcessingInstruction

        readonly target: string;
        data: string;

        // Owm methods of GXml-0.16.ProcessingInstruction

        get_target(): string;
        get_data(): string;
        set_data(value: string): void;

        // Own virtual methods of GXml-0.16.ProcessingInstruction
    ...
    interface IXsdSchema {
        // Own properties of GXml-0.16.IXsdSchema
        ...
        // Owm methods of GXml-0.16.IXsdSchema
        ...
        // Own virtual methods of GXml-0.16.IXsdSchema
    ...
    interface IXsdBaseType {
        // Own properties of GXml-0.16.IXsdBaseType

        anotation: IXsdAnnotation;

        // Owm methods of GXml-0.16.IXsdBaseType

        get_anotation(): IXsdAnnotation;
        set_anotation(value: IXsdAnnotation): void;

        // Own virtual methods of GXml-0.16.IXsdBaseType
    ...
    interface IXsdSimpleType {
        // Own properties of GXml-0.16.IXsdSimpleType
        ...
        // Owm methods of GXml-0.16.IXsdSimpleType
        ...
        // Own virtual methods of GXml-0.16.IXsdSimpleType
    ...
    interface IXsdTypeRestriction {
        // Own properties of GXml-0.16.IXsdTypeRestriction
        ...
        // Owm methods of GXml-0.16.IXsdTypeRestriction
        ...
        // Own virtual methods of GXml-0.16.IXsdTypeRestriction
    ...
    interface IXsdTypeRestrictionDef {
        // Own properties of GXml-0.16.IXsdTypeRestrictionDef

        annotation: IXsdAnnotation;

        // Owm methods of GXml-0.16.IXsdTypeRestrictionDef

        get_annotation(): IXsdAnnotation;
        set_annotation(value: IXsdAnnotation): void;

        // Own virtual methods of GXml-0.16.IXsdTypeRestrictionDef
    ...
    interface IXsdTypeRestrictionEnumeration {
        // Own properties of GXml-0.16.IXsdTypeRestrictionEnumeration

        id: string;
        value: string;

        // Owm methods of GXml-0.16.IXsdTypeRestrictionEnumeration
        ...
        // Own virtual methods of GXml-0.16.IXsdTypeRestrictionEnumeration
    ...
    interface IXsdTypeRestrictionWhiteSpace {
        // Own properties of GXml-0.16.IXsdTypeRestrictionWhiteSpace

        fixed: boolean;
        id: string;
        value: string;

        // Owm methods of GXml-0.16.IXsdTypeRestrictionWhiteSpace
        ...
        // Own virtual methods of GXml-0.16.IXsdTypeRestrictionWhiteSpace
    ...
    interface IXsdComplexType {
        // Own properties of GXml-0.16.IXsdComplexType
        ...
        // Owm methods of GXml-0.16.IXsdComplexType
        ...
        // Own virtual methods of GXml-0.16.IXsdComplexType
    ...
    interface IXsdExtension {
        // Own properties of GXml-0.16.IXsdExtension

        base: string;

        // Owm methods of GXml-0.16.IXsdExtension

        get_base(): string;
        set_base(value: string): void;

        // Own virtual methods of GXml-0.16.IXsdExtension
    ...
    interface IXsdElement {
        // Own properties of GXml-0.16.IXsdElement
        ...
        // Owm methods of GXml-0.16.IXsdElement
        ...
        // Own virtual methods of GXml-0.16.IXsdElement
    ...
    interface IXsdBaseContent {
        // Own properties of GXml-0.16.IXsdBaseContent

        anotation: IXsdAnnotation;

        // Owm methods of GXml-0.16.IXsdBaseContent

        get_anotation(): IXsdAnnotation;
        set_anotation(value: IXsdAnnotation): void;

        // Own virtual methods of GXml-0.16.IXsdBaseContent
    ...
    interface IXsdBaseAttribute {
        // Own properties of GXml-0.16.IXsdBaseAttribute

        anotation: IXsdAnnotation;

        // Owm methods of GXml-0.16.IXsdBaseAttribute

        get_anotation(): IXsdAnnotation;
        set_anotation(value: IXsdAnnotation): void;

        // Own virtual methods of GXml-0.16.IXsdBaseAttribute
    ...
    interface IXsdList {
        // Own properties of GXml-0.16.IXsdList
        ...
        // Owm methods of GXml-0.16.IXsdList
        ...
        // Own virtual methods of GXml-0.16.IXsdList
    ...
    interface Serializable {
        // Own properties of GXml-0.16.Serializable
        ...
        // Owm methods of GXml-0.16.Serializable
        ...
        // Own virtual methods of GXml-0.16.Serializable
    ...
    interface SerializableCollection {
        // Owm methods of GXml-0.16.SerializableCollection
        ...
        // Own virtual methods of GXml-0.16.SerializableCollection
    ...
    interface SerializableMapDualKey {
        // Owm methods of GXml-0.16.SerializableMapDualKey

        get_map_primary_key(): any;
        get_map_secondary_key(): any;

        // Own virtual methods of GXml-0.16.SerializableMapDualKey
    ...
    interface SerializableMapKey {
        // Owm methods of GXml-0.16.SerializableMapKey

        get_map_key(): any;

        // Own virtual methods of GXml-0.16.SerializableMapKey

        vfunc_get_map_key(): any;
    }

    interface SerializableProperty {
        // Owm methods of GXml-0.16.SerializableProperty
        ...
        // Own virtual methods of GXml-0.16.SerializableProperty
    ...
    interface Text {
        // Own properties of GXml-0.16.Text

        str: string;

        // Owm methods of GXml-0.16.Text

        get_str(): string;
        set_str(value: string): void;

        // Own virtual methods of GXml-0.16.Text
    ...
    interface XPathObject {
        ...
        // Owm methods of GXml-0.16.XPathObject
        ...
        // Own virtual methods of GXml-0.16.XPathObject

...
GJS TypeScript type definitions for Anthy-9000 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v5.4.0.
...
| `@girs/anthy-9000/vocabulary` | GIR-derived widget data: settable properties, enum nicks, slot candidates |
...
`anthy-9000` declares widgets, so it also carries what the GIR says about them, as
types and as values a test can read:

```ts
import type { Widgets, PropsOf } from '@girs/anthy-9000/vocabulary';
import { OWN_PROPS, ENUM_NICKS, PROVENANCE } from '@girs/anthy-9000/vocabulary';
```

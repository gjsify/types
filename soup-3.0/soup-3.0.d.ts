...
static MESSAGE_ALREADY_IN_QUEUE: number
    ...
    // Constructors of Soup.SessionError

constructor(options: { message: string, code: number});
_init(...args: any[]): void;


    // Own static methods of Soup.SessionError
...
static BAD_ORIGIN: number
    ...
    // Constructors of Soup.WebsocketError

constructor(options: { message: string, code: number});
_init(...args: any[]): void;


    // Own static methods of Soup.WebsocketError
...
static new_options_ping(base_uri: GLib.Uri): Message;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'accept-certificate', callback: ((_source: this, tls_peer_certificate: Gio.TlsCertificate, tls_peer_errors: Gio.TlsCertificateFlags) => boolean)): number
    connect_after(signal: 'accept-certificate', callback: ((_source: this, tls_peer_certificate: Gio.TlsCertificate, tls_peer_errors: Gio.TlsCertificateFlags) => boolean)): number
    emit(signal: 'accept-certificate', tls_peer_certificate: Gio.TlsCertificate, tls_peer_errors: Gio.TlsCertificateFlags): void
    ...
    connect(signal: 'request-certificate', callback: ((_source: this, tls_connection: Gio.TlsClientConnection) => boolean)): number
    connect_after(signal: 'request-certificate', callback: ((_source: this, tls_connection: Gio.TlsClientConnection) => boolean)): number
    emit(signal: 'request-certificate', tls_connection: Gio.TlsClientConnection): void
    connect(signal: 'request-certificate-password', callback: ((_source: this, tls_password: Gio.TlsPassword) => boolean)): number
    connect_after(signal: 'request-certificate-password', callback: ((_source: this, tls_password: Gio.TlsPassword) => boolean)): number
...
class ServerMessage extends GObject.Object {
    ...
    // Constructors of Soup.ServerMessage
...
_init(...args: any[]): void;
    ...
    // Own signals of Soup.ServerMessage
    ...
    // Own methods of Soup.ServerMessage
...
_init(...args: any[]): void;
    ...
    // Own methods of Soup.MessageMetrics

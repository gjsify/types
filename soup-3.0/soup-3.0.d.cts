 ...
 */
export function cookie_parse(header: string | null, origin: GLib.Uri | null): Cookie | null
/**
 ...
 */
export function date_time_new_from_http_string(date_string: string | null): GLib.DateTime | null
/**
 ...
 */
export function date_time_to_string(date: GLib.DateTime, format: DateFormat): string | null
/**
 * Decodes `form`.
 * 
 ...
 */
export function form_decode_multipart(multipart: Multipart, file_control_name: string | null): [ /* returnType */ GLib.HashTable | null, /* filename */ string | null, /* content_type */ string | null, /* file */ GLib.Bytes ]
/**
 ...
 */
export function uri_decode_data_uri(uri: string | null): [ /* returnType */ GLib.Bytes, /* content_type */ string | null ]
/**
 ...
 */
export function websocket_client_verify_handshake(msg: Message, supported_extensions: GObject.TypeClass[] | null): [ /* returnType */ boolean, /* accepted_extensions */ WebsocketExtension[] ]
/**
 ...
 */
export function websocket_server_process_handshake(msg: ServerMessage, expected_origin: string | null, protocols: string[] | null, supported_extensions: GObject.TypeClass[] | null): [ /* returnType */ boolean, /* accepted_extensions */ WebsocketExtension[] ]
/**

 ...
 *
 * 6 instantiable GTypes (of which 1 concrete widgets), 6 declarations, 0 enum nick unions, 0 slot candidates.
 *
...
export interface AmtkActionInfoCentralStoreProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type AmtkActionInfoCentralStoreConstructOnly = never;

export interface AmtkActionInfoStoreProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type AmtkActionInfoStoreConstructOnly = never;

export interface AmtkApplicationWindowProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type AmtkApplicationWindowConstructOnly = 'application-window';

export interface AmtkFactoryProps {
    /**
     ...
     * @since 3.0
     * @default AMTK_FACTORY_FLAGS_NONE
     */
    'default-flags'?: number;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type AmtkFactoryConstructOnly = 'application';

export interface AmtkMenuShellProps {
    /**
     * The #GtkMenuShell.
     * @since 2.0
     */
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type AmtkMenuShellConstructOnly = 'menu-shell';

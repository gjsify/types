...
export namespace GXml {
    ...
    class CssSelectorError extends GLib.Error {
        // Own fields of GXml-0.18.CssSelectorError
        ...
        // Constructors of GXml-0.18.CssSelectorError

        constructor(options: { message: string; code: number });
    }

    class DocumentError extends GLib.Error {
        // Own fields of GXml-0.18.DocumentError

        INVALID_DOCUMENT_ERROR: number;
        INVALID_FILE: number;

        // Constructors of GXml-0.18.DocumentError

        constructor(options: { message: string; code: number });
    }

    class DomError extends GLib.Error {
        // Own fields of GXml-0.18.DomError
        ...
        // Constructors of GXml-0.18.DomError

        constructor(options: { message: string; code: number });
    }

    class EnumerationError extends GLib.Error {
        // Own fields of GXml-0.18.EnumerationError

        INVALID_VALUE: number;
        INVALID_TEXT: number;

        // Constructors of GXml-0.18.EnumerationError

        constructor(options: { message: string; code: number });
    }

    class Error extends GLib.Error {
        // Own fields of GXml-0.18.Error

        NOT_SUPPORTED: number;
        PARSER: number;
        WRITER: number;

        // Constructors of GXml-0.18.Error

        constructor(options: { message: string; code: number });
    }

    class ParserError extends GLib.Error {
        // Own fields of GXml-0.18.ParserError

        INVALID_DATA_ERROR: number;
        INVALID_FILE_ERROR: number;
        INVALID_STREAM_ERROR: number;

        // Constructors of GXml-0.18.ParserError

        constructor(options: { message: string; code: number });
    }

    class IXsdSchemaError extends GLib.Error {
        // Own fields of GXml-0.18.IXsdSchemaError

        INVALIDATION_ERROR: number;

        // Constructors of GXml-0.18.IXsdSchemaError

        constructor(options: { message: string; code: number });
    }

    class SerializableError extends GLib.Error {
        // Own fields of GXml-0.18.SerializableError

        UNSUPPORTED_TYPE_ERROR: number;
        STR_TO_VALUE_ERROR: number;

        // Constructors of GXml-0.18.SerializableError

        constructor(options: { message: string; code: number });
    }

    class SerializableEnumError extends GLib.Error {
        // Own fields of GXml-0.18.SerializableEnumError

        INVALID_VALUE_ERROR: number;
        PARSE_ERROR: number;

        // Constructors of GXml-0.18.SerializableEnumError

        constructor(options: { message: string; code: number });
    }

    class XPathError extends GLib.Error {
        // Own fields of GXml-0.18.XPathError
        ...
        // Constructors of GXml-0.18.XPathError
    ...
    class CssSelectorData extends GObject.Object {
        // Own properties of GXml-0.18.CssSelectorData
    ...
    class CssSelectorParser extends GObject.Object {
        // Own properties of GXml-0.18.CssSelectorParser

        readonly selectors: Gee.List;

        // Constructors of GXml-0.18.CssSelectorParser

        static ['new'](): CssSelectorParser;

        // Owm methods of GXml-0.18.CssSelectorParser
    ...
    class DomNodeFilter extends GObject.Object {
        // Constructors of GXml-0.18.DomNodeFilter
    ...
    class DomElementList extends Gee.ArrayList {
        // Constructors of GXml-0.18.DomElementList
    ...
    class DomEventInit extends GObject.Object {
        // Own properties of GXml-0.18.DomEventInit

        bubbles: boolean;
        cancelable: boolean;

        // Constructors of GXml-0.18.DomEventInit

        static ['new'](): DomEventInit;

        // Owm methods of GXml-0.18.DomEventInit
    ...
    class DomCustomEventInit extends DomEventInit {
        // Own properties of GXml-0.18.DomCustomEventInit

        detail: GObject.Value;

        // Constructors of GXml-0.18.DomCustomEventInit

        static ['new'](): DomCustomEventInit;

        // Owm methods of GXml-0.18.DomCustomEventInit
    ...
    class DomTimeStamp extends GObject.Object {
        // Own properties of GXml-0.18.DomTimeStamp

        time: GLib.DateTime;

        // Constructors of GXml-0.18.DomTimeStamp

        static ['new'](): DomTimeStamp;

        // Owm methods of GXml-0.18.DomTimeStamp
    ...
    class DomMutationObserverInit extends GObject.Object {
        // Own properties of GXml-0.18.DomMutationObserverInit
        ...
        // Constructors of GXml-0.18.DomMutationObserverInit

        static ['new'](): DomMutationObserverInit;

        // Owm methods of GXml-0.18.DomMutationObserverInit
    ...
    class DomErrorName extends GObject.Object {
        // Constructors of GXml-0.18.DomErrorName

        static ['new'](): DomErrorName;

        // Owm methods of GXml-0.18.DomErrorName
    ...
    class ElementList extends Gee.ArrayList {
        // Constructors of GXml-0.18.ElementList
    ...
    class GHtmlDocument extends GDocument {
        // Own properties of GXml-0.18.GHtmlDocument

        readonly default_options: number;
        readonly defaultOptions: number;

        // Constructors of GXml-0.18.GHtmlDocument
        ...
        // Owm methods of GXml-0.18.GHtmlDocument
    ...
    class GomAttr extends GomNode {
        // Constructors of GXml-0.18.GomAttr
    ...
    abstract class BaseCollection extends GObject.Object {
        // Owm methods of GXml-0.18.BaseCollection
    ...
    class GomArrayList extends BaseCollection {
        // Constructors of GXml-0.18.GomArrayList
    ...
    class GomHashMap extends BaseCollection {
        // Constructors of GXml-0.18.GomHashMap

        static ['new'](): GomHashMap;

        // Owm methods of GXml-0.18.GomHashMap
    ...
    class GomHashPairedMap extends BaseCollection {
        // Constructors of GXml-0.18.GomHashPairedMap

        static ['new'](): GomHashPairedMap;

        // Owm methods of GXml-0.18.GomHashPairedMap
    ...
    class GomHashThreeMap extends BaseCollection {
        // Constructors of GXml-0.18.GomHashThreeMap

        static ['new'](): GomHashThreeMap;

        // Owm methods of GXml-0.18.GomHashThreeMap
    ...
    class GomDocument extends GomNode {
        // Constructors of GXml-0.18.GomDocument
        ...
        // Owm methods of GXml-0.18.GomDocument
    ...
    class GomImplementation extends GObject.Object {
        // Constructors of GXml-0.18.GomImplementation
    ...
    class GomDocumentType extends GomNode {
        // Constructors of GXml-0.18.GomDocumentType
    ...
    class GomDocumentFragment extends GomNode {
        // Constructors of GXml-0.18.GomDocumentFragment
    ...
    class GomElement extends GomNode {
        // Own properties of GXml-0.18.GomElement

        parse_children: boolean;
        parseChildren: boolean;
        unparsed: string;

        // Constructors of GXml-0.18.GomElement

        static ['new'](): GomElement;

        // Owm methods of GXml-0.18.GomElement
    ...
    class GomElementAttributes extends Gee.HashMap {
        // Constructors of GXml-0.18.GomElementAttributes
    ...
    class GomNode extends GObject.Object {
        // Constructors of GXml-0.18.GomNode
    ...
    class GomNodeList extends Gee.ArrayList {
        // Constructors of GXml-0.18.GomNodeList
    ...
    abstract class GomBaseProperty extends GObject.Object {
        // Own properties of GXml-0.18.GomBaseProperty

        value: string;

        // Owm methods of GXml-0.18.GomBaseProperty
    ...
    class GomString extends GomBaseProperty {
        // Constructors of GXml-0.18.GomString
    ...
    class GomArrayString extends GomBaseProperty {
        // Constructors of GXml-0.18.GomArrayString

        static ['new'](): GomArrayString;

        // Owm methods of GXml-0.18.GomArrayString
    ...
    class GomXsdArrayString extends GomArrayString {
        // Own properties of GXml-0.18.GomXsdArrayString

        simple_type: string;
        simpleType: string;
        source: Gio.File;

        // Constructors of GXml-0.18.GomXsdArrayString

        static ['new'](): GomXsdArrayString;

        // Owm methods of GXml-0.18.GomXsdArrayString
    ...
    class GomDouble extends GomBaseProperty {
        // Own properties of GXml-0.18.GomDouble

        decimals: number;

        // Constructors of GXml-0.18.GomDouble

        static ['new'](): GomDouble;

        // Owm methods of GXml-0.18.GomDouble
    ...
    class GomFloat extends GomDouble {
        // Constructors of GXml-0.18.GomFloat

        static ['new'](): GomFloat;

        // Owm methods of GXml-0.18.GomFloat
    ...
    class GomInt extends GomBaseProperty {
        // Constructors of GXml-0.18.GomInt

        static ['new'](): GomInt;

        // Owm methods of GXml-0.18.GomInt
    ...
    class GomBoolean extends GomBaseProperty {
        // Constructors of GXml-0.18.GomBoolean

        static ['new'](): GomBoolean;

        // Owm methods of GXml-0.18.GomBoolean
    ...
    class GomEnum extends GomBaseProperty {
        // Own properties of GXml-0.18.GomEnum

        enum_type: GObject.GType;
        enumType: GObject.GType;

        // Constructors of GXml-0.18.GomEnum

        static ['new'](): GomEnum;

        // Owm methods of GXml-0.18.GomEnum
    ...
    class GomDate extends GomBaseProperty {
        // Constructors of GXml-0.18.GomDate

        static ['new'](): GomDate;

        // Owm methods of GXml-0.18.GomDate
    ...
    class GomDateTime extends GomBaseProperty {
        // Own properties of GXml-0.18.GomDateTime

        format: string;

        // Constructors of GXml-0.18.GomDateTime

        static ['new'](): GomDateTime;

        // Owm methods of GXml-0.18.GomDateTime
    ...
    class GomXsdSchema extends GomElement {
        // Own properties of GXml-0.18.GomXsdSchema
        ...
        // Constructors of GXml-0.18.GomXsdSchema

        static ['new'](): GomXsdSchema;

        // Owm methods of GXml-0.18.GomXsdSchema
    ...
    class GomXsdSimpleType extends GomElement {
        // Own properties of GXml-0.18.GomXsdSimpleType
        ...
        // Constructors of GXml-0.18.GomXsdSimpleType

        static ['new'](): GomXsdSimpleType;

        // Owm methods of GXml-0.18.GomXsdSimpleType
    ...
    class GomXsdTypeDefinition extends GomElement {
        // Own properties of GXml-0.18.GomXsdTypeDefinition

        annotation: GomXsdAnnotation;

        // Constructors of GXml-0.18.GomXsdTypeDefinition

        static ['new'](): GomXsdTypeDefinition;

        // Owm methods of GXml-0.18.GomXsdTypeDefinition
    ...
    class GomXsdTypeList extends GomXsdTypeDefinition {
        // Constructors of GXml-0.18.GomXsdTypeList
    ...
    class GomXsdTypeUnion extends GomXsdTypeDefinition {
        // Constructors of GXml-0.18.GomXsdTypeUnion
    ...
    class GomXsdTypeRestriction extends GomXsdTypeDefinition {
        // Own properties of GXml-0.18.GomXsdTypeRestriction
        ...
        // Constructors of GXml-0.18.GomXsdTypeRestriction

        static ['new'](): GomXsdTypeRestriction;

        // Owm methods of GXml-0.18.GomXsdTypeRestriction
    ...
    class GomXsdTypeRestrictionDef extends GomElement {
        // Own properties of GXml-0.18.GomXsdTypeRestrictionDef

        annotation: GomXsdAnnotation;

        // Constructors of GXml-0.18.GomXsdTypeRestrictionDef

        static ['new'](): GomXsdTypeRestrictionDef;

        // Owm methods of GXml-0.18.GomXsdTypeRestrictionDef
    ...
    class GomXsdTypeRestrictionMinExclusive extends GomXsdTypeRestrictionDef {
        // Constructors of GXml-0.18.GomXsdTypeRestrictionMinExclusive
    ...
    class GomXsdTypeRestrictionMinInclusive extends GomXsdTypeRestrictionDef {
        // Constructors of GXml-0.18.GomXsdTypeRestrictionMinInclusive
    ...
    class GomXsdTypeRestrictionMaxExclusive extends GomXsdTypeRestrictionDef {
        // Constructors of GXml-0.18.GomXsdTypeRestrictionMaxExclusive
    ...
    class GomXsdTypeRestrictionMaxInclusive extends GomXsdTypeRestrictionDef {
        // Constructors of GXml-0.18.GomXsdTypeRestrictionMaxInclusive
    ...
    class GomXsdTypeRestrictionTotalDigits extends GomXsdTypeRestrictionDef {
        // Constructors of GXml-0.18.GomXsdTypeRestrictionTotalDigits
    ...
    class GomXsdTypeRestrictionFractionDigits extends GomXsdTypeRestrictionDef {
        // Constructors of GXml-0.18.GomXsdTypeRestrictionFractionDigits
    ...
    class GomXsdTypeRestrictionLength extends GomXsdTypeRestrictionDef {
        // Constructors of GXml-0.18.GomXsdTypeRestrictionLength
    ...
    class GomXsdTypeRestrictionMinLength extends GomXsdTypeRestrictionDef {
        // Constructors of GXml-0.18.GomXsdTypeRestrictionMinLength
    ...
    class GomXsdTypeRestrictionMaxLength extends GomXsdTypeRestrictionDef {
        // Constructors of GXml-0.18.GomXsdTypeRestrictionMaxLength
    ...
    class GomXsdTypeRestrictionEnumeration extends GomXsdTypeRestrictionDef {
        // Own properties of GXml-0.18.GomXsdTypeRestrictionEnumeration

        value: string;

        // Constructors of GXml-0.18.GomXsdTypeRestrictionEnumeration

        static ['new'](): GomXsdTypeRestrictionEnumeration;

        // Owm methods of GXml-0.18.GomXsdTypeRestrictionEnumeration
    ...
    class GomXsdTypeRestrictionWhiteSpace extends GomXsdTypeRestrictionDef {
        // Own properties of GXml-0.18.GomXsdTypeRestrictionWhiteSpace

        fixed: GomXsdTypeRestrictionWhiteSpaceFixed;
        value: string;

        // Constructors of GXml-0.18.GomXsdTypeRestrictionWhiteSpace

        static ['new'](): GomXsdTypeRestrictionWhiteSpace;

        // Owm methods of GXml-0.18.GomXsdTypeRestrictionWhiteSpace
    ...
    class GomXsdTypeRestrictionWhiteSpaceFixed extends GomBoolean {
        // Constructors of GXml-0.18.GomXsdTypeRestrictionWhiteSpaceFixed
    ...
    class GomXsdTypeRestrictionPattern extends GomXsdTypeRestrictionDef {
        // Constructors of GXml-0.18.GomXsdTypeRestrictionPattern
    ...
    class GomXsdTypeRestrictionAssertion extends GomXsdTypeRestrictionDef {
        // Constructors of GXml-0.18.GomXsdTypeRestrictionAssertion
    ...
    class GomXsdTypeRestrictionExplicitTimezone extends GomXsdTypeRestrictionDef {
        // Constructors of GXml-0.18.GomXsdTypeRestrictionExplicitTimezone
    ...
    class GomXsdComplexType extends GomXsdBaseType {
        // Own properties of GXml-0.18.GomXsdComplexType
        ...
        // Constructors of GXml-0.18.GomXsdComplexType

        static ['new'](): GomXsdComplexType;

        // Owm methods of GXml-0.18.GomXsdComplexType
    ...
    class GomXsdExtension extends GomElement {
        // Own properties of GXml-0.18.GomXsdExtension

        base: string;

        // Constructors of GXml-0.18.GomXsdExtension

        static ['new'](): GomXsdExtension;

        // Owm methods of GXml-0.18.GomXsdExtension
    ...
    class GomXsdElement extends GomElement {
        // Own properties of GXml-0.18.GomXsdElement
        ...
        // Constructors of GXml-0.18.GomXsdElement

        static ['new'](): GomXsdElement;

        // Owm methods of GXml-0.18.GomXsdElement
    ...
    class GomXsdAnnotation extends GomElement {
        // Constructors of GXml-0.18.GomXsdAnnotation
    ...
    class GomXsdBaseType extends GomElement {
        // Own properties of GXml-0.18.GomXsdBaseType

        anotation: GomXsdAnnotation;

        // Constructors of GXml-0.18.GomXsdBaseType

        static ['new'](): GomXsdBaseType;

        // Owm methods of GXml-0.18.GomXsdBaseType
    ...
    class GomXsdBaseContent extends GomElement {
        // Own properties of GXml-0.18.GomXsdBaseContent

        anotation: GomXsdAnnotation;

        // Constructors of GXml-0.18.GomXsdBaseContent

        static ['new'](): GomXsdBaseContent;

        // Owm methods of GXml-0.18.GomXsdBaseContent
    ...
    class GomXsdSimpleContent extends GomXsdBaseContent {
        // Constructors of GXml-0.18.GomXsdSimpleContent
    ...
    class GomXsdComplexContent extends GomXsdBaseContent {
        // Constructors of GXml-0.18.GomXsdComplexContent
    ...
    class GomXsdOpenContent extends GomXsdBaseContent {
        // Constructors of GXml-0.18.GomXsdOpenContent
    ...
    class GomXsdBaseAttribute extends GomElement {
        // Own properties of GXml-0.18.GomXsdBaseAttribute

        anotation: GomXsdAnnotation;

        // Constructors of GXml-0.18.GomXsdBaseAttribute

        static ['new'](): GomXsdBaseAttribute;

        // Owm methods of GXml-0.18.GomXsdBaseAttribute
    ...
    class GomXsdAttribute extends GomXsdBaseAttribute {
        // Constructors of GXml-0.18.GomXsdAttribute
    ...
    class GomXsdAttributeGroup extends GomXsdBaseAttribute {
        // Constructors of GXml-0.18.GomXsdAttributeGroup
    ...
    class GomXsdList extends GomArrayList {
        // Own properties of GXml-0.18.GomXsdList

        readonly length: number;

        // Constructors of GXml-0.18.GomXsdList

        static ['new'](): GomXsdList;

        // Owm methods of GXml-0.18.GomXsdList
    ...
    class GomXsdListElements extends GomXsdList {
        // Constructors of GXml-0.18.GomXsdListElements
    ...
    class GomXsdListSimpleTypes extends GomXsdList {
        // Constructors of GXml-0.18.GomXsdListSimpleTypes
    ...
    class GomXsdListComplexTypes extends GomXsdList {
        // Constructors of GXml-0.18.GomXsdListComplexTypes
    ...
    class GomXsdListTypeRestrictionEnumerations extends GomXsdList {
        // Constructors of GXml-0.18.GomXsdListTypeRestrictionEnumerations
    ...
    class GomXsdListTypeRestrictionWhiteSpaces extends GomXsdList {
        // Constructors of GXml-0.18.GomXsdListTypeRestrictionWhiteSpaces
    ...
    class GomCharacterData extends GomNode {
        // Constructors of GXml-0.18.GomCharacterData
    ...
    class GomText extends GomCharacterData {
        // Constructors of GXml-0.18.GomText
    ...
    class GomProcessingInstruction extends GomCharacterData {
        // Constructors of GXml-0.18.GomProcessingInstruction
    ...
    class GomComment extends GomCharacterData {
        // Constructors of GXml-0.18.GomComment
    ...
    class GAttribute extends GNode {
        // Constructors of GXml-0.18.GAttribute
    ...
    class GCDATA extends GNode {
        // Constructors of GXml-0.18.GCDATA
    ...
    class GCharacterData extends GNonDocumentChildNode {
        // Constructors of GXml-0.18.GCharacterData
    ...
    class GChildNode extends GNode {
        // Constructors of GXml-0.18.GChildNode
    ...
    class GNonDocumentChildNode extends GChildNode {
        // Constructors of GXml-0.18.GNonDocumentChildNode
    ...
    class GComment extends GCharacterData {
        // Constructors of GXml-0.18.GComment
    ...
    class GDocument extends GNode {
        // Own fields of GXml-0.18.GDocument

        doc: any;

        // Constructors of GXml-0.18.GDocument
        ...
        // Owm methods of GXml-0.18.GDocument
    ...
    class GImplementation extends GObject.Object {
        // Constructors of GXml-0.18.GImplementation
    ...
    class GDocumentType extends GChildNode {
        // Constructors of GXml-0.18.GDocumentType
    ...
    class GDocumentFragment extends GDocument {
        // Constructors of GXml-0.18.GDocumentFragment
    ...
    class GDomNodeIterator extends GObject.Object {
        // Constructors of GXml-0.18.GDomNodeIterator
    ...
    class GDomTreeWalker extends GObject.Object {
        // Constructors of GXml-0.18.GDomTreeWalker
    ...
    class GDomTokenList extends Gee.ArrayList {
        // Constructors of GXml-0.18.GDomTokenList

        static ['new'](e: DomElement, attr: string): GDomTokenList;

        // Owm methods of GXml-0.18.GDomTokenList
    ...
    class GDomSettableTokenList extends GDomTokenList {
        // Constructors of GXml-0.18.GDomSettableTokenList
    ...
    class GDomHTMLCollection extends Gee.ArrayList {
        // Constructors of GXml-0.18.GDomHTMLCollection
    ...
    class GDomEvent extends GObject.Object {
        // Constructors of GXml-0.18.GDomEvent
    ...
    class GDomCustomEvent extends GDomEvent {
        // Own properties of GXml-0.18.GDomCustomEvent

        readonly detail: GObject.Value;

        // Constructors of GXml-0.18.GDomCustomEvent

        static ['new'](): GDomCustomEvent;

        // Owm methods of GXml-0.18.GDomCustomEvent
    ...
    class GDomRange extends GObject.Object {
        // Constructors of GXml-0.18.GDomRange
    ...
    class GElement extends GNonDocumentChildNode {
        // Constructors of GXml-0.18.GElement
    ...
    class GHashMapAttr extends Gee.AbstractMap {
        // Constructors of GXml-0.18.GHashMapAttr
    ...
    class GHashMapAttrEntry extends Gee.MapEntry {
        // Constructors of GXml-0.18.GHashMapAttrEntry
    ...
    class GHashMapAttrIterator extends GObject.Object {
        // Constructors of GXml-0.18.GHashMapAttrIterator
    ...
    class GListChildren extends Gee.AbstractBidirList {
        // Constructors of GXml-0.18.GListChildren
    ...
    class GListChildrenIterator extends GObject.Object {
        // Constructors of GXml-0.18.GListChildrenIterator
    ...
    class GListNamespaces extends Gee.AbstractList {
        // Constructors of GXml-0.18.GListNamespaces
    ...
    class GListNamespacesIterator extends GObject.Object {
        // Constructors of GXml-0.18.GListNamespacesIterator
    ...
    class GNamespace extends GObject.Object {
        // Constructors of GXml-0.18.GNamespace

        static ['new'](ns: any): GNamespace;

        // Owm methods of GXml-0.18.GNamespace
    ...
    abstract class GNode extends GObject.Object {
        // Own properties of GXml-0.18.GNode
        ...
        // Owm methods of GXml-0.18.GNode
    ...
    class GProcessingInstruction extends GCharacterData {
        // Constructors of GXml-0.18.GProcessingInstruction
    ...
    class GText extends GCharacterData {
        // Constructors of GXml-0.18.GText
    ...
    class GXPathObject extends GObject.Object {
        // Constructors of GXml-0.18.GXPathObject
    ...
    class NodeList extends Gee.ArrayList {
        // Constructors of GXml-0.18.NodeList

        static ['new'](): NodeList;

        // Owm methods of GXml-0.18.NodeList
    ...
    class SerializableBool extends GObject.Object {
        // Constructors of GXml-0.18.SerializableBool

        static ['new'](): SerializableBool;

        // Owm methods of GXml-0.18.SerializableBool
    ...
    abstract class SerializableContainer extends SerializableObjectModel {
        // Owm methods of GXml-0.18.SerializableContainer
    ...
    class SerializableDouble extends GObject.Object {
        // Constructors of GXml-0.18.SerializableDouble

        static ['new'](): SerializableDouble;

        // Owm methods of GXml-0.18.SerializableDouble
    ...
    class SerializableEnum extends GObject.Object {
        // Constructors of GXml-0.18.SerializableEnum

        static with_enum(type: GObject.GType): SerializableEnum;

        static ['new'](): SerializableEnum;

        // Owm methods of GXml-0.18.SerializableEnum
    ...
    class SerializableFloat extends SerializableDouble {
        // Constructors of GXml-0.18.SerializableFloat

        static ['new'](): SerializableFloat;

        // Owm methods of GXml-0.18.SerializableFloat
    ...
    class SerializableArrayList extends Gee.ArrayList {
        // Own properties of GXml-0.18.SerializableArrayList
        ...
        // Constructors of GXml-0.18.SerializableArrayList

        static ['new'](): SerializableArrayList;

        // Owm methods of GXml-0.18.SerializableArrayList
    ...
    class SerializableDualKeyMap extends GObject.Object {
        // Own properties of GXml-0.18.SerializableDualKeyMap
        ...
        // Own fields of GXml-0.18.SerializableDualKeyMap

        storage: Gee.HashMultiMap;

        // Constructors of GXml-0.18.SerializableDualKeyMap

        static ['new'](): SerializableDualKeyMap;

        // Owm methods of GXml-0.18.SerializableDualKeyMap
    ...
    class SerializableHashMap extends Gee.HashMap {
        // Own properties of GXml-0.18.SerializableHashMap

        ignored_serializable_properties: GLib.HashTable<string, GObject.ParamSpec>;
        ignoredSerializableProperties: GLib.HashTable<string, GObject.ParamSpec>;

        // Constructors of GXml-0.18.SerializableHashMap

        static ['new'](): SerializableHashMap;

        // Owm methods of GXml-0.18.SerializableHashMap
    ...
    class SerializableTreeMap extends Gee.TreeMap {
        // Own properties of GXml-0.18.SerializableTreeMap

        ignored_serializable_properties: GLib.HashTable<string, GObject.ParamSpec>;
        ignoredSerializableProperties: GLib.HashTable<string, GObject.ParamSpec>;

        // Constructors of GXml-0.18.SerializableTreeMap

        static ['new'](): SerializableTreeMap;

        // Owm methods of GXml-0.18.SerializableTreeMap
    ...
    class SerializableInt extends SerializableDouble {
        // Constructors of GXml-0.18.SerializableInt

        static ['new'](): SerializableInt;

        // Owm methods of GXml-0.18.SerializableInt
    ...
    abstract class SerializableObjectModel extends GObject.Object {
        // Own properties of GXml-0.18.SerializableObjectModel

        ignored_serializable_properties: GLib.HashTable<string, GObject.ParamSpec>;
        ignoredSerializableProperties: GLib.HashTable<string, GObject.ParamSpec>;

        // Owm methods of GXml-0.18.SerializableObjectModel
    ...
    class SerializableValueList extends GObject.Object {
        // Own fields of GXml-0.18.SerializableValueList

        extra: Gee.ArrayList;

        // Constructors of GXml-0.18.SerializableValueList

        static ['new'](): SerializableValueList;

        // Owm methods of GXml-0.18.SerializableValueList
    ...
    class TAttribute extends TNode {
        // Constructors of GXml-0.18.TAttribute
    ...
    class TCDATA extends TNode {
        // Constructors of GXml-0.18.TCDATA
    ...
    class TComment extends TNode {
        // Constructors of GXml-0.18.TComment
    ...
    class TDocument extends TNode {
        // Constructors of GXml-0.18.TDocument
        ...
        // Owm methods of GXml-0.18.TDocument
    ...
    class TElement extends TNode {
        // Constructors of GXml-0.18.TElement
    ...
    class TNamespace extends TNode {
        // Constructors of GXml-0.18.TNamespace
    ...
    abstract class TNode extends GObject.Object {
        // Own properties of GXml-0.18.TNode
        ...
        // Owm methods of GXml-0.18.TNode
    ...
    class TNodeTChildrenList extends Gee.AbstractBidirList {
        // Constructors of GXml-0.18.TNodeTChildrenList
    ...
    class TProcessingInstruction extends TNode {
        // Constructors of GXml-0.18.TProcessingInstruction
    ...
    class TText extends TNode {
        // Constructors of GXml-0.18.TText
    ...
    class XParser extends GObject.Object {
        // Constructors of GXml-0.18.XParser

        static ['new'](node: DomNode): XParser;

        // Owm methods of GXml-0.18.XParser
    ...
    class Enumeration {
        // Constructors of GXml-0.18.Enumeration

        constructor(properties?: Partial<{}>);

        static ['new'](): Enumeration;

        // Owm methods of GXml-0.18.Enumeration
    ...
    interface Collection {
        // Own properties of GXml-0.18.Collection
    ...
    interface MappeableElement {
        // Owm methods of GXml-0.18.MappeableElement

        get_map_key(): string;

        // Own virtual methods of GXml-0.18.MappeableElement

        vfunc_get_map_key(): string;
    }

    interface Map {
        // Own properties of GXml-0.18.Map
        ...
        // Owm methods of GXml-0.18.Map

        item(key: string): DomElement;
        has_key(key: string): boolean;
        get_attribute_key(): string;
        set_attribute_key(value: string): void;
        get_keys_set(): Gee.Set;

        // Own virtual methods of GXml-0.18.Map

        vfunc_item(key: string): DomElement;
    ...
    interface MappeableElementPairKey {
        // Owm methods of GXml-0.18.MappeableElementPairKey

        get_map_primary_key(): string;
        get_map_secondary_key(): string;

        // Own virtual methods of GXml-0.18.MappeableElementPairKey
    ...
    interface PairedMap {
        // Own properties of GXml-0.18.PairedMap
        ...
        // Owm methods of GXml-0.18.PairedMap

        item(primary_key: string, secondary_key: string): DomElement;
        ...
        // Own virtual methods of GXml-0.18.PairedMap

        vfunc_item(primary_key: string, secondary_key: string): DomElement;
    ...
    interface MappeableElementThreeKey {
        // Owm methods of GXml-0.18.MappeableElementThreeKey

        get_map_pkey(): string;
        get_map_skey(): string;
        get_map_tkey(): string;

        // Own virtual methods of GXml-0.18.MappeableElementThreeKey
    ...
    interface ThreeMap {
        // Own properties of GXml-0.18.ThreeMap
        ...
        // Owm methods of GXml-0.18.ThreeMap

        item(primary_key: string, secondary_key: string, third_key: string): DomElement;
        has_primary_key(key: string): boolean;
        has_secondary_key(pkey: string, key: string): boolean;
        ...
        // Own virtual methods of GXml-0.18.ThreeMap

        vfunc_item(primary_key: string, secondary_key: string, third_key: string): DomElement;
        vfunc_has_primary_key(key: string): boolean;
        vfunc_has_secondary_key(pkey: string, key: string): boolean;
    ...
    interface Attribute {
        // Own properties of GXml-0.18.Attribute

        namespace: Namespace;
        readonly prefix: string;

        // Owm methods of GXml-0.18.Attribute

        get_namespace(): Namespace;
        set_namespace(value: Namespace): void;
        get_prefix(): string;

        // Own virtual methods of GXml-0.18.Attribute
    ...
    interface CDATA {
        // Own properties of GXml-0.18.CDATA

        readonly str: string;

        // Owm methods of GXml-0.18.CDATA

        get_str(): string;

        // Own virtual methods of GXml-0.18.CDATA

        vfunc_get_str(): string;
    }

    interface Character {
        // Own properties of GXml-0.18.Character

        str: string;

        // Owm methods of GXml-0.18.Character

        get_str(): string;
        set_str(value: string): void;

        // Own virtual methods of GXml-0.18.Character
    ...
    interface Comment {
        // Own properties of GXml-0.18.Comment

        str: string;

        // Owm methods of GXml-0.18.Comment

        get_str(): string;
        set_str(value: string): void;

        // Own virtual methods of GXml-0.18.Comment
    ...
    interface Document {
        // Own properties of GXml-0.18.Document
        ...
        // Owm methods of GXml-0.18.Document
        ...
        // Own virtual methods of GXml-0.18.Document
    ...
    interface DomAttr {
        // Own properties of GXml-0.18.DomAttr
        ...
        // Owm methods of GXml-0.18.DomAttr
        ...
        // Own virtual methods of GXml-0.18.DomAttr
    ...
    interface DomCharacterData {
        // Own properties of GXml-0.18.DomCharacterData

        data: string;
        readonly length: number;

        // Owm methods of GXml-0.18.DomCharacterData
        ...
        // Own virtual methods of GXml-0.18.DomCharacterData
    ...
    interface DomText {
        // Own properties of GXml-0.18.DomText

        readonly whole_text: string;
        readonly wholeText: string;

        // Owm methods of GXml-0.18.DomText

        split_text(offset: number): DomText;
        get_whole_text(): string;

        // Own virtual methods of GXml-0.18.DomText
    ...
    interface DomProcessingInstruction {
        // Own properties of GXml-0.18.DomProcessingInstruction

        readonly target: string;

        // Owm methods of GXml-0.18.DomProcessingInstruction

        get_target(): string;

        // Own virtual methods of GXml-0.18.DomProcessingInstruction
    ...
    interface DomNonElementParentNode {
        // Owm methods of GXml-0.18.DomNonElementParentNode

        get_element_by_id(element_id: string): DomElement;

        // Own virtual methods of GXml-0.18.DomNonElementParentNode

        vfunc_get_element_by_id(element_id: string): DomElement;
    }

    interface DomParentNode {
        // Own properties of GXml-0.18.DomParentNode
        ...
        // Owm methods of GXml-0.18.DomParentNode
        ...
        // Own virtual methods of GXml-0.18.DomParentNode
    ...
    interface DomNonDocumentTypeChildNode {
        // Own properties of GXml-0.18.DomNonDocumentTypeChildNode
        ...
        // Owm methods of GXml-0.18.DomNonDocumentTypeChildNode

        get_previous_element_sibling(): DomElement;
        get_next_element_sibling(): DomElement;

        // Own virtual methods of GXml-0.18.DomNonDocumentTypeChildNode
    ...
    interface DomChildNode {
        // Owm methods of GXml-0.18.DomChildNode

        remove(): void;

        // Own virtual methods of GXml-0.18.DomChildNode

        vfunc_remove(): void;
    }

    interface DomNodeList {
        // Own properties of GXml-0.18.DomNodeList

        readonly length: number;

        // Owm methods of GXml-0.18.DomNodeList

        item(index: number): DomNode;
        get_length(): number;

        // Own virtual methods of GXml-0.18.DomNodeList
    ...
    interface DomHTMLCollection {
        // Own properties of GXml-0.18.DomHTMLCollection

        readonly length: number;

        // Owm methods of GXml-0.18.DomHTMLCollection
        ...
        // Own virtual methods of GXml-0.18.DomHTMLCollection
    ...
    interface DomNodeIterator {
        // Own properties of GXml-0.18.DomNodeIterator
        ...
        // Owm methods of GXml-0.18.DomNodeIterator
        ...
        // Own virtual methods of GXml-0.18.DomNodeIterator
    ...
    interface DomTreeWalker {
        // Own properties of GXml-0.18.DomTreeWalker
        ...
        // Owm methods of GXml-0.18.DomTreeWalker
        ...
        // Own virtual methods of GXml-0.18.DomTreeWalker
    ...
    interface DomNamedNodeMap {
        // Own properties of GXml-0.18.DomNamedNodeMap

        readonly length: number;

        // Owm methods of GXml-0.18.DomNamedNodeMap
        ...
        // Own virtual methods of GXml-0.18.DomNamedNodeMap
    ...
    interface DomTokenList {
        // Own properties of GXml-0.18.DomTokenList

        readonly length: number;

        // Owm methods of GXml-0.18.DomTokenList
        ...
        // Own virtual methods of GXml-0.18.DomTokenList
    ...
    interface DomSettableTokenList {
        // Own properties of GXml-0.18.DomSettableTokenList

        value: string;

        // Owm methods of GXml-0.18.DomSettableTokenList

        get_value(): string;
        set_value(value: string): void;

        // Own virtual methods of GXml-0.18.DomSettableTokenList
    ...
    interface DomDocument {
        // Own properties of GXml-0.18.DomDocument
        ...
        // Owm methods of GXml-0.18.DomDocument
        ...
        // Own virtual methods of GXml-0.18.DomDocument
    ...
    interface DomImplementation {
        // Owm methods of GXml-0.18.DomImplementation
        ...
        // Own virtual methods of GXml-0.18.DomImplementation
    ...
    interface DomDocumentType {
        // Own properties of GXml-0.18.DomDocumentType
        ...
        // Owm methods of GXml-0.18.DomDocumentType

        get_name(): string;
        get_public_id(): string;
        get_system_id(): string;

        // Own virtual methods of GXml-0.18.DomDocumentType
    ...
    interface DomHtmlDocument {
        // Owm methods of GXml-0.18.DomHtmlDocument

        read_from_string(str: string): void;
        read_from_string_tolerant(str: string): void;
        to_html(): string;

        // Own virtual methods of GXml-0.18.DomHtmlDocument
    ...
    interface DomElement {
        // Own properties of GXml-0.18.DomElement
        ...
        // Owm methods of GXml-0.18.DomElement
        ...
        // Own virtual methods of GXml-0.18.DomElement
    ...
    interface DomEventTarget {
        // Owm methods of GXml-0.18.DomEventTarget
        ...
        // Own virtual methods of GXml-0.18.DomEventTarget
    ...
    interface DomEventListener {
        // Owm methods of GXml-0.18.DomEventListener

        handle_event(event: DomEvent): void;

        // Own virtual methods of GXml-0.18.DomEventListener

        vfunc_handle_event(event: DomEvent): void;
    }

    interface DomEvent {
        // Own properties of GXml-0.18.DomEvent
        ...
        // Owm methods of GXml-0.18.DomEvent
        ...
        // Own virtual methods of GXml-0.18.DomEvent
    ...
    interface DomCustomEvent {
        // Own properties of GXml-0.18.DomCustomEvent

        readonly detail: GObject.Value;

        // Owm methods of GXml-0.18.DomCustomEvent

        init_custom_event(type: string, bubbles: boolean, cancelable: boolean, detail: GObject.Value): void;
        get_detail(): void;

        // Own virtual methods of GXml-0.18.DomCustomEvent
    ...
    interface DomMutationObserver {
        // Owm methods of GXml-0.18.DomMutationObserver

        observe(target: Node, options: DomMutationObserverInit): void;
        disconnect(): void;
        take_records(): Gee.List;

        // Own virtual methods of GXml-0.18.DomMutationObserver
    ...
    interface DomMutationRecord {
        // Own properties of GXml-0.18.DomMutationRecord
        ...
        // Owm methods of GXml-0.18.DomMutationRecord
        ...
        // Own virtual methods of GXml-0.18.DomMutationRecord
    ...
    interface DomNode {
        // Own properties of GXml-0.18.DomNode
        ...
        // Owm methods of GXml-0.18.DomNode
        ...
        // Own virtual methods of GXml-0.18.DomNode
    ...
    interface DomRange {
        // Own properties of GXml-0.18.DomRange
        ...
        // Owm methods of GXml-0.18.DomRange
        ...
        // Own virtual methods of GXml-0.18.DomRange
    ...
    interface Element {
        // Own properties of GXml-0.18.Element

        readonly tag_name: string;
        readonly tagName: string;
        content: string;

        // Owm methods of GXml-0.18.Element
        ...
        // Own virtual methods of GXml-0.18.Element
    ...
    interface GomObject {
        // Owm methods of GXml-0.18.GomObject
        ...
        // Own virtual methods of GXml-0.18.GomObject
    ...
    interface GomProperty {
        // Own properties of GXml-0.18.GomProperty

        value: string;

        // Owm methods of GXml-0.18.GomProperty

        validate_value(val: string): boolean;
        get_value(): string;
        set_value(value: string): void;

        // Own virtual methods of GXml-0.18.GomProperty
    ...
    interface Namespace {
        // Own properties of GXml-0.18.Namespace

        readonly uri: string;
        readonly prefix: string;

        // Owm methods of GXml-0.18.Namespace

        get_uri(): string;
        get_prefix(): string;

        // Own virtual methods of GXml-0.18.Namespace
    ...
    interface Node {
        // Own properties of GXml-0.18.Node
        ...
        // Own virtual methods of GXml-0.18.Node
    ...
    interface Notation {
        // Own properties of GXml-0.18.Notation
        ...
        // Owm methods of GXml-0.18.Notation

        get_public_id(): string;
        get_external_id(): string;

        // Own virtual methods of GXml-0.18.Notation
    ...
    interface Parser {
        // Own properties of GXml-0.18.Parser

        backup: boolean;
        indent: boolean;
        readonly node: DomNode;

        // Owm methods of GXml-0.18.Parser
        ...
        // Own virtual methods of GXml-0.18.Parser
    ...
    interface ProcessingInstruction {
        // Own properties of GXml-0.18.ProcessingInstruction

        readonly target: string;
        data: string;

        // Owm methods of GXml-0.18.ProcessingInstruction

        get_target(): string;
        get_data(): string;
        set_data(value: string): void;

        // Own virtual methods of GXml-0.18.ProcessingInstruction
    ...
    interface IXsdSchema {
        // Own properties of GXml-0.18.IXsdSchema
        ...
        // Owm methods of GXml-0.18.IXsdSchema
        ...
        // Own virtual methods of GXml-0.18.IXsdSchema
    ...
    interface IXsdBaseType {
        // Own properties of GXml-0.18.IXsdBaseType

        anotation: IXsdAnnotation;

        // Owm methods of GXml-0.18.IXsdBaseType

        get_anotation(): IXsdAnnotation;
        set_anotation(value: IXsdAnnotation): void;

        // Own virtual methods of GXml-0.18.IXsdBaseType
    ...
    interface IXsdSimpleType {
        // Own properties of GXml-0.18.IXsdSimpleType
        ...
        // Owm methods of GXml-0.18.IXsdSimpleType
        ...
        // Own virtual methods of GXml-0.18.IXsdSimpleType
    ...
    interface IXsdTypeRestriction {
        // Own properties of GXml-0.18.IXsdTypeRestriction
        ...
        // Owm methods of GXml-0.18.IXsdTypeRestriction
        ...
        // Own virtual methods of GXml-0.18.IXsdTypeRestriction
    ...
    interface IXsdTypeRestrictionDef {
        // Own properties of GXml-0.18.IXsdTypeRestrictionDef

        annotation: IXsdAnnotation;

        // Owm methods of GXml-0.18.IXsdTypeRestrictionDef

        get_annotation(): IXsdAnnotation;
        set_annotation(value: IXsdAnnotation): void;

        // Own virtual methods of GXml-0.18.IXsdTypeRestrictionDef
    ...
    interface IXsdTypeRestrictionEnumeration {
        // Own properties of GXml-0.18.IXsdTypeRestrictionEnumeration

        id: string;
        value: string;

        // Owm methods of GXml-0.18.IXsdTypeRestrictionEnumeration
        ...
        // Own virtual methods of GXml-0.18.IXsdTypeRestrictionEnumeration
    ...
    interface IXsdTypeRestrictionWhiteSpace {
        // Own properties of GXml-0.18.IXsdTypeRestrictionWhiteSpace

        fixed: boolean;
        id: string;
        value: string;

        // Owm methods of GXml-0.18.IXsdTypeRestrictionWhiteSpace
        ...
        // Own virtual methods of GXml-0.18.IXsdTypeRestrictionWhiteSpace
    ...
    interface IXsdComplexType {
        // Own properties of GXml-0.18.IXsdComplexType
        ...
        // Owm methods of GXml-0.18.IXsdComplexType
        ...
        // Own virtual methods of GXml-0.18.IXsdComplexType
    ...
    interface IXsdExtension {
        // Own properties of GXml-0.18.IXsdExtension

        base: string;

        // Owm methods of GXml-0.18.IXsdExtension

        get_base(): string;
        set_base(value: string): void;

        // Own virtual methods of GXml-0.18.IXsdExtension
    ...
    interface IXsdElement {
        // Own properties of GXml-0.18.IXsdElement
        ...
        // Owm methods of GXml-0.18.IXsdElement
        ...
        // Own virtual methods of GXml-0.18.IXsdElement
    ...
    interface IXsdBaseContent {
        // Own properties of GXml-0.18.IXsdBaseContent

        anotation: IXsdAnnotation;

        // Owm methods of GXml-0.18.IXsdBaseContent

        get_anotation(): IXsdAnnotation;
        set_anotation(value: IXsdAnnotation): void;

        // Own virtual methods of GXml-0.18.IXsdBaseContent
    ...
    interface IXsdBaseAttribute {
        // Own properties of GXml-0.18.IXsdBaseAttribute

        anotation: IXsdAnnotation;

        // Owm methods of GXml-0.18.IXsdBaseAttribute

        get_anotation(): IXsdAnnotation;
        set_anotation(value: IXsdAnnotation): void;

        // Own virtual methods of GXml-0.18.IXsdBaseAttribute
    ...
    interface IXsdList {
        // Own properties of GXml-0.18.IXsdList
        ...
        // Owm methods of GXml-0.18.IXsdList
        ...
        // Own virtual methods of GXml-0.18.IXsdList
    ...
    interface Serializable {
        // Own properties of GXml-0.18.Serializable
        ...
        // Owm methods of GXml-0.18.Serializable
        ...
        // Own virtual methods of GXml-0.18.Serializable
    ...
    interface SerializableCollection {
        // Owm methods of GXml-0.18.SerializableCollection
        ...
        // Own virtual methods of GXml-0.18.SerializableCollection
    ...
    interface SerializableMapDualKey {
        // Owm methods of GXml-0.18.SerializableMapDualKey

        get_map_primary_key(): any;
        get_map_secondary_key(): any;

        // Own virtual methods of GXml-0.18.SerializableMapDualKey
    ...
    interface SerializableMapKey {
        // Owm methods of GXml-0.18.SerializableMapKey

        get_map_key(): any;

        // Own virtual methods of GXml-0.18.SerializableMapKey

        vfunc_get_map_key(): any;
    }

    interface SerializableProperty {
        // Owm methods of GXml-0.18.SerializableProperty
        ...
        // Own virtual methods of GXml-0.18.SerializableProperty
    ...
    interface Text {
        // Own properties of GXml-0.18.Text

        str: string;

        // Owm methods of GXml-0.18.Text

        get_str(): string;
        set_str(value: string): void;

        // Own virtual methods of GXml-0.18.Text
    ...
    interface XPathObject {
        ...
        // Owm methods of GXml-0.18.XPathObject
        ...
        // Own virtual methods of GXml-0.18.XPathObject

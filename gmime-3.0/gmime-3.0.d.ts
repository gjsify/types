 ...
 */
function utils_decode_8bit(options: ParserOptions | null, text: Uint8Array): string | null
/**
 ...
 */
function utils_header_format_date(date: GLib.DateTime): string | null
/**
 ...
 * @param str input string
 */
function utils_unquote_string(str: string | null): void
/**

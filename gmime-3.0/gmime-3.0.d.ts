...
export namespace GMime {
    ...
    class ApplicationPkcs7Mime extends Part {
        // Own fields of GMime-3.0.ApplicationPkcs7Mime

        parent_object: Part;
        smime_type: SecureMimeType;

        // Constructors of GMime-3.0.ApplicationPkcs7Mime

        static ['new'](type: SecureMimeType): ApplicationPkcs7Mime;

        // Owm methods of GMime-3.0.ApplicationPkcs7Mime
    ...
    class AutocryptHeader extends GObject.Object {
         ...
         */
        set_keydata(keydata: GLib.Bytes): void;
        /**
    ...
    class AutocryptHeaderList extends GObject.Object {
        // Own fields of GMime-3.0.AutocryptHeaderList

        parent_object: GObject.Object;

        // Constructors of GMime-3.0.AutocryptHeaderList

        static ['new'](): AutocryptHeaderList;

        // Owm methods of GMime-3.0.AutocryptHeaderList
    ...
    class Certificate extends GObject.Object {
        // Own fields of GMime-3.0.Certificate
        ...
        // Constructors of GMime-3.0.Certificate

        static ['new'](): Certificate;

        // Owm methods of GMime-3.0.Certificate
    ...
    class CertificateList extends GObject.Object {
        // Own fields of GMime-3.0.CertificateList

        parent_object: GObject.Object;
        array: any[];

        // Constructors of GMime-3.0.CertificateList

        static ['new'](): CertificateList;

        // Owm methods of GMime-3.0.CertificateList
    ...
    class ContentDisposition extends GObject.Object {
        // Own fields of GMime-3.0.ContentDisposition

        parent_object: GObject.Object;
        disposition: string;
        params: ParamList;

        // Constructors of GMime-3.0.ContentDisposition

        static ['new'](): ContentDisposition;

        // Owm methods of GMime-3.0.ContentDisposition
    ...
    class ContentType extends GObject.Object {
        // Own fields of GMime-3.0.ContentType
        ...
        // Constructors of GMime-3.0.ContentType

        static ['new'](type: string, subtype: string): ContentType;

        // Owm methods of GMime-3.0.ContentType
    ...
    class CryptoContext extends GObject.Object {
        // Own fields of GMime-3.0.CryptoContext

        parent_object: GObject.Object;
        request_passwd: PasswordRequestFunc;

        // Constructors of GMime-3.0.CryptoContext

        static ['new'](protocol: string): CryptoContext;

        // Owm methods of GMime-3.0.CryptoContext
    ...
    class DataWrapper extends GObject.Object {
        // Own fields of GMime-3.0.DataWrapper

        parent_object: GObject.Object;
        encoding: ContentEncoding;
        stream: Stream;

        // Constructors of GMime-3.0.DataWrapper

        static ['new'](): DataWrapper;

        static new_with_stream(stream: Stream, encoding: ContentEncoding): DataWrapper;

        // Owm methods of GMime-3.0.DataWrapper
    ...
    class DecryptResult extends GObject.Object {
        // Own fields of GMime-3.0.DecryptResult
        ...
        // Constructors of GMime-3.0.DecryptResult

        static ['new'](): DecryptResult;

        // Owm methods of GMime-3.0.DecryptResult
    ...
    abstract class Filter extends GObject.Object {
        // Own fields of GMime-3.0.Filter
        ...
        // Owm methods of GMime-3.0.Filter
         ...
         */
        complete(inbuf: Uint8Array, prespace: number): void;
        /**
         ...
         * @param prespace prespace buffer length
         */
        filter(inbuf: Uint8Array, prespace: number): void;
        /**
         * Resets the filter.
         */
        reset(): void;
    ...
    class FilterBasic extends Filter {
        // Own fields of GMime-3.0.FilterBasic

        parent_object: Filter;

        // Constructors of GMime-3.0.FilterBasic
    ...
    class FilterBest extends Filter {
        // Own fields of GMime-3.0.FilterBest
        ...
        // Constructors of GMime-3.0.FilterBest

        static ['new'](flags: FilterBestFlags): FilterBest;

        // Owm methods of GMime-3.0.FilterBest
    ...
    class FilterCharset extends Filter {
        // Own fields of GMime-3.0.FilterCharset

        parent_object: Filter;
        from_charset: string;
        to_charset: string;

        // Constructors of GMime-3.0.FilterCharset
    ...
    class FilterChecksum extends Filter {
        // Own fields of GMime-3.0.FilterChecksum

        parent_object: Filter;

        // Constructors of GMime-3.0.FilterChecksum

        static ['new'](type: GLib.ChecksumType): FilterChecksum;

        // Owm methods of GMime-3.0.FilterChecksum
    ...
    class FilterDos2Unix extends Filter {
        // Own fields of GMime-3.0.FilterDos2Unix

        parent_object: Filter;
        ensure_newline: boolean;
        pc: number;

        // Constructors of GMime-3.0.FilterDos2Unix
    ...
    class FilterEnriched extends Filter {
        // Own fields of GMime-3.0.FilterEnriched

        parent_object: Filter;
        flags: number;
        nofill: number;

        // Constructors of GMime-3.0.FilterEnriched
    ...
    class FilterFrom extends Filter {
        // Own fields of GMime-3.0.FilterFrom

        parent_object: Filter;
        mode: FilterFromMode;
        midline: boolean;

        // Constructors of GMime-3.0.FilterFrom
    ...
    class FilterGZip extends Filter {
        // Own fields of GMime-3.0.FilterGZip
        ...
        // Constructors of GMime-3.0.FilterGZip

        static ['new'](mode: FilterGZipMode, level: number): FilterGZip;

        // Owm methods of GMime-3.0.FilterGZip
    ...
    class FilterHTML extends Filter {
        // Own fields of GMime-3.0.FilterHTML
        ...
        // Constructors of GMime-3.0.FilterHTML
    ...
    class FilterOpenPGP extends Filter {
        // Own fields of GMime-3.0.FilterOpenPGP

        parent_object: Filter;

        // Constructors of GMime-3.0.FilterOpenPGP

        static ['new'](): FilterOpenPGP;

        // Owm methods of GMime-3.0.FilterOpenPGP
    ...
    class FilterSmtpData extends Filter {
        // Own fields of GMime-3.0.FilterSmtpData

        parent_object: Filter;
        bol: boolean;

        // Constructors of GMime-3.0.FilterSmtpData
    ...
    class FilterStrip extends Filter {
        // Own fields of GMime-3.0.FilterStrip

        parent_object: Filter;

        // Constructors of GMime-3.0.FilterStrip
    ...
    class FilterUnix2Dos extends Filter {
        // Own fields of GMime-3.0.FilterUnix2Dos

        parent_object: Filter;
        ensure_newline: boolean;
        pc: number;

        // Constructors of GMime-3.0.FilterUnix2Dos
    ...
    class FilterWindows extends Filter {
        // Own fields of GMime-3.0.FilterWindows

        parent_object: Filter;
        is_windows: boolean;
        claimed_charset: string;

        // Constructors of GMime-3.0.FilterWindows

        static ['new'](claimed_charset: string): FilterWindows;

        // Owm methods of GMime-3.0.FilterWindows
    ...
    class FilterYenc extends Filter {
        // Own fields of GMime-3.0.FilterYenc
        ...
        // Constructors of GMime-3.0.FilterYenc

        static ['new'](encode: boolean): FilterYenc;

        // Owm methods of GMime-3.0.FilterYenc
    ...
    class GpgContext extends CryptoContext {
        // Constructors of GMime-3.0.GpgContext
    ...
    class Header extends GObject.Object {
        // Owm methods of GMime-3.0.Header
    ...
    class HeaderList extends GObject.Object {
        // Own fields of GMime-3.0.HeaderList

        parent_object: GObject.Object;

        // Constructors of GMime-3.0.HeaderList

        static ['new'](options?: ParserOptions | null): HeaderList;

        // Owm methods of GMime-3.0.HeaderList
    ...
    abstract class InternetAddress extends GObject.Object {
        // Own fields of GMime-3.0.InternetAddress

        parent_object: GObject.Object;
        charset: string;
        name: string;

        // Owm methods of GMime-3.0.InternetAddress
    ...
    class InternetAddressGroup extends InternetAddress {
        // Own fields of GMime-3.0.InternetAddressGroup

        parent_object: InternetAddress;
        members: InternetAddressList;

        // Constructors of GMime-3.0.InternetAddressGroup

        static ['new'](name: string): InternetAddressGroup;

        // Owm methods of GMime-3.0.InternetAddressGroup
    ...
    class InternetAddressList extends GObject.Object {
        // Own fields of GMime-3.0.InternetAddressList

        parent_object: GObject.Object;
        array: any[];

        // Constructors of GMime-3.0.InternetAddressList

        static ['new'](): InternetAddressList;

        // Owm methods of GMime-3.0.InternetAddressList
    ...
    class InternetAddressMailbox extends InternetAddress {
        // Own fields of GMime-3.0.InternetAddressMailbox
        ...
        // Constructors of GMime-3.0.InternetAddressMailbox

        static ['new'](name: string, addr: string): InternetAddressMailbox;

        // Owm methods of GMime-3.0.InternetAddressMailbox
    ...
    class Message extends Object {
        // Own fields of GMime-3.0.Message
        ...
        // Constructors of GMime-3.0.Message

        static ['new'](pretty_headers: boolean): Message;

        // Owm methods of GMime-3.0.Message
    ...
    class MessagePart extends Object {
        // Own fields of GMime-3.0.MessagePart

        parent_object: Object;
        message: Message;

        // Constructors of GMime-3.0.MessagePart

        static ['new'](subtype: string): MessagePart;

        static new_with_message(subtype: string, message: Message): MessagePart;

        // Owm methods of GMime-3.0.MessagePart
    ...
    class MessagePartial extends Part {
        // Own fields of GMime-3.0.MessagePartial
        ...
        // Constructors of GMime-3.0.MessagePartial

        static ['new'](id: string, number: number, total: number): MessagePartial;

        // Owm methods of GMime-3.0.MessagePartial
    ...
    class Multipart extends Object {
        // Own fields of GMime-3.0.Multipart
        ...
        // Constructors of GMime-3.0.Multipart

        static ['new'](): Multipart;

        static new_with_subtype(subtype: string): Multipart;

        // Owm methods of GMime-3.0.Multipart
    ...
    class MultipartEncrypted extends Multipart {
        // Own fields of GMime-3.0.MultipartEncrypted

        parent_object: Multipart;

        // Constructors of GMime-3.0.MultipartEncrypted

        static ['new'](): MultipartEncrypted;

        // Owm methods of GMime-3.0.MultipartEncrypted
         ...
         * @returns the decrypted MIME part on success or %NULL on fail. If the decryption fails, an exception will be set on @err to provide information as to why the failure occurred.
         */
        decrypt(flags: DecryptFlags, session_key: string): Object | null;
    }
    ...
    class MultipartSigned extends Multipart {
        // Own fields of GMime-3.0.MultipartSigned

        parent_object: Multipart;

        // Constructors of GMime-3.0.MultipartSigned

        static ['new'](): MultipartSigned;

        // Owm methods of GMime-3.0.MultipartSigned
    ...
    abstract class Object extends GObject.Object {
        // Own fields of GMime-3.0.Object
        ...
        // Constructors of GMime-3.0.Object
        ...
        // Owm methods of GMime-3.0.Object
    ...
    class Param extends GObject.Object {
        ...
        // Owm methods of GMime-3.0.Param
    ...
    class ParamList extends GObject.Object {
        // Constructors of GMime-3.0.ParamList

        static ['new'](): ParamList;

        // Owm methods of GMime-3.0.ParamList
    ...
    class Parser extends GObject.Object {
        // Own fields of GMime-3.0.Parser

        parent_object: GObject.Object;
        priv: any;

        // Constructors of GMime-3.0.Parser

        static ['new'](): Parser;

        static new_with_stream(stream: Stream): Parser;

        // Owm methods of GMime-3.0.Parser
    ...
    class Part extends Object {
        ...
        // Constructors of GMime-3.0.Part

        static ['new'](): Part;

        static new_with_type(type: string, subtype: string): Part;

        // Owm methods of GMime-3.0.Part
    ...
    class Pkcs7Context extends CryptoContext {
        // Constructors of GMime-3.0.Pkcs7Context
    ...
    class Signature extends GObject.Object {
        // Own fields of GMime-3.0.Signature
        ...
        // Constructors of GMime-3.0.Signature

        static ['new'](): Signature;

        // Owm methods of GMime-3.0.Signature
    ...
    class SignatureList extends GObject.Object {
        // Own fields of GMime-3.0.SignatureList

        parent_object: GObject.Object;

        // Constructors of GMime-3.0.SignatureList

        static ['new'](): SignatureList;

        // Owm methods of GMime-3.0.SignatureList
    ...
    abstract class Stream extends GObject.Object {
        // Owm methods of GMime-3.0.Stream
    ...
    class StreamBuffer extends Stream {
        // Own fields of GMime-3.0.StreamBuffer
        ...
        // Constructors of GMime-3.0.StreamBuffer
    ...
    class StreamCat extends Stream {
        // Own fields of GMime-3.0.StreamCat

        parent_object: Stream;
        sources: any;
        current: any;

        // Constructors of GMime-3.0.StreamCat

        static ['new'](): StreamCat;

        // Owm methods of GMime-3.0.StreamCat
    ...
    class StreamFile extends Stream {
        // Own fields of GMime-3.0.StreamFile

        parent_object: Stream;
        owner: boolean;
        fp: any;

        // Constructors of GMime-3.0.StreamFile

        static ['new'](fp?: any | null): StreamFile;

        static new_with_bounds(fp: any | null, start: number, end: number): StreamFile;

        // Owm methods of GMime-3.0.StreamFile
    ...
    class StreamFilter extends Stream {
        // Own fields of GMime-3.0.StreamFilter
        ...
        // Constructors of GMime-3.0.StreamFilter

        static ['new'](stream: Stream): StreamFilter;

        // Owm methods of GMime-3.0.StreamFilter
    ...
    class StreamFs extends Stream {
        // Own fields of GMime-3.0.StreamFs
    ...
    class StreamGIO extends Stream {
        // Own fields of GMime-3.0.StreamGIO
    ...
    class StreamMem extends Stream {
        // Own fields of GMime-3.0.StreamMem

        parent_object: Stream;
        buffer: Uint8Array;
        owner: boolean;

        // Constructors of GMime-3.0.StreamMem
        ...
        // Owm methods of GMime-3.0.StreamMem
    ...
    class StreamMmap extends Stream {
        // Own fields of GMime-3.0.StreamMmap
        ...
        // Constructors of GMime-3.0.StreamMmap
        ...
        // Owm methods of GMime-3.0.StreamMmap
    ...
    class StreamNull extends Stream {
        // Own fields of GMime-3.0.StreamNull
        ...
        // Constructors of GMime-3.0.StreamNull

        static ['new'](): StreamNull;

        // Owm methods of GMime-3.0.StreamNull
    ...
    class StreamPipe extends Stream {
        // Own fields of GMime-3.0.StreamPipe
        ...
        // Constructors of GMime-3.0.StreamPipe

        static ['new'](fd: number): StreamPipe;

        // Owm methods of GMime-3.0.StreamPipe
    ...
    class TextPart extends Part {
        // Own fields of GMime-3.0.TextPart

        parent_object: Part;

        // Constructors of GMime-3.0.TextPart

        static ['new'](): TextPart;

        static new_with_subtype(subtype: string): TextPart;

        // Owm methods of GMime-3.0.TextPart
    ...
    class ApplicationPkcs7MimeClass {}

    class AutocryptHeaderClass {}

    class AutocryptHeaderListClass {}

    class CertificateClass {}

    class CertificateListClass {}

    /**
     * State used by g_mime_charset_best() and g_mime_charset_best_name().
     */
    class Charset {
        // Own fields of GMime-3.0.Charset

        mask: number;
        level: number;

        // Constructors of GMime-3.0.Charset
        ...
        // Owm methods of GMime-3.0.Charset
         ...
         * `charset-&`gt;mask with the mask for each glyph. This has the effect of
         * limiting what charsets our `charset-&`gt;mask can match.
    ...
    class DecryptResultClass {}

    /**
     * A context used for encoding or decoding data.
     */
    class Encoding {
        // Own fields of GMime-3.0.Encoding
        ...
        // Owm methods of GMime-3.0.Encoding
    ...
    class FilterBasicClass {}

    class FilterBestClass {}

    class FilterCharsetClass {}

    class FilterChecksumClass {}

    class FilterClass {}

    class FilterDos2UnixClass {}

    class FilterEnrichedClass {}

    class FilterFromClass {}

    class FilterGZipClass {}

    class FilterHTMLClass {}

    class FilterOpenPGPClass {}

    class FilterSmtpDataClass {}

    class FilterStripClass {}

    class FilterUnix2DosClass {}

    class FilterWindowsClass {}

    class FilterYencClass {}

    /**
     * Format options for serializing various GMime objects.
     */
    class FormatOptions {
        // Constructors of GMime-3.0.FormatOptions

        constructor(properties?: Partial<{}>);

        static ['new'](): FormatOptions;

        // Owm methods of GMime-3.0.FormatOptions
    ...
    class HeaderListClass {}

    class InternetAddressClass {}

    class InternetAddressGroupClass {}

    class InternetAddressListClass {}

    class InternetAddressMailboxClass {}

    class MessageClass {}

    class MessagePartClass {}

    class MessagePartialClass {}
     ...
     */
    class OpenPGPMarker {
        // Own fields of GMime-3.0.OpenPGPMarker
     ...
     */
    class ParserOptions {
        // Constructors of GMime-3.0.ParserOptions

        constructor(properties?: Partial<{}>);

        static ['new'](): ParserOptions;

        // Owm methods of GMime-3.0.ParserOptions
     ...
     */
    class PartIter {
        // Constructors of GMime-3.0.PartIter

        constructor(toplevel: Object);

        static ['new'](toplevel: Object): PartIter;

        // Owm methods of GMime-3.0.PartIter
     ...
     */
    class References {
        // Own fields of GMime-3.0.References

        array: any[];

        // Constructors of GMime-3.0.References
        ...
        // Owm methods of GMime-3.0.References
    ...
    class SignatureListClass {}

    class StreamBufferClass {}

    class StreamCatClass {}
    ...
    class StreamGIOClass {}

    /**
     * An I/O vector for use with g_mime_stream_writev().
     */
    class StreamIOVector {
        // Own fields of GMime-3.0.StreamIOVector

        data: any;
        len: number;

        // Constructors of GMime-3.0.StreamIOVector
    ...
    class StreamMmapClass {}

    class StreamNullClass {}

    class StreamPipeClass {}

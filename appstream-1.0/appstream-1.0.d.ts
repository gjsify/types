 ...
 */
function agreement_kind_from_string(value: string | null): AgreementKind
/**
 * Converts the enumerated value to an text representation.
 * @param value the #AsAgreementKind.
 * @returns string version of @value
 */
function agreement_kind_to_string(value: AgreementKind): string | null
/**
 * Converts the text representation to an enumerated value.
 * @param kind the string.
 * @returns a #AsArtifactKind, or %AS_ARTIFACT_KIND_UNKNOWN for unknown.
 */
function artifact_kind_from_string(kind: string | null): ArtifactKind
/**
 * Converts the enumerated value to an text representation.
 * @param kind the #AsArtifactKind.
 * @returns string version of @kind
 */
function artifact_kind_to_string(kind: ArtifactKind): string | null
/**
 * Converts the text representation to an enumerated value.
 * @param bundle_str the string.
 * @returns a #AsBundleKind or %AS_BUNDLE_KIND_UNKNOWN for unknown
 */
function bundle_kind_from_string(bundle_str: string | null): BundleKind
/**
 * Converts the enumerated value to an text representation.
 * @param kind the %AsBundleKind.
 * @returns string version of @kind
 */
function bundle_kind_to_string(kind: BundleKind): string | null
/**
 * Converts the text representation to an enumerated value.
 * @param kind_str the string.
 * @returns a #AsChecksumKind or %AS_CHECKSUM_KIND_NONE for unknown
 */
function checksum_kind_from_string(kind_str: string | null): ChecksumKind
/**
 * Converts the enumerated value to an text representation.
 * @param kind the %AsChecksumKind.
 * @returns string version of @kind
 */
function checksum_kind_to_string(kind: ChecksumKind): string | null
/**
 * Converts the text representation to an enumerated value.
 * @param str the string.
 * @returns a #AsColorKind or %AS_COLOR_KIND_UNKNOWN for unknown.
 */
function color_kind_from_string(str: string | null): ColorKind
/**
 * Converts the enumerated value to an text representation.
 * @param kind the %AsColorKind.
 * @returns string version of @kind
 */
function color_kind_to_string(kind: ColorKind): string | null
/**
 * Converts the text representation to an enumerated value.
 * @param str the string.
 * @returns a #AsColorKind or %AS_COLOR_SCHEME_KIND_UNKNOWN for unknown.
 */
function color_scheme_kind_from_string(str: string | null): ColorSchemeKind
/**
 * Converts the enumerated value to an text representation.
 * @param kind the %AsColorSchemeKind.
 * @returns string version of @kind
 */
function color_scheme_kind_to_string(kind: ColorSchemeKind): string | null
/**
 * Converts the text representation to an enumerated value.
 * @param kind_str the string.
 * @returns a #AsComponentKind or %AS_COMPONENT_KIND_UNKNOWN for unknown
 */
function component_kind_from_string(kind_str: string | null): ComponentKind
/**
 * Converts the enumerated value to an text representation.
 * @param kind the #AsComponentKind.
 * @returns string version of @kind
 */
function component_kind_to_string(kind: ComponentKind): string | null
/**
 * Converts the text representation to an enumerated value.
 * @param scope_str the string.
 * @returns a #AsComponentScope or %AS_COMPONENT_SCOPE_UNKNOWN for unknown
 */
function component_scope_from_string(scope_str: string | null): ComponentScope
/**
 * Converts the enumerated value to an text representation.
 * @param scope the #AsComponentScope.
 * @returns string version of @scope
 */
function component_scope_to_string(scope: ComponentScope): string | null
/**
 ...
 */
function content_rating_system_from_locale(locale: string | null): ContentRatingSystem
/**
 ...
 */
function content_rating_value_from_string(value: string | null): ContentRatingValue
/**
 * Converts the enumerated value to an text representation.
 * @param value the #AsContentRatingValue.
 * @returns string version of @value
 */
function content_rating_value_to_string(value: ContentRatingValue): string | null
/**
 * Converts the text representation to an enumerated value.
 * @param kind_str the string.
 * @returns a #AsControlKind or %AS_CONTROL_KIND_UNKNOWN for unknown
 */
function control_kind_from_string(kind_str: string | null): ControlKind
/**
 * Converts the enumerated value to a text representation.
 * @param kind the #AsControlKind.
 * @returns string version of @kind
 */
function control_kind_to_string(kind: ControlKind): string | null
/**
 * Converts the text representation to an enumerated value.
 * @param kind_str the string.
 * @returns a #AsDisplayLengthKind or %AS_DISPLAY_LENGTH_KIND_UNKNOWN for unknown
 */
function display_length_kind_from_string(kind_str: string | null): DisplayLengthKind
/**
 * Converts the enumerated value to a text representation.
 * @param kind the #AsDisplayLengthKind.
 * @returns string version of @kind
 */
function display_length_kind_to_string(kind: DisplayLengthKind): string | null
/**
 * Converts the text representation to an enumerated value.
 * @param kind_str the string.
 * @returns a #AsDisplaySideKind or %AS_DISPLAY_SIDE_KIND_UNKNOWN for unknown
 */
function display_side_kind_from_string(kind_str: string | null): DisplaySideKind
/**
 * Converts the enumerated value to a text representation.
 * @param kind the #AsDisplaySideKind.
 * @returns string version of @kind
 */
function display_side_kind_to_string(kind: DisplaySideKind): string | null
/**
 * Converts the text representation to an enumerated value.
 * @param kind_str the string.
 * @returns a #AsFormatKind or %AS_FORMAT_KIND_UNKNOWN for unknown
 */
function format_kind_from_string(kind_str: string | null): FormatKind
/**
 * Converts the enumerated value to an text representation.
 * @param kind the #AsFormatKind.
 * @returns string version of @kind
 */
function format_kind_to_string(kind: FormatKind): string | null
/**
 * Converts the text representation to an enumerated value.
 * @param version_str the string.
 * @returns a #AsFormatVersion. For unknown, the highest version number is assumed.
 */
function format_version_from_string(version_str: string | null): FormatVersion
/**
 * Converts the enumerated value to an text representation.
 ...
 */
function get_current_distro_component_id(): string | null
/**
 ...
 */
function icon_kind_from_string(kind_str: string | null): IconKind
/**
 * Converts the enumerated value to an text representation.
 * @param kind the %AsIconKind.
 * @returns string version of @kind
 */
function icon_kind_to_string(kind: IconKind): string | null
/**
 * Converts the text representation to an enumerated value.
 * @param kind the string.
 * @returns a #AsImageKind, or %AS_IMAGE_KIND_UNKNOWN for unknown.
 */
function image_kind_from_string(kind: string | null): ImageKind
/**
 * Converts the enumerated value to an text representation.
 * @param kind the #AsImageKind.
 * @returns string version of @kind
 */
function image_kind_to_string(kind: ImageKind): string | null
/**
 * Converts the text representation to an enumerated value.
 * @param kind_str the string.
 * @returns a #AsInternetKind or %AS_INTERNET_KIND_UNKNOWN for unknown
 */
function internet_kind_from_string(kind_str: string | null): InternetKind
/**
 * Converts the enumerated value to a text representation.
 * @param kind the #AsInternetKind.
 * @returns string version of @kind
 */
function internet_kind_to_string(kind: InternetKind): string | null
/**
 ...
 */
function is_spdx_license_exception_id(exception_id: string | null): boolean
/**
 ...
 */
function is_spdx_license_expression(license: string | null): boolean
/**
 * Searches the known list of SPDX license IDs.
 * @param license_id a single SPDX license ID, e.g. "GPL-3.0"
 * @returns %TRUE if the string is a valid SPDX license ID
 */
function is_spdx_license_id(license_id: string | null): boolean
/**
 * Converts the text representation to an enumerated value.
 * @param kind_str the string.
 * @returns a #AsIssueKind or %AS_ISSUE_KIND_UNKNOWN for unknown
 */
function issue_kind_from_string(kind_str: string | null): IssueKind
/**
 * Converts the enumerated value to an text representation.
 * @param kind the %AsIssueKind.
 * @returns string version of @kind
 */
function issue_kind_to_string(kind: IssueKind): string | null
/**
 * Converts the text representation to an enumerated value.
 * @param str the string.
 * @returns a #AsIssueSeverity, or %AS_ISSUE_SEVERITY_UNKNOWN for unknown.
 */
function issue_severity_from_string(str: string | null): IssueSeverity
/**
 * Converts the enumerated value to an text representation.
 * @param severity the #AsIssueSeverity.
 * @returns string version of @severity
 */
function issue_severity_to_string(severity: IssueSeverity): string | null
/**
 * Converts the text representation to an enumerated value.
 * @param kind_str the string.
 * @returns a #AsLaunchableKind or %AS_LAUNCHABLE_KIND_UNKNOWN for unknown
 */
function launchable_kind_from_string(kind_str: string | null): LaunchableKind
/**
 * Converts the enumerated value to a text representation.
 * @param kind the #AsLaunchableKind.
 * @returns string version of @kind
 */
function launchable_kind_to_string(kind: LaunchableKind): string | null
/**
 ...
 */
function license_is_free_license(license: string | null): boolean
/**
 ...
 */
function license_is_metadata_license(license: string | null): boolean
/**
 ...
 */
function license_is_metadata_license_id(license_id: string | null): boolean
/**
 ...
 */
function license_to_spdx_id(license: string | null): string | null
 ...
 */
function merge_kind_from_string(kind_str: string | null): MergeKind
/**
 * Converts the enumerated value to an text representation.
 * @param kind the #AsMergeKind.
 * @returns string version of @kind
 */
function merge_kind_to_string(kind: MergeKind): string | null
 ...
 */
function provided_kind_from_string(kind_str: string | null): ProvidedKind
/**
 ...
 */
function provided_kind_to_l10n_string(kind: ProvidedKind): string | null
/**
 * Converts the enumerated value to a text representation.
 * @param kind the #AsProvidedKind.
 * @returns string version of @kind
 */
function provided_kind_to_string(kind: ProvidedKind): string | null
/**
 * Converts the text representation to an enumerated value.
 * @param compare_str the string.
 * @returns a #AsRelationCompare, or %AS_RELATION_COMPARE_UNKNOWN for unknown.
 */
function relation_compare_from_string(compare_str: string | null): RelationCompare
/**
 * Converts the enumerated value to an text representation.
 ...
 */
function relation_compare_to_string(compare: RelationCompare): string | null
/**
 * Converts the enumerated value to an text representation.
 ...
 * @returns string version of @compare
 */
function relation_compare_to_symbols_string(compare: RelationCompare): string | null
 ...
 */
function relation_item_kind_from_string(kind_str: string | null): RelationItemKind
/**
 * Converts the enumerated value to a text representation.
 * @param kind the #AsRelationKind.
 * @returns string version of @kind
 */
function relation_item_kind_to_string(kind: RelationItemKind): string | null
/**
 * Converts the text representation to an enumerated value.
 * @param kind_str the string.
 * @returns a #AsRelationKind or %AS_RELATION_KIND_UNKNOWN for unknown
 */
function relation_kind_from_string(kind_str: string | null): RelationKind
/**
 * Converts the enumerated value to a text representation.
 * @param kind the #AsRelationKind.
 * @returns string version of @kind
 */
function relation_kind_to_string(kind: RelationKind): string | null
/**
 * Converts the text representation to an enumerated value.
 * @param kind_str the string.
 * @returns an #AsReleaseKind or %AS_RELEASE_KIND_UNKNOWN for unknown
 */
function release_kind_from_string(kind_str: string | null): ReleaseKind
/**
 * Converts the enumerated value to an text representation.
 * @param kind the #AsReleaseKind.
 * @returns string version of @kind
 */
function release_kind_to_string(kind: ReleaseKind): string | null
/**
 * Converts the text representation to an enumerated value.
 * @param kind_str the string.
 * @returns an #AsReleaseUrlKind or %AS_RELEASE_URL_KIND_UNKNOWN for unknown
 */
function release_url_kind_from_string(kind_str: string | null): ReleaseUrlKind
/**
 * Converts the enumerated value to an text representation.
 * @param kind the #AsReleaseUrlKind.
 * @returns string version of @kind
 */
function release_url_kind_to_string(kind: ReleaseUrlKind): string | null
/**
 * Converts the text representation to an enumerated value.
 * @param kind_str the string.
 * @returns an #AsReleaseKind or %AS_RELEASE_KIND_UNKNOWN for unknown
 */
function releases_kind_from_string(kind_str: string | null): ReleasesKind
/**
 * Converts the enumerated value to an text representation.
 * @param kind the #AsReleaseKind.
 * @returns string version of @kind
 */
function releases_kind_to_string(kind: ReleasesKind): string | null
/**
 * Converts the text representation to an enumerated value.
 * @param kind the string.
 * @returns a %AsScreenshotKind, or %AS_SCREENSHOT_KIND_UNKNOWN if not known.
 */
function screenshot_kind_from_string(kind: string | null): ScreenshotKind
/**
 * Converts the enumerated value to an text representation.
 * @param kind the #AsScreenshotKind.
 * @returns string version of @kind
 */
function screenshot_kind_to_string(kind: ScreenshotKind): string | null
/**
 * Converts the text representation to an enumerated value.
 ...
 */
function spdx_license_detokenize(license_tokens: string | null): string | null
/**
 ...
 */
function spdx_license_tokenize(license: string | null): string[] | null
/**
 * Converts the text representation to an enumerated value.
 * @param kind_str the string.
 * @returns a #AsSuggestedKind or %AS_SUGGESTED_KIND_UNKNOWN for unknown
 */
function suggested_kind_from_string(kind_str: string | null): SuggestedKind
/**
 * Converts the enumerated value to an text representation.
 * @param kind the %AsSuggestedKind.
 * @returns string version of @kind
 */
function suggested_kind_to_string(kind: SuggestedKind): string | null
 ...
 */
function translation_kind_from_string(kind_str: string | null): TranslationKind
/**
 * Converts the enumerated value to a text representation.
 * @param kind the #AsTranslationKind.
 * @returns string version of @kind
 */
function translation_kind_to_string(kind: TranslationKind): string | null
/**
 * Converts the text representation to an enumerated value.
 ...
 */
function utils_data_id_equal(data_id1: string | null, data_id2: string | null): boolean
/**
 * Get the component-id part of the data-id.
 * @param data_id The data-id.
 */
function utils_data_id_get_cid(data_id: string | null): string | null
/**
 ...
 */
function utils_data_id_hash(data_id: string | null): number
/**
 ...
 */
function utils_data_id_match(data_id1: string | null, data_id2: string | null, match_flags: DataIdMatchFlags): boolean
/**
 ...
 */
function utils_data_id_valid(data_id: string | null): boolean
 ...
 */
function utils_guess_scope_from_path(path: string | null): ComponentScope
/**
 ...
 */
function utils_install_metadata_file(location: MetadataLocation, filename: string | null, origin: string | null, destdir: string | null): boolean
function utils_is_category_name(category_name: string | null): boolean
/**
 ...
 */
function utils_is_desktop_environment(desktop: string | null): boolean
/**
 ...
 */
function utils_is_platform_triplet(triplet: string | null): boolean
/**
 ...
 */
function utils_is_tld(tld: string | null): boolean
/**
 ...
 * @returns >>0 if a is newer than b;     0 if a and b are the same version;     <<0 if b is newer than a
 */
function vercmp_simple(a: string | null, b: string | null): number
/**
 ...
 */
function vercmp_test_match(ver1: string | null, compare: RelationCompare, ver2: string | null, flags: VercmpFlags): boolean
/**
 * Get the version of the AppStream library that is currently used
 ...
 */
function video_codec_kind_from_string(str: string | null): VideoCodecKind
/**
 * Converts the enumerated value to an text representation.
 * @param kind the #AsVideoCodecKind.
 * @returns string version of @codec
 */
function video_codec_kind_to_string(kind: VideoCodecKind): string | null
/**
 * Converts the text representation to an enumerated value.
 * @param str the string.
 * @returns a #AsVideoContainerKind, or %AS_VIDEO_CONTAINER_KIND_UNKNOWN for unknown.
 */
function video_container_kind_from_string(str: string | null): VideoContainerKind
/**
 * Converts the enumerated value to an text representation.
 * @param kind the #AsVideoContainerKind.
 * @returns string version of @kind
 */
function video_container_kind_to_string(kind: VideoContainerKind): string | null
module Agreement {

 ...
 *
 * GENERATED — do not edit. Provenance: Ide-47 — library 47.0.0 — dropped empty base(s): GObject.InitiallyUnowned GObject.Object Gio.ActionGroup Gio.ActionMap
 *
...
import type { AdwActionRowConstructOnly, AdwActionRowProps, AdwApplicationWindowConstructOnly, AdwApplicationWindowProps, AdwComboRowConstructOnly, AdwComboRowProps, AdwDialogConstructOnly, AdwDialogProps, AdwPreferencesRowConstructOnly, AdwPreferencesRowProps, AdwToolbarStyleNick, AdwWindowConstructOnly, AdwWindowProps } from '@girs/adw-1/vocabulary';

/**
 * The GIR-derived widget VOCABULARY for Ide-47.
 *
 * GENERATED — do not edit. Provenance: Ide-47 — library 47.0.0 — dropped empty base(s): GtkSource.CompletionProposal — prop(s) no TypeScript value satisfies: Ide.TaskCache.key-copy-func Ide.TaskCache.key-destroy-func Ide.TaskCache.key-equal-func Ide.TaskCache.key-hash-func Ide.TaskCache.populate-callback Ide.TaskCache.populate-callback-data Ide.TaskCache.populate-callback-data-destroy Ide.TaskCache.value-copy-func Ide.TaskCache.value-destroy-func
 *
 * 181 instantiable GTypes (of which 36 concrete widgets), 196 declarations, 21 enum nick unions, 9 slot candidates.
 *
...
import type Ide from './ide-47.js';
...
export interface IdeSearchPopoverProps extends AdwDialogProps, GtkAccessibleProps, GtkBuildableProps, GtkConstraintTargetProps {
    'search-engine'?: Ide.SearchEngine;
    /** @default TRUE */
    'show-preview'?: boolean;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type IdeSearchPopoverConstructOnly = AdwDialogConstructOnly | GtkAccessibleConstructOnly | GtkBuildableConstructOnly | GtkConstraintTargetConstructOnly | 'search-engine';

 ...
 */
function tagImageDataToImageSample(imageData: Uint8Array, imageType: TagImageType): Gst.Sample | null
/**
 ...
 * @returns A new #GstTagList with all tags that could be extracted from the          given vorbiscomment buffer or NULL on error.
 */
function tagListFromVorbiscomment(data: Uint8Array, idData: Uint8Array): [ /* returnType */ Gst.TagList | null, /* vendorString */ string | null ]
/**
 * Creates a new tag list that contains the information parsed out of a
 * vorbiscomment packet.
 * @param buffer buffer to convert
 ...
 * @returns A new #GstTagList with all tags that could be extracted from the          given vorbiscomment buffer or NULL on error.
 */
function tagListFromVorbiscommentBuffer(buffer: Gst.Buffer, idData: Uint8Array): [ /* returnType */ Gst.TagList | null, /* vendorString */ string | null ]
/**
 ...
 */
function tagListNewFromId3v1(data: Uint8Array): Gst.TagList | null
/**

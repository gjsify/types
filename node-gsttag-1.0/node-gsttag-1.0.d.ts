 ...
 */
function tagCheckLanguageCode(langCode: string | null): boolean
/**
 ...
 */
function tagFreeformStringToUtf8(data: number[], envVars: string[]): string | null
/**
 * Looks up the GStreamer tag for a ID3v2 tag.
 * @param id3Tag ID3v2 tag to convert to GStreamer tag
 * @returns The corresponding GStreamer tag or NULL if none exists.
 */
function tagFromId3Tag(id3Tag: string | null): string | null
/**
 ...
 * @returns The corresponding GStreamer tag or NULL if none exists.
 */
function tagFromId3UserTag(type: string | null, id3UserTag: string | null): string | null
/**
 * Looks up the GStreamer tag for a vorbiscomment tag.
 * @param vorbisTag vorbiscomment tag to convert to GStreamer tag
 * @returns The corresponding GStreamer tag or NULL if none exists.
 */
function tagFromVorbisTag(vorbisTag: string | null): string | null
/**
 ...
 */
function tagGetLanguageCodeIso6391(langCode: string | null): string | null
/**
 ...
 */
function tagGetLanguageCodeIso6392B(langCode: string | null): string | null
/**
 ...
 * @returns three-letter ISO-639-2 language code string that maps to @lang_code,     or NULL if no mapping is known. The returned string must not be     modified or freed.
 */
function tagGetLanguageCodeIso6392T(langCode: string | null): string | null
/**
 ...
 */
function tagGetLanguageName(languageCode: string | null): string | null
/**
 ...
 */
function tagGetLicenseDescription(licenseRef: string | null): string | null
/**
 ...
 */
function tagGetLicenseFlags(licenseRef: string | null): TagLicenseFlags
/**
 ...
 */
function tagGetLicenseJurisdiction(licenseRef: string | null): string | null
/**
 ...
 */
function tagGetLicenseNick(licenseRef: string | null): string | null
/**
 ...
 */
function tagGetLicenseTitle(licenseRef: string | null): string | null
/**
 * Get the version of a license.
 * @param licenseRef a license reference string in form of a URI,     e.g. "http://creativecommons.org/licenses/by-nc-nd/2.0/"
 * @returns the version of the license, or NULL if the license is not known or    has no version
 */
function tagGetLicenseVersion(licenseRef: string | null): string | null
/**
 ...
 */
function tagId3GenreGet(id: number): string | null
/**
 ...
 */
function tagImageDataToImageSample(imageData: number[], imageType: TagImageType): Gst.Sample | null
/**
 ...
 */
function tagListAddId3Image(tagList: Gst.TagList, imageData: number[], id3PictureType: number): boolean
/**
 ...
 */
function tagListFromId3v2Tag(buffer: Gst.Buffer): Gst.TagList | null
/**
 * Creates a new tag list that contains the information parsed out of a
 ...
 * @returns A new #GstTagList with all tags that could be extracted from the          given vorbiscomment buffer or NULL on error.
 */
function tagListFromVorbiscomment(data: number[], idData: number[]): [ /* returnType */ Gst.TagList | null, /* vendorString */ string | null ]
/**
 * Creates a new tag list that contains the information parsed out of a
 * vorbiscomment packet.
 * @param buffer buffer to convert
 ...
 * @returns A new #GstTagList with all tags that could be extracted from the          given vorbiscomment buffer or NULL on error.
 */
function tagListFromVorbiscommentBuffer(buffer: Gst.Buffer, idData: number[]): [ /* returnType */ Gst.TagList | null, /* vendorString */ string | null ]
/**
 * Parse a xmp packet into a taglist.
 * @param buffer buffer
 * @returns new taglist or %NULL, free the list when done
 */
function tagListFromXmpBuffer(buffer: Gst.Buffer): Gst.TagList | null
/**
 ...
 */
function tagListNewFromId3v1(data: number[]): Gst.TagList | null
/**
 ...
 */
function tagListToVorbiscommentBuffer(list: Gst.TagList, idData: number[], vendorString: string | null): Gst.Buffer
/**
 ...
 */
function tagListToXmpBuffer(list: Gst.TagList, readOnly: boolean, schemas: string[]): Gst.Buffer | null
/**
 ...
 */
function tagParseExtendedComment(extComment: string | null, failIfNoKey: boolean): [ /* returnType */ boolean, /* key */ string | null, /* lang */ string | null, /* value */ string | null ]
/**
 ...
 */
function tagToId3Tag(gstTag: string | null): string | null
/**
 * Creates a new tag list that contains the information parsed out of a
 * vorbiscomment packet.
 ...
 */
function tagToVorbisComments(list: Gst.TagList, tag: string | null): string[]
/**
 * Looks up the vorbiscomment tag for a GStreamer tag.
 * @param gstTag GStreamer tag to convert to vorbiscomment tag
 * @returns The corresponding vorbiscomment tag or NULL if none exists.
 */
function tagToVorbisTag(gstTag: string | null): string | null
/**
 ...
 */
function vorbisTagAdd(list: Gst.TagList, tag: string | null, value: string | null): void
module TagXmpWriter {

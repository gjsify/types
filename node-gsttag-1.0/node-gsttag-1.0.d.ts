 ...
 */
function tagFromId3Tag(id3Tag: string): string | null
/**
 ...
 * @returns The corresponding GStreamer tag or NULL if none exists.
 */
function tagFromId3UserTag(type: string, id3UserTag: string): string | null
/**
 * Looks up the GStreamer tag for a vorbiscomment tag.
 * @param vorbisTag vorbiscomment tag to convert to GStreamer tag
 * @returns The corresponding GStreamer tag or NULL if none exists.
 */
function tagFromVorbisTag(vorbisTag: string): string | null
/**
 ...
 */
function tagGetLanguageCodeIso6391(langCode: string): string | null
/**
 ...
 */
function tagGetLanguageCodeIso6392B(langCode: string): string | null
/**
 ...
 * @returns three-letter ISO-639-2 language code string that maps to @lang_code,     or NULL if no mapping is known. The returned string must not be     modified or freed.
 */
function tagGetLanguageCodeIso6392T(langCode: string): string | null
/**
 ...
 */
function tagGetLanguageName(languageCode: string): string | null
/**
 ...
 */
function tagGetLicenseDescription(licenseRef: string): string | null
/**
 ...
 */
function tagGetLicenseJurisdiction(licenseRef: string): string | null
/**
 ...
 */
function tagGetLicenseNick(licenseRef: string): string | null
/**
 ...
 */
function tagGetLicenseTitle(licenseRef: string): string | null
/**
 * Get the version of a license.
 * @param licenseRef a license reference string in form of a URI,     e.g. "http://creativecommons.org/licenses/by-nc-nd/2.0/"
 * @returns the version of the license, or NULL if the license is not known or    has no version
 */
function tagGetLicenseVersion(licenseRef: string): string | null
/**
 ...
 * @returns A new #GstTagList with all tags that could be extracted from the          given vorbiscomment buffer or NULL on error.
 */
function tagListFromVorbiscomment(data: number[], idData: number[]): [ /* returnType */ Gst.TagList | null, /* vendorString */ string ]
/**
 * Creates a new tag list that contains the information parsed out of a
 * vorbiscomment packet.
 * @param buffer buffer to convert
 ...
 * @returns A new #GstTagList with all tags that could be extracted from the          given vorbiscomment buffer or NULL on error.
 */
function tagListFromVorbiscommentBuffer(buffer: Gst.Buffer, idData: number[]): [ /* returnType */ Gst.TagList | null, /* vendorString */ string ]
/**
 ...
 */
function tagParseExtendedComment(extComment: string, failIfNoKey: boolean): [ /* returnType */ boolean, /* key */ string | null, /* lang */ string | null, /* value */ string | null ]
/**
 ...
 */
function tagToId3Tag(gstTag: string): string | null
/**
 * Creates a new tag list that contains the information parsed out of a
 * vorbiscomment packet.
 ...
 */
function tagToVorbisTag(gstTag: string): string | null
/**

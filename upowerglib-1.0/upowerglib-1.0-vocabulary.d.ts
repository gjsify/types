/**
 * The GIR-derived widget VOCABULARY for UPowerGlib-1.0.
 *
 * GENERATED — do not edit. Provenance: UPowerGlib-1.0 — library 1.91.3
 *
...
export interface UpClientProps extends GObjectProps, GAsyncInitableProps, GInitableProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type UpClientConstructOnly = GObjectConstructOnly | GAsyncInitableConstructOnly | GInitableConstructOnly;

export interface UpDeviceProps extends GObjectProps {
    /**
     ...
     * @default -1
     */
    'charge-cycles'?: number;
    /**
     * The charge end threshold of a battery.
     * @since 1.90.5
     * @default 100
     */
    'charge-end-threshold'?: number;
    /**
     * The charge start threshold of a battery.
     * @since 1.90.5
     * @default 0
     */
    'charge-start-threshold'?: number;
    /**
     * The charge threshold of a battery is enabled, or false if unknown or non-applicable.
     * @since 1.90.5
     * @default FALSE
     */
    'charge-threshold-enabled'?: boolean;
    /**
     * The charge threshold of a battery is supported, or false if unknown or non-applicable.
     * @since 1.90.5
     * @default FALSE
     */
    'charge-threshold-supported'?: boolean;
    /**
     * The energy left in the device.
     * @since 0.9.0
     * @default 0.000000
     */
    energy?: number;
    /**
     * The energy the device will have when it is empty.
     * @since 0.9.0
     * @default 0.000000
     */
    'energy-empty'?: number;
    ...
    'energy-full'?: number;
    /**
     * The amount of energy when the device was brand new.
     * @since 0.9.0
     * @default 0.000000
     */
    'energy-full-design'?: number;
    /**
    ...
    voltage?: number;
    /** @default 0.000000 */
    'voltage-max-design'?: number;
    /** @default 0.000000 */
    'voltage-min-design'?: number;
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type UpDeviceConstructOnly = GObjectConstructOnly;

export interface UpHistoryItemProps extends GObjectProps {
    /**
     * @since 0.9.0
     * @default 0
     */
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type UpHistoryItemConstructOnly = GObjectConstructOnly;

export interface UpStatsItemProps extends GObjectProps {
    /**
     * @since 0.9.0
     * @default 0.000000
     */
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type UpStatsItemConstructOnly = GObjectConstructOnly;

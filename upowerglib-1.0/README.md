...
GJS TypeScript type definitions for UPowerGlib-1.0, generated from library version 1.90.2 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v4.0.0-beta.3.

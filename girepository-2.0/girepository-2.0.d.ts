 ...
 * @param throws TODO
 */
function callable_info_invoke(info: CallableInfo, function_: any | null, in_args: Argument[], out_args: Argument[], return_value: Argument, is_method: boolean, throws: boolean): boolean
/**
 ...
 */
function callable_info_iterate_return_attributes(info: CallableInfo, iterator: AttributeIter): [ /* returnType */ boolean, /* iterator */ AttributeIter, /* name */ string | null, /* value */ string | null ]
/**
...
function cclosure_marshal_generic(closure: GObject.TClosure, return_gvalue: any, n_param_values: number, param_values: any, invocation_hint: any | null, marshal_data: any | null): void
/**

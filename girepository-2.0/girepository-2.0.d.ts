...
export namespace GIRepository {
     ...
     * @param info a #GIArgInfo
     */
    function arg_info_load_type(info: ArgInfo): void;
    /**
     ...
     */
    function callable_info_iterate_return_attributes(info: CallableInfo, iterator: AttributeIter): boolean;
    /**
     ...
     * @param n the argument index to fetch
     */
    function callable_info_load_arg(info: CallableInfo, n: number): void;
    /**
     ...
     * @param info a #GICallableInfo
     */
    function callable_info_load_return_type(info: CallableInfo): void;
    /**
     ...
     * @returns the #GIFunctionInfo. Free the struct by calling g_base_info_unref() when done.
     */
    function object_info_find_method_using_interfaces(info: ObjectInfo, name: string): FunctionInfo | null;
    /**
     * TODO
     * @param info a #GIObjectInfo
     * @param name Name of signal
     ...
     * @returns the #GIVFuncInfo. Free the struct by calling g_base_info_unref() when done.
     */
    function object_info_find_vfunc_using_interfaces(info: ObjectInfo, name: string): VFuncInfo | null;
    /**
    ...
    class Repository extends GObject.Object {
        // Owm methods of GIRepository-2.0.Repository
         ...
         */
        get_object_gtype_interfaces(gtype: GObject.GType): void;
        /**
     ...
     */
    class AttributeIter {
        // Constructors of GIRepository-2.0.AttributeIter
     ...
     */
    class BaseInfo {
        // Constructors of GIRepository-2.0.BaseInfo

        constructor(properties?: Partial<{}>);

        // Owm methods of GIRepository-2.0.BaseInfo
         ...
         * @returns %TRUE if there are more attributes
         */
        iterate_attributes(iterator: AttributeIter): boolean;
    }
     ...
     */
    class Typelib {
        // Owm methods of GIRepository-2.0.Typelib
     ...
     */
    class Argument {
        // Own fields of GIRepository-2.0.Argument
        ...
        // Constructors of GIRepository-2.0.Argument

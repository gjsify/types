...
export namespace Meta {
     ...
     * @default meta-cursor
     */
    const CURSOR_EXTENSION_POINT_NAME: string;
     ...
     * @param callback 
     */
    function read_bytes(fd: number, offset: number, length: number, callback: Gio.AsyncReadyCallback<number> | null): void;
    /**
     * @param fd 
     * @param offset 
     * @param length 
     * @param callback 
     */
    function read_bytes(fd: number, offset: number, length: number, callback: Gio.AsyncReadyCallback<number> | null): globalThis.Promise<boolean> | void;
     ...
     * @gir-type Flags
     */
    export namespace ExternalConstraintFlags {
        export const $gtype: GObject.GType<ExternalConstraintFlags>;
    }

    /**
     * @gir-type Flags
     */
    enum ExternalConstraintFlags {
        NONE = 0,
        MOVE = 1,
        RESIZE = 2,
    }
     ...
     * @gir-type Flags
     */
    export namespace IdleMonitorWatchFlags {
        export const $gtype: GObject.GType<IdleMonitorWatchFlags>;
    }
    ...
    enum IdleMonitorWatchFlags {
        ...
        UNINHIBITABLE = 1,
        /**
         * Start idle timer now and ignore any
         *   previous idle time
         */
        START_NOW = 2,
    }
    ...
    namespace Backend {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
             ...
             * @run-last
             */
            "override-cursor": () => Clutter.CursorType;
            /**
             * @signal
             * @run-last
             */
             ...
             * @run-last
             */
            "reset-keymap-description": () => KeymapDescription;
            /**
             * @signal
             * @run-last
             */
            "reset-keymap-layout-index": () => number;
            "notify::capabilities": (pspec: GObject.ParamSpec) => void;
            "notify::context": (pspec: GObject.ParamSpec) => void;
            "notify::last-input-device": (pspec: GObject.ParamSpec) => void;
        }
        ...
        interface ConstructorProps extends GObject.Object.ConstructorProps, Gio.Initable.ConstructorProps {
            ...
            context: Context;
            last_input_device: Clutter.InputDevice | null;
            lastInputDevice: Clutter.InputDevice | null;
        }
    }
    ...
    abstract class Backend extends GObject.Object implements Gio.Initable {
         ...
         * @read-only
         */
        get last_input_device(): Clutter.InputDevice | null;

        /**
         * @read-only
         */
        get lastInputDevice(): Clutter.InputDevice | null;
        ...
        /**
         * Returns the {@link Meta.LogicalMonitor} that currently has the mouse pointer.
         * @returns The current {@link Meta.LogicalMonitor}.
         */
         ...
         * @returns The current keymap description.
         */
        get_keymap_description(): KeymapDescription;

        /**
         * Gets the last input device that had the focus.
         * @returns a {@link Clutter.InputDevice}, or `null` if no device has the focus
         */
        get_last_input_device(): Clutter.InputDevice | null;
         ...
         * @param cancellable 
         */
        set_keymap_async(description: KeymapDescription, layout_index: number, cancellable: Gio.Cancellable | null): globalThis.Promise<boolean>;
         ...
         * @param callback 
         */
        set_keymap_async(description: KeymapDescription, layout_index: number, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback<this> | null): void;
         ...
         * @param callback 
         */
        set_keymap_async(description: KeymapDescription, layout_index: number, cancellable: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback<this> | null): globalThis.Promise<boolean> | void;
    ...
    abstract class Backlight extends GObject.Object {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof Backlight.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, Backlight.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof Backlight.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, Backlight.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof Backlight.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<Backlight.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
    ...
    abstract class Compositor extends GObject.Object {
        ...
        /**
         * @returns The input panel group corresponding to `display`
         */
        get_input_panel_group(): Clutter.Actor;
    ...
    class Context extends GObject.Object {
        ...
        /**
         * Get the {@link Meta.WaylandCompositor} associated with the MetaContext.
    ...
    namespace Cursor {
        // Signal signatures
        interface SignalSignatures extends Clutter.Cursor.SignalSignatures {
            "notify::backend": (pspec: GObject.ParamSpec) => void;
            "notify::size": (pspec: GObject.ParamSpec) => void;
        ...
        // Constructor properties interface
        interface ConstructorProps extends Clutter.Cursor.ConstructorProps {
            backend: Backend;
            size: number;
            theme_name: string;
            themeName: string;
     ...
     * @gir-type Class
     */
    abstract class Cursor extends Clutter.Cursor {
        ...
        // Methods
        /**
         * Gets the {@link Meta.Backend} of the cursor
         * @returns the backend
         */
        get_backend(): Backend;
    ...
    namespace Display {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
             ...
             * @run-last
             */
            "grab-op-begin": (object: Window, p0: GrabOp, p1: Clutter.Sprite) => void;
            /**
             * @signal
             * @run-last
             */
             ...
             * @run-last
             */
            "modifiers-accelerator-activated": () => void;
            /**
             * @signal
             * @run-last
             */
    ...
    class IdleMonitor extends GObject.Object {
         ...
         * @returns a watch id Adds a watch for a specific idle time. The callback will be called when the user has accumulated `interval_msec` milliseconds of idle time. This function will return an ID that can either be passed to `meta_idle_monitor_remove_watch()`, or can be used to tell idle time watches apart if you have more than one. The idle watch is affected by idle inhibitors and takes into account the idle time from before the watch was added. `meta_idle_monitor_add_idle_watch_full()` allows creating idle watches with different behavior. Also note that this function will only care about positive transitions (user's idle time exceeding a certain time). If you want to know about when the user has become active, use `meta_idle_monitor_add_user_active_watch()`.
         */
         ...
         * @param interval_msec The idletime interval, in milliseconds
         * @param callback The callback to call when the user has     accumulated `interval_msec` milliseconds of idle time.
         * @param flags Flags for the idle watch
         * @returns a watch id This function is identical to `meta_idle_monitor_add_idle_watch()`, with the addition of a flags parameter to modify the behavior of the idle watch.
         */
        add_idle_watch_full(interval_msec: bigint | number, callback: IdleMonitorWatchFunc | null, flags: IdleMonitorWatchFlags): number;
     ...
     * by a {@link Meta.Monitor}.
     * 
     * {@link Meta.LogicalMonitor} has a single viewport, with its owns transformations
     * (such as scaling), that are applied to all the {@link Meta.Monitor}s that
     * are grouped by it.
     * 
     * {@link Meta.LogicalMonitor} provides an abstraction that makes it easy to handle
     * the specifics of setting up different {@link Meta.Monitor}s. It then can
    ...
    class LogicalMonitor extends GObject.Object {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof LogicalMonitor.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, LogicalMonitor.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof LogicalMonitor.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, LogicalMonitor.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof LogicalMonitor.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<LogicalMonitor.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;

        // Methods
        /**
         * Returns the list of {@link Meta.Monitor}s.
         * @returns The list of {@link Meta.Monitor}s.
         */
        get_monitors(): Monitor[];

        /**
         * Returns the {@link Meta.Monitor}s number which is compatible with the monitor
         * API on {@link Meta.Display} until the next monitors-changed.
         * @returns The {@link Meta.Monitor}s number
         */
        get_number(): number;
    }
    ...
    class Monitor extends GObject.Object {
        ...
        // Methods
        /**
         * Returns the {@link Meta.Backlight} of the monitor, or NULL if it has no
         * controllable backlight.
         * @returns The {@link Meta.Backlight}.
         */
    ...
    namespace MonitorManager {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
             ...
             * @run-last
             */
            "monitor-privacy-screen-changed": (logical_monitor: LogicalMonitor, enabled: boolean) => void;
            /**
             * @signal
             * @run-last
             */
     ...
     * multiple monitors (both {@link Meta.Monitor} and {@link Meta.LogicalMonitor}) and GPU's
    ...
    class MonitorManager extends GObject.Object {
        ...
        /**
         * Returns the list of {@link Meta.LogicalMonitor}s. See also
         * `meta_monitor_manager_get_num_logical_monitors()` if you only need the size of
         * the list.
         * @returns The list of {@link Meta.LogicalMonitor}s.
         */
        ...
        /**
         * Returns the list of {@link Meta.Monitor}s. See also
         * `meta_monitor_manager_get_logical_monitors()` for a list of
         * {@link Meta.LogicalMonitor}s.
         * @returns The list of {@link Meta.Monitor}s.
         */
    ...
    class MultiTexture extends GObject.Object {
         ...
         * @param pipeline 
         */
        add_pipeline_sampling(coeffs: MultiTextureCoefficients, premult: MultiTextureAlphaMode, pipeline: Cogl.Pipeline): void;
    ...
    class ShapedTexture extends GObject.Object implements Clutter.Content {
        ...
        /**
         * Captures the shaped texture contents as a {@link Cogl.Bitmap} in the
         * specified format.
         ...
         * @param format The pixel format for the image data
         * @returns a new {@link Cogl.Bitmap}
         */
        paint_to_bitmap(clip: Mtk.Rectangle | null, format: Cogl.PixelFormat): Cogl.Bitmap | null;
    ...
    class WaylandClient extends GObject.Object {
        ...
        /**
         * Get the {@link Gio.Subprocess} which was created by meta_wayland_client_new_subprocess.
         * @returns The {@link Gio.Subprocess}
         */
    ...
    namespace Window {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
            ...
            "notify::a11y-dbus-name": (pspec: GObject.ParamSpec) => void;
            "notify::a11y-object-path": (pspec: GObject.ParamSpec) => void;
    ...
    abstract class Window extends GObject.Object implements Gio.Initable {
         ...
         * @default null
         */
        get a11y_dbus_name(): string;

        /**
         * @read-only
         * @default null
         */
        get a11yDbusName(): string;

        /**
         * @read-only
         * @default null
         */
        get a11y_object_path(): string;

        /**
         * @read-only
         * @default null
         */
        get a11yObjectPath(): string;
         ...
         * @param constraint a {@link Meta.ExternalConstraint}
         */
        add_external_constraint(constraint: ExternalConstraint): void;
         ...
         * @param pos_hint 
         */
        begin_grab_op(op: GrabOp, sprite: Clutter.Sprite | null, timestamp: number, pos_hint: Graphene.Point | null): boolean;
         ...
         */
        get_max_size(): [boolean, number, number];
        ...
        /**
         * @returns `true` if the window is maximized vertically and horizontally.
         */
         ...
         * @param constraint a {@link Meta.ExternalConstraint}
         */
        remove_external_constraint(constraint: ExternalConstraint): void;
         ...
         * @param directions 
         */
        set_maximize_flags(directions: MaximizeFlags): void;

        /**
         * Set the window type
         * @param type The {@link Meta.WindowType}
         */
         ...
         * @param directions 
         */
        set_unmaximize_flags(directions: MaximizeFlags): void;
    ...
    abstract class WindowActor extends Clutter.Actor implements Atk.ImplementorIface, Clutter.Animatable {
         ...
         * the layers, and returns the result as a {@link Cogl.Bitmap} in the
         * specified format.
        ...
        /**
         * @param clip A clipping rectangle, in actor coordinates, to help prevent extra processing. In the case that the clipping rectangle is partially or fully outside the bounds of the actor, the rectangle will be clipped.
         * @param format pixel format for the offscreen texture, or {@link Cogl.PixelFormat.ANY}   to keep the default (8-bit RGBA).
         * @param color_state destination color state for the paint, or `null`   to inherit the actor's color state. Pass a BT.2020 / PQ {@link Clutter.ColorState}   together with {@link Cogl.PixelFormat.RGBA_FP_16161616} to retain HDR data.
         * @returns a new {@link Clutter.Content}
         * @throws GLib.Error
         */
        paint_to_content_full(clip: Mtk.Rectangle | null, format: Cogl.PixelFormat, color_state: Clutter.ColorState | null): Clutter.Content | null;
     ...
     * @gir-type Struct
     */
    class ExternalConstraintInfo {
        static $gtype: GObject.GType<ExternalConstraintInfo>;

        // Fields
        new_rect: Mtk.Rectangle;

        flags: ExternalConstraintFlags;
     ...
     * @gir-type Alias
     */
    type ExternalConstraintInterface = typeof ExternalConstraint;
    ...
    class KeymapDescription {
        static $gtype: GObject.GType<KeymapDescription>;

        // Constructors
        constructor(model: string, layout: string, variant: string, options: string, display_names: string[], short_names: string[]);

        static new_from_rules(model: string, layout: string, variant: string, options: string, display_names: string[], short_names: string[]): KeymapDescription;

        // Methods
        /**
         * @param other 
         */
        direct_equal(other: KeymapDescription): boolean;

        is_locked(): boolean;

        ref(): KeymapDescription;
    ...
    namespace ExternalConstraint {
        /**
         * Interface for implementing ExternalConstraint.
         * Contains only the virtual methods that need to be implemented.
         */
        interface Interface {
             ...
             * @param window the {@link Meta.Window} being constrained
             * @param info a {@link Meta.ExternalConstraintInfo} with constraint parameters
             * @virtual
             */
            vfunc_constrain(window: Window, info: ExternalConstraintInfo): boolean;
        }
    ...
    export interface ExternalConstraintNamespace {
        $gtype: GObject.GType<ExternalConstraint>;
        prototype: ExternalConstraint;
    }
    /**
     * @gir-type Interface
     */
    interface ExternalConstraint extends GObject.Object, ExternalConstraint.Interface {
         ...
         * @param window the {@link Meta.Window} being constrained
         * @param info a {@link Meta.ExternalConstraintInfo} with constraint parameters
         * @returns `true` if the constraint has fully constrained the window,             `false` otherwise.
         */
        constrain(window: Window, info: ExternalConstraintInfo): boolean;
    }


    export const ExternalConstraint: ExternalConstraintNamespace & {
        new (): ExternalConstraint; // This allows `obj instanceof ExternalConstraint`
    };

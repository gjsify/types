...
![version](https://img.shields.io/npm/v/@girs/st-18)
![downloads/week](https://img.shields.io/npm/dw/@girs/st-18)

GJS TypeScript type definitions for St-18 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v5.3.0.
...
| `@girs/st-18/vocabulary` | GIR-derived widget data: settable properties, enum nicks, slot candidates |
...
Referencing `@girs/st-18/ambient` instead pulls in these declarations
...
`st-18` declares widgets, so it also carries what the GIR says about them, as
types and as values a test can read:

```ts
import type { Widgets, PropsOf } from '@girs/st-18/vocabulary';
import { OWN_PROPS, ENUM_NICKS, PROVENANCE } from '@girs/st-18/vocabulary';
```

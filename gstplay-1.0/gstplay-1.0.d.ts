...
static new_with_main_context(play: Play, context: GLib.MainContext): PlaySignalAdapter;
    ...
    connect(signal: 'error', callback: ((_source: this, error: GLib.Error, details: Gst.Structure | null) => void)): number
    connect_after(signal: 'error', callback: ((_source: this, error: GLib.Error, details: Gst.Structure | null) => void)): number
    ...
    connect(signal: 'warning', callback: ((_source: this, error: GLib.Error, details: Gst.Structure | null) => void)): number
    connect_after(signal: 'warning', callback: ((_source: this, error: GLib.Error, details: Gst.Structure | null) => void)): number

...
GJS TypeScript type definitions for Gucharmap-2.90, generated from library version 17.0.2 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v4.0.0-rc.9.

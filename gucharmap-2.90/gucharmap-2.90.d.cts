...
export function get_nameslist_colons(uc: string): string[]
export function get_nameslist_equals(uc: string): string[]
 ...
 */
export function unichar_isdefined(uc: string): boolean
/**
 ...
 */
export function unichar_isgraph(uc: string): boolean
/**
 ...
 */
export function unichar_to_printable_utf8(uc: string, outbuf: string | null): number
/**
 * Classifies a Unicode character by type.
 * @param uc a Unicode character
 * @returns the type of the character.
 */
export function unichar_type(uc: string): GLib.UnicodeType
export function unichar_validate(uc: string): boolean
/**

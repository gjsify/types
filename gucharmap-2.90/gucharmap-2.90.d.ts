...
static ["new"](): Chartable;
    ...
    connect(signal: 'move-cursor', callback: ((_source: this, object: Gtk.MovementStep, p0: number) => boolean)): number
    connect_after(signal: 'move-cursor', callback: ((_source: this, object: Gtk.MovementStep, p0: number) => boolean)): number
...
module ChartableAccessible {
    ...
    interface ConstructorProps extends Atk.NoOpObject.ConstructorProps, Atk.Action.ConstructorProps, Atk.Component.ConstructorProps, Atk.Document.ConstructorProps, Atk.EditableText.ConstructorProps, Atk.Hypertext.ConstructorProps, Atk.Image.ConstructorProps, Atk.Selection.ConstructorProps, Atk.Table.ConstructorProps, Atk.TableCell.ConstructorProps, Atk.Text.ConstructorProps, Atk.Value.ConstructorProps, Atk.Window.ConstructorProps {

    }

}

class ChartableAccessible extends Atk.NoOpObject implements Atk.Action, Atk.Component, Atk.Document, Atk.EditableText, Atk.Hypertext, Atk.Image, Atk.Selection, Atk.Table, Atk.TableCell, Atk.Text, Atk.Value, Atk.Window {
...
module ChartableCellAccessible {
    ...
    interface ConstructorProps extends Atk.Object.ConstructorProps, Atk.Action.ConstructorProps, Atk.Component.ConstructorProps {

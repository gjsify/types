...
static ["new"](io_stream: Gio.IOStream): Client;
    ...
    connect(signal: 'handle-call', callback: ((_source: this, method: string, id: GLib.Variant, params: GLib.Variant | null) => boolean)): number
    connect_after(signal: 'handle-call', callback: ((_source: this, method: string, id: GLib.Variant, params: GLib.Variant | null) => boolean)): number
    emit(signal: 'handle-call', method: string, id: GLib.Variant, params?: (GLib.Variant | null)): void
    connect(signal: 'notification', callback: ((_source: this, method: string, params: GLib.Variant | null) => void)): number
    connect_after(signal: 'notification', callback: ((_source: this, method: string, params: GLib.Variant | null) => void)): number
...
static ["new"](): Server;
    ...
    connect(signal: 'handle-call', callback: ((_source: this, client: Client, method: string, id: GLib.Variant, params: GLib.Variant) => boolean)): number
    connect_after(signal: 'handle-call', callback: ((_source: this, client: Client, method: string, id: GLib.Variant, params: GLib.Variant) => boolean)): number
    emit(signal: 'handle-call', client: Client, method: string, id: GLib.Variant, params: GLib.Variant): void
    connect(signal: 'notification', callback: ((_source: this, client: Client, method: string, id: GLib.Variant) => void)): number
    connect_after(signal: 'notification', callback: ((_source: this, client: Client, method: string, id: GLib.Variant) => void)): number

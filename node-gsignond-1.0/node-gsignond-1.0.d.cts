 ...
 * @returns the result
 */
export function isHostInDomain(host: string | null, domain: string | null): boolean
/**
 ...
 */
export function wipeDirectory(dirname: string | null): boolean
/**
 ...
 * @returns TRUE if wiping and removal was successful.
 */
export function wipeFile(filename: string | null): boolean

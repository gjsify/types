...
import type AppStreamGlib from '@girs/node-appstreamglib-1.0';
...
interface Package {
    ...
    // Has conflict: explode(dir: string, glob: string[]): boolean
    /**
     ...
     */
    logStart(): void
    // Has conflict: open(filename: string): boolean
    /**

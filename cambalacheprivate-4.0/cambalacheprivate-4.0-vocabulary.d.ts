/**
 * The GIR-derived widget VOCABULARY for CambalachePrivate-4.0.
 *
 * GENERATED — do not edit. Provenance: CambalachePrivate-4.0
 *
...
import type { GtkSymbolicPaintableConstructOnly, GtkSymbolicPaintableProps } from '@girs/gtk-4.0/vocabulary';
...
export interface CmbPrivateSvgProps extends GObjectProps, GdkPaintableProps, GtkSymbolicPaintableProps {
    /**
...
export type CmbPrivateSvgConstructOnly = GObjectConstructOnly | GdkPaintableConstructOnly | GtkSymbolicPaintableConstructOnly | 'resource';

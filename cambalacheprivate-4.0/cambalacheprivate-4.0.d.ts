...
export namespace CambalachePrivate {
    ...
    class BuilderScope extends Gtk.BuilderCScope implements Gtk.BuilderScope {
         ...
         * @internal
         */
        $signals: BuilderScope.SignalSignatures;
        ...
        /**
         * Try to lookup a {@link GObject.GType} via the given function name, specified
        ...
        /**
         * Try to lookup a {@link GObject.GType} via the its name. See

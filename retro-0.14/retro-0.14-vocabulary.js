...
export const OWN_PROPS = {
    RetroCore: ['content-directory', 'runahead', 'save-directory', 'system-directory'],
    RetroCoreView: ['can-grab-pointer', 'snap-pointer-to-borders'],
    RetroMainLoop: ['core', 'speed-rate'],
};

export const OWN_SIGNALS = {
    RetroCore: ['audio-output', 'log', 'message', 'options-set', 'shutdown', 'video-output'],
    RetroOption: ['value-changed'],
};
...
export const DECLS = {
    ...
    RetroCoreView: ['RetroCoreView', 'GtkEventBox', 'GtkBin', 'GtkContainer', 'GtkWidget', 'GInitiallyUnowned', 'GObject', 'GtkBuildable'],
    RetroKeyJoypadMapping: ['RetroKeyJoypadMapping', 'GObject'],
    RetroMainLoop: ['RetroMainLoop', 'GObject'],
...
export const PROP_TYPES = {
    'RetroCore.content-directory': 'gchararray',
    'RetroCore.runahead': 'guint',
    'RetroCore.save-directory': 'gchararray',
    'RetroCore.system-directory': 'gchararray',
    'RetroCoreView.can-grab-pointer': 'gboolean',
    'RetroCoreView.snap-pointer-to-borders': 'gboolean',
    'RetroMainLoop.core': 'RetroCore',
    'RetroMainLoop.speed-rate': 'gdouble',
};

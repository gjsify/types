/**
 * The GIR-derived widget VOCABULARY for Retro-0.14.
 *
 * GENERATED — do not edit. Provenance: Retro-0.14 — dropped empty base(s): Atk.ImplementorIface
 *
 * 10 instantiable GTypes (of which 1 concrete widgets), 10 declarations, 9 enum nick unions, 0 slot candidates.
 *
...
import type Retro from './retro-0.14.js';
...
export type RetroAnalogIdNick = 'x' | 'y' | 'count';
export type RetroAnalogIndexNick = 'left' | 'right' | 'count';
export type RetroControllerTypeNick = 'none' | 'joypad' | 'mouse' | 'keyboard' | 'lightgun' | 'analog' | 'pointer' | 'count' | 'type-mask';
export type RetroJoypadIdNick = 'b' | 'y' | 'select' | 'start' | 'up' | 'down' | 'left' | 'right' | 'a' | 'x' | 'l' | 'r' | 'l2' | 'r2' | 'l3' | 'r3' | 'count';
export type RetroLightgunIdNick = 'x' | 'y' | 'trigger' | 'cursor' | 'turbo' | 'pause' | 'start' | 'count';
export type RetroMouseIdNick = 'x' | 'y' | 'left' | 'right' | 'wheelup' | 'wheeldown' | 'middle' | 'horiz-wheelup' | 'horiz-wheeldown' | 'count';
export type RetroPointerIdNick = 'x' | 'y' | 'pressed' | 'count';
export type RetroRumbleEffectNick = 'strong' | 'weak' | 'count';
export type RetroVideoFilterNick = 'smooth' | 'sharp' | 'crt' | 'count';
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type RetroCoreConstructOnly = GObjectConstructOnly;
...
export interface RetroCoreViewProps extends GtkEventBoxProps, GtkBuildableProps {
    ...
    'snap-pointer-to-borders'?: boolean;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
...
export interface RetroMainLoopProps extends GObjectProps {
    core?: Retro.Core;
    'speed-rate'?: number;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type RetroMainLoopConstructOnly = GObjectConstructOnly;
...
export interface Widgets {
    RetroCoreView: {
        class: Retro.CoreView;
        props: RetroCoreViewProps;
        signals: Retro.CoreView.SignalSignatures;
        constructOnly: RetroCoreViewConstructOnly;
        slotCandidates: {};
    };
}

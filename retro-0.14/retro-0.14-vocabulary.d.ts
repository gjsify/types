 ...
 *
 * GENERATED — do not edit. Provenance: Retro-0.14 — dropped empty base(s): GObject.Object GObject.InitiallyUnowned Atk.ImplementorIface
 *
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type RetroCoreConstructOnly = never;
...
export interface RetroMainLoopProps {
    core?: Retro.Core;
    'speed-rate'?: number;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type RetroMainLoopConstructOnly = never;

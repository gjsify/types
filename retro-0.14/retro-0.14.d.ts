...
static ["new"](filename: string): Core;
    ...
    connect(signal: 'audio-output', callback: ((_source: this, data: Uint8Array, sample_rate: number) => void)): number
    connect_after(signal: 'audio-output', callback: ((_source: this, data: Uint8Array, sample_rate: number) => void)): number

...
export const OWN_PROPS = {
    ...
    GdauiDataCellRendererBin: ['data-handler', 'editable', 'to-be-deleted', 'type', 'value'],
    GdauiDataCellRendererBoolean: ['data-handler', 'editable', 'to-be-deleted', 'type', 'value'],
    GdauiDataCellRendererCombo: ['data-set', 'data-set-source', 'set-default-if-invalid', 'show-expander', 'to-be-deleted', 'values', 'values-display'],
    GdauiDataCellRendererInfo: ['editable', 'group', 'iter', 'store', 'to-be-deleted'],
    GdauiDataCellRendererTextual: ['data-handler', 'options', 'to-be-deleted', 'type', 'value'],
    GdauiDataFilter: ['data-widget'],
    GdauiDataProxyInfo: ['data-proxy'],
    GdauiDataStore: ['model', 'prepend-null-entry'],
...
export const OWN_SIGNALS = {
    ...
    GdauiCloud: ['activate'],
    GdauiDataCellRendererBin: ['changed'],
    GdauiDataCellRendererBoolean: ['changed'],
    GdauiDataCellRendererCombo: ['changed'],
    GdauiDataCellRendererInfo: ['status-changed'],
    GdauiDataCellRendererTextual: ['changed'],
    ...
    GdauiSet: ['public-data-changed', 'source-model-changed'],
    GdauiTreeStore: ['drag-can-drag', 'drag-can-drop', 'drag-delete', 'drag-drop', 'drag-get'],
};
...
export const PROP_TYPES = {
    ...
    'GdauiEntryCommonTime.type': 'GType',
...
export const SINCE = {
    ...
    'GdauiSet::public-data-changed': '4.2',
    'GdauiSet::source-model-changed': '4.2',
};

...
export namespace GstAllocators {
    ...
    class DRMDumbAllocator extends Gst.Allocator {
        // Own properties of GstAllocators-1.0.DRMDumbAllocator
         ...
         */
        alloc(drm_fourcc: number, width: number, height: number): Gst.Memory;
        /**

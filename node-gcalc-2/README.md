...
![version](https://img.shields.io/npm/v/@girs/node-gcalc-2)
![downloads/week](https://img.shields.io/npm/dw/@girs/node-gcalc-2)


Node.js TypeScript type definitions for GCalc-2, generated from library version 2.0.0 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v3.2.7.

...
export const OWN_PROPS = {
    EomClipboardHandler: ['pixbuf', 'uri'],
...
export const OWN_SIGNALS = {
    EomImage: ['changed', 'file-changed', 'next-frame', 'save-progress', 'size-prepared', 'thumbnail-changed'],
    EomJob: ['finished', 'progress'],
...
export const PROP_TYPES = {
    'EomClipboardHandler.pixbuf': 'GdkPixbuf',
    'EomClipboardHandler.uri': 'gchararray',
    'EomPropertiesDialog.netbook-mode': 'gboolean',
    'EomPropertiesDialog.thumbview': 'EomThumbView',
    'EomScrollView.antialiasing-in': 'gboolean',
    'EomScrollView.antialiasing-out': 'gboolean',
    'EomScrollView.image': 'EomImage',
    'EomScrollView.scrollwheel-zoom': 'gboolean',
    'EomScrollView.transparency-style': 'EomTransparencyStyle',
    'EomScrollView.use-background-color': 'gboolean',
    'EomScrollView.zoom-multiplier': 'gdouble',
    'EomSidebar.current-page': 'GtkWidget',
    'EomThumbNav.mode': 'gint',
    'EomThumbNav.show-buttons': 'gboolean',
    'EomThumbNav.thumbview': 'EomThumbView',
    'EomWindow.collection-position': 'EomWindowCollectionPos',
    'EomWindow.collection-resizable': 'gboolean',
    'EomWindow.startup-flags': 'EomStartupFlags',
};

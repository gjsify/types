...
export namespace Eom {
    ...
    class JobModel extends Job {
        ...
        static ["new"](file_list: Gio.File[], preserve_order: boolean): JobModel;
    ...
    class ListStore extends Gtk.ListStore implements Gtk.Buildable, Gtk.TreeDragDest, Gtk.TreeDragSource, Gtk.TreeModel, Gtk.TreeSortable {
         ...
         * @param preserve_order Flag to indicate whether to honor the order of input parameters.
         */
        add_files(file_list: Gio.File[], preserve_order: boolean): void;
    ...
    class PropertiesDialog extends Gtk.Dialog implements Atk.ImplementorIface, Gtk.Buildable {
        ...
        static ["new"](parent: Gtk.Window, thumbview: ThumbView, next_image_action: Gtk.Action, previous_image_action: Gtk.Action): PropertiesDialog;
        ...
        // Signals
        /** @signal */
        connect<K extends keyof PropertiesDialog.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, PropertiesDialog.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof PropertiesDialog.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, PropertiesDialog.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof PropertiesDialog.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<PropertiesDialog.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
    ...
    class ScrollView extends Gtk.Grid implements Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
         ...
         * @default Eom.TransparencyStyle.CHECKED
         */
    ...
    class Window extends Gtk.ApplicationWindow implements Atk.ImplementorIface, Gio.ActionGroup, Gio.ActionMap, Gtk.Buildable {
         ...
         * @default Eom.WindowCollectionPos.BOTTOM
         */

...
export namespace EBook {
    ...
    class BookClient extends EDataServer.Client {
        // Own properties of EBook-1.2.BookClient
        ...
        // Constructors of EBook-1.2.BookClient

        static ['new'](source: EDataServer.Source): BookClient;

        // Owm methods of EBook-1.2.BookClient
         ...
         * @param registry an #ESourceRegistry
         */
        static get_self(registry: EDataServer.SourceRegistry): boolean;
        /**
         ...
         */
        add_contact_finish(result: Gio.AsyncResult): boolean;
        /**
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        add_contacts_finish(result: Gio.AsyncResult): boolean;
        /**
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_contact_finish(result: Gio.AsyncResult): boolean;
        /**
         * Receive #EContact from the `client` for the gived `uid`.
         * If successful, then the `out_contact` is set to newly allocated
         * #EContact, which should be freed with g_object_unref().
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_contact_sync(uid: string, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_contacts_finish(result: Gio.AsyncResult): boolean;
        /**
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_contacts_sync(sexp: string, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_contacts_uids_finish(result: Gio.AsyncResult): boolean;
        /**
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_contacts_uids_sync(sexp: string, cancellable?: Gio.Cancellable | null): boolean;
        /**
         ...
         * @returns %TRUE if successful, %FALSE otherwise.
         */
        get_cursor_finish(result: Gio.AsyncResult): boolean;
        /**
    ...
    class BookClientCursor extends GObject.Object {
        // Own properties of EBook-1.2.BookClientCursor
        ...
        // Owm methods of EBook-1.2.BookClientCursor
         ...
         */
        step_finish(result: Gio.AsyncResult): number;
        /**
         * &lt;link linkend="cursor-iteration"&gt;Steps the cursor through the results&lt;/link&gt; by
         * a maximum of `count` and fetch the results traversed.
         *
    ...
    class BookClientView extends GObject.Object {
        // Own properties of EBook-1.2.BookClientView
        ...
        // Owm methods of EBook-1.2.BookClientView
         ...
         */
        dup_contacts_finish(result: Gio.AsyncResult): boolean;
        /**
    ...
    class Destination extends GObject.Object {
        // Own fields of EBook-1.2.Destination

        object: GObject.Object;

        // Constructors of EBook-1.2.Destination

        static ['new'](): Destination;

        // Owm methods of EBook-1.2.Destination
     ...
     */
    class BookClientClass {}

    /**
     * The cursor class structure.
     */
    class BookClientCursorClass {}

...
module BookClient {
    ...
    interface ConstructorProps extends EDataServer.Client.ConstructorProps, Gio.AsyncInitable.ConstructorProps, Gio.Initable.ConstructorProps {
locale: string;
    }
...
_init(...args: any[]): void;
    ...
    connect_after(signal: 'objects-added', callback: ((_source: this, objects: EBookContacts.Contact[]) => void)): number
    emit(signal: 'objects-added', objects: EBookContacts.Contact[]): void
    connect(signal: 'objects-modified', callback: ((_source: this, objects: EBookContacts.Contact[]) => void)): number
    connect_after(signal: 'objects-modified', callback: ((_source: this, objects: EBookContacts.Contact[]) => void)): number

...
function marshal_VOID__INT_INT(closure: GObject.Closure, return_value: GObject.Value, n_param_values: number, param_values: GObject.Value, invocation_hint?: (any | null), marshal_data?: (any | null)): void
/**

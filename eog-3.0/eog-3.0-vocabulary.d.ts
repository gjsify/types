...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type EogJobCopyConstructOnly = EogJobConstructOnly;

export interface EogJobLoadProps extends EogJobProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type EogJobLoadConstructOnly = EogJobConstructOnly;

export interface EogJobModelProps extends EogJobProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type EogJobModelConstructOnly = EogJobConstructOnly;

export interface EogJobSaveProps extends EogJobProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type EogJobSaveConstructOnly = EogJobConstructOnly;

export interface EogJobSaveAsProps extends EogJobSaveProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type EogJobSaveAsConstructOnly = EogJobSaveConstructOnly;

export interface EogJobThumbnailProps extends EogJobProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type EogJobThumbnailConstructOnly = EogJobConstructOnly;

export interface EogJobTransformProps extends EogJobProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type EogJobTransformConstructOnly = EogJobConstructOnly;

export interface EogListStoreProps extends GtkListStoreProps, GtkBuildableProps, GtkTreeDragDestProps, GtkTreeDragSourceProps, GtkTreeModelProps, GtkTreeSortableProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type EogListStoreConstructOnly = GtkListStoreConstructOnly | GtkBuildableConstructOnly | GtkTreeDragDestConstructOnly | GtkTreeDragSourceConstructOnly | GtkTreeModelConstructOnly | GtkTreeSortableConstructOnly;
...
export interface EogURIConverterProps extends GObjectProps {
    ...
    /** @default 1 */
    'counter-n-digits'?: number;
    /** @default 1 */
    'counter-start'?: bigint | number;
    /** @default 1 */
    'n-images'?: number;
    /** @default 95 */

...
import './node-mediaart-2.0-import.d.ts';
 ...
 */
function bufferToJpeg(buffer: Uint8Array, bufferMime: string | null, target: string | null): boolean
/**
 ...
 */
function getFile(artist: string | null, title: string | null, prefix: string | null): [ /* returnType */ boolean, /* cacheFile */ Gio.File ]
/**
 ...
 */
function removeAsync(artist: string | null, album: string | null, ioPriority: number, sourceObject: GObject.Object | null, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void
/**
...
interface Process extends Gio.Initable {
     ...
     * @param callback a #GAsyncReadyCallback to call when the request is satisfied
     */
    bufferAsync(type: Type, flags: ProcessFlags, relatedFile: Gio.File, buffer: Uint8Array | null, mime: string | null, artist: string | null, title: string | null, ioPriority: number, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void
    /**
     * Finishes the asynchronous operation started with

 ...
 */
function bufferToJpeg(buffer: number[], bufferMime: string | null, target: string | null): boolean
/**
...
interface Process extends Gio.Initable {
     ...
     */
    buffer(type: Type, flags: ProcessFlags, relatedFile: Gio.File, buffer: number[] | null, mime: string | null, artist: string | null, title: string | null, cancellable: Gio.Cancellable | null): boolean
    /**

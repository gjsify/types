/**
 * The GIR-derived widget VOCABULARY for GstInsertBin-1.0.
 *
...
import type { GstBinConstructOnly, GstBinProps, GstChildProxyConstructOnly, GstChildProxyProps, GstElementConstructOnly, GstElementProps, GstObjectConstructOnly, GstObjectProps } from '@girs/gst-1.0/vocabulary';
...
/** This element is a #GstBin that has a single source and sink pad. */
export interface GstInsertBinProps extends GstBinProps, GstChildProxyProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GstInsertBinConstructOnly = GstBinConstructOnly | GstChildProxyConstructOnly;

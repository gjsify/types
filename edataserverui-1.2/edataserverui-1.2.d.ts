...
export namespace EDataServerUI {
    ...
    class CellRendererColor extends Gtk.CellRenderer {
        // Own properties of EDataServerUI-1.2.CellRendererColor

        rgba: Gdk.RGBA;

        // Constructors of EDataServerUI-1.2.CellRendererColor
    ...
    class CertificateWidget extends Gtk.ScrolledWindow {
        // Constructors of EDataServerUI-1.2.CertificateWidget

        static ['new'](): CertificateWidget;

        // Owm methods of EDataServerUI-1.2.CertificateWidget
    ...
    class CredentialsPrompter extends GObject.Object {
        // Own properties of EDataServerUI-1.2.CredentialsPrompter
        ...
        // Constructors of EDataServerUI-1.2.CredentialsPrompter

        static ['new'](registry: EDataServer.SourceRegistry): CredentialsPrompter;

        // Owm methods of EDataServerUI-1.2.CredentialsPrompter
    ...
    abstract class CredentialsPrompterImpl extends EDataServer.Extension {
        // Owm methods of EDataServerUI-1.2.CredentialsPrompterImpl
    ...
    class CredentialsPrompterImplOAuth2 extends CredentialsPrompterImpl {
        // Constructors of EDataServerUI-1.2.CredentialsPrompterImplOAuth2
    ...
    class CredentialsPrompterImplPassword extends CredentialsPrompterImpl {
        // Constructors of EDataServerUI-1.2.CredentialsPrompterImplPassword
    ...
    class RemindersWidget extends Gtk.Grid {
        // Own properties of EDataServerUI-1.2.RemindersWidget

        readonly empty: boolean;
        watcher: ECal.ReminderWatcher;

        // Constructors of EDataServerUI-1.2.RemindersWidget

        static ['new'](watcher: ECal.ReminderWatcher): RemindersWidget;

        // Owm methods of EDataServerUI-1.2.RemindersWidget
    ...
    class WebDAVDiscoverContent extends Gtk.Grid {
        // Constructors of EDataServerUI-1.2.WebDAVDiscoverContent
        ...
        // Owm methods of EDataServerUI-1.2.WebDAVDiscoverContent
    ...
    class WebDAVDiscoverDialog extends Gtk.Dialog {
        // Constructors of EDataServerUI-1.2.WebDAVDiscoverDialog
        ...
        // Owm methods of EDataServerUI-1.2.WebDAVDiscoverDialog
    ...
    class CredentialsPrompterImplClass {
        // Own fields of EDataServerUI-1.2.CredentialsPrompterImplClass

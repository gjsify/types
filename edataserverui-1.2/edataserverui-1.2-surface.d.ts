...
export interface ECertificateWidgetProps extends GtkScrolledWindowProps, GtkBuildableProps {
}
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type EWebDAVDiscoverContentConstructOnly = GtkGridConstructOnly | GtkBuildableConstructOnly | GtkOrientableConstructOnly;

export interface EWebDAVDiscoverDialogProps extends GtkDialogProps, GtkBuildableProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type EWebDAVDiscoverDialogConstructOnly = GtkDialogConstructOnly | GtkBuildableConstructOnly;
...
export interface Widgets {
    ECertificateWidget: {
        class: EDataServerUI.CertificateWidget;
        props: ECertificateWidgetProps;
        signals: EDataServerUI.CertificateWidget.SignalSignatures;
        constructOnly: ECertificateWidgetConstructOnly;
        slotCandidates: {};
    };
    ERemindersWidget: {
        class: EDataServerUI.RemindersWidget;
        props: ERemindersWidgetProps;
        signals: EDataServerUI.RemindersWidget.SignalSignatures;
        constructOnly: ERemindersWidgetConstructOnly;
        slotCandidates: {};
    };
    EWebDAVDiscoverContent: {
        class: EDataServerUI.WebDAVDiscoverContent;
        props: EWebDAVDiscoverContentProps;
        signals: EDataServerUI.WebDAVDiscoverContent.SignalSignatures;
        constructOnly: EWebDAVDiscoverContentConstructOnly;
        slotCandidates: {};
    };
    EWebDAVDiscoverDialog: {
        class: EDataServerUI.WebDAVDiscoverDialog;
        props: EWebDAVDiscoverDialogProps;
        signals: EDataServerUI.WebDAVDiscoverDialog.SignalSignatures;
        constructOnly: EWebDAVDiscoverDialogConstructOnly;
        slotCandidates: {};
    };
}

...
import './gssdp-1.6-ambient.d.ts';
import './gssdp-1.6-import.d.ts';
/**
 * GSSDP-1.6
 */
...
export interface Client extends Gio.Initable {
     ...
     * The network mask of the assoicated network interface.
     */
    readonly host_mask: Gio.InetAddressMask
    /**
     * The name of the network interface this client is associated with.
     * Set to NULL to autodetect.
     */
    ...
    connect(sigName: "notify::address", callback: (($obj: Client, pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::address", callback: (($obj: Client, pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::port", callback: (($obj: Client, pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::port", callback: (($obj: Client, pspec: GObject.ParamSpec) => void)): number

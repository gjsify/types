...
export namespace GSSDP {
    ...
    class Error extends GLib.Error {
        ...
        // Constructors of GSSDP-1.6.Error

        constructor(options: { message: string; code: number });

        // Owm methods of GSSDP-1.6.Error
    ...
    class Client extends GObject.Object {
        // Own properties of GSSDP-1.6.Client
        ...
        // Constructors of GSSDP-1.6.Client
        ...
        // Owm methods of GSSDP-1.6.Client
    ...
    class ResourceBrowser extends GObject.Object {
        // Own properties of GSSDP-1.6.ResourceBrowser
        ...
        // Constructors of GSSDP-1.6.ResourceBrowser

        static ['new'](client: Client, target: string): ResourceBrowser;

        // Owm methods of GSSDP-1.6.ResourceBrowser
    ...
    class ResourceGroup extends GObject.Object {
        // Own properties of GSSDP-1.6.ResourceGroup
        ...
        // Constructors of GSSDP-1.6.ResourceGroup

        static ['new'](client: Client): ResourceGroup;

        // Owm methods of GSSDP-1.6.ResourceGroup
        ...
        /**
         * Sets `resource_group&`lt;!-- --&gt;s availability to `available`. Changing
         * `resource_group&`lt;!-- --&gt;s availability causes it to announce its new state

...
static ["new"](...args: never[]): any;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'connect-failed', callback: ((_source: this, device: SpiceClientGLib.UsbDevice, error: GLib.Error) => void)): number
    connect_after(signal: 'connect-failed', callback: ((_source: this, device: SpiceClientGLib.UsbDevice, error: GLib.Error) => void)): number

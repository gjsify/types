/**
 * The GIR-derived widget VOCABULARY for Gm-0.
 *
 * GENERATED — do not edit. Provenance: Gm-0 — prop(s) no TypeScript value satisfies: Gm.DisplayPanel.corner-radii
 *
...
export interface GmCutoutProps extends GObjectProps {
    /**
...
export type GmCutoutConstructOnly = GObjectConstructOnly | 'name' | 'path';

/** Get device dependent information. */
export interface GmDeviceInfoProps extends GObjectProps {
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GmDeviceInfoConstructOnly = GObjectConstructOnly | 'compatibles';

/** Physical properties of a display panel like size, cutouts and rounded corners. */
export interface GmDisplayPanelProps extends GObjectProps {
    /**
     * The corner radius of the panel edges in device pixels.
     * @since 0.0.1
     * @default 0
     * @deprecated since 0.6.0: Use [property@DisplayPanel:corner-radii] instead
     */
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GmDisplayPanelConstructOnly = GObjectConstructOnly;

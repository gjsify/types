...
export namespace GXPS {
    ...
    class Error extends GLib.Error {
        ...
        // Constructors of GXPS-0.1.Error
    ...
    class CoreProperties extends GObject.Object {
        // Own properties of GXPS-0.1.CoreProperties

        source: string;

        // Owm methods of GXPS-0.1.CoreProperties
    ...
    class Document extends GObject.Object {
        // Own properties of GXPS-0.1.Document

        source: string;

        // Owm methods of GXPS-0.1.Document
         ...
         */
        get_page_size(n_page: number): boolean;
        /**
    ...
    class DocumentStructure extends GObject.Object {
        // Own properties of GXPS-0.1.DocumentStructure

        source: string;

        // Owm methods of GXPS-0.1.DocumentStructure
    ...
    class File extends GObject.Object {
        // Own properties of GXPS-0.1.File

        file: Gio.File;

        // Constructors of GXPS-0.1.File

        static ['new'](filename: Gio.File): File;

        // Owm methods of GXPS-0.1.File
    ...
    class Page extends GObject.Object {
        // Own properties of GXPS-0.1.Page

        source: string;

        // Owm methods of GXPS-0.1.Page
         ...
         */
        get_anchor_destination(anchor: string): boolean;
        /**
     ...
     */
    class LinkTarget {
        // Owm methods of GXPS-0.1.LinkTarget
     ...
     */
    class OutlineIter {
        // Constructors of GXPS-0.1.OutlineIter

        constructor(properties?: Partial<{}>);

        // Owm methods of GXPS-0.1.OutlineIter

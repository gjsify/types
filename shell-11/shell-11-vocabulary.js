// The widget vocabulary of Shell-11 as runtime data.
//
// GENERATED — do not edit. Provenance: Shell-11 — dropped empty base(s): Atk.ImplementorIface — inlined base(s) their owner's vocabulary does not emit: NM.SecretAgentOld — prop(s) whose type the model cannot resolve: Shell.App.app-info: Gio.DesktopAppInfo
//
...
export const PROVENANCE = {
    ...
    requiredVocabularies: ['@girs/clutter-11/vocabulary', '@girs/gcr-4/vocabulary', '@girs/gio-2.0/vocabulary', '@girs/gobject-2.0/vocabulary', '@girs/gtk-3.0/vocabulary', '@girs/polkitagent-1.0/vocabulary', '@girs/st-11/vocabulary'],
};
...
export const OWN_PROPS = {
    ...
    ShellGlobal: ['frame-finish-timestamp', 'frame-timestamps', 'session-mode'],
...
export const DECLS = {
    ...
    ShellEmbeddedWindow: ['ShellEmbeddedWindow', 'GtkWindow', 'GtkBin', 'GtkContainer', 'GtkWidget', 'GInitiallyUnowned', 'GObject', 'GtkBuildable'],
    ...
    ShellGtkEmbed: ['ShellGtkEmbed', 'ClutterClone', 'ClutterActor', 'GInitiallyUnowned', 'GObject', 'ClutterAnimatable', 'ClutterContainer', 'ClutterScriptable'],
    ...
    ShellSquareBin: ['ShellSquareBin', 'StBin', 'StWidget', 'ClutterActor', 'GInitiallyUnowned', 'GObject', 'ClutterAnimatable', 'ClutterContainer', 'ClutterScriptable'],
    ShellStack: ['ShellStack', 'StWidget', 'ClutterActor', 'GInitiallyUnowned', 'GObject', 'ClutterAnimatable', 'ClutterContainer', 'ClutterScriptable'],
    ShellTrayIcon: ['ShellTrayIcon', 'ShellGtkEmbed', 'ClutterClone', 'ClutterActor', 'GInitiallyUnowned', 'GObject', 'ClutterAnimatable', 'ClutterContainer', 'ClutterScriptable'],
    ShellTrayManager: ['ShellTrayManager', 'GObject'],
    ShellWM: ['ShellWM', 'GObject'],
    ShellWindowPreview: ['ShellWindowPreview', 'StWidget', 'ClutterActor', 'GInitiallyUnowned', 'GObject', 'ClutterAnimatable', 'ClutterContainer', 'ClutterScriptable'],
    ...
    ShellWorkspaceBackground: ['ShellWorkspaceBackground', 'StWidget', 'ClutterActor', 'GInitiallyUnowned', 'GObject', 'ClutterAnimatable', 'ClutterContainer', 'ClutterScriptable'],
};
...
export const PROP_TYPES = {
    'NMSecretAgentOld.auto-register': 'gboolean',
    'NMSecretAgentOld.capabilities': 'NMSecretAgentCapabilities',
    'NMSecretAgentOld.dbus-connection': 'GDBusConnection',
    'NMSecretAgentOld.identifier': 'gchararray',
    'ShellBlurEffect.brightness': 'gfloat',
    'ShellBlurEffect.mode': 'ShellBlurMode',
    'ShellBlurEffect.sigma': 'gint',
    'ShellGlobal.frame-finish-timestamp': 'gboolean',
    'ShellGlobal.frame-timestamps': 'gboolean',
    'ShellGlobal.session-mode': 'gchararray',
    'ShellGtkEmbed.window': 'ShellEmbeddedWindow',
    'ShellKeyringPrompt.confirm-actor': 'ClutterText',
    'ShellKeyringPrompt.password-actor': 'ClutterText',
    'ShellWindowPreview.window-container': 'ClutterActor',
    'ShellWorkspaceBackground.monitor-index': 'gint',
    'ShellWorkspaceBackground.state-adjustment-value': 'gdouble',
};

...
export namespace GWeather {
    ...
    class Info extends GObject.Object {
        // Own properties of GWeather-3.0.Info
        ...
        // Constructors of GWeather-3.0.Info

        static ['new'](location?: Location | null): Info;

        // Owm methods of GWeather-3.0.Info
        ...
        get_upcoming_moonphases(): boolean;
        get_update(): string;
        get_value_apparent(unit: TemperatureUnit): boolean;
        /**
         ...
         */
        get_value_conditions(): boolean;
        get_value_dew(unit: TemperatureUnit): boolean;
        get_value_moonphase(): boolean;
        get_value_pressure(unit: PressureUnit): boolean;
        /**
         * Fills out `sky` with current sky conditions.
         * @returns TRUE is @sky is valid, FALSE otherwise.
         */
        get_value_sky(): boolean;
        get_value_sunrise(): boolean;
        get_value_sunset(): boolean;
        get_value_temp(unit: TemperatureUnit): boolean;
        get_value_temp_max(unit: TemperatureUnit): boolean;
        get_value_temp_min(unit: TemperatureUnit): boolean;
        /**
         * Note that `value` may be 0 if `info` has not yet been updated.
         * @returns TRUE is @value is valid, FALSE otherwise.
         */
        get_value_update(): boolean;
        get_value_visibility(unit: DistanceUnit): boolean;
        get_value_wind(unit: SpeedUnit): boolean;
    ...
    class LocationEntry extends Gtk.SearchEntry {
        // Own properties of GWeather-3.0.LocationEntry
        ...
        // Constructors of GWeather-3.0.LocationEntry

        static ['new'](top: Location): LocationEntry;

        // Owm methods of GWeather-3.0.LocationEntry
    ...
    class TimezoneMenu extends Gtk.ComboBox {
        // Own properties of GWeather-3.0.TimezoneMenu

        top: Location;
        tzid: string;

        // Constructors of GWeather-3.0.TimezoneMenu

        static ['new'](top: Location): TimezoneMenu;

        // Owm methods of GWeather-3.0.TimezoneMenu
     ...
     */
    class Conditions {
        // Own fields of GWeather-3.0.Conditions

        significant: boolean;
        phenomenon: ConditionPhenomenon;
        qualifier: ConditionQualifier;

        // Owm methods of GWeather-3.0.Conditions
     ...
     */
    class Location {
        // Constructors of GWeather-3.0.Location
        ...
        // Owm methods of GWeather-3.0.Location
     ...
     */
    class Timezone {
        // Owm methods of GWeather-3.0.Timezone

...
export const DECLS = {
    ...
    GWeatherLocationEntry: ['GWeatherLocationEntry', 'GtkSearchEntry', 'GtkEntry', 'GtkWidget', 'GInitiallyUnowned', 'GObject', 'GtkBuildable', 'GtkCellEditable', 'GtkEditable'],
    GWeatherTimezoneMenu: ['GWeatherTimezoneMenu', 'GtkComboBox', 'GtkBin', 'GtkContainer', 'GtkWidget', 'GInitiallyUnowned', 'GObject', 'GtkBuildable', 'GtkCellEditable', 'GtkCellLayout'],
};
...
export const PROP_TYPES = {
    ...
    'GWeatherInfo.enabled-providers': 'GWeatherProvider',
    'GWeatherLocationEntry.show-named-timezones': 'gboolean',
    'GWeatherTimezoneMenu.tzid': 'gchararray',
};

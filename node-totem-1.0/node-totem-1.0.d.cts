...
export function interfaceGetFullPath(name: string): string | null
/**
 ...
 */
export function interfaceLoad(name: string, fatal: boolean, parent: Gtk.Window | null, userData: any | null): Gtk.Builder
/**
 ...
 * @returns the loaded #GtkBuilder object, or %NULL
 */
export function interfaceLoadWithFullPath(filename: string, fatal: boolean, parent: Gtk.Window | null, userData: any | null): Gtk.Builder
/**
 ...
 */
export function pluginFindFile(pluginName: string, file: string): string | null
/**
 ...
 */
export function pluginLoadInterface(pluginName: string, name: string, fatal: boolean, parent: Gtk.Window | null, userData: any | null): Gtk.Builder

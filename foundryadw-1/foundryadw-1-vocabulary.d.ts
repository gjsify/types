...
export interface FoundryDocumentationNavigatorProps extends FoundryPathNavigatorProps {
    documentation?: Foundry.Documentation;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type FoundryDocumentationNavigatorConstructOnly = FoundryPathNavigatorConstructOnly | 'documentation';

export interface FoundryFileNavigatorProps extends FoundryPathNavigatorProps {
    file?: Gio.File;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type FoundryFileNavigatorConstructOnly = FoundryPathNavigatorConstructOnly | 'file';
...
export interface FoundrySymbolNavigatorProps extends FoundryPathNavigatorProps {
    symbol?: Foundry.Symbol;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type FoundrySymbolNavigatorConstructOnly = FoundryPathNavigatorConstructOnly | 'symbol';

...
export function process_rows(babl_fish: Object, source: any | null, source_stride: number, dest: any | null, dest_stride: number, n: number, rows: number): number
/**
 ...
 */
export function space_get(space: Object): [ /* xw */ number, /* yw */ number, /* xr */ number, /* yr */ number, /* xg */ number, /* yg */ number, /* xb */ number, /* yb */ number, /* red_trc */ Object, /* green_trc */ Object, /* blue_trc */ Object ]
 ...
 */
export function space_get_rgb_luminance(space: Object): [ /* red_luminance */ number, /* green_luminance */ number, /* blue_luminance */ number ]

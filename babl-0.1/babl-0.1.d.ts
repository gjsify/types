...
export namespace Babl {
     ...
     */
    function space_from_icc(icc_data: string, icc_length: number, intent: IccIntent): Object;
    /**
     ...
     */
    function space_get(space: Object): void;
     ...
     */
    function space_get_icc(babl: Object): string;
    /**
     ...
     */
    function space_get_rgb_luminance(space: Object): void;

 ...
 * @param performance 
 */
function fast_fish(source_format: any | null, destination_format: any | null, performance: string | null): Object
/**
 ...
 * @param name 
 */
function format_exists(name: string | null): number
/**
 ...
 * @param babl 
 */
function format_get_encoding(babl: Object): string | null
/**
 ...
 * @param space 
 */
function format_with_space(encoding: string | null, space: Object): Object
function get_model_flags(model: Object): ModelFlag
/**
 * Returns a string describing a Babl object.
 * @param babl 
 */
function get_name(babl: Object): string | null
/**
 * Get the version information on the babl library
 */
function get_version(): [ /* major */ number, /* minor */ number, /* micro */ number ]
function icc_get_key(icc_data: string | null, icc_length: number, key: string | null, language: string | null, country: string | null): string | null
function icc_make_space(icc_data: string | null, icc_length: number, intent: IccIntent, error: string | null): Object
/**
...
function model_is(babl: Object, model_name: string | null): number
/**
 ...
 * @param space 
 */
function model_with_space(name: string | null, space: Object): Object
/**
 ...
 */
function new_palette(name: string | null, format_u8: Object, format_u8_with_alpha: Object): Object
/**
 * create a new palette based format, name is optional pass in NULL to get
 * an anonymous format. If you pass in with_alpha the format also gets
 * an 8bit alpha channel. Returns the BablModel of the color model. If
 ...
 * @param format_u8_with_alpha 
 */
function new_palette_with_space(name: string | null, space: Object, format_u8: Object, format_u8_with_alpha: Object): Object
/**
...
function process_rows(babl_fish: Object, source: any | null, source_stride: number, dest: any | null, dest_stride: number, n: number, rows: number): number
/**
 ...
 */
function space_from_icc(icc_data: string | null, icc_length: number, intent: IccIntent): [ /* returnType */ Object, /* error */ string | null ]
/**
 ...
 */
function space_get_icc(babl: Object): [ /* returnType */ string | null, /* length */ number ]
/**

/**
 * The GIR-derived widget VOCABULARY for St-15.
 *
 * GENERATED — do not edit. Provenance: St-15 — dropped empty base(s): Atk.ImplementorIface
 *
 * 27 instantiable GTypes (of which 0 concrete widgets), 28 declarations, 12 enum nick unions, 0 slot candidates.
 *
...
import type { ClutterActorAccessibleConstructOnly, ClutterActorAccessibleProps, ClutterActorConstructOnly, ClutterActorMetaConstructOnly, ClutterActorMetaProps, ClutterActorProps, ClutterAnimatableConstructOnly, ClutterAnimatableProps, ClutterContentConstructOnly, ClutterContentProps, ClutterEffectConstructOnly, ClutterEffectProps, ClutterImageConstructOnly, ClutterImageProps, ClutterInputContentPurposeNick, ClutterOffscreenEffectConstructOnly, ClutterOffscreenEffectProps, ClutterShaderEffectConstructOnly, ClutterShaderEffectProps } from '@girs/clutter-15/vocabulary';

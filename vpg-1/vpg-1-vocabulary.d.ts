/**
 * The GIR-derived widget VOCABULARY for Vpg-1.
 *
 * GENERATED — do not edit. Provenance: Vpg-1 — inlined base(s) their owner's vocabulary does not emit: Vda.Connection
 *
...
export interface VpgConnectionProps extends GObjectProps, VdaConnectionProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type VpgConnectionConstructOnly = GObjectConstructOnly | VdaConnectionConstructOnly;

...
static ["new"](): FeedsPool;
    ...
    connect_after(signal: 'feed-ready', callback: ((_source: this, feed: GObject.Object, items: FeedItem[]) => void)): number
...
static ["new"](): FeedsPublisher;
    ...
    connect_after(signal: 'delete-subscription', callback: ((_source: this, object: FeedChannel, p0: string) => void)): number
    ...
    connect_after(signal: 'new-subscription', callback: ((_source: this, object: FeedChannel, p0: string) => void)): number
...
static ["new"](): FeedsSubscriber;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'notification-received', callback: ((_source: this, feed: GObject.Object, item: GObject.Object) => void)): number
    connect_after(signal: 'notification-received', callback: ((_source: this, feed: GObject.Object, item: GObject.Object) => void)): number

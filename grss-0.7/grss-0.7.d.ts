...
export namespace Grss {
    ...
    class FeedAtomFormatter extends FeedFormatter {
        // Constructors of Grss-0.7.FeedAtomFormatter
    ...
    class FeedChannel extends GObject.Object {
        // Constructors of Grss-0.7.FeedChannel
        ...
        // Owm methods of Grss-0.7.FeedChannel
    ...
    class FeedEnclosure extends GObject.Object {
        // Constructors of Grss-0.7.FeedEnclosure

        static ['new'](url: string): FeedEnclosure;

        // Owm methods of Grss-0.7.FeedEnclosure
    ...
    abstract class FeedFormatter extends GObject.Object {
        // Owm methods of Grss-0.7.FeedFormatter
    ...
    class FeedItem extends GObject.Object {
        // Constructors of Grss-0.7.FeedItem

        static ['new'](parent: FeedChannel): FeedItem;

        // Owm methods of Grss-0.7.FeedItem
    ...
    class FeedParser extends GObject.Object {
        // Constructors of Grss-0.7.FeedParser

        static ['new'](): FeedParser;

        // Owm methods of Grss-0.7.FeedParser
    ...
    class FeedRssFormatter extends FeedFormatter {
        // Constructors of Grss-0.7.FeedRssFormatter
    ...
    class FeedsGroup extends GObject.Object {
        // Constructors of Grss-0.7.FeedsGroup

        static ['new'](): FeedsGroup;

        // Owm methods of Grss-0.7.FeedsGroup
    ...
    class FeedsPool extends GObject.Object {
        // Constructors of Grss-0.7.FeedsPool

        static ['new'](): FeedsPool;

        // Owm methods of Grss-0.7.FeedsPool
    ...
    class FeedsPublisher extends GObject.Object {
        // Constructors of Grss-0.7.FeedsPublisher

        static ['new'](): FeedsPublisher;

        // Owm methods of Grss-0.7.FeedsPublisher
    ...
    abstract class FeedsStore extends GObject.Object {
        // Owm methods of Grss-0.7.FeedsStore
    ...
    class FeedsSubscriber extends GObject.Object {
        // Constructors of Grss-0.7.FeedsSubscriber

        static ['new'](): FeedsSubscriber;

        // Owm methods of Grss-0.7.FeedsSubscriber
    ...
    class FeedAtomFormatterClass {}

    class FeedAtomFormatterPrivate {}

    class FeedChannelClass {}

    class FeedChannelPrivate {}

    class FeedEnclosureClass {}

    class FeedEnclosurePrivate {}

    class FeedFormatterClass {}
    ...
    class FeedRssFormatterClass {}

    class FeedRssFormatterPrivate {}

    class FeedsGroupClass {}

    class FeedsGroupPrivate {}

    class FeedsPoolClass {}

    class FeedsPoolPrivate {}

    class FeedsPublisherClass {}

    class FeedsPublisherPrivate {}

    class FeedsStoreClass {}

    class FeedsStorePrivate {}

    class FeedsSubscriberClass {}

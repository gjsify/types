/**
 * The GIR-derived widget VOCABULARY for Gcr-3.
 *
 * GENERATED — do not edit. Provenance: Gcr-3 — library 3.41.2
 *
 * 12 instantiable GTypes (of which 0 concrete widgets), 16 declarations, 0 enum nick unions, 0 slot candidates.
 *
...
import type Gcr from './gcr-3.js';
import type Gio from '@girs/gio-2.0';
import type { GckObjectConstructOnly, GckObjectProps } from '@girs/gck-1/vocabulary';
...
export interface GcrCertificateProps extends GcrComparableProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GcrCertificateConstructOnly = GcrComparableConstructOnly;
...
export interface GcrCollectionProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GcrCollectionConstructOnly = GObjectConstructOnly;

/** An interface for comparing objects */
export interface GcrComparableProps extends GObjectProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GcrComparableConstructOnly = GObjectConstructOnly;

/** A collection which filters a [iface@Collection]. */
export interface GcrFilterCollectionProps extends GObjectProps, GcrCollectionProps {
    underlying?: Gcr.Collection;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GcrFilterCollectionConstructOnly = GObjectConstructOnly | GcrCollectionConstructOnly | 'underlying';
...
export interface GcrPkcs11CertificateProps extends GckObjectProps, GcrCertificateProps, GcrComparableProps {
    /** Automatically loaded attributes for this certificate. */
    attributes?: Gck.Attributes;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GcrPkcs11CertificateConstructOnly = GckObjectConstructOnly | GcrCertificateConstructOnly | GcrComparableConstructOnly | 'attributes';
...
export interface GcrSimpleCertificateProps extends GObjectProps, GcrCertificateProps, GcrComparableProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GcrSimpleCertificateConstructOnly = GObjectConstructOnly | GcrCertificateConstructOnly | GcrComparableConstructOnly;

/** A simple implementation of [iface@Collection], which you can add and remove objects from. */
export interface GcrSimpleCollectionProps extends GObjectProps, GcrCollectionProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GcrSimpleCollectionConstructOnly = GObjectConstructOnly | GcrCollectionConstructOnly;
...
/** An implementation of #GcrCollection, which combines the objects in other [iface@Collection]s. */
export interface GcrUnionCollectionProps extends GObjectProps, GcrCollectionProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type GcrUnionCollectionConstructOnly = GObjectConstructOnly | GcrCollectionConstructOnly;

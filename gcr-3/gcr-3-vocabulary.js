// The widget vocabulary of Gcr-3 as runtime data.
//
...
export const PROVENANCE = {
    ...
    requiredVocabularies: ['@girs/gck-1/vocabulary', '@girs/gio-2.0/vocabulary', '@girs/gobject-2.0/vocabulary'],
};

export const OWN_PROPS = {
    GcrCertificateRequest: ['private-key'],
    GcrFilterCollection: ['underlying'],
...
export const DECLS = {
    ...
    GcrFilterCollection: ['GcrFilterCollection', 'GObject', 'GcrCollection'],
    GcrParser: ['GcrParser', 'GObject'],
    GcrPkcs11Certificate: ['GcrPkcs11Certificate', 'GckObject', 'GObject', 'GcrCertificate', 'GcrComparable'],
    GcrSecretExchange: ['GcrSecretExchange', 'GObject'],
    GcrSimpleCertificate: ['GcrSimpleCertificate', 'GObject', 'GcrCertificate', 'GcrComparable'],
    GcrSimpleCollection: ['GcrSimpleCollection', 'GObject', 'GcrCollection'],
    ...
    GcrUnionCollection: ['GcrUnionCollection', 'GObject', 'GcrCollection'],
};
...
export const PROP_TYPES = {
    ...
    'GcrFilterCollection.underlying': 'GcrCollection',

...
interface BookClientView extends Gio.Initable {
     ...
     * @param cancellable optional #GCancellable object, or %NULL
     */
    dupContacts(rangeStart: number, rangeLength: number, cancellable: Gio.Cancellable | null): void
    /**
     ...
     */
    dupContactsFinish(result: Gio.AsyncResult): [ /* returnType */ boolean, /* outRangeStart */ number, /* outContacts */ EBookContacts.Contact[] ]
    /**
     ...
     */
    dupIndices(): EBookContacts.BookIndices
    /**
     ...
     */
    setSortFieldsSync(fields: EBookContacts.BookClientViewSortFields, cancellable: Gio.Cancellable | null): boolean
    /**
    ...
    on(sigName: "content-changed", callback: BookClientView.ContentChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "content-changed", callback: BookClientView.ContentChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "content-changed", callback: BookClientView.ContentChangedSignalCallback): NodeJS.EventEmitter

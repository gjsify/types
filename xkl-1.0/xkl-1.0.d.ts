...
_init(...args: any[]): void;
    ...
    connect(signal: 'X-state-changed', callback: ((_source: this, object: EngineStateChange, p0: number, p1: boolean) => void)): number
    connect_after(signal: 'X-state-changed', callback: ((_source: this, object: EngineStateChange, p0: number, p1: boolean) => void)): number
    ...
    connect_after(signal: 'new-toplevel-window', callback: ((_source: this, object: number, p0: number) => number)): number
    emit(signal: 'new-toplevel-window', object: number, p0: number): void

    // Own static methods of Xkl.Engine

    static INT__LONG_LONG(closure: GObject.Closure, return_value: GObject.Value, n_param_values: number, param_values: GObject.Value, invocation_hint: any, marshal_data: any): void
    static VOID__ENUM_INT_BOOLEAN(closure: GObject.Closure, return_value: GObject.Value, n_param_values: number, param_values: GObject.Value, invocation_hint: any, marshal_data: any): void
    /**

...
export namespace Xkl {
    ...
    class ConfigItem extends GObject.Object {
        // Own fields of Xkl-1.0.ConfigItem

        name: number[];
        short_description: number[];
        description: number[];

        // Constructors of Xkl-1.0.ConfigItem

        static ['new'](): ConfigItem;

        // Owm methods of Xkl-1.0.ConfigItem
    ...
    class ConfigRec extends GObject.Object {
        // Own fields of Xkl-1.0.ConfigRec
        ...
        // Constructors of Xkl-1.0.ConfigRec

        static ['new'](): ConfigRec;

        // Owm methods of Xkl-1.0.ConfigRec
    ...
    class ConfigRegistry extends GObject.Object {
        // Own properties of Xkl-1.0.ConfigRegistry

        engine: Engine;

        // Owm methods of Xkl-1.0.ConfigRegistry
    ...
    class Engine extends GObject.Object {
        // Own properties of Xkl-1.0.Engine
    ...
    class State {
        // Own fields of Xkl-1.0.State

        group: number;
        indicators: number;

        // Constructors of Xkl-1.0.State

...
export namespace InputPad {
     ...
     * @param marshal_data
     */
    function BOOLEAN__STRING_UINT_UINT_UINT_UINT(
     ...
     * @param options
     */
    function gdk_xkb_set_layout(
        window: GtkWindow,
        xkb_key_list: XKBKeyList,
        layouts: string,
        variants: string,
        options: string,
    ): number;
     ...
     */
    function window_init(argv: string[] | null, type: WindowType | null): [number, string[] | null, number];
    /**
     * @param window_data
     */
    ...
    class GtkApplication extends Gtk.Application implements Gio.ActionGroup, Gio.ActionMap {
        ...
        connect<K extends keyof GtkApplication.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, GtkApplication.SignalSignatures[K]>,
        ): number;
        ...
        emit<K extends keyof GtkApplication.SignalSignatures>(
            signal: K,
            ...args: GObject.GjsParameters<GtkApplication.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never
        ): void;
    ...
    class GtkButton extends Gtk.Button implements Atk.ImplementorIface, Gtk.Actionable, Gtk.Activatable, Gtk.Buildable {
        ...
        /** @signal */
        connect<K extends keyof GtkButton.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, GtkButton.SignalSignatures[K]>,
        ): number;
        connect(signal: string, callback: (...args: any[]) => any): number;
        /** @signal */
        ...
        emit<K extends keyof GtkButton.SignalSignatures>(
            signal: K,
            ...args: GObject.GjsParameters<GtkButton.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never
        ): void;
        emit(signal: string, ...args: any[]): void;
         ...
         * @param type
         */
        set_table_type(type: TableType | null): void;
        /**
         * @param code
         */
         ...
         * about checking for a toplevel {@link InputPad.GtkWindow} in the docs for
         ...
         * has been added to a widget hierarchy with a {@link InputPad.GtkWindow} at the top.
         *
         ...
         * space. When a user resizes a {@link InputPad.GtkWindow}, widgets with expand=TRUE
         ...
         * hierarchy with {@link InputPad.GtkWindow} at the top.
         *
         ...
         * this widget. This function can only be called after the widget
         * has been added to a widget hierarchy with a {@link InputPad.GtkWindow}
         * at the top.
         *
        ...
        /**
         * Returns the {@link InputPad.GtkWindow} of the current tooltip. This can be the
         * GtkWindow created by default, or the custom tooltip window set
         * using `gtk_widget_set_tooltip_window()`.
         * @returns The {@link InputPad.GtkWindow} of the current tooltip.
         */
         ...
         * window was inside a {@link InputPad.GtkWindow}-derived widget which was in turn
         * inside the toplevel {@link InputPad.GtkWindow}. While the second case may
         * seem unlikely, it actually happens when a {@link Gtk.Plug} is embedded
         * inside a {@link Gtk.Socket} within the same application.
         *
         * To reliably find the toplevel {@link InputPad.GtkWindow}, use
        ...
        grab_default(): void;
        /**
         * Causes `widget` to have the keyboard focus for the {@link InputPad.GtkWindow} it's
         ...
         * signal on a {@link InputPad.GtkWindow}. The function calls `gtk_widget_hide()` on its
         ...
         *
         * Currently only {@link InputPad.GtkWindow} and {@link Gtk.Invisible} (and out-of-process
         ...
         * that do pay attention to the flag, such as {@link Gtk.EventBox} and {@link InputPad.GtkWindow},
         ...
         *
         * For {@link InputPad.GtkWindow} classes, setting a `parent_window` effects whether
         * the window is a toplevel window or can be embedded into other
         * widgets.
         *
         * For {@link InputPad.GtkWindow} classes, this needs to be called before the
         * window is realized.
         ...
         * @param custom_window a {@link InputPad.GtkWindow}, or `null`
         */
         ...
         * (i.e. a {@link InputPad.GtkWindow} that has not yet been shown), enter the main
        ...
        implements Atk.ImplementorIface, Gtk.Buildable, Gtk.CellEditable, Gtk.CellLayout
    {
        ...
        connect<K extends keyof GtkComboBox.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, GtkComboBox.SignalSignatures[K]>,
        ): number;
        connect(signal: string, callback: (...args: any[]) => any): number;
        /** @signal */
        ...
        emit<K extends keyof GtkComboBox.SignalSignatures>(
            signal: K,
            ...args: GObject.GjsParameters<GtkComboBox.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never
        ): void;
        emit(signal: string, ...args: any[]): void;
    ...
    abstract class GtkKbdui extends GObject.Object {
        ...
        /** @signal */
        connect<K extends keyof GtkKbdui.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, GtkKbdui.SignalSignatures[K]>,
        ): number;
        connect(signal: string, callback: (...args: any[]) => any): number;
        /** @signal */
        ...
        emit<K extends keyof GtkKbdui.SignalSignatures>(
            signal: K,
            ...args: GObject.GjsParameters<GtkKbdui.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never
        ): void;
        emit(signal: string, ...args: any[]): void;
    ...
    class GtkViewport extends Gtk.Bin implements Atk.ImplementorIface, Gtk.Buildable, Gtk.Scrollable {
        ...
        connect<K extends keyof GtkViewport.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, GtkViewport.SignalSignatures[K]>,
        ): number;
        connect(signal: string, callback: (...args: any[]) => any): number;
        /** @signal */
        ...
        emit<K extends keyof GtkViewport.SignalSignatures>(
            signal: K,
            ...args: GObject.GjsParameters<GtkViewport.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never
        ): void;
        emit(signal: string, ...args: any[]): void;
        ...
        implements Atk.ImplementorIface, Gio.ActionGroup, Gio.ActionMap, Gtk.Buildable
    {
         ...
         * @param type
         */
        set_show_layout(type: WindowShowLayoutType | null): void;
        /**
         * @param type
         */
        set_show_table(type: WindowShowTableType | null): void;
        /**

...
export namespace GPluginGtk4 {
     ...
     * @since 0.38
     */
    class PluginRow extends Gtk.ListBoxRow implements Gtk.Accessible, Gtk.Actionable, Gtk.Buildable, Gtk.ConstraintTarget {
     ...
     * @since 0.40
     */
    class PluginSettingsList extends Gtk.Box implements Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Orientable {

...
function interfaces_marshal_VOID__OBJECT_BOOLEAN(closure: GObject.Closure, return_value: GObject.Value, n_param_values: number, param_values: GObject.Value, invocation_hint: any, marshal_data: any): void
function interfaces_marshal_VOID__OBJECT_INT(closure: GObject.Closure, return_value: GObject.Value, n_param_values: number, param_values: GObject.Value, invocation_hint: any, marshal_data: any): void
function interfaces_marshal_VOID__OBJECT_POINTER(closure: GObject.Closure, return_value: GObject.Value, n_param_values: number, param_values: GObject.Value, invocation_hint: any, marshal_data: any): void
function interfaces_marshal_VOID__OBJECT_STRING(closure: GObject.Closure, return_value: GObject.Value, n_param_values: number, param_values: GObject.Value, invocation_hint: any, marshal_data: any): void
function interfaces_marshal_VOID__OBJECT_ULONG(closure: GObject.Closure, return_value: GObject.Value, n_param_values: number, param_values: GObject.Value, invocation_hint: any, marshal_data: any): void
/**

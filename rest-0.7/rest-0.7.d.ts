...
export namespace Rest {
    ...
    class ProxyCallError extends GLib.Error {
        // Own fields of Rest-0.7.ProxyCallError
        ...
        // Constructors of Rest-0.7.ProxyCallError

        constructor(options: { message: string; code: number });

        // Owm methods of Rest-0.7.ProxyCallError
    ...
    class ProxyError extends GLib.Error {
        // Own fields of Rest-0.7.ProxyError
        ...
        // Constructors of Rest-0.7.ProxyError

        constructor(options: { message: string; code: number });

        // Owm methods of Rest-0.7.ProxyError
    ...
    class OAuth2Proxy extends Proxy {
        // Own properties of Rest-0.7.OAuth2Proxy
        ...
        // Constructors of Rest-0.7.OAuth2Proxy
        ...
        // Owm methods of Rest-0.7.OAuth2Proxy
    ...
    class OAuthProxy extends Proxy {
        // Own properties of Rest-0.7.OAuthProxy
        ...
        // Constructors of Rest-0.7.OAuthProxy
        ...
        // Owm methods of Rest-0.7.OAuthProxy
    ...
    class OAuthProxyCall extends ProxyCall {
        // Owm methods of Rest-0.7.OAuthProxyCall
    ...
    class Proxy extends GObject.Object {
        // Own properties of Rest-0.7.Proxy
        ...
        // Constructors of Rest-0.7.Proxy
    ...
    class ProxyAuth extends GObject.Object {
        // Owm methods of Rest-0.7.ProxyAuth
    ...
    class ProxyCall extends GObject.Object {
        // Own properties of Rest-0.7.ProxyCall

        proxy: Proxy;

        // Owm methods of Rest-0.7.ProxyCall
    ...
    class XmlParser extends GObject.Object {
        // Constructors of Rest-0.7.XmlParser

        static ['new'](): XmlParser;

        // Owm methods of Rest-0.7.XmlParser
    ...
    class OAuth2ProxyCallClass {}

    class OAuth2ProxyClass {}

    class OAuth2ProxyPrivate {}

    class OAuthProxyCallClass {}

    class OAuthProxyClass {}

    class Param {
        // Constructors of Rest-0.7.Param
    ...
    class Params {
        // Owm methods of Rest-0.7.Params
    ...
    class ParamsIter {
        // Owm methods of Rest-0.7.ParamsIter
    ...
    class XmlNode {
        // Own fields of Rest-0.7.XmlNode

        name: string;
        content: string;

        // Owm methods of Rest-0.7.XmlNode

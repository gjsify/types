...
export namespace Gst {
    ...
    class CoreError extends GLib.Error {
        // Own fields of Gst-1.0.CoreError
        ...
        // Constructors of Gst-1.0.CoreError

        constructor(options: { message: string; code: number });

        // Owm methods of Gst-1.0.CoreError
    ...
    class LibraryError extends GLib.Error {
        // Own fields of Gst-1.0.LibraryError
        ...
        // Constructors of Gst-1.0.LibraryError

        constructor(options: { message: string; code: number });

        // Owm methods of Gst-1.0.LibraryError
    ...
    class ParseError extends GLib.Error {
        // Own fields of Gst-1.0.ParseError
        ...
        // Constructors of Gst-1.0.ParseError

        constructor(options: { message: string; code: number });

        // Owm methods of Gst-1.0.ParseError
    ...
    class PluginError extends GLib.Error {
        // Own fields of Gst-1.0.PluginError
        ...
        // Constructors of Gst-1.0.PluginError

        constructor(options: { message: string; code: number });

        // Owm methods of Gst-1.0.PluginError
    ...
    class ResourceError extends GLib.Error {
        // Own fields of Gst-1.0.ResourceError
        ...
        // Constructors of Gst-1.0.ResourceError

        constructor(options: { message: string; code: number });

        // Owm methods of Gst-1.0.ResourceError
    ...
    class StreamError extends GLib.Error {
        // Own fields of Gst-1.0.StreamError
        ...
        // Constructors of Gst-1.0.StreamError

        constructor(options: { message: string; code: number });

        // Owm methods of Gst-1.0.StreamError
    ...
    class URIError extends GLib.Error {
        // Own fields of Gst-1.0.URIError
         ...
         *     the URI references
         */
        BAD_REFERENCE: number;

        // Constructors of Gst-1.0.URIError

        constructor(options: { message: string; code: number });

        // Owm methods of Gst-1.0.URIError
     ...
     */
    function buffer_list_replace(old_list?: BufferList | null, new_list?: BufferList | null): boolean;
    /**
     * Modifies a pointer to a #GstBufferList to point to a different
     ...
     * @returns %TRUE if @new_list was different from @old_list
     */
    function buffer_list_take(old_list: BufferList, new_list?: BufferList | null): boolean;
    /**
     ...
     */
    function context_replace(old_context: Context, new_context?: Context | null): boolean;
     ...
     */
    function message_take(old_message: Message, new_message?: Message | null): boolean;
    /**
     ...
     */
    function query_take(old_query?: Query | null, new_query?: Query | null): boolean;
    /**
     ...
     */
    function tag_list_replace(old_taglist?: TagList | null, new_taglist?: TagList | null): boolean;
    /**
     ...
     * @returns %TRUE if @new_taglist was different from @old_taglist
     */
    function tag_list_take(old_taglist: TagList, new_taglist?: TagList | null): boolean;
    /**
     ...
     */
    function type_is_plugin_api(type: GObject.GType): boolean;
    /**
     ...
     * @returns %TRUE on success
     */
    function value_deserialize_with_pspec(src: string, pspec?: GObject.ParamSpec | null): boolean;
    /**
    ...
    interface ValueDeserializeWithPSpecFunc {
        (dest: GObject.Value, s: string, pspec: GObject.ParamSpec): boolean;
    }
    ...
    abstract class Allocator extends Object {
        // Own fields of Gst-1.0.Allocator
        ...
        // Owm methods of Gst-1.0.Allocator
    ...
    class Bin extends Element {
        ...
        // Constructors of Gst-1.0.Bin

        static ['new'](name?: string | null): Bin;

        // Owm methods of Gst-1.0.Bin
    ...
    class BufferPool extends Object {
        // Own fields of Gst-1.0.BufferPool

        object: Object;
        flushing: number;

        // Constructors of Gst-1.0.BufferPool

        static ['new'](): BufferPool;

        // Owm methods of Gst-1.0.BufferPool
         ...
         * @param config a #GstBufferPool configuration
         */
        static config_get_allocator(config: Structure): boolean;
        /**
         ...
         * @param config a #GstBufferPool configuration
         */
        static config_get_params(config: Structure): boolean;
        /**
    ...
    class Bus extends Object {
        ...
        // Own fields of Gst-1.0.Bus

        object: Object;

        // Constructors of Gst-1.0.Bus

        static ['new'](): Bus;

        // Owm methods of Gst-1.0.Bus
    ...
    abstract class Clock extends Object {
        // Own properties of Gst-1.0.Clock
        ...
        // Own fields of Gst-1.0.Clock

        object: Object;

        // Owm methods of Gst-1.0.Clock
         ...
         */
        static id_wait(id: ClockID): ClockReturn;
        /**
    ...
    abstract class ControlBinding extends Object {
        // Own properties of Gst-1.0.ControlBinding

        name: string;
        object: Object;

        // Own fields of Gst-1.0.ControlBinding

        pspec: GObject.ParamSpec;

        // Owm methods of Gst-1.0.ControlBinding
    ...
    abstract class Device extends Object {
        // Own properties of Gst-1.0.Device
    ...
    class DeviceMonitor extends Object {
        // Own properties of Gst-1.0.DeviceMonitor

        show_all: boolean;
        showAll: boolean;

        // Constructors of Gst-1.0.DeviceMonitor

        static ['new'](): DeviceMonitor;

        // Owm methods of Gst-1.0.DeviceMonitor
    ...
    abstract class DeviceProvider extends Object {
        // Own fields of Gst-1.0.DeviceProvider

        devices: any[];

        // Owm methods of Gst-1.0.DeviceProvider
    ...
    class DeviceProviderFactory extends PluginFeature {
        // Owm methods of Gst-1.0.DeviceProviderFactory
    ...
    class DynamicTypeFactory extends PluginFeature {
        // Owm methods of Gst-1.0.DynamicTypeFactory
    ...
    abstract class Element extends Object {
        ...
        // Owm methods of Gst-1.0.Element
    ...
    class ElementFactory extends PluginFeature {
        // Owm methods of Gst-1.0.ElementFactory
     ...
     */
    class FlagSet {
        // Owm methods of Gst-1.0.FlagSet
    ...
    class GhostPad extends ProxyPad {
        // Own fields of Gst-1.0.GhostPad

        pad: ProxyPad;

        // Constructors of Gst-1.0.GhostPad
        ...
        // Owm methods of Gst-1.0.GhostPad
    ...
    abstract class Object extends GObject.InitiallyUnowned {
        // Own properties of Gst-1.0.Object
        ...
        // Own fields of Gst-1.0.Object

        object: GObject.InitiallyUnowned;
        flags: number;

        // Owm methods of Gst-1.0.Object
         ...
         */
        static replace(oldobj?: Object | null, newobj?: Object | null): boolean;
    ...
    class Pad extends Object {
        ...
        // Own fields of Gst-1.0.Pad

        object: Object;
        element_private: any;
        padtemplate: PadTemplate;

        // Constructors of Gst-1.0.Pad
         ...
         * @returns the #GstPadTemplate from which     this pad was instantiated, or %NULL if this pad has no     template. Unref after usage.
         */
        get_pad_template(): PadTemplate | null;
        /**
         * Gets the capabilities for `pad'`s template.
         * @returns the #GstCaps of this pad template. Unref after usage.
         */
         ...
         * @returns a #GstPad, or %NULL if @pad has none or more than one internal links. Unref returned pad with gst_object_unref().
         */
         ...
         * @returns the current #GstStream for @pad, or %NULL.     unref the returned stream when no longer needed.
         */
         ...
         * @returns a new #GstIterator of #GstPad     or %NULL when the pad does not have an iterator function     configured. Use gst_iterator_free() after usage.
         */
    ...
    class PadTemplate extends Object {
        // Own properties of Gst-1.0.PadTemplate
        ...
        // Own fields of Gst-1.0.PadTemplate

        object: Object;

        // Constructors of Gst-1.0.PadTemplate
        ...
        // Owm methods of Gst-1.0.PadTemplate

        /**
         * Gets the capabilities of the pad template.
         * @returns the #GstCaps of the pad template. Unref after usage.
         */
        get_caps(): Caps;
        /**
    ...
    class Pipeline extends Bin {
        // Own properties of Gst-1.0.Pipeline
        ...
        // Own fields of Gst-1.0.Pipeline

        bin: Bin;
        fixed_clock: Clock;
        stream_time: ClockTime;

        // Constructors of Gst-1.0.Pipeline

        static ['new'](name?: string | null): Pipeline;

        // Owm methods of Gst-1.0.Pipeline
    ...
    abstract class PluginFeature extends Object {
        // Owm methods of Gst-1.0.PluginFeature
    ...
    class ProxyPad extends Pad {
        // Own fields of Gst-1.0.ProxyPad

        pad: Pad;

        // Owm methods of Gst-1.0.ProxyPad
         ...
         * @param size The length of the buffer
         */
        static getrange_default(pad: Pad, parent: Object, offset: number, size: number): FlowReturn;
        /**
         ...
         * @returns the target #GstProxyPad, can be %NULL.  Unref target pad after usage.
         */
    ...
    class Registry extends Object {
        // Own fields of Gst-1.0.Registry

        object: Object;

        // Owm methods of Gst-1.0.Registry
         ...
         * @returns a #GList of     #GstPluginFeature. Use gst_plugin_feature_list_free() after usage. MT safe.
         */
         ...
         * @param type a #GType.
         * @returns a #GList of     #GstPluginFeature of @type. Use gst_plugin_feature_list_free() after use MT safe.
         */
    ...
    class SharedTaskPool extends TaskPool {
        // Constructors of Gst-1.0.SharedTaskPool

        static ['new'](): SharedTaskPool;

        // Owm methods of Gst-1.0.SharedTaskPool
    ...
    class Stream extends Object {
        // Own properties of Gst-1.0.Stream
    ...
    class StreamCollection extends Object {
        // Own properties of Gst-1.0.StreamCollection

        upstream_id: string;
        upstreamId: string;

        // Constructors of Gst-1.0.StreamCollection

        static ['new'](upstream_id?: string | null): StreamCollection;

        // Owm methods of Gst-1.0.StreamCollection
    ...
    class SystemClock extends Clock {
        // Own properties of Gst-1.0.SystemClock

        clock_type: ClockType;
        clockType: ClockType;

        // Own fields of Gst-1.0.SystemClock

        clock: Clock;

        // Owm methods of Gst-1.0.SystemClock
    ...
    class Task extends Object {
        ...
        // Constructors of Gst-1.0.Task

        static ['new'](func: TaskFunction): Task;

        // Owm methods of Gst-1.0.Task
    ...
    class TaskPool extends Object {
        // Own fields of Gst-1.0.TaskPool

        object: Object;

        // Constructors of Gst-1.0.TaskPool

        static ['new'](): TaskPool;

        // Owm methods of Gst-1.0.TaskPool
    ...
    abstract class Tracer extends Object {
        // Own properties of Gst-1.0.Tracer

        params: string;

        // Owm methods of Gst-1.0.Tracer
    ...
    class TracerFactory extends PluginFeature {
        // Owm methods of Gst-1.0.TracerFactory
    ...
    class TypeFindFactory extends PluginFeature {
        // Owm methods of Gst-1.0.TypeFindFactory
     ...
     */
    class ValueArray {
        // Owm methods of Gst-1.0.ValueArray
     ...
     */
    class ValueList {
        // Owm methods of Gst-1.0.ValueList
         ...
         * @param value2 a #GValue
         */
        static concat(value1: GObject.Value, value2: GObject.Value): void;
        /**
         * Gets the number of values contained in `value`.
         * @param value a #GValue of type #GST_TYPE_LIST
         */
         ...
         * @param value2 a #GValue
         */
        static merge(value1: GObject.Value, value2: GObject.Value): void;
        /**
    ...
    class AllocationParams {
        // Own fields of Gst-1.0.AllocationParams
        ...
        // Constructors of Gst-1.0.AllocationParams
        ...
        // Owm methods of Gst-1.0.AllocationParams
    ...
    class Buffer {
        ...
        // Constructors of Gst-1.0.Buffer
         ...
         * @returns the new #GstBuffer that contains the memory     of the two source buffers.
         */
         ...
         */
        extract_dup(offset: number, size: number): void;
        /**
         ...
         */
        find_memory(offset: number, size: number): boolean;
        /**
         ...
         * @param idx an index
         * @returns a #GstMemory that contains the data of the memory block at @idx.
         */
         ...
         * @returns a #GstMemory that contains the merged data of @length    blocks starting at @idx.
         */
         ...
         * @returns the #GstReferenceTimestampMeta or %NULL when there is no such metadata on @buffer.
         */
         ...
         * @returns %TRUE if the map succeeded and @info contains valid data.
         */
        map_range(idx: number, length: number, flags: MapFlags): boolean;
        /**
     ...
     */
    class BufferList {
        // Constructors of Gst-1.0.BufferList
        ...
        // Owm methods of Gst-1.0.BufferList
         ...
         * @param new_list pointer to a #GstBufferList that     will replace the buffer list pointed to by @old_list.
         */
        static replace(old_list?: BufferList | null, new_list?: BufferList | null): boolean;
        /**
         * Modifies a pointer to a #GstBufferList to point to a different
         * #GstBufferList. This function is similar to gst_buffer_list_replace() except
         * that it takes ownership of `new_list`.
         ...
         * @param new_list pointer to a #GstBufferList     that will replace the bufferlist pointed to by @old_list.
         */
        static take(old_list: BufferList, new_list?: BufferList | null): boolean;
    ...
    class BufferPoolAcquireParams {
        // Own fields of Gst-1.0.BufferPoolAcquireParams
    ...
    class Caps {
         ...
         * @returns a pointer to the #GstCapsFeatures     corresponding to @index
         */
     ...
     */
    class CapsFeatures {
        // Constructors of Gst-1.0.CapsFeatures
        ...
        // Owm methods of Gst-1.0.CapsFeatures
     ...
     */
    class ClockEntry {
        // Own fields of Gst-1.0.ClockEntry
    ...
    class Context {
         ...
         * @param new_context pointer to a #GstContext that will     replace the context pointed to by @old_context.
         */
        static replace(old_context: Context, new_context?: Context | null): boolean;
     ...
     */
    class CustomMeta {
        // Owm methods of Gst-1.0.CustomMeta
     ...
     */
    class DateTime {
        // Constructors of Gst-1.0.DateTime
        ...
        // Owm methods of Gst-1.0.DateTime
         ...
         * @returns a newly created #GDateTime, or %NULL on error or if @datetime does not have a year, month, day, hour, minute and second.
         */
     ...
     */
    class DebugCategory {
        // Constructors of Gst-1.0.DebugCategory

        constructor(properties?: Partial<{}>);

        // Owm methods of Gst-1.0.DebugCategory
    ...
    class DebugMessage {
        // Owm methods of Gst-1.0.DebugMessage
    ...
    class DeviceProviderClass {
        // Own fields of Gst-1.0.DeviceProviderClass

        factory: DeviceProviderFactory;

        // Owm methods of Gst-1.0.DeviceProviderClass
         ...
         * @param value the value to set
         */
        add_static_metadata(key: string, value: string): void;
        /**
         * Get metadata with `key` in `klass`.
         * @param key the key to get
         * @returns the metadata for @key.
     ...
     */
    class ElementClass {
        // Own fields of Gst-1.0.ElementClass
        ...
        // Owm methods of Gst-1.0.ElementClass
         ...
         */
        add_static_pad_template(static_templ: StaticPadTemplate): void;
        /**
         * Adds a pad template to an element class based on the static pad template
         * `templ`. This is mainly used in the _class_init functions of element
         * implementations. If a pad template with the same name already exists,
         ...
         */
        add_static_pad_template_with_gtype(static_templ: StaticPadTemplate, pad_type: GObject.GType): void;
        /**
         * Get metadata with `key` in `klass`.
         * @param key the key to get
         * @returns the metadata for @key.
     ...
     */
    class Event {
        // Own fields of Gst-1.0.Event

        type: EventType;
        timestamp: number;
        seqnum: number;

        // Constructors of Gst-1.0.Event
    ...
    class FormatDefinition {
        // Own fields of Gst-1.0.FormatDefinition
     ...
     */
    class Iterator {
        // Own fields of Gst-1.0.Iterator
        ...
        // Constructors of Gst-1.0.Iterator
        ...
        static new_single(type: GObject.GType, object: GObject.Value): Iterator;

        // Owm methods of Gst-1.0.Iterator
         ...
         */
        find_custom(func: GLib.CompareFunc): boolean;
        /**
    ...
    class Memory {
        ...
        // Constructors of Gst-1.0.Memory
         ...
         */
        make_mapped(flags: MapFlags): Memory | null;
        /**
    ...
    class Message {
        ...
        // Constructors of Gst-1.0.Message
        ...
        // Owm methods of Gst-1.0.Message
         ...
         * @param new_message pointer to a #GstMessage that     will replace the message pointed to by @old_message.
         */
        static take(old_message: Message, new_message?: Message | null): boolean;
     ...
     */
    class Meta {
        // Own fields of Gst-1.0.Meta

        flags: MetaFlags;

        // Owm methods of Gst-1.0.Meta
     ...
     */
    class MetaInfo {
        // Own fields of Gst-1.0.MetaInfo
        ...
        // Owm methods of Gst-1.0.MetaInfo
    ...
    class MetaTransformCopy {
        // Own fields of Gst-1.0.MetaTransformCopy

        region: boolean;
        offset: number;
        size: number;

        // Constructors of Gst-1.0.MetaTransformCopy
     ...
     */
    class MiniObject {
        // Own fields of Gst-1.0.MiniObject
        ...
        // Owm methods of Gst-1.0.MiniObject
         ...
         * @param newdata pointer to new mini-object
         */
        static replace(olddata?: MiniObject | null, newdata?: MiniObject | null): boolean;
        /**
         * Modifies a pointer to point to a new mini-object. The modification
         * is done atomically. This version is similar to gst_mini_object_replace()
         * except that it does not increase the refcount of `newdata` and thus
         ...
         * @param newdata pointer to new mini-object
         */
        static take(olddata: MiniObject, newdata: MiniObject): boolean;
     ...
     */
    class ObjectClass {
        // Own fields of Gst-1.0.ObjectClass
     ...
     */
    class PadProbeInfo {
        // Own fields of Gst-1.0.PadProbeInfo
        ...
        // Owm methods of Gst-1.0.PadProbeInfo
    ...
    class ParamSpecArray {
        // Own fields of Gst-1.0.ParamSpecArray
    ...
    class ParamSpecFraction {
        // Own fields of Gst-1.0.ParamSpecFraction
    ...
    class ParentBufferMeta {
        // Owm methods of Gst-1.0.ParentBufferMeta
     ...
     */
    class ParseContext {
        // Constructors of Gst-1.0.ParseContext

        constructor(properties?: Partial<{}>);

        static ['new'](): ParseContext;

        // Owm methods of Gst-1.0.ParseContext
     ...
     */
    class PluginDesc {
        // Own fields of Gst-1.0.PluginDesc
     ...
     */
    class PollFD {
        // Own fields of Gst-1.0.PollFD

        fd: number;

        // Constructors of Gst-1.0.PollFD
     ...
     */
    class Promise {
        // Constructors of Gst-1.0.Promise
        ...
        // Owm methods of Gst-1.0.Promise
    ...
    class ProtectionMeta {
        // Owm methods of Gst-1.0.ProtectionMeta
     ...
     */
    class Query {
        // Own fields of Gst-1.0.Query

        type: QueryType;

        // Constructors of Gst-1.0.Query
         ...
         * @param new_query pointer to a #GstQuery that will     replace the query pointed to by @old_query.
         */
        static take(old_query?: Query | null, new_query?: Query | null): boolean;
         ...
         */
        find_allocation_meta(api: GObject.GType): boolean;
        /**
         ...
         * valid.
         */
        parse_accept_caps(): void;
        /**
         * Parse the result from `query` and store in `result`.
         */
        parse_accept_caps_result(): void;
        /**
    ...
    class ReferenceTimestampMeta {
        // Own fields of Gst-1.0.ReferenceTimestampMeta

        timestamp: ClockTime;
        duration: ClockTime;

        // Owm methods of Gst-1.0.ReferenceTimestampMeta
     ...
     */
    class Sample {
        // Constructors of Gst-1.0.Sample
    ...
    class Segment {
        ...
        // Constructors of Gst-1.0.Segment
        ...
        // Owm methods of Gst-1.0.Segment
         ...
         */
        position_from_running_time_full(format: Format, running_time: number): number;
        /**
         ...
         * @returns a 1 or -1 on success, 0 on failure.
         */
        position_from_stream_time_full(format: Format, stream_time: number): number;
        /**
         ...
         * @returns a 1 or -1 on success, 0 on failure.
         */
        to_stream_time_full(format: Format, position: number): number;
    }
     ...
     */
    class StaticCaps {
        // Own fields of Gst-1.0.StaticCaps

        string: string;

        // Owm methods of Gst-1.0.StaticCaps
         ...
         * @returns a pointer to the #GstCaps. Since the     core holds an additional ref to the returned caps, use     gst_caps_make_writable() on the returned caps to modify it.
         */
        get(): Caps | null;
    }
    ...
    class StaticPadTemplate {
        // Own fields of Gst-1.0.StaticPadTemplate

        name_template: string;
        direction: PadDirection;
        presence: PadPresence;

        // Owm methods of Gst-1.0.StaticPadTemplate
         ...
         * @returns the #GstCaps of the static pad template. Unref after usage. Since the core holds an additional ref to the returned caps, use gst_caps_make_writable() on the returned caps to modify it.
         */
        get_caps(): Caps;
    }
     ...
     */
    class Structure {
        // Own fields of Gst-1.0.Structure

        type: GObject.GType;

        // Constructors of Gst-1.0.Structure
        ...
        // Owm methods of Gst-1.0.Structure
         ...
         * @param newstr a new #GstStructure
         */
        static take(oldstr_ptr?: Structure | null, newstr?: Structure | null): boolean;
         ...
         */
        get_array(fieldname: string): boolean;
        /**
         ...
         */
        get_clock_time(fieldname: string): boolean;
        /**
         ...
         */
        get_date(fieldname: string): boolean;
        /**
         ...
         * @returns %TRUE if the value could be set correctly. If there was no field with @fieldname or the existing field did not contain a data, this function returns %FALSE.
         */
        get_date_time(fieldname: string): boolean;
        /**
         ...
         */
        get_flags(fieldname: string, flags_type: GObject.GType): boolean;
        /**
         ...
         */
        get_int64(fieldname: string): boolean;
        /**
         * This is useful in language bindings where unknown #GValue types are not
         ...
         */
        get_list(fieldname: string): boolean;
        /**
         ...
         */
        get_uint64(fieldname: string): boolean;
        /**
     ...
     */
    class TagList {
        // Constructors of Gst-1.0.TagList
        ...
        // Owm methods of Gst-1.0.TagList
         ...
         * @param tag tag to read out
         */
        static copy_value(list: TagList, tag: string): boolean;
        /**
         * Modifies a pointer to a #GstTagList to point to a different #GstTagList. The
         * modification is done atomically (so this is useful for ensuring thread
         * safety in some cases), and the reference counts are updated appropriately
         ...
         * @param new_taglist pointer to a #GstTagList that     will replace the tag list pointed to by @old_taglist.
         */
        static replace(old_taglist?: TagList | null, new_taglist?: TagList | null): boolean;
        /**
         * Modifies a pointer to a #GstTagList to point to a different #GstTagList.
         * This function is similar to gst_tag_list_replace() except that it takes
         * ownership of `new_taglist`.
         ...
         * @param new_taglist pointer to a #GstTagList that     will replace the taglist pointed to by @old_taglist.
         */
        static take(old_taglist: TagList, new_taglist?: TagList | null): boolean;
         ...
         * @returns %TRUE, if a value was copied, %FALSE if the tag didn't exist in the              given list.
         */
        get_boolean(tag: string): boolean;
        /**
         ...
         * @returns %TRUE, if a value was copied, %FALSE if the tag didn't exist in the              given list.
         */
        get_boolean_index(tag: string, index: number): boolean;
        /**
         ...
         */
        get_date_index(tag: string, index: number): boolean;
        /**
         ...
         */
        get_date_time(tag: string): boolean;
        /**
         ...
         * @returns %TRUE, if a value was copied, %FALSE if the tag didn't exist in the              given list or if it was %NULL.
         */
        get_date_time_index(tag: string, index: number): boolean;
        /**
         * Copies the contents for the given tag into the value, merging multiple values
         * into one if multiple values are associated with the tag.
         * @param tag tag to read out
         ...
         * @returns %TRUE, if a value was copied, %FALSE if the tag didn't exist in the              given list.
         */
        get_double_index(tag: string, index: number): boolean;
        /**
         * Copies the contents for the given tag into the value, merging multiple values
         * into one if multiple values are associated with the tag.
         * @param tag tag to read out
         ...
         * @returns %TRUE, if a value was copied, %FALSE if the tag didn't exist in the              given list.
         */
        get_float_index(tag: string, index: number): boolean;
        /**
         * Copies the contents for the given tag into the value, merging multiple values
         * into one if multiple values are associated with the tag.
         * @param tag tag to read out
         ...
         * @returns %TRUE, if a value was copied, %FALSE if the tag didn't exist in the              given list.
         */
        get_int64_index(tag: string, index: number): boolean;
        /**
         * Gets the value that is at the given index for the given tag in the given
         * list.
         * @param tag tag to read out
         ...
         * @returns %TRUE, if a value was copied, %FALSE if the tag didn't exist in the              given list.
         */
        get_int_index(tag: string, index: number): boolean;
        /**
         * Copies the contents for the given tag into the value, merging multiple values
         * into one if multiple values are associated with the tag.
         * @param tag tag to read out
         * @returns %TRUE, if a value was copied, %FALSE if the tag didn't exist in the              given list.
         */
        get_pointer(tag: string): boolean;
        /**
         * Gets the value that is at the given index for the given tag in the given
         * list.
         * @param tag tag to read out
         ...
         * @returns %TRUE, if a value was copied, %FALSE if the tag didn't exist in the              given list.
         */
        get_pointer_index(tag: string, index: number): boolean;
        /**
         ...
         */
        get_sample_index(tag: string, index: number): boolean;
        /**
         ...
         * @returns %TRUE, if a value was copied, %FALSE if the tag didn't exist in the              given list.
         */
        get_string_index(tag: string, index: number): boolean;
        /**
         ...
         * @returns %TRUE, if a value was copied, %FALSE if the tag didn't exist in the              given list.
         */
        get_uint64_index(tag: string, index: number): boolean;
        /**
         * Gets the value that is at the given index for the given tag in the given
         * list.
         * @param tag tag to read out
         ...
         * @returns %TRUE, if a value was copied, %FALSE if the tag didn't exist in the              given list.
         */
        get_uint_index(tag: string, index: number): boolean;
        /**
         * Gets the value that is at the given index for the given tag in the given
         * list.
         * @param tag tag to read out
         ...
         */
        peek_string_index(tag: string, index: number): boolean;
        /**
     ...
     */
    class TimedValue {
        // Own fields of Gst-1.0.TimedValue

        timestamp: ClockTime;
        value: number;

        // Constructors of Gst-1.0.TimedValue
     ...
     */
    class TypeFind {
        // Own fields of Gst-1.0.TypeFind

        data: any;

        // Constructors of Gst-1.0.TypeFind
        ...
        // Owm methods of Gst-1.0.TypeFind
         ...
         * @param caps The fixed #GstCaps to suggest
         */
    ...
    class Uri {
         ...
         * @returns A #GList of path segment          strings or %NULL if no path segments are available. Free the list          when no longer needed with g_list_free_full(list, g_free).
         */
         ...
         * @returns A #GstUri which represents the base                                      with the reference URI joined on.
         */
     ...
     */
    class ValueTable {
        // Own fields of Gst-1.0.ValueTable
    ...
    interface ChildProxy {
        // Owm methods of Gst-1.0.ChildProxy
        ...
        // Own virtual methods of Gst-1.0.ChildProxy
    ...
    interface Preset {
        ...
        // Own virtual methods of Gst-1.0.Preset
         ...
         * @param tag meta data item name
         */
        vfunc_get_meta(name: string, tag: string): boolean;
        /**
         * Get a copy of preset names as a %NULL terminated string array.
         */
    ...
    interface TagSetter {
        // Owm methods of Gst-1.0.TagSetter
    ...
    interface TocSetter {
        // Owm methods of Gst-1.0.TocSetter
    ...
    interface URIHandler {
        // Owm methods of Gst-1.0.URIHandler
        ...
        // Own virtual methods of Gst-1.0.URIHandler

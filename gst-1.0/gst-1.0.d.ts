 ...
 */
function tag_merge_strings_with_comma(src: GObject.Value): unknown
/**
 * This is a convenience function for the func argument of gst_tag_register().
 * It creates a copy of the first value from the list.
 * @param src GValue to copy from
 */
function tag_merge_use_first(src: GObject.Value): unknown
/**
 ...
 */
function value_init_and_copy(src: GObject.Value): unknown
/**
 ...
 */
function value_union(value1: GObject.Value, value2: GObject.Value): [boolean, unknown]
/**
...
static ["new"](name?: (string | null)): Bin;
    ...
    connect_after(signal: 'deep-element-added', callback: ((_source: this, sub_bin: Bin, element: Element) => void)): number
    ...
    connect_after(signal: 'deep-element-removed', callback: ((_source: this, sub_bin: Bin, element: Element) => void)): number
...
_init(...args: any[]): void;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'deep-notify', callback: ((_source: this, prop_object: Object, prop: GObject.ParamSpec) => void)): number
    connect_after(signal: 'deep-notify', callback: ((_source: this, prop_object: Object, prop: GObject.ParamSpec) => void)): number
...
static ["new"](upstream_id?: (string | null)): StreamCollection;
    ...
    connect_after(signal: 'stream-notify', callback: ((_source: this, object: Stream, p0: GObject.ParamSpec) => void)): number
...
_init(...args: any[]): void;
     ...
     * @param value2 a #GValue
     */
    static concat(value1: GObject.Value, value2: GObject.Value): unknown
    /**
     * Gets the number of values contained in `value`.
     * @param value a #GValue of type #GST_TYPE_LIST
     */
     ...
     * @param value2 a #GValue
     */
    static merge(value1: GObject.Value, value2: GObject.Value): unknown
    /**
...
static new_sized(size: number): BufferList;
    ...
    // Own static methods of Gst.BufferList
...
static ["new"](context_type: string, persistent: boolean): Context;
    ...
    // Own static methods of Gst.Context
...
constructor(flags: MemoryFlags, data: Uint8Array, maxsize: number, offset: number, notify?: (GLib.DestroyNotify | null));
_init(...args: any[]): void;

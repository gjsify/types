...
export namespace GWeather {
    ...
    class Info extends GObject.Object {
        // Own properties of GWeather-4.0.Info
        ...
        // Constructors of GWeather-4.0.Info

        static ['new'](location?: Location | null): Info;

        // Owm methods of GWeather-4.0.Info
     ...
     */
    class Conditions {
        // Own fields of GWeather-4.0.Conditions

        significant: boolean;
        phenomenon: ConditionPhenomenon;
        qualifier: ConditionQualifier;

        // Owm methods of GWeather-4.0.Conditions

// The widget vocabulary of GWeather-4.0 as runtime data.
//
// GENERATED — do not edit. Provenance: GWeather-4.0
//
...
export const PROVENANCE = {
    ...
    unsettableProps: [],
    unresolvedProps: [],
    identifierPrefixes: ['GWeather'],
    requiredVocabularies: ['@girs/gobject-2.0/vocabulary'],
};

export const OWN_PROPS = {
    GWeatherInfo: ['application-id', 'contact-info', 'enabled-providers', 'location'],
};
...
export const DECLS = {
    GWeatherInfo: ['GWeatherInfo', 'GObject'],
    GWeatherLocation: ['GWeatherLocation', 'GObject'],
};
...
export const FLAG_VALUES = {
    ...
    'GWeatherProvider.met-no': 8,
    'GWeatherProvider.metar': 1,
    'GWeatherProvider.none': 0,
    'GWeatherProvider.nws': 32,
    'GWeatherProvider.owm': 16,
};
...
export const PROP_ENUMS = {
    'GWeatherInfo.enabled-providers': 'GWeatherProvider',
};
...
export const PROP_TYPES = {
    'GWeatherInfo.application-id': 'gchararray',
    'GWeatherInfo.contact-info': 'gchararray',
    'GWeatherInfo.enabled-providers': 'GWeatherProvider',
    'GWeatherInfo.location': 'GWeatherLocation',
};

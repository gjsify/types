...
import './node-handy-0.0-import.d.ts';
 ...
 */
function listBoxSeparatorHeader(row: Gtk.ListBoxRow, before: Gtk.ListBoxRow | null, unusedUserData: any | null): void
/**
 * Computes the length of the string in utf-8 characters. See #g_utf8_strlen.
 * @param string a #GString
 * @returns the length of @string in characters
 */
function stringUtf8Len(string: GLib.String): number
/**
 ...
 * @returns @string
 */
function stringUtf8Truncate(string: GLib.String, len: number): GLib.String
/**
...
interface Swipeable extends Gtk.Widget {
    ...
    on(sigName: "begin-swipe", callback: Swipeable.BeginSwipeSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "begin-swipe", callback: Swipeable.BeginSwipeSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "begin-swipe", callback: Swipeable.BeginSwipeSignalCallback): NodeJS.EventEmitter
    emit(sigName: "begin-swipe", ...args: any[]): void
    connect(sigName: "end-swipe", callback: Swipeable.EndSwipeSignalCallback): number
    on(sigName: "end-swipe", callback: Swipeable.EndSwipeSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "end-swipe", callback: Swipeable.EndSwipeSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "end-swipe", callback: Swipeable.EndSwipeSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "switch-child", callback: Swipeable.SwitchChildSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "switch-child", callback: Swipeable.SwitchChildSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "switch-child", callback: Swipeable.SwitchChildSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "update-swipe", callback: Swipeable.UpdateSwipeSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "update-swipe", callback: Swipeable.UpdateSwipeSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "update-swipe", callback: Swipeable.UpdateSwipeSignalCallback): NodeJS.EventEmitter
...
interface Column extends Atk.ImplementorIface, Gtk.Buildable {
    ...
    connect(sigName: "notify::linear-growth-width", callback: (...args: any[]) => void): number
    on(sigName: "notify::linear-growth-width", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::linear-growth-width", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::linear-growth-width", callback: (...args: any[]) => void): NodeJS.EventEmitter
    emit(sigName: "notify::linear-growth-width", ...args: any[]): void
    connect(sigName: "notify::maximum-width", callback: (...args: any[]) => void): number
    on(sigName: "notify::maximum-width", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::maximum-width", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::maximum-width", callback: (...args: any[]) => void): NodeJS.EventEmitter
...
interface Dialer extends Atk.ImplementorIface, Gtk.Buildable {
    ...
    submitted(number: string | null): void

    // Own signals of Handy-0.0.Handy.Dialer

    connect(sigName: "deleted", callback: Dialer.DeletedSignalCallback): number
    on(sigName: "deleted", callback: Dialer.DeletedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "deleted", callback: Dialer.DeletedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "deleted", callback: Dialer.DeletedSignalCallback): NodeJS.EventEmitter
    emit(sigName: "deleted", ...args: any[]): void
    connect(sigName: "submitted", callback: Dialer.SubmittedSignalCallback): number
    on(sigName: "submitted", callback: Dialer.SubmittedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "submitted", callback: Dialer.SubmittedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "submitted", callback: Dialer.SubmittedSignalCallback): NodeJS.EventEmitter
    emit(sigName: "submitted", ...args: any[]): void
    connect(sigName: "symbol-clicked", callback: Dialer.SymbolClickedSignalCallback): number
    on(sigName: "symbol-clicked", callback: Dialer.SymbolClickedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "symbol-clicked", callback: Dialer.SymbolClickedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "symbol-clicked", callback: Dialer.SymbolClickedSignalCallback): NodeJS.EventEmitter
    ...
    connect(sigName: "notify::show-action-buttons", callback: (...args: any[]) => void): number
    on(sigName: "notify::show-action-buttons", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::show-action-buttons", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::show-action-buttons", callback: (...args: any[]) => void): NodeJS.EventEmitter
...
interface DialerButton extends Atk.ImplementorIface, Gtk.Actionable, Gtk.Activatable, Gtk.Buildable {
    ...
    connect(sigName: "notify::digit", callback: (...args: any[]) => void): number
    on(sigName: "notify::digit", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::digit", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::digit", callback: (...args: any[]) => void): NodeJS.EventEmitter
    emit(sigName: "notify::digit", ...args: any[]): void
    connect(sigName: "notify::symbols", callback: (...args: any[]) => void): number
    on(sigName: "notify::symbols", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::symbols", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::symbols", callback: (...args: any[]) => void): NodeJS.EventEmitter
...
interface DialerCycleButton extends Atk.ImplementorIface, Gtk.Actionable, Gtk.Activatable, Gtk.Buildable {
    ...
    on(sigName: "cycle-end", callback: DialerCycleButton.CycleEndSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "cycle-end", callback: DialerCycleButton.CycleEndSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "cycle-end", callback: DialerCycleButton.CycleEndSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "cycle-start", callback: DialerCycleButton.CycleStartSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "cycle-start", callback: DialerCycleButton.CycleStartSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "cycle-start", callback: DialerCycleButton.CycleStartSignalCallback): NodeJS.EventEmitter
    emit(sigName: "cycle-start", ...args: any[]): void

    // Class property signals of Handy-0.0.Handy.DialerCycleButton

    connect(sigName: "notify::cycle-timeout", callback: (...args: any[]) => void): number
    on(sigName: "notify::cycle-timeout", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::cycle-timeout", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::cycle-timeout", callback: (...args: any[]) => void): NodeJS.EventEmitter
...
interface Dialog extends Atk.ImplementorIface, Gtk.Buildable {
    ...
    connect(sigName: "notify::narrow", callback: (...args: any[]) => void): number
    on(sigName: "notify::narrow", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::narrow", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::narrow", callback: (...args: any[]) => void): NodeJS.EventEmitter
...
interface HeaderGroup extends Gtk.Buildable {
    ...
    connect(sigName: "notify::focus", callback: (...args: any[]) => void): number
    on(sigName: "notify::focus", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::focus", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::focus", callback: (...args: any[]) => void): NodeJS.EventEmitter
...
interface Keypad extends Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
    ...
    connect(sigName: "notify::left-action", callback: (...args: any[]) => void): number
    on(sigName: "notify::left-action", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::left-action", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::left-action", callback: (...args: any[]) => void): NodeJS.EventEmitter
    emit(sigName: "notify::left-action", ...args: any[]): void
    connect(sigName: "notify::only-digits", callback: (...args: any[]) => void): number
    on(sigName: "notify::only-digits", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::only-digits", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::only-digits", callback: (...args: any[]) => void): NodeJS.EventEmitter
    emit(sigName: "notify::only-digits", ...args: any[]): void
    connect(sigName: "notify::right-action", callback: (...args: any[]) => void): number
    on(sigName: "notify::right-action", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::right-action", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::right-action", callback: (...args: any[]) => void): NodeJS.EventEmitter
    emit(sigName: "notify::right-action", ...args: any[]): void
    connect(sigName: "notify::show-symbols", callback: (...args: any[]) => void): number
    on(sigName: "notify::show-symbols", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::show-symbols", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::show-symbols", callback: (...args: any[]) => void): NodeJS.EventEmitter
...
interface Leaflet extends Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable, Swipeable {
    ...
    connect(sigName: "notify::child-transition-type", callback: (...args: any[]) => void): number
    on(sigName: "notify::child-transition-type", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::child-transition-type", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::child-transition-type", callback: (...args: any[]) => void): NodeJS.EventEmitter
    emit(sigName: "notify::child-transition-type", ...args: any[]): void
    connect(sigName: "notify::fold", callback: (...args: any[]) => void): number
    on(sigName: "notify::fold", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::fold", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::fold", callback: (...args: any[]) => void): NodeJS.EventEmitter
    ...
    connect(sigName: "notify::mode-transition-type", callback: (...args: any[]) => void): number
    on(sigName: "notify::mode-transition-type", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::mode-transition-type", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::mode-transition-type", callback: (...args: any[]) => void): NodeJS.EventEmitter
...
interface Paginator extends Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable, Swipeable {
    ...
    on(sigName: "page-changed", callback: Paginator.PageChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "page-changed", callback: Paginator.PageChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "page-changed", callback: Paginator.PageChangedSignalCallback): NodeJS.EventEmitter
    ...
    connect(sigName: "notify::center-content", callback: (...args: any[]) => void): number
    on(sigName: "notify::center-content", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::center-content", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::center-content", callback: (...args: any[]) => void): NodeJS.EventEmitter
    emit(sigName: "notify::center-content", ...args: any[]): void
    connect(sigName: "notify::indicator-spacing", callback: (...args: any[]) => void): number
    on(sigName: "notify::indicator-spacing", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::indicator-spacing", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::indicator-spacing", callback: (...args: any[]) => void): NodeJS.EventEmitter
    emit(sigName: "notify::indicator-spacing", ...args: any[]): void
    connect(sigName: "notify::indicator-style", callback: (...args: any[]) => void): number
    on(sigName: "notify::indicator-style", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::indicator-style", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::indicator-style", callback: (...args: any[]) => void): NodeJS.EventEmitter

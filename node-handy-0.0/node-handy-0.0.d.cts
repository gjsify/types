 ...
 */
export function enumValueRowName(value: EnumValueObject, userData: any | null): string | null
/**
 ...
 */
export function listBoxSeparatorHeader(row: Gtk.ListBoxRow, before: Gtk.ListBoxRow | null, unusedUserData: any | null): void
/**

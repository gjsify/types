...
import './node-devhelp-3.0-import.d.ts';
    
/**
 * Devhelp-3.0
 */

import type WebKit2 from '@girs/node-webkit2-4.1';
...
export function linkTypeToString(linkType: LinkType): string | null
...
export interface AssistantView extends Atk.ImplementorIface, Gtk.Buildable {
    ...
    on(sigName: "open-uri", callback: AssistantView.OpenUriSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "open-uri", callback: AssistantView.OpenUriSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "open-uri", callback: AssistantView.OpenUriSignalCallback): NodeJS.EventEmitter
...
export interface Book {
    ...
    on(sigName: "deleted", callback: Book.DeletedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "deleted", callback: Book.DeletedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "deleted", callback: Book.DeletedSignalCallback): NodeJS.EventEmitter
    emit(sigName: "deleted", ...args: any[]): void
    connect(sigName: "updated", callback: Book.UpdatedSignalCallback): number
    on(sigName: "updated", callback: Book.UpdatedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "updated", callback: Book.UpdatedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "updated", callback: Book.UpdatedSignalCallback): NodeJS.EventEmitter
...
export interface BookList {
    ...
    on(sigName: "add-book", callback: BookList.AddBookSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "add-book", callback: BookList.AddBookSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "add-book", callback: BookList.AddBookSignalCallback): NodeJS.EventEmitter
    emit(sigName: "add-book", ...args: any[]): void
    connect(sigName: "remove-book", callback: BookList.RemoveBookSignalCallback): number
    on(sigName: "remove-book", callback: BookList.RemoveBookSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "remove-book", callback: BookList.RemoveBookSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "remove-book", callback: BookList.RemoveBookSignalCallback): NodeJS.EventEmitter
...
export interface BookTree extends Atk.ImplementorIface, Gtk.Buildable, Gtk.Scrollable {
    ...
    on(sigName: "link-selected", callback: BookTree.LinkSelectedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "link-selected", callback: BookTree.LinkSelectedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "link-selected", callback: BookTree.LinkSelectedSignalCallback): NodeJS.EventEmitter
...
export interface Completion {
     ...
     * @param str a string.
     */
    addString(str: string | null): void
    /**
...
export class Completion extends GObject.Object {
     ...
     * @returns the completed prefix, or %NULL if a longer prefix has not been found. Free with g_free() when no longer needed.
     */
    static aggregateComplete(completionObjects: Completion[] | null, prefix: string | null): string | null
}
...
export interface KeywordModel extends Gtk.TreeModel {
     ...
     */
    filter(searchString: string | null, currentBookId: string | null, profile: Profile | null): Link | null
...
export interface Settings {
     ...
     */
    getSelectedFonts(): [ /* variableFont */ string | null, /* fixedFont */ string | null ]
     ...
     */
    setFixedFont(fixedFont: string | null): void
    /**
     ...
     */
    setVariableFont(variableFont: string | null): void
    /**
    ...
    on(sigName: "books-disabled-changed", callback: Settings.BooksDisabledChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "books-disabled-changed", callback: Settings.BooksDisabledChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "books-disabled-changed", callback: Settings.BooksDisabledChangedSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "fonts-changed", callback: Settings.FontsChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "fonts-changed", callback: Settings.FontsChangedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "fonts-changed", callback: Settings.FontsChangedSignalCallback): NodeJS.EventEmitter
    emit(sigName: "fonts-changed", ...args: any[]): void

    // Class property signals of Devhelp-3.0.Devhelp.Settings

    connect(sigName: "notify::fixed-font", callback: (...args: any[]) => void): number
    on(sigName: "notify::fixed-font", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::fixed-font", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "notify::fixed-font", callback: (...args: any[]) => void): NodeJS.EventEmitter
    emit(sigName: "notify::fixed-font", ...args: any[]): void
    connect(sigName: "notify::group-books-by-language", callback: (...args: any[]) => void): number
    on(sigName: "notify::group-books-by-language", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::group-books-by-language", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    ...
    connect(sigName: "notify::use-system-fonts", callback: (...args: any[]) => void): number
    on(sigName: "notify::use-system-fonts", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::use-system-fonts", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    ...
    connect(sigName: "notify::variable-font", callback: (...args: any[]) => void): number
    on(sigName: "notify::variable-font", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "notify::variable-font", callback: (...args: any[]) => void, after?: boolean): NodeJS.EventEmitter
...
export interface SettingsBuilder {
     ...
     */
    setContentsPath(contentsPath: string | null): void
    /**
     ...
     */
    setFontsPath(fontsPath: string | null): void
...
export interface Sidebar extends Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
     ...
     */
    setSearchFocus(): void
    setSearchString(str: string | null): void
    ...
    on(sigName: "link-selected", callback: Sidebar.LinkSelectedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "link-selected", callback: Sidebar.LinkSelectedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "link-selected", callback: Sidebar.LinkSelectedSignalCallback): NodeJS.EventEmitter
    emit(sigName: "link-selected", ...args: any[]): void
...
export interface WebView extends Atk.ImplementorIface, Gtk.Buildable {
    ...
    openNewTab(uri: string | null): void

    // Own signals of Devhelp-3.0.Devhelp.WebView

    connect(sigName: "open-new-tab", callback: WebView.OpenNewTabSignalCallback): number
    on(sigName: "open-new-tab", callback: WebView.OpenNewTabSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "open-new-tab", callback: WebView.OpenNewTabSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "open-new-tab", callback: WebView.OpenNewTabSignalCallback): NodeJS.EventEmitter
...
export interface Link {
     ...
     */
    belongsToPage(pageId: string | null): boolean
    /**
     ...
     */
    getUri(): string | null
    matchRelativeUrl(relativeUrl: string | null): boolean
    /**
...
export class Link {
    ...
    constructor(type: LinkType, bookLink: Link, name: string | null, relativeUrl: string | null) 
    static new(type: LinkType, bookLink: Link, name: string | null, relativeUrl: string | null): Link
    static newBook(basePath: string | null, bookId: string | null, bookTitle: string | null, relativeUrl: string | null): Link
}
...
export interface WebViewClass {
    ...
    parentClass: WebKit2.WebViewClass
    openNewTab: (view: WebView, uri: string | null) => void
    padding: any[]
}

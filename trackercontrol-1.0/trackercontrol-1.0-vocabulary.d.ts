/**
 * The GIR-derived widget VOCABULARY for TrackerControl-1.0.
 *
 * GENERATED — do not edit. Provenance: TrackerControl-1.0
 *
...
export type TrackerMinerManagerConstructOnly = GObjectConstructOnly | GInitableConstructOnly | 'auto-start';

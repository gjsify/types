...
module Resolver {
    ...
    interface ConstructorProperties extends Gio.Resolver.ConstructorProperties {
    }
...
module Server {
     ...
     */
    interface CompareMessagesSignalCallback {
...
interface Server {
    ...
    connect_after(sigName: "compare-messages", callback: Server.CompareMessagesSignalCallback): number
    ...
    connect_after(sigName: "handle-message", callback: Server.HandleMessageSignalCallback): number

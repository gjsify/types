...
static ["new"](): Server;
    ...
    connect(signal: 'compare-messages', callback: ((_source: this, expected_message: Soup.Message, actual_message: Soup.Message, actual_client: Soup.ClientContext) => boolean)): number
    connect_after(signal: 'compare-messages', callback: ((_source: this, expected_message: Soup.Message, actual_message: Soup.Message, actual_client: Soup.ClientContext) => boolean)): number
    emit(signal: 'compare-messages', expected_message: Soup.Message, actual_message: Soup.Message, actual_client: Soup.ClientContext): void
    connect(signal: 'handle-message', callback: ((_source: this, message: Soup.Message, client: Soup.ClientContext) => boolean)): number
    connect_after(signal: 'handle-message', callback: ((_source: this, message: Soup.Message, client: Soup.ClientContext) => boolean)): number

...
export namespace Uhm {
    ...
    class Resolver extends Gio.Resolver {
        // Constructors of Uhm-0.0.Resolver

        static ['new'](): Resolver;

        // Owm methods of Uhm-0.0.Resolver
    ...
    class Server extends GObject.Object {
        // Own properties of Uhm-0.0.Server
        ...
        // Constructors of Uhm-0.0.Server

        static ['new'](): Server;

        // Owm methods of Uhm-0.0.Server

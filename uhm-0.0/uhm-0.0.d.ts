...
export namespace Uhm {
    ...
    class Resolver extends Gio.Resolver {
        ...
        /** @signal */
        emit<K extends keyof Resolver.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<Resolver.SignalSignatures[K]>): void;
    ...
    namespace Server {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
             ...
             * @run-last
             */
            "compare-messages": (expected_message: Soup.Message, actual_message: Soup.Message, actual_client: Soup.ClientContext) => boolean | void;
            /**
             ...
             * @run-last
             */
            "handle-message": (message: Soup.Message, client: Soup.ClientContext) => boolean | void;

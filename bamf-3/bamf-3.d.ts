...
_init(...args: any[]): void;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'active-application-changed', callback: ((_source: this, object: Application, p0: Application) => void)): number
    connect_after(signal: 'active-application-changed', callback: ((_source: this, object: Application, p0: Application) => void)): number
    ...
    connect_after(signal: 'active-window-changed', callback: ((_source: this, object: Window, p0: Window) => void)): number
...
_init(...args: any[]): void;
    ...
    connect_after(signal: 'maximized-changed', callback: ((_source: this, object: number, p0: number) => void)): number

/**
 * The GIR-derived widget VOCABULARY for AppIndicator3-0.1.
 *
 * GENERATED — do not edit. Provenance: AppIndicator3-0.1
 *
...
/** A application indicator represents the values that are needed to show a unique status in the panel for an application. */
export interface AppIndicatorProps extends GObjectProps {
    /**
     * If the indicator sets it's status to %APP_INDICATOR_STATUS_ATTENTION then this textual description of the icon shown.
     * @default NULL
     */
    'attention-icon-desc'?: string;
    /**
     * If the indicator sets it's status to %APP_INDICATOR_STATUS_ATTENTION then this icon is shown.
     * @default NULL
     */
    'attention-icon-name'?: string;
    /**
    ...
    id?: string;
    /**
     * A label that can be shown next to the string in the application indicator.
     * @default NULL
     */
    label?: string;
    /**
     * An optional string to provide guidance to the panel on how big the #AppIndicator:label string could get.
     * @default NULL
     */
    'label-guide'?: string;
    /**
     * The ordering index is an odd parameter, and if you think you don't need it you're probably right.
     * @default 0
     */
    'ordering-index'?: number;
    /**
...
export type AppIndicatorConstructOnly = GObjectConstructOnly | 'category' | 'id';

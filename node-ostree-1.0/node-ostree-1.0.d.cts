...
export function checksumB64FromBytes(csum: number[]): string | null
export function checksumB64ToBytes(checksum: string): number[]
export function checksumBytesPeek(bytes: GLib.Variant): number[]
/**
 * Like ostree_checksum_bytes_peek(), but also throws `error`.
 * @param bytes #GVariant of type ay
 * @returns Binary checksum data
 */
export function checksumBytesPeekValidate(bytes: GLib.Variant): number[]
/**
 ...
 */
export function checksumFile(f: Gio.File, objtype: ObjectType, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* outCsum */ number[] ]
/**
 ...
 */
export function checksumFileAsyncFinish(f: Gio.File, result: Gio.AsyncResult): [ /* returnType */ boolean, /* outCsum */ number[] ]
/**
 ...
 * @param cancellable Cancellable
 */
export function checksumFileFromInput(fileInfo: Gio.FileInfo, xattrs: GLib.Variant | null, in_: Gio.InputStream | null, objtype: ObjectType, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* outCsum */ number[] ]
export function checksumFromBytes(csum: number[]): string | null
...
export function checksumToBytes(checksum: string): number[]
 ...
 */
export function objectFromString(str: string): [ /* outChecksum */ string | null, /* outObjtype */ ObjectType ]
/**
...
export function objectToString(checksum: string, objtype: ObjectType): string | null
/**

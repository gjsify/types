...
import './node-ostree-1.0-import.d.ts';
...
function checksumB64FromBytes(csum: number[]): string | null
function checksumB64ToBytes(checksum: string | null): number[]
function checksumBytesPeek(bytes: GLib.Variant): number[]
/**
 * Like ostree_checksum_bytes_peek(), but also throws `error`.
 * @param bytes #GVariant of type ay
 * @returns Binary checksum data
 */
function checksumBytesPeekValidate(bytes: GLib.Variant): number[]
/**
 ...
 */
function checksumFile(f: Gio.File, objtype: ObjectType, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* outCsum */ number[] ]
/**
 ...
 */
function checksumFileAsyncFinish(f: Gio.File, result: Gio.AsyncResult): [ /* returnType */ boolean, /* outCsum */ number[] ]
/**
 ...
 * @param cancellable Cancellable
 */
function checksumFileFromInput(fileInfo: Gio.FileInfo, xattrs: GLib.Variant | null, in_: Gio.InputStream | null, objtype: ObjectType, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* outCsum */ number[] ]
function checksumFromBytes(csum: number[]): string | null
function checksumFromBytesV(csumV: GLib.Variant): string | null
/**
 ...
 */
function checksumInplaceToBytes(checksum: string | null, buf: number): void
function checksumToBytes(checksum: string | null): number[]
function checksumToBytesV(checksum: string | null): GLib.Variant
...
function commitGetParent(commitVariant: GLib.Variant): string | null
 ...
 * @param cancellable Cancellable
 */
function contentFileParseAt(compressed: boolean, parentDfd: number, path: string | null, trusted: boolean, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* outInput */ Gio.InputStream, /* outFileInfo */ Gio.FileInfo, /* outXattrs */ GLib.Variant ]
/**
 ...
 */
function hashObjectName(a: any | null): number
 ...
 */
function objectFromString(str: string | null): [ /* outChecksum */ string | null, /* outObjtype */ ObjectType ]
/**
 ...
 */
function objectNameDeserialize(variant: GLib.Variant): [ /* outChecksum */ string | null, /* outObjtype */ ObjectType ]
function objectNameSerialize(checksum: string | null, objtype: ObjectType): GLib.Variant
function objectToString(checksum: string | null, objtype: ObjectType): string | null
/**
 * The reverse of ostree_object_type_to_string().
 * @param str A stringified version of #OstreeObjectType
 */
function objectTypeFromString(str: string | null): ObjectType
/**
 * Serialize `objtype` to a string; this is used for file extensions.
 * @param objtype an #OstreeObjectType
 */
function objectTypeToString(objtype: ObjectType): string | null
/**
 ...
 */
function parseRefspec(refspec: string | null): [ /* returnType */ boolean, /* outRemote */ string | null, /* outRef */ string | null ]
/**
...
function repoCommitTraverseIterCleanup(p: any | null): void
/**
 * Use this function to see if input strings are checksums.
 * @param sha256 SHA256 hex string
 * @returns %TRUE if @sha256 is a valid checksum string, %FALSE otherwise
 */
function validateChecksumString(sha256: string | null): boolean
function validateRev(rev: string | null): boolean
function validateStructureofChecksumString(checksum: string | null): boolean
/**
...
interface Repo {
     ...
     * @param cancellable Cancellable
     */
    writeContent(expectedChecksum: string | null, objectInput: Gio.InputStream, length: number, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* outCsum */ number[] ]
    /**
     ...
     * @param cancellable Cancellable
     */
    writeMetadata(objtype: ObjectType, expectedChecksum: string | null, object: GLib.Variant, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* outCsum */ number[] ]
    /**

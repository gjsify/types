...
export namespace FolksDummy {
    ...
    class Backend extends Folks.Backend {
        // Constructors of FolksDummy-0.6.Backend

        static ['new'](): Backend;

        // Owm methods of FolksDummy-0.6.Backend
    ...
    class FullPersona extends Persona {
        // Constructors of FolksDummy-0.6.FullPersona
        ...
        // Owm methods of FolksDummy-0.6.FullPersona
    ...
    class PersonaStore extends Folks.PersonaStore {
        ...
        set_add_persona_from_details_mock(mock: PersonaStoreAddPersonaFromDetailsMock): void;
        set_remove_persona_mock(mock: PersonaStoreRemovePersonaMock): void;
        set_prepare_mock(mock: PersonaStorePrepareMock): void;
    ...
    class Persona extends Folks.Persona {
        // Own properties of FolksDummy-0.6.Persona

        property_change_delay: number;
        propertyChangeDelay: number;

        // Constructors of FolksDummy-0.6.Persona
        ...
        // Owm methods of FolksDummy-0.6.Persona

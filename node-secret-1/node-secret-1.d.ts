 ...
 * similar functions.
 */
const COLLECTION_SESSION: string | null
/**
 ...
 */
function passwordLookupFinish(result: Gio.AsyncResult): string | null
/**
 ...
 * @returns a new password string which should be freed with   [func@password_free] or may be freed with [func@GLib.free] when done
 */
function passwordLookupSync(schema: Schema | null, attributes: GLib.HashTable, cancellable: Gio.Cancellable | null): string | null
/**
 ...
 * @param callback called when the operation completes
 */
function passwordStore(schema: Schema | null, attributes: GLib.HashTable, collection: string | null, label: string | null, password: string | null, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void
/**
 * Store a password in the secret service.
 * 
 ...
 * @param callback called when the operation completes
 */
function passwordStoreBinary(schema: Schema | null, attributes: GLib.HashTable, collection: string | null, label: string | null, value: Value, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void
/**
 * Store a password in the secret service.
 * 
 ...
 * @returns whether the storage was successful or not
 */
function passwordStoreBinarySync(schema: Schema | null, attributes: GLib.HashTable, collection: string | null, label: string | null, value: Value, cancellable: Gio.Cancellable | null): boolean
/**
 * Store a password in the secret service.
 * 
 * The `attributes` should be a set of key and value string pairs.
 ...
 * @returns whether the storage was successful or not
 */
function passwordStoreSync(schema: Schema | null, attributes: GLib.HashTable, collection: string | null, label: string | null, password: string | null, cancellable: Gio.Cancellable | null): boolean
/**
...
interface Backend extends Gio.AsyncInitable {
    ...
    store(schema: Schema, attributes: GLib.HashTable, collection: string | null, label: string | null, value: Value, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void
...
class Collection extends Gio.DBusProxy {
     ...
     * @returns the collection, or %NULL if none assigned to the alias
     */
    static forAliasSync(service: Service | null, alias: string | null, flags: CollectionFlags, cancellable: Gio.Cancellable | null): Collection | null
}
...
module Item {
    ...
    interface ConstructorProperties extends Gio.AsyncInitable.ConstructorProperties, Gio.DBusInterface.ConstructorProperties, Gio.Initable.ConstructorProperties, Retrievable.ConstructorProperties, Gio.DBusProxy.ConstructorProperties {
...
class Item extends Gio.DBusProxy {
     ...
     * @param callback called when the operation completes
     */
    static create(collection: Collection, schema: Schema | null, attributes: GLib.HashTable, label: string | null, value: Value, flags: ItemCreateFlags, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void
    /**
     ...
     * @returns the new item, which should be unreferenced   with [method@GObject.Object.unref]
     */
    static createSync(collection: Collection, schema: Schema | null, attributes: GLib.HashTable, label: string | null, value: Value, flags: ItemCreateFlags, cancellable: Gio.Cancellable | null): Item
    /**
...
module Service {
    ...
    interface ConstructorProperties extends Gio.AsyncInitable.ConstructorProperties, Gio.DBusInterface.ConstructorProperties, Gio.Initable.ConstructorProperties, Backend.ConstructorProperties, Gio.DBusProxy.ConstructorProperties {
    }
...
interface Service extends Gio.AsyncInitable, Gio.DBusInterface, Gio.Initable, Backend {
     ...
     * @param callback called when the operation completes
     */
    store(schema: Schema | null, attributes: GLib.HashTable, collection: string | null, label: string | null, value: Value, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void
     ...
     * @returns whether the storage was successful or not
     */
    storeSync(schema: Schema | null, attributes: GLib.HashTable, collection: string | null, label: string | null, value: Value, cancellable: Gio.Cancellable | null): boolean
    /**
...
class Schema {
     ...
     */
    constructor(name: string | null, flags: SchemaFlags, attributeNamesAndTypes: GLib.HashTable) 
    /**
     * Using this function is not normally necessary from C code. This is useful
     * for constructing #SecretSchema structures in bindings.
     * 
     ...
     * @returns the new schema, which should be unreferenced with   [method@Schema.unref] when done
     */
    static new(name: string | null, flags: SchemaFlags, attributeNamesAndTypes: GLib.HashTable): Schema
}

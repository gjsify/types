// The widget vocabulary of Shell-15 as runtime data.
//
// GENERATED — do not edit. Provenance: Shell-15 — dropped empty base(s): Atk.ImplementorIface — inlined base(s) their owner's vocabulary does not emit: NM.SecretAgentOld — prop(s) whose type the model cannot resolve: Shell.App.app-info: Gio.DesktopAppInfo
//
...
export const PROVENANCE = {
    ...
    requiredVocabularies: ['@girs/clutter-15/vocabulary', '@girs/gcr-4/vocabulary', '@girs/gio-2.0/vocabulary', '@girs/gobject-2.0/vocabulary', '@girs/polkitagent-1.0/vocabulary', '@girs/st-15/vocabulary'],
};

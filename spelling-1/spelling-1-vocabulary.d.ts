/**
 * The GIR-derived widget VOCABULARY for Spelling-1.
 *
 * GENERATED — do not edit. Provenance: Spelling-1
 *
...
import type Spelling from './spelling-1.js';
import type { GActionGroupConstructOnly, GActionGroupProps } from '@girs/gio-2.0/vocabulary';
...
export interface SpellingCheckerProps extends GObjectProps {
    /**
     * The "language" to use when checking words with the configured `SpellingProvider`.
     * @default NULL
     */
    language?: string | null;
    /** The "provider" property contains the provider that is providing information to the spell checker. */
    provider?: Spelling.Provider;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type SpellingCheckerConstructOnly = GObjectConstructOnly | 'provider';

/** Represents a spellchecking language. */
export interface SpellingLanguageProps extends GObjectProps {
    /**
     * The language code.
     * @default NULL
     */
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type SpellingLanguageConstructOnly = GObjectConstructOnly | 'code' | 'group' | 'name';

/** `SpellingTextBufferAdapter` implements helpers to easily add spellchecking capabilities to a `GtkSourceBuffer`. */
export interface SpellingTextBufferAdapterProps extends GObjectProps, GActionGroupProps {
    /** The [class@GtkSource.Buffer]. */
    buffer?: GtkSource.Buffer | null;
    /** The [class@Spelling.Checker]. */
    checker?: Spelling.Checker | null;
    /**
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type SpellingTextBufferAdapterConstructOnly = GObjectConstructOnly | GActionGroupConstructOnly | 'buffer';

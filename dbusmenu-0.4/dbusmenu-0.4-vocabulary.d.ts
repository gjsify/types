/**
 * The GIR-derived widget VOCABULARY for Dbusmenu-0.4.
 *
...
export interface DbusmenuClientProps extends GObjectProps {
    /** @default NULL */
    'dbus-name'?: string;
    /** @default NULL */
    'dbus-object'?: string;
...
export type DbusmenuClientConstructOnly = GObjectConstructOnly | 'dbus-name' | 'dbus-object';

/** This is the #GObject based object that represents a menu item. */
export interface DbusmenuMenuitemProps extends GObjectProps {
    /** @default -1 */
    id?: number;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type DbusmenuMenuitemConstructOnly = GObjectConstructOnly | 'id';

/** Public instance data for a #DbusmenuMenuitemProxy. */
export interface DbusmenuMenuitemProxyProps extends DbusmenuMenuitemProps {
    'menu-item'?: Dbusmenu.Menuitem;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type DbusmenuMenuitemProxyConstructOnly = DbusmenuMenuitemConstructOnly | 'menu-item';

/** A server which represents a sharing of a set of #DbusmenuMenuitems across DBus to a #DbusmenuClient. */
export interface DbusmenuServerProps extends GObjectProps {
    /** @default /com/canonical/dbusmenu */
    'dbus-object'?: string;
    'root-node'?: Dbusmenu.Menuitem;
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type DbusmenuServerConstructOnly = GObjectConstructOnly | 'dbus-object';

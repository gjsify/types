...
export namespace Dbusmenu {
    ...
    class Client extends GObject.Object {
        // Own properties of Dbusmenu-0.4.Client
        ...
        // Constructors of Dbusmenu-0.4.Client

        static ['new'](name: string, object: string): Client;

        // Owm methods of Dbusmenu-0.4.Client
    ...
    class Menuitem extends GObject.Object {
        // Own properties of Dbusmenu-0.4.Menuitem

        id: number;

        // Constructors of Dbusmenu-0.4.Menuitem

        static ['new'](): Menuitem;

        static new_with_id(id: number): Menuitem;

        // Owm methods of Dbusmenu-0.4.Menuitem
    ...
    class MenuitemProxy extends Menuitem {
        // Own properties of Dbusmenu-0.4.MenuitemProxy

        menu_item: Menuitem;
        menuItem: Menuitem;

        // Constructors of Dbusmenu-0.4.MenuitemProxy

        static ['new'](mi: Menuitem): MenuitemProxy;

        // Owm methods of Dbusmenu-0.4.MenuitemProxy
    ...
    class Server extends GObject.Object {
        // Own properties of Dbusmenu-0.4.Server
        ...
        // Constructors of Dbusmenu-0.4.Server

        static ['new'](object: string): Server;

        // Owm methods of Dbusmenu-0.4.Server

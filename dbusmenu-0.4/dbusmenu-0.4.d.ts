...
static ["new"](name: string, object: string): Client;
    ...
    connect(signal: 'event-result', callback: ((_source: this, object: GObject.Object, p0: string, p1: GLib.Variant, p2: number, p3: any | null) => void)): number
    connect_after(signal: 'event-result', callback: ((_source: this, object: GObject.Object, p0: string, p1: GLib.Variant, p2: number, p3: any | null) => void)): number
    emit(signal: 'event-result', object: GObject.Object, p0: string, p1: GLib.Variant, p2: number, p3?: (any | null)): void
    ...
    connect_after(signal: 'item-activate', callback: ((_source: this, arg1: GObject.Object, arg2: number) => void)): number
...
static new_with_id(id: number): Menuitem;
    ...
    connect(signal: 'child-moved', callback: ((_source: this, arg1: GObject.Object, arg2: number, arg3: number) => void)): number
    connect_after(signal: 'child-moved', callback: ((_source: this, arg1: GObject.Object, arg2: number, arg3: number) => void)): number
    ...
    connect(signal: 'event', callback: ((_source: this, arg1: string, arg2: GLib.Variant, arg3: number) => boolean)): number
    connect_after(signal: 'event', callback: ((_source: this, arg1: string, arg2: GLib.Variant, arg3: number) => boolean)): number
    ...
    connect_after(signal: 'property-changed', callback: ((_source: this, arg1: string, arg2: GLib.Variant) => void)): number
...
static ["new"](object: string): Server;
    ...
    connect_after(signal: 'item-activation-requested', callback: ((_source: this, arg1: number, arg2: number) => void)): number
    emit(signal: 'item-activation-requested', arg1: number, arg2: number): void
    connect(signal: 'item-property-updated', callback: ((_source: this, object: number, p0: string, p1: GLib.Variant) => void)): number
    connect_after(signal: 'item-property-updated', callback: ((_source: this, object: number, p0: string, p1: GLib.Variant) => void)): number

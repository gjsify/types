 ...
 */
export function infGetDriverVersion(keyfile: GLib.KeyFile, timestamp: number): string | null
/**
 ...
 */
export function utilsSpdxLicenseDetokenize(licenseTokens: string | null): string | null
/**
 ...
 */
export function utilsVersionFromUint16(val: number, flags: VersionParseFlag): string | null
/**
 ...
 */
export function utilsVersionFromUint32(val: number, flags: VersionParseFlag): string | null
/**

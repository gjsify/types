...
static ["new"](swarm_name: string): Peer;
    ...
    connect_after(signal: 'connection-acquired', callback: ((_source: this, object: Gio.DBusConnection) => void)): number
    ...
    connect_after(signal: 'connection-closed', callback: ((_source: this, connection: Gio.DBusConnection) => void)): number
...
static new_with_back_end(name: string, back_end: Model): SharedModel;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'begin-transaction', callback: ((_source: this, begin_seqnum: number, end_seqnum: number) => void)): number
    connect_after(signal: 'begin-transaction', callback: ((_source: this, begin_seqnum: number, end_seqnum: number) => void)): number
    emit(signal: 'begin-transaction', begin_seqnum: number, end_seqnum: number): void
    connect(signal: 'end-transaction', callback: ((_source: this, begin_seqnum: number, end_seqnum: number) => void)): number
    connect_after(signal: 'end-transaction', callback: ((_source: this, begin_seqnum: number, end_seqnum: number) => void)): number

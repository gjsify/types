...
_init(...args: any[]): void;
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number
    emit(id: string, ...args: any[]): void
    connect(signal: 'form-controls-associated', callback: ((_source: this, frame: Frame, elements: JavaScriptCore.Value[]) => void)): number
    connect_after(signal: 'form-controls-associated', callback: ((_source: this, frame: Frame, elements: JavaScriptCore.Value[]) => void)): number
    emit(signal: 'form-controls-associated', frame: Frame, elements: JavaScriptCore.Value[]): void
    connect(signal: 'will-send-submit-event', callback: ((_source: this, form: JavaScriptCore.Value, source_frame: Frame, target_frame: Frame) => void)): number
    connect_after(signal: 'will-send-submit-event', callback: ((_source: this, form: JavaScriptCore.Value, source_frame: Frame, target_frame: Frame) => void)): number
    emit(signal: 'will-send-submit-event', form: JavaScriptCore.Value, source_frame: Frame, target_frame: Frame): void
    connect(signal: 'will-submit-form', callback: ((_source: this, form: JavaScriptCore.Value, source_frame: Frame, target_frame: Frame) => void)): number
    connect_after(signal: 'will-submit-form', callback: ((_source: this, form: JavaScriptCore.Value, source_frame: Frame, target_frame: Frame) => void)): number

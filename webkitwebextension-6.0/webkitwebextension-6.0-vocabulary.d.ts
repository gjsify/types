/**
 * The GIR-derived widget VOCABULARY for WebKitWebExtension-6.0.
 *
 * GENERATED — do not edit. Provenance: WebKitWebExtension-6.0
 *
 * 13 instantiable GTypes (of which 0 concrete widgets), 13 declarations, 0 enum nick unions, 0 slot candidates.
 *

...
export const PROP_TYPES = {
    'DzlAnimation.duration': 'guint',
    'DzlAnimation.frame-clock': 'GdkFrameClock',
    'DzlAnimation.mode': 'DzlAnimationMode',
    'DzlAnimation.target': 'GObject',
    'DzlApplicationWindow.fullscreen': 'gboolean',
    'DzlBindingGroup.source': 'GObject',
    'DzlBoldingLabel.bold': 'gboolean',
    'DzlBox.max-width-request': 'gint',
    'DzlBoxTheatric.alpha': 'gdouble',
    'DzlBoxTheatric.background': 'gchararray',
    'DzlBoxTheatric.height': 'gint',
    'DzlBoxTheatric.icon': 'GIcon',
    'DzlBoxTheatric.surface': 'gpointer',
    'DzlBoxTheatric.target': 'GtkWidget',
    'DzlBoxTheatric.width': 'gint',
    'DzlBoxTheatric.x': 'gint',
    'DzlBoxTheatric.y': 'gint',
    'DzlCenteringBin.max-width-request': 'gint',
    'DzlColumnLayout.column-spacing': 'gint',
    'DzlColumnLayout.column-width': 'gint',
    'DzlColumnLayout.max-columns': 'guint',
    'DzlColumnLayout.row-spacing': 'gint',
    'DzlCpuGraph.max-samples': 'guint',
    'DzlCpuGraph.timespan': 'gint64',
    'DzlCssProvider.base-path': 'gchararray',
    'DzlDirectoryModel.directory': 'GFile',
    'DzlDock.manager': 'DzlDockManager',
    'DzlDockBin.bottom-visible': 'gboolean',
    'DzlDockBin.left-visible': 'gboolean',
    'DzlDockBin.right-visible': 'gboolean',
    'DzlDockBin.top-visible': 'gboolean',
    'DzlDockBinEdge.edge': 'GtkPositionType',
    'DzlDockOverlayEdge.edge': 'GtkPositionType',
    'DzlDockOverlayEdge.position': 'gint',
    'DzlDockRevealer.position': 'gint',
    'DzlDockRevealer.position-set': 'gboolean',
    'DzlDockRevealer.reveal-child': 'gboolean',
    'DzlDockRevealer.transition-duration': 'guint',
    'DzlDockRevealer.transition-type': 'DzlDockRevealerTransitionType',
    'DzlDockStack.edge': 'GtkPositionType',
    'DzlDockStack.show-pinned-button': 'gboolean',
    'DzlDockStack.style': 'DzlTabStyle',
    'DzlDockTransientGrab.timeout': 'guint',
    'DzlDockWidget.can-close': 'gboolean',
    'DzlDockWidget.gicon': 'GIcon',
    'DzlDockWidget.icon-name': 'gchararray',
    'DzlDockWidget.manager': 'DzlDockManager',
    'DzlDockWidget.title': 'gchararray',
    'DzlEmptyState.icon-name': 'gchararray',
    'DzlEmptyState.pixel-size': 'gint',
    'DzlEmptyState.resource': 'gchararray',
    'DzlEmptyState.subtitle': 'gchararray',
    'DzlEmptyState.title': 'gchararray',
    'DzlEntryBox.max-width-chars': 'gint',
    'DzlFileChooserEntry.action': 'GtkFileChooserAction',
    'DzlFileChooserEntry.create-folders': 'gboolean',
    'DzlFileChooserEntry.do-overwrite-confirmation': 'gboolean',
    'DzlFileChooserEntry.file': 'GFile',
    'DzlFileChooserEntry.filter': 'GtkFileFilter',
    'DzlFileChooserEntry.local-only': 'gboolean',
    'DzlFileChooserEntry.max-width-chars': 'gint',
    'DzlFileChooserEntry.show-hidden': 'gboolean',
    'DzlFileChooserEntry.title': 'gchararray',
    'DzlFileTransfer.flags': 'DzlFileTransferFlags',
    'DzlFuzzyIndexBuilder.case-sensitive': 'gboolean',
    'DzlFuzzyIndexCursor.case-sensitive': 'gboolean',
    'DzlFuzzyIndexCursor.index': 'DzlFuzzyIndex',
    'DzlFuzzyIndexCursor.max-matches': 'guint',
    'DzlFuzzyIndexCursor.query': 'gchararray',
    'DzlFuzzyIndexMatch.key': 'gchararray',
    'DzlFuzzyIndexMatch.priority': 'guint',
    'DzlFuzzyIndexMatch.score': 'gfloat',
    'DzlGraphColumn.name': 'gchararray',
    'DzlGraphColumn.value-type': 'GType',
    'DzlGraphLineRenderer.column': 'guint',
    'DzlGraphLineRenderer.line-width': 'gdouble',
    'DzlGraphLineRenderer.stroke-color': 'gchararray',
    'DzlGraphModel.max-samples': 'guint',
    'DzlGraphModel.timespan': 'gint64',
    'DzlGraphModel.value-max': 'gdouble',
    'DzlGraphModel.value-min': 'gdouble',
    'DzlGraphView.model': 'DzlGraphModel',
    'DzlListBox.property-name': 'gchararray',
    'DzlListBox.row-type': 'GType',
    'DzlListBox.row-type-name': 'gchararray',
    'DzlListStoreAdapter.model': 'GListModel',
    'DzlMenuButton.icon-name': 'gchararray',
    'DzlMenuButton.menu-id': 'gchararray',
    'DzlMenuButton.model': 'GMenuModel',
    'DzlMenuButton.show-accels': 'gboolean',
    'DzlMenuButton.show-arrow': 'gboolean',
    'DzlMenuButton.show-icons': 'gboolean',
    'DzlMenuButton.transitions-enabled': 'gboolean',
    'DzlMultiPaned.orientation': 'GtkOrientation',
    'DzlPathBar.path': 'DzlPath',
    'DzlPathElement.icon-name': 'gchararray',
    'DzlPathElement.id': 'gchararray',
    'DzlPathElement.title': 'gchararray',
    'DzlPillBox.label': 'gchararray',
    'DzlPreferencesBin.keywords': 'gchararray',
    'DzlPreferencesBin.path': 'gchararray',
    'DzlPreferencesBin.priority': 'gint',
    'DzlPreferencesBin.schema-id': 'gchararray',
    'DzlPreferencesEntry.text': 'gchararray',
    'DzlPreferencesEntry.title': 'gchararray',
    'DzlPreferencesFileChooserButton.action': 'GtkFileChooserAction',
    'DzlPreferencesFileChooserButton.key': 'gchararray',
    'DzlPreferencesFileChooserButton.subtitle': 'gchararray',
    'DzlPreferencesFileChooserButton.title': 'gchararray',
    'DzlPreferencesFontButton.key': 'gchararray',
    'DzlPreferencesFontButton.title': 'gchararray',
    'DzlPreferencesGroup.is-list': 'gboolean',
    'DzlPreferencesGroup.mode': 'GtkSelectionMode',
    'DzlPreferencesGroup.priority': 'gint',
    'DzlPreferencesGroup.title': 'gchararray',
    'DzlPreferencesPage.priority': 'gint',
    'DzlPreferencesSpinButton.key': 'gchararray',
    'DzlPreferencesSpinButton.subtitle': 'gchararray',
    'DzlPreferencesSpinButton.title': 'gchararray',
    'DzlPreferencesSwitch.is-radio': 'gboolean',
    'DzlPreferencesSwitch.key': 'gchararray',
    'DzlPreferencesSwitch.subtitle': 'gchararray',
    'DzlPreferencesSwitch.title': 'gchararray',
    'DzlPreferencesView.show-search-entry': 'gboolean',
    'DzlPreferencesView.use-sidebar': 'gboolean',
    'DzlProgressButton.progress': 'guint',
    'DzlProgressButton.show-progress': 'gboolean',
    'DzlProgressIcon.progress': 'gdouble',
    'DzlProgressMenuButton.progress': 'gdouble',
    'DzlProgressMenuButton.show-progress': 'gboolean',
    'DzlProgressMenuButton.show-theatric': 'gboolean',
    'DzlProgressMenuButton.theatric-icon-name': 'gchararray',
    'DzlProgressMenuButton.transition-duration': 'guint',
    'DzlPropertiesGroup.object': 'GObject',
    'DzlPropertiesGroup.object-type': 'GType',
    'DzlRadioBox.active-id': 'gchararray',
    'DzlRadioBox.show-more': 'gboolean',
    'DzlReadOnlyListModel.base-model': 'GListModel',
    'DzlRecursiveFileMonitor.root': 'GFile',
    'DzlSearchBar.search-mode-enabled': 'gboolean',
    'DzlSearchBar.show-close-button': 'gboolean',
    'DzlSettingsFlagAction.flag-nick': 'gchararray',
    'DzlSettingsFlagAction.schema-id': 'gchararray',
    'DzlSettingsFlagAction.schema-key': 'gchararray',
    'DzlSettingsSandwich.path': 'gchararray',
    'DzlSettingsSandwich.schema-id': 'gchararray',
    'DzlShortcutAccelDialog.accelerator': 'gchararray',
    'DzlShortcutAccelDialog.shortcut-title': 'gchararray',
    'DzlShortcutContext.name': 'gchararray',
    'DzlShortcutContext.use-binding-sets': 'gboolean',
    'DzlShortcutController.manager': 'DzlShortcutManager',
    'DzlShortcutController.widget': 'GtkWidget',
    'DzlShortcutLabel.accelerator': 'gchararray',
    'DzlShortcutManager.theme': 'DzlShortcutTheme',
    'DzlShortcutManager.theme-name': 'gchararray',
    'DzlShortcutManager.user-dir': 'gchararray',
    'DzlShortcutModel.manager': 'DzlShortcutManager',
    'DzlShortcutModel.theme': 'DzlShortcutTheme',
    'DzlShortcutSimpleLabel.accel': 'gchararray',
    'DzlShortcutSimpleLabel.action': 'gchararray',
    'DzlShortcutSimpleLabel.command': 'gchararray',
    'DzlShortcutSimpleLabel.show-accel': 'gboolean',
    'DzlShortcutSimpleLabel.title': 'gchararray',
    'DzlShortcutTheme.name': 'gchararray',
    'DzlShortcutTheme.parent-name': 'gchararray',
    'DzlShortcutTheme.subtitle': 'gchararray',
    'DzlShortcutTheme.title': 'gchararray',
    'DzlShortcutThemeEditor.theme': 'DzlShortcutTheme',
    'DzlShortcutTooltip.accel': 'gchararray',
    'DzlShortcutTooltip.command-id': 'gchararray',
    'DzlShortcutTooltip.title': 'gchararray',
    'DzlShortcutTooltip.widget': 'GtkWidget',
    'DzlShortcutsGroup.accel-size-group': 'GtkSizeGroup',
    'DzlShortcutsGroup.title': 'gchararray',
    'DzlShortcutsGroup.title-size-group': 'GtkSizeGroup',
    'DzlShortcutsGroup.view': 'gchararray',
    'DzlShortcutsSection.max-height': 'guint',
    'DzlShortcutsSection.section-name': 'gchararray',
    'DzlShortcutsSection.title': 'gchararray',
    'DzlShortcutsSection.view-name': 'gchararray',
    'DzlShortcutsShortcut.accel-size-group': 'GtkSizeGroup',
    'DzlShortcutsShortcut.accelerator': 'gchararray',
    'DzlShortcutsShortcut.action-name': 'gchararray',
    'DzlShortcutsShortcut.direction': 'GtkTextDirection',
    'DzlShortcutsShortcut.icon': 'GIcon',
    'DzlShortcutsShortcut.icon-set': 'gboolean',
    'DzlShortcutsShortcut.shortcut-type': 'GtkShortcutType',
    'DzlShortcutsShortcut.subtitle': 'gchararray',
    'DzlShortcutsShortcut.subtitle-set': 'gboolean',
    'DzlShortcutsShortcut.title': 'gchararray',
    'DzlShortcutsShortcut.title-size-group': 'GtkSizeGroup',
    'DzlShortcutsWindow.section-name': 'gchararray',
    'DzlShortcutsWindow.view-name': 'gchararray',
    'DzlSignalGroup.target': 'GObject',
    'DzlSignalGroup.target-type': 'GType',
    'DzlSimpleLabel.label': 'gchararray',
    'DzlSimpleLabel.width-chars': 'gint',
    'DzlSimpleLabel.xalign': 'gfloat',
    'DzlSimplePopover.button-text': 'gchararray',
    'DzlSimplePopover.message': 'gchararray',
    'DzlSimplePopover.ready': 'gboolean',
    'DzlSimplePopover.text': 'gchararray',
    'DzlSimplePopover.title': 'gchararray',
    'DzlSlider.position': 'DzlSliderPosition',
    'DzlStateMachine.state': 'gchararray',
    'DzlSuggestion.icon-name': 'gchararray',
    'DzlSuggestion.id': 'gchararray',
    'DzlSuggestion.secondary-icon-name': 'gchararray',
    'DzlSuggestion.subtitle': 'gchararray',
    'DzlSuggestion.title': 'gchararray',
    'DzlSuggestionEntry.activate-on-single-click': 'gboolean',
    'DzlSuggestionEntry.compact': 'gboolean',
    'DzlSuggestionEntry.model': 'GListModel',
    'DzlSuggestionEntry.suggestion': 'DzlSuggestion',
    'DzlSuggestionEntryBuffer.suggestion': 'DzlSuggestion',
    'DzlSuggestionPopover.model': 'DzlSuggestion',
    'DzlSuggestionPopover.relative-to': 'GtkWidget',
    'DzlSuggestionPopover.selected': 'DzlSuggestion',
    'DzlSuggestionPopover.subtitle-ellipsize': 'PangoEllipsizeMode',
    'DzlSuggestionPopover.title-ellipsize': 'PangoEllipsizeMode',
    'DzlSuggestionRow.orientation': 'GtkOrientation',
    'DzlSuggestionRow.suggestion': 'DzlSuggestion',
    'DzlTab.active': 'gboolean',
    'DzlTab.can-close': 'gboolean',
    'DzlTab.edge': 'GtkPositionType',
    'DzlTab.style': 'DzlTabStyle',
    'DzlTab.title': 'gchararray',
    'DzlTab.widget': 'GtkWidget',
    'DzlTabStrip.edge': 'GtkPositionType',
    'DzlTabStrip.stack': 'GtkStack',
    'DzlTabStrip.style': 'DzlTabStyle',
    'DzlTaskCache.key-copy-func': 'gpointer',
    'DzlTaskCache.key-destroy-func': 'gpointer',
    'DzlTaskCache.key-equal-func': 'gpointer',
    'DzlTaskCache.key-hash-func': 'gpointer',
    'DzlTaskCache.populate-callback': 'gpointer',
    'DzlTaskCache.populate-callback-data': 'gpointer',
    'DzlTaskCache.populate-callback-data-destroy': 'gpointer',
    'DzlTaskCache.time-to-live': 'gint64',
    'DzlTaskCache.value-copy-func': 'gpointer',
    'DzlTaskCache.value-destroy-func': 'gpointer',
    'DzlThreeGrid.column-spacing': 'guint',
    'DzlThreeGrid.row-spacing': 'guint',
    'DzlTree.always-expand': 'gboolean',
    'DzlTree.context-menu': 'GMenuModel',
    'DzlTree.root': 'DzlTreeNode',
    'DzlTree.selection': 'DzlTreeNode',
    'DzlTree.show-icons': 'gboolean',
    'DzlTreeNode.children-possible': 'gboolean',
    'DzlTreeNode.expanded-icon-name': 'gchararray',
    'DzlTreeNode.gicon': 'GIcon',
    'DzlTreeNode.icon-name': 'gchararray',
    'DzlTreeNode.item': 'GObject',
    'DzlTreeNode.reset-on-collapse': 'gboolean',
    'DzlTreeNode.text': 'gchararray',
    'DzlTreeNode.tree': 'DzlTree',
    'DzlTreeNode.use-dim-label': 'gboolean',
    'DzlTreeNode.use-markup': 'gboolean',
    'DzlWidgetActionGroup.widget': 'GtkWidget',
};

...
function content_code_name(code: ContentCode): string | null
function content_code_read_from_buffer(buf: string | null): ContentCode
function content_code_string(code: ContentCode): string | null
function content_code_string_as_int32(str: string | null): number
...
function mime_to_format(transcode_mimetype: string | null): string | null

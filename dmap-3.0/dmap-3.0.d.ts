...
_init(...args: any[]): void;
    ...
    connect(signal: 'authenticate', callback: ((_source: this, object: string, p0: Soup.Session, p1: Soup.Message, p2: Soup.Auth, p3: boolean) => void)): number
    connect_after(signal: 'authenticate', callback: ((_source: this, object: string, p0: Soup.Session, p1: Soup.Message, p2: Soup.Auth, p3: boolean) => void)): number

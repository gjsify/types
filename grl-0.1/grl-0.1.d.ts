...
export namespace Grl {
    ...
    class Config extends GObject.Object {
        // Constructors of Grl-0.1.Config

        static ['new'](plugin: string, source: string): Config;

        // Owm methods of Grl-0.1.Config
    ...
    class Data extends GObject.Object {
        // Own properties of Grl-0.1.Data

        overwrite: boolean;

        // Constructors of Grl-0.1.Data

        static ['new'](): Data;

        // Owm methods of Grl-0.1.Data
         ...
         */
        get_binary(key: GObject.ParamSpec): number;
        /**
    ...
    class Media extends Data {
        // Constructors of Grl-0.1.Media

        static ['new'](): Media;

        // Owm methods of Grl-0.1.Media
    ...
    class MediaAudio extends Media {
        // Constructors of Grl-0.1.MediaAudio

        static ['new'](): MediaAudio;

        // Owm methods of Grl-0.1.MediaAudio
    ...
    class MediaBox extends Media {
        // Constructors of Grl-0.1.MediaBox

        static ['new'](): MediaBox;

        // Owm methods of Grl-0.1.MediaBox
    ...
    class MediaImage extends Media {
        // Constructors of Grl-0.1.MediaImage

        static ['new'](): MediaImage;

        // Owm methods of Grl-0.1.MediaImage
    ...
    abstract class MediaPlugin extends GObject.Object {
        // Owm methods of Grl-0.1.MediaPlugin
    ...
    abstract class MediaSource extends MetadataSource {
        // Own properties of Grl-0.1.MediaSource
        ...
        // Owm methods of Grl-0.1.MediaSource
    ...
    class MediaVideo extends Media {
        // Constructors of Grl-0.1.MediaVideo

        static ['new'](): MediaVideo;

        // Owm methods of Grl-0.1.MediaVideo
    ...
    abstract class MetadataSource extends MediaPlugin {
        // Own properties of Grl-0.1.MetadataSource
        ...
        // Owm methods of Grl-0.1.MetadataSource
         ...
         * @returns if
         */
        filter_slow(keys: GObject.ParamSpec[] | null, return_filtered: boolean): GObject.ParamSpec[];
        /**
         ...
         */
        filter_supported(keys: GObject.ParamSpec[] | null, return_filtered: boolean): GObject.ParamSpec[];
        /**
         ...
         */
        filter_writable(keys: GObject.ParamSpec[] | null, return_filtered: boolean): GObject.ParamSpec[];
         ...
         */
        may_resolve(media: Media, key_id: KeyID): boolean;
    ...
    class PluginRegistry extends GObject.Object {
        // Owm methods of Grl-0.1.PluginRegistry
    ...
    class RelatedKeys extends GObject.Object {
        // Constructors of Grl-0.1.RelatedKeys

        static ['new'](): RelatedKeys;

        // Owm methods of Grl-0.1.RelatedKeys
    ...
    class LogDomain {
        // Owm methods of Grl-0.1.LogDomain
    ...
    class MediaSourceBrowseSpec {
        // Own fields of Grl-0.1.MediaSourceBrowseSpec
    ...
    class MediaSourceMediaFromUriSpec {
        // Own fields of Grl-0.1.MediaSourceMediaFromUriSpec
    ...
    class MediaSourceMetadataSpec {
        // Own fields of Grl-0.1.MediaSourceMetadataSpec
    ...
    class MediaSourceQuerySpec {
        // Own fields of Grl-0.1.MediaSourceQuerySpec
    ...
    class MediaSourceRemoveSpec {
        // Own fields of Grl-0.1.MediaSourceRemoveSpec
    ...
    class MediaSourceSearchSpec {
        // Own fields of Grl-0.1.MediaSourceSearchSpec
    ...
    class MediaSourceStoreSpec {
        // Own fields of Grl-0.1.MediaSourceStoreSpec
    ...
    class MetadataSourceClass {
        // Own fields of Grl-0.1.MetadataSourceClass
    ...
    class MetadataSourceResolveSpec {
        // Own fields of Grl-0.1.MetadataSourceResolveSpec
    ...
    class MetadataSourceSetMetadataSpec {
        // Own fields of Grl-0.1.MetadataSourceSetMetadataSpec
    ...
    class PluginDescriptor {
        // Own fields of Grl-0.1.PluginDescriptor
     ...
     */
    class PluginInfo {
        // Own fields of Grl-0.1.PluginInfo

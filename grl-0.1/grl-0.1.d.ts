...
function marshal_VOID__BOXED_ENUM_BOOLEAN(closure: GObject.Closure, return_value: GObject.Value, n_param_values: number, param_values: GObject.Value, invocation_hint: any, marshal_data: any): void
/**
...
_init(...args: any[]): void;
    ...
    connect(signal: 'content-changed', callback: ((_source: this, changed_medias: any[], change_type: MediaSourceChangeType, location_unknown: boolean) => void)): number
    connect_after(signal: 'content-changed', callback: ((_source: this, changed_medias: any[], change_type: MediaSourceChangeType, location_unknown: boolean) => void)): number
    emit(signal: 'content-changed', changed_medias: any[], change_type: MediaSourceChangeType, location_unknown: boolean): void

...
export const OWN_PROPS = {
    RetroCore: ['core-assets-directory', 'filename', 'runahead', 'save-directory', 'speed-rate', 'system-directory', 'user-name'],
    RetroCoreView: ['can-grab-pointer', 'snap-pointer-to-borders'],
};

export const OWN_SIGNALS = {
    RetroCore: ['crashed', 'log', 'message', 'shutdown', 'video-output'],
...
export const PROP_TYPES = {
    'RetroCore.core-assets-directory': 'gchararray',
    'RetroCore.filename': 'gchararray',
    'RetroCore.runahead': 'guint',
    'RetroCore.save-directory': 'gchararray',
    'RetroCore.speed-rate': 'gdouble',
    'RetroCore.system-directory': 'gchararray',
    'RetroCore.user-name': 'gchararray',

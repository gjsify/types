...
export namespace Retro {
    ...
    class ControllerIterator extends GObject.Object {
        // Owm methods of Retro-2.ControllerIterator
    ...
    class Core extends GObject.Object {
        // Own properties of Retro-2.Core
        ...
        // Constructors of Retro-2.Core

        static ['new'](filename: string): Core;

        // Owm methods of Retro-2.Core
    ...
    class CoreDescriptor extends GObject.Object {
        // Constructors of Retro-2.CoreDescriptor

        static ['new'](filename: string): CoreDescriptor;

        // Owm methods of Retro-2.CoreDescriptor
    ...
    class CoreView extends Gtk.Widget {
        // Own properties of Retro-2.CoreView
        ...
        // Constructors of Retro-2.CoreView

        static ['new'](): CoreView;

        // Owm methods of Retro-2.CoreView
    ...
    class KeyJoypadMapping extends GObject.Object {
        // Constructors of Retro-2.KeyJoypadMapping

        static ['new'](): KeyJoypadMapping;

        static new_default(): KeyJoypadMapping;

        // Owm methods of Retro-2.KeyJoypadMapping
    ...
    class ModuleIterator extends GObject.Object {
        // Constructors of Retro-2.ModuleIterator

        static ['new'](lookup_paths: string[], recursive: boolean): ModuleIterator;

        // Owm methods of Retro-2.ModuleIterator
    ...
    class ModuleQuery extends GObject.Object {
        // Constructors of Retro-2.ModuleQuery

        static ['new'](recursive: boolean): ModuleQuery;

        // Owm methods of Retro-2.ModuleQuery
    ...
    class OptionIterator extends GObject.Object {
        // Owm methods of Retro-2.OptionIterator
    ...
    class Pixdata {
        // Owm methods of Retro-2.Pixdata
    ...
    class Input {
        // Constructors of Retro-2.Input

        constructor(properties?: Partial<{}>);

        static ['new'](): Input;

        // Owm methods of Retro-2.Input
    ...
    interface Controller {
        // Owm methods of Retro-2.Controller
        ...
        // Own virtual methods of Retro-2.Controller

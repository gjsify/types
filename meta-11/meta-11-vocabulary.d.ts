/**
 * The GIR-derived widget VOCABULARY for Meta-11.
 *
 * GENERATED — do not edit. Provenance: Meta-11 — dropped empty base(s): Atk.ImplementorIface
 *
 * 30 instantiable GTypes (of which 0 concrete widgets), 30 declarations, 30 enum nick unions, 0 slot candidates.
 *
...
import type { ClutterActorConstructOnly, ClutterActorProps, ClutterAnimatableConstructOnly, ClutterAnimatableProps, ClutterContainerConstructOnly, ClutterContainerProps, ClutterContentConstructOnly, ClutterContentProps, ClutterScriptableConstructOnly, ClutterScriptableProps, ClutterStageConstructOnly, ClutterStageProps } from '@girs/clutter-11/vocabulary';
import type { GAppLaunchContextConstructOnly, GAppLaunchContextProps, GInitableConstructOnly, GInitableProps } from '@girs/gio-2.0/vocabulary';
...
export type MetaCompositorTypeNick = 'wayland' | 'x11';
...
export type MetaGrabOpNick = 'none' | 'window-base' | 'wayland-popup' | 'frame-button' | 'moving' | 'resizing-nw' | 'resizing-n' | 'resizing-ne' | 'resizing-e' | 'resizing-sw' | 'resizing-s' | 'resizing-se' | 'resizing-w' | 'keyboard-moving' | 'keyboard-resizing-unknown' | 'keyboard-resizing-nw' | 'keyboard-resizing-n' | 'keyboard-resizing-ne' | 'keyboard-resizing-e' | 'keyboard-resizing-sw' | 'keyboard-resizing-s' | 'keyboard-resizing-se' | 'keyboard-resizing-w';
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MetaBarrierConstructOnly = GObjectConstructOnly | GInitableConstructOnly | 'backend' | 'directions' | 'display' | 'x1' | 'x2' | 'y1' | 'y2';
...
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MetaContextConstructOnly = GObjectConstructOnly | 'name';

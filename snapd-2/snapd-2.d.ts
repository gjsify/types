...
export namespace Snapd {
    ...
    class Category extends GObject.Object {
        ...
        // Own properties of Snapd.Category

        get featured(): boolean;
        get name(): string;

        // Constructors of Snapd.Category

        constructor(properties?: Partial<Category.ConstructorProps>, ...args: any[]);

        _init(...args: any[]): void;

        // Own methods of Snapd.Category
    ...
    class CategoryDetails extends GObject.Object {
        ...
        // Own properties of Snapd.CategoryDetails

        get name(): string;

        // Constructors of Snapd.CategoryDetails

        constructor(properties?: Partial<CategoryDetails.ConstructorProps>, ...args: any[]);

        _init(...args: any[]): void;

        // Own methods of Snapd.CategoryDetails

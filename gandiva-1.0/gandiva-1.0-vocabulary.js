...
export const PROP_TYPES = {
    'GGandivaExpression.expression': 'gpointer',
    'GGandivaExpression.result-field': 'GArrowField',
    'GGandivaExpression.root-node': 'GGandivaNode',
    'GGandivaFieldNode.field': 'GArrowField',
    'GGandivaFunctionNode.name': 'gchararray',
    'GGandivaFunctionSignature.function-signature': 'gpointer',
    'GGandivaIfNode.condition-node': 'GGandivaNode',
    'GGandivaIfNode.else-node': 'GGandivaNode',
    'GGandivaIfNode.then-node': 'GGandivaNode',
    'GGandivaNativeFunction.native-function': 'gpointer',
    'GGandivaNode.node': 'gpointer',
    'GGandivaNode.return-type': 'GArrowDataType',
    'GGandivaProjector.projector': 'gpointer',
};

/**
 * The GIR-derived widget VOCABULARY for MediaArt-1.0.
 *
 * GENERATED — do not edit. Provenance: MediaArt-1.0
 *
...
export interface MediaArtProcessProps extends GObjectProps, GInitableProps {
}
/** Settable only at construction — a renderer must REBUILD, not patch. */
export type MediaArtProcessConstructOnly = GObjectConstructOnly | GInitableConstructOnly;

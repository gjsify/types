...
static new_with_window(window: xlib.Window): TexturePixmap;
    ...
    connect(signal: 'queue-damage-redraw', callback: ((_source: this, x: number, y: number, width: number, height: number) => void)): number
    connect_after(signal: 'queue-damage-redraw', callback: ((_source: this, x: number, y: number, width: number, height: number) => void)): number
    emit(signal: 'queue-damage-redraw', x: number, y: number, width: number, height: number): void
    connect(signal: 'update-area', callback: ((_source: this, x: number, y: number, width: number, height: number) => void)): number
    connect_after(signal: 'update-area', callback: ((_source: this, x: number, y: number, width: number, height: number) => void)): number

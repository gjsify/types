...
export namespace DbusmenuGtk {
    ...
    class Client extends Dbusmenu.Client {
        // Constructors of DbusmenuGtk-0.4.Client

        static ['new'](dbus_name: string, dbus_object: string): Client;

        // Owm methods of DbusmenuGtk-0.4.Client
    ...
    class Menu extends Gtk.Menu {
        // Own properties of DbusmenuGtk-0.4.Menu
        ...
        // Constructors of DbusmenuGtk-0.4.Menu

        static ['new'](dbus_name: string, dbus_object: string): Menu;

        // Owm methods of DbusmenuGtk-0.4.Menu
